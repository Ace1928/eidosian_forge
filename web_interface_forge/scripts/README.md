# `web_interface_forge/scripts`

<!-- EIDOS:DOCSYS:START -->
- Contract: `eidos.directory_doc.v1`
- Generated: `2026-03-13T00:19:31Z`
- Path: `web_interface_forge/scripts`

## What It Is

Managed directory documentation for `web_interface_forge/scripts`, generated from tracked files and directory structure.

## Why It Exists

This directory exists to hold the `scripts` surface for `web_interface_forge` and keep that responsibility separate from adjacent forge concerns.
