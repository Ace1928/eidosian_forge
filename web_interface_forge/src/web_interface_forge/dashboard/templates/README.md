# `web_interface_forge/src/web_interface_forge/dashboard/templates`

<!-- EIDOS:DOCSYS:START -->
- Contract: `eidos.directory_doc.v1`
- Generated: `2026-03-13T00:19:31Z`
- Path: `web_interface_forge/src/web_interface_forge/dashboard/templates`

## What It Is

Managed directory documentation for `web_interface_forge/src/web_interface_forge/dashboard/templates`, generated from tracked files and directory structure.

## Why It Exists

This directory exists to hold the `templates` surface for `web_interface_forge` and keep that responsibility separate from adjacent forge concerns.
...
- Parent README: [`web_interface_forge/src/web_interface_forge/dashboard/README.md`](../README.md)
