...
Managed directory documentation for `gis_forge/src`, generated from tracked files and directory structure.

## Why It Exists

This directory exists to hold the `src` surface for `gis_forge` and keep that responsibility separate from adjacent forge concerns.
