# `gis_forge/src/gis_forge/cli`

<!-- EIDOS:DOCSYS:START -->
- Contract: `eidos.directory_doc.v1`
- Generated: `2026-03-13T00:19:22Z`
- Path: `gis_forge/src/gis_forge/cli`

## What It Is

Managed directory documentation for `gis_forge/src/gis_forge/cli`, generated from tracked files and directory structure.

## Why It Exists

This directory exists to hold the `cli` surface for `gis_forge` and keep that responsibility separate from adjacent forge concerns.
...
- Parent README: [`gis_forge/src/gis_forge/README.md`](../README.md)
- Forge README: [`gis_forge/README.md`](../../../README.md)
