# `gis_forge/src/gis_forge`

<!-- EIDOS:DOCSYS:START -->
- Contract: `eidos.directory_doc.v1`
- Generated: `2026-03-13T00:19:22Z`
- Path: `gis_forge/src/gis_forge`

## What It Is

Managed directory documentation for `gis_forge/src/gis_forge`, generated from tracked files and directory structure.

## Why It Exists

This directory exists to hold the `forge` surface for `gis_forge` and keep that responsibility separate from adjacent forge concerns.
...
- Python modules: `analysis, core, defaults, identity, ontology, ontology_engine, vector_substrate`
...
- [`identity.py`](./identity.py)
- [`ontology.py`](./ontology.py)
- [`ontology_engine.py`](./ontology_engine.py)
- [`vector_substrate.py`](./vector_substrate.py)
...
- Parent README: [`gis_forge/src/README.md`](../README.md)
