...
k.addSingletonGetter = function (a) {
  ...
  a.getInstance = function () {
    ...
    k.DEBUG &&
      (k.instantiatedSingletons_[k.instantiatedSingletons_.length] = a);
...
k.string.internal.caseInsensitiveStartsWith = function (a, b) {
  return (
    0 == k.string.internal.caseInsensitiveCompare(b, a.substr(0, b.length))
  );
};
...
k.i18n.bidi.hasAnyLtr = function (a) {
  return k.i18n.bidi.ltrCharReg_.test(
    k.i18n.bidi.stripHtmlIfNeeded_(a, void 0),
  );
};
...
k.string.caseInsensitiveStartsWith =
  k.string.internal.caseInsensitiveStartsWith;
...
k.userAgent.MOBILE =
  k.userAgent.ASSUME_MOBILE_WEBKIT || k.userAgent.isMobile_();
...
k.debug.enhanceError = function (a, b) {
  a instanceof Error ||
    ...
    Error.captureStackTrace &&
      Error.captureStackTrace(a, k.debug.enhanceError));
...
L.GENERATE_FROM_OBJECT &&
  ...
  (Y.postaladdress.PostalAddress.fromObject = function (a) {
    ...
    null != a.dependentThoroughfareName &&
      P(b, 21, a.dependentThoroughfareName);
    null != a.postalCodeNumber && P(b, 12, a.postalCodeNumber);
    null != a.postalCodeNumberExtension &&
      P(b, 13, a.postalCodeNumberExtension);
    ...
    function (a) {
      ...
      a.subscriptionId &&
        S(
          b,
          7,
          Y.moneta.integrator.common.SubscriptionId.fromObject(
            a.subscriptionId,
          ),
        );
...
Y.moneta.integrator.common.address.Address.serializeBinaryToWriter = function (
  ...
  c = a.getAddress();
  null != c &&
    J(b, 2, c, Y.postaladdress.PostalAddress.serializeBinaryToWriter);
  c = O(a, 7);
  ...
  (Y.moneta.integrator.common.tax.TaxDetails.fromObject = function (a) {
    ...
    a.assesseeAddress &&
      S(
        b,
        1,
        Y.moneta.integrator.common.address.Address.fromObject(
          a.assesseeAddress,
        ),
      );
    a.taxList &&
  ...
  (Y.moneta.integrator.common.cart.LineItemComputedInfo.fromObject = function (
    ...
    a.totalTaxDetails &&
      S(
        b,
        3,
        Y.moneta.integrator.common.cart.TaxDetails.fromObject(
          a.totalTaxDetails,
        ),
      );
    a.priceDetails &&
    ...
    function (a) {
      ...
      a.availableAmount &&
        S(
          b,
          1,
          Y.moneta.integrator.common.Amount.fromObject(a.availableAmount),
        );
      a.promotionalAmount &&
        S(
          b,
...
d =
  Y.moneta.integrator.common.buyflow.IntegratorPurchaseOrderResponse.prototype;
d.getProductCorrelationId = function () {
  return Q(this, Y.moneta.integrator.common.ProductCorrelationId, 1);
};
d.setProductCorrelationId = function (a) {
...
L.GENERATE_TO_OBJECT &&
  ((Y.moneta.integrator.common.purchaseorder.LineItem.prototype.toObject =
    function (a) {
      return Y.moneta.integrator.common.purchaseorder.LineItem.toObject(
        a,
        this,
      );
    }),
...
L.GENERATE_FROM_OBJECT &&
  ...
  (Y.moneta.integrator.ui.buyflow.ManagedPurchaseCallbackData.fromObject =
    function (a) {
      ...
      null != a.integratorDisplayMessage &&
        P(b, 10, a.integratorDisplayMessage);
      a.selectedShippingDetails &&
        S(
          b,
          11,
...
var Mc = function (a, b, c, f, g) {
  ...
  Pc = function (a, b, c, f, g) {
    a = function (l) {
      console.log(
        "Clearing licenses cache value after payment for appId: " + c,
      );
...
var rd = function (a, b) {
  ...
  pd = function (a) {
    a.xhr_ &&
      a.useXhr2Timeout_ &&
      (a.xhr_[k.net.XhrIo.XHR2_ON_TIMEOUT_] = null);
...
var od = function (a, b) {
  return (
    b + " [" + a.lastMethod_ + " " + a.lastUri_ + " " + a.getStatus() + "]"
  );
};
k.debug.entryPointRegistry.register(function (a) {
