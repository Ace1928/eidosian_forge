...
- Path: `prompt_forge/src`

## What It Is

Managed directory documentation for `prompt_forge/src`, generated from tracked files and directory structure.

## Why It Exists

This directory exists to hold the `src` surface for `prompt_forge` and keep that responsibility separate from adjacent forge concerns.
...
- [`prompt_forge`](./prompt_forge/README.md)
...
- Parent README: [`prompt_forge/README.md`](../README.md)
