# `prompt_forge/src/prompt_forge/cli`

<!-- EIDOS:DOCSYS:START -->
- Contract: `eidos.directory_doc.v1`
- Generated: `2026-03-13T00:19:24Z`
- Path: `prompt_forge/src/prompt_forge/cli`

## What It Is

Managed directory documentation for `prompt_forge/src/prompt_forge/cli`, generated from tracked files and directory structure.

## Why It Exists

This directory exists to hold the `cli` surface for `prompt_forge` and keep that responsibility separate from adjacent forge concerns.
...
- Parent README: [`prompt_forge/src/prompt_forge/README.md`](../README.md)
