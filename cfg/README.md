...
Managed directory documentation for `cfg`, generated from tracked files and directory structure.

## Why It Exists

This directory exists to hold the `cfg` surface for `cfg` and keep that responsibility separate from adjacent forge concerns.
...
- [`autonomy.example.yaml`](./autonomy.example.yaml)
- [`local_agent_profiles.json`](./local_agent_profiles.json)
...
- Forge README: [`cfg/README.md`](README.md)
