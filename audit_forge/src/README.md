...
- Path: `audit_forge/src`

## What It Is

Managed directory documentation for `audit_forge/src`, generated from tracked files and directory structure.

## Why It Exists

This directory exists to hold the `src` surface for `audit_forge` and keep that responsibility separate from adjacent forge concerns.
...
- [`audit_forge`](./audit_forge/README.md)
