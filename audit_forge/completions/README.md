# `audit_forge/completions`

<!-- EIDOS:DOCSYS:START -->
- Contract: `eidos.directory_doc.v1`
- Generated: `2026-03-13T00:19:21Z`
- Path: `audit_forge/completions`

## What It Is

Managed directory documentation for `audit_forge/completions`, generated from tracked files and directory structure.

## Why It Exists

This directory exists to hold the `forge` surface for `audit_forge` and keep that responsibility separate from adjacent forge concerns.
...
- [`audit-forge.bash`](./audit-forge.bash)
...
- Parent README: [`audit_forge/README.md`](../README.md)
