...
- Path: `refactor_forge/src`

## What It Is

Managed directory documentation for `refactor_forge/src`, generated from tracked files and directory structure.

## Why It Exists

This directory exists to hold the `src` surface for `refactor_forge` and keep that responsibility separate from adjacent forge concerns.
...
- [`refactor_forge`](./refactor_forge/README.md)
