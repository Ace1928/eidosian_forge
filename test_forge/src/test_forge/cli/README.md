# `test_forge/src/test_forge/cli`

<!-- EIDOS:DOCSYS:START -->
- Contract: `eidos.directory_doc.v1`
- Generated: `2026-03-13T00:19:30Z`
- Path: `test_forge/src/test_forge/cli`

## What It Is

Managed directory documentation for `test_forge/src/test_forge/cli`, generated from tracked files and directory structure.

## Why It Exists

This directory exists to hold the `cli` surface for `test_forge` and keep that responsibility separate from adjacent forge concerns.
...
- Parent README: [`test_forge/src/test_forge/README.md`](../README.md)
- Forge README: [`test_forge/README.md`](../../../README.md)
