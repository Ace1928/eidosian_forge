# `figlet_forge/src/figlet_forge/core`

<!-- EIDOS:DOCSYS:START -->
- Contract: `eidos.directory_doc.v1`
- Generated: `2026-03-13T00:19:21Z`
- Path: `figlet_forge/src/figlet_forge/core`

## What It Is

Managed directory documentation for `figlet_forge/src/figlet_forge/core`, generated from tracked files and directory structure.

## Why It Exists

This directory exists to hold the `core` surface for `figlet_forge` and keep that responsibility separate from adjacent forge concerns.
...
- Python modules: `exceptions, figlet_builder, figlet_font, figlet_string, utils`
...
- [`figlet_builder.py`](./figlet_builder.py)
- [`figlet_font.py`](./figlet_font.py)
- [`figlet_string.py`](./figlet_string.py)
- [`utils.py`](./utils.py)
