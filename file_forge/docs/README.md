...
- Path: `file_forge/docs`

## What It Is

Managed directory documentation for `file_forge/docs`, generated from tracked files and directory structure.

## Why It Exists

This directory exists to hold the `docs` surface for `file_forge` and keep that responsibility separate from adjacent forge concerns.
