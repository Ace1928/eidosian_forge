# `file_forge/docs/manual/go/api`

<!-- EIDOS:DOCSYS:START -->
- Contract: `eidos.directory_doc.v1`
- Generated: `2026-03-13T00:19:21Z`
- Path: `file_forge/docs/manual/go/api`

## What It Is

Managed directory documentation for `file_forge/docs/manual/go/api`, generated from tracked files and directory structure.
