...
Managed directory documentation for `file_forge/src`, generated from tracked files and directory structure.

## Why It Exists

This directory exists to hold the `src` surface for `file_forge` and keep that responsibility separate from adjacent forge concerns.
...
- [`file_forge`](./file_forge/README.md)
