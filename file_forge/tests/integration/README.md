# `file_forge/tests/integration`

<!-- EIDOS:DOCSYS:START -->
- Contract: `eidos.directory_doc.v1`
- Generated: `2026-03-13T00:19:21Z`
- Path: `file_forge/tests/integration`

## What It Is

Managed directory documentation for `file_forge/tests/integration`, generated from tracked files and directory structure.
...
- Parent README: [`file_forge/tests/README.md`](../README.md)
