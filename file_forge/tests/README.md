...
- Path: `file_forge/tests`

## What It Is

Managed directory documentation for `file_forge/tests`, generated from tracked files and directory structure.

## Why It Exists

This directory exists to hold the `tests` surface for `file_forge` and keep that responsibility separate from adjacent forge concerns.
...
- Child directories: `8`
- Tests detected: `True`
- Python modules: `conftest, test_file`
...
- Parent README: [`file_forge/README.md`](../README.md)
