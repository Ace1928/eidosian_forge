# `lyrics_forge/src/lyrics_forge/cli`

<!-- EIDOS:DOCSYS:START -->
- Contract: `eidos.directory_doc.v1`
- Generated: `2026-03-13T00:19:22Z`
- Path: `lyrics_forge/src/lyrics_forge/cli`

## What It Is

Managed directory documentation for `lyrics_forge/src/lyrics_forge/cli`, generated from tracked files and directory structure.

## Why It Exists

This directory exists to hold the `cli` surface for `lyrics_forge` and keep that responsibility separate from adjacent forge concerns.
...
- Parent README: [`lyrics_forge/src/lyrics_forge/README.md`](../README.md)
- Forge README: [`lyrics_forge/README.md`](../../../README.md)
