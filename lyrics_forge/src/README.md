...
- Path: `lyrics_forge/src`

## What It Is

Managed directory documentation for `lyrics_forge/src`, generated from tracked files and directory structure.

## Why It Exists

This directory exists to hold the `src` surface for `lyrics_forge` and keep that responsibility separate from adjacent forge concerns.
...
- [`lyrics_forge`](./lyrics_forge/README.md)
