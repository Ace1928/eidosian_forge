...
- Path: `lyrics_forge/tests`

## What It Is

Managed directory documentation for `lyrics_forge/tests`, generated from tracked files and directory structure.

## Why It Exists

This directory exists to hold the `tests` surface for `lyrics_forge` and keep that responsibility separate from adjacent forge concerns.
