...
- Path: `erais_forge/tools`

## What It Is

Managed directory documentation for `erais_forge/tools`, generated from tracked files and directory structure.
...
- Python modules: `benchmark_genetics, profile_genetics`
...
- [`benchmark_genetics.py`](./benchmark_genetics.py)
- [`profile_genetics.py`](./profile_genetics.py)
