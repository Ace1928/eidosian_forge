...
- Path: `erais_forge/src`

## What It Is

Managed directory documentation for `erais_forge/src`, generated from tracked files and directory structure.

## Why It Exists

This directory exists to hold the `src` surface for `erais_forge` and keep that responsibility separate from adjacent forge concerns.
...
- [`erais_forge`](./erais_forge/README.md)
...
- Parent README: [`erais_forge/README.md`](../README.md)
