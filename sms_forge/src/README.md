...
Managed directory documentation for `sms_forge/src`, generated from tracked files and directory structure.

## Why It Exists

This directory exists to hold the `src` surface for `sms_forge` and keep that responsibility separate from adjacent forge concerns.
...
- Parent README: [`sms_forge/README.md`](../README.md)
