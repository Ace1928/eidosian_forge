# `sms_forge/src/sms_forge/utils`

<!-- EIDOS:DOCSYS:START -->
- Contract: `eidos.directory_doc.v1`
- Generated: `2026-03-13T00:19:25Z`
- Path: `sms_forge/src/sms_forge/utils`

## What It Is

Managed directory documentation for `sms_forge/src/sms_forge/utils`, generated from tracked files and directory structure.

## Why It Exists

This directory exists to hold the `utils` surface for `sms_forge` and keep that responsibility separate from adjacent forge concerns.
...
- Python modules: `contacts, parser`
