# `sms_forge/src/sms_forge/cli`

<!-- EIDOS:DOCSYS:START -->
- Contract: `eidos.directory_doc.v1`
- Generated: `2026-03-13T00:19:25Z`
- Path: `sms_forge/src/sms_forge/cli`

## What It Is

Managed directory documentation for `sms_forge/src/sms_forge/cli`, generated from tracked files and directory structure.

## Why It Exists

This directory exists to hold the `cli` surface for `sms_forge` and keep that responsibility separate from adjacent forge concerns.
...
- Parent README: [`sms_forge/src/sms_forge/README.md`](../README.md)
