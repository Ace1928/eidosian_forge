# `diagnostics_forge/tests`

<!-- EIDOS:DOCSYS:START -->
- Contract: `eidos.directory_doc.v1`
- Generated: `2026-03-13T00:19:21Z`
- Path: `diagnostics_forge/tests`

## What It Is

Managed directory documentation for `diagnostics_forge/tests`, generated from tracked files and directory structure.

## Why It Exists

This directory exists to hold the `tests` surface for `diagnostics_forge` and keep that responsibility separate from adjacent forge concerns.
...
- Child directories: `0`
- Tests detected: `True`
- Python modules: `conftest, test_cli_dashboard, test_diag, test_diagnostics, test_prometheus`
...
- [`test_cli_dashboard.py`](./test_cli_dashboard.py)
- [`test_diag.py`](./test_diag.py)
- [`test_diagnostics.py`](./test_diagnostics.py)
- [`test_prometheus.py`](./test_prometheus.py)
...
- Parent README: [`diagnostics_forge/README.md`](../README.md)
