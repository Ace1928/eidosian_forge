# `glyph_forge/src/glyph_forge/core`

<!-- EIDOS:DOCSYS:START -->
- Contract: `eidos.directory_doc.v1`
- Generated: `2026-03-13T00:19:22Z`
- Path: `glyph_forge/src/glyph_forge/core`

## What It Is

Managed directory documentation for `glyph_forge/src/glyph_forge/core`, generated from tracked files and directory structure.
...
- Python modules: `banner_generator, style_manager`
...
- [`banner_generator.py`](./banner_generator.py)
- [`style_manager.py`](./style_manager.py)
