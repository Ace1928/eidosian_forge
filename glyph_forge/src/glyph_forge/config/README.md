# `glyph_forge/src/glyph_forge/config`

<!-- EIDOS:DOCSYS:START -->
- Contract: `eidos.directory_doc.v1`
- Generated: `2026-03-13T00:19:22Z`
- Path: `glyph_forge/src/glyph_forge/config`

## What It Is

Managed directory documentation for `glyph_forge/src/glyph_forge/config`, generated from tracked files and directory structure.

## Why It Exists

This directory exists to hold the `config` surface for `glyph_forge` and keep that responsibility separate from adjacent forge concerns.
