...
- Path: `glyph_forge/src`

## What It Is

Managed directory documentation for `glyph_forge/src`, generated from tracked files and directory structure.

## Why It Exists

This directory exists to hold the `src` surface for `glyph_forge` and keep that responsibility separate from adjacent forge concerns.
...
- [`glyph_forge`](./glyph_forge/README.md)
