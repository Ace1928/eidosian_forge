...
- Path: `glyph_forge/assets`

## What It Is

Managed directory documentation for `glyph_forge/assets`, generated from tracked files and directory structure.
