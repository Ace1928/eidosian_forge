...
- Path: `version_forge/src`

## What It Is

Managed directory documentation for `version_forge/src`, generated from tracked files and directory structure.

## Why It Exists

This directory exists to hold the `src` surface for `version_forge` and keep that responsibility separate from adjacent forge concerns.

## How It Works

- Tracked files in scope: `21`
- Child directories: `1`
- Tests detected: `False`

## Contents

- [`version_forge`](./version_forge/README.md)
...
- Parent README: [`version_forge/README.md`](../README.md)
