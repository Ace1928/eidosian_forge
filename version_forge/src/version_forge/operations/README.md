# `version_forge/src/version_forge/operations`

<!-- EIDOS:DOCSYS:START -->
- Contract: `eidos.directory_doc.v1`
- Generated: `2026-03-13T00:19:31Z`
- Path: `version_forge/src/version_forge/operations`

## What It Is

Managed directory documentation for `version_forge/src/version_forge/operations`, generated from tracked files and directory structure.

## Why It Exists

This directory exists to hold the `forge` surface for `version_forge` and keep that responsibility separate from adjacent forge concerns.
...
- Python modules: `compare, migration, update`
