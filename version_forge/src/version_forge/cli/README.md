# `version_forge/src/version_forge/cli`

<!-- EIDOS:DOCSYS:START -->
- Contract: `eidos.directory_doc.v1`
- Generated: `2026-03-13T00:19:31Z`
- Path: `version_forge/src/version_forge/cli`

## What It Is

Managed directory documentation for `version_forge/src/version_forge/cli`, generated from tracked files and directory structure.

## Why It Exists

This directory exists to hold the `cli` surface for `version_forge` and keep that responsibility separate from adjacent forge concerns.
...
- Parent README: [`version_forge/src/version_forge/README.md`](../README.md)
- Forge README: [`version_forge/README.md`](../../../README.md)
