# `article_forge/scripts`

<!-- EIDOS:DOCSYS:START -->
- Contract: `eidos.directory_doc.v1`
- Generated: `2026-03-13T00:19:21Z`
- Path: `article_forge/scripts`

## What It Is

Managed directory documentation for `article_forge/scripts`, generated from tracked files and directory structure.

## Why It Exists

This directory exists to hold the `scripts` surface for `article_forge` and keep that responsibility separate from adjacent forge concerns.
...
- Python modules: `extract_profile_data, parse_vscode_config`
...
- [`extract_profile_data.py`](./extract_profile_data.py)
- [`parse_vscode_config.py`](./parse_vscode_config.py)
...
- Parent README: [`article_forge/README.md`](../README.md)
