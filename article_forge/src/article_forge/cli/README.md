# `article_forge/src/article_forge/cli`

<!-- EIDOS:DOCSYS:START -->
- Contract: `eidos.directory_doc.v1`
- Generated: `2026-03-13T00:19:21Z`
- Path: `article_forge/src/article_forge/cli`

## What It Is

Managed directory documentation for `article_forge/src/article_forge/cli`, generated from tracked files and directory structure.

## Why It Exists

This directory exists to hold the `cli` surface for `article_forge` and keep that responsibility separate from adjacent forge concerns.
...
- Parent README: [`article_forge/src/article_forge/README.md`](../README.md)
