...
- Path: `article_forge/src`

## What It Is

Managed directory documentation for `article_forge/src`, generated from tracked files and directory structure.

## Why It Exists

This directory exists to hold the `src` surface for `article_forge` and keep that responsibility separate from adjacent forge concerns.
...
- [`article_forge`](./article_forge/README.md)
