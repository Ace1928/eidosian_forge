# `knowledge_forge/src/knowledge_forge/integrations`

<!-- EIDOS:DOCSYS:START -->
- Contract: `eidos.directory_doc.v1`
- Generated: `2026-03-13T00:19:22Z`
- Path: `knowledge_forge/src/knowledge_forge/integrations`

## What It Is

Managed directory documentation for `knowledge_forge/src/knowledge_forge/integrations`, generated from tracked files and directory structure.
...
- Python modules: `graphrag, memory_ingest`
...
- [`memory_ingest.py`](./memory_ingest.py)
...
- Parent README: [`knowledge_forge/src/knowledge_forge/README.md`](../README.md)
