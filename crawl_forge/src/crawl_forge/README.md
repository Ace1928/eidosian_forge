# `crawl_forge/src/crawl_forge`

<!-- EIDOS:DOCSYS:START -->
- Contract: `eidos.directory_doc.v1`
- Generated: `2026-03-13T00:19:21Z`
- Path: `crawl_forge/src/crawl_forge`

## What It Is

Managed directory documentation for `crawl_forge/src/crawl_forge`, generated from tracked files and directory structure.
...
- Python modules: `cli, tika_extractor`
...
- [`cli.py`](./cli.py)
- [`tika_extractor.py`](./tika_extractor.py)
...
- Parent README: [`crawl_forge/src/README.md`](../README.md)
- Forge README: [`crawl_forge/README.md`](../../README.md)
