...
- Path: `crawl_forge/src`

## What It Is

Managed directory documentation for `crawl_forge/src`, generated from tracked files and directory structure.

## Why It Exists

This directory exists to hold the `src` surface for `crawl_forge` and keep that responsibility separate from adjacent forge concerns.
...
- [`crawl_forge`](./crawl_forge/README.md)
