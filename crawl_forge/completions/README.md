# `crawl_forge/completions`

<!-- EIDOS:DOCSYS:START -->
- Contract: `eidos.directory_doc.v1`
- Generated: `2026-03-13T00:19:21Z`
- Path: `crawl_forge/completions`

## What It Is

Managed directory documentation for `crawl_forge/completions`, generated from tracked files and directory structure.

## Why It Exists

This directory exists to hold the `forge` surface for `crawl_forge` and keep that responsibility separate from adjacent forge concerns.
...
- [`crawl-forge.bash`](./crawl-forge.bash)
...
- Parent README: [`crawl_forge/README.md`](../README.md)
