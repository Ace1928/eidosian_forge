...
Managed directory documentation for `word_forge/src`, generated from tracked files and directory structure.

## Why It Exists

This directory exists to hold the `src` surface for `word_forge` and keep that responsibility separate from adjacent forge concerns.

## How It Works

- Tracked files in scope: `105`
- Child directories: `2`
...
- [`old`](./old/README.md)
- [`word_forge`](./word_forge/README.md)
