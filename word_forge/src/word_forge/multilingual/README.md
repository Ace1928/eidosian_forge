# `word_forge/src/word_forge/multilingual`

<!-- EIDOS:DOCSYS:START -->
- Contract: `eidos.directory_doc.v1`
- Generated: `2026-03-13T00:19:31Z`
- Path: `word_forge/src/word_forge/multilingual`

## What It Is

Managed directory documentation for `word_forge/src/word_forge/multilingual`, generated from tracked files and directory structure.
...
- Python modules: `multilingual_manager, wiktextract_ingest`
...
- [`multilingual_manager.py`](./multilingual_manager.py)
- [`wiktextract_ingest.py`](./wiktextract_ingest.py)
