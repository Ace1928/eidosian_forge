# `word_forge/src/word_forge/database`

<!-- EIDOS:DOCSYS:START -->
- Contract: `eidos.directory_doc.v1`
- Generated: `2026-03-13T00:19:31Z`
- Path: `word_forge/src/word_forge/database`

## What It Is

Managed directory documentation for `word_forge/src/word_forge/database`, generated from tracked files and directory structure.
...
- Python modules: `database_config, database_manager, database_worker`
...
- [`database_worker.py`](./database_worker.py)
