# `word_forge/src/word_forge/queue`

<!-- EIDOS:DOCSYS:START -->
- Contract: `eidos.directory_doc.v1`
- Generated: `2026-03-13T00:19:31Z`
- Path: `word_forge/src/word_forge/queue`

## What It Is

Managed directory documentation for `word_forge/src/word_forge/queue`, generated from tracked files and directory structure.
...
- Python modules: `queue_config, queue_manager, queue_worker, worker_manager`
...
- [`queue_config.py`](./queue_config.py)
- [`queue_manager.py`](./queue_manager.py)
- [`queue_worker.py`](./queue_worker.py)
