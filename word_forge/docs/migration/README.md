# `word_forge/docs/migration`

<!-- EIDOS:DOCSYS:START -->
- Contract: `eidos.directory_doc.v1`
- Generated: `2026-03-13T00:19:31Z`
- Path: `word_forge/docs/migration`

## What It Is

Managed directory documentation for `word_forge/docs/migration`, generated from tracked files and directory structure.
...
- [`emotion_config_migration.md`](./emotion_config_migration.md)
...
- Parent README: [`word_forge/docs/README.md`](../README.md)
