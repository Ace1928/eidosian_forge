# `word_forge/.github/workflows`

<!-- EIDOS:DOCSYS:START -->
- Contract: `eidos.directory_doc.v1`
- Generated: `2026-03-13T00:19:31Z`
- Path: `word_forge/.github/workflows`

## What It Is

Managed directory documentation for `word_forge/.github/workflows`, generated from tracked files and directory structure.
...
- [`ci.yml`](./ci.yml)
- [`python-task.yml`](./python-task.yml)
...
- Parent README: [`word_forge/.github/README.md`](../README.md)
