# `agent_forge/src/agent_forge/cli`

<!-- EIDOS:DOCSYS:START -->
- Contract: `eidos.directory_doc.v1`
- Generated: `2026-03-13T00:19:21Z`
- Path: `agent_forge/src/agent_forge/cli`

## What It Is

Managed directory documentation for `agent_forge/src/agent_forge/cli`, generated from tracked files and directory structure.

## Why It Exists

This directory exists to hold the `cli` surface for `agent_forge` and keep that responsibility separate from adjacent forge concerns.
...
- Python modules: `eidctl, eidosd, eidtop`
