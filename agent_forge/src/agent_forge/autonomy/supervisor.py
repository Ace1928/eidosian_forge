...
class AutonomySupervisor:
    ...
    def _context_packet(self) -> dict[str, Any]:
        ...
        trend_entries = (runtime.get("trends") or {}).get("entries") if isinstance(runtime.get("trends"), Mapping) else []
        memory_trend_entries = (runtime.get("memory_trends") or {}).get("entries") if isinstance(runtime.get("memory_trends"), Mapping) else []
