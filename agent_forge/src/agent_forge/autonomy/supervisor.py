...
class AutonomySupervisor:
            ...
            if directory_docs_path.exists():
                ...
                if isinstance(payload, Mapping):
                    directory_docs_summary = {
                        ...
                        "drift_state": _to_text(payload.get("drift_state")),
                        "missing_examples": [
    ...
    def _score_mission(self, mission: Mapping[str, Any], context: Mapping[str, Any]) -> float:
        ...
        docs_missing_delta = int(directory_docs.get("missing_delta") or 0)
        docs_coverage_delta = float(directory_docs.get("coverage_delta") or 0.0)
        ...
        if template == "hygiene":
            ...
            if docs_missing_delta > 0 or docs_coverage_delta < 0:
                score += 0.2
    ...
    def tick(self, *, beat_count: int) -> dict[str, Any]:
        ...
        ctx_payload = {
            ...
            "directory_docs_missing_delta": int(((context.get("directory_docs_summary") or {}).get("missing_delta")) or 0),
            "directory_docs_coverage_delta": float(((context.get("directory_docs_summary") or {}).get("coverage_delta")) or 0.0),
