# `agent_forge/src/agent_forge/agent`

<!-- EIDOS:DOCSYS:START -->
- Contract: `eidos.directory_doc.v1`
- Generated: `2026-03-13T00:19:21Z`
- Path: `agent_forge/src/agent_forge/agent`

## What It Is

Managed directory documentation for `agent_forge/src/agent_forge/agent`, generated from tracked files and directory structure.
...
- Python modules: `agent, base, prompt_templates`
