...
- Path: `agent_forge/src`

## What It Is

Managed directory documentation for `agent_forge/src`, generated from tracked files and directory structure.

## Why It Exists

This directory exists to hold the `src` surface for `agent_forge` and keep that responsibility separate from adjacent forge concerns.

## How It Works

- Tracked files in scope: `112`
- Child directories: `1`
- Tests detected: `False`

## Contents

- [`agent_forge`](./agent_forge/README.md)
