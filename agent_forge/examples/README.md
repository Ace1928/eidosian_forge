# `agent_forge/examples`

<!-- EIDOS:DOCSYS:START -->
- Contract: `eidos.directory_doc.v1`
- Generated: `2026-03-13T00:19:21Z`
- Path: `agent_forge/examples`

## What It Is

Managed directory documentation for `agent_forge/examples`, generated from tracked files and directory structure.

## Why It Exists

This directory exists to hold the `examples` surface for `agent_forge` and keep that responsibility separate from adjacent forge concerns.
...
- Python modules: `basic_agent, sandbox_test, task_manager_demo`
...
- [`task_manager_demo.py`](./task_manager_demo.py)
...
- Parent README: [`agent_forge/README.md`](../README.md)
