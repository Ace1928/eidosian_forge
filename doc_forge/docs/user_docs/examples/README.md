# `doc_forge/docs/user_docs/examples`

<!-- EIDOS:DOCSYS:START -->
- Contract: `eidos.directory_doc.v1`
- Generated: `2026-03-13T00:19:21Z`
- Path: `doc_forge/docs/user_docs/examples`

## What It Is

Managed directory documentation for `doc_forge/docs/user_docs/examples`, generated from tracked files and directory structure.

## Why It Exists

This directory exists to hold the `examples` surface for `doc_forge` and keep that responsibility separate from adjacent forge concerns.
