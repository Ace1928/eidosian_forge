# `doc_forge/docs/user_docs/api`

<!-- EIDOS:DOCSYS:START -->
- Contract: `eidos.directory_doc.v1`
- Generated: `2026-03-13T00:19:21Z`
- Path: `doc_forge/docs/user_docs/api`

## What It Is

Managed directory documentation for `doc_forge/docs/user_docs/api`, generated from tracked files and directory structure.
