# `doc_forge/benchmarks`

<!-- EIDOS:DOCSYS:START -->
- Contract: `eidos.directory_doc.v1`
- Generated: `2026-03-13T00:19:21Z`
- Path: `doc_forge/benchmarks`

## What It Is

Managed directory documentation for `doc_forge/benchmarks`, generated from tracked files and directory structure.

## Why It Exists

This directory exists to hold the `benchmarks` surface for `doc_forge` and keep that responsibility separate from adjacent forge concerns.
