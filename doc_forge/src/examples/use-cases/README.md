# `doc_forge/src/examples/use-cases`

<!-- EIDOS:DOCSYS:START -->
- Contract: `eidos.directory_doc.v1`
- Generated: `2026-03-13T00:19:21Z`
- Path: `doc_forge/src/examples/use-cases`

## What It Is

Managed directory documentation for `doc_forge/src/examples/use-cases`, generated from tracked files and directory structure.
