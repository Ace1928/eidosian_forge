# `doc_forge/src/examples/advanced`

<!-- EIDOS:DOCSYS:START -->
- Contract: `eidos.directory_doc.v1`
- Generated: `2026-03-13T00:19:21Z`
- Path: `doc_forge/src/examples/advanced`

## What It Is

Managed directory documentation for `doc_forge/src/examples/advanced`, generated from tracked files and directory structure.
