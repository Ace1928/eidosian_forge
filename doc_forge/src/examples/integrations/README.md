# `doc_forge/src/examples/integrations`

<!-- EIDOS:DOCSYS:START -->
- Contract: `eidos.directory_doc.v1`
- Generated: `2026-03-13T00:19:21Z`
- Path: `doc_forge/src/examples/integrations`

## What It Is

Managed directory documentation for `doc_forge/src/examples/integrations`, generated from tracked files and directory structure.
...
- Parent README: [`doc_forge/src/examples/README.md`](../README.md)
