# `doc_forge/src/templates/tests`

<!-- EIDOS:DOCSYS:START -->
- Contract: `eidos.directory_doc.v1`
- Generated: `2026-03-13T00:19:21Z`
- Path: `doc_forge/src/templates/tests`

## What It Is

Managed directory documentation for `doc_forge/src/templates/tests`, generated from tracked files and directory structure.
...
- [`test_template.py`](./test_template.py)
...
- Parent README: [`doc_forge/src/templates/README.md`](../README.md)
