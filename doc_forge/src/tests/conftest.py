...
def sample_toc_structure() -> Dict[str, Any]:
    ...
    return {
        "getting_started": {
            ...
            "items": [
                {"title": "Installation", "url": "user_docs/getting_started/installation.html", "priority": 10},
                {"title": "Quickstart", "url": "user_docs/getting_started/quickstart.html", "priority": 20},
            ],
        },
        "user_guide": {
            "title": "User Guide",
            "items": [
                {"title": "Basic Usage", "url": "user_docs/guides/basic_usage.html", "priority": 30},
                {"title": "Advanced Features", "url": "user_docs/guides/advanced_features.html", "priority": 40},
            ],
        },
        "reference": {
            "title": "API Reference",
            "items": [{"title": "Module Reference", "url": "auto_docs/api/module_reference.html", "priority": 50}],
        },
    }
...
def mock_document_metadata(temp_docs_dir) -> Callable:
    ...
    def create_metadata(
        filename: str, title: str = "", category: str = "user", section: str = "getting_started", priority: int = 50
    ) -> DocumentMetadata:
        ...
        return DocumentMetadata(path=path, title=title, category=category, section=section, priority=priority)
