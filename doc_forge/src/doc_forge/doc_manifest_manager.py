...
class DocManifestManager:
    ...
    def _initialize_default_manifest(self) -> None:
        ...
        self.manifest = {
            ...
            "documentation_categories": {
                ...
                "assets": {"title": "Assets", "description": "Documentation assets and resources", "sections": {}},
            },
            "metadata": {
                "last_updated": datetime.now().isoformat(),
                "validation_status": {"missing_docs": [], "outdated_docs": [], "orphaned_docs": []},
                "build_info": {"last_build": "", "build_status": ""},
            },
        }
    ...
    def discover_documentation(self) -> None:
        ...
        discovered_docs: Dict[str, Dict[str, Dict[str, Any]]] = {"manual": {}, "auto": {}, "source": {}, "assets": {}}
    ...
    def validate_documentation(self) -> Dict[str, List[str]]:
        ...
        """
        results: Dict[str, List[str]] = {"missing_docs": [], "outdated_docs": [], "orphaned_docs": []}
    ...
    def update_build_info(self, status: str) -> None:
        ...
        """
        self.manifest["metadata"]["build_info"] = {"last_build": datetime.now().isoformat(), "build_status": status}
        self.save_manifest()
...
def load_doc_manifest(repo_path: Optional[Union[str, Path]]) -> Dict[str, Any]:
    ...
    if repo_path is None:
        ...
        possible_paths = [Path("."), Path(".."), Path(__file__).resolve().parent.parent.parent]
