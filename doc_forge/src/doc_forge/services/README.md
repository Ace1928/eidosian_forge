# `doc_forge/src/doc_forge/services`

<!-- EIDOS:DOCSYS:START -->
- Contract: `eidos.directory_doc.v1`
- Generated: `2026-03-13T00:19:21Z`
- Path: `doc_forge/src/doc_forge/services`

## What It Is

Managed directory documentation for `doc_forge/src/doc_forge/services`, generated from tracked files and directory structure.

## Why It Exists

This directory exists to hold the `services` surface for `doc_forge` and keep that responsibility separate from adjacent forge concerns.
