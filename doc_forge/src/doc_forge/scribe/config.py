...
class ScribeConfig:
    ...
    @classmethod
    def from_env(cls, forge_root: Path | None = None, host: str | None = None, port: int | None = None, dry_run: bool = False) -> "ScribeConfig":
        forge_root = forge_root or Path(os.environ.get("EIDOS_FORGE_ROOT", "/data/data/com.termux/files/home/eidosian_forge")).resolve()
        ...
        return cls(
            ...
            completion_url=os.environ.get("EIDOS_DOC_FORGE_COMPLETION_URL", f"http://127.0.0.1:{os.environ.get('EIDOS_DOC_FORGE_LLM_PORT', '8093')}/completion"),
            llm_model_path=model_path,
            llama_server_bin=(forge_root / os.environ.get("EIDOS_DOC_FORGE_LLAMA_SERVER_BIN", "llama.cpp/build/bin/llama-server")).resolve(),
            ...
            include_suffixes={
                ".py", ".pyi", ".js", ".jsx", ".ts", ".tsx", ".java", ".kt", ".kts", ".go", ".rs", 
                ".c", ".h", ".hpp", ".cc", ".cpp", ".cs", ".swift", ".rb", ".php", ".lua", ".sh", 
                ".bash", ".zsh", ".ps1", ".sql", ".md", ".rst", ".txt", ".adoc", ".org", ".log", 
                ".json", ".jsonl", ".yaml", ".yml", ".toml", ".ini", ".cfg", ".conf", ".xml", 
                ".csv", ".tsv", ".env", ".html", ".htm", ".xhtml", ".css", ".scss", ".less", 
                ".svg", ".pdf", ".docx"
            },
