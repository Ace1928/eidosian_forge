...
- Path: `benchmarks/schemas`

## What It Is

Managed directory documentation for `benchmarks/schemas`, generated from tracked files and directory structure.

## Why It Exists

This directory exists to hold the `directory` surface for `benchmarks` and keep that responsibility separate from adjacent forge concerns.
...
- [`graphrag_qualitative_assessment.schema.json`](./graphrag_qualitative_assessment.schema.json)
...
- Parent README: [`benchmarks/README.md`](../README.md)
