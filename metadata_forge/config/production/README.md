# `metadata_forge/config/production`

<!-- EIDOS:DOCSYS:START -->
- Contract: `eidos.directory_doc.v1`
- Generated: `2026-03-13T00:19:22Z`
- Path: `metadata_forge/config/production`

## What It Is

Managed directory documentation for `metadata_forge/config/production`, generated from tracked files and directory structure.
