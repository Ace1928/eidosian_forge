...
- Path: `metadata_forge/src`

## What It Is

Managed directory documentation for `metadata_forge/src`, generated from tracked files and directory structure.
...
- [`metadata_forge`](./metadata_forge/README.md)
