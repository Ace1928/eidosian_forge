# `metadata_forge/tests/security`

<!-- EIDOS:DOCSYS:START -->
- Contract: `eidos.directory_doc.v1`
- Generated: `2026-03-13T00:19:24Z`
- Path: `metadata_forge/tests/security`

## What It Is

Managed directory documentation for `metadata_forge/tests/security`, generated from tracked files and directory structure.
