# `metadata_forge/eidosian_monorepo/scripts/utils`

<!-- EIDOS:DOCSYS:START -->
- Contract: `eidos.directory_doc.v1`
- Generated: `2026-03-13T00:19:23Z`
- Path: `metadata_forge/eidosian_monorepo/scripts/utils`

## What It Is

Managed directory documentation for `metadata_forge/eidosian_monorepo/scripts/utils`, generated from tracked files and directory structure.
...
- [`.gitkeep`](./.gitkeep)
- [`project_stats.py`](./project_stats.py)
...
- Parent README: [`metadata_forge/eidosian_monorepo/scripts/README.md`](../README.md)
