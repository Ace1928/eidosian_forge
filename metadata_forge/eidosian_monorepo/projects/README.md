# `metadata_forge/eidosian_monorepo/projects`

<!-- EIDOS:DOCSYS:START -->
- Contract: `eidos.directory_doc.v1`
- Generated: `2026-03-13T00:19:23Z`
- Path: `metadata_forge/eidosian_monorepo/projects`

## What It Is

Managed directory documentation for `metadata_forge/eidosian_monorepo/projects`, generated from tracked files and directory structure.
...
- Tracked files in scope: `48`
- Child directories: `5`
- Tests detected: `True`

## Contents

- [`['python', 'nodejs', 'go', 'rust']_project`](./['python', 'nodejs', 'go', 'rust']_project/README.md)
- [`go_project`](./go_project/README.md)
- [`nodejs_project`](./nodejs_project/README.md)
- [`python_project`](./python_project/README.md)
- [`rust_project`](./rust_project/README.md)
...
- Parent README: [`metadata_forge/eidosian_monorepo/README.md`](../README.md)
