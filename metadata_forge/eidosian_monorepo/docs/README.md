# `metadata_forge/eidosian_monorepo/docs`

<!-- EIDOS:DOCSYS:START -->
- Contract: `eidos.directory_doc.v1`
- Generated: `2026-03-13T00:19:22Z`
- Path: `metadata_forge/eidosian_monorepo/docs`

## What It Is

Managed directory documentation for `metadata_forge/eidosian_monorepo/docs`, generated from tracked files and directory structure.

## Why It Exists

This directory exists to hold the `docs` surface for `metadata_forge` and keep that responsibility separate from adjacent forge concerns.
