# `metadata_forge/eidosian_monorepo/docs/manual/python`

<!-- EIDOS:DOCSYS:START -->
- Contract: `eidos.directory_doc.v1`
- Generated: `2026-03-13T00:19:23Z`
- Path: `metadata_forge/eidosian_monorepo/docs/manual/python`

## What It Is

Managed directory documentation for `metadata_forge/eidosian_monorepo/docs/manual/python`, generated from tracked files and directory structure.
...
- Parent README: [`metadata_forge/eidosian_monorepo/docs/manual/README.md`](../README.md)
