# `metadata_forge/docs/manual/go/guides`

<!-- EIDOS:DOCSYS:START -->
- Contract: `eidos.directory_doc.v1`
- Generated: `2026-03-13T00:19:22Z`
- Path: `metadata_forge/docs/manual/go/guides`

## What It Is

Managed directory documentation for `metadata_forge/docs/manual/go/guides`, generated from tracked files and directory structure.
