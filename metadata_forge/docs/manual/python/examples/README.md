# `metadata_forge/docs/manual/python/examples`

<!-- EIDOS:DOCSYS:START -->
- Contract: `eidos.directory_doc.v1`
- Generated: `2026-03-13T00:19:22Z`
- Path: `metadata_forge/docs/manual/python/examples`

## What It Is

Managed directory documentation for `metadata_forge/docs/manual/python/examples`, generated from tracked files and directory structure.
...
- Parent README: [`metadata_forge/docs/manual/python/README.md`](../README.md)
