# `metadata_forge/templates`

<!-- EIDOS:DOCSYS:START -->
- Contract: `eidos.directory_doc.v1`
- Generated: `2026-03-13T00:19:24Z`
- Path: `metadata_forge/templates`

## What It Is

Managed directory documentation for `metadata_forge/templates`, generated from tracked files and directory structure.

## Why It Exists

This directory exists to hold the `templates` surface for `metadata_forge` and keep that responsibility separate from adjacent forge concerns.
