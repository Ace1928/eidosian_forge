...
- [x] ~~Add per-language parser adapters (tree-sitter path) for deeper non-Python fidelity.~~
...
- [x] ~~Add optional vector index backend for semantic retrieval experiments.~~
