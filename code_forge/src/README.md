...
Managed directory documentation for `code_forge/src`, generated from tracked files and directory structure.

## Why It Exists

This directory exists to hold the `src` surface for `code_forge` and keep that responsibility separate from adjacent forge concerns.
