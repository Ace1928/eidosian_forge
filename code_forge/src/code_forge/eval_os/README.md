# `code_forge/src/code_forge/eval_os`

<!-- EIDOS:DOCSYS:START -->
- Contract: `eidos.directory_doc.v1`
- Generated: `2026-03-13T00:19:21Z`
- Path: `code_forge/src/code_forge/eval_os`

## What It Is

Managed directory documentation for `code_forge/src/code_forge/eval_os`, generated from tracked files and directory structure.

## Why It Exists

This directory exists to hold the `forge` surface for `code_forge` and keep that responsibility separate from adjacent forge concerns.
...
- Python modules: `contracts, replay, runner, scoring, staleness, taskbank, tracing`
...
- Parent README: [`code_forge/src/code_forge/README.md`](../README.md)
- Forge README: [`code_forge/README.md`](../../../README.md)
