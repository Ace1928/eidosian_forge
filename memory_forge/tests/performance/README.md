# `memory_forge/tests/performance`

<!-- EIDOS:DOCSYS:START -->
- Contract: `eidos.directory_doc.v1`
- Generated: `2026-03-13T00:19:22Z`
- Path: `memory_forge/tests/performance`

## What It Is

Managed directory documentation for `memory_forge/tests/performance`, generated from tracked files and directory structure.
...
- Parent README: [`memory_forge/tests/README.md`](../README.md)
