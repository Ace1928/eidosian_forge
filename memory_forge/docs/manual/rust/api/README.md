# `memory_forge/docs/manual/rust/api`

<!-- EIDOS:DOCSYS:START -->
- Contract: `eidos.directory_doc.v1`
- Generated: `2026-03-13T00:19:22Z`
- Path: `memory_forge/docs/manual/rust/api`

## What It Is

Managed directory documentation for `memory_forge/docs/manual/rust/api`, generated from tracked files and directory structure.
