# `memory_forge/config/development`

<!-- EIDOS:DOCSYS:START -->
- Contract: `eidos.directory_doc.v1`
- Generated: `2026-03-13T00:19:22Z`
- Path: `memory_forge/config/development`

## What It Is

Managed directory documentation for `memory_forge/config/development`, generated from tracked files and directory structure.
...
- Parent README: [`memory_forge/config/README.md`](../README.md)
