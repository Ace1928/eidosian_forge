...
- Path: `memory_forge/config`

## What It Is

Managed directory documentation for `memory_forge/config`, generated from tracked files and directory structure.

## Why It Exists

This directory exists to hold the `config` surface for `memory_forge` and keep that responsibility separate from adjacent forge concerns.
