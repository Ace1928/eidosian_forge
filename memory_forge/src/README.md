...
- Path: `memory_forge/src`

## What It Is

Managed directory documentation for `memory_forge/src`, generated from tracked files and directory structure.

## Why It Exists

This directory exists to hold the `src` surface for `memory_forge` and keep that responsibility separate from adjacent forge concerns.
...
- [`memory_forge`](./memory_forge/README.md)
