...
class MemoryConfig(BaseModel):
    episodic: BackendConfig = Field(
        default_factory=lambda: BackendConfig(
            type="json", connection_string="./data/episodic_memory.json", collection_name="episodic"
        )
    )
    semantic: BackendConfig = Field(
        default_factory=lambda: BackendConfig(
            type="json", connection_string="./data/semantic_memory.json", collection_name="semantic"
        )
    )
