...
class MockLLMController(AbstractLLMController):
    ...
    def __init__(self) -> None:
        ...
        default_response = {
            ...
            "affected_units": [],
            "evolution_details": {"new_context": "", "new_keywords": [], "new_relationships": []},
        }
    ...
    def get_completion(self, prompt: str, response_format: dict = None, temperature: float = 0.7) -> str:
        ...
        # Track the call
        self.calls.append(
            {"prompt": prompt, "response_format": response_format, "temperature": temperature, "timestamp": time.time()}
        )
    ...
    def get_completion_stream(self, prompt: str, response_format: dict = None, temperature: float = 0.7) -> str:
        """
