# `narrative_forge/src/narrative_forge`

<!-- EIDOS:DOCSYS:START -->
- Contract: `eidos.directory_doc.v1`
- Generated: `2026-03-13T00:19:24Z`
- Path: `narrative_forge/src/narrative_forge`

## What It Is

Managed directory documentation for `narrative_forge/src/narrative_forge`, generated from tracked files and directory structure.

## Why It Exists

This directory exists to hold the `forge` surface for `narrative_forge` and keep that responsibility separate from adjacent forge concerns.
...
- Python modules: `cli, engine, memory`
...
- Parent README: [`narrative_forge/src/README.md`](../README.md)
- Forge README: [`narrative_forge/README.md`](../../README.md)
