...
- Path: `narrative_forge/src`

## What It Is

Managed directory documentation for `narrative_forge/src`, generated from tracked files and directory structure.

## Why It Exists

This directory exists to hold the `src` surface for `narrative_forge` and keep that responsibility separate from adjacent forge concerns.
...
- [`narrative_forge`](./narrative_forge/README.md)
