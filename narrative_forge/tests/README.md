# `narrative_forge/tests`

<!-- EIDOS:DOCSYS:START -->
- Contract: `eidos.directory_doc.v1`
- Generated: `2026-03-13T00:19:24Z`
- Path: `narrative_forge/tests`

## What It Is

Managed directory documentation for `narrative_forge/tests`, generated from tracked files and directory structure.

## Why It Exists

This directory exists to hold the `tests` surface for `narrative_forge` and keep that responsibility separate from adjacent forge concerns.
...
- Parent README: [`narrative_forge/README.md`](../README.md)
