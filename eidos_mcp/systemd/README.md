...
- Path: `eidos_mcp/systemd`

## What It Is

Managed directory documentation for `eidos_mcp/systemd`, generated from tracked files and directory structure.
...
- [`eidos-mcp.service`](./eidos-mcp.service)
