...
def mock_dependencies():
    with patch("subprocess.Popen") as mock_popen, patch("mcp.server.fastmcp.FastMCP") as mock_fastmcp:
...
def test_server_imports_and_initialization(mock_dependencies):
    ...
    from eidos_mcp.core import list_resource_metadata, list_tool_metadata
    ...
    expected_resources = ["eidos://config", "eidos://persona", "eidos://roadmap"]
