...
Managed directory documentation for `eidos_mcp/docs`, generated from tracked files and directory structure.

## Why It Exists

This directory exists to hold the `docs` surface for `eidos_mcp` and keep that responsibility separate from adjacent forge concerns.
...
- [`CHATMOCK_PLACEMENT_DECISION_2026-02-22.md`](./CHATMOCK_PLACEMENT_DECISION_2026-02-22.md)
...
- Parent README: [`eidos_mcp/README.md`](../README.md)
