# `eidos_mcp/src/eidos_mcp/config`

<!-- EIDOS:DOCSYS:START -->
- Contract: `eidos.directory_doc.v1`
- Generated: `2026-03-13T00:19:21Z`
- Path: `eidos_mcp/src/eidos_mcp/config`

## What It Is

Managed directory documentation for `eidos_mcp/src/eidos_mcp/config`, generated from tracked files and directory structure.

## Why It Exists

This directory exists to hold the `config` surface for `eidos_mcp` and keep that responsibility separate from adjacent forge concerns.
