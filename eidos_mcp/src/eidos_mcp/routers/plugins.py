...
from ..plugins import (
    get_loader, init_plugins, list_plugins, list_tools,
    get_tool, call_tool, PluginInfo, ToolInfo
)
...
@tool(
    ...
    parameters={
        ...
        "properties": {
            "include_tools": {
                "type": "boolean",
                "description": "Include list of tools for each plugin"
            }
        },
        "required": []
    }
...
@tool(
    ...
    parameters={
        ...
        "properties": {
            ...
            "filter_plugin": {
                "type": "string",
                "description": "Filter tools by plugin ID"
            }
        },
        "required": []
    }
...
@tool(
    description="Discover and load any new plugins.",
    parameters={"type": "object", "properties": {}, "required": []}
)
@eidosian()
def plugin_discover() -> str:
    ...
    return json.dumps({
        ...
        "loaded": [
            {"id": p.id, "name": p.name, "tools": len(p.tools)}
