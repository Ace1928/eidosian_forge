...
@tool(
    ...
    parameters={
        ...
        "properties": {
            ...
            "definition": {
                "type": "string",
                "description": "Definition or meaning of the term"
            },
            "pos": {
                "type": "string",
...
@tool(
    ...
    parameters={
        ...
        "properties": {
            "term": {
                "type": "string",
                "description": "The term to find relations for"
            },
            "relation_type": {
                "type": "string",
...
@tool(
    ...
    parameters={
        ...
        "properties": {
            "term1": {
                "type": "string",
                "description": "Starting term"
            },
            "term2": {
                "type": "string",
                "description": "Ending term"
            },
        },
...
@tool(
    ...
    parameters={
        ...
        "properties": {
            "text": {
                "type": "string",
                "description": "Text to analyze and build graph from"
            },
            "min_word_length": {
                "type": "integer",
                "description": "Minimum word length to include (default: 4)"
            },
        },
        "required": ["text"],
    },
