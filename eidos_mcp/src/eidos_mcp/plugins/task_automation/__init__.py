...
PLUGIN_MANIFEST = {
    ...
    "author": "Eidos",
    "tools": ["task_queue_add", "task_queue_list", "task_queue_status", "task_execute", "task_schedule", "task_cancel"],
}
...
@eidosian()
def task_queue_add(
    command: str, description: str = "", priority: int = 5, timeout: int = 300, working_dir: Optional[str] = None
) -> str:
    """
...
@eidosian()
def task_queue_list(status: Optional[str] = None, limit: int = 50) -> str:
    """
...
@eidosian()
def task_schedule(command: str, delay_seconds: int, description: str = "", repeat: bool = False) -> str:
    """
