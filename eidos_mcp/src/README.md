...
Managed directory documentation for `eidos_mcp/src`, generated from tracked files and directory structure.

## Why It Exists

This directory exists to hold the `src` surface for `eidos_mcp` and keep that responsibility separate from adjacent forge concerns.
