# `viz_forge/.github/workflows`

<!-- EIDOS:DOCSYS:START -->
- Contract: `eidos.directory_doc.v1`
- Generated: `2026-03-13T00:19:31Z`
- Path: `viz_forge/.github/workflows`

## What It Is

Managed directory documentation for `viz_forge/.github/workflows`, generated from tracked files and directory structure.

## Why It Exists

This directory exists to hold the `forge` surface for `viz_forge` and keep that responsibility separate from adjacent forge concerns.
...
- Parent README: [`viz_forge/.github/README.md`](../README.md)
