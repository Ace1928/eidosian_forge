# `terminal_forge/src/terminal_forge`

<!-- EIDOS:DOCSYS:START -->
- Contract: `eidos.directory_doc.v1`
- Generated: `2026-03-13T00:19:30Z`
- Path: `terminal_forge/src/terminal_forge`

## What It Is

Managed directory documentation for `terminal_forge/src/terminal_forge`, generated from tracked files and directory structure.
...
- Python modules: `ascii_art, banner, borders, cli, colors, effects, layout, rich_theme, themes, utils`

## Contents

- [`ascii_art`](./ascii_art/README.md)

## Prominent Files

- [`__init__.py`](./__init__.py)
- [`ascii_art.py`](./ascii_art.py)
- [`banner.py`](./banner.py)
- [`borders.py`](./borders.py)
- [`cli.py`](./cli.py)
- [`colors.py`](./colors.py)
- [`effects.py`](./effects.py)
- [`layout.py`](./layout.py)
...
- Parent README: [`terminal_forge/src/README.md`](../README.md)
