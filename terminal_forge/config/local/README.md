# `terminal_forge/config/local`

<!-- EIDOS:DOCSYS:START -->
- Contract: `eidos.directory_doc.v1`
- Generated: `2026-03-13T00:19:25Z`
- Path: `terminal_forge/config/local`

## What It Is

Managed directory documentation for `terminal_forge/config/local`, generated from tracked files and directory structure.
