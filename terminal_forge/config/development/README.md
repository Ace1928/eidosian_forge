# `terminal_forge/config/development`

<!-- EIDOS:DOCSYS:START -->
- Contract: `eidos.directory_doc.v1`
- Generated: `2026-03-13T00:19:25Z`
- Path: `terminal_forge/config/development`

## What It Is

Managed directory documentation for `terminal_forge/config/development`, generated from tracked files and directory structure.
...
- Parent README: [`terminal_forge/config/README.md`](../README.md)
