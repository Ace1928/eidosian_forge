# `terminal_forge/docs/manual/javascript/api`

<!-- EIDOS:DOCSYS:START -->
- Contract: `eidos.directory_doc.v1`
- Generated: `2026-03-13T00:19:26Z`
- Path: `terminal_forge/docs/manual/javascript/api`

## What It Is

Managed directory documentation for `terminal_forge/docs/manual/javascript/api`, generated from tracked files and directory structure.
