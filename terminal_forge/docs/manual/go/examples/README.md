# `terminal_forge/docs/manual/go/examples`

<!-- EIDOS:DOCSYS:START -->
- Contract: `eidos.directory_doc.v1`
- Generated: `2026-03-13T00:19:26Z`
- Path: `terminal_forge/docs/manual/go/examples`

## What It Is

Managed directory documentation for `terminal_forge/docs/manual/go/examples`, generated from tracked files and directory structure.
