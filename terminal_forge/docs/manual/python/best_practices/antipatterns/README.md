# `terminal_forge/docs/manual/python/best_practices/antipatterns`

<!-- EIDOS:DOCSYS:START -->
- Contract: `eidos.directory_doc.v1`
- Generated: `2026-03-13T00:19:27Z`
- Path: `terminal_forge/docs/manual/python/best_practices/antipatterns`

## What It Is

Managed directory documentation for `terminal_forge/docs/manual/python/best_practices/antipatterns`, generated from tracked files and directory structure.
...
- Parent README: [`terminal_forge/docs/manual/python/best_practices/README.md`](../README.md)
