# `terminal_forge/docs/manual/python/guides`

<!-- EIDOS:DOCSYS:START -->
- Contract: `eidos.directory_doc.v1`
- Generated: `2026-03-13T00:19:27Z`
- Path: `terminal_forge/docs/manual/python/guides`

## What It Is

Managed directory documentation for `terminal_forge/docs/manual/python/guides`, generated from tracked files and directory structure.
