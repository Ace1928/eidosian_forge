# `terminal_forge/docs/examples/complete_projects`

<!-- EIDOS:DOCSYS:START -->
- Contract: `eidos.directory_doc.v1`
- Generated: `2026-03-13T00:19:26Z`
- Path: `terminal_forge/docs/examples/complete_projects`

## What It Is

Managed directory documentation for `terminal_forge/docs/examples/complete_projects`, generated from tracked files and directory structure.
...
- [`status_display`](./status_display/README.md)
...
- Parent README: [`terminal_forge/docs/examples/README.md`](../README.md)
