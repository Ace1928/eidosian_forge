# `terminal_forge/docs/tools/generators`

<!-- EIDOS:DOCSYS:START -->
- Contract: `eidos.directory_doc.v1`
- Generated: `2026-03-13T00:19:27Z`
- Path: `terminal_forge/docs/tools/generators`

## What It Is

Managed directory documentation for `terminal_forge/docs/tools/generators`, generated from tracked files and directory structure.
...
- Python modules: `api_docs, ascii_preview, theme_catalog`
...
- [`api_docs.py`](./api_docs.py)
- [`ascii_preview.py`](./ascii_preview.py)
- [`theme_catalog.py`](./theme_catalog.py)
...
- Parent README: [`terminal_forge/docs/tools/README.md`](../README.md)
