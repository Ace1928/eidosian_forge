# `terminal_forge/docs/ai/examples`

<!-- EIDOS:DOCSYS:START -->
- Contract: `eidos.directory_doc.v1`
- Generated: `2026-03-13T00:19:25Z`
- Path: `terminal_forge/docs/ai/examples`

## What It Is

Managed directory documentation for `terminal_forge/docs/ai/examples`, generated from tracked files and directory structure.
