# `terminal_forge/eidosian_monorepo/config/local`

<!-- EIDOS:DOCSYS:START -->
- Contract: `eidos.directory_doc.v1`
- Generated: `2026-03-13T00:19:27Z`
- Path: `terminal_forge/eidosian_monorepo/config/local`

## What It Is

Managed directory documentation for `terminal_forge/eidosian_monorepo/config/local`, generated from tracked files and directory structure.
