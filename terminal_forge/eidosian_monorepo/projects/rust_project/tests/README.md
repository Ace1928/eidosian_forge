# `terminal_forge/eidosian_monorepo/projects/rust_project/tests`

<!-- EIDOS:DOCSYS:START -->
- Contract: `eidos.directory_doc.v1`
- Generated: `2026-03-13T00:19:29Z`
- Path: `terminal_forge/eidosian_monorepo/projects/rust_project/tests`

## What It Is

Managed directory documentation for `terminal_forge/eidosian_monorepo/projects/rust_project/tests`, generated from tracked files and directory structure.

## Why It Exists

This directory exists to hold the `tests` surface for `terminal_forge` and keep that responsibility separate from adjacent forge concerns.
...
- Parent README: [`terminal_forge/eidosian_monorepo/projects/rust_project/README.md`](../README.md)
