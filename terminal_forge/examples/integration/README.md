# `terminal_forge/examples/integration`

<!-- EIDOS:DOCSYS:START -->
- Contract: `eidos.directory_doc.v1`
- Generated: `2026-03-13T00:19:29Z`
- Path: `terminal_forge/examples/integration`

## What It Is

Managed directory documentation for `terminal_forge/examples/integration`, generated from tracked files and directory structure.
...
- Python modules: `api_consumption, data_visualization, real_time`
...
- [`api_consumption.py`](./api_consumption.py)
