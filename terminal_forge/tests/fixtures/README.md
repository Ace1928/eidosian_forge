# `terminal_forge/tests/fixtures`

<!-- EIDOS:DOCSYS:START -->
- Contract: `eidos.directory_doc.v1`
- Generated: `2026-03-13T00:19:30Z`
- Path: `terminal_forge/tests/fixtures`

## What It Is

Managed directory documentation for `terminal_forge/tests/fixtures`, generated from tracked files and directory structure.
...
- Child directories: `0`
- Tests detected: `True`
- Python modules: `color_schemes, mock_terminal, sample_layouts`
...
- [`color_schemes.py`](./color_schemes.py)
- [`mock_terminal.py`](./mock_terminal.py)
- [`sample_layouts.py`](./sample_layouts.py)
