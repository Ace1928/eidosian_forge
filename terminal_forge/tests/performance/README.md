# `terminal_forge/tests/performance`

<!-- EIDOS:DOCSYS:START -->
- Contract: `eidos.directory_doc.v1`
- Generated: `2026-03-13T00:19:30Z`
- Path: `terminal_forge/tests/performance`

## What It Is

Managed directory documentation for `terminal_forge/tests/performance`, generated from tracked files and directory structure.
...
- Child directories: `0`
- Tests detected: `True`
- Python modules: `test_memory_usage, test_rendering_speed, test_terminal_io`
...
- [`test_memory_usage.py`](./test_memory_usage.py)
- [`test_rendering_speed.py`](./test_rendering_speed.py)
- [`test_terminal_io.py`](./test_terminal_io.py)
...
- Parent README: [`terminal_forge/tests/README.md`](../README.md)
