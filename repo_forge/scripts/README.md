...
- Path: `repo_forge/scripts`

## What It Is

Managed directory documentation for `repo_forge/scripts`, generated from tracked files and directory structure.

## Why It Exists

This directory exists to hold the `scripts` surface for `repo_forge` and keep that responsibility separate from adjacent forge concerns.
