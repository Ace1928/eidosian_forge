...
Managed directory documentation for `repo_forge/src`, generated from tracked files and directory structure.

## Why It Exists

This directory exists to hold the `src` surface for `repo_forge` and keep that responsibility separate from adjacent forge concerns.
...
- [`repo_forge`](./repo_forge/README.md)
