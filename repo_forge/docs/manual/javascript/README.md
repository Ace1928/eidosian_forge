# `repo_forge/docs/manual/javascript`

<!-- EIDOS:DOCSYS:START -->
- Contract: `eidos.directory_doc.v1`
- Generated: `2026-03-13T00:19:25Z`
- Path: `repo_forge/docs/manual/javascript`

## What It Is

Managed directory documentation for `repo_forge/docs/manual/javascript`, generated from tracked files and directory structure.

## Why It Exists

This directory exists to hold the `forge` surface for `repo_forge` and keep that responsibility separate from adjacent forge concerns.
...
- Parent README: [`repo_forge/docs/manual/README.md`](../README.md)
- Forge README: [`repo_forge/README.md`](../../../README.md)
