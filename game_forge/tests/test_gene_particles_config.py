...
def test_simulation_config_all_validation_branches():
    invalid_cases = [
        ...
        ("force_registry_family_scale", {}),
        ("force_registry_softening", 0.0),
        ("force_registry_yukawa_decay", 0.0),
        ("force_registry_lj_sigma", 0.0),
        ("force_registry_morse_r0", 0.0),
        ("force_registry_morse_width", 0.0),
        ("use_morton_ordering", "yes"),
        ("morton_min_particles", 0),
        ("morton_cell_scale", 0.0),
