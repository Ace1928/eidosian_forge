...
python game_forge/tools/run.py benchmark-suite -- --preset quick --summary game_forge/tools/artifacts/benchmark_suite_summary.json --policy-manifest game_forge/tools/policy_manifest.json
