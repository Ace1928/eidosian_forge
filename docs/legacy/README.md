...
Managed directory documentation for `docs/legacy`, generated from tracked files and directory structure.
...
- Tracked files in scope: `109`
- Child directories: `2`
- Tests detected: `False`

## Contents

- [`aurora_archive`](./aurora_archive/README.md)
- [`aurora_chat_logs`](./aurora_chat_logs/README.md)
