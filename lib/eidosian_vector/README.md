...
- Path: `lib/eidosian_vector`

## What It Is

Managed directory documentation for `lib/eidosian_vector`, generated from tracked files and directory structure.
...
- Python modules: `embedders, hnsw_store`
