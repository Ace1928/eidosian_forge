...
Managed directory documentation for `lib/tom-select`, generated from tracked files and directory structure.

## Why It Exists

This directory exists to hold the `library` surface for `lib` and keep that responsibility separate from adjacent forge concerns.
...
- [`tom-select.complete.min.js`](./tom-select.complete.min.js)
- [`tom-select.css`](./tom-select.css)
