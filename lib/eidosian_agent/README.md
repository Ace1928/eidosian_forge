...
- Path: `lib/eidosian_agent`

## What It Is

Managed directory documentation for `lib/eidosian_agent`, generated from tracked files and directory structure.
...
- Python modules: `local_mcp_agent`
...
- [`local_mcp_agent.py`](./local_mcp_agent.py)
