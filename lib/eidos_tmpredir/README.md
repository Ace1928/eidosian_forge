...
- Path: `lib/eidos_tmpredir`

## What It Is

Managed directory documentation for `lib/eidos_tmpredir`, generated from tracked files and directory structure.
