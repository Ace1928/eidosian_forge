...
Managed directory documentation for `lib/cli`, generated from tracked files and directory structure.

## Why It Exists

This directory exists to hold the `cli` surface for `lib` and keep that responsibility separate from adjacent forge concerns.
