...
- Path: `shell/templates`

## What It Is

Managed directory documentation for `shell/templates`, generated from tracked files and directory structure.

## Why It Exists

This directory exists to hold the `templates` surface for `shell` and keep that responsibility separate from adjacent forge concerns.
