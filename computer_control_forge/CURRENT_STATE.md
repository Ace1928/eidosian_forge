...
The Computer Control Forge provides **safe, auditable keyboard/mouse control and screen capture** for Eidosian agents. It's the physical interface layer that allows EIDOS to interact with the desktop environment.
