# `computer_control_forge/screenshots`

<!-- EIDOS:DOCSYS:START -->
- Contract: `eidos.directory_doc.v1`
- Generated: `2026-03-13T00:19:21Z`
- Path: `computer_control_forge/screenshots`

## What It Is

Managed directory documentation for `computer_control_forge/screenshots`, generated from tracked files and directory structure.
...
- [`test_capture.png`](./test_capture.png)
- [`visual_test_after.png`](./visual_test_after.png)
