...
- Generated: `2026-03-13T06:21:49Z`
- Repo root: `/data/data/com.termux/files/home/eidosian_forge`
- Git head: `0580243b594ec70657c0e29945e8a4953a56f780`
- Worktree dirty: `None`
- Overall status: `yellow`
- Overall score: `0.69214`

## Categories

| Category | Status | Score |
| --- | --- | ---: |
| external_validity | green | 0.965342 |
...
- `external_validity`: Only imported reference external benchmark baselines are present; no Eidos-run local or remote external suite artifact exists yet.
