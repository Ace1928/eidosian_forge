...
| observability | green | 0.8 |
| operational_reproducibility | yellow | 0.6875 |
| adversarial_robustness | red | 0.15 |

## Top Gaps

- `regression`: Overall proof score regressed by `-0.016536` versus `/data/data/com.termux/files/home/eidosian_forge/reports/proof/entity_proof_scorecard_20260320_065106.json`.
