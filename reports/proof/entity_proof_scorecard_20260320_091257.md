...
- `observability`: No qwenchat runtime status artifact found.
- `observability`: No living pipeline status artifact found.
- `observability`: No qwenchat history ledger found.
- `observability`: No living pipeline history ledger found.
...
- `qwenchat_status`: `None`
- `qwenchat_phase`: `None`
- `living_pipeline_status`: `None`
- `living_pipeline_phase`: `None`
...
- `last_sync_at`: `2026-03-20T07:36:01.914867+00:00`
- `recent_sessions`: `6`
- `imported_records`: `35`
- `codex_records`: `24`
- `gemini_records`: `11`
