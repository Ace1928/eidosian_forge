...
class RequestMethodInjectionTests(MethodInjectionTestsMixin, SynchronousTestCase):
    """
    ...
    def attemptRequestWithMaliciousMethod(self, method):
        ...
        """
        client.Request(method=method, uri=b'http://twisted.invalid', headers=http_headers.Headers(), bodyProducer=None)