...
class BaseLinearRegressorPartitionerTest(object):
    ...
    def testPartitioner(self):
        ...
        regressor = self._linear_regressor_fn(feature_columns=(self._fc_lib.categorical_column_with_hash_bucket('language', hash_bucket_size=x_dim),), partitioner=_partitioner, model_dir=self._model_dir)
