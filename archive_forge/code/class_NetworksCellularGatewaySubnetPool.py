...
class NetworksCellularGatewaySubnetPool(object):
    ...
    def __init__(self, params, meraki):
        self.meraki = meraki
        self.new_object = dict(mask=params.get('mask'), cidr=params.get('cidr'), network_id=params.get('networkId'))
    ...
    def get_object_by_name(self, name):
        result = None
        try:
            items = self.meraki.exec_meraki(family='cellulargateway', function='getNetworkCellularGatewaySubnetPool', params=self.get_all_params(name=name))
    ...
    def requires_update(self, current_obj):
        ...
        obj_params = [('mask', 'mask'), ('cidr', 'cidr'), ('networkId', 'networkId')]
    ...
    def update(self):
        ...
        name = self.new_object.get('name')
        result = None
        result = self.meraki.exec_meraki(family='cellulargateway', function='updateNetworkCellularGatewaySubnetPool', params=self.update_all_params(), op_modifies=True)
        return result