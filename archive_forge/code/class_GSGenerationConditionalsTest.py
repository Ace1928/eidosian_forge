...
class GSGenerationConditionalsTest(GSTestCase):
    ...
    def testBucketConditionalSetAcl(self):
        ...
        with self.assertRaisesRegexp(ValueError, 'Received if_metageneration argument with no if_generation argument'):
            b.set_acl('bucket-owner-full-control', key_name='foo', if_metageneration=123)
        with self.assertRaisesRegexp(GSResponseError, VERSION_MISMATCH):
            b.set_acl('bucket-owner-full-control', key_name='foo', if_generation=int(g2) + 1)
        with self.assertRaisesRegexp(GSResponseError, VERSION_MISMATCH):
            b.set_acl('bucket-owner-full-control', key_name='foo', if_generation=g2, if_metageneration=int(mg2) + 1)
        ...
        b.set_acl('public-read', key_name='foo', if_generation=g3, if_metageneration=mg3)
    ...
    def testBucketConditionalSetCannedAcl(self):
        ...
        self.assertGreater(mg2, mg1)
        with self.assertRaisesRegexp(ValueError, 'Received if_metageneration argument with no if_generation argument'):
            b.set_canned_acl('bucket-owner-full-control', key_name='foo', if_metageneration=123)
        with self.assertRaisesRegexp(GSResponseError, VERSION_MISMATCH):
            b.set_canned_acl('bucket-owner-full-control', key_name='foo', if_generation=int(g2) + 1)
        with self.assertRaisesRegexp(GSResponseError, VERSION_MISMATCH):
            b.set_canned_acl('bucket-owner-full-control', key_name='foo', if_generation=g2, if_metageneration=int(mg2) + 1)
        ...
        self.assertEqual(g3, g2)
        self.assertGreater(mg3, mg2)
        b.set_canned_acl('public-read', key_name='foo', if_generation=g3, if_metageneration=mg3)
    ...
    def testObjectConditionalSetAcl(self):
        ...
        with self.assertRaisesRegexp(GSResponseError, VERSION_MISMATCH):
            k.set_acl('bucket-owner-full-control', if_generation=g2, if_metageneration=int(mg2) + 1)
    ...
    def testObjectConditionalSetCannedAcl(self):
        ...
        with self.assertRaisesRegexp(GSResponseError, VERSION_MISMATCH):
            k.set_canned_acl('bucket-owner-full-control', if_generation=g2, if_metageneration=int(mg2) + 1)
