...
import six
def ImportResource(resource, kind=None, is_async=False, details=None, failed=None):
  ...
  """
    _PrintResourceChange('import', resource, kind, is_async, details, failed, operation_past_tense='imported')