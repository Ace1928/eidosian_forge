...
class ArceeRetriever(BaseRetriever):
    ...
    def __init__(self, **data: Any) -> None:
        ...
        super().__init__(**data)
        self._client = ArceeWrapper(arcee_api_key=self.arcee_api_key.get_secret_value(), arcee_api_url=self.arcee_api_url, arcee_api_version=self.arcee_api_version, model_kwargs=self.model_kwargs, model_name=self.model)
