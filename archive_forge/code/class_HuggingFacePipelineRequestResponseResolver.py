...
class HuggingFacePipelineRequestResponseResolver:
    ...
    def __call__(self, args: Sequence[Any], kwargs: Dict[str, Any], response: Response, start_time: float, time_elapsed: float) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            if task in SUPPORTED_PIPELINE_TASKS or task.startswith('translation'):
                ...
                return {table_name: wandb.Table(columns=packed_data[0], data=packed_data[1:])}
    ...
    def _format_data(self, task: str, input_data: Union[List[Any], Any], response: Union[List[Any], Any], kwargs: Dict[str, Any]) -> List[Dict[str, Any]]:
