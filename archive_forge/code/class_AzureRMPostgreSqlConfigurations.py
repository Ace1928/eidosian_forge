...
class AzureRMPostgreSqlConfigurations(AzureRMModuleBase):
    ...
    def __init__(self):
        ...
        super(AzureRMPostgreSqlConfigurations, self).__init__(derived_arg_spec=self.module_arg_spec, supports_check_mode=True, supports_tags=False)
    ...
    def create_update_configuration(self):
        ...
        try:
            response = self.postgresql_client.configurations.begin_create_or_update(resource_group_name=self.resource_group, server_name=self.server_name, configuration_name=self.name, parameters=self.value, source='user-override')
    ...
    def delete_configuration(self):
        ...
        try:
            response = self.postgresql_client.configurations.begin_create_or_update(resource_group_name=self.resource_group, server_name=self.server_name, configuration_name=self.name, source='system-default')
