...
class MulticlassCalibrationError(Metric):
    ...
    def __init__(self, num_classes: int, n_bins: int=15, norm: Literal['l1', 'l2', 'max']='l1', ignore_index: Optional[int]=None, validate_args: bool=True, **kwargs: Any) -> None:
    ...
    def update(self, preds: Tensor, target: Tensor) -> None:
        ...
        preds, target = _multiclass_confusion_matrix_format(preds, target, ignore_index=self.ignore_index, convert_to_labels=False)
