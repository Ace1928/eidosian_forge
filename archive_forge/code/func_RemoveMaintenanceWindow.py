...
def RemoveMaintenanceWindow(self, cluster_ref, existing_policy):
    ...
    if existing_policy is None or existing_policy.window is None or (existing_policy.window.dailyMaintenanceWindow is None and existing_policy.window.recurringWindow is None):
