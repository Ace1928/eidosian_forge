...
class OrganizationsApplianceVpnVpnFirewallRules(object):
    ...
    def __init__(self, params, meraki):
        self.meraki = meraki
        self.new_object = dict(rules=params.get('rules'), syslogDefaultRule=params.get('syslogDefaultRule'), organization_id=params.get('organizationId'))
    ...
    def get_object_by_name(self, name):
        result = None
        try:
            items = self.meraki.exec_meraki(family='appliance', function='getOrganizationApplianceVpnVpnFirewallRules', params=self.get_all_params(name=name))
    ...
    def requires_update(self, current_obj):
        ...
        obj_params = [('rules', 'rules'), ('syslogDefaultRule', 'syslogDefaultRule'), ('organizationId', 'organizationId')]
    ...
    def update(self):
        ...
        name = self.new_object.get('name')
        result = None
        result = self.meraki.exec_meraki(family='appliance', function='updateOrganizationApplianceVpnVpnFirewallRules', params=self.update_all_params(), op_modifies=True)
        return result