...
def AddListInstancesOutputFormat(parser, release_track=base.ReleaseTrack.GA):
    parser.display_info.AddTransforms({'preservedState': _TransformPreservedState})
    parser.display_info.AddFormat(_RELEASE_TRACK_TO_LIST_INSTANCES_FORMAT[release_track])