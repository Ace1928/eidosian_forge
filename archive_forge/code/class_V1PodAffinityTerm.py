...
class V1PodAffinityTerm(object):
    ...
    swagger_types = {'label_selector': 'V1LabelSelector', 'namespaces': 'list[str]', 'topology_key': 'str'}
    attribute_map = {'label_selector': 'labelSelector', 'namespaces': 'namespaces', 'topology_key': 'topologyKey'}
