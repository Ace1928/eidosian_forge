...
def export_default_values_opset18() -> None:
    ...
    node = onnx.helper.make_node('Split', inputs=['input'], outputs=['output_1', 'output_2', 'output_3'], num_outputs=3)
    ...
    expect(node, inputs=[node_input], outputs=expected_outputs, name='test_split_equal_parts_default_axis_opset18')
    ...
    expect(node, inputs=[node_input, split], outputs=expected_outputs, name='test_split_variable_parts_default_axis_opset18')