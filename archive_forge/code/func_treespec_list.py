...
def treespec_list(iterable: Iterable[PyTreeSpec]=(), *, none_is_leaf: bool=False, namespace: str='') -> PyTreeSpec:
    ...
    """
    return _C.make_from_collection(list(iterable), none_is_leaf, namespace)