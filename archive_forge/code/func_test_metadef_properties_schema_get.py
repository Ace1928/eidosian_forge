...
def test_metadef_properties_schema_get(self):
    self._verify('openstack.proxy.Proxy._get', self.proxy.get_metadef_properties_schema, expected_args=[_metadef_schema.MetadefSchema], expected_kwargs={'base_path': '/schemas/metadefs/properties', 'requires_id': False})