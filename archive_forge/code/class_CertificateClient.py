...
class CertificateClient(object):
    ...
    def Create(self, parent_ref, cert_id, self_managed_cert_data=None, description='', labels=None):
    ...
    """
        req = self.messages.CertificatemanagerProjectsLocationsCertificatesCreateRequest(parent=parent_ref.RelativeName(), certificateId=cert_id, certificate=self.messages.Certificate(labels=labels, description=description, selfManagedCertData=self_managed_cert_data))
    ...
    """
        get_req = self.messages.CertificatemanagerProjectsLocationsCertificatesGetRequest(name=cert_ref.RelativeName())
    ...
    """
        list_req = self.messages.CertificatemanagerProjectsLocationsCertificatesListRequest(parent=parent_ref.RelativeName(), filter=list_filter, orderBy=order_by)
        return list_pager.YieldFromList(self._service, list_req, batch_size=page_size, limit=limit, current_token_attribute='pageToken', next_token_attribute='nextPageToken', field='certificates', batch_size_attribute='pageSize')
    ...
    """
        delete_req = self.messages.CertificatemanagerProjectsLocationsCertificatesDeleteRequest(name=cert_ref.RelativeName())
        return self._service.Delete(delete_req)

    def Patch(self, cert_ref, self_managed_cert_data=None, labels=None, description=None):
    ...
    """
        ...
        patch_req = self.messages.CertificatemanagerProjectsLocationsCertificatesPatchRequest(certificate=certificate, name=cert_ref.RelativeName(), updateMask=update_mask)
