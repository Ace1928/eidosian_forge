...
class NetworksWirelessSsids(object):
    ...
    def update_by_id_params(self):
        ...
        if self.new_object.get('authMode') is not None or self.new_object.get('auth_mode') is not None:
            new_object_params['authMode'] = self.new_object.get('authMode') or self.new_object.get('auth_mode')
        if self.new_object.get('enterpriseAdminAccess') is not None or self.new_object.get('enterprise_admin_access') is not None:
            new_object_params['enterpriseAdminAccess'] = self.new_object.get('enterpriseAdminAccess') or self.new_object.get('enterprise_admin_access')
        if self.new_object.get('encryptionMode') is not None or self.new_object.get('encryption_mode') is not None:
            new_object_params['encryptionMode'] = self.new_object.get('encryptionMode') or self.new_object.get('encryption_mode')
        if self.new_object.get('psk') is not None or self.new_object.get('psk') is not None:
            new_object_params['psk'] = self.new_object.get('psk') or self.new_object.get('psk')
        if self.new_object.get('wpaEncryptionMode') is not None or self.new_object.get('wpa_encryption_mode') is not None:
            new_object_params['wpaEncryptionMode'] = self.new_object.get('wpaEncryptionMode') or self.new_object.get('wpa_encryption_mode')
        if self.new_object.get('dot11w') is not None or self.new_object.get('dot11w') is not None:
            new_object_params['dot11w'] = self.new_object.get('dot11w') or self.new_object.get('dot11w')
        if self.new_object.get('dot11r') is not None or self.new_object.get('dot11r') is not None:
            new_object_params['dot11r'] = self.new_object.get('dot11r') or self.new_object.get('dot11r')
        if self.new_object.get('splashPage') is not None or self.new_object.get('splash_page') is not None:
            new_object_params['splashPage'] = self.new_object.get('splashPage') or self.new_object.get('splash_page')
        if self.new_object.get('splashGuestSponsorDomains') is not None or self.new_object.get('splash_guest_sponsor_domains') is not None:
            new_object_params['splashGuestSponsorDomains'] = self.new_object.get('splashGuestSponsorDomains') or self.new_object.get('splash_guest_sponsor_domains')
        if self.new_object.get('oauth') is not None or self.new_object.get('oauth') is not None:
            new_object_params['oauth'] = self.new_object.get('oauth') or self.new_object.get('oauth')
        if self.new_object.get('localRadius') is not None or self.new_object.get('local_radius') is not None:
            new_object_params['localRadius'] = self.new_object.get('localRadius') or self.new_object.get('local_radius')
        if self.new_object.get('ldap') is not None or self.new_object.get('ldap') is not None:
            new_object_params['ldap'] = self.new_object.get('ldap') or self.new_object.get('ldap')
        if self.new_object.get('activeDirectory') is not None or self.new_object.get('active_directory') is not None:
            new_object_params['activeDirectory'] = self.new_object.get('activeDirectory') or self.new_object.get('active_directory')
        ...
        if self.new_object.get('radiusCalledStationId') is not None or self.new_object.get('radius_called_station_id') is not None:
            new_object_params['radiusCalledStationId'] = self.new_object.get('radiusCalledStationId') or self.new_object.get('radius_called_station_id')
        if self.new_object.get('radiusAuthenticationNasId') is not None or self.new_object.get('radius_authentication_nas_id') is not None:
            new_object_params['radiusAuthenticationNasId'] = self.new_object.get('radiusAuthenticationNasId') or self.new_object.get('radius_authentication_nas_id')
        if self.new_object.get('radiusServerTimeout') is not None or self.new_object.get('radius_server_timeout') is not None:
            new_object_params['radiusServerTimeout'] = self.new_object.get('radiusServerTimeout') or self.new_object.get('radius_server_timeout')
        if self.new_object.get('radiusServerAttemptsLimit') is not None or self.new_object.get('radius_server_attempts_limit') is not None:
            new_object_params['radiusServerAttemptsLimit'] = self.new_object.get('radiusServerAttemptsLimit') or self.new_object.get('radius_server_attempts_limit')
        ...
        if self.new_object.get('radiusFailoverPolicy') is not None or self.new_object.get('radius_failover_policy') is not None:
            new_object_params['radiusFailoverPolicy'] = self.new_object.get('radiusFailoverPolicy') or self.new_object.get('radius_failover_policy')
        if self.new_object.get('radiusLoadBalancingPolicy') is not None or self.new_object.get('radius_load_balancing_policy') is not None:
            new_object_params['radiusLoadBalancingPolicy'] = self.new_object.get('radiusLoadBalancingPolicy') or self.new_object.get('radius_load_balancing_policy')
        ...
        if self.new_object.get('radiusAccountingInterimInterval') is not None or self.new_object.get('radius_accounting_interim_interval') is not None:
            new_object_params['radiusAccountingInterimInterval'] = self.new_object.get('radiusAccountingInterimInterval') or self.new_object.get('radius_accounting_interim_interval')
        if self.new_object.get('radiusAttributeForGroupPolicies') is not None or self.new_object.get('radius_attribute_for_group_policies') is not None:
            new_object_params['radiusAttributeForGroupPolicies'] = self.new_object.get('radiusAttributeForGroupPolicies') or self.new_object.get('radius_attribute_for_group_policies')
        if self.new_object.get('ipAssignmentMode') is not None or self.new_object.get('ip_assignment_mode') is not None:
            new_object_params['ipAssignmentMode'] = self.new_object.get('ipAssignmentMode') or self.new_object.get('ip_assignment_mode')
        ...
        if self.new_object.get('concentratorNetworkId') is not None or self.new_object.get('concentrator_network_id') is not None:
            new_object_params['concentratorNetworkId'] = self.new_object.get('concentratorNetworkId') or self.new_object.get('concentrator_network_id')
        if self.new_object.get('secondaryConcentratorNetworkId') is not None or self.new_object.get('secondary_concentrator_network_id') is not None:
            new_object_params['secondaryConcentratorNetworkId'] = self.new_object.get('secondaryConcentratorNetworkId') or self.new_object.get('secondary_concentrator_network_id')
        ...
        if self.new_object.get('defaultVlanId') is not None or self.new_object.get('default_vlan_id') is not None:
            new_object_params['defaultVlanId'] = self.new_object.get('defaultVlanId') or self.new_object.get('default_vlan_id')
        if self.new_object.get('apTagsAndVlanIds') is not None or self.new_object.get('ap_tags_and_vlan_ids') is not None:
            new_object_params['apTagsAndVlanIds'] = self.new_object.get('apTagsAndVlanIds') or self.new_object.get('ap_tags_and_vlan_ids')
        ...
        if self.new_object.get('walledGardenRanges') is not None or self.new_object.get('walled_garden_ranges') is not None:
            new_object_params['walledGardenRanges'] = self.new_object.get('walledGardenRanges') or self.new_object.get('walled_garden_ranges')
        if self.new_object.get('gre') is not None or self.new_object.get('gre') is not None:
            new_object_params['gre'] = self.new_object.get('gre') or self.new_object.get('gre')
        ...
        if self.new_object.get('radiusGuestVlanId') is not None or self.new_object.get('radius_guest_vlan_id') is not None:
            new_object_params['radiusGuestVlanId'] = self.new_object.get('radiusGuestVlanId') or self.new_object.get('radius_guest_vlan_id')
        if self.new_object.get('minBitrate') is not None or self.new_object.get('min_bitrate') is not None:
            new_object_params['minBitrate'] = self.new_object.get('minBitrate') or self.new_object.get('min_bitrate')
        if self.new_object.get('bandSelection') is not None or self.new_object.get('band_selection') is not None:
            new_object_params['bandSelection'] = self.new_object.get('bandSelection') or self.new_object.get('band_selection')
        if self.new_object.get('perClientBandwidthLimitUp') is not None or self.new_object.get('per_client_bandwidth_limit_up') is not None:
            new_object_params['perClientBandwidthLimitUp'] = self.new_object.get('perClientBandwidthLimitUp') or self.new_object.get('per_client_bandwidth_limit_up')
        if self.new_object.get('perClientBandwidthLimitDown') is not None or self.new_object.get('per_client_bandwidth_limit_down') is not None:
            new_object_params['perClientBandwidthLimitDown'] = self.new_object.get('perClientBandwidthLimitDown') or self.new_object.get('per_client_bandwidth_limit_down')
        if self.new_object.get('perSsidBandwidthLimitUp') is not None or self.new_object.get('per_ssid_bandwidth_limit_up') is not None:
            new_object_params['perSsidBandwidthLimitUp'] = self.new_object.get('perSsidBandwidthLimitUp') or self.new_object.get('per_ssid_bandwidth_limit_up')
        if self.new_object.get('perSsidBandwidthLimitDown') is not None or self.new_object.get('per_ssid_bandwidth_limit_down') is not None:
            new_object_params['perSsidBandwidthLimitDown'] = self.new_object.get('perSsidBandwidthLimitDown') or self.new_object.get('per_ssid_bandwidth_limit_down')
        ...
        if self.new_object.get('availabilityTags') is not None or self.new_object.get('availability_tags') is not None:
            new_object_params['availabilityTags'] = self.new_object.get('availabilityTags') or self.new_object.get('availability_tags')
        ...
        if self.new_object.get('dnsRewrite') is not None or self.new_object.get('dns_rewrite') is not None:
            new_object_params['dnsRewrite'] = self.new_object.get('dnsRewrite') or self.new_object.get('dns_rewrite')
        if self.new_object.get('speedBurst') is not None or self.new_object.get('speed_burst') is not None:
            new_object_params['speedBurst'] = self.new_object.get('speedBurst') or self.new_object.get('speed_burst')
        if self.new_object.get('networkId') is not None or self.new_object.get('network_id') is not None:
            new_object_params['networkId'] = self.new_object.get('networkId') or self.new_object.get('network_id')
        if self.new_object.get('number') is not None or self.new_object.get('number') is not None:
            new_object_params['number'] = self.new_object.get('number') or self.new_object.get('number')
        return new_object_params

    def get_object_by_name(self, name):
        result = None
        try:
            items = self.meraki.exec_meraki(family='wireless', function='getNetworkWirelessSsids', params=self.get_all_params(name=name))
    ...
    def get_object_by_id(self, id):
        result = None
        try:
            items = self.meraki.exec_meraki(family='wireless', function='getNetworkWirelessSsid', params=self.get_params_by_id())
            if isinstance(items, dict):
                if 'response' in items:
                    items = items.get('response')
            result = items
    ...
    def update(self):
        ...
        result = self.meraki.exec_meraki(family='wireless', function='updateNetworkWirelessSsid', params=self.update_by_id_params(), op_modifies=True)
        return result