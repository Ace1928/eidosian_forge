...
def _validate_content_type(flask_request, allowed_content_types: List[str]):
    ...
    if flask_request.content_type is None:
        raise MlflowException(message='Bad Request. Content-Type header is missing.', error_code=INVALID_PARAMETER_VALUE)
    ...
    if content_type not in allowed_content_types:
        ...
        raise MlflowException(message=message, error_code=INVALID_PARAMETER_VALUE)