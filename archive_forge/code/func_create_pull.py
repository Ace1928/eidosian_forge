...
def create_pull(self, base: str, head: str, *, title: Opt[str]=NotSet, body: Opt[str]=NotSet, maintainer_can_modify: Opt[bool]=NotSet, draft: Opt[bool]=NotSet, issue: Opt[github.Issue.Issue]=NotSet) -> github.PullRequest.PullRequest:
    """
    ...
    post_parameters = NotSet.remove_unset_items({'base': base, 'head': head, 'title': title, 'body': body, 'maintainer_can_modify': maintainer_can_modify, 'draft': draft})
    if is_defined(issue):
