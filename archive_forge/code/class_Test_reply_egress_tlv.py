...
class Test_reply_egress_tlv(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.ins = cfm.reply_egress_tlv(self.length, self.action, self.mac_address, self.port_id_length, self.port_id_subtype, self.port_id)
        self.form = '!BHB6sBB3s'
    ...
    def test_default_args(self):
        ...
        buf = ins.serialize()
        res = struct.unpack_from(cfm.reply_egress_tlv._PACK_STR, bytes(buf))
