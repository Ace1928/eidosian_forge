...
class NetworkAccessAuthenticationRules(object):
    ...
    def get_object_by_id(self, id, policy_id):
        try:
            result = self.ise.exec(family='network_access_authentication_rules', function='get_network_access_authentication_rule_by_id', handle_func_exception=False, params={'id': id, 'policy_id': policy_id}).response['response']
    ...
    def create(self):
        result = self.ise.exec(family='network_access_authentication_rules', function='create_network_access_authentication_rule', params=self.new_object).response
        return result
    ...
    def update(self):
        ...
        result = self.ise.exec(family='network_access_authentication_rules', function='update_network_access_authentication_rule_by_id', params=self.new_object).response
        return result
    ...
    def delete(self):
        ...
        if not id:
            ...
            rule.update(dict(id=id_))
            self.new_object.update(dict(rule=rule, id=id_))
        result = self.ise.exec(family='network_access_authentication_rules', function='delete_network_access_authentication_rule_by_id', params=self.new_object).response
        return result