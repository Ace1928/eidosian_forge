...
class AzureCogsTextAnalyticsHealthTool(BaseTool):
    ...
    description: str = 'A wrapper around Azure Cognitive Services Text Analytics for Health. Useful for when you need to identify entities in healthcare data. Input should be text.'
    ...
    def validate_environment(cls, values: Dict) -> Dict:
        ...
        try:
            ...
            values['text_analytics_client'] = sdk.TextAnalyticsClient(endpoint=azure_cogs_endpoint, credential=AzureKeyCredential(azure_cogs_key))
        except ImportError:
