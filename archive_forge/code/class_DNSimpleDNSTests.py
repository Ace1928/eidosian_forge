...
class DNSimpleDNSTests(unittest.TestCase):
    ...
    def test_list_zones_success(self):
        ...
        self.assertHasKeys(zone1.extra, ['registrant_id', 'user_id', 'unicode_name', 'token', 'state', 'language', 'lockable', 'auto_renew', 'whois_protected', 'record_count', 'service_count', 'expires_on', 'created_at', 'updated_at'])
        zone2 = zones[1]
        ...
        self.assertHasKeys(zone2.extra, ['registrant_id', 'user_id', 'unicode_name', 'token', 'state', 'language', 'lockable', 'auto_renew', 'whois_protected', 'record_count', 'service_count', 'expires_on', 'created_at', 'updated_at'])
    ...
    def test_list_records_success(self):
        ...
        self.assertHasKeys(record1.extra, ['ttl', 'created_at', 'updated_at', 'domain_id', 'priority'])
        record2 = records[1]
        ...
        self.assertHasKeys(record2.extra, ['ttl', 'created_at', 'updated_at', 'domain_id', 'priority'])
        record3 = records[2]
        ...
        self.assertHasKeys(record3.extra, ['ttl', 'created_at', 'updated_at', 'domain_id', 'priority'])
    ...
    def test_get_record_success(self):
        ...
        self.assertHasKeys(record.extra, ['ttl', 'created_at', 'updated_at', 'domain_id', 'priority'])
    ...
    def test_create_zone_success(self):
        ...
        self.assertHasKeys(zone.extra, ['registrant_id', 'user_id', 'unicode_name', 'token', 'state', 'language', 'lockable', 'auto_renew', 'whois_protected', 'record_count', 'service_count', 'expires_on', 'created_at', 'updated_at'])

    def test_create_record_success(self):
        zone = self.driver.list_zones()[0]
        DNSimpleDNSMockHttp.type = 'CREATE'
        record = self.driver.create_record(name='domain4', zone=zone, type=RecordType.MX, data='mail.example.com')
    ...
    def test_update_record_success(self):
        ...
        extra = {'ttl': 4500}
        record1 = self.driver.update_record(record=record, name='www', type=record.type, data='updated.com', extra=extra)
        self.assertEqual(record.data, 'example.com')
