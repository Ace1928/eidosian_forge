...
class RegistriesClient(object):
    ...
    def Create(self, parent_ref, registry_id, credentials=None, event_notification_configs=None, state_pubsub_topic=None, mqtt_enabled_state=None, http_enabled_state=None):
    ...
    """
        if state_pubsub_topic:
            state_notification_config = self.messages.StateNotificationConfig(pubsubTopicName=state_pubsub_topic.RelativeName())
        else:
            state_notification_config = None
        if mqtt_enabled_state:
            mqtt_config = self.messages.MqttConfig(mqttEnabledState=mqtt_enabled_state)
        else:
            mqtt_config = None
        if http_enabled_state:
            http_config = self.messages.HttpConfig(httpEnabledState=http_enabled_state)
        else:
            http_config = None
        create_req = self.messages.CloudiotProjectsLocationsRegistriesCreateRequest(parent=parent_ref.RelativeName(), deviceRegistry=self.messages.DeviceRegistry(id=registry_id, credentials=credentials or [], eventNotificationConfigs=event_notification_configs or [], stateNotificationConfig=state_notification_config, mqttConfig=mqtt_config, httpConfig=http_config))
        return self._service.Create(create_req)

    def Delete(self, registry_ref):
        delete_req = self.messages.CloudiotProjectsLocationsRegistriesDeleteRequest(name=registry_ref.RelativeName())
        return self._service.Delete(delete_req)

    def Get(self, registry_ref):
        get_req = self.messages.CloudiotProjectsLocationsRegistriesGetRequest(name=registry_ref.RelativeName())
    ...
    """
        list_req = self.messages.CloudiotProjectsLocationsRegistriesListRequest(parent=parent_ref.RelativeName())
        return list_pager.YieldFromList(self._service, list_req, batch_size=page_size, limit=limit, field='deviceRegistries', batch_size_attribute='pageSize')

    def Patch(self, registry_ref, credentials=None, event_notification_configs=None, state_pubsub_topic=None, mqtt_enabled_state=None, http_enabled_state=None, log_level=None):
    ...
    """
        ...
        if http_enabled_state:
            ...
            http_config = None
        device_registry_update_settings = [_DeviceRegistryUpdateSetting('credentials', 'credentials', credentials), _DeviceRegistryUpdateSetting('eventNotificationConfigs', 'event_notification_configs', event_notification_configs), _DeviceRegistryUpdateSetting('stateNotificationConfig', 'state_notification_config.pubsub_topic_name', state_notification_config), _DeviceRegistryUpdateSetting('mqttConfig', 'mqtt_config.mqtt_enabled_state', mqtt_config), _DeviceRegistryUpdateSetting('httpConfig', 'http_config.http_enabled_state', http_config), _DeviceRegistryUpdateSetting('logLevel', 'logLevel', log_level)]
        update_mask = []
        ...
        patch_req = self.messages.CloudiotProjectsLocationsRegistriesPatchRequest(deviceRegistry=registry, name=registry_ref.RelativeName(), updateMask=','.join(update_mask))
    ...
    """
        set_req = self.messages.CloudiotProjectsLocationsRegistriesSetIamPolicyRequest(resource=registry_ref.RelativeName(), setIamPolicyRequest=set_iam_policy_request)
    ...
    """
        get_req = self.messages.CloudiotProjectsLocationsRegistriesGetIamPolicyRequest(resource=registry_ref.RelativeName())
