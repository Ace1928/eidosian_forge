...
class LoginButton(Button):
    ...
    def __init__(self, value: str='Sign in with Hugging Face', logout_value: str='Logout ({})', *, every: float | None=None, variant: Literal['primary', 'secondary', 'stop']='secondary', size: Literal['sm', 'lg'] | None=None, icon: str | None='https://huggingface.co/front/assets/huggingface_logo-noborder.svg', link: str | None=None, visible: bool=True, interactive: bool=True, elem_id: str | None=None, elem_classes: list[str] | str | None=None, render: bool=True, scale: int | None=0, min_width: int | None=None, signed_in_value: str='Signed in as {}'):
        """
        Parameters:
        ...
        if signed_in_value != 'Signed in as {}':
            warnings.warn('The `signed_in_value` parameter is deprecated. Please use `logout_value` instead.')
