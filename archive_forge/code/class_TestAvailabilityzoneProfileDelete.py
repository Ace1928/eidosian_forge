...
class TestAvailabilityzoneProfileDelete(TestAvailabilityzoneProfile):
    ...
    def setUp(self):
        super().setUp()
        self.cmd = availabilityzoneprofile.DeleteAvailabilityzoneProfile(self.app, None)
    ...
    def test_availabilityzoneprofile_delete(self):
        ...
        self.api_mock.availabilityzoneprofile_delete.assert_called_with(availabilityzoneprofile_id=self._availabilityzoneprofile.id)
