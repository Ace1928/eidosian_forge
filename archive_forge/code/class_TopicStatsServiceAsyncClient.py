...
class TopicStatsServiceAsyncClient:
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        """
        return TopicStatsServiceClient.from_service_account_info.__func__(TopicStatsServiceAsyncClient, info, *args, **kwargs)
    ...
    def from_service_account_file(cls, filename: str, *args, **kwargs):
        ...
        Returns:
            TopicStatsServiceAsyncClient: The constructed client.
        """
        return TopicStatsServiceClient.from_service_account_file.__func__(TopicStatsServiceAsyncClient, filename, *args, **kwargs)
    ...
    def get_mtls_endpoint_and_cert_source(cls, client_options: Optional[ClientOptions]=None):
        ...
        """
        return TopicStatsServiceClient.get_mtls_endpoint_and_cert_source(client_options)
    ...
    get_transport_class = functools.partial(type(TopicStatsServiceClient).get_transport_class, type(TopicStatsServiceClient))

    def __init__(self, *, credentials: Optional[ga_credentials.Credentials]=None, transport: Union[str, TopicStatsServiceTransport]='grpc_asyncio', client_options: Optional[ClientOptions]=None, client_info: gapic_v1.client_info.ClientInfo=DEFAULT_CLIENT_INFO) -> None:
        ...
        """
        self._client = TopicStatsServiceClient(credentials=credentials, transport=transport, client_options=client_options, client_info=client_info)

    async def compute_message_stats(self, request: Optional[Union[topic_stats.ComputeMessageStatsRequest, dict]]=None, *, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> topic_stats.ComputeMessageStatsResponse:
        ...
        rpc = gapic_v1.method_async.wrap_method(self._client._transport.compute_message_stats, default_timeout=None, client_info=DEFAULT_CLIENT_INFO)
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((('topic', request.topic),)),)
        response = await rpc(request, retry=retry, timeout=timeout, metadata=metadata)
        return response

    async def compute_head_cursor(self, request: Optional[Union[topic_stats.ComputeHeadCursorRequest, dict]]=None, *, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> topic_stats.ComputeHeadCursorResponse:
        ...
        rpc = gapic_v1.method_async.wrap_method(self._client._transport.compute_head_cursor, default_timeout=None, client_info=DEFAULT_CLIENT_INFO)
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((('topic', request.topic),)),)
        response = await rpc(request, retry=retry, timeout=timeout, metadata=metadata)
        return response

    async def compute_time_cursor(self, request: Optional[Union[topic_stats.ComputeTimeCursorRequest, dict]]=None, *, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> topic_stats.ComputeTimeCursorResponse:
        ...
        rpc = gapic_v1.method_async.wrap_method(self._client._transport.compute_time_cursor, default_timeout=None, client_info=DEFAULT_CLIENT_INFO)
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((('topic', request.topic),)),)
        response = await rpc(request, retry=retry, timeout=timeout, metadata=metadata)
        return response
