...
class Test_lacp(unittest.TestCase):
    ...
    def test_init(self):
        ...
        self.assertEqual(self.actor_state_aggregation, self.l.actor_state_aggregation)
        self.assertEqual(self.actor_state_synchronization, self.l.actor_state_synchronization)
        self.assertEqual(self.actor_state_collecting, self.l.actor_state_collecting)
        self.assertEqual(self.actor_state_distributing, self.l.actor_state_distributing)
        ...
        self.assertEqual(self.partner_system_priority, self.l.partner_system_priority)
        ...
        self.assertEqual(self.partner_state_aggregation, self.l.partner_state_aggregation)
        self.assertEqual(self.partner_state_synchronization, self.l.partner_state_synchronization)
        self.assertEqual(self.partner_state_collecting, self.l.partner_state_collecting)
        self.assertEqual(self.partner_state_distributing, self.l.partner_state_distributing)
        self.assertEqual(self.partner_state_defaulted, self.l.partner_state_defaulted)
    ...
    def test_parser(self):
        ...
        self.assertEqual(res.actor_state_synchronization, self.actor_state_synchronization)
        ...
        self.assertEqual(res.partner_state_aggregation, self.partner_state_aggregation)
        self.assertEqual(res.partner_state_synchronization, self.partner_state_synchronization)
        self.assertEqual(res.partner_state_collecting, self.partner_state_collecting)
        self.assertEqual(res.partner_state_distributing, self.partner_state_distributing)
    ...
    def test_build_lacp(self):
        ...
        self.assertEqual(l.actor_state_synchronization, self.actor_state_synchronization)
        ...
        self.assertEqual(l.partner_state_synchronization, self.partner_state_synchronization)
        self.assertEqual(l.partner_state_collecting, self.partner_state_collecting)
        self.assertEqual(l.partner_state_distributing, self.partner_state_distributing)
    ...
    def test_invalid_partner_state_defaulted(self):
        self.assertRaises(AssertionError, lacp, self.version, self.actor_system_priority, self.actor_system, self.actor_key, self.actor_port_priority, self.actor_port, self.actor_state_activity, self.actor_state_timeout, self.actor_state_aggregation, self.actor_state_synchronization, self.actor_state_collecting, self.actor_state_distributing, self.actor_state_defaulted, self.actor_state_expired, self.partner_system_priority, self.partner_system, self.partner_key, self.partner_port_priority, self.partner_port, self.partner_state_activity, self.partner_state_timeout, self.partner_state_aggregation, self.partner_state_synchronization, self.partner_state_collecting, self.partner_state_distributing, -1, self.partner_state_expired, self.collector_max_delay)

    def test_invalid_partner_state_expired(self):
        self.assertRaises(AssertionError, lacp, self.version, self.actor_system_priority, self.actor_system, self.actor_key, self.actor_port_priority, self.actor_port, self.actor_state_activity, self.actor_state_timeout, self.actor_state_aggregation, self.actor_state_synchronization, self.actor_state_collecting, self.actor_state_distributing, self.actor_state_defaulted, self.actor_state_expired, self.partner_system_priority, self.partner_system, self.partner_key, self.partner_port_priority, self.partner_port, self.partner_state_activity, self.partner_state_timeout, self.partner_state_aggregation, self.partner_state_synchronization, self.partner_state_collecting, self.partner_state_distributing, self.partner_state_defaulted, -1, self.collector_max_delay)
