...
class Badge(VuetifyWidget):
    ...
    offset_x = Union([Float(), Unicode()], default_value=None, allow_none=True).tag(sync=True)
    offset_y = Union([Float(), Unicode()], default_value=None, allow_none=True).tag(sync=True)
