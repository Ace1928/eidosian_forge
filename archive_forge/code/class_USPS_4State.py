...
class USPS_4State(Barcode):
    ...
    _humanReadable = 0
    if True:
        tops = dict(F=(0.0625, 0.0825), T=(0.0195, 0.0285), A=(0.0625, 0.0825), D=(0.0195, 0.0285))
        bottoms = dict(F=(-0.0625, -0.0825), T=(-0.0195, -0.0285), D=(-0.0625, -0.0825), A=(-0.0195, -0.0285))
        dimensions = dict(width=(0.015, 0.025), pitch=(0.0416, 0.05), hcz=(0.125, 0.125), vcz=(0.028, 0.028))
    else:
        tops = dict(F=(0.067, 0.115), T=(0.021, 0.04), A=(0.067, 0.115), D=(0.021, 0.04))
        bottoms = dict(F=(-0.067, -0.115), D=(-0.067, -0.115), T=(-0.021, -0.04), A=(-0.021, -0.04))
        dimensions = dict(width=(0.015, 0.025), pitch=(0.0416, 0.05), hcz=(0.125, 0.125), vcz=(0.04, 0.04))
