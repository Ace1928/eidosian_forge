...
class BaseInferenceType(dict):
    ...
    def __getitem__(self, __key: Any) -> Any:
        warnings.warn(f"Accessing '{self.__class__.__name__}' values through dict is deprecated and will be removed from version '0.25'. Use dataclass attributes instead.", FutureWarning)
