...
class QuasiRRHO:
    ...
    def __init__(self, mol: Molecule, frequencies: list[float], energy: float, mult: int, sigma_r: float=1, temp: float=298.15, press: float=101317, v0: float=100) -> None:
        """
        Args:
        ...
        self.press = press
        self.v0 = v0
        self.entropy_quasiRRHO = None
        self.free_energy_quasiRRHO = None
        self.h_corrected = None
        self.entropy_ho = None
        self.free_energy_ho = None
