...
class KeyDBSession:
    ...
    def __init__(self, uri: typing.Union[str, KeyDBUri], name: str, client_pools: ClientPools, db_id: typing.Optional[int]=None, encoder: typing.Optional[Encoder]=None, serializer: typing.Optional[typing.Type[BaseSerializer]]=None, settings: typing.Optional[KeyDBSettings]=None, cache_ttl: typing.Optional[Number]=None, cache_prefix: typing.Optional[str]=None, cache_enabled: typing.Optional[bool]=None, **config):
        if isinstance(uri, str):
            uri = KeyDBUri(dsn=uri)
        self.uri: KeyDBUri = uri
        self.name = name
        self.db_id = db_id or uri.db_id
        self.config = config
        self.settings = settings or default_settings
        self.encoder = encoder or Encoder(encoding=config.get('encoding', self.settings.encoding), encoding_errors=config.get('encoding_errors', self.settings.encoding_errors), decode_responses=True)
        ...
        self.state = SessionCtx(cache_max_attempts=config.get('cache_max_attempts', 20))
    ...
    @classmethod
    def _get_async_client_class(cls, settings: KeyDBSettings, retry_client_enabled: typing.Optional[bool]=None, retry_client_max_attempts: typing.Optional[int]=None, retry_client_max_delay: typing.Optional[int]=None, retry_client_logging_level: typing.Optional[int]=None, **kwargs) -> typing.Type[AsyncKeyDB]:
        """
        Returns the client class
        """
        retry_client_enabled = retry_client_enabled if retry_client_enabled is not None else settings.retry_client_enabled
        ...
        retry_client_max_delay = retry_client_max_delay if retry_client_max_delay is not None else settings.retry_client_max_delay
        retry_client_logging_level = retry_client_logging_level if retry_client_logging_level is not None else settings.retry_client_logging_level
        return create_retryable_client(AsyncKeyDB, max_attempts=retry_client_max_attempts, max_delay=retry_client_max_delay, logging_level=retry_client_logging_level, **kwargs)

    @property
    def client(self) -> KeyDB:
        if self.state.client is None:
            self.state.client = self._get_client_class(self.settings, **self.config)(connection_pool=self.client_pools.pool)
        return self.state.client

    @property
    def async_client(self) -> AsyncKeyDB:
        if self.state.async_client is None:
            self.state.async_client = self._get_async_client_class(self.settings, **self.config)(connection_pool=self.client_pools.apool)
    ...
    def get_pubsub(self, retryable: typing.Optional[bool]=None, **kwargs) -> PubSubT:
        """
    ...
    def pipeline(self) -> Pipeline:
        ...
        if self.state.pipeline is None:
            self.state.pipeline = self.client.pipeline(transaction=self.config.get('transaction', True), shard_hint=self.config.get('shard_hint', None))
    ...
    def async_pipeline(self) -> AsyncPipeline:
        ...
        if self.state.async_pipeline is None:
            self.state.async_pipeline = self.async_client.pipeline(transaction=self.config.get('transaction', True), shard_hint=self.config.get('shard_hint', None))
        return self.state.async_pipeline

    def get_pipeline(self, transaction: typing.Optional[bool]=True, shard_hint: typing.Optional[str]=None, retryable: typing.Optional[bool]=None, **kwargs) -> PipelineT:
        """
    ...
    def get_async_pipeline(self, transaction: typing.Optional[bool]=True, shard_hint: typing.Optional[str]=None, retryable: typing.Optional[bool]=None, **kwargs) -> AsyncPipelineT:
        """
        Return a new pipeline object that can queue multiple commands for
        later execution. ``transaction`` indicates whether all commands
        should be executed atomically. Apart from making a group of operations
        ...
        if retryable is None:
            retryable = self.settings.retry_client_enabled
        return self.async_client.pipeline(transaction=transaction, shard_hint=shard_hint, retryable=retryable)
    ...
    def get_lock(self, name: str, timeout: typing.Optional[Number]=None, sleep: Number=0.1, blocking: bool=True, blocking_timeout: typing.Optional[Number]=None, thread_local: bool=True, **kwargs) -> Lock:
        """
        ...
        if name not in self.state.locks:
            self.state.locks[name] = Lock(self.client, name=name, timeout=timeout, sleep=sleep, blocking=blocking, blocking_timeout=blocking_timeout, thread_local=thread_local)
        if not self.state.lock:
            self.state.lock = self.state.locks[name]
    ...
    async def async_close_locks(self, names: typing.Optional[typing.Union[typing.List[str], str]]=None):
        if names is None:
            names = list(self.state.async_locks.keys())
        if isinstance(names, str):
            names = [names]
        for name in names:
    ...
    async def async_plisten(self, *patterns: str, timeout: typing.Optional[float]=None, unsubscribe_after: typing.Optional[bool]=False, close_after: typing.Optional[bool]=False, listen_callback: typing.Optional[typing.Callable]=None, cancel_callback: typing.Optional[typing.Callable]=None, **kwargs) -> typing.AsyncIterator[typing.Any]:
        """
        [PubSub] Listens for messages
        """
    ...
    def serialize(self, value: typing.Any, serializer: typing.Optional[typing.Union[typing.Callable, bool]]=None, **kwargs):
        """
    ...
    def deserialize(self, value: typing.Any, deserializer: typing.Optional[typing.Union[typing.Callable, bool]]=None, **kwargs):
        """
        Handles deserialization
        """
        if deserializer and callable(deserializer):
            return deserializer(value, **kwargs)
        if deserializer is False:
            return value
        if deserializer is True:
    ...
    def set(self, name: str, value: typing.Any, ex: typing.Union[ExpiryT, None]=None, px: typing.Union[ExpiryT, None]=None, nx: bool=False, xx: bool=False, keepttl: bool=False, get: bool=False, exat: typing.Union[AbsExpiryT, None]=None, pxat: typing.Union[AbsExpiryT, None]=None, _serializer: typing.Optional[typing.Union[typing.Callable, bool]]=None, **kwargs) -> typing.Any:
        """
        Serializes the Value using `serializer` and executes a set command
        """
        value = self.serialize(value, _serializer, **kwargs)
        return self.client.set(name=name, value=value, ex=ex, px=px, nx=nx, xx=xx, keepttl=keepttl, get=get, exat=exat, pxat=pxat, **kwargs)

    async def async_set(self, name: str, value: typing.Any, ex: typing.Union[ExpiryT, None]=None, px: typing.Union[ExpiryT, None]=None, nx: bool=False, xx: bool=False, keepttl: bool=False, get: bool=False, exat: typing.Union[AbsExpiryT, None]=None, pxat: typing.Union[AbsExpiryT, None]=None, _serializer: typing.Optional[typing.Union[typing.Callable, bool]]=None, **kwargs) -> typing.Any:
        """
        Serializes the Value using `serializer` and executes a set command
        """
        value = self.serialize(value, _serializer, **kwargs)
        return await self.async_client.set(name=name, value=value, ex=ex, px=px, nx=nx, xx=xx, keepttl=keepttl, get=get, exat=exat, pxat=pxat, **kwargs)

    def get(self, name: str, default: typing.Any=None, _return_raw_value: typing.Optional[bool]=None, _serializer: typing.Optional[typing.Union[typing.Callable, bool]]=None, **kwargs) -> typing.Any:
        """
        Serializes the Value using `serializer` and executes a set command
        ...
        if not val:
            return default
        if _return_raw_value:
            return val
        return self.deserialize(val, _serializer, **kwargs)

    async def async_get(self, name: str, default: typing.Any=None, _return_raw_value: typing.Optional[bool]=None, _serializer: typing.Optional[typing.Union[typing.Callable, bool]]=None, **kwargs) -> typing.Any:
        """
        Serializes the Value using `serializer` and executes a set command
    ...
    def delete(self, names: typing.Union[typing.List[str], str], **kwargs) -> typing.Any:
        """
    ...
    async def async_delete(self, names: typing.Union[typing.List[str], str], **kwargs) -> typing.Any:
        """
        Delete one or more keys specified by names
        """
        if isinstance(names, str):
    ...
    def update(self, name: str, data: typing.Dict[typing.Any, typing.Any], overwrite: typing.Optional[bool]=False, **kwargs) -> typing.Any:
        """
        ...
        """
        if overwrite:
            return self.set(name=name, value=data, **kwargs)
        src_data: typing.Dict[typing.Any, typing.Any] = self.get(name, {})
        src_data.update(data)
        return self.set(name=name, value=src_data, **kwargs)

    async def async_update(self, name: str, data: typing.Dict[typing.Any, typing.Any], overwrite: typing.Optional[bool]=False, **kwargs) -> typing.Any:
        """
        Update the key: `name` with data
        ...
        """
        if overwrite:
            return await self.async_set(name=name, value=data, **kwargs)
        src_data: typing.Dict[typing.Any, typing.Any] = await self.async_get(name, {})
        src_data.update(data)
        return await self.async_set(name=name, value=src_data, **kwargs)

    def exists(self, keys: typing.Union[typing.List[KeyT], KeyT], **kwargs) -> bool:
        """
    ...
    async def async_exists(self, keys: typing.Union[typing.List[KeyT], KeyT], **kwargs) -> bool:
        """
        Check if a key exists
        """
        if not isinstance(keys, list):
    ...
    def decr(self, name: str, amount: typing.Optional[int]=1, **kwargs) -> int:
        """
        Decrement the value of key `name` by `amount`
        """
        return self.client.decr(name, amount=amount, **kwargs)

    async def async_decr(self, name: str, amount: typing.Optional[int]=1, **kwargs) -> int:
        """
        Decrement the value of key `name` by `amount`
        """
        return await self.async_client.decr(name, amount=amount, **kwargs)

    def decrby(self, name: str, amount: typing.Optional[int]=1, **kwargs) -> int:
        """
        Decrement the value of key `name` by `amount`
        """
        return self.client.decrby(name, amount=amount, **kwargs)

    async def async_decrby(self, name: str, amount: typing.Optional[int]=1, **kwargs) -> int:
        """
        Decrement the value of key `name` by `amount`
        """
        return await self.async_client.decrby(name, amount=amount, **kwargs)

    def incr(self, name: str, amount: typing.Optional[int]=1, **kwargs) -> int:
        """
        Increment the value of key `name` by `amount`
        """
        return self.client.incr(name, amount=amount, **kwargs)

    async def async_incr(self, name: str, amount: typing.Optional[int]=1, **kwargs) -> int:
        """
        Increment the value of key `name` by `amount`
        """
        return await self.async_client.incr(name, amount=amount, **kwargs)

    def incrby(self, name: str, amount: typing.Optional[int]=1, **kwargs) -> int:
        """
        Increment the value of key `name` by `amount`
        """
        return self.client.incrby(name, amount=amount, **kwargs)

    async def async_incrby(self, name: str, amount: typing.Optional[int]=1, **kwargs) -> int:
        """
        Increment the value of key `name` by `amount`
        """
        return await self.async_client.incrby(name, amount=amount, **kwargs)

    def incrbyfloat(self, name: str, amount: typing.Optional[float]=1.0, **kwargs) -> float:
        """
        Increment the value of key `name` by `amount`
        """
        return self.client.incrbyfloat(name, amount=amount, **kwargs)

    async def async_incrbyfloat(self, name: str, amount: typing.Optional[float]=1.0, **kwargs) -> float:
        """
        Increment the value of key `name` by `amount`
        """
        return await self.async_client.incrbyfloat(name, amount=amount, **kwargs)

    def getbit(self, name: str, offset: int, **kwargs) -> int:
        """
        Returns the bit value at offset in the string value stored at key
        """
        return self.client.getbit(name, offset, **kwargs)

    async def async_getbit(self, name: str, offset: int, **kwargs) -> int:
        """
        Returns the bit value at offset in the string value stored at key
        """
        return await self.async_client.getbit(name, offset, **kwargs)

    def setbit(self, name: str, offset: int, value: int, **kwargs) -> int:
        """
        Sets or clears the bit at offset in the string value stored at key
        """
        return self.client.setbit(name, offset, value, **kwargs)

    async def async_setbit(self, name: str, offset: int, value: int, **kwargs) -> int:
        """
        Sets or clears the bit at offset in the string value stored at key
        """
        return await self.async_client.setbit(name, offset, value, **kwargs)

    def bitcount(self, name: str, start: typing.Optional[int]=None, end: typing.Optional[int]=None, **kwargs) -> int:
        """
        Count the number of set bits (population counting) in a string
        """
        return self.client.bitcount(name, start=start, end=end, **kwargs)

    async def async_bitcount(self, name: str, start: typing.Optional[int]=None, end: typing.Optional[int]=None, **kwargs) -> int:
        """
        Count the number of set bits (population counting) in a string
        """
        return await self.async_client.bitcount(name, start=start, end=end, **kwargs)

    def bitop(self, operation: str, dest: str, *keys: str, **kwargs) -> int:
        """
        Perform bitwise operations between strings
        """
        return self.client.bitop(operation, dest, *keys, **kwargs)

    async def async_bitop(self, operation: str, dest: str, *keys: str, **kwargs) -> int:
        """
        Perform bitwise operations between strings
        """
        return await self.async_client.bitop(operation, dest, *keys, **kwargs)

    def bitpos(self, name: str, bit: int, start: typing.Optional[int]=None, end: typing.Optional[int]=None, **kwargs) -> int:
        """
        Find first bit set or clear in a string
        """
        return self.client.bitpos(name, bit, start=start, end=end, **kwargs)

    async def async_bitpos(self, name: str, bit: int, start: typing.Optional[int]=None, end: typing.Optional[int]=None, **kwargs) -> int:
        """
        Find first bit set or clear in a string
        """
        return await self.async_client.bitpos(name, bit, start=start, end=end, **kwargs)

    def strlen(self, name: str, **kwargs) -> int:
        """
        Get the length of the value stored in a key
        """
        return self.client.strlen(name, **kwargs)

    async def async_strlen(self, name: str, **kwargs) -> int:
        """
        Get the length of the value stored in a key
        """
        return await self.async_client.strlen(name, **kwargs)

    def getrange(self, name: str, start: int, end: int, **kwargs) -> str:
        """
        Get a substring of the string stored at a key
        """
        return self.client.getrange(name, start, end, **kwargs)

    async def async_getrange(self, name: str, start: int, end: int, **kwargs) -> str:
        """
        Get a substring of the string stored at a key
        """
        return await self.async_client.getrange(name, start, end, **kwargs)

    def setrange(self, name: str, offset: int, value: str, **kwargs) -> int:
        """
        Overwrite part of a string at key starting at the specified offset
        """
        return self.client.setrange(name, offset, value, **kwargs)

    async def async_setrange(self, name: str, offset: int, value: str, **kwargs) -> int:
        """
        Overwrite part of a string at key starting at the specified offset
        """
        return await self.async_client.setrange(name, offset, value, **kwargs)

    def getset(self, name: str, value: str, **kwargs) -> str:
        """
        Set the string value of a key and return its old value
        """
        return self.client.getset(name, value, **kwargs)

    async def async_getset(self, name: str, value: str, **kwargs) -> str:
        """
        Set the string value of a key and return its old value
        """
        return await self.async_client.getset(name, value, **kwargs)

    def mget(self, *names: str, **kwargs) -> typing.List[typing.Optional[str]]:
        """
        Get the values of all the given keys
        """
        return self.client.mget(*names, **kwargs)

    async def async_mget(self, *names: str, **kwargs) -> typing.List[typing.Optional[str]]:
        """
        Get the values of all the given keys
        """
        return await self.async_client.mget(*names, **kwargs)

    def mset(self, mapping: typing.Mapping[str, str], **kwargs) -> bool:
        """
        Set multiple keys to multiple values
        """
        return self.client.mset(mapping, **kwargs)

    async def async_mset(self, mapping: typing.Mapping[str, str], **kwargs) -> bool:
        """
        Set multiple keys to multiple values
        """
        return await self.async_client.mset(mapping, **kwargs)

    def msetnx(self, mapping: typing.Mapping[str, str], **kwargs) -> bool:
        """
        Set multiple keys to multiple values, only if none of the keys exist
        """
        return self.client.msetnx(mapping, **kwargs)

    async def async_msetnx(self, mapping: typing.Mapping[str, str], **kwargs) -> bool:
        """
        Set multiple keys to multiple values, only if none of the keys exist
        """
        return await self.async_client.msetnx(mapping, **kwargs)

    def expire(self, name: str, time: int, nx: bool=False, xx: bool=False, gt: bool=False, lt: bool=False, **kwargs) -> bool:
        """
        Set a key's time to live in seconds
        """
        return self.client.expire(name, time, nx=nx, xx=xx, gt=gt, lt=lt, **kwargs)

    async def async_expire(self, name: str, time: int, nx: bool=False, xx: bool=False, gt: bool=False, lt: bool=False, **kwargs) -> bool:
        """
        Set a key's time to live in seconds
        """
        return await self.async_client.expire(name, time, nx=nx, xx=xx, gt=gt, lt=lt, **kwargs)

    def expireat(self, name: str, when: int, nx: bool=False, xx: bool=False, gt: bool=False, lt: bool=False, **kwargs) -> bool:
        """
        Set the expiration for a key as a UNIX timestamp
        """
        return self.client.expireat(name, when, nx=nx, xx=xx, gt=gt, lt=lt, **kwargs)

    async def async_expireat(self, name: str, when: int, nx: bool=False, xx: bool=False, gt: bool=False, lt: bool=False, **kwargs) -> bool:
        """
        Set the expiration for a key as a UNIX timestamp
        """
        return await self.async_client.expireat(name, when, nx=nx, xx=xx, gt=gt, lt=lt, **kwargs)

    def pexpire(self, name: str, time: int, nx: bool=False, xx: bool=False, gt: bool=False, lt: bool=False, **kwargs) -> bool:
        """
        Set a key's time to live in milliseconds
        """
        return self.client.pexpire(name, time, nx=nx, xx=xx, gt=gt, lt=lt, **kwargs)

    async def async_pexpire(self, name: str, time: int, nx: bool=False, xx: bool=False, gt: bool=False, lt: bool=False, **kwargs) -> bool:
        """
        Set a key's time to live in milliseconds
        """
        return await self.async_client.pexpire(name, time, nx=nx, xx=xx, gt=gt, lt=lt, **kwargs)

    def pexpireat(self, name: str, when: int, nx: bool=False, xx: bool=False, gt: bool=False, lt: bool=False, **kwargs) -> bool:
        """
        Set the expiration for a key as a UNIX timestamp specified in milliseconds
        """
        return self.client.pexpireat(name, when, nx=nx, xx=xx, gt=gt, lt=lt, **kwargs)

    async def async_pexpireat(self, name: str, when: int, nx: bool=False, xx: bool=False, gt: bool=False, lt: bool=False, **kwargs) -> bool:
        """
        Set the expiration for a key as a UNIX timestamp specified in milliseconds
        """
        return await self.async_client.pexpireat(name, when, nx=nx, xx=xx, gt=gt, lt=lt, **kwargs)

    def ttl(self, name: str, **kwargs) -> int:
        """
        Get the time to live for a key
        """
        return self.client.ttl(name, **kwargs)

    async def async_ttl(self, name: str, **kwargs) -> int:
        """
        Get the time to live for a key
        """
        return await self.async_client.ttl(name, **kwargs)

    def pttl(self, name: str, **kwargs) -> int:
        """
        Get the time to live for a key in milliseconds
        """
        return self.client.pttl(name, **kwargs)

    async def async_pttl(self, name: str, **kwargs) -> int:
        """
        Get the time to live for a key in milliseconds
        """
        return await self.async_client.pttl(name, **kwargs)

    def persist(self, name: str, **kwargs) -> bool:
        """
        Remove the expiration from a key
        """
        return self.client.persist(name, **kwargs)

    async def async_persist(self, name: str, **kwargs) -> bool:
        """
        Remove the expiration from a key
        """
        return await self.async_client.persist(name, **kwargs)

    def psetex(self, name: str, time_ms: int, value: typing.Any, **kwargs) -> bool:
        """
        Set the value and expiration in milliseconds of a key
        """
        return self.client.psetex(name, time_ms, value, **kwargs)

    async def async_psetex(self, name: str, time_ms: int, value: typing.Any, **kwargs) -> bool:
        """
        Set the value and expiration in milliseconds of a key
        """
        return await self.async_client.psetex(name, time_ms, value, **kwargs)

    def setex(self, name: str, time: int, value: typing.Any, **kwargs) -> bool:
        """
        Set the value and expiration of a key
        """
        return self.client.setex(name, time, value, **kwargs)

    async def async_setex(self, name: str, time: int, value: typing.Any, **kwargs) -> bool:
        """
        Set the value and expiration of a key
        """
        return await self.async_client.setex(name, time, value, **kwargs)

    def getdel(self, name: str, **kwargs) -> typing.Any:
        """
        Get the value of a key and delete it
        """
        return self.client.getdel(name, **kwargs)

    async def async_getdel(self, name: str, **kwargs) -> typing.Any:
        """
        Get the value of a key and delete it
        """
        return await self.async_client.getdel(name, **kwargs)

    def hdel(self, name: str, *keys: str, **kwargs) -> int:
        """
        Delete one or more hash fields
        """
        return self.client.hdel(name, *keys, **kwargs)

    async def async_hdel(self, name: str, *keys: str, **kwargs) -> int:
        """
        Delete one or more hash fields
        """
        return await self.async_client.hdel(name, *keys, **kwargs)

    def hexists(self, name: str, key: str, **kwargs) -> bool:
        """
        Determine if a hash field exists
        """
        return self.client.hexists(name, key, **kwargs)

    async def async_hexists(self, name: str, key: str, **kwargs) -> bool:
        """
        Determine if a hash field exists
        """
        return await self.async_client.hexists(name, key, **kwargs)

    def hget(self, name: str, key: str, **kwargs) -> typing.Any:
        """
        Get the value of a hash field
        """
        return self.client.hget(name, key, **kwargs)

    async def async_hget(self, name: str, key: str, **kwargs) -> typing.Any:
        """
        Get the value of a hash field
        """
        return await self.async_client.hget(name, key, **kwargs)

    def hgetall(self, name: str, **kwargs) -> typing.Dict:
        """
        Get all the fields and values in a hash
        """
        return self.client.hgetall(name, **kwargs)

    async def async_hgetall(self, name: str, **kwargs) -> typing.Dict:
        """
        Get all the fields and values in a hash
        """
        return await self.async_client.hgetall(name, **kwargs)

    def hincrby(self, name: str, key: str, amount: int=1, **kwargs) -> int:
        """
        Increment the integer value of a hash field by the given number
        """
        return self.client.hincrby(name, key, amount, **kwargs)

    async def async_hincrby(self, name: str, key: str, amount: int=1, **kwargs) -> int:
        """
        Increment the integer value of a hash field by the given number
        """
        return await self.async_client.hincrby(name, key, amount, **kwargs)

    def hincrbyfloat(self, name: str, key: str, amount: float=1.0, **kwargs) -> float:
        """
        Increment the float value of a hash field by the given amount
        """
        return self.client.hincrbyfloat(name, key, amount, **kwargs)

    async def async_hincrbyfloat(self, name: str, key: str, amount: float=1.0, **kwargs) -> float:
        """
        Increment the float value of a hash field by the given amount
        """
        return await self.async_client.hincrbyfloat(name, key, amount, **kwargs)

    def hkeys(self, name: str, **kwargs) -> typing.List:
        """
        Get all the fields in a hash
        """
        return self.client.hkeys(name, **kwargs)

    async def async_hkeys(self, name: str, **kwargs) -> typing.List:
        """
        Get all the fields in a hash
        """
        return await self.async_client.hkeys(name, **kwargs)

    def hlen(self, name: str, **kwargs) -> int:
        """
        Get the number of fields in a hash
        """
        return self.client.hlen(name, **kwargs)

    async def async_hlen(self, name: str, **kwargs) -> int:
        """
        Get the number of fields in a hash
        """
        return await self.async_client.hlen(name, **kwargs)

    def hmget(self, name: str, keys: typing.List, **kwargs) -> typing.List:
        """
        Get the values of all the given hash fields
        """
        return self.client.hmget(name, keys, **kwargs)

    async def async_hmget(self, name: str, keys: typing.List, **kwargs) -> typing.List:
        """
        Get the values of all the given hash fields
        """
        return await self.async_client.hmget(name, keys, **kwargs)

    def hmset(self, name: str, mapping: typing.Dict, **kwargs) -> bool:
        """
        Set multiple hash fields to multiple values
        """
        return self.client.hmset(name, mapping, **kwargs)

    async def async_hmset(self, name: str, mapping: typing.Dict, **kwargs) -> bool:
        """
        Set multiple hash fields to multiple values
        """
        return await self.async_client.hmset(name, mapping, **kwargs)

    def hset(self, name: str, key: str, value: typing.Any, **kwargs) -> bool:
        """
        Set the string value of a hash field
        """
        return self.client.hset(name, key, value, **kwargs)

    async def async_hset(self, name: str, key: str, value: typing.Any, **kwargs) -> bool:
        """
        Set the string value of a hash field
        """
        return await self.async_client.hset(name, key, value, **kwargs)

    def hsetnx(self, name: str, key: str, value: typing.Any, **kwargs) -> bool:
        """
        Set the value of a hash field, only if the field does not exist
        """
        return self.client.hsetnx(name, key, value, **kwargs)

    async def async_hsetnx(self, name: str, key: str, value: typing.Any, **kwargs) -> bool:
        """
        Set the value of a hash field, only if the field does not exist
        """
        return await self.async_client.hsetnx(name, key, value, **kwargs)

    def hstrlen(self, name: str, key: str, **kwargs) -> int:
        """
        Get the length of the value of a hash field
        """
        return self.client.hstrlen(name, key, **kwargs)

    async def async_hstrlen(self, name: str, key: str, **kwargs) -> int:
        """
        Get the length of the value of a hash field
        """
        return await self.async_client.hstrlen(name, key, **kwargs)

    def hvals(self, name: str, **kwargs) -> typing.List:
        """
        Get all the values in a hash
        """
        return self.client.hvals(name, **kwargs)

    async def async_hvals(self, name: str, **kwargs) -> typing.List:
        """
        Get all the values in a hash
        """
        return await self.async_client.hvals(name, **kwargs)

    def lindex(self, name: str, index: int, **kwargs) -> typing.Any:
        """
        Get an element from a list by its index
        """
        return self.client.lindex(name, index, **kwargs)

    async def async_lindex(self, name: str, index: int, **kwargs) -> typing.Any:
        """
        Get an element from a list by its index
        """
        return await self.async_client.lindex(name, index, **kwargs)

    def linsert(self, name: str, where: str, refvalue: typing.Any, value: typing.Any, **kwargs) -> int:
        """
        Insert an element before or after another element in a list
        """
        return self.client.linsert(name, where, refvalue, value, **kwargs)

    async def async_linsert(self, name: str, where: str, refvalue: typing.Any, value: typing.Any, **kwargs) -> int:
        """
        Insert an element before or after another element in a list
        """
        return await self.async_client.linsert(name, where, refvalue, value, **kwargs)

    def llen(self, name: str, **kwargs) -> int:
        """
        Get the length of a list
        """
        return self.client.llen(name, **kwargs)

    async def async_llen(self, name: str, **kwargs) -> int:
        """
        Get the length of a list
        """
        return await self.async_client.llen(name, **kwargs)

    def lpop(self, name: str, **kwargs) -> typing.Any:
        """
        Remove and get the first element in a list
        """
        return self.client.lpop(name, **kwargs)

    async def async_lpop(self, name: str, **kwargs) -> typing.Any:
        """
        Remove and get the first element in a list
        """
        return await self.async_client.lpop(name, **kwargs)

    def rpop(self, name: str, **kwargs) -> typing.Any:
        """
        Remove and get the last element in a list
        """
        return self.client.rpop(name, **kwargs)

    async def async_rpop(self, name: str, **kwargs) -> typing.Any:
        """
        Remove and get the last element in a list
        """
        return await self.async_client.rpop(name, **kwargs)

    def lpush(self, name: str, *values: typing.Any, **kwargs) -> int:
        """
        Prepend one or multiple values to a list
        """
        return self.client.lpush(name, *values, **kwargs)

    async def async_lpush(self, name: str, *values: typing.Any, **kwargs) -> int:
        """
        Prepend one or multiple values to a list
        """
        return await self.async_client.lpush(name, *values, **kwargs)

    def rpush(self, name: str, *values: typing.Any, **kwargs) -> int:
        """
        Append one or multiple values to a list
        """
        return self.client.rpush(name, *values, **kwargs)

    async def async_rpush(self, name: str, *values: typing.Any, **kwargs) -> int:
        """
        Append one or multiple values to a list
        """
        return await self.async_client.rpush(name, *values, **kwargs)

    def lpushx(self, name: str, value: typing.Any, **kwargs) -> int:
        """
        Prepend a value to a list, only if the list exists
        """
        return self.client.lpushx(name, value, **kwargs)

    async def async_lpushx(self, name: str, value: typing.Any, **kwargs) -> int:
        """
        Prepend a value to a list, only if the list exists
        """
        return await self.async_client.lpushx(name, value, **kwargs)

    def rpushx(self, name: str, value: typing.Any, **kwargs) -> int:
        """
        Append a value to a list, only if the list exists
        """
        return self.client.rpushx(name, value, **kwargs)

    async def async_rpushx(self, name: str, value: typing.Any, **kwargs) -> int:
        """
        Append a value to a list, only if the list exists
        """
        return await self.async_client.rpushx(name, value, **kwargs)

    def lrange(self, name: str, start: int, end: int, **kwargs) -> typing.List:
        """
        Get a range of elements from a list
        """
        return self.client.lrange(name, start, end, **kwargs)

    async def async_lrange(self, name: str, start: int, end: int, **kwargs) -> typing.List:
        """
        Get a range of elements from a list
        """
        return await self.async_client.lrange(name, start, end, **kwargs)

    def lrem(self, name: str, count: int, value: typing.Any, **kwargs) -> int:
        """
        Remove elements from a list
        """
        return self.client.lrem(name, count, value, **kwargs)

    async def async_lrem(self, name: str, count: int, value: typing.Any, **kwargs) -> int:
        """
        Remove elements from a list
        """
        return await self.async_client.lrem(name, count, value, **kwargs)

    def lset(self, name: str, index: int, value: typing.Any, **kwargs) -> bool:
        """
        Set the value of an element in a list by its index
        """
        return self.client.lset(name, index, value, **kwargs)

    async def async_lset(self, name: str, index: int, value: typing.Any, **kwargs) -> bool:
        """
        Set the value of an element in a list by its index
        """
        return await self.async_client.lset(name, index, value, **kwargs)

    def ltrim(self, name: str, start: int, end: int, **kwargs) -> bool:
        """
        Trim a list to the specified range
        """
        return self.client.ltrim(name, start, end, **kwargs)

    async def async_ltrim(self, name: str, start: int, end: int, **kwargs) -> bool:
        """
        Trim a list to the specified range
        """
        return await self.async_client.ltrim(name, start, end, **kwargs)

    def zadd(self, name: str, *args: typing.Any, **kwargs) -> int:
        """
        Add one or more members to a sorted set, or update its score if it already exists
        """
        return self.client.zadd(name, *args, **kwargs)

    async def async_zadd(self, name: str, *args: typing.Any, **kwargs) -> int:
        """
        Add one or more members to a sorted set, or update its score if it already exists
        """

    def zcard(self, name: str, **kwargs) -> int:
        """
        Get the number of members in a sorted set
        """
        return self.client.zcard(name, **kwargs)

    async def async_zcard(self, name: str, **kwargs) -> int:
        """
        Get the number of members in a sorted set
        """
        return await self.async_client.zcard(name, **kwargs)

    def zcount(self, name: str, min: typing.Any, max: typing.Any, **kwargs) -> int:
        """
        Count the members in a sorted set with scores within the given values
        """
        return self.client.zcount(name, min, max, **kwargs)

    async def async_zcount(self, name: str, min: typing.Any, max: typing.Any, **kwargs) -> int:
        """
        Count the members in a sorted set with scores within the given values
        """
        return await self.async_client.zcount(name, min, max, **kwargs)

    def zincrby(self, name: str, amount: float, value: typing.Any, **kwargs) -> float:
        """
        Increment the score of a member in a sorted set
        """
        return self.client.zincrby(name, amount, value, **kwargs)

    async def async_zincrby(self, name: str, amount: float, value: typing.Any, **kwargs) -> float:
        """
        Increment the score of a member in a sorted set
        """
        return await self.async_client.zincrby(name, amount, value, **kwargs)

    def zinterstore(self, dest: str, keys: typing.List[str], aggregate: str=None, **kwargs) -> int:
        """
        Intersect multiple sorted sets and store the resulting sorted set in a new key
        """
        return self.client.zinterstore(dest, keys, aggregate, **kwargs)

    async def async_zinterstore(self, dest: str, keys: typing.List[str], aggregate: str=None, **kwargs) -> int:
        """
        Intersect multiple sorted sets and store the resulting sorted set in a new key
        """
        return await self.async_client.zinterstore(dest, keys, aggregate, **kwargs)

    def zlexcount(self, name: str, min: typing.Any, max: typing.Any, **kwargs) -> int:
        """
        Count the number of members in a sorted set between a given lexicographical range
        """
        return self.client.zlexcount(name, min, max, **kwargs)

    async def async_zlexcount(self, name: str, min: typing.Any, max: typing.Any, **kwargs) -> int:
        """
        Count the number of members in a sorted set between a given lexicographical range
        """
        return await self.async_client.zlexcount(name, min, max, **kwargs)

    def zpopmax(self, name: str, count: int=None, **kwargs) -> typing.List:
        """
        Remove and return members with the highest scores in a sorted set
        """
        return self.client.zpopmax(name, count, **kwargs)

    async def async_zpopmax(self, name: str, count: int=None, **kwargs) -> typing.List:
        """
        Remove and return members with the highest scores in a sorted set
        """
        return await self.async_client.zpopmax(name, count, **kwargs)

    def zpopmin(self, name: str, count: int=None, **kwargs) -> typing.List:
        """
        Remove and return members with the lowest scores in a sorted set
        """
        return self.client.zpopmin(name, count, **kwargs)

    async def async_zpopmin(self, name: str, count: int=None, **kwargs) -> typing.List:
        """
        Remove and return members with the lowest scores in a sorted set
        """
        return await self.async_client.zpopmin(name, count, **kwargs)

    def zrange(self, name: str, start: int, stop: int, desc: bool=False, withscores: bool=False, score_cast_func: typing.Callable=float, **kwargs) -> typing.List:
        """
        Return a range of members in a sorted set, by index
        """
        return self.client.zrange(name, start, stop, desc, withscores, score_cast_func, **kwargs)

    async def async_zrange(self, name: str, start: int, stop: int, desc: bool=False, withscores: bool=False, score_cast_func: typing.Callable=float, **kwargs) -> typing.List:
        """
        Return a range of members in a sorted set, by index
        """
        return await self.async_client.zrange(name, start, stop, desc, withscores, score_cast_func, **kwargs)

    def zrangebylex(self, name: str, min: typing.Any, max: typing.Any, start: int=None, num: int=None, **kwargs) -> typing.List:
        """
        Return a range of members in a sorted set, by lexicographical range
        """
        return self.client.zrangebylex(name, min, max, start, num, **kwargs)

    async def async_zrangebylex(self, name: str, min: typing.Any, max: typing.Any, start: int=None, num: int=None, **kwargs) -> typing.List:
        """
        Return a range of members in a sorted set, by lexicographical range
        """
        return await self.async_client.zrangebylex(name, min, max, start, num, **kwargs)

    def zrangebyscore(self, name: str, min: typing.Any, max: typing.Any, start: int=None, num: int=None, withscores: bool=False, score_cast_func: typing.Callable=float, **kwargs) -> typing.List:
        """
        Return a range of members in a sorted set, by score
        """
        return self.client.zrangebyscore(name, min, max, start, num, withscores, score_cast_func, **kwargs)

    async def async_zrangebyscore(self, name: str, min: typing.Any, max: typing.Any, start: int=None, num: int=None, withscores: bool=False, score_cast_func: typing.Callable=float, **kwargs) -> typing.List:
        """
        Return a range of members in a sorted set, by score
        """
        return await self.async_client.zrangebyscore(name, min, max, start, num, withscores, score_cast_func, **kwargs)

    def zrank(self, name: str, value: typing.Any, **kwargs) -> int:
        """
        Determine the index of a member in a sorted set
        """
        return self.client.zrank(name, value, **kwargs)

    async def async_zrank(self, name: str, value: typing.Any, **kwargs) -> int:
        """
        Determine the index of a member in a sorted set
        """
        return await self.async_client.zrank(name, value, **kwargs)

    def zrem(self, name: str, *values: typing.Any, **kwargs) -> int:
        """
        Remove one or more members from a sorted set
        """
        return self.client.zrem(name, *values, **kwargs)

    async def async_zrem(self, name: str, *values: typing.Any, **kwargs) -> int:
        """
        Remove one or more members from a sorted set
        """
        return await self.async_client.zrem(name, *values, **kwargs)

    def zremrangebylex(self, name: str, min: typing.Any, max: typing.Any, **kwargs) -> int:
        """
        Remove all members in a sorted set between the given lexicographical range
        """
        return self.client.zremrangebylex(name, min, max, **kwargs)

    async def async_zremrangebylex(self, name: str, min: typing.Any, max: typing.Any, **kwargs) -> int:
        """
        Remove all members in a sorted set between the given lexicographical range
        """
        return await self.async_client.zremrangebylex(name, min, max, **kwargs)

    def zremrangebyrank(self, name: str, min: int, max: int, **kwargs) -> int:
        """
        Remove all members in a sorted set within the given indexes
        """
        return self.client.zremrangebyrank(name, min, max, **kwargs)

    async def async_zremrangebyrank(self, name: str, min: int, max: int, **kwargs) -> int:
        """
        Remove all members in a sorted set within the given indexes
        """
        return await self.async_client.zremrangebyrank(name, min, max, **kwargs)

    def zremrangebyscore(self, name: str, min: typing.Any, max: typing.Any, **kwargs) -> int:
        """
        Remove all members in a sorted set within the given scores
        """
        return self.client.zremrangebyscore(name, min, max, **kwargs)

    async def async_zremrangebyscore(self, name: str, min: typing.Any, max: typing.Any, **kwargs) -> int:
        """
        Remove all members in a sorted set within the given scores
        """
        return await self.async_client.zremrangebyscore(name, min, max, **kwargs)

    def zrevrange(self, name: str, start: int, num: int, withscores: bool=False, score_cast_func: typing.Callable=float, **kwargs) -> typing.List:
        """
        Return a range of members in a sorted set, by index, with scores ordered from high to low
        """
        return self.client.zrevrange(name, start, num, withscores, score_cast_func, **kwargs)

    async def async_zrevrange(self, name: str, start: int, num: int, withscores: bool=False, score_cast_func: typing.Callable=float, **kwargs) -> typing.List:
        """
        Return a range of members in a sorted set, by index, with scores ordered from high to low
        """
        return await self.async_client.zrevrange(name, start, num, withscores, score_cast_func, **kwargs)

    def zrevrangebylex(self, name: str, max: typing.Any, min: typing.Any, start: int=None, num: int=None, **kwargs) -> typing.List:
        """
        Return a range of members in a sorted set, by lexicographical range, ordered from higher to lower strings.
        """
        return self.client.zrevrangebylex(name, max, min, start, num, **kwargs)

    async def async_zrevrangebylex(self, name: str, max: typing.Any, min: typing.Any, start: int=None, num: int=None, **kwargs) -> typing.List:
        """
        Return a range of members in a sorted set, by lexicographical range, ordered from higher to lower strings.
        """
        return await self.async_client.zrevrangebylex(name, max, min, start, num, **kwargs)

    def zrevrangebyscore(self, name: str, max: typing.Any, min: typing.Any, start: int=None, num: int=None, withscores: bool=False, score_cast_func: typing.Callable=float, **kwargs) -> typing.List:
        """
        Return a range of members in a sorted set, by score, with scores ordered from high to low
        """
        return self.client.zrevrangebyscore(name, max, min, start, num, withscores, score_cast_func, **kwargs)

    async def async_zrevrangebyscore(self, name: str, max: typing.Any, min: typing.Any, start: int=None, num: int=None, withscores: bool=False, score_cast_func: typing.Callable=float, **kwargs) -> typing.List:
        """
        Return a range of members in a sorted set, by score, with scores ordered from high to low
        """
        return await self.async_client.zrevrangebyscore(name, max, min, start, num, withscores, score_cast_func, **kwargs)

    def zrevrank(self, name: str, value: typing.Any, **kwargs) -> int:
        """
        Determine the index of a member in a sorted set, with scores ordered from high to low
        """
        return self.client.zrevrank(name, value, **kwargs)

    async def async_zrevrank(self, name: str, value: typing.Any, **kwargs) -> int:
        """
        Determine the index of a member in a sorted set, with scores ordered from high to low
        """
        return await self.async_client.zrevrank(name, value, **kwargs)

    def zscore(self, name: str, value: typing.Any, **kwargs) -> float:
        """
        Get the score associated with the given member in a sorted set
        """
        return self.client.zscore(name, value, **kwargs)

    async def async_zscore(self, name: str, value: typing.Any, **kwargs) -> float:
        """
        Get the score associated with the given member in a sorted set
        """
        return await self.async_client.zscore(name, value, **kwargs)

    def zunionstore(self, dest: str, keys: typing.List[str], aggregate: str=None, **kwargs) -> int:
        """
        Add multiple sorted sets and store the resulting sorted set in a new key
        """
        return self.client.zunionstore(dest, keys, aggregate, **kwargs)

    async def async_zunionstore(self, dest: str, keys: typing.List[str], aggregate: str=None, **kwargs) -> int:
        """
        Add multiple sorted sets and store the resulting sorted set in a new key
        """
        return await self.async_client.zunionstore(dest, keys, aggregate, **kwargs)

    def scan(self, cursor: int=0, match: str=None, count: int=None, **kwargs) -> typing.Tuple[int, typing.List]:
        """
        Incrementally iterate the keys space
        """
        return self.client.scan(cursor, match, count, **kwargs)

    async def async_scan(self, cursor: int=0, match: str=None, count: int=None, **kwargs) -> typing.Tuple[int, typing.List]:
        """
        Incrementally iterate the keys space
        """
        return await self.async_client.scan(cursor, match, count, **kwargs)

    def sscan(self, name: str, cursor: int=0, match: str=None, count: int=None, **kwargs) -> typing.Tuple[int, typing.List]:
        """
        Incrementally iterate Set elements
        """
        return self.client.sscan(name, cursor, match, count, **kwargs)

    async def async_sscan(self, name: str, cursor: int=0, match: str=None, count: int=None, **kwargs) -> typing.Tuple[int, typing.List]:
        """
        Incrementally iterate Set elements
        """
        return await self.async_client.sscan(name, cursor, match, count, **kwargs)

    def hscan(self, name: str, cursor: int=0, match: str=None, count: int=None, **kwargs) -> typing.Tuple[int, typing.List]:
        """
        Incrementally iterate hash fields and associated values
        """
        return self.client.hscan(name, cursor, match, count, **kwargs)

    async def async_hscan(self, name: str, cursor: int=0, match: str=None, count: int=None, **kwargs) -> typing.Tuple[int, typing.List]:
        """
        Incrementally iterate hash fields and associated values
        """
        return await self.async_client.hscan(name, cursor, match, count, **kwargs)

    def zscan(self, name: str, cursor: int=0, match: str=None, count: int=None, score_cast_func: typing.Callable=float, **kwargs) -> typing.Tuple[int, typing.List]:
        """
        Incrementally iterate sorted sets elements and associated scores
        """
        return self.client.zscan(name, cursor, match, count, score_cast_func, **kwargs)

    async def async_zscan(self, name: str, cursor: int=0, match: str=None, count: int=None, score_cast_func: typing.Callable=float, **kwargs) -> typing.Tuple[int, typing.List]:
        """
        Incrementally iterate sorted sets elements and associated scores
        """
        return await self.async_client.zscan(name, cursor, match, count, score_cast_func, **kwargs)

    def scan_iter(self, match: typing.Union[PatternT, None]=None, count: typing.Union[int, None]=None, _type: typing.Union[str, None]=None, **kwargs) -> typing.Iterator:
        """
    ...
    async def async_scan_iter(self, match: typing.Union[PatternT, None]=None, count: typing.Union[int, None]=None, _type: typing.Union[str, None]=None, **kwargs) -> typing.AsyncIterator:
        """
        Make an iterator using the SCAN command so that the client doesn't
        need to remember the cursor position.
    ...
    def zunion(self, name: str, keys: typing.List[str], aggregate: str=None, **kwargs) -> typing.List:
        """
        Add multiple sorted sets and store the resulting sorted set in a new key
        """
        return self.client.zunion(name, keys, aggregate, **kwargs)

    async def async_zunion(self, name: str, keys: typing.List[str], aggregate: str=None, **kwargs) -> typing.List:
        """
        Add multiple sorted sets and store the resulting sorted set in a new key
        """
        return await self.async_client.zunion(name, keys, aggregate, **kwargs)

    def zinter(self, name: str, keys: typing.List[str], aggregate: str=None, **kwargs) -> typing.List:
        """
        Intersect multiple sorted sets and store the resulting sorted set in a new key
        """
        return self.client.zinter(name, keys, aggregate, **kwargs)

    async def async_zinter(self, name: str, keys: typing.List[str], aggregate: str=None, **kwargs) -> typing.List:
        """
        Intersect multiple sorted sets and store the resulting sorted set in a new key
        """
        return await self.async_client.zinter(name, keys, aggregate, **kwargs)

    def lmove(self, source_list: str, destination_list: str, source: typing.Optional[str]='LEFT', destination: typing.Optional[str]='RIGHT', **kwargs) -> typing.Any:
        """
        Pop a value from a list, push it to another list and return it
        """
        return self.client.lmove(source_list, destination_list, source, destination, **kwargs)

    async def async_lmove(self, source_list: str, destination_list: str, source: typing.Optional[str]='LEFT', destination: typing.Optional[str]='RIGHT', **kwargs) -> typing.Any:
        """
        Pop a value from a list, push it to another list and return it
        """
        return await self.async_client.lmove(source_list, destination_list, source, destination, **kwargs)

    def blmove(self, source_list: str, destination_list: str, source: typing.Optional[str]='LEFT', destination: typing.Optional[str]='RIGHT', timeout: int=0, **kwargs) -> typing.Any:
        """
        Pop a value from a list, push it to another list and return it; or block until one is available
        """
        return self.client.blmove(source_list, destination_list, timeout, source, destination, **kwargs)

    async def async_blmove(self, source_list: str, destination_list: str, source: typing.Optional[str]='LEFT', destination: typing.Optional[str]='RIGHT', timeout: int=0, **kwargs) -> typing.Any:
        """
        Pop a value from a list, push it to another list and return it; or block until one is available
        """
        return await self.async_client.blmove(source_list, destination_list, timeout, source, destination, **kwargs)

    def brpoplpush(self, source: str, destination: str, timeout: int=0, **kwargs) -> typing.Any:
        """
        Pop a value from a list, push it to another list and return it; or block until one is available
        """
        return self.client.brpoplpush(source, destination, timeout, **kwargs)

    async def async_brpoplpush(self, source: str, destination: str, timeout: int=0, **kwargs) -> typing.Any:
        """
        Pop a value from a list, push it to another list and return it; or block until one is available
        """
    ...
    async def async_execute_command(self, *args, **kwargs) -> typing.Any:
        """
        Execute a command
        """
        return await self.async_client.execute_command(*args, **kwargs)

    def replicaof(self, host: str, port: typing.Optional[int]=6379, **kwargs) -> bool:
        """
        Make the server a replica of another instance, or promote it as master
        """
        return self.client.replicaof(host, port, **kwargs)

    async def async_replicaof(self, host: str, port: typing.Optional[int]=6379, **kwargs) -> bool:
        """
        Make the server a replica of another instance, or promote it as master
        """
    ...
    def sadd(self, name: str, *values: typing.Any, _serialize: typing.Optional[bool]=True, _serializer: typing.Optional[typing.Callable]=None, **kwargs) -> int:
        """
        Add one or more members to a set
        """
        if _serialize:
            values = [self.serialize(value, _serializer, **kwargs) for value in values]
        return self.client.sadd(name, *values, **kwargs)

    async def async_sadd(self, name: str, *values: typing.Any, _serialize: typing.Optional[bool]=True, _serializer: typing.Optional[typing.Callable]=None, **kwargs) -> int:
        """
        Add one or more members to a set
        """
        if _serialize:
    ...
    def scard(self, name: str, **kwargs) -> int:
        """
        Get the number of members in a set
        """
        return self.client.scard(name, **kwargs)

    async def async_scard(self, name: str, **kwargs) -> int:
        """
        Get the number of members in a set
        """
        return await self.async_client.scard(name, **kwargs)

    def sdiff(self, keys: typing.Union[str, typing.Iterable], *args: typing.Any, _return_raw_values: typing.Optional[bool]=None, _serializer: typing.Optional[typing.Callable]=None, **kwargs) -> typing.Set:
        """
        Subtract multiple sets and return the resulting set
        """
        values = self.client.sdiff(keys, *args, **kwargs)
        if _return_raw_values:
            return values
        return {self.deserialize(value, _serializer, **kwargs) for value in values}

    async def async_sdiff(self, keys: typing.Union[str, typing.Iterable], *args: typing.Any, _return_raw_values: typing.Optional[bool]=None, _serializer: typing.Optional[typing.Callable]=None, **kwargs) -> typing.Set:
        """
        Subtract multiple sets and return the resulting set
        """
    ...
    def sdiffstore(self, destination: str, keys: typing.Union[str, typing.Iterable], *args: typing.Any, **kwargs) -> int:
        """
        Subtract multiple sets and store the resulting set in a key
        """
        return self.client.sdiffstore(destination, keys, *args, **kwargs)

    async def async_sdiffstore(self, destination: str, keys: typing.Union[str, typing.Iterable], *args: typing.Any, **kwargs) -> int:
        """
        Subtract multiple sets and store the resulting set in a key
        """
        return await self.async_client.sdiffstore(destination, keys, *args, **kwargs)

    def sinter(self, keys: typing.Union[str, typing.Iterable], *args: typing.Any, _return_raw_values: typing.Optional[bool]=None, _serializer: typing.Optional[typing.Callable]=None, **kwargs) -> typing.Set:
        """
    ...
    async def async_sinter(self, keys: typing.Union[str, typing.Iterable], *args: typing.Any, _return_raw_values: typing.Optional[bool]=None, _serializer: typing.Optional[typing.Callable]=None, **kwargs) -> typing.Set:
        """
        Intersect multiple sets
        """
    ...
    def sinterstore(self, destination: str, keys: typing.Union[str, typing.Iterable], *args: typing.Any, **kwargs) -> int:
        """
        Intersect multiple sets and store the resulting set in a key
        """
        return self.client.sinterstore(destination, keys, *args, **kwargs)

    async def async_sinterstore(self, destination: str, keys: typing.Union[str, typing.Iterable], *args: typing.Any, **kwargs) -> int:
        """
        Intersect multiple sets and store the resulting set in a key
        """
        return await self.async_client.sinterstore(destination, keys, *args, **kwargs)

    def sismember(self, name: str, value: typing.Any, _serialize: typing.Optional[bool]=True, _serializer: typing.Optional[typing.Callable]=None, **kwargs) -> bool:
        """
    ...
    async def async_sismember(self, name: str, value: typing.Any, _serialize: typing.Optional[bool]=True, _serializer: typing.Optional[typing.Callable]=None, **kwargs) -> bool:
        """
        Determine if a given value is a member of a set
        """
        if _serialize:
    ...
    def smembers(self, name: str, _return_raw_values: typing.Optional[bool]=None, _serializer: typing.Optional[typing.Callable]=None, **kwargs) -> typing.Set:
        """
    ...
    async def async_smembers(self, name: str, _return_raw_values: typing.Optional[bool]=None, _serializer: typing.Optional[typing.Callable]=None, **kwargs) -> typing.Set:
        """
        Get all the members in a set
        """
    ...
    def smove(self, source: str, destination: str, value: typing.Any, _serialize: typing.Optional[bool]=True, _serializer: typing.Optional[typing.Callable]=None, **kwargs) -> bool:
        """
    ...
    async def async_smove(self, source: str, destination: str, value: typing.Any, _serialize: typing.Optional[bool]=True, _serializer: typing.Optional[typing.Callable]=None, **kwargs) -> bool:
        """
        Move a member from one set to another
        """
        if _serialize:
    ...
    def spop(self, name: str, count: typing.Optional[int]=None, _return_raw_values: typing.Optional[bool]=None, _serializer: typing.Optional[typing.Callable]=None, **kwargs) -> typing.Union[typing.Any, typing.List]:
        """
    ...
    async def async_spop(self, name: str, count: typing.Optional[int]=None, _return_raw_values: typing.Optional[bool]=None, _serializer: typing.Optional[typing.Callable]=None, **kwargs) -> typing.Union[typing.Any, typing.List]:
        """
        Remove and return one or multiple random members from a set
        """
    ...
    def srandmember(self, name: str, count: typing.Optional[int]=None, _return_raw_values: typing.Optional[bool]=None, _serializer: typing.Optional[typing.Callable]=None, **kwargs) -> typing.Union[typing.Any, typing.List]:
        """
    ...
    async def async_srandmember(self, name: str, count: typing.Optional[int]=None, _return_raw_values: typing.Optional[bool]=None, _serializer: typing.Optional[typing.Callable]=None, **kwargs) -> typing.Union[typing.Any, typing.List]:
        """
        Get one or multiple random members from a set
        """
    ...
    def srem(self, name: str, *values: typing.Any, _serialize: typing.Optional[bool]=True, _serializer: typing.Optional[typing.Callable]=None, **kwargs) -> int:
        """
    ...
    async def async_srem(self, name: str, *values: typing.Any, _serialize: typing.Optional[bool]=True, _serializer: typing.Optional[typing.Callable]=None, **kwargs) -> int:
        """
        Remove one or more members from a set
        """
        if _serialize:
    ...
    def sunion(self, *names: str, _return_raw_values: typing.Optional[bool]=None, _serializer: typing.Optional[typing.Callable]=None, **kwargs) -> typing.Set:
        """
    ...
    async def async_sunion(self, *names: str, _return_raw_values: typing.Optional[bool]=None, _serializer: typing.Optional[typing.Callable]=None, **kwargs) -> typing.Set:
        """
        Return the union of multiple sets
        """
    ...
    def sunionstore(self, destination: str, *names: str, **kwargs) -> int:
        """
        Store the union of multiple sets in a key
        """
        return self.client.sunionstore(destination, *names, **kwargs)

    async def async_sunionstore(self, destination: str, *names: str, **kwargs) -> int:
        """
        Store the union of multiple sets in a key
        """
    ...
    def transaction(self, func: Pipeline, *watches: typing.Any, **kwargs) -> typing.List:
        """
        Run a transaction
        """
        return self.client.transaction(func, *watches, **kwargs)

    async def async_transaction(self, func: AsyncPipeline, *watches: typing.Any, **kwargs) -> typing.List:
        """
        Run a transaction
        """
        return await self.async_client.transaction(func, *watches, **kwargs)

    def config_get(self, pattern: str, **kwargs) -> typing.Dict:
        """
        Get the value of a configuration parameter
        """
        return self.client.config_get(pattern, **kwargs)

    async def async_config_get(self, pattern: str, **kwargs) -> typing.Dict:
        """
        Get the value of a configuration parameter
        """
        return await self.async_client.config_get(pattern, **kwargs)

    def config_set(self, name: str, value: typing.Any, **kwargs) -> bool:
        """
        Set a configuration parameter to the given value
        """
        return self.client.config_set(name, value, **kwargs)

    async def async_config_set(self, name: str, value: typing.Any, **kwargs) -> bool:
        """
        Set a configuration parameter to the given value
        """
    ...
    def keys(self, pattern: typing.Optional[str]=None, **kwargs) -> typing.List[KeyT]:
        """
        Get a List of all keys
        """
        return self.client.keys(pattern=pattern, **kwargs)

    async def async_keys(self, pattern: typing.Optional[str]=None, **kwargs) -> typing.List[KeyT]:
        """
        Get a List of all keys
        """
    ...
    def info(self, section: typing.Optional[str]=None, *args, **kwargs):
        """
        Return information and statistics about the server
        """
        return self.client.info(*args, section=section, **kwargs)

    async def async_info(self, section: typing.Optional[str]=None, *args, **kwargs):
        """
        Return information and statistics about the server
        """
        return await self.async_client.info(*args, section=section, **kwargs)

    def move(self, key: KeyT, db: int, **kwargs) -> bool:
        """
        Move a key to another database
        """
        return self.client.move(key, db, **kwargs)

    async def async_move(self, key: KeyT, db: int, **kwargs) -> bool:
        """
        Move a key to another database
        """
        return await self.async_client.move(key, db, **kwargs)

    def rename(self, key: KeyT, newkey: KeyT, **kwargs) -> bool:
        """
        Rename a key
        """
        return self.client.rename(key, newkey, **kwargs)

    async def async_rename(self, key: KeyT, newkey: KeyT, **kwargs) -> bool:
        """
        Rename a key
        """
        return await self.async_client.rename(key, newkey, **kwargs)

    def renamenx(self, key: KeyT, newkey: KeyT, **kwargs) -> bool:
        """
        Rename a key, only if the new key does not exist
        """
        return self.client.renamenx(key, newkey, **kwargs)

    async def async_renamenx(self, key: KeyT, newkey: KeyT, **kwargs) -> bool:
        """
        Rename a key, only if the new key does not exist
        """
        return await self.async_client.renamenx(key, newkey, **kwargs)

    def migrate(self, session: typing.Optional[typing.Type['KeyDBSession']]=None, host: typing.Optional[str]=None, port: typing.Optional[int]=None, keys: typing.Optional[typing.Union[KeyT, typing.List[KeyT]]]=None, destination_db: typing.Optional[int]=None, timeout: typing.Optional[int]=None, copy: typing.Optional[bool]=None, replace: typing.Optional[bool]=None, auth: typing.Optional[str]=None, **kwargs):
        """
        ...
        return self.client.migrate(session=session, host=host, port=port, keys=keys, destination_db=destination_db, timeout=timeout, copy=copy, replace=replace, auth=auth, **kwargs)

    async def async_migrate(self, session: typing.Optional[typing.Type['KeyDBSession']]=None, host: typing.Optional[str]=None, port: typing.Optional[int]=None, keys: typing.Optional[typing.Union[KeyT, typing.List[KeyT]]]=None, destination_db: typing.Optional[int]=None, timeout: typing.Optional[int]=None, copy: typing.Optional[bool]=None, replace: typing.Optional[bool]=None, auth: typing.Optional[str]=None, **kwargs):
        """
        Migrate a key to a different KeyDB instance
        """
        if session:
            ...
            auth = auth if auth is not None else session.uri.auth_str
            destination_db = destination_db if destination_db is not None else session.uri.db_id
        return await self.async_client.migrate(session=session, host=host, port=port, keys=keys, destination_db=destination_db, timeout=timeout, copy=copy, replace=replace, auth=auth, **kwargs)
    ...
    def module_load(self, path: str, **kwargs):
        """
        Load a module
        """
        return self.client.module_load(path, **kwargs)

    async def async_module_load(self, path: str, **kwargs):
        """
        Load a module
        """
        return await self.async_client.module_load(path, **kwargs)

    def module_loadex(self, path: str, options: typing.Optional[typing.List[str]]=None, args: typing.Optional[typing.List[str]]=None, **kwargs):
        """
        Load a module
        """
        return self.client.module_loadex(path, options=options, args=args, **kwargs)

    async def async_module_loadex(self, path: str, options: typing.Optional[typing.List[str]]=None, args: typing.Optional[typing.List[str]]=None, **kwargs):
        """
        Load a module
        """
        return await self.async_client.module_loadex(path, options=options, args=args, **kwargs)

    def module_unload(self, name: str, **kwargs):
        """
        Unload a module
        """
        return self.client.module_unload(name, **kwargs)

    async def async_module_unload(self, name: str, **kwargs):
        """
        Unload a module
        """
    ...
    async def async_wait_for_ready(self, interval: int=1.0, max_attempts: typing.Optional[int]=None, timeout: typing.Optional[float]=60.0, verbose: bool=False, **kwargs):
        if self.state.active:
            return
        attempts = 0
        start_time = time.time()
    ...
    def cachify(self, cache_ttl: int=None, typed: bool=False, cache_prefix: str=None, exclude: typing.List[str]=None, exclude_null: typing.Optional[bool]=False, exclude_return_types: typing.Optional[typing.List[type]]=None, exclude_return_objs: typing.Optional[typing.List[typing.Any]]=None, exclude_kwargs: typing.Optional[typing.List[str]]=None, include_cache_hit: typing.Optional[bool]=False, invalidate_cache_key: typing.Optional[str]=None, _no_cache: typing.Optional[bool]=False, _no_cache_kwargs: typing.Optional[typing.List[str]]=None, _no_cache_validator: typing.Optional[typing.Callable]=None, _func_name: typing.Optional[str]=None, _validate_requests: typing.Optional[bool]=True, _exclude_request_headers: typing.Optional[typing.Union[typing.List[str], bool]]=True, _cache_invalidator: typing.Optional[typing.Union[bool, typing.Callable]]=None, _invalidate_after_n_hits: typing.Optional[int]=None, _cache_timeout: typing.Optional[float]=5.0, **kwargs):
        ...
        def decorator(func):
            ...
            return wrapper_builder(self, func, base, cache_ttl=cache_ttl, typed=typed, cache_prefix=cache_prefix, exclude=exclude, exclude_null=exclude_null, exclude_return_types=exclude_return_types, exclude_return_objs=exclude_return_objs, exclude_kwargs=exclude_kwargs, include_cache_hit=include_cache_hit, invalidate_cache_key=invalidate_cache_key, _no_cache=_no_cache, _no_cache_kwargs=_no_cache_kwargs, _no_cache_validator=_no_cache_validator, _validate_requests=_validate_requests, _exclude_request_headers=_exclude_request_headers, _cache_invalidator=_cache_invalidator, _invalidate_after_n_hits=_invalidate_after_n_hits, _cache_timeout=_cache_timeout, **kwargs)
        return decorator
    ...
    async def _async_get_stats(self) -> typing.Dict[str, typing.Any]:
        stats = {'pool': getattr(self.client.connection_pool, '_stats', {}), 'apool': getattr(self.async_client.connection_pool, '_stats', {})}
        _info = await self.async_info()
        for key in {'maxclients', 'connected_clients', 'used_memory', 'used_memory_human', 'used_memory_peak_human', 'used_memory_peak_perc', 'maxmemory', 'maxmemory_human', 'maxmemory_policy', 'total_system_memory', 'total_system_memory_human', 'instantaneous_input_kbps', 'instantaneous_output_kbps'}:
            if key in _info:
                stats[key] = _info[key]
    ...
    async def async_get_key_sizes(self, match: typing.Union[PatternT, None]=None, count: typing.Union[int, None]=None, _type: typing.Union[str, None]=None, min_size: typing.Union[ByteSize, int, str, None]=None, max_size: typing.Union[ByteSize, int, str, None]=None, raise_error: typing.Optional[bool]=False, parse: typing.Optional[bool]=True, verbose: typing.Optional[bool]=True, **kwargs) -> typing.AsyncIterator[typing.Tuple[bytes, typing.Union[ByteSize, int]]]:
        """
        Returns an iterator that yields a tuple of key name and size in bytes or a ByteSize object
        """
        if min_size is not None and (not isinstance(min_size, ByteSize)):
    ...
    async def _async_cli(self, args: typing.Union[str, typing.List[str]], stdout=asyncio.subprocess.PIPE, stderr=asyncio.subprocess.PIPE, output_encoding: str='UTF-8', output_errors: str='ignore', entrypoint: str='keydb-cli', **kwargs) -> str:
        """
        Runs a CLI command on the server
        """
        base_args = self.uri.connection_args.copy()
