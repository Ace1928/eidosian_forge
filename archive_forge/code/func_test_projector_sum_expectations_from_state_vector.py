...
def test_projector_sum_expectations_from_state_vector():
    ...
    np.testing.assert_allclose(proj_sum.expectation_from_state_vector(random_state_vector, qid_map={q0: 0}), 0.6 * zero_projector_sum.expectation_from_state_vector(random_state_vector, qid_map={q0: 0}) + 0.4 * one_projector_sum.expectation_from_state_vector(random_state_vector, qid_map={q0: 0}))