...
class WorkflowRun(CompletableGithubObject):
    ...
    def timing(self) -> TimingData:
        ...
        return TimingData(billable=data['billable'], run_duration_ms=data['run_duration_ms'])
    ...
    def jobs(self, _filter: Opt[str]=NotSet) -> PaginatedList[WorkflowJob]:
        ...
        return PaginatedList(github.WorkflowJob.WorkflowJob, self._requester, self.jobs_url, url_parameters, list_item='jobs')
    ...
    def _useAttributes(self, attributes: dict[str, Any]) -> None:
        ...
        if 'run_started_at' in attributes:
        ...
        if 'head_repository' in attributes:
            self._head_repository = self._makeClassAttribute(github.Repository.Repository, attributes['head_repository'])