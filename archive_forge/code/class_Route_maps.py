...
class Route_maps(ResourceModule):
    ...
    def __init__(self, module):
        super(Route_maps, self).__init__(empty_fact_val=[], facts_module=Facts(module), module=module, resource='route_maps', tmplt=Route_mapsTemplate())
        self.parsers = ['call', 'description', 'action', 'continue_sequence', 'set_aggregator_ip', 'set_aggregator_as', 'set_as_path_exclude', 'set_as_path_prepend', 'set_atomic_aggregate', 'set_bgp_extcommunity_rt', 'set_extcommunity_rt', 'set_extcommunity_soo', 'set_ip_next_hop', 'set_ipv6_next_hop', 'set_large_community', 'set_local_preference', 'set_metric', 'set_metric_type', 'set_origin', 'set_originator_id', 'set_src', 'set_tag', 'set_weight', 'set_comm_list', 'set_comm_list_delete', 'set_community', 'match_as_path', 'match_community_community_list', 'match_community_exact_match', 'match_extcommunity', 'match_interface', 'match_large_community_large_community_list', 'match_metric', 'match_origin', 'match_peer', 'match_ip_address', 'match_ip_next_hop', 'match_ip_route_source', 'on_match_goto', 'on_match_next', 'match_ipv6_address', 'match_ipv6_nexthop', 'match_rpki']
