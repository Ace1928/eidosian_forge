...
def generate_pgroups_dict(module, array):
    ...
    for pgroup in range(0, len(pgroups)):
        ...
        pgroups_info[protgroup] = {'hgroups': pgroups[pgroup]['hgroups'], 'hosts': pgroups[pgroup]['hosts'], 'source': pgroups[pgroup]['source'], 'targets': pgroups[pgroup]['targets'], 'volumes': pgroups[pgroup]['volumes']}
        try:
