...
class NetworkSecurityManager(BaseManager):
    ...
    def update_on_device(self):
        ...
        uri = 'https://{0}:{1}/mgmt/tm/security/dos/profile/{2}/dos-network/{3}'.format(self.client.provider['server'], self.client.provider['server_port'], transform_name(self.want.partition, self.want.profile), self.want.profile)
    ...
    def create_vector_container_on_device(self):
        ...
        uri = 'https://{0}:{1}/mgmt/tm/security/dos/profile/{2}/dos-network/'.format(self.client.provider['server'], self.client.provider['server_port'], transform_name(self.want.partition, self.want.profile))
