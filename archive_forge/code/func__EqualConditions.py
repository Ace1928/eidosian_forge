...
def _EqualConditions(binding_condition, input_condition):
    ...
    if binding_condition is None or input_condition is None:
        return False
    return binding_condition.expression == input_condition.get('expression') and binding_condition.title == input_condition.get('title') and (binding_condition.description == input_condition.get('description'))