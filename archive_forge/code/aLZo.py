...
class FileProcessor:
    ...
    This class uses modular functions to support easy maintenance and scalability.
    """

    def __init__(self, folder_path: str):
        """
        Initializes the FileProcessor with the path to the folder containing documents.
        :param folder_path: str - Path to the directory containing the files to be processed.
        """
    ...
    def _list_files(self) -> List[str]:
        ...
        Filters out unsupported file types and hidden files.
    ...
    def _read_markdown_file(self, file_path: str) -> str:
        ...
        :param file_path: str - The path to the markdown file.
        :return: str - The content of the file.
        """
        with open(file_path, "r", encoding="utf-8") as file:
            return file.read()
