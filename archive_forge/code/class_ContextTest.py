...
class ContextTest(test_base.BaseTestCase):
    ...
    def test_from_dict(self):
        dct = {'auth_token': 'token1', 'user': 'user1', 'user_name': 'user1_name', 'project_id': 'tenant1', 'project_name': 'tenant1_name', 'domain': 'domain1', 'domain_name': 'domain1_name', 'user_domain': 'user_domain1', 'user_domain_name': 'user_domain1_name', 'project_domain': 'project_domain1', 'project_domain_name': 'project_domain1_name', 'is_admin': True, 'read_only': True, 'show_deleted': True, 'request_id': 'request1', 'global_request_id': 'req-uuid', 'resource_uuid': 'instance1', 'extra_data': 'foo', 'system_scope': 'all'}
    ...
    def test_from_environ_variables(self):
        ...
        self.assertEqual(service_user_domain_name, ctx.service_user_domain_name)
        self.assertEqual(service_project_id, ctx.service_project_id)
        self.assertEqual(service_project_name, ctx.service_project_name)
        self.assertEqual(service_project_domain_id, ctx.service_project_domain_id)
        self.assertEqual(service_project_domain_name, ctx.service_project_domain_name)
    ...
    def test_values(self):
        ...
        user_identity = '%s %s %s %s %s' % (user_id, project_id, domain_id, user_domain_id, project_domain_id)
