    ...
    if op_schema.op in self.op_strategy_funcs:
        ...
        if isinstance(op_strategy, OpStrategy):
            ...
            if op_schema.return_type_tuple_tensors():
                output_spec: OutputSpecType = tuple([DTensorSpec(mesh=output_strategy.output_spec.mesh, placements=output_strategy.output_spec.placements, tensor_meta=output_strategy.output_spec.tensor_meta) for _ in range(len(op_schema.op._schema.returns))])
