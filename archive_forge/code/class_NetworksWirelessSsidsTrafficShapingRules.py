...
class NetworksWirelessSsidsTrafficShapingRules(object):
    ...
    def __init__(self, params, meraki):
        self.meraki = meraki
        self.new_object = dict(trafficShapingEnabled=params.get('trafficShapingEnabled'), defaultRulesEnabled=params.get('defaultRulesEnabled'), rules=params.get('rules'), network_id=params.get('networkId'), number=params.get('number'))
    ...
    def get_object_by_name(self, name):
        result = None
        try:
            items = self.meraki.exec_meraki(family='wireless', function='getNetworkWirelessSsidTrafficShapingRules', params=self.get_all_params(name=name))
    ...
    def requires_update(self, current_obj):
        ...
        obj_params = [('trafficShapingEnabled', 'trafficShapingEnabled'), ('defaultRulesEnabled', 'defaultRulesEnabled'), ('rules', 'rules'), ('networkId', 'networkId'), ('number', 'number')]
    ...
    def update(self):
        ...
        name = self.new_object.get('name')
        result = None
        result = self.meraki.exec_meraki(family='wireless', function='updateNetworkWirelessSsidTrafficShapingRules', params=self.update_all_params(), op_modifies=True)
        return result