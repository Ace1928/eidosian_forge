...
class RunQueueItemFileSaver:
    ...
    def __init__(self, agent_run: Optional[Union['wandb.sdk.wandb_run.Run', 'wandb.sdk.lib.RunDisabled']], run_queue_item_id: str):
        self.run_queue_item_id = run_queue_item_id
        self.run = agent_run

    def save_contents(self, contents: str, fname: str, file_sub_type: FileSubtypes) -> Optional[List[str]]:
