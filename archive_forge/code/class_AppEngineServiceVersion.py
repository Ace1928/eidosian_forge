...
class AppEngineServiceVersion(IapIamResource):
  ...
  """
    ...
    def _Parse(self):
        ...
        return self.registry.Parse(None, params={'project': project.projectNumber, 'iapWebId': _AppEngineAppId(project.projectId), 'serviceId': self.service_id, 'versionId': self.version_id}, collection=IAP_WEB_SERVICES_VERSIONS_COLLECTION)