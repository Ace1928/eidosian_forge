...
class AzureAiServicesTextAnalyticsForHealthTool(BaseTool):
    ...
    description: str = 'A wrapper around Azure AI Services Text Analytics for Health. Useful for when you need to identify entities in healthcare data. Input should be text.'
    ...
    def validate_environment(cls, values: Dict) -> Dict:
        ...
        try:
            ...
            values['text_analytics_client'] = sdk.TextAnalyticsClient(endpoint=azure_ai_services_endpoint, credential=AzureKeyCredential(azure_ai_services_key))
        except ImportError:
            raise ImportError('azure-ai-textanalytics is not installed. Run `pip install azure-ai-textanalytics` to install.')
        return values
