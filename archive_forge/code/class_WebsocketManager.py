...
class WebsocketManager(ChatServiceManager):
    ...
    def start_task(self):
        ...
        tornado.ioloop.PeriodicCallback(callback=self._manager_loop_fn, callback_time=callback_time).start()
    ...
    def _make_app(self):
        ...
        return tornado.web.Application([('/websocket', MessageSocketHandler, {'subs': self.subs, 'message_callback': message_callback})], debug=self.debug)
