...
def evaluate_first_stage_var_shift(current_master_fsv_vals, previous_master_fsv_vals, first_iter_master_fsv_vals):
    """
    ...
    if not current_master_fsv_vals:
        ...
        return max((abs(current_master_fsv_vals[var] - previous_master_fsv_vals[var]) / max((abs(first_iter_master_fsv_vals[var]), 1)) for var in previous_master_fsv_vals))