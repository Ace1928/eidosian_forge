...
class ResultOfCoroutineAssertionsTests(unittest.SynchronousTestCase):
    ...
    def test_successResultOfWithException(self):
        ...
        """
        self.assertRaises(self.failureException, self.successResultOf, self.raisesException())
    ...
    def test_failureResultOfWithoutResult(self):
        ...
        with no current result.
        """
        self.assertRaises(self.failureException, self.failureResultOf, self.noCurrentResult())
    ...
    def test_failureResultOfWithSuccess(self):
        ...
        """
        self.assertRaises(self.failureException, self.failureResultOf, self.successResult())
    ...
    def test_failureResultOfWithException(self):
        ...
        """
        self.assertEqual(self.failure.value, self.failureResultOf(self.raisesException()).value)
