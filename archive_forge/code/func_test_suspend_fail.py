...
def test_suspend_fail(self):
    ...
    self.stack = stack.Stack(self.ctx, 'suspend_test_fail', template.Template(tmpl))
    self.stack.store()
    self.stack.create()
    ...
    self.assertEqual('Resource SUSPEND failed: Exception: resources.AResource: foo', self.stack.status_reason)
