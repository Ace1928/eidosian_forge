...
def create_one_aggregate(attrs=None):
    ...
    """
    attrs = attrs or {}
    aggregate_info = {'name': 'aggregate-name-' + uuid.uuid4().hex, 'availability_zone': 'ag_zone', 'hosts': [], 'id': 'aggregate-id-' + uuid.uuid4().hex, 'metadata': {'availability_zone': 'ag_zone', 'key1': 'value1'}}
