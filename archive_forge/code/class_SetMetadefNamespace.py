...
class SetMetadefNamespace(command.Command):
    ...
    def get_parser(self, prog_name):
        ...
        parser.add_argument('namespace', metavar='<namespace>', help=_('Metadef namespace to modify (name)'))
        parser.add_argument('--display-name', metavar='<display_name>', help=_('Set a user-friendly name for the namespace.'))
        parser.add_argument('--description', metavar='<description>', help=_('Set the description of the namespace'))
        visibility_group = parser.add_mutually_exclusive_group()
        visibility_group.add_argument('--public', action='store_const', const='public', dest='visibility', help=_('Metadef namespace is accessible to the public'))
        visibility_group.add_argument('--private', action='store_const', const='private', dest='visibility', help=_('Metadef namespace is inaccessible to the public (default)'))
