...
class ThreadGroup(object):
    ...
    * provide an easy API to add timers.
    ...
    def add_timer(self, interval, callback, initial_delay=None, *args, **kwargs):
        ...
        """
        if args or kwargs:
            warnings.warn('Calling add_timer() with arguments to the callback function is deprecated. Use add_timer_args() instead.', DeprecationWarning)
        return self.add_timer_args(interval, callback, args, kwargs, initial_delay=initial_delay)
    ...
    def _wait_threads(self):
        self._perform_action_on_threads(lambda x: x.wait(), lambda x: LOG.exception('Error waiting on thread.'))
    ...
    def cancel(self, *throw_args, **kwargs):
        ...
        """
        self._perform_action_on_threads(lambda x: x.cancel(*throw_args), lambda x: LOG.exception('Error canceling thread.'))
