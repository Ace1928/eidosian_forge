...
class TestTSNR:
    ...
    out_filenames = {'detrended_file': 'detrend.nii.gz', 'mean_file': 'mean.nii.gz', 'stddev_file': 'stdev.nii.gz', 'tsnr_file': 'tsnr.nii.gz'}
    ...
    def test_tsnr_withpoly3(self):
        ...
        self.assert_expected_outputs_poly(tsnrresult, {'detrended_file': (1.8, 7.95), 'mean_file': (2.8, 7.7), 'stddev_file': (0.1, 1.7), 'tsnr_file': (2.6, 57.3)})
    ...
    fake_data = np.array([[[[2, 4, 3, 9, 1], [3, 6, 4, 7, 4]], [[8, 3, 4, 6, 2], [4, 0, 4, 4, 2]]], [[[9, 7, 5, 5, 7], [7, 8, 4, 8, 4]], [[0, 4, 7, 1, 7], [6, 8, 8, 8, 7]]]], dtype=np.int16)