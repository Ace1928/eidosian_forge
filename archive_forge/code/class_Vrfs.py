...
class Vrfs(ConfigBase):
    ...
    def execute_module(self):
        ...
        if self._module.check_mode:
            ...
            new_config = get_new_config(commands, existing_vrf_interfaces_facts, TEST_KEYS_formatted_diff)
            result['after(generated)'] = new_config
        if self._module._diff:
            result['diff'] = get_formatted_config_diff(existing_vrf_interfaces_facts, new_config, self._module._verbosity)
