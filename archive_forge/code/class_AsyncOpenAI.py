...
class AsyncOpenAI(AsyncAPIClient):
    ...
    def default_headers(self) -> dict[str, str | Omit]:
        return {**super().default_headers, 'X-Stainless-Async': f'async:{get_async_library()}', 'OpenAI-Organization': self.organization if self.organization is not None else Omit(), **self._custom_headers}
