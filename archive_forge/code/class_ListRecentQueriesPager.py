...
class ListRecentQueriesPager:
    ...
    def __init__(self, method: Callable[..., logging_config.ListRecentQueriesResponse], request: logging_config.ListRecentQueriesRequest, response: logging_config.ListRecentQueriesResponse, *, metadata: Sequence[Tuple[str, str]]=()):
