...
class BinaryPrecisionAtFixedRecall(BinaryPrecisionRecallCurve):
    ...
    def __init__(self, min_recall: float, thresholds: Optional[Union[int, List[float], Tensor]]=None, ignore_index: Optional[int]=None, validate_args: bool=True, **kwargs: Any) -> None:
    ...
    def compute(self) -> Tuple[Tensor, Tensor]:
        ...
        return _binary_recall_at_fixed_precision_compute(state, self.thresholds, self.min_recall, reduce_fn=_precision_at_recall)
