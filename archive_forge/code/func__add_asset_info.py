...
def _add_asset_info(trackable_asset, asset_info: _AssetInfo, mapped_path_variable: resource_variable_ops.ResourceVariable):
    ...
    try:
        ...
        pass
    path = builder_impl.get_asset_filename_to_add(asset_filepath=original_path, asset_filename_map=asset_info.asset_filename_map)
    ...
    asset_info.asset_initializers_by_resource[original_path_tensor] = mapped_path_variable.initializer
