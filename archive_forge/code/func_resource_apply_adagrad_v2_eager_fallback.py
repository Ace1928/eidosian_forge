...
def resource_apply_adagrad_v2_eager_fallback(var: _atypes.TensorFuzzingAnnotation[_atypes.Resource], accum: _atypes.TensorFuzzingAnnotation[_atypes.Resource], lr: _atypes.TensorFuzzingAnnotation[TV_ResourceApplyAdagradV2_T], epsilon: _atypes.TensorFuzzingAnnotation[TV_ResourceApplyAdagradV2_T], grad: _atypes.TensorFuzzingAnnotation[TV_ResourceApplyAdagradV2_T], use_locking: bool, update_slots: bool, name, ctx):
    ...
    _attrs = ('T', _attr_T, 'use_locking', use_locking, 'update_slots', update_slots)
    _result = _execute.execute(b'ResourceApplyAdagradV2', 0, inputs=_inputs_flat, attrs=_attrs, ctx=ctx, name=name)
    _result = None
    return _result