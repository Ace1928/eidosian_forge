...
def test_create_metadef_object(self):
    self.verify_create(self.proxy.create_metadef_object, _metadef_object.MetadefObject, method_kwargs={'namespace': 'test_namespace_name'}, expected_kwargs={'namespace_name': 'test_namespace_name'})