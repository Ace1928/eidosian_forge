...
def test_update_resource_convergence_failed(self, mock_needs_update, mock_update_template_diff):
    ...
    tr = scheduler.TaskRunner(res.update_convergence, new_temp.id, {4, 3}, 'engine-007', 120, new_stack, self.dummy_event)
