...
class FakeCommandWithInvalidCompleter(Command):
    ...
    command_spec = Command.CreateCommandSpec('fake1', argparse_arguments=[CommandArgument('arg', completer='BAD')])
    help_spec = Command.HelpSpec(help_name='fake1', help_name_aliases=[], help_type='command_help', help_one_line_summary='fake command for tests', help_text='fake command for tests', subcommand_help_text={})
