...
@pytest.mark.parametrize('iana_encoding, expected_languages', [('cp864', ['Arabic', 'Farsi']), ('cp862', ['Hebrew']), ('cp737', ['Greek']), ('cp424', ['Hebrew']), ('cp273', ['Latin Based']), ('johab', ['Korean']), ('shift_jis', ['Japanese']), ('mac_greek', ['Greek']), ('iso2022_jp', ['Japanese'])])
