...
class EventSchema:
    ...
    def __init__(self, schema: SchemaType, validator_class: type[Validator]=validators.Draft7Validator, format_checker: FormatChecker=draft7_format_checker, registry: Registry[Any] | None=None):
