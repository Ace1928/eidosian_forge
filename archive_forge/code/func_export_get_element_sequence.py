...
def export_get_element_sequence() -> None:
    ...
    expect(node, inputs=[optional], outputs=[output], input_type_protos=[optional_type_proto], name='test_optional_get_element_optional_sequence')
    expect(node, inputs=[optional], outputs=[output], input_type_protos=[seq_type_proto], name='test_optional_get_element_sequence')