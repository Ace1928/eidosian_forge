...
class DeploymentmanagerV2(base_api.BaseApiClient):
    ...
    class OperationsService(base_api.BaseApiService):
      ...
      """
            config = self.GetMethodConfig('Get')
            return self._RunMethod(config, request, global_params=global_params)
        Get.method_config = lambda: base_api.ApiMethodInfo(http_method='GET', method_id='deploymentmanager.operations.get', ordered_params=['project', 'operation'], path_params=['operation', 'project'], query_params=[], relative_path='deploymentmanager/v2/projects/{project}/global/operations/{operation}', request_field='', request_type_name='DeploymentmanagerOperationsGetRequest', response_type_name='Operation', supports_download=False)
      ...
      """
            config = self.GetMethodConfig('List')
            return self._RunMethod(config, request, global_params=global_params)
        List.method_config = lambda: base_api.ApiMethodInfo(http_method='GET', method_id='deploymentmanager.operations.list', ordered_params=['project'], path_params=['project'], query_params=['filter', 'maxResults', 'orderBy', 'pageToken'], relative_path='deploymentmanager/v2/projects/{project}/global/operations', request_field='', request_type_name='DeploymentmanagerOperationsListRequest', response_type_name='OperationsListResponse', supports_download=False)
    ...
    class ResourcesService(base_api.BaseApiService):
      ...
      """
            config = self.GetMethodConfig('Get')
            return self._RunMethod(config, request, global_params=global_params)
        Get.method_config = lambda: base_api.ApiMethodInfo(http_method='GET', method_id='deploymentmanager.resources.get', ordered_params=['project', 'deployment', 'resource'], path_params=['deployment', 'project', 'resource'], query_params=[], relative_path='deploymentmanager/v2/projects/{project}/global/deployments/{deployment}/resources/{resource}', request_field='', request_type_name='DeploymentmanagerResourcesGetRequest', response_type_name='Resource', supports_download=False)
      ...
      """
            config = self.GetMethodConfig('List')
            return self._RunMethod(config, request, global_params=global_params)
        List.method_config = lambda: base_api.ApiMethodInfo(http_method='GET', method_id='deploymentmanager.resources.list', ordered_params=['project', 'deployment'], path_params=['deployment', 'project'], query_params=['filter', 'maxResults', 'orderBy', 'pageToken'], relative_path='deploymentmanager/v2/projects/{project}/global/deployments/{deployment}/resources', request_field='', request_type_name='DeploymentmanagerResourcesListRequest', response_type_name='ResourcesListResponse', supports_download=False)
    ...
    class TypesService(base_api.BaseApiService):
      ...
      """
            config = self.GetMethodConfig('List')
            return self._RunMethod(config, request, global_params=global_params)
        List.method_config = lambda: base_api.ApiMethodInfo(http_method='GET', method_id='deploymentmanager.types.list', ordered_params=['project'], path_params=['project'], query_params=['filter', 'maxResults', 'orderBy', 'pageToken'], relative_path='deploymentmanager/v2/projects/{project}/global/types', request_field='', request_type_name='DeploymentmanagerTypesListRequest', response_type_name='TypesListResponse', supports_download=False)