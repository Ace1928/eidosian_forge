...
class KendallRankCorrCoef(Metric):
    ...
    def __init__(self, variant: Literal['a', 'b', 'c']='b', t_test: bool=False, alternative: Optional[Literal['two-sided', 'less', 'greater']]='two-sided', num_outputs: int=1, **kwargs: Any) -> None:
    ...
    def update(self, preds: Tensor, target: Tensor) -> None:
        ...
        self.preds, self.target = _kendall_corrcoef_update(preds, target, self.preds, self.target, num_outputs=self.num_outputs)
