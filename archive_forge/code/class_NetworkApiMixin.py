...
class NetworkApiMixin:
    ...
    def create_network(self, name, driver=None, options=None, ipam=None, check_duplicate=None, internal=False, labels=None, enable_ipv6=False, attachable=None, scope=None, ingress=None):
        """
        ...
        data = {'Name': name, 'Driver': driver, 'Options': options, 'IPAM': ipam, 'CheckDuplicate': check_duplicate}
        ...
        if internal:
            if version_lt(self._version, '1.22'):
                raise InvalidVersion('Internal networks are not supported in API version < 1.22')
            data['Internal'] = True
        if attachable is not None:
            if version_lt(self._version, '1.24'):
                raise InvalidVersion('attachable is not supported in API version < 1.24')
