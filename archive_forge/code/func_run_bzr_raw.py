...
def run_bzr_raw(self, args, retcode=0, stdin=None, encoding=None, working_dir=None, error_regexes=[]):
    ...
    try:
        result = self._run_bzr_core(args, encoding=encoding, stdin=stdin, stdout=wrapped_stdout, stderr=wrapped_stderr, working_dir=working_dir)
    finally:
