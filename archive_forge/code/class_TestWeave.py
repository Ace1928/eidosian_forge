...
class TestWeave(TestCaseWithMemoryTransport, VersionedFileTestMixIn):
    ...
    def get_file(self, name='foo'):
        return WeaveFile(name, self.get_transport(), create=True, get_scope=self.get_transaction)
    ...
    def reopen_file(self, name='foo', create=False):
        return WeaveFile(name, self.get_transport(), create=create, get_scope=self.get_transaction)

    def test_no_implicit_create(self):
        self.assertRaises(transport.NoSuchFile, WeaveFile, 'foo', self.get_transport(), get_scope=self.get_transaction)
