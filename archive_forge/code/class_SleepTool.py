...
class SleepTool(BaseTool):
    ...
    def _run(self, sleep_time: int, run_manager: Optional[CallbackManagerForToolRun]=None) -> str:
        """Use the Sleep tool."""
        sleep(sleep_time)
        return f'Agent slept for {sleep_time} seconds.'

    async def _arun(self, sleep_time: int, run_manager: Optional[AsyncCallbackManagerForToolRun]=None) -> str:
