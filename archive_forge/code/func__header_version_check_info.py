...
@staticmethod
def _header_version_check_info(check_version: Optional['CheckVersionResponse']=None, *, settings: 'Settings', printer: Union['PrinterTerm', 'PrinterJupyter']) -> None:
    ...
    printer.display(check_version.upgrade_message, off=not check_version.upgrade_message)