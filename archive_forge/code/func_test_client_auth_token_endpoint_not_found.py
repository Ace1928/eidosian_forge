...
@mock.patch.object(service_catalog, 'ServiceCatalog', side_effect=other_client.exceptions.EndpointNotFound)
def test_client_auth_token_endpoint_not_found(self, mock_service_catalog):
    ...
    with mock.patch('requests.request', mock_request):
        self.assertRaises(exceptions.EndpointNotFound, instance.authenticate)