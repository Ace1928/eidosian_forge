...
class V2beta1MetricStatus(object):
    ...
    swagger_types = {'external': 'V2beta1ExternalMetricStatus', 'object': 'V2beta1ObjectMetricStatus', 'pods': 'V2beta1PodsMetricStatus', 'resource': 'V2beta1ResourceMetricStatus', 'type': 'str'}
