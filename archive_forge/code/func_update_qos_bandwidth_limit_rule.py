...
def update_qos_bandwidth_limit_rule(self, qos_rule, qos_policy, **attrs):
    ...
    return self._update(_qos_bandwidth_limit_rule.QoSBandwidthLimitRule, qos_rule, qos_policy_id=policy.id, **attrs)