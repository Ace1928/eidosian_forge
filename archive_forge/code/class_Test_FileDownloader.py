...
class Test_FileDownloader(unittest.TestCase):
    ...
    def test_init(self):
        ...
        self.assertIsNone(f._fname)
        with self.assertRaisesRegex(RuntimeError, "cacert='nonexistent_file_name' does not refer to a valid file."):
    ...
    def test_get_platform_url(self):
        ...
        with self.assertRaisesRegex(RuntimeError, "cannot infer the correct url for platform '.*'"):
