...
class VpnTunnelHelper(object):
    ...
    """
        request = self._messages.ComputeVpnTunnelsInsertRequest(project=ref.project, region=ref.region, vpnTunnel=vpn_tunnel)
    ...
    """
        request = self._messages.ComputeVpnTunnelsGetRequest(project=ref.project, region=ref.region, vpnTunnel=ref.Name())
    ...
    """
        request = self._messages.ComputeVpnTunnelsDeleteRequest(project=ref.project, region=ref.region, vpnTunnel=ref.Name())
    ...
    """
        ...
        while True:
            request = self._messages.ComputeVpnTunnelsAggregatedListRequest(project=project, filter=filter_expr, pageToken=next_page_token)
    ...
    """
        ...
        request = self._messages.ComputeVpnTunnelsSetLabelsRequest(project=ref.project, region=ref.region, resource=ref.Name(), regionSetLabelsRequest=set_labels_request)
