...
def draw_game_elements(
    ...
    def main() -> None:
        ...
        screen, snake_entity, apple_entity, search_entity, game_clock = (
            setup_environment()
        )
        ...
        while running:
            ...
            snake_entity.update(apple_entity)
            if snake_entity.check_collision(apple_entity.position):
                apple_entity.position = apple_entity.generate(snake_entity.body)

            # Pathfinding update
            search_entity.update_path(
                snake_entity.get_head_position(), apple_entity.position
            )
