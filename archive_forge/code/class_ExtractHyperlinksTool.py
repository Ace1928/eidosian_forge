...
class ExtractHyperlinksTool(BaseBrowserTool):
    ...
    def _run(self, absolute_urls: bool=False, run_manager: Optional[CallbackManagerForToolRun]=None) -> str:
        """Use the tool."""
    ...
    async def _arun(self, absolute_urls: bool=False, run_manager: Optional[AsyncCallbackManagerForToolRun]=None) -> str:
