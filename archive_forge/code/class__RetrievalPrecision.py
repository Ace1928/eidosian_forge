...
class _RetrievalPrecision(RetrievalPrecision):
    ...
    def __init__(self, empty_target_action: str='neg', ignore_index: Optional[int]=None, top_k: Optional[int]=None, adaptive_k: bool=False, **kwargs: Any) -> None:
        _deprecated_root_import_class('', 'retrieval')
        super().__init__(empty_target_action=empty_target_action, ignore_index=ignore_index, top_k=top_k, adaptive_k=adaptive_k, **kwargs)