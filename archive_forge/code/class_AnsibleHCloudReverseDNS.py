...
class AnsibleHCloudReverseDNS(AnsibleHCloud):
    ...
    def _prepare_result(self):
        result = {'server': None, 'floating_ip': None, 'load_balancer': None, 'ip_address': to_native(self.hcloud_rdns['ip_address']), 'dns_ptr': to_native(self.hcloud_rdns['dns_ptr'])}
    ...
    def _get_resource(self):
        try:
            if self.module.params.get('server'):
                self.hcloud_resource = self._client_get_by_name_or_id('servers', self.module.params.get('server'))
            elif self.module.params.get('floating_ip'):
                ...
                self.hcloud_resource = self._client_get_by_name_or_id('load_balancers', self.module.params.get('load_balancer'))
    ...
    def _create_rdns(self):
        ...
        params = {'ip': self.module.params.get('ip_address'), 'dns_ptr': self.module.params.get('dns_ptr')}
