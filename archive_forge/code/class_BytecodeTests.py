...
class BytecodeTests(TestCase):
    ...
    def test_slice(self):
        ...
        for name in ('argcount', 'posonlyargcount', 'kwonlyargcount', 'first_lineno', 'name', 'filename', 'docstring', 'cellvars', 'freevars', 'argnames'):
    ...
    def test_from_code_freevars(self):
        ...
        bytecode = Bytecode.from_code(code)
        self.assertEqual(bytecode, [Instr('LOAD_DEREF', FreeVar('x'), lineno=5), Instr('RETURN_VALUE', lineno=5)])
