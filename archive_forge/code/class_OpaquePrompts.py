...
class OpaquePrompts(LLM):
    ...
    def validate_environment(cls, values: Dict) -> Dict:
        ...
        if not api_key:
            raise ValueError('Could not find OPAQUEPROMPTS_API_KEY in the environment. Please set it to your OpaquePrompts API key.You can get it by creating an account on the OpaquePrompts website: https://opaqueprompts.opaque.co/ .')
        return values
    ...
    def _call(self, prompt: str, stop: Optional[List[str]]=None, run_manager: Optional[CallbackManagerForLLMRun]=None, **kwargs: Any) -> str:
        ...
        desanitize_response: op.DesanitizeResponse = op.desanitize(llm_response, secure_context=sanitize_response.secure_context)
