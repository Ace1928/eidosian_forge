...
class Chatbot(Component):
    ...
    def __init__(self, value: list[list[str | tuple[str] | tuple[str | Path, str] | None]] | Callable | None=None, *, label: str | None=None, every: float | None=None, show_label: bool | None=None, container: bool=True, scale: int | None=None, min_width: int=160, visible: bool=True, elem_id: str | None=None, elem_classes: list[str] | str | None=None, render: bool=True, height: int | str | None=None, latex_delimiters: list[dict[str, str | bool]] | None=None, rtl: bool=False, show_share_button: bool | None=None, show_copy_button: bool=False, avatar_images: tuple[str | Path | None, str | Path | None] | None=None, sanitize_html: bool=True, render_markdown: bool=True, bubble_full_width: bool=True, line_breaks: bool=True, likeable: bool=False, layout: Literal['panel', 'bubble'] | None=None, placeholder: str | None=None):
        """
        Parameters:
        ...
        if avatar_images is None:
            ...
            self.avatar_images = [self.serve_static_file(avatar_images[0]), self.serve_static_file(avatar_images[1])]
    ...
    def preprocess(self, payload: ChatbotData | None) -> list[list[str | tuple[str] | tuple[str, str] | None]] | None:
        """
        Parameters:
    ...
    def postprocess(self, value: list[list[str | tuple[str] | tuple[str, str] | None] | tuple] | None) -> ChatbotData:
        """
        Parameters:
