...
def async_to_custom_streamed_response_wrapper(func: Callable[P, Awaitable[object]], response_cls: type[_AsyncAPIResponseT]) -> Callable[P, AsyncResponseContextManager[_AsyncAPIResponseT]]:
