...
def artifact2message(self, artifact, descriptor, sign=None, sign_alg=None, digest_alg=None):
    """
    ...
    _sid = sid()
    mid, msg = self.create_artifact_resolve(artifact, destination, _sid, sign=sign, sign_alg=sign_alg, digest_alg=digest_alg)
