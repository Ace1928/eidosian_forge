...
class TestBuildTree(TestCaseWithTransport):
    ...
    def test_directory_conflict_handling(self):
        ...
        self.assertEqual([DuplicateEntry('Diverted to', 'dir1.diverted', 'dir1', 'new-dir1', None)], target.conflicts())
        ...
        self.assertEqual([DuplicateEntry('Diverted to', 'dir1/file.diverted', 'dir1/file', 'new-file', None)], target.conflicts())
