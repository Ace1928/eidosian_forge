...
class WorkingTree(mutabletree.MutableTree, ControlComponent):
    ...
    def __init__(self, basedir='.', branch=None, _internal=False, _transport=None, _format=None, _controldir=None):
        ...
        if not _internal:
            raise errors.BzrError('Please use controldir.open_workingtree or WorkingTree.open() to obtain a WorkingTree.')
    ...
    branch = property(fget=lambda self: self._branch, doc='The branch this WorkingTree is connected to.\n\n            This cannot be set - it is reflective of the actual disk structure\n            the working tree has been constructed from.\n            ')
    ...
    def open_containing_paths(file_list, default_directory=None, canonicalize=True, apply_view=True):
        ...
        return (tree, tree.safe_relpath_files(file_list, canonicalize, apply_view=apply_view))
    ...
    def __repr__(self):
        return '<{} of {}>'.format(self.__class__.__name__, getattr(self, 'basedir', None))
    ...
    def pull(self, source, overwrite=False, stop_revision=None, change_reporter=None, possible_transports=None, local=False, show_base=False, tag_selector=None):
        ...
        with self.lock_write(), source.lock_read():
            ...
            if new_revision_info != old_revision_info:
                ...
                parent_trees.extend([(parent, repository.revision_tree(parent)) for parent in merges])
    ...
    def update(self, change_reporter=None, possible_transports=None, revision=None, old_tip=None, show_base=False):
