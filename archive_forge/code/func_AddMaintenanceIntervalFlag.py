...
def AddMaintenanceIntervalFlag(parser, for_node_pool=False, hidden=True):
    ...
    parser.add_argument('--maintenance-interval', type=type_validator, hidden=hidden, help=help_text)