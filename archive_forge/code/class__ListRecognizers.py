...
class _ListRecognizers(SpeechRestStub):
    ...
    def __call__(self, request: cloud_speech.ListRecognizersRequest, *, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Optional[float]=None, metadata: Sequence[Tuple[str, str]]=()) -> cloud_speech.ListRecognizersResponse:
        """Call the list recognizers method over HTTP.
            ...
            """
        http_options: List[Dict[str, str]] = [{'method': 'get', 'uri': '/v2/{parent=projects/*/locations/*}/recognizers'}]
