...
def test_import_image__web_download(self):
    ...
    self.image_client.import_image.assert_called_once_with(self.image, method='web-download', uri='https://example.com/', remote_region=None, remote_image_id=None, remote_service_interface=None, stores=None, all_stores=None, all_stores_must_succeed=False)