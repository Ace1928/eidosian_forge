...
class AbstractProcessor(abc.ABC):
    ...
    async def run_async(self, program: cirq.Circuit, program_id: Optional[str]=None, job_id: Optional[str]=None, param_resolver: Optional[cirq.ParamResolver]=None, repetitions: int=1, program_description: Optional[str]=None, program_labels: Optional[Dict[str, str]]=None, job_description: Optional[str]=None, job_labels: Optional[Dict[str, str]]=None, run_name: str='', device_config_name: str='') -> cirq.Result:
        ...
        """
        job = await self.run_sweep_async(program=program, program_id=program_id, job_id=job_id, params=[param_resolver or cirq.ParamResolver({})], repetitions=repetitions, program_description=program_description, program_labels=program_labels, job_description=job_description, job_labels=job_labels, run_name=run_name, device_config_name=device_config_name)
    ...
    @abc.abstractmethod
    async def run_calibration_async(self, layers: List['cg.CalibrationLayer'], program_id: Optional[str]=None, job_id: Optional[str]=None, program_description: Optional[str]=None, program_labels: Optional[Dict[str, str]]=None, job_description: Optional[str]=None, job_labels: Optional[Dict[str, str]]=None) -> 'abstract_job.AbstractJob':
    ...
    @abc.abstractmethod
    def create_reservation(self, start_time: datetime.datetime, end_time: datetime.datetime, whitelisted_users: Optional[List[str]]=None) -> quantum.QuantumReservation:
    ...
    @abc.abstractmethod
    def list_reservations(self, from_time: Union[None, datetime.datetime, datetime.timedelta], to_time: Union[None, datetime.datetime, datetime.timedelta]) -> List[quantum.QuantumReservation]:
