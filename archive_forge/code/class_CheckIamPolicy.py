  ...
  """
    ...
    Args:
      parser: An argparse parser that you can use to add arguments that go
          ...
          allowed.
    """
        service_flag = common_flags.producer_service_flag(suffix='for which to check the IAM policy')
    ...
    """
        ...
        request = query_request(servicesId=service, testIamPermissionsRequest=messages.TestIamPermissionsRequest(permissions=all_iam_permissions))
