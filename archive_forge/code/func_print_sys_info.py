...
def print_sys_info(*, additional_pkgs: Sequence[str]=tuple()) -> None:
    ...
    all_packages = sorted(set(langchain_pkgs + other_langchain_packages + list(additional_pkgs)))
    ...
    system_info = {'OS': platform.system(), 'OS Version': platform.version(), 'Python Version': sys.version}
    print()
