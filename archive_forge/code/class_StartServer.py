...
class StartServer(command.Command):
    ...
    def get_parser(self, prog_name):
        ...
        parser.add_argument('server', metavar='<server>', nargs='+', help=_('Server(s) to start (name or ID)'))
        parser.add_argument('--all-projects', action='store_true', default=boolenv('ALL_PROJECTS'), help=_('Start server(s) in another project by name (admin only)(can be specified using the ALL_PROJECTS envvar)'))
        return parser
