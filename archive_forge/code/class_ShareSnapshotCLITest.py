...
class ShareSnapshotCLITest(base.OSCClientTestBase):
    ...
    def test_share_snapshot_delete(self):
        ...
        self.openstack(f'share snapshot delete {snapshot_1['id']} {snapshot_2['id']} --wait')
        ...
        self.openstack(f'share snapshot set {snapshot_3['id']} --status creating')
        self.openstack(f'share snapshot delete {snapshot_3['id']} --wait --force')
