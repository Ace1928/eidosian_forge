...
def test_ionq_client_list_calibrations_limit(mock_get):
    ...
    mock_get.return_value.json.return_value = {'calibrations': [{'id': '1'}, {'id': '2'}, {'id': 3}]}
    ...
    mock_get.assert_called_with('http://example.com/v0.3/calibrations', headers=expected_headers, json={'limit': 1000}, params={})