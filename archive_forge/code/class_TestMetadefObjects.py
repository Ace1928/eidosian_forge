...
class TestMetadefObjects(metadef_base.MetadefFunctionalTestBase):
    ...
    def _create_object(self, namespaces):
        ...
        for namespace in namespaces:
            ...
            data = {'name': 'object_of_%s' % namespace['namespace'], 'description': 'object description.', 'required': ['property1'], 'properties': {'property1': {'type': 'integer', 'title': 'property1', 'description': 'property1 description'}}}
            path = self._url('/v2/metadefs/namespaces/%s/objects' % namespace['namespace'])
