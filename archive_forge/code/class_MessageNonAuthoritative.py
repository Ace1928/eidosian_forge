...
class MessageNonAuthoritative:
    ...
    def bytes(cls):
        ...
        """
        return b'\x01\x00\x00\x00\x00\x00\x00\x01\x00\x00\x00\x00\x00\x00\x01\x00\x01\x00\x00\x00\x00\x00\x04\x01\x02\x03\x04'
    ...
    def kwargs(cls):
        ...
        """
        return dict(id=256, auth=0, ednsVersion=None, answers=[dns.RRHeader(b'', payload=dns.Record_A('1.2.3.4', ttl=0), auth=False)])