...
def raster_geometry_mask(dataset, shapes, all_touched=False, invert=False, crop=False, pad=False, pad_width=0.5):
    ...
    try:
        ...
        if crop:
            ...
            warnings.warn('shapes are outside bounds of raster. Are they in different coordinate reference systems?')
    ...
    mask = geometry_mask(shapes, transform=transform, invert=invert, out_shape=out_shape, all_touched=all_touched)
