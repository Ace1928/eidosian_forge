...
class DigestCredentialFactory:
    ...
    def __init__(self, algorithm, authenticationRealm):
        ...
        """
        self.digest = credentials.DigestCredentialFactory(algorithm, authenticationRealm)
    ...
    def decode(self, response, request):
        ...
        """
        return self.digest.decode(response, request.method, request.getClientAddress().host)