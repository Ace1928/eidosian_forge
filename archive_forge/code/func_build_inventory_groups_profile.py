...
def build_inventory_groups_profile(self, group_name):
    ...
    gen_instances = [instance_name for instance_name in self.inventory.hosts.keys() if 'ansible_lxd_profile' in self.inventory.get_host(instance_name).get_vars().keys()]
