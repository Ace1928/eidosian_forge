...
class ImageCompressorApp(tk.Tk):
    ...
    def compress_image(self) -> None:
        ...
        asyncio.run_coroutine_threadsafe(self.async_compress_image(), self.asyncio_loop)

    # Ensure async_compress_image and other async methods are correctly defined
    async def async_compress_image(self) -> None:
        ...
        try:
            ...
            )  # Assuming compress is synchronous
