...
def test_print_hadamard():
    ...
    assert mathml(HadamardProduct(X, Y * Y), printer='presentation') == '<mrow><mi>X</mi><mo>&#x2218;</mo><msup><mi>Y</mi><mn>2</mn></msup></mrow>'
    assert mathml(HadamardProduct(X, Y) * Y, printer='presentation') == '<mrow><mfenced><mrow><mi>X</mi><mo>&#x2218;</mo><mi>Y</mi></mrow></mfenced><mo>&InvisibleTimes;</mo><mi>Y</mi></mrow>'
    assert mathml(HadamardProduct(X, Y, Y), printer='presentation') == '<mrow><mi>X</mi><mo>&#x2218;</mo><mi>Y</mi><mo>&#x2218;</mo><mi>Y</mi></mrow>'
    assert mathml(Transpose(HadamardProduct(X, Y)), printer='presentation') == '<msup><mfenced><mrow><mi>X</mi><mo>&#x2218;</mo><mi>Y</mi></mrow></mfenced><mo>T</mo></msup>'