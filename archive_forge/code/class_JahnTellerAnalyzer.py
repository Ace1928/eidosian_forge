...
class JahnTellerAnalyzer:
    ...
    def __init__(self):
        ...
        self.spin_configs = {'oct': {0: {'high': {'e_g': 0, 't_2g': 0}, 'default': 'high'}, 1: {'high': {'e_g': 0, 't_2g': 1}, 'default': 'high'}, 2: {'high': {'e_g': 0, 't_2g': 2}, 'default': 'high'}, 3: {'high': {'e_g': 0, 't_2g': 3}, 'default': 'high'}, 4: {'high': {'e_g': 1, 't_2g': 3}, 'low': {'e_g': 0, 't_2g': 4}, 'default': 'high'}, 5: {'high': {'e_g': 2, 't_2g': 3}, 'low': {'e_g': 0, 't_2g': 5}, 'default': 'low'}, 6: {'high': {'e_g': 2, 't_2g': 4}, 'low': {'e_g': 0, 't_2g': 6}, 'default': 'high'}, 7: {'high': {'e_g': 2, 't_2g': 5}, 'low': {'e_g': 1, 't_2g': 6}, 'default': 'low'}, 8: {'high': {'e_g': 2, 't_2g': 6}, 'default': 'high'}, 9: {'high': {'e_g': 3, 't_2g': 6}, 'default': 'high'}, 10: {'high': {'e_g': 4, 't_2g': 6}, 'default': 'high'}}, 'tet': {0: {'high': {'e': 0, 't_2': 0}, 'default': 'high'}, 1: {'high': {'e': 1, 't_2': 0}, 'default': 'high'}, 2: {'high': {'e': 2, 't_2': 0}, 'default': 'high'}, 3: {'high': {'e': 2, 't_2': 1}, 'default': 'high'}, 4: {'high': {'e': 2, 't_2': 2}, 'default': 'high'}, 5: {'high': {'e': 2, 't_2': 3}, 'default': 'high'}, 6: {'high': {'e': 3, 't_2': 3}, 'default': 'high'}, 7: {'high': {'e': 4, 't_2': 3}, 'default': 'high'}, 8: {'high': {'e': 4, 't_2': 4}, 'default': 'high'}, 9: {'high': {'e': 4, 't_2': 5}, 'default': 'high'}, 10: {'high': {'e': 4, 't_2': 6}, 'default': 'high'}}}
    ...
    def get_analysis(self, structure: Structure, calculate_valences: bool=True, guesstimate_spin: bool=False, op_threshold: float=0.1) -> dict:
        """
        ...
        """
        return self.get_analysis_and_structure(structure, calculate_valences=calculate_valences, guesstimate_spin=guesstimate_spin, op_threshold=op_threshold)[0]
