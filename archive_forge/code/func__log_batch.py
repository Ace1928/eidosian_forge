...
def _log_batch():
    ...
    request_message = _get_request_message(LogBatch(), schema={'run_id': [_assert_string, _assert_required], 'metrics': [_assert_array, _assert_metrics_fields_present], 'params': [_assert_array, _assert_params_tags_fields_present], 'tags': [_assert_array, _assert_params_tags_fields_present]})
    ...
    _get_tracking_store().log_batch(run_id=request_message.run_id, metrics=metrics, params=params, tags=tags)
