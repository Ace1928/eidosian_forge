...
class ListSnapshotsAsyncPager:
    ...
    def __init__(self, method: Callable[..., Awaitable[pubsub.ListSnapshotsResponse]], request: pubsub.ListSnapshotsRequest, response: pubsub.ListSnapshotsResponse, *, metadata: Sequence[Tuple[str, str]]=()):
