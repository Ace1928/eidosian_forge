...
class V2beta2HorizontalPodAutoscalerStatus(object):
    ...
    swagger_types = {'conditions': 'list[V2beta2HorizontalPodAutoscalerCondition]', 'current_metrics': 'list[V2beta2MetricStatus]', 'current_replicas': 'int', 'desired_replicas': 'int', 'last_scale_time': 'datetime', 'observed_generation': 'int'}
