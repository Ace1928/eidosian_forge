...
def _make_array_nonempty_pyarrow_dtype(dtype):
    ...
    if pa.types.is_integer(dtype.pyarrow_dtype):
        ...
        data = [True, False]
    elif pa.types.is_string(dtype.pyarrow_dtype) or pa.types.is_large_string(dtype.pyarrow_dtype):
        data = ['a', 'b']
    ...
    elif pa.types.is_binary(dtype.pyarrow_dtype) or pa.types.is_large_binary(dtype.pyarrow_dtype):
        data = [b'a', b'b']
