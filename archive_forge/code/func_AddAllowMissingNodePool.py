...
def AddAllowMissingNodePool(parser: parser_arguments.ArgumentInterceptor):
  ...
  """
    parser.add_argument('--allow-missing', action='store_true', help='If set, and the Bare Metal Node Pool is not found, the request will succeed but no action will be taken.')