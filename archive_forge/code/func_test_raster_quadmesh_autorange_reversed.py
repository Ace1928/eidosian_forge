...
def test_raster_quadmesh_autorange_reversed(array_module):
    ...
    out = xr.DataArray(array_module.array([[8.0, 8.0, 7.0, 7.0, 6.0, 6.0, 5.0, 5.0], [8.0, 8.0, 7.0, 7.0, 6.0, 6.0, 5.0, 5.0], [4.0, 4.0, 3.0, 3.0, 2.0, 2.0, 1.0, 1.0], [4.0, 4.0, 3.0, 3.0, 2.0, 2.0, 1.0, 1.0]], dtype='f8'), coords=[('b', y_coords), ('a', x_coords)])
