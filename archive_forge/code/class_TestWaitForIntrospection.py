...
class TestWaitForIntrospection(base.TestCase):
    ...
    def test_timeout(self, mock_fetch):
        self.assertRaises(exceptions.ResourceTimeout, self.proxy.wait_for_introspection, self.introspection, timeout=0.001)
    ...
    def test_failure(self, mock_fetch):
        ...
        mock_fetch.side_effect = _side_effect
        self.assertRaisesRegex(exceptions.ResourceFailure, 'boom', self.proxy.wait_for_introspection, self.introspection)
