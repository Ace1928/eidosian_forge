...
class JsonTeacher(ConversationTeacher):
    ...
    def add_cmdline_args(argparser):
        ...
        agent.add_argument('-ffdt', '--fromfile-datatype-extension', type='bool', default=False, help='If true, use _train.jsonl, _valid.jsonl, _test.jsonl file extensions')
        agent.add_argument('--label-turns', type=str, help='which speaker to use as label', choices=['firstspeaker', 'secondspeaker', 'both'], default='secondspeaker')
