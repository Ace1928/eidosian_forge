...
def multiclass_specificity(preds: Tensor, target: Tensor, num_classes: int, average: Optional[Literal['micro', 'macro', 'weighted', 'none']]='macro', top_k: int=1, multidim_average: Literal['global', 'samplewise']='global', ignore_index: Optional[int]=None, validate_args: bool=True) -> Tensor:
