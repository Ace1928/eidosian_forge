...
def test_tabulator_patch_with_sorters_and_pagination(document, comm):
    ...
    expected_src = {'index': np.array([1, 4]), 'A': np.array([1, 1]), 'B': np.array([1, 0]), 'C': np.array(['foo2', 'foo5']), 'D': np.array(['2009-01-02T00:00:00.000000000', '2009-01-07T00:00:00.000000000'], dtype='datetime64[ns]').astype(np.int64) / 1000000.0}
