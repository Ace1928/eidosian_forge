...
def test_contentLengthAndTransferEncodingWithPipelinedRequests(self):
    """
        ...
        """
    self.assertRequestRejected([b'GET /a HTTP/1.1', b'Transfer-Encoding: chunked', b'Content-Length: 0', b'Host: host.invalid', b'', b'', b'GET /a HTTP/1.1', b'Host: host.invalid', b'', b''])