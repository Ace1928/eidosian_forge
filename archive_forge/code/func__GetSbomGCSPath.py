...
def _GetSbomGCSPath(storage_path, resource_uri, sbom):
    ...
    return 'gs://{storage_path}/{uri_encoded}/sbom/user-{version}.{ext}'.format(**{'storage_path': storage_path.replace('gs://', '').rstrip('/'), 'uri_encoded': uri_encoded, 'version': version, 'ext': sbom.GetExtension()})