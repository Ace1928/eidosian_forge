...
class ModelShowcase(ShowBase):
    ...
    def configure_point_light(self):
        ...
        point_light_node_path.setPos(
            tuple(position_vector)
        )  # Convert numpy array to tuple before setting position
    ...
    def configure_ambient_light(self):
        ...
        self.ambient_light.setColor(tuple(color_vector))  # Convert numpy array to tuple
