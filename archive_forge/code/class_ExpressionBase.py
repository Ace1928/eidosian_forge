...
class ExpressionBase(PyomoObject):
    ...
    def nargs(self):
        ...
        """
        raise NotImplementedError(f'Derived expression ({self.__class__}) failed to implement nargs()')
    ...
    def arg(self, i):
        ...
        if i < 0:
            i += self.nargs()
            if i < 0:
                raise KeyError('Invalid index for expression argument: %d' % i - self.nargs())
        elif i >= self.nargs():
    ...
    def args(self):
        ...
        """
        raise NotImplementedError(f'Derived expression ({self.__class__}) failed to implement args()')
    ...
    def to_string(self, verbose=None, labeler=None, smap=None, compute_values=False):
        ...
        """
        return visitor.expression_to_string(self, verbose=verbose, labeler=labeler, smap=smap, compute_values=compute_values)
    ...
    def _to_string(self, values, verbose, smap):
        ...
        """
        raise NotImplementedError(f'Derived expression ({self.__class__}) failed to implement _to_string()')
    ...
    def getname(self, *args, **kwds):
        ...
        """
        raise NotImplementedError(f'Derived expression ({self.__class__}) failed to implement getname()')
    ...
    def _apply_operation(self, result):
        ...
        """
        raise NotImplementedError(f'Derived expression ({self.__class__}) failed to implement _apply_operation()')