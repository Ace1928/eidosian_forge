...
class UpdateWebhook(base.UpdateCommand):
    ...
    """
        ...
        trigger_utils.AddBuildConfigArgsForUpdate(flag_config, has_file_source=True, require_docker_image=False)
    ...
    """
        ...
        trigger_utils.ParseBuildConfigArgsForUpdate(trigger, old_trigger, args, messages, update_mask, default_image=default_image, has_repo_source=True, has_file_source=True)
    ...
    """
        ...
        update_mask = sorted(set((sub if m.startswith(sub) else m for m in update_mask)))
