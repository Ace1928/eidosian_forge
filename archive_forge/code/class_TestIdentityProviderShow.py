...
class TestIdentityProviderShow(TestIdentityProvider):
    ...
    def setUp(self):
        ...
        ret = fakes.FakeResource(None, copy.deepcopy(identity_fakes.IDENTITY_PROVIDER), loaded=True)
        self.identity_providers_mock.get.side_effect = [Exception('Not found'), ret]
