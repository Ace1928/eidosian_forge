...
def ListViolations(client, msg, project_id):
    ...
    req = msg.AnthospolicycontrollerstatusPaProjectsMembershipConstraintAuditViolationsListRequest()
    return _Autopage(client_fn, req, project_id, lambda response: response.membershipConstraintAuditViolations)