...
class NamedUser(github.GithubObject.CompletableGithubObject):
    ...
    def get_gists(self, since: Opt[datetime]=NotSet) -> PaginatedList[Gist]:
        ...
        return github.PaginatedList.PaginatedList(github.Gist.Gist, self._requester, f'{self.url}/gists', url_parameters)
    ...
    def get_orgs(self) -> PaginatedList[Organization]:
        ...
        """
        return github.PaginatedList.PaginatedList(github.Organization.Organization, self._requester, f'{self.url}/orgs', None)
    ...
    def get_projects(self, state: str='open') -> PaginatedList[Project]:
        ...
        return github.PaginatedList.PaginatedList(github.Project.Project, self._requester, f'{self.url}/projects', url_parameters, headers={'Accept': Consts.mediaTypeProjectsPreview})
    ...
    def get_public_events(self) -> PaginatedList[Event]:
        ...
        """
        return github.PaginatedList.PaginatedList(github.Event.Event, self._requester, f'{self.url}/events/public', None)
    ...
    def get_received_events(self) -> PaginatedList[Event]:
        ...
        """
        return github.PaginatedList.PaginatedList(github.Event.Event, self._requester, f'{self.url}/received_events', None)
    ...
    def get_repos(self, type: Opt[str]=NotSet, sort: Opt[str]=NotSet, direction: Opt[str]=NotSet) -> PaginatedList[Repository]:
        ...
        return github.PaginatedList.PaginatedList(github.Repository.Repository, self._requester, f'{self.url}/repos', url_parameters)
    ...
    def get_starred(self) -> PaginatedList[Repository]:
        ...
        """
        return github.PaginatedList.PaginatedList(github.Repository.Repository, self._requester, f'{self.url}/starred', None)
    ...
    def get_subscriptions(self) -> PaginatedList[Repository]:
        ...
        """
        return github.PaginatedList.PaginatedList(github.Repository.Repository, self._requester, f'{self.url}/subscriptions', None)
    ...
    def get_watched(self) -> PaginatedList[Repository]:
        ...
        """
        return github.PaginatedList.PaginatedList(github.Repository.Repository, self._requester, f'{self.url}/watched', None)
    ...
    def _useAttributes(self, attributes: dict[str, Any]) -> None:
        ...
        if 'followers_url' in attributes:
        ...
        if 'invitation_teams_url' in attributes:
        ...
        if 'organizations_url' in attributes:
        ...
        if 'received_events_url' in attributes:
        ...
        if 'twitter_username' in attributes:
