...
def short_time_objective_intelligibility(preds: Tensor, target: Tensor, fs: int, extended: bool=False, keep_same_device: bool=False) -> Tensor:
    ...
    if not _PYSTOI_AVAILABLE:
        raise ModuleNotFoundError('ShortTimeObjectiveIntelligibility metric requires that `pystoi` is installed. Either install as `pip install torchmetrics[audio]` or `pip install pystoi`.')
