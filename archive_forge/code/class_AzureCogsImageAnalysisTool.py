...
class AzureCogsImageAnalysisTool(BaseTool):
    ...
    description: str = 'A wrapper around Azure Cognitive Services Image Analysis. Useful for when you need to analyze images. Input should be a url to an image.'
    ...
    def validate_environment(cls, values: Dict) -> Dict:
        ...
        try:
            ...
            values['analysis_options'].features = sdk.ImageAnalysisFeature.CAPTION | sdk.ImageAnalysisFeature.OBJECTS | sdk.ImageAnalysisFeature.TAGS | sdk.ImageAnalysisFeature.TEXT
        except ImportError:
