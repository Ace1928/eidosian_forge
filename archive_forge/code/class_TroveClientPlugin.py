...
class TroveClientPlugin(client_plugin.ClientPlugin):
    ...
    def _create(self):
        ...
        args = {'endpoint_type': endpoint_type, 'service_type': self.DATABASE, 'session': con.keystone_session, 'retries': cfg.CONF.client_retry_limit, 'region_name': self._get_region_name()}
