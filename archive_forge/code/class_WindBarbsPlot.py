...
class WindBarbsPlot(ColorbarPlot):
    ...
    style_opts = ['alpha', 'color', 'edgecolors', 'facecolors', 'linewidth', 'marker', 'visible', 'cmap', 'norm', 'length', 'barbcolor', 'flagcolor', 'fill_empty', 'rounding', 'barb_increments', 'flip_barb', 'pivot', 'sizes', 'width']
    _nonvectorized_styles = ['alpha', 'marker', 'cmap', 'visible', 'norm', 'length', 'barbcolor', 'flagcolor', 'fill_empty', 'rounding', 'barb_increments', 'flip_barb', 'pivot', 'sizes', 'width']
    ...
    def get_data(self, element, ranges, style):
        ...
        if uses_color and (flagcolor is not None or barbcolor is not None):
            self.param.warning("Cannot declare style mapping for 'color' option and either 'flagcolor' and 'barbcolor'; ignoring 'flagcolor' and 'barbcolor'.")
