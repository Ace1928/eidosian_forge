...
class ElementMutation(OffspringCreator):
    ...
    def __init__(self, element_pool, max_diff_elements, min_percentage_elements, verbose, num_muts=1, rng=np.random):
        ...
        if max_diff_elements is None:
            self.max_diff_elements = [1000000.0 for _ in self.element_pools]
