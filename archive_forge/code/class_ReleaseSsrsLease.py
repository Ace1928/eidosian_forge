...
class ReleaseSsrsLease(base.Command):
    ...
    """
        ...
        request = sql_messages.SqlInstancesReleaseSsrsLeaseRequest(instance=instance_ref.instance, project=instance_ref.project)
        ...
        operations.OperationsV1Beta4.WaitForOperation(sql_client, operation_ref, 'Releasing SSRS lease')
