...
class RunInputs(_MlflowObject):
    ...
    def to_proto(self):
        ...
        run_inputs.dataset_inputs.extend([dataset_input.to_proto() for dataset_input in self.dataset_inputs])
        return run_inputs

    def to_dictionary(self) -> Dict[Any, Any]:
        return {'dataset_inputs': self.dataset_inputs}

    @classmethod
    def from_proto(cls, proto):
        dataset_inputs = [DatasetInput.from_proto(dataset_input) for dataset_input in proto.dataset_inputs]
