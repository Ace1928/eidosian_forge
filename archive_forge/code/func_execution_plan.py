...
def execution_plan(workers, config, **kwargs):
    raise NotImplementedError("It is no longer supported to use the `Algorithm.execution_plan()` API! Set `_disable_execution_plan_api=True` in your config and override the `Algorithm.training_step()` method with your algo's custom execution logic instead.")