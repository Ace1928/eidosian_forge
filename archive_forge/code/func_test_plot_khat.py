...
@pytest.mark.parametrize('kwargs', [{}, {'xlabels': True}, {'color': 'obs_dim', 'xlabels': True, 'show_bins': True, 'bin_format': '{0}'}, {'color': 'obs_dim', 'legend': True, 'hover_label': True}, {'color': 'blue', 'coords': {'obs_dim': slice(2, 4)}}, {'color': np.random.uniform(size=8), 'show_bins': True}, {'color': np.random.uniform(size=(8, 3)), 'show_bins': True, 'show_hlines': True, 'threshold': 1}])
