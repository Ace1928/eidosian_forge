...
class NetAppOntapFilePolicy(object):
    ...
    def create_policy(self):
        ...
        try:
            ...
            self.module.fail_json(msg='Error creating file-directory policy %s: %s' % (self.parameters['policy_name'], to_native(error)), exception=traceback.format_exc())
    ...
    def remove_policy(self):
        ...
        try:
            ...
            self.module.fail_json(msg='Error removing file-directory policy %s: %s' % (self.parameters['policy_name'], to_native(error)), exception=traceback.format_exc())
    ...
    def apply(self):
        ...
        if self.na_helper.changed:
            if self.module.check_mode:
                ...
                self.remove_policy()
        result = netapp_utils.generate_result(self.na_helper.changed, cd_action, extra_responses={'task action': task_cd_action, 'task modify': task_modify})
