...
class Konko(LLM):
    ...
    def validate_environment(cls, values: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if not hasattr(konko, '_is_legacy_openai'):
            warnings.warn("You are using an older version of the 'konko' package. Please consider upgrading to access new featuresincluding the completion endpoint.")
        return values
    ...
    def _call(self, prompt: str, stop: Optional[List[str]]=None, run_manager: Optional[CallbackManagerForLLMRun]=None, **kwargs: Any) -> str:
        ...
        try:
            ...
            raise ValueError('`konko` has no `Completion` attribute, this is likely due to an old version of the konko package. Try upgrading it with `pip install --upgrade konko`.')
        if is_openai_v1():
