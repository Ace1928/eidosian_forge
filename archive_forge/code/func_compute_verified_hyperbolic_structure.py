...
def compute_verified_hyperbolic_structure(triangulation, source='orb', bits_prec=53, verbose=False):
    """
    ...
    return compute_verified_hyperbolic_structure_from_approx_structure(approx, bits_prec, verbose)