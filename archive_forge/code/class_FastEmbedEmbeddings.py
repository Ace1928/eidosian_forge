    ...
    * https://qdrant.github.io/fastembed/
    ...
    def validate_environment(cls, values: Dict) -> Dict:
        ...
        try:
            ...
            values['_model'] = TextEmbedding(model_name=model_name, max_length=max_length, cache_dir=cache_dir, threads=threads)
        except ImportError as ie:
            try:
                from fastembed.embedding import FlagEmbedding
                values['_model'] = FlagEmbedding(model_name=model_name, max_length=max_length, cache_dir=cache_dir, threads=threads)
            except ImportError:
                raise ImportError("Could not import 'fastembed' Python package. Please install it with `pip install fastembed`.") from ie
        return values
