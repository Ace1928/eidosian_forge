...
def ProgressColumn(label: str | None=None, *, width: ColumnWidth | None=None, help: str | None=None, format: str | None=None, min_value: int | float | None=None, max_value: int | float | None=None) -> ColumnConfig:
    ...
    .. output::
        ...
        height: 300px
    """
    return ColumnConfig(label=label, width=width, help=help, type_config=ProgressColumnConfig(type='progress', format=format, min_value=min_value, max_value=max_value))