...
class ListObjectsAsyncPager:
    ...
    def __init__(self, method: Callable[..., Awaitable[storage.ListObjectsResponse]], request: storage.ListObjectsRequest, response: storage.ListObjectsResponse, *, metadata: Sequence[Tuple[str, str]]=()):
