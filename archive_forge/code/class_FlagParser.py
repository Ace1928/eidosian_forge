...
class FlagParser(flags.PocoFlagParser):
    ...
    def install_bundle(self, policy_content_spec: messages.Message) -> messages.Message:
    ...
    def install_template_library(self, poco_cfg: messages.Message) -> messages.Message:
        return self._update_template_cfg(poco_cfg, 'ALL')

    def uninstall_template_library(self, poco_cfg: messages.Message) -> messages.Message:
