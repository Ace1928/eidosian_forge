...
class ServerType(BaseDomain, DomainIdentityMixin):
    ...
    """
    __slots__ = ('id', 'name', 'description', 'cores', 'memory', 'disk', 'prices', 'storage_type', 'cpu_type', 'architecture', 'deprecated', 'deprecation', 'included_traffic')

    def __init__(self, id: int | None=None, name: str | None=None, description: str | None=None, cores: int | None=None, memory: int | None=None, disk: int | None=None, prices: dict | None=None, storage_type: str | None=None, cpu_type: str | None=None, architecture: str | None=None, deprecated: bool | None=None, deprecation: dict | None=None, included_traffic: int | None=None):
        self.id = id
        self.name = name
