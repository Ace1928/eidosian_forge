...
class TuneReportCheckpointCallback(TuneCallback):
    ...
    def __init__(self, metrics: Optional[Union[str, List[str], Dict[str, str]]]=None, filename: str='checkpoint', frequency: int=1, results_postprocessing_fn: Optional[Callable[[Dict[str, Union[float, List[float]]]], Dict[str, float]]]=None):
    ...
    def __call__(self, env: CallbackEnv) -> None:
        ...
        if self._report_callback_cls:
            ...
            return
        with self._get_checkpoint(model=env.model, epoch=env.iteration, filename=self._filename, frequency=self._frequency) as checkpoint:
