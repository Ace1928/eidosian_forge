...
class TrelloLoader(BaseLoader):
    ...
    def __init__(self, client: TrelloClient, board_name: str, *, include_card_name: bool=True, include_comments: bool=True, include_checklist: bool=True, card_filter: Literal['closed', 'open', 'all']='all', extra_metadata: Tuple[str, ...]=('due_date', 'labels', 'list', 'closed')):
    ...
    @classmethod
    def from_credentials(cls, board_name: str, *, api_key: Optional[str]=None, token: Optional[str]=None, **kwargs: Any) -> TrelloLoader:
        ...
        try:
            ...
            raise ImportError('Could not import trello python package. Please install it with `pip install py-trello`.') from ex
