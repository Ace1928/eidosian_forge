...
class WebsecurityscannerV1beta(base_api.BaseApiClient):
    ...
    def __init__(self, url='', credentials=None, get_credentials=True, http=None, model=None, log_request=False, log_response=False, credentials_args=None, default_global_params=None, additional_http_headers=None, response_encoding=None):
        ...
        super(WebsecurityscannerV1beta, self).__init__(url, credentials=credentials, get_credentials=get_credentials, http=http, model=model, log_request=log_request, log_response=log_response, credentials_args=credentials_args, default_global_params=default_global_params, additional_http_headers=additional_http_headers, response_encoding=response_encoding)
    ...
    class ProjectsScanConfigsScanRunsFindingTypeStatsService(base_api.BaseApiService):
      ...
      """
            config = self.GetMethodConfig('List')
            return self._RunMethod(config, request, global_params=global_params)
        List.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1beta/projects/{projectsId}/scanConfigs/{scanConfigsId}/scanRuns/{scanRunsId}/findingTypeStats', http_method='GET', method_id='websecurityscanner.projects.scanConfigs.scanRuns.findingTypeStats.list', ordered_params=['parent'], path_params=['parent'], query_params=[], relative_path='v1beta/{+parent}/findingTypeStats', request_field='', request_type_name='WebsecurityscannerProjectsScanConfigsScanRunsFindingTypeStatsListRequest', response_type_name='ListFindingTypeStatsResponse', supports_download=False)
    ...
    class ProjectsScanConfigsService(base_api.BaseApiService):
      ...
      """
            ...
            return self._RunMethod(config, request, global_params=global_params)
        Create.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1beta/projects/{projectsId}/scanConfigs', http_method='POST', method_id='websecurityscanner.projects.scanConfigs.create', ordered_params=['parent'], path_params=['parent'], query_params=[], relative_path='v1beta/{+parent}/scanConfigs', request_field='scanConfig', request_type_name='WebsecurityscannerProjectsScanConfigsCreateRequest', response_type_name='ScanConfig', supports_download=False)
      ...
      """
            ...
            return self._RunMethod(config, request, global_params=global_params)
        Delete.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1beta/projects/{projectsId}/scanConfigs/{scanConfigsId}', http_method='DELETE', method_id='websecurityscanner.projects.scanConfigs.delete', ordered_params=['name'], path_params=['name'], query_params=[], relative_path='v1beta/{+name}', request_field='', request_type_name='WebsecurityscannerProjectsScanConfigsDeleteRequest', response_type_name='Empty', supports_download=False)
      ...
      """
            config = self.GetMethodConfig('Get')
            return self._RunMethod(config, request, global_params=global_params)
        Get.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1beta/projects/{projectsId}/scanConfigs/{scanConfigsId}', http_method='GET', method_id='websecurityscanner.projects.scanConfigs.get', ordered_params=['name'], path_params=['name'], query_params=[], relative_path='v1beta/{+name}', request_field='', request_type_name='WebsecurityscannerProjectsScanConfigsGetRequest', response_type_name='ScanConfig', supports_download=False)
      ...
      """
            config = self.GetMethodConfig('List')
            return self._RunMethod(config, request, global_params=global_params)
        List.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1beta/projects/{projectsId}/scanConfigs', http_method='GET', method_id='websecurityscanner.projects.scanConfigs.list', ordered_params=['parent'], path_params=['parent'], query_params=['pageSize', 'pageToken'], relative_path='v1beta/{+parent}/scanConfigs', request_field='', request_type_name='WebsecurityscannerProjectsScanConfigsListRequest', response_type_name='ListScanConfigsResponse', supports_download=False)
      ...
      """
            ...
            return self._RunMethod(config, request, global_params=global_params)
        Patch.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1beta/projects/{projectsId}/scanConfigs/{scanConfigsId}', http_method='PATCH', method_id='websecurityscanner.projects.scanConfigs.patch', ordered_params=['name'], path_params=['name'], query_params=['updateMask'], relative_path='v1beta/{+name}', request_field='scanConfig', request_type_name='WebsecurityscannerProjectsScanConfigsPatchRequest', response_type_name='ScanConfig', supports_download=False)
      ...
      """
            ...
            return self._RunMethod(config, request, global_params=global_params)
        Start.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1beta/projects/{projectsId}/scanConfigs/{scanConfigsId}:start', http_method='POST', method_id='websecurityscanner.projects.scanConfigs.start', ordered_params=['name'], path_params=['name'], query_params=[], relative_path='v1beta/{+name}:start', request_field='startScanRunRequest', request_type_name='WebsecurityscannerProjectsScanConfigsStartRequest', response_type_name='ScanRun', supports_download=False)
