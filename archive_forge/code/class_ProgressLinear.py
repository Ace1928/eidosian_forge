...
class ProgressLinear(VuetifyWidget):
    ...
    background_opacity = Union([Float(), Unicode()], default_value=None, allow_none=True).tag(sync=True)
    bottom = Bool(None, allow_none=True).tag(sync=True)
    buffer_value = Union([Float(), Unicode()], default_value=None, allow_none=True).tag(sync=True)
