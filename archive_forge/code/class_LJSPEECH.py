...
class LJSPEECH(Dataset):
    ...
    def __init__(self, root: Union[str, Path], url: str=_RELEASE_CONFIGS['release1']['url'], folder_in_archive: str=_RELEASE_CONFIGS['release1']['folder_in_archive'], download: bool=False) -> None:
    ...
    def __getitem__(self, n: int) -> Tuple[Tensor, int, str, str]:
        ...
        return (waveform, sample_rate, transcript, normalized_transcript)
