...
def _status_response(self, response_class, issuer, status, sign=None, sign_alg=None, digest_alg=None, **kwargs):
    ...
    response = response_class(issuer=issuer, id=mid, version=VERSION, issue_instant=instant(), status=status, **kwargs)
