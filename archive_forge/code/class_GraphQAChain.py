...
class GraphQAChain(Chain):
    ...
    *Security note*: Make sure that the database connection uses credentials
    ...
    @classmethod
    def from_llm(cls, llm: BaseLanguageModel, qa_prompt: BasePromptTemplate=GRAPH_QA_PROMPT, entity_prompt: BasePromptTemplate=ENTITY_EXTRACTION_PROMPT, **kwargs: Any) -> GraphQAChain:
        """Initialize from LLM."""
    ...
    def _call(self, inputs: Dict[str, Any], run_manager: Optional[CallbackManagerForChainRun]=None) -> Dict[str, str]:
        ...
        result = self.qa_chain({'question': question, 'context': context}, callbacks=_run_manager.get_child())
