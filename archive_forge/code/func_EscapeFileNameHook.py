...
def EscapeFileNameHook(ref, unused_args, req):
    ...
    file = resources.REGISTRY.Create('artifactregistry.projects.locations.repositories.files', projectsId=ref.projectsId, locationsId=ref.locationsId, repositoriesId=ref.repositoriesId, filesId=ref.filesId.replace('/', '%2F'))
