...
class RootingTool(QtWidgets.QMainWindow):
    def __init__(self):
        ...
        self.browser_window = QWebEngineView(self)
    ...
    def init_ui(self):
        ...
        self.documentationButton.clicked.connect(self.show_documentation)
        self.custom_rom_path = None

        # Set up main tab layout
        main_layout = QVBoxLayout()
        main_layout.addWidget(self.detectDevicesButton)
        main_layout.addWidget(self.selectRomButton)
        main_layout.addWidget(self.browseRomButton)
        main_layout.addWidget(self.setupDeviceButton)
        main_layout.addWidget(self.documentationButton)
        self.main_tab.setLayout(main_layout)

        # Set up tab widget
        self.tab_widget.addTab(self.main_tab, "Main")
        self.tab_widget.addTab(self.browser_window, "Browser")
    ...
    def browse_rom(self):
        ...
        self.tab_widget.setCurrentWidget(self.browser_window)
