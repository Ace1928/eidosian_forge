...
class FugueSQLVisitor(fugue_sqlVisitor):
    ...
    def _str(self, node: Union[Tree, Token, None], delimit: str=' ', upper_keyword: bool=False) -> str:
        return self.sql.get_norm_text(node, delimiter=delimit, upper_keyword=upper_keyword)
