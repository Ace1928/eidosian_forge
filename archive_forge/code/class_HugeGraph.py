...
class HugeGraph:
    ...
    *Security note*: Make sure that the database connection uses credentials
    ...
    def __init__(self, username: str='default', password: str='default', address: str='127.0.0.1', port: int=8081, graph: str='hugegraph') -> None:
        """Create a new HugeGraph wrapper instance."""
        try:
            from hugegraph.connection import PyHugeGraph
        except ImportError:
            raise ValueError('Please install HugeGraph Python client first: `pip3 install hugegraph-python`')
