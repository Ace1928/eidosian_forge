...
class MemcacheSetRequest(ProtocolBuffer.ProtocolMessage):
    ...
    REPLACE = 3
    CAS = 4
    _SetPolicy_NAMES = {1: 'SET', 2: 'ADD', 3: 'REPLACE', 4: 'CAS'}

    def SetPolicy_Name(cls, x):
        return cls._SetPolicy_NAMES.get(x, '')
