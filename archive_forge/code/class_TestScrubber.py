...
class TestScrubber(functional.FunctionalTest):
    ...
    def setUp(self):
        ...
        CONF.set_override('connection', self.api_server.sql_connection, group='database')
    ...
    def test_delayed_delete(self):
        ...
        self.start_servers(delayed_delete=True, daemon=True, metadata_encryption_key='', **kwargs)
    ...
    def test_scrubber_delete_handles_exception(self):
        ...
        self.cleanup()
        kwargs = self.__dict__.copy()
        self.start_servers(delayed_delete=True, daemon=False, default_store='file', **kwargs)
