...
class TwoQubitDiagonalGate(raw_types.Gate):
    ...
    def _resolve_parameters_(self, resolver: 'cirq.ParamResolver', recursive: bool) -> 'TwoQubitDiagonalGate':
        return TwoQubitDiagonalGate(protocols.resolve_parameters(self._diag_angles_radians, resolver, recursive))
