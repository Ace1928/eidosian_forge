...
class CloudkmsV1alpha1(base_api.BaseApiClient):
    ...
    def __init__(self, url='', credentials=None, get_credentials=True, http=None, model=None, log_request=False, log_response=False, credentials_args=None, default_global_params=None, additional_http_headers=None, response_encoding=None):
        ...
        super(CloudkmsV1alpha1, self).__init__(url, credentials=credentials, get_credentials=get_credentials, http=http, model=model, log_request=log_request, log_response=log_response, credentials_args=credentials_args, default_global_params=default_global_params, additional_http_headers=additional_http_headers, response_encoding=response_encoding)
    ...
    class ProjectsService(base_api.BaseApiService):
      ...
      """
        ...
        GetProjectOptOutState.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1alpha1/projects/{projectsId}:getProjectOptOutState', http_method='GET', method_id='cloudkms.projects.getProjectOptOutState', ordered_params=['name'], path_params=['name'], query_params=[], relative_path='v1alpha1/{+name}:getProjectOptOutState', request_field='', request_type_name='CloudkmsProjectsGetProjectOptOutStateRequest', response_type_name='GetProjectOptOutStateResponse', supports_download=False)
      ...
      """
            ...
            return self._RunMethod(config, request, global_params=global_params)
        SetProjectOptOutState.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1alpha1/projects/{projectsId}:setProjectOptOutState', http_method='POST', method_id='cloudkms.projects.setProjectOptOutState', ordered_params=['name'], path_params=['name'], query_params=[], relative_path='v1alpha1/{+name}:setProjectOptOutState', request_field='setProjectOptOutStateRequest', request_type_name='CloudkmsProjectsSetProjectOptOutStateRequest', response_type_name='SetProjectOptOutStateResponse', supports_download=False)