...
class ThemesHandler(FileFindHandler):
    ...
    def initialize(self, path: str | list[str], default_filename: str | None=None, no_cache_paths: list[str] | None=None, themes_url: str | None=None, labextensions_path: list[str] | None=None, **kwargs: Any) -> None:
    ...
    def get_content(self, abspath: str, start: int | None=None, end: int | None=None) -> bytes | Generator[bytes, None, None]:
