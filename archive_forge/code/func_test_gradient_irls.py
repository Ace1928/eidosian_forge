    ...
    for family_class, family_links in families:
        for link in family_links:
            for binom_version in (0, 1):
                ...
                if not (family_class, link) in [(fam.Poisson, lnk.Sqrt), (fam.Gamma, lnk.InversePower), (fam.InverseGaussian, lnk.Identity)]:
                ...
                for max_start_irls, start_params in ((0, rslt_irls.params), (3, None)):
                    ...
                    rslt_gradient = mod_gradient.fit(max_start_irls=max_start_irls, start_params=start_params, method='newton', maxiter=300)
                    ...
                    rslt_gradient_eim = mod_gradient.fit(max_start_irls=0, cov_type='eim', start_params=rslt_gradient.params, method='newton', maxiter=300)
