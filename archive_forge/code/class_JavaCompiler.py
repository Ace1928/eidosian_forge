...
class JavaCompiler(BasicLinkerIsCompilerMixin, Compiler):
    language = 'java'
    id = 'unknown'
    _WARNING_LEVELS: T.Dict[str, T.List[str]] = {'0': ['-nowarn'], '1': ['-Xlint:all'], '2': ['-Xlint:all', '-Xdoclint:all'], '3': ['-Xlint:all', '-Xdoclint:all']}

    def __init__(self, exelist: T.List[str], version: str, for_machine: MachineChoice, info: 'MachineInfo', full_version: T.Optional[str]=None):
    ...
    def sanity_check(self, work_dir: str, environment: 'Environment') -> None:
        ...
        with open(source_name, 'w', encoding='utf-8') as ofile:
            ofile.write(textwrap.dedent('class SanityCheck {\n                  public static void main(String[] args) {\n                    int i;\n                  }\n                }\n                '))
        ...
        if runner:
            ...
            m = "Java Virtual Machine wasn't found, but it's needed by Meson. Please install a JRE.\nIf you have specific needs where this requirement doesn't make sense, please open a bug at https://github.com/mesonbuild/meson/issues/new and tell us all about it."
