...
def get_object_locations(obj_refs: List[ObjectRef], timeout_ms: int=-1) -> Dict[ObjectRef, Dict[str, Any]]:
    ...
    return ray._private.worker.global_worker.core_worker.get_object_locations(obj_refs, timeout_ms)