...
def test_select_datastore_insufficient_freespace(self, mock_get_freespace, mock_ds_ref):
    ...
    self.assertRaises(exceptions.StorageFull, self.store.select_datastore, image_size)