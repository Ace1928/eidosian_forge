...
class ORTModelForMaskedLM(ORTModel):
    ...
    @add_start_docstrings_to_model_forward(ONNX_TEXT_INPUTS_DOCSTRING.format('batch_size, sequence_length') + MASKED_LM_EXAMPLE.format(processor_class=_TOKENIZER_FOR_DOC, model_class='ORTModelForMaskedLM', checkpoint='optimum/bert-base-uncased-for-fill-mask'))
