...
class ExecutionEngine:
    ...
    def _downloaded(self, result: Union[Response, Request, Failure], request: Request) -> Union[Deferred, Response, Failure]:
        assert self.slot is not None
        self.slot.remove_request(request)
    ...
    def _download(self, request: Request) -> Deferred:
        ...
        def _on_success(result: Union[Response, Request]) -> Union[Response, Request]:
            ...
            if isinstance(result, Response):
                ...
                self.signals.send_catch_log(signal=signals.response_received, response=result, request=result.request, spider=self.spider)
            return result
