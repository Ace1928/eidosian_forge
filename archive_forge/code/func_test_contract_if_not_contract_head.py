...
def test_contract_if_not_contract_head(self, mock_validate_engine, mock_get_alembic_branch_head, mock_get_current_alembic_heads):
    ...
    self.assertIn("Database contraction failed. Couldn't find head revision of contract branch.", exit.code)