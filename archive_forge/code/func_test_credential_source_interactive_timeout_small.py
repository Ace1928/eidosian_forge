...
def test_credential_source_interactive_timeout_small(self):
    with pytest.raises(ValueError) as excinfo:
        CREDENTIAL_SOURCE = {'executable': {'command': self.CREDENTIAL_SOURCE_EXECUTABLE_COMMAND, 'interactive_timeout_millis': 30000 - 1, 'output_file': self.CREDENTIAL_SOURCE_EXECUTABLE_OUTPUT_FILE}}
