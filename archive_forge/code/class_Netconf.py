...
class Netconf(NetconfBase):
    ...
    def get_capabilities(self):
        result = dict()
        result['rpc'] = self.get_base_rpc() + ['commit', 'discard_changes', 'validate', 'lock', 'unlock', 'copy_copy', 'execute_rpc', 'load_configuration', 'get_configuration', 'command', 'reboot', 'halt']
    ...
    @ensure_ncclient
    def commit(self, confirmed=False, timeout=None, persist=None, check=False, comment=None, synchronize=False, at_time=None):
        """
