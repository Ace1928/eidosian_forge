...
class LSFEnvironment(ClusterEnvironment):
    ...
    def world_size(self) -> int:
        ...
        if world_size is None:
            raise ValueError('Cannot determine world size. Environment variable `JSM_NAMESPACE_SIZE` not found. Make sure you run your executable with `jsrun`.')
    ...
    def global_rank(self) -> int:
        ...
        if global_rank is None:
            raise ValueError('Cannot determine global rank. Environment variable `JSM_NAMESPACE_RANK` not found. Make sure you run your executable with `jsrun`.')
    ...
    def local_rank(self) -> int:
        ...
        if local_rank is None:
            raise ValueError('Cannot determine local rank. Environment variable `JSM_NAMESPACE_LOCAL_RANK` not found. Make sure you run your executable with `jsrun`.')
