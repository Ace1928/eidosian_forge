...
class LoadBalancersClient(ClientEntityBase):
    ...
    def get_by_id(self, id: int) -> BoundLoadBalancer:
        ...
        """
        response = self._client.request(url=f'/load_balancers/{id}', method='GET')
        return BoundLoadBalancer(self, response['load_balancer'])

    def get_list(self, name: str | None=None, label_selector: str | None=None, page: int | None=None, per_page: int | None=None) -> LoadBalancersPageResult:
        ...
        load_balancers = [BoundLoadBalancer(self, load_balancer_data) for load_balancer_data in response['load_balancers']]
        return LoadBalancersPageResult(load_balancers, Meta.parse_meta(response))

    def get_all(self, name: str | None=None, label_selector: str | None=None) -> list[BoundLoadBalancer]:
    ...
    def create(self, name: str, load_balancer_type: LoadBalancerType | BoundLoadBalancerType, algorithm: LoadBalancerAlgorithm | None=None, services: list[LoadBalancerService] | None=None, targets: list[LoadBalancerTarget] | None=None, labels: dict[str, str] | None=None, location: Location | BoundLocation | None=None, network_zone: str | None=None, public_interface: bool | None=None, network: Network | BoundNetwork | None=None) -> CreateLoadBalancerResponse:
        ...
        """
        data: dict[str, Any] = {'name': name, 'load_balancer_type': load_balancer_type.id_or_name}
    ...
    def update(self, load_balancer: LoadBalancer | BoundLoadBalancer, name: str | None=None, labels: dict[str, str] | None=None) -> BoundLoadBalancer:
        ...
        response = self._client.request(url=f'/load_balancers/{load_balancer.id}', method='PUT', json=data)
        return BoundLoadBalancer(self, response['load_balancer'])
    ...
    def delete(self, load_balancer: LoadBalancer | BoundLoadBalancer) -> bool:
        ...
        :return: boolean
        """
        self._client.request(url=f'/load_balancers/{load_balancer.id}', method='DELETE')
        return True

    def get_metrics(self, load_balancer: LoadBalancer | BoundLoadBalancer, type: MetricsType | list[MetricsType], start: datetime | str, end: datetime | str, step: float | None=None) -> GetMetricsResponse:
        ...
        if step is not None:
            params['step'] = step
        response = self._client.request(url=f'/load_balancers/{load_balancer.id}/metrics', method='GET', params=params)
        return GetMetricsResponse(metrics=Metrics(**response['metrics']))

    def get_actions_list(self, load_balancer: LoadBalancer | BoundLoadBalancer, status: list[str] | None=None, sort: list[str] | None=None, page: int | None=None, per_page: int | None=None) -> ActionsPageResult:
        ...
        if per_page is not None:
            params['per_page'] = per_page
        response = self._client.request(url=f'/load_balancers/{load_balancer.id}/actions', method='GET', params=params)
        actions = [BoundAction(self._client.actions, action_data) for action_data in response['actions']]
        return ActionsPageResult(actions, Meta.parse_meta(response))

    def get_actions(self, load_balancer: LoadBalancer | BoundLoadBalancer, status: list[str] | None=None, sort: list[str] | None=None) -> list[BoundAction]:
        """Returns all action objects for a Load Balancer.
        ...
        """
        return self._iter_pages(self.get_actions_list, load_balancer, status=status, sort=sort)

    def add_service(self, load_balancer: LoadBalancer | BoundLoadBalancer, service: LoadBalancerService) -> BoundAction:
        ...
        response = self._client.request(url=f'/load_balancers/{load_balancer.id}/actions/add_service', method='POST', json=data)
        return BoundAction(self._client.actions, response['action'])

    def update_service(self, load_balancer: LoadBalancer | BoundLoadBalancer, service: LoadBalancerService) -> BoundAction:
        ...
        """
        data: dict[str, Any] = service.to_payload()
        response = self._client.request(url=f'/load_balancers/{load_balancer.id}/actions/update_service', method='POST', json=data)
        return BoundAction(self._client.actions, response['action'])

    def delete_service(self, load_balancer: LoadBalancer | BoundLoadBalancer, service: LoadBalancerService) -> BoundAction:
        ...
        response = self._client.request(url=f'/load_balancers/{load_balancer.id}/actions/delete_service', method='POST', json=data)
        return BoundAction(self._client.actions, response['action'])

    def add_target(self, load_balancer: LoadBalancer | BoundLoadBalancer, target: LoadBalancerTarget) -> BoundAction:
        ...
        response = self._client.request(url=f'/load_balancers/{load_balancer.id}/actions/add_target', method='POST', json=data)
        return BoundAction(self._client.actions, response['action'])
    ...
    def change_protection(self, load_balancer: LoadBalancer | BoundLoadBalancer, delete: bool | None=None) -> BoundAction:
        ...
        response = self._client.request(url=f'/load_balancers/{load_balancer.id}/actions/change_protection', method='POST', json=data)
        return BoundAction(self._client.actions, response['action'])
    ...
    def disable_public_interface(self, load_balancer: LoadBalancer | BoundLoadBalancer) -> BoundAction:
        ...
        :return: :class:`BoundAction <hcloud.actions.client.BoundAction>`
        """
        response = self._client.request(url=f'/load_balancers/{load_balancer.id}/actions/disable_public_interface', method='POST')
        return BoundAction(self._client.actions, response['action'])

    def change_type(self, load_balancer: LoadBalancer | BoundLoadBalancer, load_balancer_type: LoadBalancerType | BoundLoadBalancerType) -> BoundAction:
        ...
        response = self._client.request(url=f'/load_balancers/{load_balancer.id}/actions/change_type', method='POST', json=data)
        return BoundAction(self._client.actions, response['action'])