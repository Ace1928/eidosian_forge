...
class SparkIO(object):
    ...
    def __init__(self, spark_session: SparkSession):
        ...
        self._loads: Dict[str, Callable[..., DataFrame]] = {'csv': self._load_csv, 'parquet': self._load_parquet, 'json': self._load_json}
    ...
    def _get_writer(self, sdf: ps.DataFrame, partition_spec: PartitionSpec) -> ps.DataFrameWriter:
        num = int(partition_spec.num_partitions)
