...
class TestDataMigrationFramework(test_utils.BaseTestCase):
    ...
    @mock.patch('glance.db.sqlalchemy.alembic_migrations.data_migrations._find_migration_modules')
    def test_has_pending_migrations_mult_migration_one_pending(self, mock_find):
        mock_migration1 = mock.Mock()
        mock_migration1.has_migrations.return_value = False
        mock_migration2 = mock.Mock()
    ...
    @mock.patch('glance.db.sqlalchemy.alembic_migrations.data_migrations._find_migration_modules')
    def test_has_pending_migrations_mult_migration_some_pending(self, mock_find):
        mock_migration1 = mock.Mock()
        mock_migration1.has_migrations.return_value = False
        mock_migration2 = mock.Mock()
        mock_migration2.has_migrations.return_value = True
        ...
        mock_find.return_value = [mock_migration1, mock_migration2, mock_migration3, mock_migration4]
        self.assertTrue(data_migrations.has_pending_migrations(mock.Mock()))
