...
class RequestWriteToMethodInjectionTests(MethodInjectionTestsMixin, SynchronousTestCase):
    """
    ...
    def attemptRequestWithMaliciousMethod(self, method):
        ...
        req = client.Request(method=b'GET', uri=b'http://twisted.invalid', headers=headers, bodyProducer=None)
        req.method = method
