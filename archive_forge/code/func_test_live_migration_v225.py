...
def test_live_migration_v225(self):
    self.run_command('live-migration sample-server hostname', api_version='2.25')
    self.assert_called('POST', '/servers/1234/action', {'os-migrateLive': {'host': 'hostname', 'block_migration': 'auto'}})
    self.run_command('live-migration sample-server hostname --block-migrate', api_version='2.25')
    ...
    self.assert_called('POST', '/servers/1234/action', {'os-migrateLive': {'host': None, 'block_migration': 'auto'}})