...
class Textarea(VuetifyWidget):
    ...
    row_height = Union([Float(), Unicode()], default_value=None, allow_none=True).tag(sync=True)
    rows = Union([Float(), Unicode()], default_value=None, allow_none=True).tag(sync=True)
