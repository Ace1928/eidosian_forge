...
class TestCopyImageTask(test_utils.BaseTestCase):
    ...
    def setUp(self):
        ...
        task_input = {'import_req': {'method': {'name': 'copy-image'}, 'stores': ['fast']}}
    ...
    @mock.patch.object(store_api, 'get_store_from_store_identifier')
    def test_copy_image_to_staging_store_partial_data_exists(self, mock_store_api, mock_exists, mock_getsize, mock_unlink):
        mock_store_api.return_value = self.staging_store
