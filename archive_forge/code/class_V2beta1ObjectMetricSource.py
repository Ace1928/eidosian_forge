...
class V2beta1ObjectMetricSource(object):
    ...
    swagger_types = {'average_value': 'str', 'metric_name': 'str', 'selector': 'V1LabelSelector', 'target': 'V2beta1CrossVersionObjectReference', 'target_value': 'str'}
    attribute_map = {'average_value': 'averageValue', 'metric_name': 'metricName', 'selector': 'selector', 'target': 'target', 'target_value': 'targetValue'}
