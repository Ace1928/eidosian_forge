...
@cli.register_custom_action('ProjectDeployment', mandatory=('status',), optional=('comment', 'represented_as'))
@exc.on_http_error(exc.GitlabDeploymentApprovalError)
def approval(self, status: str, comment: Optional[str]=None, represented_as: Optional[str]=None, **kwargs: Any) -> Dict[str, Any]:
