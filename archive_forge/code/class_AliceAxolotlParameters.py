class AliceAxolotlParameters:
    ...
    def __init__(self, ourIdentityKey, ourBaseKey, theirIdentityKey, theirSignedPreKey, theirRatchetKey, theirOneTimePreKey):
        """
        ...
        if ourBaseKey is None or ourIdentityKey is None or theirSignedPreKey is None or (theirRatchetKey is None) or (theirIdentityKey is None) or (theirSignedPreKey is None):
