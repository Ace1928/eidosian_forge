...
class AlphaZeroConfig(AlgorithmConfig):
    ...
    def __init__(self, algo_class=None):
        ...
        self.replay_buffer_config = {'type': 'ReplayBuffer', 'capacity': 1000, 'storage_unit': 'fragments'}
        self.num_steps_sampled_before_learning_starts = 1000
        self.lr_schedule = None
        self.vf_share_layers = False
        self.mcts_config = {'puct_coefficient': 1.0, 'num_simulations': 30, 'temperature': 1.5, 'dirichlet_epsilon': 0.25, 'dirichlet_noise': 0.03, 'argmax_tree_policy': False, 'add_dirichlet_noise': True}
        self.ranked_rewards = {'enable': True, 'percentile': 75, 'buffer_max_length': 1000, 'initialize_buffer': True, 'num_init_rewards': 100}
