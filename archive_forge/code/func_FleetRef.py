...
def FleetRef(project, fleet='default', location='global', release_track=base.ReleaseTrack.ALPHA) -> resources.Resource:
    return resources.REGISTRY.Parse(line=None, params={'projectsId': project, 'locationsId': location, 'fleetsId': fleet}, collection='gkehub.projects.locations.fleets', api_version=VERSION_MAP[release_track])