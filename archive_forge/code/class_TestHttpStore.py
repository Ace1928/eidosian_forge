...
class TestHttpStore(base.StoreBaseTest, test_store_capabilities.TestStoreCapabilitiesChecking):
    ...
    def test_http_get(self):
        ...
        expected_returns = ['I ', 'am', ' a', ' t', 'ea', 'po', 't,', ' s', 'ho', 'rt', ' a', 'nd', ' s', 'to', 'ut', '\n']
    ...
    def test_http_get_redirect(self):
        ...
        responses = [utils.fake_response(), utils.fake_response(status_code=301, headers=redirect2), utils.fake_response(status_code=302, headers=redirect1)]
    ...
    def test_http_get_max_redirects(self):
        ...
        responses = [utils.fake_response(status_code=302, headers=redirect)] * (http.MAX_REDIRECTS + 2)
