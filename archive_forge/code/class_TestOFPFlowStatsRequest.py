...
class TestOFPFlowStatsRequest(unittest.TestCase):
    ...
    def test_init(self):
        ...
        c = OFPFlowStatsRequest(_Datapath, self.table_id, self.out_port, self.out_group, self.cookie, self.cookie_mask, match)
    ...
    def _test_serialize(self, table_id, out_port, out_group, cookie, cookie_mask):
        ...
        c = OFPFlowStatsRequest(_Datapath, table_id, out_port, out_group, cookie, cookie_mask, match)
        c.serialize()
        ...
        fmt = ofproto.OFP_HEADER_PACK_STR + ofproto.OFP_STATS_REQUEST_PACK_STR[1:] + ofproto.OFP_FLOW_STATS_REQUEST_PACK_STR[1:] + 'HHHBB' + MTEthType.pack_str[1:] + '6x'
        ...
        size = ofproto.OFP_STATS_REPLY_SIZE + ofproto.OFP_FLOW_STATS_REQUEST_SIZE + calcsize(MTEthType.pack_str + '6x')
