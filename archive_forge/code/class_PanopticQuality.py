...
class PanopticQuality(Metric):
    ...
    def update(self, preds: Tensor, target: Tensor) -> None:
        ...
        iou_sum, true_positives, false_positives, false_negatives = _panoptic_quality_update(flatten_preds, flatten_target, self.cat_id_to_continuous_id, self.void_color)
