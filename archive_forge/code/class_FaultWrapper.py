...
class FaultWrapper(wsgi.Middleware):
    ...
    def _error(self, ex):
        ...
        error = {'code': webob_exc.code, 'title': webob_exc.title, 'explanation': webob_exc.explanation, 'error': {'type': ex_type, 'traceback': trace}}
        if safe:
