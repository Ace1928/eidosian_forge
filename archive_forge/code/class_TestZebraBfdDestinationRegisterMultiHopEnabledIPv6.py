...
class TestZebraBfdDestinationRegisterMultiHopEnabledIPv6(unittest.TestCase):
    buf = b'\x00\x00\x00\x01\x00\n \x01\r\xb8\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x01\x00\x00\x00\x10\x00\x00\x00 \x01\x01\x00\n \x01\r\xb8\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x02\x05'
    pid = 1
