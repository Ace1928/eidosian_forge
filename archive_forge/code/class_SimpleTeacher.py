...
class SimpleTeacher(DefaultTeacher):
    ...
    def add_cmdline_args(argparser):
        ...
        agent.add_argument('--light_use_current_self_output', type=str, default='none', choices=['none', 'all', 'all_filtered', 'all_filtered_remove'])
        agent.add_argument('--light_label_type', type=str, default='speech', choices=['speech', 'action', 'emote'], help='type of target in light dialogues')
