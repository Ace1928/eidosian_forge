...
class PyVmomiDeviceHelper(object):
    ...
    def __init__(self, module):
        ...
        self.module = module
        self.scsi_device_type = {'lsilogic': vim.vm.device.VirtualLsiLogicController, 'paravirtual': vim.vm.device.ParaVirtualSCSIController, 'buslogic': vim.vm.device.VirtualBusLogicController, 'lsilogicsas': vim.vm.device.VirtualLsiLogicSASController}
        ...
        self.disk_ctl_device_type.update({'sata': self.sata_device_type, 'nvme': self.nvme_device_type, 'ide': self.ide_device_type})
        self.usb_device_type = {'usb2': vim.vm.device.VirtualUSBController, 'usb3': vim.vm.device.VirtualUSBXHCIController}
        self.nic_device_type = {'pcnet32': vim.vm.device.VirtualPCNet32, 'vmxnet2': vim.vm.device.VirtualVmxnet2, 'vmxnet3': vim.vm.device.VirtualVmxnet3, 'e1000': vim.vm.device.VirtualE1000, 'e1000e': vim.vm.device.VirtualE1000e, 'sriov': vim.vm.device.VirtualSriovEthernetCard, 'pvrdma': vim.vm.device.VirtualVmxnet3Vrdma}
    ...
    def integer_value(self, input_value, name):
        ...
        if isinstance(input_value, int):
            ...
            self.module.fail_json(msg='"%s" attribute should be an integer value.' % name)
