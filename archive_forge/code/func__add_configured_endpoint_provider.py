...
def _add_configured_endpoint_provider(self, client_name, config_store):
    chain = ConfiguredEndpointProvider(full_config=self.full_config, scoped_config=self.get_scoped_config(), client_name=client_name)
    config_store.set_config_provider(logical_name='endpoint_url', provider=chain)