...
class SparseCSRTensor(torch.Tensor):
    ...
    def _to(cls, arg0, device):
        ...
        return cls._wrap(arg0.shape, arg0.__values.to(device=device), arg0.__row_indices.to(device=device), arg0.__row_offsets.to(device=device), arg0.__column_indices.to(device=device), tuple((t.to(device=device) for t in arg0.__transp_info)))
