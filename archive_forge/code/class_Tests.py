...
class Tests(TestCase):
    ...
    def test_max_size(self):
        ...
        with mock.patch.object(peephole_opt, 'MAX_SIZE', max_size):
            size = max_size
            result = (9,) * size
            code = Bytecode([Instr('LOAD_CONST', 9), Instr('BUILD_TUPLE', 1), Instr('LOAD_CONST', size), Instr('BINARY_MULTIPLY'), Instr('STORE_NAME', 'x')])
            self.check(code, Instr('LOAD_CONST', result), Instr('STORE_NAME', 'x'))
            size = max_size + 1
            code = Bytecode([Instr('LOAD_CONST', 9), Instr('BUILD_TUPLE', 1), Instr('LOAD_CONST', size), Instr('BINARY_MULTIPLY'), Instr('STORE_NAME', 'x')])
            self.check(code, Instr('LOAD_CONST', (9,)), Instr('LOAD_CONST', size), Instr('BINARY_MULTIPLY'), Instr('STORE_NAME', 'x'))
    ...
    def test_build_list(self):
        code = Bytecode([Instr('LOAD_NAME', 'x'), Instr('LOAD_CONST', 1), Instr('LOAD_CONST', 2), Instr('LOAD_CONST', 3), Instr('BUILD_LIST', 3), Instr('COMPARE_OP', Compare.IN), Instr('STORE_NAME', 'test')])
        self.check(code, Instr('LOAD_NAME', 'x'), Instr('LOAD_CONST', (1, 2, 3)), Instr('COMPARE_OP', Compare.IN), Instr('STORE_NAME', 'test'))
    ...
    def test_build_tuple_unpack_seq_const(self):
        code = Bytecode([Instr('LOAD_CONST', 3), Instr('LOAD_CONST', 4), Instr('BUILD_TUPLE', 2), Instr('UNPACK_SEQUENCE', 2), Instr('STORE_NAME', 'x'), Instr('STORE_NAME', 'y')])
        self.check(code, Instr('LOAD_CONST', (3, 4)), Instr('UNPACK_SEQUENCE', 2), Instr('STORE_NAME', 'x'), Instr('STORE_NAME', 'y'))
    ...
    def test_build_set(self):
        code = Bytecode([Instr('LOAD_NAME', 'x'), Instr('LOAD_CONST', 1), Instr('LOAD_CONST', 2), Instr('LOAD_CONST', 3), Instr('BUILD_SET', 3), Instr('COMPARE_OP', Compare.IN), Instr('STORE_NAME', 'test')])
        self.check(code, Instr('LOAD_NAME', 'x'), Instr('LOAD_CONST', frozenset((1, 2, 3))), Instr('COMPARE_OP', Compare.IN), Instr('STORE_NAME', 'test'))
    ...
    def test_jump_to_return(self):
        label_instr4 = Label()
        label_instr6 = Label()
        code = Bytecode([Instr('LOAD_FAST', 'condition'), Instr('POP_JUMP_IF_FALSE', label_instr4), Instr('LOAD_CONST', 'yes'), Instr('JUMP_FORWARD', label_instr6), label_instr4, Instr('LOAD_CONST', 'no'), label_instr6, Instr('RETURN_VALUE')])
        label = Label()
        self.check(code, Instr('LOAD_FAST', 'condition'), Instr('POP_JUMP_IF_FALSE', label), Instr('LOAD_CONST', 'yes'), Instr('RETURN_VALUE'), label, Instr('LOAD_CONST', 'no'), Instr('RETURN_VALUE'))
