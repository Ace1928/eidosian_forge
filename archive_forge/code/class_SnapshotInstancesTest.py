...
class SnapshotInstancesTest(utils.TestCase):
    ...
    def setUp(self):
        ...
        self.manager = share_snapshot_instances.ShareSnapshotInstanceManager(api=mock_microversion)
    ...
    def test_get(self):
        ...
        self.manager._get.assert_called_once_with('/snapshot-instances/' + 'fake_snapshot_instance', 'snapshot_instance')
    ...
    def test_reset_instance_state(self):
        ...
        self.manager._action.assert_called_once_with('reset_status', 'fake_instance', {'status': state})
