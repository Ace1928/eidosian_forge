...
def test_flavor_find_fetch_extra(self):
    ...
    with mock.patch('openstack.compute.v2.flavor.Flavor.fetch_extra_specs') as mocked:
        ...
        self._verify('openstack.proxy.Proxy._find', self.proxy.find_flavor, method_args=['res', True], method_kwargs={'get_extra_specs': True}, expected_result=res, expected_args=[flavor.Flavor, 'res'], expected_kwargs={'ignore_missing': True})
