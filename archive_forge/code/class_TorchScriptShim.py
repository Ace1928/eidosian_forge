...
class TorchScriptShim(PyTorchShim):
    ...
    def __init__(self, model: Optional['torch.jit.ScriptModule'], config=None, optimizer: Any=None, mixed_precision: bool=False, grad_scaler: Optional[PyTorchGradScaler]=None, device: Optional['torch.device']=None):
