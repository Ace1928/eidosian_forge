...
async def validate_async_rules(func: Callable, *args: Any, **kwargs: Any) -> None:
    """
    ...
    for arg, value in bound_arguments.arguments.items():
        if arg in AsyncLogDecorator.validation_rules:
            validation_rule = AsyncLogDecorator.validation_rules[arg]
            try:
