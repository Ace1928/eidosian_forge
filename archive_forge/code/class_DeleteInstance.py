...
class DeleteInstance(base.DeleteCommand):
    ...
    detailed_help = {'EXAMPLES': textwrap.dedent('          To delete an instance, run:\n\n            $ {command} my-instance-id\n\n          ')}
    ...
    """
        ...
        for instance in args.instance:
            should_continue = console_io.PromptContinue(message='Delete instance {}. Are you sure?'.format(instance))
            if should_continue:
                ref = util.GetInstanceRef(instance)
                msg = msgs.BigtableadminProjectsInstancesDeleteRequest(name=ref.RelativeName())
