...
class LoggingServiceV2GrpcAsyncIOTransport(LoggingServiceV2Transport):
    ...
    @property
    def delete_log(self) -> Callable[[logging.DeleteLogRequest], Awaitable[empty_pb2.Empty]]:
        """Return a callable for the delete log method over gRPC.
        ...
        if 'delete_log' not in self._stubs:
            self._stubs['delete_log'] = self.grpc_channel.unary_unary('/google.logging.v2.LoggingServiceV2/DeleteLog', request_serializer=logging.DeleteLogRequest.serialize, response_deserializer=empty_pb2.Empty.FromString)
        return self._stubs['delete_log']

    @property
    def write_log_entries(self) -> Callable[[logging.WriteLogEntriesRequest], Awaitable[logging.WriteLogEntriesResponse]]:
        """Return a callable for the write log entries method over gRPC.
        ...
        if 'write_log_entries' not in self._stubs:
            self._stubs['write_log_entries'] = self.grpc_channel.unary_unary('/google.logging.v2.LoggingServiceV2/WriteLogEntries', request_serializer=logging.WriteLogEntriesRequest.serialize, response_deserializer=logging.WriteLogEntriesResponse.deserialize)
        return self._stubs['write_log_entries']

    @property
    def list_log_entries(self) -> Callable[[logging.ListLogEntriesRequest], Awaitable[logging.ListLogEntriesResponse]]:
        """Return a callable for the list log entries method over gRPC.
        ...
        if 'list_log_entries' not in self._stubs:
            self._stubs['list_log_entries'] = self.grpc_channel.unary_unary('/google.logging.v2.LoggingServiceV2/ListLogEntries', request_serializer=logging.ListLogEntriesRequest.serialize, response_deserializer=logging.ListLogEntriesResponse.deserialize)
        return self._stubs['list_log_entries']

    @property
    def list_monitored_resource_descriptors(self) -> Callable[[logging.ListMonitoredResourceDescriptorsRequest], Awaitable[logging.ListMonitoredResourceDescriptorsResponse]]:
        """Return a callable for the list monitored resource
        ...
        if 'list_monitored_resource_descriptors' not in self._stubs:
            self._stubs['list_monitored_resource_descriptors'] = self.grpc_channel.unary_unary('/google.logging.v2.LoggingServiceV2/ListMonitoredResourceDescriptors', request_serializer=logging.ListMonitoredResourceDescriptorsRequest.serialize, response_deserializer=logging.ListMonitoredResourceDescriptorsResponse.deserialize)
        return self._stubs['list_monitored_resource_descriptors']

    @property
    def list_logs(self) -> Callable[[logging.ListLogsRequest], Awaitable[logging.ListLogsResponse]]:
        """Return a callable for the list logs method over gRPC.
        ...
        if 'list_logs' not in self._stubs:
            self._stubs['list_logs'] = self.grpc_channel.unary_unary('/google.logging.v2.LoggingServiceV2/ListLogs', request_serializer=logging.ListLogsRequest.serialize, response_deserializer=logging.ListLogsResponse.deserialize)
        return self._stubs['list_logs']

    @property
    def tail_log_entries(self) -> Callable[[logging.TailLogEntriesRequest], Awaitable[logging.TailLogEntriesResponse]]:
        """Return a callable for the tail log entries method over gRPC.
        ...
        if 'tail_log_entries' not in self._stubs:
            self._stubs['tail_log_entries'] = self.grpc_channel.stream_stream('/google.logging.v2.LoggingServiceV2/TailLogEntries', request_serializer=logging.TailLogEntriesRequest.serialize, response_deserializer=logging.TailLogEntriesResponse.deserialize)
