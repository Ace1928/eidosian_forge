...
def get_pulls(self, state: Opt[str]=NotSet, sort: Opt[str]=NotSet, direction: Opt[str]=NotSet, base: Opt[str]=NotSet, head: Opt[str]=NotSet) -> PaginatedList[PullRequest]:
    """
    ...
    return PaginatedList(github.PullRequest.PullRequest, self._requester, f'{self.url}/pulls', url_parameters)