...
def AddServiceMinInstancesFlag(parser):
    ...
    parser.add_argument('--service-min-instances', type=_ScaleValue, help="The minimum number of container instances for this Service to run or 'default' to remove any minimum. These instances will be divided among all Revisions receiving a percentage of traffic.")