...
class RequestViewerHook(PecanHook):
    ...
    **blacklist**
    ...
    def __init__(self, config=None, writer=sys.stdout, terminal=True, headers=True):
        ...
        elif config.__class__.__name__ == 'Config':
