...
def _update_experiment():
    request_message = _get_request_message(UpdateExperiment(), schema={'experiment_id': [_assert_required, _assert_string], 'new_name': [_assert_string, _assert_required]})
    if request_message.new_name:
        _get_tracking_store().rename_experiment(request_message.experiment_id, request_message.new_name)
