...
class XCodeBackend(backends.Backend):
    ...
    def write_tree(self, objects_dict, tree_node, children_array, current_subdir) -> None:
        ...
        potentials = [os.path.join(current_subdir, 'meson.build'), os.path.join(current_subdir, 'meson.options'), os.path.join(current_subdir, 'meson_options.txt')]
        ...
        for name in self.source_phase:
            ...
            for gt in t.generated:
                if isinstance(gt, build.CustomTarget):
                    ...
                    for o in ofilenames:
                        file_arr.add_item(self.custom_target_output_buildfile[o], os.path.join(self.environment.get_build_dir(), o))
