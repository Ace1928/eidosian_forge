...
class Pathfinder:
    def __init__(
        ...
        self.env_adapt = environmental_adaptability
        self.multi_agent = multi_agent_coordination
        self.resource_optim = resource_optimization
    ...
    def heuristic(
        ...
        Parameters:
            ...
            space_around_agent (int): The space around the agent to consider for path planning. If the space has to be occupied, so long as a collision won't occur then the agent will.
            space_around_goals (int): The space around the goals to consider for path planning. The agent will always try and make its self position collide/overlap with the goal position. Space is only for body if relevant.
            space_around_obstacles (int): The space around the obstacles to consider for path planning. If the space has to be occupied, so long as a collision won't occur then the agent will.
