...
def _make_remote(function_or_class, options):
    ...
    if inspect.isfunction(function_or_class) or is_cython(function_or_class):
        ...
        return ray.remote_function.RemoteFunction(Language.PYTHON, function_or_class, None, options)
    ...
    raise TypeError('The @ray.remote decorator must be applied to either a function or a class.')