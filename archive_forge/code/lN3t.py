...
class DynamicActivationNeuronApp:
    ...
    def train_with_text_data(self):
        # Set parameters (these should be defined somewhere in your class or passed to the method)
        INPUT_SIZE = 10  # example value
        SYNTHETIC_DATA_SIZE = 10000  # example value
        TEST_SIZE = 0.2  # example value
        RANDOM_STATE = 42  # example value
        SYNTHETIC_DATA_DIR = "./synthetic_data"  # example value
        BATCH_SIZE = 32  # example value
        LR = 0.001  # example value
        WEIGHT_DECAY = 0.0001  # example value
        REGRESSION_TRAINED_MODEL_PATH = "./trained_model.pkl"  # example value
        TARGET_LOSS = 0.01  # example value
        TARGET_RMSE = 0.1  # example value
        TARGET_MAPE = 1.0  # example value
        OUTPUT_DIR = "./output"  # example value
        ...
        if self.use_existing_data:
            regression_train_loader, regression_val_loader = (
                DataProcessor.create_or_load_synthetic_data(
                    ...
                    SYNTHETIC_DATA_DIR,
                    BATCH_SIZE,
                    dynamic_padding=True,  # Ensure dynamic handling of input sizes
                )
            )
        else:
            regression_train_loader, regression_val_loader = (
