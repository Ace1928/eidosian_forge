...
class Test_suffix(unittest.TestCase):
    ...
    def test_export_suffix_generator(self):
        ...
        self.assertEqual([id(c_) for c_ in export_suffix_generator(m)], [id(m.s1), id(m.s1i), id(m.s3), id(m.s3i), id(m.b.s1), id(m.b.s1i), id(m.b.s3), id(m.b.s3i)])
        self.assertEqual([id(c_) for c_ in export_suffix_generator(m, descend_into=False)], [id(m.s1), id(m.s1i), id(m.s3), id(m.s3i)])
        self.assertEqual([id(c_) for c_ in export_suffix_generator(m, datatype=suffix.INT)], [id(m.s1i), id(m.s3i), id(m.b.s1i), id(m.b.s3i)])
        m.s1.deactivate()
        m.b.deactivate()
        self.assertEqual([id(c_) for c_ in export_suffix_generator(m, active=True)], [id(m.s1i), id(m.s3), id(m.s3i)])
    ...
    def test_import_suffix_generator(self):
        ...
        m.b.s3 = suffix(direction=suffix.EXPORT)
        m.b.s3i = suffix(direction=suffix.EXPORT, datatype=suffix.INT)
        self.assertEqual([id(c_) for c_ in import_suffix_generator(m)], [id(m.s1), id(m.s1i), id(m.s2), id(m.s2i), id(m.b.s1), id(m.b.s1i), id(m.b.s2), id(m.b.s2i)])
        self.assertEqual([id(c_) for c_ in import_suffix_generator(m, descend_into=False)], [id(m.s1), id(m.s1i), id(m.s2), id(m.s2i)])
        self.assertEqual([id(c_) for c_ in import_suffix_generator(m, datatype=suffix.INT)], [id(m.s1i), id(m.s2i), id(m.b.s1i), id(m.b.s2i)])
        m.s1.deactivate()
        m.b.deactivate()
        self.assertEqual([id(c_) for c_ in import_suffix_generator(m, active=True)], [id(m.s1i), id(m.s2), id(m.s2i)])
    ...
    def test_local_suffix_generator(self):
        ...
        m.b.s3 = suffix(direction=suffix.EXPORT)
        m.b.s3i = suffix(direction=suffix.EXPORT, datatype=suffix.INT)
        self.assertEqual([id(c_) for c_ in local_suffix_generator(m)], [id(m.s0), id(m.s0i), id(m.b.s0), id(m.b.s0i)])
        self.assertEqual([id(c_) for c_ in local_suffix_generator(m, descend_into=False)], [id(m.s0), id(m.s0i)])
        self.assertEqual([id(c_) for c_ in local_suffix_generator(m, datatype=suffix.INT)], [id(m.s0i), id(m.b.s0i)])
        m.s0.deactivate()
        m.b.deactivate()
        self.assertEqual([id(c_) for c_ in local_suffix_generator(m, active=True)], [id(m.s0i)])
