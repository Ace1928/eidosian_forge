...
class TestStatementsBase(object):
    ...
    def add_labels(self, record):
        record.add_attributes([('prov:label', Literal('hello')), ('prov:label', Literal('bye', langtag='en')), ('prov:label', Literal('bonjour', langtag='fr'))])

    def add_types(self, record):
        record.add_attributes([('prov:type', 'a'), ('prov:type', 1), ('prov:type', 1.0), ('prov:type', True), ('prov:type', EX_NS['abc']), ('prov:type', datetime.datetime.now()), ('prov:type', Literal('http://boiled-egg.example.com', datatype=XSD_ANYURI))])
    ...
    def test_generation_4(self):
        document = self.new_document()
        document.new_record(PROV_GENERATION, EX_NS['gen4'], ((PROV_ATTR_ENTITY, EX_NS['e1']), (PROV_ATTR_ACTIVITY, EX_NS['a1']), (PROV_ATTR_TIME, datetime.datetime.now())), {PROV_ROLE: 'somerole'})
        self.do_tests(document)
    ...
    def test_generation_7(self):
        document = self.new_document()
        a = document.generation(EX_NS['e1'], activity=EX_NS['a1'], time=datetime.datetime.now())
        a.add_attributes([(PROV_ROLE, 'somerole')])
        self.add_types(a)
        self.add_locations(a)
        self.add_labels(a)
    ...
    def test_invalidation_3(self):
        ...
        inv.add_attributes([(PROV_ROLE, 'someRole'), (PROV_ROLE, 'otherRole')])
        self.do_tests(document)
    ...
    def test_invalidation_7(self):
        document = self.new_document()
        inv = document.invalidation(EX_NS['e1'], activity=EX_NS['a1'], time=datetime.datetime.now())
        inv.add_attributes([(PROV_ROLE, 'someRole')])
        self.add_types(inv)
        self.add_locations(inv)
        self.add_labels(inv)
    ...
    def test_start_8(self):
        document = self.new_document()
        start = document.start(EX_NS['a1'], identifier=EX_NS['start8'], starter=EX_NS['a2'], time=datetime.datetime.now())
    ...
    def test_derivation_10(self):
        document = self.new_document()
        document.derivation(EX_NS['e2'], usedEntity=EX_NS['e1'], activity=EX_NS['a'], usage=EX_NS['u'], generation=EX_NS['g'])
        self.do_tests(document)
    ...
    def test_scruffy_generation_1(self):
        document = self.new_document()
        document.generation(EX_NS['e1'], EX_NS['a1'], identifier=EX_NS['gen1'], time=datetime.datetime.now())
        document.generation(EX_NS['e1'], EX_NS['a1'], identifier=EX_NS['gen1'], time=dateutil.parser.parse('2012-12-03T21:08:16.686Z'))
    ...
    def test_scruffy_generation_2(self):
        document = self.new_document()
        gen1 = document.generation(EX_NS['e1'], EX_NS['a1'], identifier=EX_NS['gen1'], time=datetime.datetime.now())
        gen2 = document.generation(EX_NS['e1'], EX_NS['a1'], identifier=EX_NS['gen1'], time=dateutil.parser.parse('2012-12-03T21:08:16.686Z'))
    ...
    def test_scruffy_invalidation_1(self):
        document = self.new_document()
        document.invalidation(EX_NS['e1'], EX_NS['a1'], identifier=EX_NS['gen1'], time=datetime.datetime.now())
        document.invalidation(EX_NS['e1'], EX_NS['a1'], identifier=EX_NS['gen1'], time=dateutil.parser.parse('2012-12-03T21:08:16.686Z'))
        document.entity(identifier=EX_NS['e1'])
        document.activity(identifier=EX_NS['a1'])
        self.do_tests(document)
    ...
    def test_scruffy_invalidation_2(self):
        document = self.new_document()
        inv1 = document.invalidation(EX_NS['e1'], EX_NS['a1'], identifier=EX_NS['gen1'], time=datetime.datetime.now())
        inv2 = document.invalidation(EX_NS['e1'], EX_NS['a1'], identifier=EX_NS['gen1'], time=dateutil.parser.parse('2012-12-03T21:08:16.686Z'))
    ...
    def test_scruffy_usage_1(self):
        document = self.new_document()
        document.usage(EX_NS['a1'], EX_NS['e1'], identifier=EX_NS['gen1'], time=datetime.datetime.now())
        document.usage(EX_NS['a1'], EX_NS['e1'], identifier=EX_NS['gen1'], time=dateutil.parser.parse('2012-12-03T21:08:16.686Z'))
        document.entity(identifier=EX_NS['e1'])
        document.activity(identifier=EX_NS['a1'])
        self.do_tests(document)
    ...
    def test_scruffy_usage_2(self):
        document = self.new_document()
        use1 = document.usage(EX_NS['a1'], EX_NS['e1'], identifier=EX_NS['gen1'], time=datetime.datetime.now())
        use2 = document.usage(EX_NS['a1'], EX_NS['e1'], identifier=EX_NS['gen1'], time=dateutil.parser.parse('2012-12-03T21:08:16.686Z'))
    ...
    def test_scruffy_start_1(self):
        document = self.new_document()
        document.start(EX_NS['a1'], EX_NS['e1'], identifier=EX_NS['gen1'], time=datetime.datetime.now())
        document.start(EX_NS['a1'], EX_NS['e1'], identifier=EX_NS['gen1'], time=dateutil.parser.parse('2012-12-03T21:08:16.686Z'))
        document.entity(identifier=EX_NS['e1'])
        document.activity(identifier=EX_NS['a1'])
        self.do_tests(document)
    ...
    def test_scruffy_start_2(self):
        document = self.new_document()
        start1 = document.start(EX_NS['a1'], EX_NS['e1'], identifier=EX_NS['gen1'], time=datetime.datetime.now())
        start2 = document.start(EX_NS['a1'], EX_NS['e1'], identifier=EX_NS['gen1'], time=dateutil.parser.parse('2012-12-03T21:08:16.686Z'))
    ...
    def test_scruffy_start_3(self):
        document = self.new_document()
        start1 = document.start(EX_NS['a1'], EX_NS['e1'], identifier=EX_NS['gen1'], time=datetime.datetime.now(), starter=EX_NS['a1s'])
        start2 = document.start(EX_NS['a1'], EX_NS['e1'], identifier=EX_NS['gen1'], time=dateutil.parser.parse('2012-12-03T21:08:16.686Z'), starter=EX_NS['a2s'])
        start1.add_attributes([(EX_NS['tag2'], 'hello')])
        start2.add_attributes([(EX_NS['tag2'], 'hi')])
        document.entity(identifier=EX_NS['e1'])
        document.activity(identifier=EX_NS['a1'])
    ...
    def test_scruffy_end_1(self):
        document = self.new_document()
        document.end(EX_NS['a1'], EX_NS['e1'], identifier=EX_NS['gen1'], time=datetime.datetime.now())
        document.end(EX_NS['a1'], EX_NS['e1'], identifier=EX_NS['gen1'], time=dateutil.parser.parse('2012-12-03T21:08:16.686Z'))
        document.entity(identifier=EX_NS['e1'])
        document.activity(identifier=EX_NS['a1'])
        self.do_tests(document)
    ...
    def test_scruffy_end_2(self):
        document = self.new_document()
        end1 = document.end(EX_NS['a1'], EX_NS['e1'], identifier=EX_NS['gen1'], time=datetime.datetime.now())
        end2 = document.end(EX_NS['a1'], EX_NS['e1'], identifier=EX_NS['gen1'], time=dateutil.parser.parse('2012-12-03T21:08:16.686Z'))
    ...
    def test_scruffy_end_3(self):
        document = self.new_document()
        end1 = document.end(EX_NS['a1'], EX_NS['e1'], identifier=EX_NS['gen1'], time=datetime.datetime.now(), ender=EX_NS['a1s'])
        end2 = document.end(EX_NS['a1'], EX_NS['e1'], identifier=EX_NS['gen1'], time=dateutil.parser.parse('2012-12-03T21:08:16.686Z'), ender=EX_NS['a2s'])
        end1.add_attributes([(EX_NS['tag2'], 'hello')])
        end2.add_attributes([(EX_NS['tag2'], 'hi')])
        document.entity(identifier=EX_NS['e1'])
        document.activity(identifier=EX_NS['a1'])
