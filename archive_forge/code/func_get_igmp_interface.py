...
def get_igmp_interface(module, interface):
    ...
    if body:
        ...
        if re.search('^en|^true|^enabled', immediate_leave):
            igmp['immediate_leave'] = True
        elif re.search('^dis|^false|^disabled', immediate_leave):
