...
class OrganizationsConfigTemplatesSwitchProfilesPorts(object):
    ...
    def get_all_params(self, name=None, id=None):
        ...
        if self.new_object.get('profileId') is not None or self.new_object.get('profile_id') is not None:
            new_object_params['profileId'] = self.new_object.get('profileId') or self.new_object.get('profile_id')
    ...
    def get_object_by_name(self, name):
        result = None
        try:
            items = self.meraki.exec_meraki(family='switch', function='getOrganizationConfigTemplateSwitchProfilePorts', params=self.get_all_params(name=name))
    ...
    def get_object_by_id(self, id):
        result = None
        try:
            items = self.meraki.exec_meraki(family='switch', function='getOrganizationConfigTemplateSwitchProfilePort', params=self.get_params_by_id())
            if isinstance(items, dict):
                if 'response' in items:
                    items = items.get('response')
            result = items
    ...
    def update(self):
        ...
        result = self.meraki.exec_meraki(family='switch', function='updateOrganizationConfigTemplateSwitchProfilePort', params=self.update_by_id_params(), op_modifies=True)
        return result