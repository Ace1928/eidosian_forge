...
class LocationsWorkforcePoolsOperationsService(base_api.BaseApiService):
    ...
    Get.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1/locations/{locationsId}/workforcePools/{workforcePoolsId}/operations/{operationsId}', http_method='GET', method_id='iam.locations.workforcePools.operations.get', ordered_params=['name'], path_params=['name'], query_params=[], relative_path='v1/{+name}', request_field='', request_type_name='IamLocationsWorkforcePoolsOperationsGetRequest', response_type_name='Operation', supports_download=False)