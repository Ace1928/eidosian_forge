...
def plot_ecdf(x_coord, y_coord, x_bands, lower, higher, confidence_bands, plot_kwargs, fill_kwargs, plot_outline_kwargs, figsize, fill_band, ax, show, backend_kwargs):
    """Bokeh ecdfplot."""
