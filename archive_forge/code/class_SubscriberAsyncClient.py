...
class SubscriberAsyncClient:
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        """
        return SubscriberClient.from_service_account_info.__func__(SubscriberAsyncClient, info, *args, **kwargs)
    ...
    def from_service_account_file(cls, filename: str, *args, **kwargs):
        ...
        Returns:
            SubscriberAsyncClient: The constructed client.
        """
        return SubscriberClient.from_service_account_file.__func__(SubscriberAsyncClient, filename, *args, **kwargs)
    ...
    def get_mtls_endpoint_and_cert_source(cls, client_options: Optional[ClientOptions]=None):
        ...
        """
        return SubscriberClient.get_mtls_endpoint_and_cert_source(client_options)
    ...
    def __init__(self, *, credentials: Optional[ga_credentials.Credentials]=None, transport: Union[str, SubscriberTransport]='grpc_asyncio', client_options: Optional[ClientOptions]=None, client_info: gapic_v1.client_info.ClientInfo=DEFAULT_CLIENT_INFO) -> None:
        ...
        """
        self._client = SubscriberClient(credentials=credentials, transport=transport, client_options=client_options, client_info=client_info)

    async def create_subscription(self, request: Optional[Union[pubsub.Subscription, dict]]=None, *, name: Optional[str]=None, topic: Optional[str]=None, push_config: Optional[pubsub.PushConfig]=None, ack_deadline_seconds: Optional[int]=None, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> pubsub.Subscription:
        ...
        rpc = gapic_v1.method_async.wrap_method(self._client._transport.create_subscription, default_retry=retries.Retry(initial=0.1, maximum=60.0, multiplier=1.3, predicate=retries.if_exception_type(core_exceptions.Aborted, core_exceptions.ServiceUnavailable, core_exceptions.Unknown), deadline=60.0), default_timeout=60.0, client_info=DEFAULT_CLIENT_INFO)
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((('name', request.name),)),)
        response = await rpc(request, retry=retry, timeout=timeout, metadata=metadata)
        return response

    async def get_subscription(self, request: Optional[Union[pubsub.GetSubscriptionRequest, dict]]=None, *, subscription: Optional[str]=None, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> pubsub.Subscription:
        ...
        rpc = gapic_v1.method_async.wrap_method(self._client._transport.get_subscription, default_retry=retries.Retry(initial=0.1, maximum=60.0, multiplier=1.3, predicate=retries.if_exception_type(core_exceptions.Aborted, core_exceptions.ServiceUnavailable, core_exceptions.Unknown), deadline=60.0), default_timeout=60.0, client_info=DEFAULT_CLIENT_INFO)
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((('subscription', request.subscription),)),)
        response = await rpc(request, retry=retry, timeout=timeout, metadata=metadata)
        return response

    async def update_subscription(self, request: Optional[Union[pubsub.UpdateSubscriptionRequest, dict]]=None, *, subscription: Optional[pubsub.Subscription]=None, update_mask: Optional[field_mask_pb2.FieldMask]=None, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> pubsub.Subscription:
        ...
        rpc = gapic_v1.method_async.wrap_method(self._client._transport.update_subscription, default_retry=retries.Retry(initial=0.1, maximum=60.0, multiplier=1.3, predicate=retries.if_exception_type(core_exceptions.ServiceUnavailable), deadline=60.0), default_timeout=60.0, client_info=DEFAULT_CLIENT_INFO)
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((('subscription.name', request.subscription.name),)),)
        response = await rpc(request, retry=retry, timeout=timeout, metadata=metadata)
        return response

    async def list_subscriptions(self, request: Optional[Union[pubsub.ListSubscriptionsRequest, dict]]=None, *, project: Optional[str]=None, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> pagers.ListSubscriptionsAsyncPager:
        ...
        rpc = gapic_v1.method_async.wrap_method(self._client._transport.list_subscriptions, default_retry=retries.Retry(initial=0.1, maximum=60.0, multiplier=1.3, predicate=retries.if_exception_type(core_exceptions.Aborted, core_exceptions.ServiceUnavailable, core_exceptions.Unknown), deadline=60.0), default_timeout=60.0, client_info=DEFAULT_CLIENT_INFO)
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((('project', request.project),)),)
        response = await rpc(request, retry=retry, timeout=timeout, metadata=metadata)
        response = pagers.ListSubscriptionsAsyncPager(method=rpc, request=request, response=response, metadata=metadata)
        return response

    async def delete_subscription(self, request: Optional[Union[pubsub.DeleteSubscriptionRequest, dict]]=None, *, subscription: Optional[str]=None, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> None:
        ...
        if subscription is not None:
            request.subscription = subscription
        rpc = gapic_v1.method_async.wrap_method(self._client._transport.delete_subscription, default_retry=retries.Retry(initial=0.1, maximum=60.0, multiplier=1.3, predicate=retries.if_exception_type(core_exceptions.ServiceUnavailable), deadline=60.0), default_timeout=60.0, client_info=DEFAULT_CLIENT_INFO)
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((('subscription', request.subscription),)),)
        await rpc(request, retry=retry, timeout=timeout, metadata=metadata)

    async def modify_ack_deadline(self, request: Optional[Union[pubsub.ModifyAckDeadlineRequest, dict]]=None, *, subscription: Optional[str]=None, ack_ids: Optional[MutableSequence[str]]=None, ack_deadline_seconds: Optional[int]=None, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> None:
        ...
        rpc = gapic_v1.method_async.wrap_method(self._client._transport.modify_ack_deadline, default_retry=retries.Retry(initial=0.1, maximum=60.0, multiplier=1.3, predicate=retries.if_exception_type(core_exceptions.ServiceUnavailable), deadline=60.0), default_timeout=60.0, client_info=DEFAULT_CLIENT_INFO)
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((('subscription', request.subscription),)),)
        await rpc(request, retry=retry, timeout=timeout, metadata=metadata)

    async def acknowledge(self, request: Optional[Union[pubsub.AcknowledgeRequest, dict]]=None, *, subscription: Optional[str]=None, ack_ids: Optional[MutableSequence[str]]=None, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> None:
        ...
        if ack_ids:
            request.ack_ids.extend(ack_ids)
        rpc = gapic_v1.method_async.wrap_method(self._client._transport.acknowledge, default_retry=retries.Retry(initial=0.1, maximum=60.0, multiplier=1.3, predicate=retries.if_exception_type(core_exceptions.ServiceUnavailable), deadline=60.0), default_timeout=60.0, client_info=DEFAULT_CLIENT_INFO)
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((('subscription', request.subscription),)),)
        await rpc(request, retry=retry, timeout=timeout, metadata=metadata)

    async def pull(self, request: Optional[Union[pubsub.PullRequest, dict]]=None, *, subscription: Optional[str]=None, return_immediately: Optional[bool]=None, max_messages: Optional[int]=None, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> pubsub.PullResponse:
        ...
        if request.return_immediately:
            warnings.warn('The return_immediately flag is deprecated and should be set to False.', category=DeprecationWarning)
        rpc = gapic_v1.method_async.wrap_method(self._client._transport.pull, default_retry=retries.Retry(initial=0.1, maximum=60.0, multiplier=1.3, predicate=retries.if_exception_type(core_exceptions.Aborted, core_exceptions.InternalServerError, core_exceptions.ServiceUnavailable, core_exceptions.Unknown), deadline=60.0), default_timeout=60.0, client_info=DEFAULT_CLIENT_INFO)
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((('subscription', request.subscription),)),)
        response = await rpc(request, retry=retry, timeout=timeout, metadata=metadata)
        return response

    def streaming_pull(self, requests: Optional[AsyncIterator[pubsub.StreamingPullRequest]]=None, *, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> Awaitable[AsyncIterable[pubsub.StreamingPullResponse]]:
    ...
    async def modify_push_config(self, request: Optional[Union[pubsub.ModifyPushConfigRequest, dict]]=None, *, subscription: Optional[str]=None, push_config: Optional[pubsub.PushConfig]=None, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> None:
        ...
        if push_config is not None:
            request.push_config = push_config
        rpc = gapic_v1.method_async.wrap_method(self._client._transport.modify_push_config, default_retry=retries.Retry(initial=0.1, maximum=60.0, multiplier=1.3, predicate=retries.if_exception_type(core_exceptions.ServiceUnavailable), deadline=60.0), default_timeout=60.0, client_info=DEFAULT_CLIENT_INFO)
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((('subscription', request.subscription),)),)
        await rpc(request, retry=retry, timeout=timeout, metadata=metadata)

    async def get_snapshot(self, request: Optional[Union[pubsub.GetSnapshotRequest, dict]]=None, *, snapshot: Optional[str]=None, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> pubsub.Snapshot:
        ...
        rpc = gapic_v1.method_async.wrap_method(self._client._transport.get_snapshot, default_retry=retries.Retry(initial=0.1, maximum=60.0, multiplier=1.3, predicate=retries.if_exception_type(core_exceptions.Aborted, core_exceptions.ServiceUnavailable, core_exceptions.Unknown), deadline=60.0), default_timeout=60.0, client_info=DEFAULT_CLIENT_INFO)
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((('snapshot', request.snapshot),)),)
        response = await rpc(request, retry=retry, timeout=timeout, metadata=metadata)
        return response

    async def list_snapshots(self, request: Optional[Union[pubsub.ListSnapshotsRequest, dict]]=None, *, project: Optional[str]=None, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> pagers.ListSnapshotsAsyncPager:
        ...
        if project is not None:
            request.project = project
        rpc = gapic_v1.method_async.wrap_method(self._client._transport.list_snapshots, default_retry=retries.Retry(initial=0.1, maximum=60.0, multiplier=1.3, predicate=retries.if_exception_type(core_exceptions.Aborted, core_exceptions.ServiceUnavailable, core_exceptions.Unknown), deadline=60.0), default_timeout=60.0, client_info=DEFAULT_CLIENT_INFO)
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((('project', request.project),)),)
        response = await rpc(request, retry=retry, timeout=timeout, metadata=metadata)
        response = pagers.ListSnapshotsAsyncPager(method=rpc, request=request, response=response, metadata=metadata)
        return response

    async def create_snapshot(self, request: Optional[Union[pubsub.CreateSnapshotRequest, dict]]=None, *, name: Optional[str]=None, subscription: Optional[str]=None, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> pubsub.Snapshot:
        ...
        if subscription is not None:
            request.subscription = subscription
        rpc = gapic_v1.method_async.wrap_method(self._client._transport.create_snapshot, default_retry=retries.Retry(initial=0.1, maximum=60.0, multiplier=1.3, predicate=retries.if_exception_type(core_exceptions.ServiceUnavailable), deadline=60.0), default_timeout=60.0, client_info=DEFAULT_CLIENT_INFO)
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((('name', request.name),)),)
        response = await rpc(request, retry=retry, timeout=timeout, metadata=metadata)
        return response

    async def update_snapshot(self, request: Optional[Union[pubsub.UpdateSnapshotRequest, dict]]=None, *, snapshot: Optional[pubsub.Snapshot]=None, update_mask: Optional[field_mask_pb2.FieldMask]=None, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> pubsub.Snapshot:
        ...
        if update_mask is not None:
            request.update_mask = update_mask
        rpc = gapic_v1.method_async.wrap_method(self._client._transport.update_snapshot, default_retry=retries.Retry(initial=0.1, maximum=60.0, multiplier=1.3, predicate=retries.if_exception_type(core_exceptions.ServiceUnavailable), deadline=60.0), default_timeout=60.0, client_info=DEFAULT_CLIENT_INFO)
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((('snapshot.name', request.snapshot.name),)),)
        response = await rpc(request, retry=retry, timeout=timeout, metadata=metadata)
        return response

    async def delete_snapshot(self, request: Optional[Union[pubsub.DeleteSnapshotRequest, dict]]=None, *, snapshot: Optional[str]=None, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> None:
        ...
        if snapshot is not None:
            request.snapshot = snapshot
        rpc = gapic_v1.method_async.wrap_method(self._client._transport.delete_snapshot, default_retry=retries.Retry(initial=0.1, maximum=60.0, multiplier=1.3, predicate=retries.if_exception_type(core_exceptions.ServiceUnavailable), deadline=60.0), default_timeout=60.0, client_info=DEFAULT_CLIENT_INFO)
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((('snapshot', request.snapshot),)),)
        await rpc(request, retry=retry, timeout=timeout, metadata=metadata)

    async def seek(self, request: Optional[Union[pubsub.SeekRequest, dict]]=None, *, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> pubsub.SeekResponse:
        ...
        rpc = gapic_v1.method_async.wrap_method(self._client._transport.seek, default_retry=retries.Retry(initial=0.1, maximum=60.0, multiplier=1.3, predicate=retries.if_exception_type(core_exceptions.Aborted, core_exceptions.ServiceUnavailable, core_exceptions.Unknown), deadline=60.0), default_timeout=60.0, client_info=DEFAULT_CLIENT_INFO)
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((('subscription', request.subscription),)),)
        response = await rpc(request, retry=retry, timeout=timeout, metadata=metadata)
        return response

    async def set_iam_policy(self, request: Optional[iam_policy_pb2.SetIamPolicyRequest]=None, *, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> policy_pb2.Policy:
    ...
    async def get_iam_policy(self, request: Optional[iam_policy_pb2.GetIamPolicyRequest]=None, *, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> policy_pb2.Policy:
    ...
    async def test_iam_permissions(self, request: Optional[iam_policy_pb2.TestIamPermissionsRequest]=None, *, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> iam_policy_pb2.TestIamPermissionsResponse:
