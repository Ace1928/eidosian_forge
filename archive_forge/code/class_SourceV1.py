...
class SourceV1(base_api.BaseApiClient):
    ...
    def __init__(self, url='', credentials=None, get_credentials=True, http=None, model=None, log_request=False, log_response=False, credentials_args=None, default_global_params=None, additional_http_headers=None, response_encoding=None):
        ...
        super(SourceV1, self).__init__(url, credentials=credentials, get_credentials=get_credentials, http=http, model=model, log_request=log_request, log_response=log_response, credentials_args=credentials_args, default_global_params=default_global_params, additional_http_headers=additional_http_headers, response_encoding=response_encoding)
...
file or directory information about that path.
      ...
      """
        ...
        Get.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1/projects/{projectId}/repos/{repoName}/aliases/{kind}/{name}/files/{filesId}', http_method='GET', method_id='source.projects.repos.aliases.files.get', ordered_params=['projectId', 'repoName', 'kind', 'name', 'path'], path_params=['kind', 'name', 'path', 'projectId', 'repoName'], query_params=['pageSize', 'pageToken', 'sourceContext_cloudRepo_aliasName', 'sourceContext_cloudRepo_repoId_uid', 'sourceContext_cloudRepo_revisionId', 'sourceContext_cloudWorkspace_snapshotId', 'sourceContext_cloudWorkspace_workspaceId_name', 'sourceContext_cloudWorkspace_workspaceId_repoId_projectRepoId_projectId', 'sourceContext_cloudWorkspace_workspaceId_repoId_projectRepoId_repoName', 'sourceContext_cloudWorkspace_workspaceId_repoId_uid', 'sourceContext_gerrit_aliasContext_kind', 'sourceContext_gerrit_aliasContext_name', 'sourceContext_gerrit_aliasName', 'sourceContext_gerrit_gerritProject', 'sourceContext_gerrit_hostUri', 'sourceContext_gerrit_revisionId', 'sourceContext_git_revisionId', 'sourceContext_git_url', 'startPosition'], relative_path='v1/projects/{projectId}/repos/{repoName}/aliases/{kind}/{name}/files/{+path}', request_field='', request_type_name='SourceProjectsReposAliasesFilesGetRequest', response_type_name='ReadResponse', supports_download=False)
...
`https://source.developers.google.com/p/PROJECT_ID/r/NAME`.
      ...
      """
            config = self.GetMethodConfig('Create')
            return self._RunMethod(config, request, global_params=global_params)
        Create.method_config = lambda: base_api.ApiMethodInfo(http_method='POST', method_id='source.projects.repos.create', ordered_params=['projectId'], path_params=['projectId'], query_params=[], relative_path='v1/projects/{projectId}/repos', request_field='<request>', request_type_name='Repo', response_type_name='Repo', supports_download=False)
      ...
      """
            config = self.GetMethodConfig('Delete')
            return self._RunMethod(config, request, global_params=global_params)
        Delete.method_config = lambda: base_api.ApiMethodInfo(http_method='DELETE', method_id='source.projects.repos.delete', ordered_params=['projectId', 'repoName'], path_params=['projectId', 'repoName'], query_params=['repoId_uid'], relative_path='v1/projects/{projectId}/repos/{repoName}', request_field='', request_type_name='SourceProjectsReposDeleteRequest', response_type_name='Empty', supports_download=False)
      ...
      """
            config = self.GetMethodConfig('Get')
            return self._RunMethod(config, request, global_params=global_params)
        Get.method_config = lambda: base_api.ApiMethodInfo(http_method='GET', method_id='source.projects.repos.get', ordered_params=['projectId', 'repoName'], path_params=['projectId', 'repoName'], query_params=['repoId_uid'], relative_path='v1/projects/{projectId}/repos/{repoName}', request_field='', request_type_name='SourceProjectsReposGetRequest', response_type_name='Repo', supports_download=False)
...
response list is sorted by name with the default repo listed first.
      ...
      """
            config = self.GetMethodConfig('List')
            return self._RunMethod(config, request, global_params=global_params)
        List.method_config = lambda: base_api.ApiMethodInfo(http_method='GET', method_id='source.projects.repos.list', ordered_params=['projectId'], path_params=['projectId'], query_params=[], relative_path='v1/projects/{projectId}/repos', request_field='', request_type_name='SourceProjectsReposListRequest', response_type_name='ListReposResponse', supports_download=False)
...
workspace is simultaneously modified by another client.
      ...
      """
            ...
            return self._RunMethod(config, request, global_params=global_params)
        Merge.method_config = lambda: base_api.ApiMethodInfo(http_method='POST', method_id='source.projects.repos.merge', ordered_params=['projectId', 'repoName'], path_params=['projectId', 'repoName'], query_params=[], relative_path='v1/projects/{projectId}/repos/{repoName}:merge', request_field='mergeRequest', request_type_name='SourceProjectsReposMergeRequest', response_type_name='Workspace', supports_download=False)
  ...
  3) its name (deprecated and going away b/32283418).
      ...
      """
            config = self.GetMethodConfig('Update')
            return self._RunMethod(config, request, global_params=global_params)
        Update.method_config = lambda: base_api.ApiMethodInfo(http_method='PUT', method_id='source.projects.repos.update', ordered_params=['projectId', 'repoName'], path_params=['projectId', 'repoName'], query_params=[], relative_path='v1/projects/{projectId}/repos/{repoName}', request_field='updateRepoRequest', request_type_name='SourceProjectsReposUpdateRequest', response_type_name='Repo', supports_download=False)
...
The result is ordered by path. Pagination is supported.
      ...
      """
            ...
            return self._RunMethod(config, request, global_params=global_params)
        ListChangedFiles.method_config = lambda: base_api.ApiMethodInfo(http_method='POST', method_id='source.listChangedFiles', ordered_params=[], path_params=[], query_params=[], relative_path='v1:listChangedFiles', request_field='<request>', request_type_name='ListChangedFilesRequest', response_type_name='ListChangedFilesResponse', supports_download=False)