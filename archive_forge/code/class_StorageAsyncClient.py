...
class StorageAsyncClient:
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        """
        return StorageClient.from_service_account_info.__func__(StorageAsyncClient, info, *args, **kwargs)
    ...
    def from_service_account_file(cls, filename: str, *args, **kwargs):
        ...
        Returns:
            StorageAsyncClient: The constructed client.
        """
        return StorageClient.from_service_account_file.__func__(StorageAsyncClient, filename, *args, **kwargs)
    ...
    def get_mtls_endpoint_and_cert_source(cls, client_options: Optional[ClientOptions]=None):
        ...
        """
        return StorageClient.get_mtls_endpoint_and_cert_source(client_options)
    ...
    def __init__(self, *, credentials: Optional[ga_credentials.Credentials]=None, transport: Union[str, StorageTransport]='grpc_asyncio', client_options: Optional[ClientOptions]=None, client_info: gapic_v1.client_info.ClientInfo=DEFAULT_CLIENT_INFO) -> None:
        ...
        """
        self._client = StorageClient(credentials=credentials, transport=transport, client_options=client_options, client_info=client_info)

    async def delete_bucket(self, request: Optional[Union[storage.DeleteBucketRequest, dict]]=None, *, name: Optional[str]=None, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> None:
        ...
        if name is not None:
            request.name = name
        rpc = gapic_v1.method_async.wrap_method(self._client._transport.delete_bucket, default_timeout=None, client_info=DEFAULT_CLIENT_INFO)
        await rpc(request, retry=retry, timeout=timeout, metadata=metadata)

    async def get_bucket(self, request: Optional[Union[storage.GetBucketRequest, dict]]=None, *, name: Optional[str]=None, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> storage.Bucket:
        ...
        if name is not None:
            request.name = name
        rpc = gapic_v1.method_async.wrap_method(self._client._transport.get_bucket, default_timeout=None, client_info=DEFAULT_CLIENT_INFO)
        response = await rpc(request, retry=retry, timeout=timeout, metadata=metadata)
        return response

    async def create_bucket(self, request: Optional[Union[storage.CreateBucketRequest, dict]]=None, *, parent: Optional[str]=None, bucket: Optional[storage.Bucket]=None, bucket_id: Optional[str]=None, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> storage.Bucket:
        ...
        rpc = gapic_v1.method_async.wrap_method(self._client._transport.create_bucket, default_timeout=None, client_info=DEFAULT_CLIENT_INFO)
        response = await rpc(request, retry=retry, timeout=timeout, metadata=metadata)
        return response

    async def list_buckets(self, request: Optional[Union[storage.ListBucketsRequest, dict]]=None, *, parent: Optional[str]=None, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> pagers.ListBucketsAsyncPager:
        ...
        if parent is not None:
            request.parent = parent
        rpc = gapic_v1.method_async.wrap_method(self._client._transport.list_buckets, default_timeout=None, client_info=DEFAULT_CLIENT_INFO)
        response = await rpc(request, retry=retry, timeout=timeout, metadata=metadata)
        response = pagers.ListBucketsAsyncPager(method=rpc, request=request, response=response, metadata=metadata)
        return response

    async def lock_bucket_retention_policy(self, request: Optional[Union[storage.LockBucketRetentionPolicyRequest, dict]]=None, *, bucket: Optional[str]=None, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> storage.Bucket:
        ...
        if bucket is not None:
            request.bucket = bucket
        rpc = gapic_v1.method_async.wrap_method(self._client._transport.lock_bucket_retention_policy, default_timeout=None, client_info=DEFAULT_CLIENT_INFO)
        response = await rpc(request, retry=retry, timeout=timeout, metadata=metadata)
        return response

    async def get_iam_policy(self, request: Optional[Union[iam_policy_pb2.GetIamPolicyRequest, dict]]=None, *, resource: Optional[str]=None, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> policy_pb2.Policy:
        ...
        rpc = gapic_v1.method_async.wrap_method(self._client._transport.get_iam_policy, default_timeout=None, client_info=DEFAULT_CLIENT_INFO)
        response = await rpc(request, retry=retry, timeout=timeout, metadata=metadata)
        return response

    async def set_iam_policy(self, request: Optional[Union[iam_policy_pb2.SetIamPolicyRequest, dict]]=None, *, resource: Optional[str]=None, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> policy_pb2.Policy:
        ...
        rpc = gapic_v1.method_async.wrap_method(self._client._transport.set_iam_policy, default_timeout=None, client_info=DEFAULT_CLIENT_INFO)
        response = await rpc(request, retry=retry, timeout=timeout, metadata=metadata)
        return response

    async def test_iam_permissions(self, request: Optional[Union[iam_policy_pb2.TestIamPermissionsRequest, dict]]=None, *, resource: Optional[str]=None, permissions: Optional[MutableSequence[str]]=None, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> iam_policy_pb2.TestIamPermissionsResponse:
        ...
        rpc = gapic_v1.method_async.wrap_method(self._client._transport.test_iam_permissions, default_timeout=None, client_info=DEFAULT_CLIENT_INFO)
        response = await rpc(request, retry=retry, timeout=timeout, metadata=metadata)
        return response

    async def update_bucket(self, request: Optional[Union[storage.UpdateBucketRequest, dict]]=None, *, bucket: Optional[storage.Bucket]=None, update_mask: Optional[field_mask_pb2.FieldMask]=None, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> storage.Bucket:
        ...
        rpc = gapic_v1.method_async.wrap_method(self._client._transport.update_bucket, default_timeout=None, client_info=DEFAULT_CLIENT_INFO)
        response = await rpc(request, retry=retry, timeout=timeout, metadata=metadata)
        return response

    async def compose_object(self, request: Optional[Union[storage.ComposeObjectRequest, dict]]=None, *, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> storage.Object:
        ...
        rpc = gapic_v1.method_async.wrap_method(self._client._transport.compose_object, default_timeout=None, client_info=DEFAULT_CLIENT_INFO)
        response = await rpc(request, retry=retry, timeout=timeout, metadata=metadata)
        return response

    async def delete_object(self, request: Optional[Union[storage.DeleteObjectRequest, dict]]=None, *, bucket: Optional[str]=None, object_: Optional[str]=None, generation: Optional[int]=None, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> None:
        ...
        rpc = gapic_v1.method_async.wrap_method(self._client._transport.delete_object, default_timeout=None, client_info=DEFAULT_CLIENT_INFO)
        await rpc(request, retry=retry, timeout=timeout, metadata=metadata)

    async def restore_object(self, request: Optional[Union[storage.RestoreObjectRequest, dict]]=None, *, bucket: Optional[str]=None, object_: Optional[str]=None, generation: Optional[int]=None, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> storage.Object:
        ...
        if generation is not None:
            request.generation = generation
        rpc = gapic_v1.method_async.wrap_method(self._client._transport.restore_object, default_timeout=None, client_info=DEFAULT_CLIENT_INFO)
        response = await rpc(request, retry=retry, timeout=timeout, metadata=metadata)
        return response

    async def cancel_resumable_write(self, request: Optional[Union[storage.CancelResumableWriteRequest, dict]]=None, *, upload_id: Optional[str]=None, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> storage.CancelResumableWriteResponse:
        ...
        rpc = gapic_v1.method_async.wrap_method(self._client._transport.cancel_resumable_write, default_timeout=None, client_info=DEFAULT_CLIENT_INFO)
        response = await rpc(request, retry=retry, timeout=timeout, metadata=metadata)
        return response
    ...
    async def get_object(self, request: Optional[Union[storage.GetObjectRequest, dict]]=None, *, bucket: Optional[str]=None, object_: Optional[str]=None, generation: Optional[int]=None, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> storage.Object:
        ...
        if generation is not None:
            request.generation = generation
        rpc = gapic_v1.method_async.wrap_method(self._client._transport.get_object, default_timeout=None, client_info=DEFAULT_CLIENT_INFO)
        response = await rpc(request, retry=retry, timeout=timeout, metadata=metadata)
        return response

    def read_object(self, request: Optional[Union[storage.ReadObjectRequest, dict]]=None, *, bucket: Optional[str]=None, object_: Optional[str]=None, generation: Optional[int]=None, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> Awaitable[AsyncIterable[storage.ReadObjectResponse]]:
        ...
        if generation is not None:
            request.generation = generation
        rpc = gapic_v1.method_async.wrap_method(self._client._transport.read_object, default_timeout=None, client_info=DEFAULT_CLIENT_INFO)
        response = rpc(request, retry=retry, timeout=timeout, metadata=metadata)
        return response

    async def update_object(self, request: Optional[Union[storage.UpdateObjectRequest, dict]]=None, *, object_: Optional[storage.Object]=None, update_mask: Optional[field_mask_pb2.FieldMask]=None, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> storage.Object:
        ...
        if update_mask is not None:
            request.update_mask = update_mask
        rpc = gapic_v1.method_async.wrap_method(self._client._transport.update_object, default_timeout=None, client_info=DEFAULT_CLIENT_INFO)
        response = await rpc(request, retry=retry, timeout=timeout, metadata=metadata)
        return response

    async def write_object(self, requests: Optional[AsyncIterator[storage.WriteObjectRequest]]=None, *, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> storage.WriteObjectResponse:
        ...
        """
        rpc = gapic_v1.method_async.wrap_method(self._client._transport.write_object, default_timeout=None, client_info=DEFAULT_CLIENT_INFO)
        response = await rpc(requests, retry=retry, timeout=timeout, metadata=metadata)
        return response

    def bidi_write_object(self, requests: Optional[AsyncIterator[storage.BidiWriteObjectRequest]]=None, *, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> Awaitable[AsyncIterable[storage.BidiWriteObjectResponse]]:
        """Stores a new object and metadata.
        ...
        """
        rpc = gapic_v1.method_async.wrap_method(self._client._transport.bidi_write_object, default_timeout=None, client_info=DEFAULT_CLIENT_INFO)
        response = rpc(requests, retry=retry, timeout=timeout, metadata=metadata)
        return response

    async def list_objects(self, request: Optional[Union[storage.ListObjectsRequest, dict]]=None, *, parent: Optional[str]=None, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> pagers.ListObjectsAsyncPager:
        ...
        if parent is not None:
            request.parent = parent
        rpc = gapic_v1.method_async.wrap_method(self._client._transport.list_objects, default_timeout=None, client_info=DEFAULT_CLIENT_INFO)
        response = await rpc(request, retry=retry, timeout=timeout, metadata=metadata)
        response = pagers.ListObjectsAsyncPager(method=rpc, request=request, response=response, metadata=metadata)
        return response

    async def rewrite_object(self, request: Optional[Union[storage.RewriteObjectRequest, dict]]=None, *, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> storage.RewriteResponse:
        ...
        rpc = gapic_v1.method_async.wrap_method(self._client._transport.rewrite_object, default_timeout=None, client_info=DEFAULT_CLIENT_INFO)
        response = await rpc(request, retry=retry, timeout=timeout, metadata=metadata)
        return response

    async def start_resumable_write(self, request: Optional[Union[storage.StartResumableWriteRequest, dict]]=None, *, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> storage.StartResumableWriteResponse:
        ...
        rpc = gapic_v1.method_async.wrap_method(self._client._transport.start_resumable_write, default_timeout=None, client_info=DEFAULT_CLIENT_INFO)
        response = await rpc(request, retry=retry, timeout=timeout, metadata=metadata)
        return response

    async def query_write_status(self, request: Optional[Union[storage.QueryWriteStatusRequest, dict]]=None, *, upload_id: Optional[str]=None, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> storage.QueryWriteStatusResponse:
        ...
        if upload_id is not None:
            request.upload_id = upload_id
        rpc = gapic_v1.method_async.wrap_method(self._client._transport.query_write_status, default_timeout=None, client_info=DEFAULT_CLIENT_INFO)
        response = await rpc(request, retry=retry, timeout=timeout, metadata=metadata)
        return response

    async def get_service_account(self, request: Optional[Union[storage.GetServiceAccountRequest, dict]]=None, *, project: Optional[str]=None, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> storage.ServiceAccount:
        ...
        """
        warnings.warn('StorageAsyncClient.get_service_account is deprecated', DeprecationWarning)
        ...
        rpc = gapic_v1.method_async.wrap_method(self._client._transport.get_service_account, default_timeout=None, client_info=DEFAULT_CLIENT_INFO)
        response = await rpc(request, retry=retry, timeout=timeout, metadata=metadata)
        return response

    async def create_hmac_key(self, request: Optional[Union[storage.CreateHmacKeyRequest, dict]]=None, *, project: Optional[str]=None, service_account_email: Optional[str]=None, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> storage.CreateHmacKeyResponse:
        ...
        """
        warnings.warn('StorageAsyncClient.create_hmac_key is deprecated', DeprecationWarning)
        ...
        rpc = gapic_v1.method_async.wrap_method(self._client._transport.create_hmac_key, default_timeout=None, client_info=DEFAULT_CLIENT_INFO)
        response = await rpc(request, retry=retry, timeout=timeout, metadata=metadata)
        return response

    async def delete_hmac_key(self, request: Optional[Union[storage.DeleteHmacKeyRequest, dict]]=None, *, access_id: Optional[str]=None, project: Optional[str]=None, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> None:
        ...
        Args:
            ...
            metadata (Sequence[Tuple[str, str]]): Strings which should be
                sent along with the request as metadata.
        """
        warnings.warn('StorageAsyncClient.delete_hmac_key is deprecated', DeprecationWarning)
        ...
        if project is not None:
            request.project = project
        rpc = gapic_v1.method_async.wrap_method(self._client._transport.delete_hmac_key, default_timeout=None, client_info=DEFAULT_CLIENT_INFO)
        await rpc(request, retry=retry, timeout=timeout, metadata=metadata)

    async def get_hmac_key(self, request: Optional[Union[storage.GetHmacKeyRequest, dict]]=None, *, access_id: Optional[str]=None, project: Optional[str]=None, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> storage.HmacKeyMetadata:
        ...
        """
        warnings.warn('StorageAsyncClient.get_hmac_key is deprecated', DeprecationWarning)
        has_flattened_params = any([access_id, project])
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of the individual field arguments should be set.')
        ...
        if project is not None:
            request.project = project
        rpc = gapic_v1.method_async.wrap_method(self._client._transport.get_hmac_key, default_timeout=None, client_info=DEFAULT_CLIENT_INFO)
        response = await rpc(request, retry=retry, timeout=timeout, metadata=metadata)
        return response

    async def list_hmac_keys(self, request: Optional[Union[storage.ListHmacKeysRequest, dict]]=None, *, project: Optional[str]=None, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> pagers.ListHmacKeysAsyncPager:
        ...
        """
        warnings.warn('StorageAsyncClient.list_hmac_keys is deprecated', DeprecationWarning)
        has_flattened_params = any([project])
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of the individual field arguments should be set.')
        ...
        if project is not None:
            request.project = project
        rpc = gapic_v1.method_async.wrap_method(self._client._transport.list_hmac_keys, default_timeout=None, client_info=DEFAULT_CLIENT_INFO)
        response = await rpc(request, retry=retry, timeout=timeout, metadata=metadata)
        response = pagers.ListHmacKeysAsyncPager(method=rpc, request=request, response=response, metadata=metadata)
        return response

    async def update_hmac_key(self, request: Optional[Union[storage.UpdateHmacKeyRequest, dict]]=None, *, hmac_key: Optional[storage.HmacKeyMetadata]=None, update_mask: Optional[field_mask_pb2.FieldMask]=None, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> storage.HmacKeyMetadata:
        ...
        """
        warnings.warn('StorageAsyncClient.update_hmac_key is deprecated', DeprecationWarning)
        ...
        if update_mask is not None:
            request.update_mask = update_mask
        rpc = gapic_v1.method_async.wrap_method(self._client._transport.update_hmac_key, default_timeout=None, client_info=DEFAULT_CLIENT_INFO)
        response = await rpc(request, retry=retry, timeout=timeout, metadata=metadata)
        return response

    async def delete_notification_config(self, request: Optional[Union[storage.DeleteNotificationConfigRequest, dict]]=None, *, name: Optional[str]=None, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> None:
        ...
        Args:
            ...
            metadata (Sequence[Tuple[str, str]]): Strings which should be
                sent along with the request as metadata.
        """
        warnings.warn('StorageAsyncClient.delete_notification_config is deprecated', DeprecationWarning)
        has_flattened_params = any([name])
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of the individual field arguments should be set.')
        ...
        if name is not None:
            request.name = name
        rpc = gapic_v1.method_async.wrap_method(self._client._transport.delete_notification_config, default_timeout=None, client_info=DEFAULT_CLIENT_INFO)
        await rpc(request, retry=retry, timeout=timeout, metadata=metadata)

    async def get_notification_config(self, request: Optional[Union[storage.GetNotificationConfigRequest, dict]]=None, *, name: Optional[str]=None, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> storage.NotificationConfig:
        ...
        """
        warnings.warn('StorageAsyncClient.get_notification_config is deprecated', DeprecationWarning)
        has_flattened_params = any([name])
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of the individual field arguments should be set.')
        ...
        if name is not None:
            request.name = name
        rpc = gapic_v1.method_async.wrap_method(self._client._transport.get_notification_config, default_timeout=None, client_info=DEFAULT_CLIENT_INFO)
        response = await rpc(request, retry=retry, timeout=timeout, metadata=metadata)
        return response

    async def create_notification_config(self, request: Optional[Union[storage.CreateNotificationConfigRequest, dict]]=None, *, parent: Optional[str]=None, notification_config: Optional[storage.NotificationConfig]=None, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> storage.NotificationConfig:
        ...
        """
        warnings.warn('StorageAsyncClient.create_notification_config is deprecated', DeprecationWarning)
        ...
        rpc = gapic_v1.method_async.wrap_method(self._client._transport.create_notification_config, default_timeout=None, client_info=DEFAULT_CLIENT_INFO)
        response = await rpc(request, retry=retry, timeout=timeout, metadata=metadata)
        return response

    async def list_notification_configs(self, request: Optional[Union[storage.ListNotificationConfigsRequest, dict]]=None, *, parent: Optional[str]=None, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> pagers.ListNotificationConfigsAsyncPager:
        ...
        """
        warnings.warn('StorageAsyncClient.list_notification_configs is deprecated', DeprecationWarning)
        has_flattened_params = any([parent])
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of the individual field arguments should be set.')
        ...
        if parent is not None:
            request.parent = parent
        rpc = gapic_v1.method_async.wrap_method(self._client._transport.list_notification_configs, default_timeout=None, client_info=DEFAULT_CLIENT_INFO)
        response = await rpc(request, retry=retry, timeout=timeout, metadata=metadata)
        response = pagers.ListNotificationConfigsAsyncPager(method=rpc, request=request, response=response, metadata=metadata)
        return response
