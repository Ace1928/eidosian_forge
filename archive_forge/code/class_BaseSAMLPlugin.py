...
class BaseSAMLPlugin(v3.FederationBaseAuth):
    ...
    def __init__(self, auth_url, identity_provider, identity_provider_url, username, password, protocol, **kwargs):
        ...
        """
        super(BaseSAMLPlugin, self).__init__(auth_url=auth_url, identity_provider=identity_provider, protocol=protocol, **kwargs)
