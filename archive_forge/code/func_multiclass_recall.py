...
def multiclass_recall(preds: Tensor, target: Tensor, num_classes: int, average: Optional[Literal['micro', 'macro', 'weighted', 'none']]='macro', top_k: int=1, multidim_average: Literal['global', 'samplewise']='global', ignore_index: Optional[int]=None, validate_args: bool=True) -> Tensor:
    ...
    return _precision_recall_reduce('recall', tp, fp, tn, fn, average=average, multidim_average=multidim_average, top_k=top_k)