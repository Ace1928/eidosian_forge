...
class CloudassetV1p1beta1(base_api.BaseApiClient):
    ...
    def __init__(self, url='', credentials=None, get_credentials=True, http=None, model=None, log_request=False, log_response=False, credentials_args=None, default_global_params=None, additional_http_headers=None, response_encoding=None):
        ...
        super(CloudassetV1p1beta1, self).__init__(url, credentials=credentials, get_credentials=get_credentials, http=http, model=model, log_request=log_request, log_response=log_response, credentials_args=credentials_args, default_global_params=default_global_params, additional_http_headers=additional_http_headers, response_encoding=response_encoding)
    ...
    class IamPoliciesService(base_api.BaseApiService):
      ...
      """
        ...
        SearchAll.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1p1beta1/{v1p1beta1Id}/{v1p1beta1Id1}/iamPolicies:searchAll', http_method='GET', method_id='cloudasset.iamPolicies.searchAll', ordered_params=['scope'], path_params=['scope'], query_params=['pageSize', 'pageToken', 'query'], relative_path='v1p1beta1/{+scope}/iamPolicies:searchAll', request_field='', request_type_name='CloudassetIamPoliciesSearchAllRequest', response_type_name='SearchAllIamPoliciesResponse', supports_download=False)
