...
class TestDeleteNetworkQosRuleBandwidthLimit(TestNetworkQosRule):
    ...
    def setUp(self):
        ...
        self.network_client.delete_qos_bandwidth_limit_rule = mock.Mock(return_value=None)
        self.network_client.find_qos_bandwidth_limit_rule = network_fakes.FakeNetworkQosRule.get_qos_rules(qos_rules=self.new_rule)
