...
class Creature:
    def __init__(self, health, attack, speed, intelligence, strategy):
        ...
        self.strategy = (
            strategy  # Strategy for encounter: 'battle', 'flee', 'group', 'mate'
        )
    ...
    def mutate(self):
        ...
        if random.random() < 0.1:  # 10% chance to change strategy
            self.strategy = random.choice(["battle", "flee", "group", "mate"])
...
class Battle:
    ...
    def handle_encounter(self, position1, position2):
        ...
        if creature1 and creature2:
            if creature1.strategy == "battle" or creature2.strategy == "battle":
                ...
                self.group(creature1, creature2, position1, position2)
    ...
    def mate(self, creature1, creature2, position):
        ...
        new_strategy = random.choice(["battle", "flee", "group", "mate"])
    ...
    def group(self, creature1, creature2, position1, position2):
        # Grouping behavior: creatures form a group and move together
...
if __name__ == "__main__":
    environment = GameEnvironment(size=10)
