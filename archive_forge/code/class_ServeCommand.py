...
class ServeCommand(BaseCommand):
    ...
    """
    arguments = BaseCommand.arguments + ({'name': '--reload', 'help': 'Watch for changes and automatically reload.', 'default': False, 'action': 'store_true'},)
    ...
    def _serve(self, app, conf):
        ...
        srv = make_server(host, port, app, handler_class=PecanWSGIRequestHandler)
