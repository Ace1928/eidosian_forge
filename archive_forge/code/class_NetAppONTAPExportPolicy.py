...
class NetAppONTAPExportPolicy:
    ...
    def __init__(self):
        ...
        self.argument_spec.update(dict(state=dict(required=False, type='str', choices=['present', 'absent'], default='present'), name=dict(required=True, type='str'), from_name=dict(required=False, type='str', default=None), vserver=dict(required=True, type='str')))
    ...
    def get_export_policy(self, name=None):
        ...
        if self.use_rest:
            ...
            if result.get_child_by_name('num-records') and int(result.get_child_content('num-records')) == 1:
                ...
                return_value = {'policy-name': export_policy}
            return return_value
    ...
    def create_export_policy(self):
        ...
        try:
            ...
            self.module.fail_json(msg='Error on creating export-policy %s: %s' % (self.parameters['name'], to_native(error)), exception=traceback.format_exc())
    ...
    def create_export_policy_rest(self):
        params = {'name': self.parameters['name'], 'svm.name': self.parameters['vserver']}
        api = 'protocols/nfs/export-policies'
