...
class PhasedFSimEngineSimulator(cirq.SimulatesIntermediateStateVector[cirq.SparseSimulatorStep]):
    ...
    def __init__(self, simulator: cirq.Simulator, *, drift_generator: ParametersDriftGenerator, gates_translator: Callable[[cirq.Gate], Optional[PhaseCalibratedFSimGate]]=try_convert_sqrt_iswap_to_fsim) -> None:
        ...
        self._drifted_parameters: Dict[Tuple[cirq.Qid, cirq.Qid, cirq.FSimGate], PhasedFSimCharacterization] = {}
    ...
    def simulate(self, program: cirq.AbstractCircuit, param_resolver: cirq.ParamResolverOrSimilarType=None, qubit_order: cirq.QubitOrderOrList=cirq.QubitOrder.DEFAULT, initial_state: Any=None) -> cirq.StateVectorTrialResult:
        converted = _convert_to_circuit_with_drift(self, program)
