...
class PeerManager(object):
    ...
    def __init__(self, core_service, neighbors_conf):
    ...
    def add_peer(self, neigh_conf, common_conf):
        peer = Peer(common_conf, neigh_conf, self._core_service, self._signal_bus, self)
    ...
    def _get_non_rtc_peers(self):
        ...
        for peer in self._peers.values():
            if peer.in_established() and (not peer.is_mpbgp_cap_valid(RF_RTC_UC)):
