...
class Arcee(LLM):
    ...
    def __init__(self, **data: Any) -> None:
        ...
        self._client = ArceeWrapper(arcee_api_key=api_key, arcee_api_url=self.arcee_api_url, arcee_api_version=self.arcee_api_version, model_kwargs=self.model_kwargs, model_name=self.model)
