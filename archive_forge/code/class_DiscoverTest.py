...
class DiscoverTest(utils.TestCase):
    ...
    def test_discover_extensions(self):
        ...
        @mock.patch.object(client, '_discover_via_python_path', mock_discover_via_python_path)
        @mock.patch.object(client, '_discover_via_entry_points', mock_discover_via_entry_points)
        def test():
