...
class SemanticScholarQueryRun(BaseTool):
    ...
    description: str = 'A wrapper around semantischolar.org Useful for when you need to answer to questionsfrom research papers.Input should be a search query.'
