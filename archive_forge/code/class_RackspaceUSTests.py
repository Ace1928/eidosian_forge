...
class RackspaceUSTests(unittest.TestCase):
    ...
    def test_create_zone_validaton_error(self):
        ...
        try:
            self.driver.create_zone(domain='foo.bar.com', type='master', ttl=10, extra={'email': 'test@test.com'})
        except Exception as e:
            self.assertEqual(str(e), 'Validation errors: Domain TTL is ' + 'required and must be greater than ' + 'or equal to 300')
        else:
            self.fail('Exception was not thrown')
    ...
    def test_create_record_success(self):
        ...
        record = self.driver.create_record(name='www', zone=zone, type=RecordType.A, data='127.1.1.1')
