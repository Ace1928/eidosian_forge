...
def AddParallelismFlag(parser):
    ...
    parser.add_argument('--parallelism', type=arg_parsers.BoundedInt(lower_bound=0), help='Number of tasks that may run concurrently. Must be less than or equal to the number of tasks. Set to 0 to unset.')