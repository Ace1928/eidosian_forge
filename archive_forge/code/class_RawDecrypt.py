...
class RawDecrypt(base.Command):
  ...
  """
    ...
    def Run(self, args):
        ...
        try:
            response = client.projects_locations_keyRings_cryptoKeys_cryptoKeyVersions.RawDecrypt(request)
        ...
        try:
            if response.plaintext is None:
                ...
                log.WriteToFileOrStdout(args.plaintext_file, response.plaintext, binary=True, overwrite=True)
        except files.Error as e:
