...
class SKObjective(NonIterativeObjectiveFunc):
    ...
    def __init__(self, scoring: Any, feature_prefix: str='', label_col: str='label', checkpoint_path: Optional[str]=None) -> None:
        super().__init__()
        self._last_id = ''
        ...
        if checkpoint_path is None:
            ...
            self._checkpoint_path = TUNE_OBJECT_FACTORY.get_path_or_temp(checkpoint_path)
    ...
    def run(self, trial: Trial) -> TrialReport:
        ...
        if trial.trial_id != self._last_id:
            ...
            self._test_x, self._test_y = self._reset_xy(trial.dfs[TUNE_DATASET_VALIDATION_DF_DEFAULT_NAME])
