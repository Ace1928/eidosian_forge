...
class NeptuneRdfGraph:
    ...
    *Security note*: Make sure that the database connection uses credentials
    ...
    def __init__(self, host: str, port: int=8182, use_https: bool=True, use_iam_auth: bool=False, client: Any=None, credentials_profile_name: Optional[str]=None, region_name: Optional[str]=None, service: str='neptunedata', sign: bool=True) -> None:
        ...
        try:
            if client is not None:
                ...
                if sign:
                    ...
                    self.client = self.session.client(service, **client_params, config=Config(signature_version=UNSIGNED))
        except ImportError:
    ...
    def query(self, query: str) -> Dict[str, Any]:
        ...
        if self.use_iam_auth:
            ...
            params = None
            creds = SimpleNamespace(access_key=access_key, secret_key=secret_key, token=session_token, region=self.region_name)
