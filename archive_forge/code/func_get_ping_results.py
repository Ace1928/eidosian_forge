...
def get_ping_results(command, module):
    ...
    if not ping:
        module.fail_json(msg='An unexpected error occurred. Check all params.', command=command, destination=module.params['dest'], vrf=module.params['vrf'], source=module.params['source'], size=module.params['size'], df_bit=module.params['df_bit'])
