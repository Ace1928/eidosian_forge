...
class KeystoneRoleAssignmentMixinTest(common.HeatTestCase):
    ...
    def setUp(self):
        ...
        self.stack = stack.Stack(self.ctx, 'test_stack_keystone', template.Template(keystone_role_assignment_template))
    ...
    def test_role_assignment_create_user(self):
        expected = [{'role': 'role_1', 'project': 'project_1', 'domain': None}, {'role': 'role_1', 'project': None, 'domain': 'domain_1'}]
        self.assertEqual(expected, self.test_role_assignment.properties.get(MixinClass.ROLES))
    ...
    def test_role_assignment_create_group(self):
        ...
        self.roles.grant.assert_any_call(role='role_1', group='group_1', domain='domain_1')
        self.roles.grant.assert_any_call(role='role_1', group='group_1', project='project_1')
    ...
    def test_validate_2(self):
        self.test_role_assignment.properties = mock.MagicMock()
        self.test_role_assignment.properties.get.return_value = [dict(role='role1', project='project1', domain='domain1')]
        self.assertRaises(exception.ResourcePropertyConflict, self.test_role_assignment.validate)
