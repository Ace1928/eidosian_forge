...
class OperationTests(ComparisonTestCase):
    ...
    def test_image_contours_x_datetime(self):
        ...
        np.testing.assert_array_almost_equal(op_contours.dimension_values('y').astype(float), [15, 14, np.nan, 14, 15])
    ...
    def test_dataset_cumulative_histogram_dask(self):
        ...
        hist = Histogram(([0, 3, 6, 9], [0.3, 0.6, 1]), vdims=('x_frequency', 'Frequency'))
        self.assertIsInstance(op_hist.data['x_frequency'], da.Array)
        self.assertEqual(op_hist, hist)
    ...
    def test_interpolate_curve_pre_with_values(self):
        interpolated = interpolate_curve(Curve([(0, 0, 'A'), (1, 0.5, 'B'), (2, 1, 'C')], vdims=['y', 'z']), interpolation='steps-pre')
    ...
    def test_interpolate_datetime_curve_mid(self):
        ...
        dates_interp = np.array(['2017-01-01T00:00:00', '2017-01-01T12:00:00', '2017-01-01T12:00:00', '2017-01-02T12:00:00', '2017-01-02T12:00:00', '2017-01-03T12:00:00', '2017-01-03T12:00:00', '2017-01-04T00:00:00'], dtype='datetime64[ns]')
    ...
    def test_interpolate_curve_post_with_values(self):
        interpolated = interpolate_curve(Curve([(0, 0, 'A'), (1, 0.5, 'B'), (2, 1, 'C')], vdims=['y', 'z']), interpolation='steps-post')
        curve = Curve([(0, 0, 'A'), (1, 0, 'A'), (1, 0.5, 'B'), (2, 0.5, 'B'), (2, 1, 'C')], vdims=['y', 'z'])
        self.assertEqual(interpolated, curve)
    ...
    def test_interpolate_datetime_curve_post(self):
        ...
        dates_interp = np.array(['2017-01-01T00:00:00', '2017-01-02T00:00:00', '2017-01-02T00:00:00', '2017-01-03T00:00:00', '2017-01-03T00:00:00', '2017-01-04T00:00:00', '2017-01-04T00:00:00'], dtype='datetime64[ns]')
