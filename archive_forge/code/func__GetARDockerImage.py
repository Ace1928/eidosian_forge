...
def _GetARDockerImage(uri):
  ...
  """
    ...
    return Artifact(resource_uri=docker_version.GetDockerString(), project=repo.project, location=repo.location, digests=digests, artifact_type=ARTIFACT_TYPE_AR_IMAGE, scheme=_REGISTRY_SCHEME_HTTPS)