...
class DriaRetriever(BaseRetriever):
    ...
    def create_knowledge_base(self, name: str, description: str, category: str='Unspecified', embedding: str='jina') -> str:
    ...
    def _get_relevant_documents(self, query: str, *, run_manager: CallbackManagerForRetrieverRun) -> List[Document]:
        ...
        docs = [Document(page_content=result['metadata'], metadata={'id': result['id'], 'score': result['score']}) for result in results]
        return docs