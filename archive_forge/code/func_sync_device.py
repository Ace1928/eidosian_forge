...
def sync_device(name=None):
  ...
  """
    ...
    if tld.is_eager:
        try:
            _result = pywrap_tfe.TFE_Py_FastPathExecute(_ctx, 'SyncDevice', name)
            return _result
            ...
            pass
        try:
            return sync_device_eager_fallback(name=name, ctx=_ctx)
        except _core._SymbolicException:
            pass
    _, _, _op, _outputs = _op_def_library._apply_op_helper('SyncDevice', name=name)
    return _op