...
class AzureAiServicesSpeechToTextTool(BaseTool):
    ...
    description: str = 'A wrapper around Azure AI Services Speech to Text. Useful for when you need to transcribe audio to text. Input should be a url to an audio file.'
    ...
    def validate_environment(cls, values: Dict) -> Dict:
        ...
        try:
            ...
            values['speech_config'] = speechsdk.SpeechConfig(subscription=azure_ai_services_key, region=azure_ai_services_region)
        except ImportError:
            raise ImportError('azure-cognitiveservices-speech is not installed. Run `pip install azure-cognitiveservices-speech` to install.')
        return values
