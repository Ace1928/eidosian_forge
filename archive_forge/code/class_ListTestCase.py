...
class ListTestCase(unittest.TestCase):
    ...
    def test_slice_assignment(self):
        ...
        steps = list(starts)
        steps.remove(0)
        test_slices = [slice(start, stop, step) for start in starts for stop in stops for step in steps]
        for test_slice in test_slices:
            ...
            self.assertEqual(f.l, plain_l, 'failed for slice {0!r}'.format(test_slice))
