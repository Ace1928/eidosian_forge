...
class ZebraBfdDestinationDeregister(_ZebraMessageBody):
    ...
    def __init__(self, pid, dst_family, dst_prefix, multi_hop, src_family, src_prefix, multi_hop_count=None, ifname=None):
    ...
    def parse(cls, buf, version=_DEFAULT_VERSION):
        ...
        return cls(pid, dst_family, dst_prefix, multi_hop, src_family, src_prefix, multi_hop_count, ifname)
