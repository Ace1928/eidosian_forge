...
def set_decomposition(custom_decomps, dev, decomp_depth=10):
    ...
    **Example**
    ...
    if isinstance(dev, qml.Device):
        ...
        new_custom_expand_fn = create_decomp_expand_fn(custom_decomps, dev, decomp_depth=decomp_depth)
        try:
        ...
        new_preprocess = _create_decomp_preprocessing(custom_decomps, dev, decomp_depth=decomp_depth)
        try:
