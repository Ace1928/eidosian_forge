...
class TestCreateConfig(TestConfig):
    ...
    def setUp(self):
        ...
        self.mock_client.software_configs.create.return_value = software_configs.SoftwareConfig(None, {})
    ...
    def test_config_create_group(self):
        properties = {'config': '', 'group': 'group', 'name': 'test', 'options': {}, 'inputs': [], 'outputs': []}
