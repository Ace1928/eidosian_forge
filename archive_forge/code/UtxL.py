...
class Environment:
    ...
    def calculate_size(self) -> int:
        ...
        return min(screen_info.current_w // 10, screen_info.current_h // 10)
...
class UserInteraction:
    def __init__(self, environment, evolution, battle):
        self.environment = environment if environment is not None else Environment()
        self.evolution = (
            evolution if evolution is not None else Evolution(self.environment)
        )
        self.battle = battle if battle is not None else Battle(self.environment)
    ...
    def run_game(self, generations=10):
        ...
        for _ in range(10):
            ...
            strategy = random.choice(["battle", "flee", "group", "mate"])
...
if __name__ == "__main__":
    ...
    interaction.run_game(generations=10)
