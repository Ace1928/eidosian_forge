...
class SpellingBase(object):
    ...
    def list_languages(self):
        ...
        """
        raise NotImplementedError('list_languages() is not implemented by abstract spelling base class!')
    ...
    def check(self, word):
        ...
        :Parameters:
            `word`: str
                The word to check.
        """
        raise NotImplementedError('check() not implemented by abstract ' + 'spelling base class!')
    ...
    def suggest(self, fragment):
        ...
        """
        raise NotImplementedError('suggest() not implemented by abstract ' + 'spelling base class!')