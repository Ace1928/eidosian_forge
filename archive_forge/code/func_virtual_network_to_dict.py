...
def virtual_network_to_dict(vnet):
    ...
    :return: dict
    """
    results = dict(id=vnet.id, name=vnet.name, location=vnet.location, type=vnet.type, tags=vnet.tags, provisioning_state=vnet.provisioning_state, flow_timeout_in_minutes=vnet.flow_timeout_in_minutes, etag=vnet.etag)
