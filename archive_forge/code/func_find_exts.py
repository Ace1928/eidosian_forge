...
def find_exts(top: str, exts: Union[str, list[str]], exclude_dirs: Optional[str]=None, include_dirs: Optional[str]=None, match_mode: Literal['basename', 'abspath']='basename') -> list[str]:
    """
    ...
    mangle_functions: dict[str, Callable[..., str]] = {'basename': os.path.basename, 'abspath': os.path.abspath}
