...
class StackUserTest(common.HeatTestCase):
    ...
    def test_handle_resume(self):
        ...
        self.fc.enable_stack_domain_user.assert_called_once_with(project_id=project_id, user_id=user_id)
    ...
    def test_handle_resume_legacy(self):
        ...
        scheduler.TaskRunner(rsrc.resume)()
        self.assertEqual((rsrc.RESUME, rsrc.COMPLETE), rsrc.state)
        self.fc.enable_stack_domain_user.assert_called_once_with(user_id=user_id, project_id=project_id)
