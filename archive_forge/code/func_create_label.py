...
def create_label(self, name: str, color: str, description: Opt[str]=NotSet) -> Label:
    ...
    headers, data = self._requester.requestJsonAndCheck('POST', f'{self.url}/labels', input=post_parameters, headers={'Accept': Consts.mediaTypeLabelDescriptionSearchPreview})
