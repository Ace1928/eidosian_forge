...
class WandbLogger(Logger):
    ...
    **Downloading and Using Artifacts**
    ...
    @rank_zero_only
    def log_table(self, key: str, columns: Optional[List[str]]=None, data: Optional[List[List[Any]]]=None, dataframe: Any=None, step: Optional[int]=None) -> None:
    ...
    @rank_zero_only
    def log_text(self, key: str, columns: Optional[List[str]]=None, data: Optional[List[List[str]]]=None, dataframe: Any=None, step: Optional[int]=None) -> None:
        """Log text as a Table.
