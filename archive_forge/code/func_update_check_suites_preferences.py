...
def update_check_suites_preferences(self, auto_trigger_checks: list[dict[str, bool | int]]) -> RepositoryPreferences:
    """
    ...
    headers, data = self._requester.requestJsonAndCheck('PATCH', f'{self.url}/check-suites/preferences', input={'auto_trigger_checks': auto_trigger_checks})
