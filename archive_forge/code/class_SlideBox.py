...
class SlideBox(Widget):
    ...
    def draw(self):
        ...
        g.add(Polygon(strokeColor=self.triangleStrokeColor, strokeWidth=self.triangleStrokeWidth, fillColor=self.triangleFillColor, points=[xt, self.boxHeight - self.triangleHeight / 2, xt - self.triangleWidth / 2, self.boxHeight + self.triangleHeight / 2, xt + self.triangleWidth / 2, self.boxHeight + self.triangleHeight / 2, xt, self.boxHeight - self.triangleHeight / 2]))
        g.add(Polygon(strokeColor=self.triangleStrokeColor, strokeWidth=self.triangleStrokeWidth, fillColor=self.triangleFillColor, points=[xt, 0 + self.triangleHeight / 2, xt - self.triangleWidth / 2, 0 - self.triangleHeight / 2, xt + self.triangleWidth / 2, 0 - self.triangleHeight / 2, xt, 0 + self.triangleHeight / 2]))
