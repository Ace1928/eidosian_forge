...
def _sacre_bleu_score(preds: Sequence[str], target: Sequence[Sequence[str]], n_gram: int=4, smooth: bool=False, tokenize: Literal['none', '13a', 'zh', 'intl', 'char']='13a', lowercase: bool=False, weights: Optional[Sequence[float]]=None) -> Tensor:
    ...
    return sacre_bleu_score(preds=preds, target=target, n_gram=n_gram, smooth=smooth, tokenize=tokenize, lowercase=lowercase, weights=weights)