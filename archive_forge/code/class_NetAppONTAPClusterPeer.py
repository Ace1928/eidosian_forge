    ...
    def apply(self):
        ...
        if source_action == 'create' and destination_action == 'create':
            ...
            if destination_action == 'delete':
                ...
                self.na_helper.changed = True
        result = netapp_utils.generate_result(self.na_helper.changed, modify=modify, extra_responses={'source_action': source_action, 'destination_action': destination_action})
