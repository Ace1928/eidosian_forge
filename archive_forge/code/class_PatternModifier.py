...
class PatternModifier(object):
    ...
    def modify(self, pattern):
        ...
        return HandshakePattern(name, self._get_message_patterns(pattern), self._get_initiator_pre_messages(pattern), self._get_responder_pre_messages(pattern), self._interpret_as_bob(pattern))