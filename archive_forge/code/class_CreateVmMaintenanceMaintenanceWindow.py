  ...
  *{command} creates a Compute Engine VM Maintenance Resource Policy
  ...
  """
    ...
    def Args(parser):
        ...
        flags.AddCycleFrequencyArgs(parser, flag_suffix='window', start_time_help='Start time of a four-hour window in which maintenance should start in daily cadence.', cadence_help='Maintenance activity window', has_restricted_start_times=True)
    ...
    def Run(self, args):
        ...
        resource_policy = util.MakeVmMaintenanceMaintenanceWindow(policy_ref, args, messages)
