...
class NodeManager(base.CreateManager):
    ...
    def list(self, associated=None, maintenance=None, marker=None, limit=None, detail=False, sort_key=None, sort_dir=None, fields=None, provision_state=None, driver=None, resource_class=None, chassis=None, fault=None, os_ironic_api_version=None, conductor_group=None, conductor=None, owner=None, retired=None, lessee=None, shards=None, sharded=None, parent_node=None, include_children=None, global_request_id=None):
        ...
        filters = utils.common_filters(marker, limit, sort_key, sort_dir, fields)
        ...
        if limit is None:
            ...
            return self._list_pagination(self._path(path), 'nodes', limit=limit, **header_values)

    def list_ports(self, node_id, marker=None, limit=None, sort_key=None, sort_dir=None, detail=False, fields=None, os_ironic_api_version=None, global_request_id=None):
        ...
        if limit is None:
            ...
            return self._list_pagination(self._path(path), 'ports', limit=limit, **header_values)

    def list_volume_connectors(self, node_id, marker=None, limit=None, sort_key=None, sort_dir=None, detail=False, fields=None, os_ironic_api_version=None, global_request_id=None):
        ...
        header_values = {'os_ironic_api_version': os_ironic_api_version, 'global_request_id': global_request_id}
        if limit is None:
            return self._list(self._path(path), response_key='connectors', obj_class=volume_connector.VolumeConnector, **header_values)
        else:
            return self._list_pagination(self._path(path), response_key='connectors', limit=limit, obj_class=volume_connector.VolumeConnector, **header_values)
    ...
    def get(self, node_id, fields=None, os_ironic_api_version=None, global_request_id=None):
        return self._get(resource_id=node_id, fields=fields, os_ironic_api_version=os_ironic_api_version, global_request_id=global_request_id)
    ...
    def delete(self, node_id, os_ironic_api_version=None, global_request_id=None):
        return self._delete(resource_id=node_id, os_ironic_api_version=os_ironic_api_version, global_request_id=global_request_id)

    def update(self, node_id, patch, http_method='PATCH', os_ironic_api_version=None, reset_interfaces=None, global_request_id=None):
        params = {}
        if reset_interfaces is not None:
            params['reset_interfaces'] = reset_interfaces
        return self._update(resource_id=node_id, patch=patch, method=http_method, os_ironic_api_version=os_ironic_api_version, global_request_id=global_request_id, params=params)

    def vendor_passthru(self, node_id, method, args=None, http_method=None, os_ironic_api_version=None, global_request_id=None):
    ...
    def vif_list(self, node_ident, os_ironic_api_version=None, global_request_id=None):
        ...
        return self._list(self._path(path), 'vifs', os_ironic_api_version=os_ironic_api_version, global_request_id=global_request_id)
    ...
    def set_maintenance(self, node_id, state, maint_reason=None, os_ironic_api_version=None, global_request_id=None):
        ...
        if isinstance(state, bool):
            ...
            try:
                ...
                raise exc.InvalidAttribute(_("Argument 'state': %(err)s") % {'err': e})
        path = '%s/maintenance' % node_id
        header_values = {'os_ironic_api_version': os_ironic_api_version, 'global_request_id': global_request_id}
        if maintenance_mode:
            reason = {'reason': maint_reason}
            return self.update(path, reason, http_method='PUT', **header_values)
        else:
            return self.delete(path, **header_values)

    def set_power_state(self, node_id, state, soft=False, timeout=None, os_ironic_api_version=None, global_request_id=None):
        ...
        if state == 'on' and soft:
            raise ValueError(_("'soft' option is invalid for the power-state 'on'"))
        ...
        if timeout is not None:
            msg = _("'timeout' option for setting power state must have positive integer value (> 0)")
            try:
                timeout = int(timeout)
        ...
        return self.update(path, body, http_method='PUT', os_ironic_api_version=os_ironic_api_version, global_request_id=global_request_id)

    def set_boot_mode(self, node_id, state, os_ironic_api_version=None, global_request_id=None):
        ...
        if state not in ('uefi', 'bios'):
            raise ValueError(_("Valid boot modes are 'uefi' or 'bios'"))
        path = '%s/states/boot_mode' % node_id
        target = state
        body = {'target': target}
        return self.update(path, body, http_method='PUT', os_ironic_api_version=os_ironic_api_version, global_request_id=global_request_id)

    def set_secure_boot(self, node_id, state, os_ironic_api_version=None, global_request_id=None):
    ...
    def set_target_raid_config(self, node_ident, target_raid_config, os_ironic_api_version=None, global_request_id=None):
        ...
        return self.update(path, target_raid_config, http_method='PUT', os_ironic_api_version=os_ironic_api_version, global_request_id=global_request_id)

    def validate(self, node_uuid, os_ironic_api_version=None, global_request_id=None):
        path = '%s/validate' % node_uuid
        return self.get(path, os_ironic_api_version=os_ironic_api_version, global_request_id=global_request_id)

    def set_provision_state(self, node_uuid, state, configdrive=None, cleansteps=None, rescue_password=None, os_ironic_api_version=None, global_request_id=None, deploysteps=None):
        ...
        if configdrive:
            if isinstance(configdrive, str):
                if os.path.isfile(configdrive):
                    ...
                    raise ValueError('Config drive seems to refer to a file or directory but this file/directory does not exist: %s.' % configdrive)
    ...
    def states(self, node_uuid, os_ironic_api_version=None, global_request_id=None):
        path = '%s/states' % node_uuid
        return self.get(path, os_ironic_api_version=os_ironic_api_version, global_request_id=global_request_id)

    def get_console(self, node_uuid, os_ironic_api_version=None, global_request_id=None):
        path = '%s/states/console' % node_uuid
        return self._get_as_dict(path, os_ironic_api_version=os_ironic_api_version, global_request_id=global_request_id)

    def set_console_mode(self, node_uuid, enabled, os_ironic_api_version=None, global_request_id=None):
        ...
        return self.update(path, target, http_method='PUT', os_ironic_api_version=os_ironic_api_version, global_request_id=global_request_id)

    def set_boot_device(self, node_uuid, boot_device, persistent=False, os_ironic_api_version=None, global_request_id=None):
        path = '%s/management/boot_device' % node_uuid
        target = {'boot_device': boot_device, 'persistent': persistent}
        return self.update(path, target, http_method='PUT', os_ironic_api_version=os_ironic_api_version, global_request_id=global_request_id)

    def get_boot_device(self, node_uuid, os_ironic_api_version=None, global_request_id=None):
        path = '%s/management/boot_device' % node_uuid
        return self._get_as_dict(path, os_ironic_api_version=os_ironic_api_version, global_request_id=global_request_id)

    def inject_nmi(self, node_uuid, os_ironic_api_version=None, global_request_id=None):
        path = '%s/management/inject_nmi' % node_uuid
        return self.update(path, {}, http_method='PUT', os_ironic_api_version=os_ironic_api_version, global_request_id=global_request_id)

    def get_supported_boot_devices(self, node_uuid, os_ironic_api_version=None, global_request_id=None):
        path = '%s/management/boot_device/supported' % node_uuid
        return self._get_as_dict(path, os_ironic_api_version=os_ironic_api_version, global_request_id=global_request_id)

    def get_vendor_passthru_methods(self, node_ident, os_ironic_api_version=None, global_request_id=None):
    ...
    def add_trait(self, node_ident, trait, os_ironic_api_version=None, global_request_id=None):
        ...
        return self.update(path, None, http_method='PUT', os_ironic_api_version=os_ironic_api_version, global_request_id=global_request_id)

    def set_traits(self, node_ident, traits, os_ironic_api_version=None, global_request_id=None):
    ...
    def remove_trait(self, node_ident, trait, os_ironic_api_version=None, global_request_id=None):
        ...
        """
        path = '%s/traits/%s' % (node_ident, trait)
        return self.delete(path, os_ironic_api_version=os_ironic_api_version, global_request_id=global_request_id)

    def remove_all_traits(self, node_ident, os_ironic_api_version=None, global_request_id=None):
    ...
    def list_bios_settings(self, node_ident, detail=False, fields=None, os_ironic_api_version=None, global_request_id=None):
        ...
        if filters:
            path += '?' + '&'.join(filters)
        return self._list_primitives(self._path(path), 'bios', os_ironic_api_version=os_ironic_api_version, global_request_id=global_request_id)
    ...
    def wait_for_provision_state(self, node_ident, expected_state, timeout=0, poll_interval=_DEFAULT_POLL_INTERVAL, poll_delay_function=None, fail_on_unexpected_state=True, os_ironic_api_version=None, global_request_id=None):
        ...
        * Error state is reached (if it's not equal to expected_state)
        ...
        def _timeout():
            return _('Node(s) %(node)s failed to reach state %(state)s in %(timeout)s seconds') % {'node': ', '.join(unfinished), 'state': expected_state, 'timeout': timeout}
        for _count in utils.poll(timeout, poll_interval, poll_delay_function, _timeout):
    ...
    def get_history_event(self, node_ident, event, os_ironic_api_version=None, global_request_id=None):
    ...
    def get_inventory(self, node_ident, os_ironic_api_version=None, global_request_id=None):
    ...
    def list_firmware_components(self, node_ident, os_ironic_api_version=None, global_request_id=None):
        ...
        return self._list_primitives(self._path(path), 'firmware', os_ironic_api_version=os_ironic_api_version, global_request_id=global_request_id)