...
class ListNotificationConfigsPager:
    ...
    def __init__(self, method: Callable[..., storage.ListNotificationConfigsResponse], request: storage.ListNotificationConfigsRequest, response: storage.ListNotificationConfigsResponse, *, metadata: Sequence[Tuple[str, str]]=()):
