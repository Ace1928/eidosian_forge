...
class Random(Exploration):
    ...
    def __init__(self, action_space: Space, *, model: ModelV2, framework: Optional[str], **kwargs):
        ...
        """
        super().__init__(action_space=action_space, model=model, framework=framework, **kwargs)
