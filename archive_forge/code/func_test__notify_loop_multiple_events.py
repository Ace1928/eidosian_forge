...
def test__notify_loop_multiple_events(self):
    ...
    self.manager.subscribe(callback_1, resources.ROUTER, events.BEFORE_DELETE)
    ...
    self.manager._notify_loop(resources.ROUTER, events.BEFORE_DELETE, mock.ANY, payload=mock.ANY)
