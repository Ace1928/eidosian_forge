...
def AddCustomAudiencesFlag(parser):
    ...
    repeated.AddPrimitiveArgs(parser, 'Service', 'custom-audiences', 'custom audiences', auto_group_help=False, additional_help='These flags modify the custom audiences that can be used in the audience field of ID token for authenticated requests.')