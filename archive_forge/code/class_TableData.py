...
class TableData(object):
    ...
    def process(self, model, data, default):
        ...
        return _process_data(self._info, model, data[self.options.namespace], default, self.filename, index=self.options.index, set=self.options.set, param=self.options.param, ncolumns=self.options.ncolumns)
