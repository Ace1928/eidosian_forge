...
class SetAutoscalingBeta(SetAutoscaling):
    ...
    def Args(parser):
        ...
        managed_instance_groups_utils.AddPredictiveAutoscaling(parser, standard=False)
    ...
    def Run(self, args):
        ...
        managed_instance_groups_utils.ValidateConflictsWithAutoscalingFile(args, managed_instance_groups_utils.ARGS_CONFLICTING_WITH_AUTOSCALING_FILE_BETA)
