...
class PlacementGroupsClient(ClientEntityBase):
    ...
    def get_by_id(self, id: int) -> BoundPlacementGroup:
        ...
        """
        response = self._client.request(url=f'/placement_groups/{id}', method='GET')
        return BoundPlacementGroup(self, response['placement_group'])

    def get_list(self, label_selector: str | None=None, page: int | None=None, per_page: int | None=None, name: str | None=None, sort: list[str] | None=None, type: str | None=None) -> PlacementGroupsPageResult:
    ...
    def get_all(self, label_selector: str | None=None, name: str | None=None, sort: list[str] | None=None) -> list[BoundPlacementGroup]:
    ...
    def create(self, name: str, type: str, labels: dict[str, str] | None=None) -> CreatePlacementGroupResponse:
        ...
        result = CreatePlacementGroupResponse(placement_group=BoundPlacementGroup(self, response['placement_group']), action=action)
        return result

    def update(self, placement_group: PlacementGroup | BoundPlacementGroup, labels: dict[str, str] | None=None, name: str | None=None) -> BoundPlacementGroup:
        ...
        if name is not None:
            data['name'] = name
        response = self._client.request(url=f'/placement_groups/{placement_group.id}', method='PUT', json=data)
        return BoundPlacementGroup(self, response['placement_group'])
    ...
    def delete(self, placement_group: PlacementGroup | BoundPlacementGroup) -> bool:
        ...
        :return: boolean
        """
        self._client.request(url=f'/placement_groups/{placement_group.id}', method='DELETE')
        return True