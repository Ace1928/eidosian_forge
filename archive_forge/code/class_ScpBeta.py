...
class ScpBeta(base.Command):
    ...
    """
        ...
        cmd = ssh.SCPCommand(srcs, dst, identity_file=keys.key_file, compress=args.compress, recursive=args.recurse, options=connection_details.options, iap_tunnel_args=iap_tunnel_args)
        return cmd.Run(env)