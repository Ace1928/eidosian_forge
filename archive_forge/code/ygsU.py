...
Converts an RWKV model checkpoint in PyTorch format to an rwkv.cpp compatible file format.

This script is designed to facilitate the conversion of RWKV model checkpoints from PyTorch
to a format compatible with the custom C++ implementation used in rwkv.cpp. It supports
various data types for the output file to optimize for different use cases.
