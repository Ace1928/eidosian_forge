...
class GameEnvironmentInitializer(ShowBase):
    ...
    def bindMouseToCamera(self):
        ...
        self.mouseWatcherNode.get_display_region()
        self.mouseWatcherNode.get_mouse()
        self.mouseWatcherNode.get_leave_pattern()
        self.mouseWatcherNode.get_within_pattern()
        self.mouseWatcherNode.get_without_pattern()
