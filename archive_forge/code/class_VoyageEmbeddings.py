...
@deprecated(since='0.0.29', removal='0.2', alternative_import='langchain_voyageai.VoyageAIEmbeddings')
class VoyageEmbeddings(BaseModel, Embeddings):
    ...
    def validate_environment(cls, values: Dict) -> Dict:
        ...
        if 'model' not in values:
            ...
            logger.warning('model will become a required arg for VoyageAIEmbeddings, we recommend to specify it when using this class. Currently the default is set to voyage-01.')
    ...
    def _invocation_params(self, input: List[str], input_type: Optional[str]=None) -> Dict:
        ...
        params: Dict = {'url': self.voyage_api_base, 'headers': {'Authorization': f'Bearer {api_key}'}, 'json': {'model': self.model, 'input': input, 'input_type': input_type, 'truncation': self.truncation}, 'timeout': self.request_timeout}
        return params
