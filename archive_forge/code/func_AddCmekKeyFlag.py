...
def AddCmekKeyFlag(parser, with_clear=True):
    ...
    if with_clear:
        ...
        policy_group.add_argument('--clear-key', default=False, action='store_true', help='Remove any previously set CMEK key reference.')
    policy_group.add_argument('--key', help='CMEK key reference to encrypt the container with.')