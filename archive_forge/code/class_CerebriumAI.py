...
class CerebriumAI(LLM):
    ...
    def _identifying_params(self) -> Mapping[str, Any]:
        ...
        return {**{'endpoint_url': self.endpoint_url}, **{'model_kwargs': self.model_kwargs}}
    ...
    def _call(self, prompt: str, stop: Optional[List[str]]=None, run_manager: Optional[CallbackManagerForLLMRun]=None, **kwargs: Any) -> str:
        headers: Dict = {'Authorization': cast(SecretStr, self.cerebriumai_api_key).get_secret_value(), 'Content-Type': 'application/json'}
