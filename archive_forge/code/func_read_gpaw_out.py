...
def read_gpaw_out(fileobj, index):
    ...
    for lines in blocks:
        ...
        try:
            ...
            parameters.update({'calculator': 'gpaw', 'uncorrected_energy': e})
            line = lines[ii + 1]
        ...
        if e is not None or f is not None:
            calc = SinglePointDFTCalculator(atoms, energy=e, forces=f, dipole=dipole, magmoms=magmoms, efermi=eFermi, bzkpts=bz_kpts, ibzkpts=ibz_kpts)
            calc.name = name
