...
class TabManager(QTabWidget):
    ...
    def setup_context_menu(self):
        """
        Sets up the context menu for the tabs.
        """
    ...
    def close_all_tabs(self):
        """
        Closes all tabs except the last one.
        """
        while self.count() > 1:
            self.close_tab(0)
    ...
    def close_other_tabs(self, index: int):
        ...
        Args:
            index (int): The index of the tab to keep open.
        """
    ...
    def move_tab(self, from_index: int, to_index: int):
        ...
        Args:
            from_index (int): The index of the tab to move.
            to_index (int): The index to move the tab to.
        """
...
class BookmarkManager(QWidget):
    ...
    def search_bookmarks(self, query: str) -> List[Dict[str, str]]:
        ...
        Returns:
            List[Dict[str, str]]: A list of matching bookmark items.
        """
        results = [
            entry
            for entry in self.bookmark_data
    ...
    def export_bookmarks(self, file_path: str):
        """
        Exports the bookmarks to a specified file.

        Args:
            file_path (str): The path to the file where bookmarks will be exported.
        """
        try:
    ...
    def import_bookmarks(self, file_path: str):
        """
        Imports bookmarks from a specified file.

        Args:
            file_path (str): The path to the file from which bookmarks will be imported.
        """
        try:
...
class BrowserUI(QMainWindow):
    ...
    def init_ui(self):
        """
        Initializes the user interface by setting up the central widget, navigation bar, menu, and status bar.
        """
        try:
