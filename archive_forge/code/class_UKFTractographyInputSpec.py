...
class UKFTractographyInputSpec(CommandLineInputSpec):
    ...
    maxBranchingAngle = traits.Float(desc="Maximum branching angle, in degrees. When using multiple tensors, a new branch will be created when the tensors' major directions form an angle between (minBranchingAngle, maxBranchingAngle). Branching is suppressed when this maxBranchingAngle is set to 0.0", argstr='--maxBranchingAngle %f')
