...
class WirelessDynamicInterface(object):
    ...
    def __init__(self, params, dnac):
        self.dnac = dnac
        self.new_object = dict(interfaceName=params.get('interfaceName'), vlanId=params.get('vlanId'), headers=params.get('headers'), interface_name=params.get('interfaceName'))
    ...
    def get_object_by_name(self, name):
        result = None
        try:
            items = self.dnac.exec(family='wireless', function='get_dynamic_interface', params=self.get_all_params(name=name))
    ...
    def requires_update(self, current_obj):
        ...
        obj_params = [('interfaceName', 'interfaceName'), ('vlanId', 'vlanId'), ('interfaceName', 'interface_name')]
    ...
    def create(self):
        result = self.dnac.exec(family='wireless', function='create_update_dynamic_interface', params=self.create_params(), op_modifies=True)
        return result
    ...
    def delete(self):
        ...
        result = self.dnac.exec(family='wireless', function='delete_dynamic_interface', params=self.delete_by_name_params())
        return result