...
class NetAppOntapPorts:
    ...
    def add_broadcast_domain_ports(self, ports):
        ...
        try:
            ...
            self.module.fail_json(msg='Error adding port for broadcast domain %s: %s' % (self.parameters['resource_name'], to_native(error)), exception=traceback.format_exc())
    ...
    def remove_portset_ports(self, port, portset_uuid=None):
        ...
        try:
            ...
            self.module.fail_json(msg='Error removing port in portset %s: %s' % (self.parameters['resource_name'], to_native(error)), exception=traceback.format_exc())
