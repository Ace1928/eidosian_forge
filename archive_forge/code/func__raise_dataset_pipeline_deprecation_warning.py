...
def _raise_dataset_pipeline_deprecation_warning():
    raise DeprecationWarning('`DatasetPipeline` is deprecated from Ray 2.8. Use `Dataset` instead. It supports lazy and streaming execution natively. To learn more, see https://docs.ray.io/en/latest/data/data-internals.html#execution.')