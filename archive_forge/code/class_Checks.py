...
class Checks(upgradecheck.UpgradeCommands):
    ...
    def check_trust_policies_are_not_empty(self):
        ...
        enforcer.load_rules()
        rules = ['identity:list_trusts', 'identity:delete_trust', 'identity:get_trust', 'identity:list_roles_for_trust', 'identity:get_role_for_trust']
        failed_rules = []
        for rule in rules:
