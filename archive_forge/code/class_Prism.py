...
class Prism:
    ...
    **Implementation**
    ...
    def __init__(self, cell, pbc=(True, True, True), tolerance=1e-08):
        ...
        self.flip = np.array([abs(self.lammps_cell[i][j] / self.lammps_tilt[k][k]) > 0.5 and self.pbc[k] for i, j, k in FLIP_ORDER])
