...
class FieldOrDatumDefWithConditionDatumDefGradientstringnull(ColorDef, MarkPropDefGradientstringnull):
    ...
    def __init__(self, bandPosition: Union[float, UndefinedType]=Undefined, condition: Union[dict, 'SchemaBase', Sequence[Union[dict, 'SchemaBase']], UndefinedType]=Undefined, datum: Union[str, bool, dict, None, float, '_Parameter', 'SchemaBase', UndefinedType]=Undefined, title: Union[str, None, 'SchemaBase', Sequence[str], UndefinedType]=Undefined, type: Union['SchemaBase', Literal['quantitative', 'ordinal', 'temporal', 'nominal', 'geojson'], UndefinedType]=Undefined, **kwds):
        super(FieldOrDatumDefWithConditionDatumDefGradientstringnull, self).__init__(bandPosition=bandPosition, condition=condition, datum=datum, title=title, type=type, **kwds)