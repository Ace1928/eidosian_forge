...
class VegaPlot(LayoutDOM):
    ...
    __js_require__ = {'paths': {'vega-embed': f'{config.npm_cdn}/vega-embed@6/build/vega-embed.min', 'vega-lite': f'{config.npm_cdn}/vega-lite@5/build/vega-lite.min', 'vega': f'{config.npm_cdn}/vega@5/build/vega.min'}, 'exports': {'vega-embed': 'vegaEmbed', 'vega': 'vega', 'vega-lite': 'vl'}}
