...
class CloudSigmaAPI20BaseTestCase:
    ...
    def test_invalid_region(self):
        ...
        assertRaisesRegex(self, ValueError, expected_msg, CloudSigma_2_0_NodeDriver, 'foo', 'bar', region='invalid')
    ...
    def test_create_node(self):
        ...
        metadata = {'foo': 'bar'}
        node = self.driver.create_node(name='test node', size=size, image=image, ex_metadata=metadata)
    ...
    def test_ex_stop_node_already_stopped(self):
        ...
        assertRaisesRegex(self, CloudSigmaError, expected_msg, self.driver.ex_stop_node, node=self.node)
    ...
    def test_ex_create_firewall_policy_with_rules(self):
        ...
        rules = [{'action': 'accept', 'direction': 'out', 'ip_proto': 'tcp', 'src_ip': '127.0.0.1', 'dst_ip': '127.0.0.1'}]
