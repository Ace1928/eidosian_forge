class BobAxolotlParameters:
    ...
    def __init__(self, ourIdentityKey, ourSignedPreKey, ourRatchetKey, ourOneTimePreKey, theirIdentityKey, theirBaseKey):
        """
        ...
        if ourIdentityKey is None or ourSignedPreKey is None or ourRatchetKey is None or (theirIdentityKey is None) or (theirBaseKey is None):
    ...
    class Builder:
        ...
        def create(self):
            return BobAxolotlParameters(self.ourIdentityKey, self.ourSignedPreKey, self.ourRatchetKey, self.ourOneTimePreKey, self.theirIdentityKey, self.theirBaseKey)