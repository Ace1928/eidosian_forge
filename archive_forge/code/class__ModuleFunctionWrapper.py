...
class _ModuleFunctionWrapper(FunctionWrapper):
    ...
    def __init__(self, func: Callable, params_re: str='^(w?(u|v+)|w(u?|v*))x*z?$', return_re: str='^[uvn]$'):
    ...
    def has_input(self) -> bool:
        return any((isinstance(x, (_WorkflowDataFrameParam, _WorkflowDataFramesParam)) for x in self._params.values()))
