...
def test_metrics_override(self):
    ...
    statsd = {'host': '127.0.0.1', 'port': '4321', 'prefix': 'statsd.override.prefix'}
    ...
    influxdb = {'use_udp': True, 'host': '127.0.0.1', 'port': '1234', 'username': 'override-username', 'password': 'override-password', 'database': 'override-database', 'measurement': 'measurement.name', 'timeout': 10}
