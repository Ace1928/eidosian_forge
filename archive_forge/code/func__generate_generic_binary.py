...
def _generate_generic_binary(self, binary, opstring, eager_grouping=False, **kw):
    ...
    text = binary.left._compiler_dispatch(self, eager_grouping=eager_grouping, **kw) + opstring + binary.right._compiler_dispatch(self, eager_grouping=eager_grouping, **kw)
