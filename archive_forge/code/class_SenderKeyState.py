...
class SenderKeyState:
    ...
    def __init__(self, id=None, iteration=None, chainKey=None, signatureKeyPublic=None, signatureKeyPrivate=None, signatureKeyPair=None, senderKeyStateStructure=None):
        """
        :type id: int
        :type iteration: int
        ...
        """
        assert bool(id) and bool(iteration) and bool(chainKey) or bool(senderKeyStateStructure) ^ bool(signatureKeyPublic or signatureKeyPair) or bool(signatureKeyPublic) ^ bool(signatureKeyPair), 'Missing required arguments'
