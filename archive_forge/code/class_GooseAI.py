...
class GooseAI(LLM):
    ...
    def _default_params(self) -> Dict[str, Any]:
        ...
        normal_params = {'temperature': self.temperature, 'max_tokens': self.max_tokens, 'top_p': self.top_p, 'min_tokens': self.min_tokens, 'frequency_penalty': self.frequency_penalty, 'presence_penalty': self.presence_penalty, 'n': self.n, 'logit_bias': self.logit_bias}
