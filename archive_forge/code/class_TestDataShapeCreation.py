...
class TestDataShapeCreation(unittest.TestCase):
    ...
    def test_time(self):
        ...
        self.assertEqual(dshape('time[tz="America/Vancouver"]')[0].tz, 'America/Vancouver')
    ...
    def test_datetime(self):
        ...
        self.assertEqual(dshape('datetime[tz="America/Vancouver"]')[0].tz, 'America/Vancouver')
    ...
    def test_units(self):
        ...
        self.assertEqual(dshape('units["second", int32]')[0].tp, dshape('int32'))
    ...
    def test_syntax(self):
        self.assertEqual(datashape.Fixed(3) * dshape('int32'), dshape('3 * int32'))
        self.assertEqual(3 * dshape('int32'), dshape('3 * int32'))
        self.assertEqual(datashape.Var() * dshape('int32'), dshape('var * int32'))
        self.assertEqual(datashape.Var() * datashape.int32, dshape('var * int32'))
    ...
    dshapes = ['bool', 'int8', 'int16', 'int32', 'int64', 'uint8', 'uint16', 'uint32', 'uint64', 'float32', 'float64', 'complex64', 'complex128', 'string', 'json', 'date', 'time', 'datetime', 'int', 'real', 'complex', 'intptr', 'uintptr', '{id: int8, value: bool, result: int16}', '{a: int32, b: int64, x: uint8, y: uint16, z: uint32}', '{a: float32, b: float64, c: complex64, d: complex128,  e: string, f: json, g: date, h: time, i: datetime}']
    dimensions = ['2', '100', '...', 'var', '2 * var * 2']
