...
class ExplainedVariance(Metric):
    ...
    def __init__(self, multioutput: Literal['raw_values', 'uniform_average', 'variance_weighted']='uniform_average', **kwargs: Any) -> None:
    ...
    def compute(self) -> Union[Tensor, Sequence[Tensor]]:
        ...
        return _explained_variance_compute(self.num_obs, self.sum_error, self.sum_squared_error, self.sum_target, self.sum_squared_target, self.multioutput)
