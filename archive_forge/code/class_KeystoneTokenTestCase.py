...
class KeystoneTokenTestCase(base.TestCase):
    ...
    def test_get_domain_name(self):
        self.assertEqual(self.domain_name, self.ks_token_credential.domain_name)

    def test_get_project_id(self):
        self.assertEqual(self.project_id, self.ks_token_credential.project_id)

    def test_get_project_name(self):
        self.assertEqual(self.project_name, self.ks_token_credential.project_name)

    def test_get_project_domain_id(self):
        self.assertEqual(self.project_domain_id, self.ks_token_credential.project_domain_id)

    def test_get_project_domain_name(self):
        self.assertEqual(self.project_domain_name, self.ks_token_credential.project_domain_name)

    def test_get_reauthenticate(self):
        self.assertEqual(self.reauthenticate, self.ks_token_credential.reauthenticate)
