...
def check_user_model(app_configs=None, **kwargs):
    ...
    if not cls._meta.get_field(cls.USERNAME_FIELD).unique and (not any((constraint.fields == (cls.USERNAME_FIELD,) for constraint in cls._meta.total_unique_constraints))):
