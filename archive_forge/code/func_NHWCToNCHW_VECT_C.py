...
def NHWCToNCHW_VECT_C(input_shape_or_tensor):
  ...
  """
    ...
    temp_shape = input_shape_or_tensor.shape.as_list() if is_tensor else input_shape_or_tensor
    if temp_shape[-1] % 4 != 0:
        raise ValueError('Last dimension of input must be evenly divisible by 4 to convert to NCHW_VECT_C.')
    temp_shape[-1] //= 4
    temp_shape.append(4)
