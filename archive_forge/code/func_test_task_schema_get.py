...
def test_task_schema_get(self):
    self._verify('openstack.proxy.Proxy._get', self.proxy.get_task_schema, expected_args=[_schema.Schema], expected_kwargs={'base_path': '/schemas/task', 'requires_id': False})