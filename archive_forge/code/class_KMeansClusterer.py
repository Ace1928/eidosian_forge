...
class KMeansClusterer(VectorSpaceClusterer):
    ...
    def __init__(self, num_means, distance, repeats=1, conv_test=1e-06, initial_means=None, normalise=False, svd_dimensions=None, rng=None, avoid_empty_clusters=False):
        """
