...
class MetricsServiceV2AsyncClient:
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        """
        return MetricsServiceV2Client.from_service_account_info.__func__(MetricsServiceV2AsyncClient, info, *args, **kwargs)
    ...
    def from_service_account_file(cls, filename: str, *args, **kwargs):
        ...
        Returns:
            MetricsServiceV2AsyncClient: The constructed client.
        """
        return MetricsServiceV2Client.from_service_account_file.__func__(MetricsServiceV2AsyncClient, filename, *args, **kwargs)
    ...
    def get_mtls_endpoint_and_cert_source(cls, client_options: Optional[ClientOptions]=None):
        ...
        """
        return MetricsServiceV2Client.get_mtls_endpoint_and_cert_source(client_options)
    ...
    def __init__(self, *, credentials: Optional[ga_credentials.Credentials]=None, transport: Union[str, MetricsServiceV2Transport]='grpc_asyncio', client_options: Optional[ClientOptions]=None, client_info: gapic_v1.client_info.ClientInfo=DEFAULT_CLIENT_INFO) -> None:
        ...
        """
        self._client = MetricsServiceV2Client(credentials=credentials, transport=transport, client_options=client_options, client_info=client_info)

    async def list_log_metrics(self, request: Optional[Union[logging_metrics.ListLogMetricsRequest, dict]]=None, *, parent: Optional[str]=None, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> pagers.ListLogMetricsAsyncPager:
        ...
        rpc = gapic_v1.method_async.wrap_method(self._client._transport.list_log_metrics, default_retry=retries.Retry(initial=0.1, maximum=60.0, multiplier=1.3, predicate=retries.if_exception_type(core_exceptions.DeadlineExceeded, core_exceptions.InternalServerError, core_exceptions.ServiceUnavailable), deadline=60.0), default_timeout=60.0, client_info=DEFAULT_CLIENT_INFO)
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((('parent', request.parent),)),)
        response = await rpc(request, retry=retry, timeout=timeout, metadata=metadata)
        response = pagers.ListLogMetricsAsyncPager(method=rpc, request=request, response=response, metadata=metadata)
        return response

    async def get_log_metric(self, request: Optional[Union[logging_metrics.GetLogMetricRequest, dict]]=None, *, metric_name: Optional[str]=None, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> logging_metrics.LogMetric:
        ...
        rpc = gapic_v1.method_async.wrap_method(self._client._transport.get_log_metric, default_retry=retries.Retry(initial=0.1, maximum=60.0, multiplier=1.3, predicate=retries.if_exception_type(core_exceptions.DeadlineExceeded, core_exceptions.InternalServerError, core_exceptions.ServiceUnavailable), deadline=60.0), default_timeout=60.0, client_info=DEFAULT_CLIENT_INFO)
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((('metric_name', request.metric_name),)),)
        response = await rpc(request, retry=retry, timeout=timeout, metadata=metadata)
        return response

    async def create_log_metric(self, request: Optional[Union[logging_metrics.CreateLogMetricRequest, dict]]=None, *, parent: Optional[str]=None, metric: Optional[logging_metrics.LogMetric]=None, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> logging_metrics.LogMetric:
        ...
        rpc = gapic_v1.method_async.wrap_method(self._client._transport.create_log_metric, default_timeout=60.0, client_info=DEFAULT_CLIENT_INFO)
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((('parent', request.parent),)),)
        response = await rpc(request, retry=retry, timeout=timeout, metadata=metadata)
        return response

    async def update_log_metric(self, request: Optional[Union[logging_metrics.UpdateLogMetricRequest, dict]]=None, *, metric_name: Optional[str]=None, metric: Optional[logging_metrics.LogMetric]=None, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> logging_metrics.LogMetric:
        ...
        if metric is not None:
            request.metric = metric
        rpc = gapic_v1.method_async.wrap_method(self._client._transport.update_log_metric, default_retry=retries.Retry(initial=0.1, maximum=60.0, multiplier=1.3, predicate=retries.if_exception_type(core_exceptions.DeadlineExceeded, core_exceptions.InternalServerError, core_exceptions.ServiceUnavailable), deadline=60.0), default_timeout=60.0, client_info=DEFAULT_CLIENT_INFO)
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((('metric_name', request.metric_name),)),)
        response = await rpc(request, retry=retry, timeout=timeout, metadata=metadata)
        return response

    async def delete_log_metric(self, request: Optional[Union[logging_metrics.DeleteLogMetricRequest, dict]]=None, *, metric_name: Optional[str]=None, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> None:
        ...
        if metric_name is not None:
            request.metric_name = metric_name
        rpc = gapic_v1.method_async.wrap_method(self._client._transport.delete_log_metric, default_retry=retries.Retry(initial=0.1, maximum=60.0, multiplier=1.3, predicate=retries.if_exception_type(core_exceptions.DeadlineExceeded, core_exceptions.InternalServerError, core_exceptions.ServiceUnavailable), deadline=60.0), default_timeout=60.0, client_info=DEFAULT_CLIENT_INFO)
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((('metric_name', request.metric_name),)),)
