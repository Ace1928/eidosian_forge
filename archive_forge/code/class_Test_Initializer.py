...
class Test_Initializer(unittest.TestCase):
    ...
    def test_constant(self):
        ...
        with self.assertRaisesRegex(RuntimeError, 'Initializer ConstantInitializer does not contain embedded indices'):
            a.indices()
    ...
    def test_dataframe(self):
        ...
        df = pd.DataFrame(data=d)
        with self.assertRaisesRegex(ValueError, 'DataFrameInitializer for DataFrame with multiple columns'):
            a = Initializer(df)
