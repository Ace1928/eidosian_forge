...
def AddDestGroupUpdateIpAndFqdnArgs(parser):
  ...
  """
    ...
    group.add_argument('--ip-range-list', help='List of ip-ranges in the Destination Group.')
    group.add_argument('--fqdn-list', help='List of FQDNs in the Destination Group.')