...
def RemoveVolumeMountFlag():
    ...
    return base.Argument('--remove-volume-mount', action=arg_parsers.UpdateAction, type=arg_parsers.ArgList(), metavar='MOUNT_PATH', help='Removes the volume mounted at the specified path from the current container.')