...
class DFS(Algorithm):
    ...
    Attributes:
        grid (List[List[int]]): A grid representation of the game environment.
    """
    ...
    def recursive_DFS(self, snake, goalstate: Node, currentstate: Node) -> Node:
        """
    ...
    def run_algorithm(self, snake) -> Node:
        """
        ...
        result_path = self.recursive_DFS(snake, goalstate, initialstate)
