...
class TestSeriesMisc:
    ...
    @pytest.mark.parametrize('kernel, has_numeric_only', [('skew', True), ('var', True), ('all', False), ('prod', True), ('any', False), ('idxmin', False), ('quantile', False), ('idxmax', False), ('min', True), ('sem', True), ('mean', True), ('nunique', False), ('max', True), ('sum', True), ('count', False), ('median', True), ('std', True), ('backfill', False), ('rank', True), ('pct_change', False), ('cummax', False), ('shift', False), ('diff', False), ('cumsum', False), ('cummin', False), ('cumprod', False), ('fillna', False), ('ffill', False), ('pad', False), ('bfill', False), ('sample', False), ('tail', False), ('take', False), ('head', False), ('cov', False), ('corr', False)])
