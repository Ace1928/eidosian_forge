...
class TestShellCliPrecedence(utils.TestShell):
    ...
    def setUp(self):
        ...
        env = {'OS_CLOUD': 'megacloud', 'OS_REGION_NAME': 'occ-env'}
    ...
    def test_shell_args_precedence_1(self, config_mock, vendor_mock):
        ...
        self.assertEqual('occ-env', _shell.cloud.config['region_name'])
        self.assertEqual('occ-env', _shell.client_manager.region_name)
    ...
    def test_shell_args_precedence_3(self, config_mock, vendor_mock):
        ...
        vendor_mock.return_value = ('file.yaml', copy.deepcopy(PUBLIC_1))
        _shell = utils.make_shell()
        utils.fake_execute(_shell, '--os-cloud scc --os-region-name krikkit list user')
