...
class ConfFixture(fixtures.Fixture):
    ...
    def __init__(self, conf, transport_url=None):
        self.conf = conf
        _import_opts(self.conf, 'oslo_messaging._drivers.impl_rabbit', 'rabbit_opts', 'oslo_messaging_rabbit')
        _import_opts(self.conf, 'oslo_messaging._drivers.base', 'base_opts', 'oslo_messaging_rabbit')
        _import_opts(self.conf, 'oslo_messaging._drivers.amqp', 'amqp_opts', 'oslo_messaging_rabbit')
        ...
        _import_opts(self.conf, 'oslo_messaging.rpc.dispatcher', '_dispatcher_opts')
        _import_opts(self.conf, 'oslo_messaging.notify.notifier', '_notifier_opts', 'oslo_messaging_notifications')
        _import_opts(self.conf, 'oslo_messaging._metrics.client', 'oslo_messaging_metrics', 'oslo_messaging_metrics')
