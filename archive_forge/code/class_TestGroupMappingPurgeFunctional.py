...
class TestGroupMappingPurgeFunctional(unit.SQLDriverOverrides, unit.TestCase):
    ...
    def config_files(self):
        ...
        config_files = super(TestGroupMappingPurgeFunctional, self).config_files()
    ...
    def config(self, config_files):
        CONF(args=['mapping_purge', '--type', 'group'], project='keystone', default_config_files=config_files)
