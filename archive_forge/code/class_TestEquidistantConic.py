...
class TestEquidistantConic:
    ...
    def test_central_longitude(self, lon):
        ...
        check_proj_params('eqdc', eqdc_offset, other_args)
        assert_array_almost_equal(eqdc_offset.boundary.coords, eqdc.boundary.coords, decimal=0)
    ...
    def test_sphere_transform(self):
        ...
        lat_1 = 29.5
        lat_2 = 45.5
        eqdc = ccrs.EquidistantConic(central_longitude=-96.0, central_latitude=23.0, standard_parallels=(lat_1, lat_2), globe=globe)
        geodetic = eqdc.as_geodetic()
        other_args = {'a=1.0', 'b=1.0', 'lon_0=-96.0', 'lat_0=23.0', 'x_0=0.0', 'y_0=0.0', 'lat_1=29.5', 'lat_2=45.5'}
        check_proj_params('eqdc', eqdc, other_args)
        assert_almost_equal(np.array(eqdc.x_limits), (-3.520038619089038, 3.520038619089038), decimal=7)
        assert_almost_equal(np.array(eqdc.y_limits), (-1.9722220547535922, 2.7066811021065535), decimal=7)
    ...
    def test_ellipsoid_transform(self):
        ...
        lat_1 = 29.5
        lat_2 = 45.5
        eqdc = ccrs.EquidistantConic(central_latitude=23.0, central_longitude=-96.0, standard_parallels=(lat_1, lat_2), globe=globe)
        geodetic = eqdc.as_geodetic()
