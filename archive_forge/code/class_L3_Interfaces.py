        ...
        for each in want:
            ...
            for every in have:
                ...
                if each_want.get('address') == every_have.get('address'):
                    if len(each_want.keys()) == len(every_have.keys()) and each_want.get('secondary') == every_have.get('secondary'):
                        diff = False
                        break
                    if not each_want.get('secondary') and (not every_have.get('secondary')):
                        diff = False
                        break
                    diff = True
                else:
