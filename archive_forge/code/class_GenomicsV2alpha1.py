...
class GenomicsV2alpha1(base_api.BaseApiClient):
    ...
    def __init__(self, url='', credentials=None, get_credentials=True, http=None, model=None, log_request=False, log_response=False, credentials_args=None, default_global_params=None, additional_http_headers=None, response_encoding=None):
        ...
        super(GenomicsV2alpha1, self).__init__(url, credentials=credentials, get_credentials=get_credentials, http=http, model=model, log_request=log_request, log_response=log_response, credentials_args=credentials_args, default_global_params=default_global_params, additional_http_headers=additional_http_headers, response_encoding=response_encoding)
    ...
    class ProjectsOperationsService(base_api.BaseApiService):
      ...
      """
            ...
            return self._RunMethod(config, request, global_params=global_params)
        Cancel.method_config = lambda: base_api.ApiMethodInfo(flat_path='v2alpha1/projects/{projectsId}/operations/{operationsId}:cancel', http_method='POST', method_id='genomics.projects.operations.cancel', ordered_params=['name'], path_params=['name'], query_params=[], relative_path='v2alpha1/{+name}:cancel', request_field='cancelOperationRequest', request_type_name='GenomicsProjectsOperationsCancelRequest', response_type_name='Empty', supports_download=False)
      ...
      """
            ...
            return self._RunMethod(config, request, global_params=global_params)
        Get.method_config = lambda: base_api.ApiMethodInfo(flat_path='v2alpha1/projects/{projectsId}/operations/{operationsId}', http_method='GET', method_id='genomics.projects.operations.get', ordered_params=['name'], path_params=['name'], query_params=[], relative_path='v2alpha1/{+name}', request_field='', request_type_name='GenomicsProjectsOperationsGetRequest', response_type_name='Operation', supports_download=False)
      ...
      """
            ...
            return self._RunMethod(config, request, global_params=global_params)
        List.method_config = lambda: base_api.ApiMethodInfo(flat_path='v2alpha1/projects/{projectsId}/operations', http_method='GET', method_id='genomics.projects.operations.list', ordered_params=['name'], path_params=['name'], query_params=['filter', 'pageSize', 'pageToken'], relative_path='v2alpha1/{+name}', request_field='', request_type_name='GenomicsProjectsOperationsListRequest', response_type_name='ListOperationsResponse', supports_download=False)
    ...
    class WorkersService(base_api.BaseApiService):
      ...
      """
            config = self.GetMethodConfig('CheckIn')
            return self._RunMethod(config, request, global_params=global_params)
        CheckIn.method_config = lambda: base_api.ApiMethodInfo(http_method='POST', method_id='genomics.workers.checkIn', ordered_params=['id'], path_params=['id'], query_params=[], relative_path='v2alpha1/workers/{id}:checkIn', request_field='checkInRequest', request_type_name='GenomicsWorkersCheckInRequest', response_type_name='CheckInResponse', supports_download=False)