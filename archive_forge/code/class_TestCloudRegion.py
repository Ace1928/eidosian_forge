...
class TestCloudRegion(base.TestCase):
    ...
    def test_get_config(self):
        ...
        self.assertEqual(fake_services_dict['interface'], cc._get_config('interface', None))
    ...
    def test_rackspace_workaround(self):
        cc = cloud_region.CloudRegion('test1', 'DFW', {'profile': 'rackspace', 'region_name': 'DFW', 'auth': {'project_id': '123456'}, 'block_storage_endpoint_override': 'https://example.com/v2/'})
    ...
    def test_get_session_with_timeout(self, mock_session):
        ...
        cc = cloud_region.CloudRegion('test1', 'region-al', config_dict, auth_plugin=mock.Mock())
        cc.get_session()
        mock_session.assert_called_with(auth=mock.ANY, verify=True, cert=None, timeout=9, collect_timing=None, discovery_cache=None)
        self.assertEqual(fake_session.additional_user_agent, [('openstacksdk', openstack_version.__version__)])
