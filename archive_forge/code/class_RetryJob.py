...
class RetryJob(base.CreateCommand):
    ...
    def Run(self, args):
        ...
        failed_activity_msg = 'Cannot retry job on rollout {}.'.format(rollout_ref.RelativeName())
        ...
        return rollout.RolloutClient().RetryJob(rollout_ref.RelativeName(), args.job_id, args.phase_id, override_deploy_policies=policies)