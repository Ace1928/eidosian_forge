...
class HumanControlEnvSpec(EnvSpec, ABC):
    ...
    def __init__(self, name, *args, resolution=(640, 360), guiscale_range=[1, 1], gamma_range=[2.0, 2.0], fov_range=[70.0, 70.0], cursor_size_range=[16, 16], **kwargs):
    ...
    def create_observables(self) -> List[TranslationHandler]:
        return [H.POVObservation(self.resolution), H.FlatInventoryObservation(ALL_ITEMS)]
