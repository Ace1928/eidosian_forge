...
class PredictionGuard(LLM):
    ...
    def validate_environment(cls, values: Dict) -> Dict:
        ...
        try:
            ...
            raise ImportError('Could not import predictionguard python package. Please install it with `pip install predictionguard`.')
        return values
    ...
    def _call(self, prompt: str, stop: Optional[List[str]]=None, run_manager: Optional[CallbackManagerForLLMRun]=None, **kwargs: Any) -> str:
        ...
        response = pg.Completion.create(model=self.model, prompt=prompt, output=self.output, temperature=params['temperature'], max_tokens=params['max_tokens'], **kwargs)
