...
def ResolveImageFromTensorflowVersion(self, tf_version, use_dl_image):
    ...
    image_family = self._ImageFamilyFromTensorflowVersion(tf_version, use_dl_image)
    request = self.messages.ComputeImagesGetFromFamilyRequest(family=image_family, project=project)
