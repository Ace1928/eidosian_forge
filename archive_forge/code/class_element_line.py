...
class element_line(element_base):
    ...
    def __init__(self, *, color: Optional[str | TupleFloat3 | TupleFloat4]=None, size: Optional[float]=None, linetype: Optional[str | Sequence[int]]=None, lineend: Optional[Literal['butt', 'projecting', 'round']]=None, colour: Optional[str | TupleFloat3 | TupleFloat4]=None, **kwargs: Any):
        super().__init__()
