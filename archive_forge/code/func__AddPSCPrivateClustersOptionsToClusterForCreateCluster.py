...
def _AddPSCPrivateClustersOptionsToClusterForCreateCluster(cluster, options, messages):
    ...
    if options.cross_connect_subnetworks is not None:
        ...
        cluster.privateClusterConfig.crossConnectConfig = messages.CrossConnectConfig(items=items)