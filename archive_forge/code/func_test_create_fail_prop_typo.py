...
def test_create_fail_prop_typo(self):
    rname = 'test_resource'
    tmpl = rsrc_defn.ResourceDefinition(rname, 'GenericResourceType', {'Food': 'abc'})
    res = generic_rsrc.ResourceWithProps(rname, tmpl, self.stack)
    estr = 'StackValidationFailed: resources.test_resource: Property error: test_resource.Properties: Unknown Property Food'
