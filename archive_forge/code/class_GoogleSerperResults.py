...
class GoogleSerperResults(BaseTool):
    ...
    description: str = 'A low-cost Google Search API.Useful for when you need to answer questions about current events.Input should be a search query. Output is a JSON object of the query results'
