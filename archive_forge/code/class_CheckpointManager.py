  ...
  """
    ...
    """
        ...
        def _record_and_sweep_state(save_path):
            ...
            self._record_state()
        if options is None:
            save_path = self._checkpoint._write(prefix, write_done_callback=_record_and_sweep_state)
        else:
            save_path = self._checkpoint._write(prefix, options=options, write_done_callback=_record_and_sweep_state)
        return save_path
