...
def system_automation_destination(data, fos, check_mode=False):
    ...
    if check_mode:
        ...
        mkey = fos.get_mkey('system', 'automation-destination', filtered_data, vdom=vdom)
    ...
    if state == 'present' or state is True:
        return fos.set('system', 'automation-destination', data=filtered_data, vdom=vdom)
    elif state == 'absent':
        return fos.delete('system', 'automation-destination', mkey=filtered_data['name'], vdom=vdom)
    else:
