...
def _set_align(self, align: Literal['left', 'center', 'right'] | tuple[Literal['relative'], int]) -> None:
    warnings.warn(f'Method `{self.__class__.__name__}._set_align` is deprecated, please use property `{self.__class__.__name__}.align`', DeprecationWarning, stacklevel=2)
    self.align = align