...
def test_sympy_control_complex():
    ...
    cirq.testing.assert_same_circuits(deferred, cirq.Circuit(cirq.CX(q0, q_ma), cirq.CX(q1, q_mb), cirq.ControlledOperation([q_ma, q_mb], cirq.X(q2), cirq.SumOfProducts([[0, 0], [1, 0], [1, 1]])), cirq.measure(q_ma, key='a'), cirq.measure(q_mb, key='b'), cirq.measure(q2, key='c')))