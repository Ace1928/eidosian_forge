...
class OsloginV1beta(base_api.BaseApiClient):
    ...
    def __init__(self, url='', credentials=None, get_credentials=True, http=None, model=None, log_request=False, log_response=False, credentials_args=None, default_global_params=None, additional_http_headers=None, response_encoding=None):
        ...
        super(OsloginV1beta, self).__init__(url, credentials=credentials, get_credentials=get_credentials, http=http, model=model, log_request=log_request, log_response=log_response, credentials_args=credentials_args, default_global_params=default_global_params, additional_http_headers=additional_http_headers, response_encoding=response_encoding)
    ...
    class UsersService(base_api.BaseApiService):
      ...
      """
            ...
            return self._RunMethod(config, request, global_params=global_params)
        GetLoginProfile.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1beta/users/{usersId}/loginProfile', http_method='GET', method_id='oslogin.users.getLoginProfile', ordered_params=['name'], path_params=['name'], query_params=['projectId', 'systemId', 'view'], relative_path='v1beta/{+name}/loginProfile', request_field='', request_type_name='OsloginUsersGetLoginProfileRequest', response_type_name='LoginProfile', supports_download=False)
      ...
      """
            ...
            return self._RunMethod(config, request, global_params=global_params)
        ImportSshPublicKey.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1beta/users/{usersId}:importSshPublicKey', http_method='POST', method_id='oslogin.users.importSshPublicKey', ordered_params=['parent'], path_params=['parent'], query_params=['projectId', 'regions', 'view'], relative_path='v1beta/{+parent}:importSshPublicKey', request_field='sshPublicKey', request_type_name='OsloginUsersImportSshPublicKeyRequest', response_type_name='ImportSshPublicKeyResponse', supports_download=False)