...
class GameEnvironmentInitializer(ShowBase):
    ...
    def createGround(self):
        ...
        nodePath.set_color(0.3, 0.3, 0.3, 1)  # Dark gray ground for better contrast
    ...
    def createPlayer(self):
        ...
        self.playerNodePath.set_color(1, 1, 1, 1)  # White player for better visibility
        self.world.attachRigidBody(body)
    ...
    def createObstacles(self):
        for _ in range(20):  # Increased number of obstacles for more complexity
    ...
    def setFrameRate(self):
        globalClock.setFrameRate(120)  # Increased frame rate for smoother gameplay
        logging.info("GameEnvironmentInitializer: Frame rate set to 120 FPS.")

    def enablePlayerMovement(self):
        self.accept(
            "arrow_up", self.applyMovement, [Vec3(0, 100, 0)]
