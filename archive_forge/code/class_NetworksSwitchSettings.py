...
class NetworksSwitchSettings(object):
    ...
    def __init__(self, params, meraki):
        self.meraki = meraki
        self.new_object = dict(vlan=params.get('vlan'), useCombinedPower=params.get('useCombinedPower'), powerExceptions=params.get('powerExceptions'), network_id=params.get('networkId'))
    ...
    def update_all_params(self):
        ...
        if self.new_object.get('powerExceptions') is not None or self.new_object.get('power_exceptions') is not None:
            new_object_params['powerExceptions'] = self.new_object.get('powerExceptions') or self.new_object.get('power_exceptions')
        if self.new_object.get('networkId') is not None or self.new_object.get('network_id') is not None:
            new_object_params['networkId'] = self.new_object.get('networkId') or self.new_object.get('network_id')
        return new_object_params
    ...
    def get_object_by_name(self, name):
        result = None
        try:
            items = self.meraki.exec_meraki(family='switch', function='getNetworkSwitchSettings', params=self.get_all_params(name=name))
    ...
    def requires_update(self, current_obj):
        ...
        obj_params = [('vlan', 'vlan'), ('useCombinedPower', 'useCombinedPower'), ('powerExceptions', 'powerExceptions'), ('networkId', 'networkId')]
    ...
    def update(self):
        ...
        name = self.new_object.get('name')
        result = None
        result = self.meraki.exec_meraki(family='switch', function='updateNetworkSwitchSettings', params=self.update_all_params(), op_modifies=True)
        return result