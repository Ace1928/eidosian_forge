...
def test_set_access_metadata(self):
    expected = {'metadata': {'key1': 'v1', 'key2': 'v2'}}
    self.run_command('access-metadata 9999 set key1=v1 key2=v2', version='2.45')
    self.assert_called('PUT', '/share-access-rules/9999/metadata', body=expected)