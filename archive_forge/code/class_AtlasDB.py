...
class AtlasDB(VectorStore):
    ...
    def __init__(self, name: str, embedding_function: Optional[Embeddings]=None, api_key: Optional[str]=None, description: str='A description for your project', is_public: bool=True, reset_project_if_exists: bool=False) -> None:
        """
        ...
        if self._embedding_function is not None:
            modality = 'embedding'
        self.project = AtlasProject(name=name, description=description, modality=modality, is_public=is_public, reset_project_if_exists=reset_project_if_exists, unique_id_field=AtlasDB._ATLAS_DEFAULT_ID_FIELD)
    ...
    def add_texts(self, texts: Iterable[str], metadatas: Optional[List[dict]]=None, ids: Optional[List[str]]=None, refresh: bool=True, **kwargs: Any) -> List[str]:
    ...
    def from_texts(cls: Type[AtlasDB], texts: List[str], embedding: Optional[Embeddings]=None, metadatas: Optional[List[dict]]=None, ids: Optional[List[str]]=None, name: Optional[str]=None, api_key: Optional[str]=None, description: str='A description for your project', is_public: bool=True, reset_project_if_exists: bool=False, index_kwargs: Optional[dict]=None, **kwargs: Any) -> AtlasDB:
        ...
        atlasDB = cls(name, embedding_function=embedding, api_key=api_key, description='A description for your project', is_public=is_public, reset_project_if_exists=reset_project_if_exists)
