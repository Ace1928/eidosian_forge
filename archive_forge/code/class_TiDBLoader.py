...
class TiDBLoader(BaseLoader):
    ...
    def __init__(self, connection_string: str, query: str, page_content_columns: Optional[List[str]]=None, metadata_columns: Optional[List[str]]=None, engine_args: Optional[Dict[str, Any]]=None) -> None:
    ...
    def lazy_load(self) -> Iterator[Document]:
        ...
        with engine.connect() as conn:
            ...
            for row in result:
                ...
                page_content = '\n'.join((f'{k}: {v}' for k, v in row_data.items() if self.page_content_columns is None or k in self.page_content_columns))
