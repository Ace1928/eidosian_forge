...
def do_generate(subparsers, parent: argparse.ArgumentParser, completer: CompositeActionCompletionFinder):
    ...
    parser.set_defaults(func=command_coverage_analyze_targets_generate, config=CoverageAnalyzeTargetsGenerateConfig)
    targets_generate = parser.add_argument_group(title='coverage arguments')
    targets_generate.add_argument('input_dir', nargs='?', help='directory to read coverage from')
    targets_generate.add_argument('output_file', help='output file for aggregated coverage')
