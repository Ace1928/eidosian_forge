...
def load_dataset(dataset_dir: str, dataset_name: str):
...
def train_on_datasets(
    dan, criterion, optimizer, num_epochs, dataset_dir, dataset_prefix
):
    dataset_index = 0
    while True:
        ...
        torch.save(dan, REGRESSION_TRAINED_MODEL_PATH)
