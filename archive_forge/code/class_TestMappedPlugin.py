...
class TestMappedPlugin(unit.TestCase):
    ...
    def setUp(self):
        ...
        self.existing_roles = {self.member_role_name: {'id': self.member_role_id}}
        self.shadow_project_mock = {'name': 'test-project', 'roles': [{'name': self.member_role_name}]}
        self.shadow_project_in_domain_mock = {'name': 'test-project-in-domain', 'domain': self.domain_mock, 'roles': [{'name': self.member_role_name}]}
        self.shadow_projects_mock = [self.shadow_project_mock, self.shadow_project_in_domain_mock]
