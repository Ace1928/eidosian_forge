...
class VultrDNSDriverV1(VultrDNSDriver):
    ...
    RECORD_TYPE_MAP = {RecordType.A: 'A', RecordType.AAAA: 'AAAA', RecordType.TXT: 'TXT', RecordType.CNAME: 'CNAME', RecordType.MX: 'MX', RecordType.NS: 'NS', RecordType.SRV: 'SRV'}
    ...
    def create_record(self, name, zone, type, data, extra=None):
        ...
        post_data = {'domain': zone.domain, 'name': name, 'type': self.RECORD_TYPE_MAP.get(type), 'data': data}
    ...
    def _to_zone(self, item):
        ...
        zone = Zone(id=item['domain'], domain=item['domain'], driver=self, type=type, ttl=None, extra=extra)
        return zone
    ...
    def _to_record(self, item, zone):
        ...
        record = Record(id=item['RECORDID'], name=item['name'], type=type, data=item['data'], zone=zone, driver=self, extra=extra)
        return record
