...
class McomplexWithExpansion(McomplexWithMemory):
    ...
    def __init__(self, tetrahedron_list=None):
        McomplexWithMemory.__init__(self, tetrahedron_list, two_zero_to_one_tet=False)
        self.moves_added_by_expansion = 0

    def zero_to_two(self, arrow, gap):
        raise NotImplementedError('0->2 move not yet implemented in terms of 2<->3 moves')
