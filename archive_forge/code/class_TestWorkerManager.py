...
class TestWorkerManager(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.mturk_manager = MTurkManager(opt=self.opt.copy(), mturk_agent_ids=mturk_agent_ids)
    ...
    def test_shutdown(self):
        ...
        self.assertEqual(len(self.worker_manager.save_disconnects.mock_calls), 1, 'save_disconnects must be called in worker manager shutdown')
        self.assertEqual(len(self.worker_manager.un_time_block_workers.mock_calls), 1, 'un_time_block_workers must be called in worker manager shutdown')
