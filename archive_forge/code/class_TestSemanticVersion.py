...
class TestSemanticVersion(base.BaseTestCase):
    ...
    def test_ordering(self):
        ordered_versions = ['1.2.3.dev6', '1.2.3.dev7', '1.2.3.a4.dev12', '1.2.3.a4.dev13', '1.2.3.a4', '1.2.3.a5.dev1', '1.2.3.a5', '1.2.3.b3.dev1', '1.2.3.b3', '1.2.3.rc2.dev1', '1.2.3.rc2', '1.2.3.rc3.dev1', '1.2.3', '1.2.4', '1.3.3', '2.2.3']
