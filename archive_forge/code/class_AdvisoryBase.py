...
class AdvisoryBase(NonCompletableGithubObject):
    ...
    def _useAttributes(self, attributes: dict[str, Any]) -> None:
        ...
        if 'published_at' in attributes:
            assert attributes['published_at'] is None or isinstance(attributes['published_at'], str), attributes['published_at']
        ...
        if 'withdrawn_at' in attributes:
            assert attributes['withdrawn_at'] is None or isinstance(attributes['withdrawn_at'], str), attributes['withdrawn_at']
