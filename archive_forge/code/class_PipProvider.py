...
class PipProvider(_ProviderBase):
    ...
    def find_matches(self, identifier: str, requirements: Mapping[str, Iterator[Requirement]], incompatibilities: Mapping[str, Iterator[Candidate]]) -> Iterable[Candidate]:
        ...
        def _eligible_for_upgrade(identifier: str) -> bool:
            ...
            return False
        constraint = _get_with_identifier(self._constraints, identifier, default=Constraint.empty())
        return self._factory.find_candidates(identifier=identifier, requirements=requirements, constraint=constraint, prefers_installed=not _eligible_for_upgrade(identifier), incompatibilities=incompatibilities)
