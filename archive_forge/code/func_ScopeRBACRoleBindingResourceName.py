...
def ScopeRBACRoleBindingResourceName(project, scope, name, release_track=base.ReleaseTrack.ALPHA):
    return resources.REGISTRY.Parse(line=None, params={'projectsId': project, 'locationsId': 'global', 'scopesId': scope, 'rbacrolebindingsId': name}, collection='gkehub.projects.locations.scopes.rbacrolebindings', api_version=VERSION_MAP[release_track]).RelativeName()