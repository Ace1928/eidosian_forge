...
class TorchContActionQModel(TorchModelV2):
    ...
    def __init__(self, obs_space, action_space, num_outputs, model_config, name):
        ...
        super(TorchContActionQModel, self).__init__(obs_space, action_space, None, model_config, name)
        combined_space = Box(-1.0, 1.0, (self.num_outputs + action_space.shape[0],))
        self.q_head = TorchFullyConnectedNetwork(combined_space, action_space, 1, model_config, 'q_head')
