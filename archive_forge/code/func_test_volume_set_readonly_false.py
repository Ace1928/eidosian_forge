...
def test_volume_set_readonly_false(self):
    self._verify('openstack.block_storage.v3.volume.Volume.set_readonly', self.proxy.set_volume_readonly, method_args=['value', False], expected_args=[self.proxy, False])