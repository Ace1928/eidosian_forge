...
class TransportTraceDecorator(decorator.TransportDecorator):
    ...
    def put_bytes_non_atomic(self, relpath: str, raw_bytes: bytes, mode=None, create_parent_dir=False, dir_mode=None):
        ...
        self._trace(('put_bytes_non_atomic', relpath, len(raw_bytes), mode, create_parent_dir, dir_mode))
        return self._decorated.put_bytes_non_atomic(relpath, raw_bytes, mode=mode, create_parent_dir=create_parent_dir, dir_mode=dir_mode)
