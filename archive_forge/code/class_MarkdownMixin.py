...
class MarkdownMixin:
    ...
    def markdown(self, body: SupportsStr, unsafe_allow_html: bool=False, *, help: str | None=None) -> DeltaGenerator:
    ...
    @gather_metrics('code')
    def code(self, body: SupportsStr, language: str | None='python') -> DeltaGenerator:
    ...
    def caption(self, body: SupportsStr, unsafe_allow_html: bool=False, *, help: str | None=None) -> DeltaGenerator:
    ...
    def latex(self, body: SupportsStr | sympy.Expr, *, help: str | None=None) -> DeltaGenerator:
