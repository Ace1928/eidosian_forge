...
class MaxComputeLoader(BaseLoader):
    ...
    def __init__(self, query: str, api_wrapper: MaxComputeAPIWrapper, *, page_content_columns: Optional[Sequence[str]]=None, metadata_columns: Optional[Sequence[str]]=None):
    ...
    @classmethod
    def from_params(cls, query: str, endpoint: str, project: str, *, access_id: Optional[str]=None, secret_access_key: Optional[str]=None, **kwargs: Any) -> MaxComputeLoader:
        ...
        """
        api_wrapper = MaxComputeAPIWrapper.from_params(endpoint, project, access_id=access_id, secret_access_key=secret_access_key)
