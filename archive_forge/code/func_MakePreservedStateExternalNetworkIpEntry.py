...
def MakePreservedStateExternalNetworkIpEntry(messages, stateful_ip):
    return messages.PreservedState.ExternalIPsValue.AdditionalProperty(key=stateful_ip.get('interface-name', STATEFUL_IP_DEFAULT_INTERFACE_NAME), value=_MakePreservedStateNetworkIpEntry(messages, stateful_ip))