...
def test_type_create_with_description(self):
    expected = {'share_type': {'name': 'test', 'description': 'test_description', 'share_type_access:is_public': True, 'extra_specs': {'driver_handles_share_servers': False}}}
    self.run_command('type-create test false --description test_description', version='2.41')
