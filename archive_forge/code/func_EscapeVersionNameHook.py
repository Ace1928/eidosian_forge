...
def EscapeVersionNameHook(ref, unused_args, req):
    ...
    version = resources.REGISTRY.Create('artifactregistry.projects.locations.repositories.packages.versions', projectsId=ref.projectsId, locationsId=ref.locationsId, repositoriesId=ref.repositoriesId, packagesId=escaped_pkg, versionsId=escaped_ver)
