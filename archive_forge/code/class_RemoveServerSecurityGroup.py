...
class RemoveServerSecurityGroup(command.Command):
    ...
    def get_parser(self, prog_name):
        ...
        parser.add_argument('server', metavar='<server>', help=_('Name or ID of server to use'))
        parser.add_argument('group', metavar='<group>', help=_('Name or ID of security group to remove from server'))
        return parser
