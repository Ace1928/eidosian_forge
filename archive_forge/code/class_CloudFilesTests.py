...
class CloudFilesTests(unittest.TestCase):
    ...
    def test_service_catalog(self):
        ...
        self.assertEqual('https://cdn.clouddrive.com/v1/MossoCloudFS', self.driver.connection.get_endpoint())
    ...
    def test_get_endpoint_internalurl(self):
        ...
        url = 'https://snet-storage101.%s1.clouddrive.com/v1/MossoCloudFS_11111-111111111-1111111111-1111111' % self.region
        self.assertEqual(url, self.driver.connection.get_endpoint())
    ...
    def test_download_object_success(self):
        container = Container(name='foo_bar_container', extra={}, driver=self)
        obj = Object(name='foo_bar_object', size=1000, hash=None, extra={}, container=container, meta_data=None, driver=CloudFilesStorageDriver)
    ...
    def test_download_object_range_success(self):
        container = Container(name='foo_bar_container', extra={}, driver=self)
        obj = Object(name='foo_bar_object_range', size=10, hash=None, extra={}, container=container, meta_data=None, driver=CloudFilesStorageDriver)
        destination_path = os.path.abspath(__file__) + '.temp'
        result = self.driver.download_object_range(obj=obj, destination_path=destination_path, start_bytes=5, end_bytes=7, overwrite_existing=False, delete_on_failure=True)
        self.assertTrue(result)
    ...
    def test_download_object_as_stream_data_is_not_buffered_in_memory(self):
        ...
        obj = Object(name='foo_bar_object_NO_BUFFER', size=1000, hash=None, extra={}, container=container, meta_data=None, driver=self.driver)
    ...
    def test_download_object_range_as_stream_success(self):
        container = Container(name='foo_bar_container', extra={}, driver=self)
        obj = Object(name='foo_bar_object_range', size=2, hash=None, extra={}, container=container, meta_data=None, driver=CloudFilesStorageDriver)
        stream = self.driver.download_object_range_as_stream(start_bytes=5, end_bytes=7, obj=obj, chunk_size=None)
        self.assertTrue(hasattr(stream, '__iter__'))
    ...
    def test_upload_object_no_content_type(self):
        ...
        container = Container(name='foo_bar_container', extra={}, driver=self)
        object_name = 'foo_test_upload'
        obj = self.driver.upload_object(file_path=file_path, verify_hash=False, container=container, object_name=object_name)
    ...
    def test_upload_object_via_stream_python3_bytes_error(self):
        ...
        mocked_response = container.upload_object_via_stream(iterator=iter(bytes_blob), object_name='img_or_vid')
    ...
    def test_ex_get_object_temp_url(self, time):
        ...
        self.driver.ex_get_meta_data.return_value = {'container_count': 1, 'object_count': 1, 'bytes_used': 1, 'temp_url_key': 'foo'}
        container = Container(name='foo_bar_container', extra={}, driver=self)
        obj = Object(name='foo_bar_object', size=1000, hash=None, extra={}, container=container, meta_data=None, driver=self)
        hmac_body = '{}\n{}\n{}'.format('GET', 60, '/v1/MossoCloudFS/foo_bar_container/foo_bar_object')
