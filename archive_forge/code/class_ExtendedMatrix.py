...
class ExtendedMatrix:
    ...
    def __init__(self, matrix, isOrientationReversing=False):
        if isinstance(matrix, ExtendedMatrix):
            ...
            self.isOrientationReversing = matrix.isOrientationReversing ^ isOrientationReversing
        else:
            self.matrix = matrix
    ...
    def _mul_impl(a, b):
        ...
        if a.isOrientationReversing:
            ...
            b_matrix = b.matrix
        return ExtendedMatrix(a.matrix * b_matrix, a.isOrientationReversing ^ b.isOrientationReversing)
