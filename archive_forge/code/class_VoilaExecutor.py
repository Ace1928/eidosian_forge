...
class VoilaExecutor(NotebookClient):
    ...
    cell_error_instruction = Unicode('Please run Voilà with --show_tracebacks=True or --debug to see the error message, or configure VoilaConfiguration.show_tracebacks.', config=True, help='instruction given to user to debug cell errors')
    cell_timeout_instruction = Unicode('Please run Voilà with --VoilaExecutor.interrupt_on_timeout=True to continue executing the rest of the notebook.', config=True, help='instruction given to user to continue execution on timeout')
