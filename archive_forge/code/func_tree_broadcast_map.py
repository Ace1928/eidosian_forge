...
def tree_broadcast_map(func: Callable[..., U], tree: PyTree[T], *rests: PyTree[T], is_leaf: Callable[[T], bool] | None=None, none_is_leaf: bool=False, namespace: str='') -> PyTree[U]:
    ...
    """
    if not rests:
        return tree_map(func, tree, is_leaf=is_leaf, none_is_leaf=none_is_leaf, namespace=namespace)
    ...
    return tree_map(func, broadcasted_tree, *broadcasted_rests, is_leaf=is_leaf, none_is_leaf=none_is_leaf, namespace=namespace)