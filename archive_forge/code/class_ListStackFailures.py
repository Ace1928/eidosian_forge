...
class ListStackFailures(command.Command):
    ...
    def take_action(self, parsed_args):
        ...
        self._print_failures(failures, deployment_failures, long=parsed_args.long)
    ...
    def get_parser(self, prog_name):
        ...
        parser.add_argument('--long', action='store_true', default=False, help=_('Show full deployment logs in output'))
        return parser
