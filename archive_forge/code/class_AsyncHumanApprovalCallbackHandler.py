...
class AsyncHumanApprovalCallbackHandler(AsyncCallbackHandler):
    ...
    def __init__(self, approve: Callable[[Any], Awaitable[bool]]=_adefault_approve, should_check: Callable[[Dict[str, Any]], bool]=_default_true):
        self._approve = approve
        self._should_check = should_check

    async def on_tool_start(self, serialized: Dict[str, Any], input_str: str, *, run_id: UUID, parent_run_id: Optional[UUID]=None, **kwargs: Any) -> Any:
