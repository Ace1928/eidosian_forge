...
class XPathContext:
    ...
    def __init__(self, root: Optional[RootArgType]=None, namespaces: Optional[NamespacesType]=None, uri: Optional[str]=None, fragment: bool=False, item: Optional[ItemArgType]=None, position: int=1, size: int=1, axis: Optional[str]=None, variables: Optional[Dict[str, CollectionArgType]]=None, current_dt: Optional[datetime.datetime]=None, timezone: Optional[Union[str, Timezone]]=None, documents: Optional[Dict[str, Optional[RootArgType]]]=None, collections: Optional[Dict[str, CollectionArgType]]=None, default_collection: CollectionArgType=None, text_resources: Optional[Dict[str, str]]=None, resource_collections: Optional[Dict[str, List[str]]]=None, default_resource_collection: Optional[str]=None, allow_environment: bool=False, default_language: Optional[str]=None, default_calendar: Optional[str]=None, default_place: Optional[str]=None) -> None:
        if namespaces:
        ...
        if documents is not None:
            self.documents = {k: get_node_tree(v, self.namespaces, k) if v is not None else v for k, v in documents.items()}
        self.variables = {}
