...
def test_type_create_with_create_share_from_snapshot_support(self, expected_bool, text):
    expected = {'share_type': {'name': 'test', 'share_type_access:is_public': True, 'extra_specs': {'driver_handles_share_servers': False, 'snapshot_support': True, 'create_share_from_snapshot_support': expected_bool}}}
    self.run_command('type-create test false --snapshot-support true --create-share-from-snapshot-support ' + text)
