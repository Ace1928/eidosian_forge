...
class UniversalGUIBuilder:
    """
    A class for building a universal GUI using Tkinter.
    """
    ...
    def create_toolbar(self):
        """
        Create the toolbar for the GUI builder.
        """
        ...
        for label, command, image_file in button_data:
            ...
            button = tk.Button(toolbar, image=image, command=command)
            button.image = image
            button.pack(side=tk.LEFT, padx=2, pady=2)

    def create_properties_panel(self):
        """
        Create the properties panel for editing widget properties.
        """
        properties_panel = tk.Frame(self.master, bd=1, relief=tk.RAISED)
        properties_panel.pack(side=tk.RIGHT, fill=tk.Y)

        label = tk.Label(properties_panel, text="Properties")
        label.pack(pady=10)
        ...
        for prop in properties:
            frame = tk.Frame(properties_panel)
