class OIDCNoPrompt(Exception):
    ...
    def __init__(self):
        msg = 'OIDC request for no user interaction received. Do not ask user for authorization, it should been done using silent authentication through create_authorization_response. See OIDCNoPrompt.__doc__ for more details.'
