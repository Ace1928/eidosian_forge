...
class ElasticsearchEmbeddings(Embeddings):
    ...
    def __init__(self, client: MlClient, model_id: str, *, input_field: str='text_field'):
        """
    ...
    @classmethod
    def from_credentials(cls, model_id: str, *, es_cloud_id: Optional[str]=None, es_user: Optional[str]=None, es_password: Optional[str]=None, input_field: str='text_field') -> ElasticsearchEmbeddings:
