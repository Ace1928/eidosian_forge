...
class AzureRMVMSSExtension(AzureRMModuleBase):
    ...
    def __init__(self):
        ...
        self.state = None
        required_if = [('state', 'present', ['publisher', 'type', 'type_handler_version'])]
        self.results = dict(changed=False, state=dict())
        super(AzureRMVMSSExtension, self).__init__(derived_arg_spec=self.module_arg_spec, supports_tags=False, required_if=required_if)
