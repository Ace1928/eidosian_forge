...
class GenericPluginTestCase(utils.TestCase):
    ...
    def setUp(self):
        ...
        self.stub_url('POST', ['v3', 'auth', 'tokens'], headers={'X-Subject-Token': self.token_v3_id}, json=self.token_v3)
    ...
    def assertCreateV3(self, **kwargs):
        ...
        self.assertEqual(self.TEST_URL + 'v3/auth/tokens', self.requests_mock.last_request.url)
