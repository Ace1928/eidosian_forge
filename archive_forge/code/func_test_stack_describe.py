...
def test_stack_describe(self):
    ...
    sl = self.eng.show_stack(self.ctx, self.stack.identifier(), resolve_outputs=True)
    ...
    service.EngineService._get_stack.assert_called_once_with(self.ctx, self.stack.identifier(), show_deleted=True)