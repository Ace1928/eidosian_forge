...
class Recommendation(base.ClientBase):
    ...
    """
        request = self._messages.RecommenderProjectsLocationsRecommendersRecommendationsGetRequest(name=name)
    ...
    """
        request = self._messages.RecommenderProjectsLocationsRecommendersRecommendationsListRequest(parent=parent_name)
        return list_pager.YieldFromList(self._service, request, batch_size_attribute='pageSize', batch_size=page_size, limit=limit, field='recommendations')
