...
class GateOperation(raw_types.Operation):
    ...
    def __repr__(self):
        ...
        dont_need_on = re.match('^[a-zA-Z0-9.()]+$', gate_repr)
    ...
    def _decompose_with_context_(self, context: Optional['cirq.DecompositionContext']=None) -> 'cirq.OP_TREE':
        return protocols.decompose_once_with_qubits(self.gate, self.qubits, NotImplemented, flatten=False, context=context)
    ...
    def _apply_channel_(self, args: 'protocols.ApplyChannelArgs') -> Union[np.ndarray, None, NotImplementedType]:
