...
class dependenciesTest(common.HeatTestCase):
    ...
    def test_complex_rev(self):
        self._dep_test_rev(('last', 'mid1'), ('last', 'mid2'), ('mid1', 'mid3'), ('mid1', 'first'), ('mid3', 'first'), ('mid2', 'first'))
    ...
    def test_leaves(self):
        d = dependencies.Dependencies([('last1', 'mid'), ('last2', 'mid'), ('mid', 'first1'), ('mid', 'first2')])
