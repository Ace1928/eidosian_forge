    ...
    **Bases:** :class:`GraphicsObject <pyqtgraph.GraphicsObject>`
    ...
    def setLookupTable(self, lut, update=True, **kwargs):
        if isinstance(lut, HistogramLUTItem):
            warnings.warn('NonUniformImage::setLookupTable(HistogramLUTItem) is deprecated and will be removed in a future version of PyQtGraph. use HistogramLUTItem::setImageItem(NonUniformImage) instead', DeprecationWarning, stacklevel=2)
