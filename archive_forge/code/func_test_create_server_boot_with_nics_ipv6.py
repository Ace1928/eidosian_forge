...
def test_create_server_boot_with_nics_ipv6(self):
    ...
    nics = [{'net-id': '11111111-1111-1111-1111-111111111111', 'v6-fixed-ip': '2001:db9:0:1::10'}]
    ...
    with mock.patch.object(self.cs.servers, '_boot', wrapped_boot):
        s = self.cs.servers.create(name='My server', image=1, flavor=1, meta={'foo': 'bar'}, userdata='hello moto', key_name='fakekey', nics=nics)
