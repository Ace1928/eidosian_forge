    ...
    def element_encode(self, obj: Any, xsd_element: 'XsdElement', level: int=0) -> ElementData:
        ...
        for name, value in obj.items():
            if name == self.text_key:
                text = value
            elif self.cdata_prefix is not None and name.startswith(self.cdata_prefix) and name[len(self.cdata_prefix):].isdigit():
            ...
            elif self.attr_prefix and name.startswith(self.attr_prefix) and (name != self.attr_prefix):
