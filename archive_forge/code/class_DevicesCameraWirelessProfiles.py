...
class DevicesCameraWirelessProfiles(object):
    ...
    def __init__(self, params, meraki):
        self.meraki = meraki
        self.new_object = dict(ids=params.get('ids'), serial=params.get('serial'))
    ...
    def get_object_by_name(self, name):
        result = None
        try:
            items = self.meraki.exec_meraki(family='camera', function='getDeviceCameraWirelessProfiles', params=self.get_all_params(name=name))
    ...
    def requires_update(self, current_obj):
        ...
        obj_params = [('ids', 'ids'), ('serial', 'serial')]
    ...
    def update(self):
        ...
        name = self.new_object.get('name')
        result = None
        result = self.meraki.exec_meraki(family='camera', function='updateDeviceCameraWirelessProfiles', params=self.update_all_params(), op_modifies=True)
        return result