...
class TestWrappedCredentials(testcase.GsUtilUnitTestCase):
    ...
    def testWrappedCredentialUsage(self, http):
        ...
        creds = WrappedCredentials(MockCredentials(token=ACCESS_TOKEN, audience='foo', subject_token_type='bar', token_url='https://sts.googleapis.com', credential_source='qux'))
