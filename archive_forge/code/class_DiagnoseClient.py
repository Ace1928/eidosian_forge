...
class DiagnoseClient(object):
    ...
    def __init__(self, compute_client=None, iam_client=None, storage_client=None):
        ...
        self._compute_client = compute_client or apis.GetClientInstance('compute', 'v1')
        self._iam_client = iam_client or apis.GetClientInstance('iam', 'v1')
        self._storage_client = storage_client or apis.GetClientInstance('storage', 'v1')
    ...
    """
        ...
        response = self._iam_client.projects_serviceAccounts.SignBlob(messages.IamProjectsServiceAccountsSignBlobRequest(name=iam_util.EmailToAccountResourceName(service_account), signBlobRequest=messages.SignBlobRequest(bytesToSign=bytes_to_sign)))
    ...
    """
        messages = self._iam_client.MESSAGES_MODULE
        response = self._iam_client.projects_serviceAccounts.List(messages.IamProjectsServiceAccountsListRequest(name=iam_util.ProjectToProjectResourceName(project)))
