...
class BigquerydatatransferV1(base_api.BaseApiClient):
    ...
    def __init__(self, url='', credentials=None, get_credentials=True, http=None, model=None, log_request=False, log_response=False, credentials_args=None, default_global_params=None, additional_http_headers=None, response_encoding=None):
        ...
        super(BigquerydatatransferV1, self).__init__(url, credentials=credentials, get_credentials=get_credentials, http=http, model=model, log_request=log_request, log_response=log_response, credentials_args=credentials_args, default_global_params=default_global_params, additional_http_headers=additional_http_headers, response_encoding=response_encoding)
    ...
    class ProjectsLocationsService(base_api.BaseApiService):
      ...
      """
            ...
            return self._RunMethod(config, request, global_params=global_params)
        EnrollDataSources.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1/projects/{projectsId}/locations/{locationsId}:enrollDataSources', http_method='POST', method_id='bigquerydatatransfer.projects.locations.enrollDataSources', ordered_params=['name'], path_params=['name'], query_params=[], relative_path='v1/{+name}:enrollDataSources', request_field='enrollDataSourcesRequest', request_type_name='BigquerydatatransferProjectsLocationsEnrollDataSourcesRequest', response_type_name='Empty', supports_download=False)
      ...
      """
            config = self.GetMethodConfig('Get')
            return self._RunMethod(config, request, global_params=global_params)
        Get.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1/projects/{projectsId}/locations/{locationsId}', http_method='GET', method_id='bigquerydatatransfer.projects.locations.get', ordered_params=['name'], path_params=['name'], query_params=[], relative_path='v1/{+name}', request_field='', request_type_name='BigquerydatatransferProjectsLocationsGetRequest', response_type_name='Location', supports_download=False)
      ...
      """
            config = self.GetMethodConfig('List')
            return self._RunMethod(config, request, global_params=global_params)
        List.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1/projects/{projectsId}/locations', http_method='GET', method_id='bigquerydatatransfer.projects.locations.list', ordered_params=['name'], path_params=['name'], query_params=['filter', 'pageSize', 'pageToken'], relative_path='v1/{+name}/locations', request_field='', request_type_name='BigquerydatatransferProjectsLocationsListRequest', response_type_name='ListLocationsResponse', supports_download=False)
      ...
      """
            ...
            return self._RunMethod(config, request, global_params=global_params)
        UnenrollDataSources.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1/projects/{projectsId}/locations/{locationsId}:unenrollDataSources', http_method='POST', method_id='bigquerydatatransfer.projects.locations.unenrollDataSources', ordered_params=['name'], path_params=['name'], query_params=[], relative_path='v1/{+name}:unenrollDataSources', request_field='unenrollDataSourcesRequest', request_type_name='BigquerydatatransferProjectsLocationsUnenrollDataSourcesRequest', response_type_name='Empty', supports_download=False)
    ...
    class ProjectsTransferConfigsRunsTransferLogsService(base_api.BaseApiService):
      ...
      """
            config = self.GetMethodConfig('List')
            return self._RunMethod(config, request, global_params=global_params)
        List.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1/projects/{projectsId}/transferConfigs/{transferConfigsId}/runs/{runsId}/transferLogs', http_method='GET', method_id='bigquerydatatransfer.projects.transferConfigs.runs.transferLogs.list', ordered_params=['parent'], path_params=['parent'], query_params=['messageTypes', 'pageSize', 'pageToken'], relative_path='v1/{+parent}/transferLogs', request_field='', request_type_name='BigquerydatatransferProjectsTransferConfigsRunsTransferLogsListRequest', response_type_name='ListTransferLogsResponse', supports_download=False)
    ...
    class ProjectsService(base_api.BaseApiService):
      ...
      """
            config = self.GetMethodConfig('EnrollDataSources')
            return self._RunMethod(config, request, global_params=global_params)
        EnrollDataSources.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1/projects/{projectsId}:enrollDataSources', http_method='POST', method_id='bigquerydatatransfer.projects.enrollDataSources', ordered_params=['name'], path_params=['name'], query_params=[], relative_path='v1/{+name}:enrollDataSources', request_field='enrollDataSourcesRequest', request_type_name='BigquerydatatransferProjectsEnrollDataSourcesRequest', response_type_name='Empty', supports_download=False)