...
"""
    ...
    def __init__(self):
        super().__init__(name='MineRLObtainDiamondShovel-v0', max_episode_steps=TIMEOUT, fov_range=[70, 70], resolution=[640, 360], gamma_range=[2, 2], guiscale_range=[1, 1], cursor_size_range=[16.0, 16.0])
