...
class LocalArtifactRepository(ArtifactRepository):
    ...
    def log_artifact(self, local_file, artifact_path=None):
        ...
        artifact_dir = os.path.join(self.artifact_dir, artifact_path) if artifact_path else self.artifact_dir
    ...
    def list_artifacts(self, path=None):
        ...
        if os.path.isdir(list_dir):
            ...
            infos = [get_file_info(f, relative_path_to_artifact_path(os.path.relpath(f, self.artifact_dir))) for f in artifact_files]
    ...
    def delete_artifacts(self, artifact_path=None):
        artifact_path = local_file_uri_to_path(os.path.join(self._artifact_dir, artifact_path) if artifact_path else self._artifact_dir)
