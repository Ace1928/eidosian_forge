...
class InterfaceShared(InterfaceBase):
    ...
    def __init__(self, process: Optional[BaseProcess]=None, process_check: bool=True, mailbox: Optional[Any]=None) -> None:
        super().__init__()
    ...
    def _deliver_download_artifact(self, download_artifact: pb.DownloadArtifactRequest) -> MailboxHandle:
    ...
    def _communicate_status(self, status: pb.StatusRequest) -> Optional[pb.StatusResponse]:
    ...
    def _deliver_get_system_metrics(self, get_system_metrics: pb.GetSystemMetricsRequest) -> MailboxHandle:
    ...
    def _deliver_network_status(self, network_status: pb.NetworkStatusRequest) -> MailboxHandle:
        record = self._make_request(network_status=network_status)
        return self._deliver_record(record)

    def _deliver_internal_messages(self, internal_message: pb.InternalMessagesRequest) -> MailboxHandle:
    ...
    def _deliver_request_sampled_history(self, sampled_history: pb.SampledHistoryRequest) -> MailboxHandle:
        record = self._make_request(sampled_history=sampled_history)
        return self._deliver_record(record)

    def _deliver_request_run_status(self, run_status: pb.RunStatusRequest) -> MailboxHandle:
