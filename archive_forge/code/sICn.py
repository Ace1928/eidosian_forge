...
class CodeStandardizer(tk.Tk):
    ...
    def standardize_code(self):
        ...
        original_code = self.file_processor.read_file(file_path)
        self.original_code_text.insert("1.0", original_code)
        ...
        self.embeddings_database.save_code_analysis(
            file_path, original_code, standardized_code
        )
    ...
    def apply_standardization(self, code: str) -> str:
        ...
        self.embeddings_database.save_code_embeddings(
