...
class ChannelConnectionClientV1(EventarcClientBase):
    ...
    def __init__(self):
        super(ChannelConnectionClientV1, self).__init__(common.API_NAME, common.API_VERSION_1, 'Channel Connection')
        ...
        publishing_client = apis.GetClientInstance(common_publishing.API_NAME, common_publishing.API_VERSION_1)
    ...
    """
        create_req = self._messages.EventarcProjectsLocationsChannelConnectionsCreateRequest(parent=channel_connection_ref.Parent().RelativeName(), channelConnection=channel_connection_message, channelConnectionId=channel_connection_ref.Name())
    ...
    """
        delete_req = self._messages.EventarcProjectsLocationsChannelConnectionsDeleteRequest(name=channel_connection_ref.RelativeName())
    ...
    """
        get_req = self._messages.EventarcProjectsLocationsChannelConnectionsGetRequest(name=channel_connection_ref.RelativeName())
    ...
    """
        list_req = self._messages.EventarcProjectsLocationsChannelConnectionsListRequest(parent=location_ref.RelativeName(), pageSize=page_size)
        return list_pager.YieldFromList(service=self._service, request=list_req, field='channelConnections', limit=limit, batch_size=page_size, batch_size_attribute='pageSize')
    ...
    """
        events_value_list_entry = common_publishing.TransformEventsForPublishing(self._publishing_messages.GoogleCloudEventarcPublishingV1PublishChannelConnectionEventsRequest.EventsValueListEntry, cloud_event)
        publish_events_request = self._publishing_messages.GoogleCloudEventarcPublishingV1PublishChannelConnectionEventsRequest(events=[events_value_list_entry])
        publish_req = self._publishing_messages.EventarcpublishingProjectsLocationsChannelConnectionsPublishEventsRequest(channelConnection=channel_connection_ref.RelativeName(), googleCloudEventarcPublishingV1PublishChannelConnectionEventsRequest=publish_events_request)
