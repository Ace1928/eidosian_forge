...
def AddClearVpcNetworkFlags(parser, resource_kind='service'):
    ...
    parser.add_argument('--clear-network', action='store_true', help='Disconnect this Cloud Run {kind} from the VPC network it is connected to.'.format(kind=resource_kind))