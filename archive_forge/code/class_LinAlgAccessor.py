...
class LinAlgAccessor:
    ...
    def svd(self, dims=None, *, full_matrices=True, compute_uv=True, hermitian=False, out_append='2', **kwargs):
        """Call :func:`xarray_einstats.linalg.svd` on this DataArray."""
        return svd(self._obj, dims=dims, full_matrices=full_matrices, compute_uv=compute_uv, hermitian=hermitian, out_append=out_append, **kwargs)

    def eig(self, dims=None, **kwargs):
        """Call :func:`xarray_einstats.linalg.eig` on this DataArray."""
        return eig(self._obj, dims=dims, **kwargs)

    def eigh(self, dims=None, *, UPLO='L', **kwargs):
