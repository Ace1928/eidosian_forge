...
class PolicytroubleshooterV3alpha(base_api.BaseApiClient):
    ...
    def __init__(self, url='', credentials=None, get_credentials=True, http=None, model=None, log_request=False, log_response=False, credentials_args=None, default_global_params=None, additional_http_headers=None, response_encoding=None):
        ...
        super(PolicytroubleshooterV3alpha, self).__init__(url, credentials=credentials, get_credentials=get_credentials, http=http, model=model, log_request=log_request, log_response=log_response, credentials_args=credentials_args, default_global_params=default_global_params, additional_http_headers=additional_http_headers, response_encoding=response_encoding)
    ...
    class IamService(base_api.BaseApiService):
      ...
      """
            config = self.GetMethodConfig('Troubleshoot')
            return self._RunMethod(config, request, global_params=global_params)
        Troubleshoot.method_config = lambda: base_api.ApiMethodInfo(http_method='POST', method_id='policytroubleshooter.iam.troubleshoot', ordered_params=[], path_params=[], query_params=[], relative_path='v3alpha/iam:troubleshoot', request_field='<request>', request_type_name='GoogleCloudPolicytroubleshooterIamV3alphaTroubleshootIamPolicyRequest', response_type_name='GoogleCloudPolicytroubleshooterIamV3alphaTroubleshootIamPolicyResponse', supports_download=False)
    ...
    class ServicePerimeterService(base_api.BaseApiService):
      ...
      """
            config = self.GetMethodConfig('Troubleshoot')
            return self._RunMethod(config, request, global_params=global_params)
        Troubleshoot.method_config = lambda: base_api.ApiMethodInfo(http_method='POST', method_id='policytroubleshooter.servicePerimeter.troubleshoot', ordered_params=[], path_params=[], query_params=[], relative_path='v3alpha/servicePerimeter:troubleshoot', request_field='<request>', request_type_name='GoogleCloudPolicytroubleshooterServiceperimeterV3alphaTroubleshootServicePerimeterRequest', response_type_name='GoogleCloudPolicytroubleshooterServiceperimeterV3alphaTroubleshootServicePerimeterResponse', supports_download=False)