    ...
    def __init__(self, value):
        ...
        if not self.restore_default:
            try:
                ...
                raise serverless_exceptions.ArgumentError("Instance count value %s is not an integer or 'default'." % value)
            if self.instance_count < 0:
                raise serverless_exceptions.ArgumentError('Instance count value %s is negative.' % value)