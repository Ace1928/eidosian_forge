...
def conv3d_backprop_input_v2_eager_fallback(input_sizes: _atypes.TensorFuzzingAnnotation[TV_Conv3DBackpropInputV2_Tshape], filter: _atypes.TensorFuzzingAnnotation[TV_Conv3DBackpropInputV2_T], out_backprop: _atypes.TensorFuzzingAnnotation[TV_Conv3DBackpropInputV2_T], strides, padding: str, data_format: str, dilations, name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_Conv3DBackpropInputV2_T]:
    ...
    _attrs = ('T', _attr_T, 'strides', strides, 'padding', padding, 'data_format', data_format, 'dilations', dilations, 'Tshape', _attr_Tshape)
    _result = _execute.execute(b'Conv3DBackpropInputV2', 1, inputs=_inputs_flat, attrs=_attrs, ctx=ctx, name=name)
