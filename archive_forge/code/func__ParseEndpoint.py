...
def _ParseEndpoint(endpoint_id, region_ref):
    ...
    return resources.REGISTRY.Parse(endpoint_id, params={'locationsId': region, 'projectsId': properties.VALUES.core.project.GetOrFail}, collection='aiplatform.projects.locations.endpoints')