...
class IncrementalTextLayout(TextLayout, EventDispatcher):
    ...
    def __init__(self, document: AbstractDocument, width: int, height: int, x: float=0, y: float=0, z: float=0, anchor_x: AnchorX='left', anchor_y: AnchorY='bottom', rotation: float=0, multiline: bool=False, dpi: Optional[float]=None, batch: Optional[Batch]=None, group: Optional[Group]=None, program: Optional[ShaderProgram]=None, wrap_lines: bool=True) -> None:
