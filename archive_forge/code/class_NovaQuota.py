...
class NovaQuota(resource.Resource):
    ...
    def handle_update(self, json_snippet, tmpl_diff, prop_diff):
        self._set_quota(json_snippet.properties(self.properties_schema, self.context))
    ...
    def validate(self):
        ...
        if sum((1 for p in self.properties.values() if p is not None)) <= 1:
            raise exception.PropertyUnspecifiedError(*sorted(set(self.PROPERTIES) - {self.PROJECT}))