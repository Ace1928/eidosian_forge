...
class FaultsClient(object):
    ...
    """
        describe_req = self.messages.FaultinjectiontestingProjectsLocationsFaultsGetRequest(name=fault)
    ...
    """
        delete_req = self.messages.FaultinjectiontestingProjectsLocationsFaultsDeleteRequest(name=fault)
    ...
    Returns:
      Fault.
    """
        create_req = api_lib_utils.ParseCreateFaultFromYaml(fault, faultconfig, parent)
    ...
    """
        list_req = self.messages.FaultinjectiontestingProjectsLocationsFaultsListRequest(parent=parent)
        return list_pager.YieldFromList(self._faults_client, list_req, field='faults', batch_size=page_size, limit=limit, batch_size_attribute='pageSize')