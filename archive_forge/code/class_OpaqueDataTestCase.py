...
class OpaqueDataTestCase(base.TestCase):
    ...
    def _create_data(self):
        return opaque_data.OpaqueData(self.data, self.name, self.created, consumers=self.consumers)
    ...
    def test_get_created_none(self):
        created = None
        data = opaque_data.OpaqueData(self.data, self.name, created, consumers=self.consumers)
