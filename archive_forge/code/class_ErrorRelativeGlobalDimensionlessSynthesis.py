...
class ErrorRelativeGlobalDimensionlessSynthesis(Metric):
    ...
    def __init__(self, ratio: float=4, reduction: Literal['elementwise_mean', 'sum', 'none', None]='elementwise_mean', **kwargs: Any) -> None:
        ...
        rank_zero_warn('Metric `UniversalImageQualityIndex` will save all targets and predictions in buffer. For large datasets this may lead to large memory footprint.')
