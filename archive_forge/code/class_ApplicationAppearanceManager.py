...
class ApplicationAppearanceManager(GetWithoutIdMixin, UpdateMixin, RESTManager):
    ...
    _update_attrs = RequiredOptional(optional=('title', 'description', 'logo', 'header_logo', 'favicon', 'new_project_guidelines', 'header_message', 'footer_message', 'message_background_color', 'message_font_color', 'email_header_and_footer_enabled'))
