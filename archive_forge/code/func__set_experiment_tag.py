...
def _set_experiment_tag():
    request_message = _get_request_message(SetExperimentTag(), schema={'experiment_id': [_assert_required, _assert_string], 'key': [_assert_required, _assert_string], 'value': [_assert_string]})
