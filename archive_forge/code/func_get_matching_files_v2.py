  ...
  **character range**:
  ...
  """
    if isinstance(pattern, six.string_types):
        ...
        return [compat.as_str_any(matching_filename) for single_filename in pattern for matching_filename in _pywrap_file_io.GetMatchingFiles(compat.as_bytes(single_filename))]