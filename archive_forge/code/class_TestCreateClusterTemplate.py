...
class TestCreateClusterTemplate(TestClusterTemplates):
    ...
    def setUp(self):
        ...
        self.ct_mock.create.return_value = api_ct.ClusterTemplate(None, CT_INFO)
        self.ngt_mock.find_unique.return_value = api_ngt.NodeGroupTemplate(None, CT_INFO['node_groups'][0])
