...
def test_format_initialize_on_transport_ex_force_new_repo_True(self):
    ...
    made_repo, control = self.assertInitializeEx(t.clone('branch'), force_new_repo=True, repo_format_name=repo_name)
    self.assertNotEqual(repo.controldir.root_transport.base, made_repo.controldir.root_transport.base)