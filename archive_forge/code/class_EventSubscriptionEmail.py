...
class EventSubscriptionEmail(object):
    ...
    def get_object_by_name(self, name):
        result = None
        try:
            items = self.dnac.exec(family='event_management', function='get_email_event_subscriptions', params=self.get_all_params(name=name))
    ...
    def create(self):
        result = self.dnac.exec(family='event_management', function='create_email_event_subscription', params=self.create_params(), op_modifies=True)
        return result
    ...
    def update(self):
        ...
        name = self.new_object.get('name') or requested_obj.get('name')
        result = None
        result = self.dnac.exec(family='event_management', function='update_email_event_subscription', params=self.update_all_params(), op_modifies=True)
        return result