...
class ShareInstanceTest(base.BaseSharedFileSystemTest):
    ...
    def test_list_share_instances(self):
        ...
        for share_instance in share_instances:
            for attribute in ('id', 'name', 'created_at', 'access_rules_status', 'availability_zone'):
    ...
    def test_delete(self):
        ...
        resource.wait_for_delete(self.operator_cloud.share, sot, wait=self._wait_for_timeout, interval=2)
