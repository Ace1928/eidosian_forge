...
class EndpointsClient(object):
    ...
    def __init__(self, client=None, messages=None, version=None):
        self.client = client or apis.GetClientInstance(constants.AI_PLATFORM_API_NAME, constants.AI_PLATFORM_API_VERSION[version])
        self.messages = messages or self.client.MESSAGES_MODULE

    def Create(self, location_ref, display_name, labels, description=None, network=None, endpoint_id=None, encryption_kms_key_name=None, request_response_logging_table=None, request_response_logging_rate=None):
    ...
    """
        ...
        if encryption_kms_key_name:
            encryption_spec = self.messages.GoogleCloudAiplatformV1EncryptionSpec(kmsKeyName=encryption_kms_key_name)
        endpoint = api_util.GetMessage('Endpoint', constants.GA_VERSION)(displayName=display_name, description=description, labels=labels, network=network, encryptionSpec=encryption_spec)
        if request_response_logging_table is not None:
            endpoint.predictRequestResponseLoggingConfig = api_util.GetMessage('PredictRequestResponseLoggingConfig', constants.GA_VERSION)(enabled=True, samplingRate=request_response_logging_rate if request_response_logging_rate else 0.0, bigqueryDestination=api_util.GetMessage('BigQueryDestination', constants.GA_VERSION)(outputUri=request_response_logging_table))
        req = self.messages.AiplatformProjectsLocationsEndpointsCreateRequest(parent=location_ref.RelativeName(), endpointId=endpoint_id, googleCloudAiplatformV1Endpoint=endpoint)
        return self.client.projects_locations_endpoints.Create(req)

    def CreateBeta(self, location_ref, display_name, labels, description=None, network=None, endpoint_id=None, encryption_kms_key_name=None, request_response_logging_table=None, request_response_logging_rate=None):
    ...
    """
        encryption_spec = None
        if encryption_kms_key_name:
            encryption_spec = self.messages.GoogleCloudAiplatformV1beta1EncryptionSpec(kmsKeyName=encryption_kms_key_name)
        endpoint = api_util.GetMessage('Endpoint', constants.BETA_VERSION)(displayName=display_name, description=description, labels=labels, network=network, encryptionSpec=encryption_spec)
        if request_response_logging_table is not None:
            endpoint.predictRequestResponseLoggingConfig = api_util.GetMessage('PredictRequestResponseLoggingConfig', constants.BETA_VERSION)(enabled=True, samplingRate=request_response_logging_rate if request_response_logging_rate else 0.0, bigqueryDestination=api_util.GetMessage('BigQueryDestination', constants.BETA_VERSION)(outputUri=request_response_logging_table))
        req = self.messages.AiplatformProjectsLocationsEndpointsCreateRequest(parent=location_ref.RelativeName(), endpointId=endpoint_id, googleCloudAiplatformV1beta1Endpoint=endpoint)
        return self.client.projects_locations_endpoints.Create(req)

    def Delete(self, endpoint_ref):
        """Deletes an existing endpoint."""
        req = self.messages.AiplatformProjectsLocationsEndpointsDeleteRequest(name=endpoint_ref.RelativeName())
        return self.client.projects_locations_endpoints.Delete(req)

    def Get(self, endpoint_ref):
        """Gets details about an endpoint."""
        req = self.messages.AiplatformProjectsLocationsEndpointsGetRequest(name=endpoint_ref.RelativeName())
        return self.client.projects_locations_endpoints.Get(req)

    def List(self, location_ref):
        """Lists endpoints in the project."""
        req = self.messages.AiplatformProjectsLocationsEndpointsListRequest(parent=location_ref.RelativeName())
        return list_pager.YieldFromList(self.client.projects_locations_endpoints, req, field='endpoints', batch_size_attribute='pageSize')

    def Patch(self, endpoint_ref, labels_update, display_name=None, description=None, traffic_split=None, clear_traffic_split=False, request_response_logging_table=None, request_response_logging_rate=None, disable_request_response_logging=False):
    ...
    """
        ...
        if traffic_split is not None:
            ...
            for key, value in sorted(traffic_split.items()):
                additional_properties.append(endpoint.TrafficSplitValue().AdditionalProperty(key=key, value=value))
            endpoint.trafficSplit = endpoint.TrafficSplitValue(additionalProperties=additional_properties)
        ...
        if request_response_logging_table is not None or request_response_logging_rate is not None:
            request_response_logging_config = self.Get(endpoint_ref).predictRequestResponseLoggingConfig
            if not request_response_logging_config:
                request_response_logging_config = api_util.GetMessage('PredictRequestResponseLoggingConfig', constants.GA_VERSION)()
            request_response_logging_config.enabled = True
            if request_response_logging_table is not None:
                request_response_logging_config.bigqueryDestination = api_util.GetMessage('BigQueryDestination', constants.GA_VERSION)(outputUri=request_response_logging_table)
        ...
        req = self.messages.AiplatformProjectsLocationsEndpointsPatchRequest(name=endpoint_ref.RelativeName(), googleCloudAiplatformV1Endpoint=endpoint, updateMask=','.join(update_mask))
        return self.client.projects_locations_endpoints.Patch(req)

    def PatchBeta(self, endpoint_ref, labels_update, display_name=None, description=None, traffic_split=None, clear_traffic_split=False, request_response_logging_table=None, request_response_logging_rate=None, disable_request_response_logging=False):
    ...
    """
        ...
        if request_response_logging_table is not None or request_response_logging_rate is not None:
            request_response_logging_config = self.Get(endpoint_ref).predictRequestResponseLoggingConfig
            if not request_response_logging_config:
                request_response_logging_config = api_util.GetMessage('PredictRequestResponseLoggingConfig', constants.BETA_VERSION)()
            request_response_logging_config.enabled = True
            if request_response_logging_table is not None:
                request_response_logging_config.bigqueryDestination = api_util.GetMessage('BigQueryDestination', constants.BETA_VERSION)(outputUri=request_response_logging_table)
            if request_response_logging_rate is not None:
                request_response_logging_config.samplingRate = request_response_logging_rate
            endpoint.predictRequestResponseLoggingConfig = request_response_logging_config
            update_mask.append('predict_request_response_logging_config')
        ...
        if not update_mask:
            raise errors.NoFieldsSpecifiedError('No updates requested.')
        req = self.messages.AiplatformProjectsLocationsEndpointsPatchRequest(name=endpoint_ref.RelativeName(), googleCloudAiplatformV1beta1Endpoint=endpoint, updateMask=','.join(update_mask))
        return self.client.projects_locations_endpoints.Patch(req)

    def Predict(self, endpoint_ref, instances_json):
        """Sends online prediction request to an endpoint using v1 API."""
        predict_request = self.messages.GoogleCloudAiplatformV1PredictRequest(instances=_ConvertPyListToMessageList(extra_types.JsonValue, instances_json['instances']))
        ...
        req = self.messages.AiplatformProjectsLocationsEndpointsPredictRequest(endpoint=endpoint_ref.RelativeName(), googleCloudAiplatformV1PredictRequest=predict_request)
    ...
    def RawPredict(self, endpoint_ref, headers, request):
        ...
        url = '{}{}/{}:rawPredict'.format(self.client.url, getattr(self.client, '_VERSION'), endpoint_ref.RelativeName())
    ...
    def Explain(self, endpoint_ref, instances_json, args):
        ...
        explain_request = self.messages.GoogleCloudAiplatformV1ExplainRequest(instances=_ConvertPyListToMessageList(extra_types.JsonValue, instances_json['instances']))
        if 'parameters' in instances_json:
        ...
        req = self.messages.AiplatformProjectsLocationsEndpointsExplainRequest(endpoint=endpoint_ref.RelativeName(), googleCloudAiplatformV1ExplainRequest=explain_request)
    ...
    def DeployModel(self, endpoint_ref, model, region, display_name, machine_type=None, accelerator_dict=None, min_replica_count=None, max_replica_count=None, autoscaling_metric_specs=None, enable_access_logging=False, disable_container_logging=False, service_account=None, traffic_split=None, deployed_model_id=None):
    ...
    """
        ...
        if resource_type == 'DEDICATED_RESOURCES':
            ...
            accelerator = flags.ParseAcceleratorFlag(accelerator_dict, constants.GA_VERSION)
            if accelerator is not None:
                machine_spec.acceleratorType = accelerator.acceleratorType
                machine_spec.acceleratorCount = accelerator.acceleratorCount
            dedicated = self.messages.GoogleCloudAiplatformV1DedicatedResources(machineSpec=machine_spec)
            ...
            if autoscaling_metric_specs is not None:
                ...
                for name, target in sorted(autoscaling_metric_specs.items()):
                    autoscaling_metric_specs_list.append(self.messages.GoogleCloudAiplatformV1AutoscalingMetricSpec(metricName=constants.OP_AUTOSCALING_METRIC_NAME_MAPPER[name], target=target))
                dedicated.autoscalingMetricSpecs = autoscaling_metric_specs_list
            deployed_model = self.messages.GoogleCloudAiplatformV1DeployedModel(dedicatedResources=dedicated, displayName=display_name, model=model_ref.RelativeName())
        else:
            ...
            deployed_model = self.messages.GoogleCloudAiplatformV1DeployedModel(automaticResources=automatic, displayName=display_name, model=model_ref.RelativeName())
        ...
        deployed_model_req = self.messages.GoogleCloudAiplatformV1DeployModelRequest(deployedModel=deployed_model)
        if traffic_split is not None:
            additional_properties = []
            for key, value in sorted(traffic_split.items()):
        ...
        req = self.messages.AiplatformProjectsLocationsEndpointsDeployModelRequest(endpoint=endpoint_ref.RelativeName(), googleCloudAiplatformV1DeployModelRequest=deployed_model_req)
    ...
    """
        undeployed_model_req = self.messages.GoogleCloudAiplatformV1UndeployModelRequest(deployedModelId=deployed_model_id)
        if traffic_split is not None:
            additional_properties = []
            for key, value in sorted(traffic_split.items()):
        ...
        req = self.messages.AiplatformProjectsLocationsEndpointsUndeployModelRequest(endpoint=endpoint_ref.RelativeName(), googleCloudAiplatformV1UndeployModelRequest=undeployed_model_req)
