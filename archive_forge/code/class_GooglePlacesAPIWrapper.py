...
@deprecated(since='0.0.33', removal='0.2.0', alternative_import='langchain_google_community.GooglePlacesAPIWrapper')
class GooglePlacesAPIWrapper(BaseModel):
    ...
    def validate_environment(cls, values: Dict) -> Dict:
        ...
        try:
            ...
            raise ImportError('Could not import googlemaps python package. Please install it with `pip install googlemaps`.')
        return values
