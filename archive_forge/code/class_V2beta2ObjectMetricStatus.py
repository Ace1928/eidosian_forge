...
class V2beta2ObjectMetricStatus(object):
    ...
    swagger_types = {'current': 'V2beta2MetricValueStatus', 'described_object': 'V2beta2CrossVersionObjectReference', 'metric': 'V2beta2MetricIdentifier'}
    attribute_map = {'current': 'current', 'described_object': 'describedObject', 'metric': 'metric'}
