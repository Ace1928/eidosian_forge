...
class ZeroShotAgent(Agent):
    ...
    @classmethod
    def create_prompt(cls, tools: Sequence[BaseTool], prefix: str=PREFIX, suffix: str=SUFFIX, format_instructions: str=FORMAT_INSTRUCTIONS, input_variables: Optional[List[str]]=None) -> PromptTemplate:
    ...
    def from_llm_and_tools(cls, llm: BaseLanguageModel, tools: Sequence[BaseTool], callback_manager: Optional[BaseCallbackManager]=None, output_parser: Optional[AgentOutputParser]=None, prefix: str=PREFIX, suffix: str=SUFFIX, format_instructions: str=FORMAT_INSTRUCTIONS, input_variables: Optional[List[str]]=None, **kwargs: Any) -> Agent:
        ...
        prompt = cls.create_prompt(tools, prefix=prefix, suffix=suffix, format_instructions=format_instructions, input_variables=input_variables)
    ...
    def _validate_tools(cls, tools: Sequence[BaseTool]) -> None:
        ...
        for tool in tools:
            if tool.description is None:
                raise ValueError(f'Got a tool {tool.name} without a description. For this agent, a description must always be provided.')
