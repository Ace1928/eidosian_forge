...
class SimdJson:
    ...
    @staticmethod
    def dumps(obj: typing.Dict[typing.Any, typing.Any], *args, default: typing.Dict[typing.Any, typing.Any]=None, cls: typing.Type[json.JSONEncoder]=None, _fallback_method: typing.Optional[typing.Callable]=None, **kwargs) -> str:
        """
    ...
    @staticmethod
    def loads(data: typing.Union[str, bytes], *args, object_hook: typing.Optional[typing.Callable]=None, recursive: typing.Optional[bool]=True, _raw: typing.Optional[bool]=False, _fallback_method: typing.Optional[typing.Callable]=None, **kwargs) -> typing.Union[typing.Dict[typing.Any, typing.Any], typing.List[str], simdjson.Object, simdjson.Array]:
        """
