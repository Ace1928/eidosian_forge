...
def test_share_network_subnet_delete(self):
    self.verify_delete(self.proxy.delete_share_network_subnet, share_network_subnet.ShareNetworkSubnet, False, method_args=['fake_network_id', 'fake_sub_network_id'], expected_args=['fake_sub_network_id'], expected_kwargs={'share_network_id': 'fake_network_id'})