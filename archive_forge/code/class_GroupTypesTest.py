...
class GroupTypesTest(utils.TestCase):
    ...
    def test_create(self):
        ...
        cs.assert_called('POST', '/group_types', {'group_type': {'name': 'test-type-3', 'description': 'test-type-3-desc', 'is_public': True}})
        self.assertIsInstance(t, group_types.GroupType)
    ...
    def test_update(self):
        ...
        cs.assert_called('PUT', '/group_types/1', {'group_type': {'name': 'test_type_1', 'description': 'test_desc_1', 'is_public': False}})
        self.assertIsInstance(t, group_types.GroupType)
        self._assert_request_id(t)
    ...
    def test_set_key(self):
        t = cs.group_types.get(1)
        res = t.set_keys({'k': 'v'})
        cs.assert_called('POST', '/group_types/1/group_specs', {'group_specs': {'k': 'v'}})
