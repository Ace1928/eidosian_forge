...
class SpannerRestTransport(SpannerTransport):
    ...
    def __init__(self, *, host: str='spanner.googleapis.com', credentials: Optional[ga_credentials.Credentials]=None, credentials_file: Optional[str]=None, scopes: Optional[Sequence[str]]=None, client_cert_source_for_mtls: Optional[Callable[[], Tuple[bytes, bytes]]]=None, quota_project_id: Optional[str]=None, client_info: gapic_v1.client_info.ClientInfo=DEFAULT_CLIENT_INFO, always_use_jwt_access: Optional[bool]=False, url_scheme: str='https', interceptor: Optional[SpannerRestInterceptor]=None, api_audience: Optional[str]=None) -> None:
    ...
    class _BatchCreateSessions(SpannerRestStub):
        ...
        def __call__(self, request: spanner.BatchCreateSessionsRequest, *, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Optional[float]=None, metadata: Sequence[Tuple[str, str]]=()) -> spanner.BatchCreateSessionsResponse:
            """Call the batch create sessions method over HTTP.
            ...
            """
            http_options: List[Dict[str, str]] = [{'method': 'post', 'uri': '/v1/{database=projects/*/instances/*/databases/*}/sessions:batchCreate', 'body': '*'}]
    ...
    class _BatchWrite(SpannerRestStub):
        ...
        def __call__(self, request: spanner.BatchWriteRequest, *, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Optional[float]=None, metadata: Sequence[Tuple[str, str]]=()) -> rest_streaming.ResponseIterator:
            """Call the batch write method over HTTP.
            ...
            """
            http_options: List[Dict[str, str]] = [{'method': 'post', 'uri': '/v1/{session=projects/*/instances/*/databases/*/sessions/*}:batchWrite', 'body': '*'}]
    ...
    class _BeginTransaction(SpannerRestStub):
        ...
        def __call__(self, request: spanner.BeginTransactionRequest, *, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Optional[float]=None, metadata: Sequence[Tuple[str, str]]=()) -> transaction.Transaction:
            """Call the begin transaction method over HTTP.
            ...
            Returns:
                ~.transaction.Transaction:
                    A transaction.
            """
            http_options: List[Dict[str, str]] = [{'method': 'post', 'uri': '/v1/{session=projects/*/instances/*/databases/*/sessions/*}:beginTransaction', 'body': '*'}]
    ...
    class _Commit(SpannerRestStub):
        ...
        def __call__(self, request: spanner.CommitRequest, *, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Optional[float]=None, metadata: Sequence[Tuple[str, str]]=()) -> commit_response.CommitResponse:
            """Call the commit method over HTTP.
            ...
            """
            http_options: List[Dict[str, str]] = [{'method': 'post', 'uri': '/v1/{session=projects/*/instances/*/databases/*/sessions/*}:commit', 'body': '*'}]
    ...
    class _CreateSession(SpannerRestStub):
        ...
        def __call__(self, request: spanner.CreateSessionRequest, *, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Optional[float]=None, metadata: Sequence[Tuple[str, str]]=()) -> spanner.Session:
            """Call the create session method over HTTP.
            ...
            """
            http_options: List[Dict[str, str]] = [{'method': 'post', 'uri': '/v1/{database=projects/*/instances/*/databases/*}/sessions', 'body': '*'}]
    ...
    class _DeleteSession(SpannerRestStub):
        ...
        def __call__(self, request: spanner.DeleteSessionRequest, *, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Optional[float]=None, metadata: Sequence[Tuple[str, str]]=()):
            """Call the delete session method over HTTP.
            ...
            Args:
                ...
                metadata (Sequence[Tuple[str, str]]): Strings which should be
                    sent along with the request as metadata.
            """
            http_options: List[Dict[str, str]] = [{'method': 'delete', 'uri': '/v1/{name=projects/*/instances/*/databases/*/sessions/*}'}]
    ...
    class _ExecuteSql(SpannerRestStub):
        ...
        def __call__(self, request: spanner.ExecuteSqlRequest, *, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Optional[float]=None, metadata: Sequence[Tuple[str, str]]=()) -> result_set.ResultSet:
            """Call the execute sql method over HTTP.
            ...
            """
            http_options: List[Dict[str, str]] = [{'method': 'post', 'uri': '/v1/{session=projects/*/instances/*/databases/*/sessions/*}:executeSql', 'body': '*'}]
    ...
    class _GetSession(SpannerRestStub):
        ...
        def __call__(self, request: spanner.GetSessionRequest, *, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Optional[float]=None, metadata: Sequence[Tuple[str, str]]=()) -> spanner.Session:
            """Call the get session method over HTTP.
            ...
            Returns:
                ~.spanner.Session:
                    A session in the Cloud Spanner API.
            """
            http_options: List[Dict[str, str]] = [{'method': 'get', 'uri': '/v1/{name=projects/*/instances/*/databases/*/sessions/*}'}]
    ...
    class _PartitionQuery(SpannerRestStub):
        ...
        def __call__(self, request: spanner.PartitionQueryRequest, *, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Optional[float]=None, metadata: Sequence[Tuple[str, str]]=()) -> spanner.PartitionResponse:
            """Call the partition query method over HTTP.
            ...
            """
            http_options: List[Dict[str, str]] = [{'method': 'post', 'uri': '/v1/{session=projects/*/instances/*/databases/*/sessions/*}:partitionQuery', 'body': '*'}]
    ...
    class _PartitionRead(SpannerRestStub):
        ...
        def __call__(self, request: spanner.PartitionReadRequest, *, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Optional[float]=None, metadata: Sequence[Tuple[str, str]]=()) -> spanner.PartitionResponse:
            """Call the partition read method over HTTP.
            ...
            """
            http_options: List[Dict[str, str]] = [{'method': 'post', 'uri': '/v1/{session=projects/*/instances/*/databases/*/sessions/*}:partitionRead', 'body': '*'}]
    ...
    class _Read(SpannerRestStub):
        ...
        def __call__(self, request: spanner.ReadRequest, *, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Optional[float]=None, metadata: Sequence[Tuple[str, str]]=()) -> result_set.ResultSet:
            """Call the read method over HTTP.
            ...
            """
            http_options: List[Dict[str, str]] = [{'method': 'post', 'uri': '/v1/{session=projects/*/instances/*/databases/*/sessions/*}:read', 'body': '*'}]
    ...
    class _Rollback(SpannerRestStub):
        ...
        def __call__(self, request: spanner.RollbackRequest, *, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Optional[float]=None, metadata: Sequence[Tuple[str, str]]=()):
            """Call the rollback method over HTTP.
            ...
            Args:
                ...
                metadata (Sequence[Tuple[str, str]]): Strings which should be
                    sent along with the request as metadata.
            """
            http_options: List[Dict[str, str]] = [{'method': 'post', 'uri': '/v1/{session=projects/*/instances/*/databases/*/sessions/*}:rollback', 'body': '*'}]
    ...
    class _StreamingRead(SpannerRestStub):
        ...
        def __call__(self, request: spanner.ReadRequest, *, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Optional[float]=None, metadata: Sequence[Tuple[str, str]]=()) -> rest_streaming.ResponseIterator:
            """Call the streaming read method over HTTP.
            ...
            """
            http_options: List[Dict[str, str]] = [{'method': 'post', 'uri': '/v1/{session=projects/*/instances/*/databases/*/sessions/*}:streamingRead', 'body': '*'}]
    ...
    @property
    def batch_create_sessions(self) -> Callable[[spanner.BatchCreateSessionsRequest], spanner.BatchCreateSessionsResponse]:
        return self._BatchCreateSessions(self._session, self._host, self._interceptor)

    @property
    def batch_write(self) -> Callable[[spanner.BatchWriteRequest], spanner.BatchWriteResponse]:
        return self._BatchWrite(self._session, self._host, self._interceptor)

    @property
    def begin_transaction(self) -> Callable[[spanner.BeginTransactionRequest], transaction.Transaction]:
        return self._BeginTransaction(self._session, self._host, self._interceptor)

    @property
    def commit(self) -> Callable[[spanner.CommitRequest], commit_response.CommitResponse]:
        return self._Commit(self._session, self._host, self._interceptor)

    @property
    def create_session(self) -> Callable[[spanner.CreateSessionRequest], spanner.Session]:
        return self._CreateSession(self._session, self._host, self._interceptor)

    @property
    def delete_session(self) -> Callable[[spanner.DeleteSessionRequest], empty_pb2.Empty]:
        return self._DeleteSession(self._session, self._host, self._interceptor)

    @property
    def execute_batch_dml(self) -> Callable[[spanner.ExecuteBatchDmlRequest], spanner.ExecuteBatchDmlResponse]:
        return self._ExecuteBatchDml(self._session, self._host, self._interceptor)

    @property
    def execute_sql(self) -> Callable[[spanner.ExecuteSqlRequest], result_set.ResultSet]:
        return self._ExecuteSql(self._session, self._host, self._interceptor)

    @property
    def execute_streaming_sql(self) -> Callable[[spanner.ExecuteSqlRequest], result_set.PartialResultSet]:
        return self._ExecuteStreamingSql(self._session, self._host, self._interceptor)

    @property
    def get_session(self) -> Callable[[spanner.GetSessionRequest], spanner.Session]:
        return self._GetSession(self._session, self._host, self._interceptor)

    @property
    def list_sessions(self) -> Callable[[spanner.ListSessionsRequest], spanner.ListSessionsResponse]:
        return self._ListSessions(self._session, self._host, self._interceptor)

    @property
    def partition_query(self) -> Callable[[spanner.PartitionQueryRequest], spanner.PartitionResponse]:
        return self._PartitionQuery(self._session, self._host, self._interceptor)

    @property
    def partition_read(self) -> Callable[[spanner.PartitionReadRequest], spanner.PartitionResponse]:
        return self._PartitionRead(self._session, self._host, self._interceptor)

    @property
    def read(self) -> Callable[[spanner.ReadRequest], result_set.ResultSet]:
        return self._Read(self._session, self._host, self._interceptor)
    ...
    @property
    def streaming_read(self) -> Callable[[spanner.ReadRequest], result_set.PartialResultSet]:
        return self._StreamingRead(self._session, self._host, self._interceptor)
