...
def construct_parallelepiped():
    ...
    vertex_data = GeomVertexData('parallelepiped_vertices_and_colors', vertex_format, Geom.UHStatic)
    vertex_writer = GeomVertexWriter(vertex_data, 'vertex')
    color_writer = GeomVertexWriter(vertex_data, 'color')
    vertices = np.array([[0, 0, 0], [2, 0, 0], [2, 1, 0], [0, 1, 0], [0.5, 0, 1], [2.5, 0, 1], [2.5, 1, 1], [0.5, 1, 1]], dtype=np.float32)
