...
def test_type_extra_specs_delete(self):
    self._verify('openstack.block_storage.v3.type.Type.delete_extra_specs', self.proxy.delete_type_extra_specs, expected_result=None, method_args=['value', 'key'], expected_args=[self.proxy, 'key'])