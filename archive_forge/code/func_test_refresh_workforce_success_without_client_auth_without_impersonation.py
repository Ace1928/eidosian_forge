...
def test_refresh_workforce_success_without_client_auth_without_impersonation(self):
    credentials = self.make_credentials(audience=WORKFORCE_AUDIENCE, subject_token_type=WORKFORCE_SUBJECT_TOKEN_TYPE, client_id=None, client_secret=None, credential_source=self.CREDENTIAL_SOURCE_TEXT, scopes=SCOPES, workforce_pool_user_project=WORKFORCE_POOL_USER_PROJECT)
