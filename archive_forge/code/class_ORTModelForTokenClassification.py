...
class ORTModelForTokenClassification(ORTModel):
    ...
    @add_start_docstrings_to_model_forward(ONNX_TEXT_INPUTS_DOCSTRING.format('batch_size, sequence_length') + TOKEN_CLASSIFICATION_EXAMPLE.format(processor_class=_TOKENIZER_FOR_DOC, model_class='ORTModelForTokenClassification', checkpoint='optimum/bert-base-NER'))
