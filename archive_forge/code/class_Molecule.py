...
class Molecule(BatchableMedia):
    ...
    def __init__(self, data_or_path: Union[str, 'TextIO'], caption: Optional[str]=None, **kwargs: str) -> None:
        super().__init__()
    ...
    @classmethod
    def seq_to_json(cls: Type['Molecule'], seq: Sequence['BatchableMedia'], run: 'LocalRun', key: str, step: Union[int, str]) -> dict:
        seq = list(seq)
