...
class V1beta1CertificateSigningRequestCondition(object):
    ...
    swagger_types = {'last_update_time': 'datetime', 'message': 'str', 'reason': 'str', 'type': 'str'}
    attribute_map = {'last_update_time': 'lastUpdateTime', 'message': 'message', 'reason': 'reason', 'type': 'type'}
