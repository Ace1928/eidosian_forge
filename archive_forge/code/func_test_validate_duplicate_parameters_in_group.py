...
def test_validate_duplicate_parameters_in_group(self):
    ...
    self.assertEqual(_('Parameter Groups error: parameter_groups.Database Group: The InstanceType parameter must be assigned to one parameter group only.'), str(exc))