...
class SubscriberServiceClient(metaclass=SubscriberServiceClientMeta):
    ...
    def __init__(self, *, credentials: Optional[ga_credentials.Credentials]=None, transport: Optional[Union[str, SubscriberServiceTransport]]=None, client_options: Optional[Union[client_options_lib.ClientOptions, dict]]=None, client_info: gapic_v1.client_info.ClientInfo=DEFAULT_CLIENT_INFO) -> None:
    ...
    def subscribe(self, requests: Optional[Iterator[subscriber.SubscribeRequest]]=None, *, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> Iterable[subscriber.SubscribeResponse]:
