...
class Shortcut:
    ...
    def load(self, filename):
        ...
        """
        self._base.QueryInterface(pythoncom.IID_IPersistFile).Load(os.path.abspath(filename))
    ...
    def save(self, filename):
        ...
        """
        self._base.QueryInterface(pythoncom.IID_IPersistFile).Save(os.path.abspath(filename), 0)
