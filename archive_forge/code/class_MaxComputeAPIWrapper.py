...
class MaxComputeAPIWrapper:
    ...
    @classmethod
    def from_params(cls, endpoint: str, project: str, *, access_id: Optional[str]=None, secret_access_key: Optional[str]=None) -> MaxComputeAPIWrapper:
        ...
        try:
            ...
            raise ImportError('Could not import pyodps python package. Please install it with `pip install pyodps` or refer to https://pyodps.readthedocs.io/.') from ex
        ...
        client = ODPS(access_id=access_id, secret_access_key=secret_access_key, project=project, endpoint=endpoint)
