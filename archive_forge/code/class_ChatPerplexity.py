...
class ChatPerplexity(BaseChatModel):
    ...
    def build_extra(cls, values: Dict[str, Any]) -> Dict[str, Any]:
        ...
        for field_name in list(values):
            ...
            if field_name not in all_required_field_names:
                logger.warning(f'WARNING! {field_name} is not a default parameter.\n                    {field_name} was transferred to model_kwargs.\n                    Please confirm that {field_name} is what you intended.')
    ...
    def validate_environment(cls, values: Dict) -> Dict:
        ...
        try:
            values['client'] = openai.OpenAI(api_key=values['pplx_api_key'], base_url='https://api.perplexity.ai')
    ...
    def _generate(self, messages: List[BaseMessage], stop: Optional[List[str]]=None, run_manager: Optional[CallbackManagerForLLMRun]=None, **kwargs: Any) -> ChatResult:
        ...
        message_dicts, params = self._create_message_dicts(messages, stop)
        params = {**params, **kwargs}
        response = self.client.chat.completions.create(model=params['model'], messages=message_dicts)
    ...
    def _invocation_params(self) -> Mapping[str, Any]:
        ...
        pplx_creds: Dict[str, Any] = {'api_key': self.pplx_api_key, 'api_base': 'https://api.perplexity.ai', 'model': self.model}
