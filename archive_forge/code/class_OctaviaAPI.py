...
class OctaviaAPI(api.BaseAPI):
    ...
    def pool_list(self, **kwargs):
        ...
        response = self._list(url, get_all=True, resources=const.POOL_RESOURCES, **kwargs)
        return response
    ...
    def flavor_list(self, **kwargs):
        ...
        response = self._list(path=url, get_all=True, resources=const.FLAVOR_RESOURCES, **kwargs)
        return response
    ...
    def flavorprofile_list(self, **kwargs):
        ...
        """
        url = const.BASE_FLAVORPROFILE_URL
        response = self._list(url, get_all=True, resources=const.FLAVORPROFILE_RESOURCES, **kwargs)
        return response
    ...
    def availabilityzone_show(self, availabilityzone_name):
        ...
        """
        response = self._find(path=const.BASE_AVAILABILITYZONE_URL, value=availabilityzone_name)
        return response
