...
class TestBzrDirOpen(TestRemote):
    ...
    def test_absent(self):
        ...
        self.assertRaises(errors.NotBranchError, RemoteBzrDir, transport, RemoteBzrDirFormat(), _client=client, _force_probe=True)
        self.assertFinished(client)

    def test_present_without_workingtree(self):
        client, transport = self.make_fake_client_and_transport()
        client.add_expected_call(b'BzrDir.open_2.1', (b'quack/',), b'success', (b'yes', b'no'))
    ...
    def test_present_with_workingtree(self):
        client, transport = self.make_fake_client_and_transport()
        client.add_expected_call(b'BzrDir.open_2.1', (b'quack/',), b'success', (b'yes', b'yes'))
        bd = RemoteBzrDir(transport, RemoteBzrDirFormat(), _client=client, _force_probe=True)
        self.assertIsInstance(bd, RemoteBzrDir)
