...
class ImputeParams(VegaLiteSchema):
    ...
    def __init__(self, frame: Union[Sequence[Union[None, float]], UndefinedType]=Undefined, keyvals: Union[dict, 'SchemaBase', Sequence[Any], UndefinedType]=Undefined, method: Union['SchemaBase', Literal['value', 'median', 'max', 'min', 'mean'], UndefinedType]=Undefined, value: Union[Any, UndefinedType]=Undefined, **kwds):
        super(ImputeParams, self).__init__(frame=frame, keyvals=keyvals, method=method, value=value, **kwds)