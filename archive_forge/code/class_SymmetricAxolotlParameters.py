class SymmetricAxolotlParameters:
    ...
    def __init__(self, ourBaseKey, ourRatchetKey, ourIdentityKey, theirBaseKey, theirRatchetKey, theirIdentityKey):
        """
        ...
        if ourBaseKey is None or ourIdentityKey is None or ourRatchetKey is None or (theirRatchetKey is None) or (theirIdentityKey is None) or (theirBaseKey is None):
    ...
    class Builder:
        ...
        def create(self):
            return SymmetricAxolotlParameters(self.ourBaseKey, self.ourRatchetKey, self.ourIdentityKey, self.theirBaseKey, self.theirRatchetKey, self.theirIdentityKey)