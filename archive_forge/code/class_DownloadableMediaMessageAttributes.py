...
class DownloadableMediaMessageAttributes(MediaAttributes):
    ...
    def __str__(self):
        return '[url=%s, mimetype=%s, file_length=%d, file_sha256=%s, media_key=%s]' % (self.url, self.mimetype, self.file_length, base64.b64encode(self.file_sha256) if self.file_sha256 else None, base64.b64encode(self.media_key) if self.media_key else None)
    ...
    @staticmethod
    def from_file(filepath, mimetype=None, file_length=None, file_sha256=None, url=None, media_key=None, context_info=None):
        ...
        return DownloadableMediaMessageAttributes(mimetype, file_length, file_sha256, url, media_key, context_info)