...
class V2beta1ResourceMetricStatus(object):
    ...
    swagger_types = {'current_average_utilization': 'int', 'current_average_value': 'str', 'name': 'str'}
    attribute_map = {'current_average_utilization': 'currentAverageUtilization', 'current_average_value': 'currentAverageValue', 'name': 'name'}
