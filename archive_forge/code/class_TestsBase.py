...
class TestsBase(TestCase):
    ...
    def make_qpd_engine(self) -> QPDEngine:
        raise NotImplementedError

    def to_native_df(self, data: Any, columns: Any) -> Any:
        raise NotImplementedError

    def to_pandas_df(self, df: DataFrame) -> pd.DataFrame:
        raise NotImplementedError
    ...
    def assert_eq(self, dfs: Dict[str, Any], sql: str, expected: Any=None, expected_cols: Any=None) -> None:
