...
def _set_registered_model_tag():
    request_message = _get_request_message(SetRegisteredModelTag(), schema={'name': [_assert_string, _assert_required], 'key': [_assert_string, _assert_required], 'value': [_assert_string]})
