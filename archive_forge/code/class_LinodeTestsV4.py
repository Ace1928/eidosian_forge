...
class LinodeTestsV4(unittest.TestCase, TestCaseMixin):
    ...
    def test_create_node_response(self):
        ...
        node = self.driver.create_node(location=location, name='node-name', image=image, root_pass='test123456', size=size)
    ...
    def test_create_node(self):
        ...
        size = self.driver.list_sizes()[0]
        location = self.driver.list_locations()[0]
        node = self.driver.create_node(location, size, image=image, name='TestNode', root_pass='test123456', ex_backups_enabled=True, ex_tags=['testing123'], ex_private_ip=True)
