...
class TestDataBeanMachine:
    ...
    def data(self, eight_schools_params, draws, chains):
        ...
        class Data:
            model, prior, obj = load_cached_models(eight_schools_params, draws, chains, 'beanmachine')['beanmachine']
        return Data
    ...
    def get_inference_data(self, eight_schools_params, predictions_data):
        ...
        return from_beanmachine(sampler=predictions, coords={'school': np.arange(eight_schools_params['J']), 'school_pred': np.arange(eight_schools_params['J'])})
