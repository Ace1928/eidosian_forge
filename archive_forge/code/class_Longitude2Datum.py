...
class Longitude2Datum(DatumChannelMixin, core.DatumDef):
    ...
    def __init__(self, datum, bandPosition: Union[float, UndefinedType]=Undefined, title: Union[str, None, Sequence[str], core.SchemaBase, UndefinedType]=Undefined, type: Union[core.SchemaBase, Literal['quantitative', 'ordinal', 'temporal', 'nominal', 'geojson'], UndefinedType]=Undefined, **kwds):
        super(Longitude2Datum, self).__init__(datum=datum, bandPosition=bandPosition, title=title, type=type, **kwds)