...
class XataVectorStore(VectorStore):
    ...
    def __init__(self, api_key: str, db_url: str, embedding: Embeddings, table_name: str) -> None:
    ...
    def add_vectors(self, vectors: List[List[float]], documents: List[Document], ids: Optional[List[str]]=None) -> List[str]:
        return self._add_vectors(vectors, documents, ids)

    def add_texts(self, texts: Iterable[str], metadatas: Optional[List[Dict[Any, Any]]]=None, ids: Optional[List[str]]=None, **kwargs: Any) -> List[str]:
        ids = ids
        docs = self._texts_to_documents(texts, metadatas)
        vectors = self._embedding.embed_documents(list(texts))
        return self.add_vectors(vectors, docs, ids)

    def _add_vectors(self, vectors: List[List[float]], documents: List[Document], ids: Optional[List[str]]=None) -> List[str]:
    ...
    @classmethod
    def from_texts(cls: Type['XataVectorStore'], texts: List[str], embedding: Embeddings, metadatas: Optional[List[dict]]=None, api_key: Optional[str]=None, db_url: Optional[str]=None, table_name: str='vectors', ids: Optional[List[str]]=None, **kwargs: Any) -> 'XataVectorStore':
        ...
        vector_db = cls(api_key=api_key, db_url=db_url, embedding=embedding, table_name=table_name)
    ...
    def similarity_search_with_score(self, query: str, k: int=4, filter: Optional[dict]=None, **kwargs: Any) -> List[Tuple[Document, float]]:
        ...
        hits = r['records']
        docs_and_scores = [(Document(page_content=hit['content'], metadata=self._extractMetadata(hit)), hit['xata']['score']) for hit in hits]
    ...
    def delete(self, ids: Optional[List[str]]=None, delete_all: Optional[bool]=None, **kwargs: Any) -> None:
