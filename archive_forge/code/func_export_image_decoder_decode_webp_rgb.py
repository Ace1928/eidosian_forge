...
def export_image_decoder_decode_webp_rgb() -> None:
    ...
    data, output = _generate_test_data('webp', _image_decoder_data.image_decoder_decode_webp_rgb, 'RGB')
    expect(node, inputs=[data], outputs=[output], name='test_image_decoder_decode_webp_rgb')