...
def qplot(x: Optional[str | Iterable[Any] | range]=None, y: Optional[str | Iterable[Any] | range]=None, data: Optional[DataLike]=None, facets: str='', margins: bool | list[str]=False, geom: str | list[str] | tuple[str]='auto', xlim: Optional[TupleFloat2]=None, ylim: Optional[TupleFloat2]=None, log: Optional[Literal['x', 'y', 'xy']]=None, main: Optional[str]=None, xlab: Optional[str]=None, ylab: Optional[str]=None, asp: Optional[float]=None, **kwargs: Any) -> ggplot:
    """
    Quick plot
