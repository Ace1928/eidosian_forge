...
class CloudassetV1(base_api.BaseApiClient):
    ...
    def __init__(self, url='', credentials=None, get_credentials=True, http=None, model=None, log_request=False, log_response=False, credentials_args=None, default_global_params=None, additional_http_headers=None, response_encoding=None):
        ...
        super(CloudassetV1, self).__init__(url, credentials=credentials, get_credentials=get_credentials, http=http, model=model, log_request=log_request, log_response=log_response, credentials_args=credentials_args, default_global_params=default_global_params, additional_http_headers=additional_http_headers, response_encoding=response_encoding)
    ...
    class AssetsService(base_api.BaseApiService):
      ...
      """
        ...
        List.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1/{v1Id}/{v1Id1}/assets', http_method='GET', method_id='cloudasset.assets.list', ordered_params=['parent'], path_params=['parent'], query_params=['assetTypes', 'contentType', 'pageSize', 'pageToken', 'readTime', 'relationshipTypes'], relative_path='v1/{+parent}/assets', request_field='', request_type_name='CloudassetAssetsListRequest', response_type_name='ListAssetsResponse', supports_download=False)
    ...
    class FeedsService(base_api.BaseApiService):
      ...
      """
            ...
            return self._RunMethod(config, request, global_params=global_params)
        Create.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1/{v1Id}/{v1Id1}/feeds', http_method='POST', method_id='cloudasset.feeds.create', ordered_params=['parent'], path_params=['parent'], query_params=[], relative_path='v1/{+parent}/feeds', request_field='createFeedRequest', request_type_name='CloudassetFeedsCreateRequest', response_type_name='Feed', supports_download=False)
      ...
      """
            ...
            return self._RunMethod(config, request, global_params=global_params)
        Delete.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1/{v1Id}/{v1Id1}/feeds/{feedsId}', http_method='DELETE', method_id='cloudasset.feeds.delete', ordered_params=['name'], path_params=['name'], query_params=[], relative_path='v1/{+name}', request_field='', request_type_name='CloudassetFeedsDeleteRequest', response_type_name='Empty', supports_download=False)
      ...
      """
            ...
            return self._RunMethod(config, request, global_params=global_params)
        Get.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1/{v1Id}/{v1Id1}/feeds/{feedsId}', http_method='GET', method_id='cloudasset.feeds.get', ordered_params=['name'], path_params=['name'], query_params=[], relative_path='v1/{+name}', request_field='', request_type_name='CloudassetFeedsGetRequest', response_type_name='Feed', supports_download=False)
      ...
      """
            config = self.GetMethodConfig('List')
            return self._RunMethod(config, request, global_params=global_params)
        List.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1/{v1Id}/{v1Id1}/feeds', http_method='GET', method_id='cloudasset.feeds.list', ordered_params=['parent'], path_params=['parent'], query_params=[], relative_path='v1/{+parent}/feeds', request_field='', request_type_name='CloudassetFeedsListRequest', response_type_name='ListFeedsResponse', supports_download=False)
      ...
      """
            ...
            return self._RunMethod(config, request, global_params=global_params)
        Patch.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1/{v1Id}/{v1Id1}/feeds/{feedsId}', http_method='PATCH', method_id='cloudasset.feeds.patch', ordered_params=['name'], path_params=['name'], query_params=[], relative_path='v1/{+name}', request_field='updateFeedRequest', request_type_name='CloudassetFeedsPatchRequest', response_type_name='Feed', supports_download=False)
    ...
    class OperationsService(base_api.BaseApiService):
      ...
      """
            config = self.GetMethodConfig('Get')
            return self._RunMethod(config, request, global_params=global_params)
        Get.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1/{v1Id}/{v1Id1}/operations/{operationsId}/{operationsId1}', http_method='GET', method_id='cloudasset.operations.get', ordered_params=['name'], path_params=['name'], query_params=[], relative_path='v1/{+name}', request_field='', request_type_name='CloudassetOperationsGetRequest', response_type_name='Operation', supports_download=False)
    ...
    class V1Service(base_api.BaseApiService):
      ...
      """
            ...
            return self._RunMethod(config, request, global_params=global_params)
        AnalyzeIamPolicy.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1/{v1Id}/{v1Id1}:analyzeIamPolicy', http_method='GET', method_id='cloudasset.analyzeIamPolicy', ordered_params=['scope'], path_params=['scope'], query_params=['analysisQuery_accessSelector_permissions', 'analysisQuery_accessSelector_roles', 'analysisQuery_conditionContext_accessTime', 'analysisQuery_identitySelector_identity', 'analysisQuery_options_analyzeServiceAccountImpersonation', 'analysisQuery_options_expandGroups', 'analysisQuery_options_expandResources', 'analysisQuery_options_expandRoles', 'analysisQuery_options_includeDenyPolicyAnalysis', 'analysisQuery_options_outputGroupEdges', 'analysisQuery_options_outputResourceEdges', 'analysisQuery_resourceSelector_fullResourceName', 'executionTimeout', 'savedAnalysisQuery'], relative_path='v1/{+scope}:analyzeIamPolicy', request_field='', request_type_name='CloudassetAnalyzeIamPolicyRequest', response_type_name='AnalyzeIamPolicyResponse', supports_download=False)
      ...
      """
            ...
            return self._RunMethod(config, request, global_params=global_params)
        AnalyzeIamPolicyLongrunning.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1/{v1Id}/{v1Id1}:analyzeIamPolicyLongrunning', http_method='POST', method_id='cloudasset.analyzeIamPolicyLongrunning', ordered_params=['scope'], path_params=['scope'], query_params=[], relative_path='v1/{+scope}:analyzeIamPolicyLongrunning', request_field='analyzeIamPolicyLongrunningRequest', request_type_name='CloudassetAnalyzeIamPolicyLongrunningRequest', response_type_name='Operation', supports_download=False)
      ...
      """
            ...
            return self._RunMethod(config, request, global_params=global_params)
        AnalyzeMove.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1/{v1Id}/{v1Id1}:analyzeMove', http_method='GET', method_id='cloudasset.analyzeMove', ordered_params=['resource'], path_params=['resource'], query_params=['destinationParent', 'view'], relative_path='v1/{+resource}:analyzeMove', request_field='', request_type_name='CloudassetAnalyzeMoveRequest', response_type_name='AnalyzeMoveResponse', supports_download=False)
      ...
      """
            ...
            return self._RunMethod(config, request, global_params=global_params)
        AnalyzeOrgPolicies.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1/{v1Id}/{v1Id1}:analyzeOrgPolicies', http_method='GET', method_id='cloudasset.analyzeOrgPolicies', ordered_params=['scope'], path_params=['scope'], query_params=['constraint', 'filter', 'pageSize', 'pageToken'], relative_path='v1/{+scope}:analyzeOrgPolicies', request_field='', request_type_name='CloudassetAnalyzeOrgPoliciesRequest', response_type_name='AnalyzeOrgPoliciesResponse', supports_download=False)
      ...
      """
            ...
            return self._RunMethod(config, request, global_params=global_params)
        AnalyzeOrgPolicyGovernedAssets.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1/{v1Id}/{v1Id1}:analyzeOrgPolicyGovernedAssets', http_method='GET', method_id='cloudasset.analyzeOrgPolicyGovernedAssets', ordered_params=['scope'], path_params=['scope'], query_params=['constraint', 'filter', 'pageSize', 'pageToken'], relative_path='v1/{+scope}:analyzeOrgPolicyGovernedAssets', request_field='', request_type_name='CloudassetAnalyzeOrgPolicyGovernedAssetsRequest', response_type_name='AnalyzeOrgPolicyGovernedAssetsResponse', supports_download=False)
      ...
      """
            ...
            return self._RunMethod(config, request, global_params=global_params)
        AnalyzeOrgPolicyGovernedContainers.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1/{v1Id}/{v1Id1}:analyzeOrgPolicyGovernedContainers', http_method='GET', method_id='cloudasset.analyzeOrgPolicyGovernedContainers', ordered_params=['scope'], path_params=['scope'], query_params=['constraint', 'filter', 'pageSize', 'pageToken'], relative_path='v1/{+scope}:analyzeOrgPolicyGovernedContainers', request_field='', request_type_name='CloudassetAnalyzeOrgPolicyGovernedContainersRequest', response_type_name='AnalyzeOrgPolicyGovernedContainersResponse', supports_download=False)
      ...
      """
            ...
            return self._RunMethod(config, request, global_params=global_params)
        AnalyzeOrgPolicyGovernedResources.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1/{v1Id}/{v1Id1}:analyzeOrgPolicyGovernedResources', http_method='GET', method_id='cloudasset.analyzeOrgPolicyGovernedResources', ordered_params=['scope'], path_params=['scope'], query_params=['constraint', 'filter', 'pageSize', 'pageToken'], relative_path='v1/{+scope}:analyzeOrgPolicyGovernedResources', request_field='', request_type_name='CloudassetAnalyzeOrgPolicyGovernedResourcesRequest', response_type_name='AnalyzeOrgPolicyGovernedResourcesResponse', supports_download=False)
      ...
      """
            ...
            return self._RunMethod(config, request, global_params=global_params)
        BatchGetAssetsHistory.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1/{v1Id}/{v1Id1}:batchGetAssetsHistory', http_method='GET', method_id='cloudasset.batchGetAssetsHistory', ordered_params=['parent'], path_params=['parent'], query_params=['assetNames', 'contentType', 'readTimeWindow_endTime', 'readTimeWindow_startTime', 'relationshipTypes'], relative_path='v1/{+parent}:batchGetAssetsHistory', request_field='', request_type_name='CloudassetBatchGetAssetsHistoryRequest', response_type_name='BatchGetAssetsHistoryResponse', supports_download=False)
      ...
      """
            ...
            return self._RunMethod(config, request, global_params=global_params)
        ExportAssets.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1/{v1Id}/{v1Id1}:exportAssets', http_method='POST', method_id='cloudasset.exportAssets', ordered_params=['parent'], path_params=['parent'], query_params=[], relative_path='v1/{+parent}:exportAssets', request_field='exportAssetsRequest', request_type_name='CloudassetExportAssetsRequest', response_type_name='Operation', supports_download=False)
      ...
      """
            ...
            return self._RunMethod(config, request, global_params=global_params)
        IngestAsset.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1/{v1Id}/{v1Id1}:ingestAsset', http_method='POST', method_id='cloudasset.ingestAsset', ordered_params=['closestCrmAncestor'], path_params=['closestCrmAncestor'], query_params=[], relative_path='v1/{+closestCrmAncestor}:ingestAsset', request_field='ingestAssetRequest', request_type_name='CloudassetIngestAssetRequest', response_type_name='IngestAssetResponse', supports_download=False)
      ...
      """
            ...
            return self._RunMethod(config, request, global_params=global_params)
        QueryAssets.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1/{v1Id}/{v1Id1}:queryAssets', http_method='POST', method_id='cloudasset.queryAssets', ordered_params=['parent'], path_params=['parent'], query_params=[], relative_path='v1/{+parent}:queryAssets', request_field='queryAssetsRequest', request_type_name='CloudassetQueryAssetsRequest', response_type_name='QueryAssetsResponse', supports_download=False)
      ...
      """
            ...
            return self._RunMethod(config, request, global_params=global_params)
        SearchAllIamPolicies.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1/{v1Id}/{v1Id1}:searchAllIamPolicies', http_method='GET', method_id='cloudasset.searchAllIamPolicies', ordered_params=['scope'], path_params=['scope'], query_params=['assetTypes', 'orderBy', 'pageSize', 'pageToken', 'query'], relative_path='v1/{+scope}:searchAllIamPolicies', request_field='', request_type_name='CloudassetSearchAllIamPoliciesRequest', response_type_name='SearchAllIamPoliciesResponse', supports_download=False)
      ...
      """
            ...
            return self._RunMethod(config, request, global_params=global_params)
        SearchAllResources.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1/{v1Id}/{v1Id1}:searchAllResources', http_method='GET', method_id='cloudasset.searchAllResources', ordered_params=['scope'], path_params=['scope'], query_params=['assetTypes', 'orderBy', 'pageSize', 'pageToken', 'query', 'readMask'], relative_path='v1/{+scope}:searchAllResources', request_field='', request_type_name='CloudassetSearchAllResourcesRequest', response_type_name='SearchAllResourcesResponse', supports_download=False)