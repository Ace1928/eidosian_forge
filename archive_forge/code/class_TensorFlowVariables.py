...
class TensorFlowVariables:
    ...
    def __init__(self, output, sess=None, input_variables=None):
        ...
        variable_list = [v for v in tf1.global_variables() if v.op.node_def.name in variable_names]
        ...
        if not tf1.executing_eagerly():
            ...
            for k, var in self.variables.items():
                self.placeholders[k] = tf1.placeholder(var.value().dtype, var.get_shape().as_list(), name='Placeholder_' + k)
