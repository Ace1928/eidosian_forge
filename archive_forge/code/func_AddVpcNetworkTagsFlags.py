...
def AddVpcNetworkTagsFlags(parser, resource_kind='service'):
    ...
    parser.add_argument('--network-tags', metavar='TAG', type=arg_parsers.ArgList(), action=arg_parsers.UpdateAction, help='Applies the given Compute Engine tags (comma separated) to the Cloud Run {kind}. To clear existing tags, use --clear-network-tags.'.format(kind=resource_kind))