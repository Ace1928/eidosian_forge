  ...
  """
    ...
    if deploy_policy_ids:
        for policy in deploy_policy_ids:
            deploy_policy_resource_ref = resources.REGISTRY.Parse(policy, collection='clouddeploy.projects.locations.deployPolicies', params={'projectsId': project_id, 'locationsId': location_id, 'deployPoliciesId': policy})
