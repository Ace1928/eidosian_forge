...
class CodeGenerator(ast.NodeVisitor):
    ...
    def __init__(self, context, prototype, gscope, attributes, constants, function_name, target, module=None, is_kernel=False, function_types: Optional[Dict]=None, debug=False, noinline=False, file_name: Optional[str]=None, begin_line=0):
    ...
    builtin_namespace.update((('print', language.core.device_print), ('min', language.minimum)))
    ...
    def visit_Assign(self, node):
        ...
        for name, value in zip(names, values):
            ...
            if value is not None and (not _is_triton_tensor(value)) and (not isinstance(value, native_nontensor_types)):
    ...
    def visit_Call(self, node):
        ...
        if fn is language.core.device_assert:
            if not self.debug:
                return
    ...
    def execute_static_assert(self, node: ast.Call) -> None:
        ...
        return None
    statically_implemented_functions: Dict[object, Callable[[ast.Call], Any]] = {language.core.static_assert: execute_static_assert, language.core.static_print: execute_static_print}