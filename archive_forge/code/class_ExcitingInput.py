...
class ExcitingInput(MSONable):
    ...
    def from_str(cls, data: str) -> Self:
        ...
        for vect in basisnode:
            ...
            vectors.append([float(x) * stretch[0] * scale, float(y) * stretch[1] * scale, float(z) * stretch[2] * scale])
    ...
    def write_file(self, celltype, filename, cartesian=False, bandstr=False, symprec: float=0.4, angle_tolerance=5, **kwargs):
        """
