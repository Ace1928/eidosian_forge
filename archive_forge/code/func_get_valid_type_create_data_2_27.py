...
def get_valid_type_create_data_2_27():
    ...
    snapshot_none_combos = list(itertools.product(public, dhss, snapshot, create_from_snapshot, revert_to_snapshot, extra_specs))
    public = [True, False]
    dhss = [True, False]
    snapshot = [True]
    ...
    snapshot_true_combos = list(itertools.product(public, dhss, snapshot, create_from_snapshot, revert_to_snapshot, extra_specs))
    public = [True, False]
    dhss = [True, False]
    snapshot = [False]
    ...
    snapshot_false_combos = list(itertools.product(public, dhss, snapshot, create_from_snapshot, revert_to_snapshot, extra_specs))
