...
class TestInjectImageMetadataTask(test_utils.BaseTestCase):
    ...
    def setUp(self):
        ...
        self.image = self.img_factory.new_image(image_id=UUID1, disk_format='qcow2', container_format='bare', extra_properties={})
        self.img_repo.get.return_value = self.image
        task_input = {'import_from': 'http://cloud.foo/image.qcow2', 'import_from_format': 'qcow2', 'image_properties': {'disk_format': 'qcow2', 'container_format': 'bare'}}
    ...
    def test_inject_image_metadata_using_non_admin_user(self):
        ...
        self.assertEqual({'test': 'abc', 'os_glance_import_task': self.task.task_id}, self.image.extra_properties)
