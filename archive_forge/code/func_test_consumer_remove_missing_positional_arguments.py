...
def test_consumer_remove_missing_positional_arguments(self, consumers):
    ...
    consumer_data = {'service': 'service1', 'resource_type': 'type1', 'resource_id': 'id1'}
    self.key_mgr.add_consumer(self.ctxt, stored_id, consumer_data)
    for consumer in consumers:
        e = self.assertRaises(TypeError, self.key_mgr.remove_consumer, self.ctxt, stored_id, consumer)
