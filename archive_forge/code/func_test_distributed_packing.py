...
def test_distributed_packing(dist, is_initialized, fsdp, setup, step_lr, optimizer, get_model, tokenizer, train, setup_tokenizer, llama_version):
    ...
    kwargs = {'model_name': llama_version, 'batch_size_training': 8, 'val_batch_size': 1, 'use_peft': False, 'dataset': 'samsum_dataset', 'batching_strategy': 'packing', 'enable_fsdp': True}
