...
class Laplace(distribution.Distribution):
  ...
  """
    ...
    def _sample_n(self, n, seed=None):
        ...
        uniform_samples = random_ops.random_uniform(shape=shape, minval=np.nextafter(self.dtype.as_numpy_dtype(-1.0), self.dtype.as_numpy_dtype(0.0)), maxval=1.0, dtype=self.dtype, seed=seed)
        return self.loc - self.scale * math_ops.sign(uniform_samples) * math_ops.log1p(-math_ops.abs(uniform_samples))
