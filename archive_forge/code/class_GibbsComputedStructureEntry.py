...
class GibbsComputedStructureEntry(ComputedStructureEntry):
    ...
    def __init__(self, structure: Structure, formation_enthalpy_per_atom: float, temp: float=300, gibbs_model: Literal['SISSO']='SISSO', composition: Composition | None=None, correction: float=0.0, energy_adjustments: list | None=None, parameters: dict | None=None, data: dict | None=None, entry_id: object | None=None):
        """
        Args:
        ...
        super().__init__(structure, energy=0, composition=composition, correction=correction, energy_adjustments=energy_adjustments, parameters=parameters, data=data, entry_id=entry_id)
        self.temp = temp
