...
def test_get_snapshot_metadata(self):
    self._verify('openstack.block_storage.v2.snapshot.Snapshot.fetch_metadata', self.proxy.get_snapshot_metadata, method_args=['value'], expected_args=[self.proxy], expected_result=snapshot.Snapshot(id='value', metadata={}))