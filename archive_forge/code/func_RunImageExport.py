...
import six
def RunImageExport(args, export_args, tags, output_filter, release_track, docker_image_tag=_DEFAULT_BUILDER_VERSION):
  ...
  """
    ...
    builder = _GetBuilder(_IMAGE_EXPORT_BUILDER_EXECUTABLE, docker_image_tag, builder_region)
    return RunImageCloudBuild(args, builder, export_args, tags, output_filter, EXPORT_ROLES_FOR_CLOUDBUILD_SERVICE_ACCOUNT, EXPORT_ROLES_FOR_COMPUTE_SERVICE_ACCOUNT, build_region=builder_region)