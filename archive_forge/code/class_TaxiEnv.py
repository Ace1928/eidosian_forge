    ...
    * v0: Initial versions release
    ...
    def render(self):
        if self.render_mode is None:
            logger.warn(f'You are calling render method without specifying any render mode. You can specify the render_mode at initialization, e.g. gym("{self.spec.id}", render_mode="rgb_array")')
    ...
    def _render_gui(self, mode):
        ...
        if self.taxi_imgs is None:
            file_names = [path.join(path.dirname(__file__), 'img/cab_front.png'), path.join(path.dirname(__file__), 'img/cab_rear.png'), path.join(path.dirname(__file__), 'img/cab_right.png'), path.join(path.dirname(__file__), 'img/cab_left.png')]
            self.taxi_imgs = [pygame.transform.scale(pygame.image.load(file_name), self.cell_size) for file_name in file_names]
        ...
        if self.median_horiz is None:
            file_names = [path.join(path.dirname(__file__), 'img/gridworld_median_left.png'), path.join(path.dirname(__file__), 'img/gridworld_median_horiz.png'), path.join(path.dirname(__file__), 'img/gridworld_median_right.png')]
            self.median_horiz = [pygame.transform.scale(pygame.image.load(file_name), self.cell_size) for file_name in file_names]
        if self.median_vert is None:
            file_names = [path.join(path.dirname(__file__), 'img/gridworld_median_top.png'), path.join(path.dirname(__file__), 'img/gridworld_median_vert.png'), path.join(path.dirname(__file__), 'img/gridworld_median_bottom.png')]
            self.median_vert = [pygame.transform.scale(pygame.image.load(file_name), self.cell_size) for file_name in file_names]
