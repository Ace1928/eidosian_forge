...
class InfinoCallbackHandler(BaseCallbackHandler):
    ...
    def __init__(self, model_id: Optional[str]=None, model_version: Optional[str]=None, verbose: bool=False) -> None:
            ...
            if invocation_params:
                ...
                if model_name:
                    ...
                    for message_list in messages:
                        ...
                        num_tokens = get_num_tokens(message_string, openai_model_name=self.chat_openai_model_name)
