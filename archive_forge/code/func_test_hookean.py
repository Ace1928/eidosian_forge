def test_hookean():
    ...
    adsorbate = Atoms([Atom('Cu', atoms[7].position + (0.0, 0.0, 2.5)), Atom('Cu', atoms[7].position + (0.0, 0.0, 5.0))])
    atoms.extend(adsorbate)
    calc = EMT()
    atoms.calc = calc
    constraints = [FixAtoms(indices=[atom.index for atom in atoms if atom.symbol == 'Pt']), Hookean(a1=8, a2=9, rt=2.6, k=15.0), Hookean(a1=8, a2=(0.0, 0.0, 1.0, -15.0), k=15.0)]
