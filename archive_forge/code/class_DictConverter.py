...
class DictConverter:
    ...
    def __init__(self, *, posterior=None, posterior_predictive=None, predictions=None, sample_stats=None, log_likelihood=None, prior=None, prior_predictive=None, sample_stats_prior=None, observed_data=None, constant_data=None, predictions_constant_data=None, warmup_posterior=None, warmup_posterior_predictive=None, warmup_predictions=None, warmup_log_likelihood=None, warmup_sample_stats=None, save_warmup=None, index_origin=None, coords=None, dims=None, pred_dims=None, pred_coords=None, attrs=None, **kwargs):
        ...
        self.coords = coords if pred_coords is None else pred_coords if coords is None else {**coords, **pred_coords}
    ...
    def posterior_to_xarray(self):
        ...
        if 'log_likelihood' in data:
            warnings.warn('log_likelihood variable found in posterior group. For stats functions log likelihood data needs to be in log_likelihood group.', UserWarning)
        posterior_attrs = self._kwargs.get('posterior_attrs')
        posterior_warmup_attrs = self._kwargs.get('posterior_warmup_attrs')
        return (dict_to_dataset(data, library=None, coords=self.coords, dims=self.dims, attrs=posterior_attrs, index_origin=self.index_origin), dict_to_dataset(data_warmup, library=None, coords=self.coords, dims=self.dims, attrs=posterior_warmup_attrs, index_origin=self.index_origin))
    ...
    def prior_to_xarray(self):
        ...
        return dict_to_dataset(data, library=None, coords=self.coords, dims=self.dims, attrs=prior_attrs, index_origin=self.index_origin)
