...
class TestAnyKeySpecs(base.BaseTestCase):
    ...
    def test_data_is_none(self):
        self.assertIsNone(validators.validate_any_key_specs_or_none(None, key_specs={}))
    ...
    def test_data_invalid_keys(self):
        data = [{'opt_name': 'a', 'opt_value': 'A'}, {'opt_name': 'b', 'opt_valuee': 'B'}]
    ...
    def test_data_optional_key(self):
        data = [{'opt_name': 'a', 'opt_value': 'A'}, {'opt_name': 'b', 'opt_value': 'B', 'ip_version': '4'}]
