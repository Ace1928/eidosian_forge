...
class SSLClientTestsMixin(TLSMixin, ReactorBuilder, ContextGeneratingMixin, ConnectionTestsMixin, BadContextTestsMixin):
    """
    ...
    def test_badContext(self):
        ...
        def useIt(reactor, contextFactory):
            return reactor.connectSSL('127.0.0.1', 1234, ClientFactory(), contextFactory)
