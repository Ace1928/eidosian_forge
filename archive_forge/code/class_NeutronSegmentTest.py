...
class NeutronSegmentTest(common.HeatTestCase):
    ...
    def setUp(self):
        ...
        self.stack = stack.Stack(self.ctx, 'segment_test', template.Template(tpl))
        ...
        self.segment.client_plugin = mock.Mock(return_value=FakeOpenStackPlugin())
        self.patchobject(self.segment, 'physical_resource_name', return_value='test_segment')
        self.patchobject(neutronV20, 'find_resourceid_by_name_or_id', return_value='private')
    ...
    def test_segment_handle_delete(self):
        ...
        mock_delete = self.patchobject(self.sdkclient.network, 'delete_segment', return_value=None)
