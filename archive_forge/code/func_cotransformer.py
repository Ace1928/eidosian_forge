...
from .._utils import (
def cotransformer(schema: Any, **validation_rules: Any) -> Callable[[Any], '_FuncAsCoTransformer']:
    ...
    def deco(func: Callable) -> '_FuncAsCoTransformer':
        assert_or_throw(not is_class_method(func), NotImplementedError("cotransformer decorator can't be used on class methods"))
        return _FuncAsCoTransformer.from_func(func, schema, validation_rules=to_validation_rules(validation_rules))
    return deco