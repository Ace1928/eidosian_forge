...
class ClientFeatureFlagsMiddleware:
    ...
    def __call__(self, environ, start_response):
        header_feature_flags = self._parse_potential_header_param_flags(environ.get('HTTP_X_TENSORBOARD_FEATURE_FLAGS'))
        query_string_feature_flags = self._parse_potential_query_param_flags(environ.get('QUERY_STRING'))
        ...
        ctx = context.from_environ(environ).replace(client_feature_flags=query_string_feature_flags)
