...
def CreatePatchDeploymentResourceArg(verb, plural=False):
  ...
  """
    ...
    return presentation_specs.ResourcePresentationSpec('patch_deployment', GetPatchDeploymentResourceSpec(), '{} {}'.format(noun, verb), required=True, plural=plural, prefixes=False)