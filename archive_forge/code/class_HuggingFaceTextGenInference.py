...
class HuggingFaceTextGenInference(LLM):
    ...
    def validate_environment(cls, values: Dict) -> Dict:
        ...
        try:
            ...
            values['client'] = text_generation.Client(values['inference_server_url'], timeout=values['timeout'], **values['server_kwargs'])
            values['async_client'] = text_generation.AsyncClient(values['inference_server_url'], timeout=values['timeout'], **values['server_kwargs'])
        except ImportError:
            raise ImportError('Could not import text_generation python package. Please install it with `pip install text_generation`.')
        return values
