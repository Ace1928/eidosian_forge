...
class ParallelGate(raw_types.Gate):
    ...
    def _resolve_parameters_(self, resolver: 'cirq.ParamResolver', recursive: bool) -> 'ParallelGate':
        return self.with_gate(sub_gate=protocols.resolve_parameters(self.sub_gate, resolver, recursive))
    ...
    def _circuit_diagram_info_(self, args: 'cirq.CircuitDiagramInfoArgs') -> 'cirq.CircuitDiagramInfo':
        ...
        return protocols.CircuitDiagramInfo(wire_symbols=wire_symbols, exponent=diagram_info.exponent, connected=False)
