...
class TestFederationUtils(unit.TestCase):
    ...
    def setUp(self):
        ...
        self.attribute_mapping_schema_2_0 = copy.deepcopy(self.attribute_mapping_schema_1_0)
        self.attribute_mapping_schema_2_0['schema_version'] = '2.0'
        self.attribute_mapping_schema_2_0['rules'][0]['local'][0]['projects'][0]['domain'] = {'name': '{some_place_holder}'}
        self.rule_processor = utils.RuleProcessor(self.mapping_id_mock, self.attribute_mapping_schema_1_0)
        self.rule_processor_schema_2_0 = utils.RuleProcessorToHonorDomainOption(self.mapping_id_mock, self.attribute_mapping_schema_2_0)
    ...
    def test_normalize_user_unexpected_type(self):
        ...
        self.assertRaises(ValidationError, self.rule_processor.normalize_user, user, self.domain_mock)
    ...
    def test_create_attribute_mapping_rules_processor_schema2_0(self):
        result = utils.create_attribute_mapping_rules_processor(self.attribute_mapping_schema_2_0)
