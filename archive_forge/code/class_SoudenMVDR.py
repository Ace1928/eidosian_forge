...
class SoudenMVDR(torch.nn.Module):
    ...
    def forward(self, specgram: Tensor, psd_s: Tensor, psd_n: Tensor, reference_channel: Union[int, Tensor], diagonal_loading: bool=True, diag_eps: float=1e-07, eps: float=1e-08) -> torch.Tensor:
        """
        Args:
