...
class StandardIOEndpointsTests(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.fakeStdio = self.successResultOf(endpoint.listen(SpecificFactory(self.specificProtocol)))
    ...
    def test_protocolCreation(self):
        ...
        self.assertIsInstance(self.fakeStdio.protocolInstance.passedAddress, PipeAddress)
