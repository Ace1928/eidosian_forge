...
class CopyV1Beta1(CopyV1):
  ...
  """
    ...
    def Run(self, args):
        ...
        with endpoint_util.AiplatformEndpointOverrides(version=constants.BETA_VERSION, region=destination_region):
            client_instance = apis.GetClientInstance(constants.AI_PLATFORM_API_NAME, constants.AI_PLATFORM_API_VERSION[constants.BETA_VERSION])
            operation = client.ModelsClient(client=client_instance, messages=client_instance.MESSAGES_MODULE).CopyV1Beta1(destination_region_ref, args.source_model, args.kms_key_name, args.destination_model_id, args.destination_parent_model)
