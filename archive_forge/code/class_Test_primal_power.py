...
class Test_primal_power(_conic_tester_base, unittest.TestCase):
    _object_factory = lambda self: primal_power(r1=variable(lb=0), r2=variable(lb=0), x=[variable(), variable()], alpha=parameter(value=0.4))

    def test_bad_alpha_type(self):
        c = primal_power(r1=variable(lb=0), r2=variable(lb=0), x=[variable(), variable()], alpha=parameter())
        c = primal_power(r1=variable(lb=0), r2=variable(lb=0), x=[variable(), variable()], alpha=data_expression())
        with self.assertRaises(TypeError):
            c = primal_power(r1=variable(lb=0), r2=variable(lb=0), x=[variable(), variable()], alpha=variable())
        with self.assertRaises(TypeError):
            c = primal_power(r1=variable(lb=0), r2=variable(lb=0), x=[variable(), variable()], alpha=expression())
