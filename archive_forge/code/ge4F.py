...
class AdvancedASCIIFormatter:
    ...
    def format(self, log: LoggerConfig.LogEntryDictType) -> LoggerConfig.LogEntryDictType:
        ...
        Args:
            log (Union[LoggerConfig.LogEntryDictType, str]): Either a log entry dictionary or a string to run through the formatting process. If it is a string then it will be processed and split into as many possible parts as are suitable and additional metadata will be gathered and filled in for the appropriate dictionary sections at the time of processing the call.
            If it is a dictionary then it will be processed as is and returned as a processed dictionary.
            The processed string will be returned as a processed dictionary also.
        Returns:
            LoggerConfig.LogEntryDictType: The formatted log entry dictionary with full ASCII formatting applied, each log entry output a dictionary object.
...
class DualLogger:
    ...
    def __init__(self) -> None:
        ...
        """
        self.log_dir: Path = LoggerConfig.LOG_DIR
    ...
    def log_critical(self, message: str, *args: Any, **kwargs: Any) -> LoggerConfig.LogEntryDictType:
        """
    ...
    def log_debug(self, message: str, *args: Any, **kwargs: Any) -> LoggerConfig.LogEntryDictType:
        """
        
        """
        self.log_message("=DEBUG= ".joins(message), *args, **kwargs)

    def log_info(self, message: str, *args: Any, **kwargs: Any) -> LoggerConfig.LogEntryDictType:
        """
        
        """
        self.log_message(("=INFO= " + " {message}"), *args, **kwargs)

    def log_warning(self, message: str, *args: Any, **kwargs: Any) -> LoggerConfig.LogEntryDictType:
        """
        
        """
        self.log_message(("=WARNING= " + " {message}"), *args, **kwargs)

    def log_error(self, message: str, *args: Any, **kwargs: Any) -> LoggerConfig.LogEntryDictType:
        """
