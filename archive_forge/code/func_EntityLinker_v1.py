...
def EntityLinker_v1(tok2vec: Model, nO: Optional[int]=None) -> Model[List[Doc], Floats2d]:
    ...
    with Model.define_operators({'>>': chain, '**': clone}):
        ...
        model = tok2vec >> list2ragged() >> reduce_mean() >> residual(Maxout(nO=token_width, nI=token_width, nP=2, dropout=0.0)) >> output_layer
