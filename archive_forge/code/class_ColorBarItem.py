...
class ColorBarItem(PlotItem):
    ...
    **Signals:**
    ...
    def __init__(self, values=None, width=25, colorMap=None, label=None, interactive=True, limits=None, rounding=1, orientation='vertical', pen='w', hoverPen='r', hoverBrush='#FF000080'):
        """
        ...
        if interactive:
            if self.horizontal:
                ...
                align = 'horizontal'
            self.region = LinearRegionItem([63, 191], align, swapMode='block', pen=pen, brush=fn.mkBrush(None), hoverPen=hoverPen, hoverBrush=hoverBrush)
