...
class NeutronProviderNetTest(common.HeatTestCase):
    ...
    def create_provider_net(self):
        ...
        rsrc = provider_net.ProviderNet('provider_net', resource_defns['provider_network_vlan'], self.stack)
        return rsrc
    ...
    def test_get_live_state(self):
        rsrc = self.create_provider_net()
        self.mockclient.show_network.return_value = {'network': {'status': 'ACTIVE', 'subnets': [], 'availability_zone_hints': [], 'availability_zones': [], 'name': 'prov-provider-nhalkd5xftp3', 'provider:physical_network': 'public', 'admin_state_up': True, 'tenant_id': 'df49ea64e87c43a792a510698364f03e', 'mtu': 0, 'router:external': False, 'port_security_enabled': True, 'shared': True, 'provider:network_type': 'flat', 'id': 'af216806-4462-4c68-bfa4-9580857e71c3', 'provider:segmentation_id': None, 'tags': ['tag1', 'tag2']}}
        reality = rsrc.get_live_state(rsrc.properties)
        expected = {'name': 'prov-provider-nhalkd5xftp3', 'physical_network': 'public', 'admin_state_up': True, 'network_type': 'flat', 'port_security_enabled': True, 'segmentation_id': None, 'router_external': False, 'availability_zone_hints': [], 'tags': ['tag1', 'tag2']}
