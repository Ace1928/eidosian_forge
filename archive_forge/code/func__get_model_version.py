...
def _get_model_version():
    request_message = _get_request_message(GetModelVersion(), schema={'name': [_assert_string, _assert_required], 'version': [_assert_string, _assert_required]})
    model_version = _get_model_registry_store().get_model_version(name=request_message.name, version=request_message.version)
