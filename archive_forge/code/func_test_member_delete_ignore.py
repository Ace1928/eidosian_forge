...
def test_member_delete_ignore(self):
    self._verify('openstack.proxy.Proxy._delete', self.proxy.remove_member, method_args=['member_id'], method_kwargs={'image': 'image_id'}, expected_args=[_member.Member], expected_kwargs={'member_id': 'member_id', 'image_id': 'image_id', 'ignore_missing': True})