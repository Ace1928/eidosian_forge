...
def AddEncryptionKeyShutdownHoursFlag(parser, with_clear=True):
    ...
    if with_clear:
        ...
        policy_group.add_argument('--clear-encryption-key-shutdown-hours', default=False, action='store_true', help='Remove any previously set CMEK key shutdown hours setting.')
    policy_group.add_argument('--encryption-key-shutdown-hours', help='The number of hours to wait before an automatic shutdown server after CMEK key revocation is detected.')