...
class DomainGroupResource(ks_flask.ResourceBase):
    ...
    def put(self, domain_id=None, group_id=None, role_id=None):
        ...
        PROVIDERS.assignment_api.create_grant(role_id, domain_id=domain_id, group_id=group_id, inherited_to_projects=False, initiator=self.audit_initiator)
        return (None, http.client.NO_CONTENT)
    ...
    def delete(self, domain_id=None, group_id=None, role_id=None):
        ...
        PROVIDERS.assignment_api.delete_grant(role_id, domain_id=domain_id, group_id=group_id, inherited_to_projects=False, initiator=self.audit_initiator)
        return (None, http.client.NO_CONTENT)