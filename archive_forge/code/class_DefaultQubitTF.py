...
class DefaultQubitTF(DefaultQubitLegacy):
    ...
    * Only exact expectation values, variances, and probabilities are
    ...
    def _apply_state_vector(self, state, device_wires):
        ...
        if batch_size:
            raise NotImplementedError('Parameter broadcasting is not supported together with initializing the state vector of a subsystem of the device when using DefaultQubitTF.')
