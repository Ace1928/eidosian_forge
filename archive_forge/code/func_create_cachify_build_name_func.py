...
def create_cachify_build_name_func(base_name: str, special_names: Optional[List[str]]=None, function_names: Optional[List[str]]=None, include_classname: Optional[bool]=True, include_http_methods: Optional[bool]=False) -> Callable[..., str]:
    """
