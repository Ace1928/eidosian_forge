...
class BarbicanKeyManagerKSTokenTestCase(BarbicanKeyManagerTestCase, base.BaseTestCase):
    ...
    def get_context(self):
        ...
        return keystone_token.KeystoneToken(token=auth.get_token(sess), auth_url=auth_url, project_id=auth.get_project_id(sess))