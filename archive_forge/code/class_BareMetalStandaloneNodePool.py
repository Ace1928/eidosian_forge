...
class BareMetalStandaloneNodePool(_messages.Message):
    """Resource that represents a bare metal standalone node pool.
  ...
  """
    ...
    class StateValueValuesEnum(_messages.Enum):
        """Output only. The current state of the bare metal standalone node pool.
    ...
    class AnnotationsValue(_messages.Message):
        """Annotations on the bare metal standalone node pool. This field has the
