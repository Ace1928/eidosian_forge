...
class UniversalGUIBuilder:
    ...
    def canvas_click(self, event: tk.Event) -> None:
        """Handle canvas click events to select or place widgets."""
    ...
    def canvas_drag(self, event: tk.Event) -> None:
        """Handle canvas drag events to move widgets or draw."""
    ...
    def canvas_release(self, event: tk.Event) -> None:
        """Handle canvas release events to finalize widget placement or drawing."""
    ...
    def new_project(self) -> None:
        """Create a new project, resetting the canvas and properties."""
    ...
    def apply_properties(self) -> None:
        """Apply the properties from the properties panel to the selected widget."""
