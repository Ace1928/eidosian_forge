...
def test_cancel_reservation(client_constructor):
    ...
    result = quantum.QuantumReservation(name=name, start_time=Timestamp(seconds=1000000000), end_time=Timestamp(seconds=1000002000), whitelisted_users=['jeff@google.com'])
    ...
    grpc_client.cancel_quantum_reservation.assert_called_with(quantum.CancelQuantumReservationRequest(name=name))