...
def ListMembershipConstraintTemplates(client, msg, project_id):
    ...
    req = msg.AnthospolicycontrollerstatusPaProjectsMembershipConstraintTemplatesListRequest()
    return _Autopage(client_fn, req, project_id, lambda response: response.membershipConstraintTemplates)