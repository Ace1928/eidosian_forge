...
class ListTopicSnapshotsAsyncPager:
    ...
    def __init__(self, method: Callable[..., Awaitable[pubsub.ListTopicSnapshotsResponse]], request: pubsub.ListTopicSnapshotsRequest, response: pubsub.ListTopicSnapshotsResponse, *, metadata: Sequence[Tuple[str, str]]=()):
