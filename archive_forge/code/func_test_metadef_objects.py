...
def test_metadef_objects(self):
    self.verify_list(self.proxy.metadef_objects, _metadef_object.MetadefObject, method_kwargs={'namespace': 'test_namespace_name'}, expected_kwargs={'namespace_name': 'test_namespace_name'})