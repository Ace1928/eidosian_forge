...
class V2beta2ObjectMetricSource(object):
    ...
    swagger_types = {'described_object': 'V2beta2CrossVersionObjectReference', 'metric': 'V2beta2MetricIdentifier', 'target': 'V2beta2MetricTarget'}
    attribute_map = {'described_object': 'describedObject', 'metric': 'metric', 'target': 'target'}
