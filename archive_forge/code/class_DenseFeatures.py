...
class DenseFeatures(kfc._BaseFeaturesLayer):
    ...
    def __init__(self, feature_columns, trainable=True, name=None, partitioner=None, **kwargs):
        ...
        """
        super().__init__(feature_columns=feature_columns, trainable=trainable, name=name, partitioner=partitioner, expected_column_type=tf.__internal__.feature_column.DenseColumn, **kwargs)
