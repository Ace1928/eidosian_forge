...
class TestKeypairShow(TestKeypair):
    ...
    def setUp(self):
        super().setUp()
        self.columns = ('created_at', 'fingerprint', 'id', 'is_deleted', 'name', 'private_key', 'type', 'user_id')
    ...
    def test_keypair_show(self):
        ...
        self.compute_sdk_client.find_keypair.assert_called_with(self.keypair.name, ignore_missing=False)
