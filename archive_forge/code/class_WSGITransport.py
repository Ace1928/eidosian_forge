...
class WSGITransport(BaseTransport):
    ...
    * `remote_addr` - A string indicating the client IP of incoming requests.
    ...
    def __init__(self, app: WSGIApplication, raise_app_exceptions: bool=True, script_name: str='', remote_addr: str='127.0.0.1', wsgi_errors: typing.TextIO | None=None) -> None:
        self.app = app
    ...
    def handle_request(self, request: Request) -> Response:
        ...
        def start_response(status: str, response_headers: list[tuple[str, str]], exc_info: OptExcInfo | None=None) -> typing.Callable[[bytes], typing.Any]:
