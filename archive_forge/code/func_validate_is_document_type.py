...
def validate_is_document_type(option: str, value: Any) -> None:
    ...
    if not isinstance(value, (abc.MutableMapping, RawBSONDocument)):
        raise TypeError(f'{option} must be an instance of dict, bson.son.SON, bson.raw_bson.RawBSONDocument, or a type that inherits from collections.MutableMapping')