...
def _register_setup_module_fixture(self) -> None:
    ...
    self.session._fixturemanager._register_fixture(name=f'_xunit_setup_module_fixture_{self.obj.__name__}', func=xunit_setup_module_fixture, nodeid=self.nodeid, scope='module', autouse=True)