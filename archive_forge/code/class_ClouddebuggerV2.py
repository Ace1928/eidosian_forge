...
class ClouddebuggerV2(base_api.BaseApiClient):
    ...
    def __init__(self, url='', credentials=None, get_credentials=True, http=None, model=None, log_request=False, log_response=False, credentials_args=None, default_global_params=None, additional_http_headers=None, response_encoding=None):
        ...
        super(ClouddebuggerV2, self).__init__(url, credentials=credentials, get_credentials=get_credentials, http=http, model=model, log_request=log_request, log_response=log_response, credentials_args=credentials_args, default_global_params=default_global_params, additional_http_headers=additional_http_headers, response_encoding=response_encoding)
    ...
    class DebuggerDebuggeesBreakpointsService(base_api.BaseApiService):
      ...
      """
            ...
            return self._RunMethod(config, request, global_params=global_params)
        Delete.method_config = lambda: base_api.ApiMethodInfo(http_method='DELETE', method_id='clouddebugger.debugger.debuggees.breakpoints.delete', ordered_params=['debuggeeId', 'breakpointId'], path_params=['breakpointId', 'debuggeeId'], query_params=['clientVersion'], relative_path='v2/debugger/debuggees/{debuggeeId}/breakpoints/{breakpointId}', request_field='', request_type_name='ClouddebuggerDebuggerDebuggeesBreakpointsDeleteRequest', response_type_name='Empty', supports_download=False)
      ...
      """
            ...
            return self._RunMethod(config, request, global_params=global_params)
        Get.method_config = lambda: base_api.ApiMethodInfo(http_method='GET', method_id='clouddebugger.debugger.debuggees.breakpoints.get', ordered_params=['debuggeeId', 'breakpointId'], path_params=['breakpointId', 'debuggeeId'], query_params=['clientVersion'], relative_path='v2/debugger/debuggees/{debuggeeId}/breakpoints/{breakpointId}', request_field='', request_type_name='ClouddebuggerDebuggerDebuggeesBreakpointsGetRequest', response_type_name='GetBreakpointResponse', supports_download=False)
      ...
      """
            config = self.GetMethodConfig('List')
            return self._RunMethod(config, request, global_params=global_params)
        List.method_config = lambda: base_api.ApiMethodInfo(http_method='GET', method_id='clouddebugger.debugger.debuggees.breakpoints.list', ordered_params=['debuggeeId'], path_params=['debuggeeId'], query_params=['action_value', 'clientVersion', 'includeAllUsers', 'includeInactive', 'stripResults', 'waitToken'], relative_path='v2/debugger/debuggees/{debuggeeId}/breakpoints', request_field='', request_type_name='ClouddebuggerDebuggerDebuggeesBreakpointsListRequest', response_type_name='ListBreakpointsResponse', supports_download=False)
      ...
      """
            ...
            return self._RunMethod(config, request, global_params=global_params)
        Set.method_config = lambda: base_api.ApiMethodInfo(http_method='POST', method_id='clouddebugger.debugger.debuggees.breakpoints.set', ordered_params=['debuggeeId'], path_params=['debuggeeId'], query_params=['canaryOption', 'clientVersion'], relative_path='v2/debugger/debuggees/{debuggeeId}/breakpoints/set', request_field='breakpoint', request_type_name='ClouddebuggerDebuggerDebuggeesBreakpointsSetRequest', response_type_name='SetBreakpointResponse', supports_download=False)
