...
def testMapboxRangeXCallbackEventData(self):
    ...
    event_data = RangeXCallback.get_event_data_from_property_update('relayout_data', relayout_data, self.mapbox_fig_dict)
    self.assertEqual(event_data, {'first': {'x_range': self.easting_range1}, 'third': {'x_range': self.easting_range2}})