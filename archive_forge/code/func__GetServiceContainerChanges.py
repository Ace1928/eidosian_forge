...
def _GetServiceContainerChanges(container_args, container_name=None):
    ...
    if container_args.IsSpecified('port'):
        changes.append(config_changes.ContainerPortChange(container_name=container_name, port=container_args.port))
    if container_args.IsSpecified('use_http2'):
        changes.append(config_changes.ContainerPortChange(use_http2=container_args.use_http2, container_name=container_name))
    return changes