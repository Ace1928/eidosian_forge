...
def GetGkeArgGroup(parser):
    ...
    return _GetOrAddArgGroup(parser, _ARG_GROUP_HELP_TEXT.format(platform='`--platform={}`'.format(platforms.PLATFORM_GKE), platform_desc=platforms.PLATFORM_SHORT_DESCRIPTIONS[platforms.PLATFORM_GKE]))