...
class CommDebugMode(TorchDispatchMode):
    ...
    def __init__(self):
        ...
        self.comm_registry = {funcol.all_gather_into_tensor, funcol.all_gather_into_tensor_coalesced, funcol.all_reduce, funcol.all_to_all_single, funcol.broadcast, funcol.reduce_scatter_tensor, funcol.reduce_scatter_tensor_coalesced}
