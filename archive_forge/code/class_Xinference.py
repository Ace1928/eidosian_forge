...
class Xinference(LLM):
    ...
    def __init__(self, server_url: Optional[str]=None, model_uid: Optional[str]=None, **model_kwargs: Any):
        try:
            from xinference.client import RESTfulClient
        except ImportError as e:
            raise ImportError('Could not import RESTfulClient from xinference. Please install it with `pip install xinference`.') from e
    ...
    def _identifying_params(self) -> Mapping[str, Any]:
        ...
        return {**{'server_url': self.server_url}, **{'model_uid': self.model_uid}, **{'model_kwargs': self.model_kwargs}}
