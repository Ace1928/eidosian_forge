...
class MultiDomainBasicAuth(AuthBase):
    ...
    def __init__(self, prompting: bool=True, index_urls: Optional[List[str]]=None, keyring_provider: str='auto') -> None:
    ...
    def handle_401(self, resp: Response, **kwargs: Any) -> Response:
        ...
        if username is not None and password is not None:
            ...
            if save and self._should_save_password_to_keyring():
                self._credentials_to_save = Credentials(url=parsed.netloc, username=username, password=password)
        _ = resp.content
