...
class PlayWrightBrowserToolkit(BaseToolkit):
    ...
    **Security Note**: This toolkit provides code to control a web-browser.
    ...
    def get_tools(self) -> List[BaseTool]:
        ...
        tool_classes: List[Type[BaseBrowserTool]] = [ClickTool, NavigateTool, NavigateBackTool, ExtractTextTool, ExtractHyperlinksTool, GetElementsTool, CurrentWebPageTool]
        tools = [tool_cls.from_browser(sync_browser=self.sync_browser, async_browser=self.async_browser) for tool_cls in tool_classes]
