...
def test_metadef_namespace_update(self):
    self.verify_update(self.proxy.update_metadef_namespace, _metadef_namespace.MetadefNamespace, method_kwargs={'is_protected': True}, expected_kwargs={'namespace': 'resource_id', 'is_protected': True})