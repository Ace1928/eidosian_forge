...
def _make_var_reduction_prim(name: str, impl_aten, doc):
    ...
    return _make_prim(schema=f'{name}(Tensor inp, int[]? dims, *, float correction, ScalarType? output_dtype=None) -> Tensor', meta=_var_reduction_meta, impl_aten=impl_aten, return_type=RETURN_TYPE.NEW, doc=doc)