...
@deprecated(since='0.0.32', removal='0.2.0', alternative_import='langchain_google_community.DocumentAIWarehouseRetriever')
class GoogleDocumentAIWarehouseRetriever(BaseRetriever):
    ...
    def validate_environment(cls, values: Dict) -> Dict:
        ...
        try:
            ...
            raise ImportError('google.cloud.contentwarehouse is not installed.Please install it with pip install google-cloud-contentwarehouse') from exc
    ...
    def _parse_search_response(self, response: 'SearchDocumentsPager') -> List[Document]:
        ...
        for doc in response.matching_documents:
            metadata = {'title': doc.document.title, 'source': doc.document.raw_document_path}
