...
class ArchiveEntry:
    ...
    @property
    def isblk(self):
        return self.filetype & 61440 == 24576

    @property
    def ischr(self):
        return self.filetype & 61440 == 8192

    @property
    def isdir(self):
        return self.filetype & 61440 == 16384

    @property
    def isfifo(self):
        return self.filetype & 61440 == 4096

    @property
    def islnk(self):
        return bool(ffi.entry_hardlink_w(self._entry_p) or ffi.entry_hardlink(self._entry_p))

    @property
    def issym(self):
        return self.filetype & 61440 == 40960

    @property
    def isreg(self):
        return self.filetype & 61440 == 32768
    ...
    def atime(self, value):
        if value is None:
            ...
            self.set_atime(int(seconds), int(fraction * 1000000000))
    ...
    def mtime(self, value):
        if value is None:
            ...
            seconds, fraction = math.modf(value)
            self.set_mtime(int(seconds), int(fraction * 1000000000))
    ...
    def ctime(self, value):
        if value is None:
            ...
            seconds, fraction = math.modf(value)
            self.set_ctime(int(seconds), int(fraction * 1000000000))
    ...
    @property
    def linkpath(self):
        path = ffi.entry_symlink_w(self._entry_p) or ffi.entry_symlink(self._entry_p) if self.issym else ffi.entry_hardlink_w(self._entry_p) or ffi.entry_hardlink(self._entry_p)
