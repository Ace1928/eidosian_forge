...
class QuantizedBiEncoderEmbeddings(BaseModel, Embeddings):
    ...
    def __init__(self, model_name: str, max_seq_len: int=512, pooling_strategy: str='mean', query_instruction: Optional[str]=None, document_instruction: Optional[str]=None, padding: bool=True, model_kwargs: Optional[Dict]=None, encode_kwargs: Optional[Dict]=None, **kwargs: Any) -> None:
    ...
    def load_model(self) -> None:
        ...
        self.transformer_tokenizer = AutoTokenizer.from_pretrained(pretrained_model_name_or_path=self.model_name_or_path)
