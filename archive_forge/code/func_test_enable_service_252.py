...
def test_enable_service_252(self, mv_mock):
    self._verify('openstack.compute.v2.service.Service.enable', self.proxy.enable_service, method_args=['value', 'host1', 'nova-compute'], expected_args=[self.proxy, 'host1', 'nova-compute'])