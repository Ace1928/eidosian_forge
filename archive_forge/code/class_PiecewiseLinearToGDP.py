...
class PiecewiseLinearToGDP(Transformation):
    ...
    def _transform_pw_linear_expr(self, pw_expr, pw_linear_func, transformation_block):
        raise DeveloperError("Derived class failed to implement '_transform_pw_linear_expr'")