...
class AbstractLocalEngine(AbstractEngine):
    ...
    def list_programs(self, created_before: Optional[Union[datetime.datetime, datetime.date]]=None, created_after: Optional[Union[datetime.datetime, datetime.date]]=None, has_labels: Optional[Dict[str, str]]=None) -> List[AbstractProgram]:
        ...
        for processor in self._processors.values():
            valid_programs.extend(processor.list_programs(created_before=created_before, created_after=created_after, has_labels=has_labels))
        return valid_programs

    def list_jobs(self, created_before: Optional[Union[datetime.datetime, datetime.date]]=None, created_after: Optional[Union[datetime.datetime, datetime.date]]=None, has_labels: Optional[Dict[str, str]]=None, execution_states: Optional[Set[quantum.ExecutionStatus.State]]=None) -> List[AbstractJob]:
        ...
        for processor in self._processors.values():
            programs = processor.list_programs(created_before=created_before, created_after=created_after, has_labels=has_labels)
            for program in programs:
                valid_jobs.extend(program.list_jobs(created_before=created_before, created_after=created_after, has_labels=has_labels, execution_states=execution_states))
        return valid_jobs
