...
class TestShowNetworkQosBandwidthLimit(TestNetworkQosRule):
    ...
    def setUp(self):
        ...
        self.network_client.get_qos_bandwidth_limit_rule = mock.Mock(return_value=self.new_rule)
    ...
    def test_show_all_options(self):
        ...
        self.network_client.get_qos_bandwidth_limit_rule.assert_called_once_with(self.new_rule.id, self.qos_policy.id)
