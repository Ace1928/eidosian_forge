...
class HeadingMixin:
    ...
    def header(self, body: SupportsStr, anchor: Anchor=None, *, help: str | None=None, divider: Divider=False) -> DeltaGenerator:
    ...
    def subheader(self, body: SupportsStr, anchor: Anchor=None, *, help: str | None=None, divider: Divider=False) -> DeltaGenerator:
    ...
    def title(self, body: SupportsStr, anchor: Anchor=None, *, help: str | None=None) -> DeltaGenerator:
