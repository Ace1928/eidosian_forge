...
class EssentialcontactsV1(base_api.BaseApiClient):
    ...
    def __init__(self, url='', credentials=None, get_credentials=True, http=None, model=None, log_request=False, log_response=False, credentials_args=None, default_global_params=None, additional_http_headers=None, response_encoding=None):
        ...
        super(EssentialcontactsV1, self).__init__(url, credentials=credentials, get_credentials=get_credentials, http=http, model=model, log_request=log_request, log_response=log_response, credentials_args=credentials_args, default_global_params=default_global_params, additional_http_headers=additional_http_headers, response_encoding=response_encoding)
    ...
    class OrganizationsContactsService(base_api.BaseApiService):
      ...
      """
            config = self.GetMethodConfig('Compute')
            return self._RunMethod(config, request, global_params=global_params)
        Compute.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1/organizations/{organizationsId}/contacts:compute', http_method='GET', method_id='essentialcontacts.organizations.contacts.compute', ordered_params=['parent'], path_params=['parent'], query_params=['notificationCategories', 'pageSize', 'pageToken'], relative_path='v1/{+parent}/contacts:compute', request_field='', request_type_name='EssentialcontactsOrganizationsContactsComputeRequest', response_type_name='GoogleCloudEssentialcontactsV1ComputeContactsResponse', supports_download=False)
      ...
      """
            config = self.GetMethodConfig('Create')
            return self._RunMethod(config, request, global_params=global_params)
        Create.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1/organizations/{organizationsId}/contacts', http_method='POST', method_id='essentialcontacts.organizations.contacts.create', ordered_params=['parent'], path_params=['parent'], query_params=[], relative_path='v1/{+parent}/contacts', request_field='googleCloudEssentialcontactsV1Contact', request_type_name='EssentialcontactsOrganizationsContactsCreateRequest', response_type_name='GoogleCloudEssentialcontactsV1Contact', supports_download=False)
      ...
      """
            config = self.GetMethodConfig('Delete')
            return self._RunMethod(config, request, global_params=global_params)
        Delete.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1/organizations/{organizationsId}/contacts/{contactsId}', http_method='DELETE', method_id='essentialcontacts.organizations.contacts.delete', ordered_params=['name'], path_params=['name'], query_params=[], relative_path='v1/{+name}', request_field='', request_type_name='EssentialcontactsOrganizationsContactsDeleteRequest', response_type_name='GoogleProtobufEmpty', supports_download=False)
      ...
      """
            config = self.GetMethodConfig('Get')
            return self._RunMethod(config, request, global_params=global_params)
        Get.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1/organizations/{organizationsId}/contacts/{contactsId}', http_method='GET', method_id='essentialcontacts.organizations.contacts.get', ordered_params=['name'], path_params=['name'], query_params=[], relative_path='v1/{+name}', request_field='', request_type_name='EssentialcontactsOrganizationsContactsGetRequest', response_type_name='GoogleCloudEssentialcontactsV1Contact', supports_download=False)
      ...
      """
            config = self.GetMethodConfig('List')
            return self._RunMethod(config, request, global_params=global_params)
        List.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1/organizations/{organizationsId}/contacts', http_method='GET', method_id='essentialcontacts.organizations.contacts.list', ordered_params=['parent'], path_params=['parent'], query_params=['pageSize', 'pageToken'], relative_path='v1/{+parent}/contacts', request_field='', request_type_name='EssentialcontactsOrganizationsContactsListRequest', response_type_name='GoogleCloudEssentialcontactsV1ListContactsResponse', supports_download=False)
      ...
      """
            config = self.GetMethodConfig('Patch')
            return self._RunMethod(config, request, global_params=global_params)
        Patch.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1/organizations/{organizationsId}/contacts/{contactsId}', http_method='PATCH', method_id='essentialcontacts.organizations.contacts.patch', ordered_params=['name'], path_params=['name'], query_params=['updateMask'], relative_path='v1/{+name}', request_field='googleCloudEssentialcontactsV1Contact', request_type_name='EssentialcontactsOrganizationsContactsPatchRequest', response_type_name='GoogleCloudEssentialcontactsV1Contact', supports_download=False)
    ...
    class ProjectsContactsService(base_api.BaseApiService):
      ...
      """
            config = self.GetMethodConfig('Compute')
            return self._RunMethod(config, request, global_params=global_params)
        Compute.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1/projects/{projectsId}/contacts:compute', http_method='GET', method_id='essentialcontacts.projects.contacts.compute', ordered_params=['parent'], path_params=['parent'], query_params=['notificationCategories', 'pageSize', 'pageToken'], relative_path='v1/{+parent}/contacts:compute', request_field='', request_type_name='EssentialcontactsProjectsContactsComputeRequest', response_type_name='GoogleCloudEssentialcontactsV1ComputeContactsResponse', supports_download=False)
      ...
      """
            config = self.GetMethodConfig('Create')
            return self._RunMethod(config, request, global_params=global_params)
        Create.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1/projects/{projectsId}/contacts', http_method='POST', method_id='essentialcontacts.projects.contacts.create', ordered_params=['parent'], path_params=['parent'], query_params=[], relative_path='v1/{+parent}/contacts', request_field='googleCloudEssentialcontactsV1Contact', request_type_name='EssentialcontactsProjectsContactsCreateRequest', response_type_name='GoogleCloudEssentialcontactsV1Contact', supports_download=False)
      ...
      """
            config = self.GetMethodConfig('Delete')
            return self._RunMethod(config, request, global_params=global_params)
        Delete.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1/projects/{projectsId}/contacts/{contactsId}', http_method='DELETE', method_id='essentialcontacts.projects.contacts.delete', ordered_params=['name'], path_params=['name'], query_params=[], relative_path='v1/{+name}', request_field='', request_type_name='EssentialcontactsProjectsContactsDeleteRequest', response_type_name='GoogleProtobufEmpty', supports_download=False)
      ...
      """
            config = self.GetMethodConfig('Get')
            return self._RunMethod(config, request, global_params=global_params)
        Get.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1/projects/{projectsId}/contacts/{contactsId}', http_method='GET', method_id='essentialcontacts.projects.contacts.get', ordered_params=['name'], path_params=['name'], query_params=[], relative_path='v1/{+name}', request_field='', request_type_name='EssentialcontactsProjectsContactsGetRequest', response_type_name='GoogleCloudEssentialcontactsV1Contact', supports_download=False)
      ...
      """
            config = self.GetMethodConfig('List')
            return self._RunMethod(config, request, global_params=global_params)
        List.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1/projects/{projectsId}/contacts', http_method='GET', method_id='essentialcontacts.projects.contacts.list', ordered_params=['parent'], path_params=['parent'], query_params=['pageSize', 'pageToken'], relative_path='v1/{+parent}/contacts', request_field='', request_type_name='EssentialcontactsProjectsContactsListRequest', response_type_name='GoogleCloudEssentialcontactsV1ListContactsResponse', supports_download=False)
      ...
      """
            config = self.GetMethodConfig('Patch')
            return self._RunMethod(config, request, global_params=global_params)
        Patch.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1/projects/{projectsId}/contacts/{contactsId}', http_method='PATCH', method_id='essentialcontacts.projects.contacts.patch', ordered_params=['name'], path_params=['name'], query_params=['updateMask'], relative_path='v1/{+name}', request_field='googleCloudEssentialcontactsV1Contact', request_type_name='EssentialcontactsProjectsContactsPatchRequest', response_type_name='GoogleCloudEssentialcontactsV1Contact', supports_download=False)
