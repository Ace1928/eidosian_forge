...
class PaiEasChatEndpoint(BaseChatModel):
    ...
    def _identifying_params(self) -> Dict[str, Any]:
        ...
        return {'eas_service_url': self.eas_service_url, 'eas_service_token': self.eas_service_token, **{'model_kwargs': _model_kwargs}}
    ...
    def _default_params(self) -> Dict[str, Any]:
        ...
        return {'max_new_tokens': self.max_new_tokens, 'temperature': self.temperature, 'top_k': self.top_k, 'top_p': self.top_p, 'stop_sequences': [], 'do_sample': self.do_sample, 'use_cache': self.use_cache}
    ...
    def format_request_payload(self, messages: List[BaseMessage], **model_kwargs: Any) -> dict:
        ...
        for message in messages:
            ...
            elif isinstance(message, ChatMessage) and message.role in ['user', 'assistant', 'system']:
