...
import functools
def _create_scatter_plot(self, x_data: pd.Series, y_data: pd.Series, z_data: Optional[pd.Series]=None, color_data: Optional[pd.Series]=None, style: Optional[str]=None, interactive: bool=True) -> None:
    """
