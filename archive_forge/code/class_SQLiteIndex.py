...
class SQLiteIndex(abc.ABC):
    ...
    def __init__(self, sql_data_path: Optional[pathlib.Path]=None, tablename: Optional[str]=None, schema: Optional['SchemaT']=None, schemas: Optional[Dict[str, Union['SchemaT', 'SchemaListT']]]=None, ephemeral: Optional[bool]=None, force_reindex: Optional[bool]=None, auto_set_schema: Optional[bool]=None, enable_internal_index: Optional[bool]=None, **kwargs):
        """
        Initializes the SQLite Index
        """
        self._initialized: bool = False
        super().__init__(**kwargs)
        self.cls_init(sql_data_path=sql_data_path, tablename=tablename, schema=schema, schemas=schemas, ephemeral=ephemeral, force_reindex=force_reindex, auto_set_schema=auto_set_schema, enable_internal_index=enable_internal_index, **kwargs)

    def cls_init(self, sql_data_path: Optional[pathlib.Path]=None, tablename: Optional[str]=None, schema: Optional['SchemaT']=None, schemas: Optional[Dict[str, Union['SchemaT', 'SchemaListT']]]=None, ephemeral: Optional[bool]=None, force_reindex: Optional[bool]=None, auto_set_schema: Optional[bool]=None, enable_internal_index: Optional[bool]=None, **kwargs):
        """
        ...
        if enable_internal_index is not None:
        ...
        if auto_set_schema is not None:
            self.auto_set_schema = auto_set_schema
        if self.schema is not None:
            if isinstance(self.schema, str):
                self.schema = lazy_import(self.schema)
        if self.schemas is not None:
            for key, value in self.schemas.items():
                if isinstance(value, list):
                    ...
                    self.schemas[key] = lazy_import(value)
    ...
    def get_index_schemas(self) -> Dict[str, Union[Type['SQLiteModelMixin'], List[Type['SQLiteModelMixin']]]]:
        ...
        """
        return self.schemas or {self.tablename: self.schema}
        ...
        with self.sql_lock.acquire(10.0):
            for tablename, schema in index_schemas.items():
                if not isinstance(schema, list):
                    schema = [schema]
                for s in schema:
                    await s.aexecute_sql_init(conn, tablename=tablename, skip_index=exists and (not self.force_reindex), auto_set=self.auto_set_schema)
        self._schemas_initialized = True
    ...
    def get_schema(self, schema_name: Optional[str]=None, tablename: Optional[str]=None) -> 'SchemaT':
        """
    ...
    def format_query(self, query: Optional[str]=None, **kwargs) -> Tuple[Optional[str], Dict[str, Any]]:
        """
    ...
    @overload
    def search_one(self, query: Optional[str]=None, skip: Optional[int]=None, tablename: Optional[str]=None, schema_name: Optional[str]=None, **kwargs) -> 'SQLiteModelMixin':
        """
    ...
    @overload
    def search_one(self, query: Optional[str]=None, skip: Optional[int]=None, return_id_only: Optional[bool]=True, tablename: Optional[str]=None, schema_name: Optional[str]=None, **kwargs) -> str:
        """
    ...
    async def asearch_one(self, query: Optional[str]=None, skip: Optional[int]=None, return_id_only: Optional[bool]=None, return_fields: Optional[List[str]]=None, tablename: Optional[str]=None, schema_name: Optional[str]=None, cast_to_object: Optional[bool]=None, **kwargs) -> Optional[Union['SQLiteModelMixin', str]]:
        """
        Executes the sql search for one item
        """
        tablename = tablename or self.default_tablename
        ...
        async with self.aconn() as conn:
            result = await schema.asearch_one(conn=conn, query=query, skip=skip, return_id_only=return_id_only, return_fields=return_fields, tablename=tablename, **kwargs)
        if self.enable_internal_index and result and cast_to_object:
            return self.populate_item_from_index(tablename, result)
        return result
    ...
    async def asearch_many(self, query: Optional[str]=None, limit: Optional[int]=None, skip: Optional[int]=None, return_id_only: Optional[bool]=None, return_fields: Optional[List[str]]=None, tablename: Optional[str]=None, schema_name: Optional[str]=None, cast_to_object: Optional[bool]=None, **kwargs) -> List[Union['SQLiteModelMixin', str]]:
        """
        Executes the sql search for many items
        """
        tablename = tablename or self.default_tablename
        ...
        async with self.aconn() as conn:
            try:
                results = await schema.asearch_many(conn=conn, query=query, limit=limit, skip=skip, return_id_only=return_id_only, return_fields=return_fields, tablename=tablename, **kwargs)
            except Exception as e:
    ...
    def delete(self, item: 'SQLiteModelMixin', **kwargs) -> None:
        """
    ...
    async def adelete(self, item: 'SQLiteModelMixin', **kwargs) -> None:
        """
        Deletes the object from the database
        """
        async with self.aconn() as conn:
    ...
    def set(self, item: 'SQLiteModelMixin', skip_set: Optional[bool]=None, skip_index: Optional[bool]=None, **kwargs) -> None:
        """
    ...
    async def aset(self, item: 'SQLiteModelMixin', skip_set: Optional[bool]=None, skip_index: Optional[bool]=None, **kwargs):
        """
        Saves the object to the database
        """
        async with self.aconn() as conn:
    ...
    def set_many(self, items: List['SQLiteModelMixin'], skip_index: Optional[bool]=None, **kwargs):
        """
    ...
    async def aset_many(self, items: List['SQLiteModelMixin'], skip_index: Optional[bool]=None, **kwargs):
        """
        Saves the objects to the database
        """
        item_cls = items[0].__class__
    ...
    async def areindex_from_internal_index(self, include: Optional[List[str]]=None, exclude: Optional[List[str]]=None, **kwargs) -> int:
        """
        Saves all items from the internal index to the DB
        """
        include = include or []
    ...
    def __getitem__(self, name: str) -> Union['SQLiteModelMixin', Any]:
        ...
        """
        if ':' in name:
            tablename, name = name.split(':', 1)
        else:
            tablename = self.default_tablename
