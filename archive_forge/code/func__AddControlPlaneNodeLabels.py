...
def _AddControlPlaneNodeLabels(bare_metal_node_config_group):
  ...
  """
    bare_metal_node_config_group.add_argument('--control-plane-node-labels', metavar='KEY=VALUE', type=arg_parsers.ArgDict(), help='Labels assigned to nodes of a node pool.')