...
import ctypes
import sys
from PyQt5.QtWidgets import QApplication, QTreeView, QFileSystemModel, QVBoxLayout, QWidget, QProgressBar
...
DUPLICATES_DIR = Path("/absolute/path/to/duplicates/directory")
SORTED_DIR = Path("/absolute/path/to/sorted/directory")
ERRORS_DIR = Path("/absolute/path/to/errors/directory")
INDEX_FILE = Path("/absolute/path/to/index.json")
ERROR_INDEX_FILE = Path("/absolute/path/to/error_index.json")
