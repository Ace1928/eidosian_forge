...
class NexusDeviceHandler(DefaultDeviceHandler):
    ...
    def get_xml_extra_prefix_kwargs(self):
        ...
        """
        d = {'nxos': 'http://www.cisco.com/nxos:1.0', 'if': 'http://www.cisco.com/nxos:1.0:if_manager', 'nfcli': 'http://www.cisco.com/nxos:1.0:nfcli', 'vlan_mgr_cli': 'http://www.cisco.com/nxos:1.0:vlan_mgr_cli'}
