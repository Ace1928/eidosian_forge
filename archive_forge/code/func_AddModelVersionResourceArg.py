...
def AddModelVersionResourceArg(parser, verb, prompt_func=region_util.PromptForRegion):
  ...
  """
    name = 'model_version'
    concept_parsers.ConceptParser.ForResource(name, GetModelResourceSpec(prompt_func=prompt_func), 'Model version {}.'.format(verb), required=True).AddToParser(parser)