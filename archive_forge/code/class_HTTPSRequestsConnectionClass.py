...
class HTTPSRequestsConnectionClass:
    ...
    def __init__(self, host: str, port: Optional[int]=None, strict: bool=False, timeout: Optional[int]=None, retry: Optional[Union[int, Retry]]=None, pool_size: Optional[int]=None, **kwargs: Any) -> None:
    ...
    def request(self, verb: str, url: str, input: Optional[Union[str, io.BufferedReader]], headers: Dict[str, str]) -> None:
        self.verb = verb
        self.url = url
        self.input = input
