...
class _ListPhraseSets(SpeechRestStub):
    ...
    def __call__(self, request: cloud_speech.ListPhraseSetsRequest, *, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Optional[float]=None, metadata: Sequence[Tuple[str, str]]=()) -> cloud_speech.ListPhraseSetsResponse:
        """Call the list phrase sets method over HTTP.
            ...
            """
        http_options: List[Dict[str, str]] = [{'method': 'get', 'uri': '/v2/{parent=projects/*/locations/*}/phraseSets'}]
