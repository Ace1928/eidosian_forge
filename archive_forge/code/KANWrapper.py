...
class KANWrapper(KAN):
    def __init__(
        self,
        width: List[int],  # width: List of integers specifying the width of each layer. Typical value: [10, 20, 10]. Range: Any list of positive integers.
        ...
        grid_range: List[int] = [-1, 1],  # grid_range: Range for the grid. Typical value: [-1, 1]. Range: Any list of two integers.
        ...
        learnable_params: Optional[Dict[str, Any]] = None,  # learnable_params: Optional dictionary of additional learnable parameters. Typical value: {"param1": value1}. Range: Any dictionary with string keys and any type of values.
