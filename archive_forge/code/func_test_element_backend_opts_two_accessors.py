...
def test_element_backend_opts_two_accessors(self):
    heat_map = HeatMap([(1, 2, 3), (2, 3, 4), (3, 4, 5)]).opts(colorbar=True, backend_opts={'colorbar': 'Testing'})
    bokeh_renderer.get_plot(heat_map)
    self.log_handler.assertContains('WARNING', "Custom option 'colorbar' expects at least two")