...
def AddDomainArg(parser):
    parser.add_argument('--domain', hidden=True, help='Optional domain name to create a multi-regional load-balancer. This requires both the Serverless Integrations (RunApps) and Compute APIs to be enabled.')