...
class ConfigManager:
    ...
    def load_settings(self) -> dict:
        """
        Loads default model settings from json file.
        If not found, returns default settings.
        """
        try:
    ...
    def save_settings(self):
        ...
        try:
            ...
            if not os.path.exists("indego_chat_settings.json"):
                with open("indego_chat_settings.json", "w") as file:
                    json.dump({self.get_default_settings()}, file)
