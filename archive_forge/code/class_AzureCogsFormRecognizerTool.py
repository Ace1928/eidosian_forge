...
class AzureCogsFormRecognizerTool(BaseTool):
    ...
    description: str = 'A wrapper around Azure Cognitive Services Form Recognizer. Useful for when you need to extract text, tables, and key-value pairs from documents. Input should be a url to a document.'
    ...
    def validate_environment(cls, values: Dict) -> Dict:
        ...
        try:
            ...
            values['doc_analysis_client'] = DocumentAnalysisClient(endpoint=azure_cogs_endpoint, credential=AzureKeyCredential(azure_cogs_key))
        except ImportError:
