...
class RescaleAction(gym.ActionWrapper):
    ...
    def __init__(self, env: gym.Env, min_action: Union[float, int, np.ndarray], max_action: Union[float, int, np.ndarray]):
        ...
        """
        assert isinstance(env.action_space, spaces.Box), f'expected Box action space, got {type(env.action_space)}'
