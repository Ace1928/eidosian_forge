...
class PublisherServiceGrpcAsyncIOTransport(PublisherServiceTransport):
    ...
    def publish(self) -> Callable[[publisher.PublishRequest], Awaitable[publisher.PublishResponse]]:
        ...
        if 'publish' not in self._stubs:
            self._stubs['publish'] = self.grpc_channel.stream_stream('/google.cloud.pubsublite.v1.PublisherService/Publish', request_serializer=publisher.PublishRequest.serialize, response_deserializer=publisher.PublishResponse.deserialize)
