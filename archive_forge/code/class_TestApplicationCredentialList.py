...
class TestApplicationCredentialList(TestApplicationCredential):
    ...
    def setUp(self):
        ...
        self.app_creds_mock.list.return_value = [fakes.FakeResource(None, copy.deepcopy(identity_fakes.APP_CRED_BASIC), loaded=True)]
        self.cmd = application_credential.ListApplicationCredential(self.app, None)
