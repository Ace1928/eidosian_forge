...
class KDBDict(BaseKDBIndex):
    ...
    def postinit(self, primary_key: Optional[str]=None, is_numeric: Optional[bool]=None, is_lookup_index: Optional[bool]=None, auto_expire: Optional[bool]=None, **kwargs):
        """
        Post init hook
        """
    ...
    def name_match_key(self) -> str:
        ...
        """
        return f'{self.name_prefix}.{self.kdb_type}.{self.name}:{self.primary_key}:*' if self.name_prefix_enabled else '*'
    ...
    def get_key(self, key: Optional[str]=None, lookup: Optional[bool]=None) -> str:
        ...
        """
        if lookup:
            return self.get_lookup_key(key)
        if key is None:
    ...
    def nested(self, child_key: Optional[str]=None, key: Optional[str]=None, **kwargs) -> 'KDBDict':
        ...
        return self.__class__(kdb=self.kdb, kdb_type=self.kdb_type, primary_key=new_primary_key, name=self.name, name_prefix=name_prefix, name_prefix_enabled=self.name_prefix_enabled, expiration=expiration, serialization_enabled=serialization_enabled, serializer=serializer, **kwargs)
    ...
    def dict(self, key: Optional[str]=None, exclude: Optional[List[str]]=None, include: Optional[List[str]]=None, exclude_none: bool=False, exclude_unset: bool=False, sort_keys: Optional[bool]=None, sorted_key: Optional[str]=None, sorted_func: Optional[Callable]=None, values_as_keys: Optional[bool]=False, reverse: Optional[bool]=False, **kwargs: Any) -> Dict[str, Any]:
        """
        Returns the dict
        """
    ...
    async def adict(self, key: Optional[str]=None, exclude: Optional[List[str]]=None, include: Optional[List[str]]=None, exclude_none: bool=False, exclude_unset: bool=False, sort_keys: Optional[bool]=None, sorted_key: Optional[str]=None, sorted_func: Optional[Callable]=None, values_as_keys: Optional[bool]=False, reverse: Optional[bool]=False, **kwargs: Any) -> Dict[str, Any]:
        """
        Returns the dict
        """
