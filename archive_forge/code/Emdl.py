...
if spec is not None and spec.loader is not None:
    ...
    activation_types = activation_dictionary_module.activation_types
    logging.info("Activation types loaded successfully from {}".format(module_name))
else:
    error_message = "Failed to load the module for activation functions due to missing spec or loader."
...
class IndegoActivation:
    ...
    def __init__(self):
        ...
        """
        self.activation_types = activation_types  # Populate the activation_types dictionary with mathematical implementations
        ...
        def parallelized_computation(activation_dict):
            ...
            Parameters:
                activation_dict (Dict[str, Callable[[torch.Tensor], torch.Tensor]]): A dictionary containing the activation function names and their corresponding
