...
class ResetSslConfig(base.Command):
    ...
    """
        ...
        console_io.PromptContinue(message='Resetting your SSL configuration will delete all client certificates and generate a new server certificate.', default=True, cancel_on_no=True)
        result_operation = sql_client.instances.ResetSslConfig(sql_messages.SqlInstancesResetSslConfigRequest(project=instance_ref.project, instance=instance_ref.instance))
        ...
        operations.OperationsV1Beta4.WaitForOperation(sql_client, operation_ref, 'Resetting SSL config')
