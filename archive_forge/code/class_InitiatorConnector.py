...
class InitiatorConnector(executor.Executor, metaclass=abc.ABCMeta):
    ...
    def __init__(self, root_helper, driver=None, execute=None, device_scan_attempts=initiator.DEVICE_SCAN_ATTEMPTS_DEFAULT, *args, **kwargs):
        super(InitiatorConnector, self).__init__(root_helper, *args, execute=execute, **kwargs)
