...
from redundant.config_manager import ConfigManager  # Assuming proper path
from redundant.logging_config import configure_logging
from concurrent.futures import ThreadPoolExecutor
from redundant.encryption_key_manager import get_valid_encryption_key
...
def get_cipher_suite() -> Fernet:
    ...
    """
    return Fernet(get_valid_encryption_key())
