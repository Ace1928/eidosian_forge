...
class LinearDict(Generic[TVector], MutableMapping[TVector, Scalar]):
    ...
    def __init__(self, terms: Optional[Mapping[TVector, Scalar]]=None, validator: Optional[Callable[[TVector], bool]]=None) -> None:
    ...
    def _json_dict_(self) -> Dict[Any, Any]:
        ...
        return {'keys': [k for k in self._terms.keys()], 'values': [v for v in self._terms.values()]}
