...
class GrocParser(Parser):
    ...
    def __init__(self, input, state=None):
        ...
        self.dfa4 = self.DFA4(self, 4, eot=self.DFA4_eot, eof=self.DFA4_eof, min=self.DFA4_min, max=self.DFA4_max, accept=self.DFA4_accept, special=self.DFA4_special, transition=self.DFA4_transition)
    ...
    valuesDict = {SUNDAY: 0, FIRST: 1, MONDAY: 1, JANUARY: 1, TUESDAY: 2, SECOND: 2, FEBRUARY: 2, WEDNESDAY: 3, THIRD: 3, MARCH: 3, THURSDAY: 4, FOURTH: 4, APRIL: 4, FRIDAY: 5, FIFTH: 5, MAY: 5, SATURDAY: 6, JUNE: 6, JULY: 7, AUGUST: 8, SEPTEMBER: 9, OCTOBER: 10, NOVEMBER: 11, DECEMBER: 12}
    ...
    def time_range(self):
        ...
        try:
            ...
            pass
        return
    DFA4_eot = DFA.unpack(u'\x0b\uffff')
    DFA4_eof = DFA.unpack(u'\x0b\uffff')
    DFA4_min = DFA.unpack(u'\x01\x06\x01\x13\x01\n\x01\uffff\x02\x04\x01\x0b\x01\uffff\x01\x14\x01\n\x01\x04')
    DFA4_max = DFA.unpack(u'\x01\x10\x02\x1a\x01\uffff\x01\x05\x01\n\x01\x10\x01\uffff\x02\x1a\x01\n')
    DFA4_accept = DFA.unpack(u'\x03\uffff\x01\x01\x03\uffff\x01\x02\x03\uffff')
    DFA4_special = DFA.unpack(u'\x0b\uffff')
    DFA4_transition = [DFA.unpack(u'\x01\x01\x02\x03\x02\uffff\x06\x02'), DFA.unpack(u'\x01\x04\x07\x05'), DFA.unpack(u'\x01\x06\x08\uffff\x01\x04\x07\x05'), DFA.unpack(u''), DFA.unpack(u'\x01\x03\x01\x07'), DFA.unpack(u'\x01\x03\x01\x07\x04\uffff\x01\x08'), DFA.unpack(u'\x06\t'), DFA.unpack(u''), DFA.unpack(u'\x07\n'), DFA.unpack(u'\x01\x06\x08\uffff\x01\x04\x07\x05'), DFA.unpack(u'\x01\x03\x01\x07\x04\uffff\x01\x08')]
    DFA4 = DFA
