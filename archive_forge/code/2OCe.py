...
# KeyDB Configuration
KEYDB_URIS = {
    "development": "keydb://localhost:6379/0",
    "cache": "keydb://localhost:6379/2",
    "public": "keydb://localhost:6379/4",
}
...
async def init_keydb_client():
    ...
    """
    await AsyncKeyDBClient.init_session(uri=KEYDB_URI)
    logging.info("KeyDB client session initialized.")


async_keydb = AsyncKeyDB(host="localhost", port=6379, password="yourpassword")
