...
from core_services import ConfigManager, LoggingManager, EncryptionManager  # Adjusted import for core_services
...
config_manager.load_config(config_path, "ImageProcessing", file_type="ini")
...
ENHANCEMENT_FACTOR: float = float(
    config_manager.get(
        "ImageProcessing", "EnhancementFactor", fallback="1.5"
    )
)
