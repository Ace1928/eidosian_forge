...
def _get_9q_square_qvm(*, client_configuration: QCSClientConfiguration, name: str, noisy: bool, qvm_type: str, compiler_timeout: float, execution_timeout: float) -> QuantumComputer:
    """
