...
class ApikeysV2(base_api.BaseApiClient):
    ...
    class OperationsService(base_api.BaseApiService):
      ...
      """
            ...
            return self._RunMethod(config, request, global_params=global_params)
        Get.method_config = lambda: base_api.ApiMethodInfo(flat_path='v2/operations/{operationsId}', http_method='GET', method_id='apikeys.operations.get', ordered_params=['name'], path_params=['name'], query_params=[], relative_path='v2/{+name}', request_field='', request_type_name='ApikeysOperationsGetRequest', response_type_name='Operation', supports_download=False)
