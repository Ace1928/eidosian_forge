...
def view_sage_jmol(atoms):
    try:
        ...
        raise ImportError('view_sage_jmol requires sage (http://www.sagemath.org/) ' + 'and is intended to be used directly in the browser')
    ...
    for atom in atoms:
        ...
        model += Sphere(radius, color=color).translate(*atom.position - atoms.cell.diagonal() / 2)
