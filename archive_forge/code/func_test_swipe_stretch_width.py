...
def test_swipe_stretch_width(page):
    ...
    swipe = Swipe(before, after, sizing_mode='stretch_width')
    ...
    assert slider_bbox['x'] == bbox['width'] / 2.0 + 3
    slider.drag_to(slider, target_position={'x': bbox['width'] / 4.0, 'y': 0}, force=True)
