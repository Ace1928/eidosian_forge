...
class ConditionalParameterValueDefnumberExprRef(ConditionalValueDefnumberExprRef):
    ...
    def __init__(self, param: Union[str, 'SchemaBase', UndefinedType]=Undefined, value: Union[dict, float, '_Parameter', 'SchemaBase', UndefinedType]=Undefined, empty: Union[bool, UndefinedType]=Undefined, **kwds):
        super(ConditionalParameterValueDefnumberExprRef, self).__init__(param=param, value=value, empty=empty, **kwds)