...
class LinuxHardware(Hardware):
    ...
    BIND_MOUNT_RE = re.compile('.*\\]')
    MTAB_BIND_MOUNT_RE = re.compile('.*bind.*"')
    OCTAL_ESCAPE_RE = re.compile('\\\\[0-9]{3}')
