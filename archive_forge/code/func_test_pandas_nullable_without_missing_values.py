...
@pytest.mark.parametrize(('data', 'dtype', 'expected_dtype'), [([1, 2, 3], 'Int64', 'int64'), ([1, 2, 3], 'Int64[pyarrow]', 'int64'), ([1, 2, 3], 'Int8', 'int8'), ([1, 2, 3], 'Int8[pyarrow]', 'int8'), ([1, 2, 3], 'UInt64', 'uint64'), ([1, 2, 3], 'UInt64[pyarrow]', 'uint64'), ([1.0, 2.25, 5.0], 'Float32', 'float32'), ([1.0, 2.25, 5.0], 'Float32[pyarrow]', 'float32'), ([True, False, False], 'boolean', 'bool'), ([True, False, False], 'boolean[pyarrow]', 'bool'), (['much ado', 'about', 'nothing'], 'string[pyarrow_numpy]', 'large_string'), (['much ado', 'about', 'nothing'], 'string[pyarrow]', 'large_string'), ([datetime(2020, 1, 1), datetime(2020, 1, 2), datetime(2020, 1, 3)], 'timestamp[ns][pyarrow]', 'timestamp[ns]'), ([datetime(2020, 1, 1), datetime(2020, 1, 2), datetime(2020, 1, 3)], 'timestamp[us][pyarrow]', 'timestamp[us]'), ([datetime(2020, 1, 1, tzinfo=timezone.utc), datetime(2020, 1, 2, tzinfo=timezone.utc), datetime(2020, 1, 3, tzinfo=timezone.utc)], 'timestamp[us, Asia/Kathmandu][pyarrow]', 'timestamp[us, tz=Asia/Kathmandu]')])
