...
class Libevdev(_LibraryWrapper):
    ...
    _api_prototypes = {'libevdev_event_type_get_name': {'argtypes': (c_uint,), 'restype': c_char_p}, 'libevdev_event_type_from_name': {'argtypes': (c_char_p,), 'restype': c_int}, 'libevdev_event_code_get_name': {'argtypes': (c_uint, c_uint), 'restype': c_char_p}, 'libevdev_event_code_from_name': {'argtypes': (c_uint, c_char_p), 'restype': c_int}, 'libevdev_event_value_get_name': {'argtypes': (c_uint, c_uint, c_int), 'restype': c_char_p}, 'libevdev_event_value_from_name': {'argtypes': (c_uint, c_uint, c_char_p), 'restype': c_int}, 'libevdev_property_get_name': {'argtypes': (c_uint,), 'restype': c_char_p}, 'libevdev_property_from_name': {'argtypes': (c_char_p,), 'restype': c_int}, 'libevdev_event_type_get_max': {'argtypes': (c_int,), 'restype': c_int}, 'libevdev_new': {'argtypes': (), 'restype': c_void_p}, 'libevdev_free': {'argtypes': (c_void_p,), 'restype': None}, 'libevdev_get_name': {'argtypes': (c_void_p,), 'restype': c_char_p}, 'libevdev_set_name': {'argtypes': (c_void_p, c_char_p), 'restype': None}, 'libevdev_get_phys': {'argtypes': (c_void_p,), 'restype': c_char_p}, 'libevdev_set_phys': {'argtypes': (c_void_p, c_char_p), 'restype': None}, 'libevdev_get_uniq': {'argtypes': (c_void_p,), 'restype': c_char_p}, 'libevdev_set_uniq': {'argtypes': (c_void_p, c_char_p), 'restype': None}, 'libevdev_get_driver_version': {'argtypes': (c_void_p,), 'restype': c_int}, 'libevdev_set_clock_id': {'argtypes': (c_void_p, c_int), 'restype': c_int}, 'libevdev_get_id_bustype': {'argtypes': (c_void_p,), 'restype': c_int}, 'libevdev_get_id_vendor': {'argtypes': (c_void_p,), 'restype': c_int}, 'libevdev_get_id_product': {'argtypes': (c_void_p,), 'restype': c_int}, 'libevdev_get_id_version': {'argtypes': (c_void_p,), 'restype': c_int}, 'libevdev_set_id_bustype': {'argtypes': (c_void_p, c_int), 'restype': None}, 'libevdev_set_id_vendor': {'argtypes': (c_void_p, c_int), 'restype': None}, 'libevdev_set_id_product': {'argtypes': (c_void_p, c_int), 'restype': None}, 'libevdev_set_id_version': {'argtypes': (c_void_p, c_int), 'restype': None}, 'libevdev_set_fd': {'argtypes': (c_void_p, c_int), 'restype': c_int}, 'libevdev_change_fd': {'argtypes': (c_void_p, c_int), 'restype': c_int}, 'libevdev_get_fd': {'argtypes': (c_void_p,), 'restype': c_int}, 'libevdev_grab': {'argtypes': (c_void_p, c_int), 'restype': c_int}, 'libevdev_get_abs_info': {'argtypes': (c_void_p, c_int), 'restype': ctypes.POINTER(_InputAbsinfo)}, 'libevdev_kernel_set_abs_info': {'argtypes': (c_void_p, c_int, ctypes.POINTER(_InputAbsinfo)), 'restype': c_int}, 'libevdev_kernel_set_led_value': {'argtypes': (c_void_p, c_int, c_int), 'restype': c_int}, 'libevdev_has_property': {'argtypes': (c_void_p, c_int), 'restype': c_int}, 'libevdev_has_event_type': {'argtypes': (c_void_p, c_int), 'restype': c_int}, 'libevdev_has_event_code': {'argtypes': (c_void_p, c_int, c_int), 'restype': c_int}, 'libevdev_set_event_value': {'argtypes': (c_void_p, c_int, c_int, c_int), 'restype': c_int}, 'libevdev_get_event_value': {'argtypes': (c_void_p, c_int, c_int), 'restype': c_int}, 'libevdev_enable_event_type': {'argtypes': (c_void_p, c_int), 'restype': c_int}, 'libevdev_enable_event_code': {'argtypes': (c_void_p, c_int, c_int, c_void_p), 'restype': c_int}, 'libevdev_disable_event_type': {'argtypes': (c_void_p, c_int), 'restype': c_int}, 'libevdev_disable_event_code': {'argtypes': (c_void_p, c_int, c_int), 'restype': c_int}, 'libevdev_enable_property': {'argtypes': (c_void_p, c_int), 'restype': c_int}, 'libevdev_next_event': {'argtypes': (c_void_p, c_uint, ctypes.POINTER(_InputEvent)), 'restype': c_int}, 'libevdev_get_num_slots': {'argtypes': (c_void_p,), 'restype': c_int}, 'libevdev_get_current_slot': {'argtypes': (c_void_p,), 'restype': c_int}, 'libevdev_get_slot_value': {'argtypes': (c_void_p, c_uint, c_uint), 'restype': c_int}, 'libevdev_set_slot_value': {'argtypes': (c_void_p, c_uint, c_uint, c_int), 'restype': c_int}, 'libevdev_has_event_pending': {'argtypes': (c_void_p,), 'restype': c_int}}
    ...
    def enable(self, event_type, event_code=None, data=None):
        ...
        if c is None:
            ...
            if t == 3:
                data = _InputAbsinfo(data.get('value', 0), data.get('minimum', 0), data.get('maximum', 0), data.get('fuzz', 0), data.get('flat', 0), data.get('resolution', 0))
