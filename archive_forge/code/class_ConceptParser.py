...
class ConceptParser(object):
    ...
    """
        ...
        for spec in specs:
            self._AddSpec(spec)
        self._command_level_fallthroughs = self._ValidateAndFormatFallthroughsMap(command_level_fallthroughs or {})
    ...
    """
        ...
        for spec_name, spec in six.iteritems(self._specs):
            ...
            runtime_handler.AddConcept(util.NormalizeFormat(spec_name), concept_info, required=spec.required)
