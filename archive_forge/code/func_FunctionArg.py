...
def FunctionArg():
    ...
    return base.Argument('--function', hidden=True, help='Specifies that the deployed object is a function. If a value is provided, that value is used as the entrypoint.')