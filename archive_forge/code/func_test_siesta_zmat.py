...
def test_siesta_zmat(siesta_factory):
    ...
    custom_dir = './dir1/'
    siesta = siesta_factory.calc(label=custom_dir + 'test_label', symlink_pseudos=False, atomic_coord_format='zmatrix', fdf_arguments={'MD.TypeOfRun': 'CG', 'MD.NumCGsteps': 1000})
    atoms.calc = siesta
