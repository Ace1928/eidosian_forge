...
class JsonSchemaEvaluator(StringEvaluator):
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        try:
            ...
            raise ImportError('The JsonSchemaEvaluator requires the jsonschema package. Please install it with `pip install jsonschema`.')
    ...
    def _evaluate_strings(self, prediction: Union[str, Any], input: Union[str, Any]=None, reference: Union[str, Any]=None, **kwargs: Any) -> dict:
