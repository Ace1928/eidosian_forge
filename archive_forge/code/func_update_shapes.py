...
def update_shapes(self, patch=None, selector=None, row=None, col=None, secondary_y=None, **kwargs) -> 'Figure':
    """
        ...
        **kwargs
        ...
        """
    for obj in self._select_annotations_like(prop='shapes', selector=selector, row=row, col=col, secondary_y=secondary_y):
