...
def test_share_network_security_service_list_select_column(self):
    self.run_command('share-network-security-service-list fake_share_nw --column id,name')
    self.assert_called('GET', '/security-services/detail?share_network_id=1234')
