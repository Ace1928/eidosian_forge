...
class _UpdateConfig(SpeechRestStub):
    ...
    def __call__(self, request: cloud_speech.UpdateConfigRequest, *, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Optional[float]=None, metadata: Sequence[Tuple[str, str]]=()) -> cloud_speech.Config:
        """Call the update config method over HTTP.
            ...
            """
        http_options: List[Dict[str, str]] = [{'method': 'patch', 'uri': '/v2/{config.name=projects/*/locations/*/config}', 'body': 'config'}]
