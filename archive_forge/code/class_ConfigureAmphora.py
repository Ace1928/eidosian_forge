...
class ConfigureAmphora(command.Command):
    ...
    def get_parser(self, prog_name):
        ...
        parser.add_argument('amphora_id', metavar='<amphora-id>', help='UUID of the amphora to configure.')
    ...
    def take_action(self, parsed_args):
        ...
        self.app.client_manager.load_balancer.amphora_configure(amphora_id=amp_id)
        if parsed_args.wait:
