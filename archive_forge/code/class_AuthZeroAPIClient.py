...
class AuthZeroAPIClient(ABC):
    ...
    def __init__(self, endpoint: Optional[Union[str, List[str]]]=None, api_key: Optional[str]=None, api_client_id: Optional[str]=None, api_client_env: Optional[str]=None, audience: Optional[str]=None, oauth_url: Optional[str]=None, client_id: Optional[str]=None, client_secret: Optional[str]=None, session_enabled: Optional[bool]=None, verbose: Optional[bool]=False, **kwargs):
        ...
        if api_client_env is not None:
            self.api_client_env = api_client_env
    ...
    def auth(self) -> 'AuthZeroTokenAuth':
        ...
        if self._auth is None:
            self._auth = get_az_resource('auth_zero_token_auth', token_flow=self.token_flow)
    ...
    def data(self) -> Dict[str, Any]:
        ...
        if self._data is None:
            self._data = self.token_flow.load_data()
        return self._data
    ...
    def check_available(self) -> bool:
        ...
        try:
            ...
            if self.verbose:
                logger.warning(f'[{response.status_code} - {self.name}] Error checking API availability: {e}')
            return False
    ...
    def get_request_kwargs(self, timeout: Optional[float]=None, **kwargs) -> Dict[str, Any]:
        ...
        return {'timeout': timeout if timeout is not None else self.default_timeout, 'auth': auth, **kwargs}
