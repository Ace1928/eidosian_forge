...
class PlotlyPlot(LayoutDOM):
    ...
    a bokeh plot.
    """
    __javascript_raw__ = [JS_URLS['jQuery'], 'https://cdn.plot.ly/plotly-2.25.2.min.js']
    ...
    __js_require__ = {'paths': {'plotly': 'https://cdn.plot.ly/plotly-2.25.2.min'}, 'exports': {'plotly': 'Plotly'}}
    data = List(Any)
