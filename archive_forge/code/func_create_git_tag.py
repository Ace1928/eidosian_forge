...
def create_git_tag(self, tag: str, message: str, object: str, type: str, tagger: Opt[InputGitAuthor]=NotSet) -> GitTag:
    """
    ...
    post_parameters: dict[str, Any] = {'tag': tag, 'message': message, 'object': object, 'type': type}
