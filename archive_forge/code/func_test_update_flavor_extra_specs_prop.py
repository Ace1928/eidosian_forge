...
def test_update_flavor_extra_specs_prop(self):
    self._verify('openstack.compute.v2.flavor.Flavor.update_extra_specs_property', self.proxy.update_flavor_extra_specs_property, method_args=['value', 'prop', 'val'], expected_args=[self.proxy, 'prop', 'val'])