...
class Optimizer1State(Optimizer8bit):
    ...
    def __init__(self, optimizer_name, params, lr=0.001, betas=(0.9, 0.0), eps=1e-08, weight_decay=0.0, optim_bits=32, args=None, min_8bit_size=4096, percentile_clipping=100, block_wise=True, max_unorm=0.0, skip_zeros=False, is_paged=False):
        """
