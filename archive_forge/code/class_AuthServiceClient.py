...
class AuthServiceClient:
    ...
    def create_user(self, username: str, password: str):
        ...
        .. code-block:: text
            ...
            is_admin: False
        """
        resp = self._request(CREATE_USER, 'POST', json={'username': username, 'password': password})
    ...
    def get_user(self, username: str):
        ...
        .. code-block:: text
            ...
            is_admin: False
        """
        resp = self._request(GET_USER, 'GET', params={'username': username})
        return User.from_json(resp['user'])
    ...
    def update_user_password(self, username: str, password: str):
        ...
        """
        self._request(UPDATE_USER_PASSWORD, 'PATCH', json={'username': username, 'password': password})
    ...
    def update_user_admin(self, username: str, is_admin: bool):
        ...
        """
        self._request(UPDATE_USER_ADMIN, 'PATCH', json={'username': username, 'is_admin': is_admin})
    ...
    def delete_user(self, username: str):
        ...
        """
        self._request(DELETE_USER, 'DELETE', json={'username': username})
    ...
    def create_experiment_permission(self, experiment_id: str, username: str, permission: str):
        ...
        .. code-block:: text
            ...
            permission: READ
        """
        resp = self._request(CREATE_EXPERIMENT_PERMISSION, 'POST', json={'experiment_id': experiment_id, 'username': username, 'permission': permission})
    ...
    def get_experiment_permission(self, experiment_id: str, username: str):
        ...
        .. code-block:: text
            ...
            permission: READ
        """
        resp = self._request(GET_EXPERIMENT_PERMISSION, 'GET', params={'experiment_id': experiment_id, 'username': username})
        return ExperimentPermission.from_json(resp['experiment_permission'])
    ...
    def update_experiment_permission(self, experiment_id: str, username: str, permission: str):
        ...
        """
        self._request(UPDATE_EXPERIMENT_PERMISSION, 'PATCH', json={'experiment_id': experiment_id, 'username': username, 'permission': permission})
    ...
    def delete_experiment_permission(self, experiment_id: str, username: str):
        ...
        """
        self._request(DELETE_EXPERIMENT_PERMISSION, 'DELETE', json={'experiment_id': experiment_id, 'username': username})
    ...
    def create_registered_model_permission(self, name: str, username: str, permission: str):
        ...
        """
        resp = self._request(CREATE_REGISTERED_MODEL_PERMISSION, 'POST', json={'name': name, 'username': username, 'permission': permission})
    ...
    def get_registered_model_permission(self, name: str, username: str):
        ...
        .. code-block:: text
            ...
            permission: READ
        """
        resp = self._request(GET_REGISTERED_MODEL_PERMISSION, 'GET', params={'name': name, 'username': username})
        return RegisteredModelPermission.from_json(resp['registered_model_permission'])
    ...
    def update_registered_model_permission(self, name: str, username: str, permission: str):
        ...
        """
        self._request(UPDATE_REGISTERED_MODEL_PERMISSION, 'PATCH', json={'name': name, 'username': username, 'permission': permission})
    ...
    def delete_registered_model_permission(self, name: str, username: str):
        ...
        """
        self._request(DELETE_REGISTERED_MODEL_PERMISSION, 'DELETE', json={'name': name, 'username': username})