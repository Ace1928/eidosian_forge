...
@base.Deprecate(is_removed=False, warning='This command is deprecated and will not be promoted to GA. Please use `gcloud beta instance-groups managed update` instead.')
...
class SetAutohealing(base.Command):
  ...
  """
    ...
    def Run(self, args):
        ...
        auto_healing_policies = managed_instance_groups_utils.CreateAutohealingPolicies(client.messages, health_check, args.initial_delay)
        ...
        igm_resource = messages.InstanceGroupManager(autoHealingPolicies=auto_healing_policies)
