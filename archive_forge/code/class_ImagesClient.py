...
class ImagesClient(ClientEntityBase):
    ...
    def get_actions_list(self, image: Image | BoundImage, sort: list[str] | None=None, page: int | None=None, per_page: int | None=None, status: list[str] | None=None) -> ActionsPageResult:
        ...
        response = self._client.request(url=f'/images/{image.id}/actions', method='GET', params=params)
        actions = [BoundAction(self._client.actions, action_data) for action_data in response['actions']]
        return ActionsPageResult(actions, Meta.parse_meta(response))

    def get_actions(self, image: Image | BoundImage, sort: list[str] | None=None, status: list[str] | None=None) -> list[BoundAction]:
        ...
        """
        return self._iter_pages(self.get_actions_list, image, sort=sort, status=status)
    ...
    def get_list(self, name: str | None=None, label_selector: str | None=None, bound_to: list[str] | None=None, type: list[str] | None=None, architecture: list[str] | None=None, sort: list[str] | None=None, page: int | None=None, per_page: int | None=None, status: list[str] | None=None, include_deprecated: bool | None=None) -> ImagesPageResult:
        """Get all images
    ...
    def get_all(self, name: str | None=None, label_selector: str | None=None, bound_to: list[str] | None=None, type: list[str] | None=None, architecture: list[str] | None=None, sort: list[str] | None=None, status: list[str] | None=None, include_deprecated: bool | None=None) -> list[BoundImage]:
        """Get all images
        ...
        """
        return self._iter_pages(self.get_list, name=name, label_selector=label_selector, bound_to=bound_to, type=type, architecture=architecture, sort=sort, status=status, include_deprecated=include_deprecated)
    ...
    def update(self, image: Image | BoundImage, description: str | None=None, type: str | None=None, labels: dict[str, str] | None=None) -> BoundImage:
        ...
        response = self._client.request(url=f'/images/{image.id}', method='PUT', json=data)
        return BoundImage(self, response['image'])
    ...
    def change_protection(self, image: Image | BoundImage, delete: bool | None=None) -> BoundAction:
        ...
        response = self._client.request(url=f'/images/{image.id}/actions/change_protection', method='POST', json=data)
