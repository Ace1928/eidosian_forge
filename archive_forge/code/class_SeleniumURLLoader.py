...
class SeleniumURLLoader(BaseLoader):
    ...
    def __init__(self, urls: List[str], continue_on_failure: bool=True, browser: Literal['chrome', 'firefox']='chrome', binary_location: Optional[str]=None, executable_path: Optional[str]=None, headless: bool=True, arguments: List[str]=[]):
    ...
    def _build_metadata(self, url: str, driver: Union['Chrome', 'Firefox']) -> dict:
        ...
        metadata = {'source': url, 'title': 'No title found.', 'description': 'No description found.', 'language': 'No language found.'}
