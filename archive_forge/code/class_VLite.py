...
class VLite(VectorStore):
    ...
    def __init__(self, embedding_function: Embeddings, collection: Optional[str]=None, **kwargs: Any):
        super().__init__()
    ...
    def add_texts(self, texts: Iterable[str], metadatas: Optional[List[dict]]=None, **kwargs: Any) -> List[str]:
        ...
        data_points = [{'text': text, 'metadata': metadata, 'id': id, 'embedding': embedding} for text, metadata, id, embedding in zip(texts, metadatas, ids, embeddings)]
    ...
    def similarity_search_with_score(self, query: str, k: int=4, filter: Optional[Dict[str, str]]=None, **kwargs: Any) -> List[Tuple[Document, float]]:
        """Return docs most similar to query.
        ...
        results = self.vlite.retrieve(text=query, top_k=k, metadata=metadata, return_scores=True, embedding=embedding)
    ...
    @classmethod
    def from_existing_index(cls, embedding: Embeddings, collection: str, **kwargs: Any) -> VLite:
    ...
    @classmethod
    def from_texts(cls, texts: List[str], embedding: Embeddings, metadatas: Optional[List[dict]]=None, collection: Optional[str]=None, **kwargs: Any) -> VLite:
    ...
    @classmethod
    def from_documents(cls, documents: List[Document], embedding: Embeddings, collection: Optional[str]=None, **kwargs: Any) -> VLite:
