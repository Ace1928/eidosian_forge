...
class _FakeEnvMixin(object):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self._fake_malmo_data = np.load(os.path.join(os.path.abspath(os.path.dirname(__file__)), 'info.npz'), allow_pickle=True)['arr_0'].tolist()
    ...
    def step(self, action) -> Tuple[Dict[str, Dict[str, Any]], Dict[str, float], Dict[str, bool], Dict[str, Dict[str, Any]]]:
