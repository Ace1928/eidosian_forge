...
import six
def _GetSqliteStoreWithCache(sqlite_credential_file=None, sqlite_access_token_file=None):
    """Get a sqlite-based Credential Store."""
    credential_store = _GetSqliteStore(sqlite_credential_file)
    sqlite_access_token_file = sqlite_access_token_file or config.Paths().access_token_db_path
