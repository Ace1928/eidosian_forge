...
def testMapboxRangeYCallbackEventData(self):
    ...
    event_data = RangeYCallback.get_event_data_from_property_update('relayout_data', relayout_data, self.mapbox_fig_dict)
    self.assertEqual(event_data, {'first': {'y_range': self.northing_range1}, 'third': {'y_range': self.northing_range2}})