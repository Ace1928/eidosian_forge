...
class ResourceDocumenter(BaseDocumenter):
    ...
    def _add_description(self, section):
        ...
        section.write('A resource representing an %s %s' % (official_service_name, self._resource_name))
    ...
    def _add_example(self, section, identifier_names):
        ...
        section.write('%s = %s.%s(%s)' % (xform_name(self._resource_name), self._service_name, self._resource_name, example_values))
