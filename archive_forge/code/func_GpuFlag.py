...
def GpuFlag():
    """Add the --gpu flag."""
    return base.Argument('--gpu', metavar='GPU', hidden=True, help='Cloud Run supports values 0 or 1.  1 gpu also requires a minimum 4 `--cpu` value  1 gpu also requires a minimum 8Gi `--memory` value.')