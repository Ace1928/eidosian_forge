...
class ListObjectsPager:
    ...
    def __init__(self, method: Callable[..., storage.ListObjectsResponse], request: storage.ListObjectsRequest, response: storage.ListObjectsResponse, *, metadata: Sequence[Tuple[str, str]]=()):
