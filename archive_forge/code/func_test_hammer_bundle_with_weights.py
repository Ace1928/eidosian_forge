...
def test_hammer_bundle_with_weights(nodes, weighted_edges, include_edge_id):
    data = pd.DataFrame({'edge_id': [1.0, np.nan, 2.0, np.nan, 3.0, np.nan, 4.0, np.nan], 'x': [0.0, np.nan, 0.0, np.nan, 0.0, np.nan, 0.0, np.nan], 'y': [0.0, np.nan, 0.0, np.nan, 0.0, np.nan, 0.0, np.nan], 'weight': [1.0, np.nan, 1.0, np.nan, 1.0, np.nan, 1.0, np.nan]})
