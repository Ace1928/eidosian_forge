...
def xla_launch_eager_fallback(constants, args, resources: List[_atypes.TensorFuzzingAnnotation[_atypes.Resource]], Tresults, function, name, ctx):
    ...
    _attrs = ('Tconstants', _attr_Tconstants, 'Targs', _attr_Targs, 'Nresources', _attr_Nresources, 'Tresults', Tresults, 'function', function)
    _result = _execute.execute(b'XlaLaunch', len(Tresults), inputs=_inputs_flat, attrs=_attrs, ctx=ctx, name=name)
