...
def test_raster_quadmesh_autorange(array_module):
    ...
    out = xr.DataArray(array_module.array([[1.0, 1.0, 2.0, 2.0, 3.0, 3.0, 4.0, 4.0], [1.0, 1.0, 2.0, 2.0, 3.0, 3.0, 4.0, 4.0], [5.0, 5.0, 6.0, 6.0, 7.0, 7.0, 8.0, 8.0], [5.0, 5.0, 6.0, 6.0, 7.0, 7.0, 8.0, 8.0]], dtype='f8'), coords=[('b', y_coords), ('a', x_coords)])
