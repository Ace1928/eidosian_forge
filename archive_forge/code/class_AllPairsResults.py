...
class AllPairsResults:
    ...
    def __init__(self, pvals_raw, all_pairs, multitest_method='hs', levels=None, n_levels=None):
        ...
        if levels is None:
            ...
            self.all_pairs_names = ['{}-{}'.format(levels[pairs[0]], levels[pairs[1]]) for pairs in all_pairs]
    ...
    def summary(self):
        ...
        text += '\n'.join(('{}  {:6.4g}'.format(pairs, pv) for pairs, pv in zip(self.all_pairs_names, self.pval_corrected())))
        return text