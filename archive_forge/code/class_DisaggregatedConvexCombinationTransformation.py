...
@TransformationFactory.register('contrib.piecewise.disaggregated_convex_combination', doc="Convert piecewise-linear model to a GDP to 'Disaggregated Convex Combination' MIP formulation.")
