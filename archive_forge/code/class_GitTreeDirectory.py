...
class GitTreeDirectory(_mod_tree.TreeDirectory):
    ...
    def __repr__(self):
        return '{}(file_id={!r}, name={!r}, parent_id={!r})'.format(self.__class__.__name__, self.file_id, self.name, self.parent_id)

    def __eq__(self, other):
        return self.kind == other.kind and self.file_id == other.file_id and (self.name == other.name) and (self.parent_id == other.parent_id)