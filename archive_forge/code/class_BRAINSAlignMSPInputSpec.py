...
class BRAINSAlignMSPInputSpec(CommandLineInputSpec):
    ...
    mspQualityLevel = traits.Int(desc=',           Flag controls how aggressive the MSP is estimated.  0=quick estimate (9 seconds), 1=normal estimate (11 seconds), 2=great estimate (22 seconds), 3=best estimate (58 seconds).,       ', argstr='--mspQualityLevel %d')
