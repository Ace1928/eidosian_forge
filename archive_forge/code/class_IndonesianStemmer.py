...
class IndonesianStemmer(BaseStemmer):
    ...
    a_2 = [Among(u'i', -1, 1, '_IndonesianStemmer__r_SUFFIX_I_OK'), Among(u'an', -1, 1, '_IndonesianStemmer__r_SUFFIX_AN_OK'), Among(u'kan', 1, 1, '_IndonesianStemmer__r_SUFFIX_KAN_OK')]
    a_3 = [Among(u'di', -1, 1), Among(u'ke', -1, 2), Among(u'me', -1, 1), Among(u'mem', 2, 5), Among(u'men', 2, 1), Among(u'meng', 4, 1), Among(u'meny', 4, 3, '_IndonesianStemmer__r_VOWEL'), Among(u'pem', -1, 6), Among(u'pen', -1, 2), Among(u'peng', 8, 2), Among(u'peny', 8, 4, '_IndonesianStemmer__r_VOWEL'), Among(u'ter', -1, 1)]
    a_4 = [Among(u'be', -1, 3, '_IndonesianStemmer__r_KER'), Among(u'belajar', 0, 4), Among(u'ber', 0, 3), Among(u'pe', -1, 1), Among(u'pelajar', 3, 2), Among(u'per', 3, 1)]
    g_vowel = [17, 65, 16]
    I_prefix = 0
    I_measure = 0
