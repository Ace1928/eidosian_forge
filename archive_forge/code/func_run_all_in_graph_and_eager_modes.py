...
def run_all_in_graph_and_eager_modes(cls):
    ...
    for name in dir(cls):
        if not name.startswith(unittest.TestLoader.testMethodPrefix) or name.startswith('testSkipEager') or name.startswith('test_skip_eager') or (name == 'test_session') or (name == 'test_scope'):
            continue
