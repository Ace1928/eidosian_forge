...
class ExternalVpnGatewayHelper(object):
    ...
    def WaitForOperation(self, external_vpn_gateway_ref, operation_ref, wait_message):
    ...
    """
        request = self._messages.ComputeExternalVpnGatewaysInsertRequest(project=ref.project, externalVpnGateway=external_vpn_gateway)
    ...
    """
        request = self._messages.ComputeExternalVpnGatewaysGetRequest(project=ref.project, externalVpnGateway=ref.Name())
    ...
    """
        request = self._messages.ComputeExternalVpnGatewaysDeleteRequest(project=ref.project, externalVpnGateway=ref.Name())
    ...
    """
        set_labels_request = self._messages.GlobalSetLabelsRequest(labelFingerprint=existing_label_fingerprint, labels=new_labels)
        request = self._messages.ComputeExternalVpnGatewaysSetLabelsRequest(project=ref.project, resource=ref.Name(), globalSetLabelsRequest=set_labels_request)
