...
class JobRunsClient(object):
    ...
    """
        ...
        self._service = self.client.projects_locations_deliveryPipelines_releases_rollouts_jobRuns

    def Terminate(self, name, override_deploy_policies=None):
    ...
    """
        ...
        request = self.messages.ClouddeployProjectsLocationsDeliveryPipelinesReleasesRolloutsJobRunsTerminateRequest(name=name, terminateJobRunRequest=self.messages.TerminateJobRunRequest(overrideDeployPolicy=override_deploy_policies))
