...
class AdaptationClient(metaclass=AdaptationClientMeta):
    ...
    def parse_phrase_set_path(path: str) -> Dict[str, str]:
        ...
        m = re.match('^projects/(?P<project>.+?)/locations/(?P<location>.+?)/phraseSets/(?P<phrase_set>.+?)$', path)
        return m.groupdict() if m else {}
    ...
    def _validate_universe_domain(self):
        ...
        """
        self._is_universe_domain_valid = self._is_universe_domain_valid or AdaptationClient._compare_universes(self.universe_domain, self.transport._credentials)
    ...
    def __init__(self, *, credentials: Optional[ga_credentials.Credentials]=None, transport: Optional[Union[str, AdaptationTransport]]=None, client_options: Optional[Union[client_options_lib.ClientOptions, dict]]=None, client_info: gapic_v1.client_info.ClientInfo=DEFAULT_CLIENT_INFO) -> None:
        ...
        self._api_endpoint = self._api_endpoint or AdaptationClient._get_api_endpoint(self._client_options.api_endpoint, self._client_cert_source, self._universe_domain, self._use_mtls_endpoint)
    ...
    def create_phrase_set(self, request: Optional[Union[cloud_speech_adaptation.CreatePhraseSetRequest, dict]]=None, *, parent: Optional[str]=None, phrase_set: Optional[resource.PhraseSet]=None, phrase_set_id: Optional[str]=None, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> resource.PhraseSet:
    ...
    def get_phrase_set(self, request: Optional[Union[cloud_speech_adaptation.GetPhraseSetRequest, dict]]=None, *, name: Optional[str]=None, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> resource.PhraseSet:
        """Get a phrase set.
    ...
    def list_phrase_set(self, request: Optional[Union[cloud_speech_adaptation.ListPhraseSetRequest, dict]]=None, *, parent: Optional[str]=None, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> pagers.ListPhraseSetPager:
        """List phrase sets.
        ...
        self._validate_universe_domain()
        response = rpc(request, retry=retry, timeout=timeout, metadata=metadata)
        response = pagers.ListPhraseSetPager(method=rpc, request=request, response=response, metadata=metadata)
        return response

    def update_phrase_set(self, request: Optional[Union[cloud_speech_adaptation.UpdatePhraseSetRequest, dict]]=None, *, phrase_set: Optional[resource.PhraseSet]=None, update_mask: Optional[field_mask_pb2.FieldMask]=None, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> resource.PhraseSet:
        """Update a phrase set.
    ...
    def delete_phrase_set(self, request: Optional[Union[cloud_speech_adaptation.DeletePhraseSetRequest, dict]]=None, *, name: Optional[str]=None, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> None:
        """Delete a phrase set.
    ...
    def create_custom_class(self, request: Optional[Union[cloud_speech_adaptation.CreateCustomClassRequest, dict]]=None, *, parent: Optional[str]=None, custom_class: Optional[resource.CustomClass]=None, custom_class_id: Optional[str]=None, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> resource.CustomClass:
    ...
    def get_custom_class(self, request: Optional[Union[cloud_speech_adaptation.GetCustomClassRequest, dict]]=None, *, name: Optional[str]=None, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> resource.CustomClass:
        """Get a custom class.
    ...
    def list_custom_classes(self, request: Optional[Union[cloud_speech_adaptation.ListCustomClassesRequest, dict]]=None, *, parent: Optional[str]=None, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> pagers.ListCustomClassesPager:
        """List custom classes.
        ...
        self._validate_universe_domain()
        response = rpc(request, retry=retry, timeout=timeout, metadata=metadata)
        response = pagers.ListCustomClassesPager(method=rpc, request=request, response=response, metadata=metadata)
        return response

    def update_custom_class(self, request: Optional[Union[cloud_speech_adaptation.UpdateCustomClassRequest, dict]]=None, *, custom_class: Optional[resource.CustomClass]=None, update_mask: Optional[field_mask_pb2.FieldMask]=None, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> resource.CustomClass:
    ...
    def delete_custom_class(self, request: Optional[Union[cloud_speech_adaptation.DeleteCustomClassRequest, dict]]=None, *, name: Optional[str]=None, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> None:
