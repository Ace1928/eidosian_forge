...
@pytest.mark.parametrize('geometry,expected', [(Point(0, 0.5), []), ([Point(0, 0.5)], [[], []]), (box(0, 0, 1.5, 1.5), []), ([box(0, 0, 1.5, 1.5)], [[], []]), (shapely.buffer(Point(3, 3), HALF_UNIT_DIAG), []), ([shapely.buffer(Point(3, 3), HALF_UNIT_DIAG)], [[], []]), (MultiPoint([[5, 7], [7, 7], [7, 8]]), [7]), ([MultiPoint([[5, 7], [7, 7], [7, 8]])], [[0], [7]])])
