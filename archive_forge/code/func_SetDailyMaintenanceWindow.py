...
def SetDailyMaintenanceWindow(self, cluster_ref, existing_policy, maintenance_window):
    """Sets the daily maintenance window for a cluster."""
    if maintenance_window == 'None':
        daily_window = None
    else:
        daily_window = self.messages.DailyMaintenanceWindow(startTime=maintenance_window)
