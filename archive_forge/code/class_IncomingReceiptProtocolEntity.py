...
class IncomingReceiptProtocolEntity(ReceiptProtocolEntity):
    ...
    def fromProtocolTreeNode(node):
        ...
        return IncomingReceiptProtocolEntity(node.getAttributeValue('id'), node.getAttributeValue('from'), node.getAttributeValue('t'), node.getAttributeValue('offline'), node.getAttributeValue('type'), node.getAttributeValue('participant'), items)