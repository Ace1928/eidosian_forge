...
class geom_boxplot(geom):
    ...
    def __init__(self, mapping: aes | None=None, data: DataLike | None=None, **kwargs: Any):
        ...
        if varwidth:
            ...
            elif isinstance(_position, position) and _position.params['preserve'] == 'total':
                warn('Cannot preserve total widths when varwidth=True', PlotnineWarning, stacklevel=2)
