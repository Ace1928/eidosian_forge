...
class ListSessionsPager:
    ...
    def __init__(self, method: Callable[..., spanner.ListSessionsResponse], request: spanner.ListSessionsRequest, response: spanner.ListSessionsResponse, *, metadata: Sequence[Tuple[str, str]]=()):
