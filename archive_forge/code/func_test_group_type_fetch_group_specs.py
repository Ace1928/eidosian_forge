...
def test_group_type_fetch_group_specs(self):
    self._verify('openstack.block_storage.v3.group_type.GroupType.fetch_group_specs', self.proxy.fetch_group_type_group_specs, method_args=['value'], expected_args=[self.proxy])