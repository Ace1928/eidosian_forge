...
<participant jid="{{participant_jid}}">
    ...
    def __init__(self, _id, _from, timestamp, notify, participant, offline, subject, participants):
    ...
    def fromProtocolTreeNode(node):
        ...
        return RemoveGroupsNotificationProtocolEntity(node['id'], node['from'], node['t'], node['notify'], node['participant'], node['offline'], removeNode['subject'], participants)