...
class HumanRendering(gym.Wrapper):
    ...
    def __init__(self, env):
        ...
        """
        super().__init__(env)
        assert env.render_mode in ['rgb_array', 'rgb_array_list'], f"Expected env.render_mode to be one of 'rgb_array' or 'rgb_array_list' but got '{env.render_mode}'"
        assert 'render_fps' in env.metadata, "The base environment must specify 'render_fps' to be used with the HumanRendering wrapper"
