...
def BaseImageArg():
    ...
    group.AddArgument(base.Argument('--base-image', hidden=True, help='Opts in to use automatic base image updates using the specified image.'))
    group.AddArgument(base.Argument('--clear-base-image', action='store_true', hidden=True, help='Opts out of use of automatic base image updates.'))
    return group