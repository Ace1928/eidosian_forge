...
class TransportDecorator(Transport):
    ...
    def __init__(self, url, _decorated=None, _from_transport=None):
        ...
        if not url.startswith(prefix):
            raise ValueError("url %r doesn't start with decorator prefix %r" % (url, prefix))
    ...
    def clone(self, offset=None):
        ...
        return self.__class__(self._get_url_prefix() + decorated_clone.base, decorated_clone, self)
    ...
    segment_parameters = property(_get_segment_parameters, _set_segment_parameters, doc='See Transport.segment_parameters')
