...
import numpy as np
def hcp0001_root(symbol, root, size, a=None, c=None, vacuum=None, orthogonal=False):
    ...
    atoms = hcp0001(symbol=symbol, size=(1, 1, size[2]), a=a, c=c, vacuum=vacuum, orthogonal=orthogonal)
