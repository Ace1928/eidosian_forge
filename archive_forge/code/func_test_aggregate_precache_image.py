...
def test_aggregate_precache_image(self):
    self._verify('openstack.compute.v2.aggregate.Aggregate.precache_images', self.proxy.aggregate_precache_images, method_args=['value', '1'], expected_args=[self.proxy, [{'id': '1'}]])