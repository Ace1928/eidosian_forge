...
def translate_properties(self, properties, client_resolve=True, ignore_resolve_error=False):
    ...
    properties.update_translation(rules, client_resolve=client_resolve, ignore_resolve_error=ignore_resolve_error)