...
class InClusterConfigTest(unittest.TestCase):
    ...
    def test_join_host_port(self):
        ...
        self.assertEqual(_TEST_IPV6_HOST_PORT, _join_host_port(_TEST_IPV6_HOST, _TEST_PORT))
    ...
    def test_empty_port(self):
        loader = self.get_test_loader(environ={SERVICE_HOST_ENV_NAME: _TEST_HOST, SERVICE_PORT_ENV_NAME: ''})
