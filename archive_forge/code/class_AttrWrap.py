...
class AttrWrap(AttrMap):
    ...
    def __init__(self, w: Widget, attr, focus_attr=None):
        ...
        [('fgreet', None, ...'hi   ')]
        """
        warnings.warn('AttrWrap is maintained for backwards compatibility only, new code should use AttrMap instead.', PendingDeprecationWarning, stacklevel=2)
    ...
    def w(self) -> Widget:
        ...
        warnings.warn('backwards compatibility, widget used to be stored as original_widget', PendingDeprecationWarning, stacklevel=2)
