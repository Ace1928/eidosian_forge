...
def _AddUpdateIngressPoliciesGroupArgs(parser, api_version):
    ...
    group_help = 'These flags modify the enforced IngressPolicies of this ServicePerimeter.'
    group = parser.add_mutually_exclusive_group(group_help)
    set_ingress_policies_help_text = 'Path to a file containing a list of Ingress Policies.\n\nThis file contains a list of YAML-compliant objects representing Ingress Policies described in the API reference.\n\nFor more information about the alpha version, see:\nhttps://cloud.google.com/access-context-manager/docs/reference/rest/v1alpha/accessPolicies.servicePerimeters\nFor more information about non-alpha versions, see: \nhttps://cloud.google.com/access-context-manager/docs/reference/rest/v1/accessPolicies.servicePerimeters'
    set_ingress_policies_arg = base.Argument('--set-ingress-policies', metavar='YAML_FILE', help=set_ingress_policies_help_text, type=ParseIngressPolicies(api_version))
    clear_ingress_policies_help_text = 'Empties existing enforced Ingress Policies.'
    clear_ingress_policies_arg = base.Argument('--clear-ingress-policies', help=clear_ingress_policies_help_text, action='store_true')
