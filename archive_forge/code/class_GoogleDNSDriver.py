...
class GoogleDNSDriver(DNSDriver):
    ...
    RECORD_TYPE_MAP = {RecordType.A: 'A', RecordType.AAAA: 'AAAA', RecordType.CNAME: 'CNAME', RecordType.MX: 'MX', RecordType.NS: 'NS', RecordType.PTR: 'PTR', RecordType.SOA: 'SOA', RecordType.SPF: 'SPF', RecordType.SRV: 'SRV', RecordType.TXT: 'TXT', RecordType.CAA: 'CAA'}
    ...
    def create_zone(self, domain, type='master', ttl=None, extra=None):
        ...
        data = {'dnsName': domain, 'name': name, 'description': description}
    ...
    def delete_record(self, record):
        ...
        :rtype: ``bool``
        """
        data = {'deletions': [{'name': record.name, 'type': record.type, 'rrdatas': record.data['rrdatas'], 'ttl': record.data['ttl']}]}
    ...
    def _ex_connection_class_kwargs(self):
        return {'auth_type': self.auth_type, 'project': self.project, 'scopes': self.scopes}
    ...
    def _to_zone(self, r):
        ...
        extra['id'] = r.get('id')
        return Zone(id=r['name'], domain=r['dnsName'], type='master', ttl=0, driver=self, extra=extra)
    ...
    def _to_record(self, r, zone):
        ...
        return Record(id=record_id, name=r['name'], type=r['type'], data=r, zone=zone, driver=self, ttl=r.get('ttl', None), extra={})
