...
class AWSScalingPolicy(heat_sp.AutoScalingPolicy):
    ...
    def _validate_min_adjustment_step(self):
        ...
        if adjustment_type != sc_util.CFN_PERCENT_CHANGE_IN_CAPACITY and adjustment_step is not None:
            raise exception.ResourcePropertyValueDependency(prop1=self.MIN_ADJUSTMENT_STEP, prop2=self.ADJUSTMENT_TYPE, value=sc_util.CFN_PERCENT_CHANGE_IN_CAPACITY)
