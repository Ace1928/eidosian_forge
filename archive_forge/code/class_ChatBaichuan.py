...
class ChatBaichuan(BaseChatModel):
    ...
    def validate_environment(cls, values: Dict) -> Dict:
        values['baichuan_api_base'] = get_from_dict_or_env(values, 'baichuan_api_base', 'BAICHUAN_API_BASE', DEFAULT_API_BASE)
    ...
    def _default_params(self) -> Dict[str, Any]:
        ...
        normal_params = {'model': self.model, 'temperature': self.temperature, 'top_p': self.top_p, 'top_k': self.top_k, 'with_search_enhance': self.with_search_enhance, 'stream': self.streaming}
