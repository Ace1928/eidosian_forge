...
def http_patch(self, path: str, *, query_data: Optional[Dict[str, Any]]=None, post_data: Optional[Union[Dict[str, Any], bytes]]=None, raw: bool=False, **kwargs: Any) -> Union[Dict[str, Any], requests.Response]:
    ...
    result = self.http_request('patch', path, query_data=query_data, post_data=post_data, raw=raw, **kwargs)
