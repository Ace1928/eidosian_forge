...
class PrivateKeyProtectionType_(SamlBase):
    ...
    c_children['{urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocolPassword}KeySharing'] = ('key_sharing', KeySharing)
    ...
    def __init__(self, key_activation=None, key_storage=None, key_sharing=None, extension=None, text=None, extension_elements=None, extension_attributes=None):
