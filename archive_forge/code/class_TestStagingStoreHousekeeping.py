...
class TestStagingStoreHousekeeping(test_utils.BaseTestCase):
    ...
    def setUp(self):
        ...
        glance_store.register_store_opts(CONF, reserved_stores={'os_glance_staging_store': 'file'})
        ...
        glance_store.create_multi_stores(CONF, reserved_stores={'os_glance_staging_store': 'file'})
    ...
    @mock.patch('os.remove')
    @mock.patch.object(housekeeping, 'LOG')
    def test_clean_orphaned_staging_residue_empty(self, mock_LOG, mock_remove, mock_listdir):
