...
def bulk_apply_changes(api, provider_information, options, zone_id, records_to_delete=None, records_to_change=None, records_to_create=None, stop_early_on_errors=True):
    """
    ...
    success = {'deleted': [], 'changed': [], 'created': []}
