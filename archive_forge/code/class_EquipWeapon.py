...
class EquipWeapon(HumanControlEnvSpec):
    ...
    def create_observables(self) -> List[Handler]:
        return super().create_observables() + [handlers.EquippedItemObservation(items=ALL_ITEMS, mainhand=True, _default='air', _other='air')]
    ...
    def create_server_quit_producers(self) -> List[Handler]:
        return [handlers.ServerQuitFromTimeUp(EPISODE_LENGTH * MS_PER_STEP), handlers.ServerQuitWhenAnyAgentFinishes()]
