...
class KexNistp256:
    ...
    def start_kex(self):
        ...
        m.add_string(self.Q_C.public_bytes(serialization.Encoding.X962, serialization.PublicFormat.UncompressedPoint))
    ...
    def _parse_kexecdh_init(self, m):
        ...
        hm.add_string(self.Q_S.public_bytes(serialization.Encoding.X962, serialization.PublicFormat.UncompressedPoint))
        hm.add_mpint(int(K))
        ...
        m.add_string(K_S)
        m.add_string(self.Q_S.public_bytes(serialization.Encoding.X962, serialization.PublicFormat.UncompressedPoint))
        m.add_string(sig)
        self.transport._send_message(m)
    ...
    def _parse_kexecdh_reply(self, m):
        ...
        hm.add_string(K_S)
        hm.add_string(self.Q_C.public_bytes(serialization.Encoding.X962, serialization.PublicFormat.UncompressedPoint))
