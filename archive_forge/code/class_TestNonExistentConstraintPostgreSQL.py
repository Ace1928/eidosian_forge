...
class TestNonExistentConstraintPostgreSQL(TestNonExistentConstraint, db_test_base._PostgreSQLOpportunisticTestCase):
    ...
    def test_raise(self):
        ...
        self.assertInnerException(matched, 'ProgrammingError', 'constraint "bar_fkey" of relation "resource_foo" does not exist\n', 'ALTER TABLE resource_foo DROP CONSTRAINT bar_fkey')
