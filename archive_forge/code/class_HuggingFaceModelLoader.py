...
class HuggingFaceModelLoader(BaseLoader):
    ...
    def __init__(self, *, search: Optional[str]=None, author: Optional[str]=None, filter: Optional[str]=None, sort: Optional[str]=None, direction: Optional[str]=None, limit: Optional[int]=3, full: Optional[bool]=None, config: Optional[bool]=None):
        ...
        """
        self.params = {'search': search, 'author': author, 'filter': filter, 'sort': sort, 'direction': direction, 'limit': limit, 'full': full, 'config': config}
