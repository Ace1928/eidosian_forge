...
class ProxyObjectV1(Generic[ProxyObjT]):
    ...
    def __init__(self, obj_cls: Optional[Union[Type[ProxyObjT], str]]=None, obj_getter: Optional[Union[Callable, str]]=None, obj_args: Optional[List[Any]]=None, obj_kwargs: Optional[Dict[str, Any]]=None, obj_initialize: Optional[bool]=True, threadsafe: Optional[bool]=True, debug_enabled: Optional[bool]=False):
        """
        Proxy Object
