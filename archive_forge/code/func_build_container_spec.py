...
def build_container_spec(self):
    ...
    if self.mounts is not None:
        ...
        for mount_config in self.mounts:
            mount_options = {'target': 'target', 'source': 'source', 'type': 'type', 'readonly': 'read_only', 'propagation': 'propagation', 'labels': 'labels', 'no_copy': 'no_copy', 'driver_config': 'driver_config', 'tmpfs_size': 'tmpfs_size', 'tmpfs_mode': 'tmpfs_mode'}
            mount_args = {}
    ...
    if self.configs is not None:
        ...
        for config_config in self.configs:
            config_args = {'config_id': config_config['config_id'], 'config_name': config_config['config_name']}
    ...
    if self.secrets is not None:
        ...
        for secret_config in self.secrets:
            secret_args = {'secret_id': secret_config['secret_id'], 'secret_name': secret_config['secret_name']}
