...
class ApigeeV1(base_api.BaseApiClient):
    ...
    class OrganizationsApisDeploymentsService(base_api.BaseApiService):
      ...
      """
            config = self.GetMethodConfig('List')
            return self._RunMethod(config, request, global_params=global_params)
        List.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1/organizations/{organizationsId}/apis/{apisId}/deployments', http_method='GET', method_id='apigee.organizations.apis.deployments.list', ordered_params=['parent'], path_params=['parent'], query_params=[], relative_path='v1/{+parent}/deployments', request_field='', request_type_name='ApigeeOrganizationsApisDeploymentsListRequest', response_type_name='GoogleCloudApigeeV1ListDeploymentsResponse', supports_download=False)
    ...
    class OrganizationsApisKeyvaluemapsEntriesService(base_api.BaseApiService):
      ...
      """
            config = self.GetMethodConfig('Create')
            return self._RunMethod(config, request, global_params=global_params)
        Create.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1/organizations/{organizationsId}/apis/{apisId}/keyvaluemaps/{keyvaluemapsId}/entries', http_method='POST', method_id='apigee.organizations.apis.keyvaluemaps.entries.create', ordered_params=['parent'], path_params=['parent'], query_params=[], relative_path='v1/{+parent}/entries', request_field='googleCloudApigeeV1KeyValueEntry', request_type_name='ApigeeOrganizationsApisKeyvaluemapsEntriesCreateRequest', response_type_name='GoogleCloudApigeeV1KeyValueEntry', supports_download=False)
      ...
      """
            config = self.GetMethodConfig('Delete')
            return self._RunMethod(config, request, global_params=global_params)
        Delete.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1/organizations/{organizationsId}/apis/{apisId}/keyvaluemaps/{keyvaluemapsId}/entries/{entriesId}', http_method='DELETE', method_id='apigee.organizations.apis.keyvaluemaps.entries.delete', ordered_params=['name'], path_params=['name'], query_params=[], relative_path='v1/{+name}', request_field='', request_type_name='ApigeeOrganizationsApisKeyvaluemapsEntriesDeleteRequest', response_type_name='GoogleCloudApigeeV1KeyValueEntry', supports_download=False)
      ...
      """
            config = self.GetMethodConfig('Get')
            return self._RunMethod(config, request, global_params=global_params)
        Get.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1/organizations/{organizationsId}/apis/{apisId}/keyvaluemaps/{keyvaluemapsId}/entries/{entriesId}', http_method='GET', method_id='apigee.organizations.apis.keyvaluemaps.entries.get', ordered_params=['name'], path_params=['name'], query_params=[], relative_path='v1/{+name}', request_field='', request_type_name='ApigeeOrganizationsApisKeyvaluemapsEntriesGetRequest', response_type_name='GoogleCloudApigeeV1KeyValueEntry', supports_download=False)
      ...
      """
            config = self.GetMethodConfig('List')
            return self._RunMethod(config, request, global_params=global_params)
        List.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1/organizations/{organizationsId}/apis/{apisId}/keyvaluemaps/{keyvaluemapsId}/entries', http_method='GET', method_id='apigee.organizations.apis.keyvaluemaps.entries.list', ordered_params=['parent'], path_params=['parent'], query_params=['pageSize', 'pageToken'], relative_path='v1/{+parent}/entries', request_field='', request_type_name='ApigeeOrganizationsApisKeyvaluemapsEntriesListRequest', response_type_name='GoogleCloudApigeeV1ListKeyValueEntriesResponse', supports_download=False)
      ...
      """
            config = self.GetMethodConfig('Update')
            return self._RunMethod(config, request, global_params=global_params)
        Update.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1/organizations/{organizationsId}/apis/{apisId}/keyvaluemaps/{keyvaluemapsId}/entries/{entriesId}', http_method='PUT', method_id='apigee.organizations.apis.keyvaluemaps.entries.update', ordered_params=['name'], path_params=['name'], query_params=[], relative_path='v1/{+name}', request_field='<request>', request_type_name='GoogleCloudApigeeV1KeyValueEntry', response_type_name='GoogleCloudApigeeV1KeyValueEntry', supports_download=False)
    ...
    class OrganizationsAppgroupsAppsKeysApiproductsService(base_api.BaseApiService):
      ...
      """
            config = self.GetMethodConfig('Delete')
            return self._RunMethod(config, request, global_params=global_params)
        Delete.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1/organizations/{organizationsId}/appgroups/{appgroupsId}/apps/{appsId}/keys/{keysId}/apiproducts/{apiproductsId}', http_method='DELETE', method_id='apigee.organizations.appgroups.apps.keys.apiproducts.delete', ordered_params=['name'], path_params=['name'], query_params=[], relative_path='v1/{+name}', request_field='', request_type_name='ApigeeOrganizationsAppgroupsAppsKeysApiproductsDeleteRequest', response_type_name='GoogleCloudApigeeV1AppGroupAppKey', supports_download=False)
      ...
      """
            ...
            return self._RunMethod(config, request, global_params=global_params)
        UpdateAppGroupAppKeyApiProduct.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1/organizations/{organizationsId}/appgroups/{appgroupsId}/apps/{appsId}/keys/{keysId}/apiproducts/{apiproductsId}', http_method='POST', method_id='apigee.organizations.appgroups.apps.keys.apiproducts.updateAppGroupAppKeyApiProduct', ordered_params=['name'], path_params=['name'], query_params=['action'], relative_path='v1/{+name}', request_field='', request_type_name='ApigeeOrganizationsAppgroupsAppsKeysApiproductsUpdateAppGroupAppKeyApiProductRequest', response_type_name='GoogleProtobufEmpty', supports_download=False)
    ...
    class OrganizationsAppgroupsAppsKeysService(base_api.BaseApiService):
      ...
      """
            config = self.GetMethodConfig('Create')
            return self._RunMethod(config, request, global_params=global_params)
        Create.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1/organizations/{organizationsId}/appgroups/{appgroupsId}/apps/{appsId}/keys', http_method='POST', method_id='apigee.organizations.appgroups.apps.keys.create', ordered_params=['parent'], path_params=['parent'], query_params=[], relative_path='v1/{+parent}/keys', request_field='googleCloudApigeeV1AppGroupAppKey', request_type_name='ApigeeOrganizationsAppgroupsAppsKeysCreateRequest', response_type_name='GoogleCloudApigeeV1AppGroupAppKey', supports_download=False)
      ...
      """
            config = self.GetMethodConfig('Delete')
            return self._RunMethod(config, request, global_params=global_params)
        Delete.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1/organizations/{organizationsId}/appgroups/{appgroupsId}/apps/{appsId}/keys/{keysId}', http_method='DELETE', method_id='apigee.organizations.appgroups.apps.keys.delete', ordered_params=['name'], path_params=['name'], query_params=[], relative_path='v1/{+name}', request_field='', request_type_name='ApigeeOrganizationsAppgroupsAppsKeysDeleteRequest', response_type_name='GoogleCloudApigeeV1AppGroupAppKey', supports_download=False)
      ...
      """
            config = self.GetMethodConfig('Get')
            return self._RunMethod(config, request, global_params=global_params)
        Get.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1/organizations/{organizationsId}/appgroups/{appgroupsId}/apps/{appsId}/keys/{keysId}', http_method='GET', method_id='apigee.organizations.appgroups.apps.keys.get', ordered_params=['name'], path_params=['name'], query_params=[], relative_path='v1/{+name}', request_field='', request_type_name='ApigeeOrganizationsAppgroupsAppsKeysGetRequest', response_type_name='GoogleCloudApigeeV1AppGroupAppKey', supports_download=False)
      ...
      """
            ...
            return self._RunMethod(config, request, global_params=global_params)
        UpdateAppGroupAppKey.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1/organizations/{organizationsId}/appgroups/{appgroupsId}/apps/{appsId}/keys/{keysId}', http_method='POST', method_id='apigee.organizations.appgroups.apps.keys.updateAppGroupAppKey', ordered_params=['name'], path_params=['name'], query_params=[], relative_path='v1/{+name}', request_field='googleCloudApigeeV1UpdateAppGroupAppKeyRequest', request_type_name='ApigeeOrganizationsAppgroupsAppsKeysUpdateAppGroupAppKeyRequest', response_type_name='GoogleCloudApigeeV1AppGroupAppKey', supports_download=False)
    ...
    class OrganizationsAppgroupsService(base_api.BaseApiService):
      ...
      """
            config = self.GetMethodConfig('Create')
            return self._RunMethod(config, request, global_params=global_params)
        Create.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1/organizations/{organizationsId}/appgroups', http_method='POST', method_id='apigee.organizations.appgroups.create', ordered_params=['parent'], path_params=['parent'], query_params=[], relative_path='v1/{+parent}/appgroups', request_field='googleCloudApigeeV1AppGroup', request_type_name='ApigeeOrganizationsAppgroupsCreateRequest', response_type_name='GoogleCloudApigeeV1AppGroup', supports_download=False)
      ...
      """
            config = self.GetMethodConfig('Delete')
            return self._RunMethod(config, request, global_params=global_params)
        Delete.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1/organizations/{organizationsId}/appgroups/{appgroupsId}', http_method='DELETE', method_id='apigee.organizations.appgroups.delete', ordered_params=['name'], path_params=['name'], query_params=[], relative_path='v1/{+name}', request_field='', request_type_name='ApigeeOrganizationsAppgroupsDeleteRequest', response_type_name='GoogleCloudApigeeV1AppGroup', supports_download=False)
      ...
      """
            config = self.GetMethodConfig('Get')
            return self._RunMethod(config, request, global_params=global_params)
        Get.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1/organizations/{organizationsId}/appgroups/{appgroupsId}', http_method='GET', method_id='apigee.organizations.appgroups.get', ordered_params=['name'], path_params=['name'], query_params=[], relative_path='v1/{+name}', request_field='', request_type_name='ApigeeOrganizationsAppgroupsGetRequest', response_type_name='GoogleCloudApigeeV1AppGroup', supports_download=False)
      ...
      """
            config = self.GetMethodConfig('List')
            return self._RunMethod(config, request, global_params=global_params)
        List.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1/organizations/{organizationsId}/appgroups', http_method='GET', method_id='apigee.organizations.appgroups.list', ordered_params=['parent'], path_params=['parent'], query_params=['filter', 'pageSize', 'pageToken'], relative_path='v1/{+parent}/appgroups', request_field='', request_type_name='ApigeeOrganizationsAppgroupsListRequest', response_type_name='GoogleCloudApigeeV1ListAppGroupsResponse', supports_download=False)
      ...
      """
            config = self.GetMethodConfig('Update')
            return self._RunMethod(config, request, global_params=global_params)
        Update.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1/organizations/{organizationsId}/appgroups/{appgroupsId}', http_method='PUT', method_id='apigee.organizations.appgroups.update', ordered_params=['name'], path_params=['name'], query_params=['action'], relative_path='v1/{+name}', request_field='googleCloudApigeeV1AppGroup', request_type_name='ApigeeOrganizationsAppgroupsUpdateRequest', response_type_name='GoogleCloudApigeeV1AppGroup', supports_download=False)
    ...
    class OrganizationsEnvironmentsApisDeploymentsService(base_api.BaseApiService):
      ...
      """
            config = self.GetMethodConfig('List')
            return self._RunMethod(config, request, global_params=global_params)
        List.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1/organizations/{organizationsId}/environments/{environmentsId}/apis/{apisId}/deployments', http_method='GET', method_id='apigee.organizations.environments.apis.deployments.list', ordered_params=['parent'], path_params=['parent'], query_params=[], relative_path='v1/{+parent}/deployments', request_field='', request_type_name='ApigeeOrganizationsEnvironmentsApisDeploymentsListRequest', response_type_name='GoogleCloudApigeeV1ListDeploymentsResponse', supports_download=False)
    ...
    class OrganizationsEnvironmentsKeyvaluemapsEntriesService(base_api.BaseApiService):
      ...
      """
            config = self.GetMethodConfig('Create')
            return self._RunMethod(config, request, global_params=global_params)
        Create.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1/organizations/{organizationsId}/environments/{environmentsId}/keyvaluemaps/{keyvaluemapsId}/entries', http_method='POST', method_id='apigee.organizations.environments.keyvaluemaps.entries.create', ordered_params=['parent'], path_params=['parent'], query_params=[], relative_path='v1/{+parent}/entries', request_field='googleCloudApigeeV1KeyValueEntry', request_type_name='ApigeeOrganizationsEnvironmentsKeyvaluemapsEntriesCreateRequest', response_type_name='GoogleCloudApigeeV1KeyValueEntry', supports_download=False)
      ...
      """
            config = self.GetMethodConfig('Delete')
            return self._RunMethod(config, request, global_params=global_params)
        Delete.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1/organizations/{organizationsId}/environments/{environmentsId}/keyvaluemaps/{keyvaluemapsId}/entries/{entriesId}', http_method='DELETE', method_id='apigee.organizations.environments.keyvaluemaps.entries.delete', ordered_params=['name'], path_params=['name'], query_params=[], relative_path='v1/{+name}', request_field='', request_type_name='ApigeeOrganizationsEnvironmentsKeyvaluemapsEntriesDeleteRequest', response_type_name='GoogleCloudApigeeV1KeyValueEntry', supports_download=False)
      ...
      """
            config = self.GetMethodConfig('Get')
            return self._RunMethod(config, request, global_params=global_params)
        Get.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1/organizations/{organizationsId}/environments/{environmentsId}/keyvaluemaps/{keyvaluemapsId}/entries/{entriesId}', http_method='GET', method_id='apigee.organizations.environments.keyvaluemaps.entries.get', ordered_params=['name'], path_params=['name'], query_params=[], relative_path='v1/{+name}', request_field='', request_type_name='ApigeeOrganizationsEnvironmentsKeyvaluemapsEntriesGetRequest', response_type_name='GoogleCloudApigeeV1KeyValueEntry', supports_download=False)
      ...
      """
            config = self.GetMethodConfig('List')
            return self._RunMethod(config, request, global_params=global_params)
        List.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1/organizations/{organizationsId}/environments/{environmentsId}/keyvaluemaps/{keyvaluemapsId}/entries', http_method='GET', method_id='apigee.organizations.environments.keyvaluemaps.entries.list', ordered_params=['parent'], path_params=['parent'], query_params=['pageSize', 'pageToken'], relative_path='v1/{+parent}/entries', request_field='', request_type_name='ApigeeOrganizationsEnvironmentsKeyvaluemapsEntriesListRequest', response_type_name='GoogleCloudApigeeV1ListKeyValueEntriesResponse', supports_download=False)
      ...
      """
            config = self.GetMethodConfig('Update')
            return self._RunMethod(config, request, global_params=global_params)
        Update.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1/organizations/{organizationsId}/environments/{environmentsId}/keyvaluemaps/{keyvaluemapsId}/entries/{entriesId}', http_method='PUT', method_id='apigee.organizations.environments.keyvaluemaps.entries.update', ordered_params=['name'], path_params=['name'], query_params=[], relative_path='v1/{+name}', request_field='<request>', request_type_name='GoogleCloudApigeeV1KeyValueEntry', response_type_name='GoogleCloudApigeeV1KeyValueEntry', supports_download=False)
    ...
    class OrganizationsKeyvaluemapsService(base_api.BaseApiService):
      ...
      """
            config = self.GetMethodConfig('Create')
            return self._RunMethod(config, request, global_params=global_params)
        Create.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1/organizations/{organizationsId}/keyvaluemaps', http_method='POST', method_id='apigee.organizations.keyvaluemaps.create', ordered_params=['parent'], path_params=['parent'], query_params=[], relative_path='v1/{+parent}/keyvaluemaps', request_field='googleCloudApigeeV1KeyValueMap', request_type_name='ApigeeOrganizationsKeyvaluemapsCreateRequest', response_type_name='GoogleCloudApigeeV1KeyValueMap', supports_download=False)
      ...
      """
            config = self.GetMethodConfig('Delete')
            return self._RunMethod(config, request, global_params=global_params)
        Delete.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1/organizations/{organizationsId}/keyvaluemaps/{keyvaluemapsId}', http_method='DELETE', method_id='apigee.organizations.keyvaluemaps.delete', ordered_params=['name'], path_params=['name'], query_params=[], relative_path='v1/{+name}', request_field='', request_type_name='ApigeeOrganizationsKeyvaluemapsDeleteRequest', response_type_name='GoogleCloudApigeeV1KeyValueMap', supports_download=False)
    ...
    class OrganizationsSecurityProfilesV2Service(base_api.BaseApiService):
      ...
      """
            config = self.GetMethodConfig('Create')
            return self._RunMethod(config, request, global_params=global_params)
        Create.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1/organizations/{organizationsId}/securityProfilesV2', http_method='POST', method_id='apigee.organizations.securityProfilesV2.create', ordered_params=['parent'], path_params=['parent'], query_params=['securityProfileV2Id'], relative_path='v1/{+parent}/securityProfilesV2', request_field='googleCloudApigeeV1SecurityProfileV2', request_type_name='ApigeeOrganizationsSecurityProfilesV2CreateRequest', response_type_name='GoogleCloudApigeeV1SecurityProfileV2', supports_download=False)
      ...
      """
            config = self.GetMethodConfig('Delete')
            return self._RunMethod(config, request, global_params=global_params)
        Delete.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1/organizations/{organizationsId}/securityProfilesV2/{securityProfilesV2Id}', http_method='DELETE', method_id='apigee.organizations.securityProfilesV2.delete', ordered_params=['name'], path_params=['name'], query_params=[], relative_path='v1/{+name}', request_field='', request_type_name='ApigeeOrganizationsSecurityProfilesV2DeleteRequest', response_type_name='GoogleProtobufEmpty', supports_download=False)
      ...
      """
            config = self.GetMethodConfig('Get')
            return self._RunMethod(config, request, global_params=global_params)
        Get.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1/organizations/{organizationsId}/securityProfilesV2/{securityProfilesV2Id}', http_method='GET', method_id='apigee.organizations.securityProfilesV2.get', ordered_params=['name'], path_params=['name'], query_params=[], relative_path='v1/{+name}', request_field='', request_type_name='ApigeeOrganizationsSecurityProfilesV2GetRequest', response_type_name='GoogleCloudApigeeV1SecurityProfileV2', supports_download=False)
      ...
      """
            config = self.GetMethodConfig('List')
            return self._RunMethod(config, request, global_params=global_params)
        List.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1/organizations/{organizationsId}/securityProfilesV2', http_method='GET', method_id='apigee.organizations.securityProfilesV2.list', ordered_params=['parent'], path_params=['parent'], query_params=['pageSize', 'pageToken'], relative_path='v1/{+parent}/securityProfilesV2', request_field='', request_type_name='ApigeeOrganizationsSecurityProfilesV2ListRequest', response_type_name='GoogleCloudApigeeV1ListSecurityProfilesV2Response', supports_download=False)
      ...
      """
            config = self.GetMethodConfig('Patch')
            return self._RunMethod(config, request, global_params=global_params)
        Patch.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1/organizations/{organizationsId}/securityProfilesV2/{securityProfilesV2Id}', http_method='PATCH', method_id='apigee.organizations.securityProfilesV2.patch', ordered_params=['name'], path_params=['name'], query_params=['updateMask'], relative_path='v1/{+name}', request_field='googleCloudApigeeV1SecurityProfileV2', request_type_name='ApigeeOrganizationsSecurityProfilesV2PatchRequest', response_type_name='GoogleCloudApigeeV1SecurityProfileV2', supports_download=False)
    ...
    class OrganizationsSharedflowsDeploymentsService(base_api.BaseApiService):
      ...
      """
            config = self.GetMethodConfig('List')
            return self._RunMethod(config, request, global_params=global_params)
        List.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1/organizations/{organizationsId}/sharedflows/{sharedflowsId}/deployments', http_method='GET', method_id='apigee.organizations.sharedflows.deployments.list', ordered_params=['parent'], path_params=['parent'], query_params=[], relative_path='v1/{+parent}/deployments', request_field='', request_type_name='ApigeeOrganizationsSharedflowsDeploymentsListRequest', response_type_name='GoogleCloudApigeeV1ListDeploymentsResponse', supports_download=False)
    ...
    class OrganizationsService(base_api.BaseApiService):
      ...
      """
            config = self.GetMethodConfig('Create')
            return self._RunMethod(config, request, global_params=global_params)
        Create.method_config = lambda: base_api.ApiMethodInfo(http_method='POST', method_id='apigee.organizations.create', ordered_params=[], path_params=[], query_params=['parent'], relative_path='v1/organizations', request_field='googleCloudApigeeV1Organization', request_type_name='ApigeeOrganizationsCreateRequest', response_type_name='GoogleLongrunningOperation', supports_download=False)
      ...
      """
            config = self.GetMethodConfig('Delete')
            return self._RunMethod(config, request, global_params=global_params)
        Delete.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1/organizations/{organizationsId}', http_method='DELETE', method_id='apigee.organizations.delete', ordered_params=['name'], path_params=['name'], query_params=['hardDelete', 'retention'], relative_path='v1/{+name}', request_field='', request_type_name='ApigeeOrganizationsDeleteRequest', response_type_name='GoogleLongrunningOperation', supports_download=False)
      ...
      """
            config = self.GetMethodConfig('Get')
            return self._RunMethod(config, request, global_params=global_params)
        Get.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1/organizations/{organizationsId}', http_method='GET', method_id='apigee.organizations.get', ordered_params=['name'], path_params=['name'], query_params=[], relative_path='v1/{+name}', request_field='', request_type_name='ApigeeOrganizationsGetRequest', response_type_name='GoogleCloudApigeeV1Organization', supports_download=False)
      ...
      """
            ...
            return self._RunMethod(config, request, global_params=global_params)
        GetControlPlaneAccess.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1/organizations/{organizationsId}/controlPlaneAccess', http_method='GET', method_id='apigee.organizations.getControlPlaneAccess', ordered_params=['name'], path_params=['name'], query_params=[], relative_path='v1/{+name}', request_field='', request_type_name='ApigeeOrganizationsGetControlPlaneAccessRequest', response_type_name='GoogleCloudApigeeV1ControlPlaneAccess', supports_download=False)
      ...
      """
            config = self.GetMethodConfig('GetDeployedIngressConfig')
            return self._RunMethod(config, request, global_params=global_params)
        GetDeployedIngressConfig.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1/organizations/{organizationsId}/deployedIngressConfig', http_method='GET', method_id='apigee.organizations.getDeployedIngressConfig', ordered_params=['name'], path_params=['name'], query_params=['view'], relative_path='v1/{+name}', request_field='', request_type_name='ApigeeOrganizationsGetDeployedIngressConfigRequest', response_type_name='GoogleCloudApigeeV1IngressConfig', supports_download=False)
      ...
      """
            ...
            return self._RunMethod(config, request, global_params=global_params)
        GetProjectMapping.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1/organizations/{organizationsId}:getProjectMapping', http_method='GET', method_id='apigee.organizations.getProjectMapping', ordered_params=['name'], path_params=['name'], query_params=[], relative_path='v1/{+name}:getProjectMapping', request_field='', request_type_name='ApigeeOrganizationsGetProjectMappingRequest', response_type_name='GoogleCloudApigeeV1OrganizationProjectMapping', supports_download=False)
      ...
      """
            ...
            return self._RunMethod(config, request, global_params=global_params)
        GetRuntimeConfig.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1/organizations/{organizationsId}/runtimeConfig', http_method='GET', method_id='apigee.organizations.getRuntimeConfig', ordered_params=['name'], path_params=['name'], query_params=[], relative_path='v1/{+name}', request_field='', request_type_name='ApigeeOrganizationsGetRuntimeConfigRequest', response_type_name='GoogleCloudApigeeV1RuntimeConfig', supports_download=False)
      ...
      """
            ...
            return self._RunMethod(config, request, global_params=global_params)
        GetSecuritySettings.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1/organizations/{organizationsId}/securitySettings', http_method='GET', method_id='apigee.organizations.getSecuritySettings', ordered_params=['name'], path_params=['name'], query_params=[], relative_path='v1/{+name}', request_field='', request_type_name='ApigeeOrganizationsGetSecuritySettingsRequest', response_type_name='GoogleCloudApigeeV1SecuritySettings', supports_download=False)
      ...
      """
            ...
            return self._RunMethod(config, request, global_params=global_params)
        GetSyncAuthorization.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1/organizations/{organizationsId}:getSyncAuthorization', http_method='POST', method_id='apigee.organizations.getSyncAuthorization', ordered_params=['name'], path_params=['name'], query_params=[], relative_path='v1/{+name}:getSyncAuthorization', request_field='googleCloudApigeeV1GetSyncAuthorizationRequest', request_type_name='ApigeeOrganizationsGetSyncAuthorizationRequest', response_type_name='GoogleCloudApigeeV1SyncAuthorization', supports_download=False)
      ...
      """
            config = self.GetMethodConfig('List')
            return self._RunMethod(config, request, global_params=global_params)
        List.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1/organizations', http_method='GET', method_id='apigee.organizations.list', ordered_params=['parent'], path_params=['parent'], query_params=[], relative_path='v1/{+parent}', request_field='', request_type_name='ApigeeOrganizationsListRequest', response_type_name='GoogleCloudApigeeV1ListOrganizationsResponse', supports_download=False)

        def Patch(self, request, global_params=None):
            """Updates properties for an Apigee organization with patch semantics using a field mask.
      ...
      """
            config = self.GetMethodConfig('Patch')
            return self._RunMethod(config, request, global_params=global_params)
        Patch.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1/organizations/{organizationsId}', http_method='PATCH', method_id='apigee.organizations.patch', ordered_params=['name'], path_params=['name'], query_params=['updateMask'], relative_path='v1/{+name}', request_field='googleCloudApigeeV1Organization', request_type_name='ApigeeOrganizationsPatchRequest', response_type_name='GoogleLongrunningOperation', supports_download=False)
      ...
      """
            ...
            return self._RunMethod(config, request, global_params=global_params)
        SetAddons.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1/organizations/{organizationsId}:setAddons', http_method='POST', method_id='apigee.organizations.setAddons', ordered_params=['org'], path_params=['org'], query_params=[], relative_path='v1/{+org}:setAddons', request_field='googleCloudApigeeV1SetAddonsRequest', request_type_name='ApigeeOrganizationsSetAddonsRequest', response_type_name='GoogleLongrunningOperation', supports_download=False)
      ...
      """
            ...
            return self._RunMethod(config, request, global_params=global_params)
        SetSyncAuthorization.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1/organizations/{organizationsId}:setSyncAuthorization', http_method='POST', method_id='apigee.organizations.setSyncAuthorization', ordered_params=['name'], path_params=['name'], query_params=[], relative_path='v1/{+name}:setSyncAuthorization', request_field='googleCloudApigeeV1SyncAuthorization', request_type_name='ApigeeOrganizationsSetSyncAuthorizationRequest', response_type_name='GoogleCloudApigeeV1SyncAuthorization', supports_download=False)
      ...
      """
            config = self.GetMethodConfig('TestIamPermissions')
            return self._RunMethod(config, request, global_params=global_params)
        TestIamPermissions.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1/organizations/{organizationsId}:testIamPermissions', http_method='POST', method_id='apigee.organizations.testIamPermissions', ordered_params=['resource'], path_params=['resource'], query_params=[], relative_path='v1/{+resource}:testIamPermissions', request_field='googleIamV1TestIamPermissionsRequest', request_type_name='ApigeeOrganizationsTestIamPermissionsRequest', response_type_name='GoogleIamV1TestIamPermissionsResponse', supports_download=False)

        def Undelete(self, request, global_params=None):
            """Undelete an Apigee organization that is soft-deleted.
      ...
      """
            ...
            return self._RunMethod(config, request, global_params=global_params)
        Undelete.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1/organizations/{organizationsId}:undelete', http_method='POST', method_id='apigee.organizations.undelete', ordered_params=['name'], path_params=['name'], query_params=[], relative_path='v1/{+name}:undelete', request_field='googleCloudApigeeV1UndeleteOrganizationRequest', request_type_name='ApigeeOrganizationsUndeleteRequest', response_type_name='GoogleLongrunningOperation', supports_download=False)
      ...
      """
            config = self.GetMethodConfig('Update')
            return self._RunMethod(config, request, global_params=global_params)
        Update.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1/organizations/{organizationsId}', http_method='PUT', method_id='apigee.organizations.update', ordered_params=['name'], path_params=['name'], query_params=[], relative_path='v1/{+name}', request_field='<request>', request_type_name='GoogleCloudApigeeV1Organization', response_type_name='GoogleCloudApigeeV1Organization', supports_download=False)
      ...
      """
            ...
            return self._RunMethod(config, request, global_params=global_params)
        UpdateControlPlaneAccess.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1/organizations/{organizationsId}/controlPlaneAccess', http_method='PATCH', method_id='apigee.organizations.updateControlPlaneAccess', ordered_params=['name'], path_params=['name'], query_params=['updateMask'], relative_path='v1/{+name}', request_field='googleCloudApigeeV1ControlPlaneAccess', request_type_name='ApigeeOrganizationsUpdateControlPlaneAccessRequest', response_type_name='GoogleLongrunningOperation', supports_download=False)
      ...
      """
            ...
            return self._RunMethod(config, request, global_params=global_params)
        UpdateSecuritySettings.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1/organizations/{organizationsId}/securitySettings', http_method='PATCH', method_id='apigee.organizations.updateSecuritySettings', ordered_params=['name'], path_params=['name'], query_params=['updateMask'], relative_path='v1/{+name}', request_field='googleCloudApigeeV1SecuritySettings', request_type_name='ApigeeOrganizationsUpdateSecuritySettingsRequest', response_type_name='GoogleCloudApigeeV1SecuritySettings', supports_download=False)
    ...
    class ProjectsService(base_api.BaseApiService):
      ...
      """
            ...
            return self._RunMethod(config, request, global_params=global_params)
        ProvisionOrganization.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1/projects/{projectsId}:provisionOrganization', http_method='POST', method_id='apigee.projects.provisionOrganization', ordered_params=['project'], path_params=['project'], query_params=[], relative_path='v1/{+project}:provisionOrganization', request_field='googleCloudApigeeV1ProvisionOrganizationRequest', request_type_name='ApigeeProjectsProvisionOrganizationRequest', response_type_name='GoogleLongrunningOperation', supports_download=False)