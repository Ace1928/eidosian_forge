...
def default_attrs(string_val: str='abc', string_list_val=['abc', ''], int_val: int=123, int_list_val=[1, 2, 3], float_val: float=10, float_list_val=[10], bool_val: bool=True, bool_list_val=[True, False], type_val: TV_DefaultAttrs_type_val=_dtypes.int32, type_list_val=[_dtypes.int32, _dtypes.float32], shape_val=[2, 1], shape_list_val=[[], [1]], tensor_val=_execute.make_tensor('dtype: DT_INT32 tensor_shape { } int_val: 1 ', 'tensor_val'), tensor_list_val=[_execute.make_tensor(_pb, 'tensor_list_val') for _pb in ('dtype: DT_INT32 tensor_shape { } int_val: 1 ',)], name=None):
  ...
  """
    ...
    if tld.is_eager:
        try:
            _result = pywrap_tfe.TFE_Py_FastPathExecute(_ctx, 'DefaultAttrs', name, 'string_val', string_val, 'string_list_val', string_list_val, 'int_val', int_val, 'int_list_val', int_list_val, 'float_val', float_val, 'float_list_val', float_list_val, 'bool_val', bool_val, 'bool_list_val', bool_list_val, 'type_val', type_val, 'type_list_val', type_list_val, 'shape_val', shape_val, 'shape_list_val', shape_list_val, 'tensor_val', tensor_val, 'tensor_list_val', tensor_list_val)
            return _result
            ...
            pass
        try:
            _result = _dispatcher_for_default_attrs((string_val, string_list_val, int_val, int_list_val, float_val, float_list_val, bool_val, bool_list_val, type_val, type_list_val, shape_val, shape_list_val, tensor_val, tensor_list_val, name), None)
            if _result is not NotImplemented:
                return _result
            return default_attrs_eager_fallback(string_val=string_val, string_list_val=string_list_val, int_val=int_val, int_list_val=int_list_val, float_val=float_val, float_list_val=float_list_val, bool_val=bool_val, bool_list_val=bool_list_val, type_val=type_val, type_list_val=type_list_val, shape_val=shape_val, shape_list_val=shape_list_val, tensor_val=tensor_val, tensor_list_val=tensor_list_val, name=name, ctx=_ctx)
        except _core._SymbolicException:
            pass
        except (TypeError, ValueError):
            _result = _dispatch.dispatch(default_attrs, (), dict(string_val=string_val, string_list_val=string_list_val, int_val=int_val, int_list_val=int_list_val, float_val=float_val, float_list_val=float_list_val, bool_val=bool_val, bool_list_val=bool_list_val, type_val=type_val, type_list_val=type_list_val, shape_val=shape_val, shape_list_val=shape_list_val, tensor_val=tensor_val, tensor_list_val=tensor_list_val, name=name))
    ...
    try:
        _, _, _op, _outputs = _op_def_library._apply_op_helper('DefaultAttrs', string_val=string_val, string_list_val=string_list_val, int_val=int_val, int_list_val=int_list_val, float_val=float_val, float_list_val=float_list_val, bool_val=bool_val, bool_list_val=bool_list_val, type_val=type_val, type_list_val=type_list_val, shape_val=shape_val, shape_list_val=shape_list_val, tensor_val=tensor_val, tensor_list_val=tensor_list_val, name=name)
    except (TypeError, ValueError):
        _result = _dispatch.dispatch(default_attrs, (), dict(string_val=string_val, string_list_val=string_list_val, int_val=int_val, int_list_val=int_list_val, float_val=float_val, float_list_val=float_list_val, bool_val=bool_val, bool_list_val=bool_list_val, type_val=type_val, type_list_val=type_list_val, shape_val=shape_val, shape_list_val=shape_list_val, tensor_val=tensor_val, tensor_list_val=tensor_list_val, name=name))
        if _result is not _dispatch.OpDispatcher.NOT_SUPPORTED:
            return _result
