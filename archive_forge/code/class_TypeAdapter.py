...
class TypeAdapter(Generic[T]):
    ...
    **Note:** `TypeAdapter` instances are not types, and cannot be used as type annotations for fields.
    ...
    @overload
    def __init__(self, type: T, *, config: ConfigDict | None=..., _parent_depth: int=..., module: str | None=...) -> None:
        ...

    def __init__(self, type: type[T] | T, *, config: ConfigDict | None=None, _parent_depth: int=2, module: str | None=None) -> None:
