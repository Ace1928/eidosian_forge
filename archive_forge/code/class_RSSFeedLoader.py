...
class RSSFeedLoader(BaseLoader):
    ...
    def __init__(self, urls: Optional[Sequence[str]]=None, opml: Optional[str]=None, continue_on_failure: bool=True, show_progress_bar: bool=False, **newsloader_kwargs: Any) -> None:
    ...
    def _get_urls(self) -> Sequence[str]:
        ...
        try:
            ...
            raise ImportError("Package listparser must be installed if the opml arg is used. Please install with 'pip install listparser' or use the urls arg instead.") from e
