...
class DatastoreV1(base_api.BaseApiClient):
    ...
    def __init__(self, url='', credentials=None, get_credentials=True, http=None, model=None, log_request=False, log_response=False, credentials_args=None, default_global_params=None, additional_http_headers=None, response_encoding=None):
        ...
        super(DatastoreV1, self).__init__(url, credentials=credentials, get_credentials=get_credentials, http=http, model=model, log_request=log_request, log_response=log_response, credentials_args=credentials_args, default_global_params=default_global_params, additional_http_headers=additional_http_headers, response_encoding=response_encoding)
    ...
    class ProjectsOperationsService(base_api.BaseApiService):
      ...
      """
            ...
            return self._RunMethod(config, request, global_params=global_params)
        Cancel.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1/projects/{projectsId}/operations/{operationsId}:cancel', http_method='POST', method_id='datastore.projects.operations.cancel', ordered_params=['name'], path_params=['name'], query_params=[], relative_path='v1/{+name}:cancel', request_field='', request_type_name='DatastoreProjectsOperationsCancelRequest', response_type_name='Empty', supports_download=False)
      ...
      """
            config = self.GetMethodConfig('Delete')
            return self._RunMethod(config, request, global_params=global_params)
        Delete.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1/projects/{projectsId}/operations/{operationsId}', http_method='DELETE', method_id='datastore.projects.operations.delete', ordered_params=['name'], path_params=['name'], query_params=[], relative_path='v1/{+name}', request_field='', request_type_name='DatastoreProjectsOperationsDeleteRequest', response_type_name='Empty', supports_download=False)
      ...
      """
            config = self.GetMethodConfig('Get')
            return self._RunMethod(config, request, global_params=global_params)
        Get.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1/projects/{projectsId}/operations/{operationsId}', http_method='GET', method_id='datastore.projects.operations.get', ordered_params=['name'], path_params=['name'], query_params=[], relative_path='v1/{+name}', request_field='', request_type_name='DatastoreProjectsOperationsGetRequest', response_type_name='GoogleLongrunningOperation', supports_download=False)
      ...
      """
            config = self.GetMethodConfig('List')
            return self._RunMethod(config, request, global_params=global_params)
        List.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1/projects/{projectsId}/operations', http_method='GET', method_id='datastore.projects.operations.list', ordered_params=['name'], path_params=['name'], query_params=['filter', 'pageSize', 'pageToken'], relative_path='v1/{+name}/operations', request_field='', request_type_name='DatastoreProjectsOperationsListRequest', response_type_name='GoogleLongrunningListOperationsResponse', supports_download=False)
    ...
    class ProjectsService(base_api.BaseApiService):
      ...
      """
            ...
            return self._RunMethod(config, request, global_params=global_params)
        AllocateIds.method_config = lambda: base_api.ApiMethodInfo(http_method='POST', method_id='datastore.projects.allocateIds', ordered_params=['projectId'], path_params=['projectId'], query_params=[], relative_path='v1/projects/{projectId}:allocateIds', request_field='allocateIdsRequest', request_type_name='DatastoreProjectsAllocateIdsRequest', response_type_name='AllocateIdsResponse', supports_download=False)
      ...
      """
            ...
            return self._RunMethod(config, request, global_params=global_params)
        BeginTransaction.method_config = lambda: base_api.ApiMethodInfo(http_method='POST', method_id='datastore.projects.beginTransaction', ordered_params=['projectId'], path_params=['projectId'], query_params=[], relative_path='v1/projects/{projectId}:beginTransaction', request_field='beginTransactionRequest', request_type_name='DatastoreProjectsBeginTransactionRequest', response_type_name='BeginTransactionResponse', supports_download=False)
      ...
      """
            ...
            return self._RunMethod(config, request, global_params=global_params)
        Commit.method_config = lambda: base_api.ApiMethodInfo(http_method='POST', method_id='datastore.projects.commit', ordered_params=['projectId'], path_params=['projectId'], query_params=[], relative_path='v1/projects/{projectId}:commit', request_field='commitRequest', request_type_name='DatastoreProjectsCommitRequest', response_type_name='CommitResponse', supports_download=False)
      ...
      """
            ...
            return self._RunMethod(config, request, global_params=global_params)
        Export.method_config = lambda: base_api.ApiMethodInfo(http_method='POST', method_id='datastore.projects.export', ordered_params=['projectId'], path_params=['projectId'], query_params=[], relative_path='v1/projects/{projectId}:export', request_field='googleDatastoreAdminV1ExportEntitiesRequest', request_type_name='DatastoreProjectsExportRequest', response_type_name='GoogleLongrunningOperation', supports_download=False)
      ...
      """
            ...
            return self._RunMethod(config, request, global_params=global_params)
        Import.method_config = lambda: base_api.ApiMethodInfo(http_method='POST', method_id='datastore.projects.import', ordered_params=['projectId'], path_params=['projectId'], query_params=[], relative_path='v1/projects/{projectId}:import', request_field='googleDatastoreAdminV1ImportEntitiesRequest', request_type_name='DatastoreProjectsImportRequest', response_type_name='GoogleLongrunningOperation', supports_download=False)
      ...
      """
            ...
            return self._RunMethod(config, request, global_params=global_params)
        Lookup.method_config = lambda: base_api.ApiMethodInfo(http_method='POST', method_id='datastore.projects.lookup', ordered_params=['projectId'], path_params=['projectId'], query_params=[], relative_path='v1/projects/{projectId}:lookup', request_field='lookupRequest', request_type_name='DatastoreProjectsLookupRequest', response_type_name='LookupResponse', supports_download=False)
      ...
      """
            ...
            return self._RunMethod(config, request, global_params=global_params)
        ReserveIds.method_config = lambda: base_api.ApiMethodInfo(http_method='POST', method_id='datastore.projects.reserveIds', ordered_params=['projectId'], path_params=['projectId'], query_params=[], relative_path='v1/projects/{projectId}:reserveIds', request_field='reserveIdsRequest', request_type_name='DatastoreProjectsReserveIdsRequest', response_type_name='ReserveIdsResponse', supports_download=False)
      ...
      """
            ...
            return self._RunMethod(config, request, global_params=global_params)
        Rollback.method_config = lambda: base_api.ApiMethodInfo(http_method='POST', method_id='datastore.projects.rollback', ordered_params=['projectId'], path_params=['projectId'], query_params=[], relative_path='v1/projects/{projectId}:rollback', request_field='rollbackRequest', request_type_name='DatastoreProjectsRollbackRequest', response_type_name='RollbackResponse', supports_download=False)
      ...
      """
            ...
            return self._RunMethod(config, request, global_params=global_params)
        RunAggregationQuery.method_config = lambda: base_api.ApiMethodInfo(http_method='POST', method_id='datastore.projects.runAggregationQuery', ordered_params=['projectId'], path_params=['projectId'], query_params=[], relative_path='v1/projects/{projectId}:runAggregationQuery', request_field='runAggregationQueryRequest', request_type_name='DatastoreProjectsRunAggregationQueryRequest', response_type_name='RunAggregationQueryResponse', supports_download=False)
      ...
      """
            ...
            return self._RunMethod(config, request, global_params=global_params)
        RunQuery.method_config = lambda: base_api.ApiMethodInfo(http_method='POST', method_id='datastore.projects.runQuery', ordered_params=['projectId'], path_params=['projectId'], query_params=[], relative_path='v1/projects/{projectId}:runQuery', request_field='runQueryRequest', request_type_name='DatastoreProjectsRunQueryRequest', response_type_name='RunQueryResponse', supports_download=False)