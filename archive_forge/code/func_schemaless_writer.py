...
def schemaless_writer(fo: IO, schema: Schema, record: Any, *, strict: bool=False, strict_allow_default: bool=False, disable_tuple_notation: bool=False):
    ...
    write_data(encoder, record, schema, named_schemas, '', {'strict': strict, 'strict_allow_default': strict_allow_default, 'disable_tuple_notation': disable_tuple_notation})
    encoder.flush()