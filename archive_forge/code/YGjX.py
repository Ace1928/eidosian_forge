...
async def cythonize_function(obj: Type) -> Type:
    ...
    """
    # Extract source code of the object
    source_code = await CythonCompiler._extract_source_code(obj)
    # Create a CythonCompiler instance with the extracted source code
    compiler = CythonCompiler(obj, source_code)
    await compiler.convert_to_c_and_run()
    return obj
