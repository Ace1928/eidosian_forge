...
class TrialGeneratorFunctionTests(unittest.SynchronousTestCase):
    ...
    def test_errorOnGeneratorFunction(self):
        ...
        self.assertIn('GeneratorTestCase.test_generator', result.errors[0][1].value.args[0])
        self.assertIn('GeneratorTestCase testMethod=test_generator', result.errors[0][1].value.args[0])
