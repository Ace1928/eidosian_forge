...
def binary_precision_at_fixed_recall(preds: Tensor, target: Tensor, min_recall: float, thresholds: Optional[Union[int, List[float], Tensor]]=None, ignore_index: Optional[int]=None, validate_args: bool=True) -> Tuple[Tensor, Tensor]:
    ...
    return _binary_recall_at_fixed_precision_compute(state, thresholds, min_precision=min_recall, reduce_fn=_precision_at_recall)