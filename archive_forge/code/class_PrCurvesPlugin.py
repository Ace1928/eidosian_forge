...
class PrCurvesPlugin(base_plugin.TBPlugin):
    ...
    def __init__(self, context):
        ...
        self._downsample_to = (context.sampling_hints or {}).get(metadata.PLUGIN_NAME, _DEFAULT_DOWNSAMPLING)
        self._version_checker = plugin_util._MetadataVersionChecker(data_kind='PR curve', latest_known_version=0)
    ...
    def get_plugin_apps(self):
        ...
        """
        return {'/tags': self.tags_route, '/pr_curves': self.pr_curves_route}

    def is_active(self):
        return False

    def frontend_metadata(self):
        return base_plugin.FrontendMetadata(element_name='tf-pr-curve-dashboard', tab_name='PR Curves')
