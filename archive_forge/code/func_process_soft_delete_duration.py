...
def process_soft_delete_duration(soft_delete_duration):
    ...
    return messages.Bucket.SoftDeletePolicyValue(retentionDurationSeconds=0 if soft_delete_duration == user_request_args_factory.CLEAR else soft_delete_duration)