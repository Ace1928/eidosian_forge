...
def WaitForFunctionUpdateOperation(op, try_set_invoker=None, on_every_poll=None):
  ...
  """
    ...
    operations.Wait(op, client.MESSAGES_MODULE, client, _DEPLOY_WAIT_NOTICE, try_set_invoker=try_set_invoker, on_every_poll=on_every_poll)