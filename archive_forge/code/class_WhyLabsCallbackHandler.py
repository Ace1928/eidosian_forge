...
class WhyLabsCallbackHandler(BaseCallbackHandler):
    ...
    * Sentiment and Toxicity
    ...
    @classmethod
    def from_params(cls, *, api_key: Optional[str]=None, org_id: Optional[str]=None, dataset_id: Optional[str]=None, sentiment: bool=False, toxicity: bool=False, themes: bool=False, logger: Optional[Logger]=None) -> WhyLabsCallbackHandler:
