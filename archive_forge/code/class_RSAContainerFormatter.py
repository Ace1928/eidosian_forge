...
class RSAContainerFormatter(formatter.EntityFormatter):
    ...
    columns = ('Container href', 'Name', 'Created', 'Status', 'Type', 'Public Key', 'Private Key', 'PK Passphrase', 'Consumers')
    ...
    def _get_formatted_data(self):
        ...
        data = (self.container_ref, self.name, self.created, self.status, self._type, formatted_public_key, formatted_private_key, formatted_pkp, formatted_consumers)
        return data