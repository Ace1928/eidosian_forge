...
def get_graph_kwargs(node_source: ColumnDataSource, edge_source: ColumnDataSource, **kwargs):
    ...
    node_renderer = GlyphRenderer(data_source=node_source, glyph=node_glyph, selection_glyph=snode_glyph or 'auto', nonselection_glyph=nsnode_glyph or 'auto', hover_glyph=hnode_glyph, muted_glyph=mnode_glyph or 'auto')
    ...
    edge_renderer = GlyphRenderer(data_source=edge_source, glyph=edge_glyph, selection_glyph=sedge_glyph or 'auto', nonselection_glyph=nsedge_glyph or 'auto', hover_glyph=hedge_glyph, muted_glyph=medge_glyph or 'auto')
