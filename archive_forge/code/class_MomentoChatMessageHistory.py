...
class MomentoChatMessageHistory(BaseChatMessageHistory):
    ...
    def __init__(self, session_id: str, cache_client: momento.CacheClient, cache_name: str, *, key_prefix: str='message_store:', ttl: Optional[timedelta]=None, ensure_cache_exists: bool=True):
