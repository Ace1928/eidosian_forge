...
class EndpointPolicyManager(base.Manager):
    ...
    def create_policy_association_for_endpoint(self, policy, endpoint):
        ...
        return self._act_on_policy_association_for_endpoint(policy, endpoint, self._put)

    def check_policy_association_for_endpoint(self, policy, endpoint):
        """Check an association between a policy and an endpoint."""
        return self._act_on_policy_association_for_endpoint(policy, endpoint, self._head)
    ...
    def create_policy_association_for_service(self, policy, service):
        ...
        return self._act_on_policy_association_for_service(policy, service, self._put)
    ...
    def delete_policy_association_for_service(self, policy, service):
        ...
        return self._act_on_policy_association_for_service(policy, service, self._delete)
    ...
    def create_policy_association_for_region_and_service(self, policy, region, service):
        """Create an association between a policy and a service in a region."""
        return self._act_on_policy_association_for_region_and_service(policy, region, service, self._put)
    ...
    def get_policy_for_endpoint(self, endpoint):
        ...
        endpoint_id = base.getid(endpoint)
        url = '/endpoints/%(endpoint_id)s/%(ext_name)s/policy' % {'endpoint_id': endpoint_id, 'ext_name': self.OS_EP_POLICY_EXT}
        resp, body = self.client.get(url)
        return self._prepare_return_value(resp, policies.Policy(self, body[policies.PolicyManager.key], loaded=True))
    ...
    def list_endpoints_for_policy(self, policy):
        ...
        policy_id = base.getid(policy)
        url = '/policies/%(policy_id)s/%(ext_name)s/endpoints' % {'policy_id': policy_id, 'ext_name': self.OS_EP_POLICY_EXT}
        return self._list(url, endpoints.EndpointManager.collection_key, obj_class=endpoints.EndpointManager.resource_class)