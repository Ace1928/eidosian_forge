...
class AcsClient:
    ...
    def __init__(self, access_key, access_key_secret, region_id, max_retries):
        self.cli = client.AcsClient(ak=access_key, secret=access_key_secret, max_retry_time=max_retries, region_id=region_id)
    ...
    def create_instance(self, instance_type, image_id, tags, key_pair_name, optimized='optimized', instance_charge_type='PostPaid', spot_strategy='SpotWithPriceLimit', internet_charge_type='PayByTraffic', internet_max_bandwidth_out=5):
