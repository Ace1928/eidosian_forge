...
def test_amphora_failover_unlinked_wait(self, mock_wait_delete, mock_wait_active):
    ...
    mock_wait_delete.assert_called_once_with(manager=mock.ANY, res_id=self._amp.id, sleep_time=mock.ANY, status_field='provisioning_status')