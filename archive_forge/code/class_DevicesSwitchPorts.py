...
class DevicesSwitchPorts(object):
    ...
    def update_by_id_params(self):
        ...
        if self.new_object.get('voiceVlan') is not None or self.new_object.get('voice_vlan') is not None:
            new_object_params['voiceVlan'] = self.new_object.get('voiceVlan') or self.new_object.get('voice_vlan')
        ...
        if self.new_object.get('stpGuard') is not None or self.new_object.get('stp_guard') is not None:
            new_object_params['stpGuard'] = self.new_object.get('stpGuard') or self.new_object.get('stp_guard')
        if self.new_object.get('linkNegotiation') is not None or self.new_object.get('link_negotiation') is not None:
            new_object_params['linkNegotiation'] = self.new_object.get('linkNegotiation') or self.new_object.get('link_negotiation')
        if self.new_object.get('portScheduleId') is not None or self.new_object.get('port_schedule_id') is not None:
            new_object_params['portScheduleId'] = self.new_object.get('portScheduleId') or self.new_object.get('port_schedule_id')
        if self.new_object.get('udld') is not None or self.new_object.get('udld') is not None:
            new_object_params['udld'] = self.new_object.get('udld') or self.new_object.get('udld')
        ...
        if self.new_object.get('macAllowList') is not None or self.new_object.get('mac_allow_list') is not None:
            new_object_params['macAllowList'] = self.new_object.get('macAllowList') or self.new_object.get('mac_allow_list')
        if self.new_object.get('stickyMacAllowList') is not None or self.new_object.get('sticky_mac_allow_list') is not None:
            new_object_params['stickyMacAllowList'] = self.new_object.get('stickyMacAllowList') or self.new_object.get('sticky_mac_allow_list')
        if self.new_object.get('stickyMacAllowListLimit') is not None or self.new_object.get('sticky_mac_allow_list_limit') is not None:
            new_object_params['stickyMacAllowListLimit'] = self.new_object.get('stickyMacAllowListLimit') or self.new_object.get('sticky_mac_allow_list_limit')
        ...
        if self.new_object.get('adaptivePolicyGroupId') is not None or self.new_object.get('adaptive_policy_group_id') is not None:
            new_object_params['adaptivePolicyGroupId'] = self.new_object.get('adaptivePolicyGroupId') or self.new_object.get('adaptive_policy_group_id')
        ...
        if self.new_object.get('profile') is not None or self.new_object.get('profile') is not None:
            new_object_params['profile'] = self.new_object.get('profile') or self.new_object.get('profile')
        if self.new_object.get('serial') is not None or self.new_object.get('serial') is not None:
    ...
    def get_object_by_name(self, name):
        ...
        try:
            items = self.meraki.exec_meraki(family='switch', function='getDeviceSwitchPorts', params=self.get_all_params(name=name))
    ...
    def get_object_by_id(self, id):
        result = None
        try:
            items = self.meraki.exec_meraki(family='switch', function='getDeviceSwitchPort', params=self.get_params_by_id())
            if isinstance(items, dict):
                if 'response' in items:
                    items = items.get('response')
            result = items
    ...
    def exists(self):
        ...
        o_id = o_id or self.new_object.get('port_id') or self.new_object.get('portId')
    ...
    def requires_update(self, current_obj):
        ...
        obj_params = [('name', 'name'), ('tags', 'tags'), ('enabled', 'enabled'), ('poeEnabled', 'poeEnabled'), ('type', 'type'), ('vlan', 'vlan'), ('voiceVlan', 'voiceVlan'), ('allowedVlans', 'allowedVlans'), ('isolationEnabled', 'isolationEnabled'), ('rstpEnabled', 'rstpEnabled'), ('stpGuard', 'stpGuard'), ('linkNegotiation', 'linkNegotiation'), ('portScheduleId', 'portScheduleId'), ('udld', 'udld'), ('accessPolicyType', 'accessPolicyType'), ('accessPolicyNumber', 'accessPolicyNumber'), ('macAllowList', 'macAllowList'), ('stickyMacAllowList', 'stickyMacAllowList'), ('stickyMacAllowListLimit', 'stickyMacAllowListLimit'), ('stormControlEnabled', 'stormControlEnabled'), ('adaptivePolicyGroupId', 'adaptivePolicyGroupId'), ('peerSgtCapable', 'peerSgtCapable'), ('flexibleStackingEnabled', 'flexibleStackingEnabled'), ('daiTrusted', 'daiTrusted'), ('profile', 'profile'), ('serial', 'serial'), ('portId', 'portId')]
    ...
    def update(self):
        ...
        result = self.meraki.exec_meraki(family='switch', function='updateDeviceSwitchPort', params=self.update_by_id_params(), op_modifies=True)
        return result