...
def _panoptic_quality(preds: Tensor, target: Tensor, things: Collection[int], stuffs: Collection[int], allow_unknown_preds_category: bool=False) -> Tensor:
    ...
    return panoptic_quality(preds=preds, target=target, things=things, stuffs=stuffs, allow_unknown_preds_category=allow_unknown_preds_category)