...
@implementer(IReadWriteHandle, interfaces.IListeningPort, interfaces.IUDPTransport, interfaces.ISystemHandle)
    ...
    def write(self, datagram, addr=None):
        ...
        if self._connectedAddr:
            ...
            try:
                ...
                elif no in (errno.WSAECONNREFUSED, errno.WSAECONNRESET, ERROR_CONNECTION_REFUSED, ERROR_PORT_UNREACHABLE):
                    self.protocol.connectionRefused()
                else:
                    raise
        else:
