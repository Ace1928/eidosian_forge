...
class CircularShiftGate(PermutationGate):
    ...
    def __repr__(self) -> str:
        return f'cirq.contrib.acquaintance.CircularShiftGate(num_qubits={self.num_qubits()!r},shift={self.shift!r}, swap_gate={self.swap_gate!r})'
    ...
    def _circuit_diagram_info_(self, args: 'cirq.CircuitDiagramInfoArgs') -> Tuple[str, ...]:
        ...
        wire_symbols = tuple((direction_symbols[int(i >= self.shift)] + str(i) + direction_symbols[int(i < self.shift)] for i in range(self.num_qubits())))
        return wire_symbols
