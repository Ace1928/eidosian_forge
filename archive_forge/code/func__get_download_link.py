...
def _get_download_link(object_resource):
    ...
    url_string = '{}download/storage/{}/b/{}/o/{}?alt=media'.format(base, properties.VALUES.storage.json_api_version.Get(), object_resource.bucket, urllib.parse.quote(object_resource.name.encode('utf-8'), safe=b'~'))
