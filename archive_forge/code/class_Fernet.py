...
class Fernet:
    ...
    def __init__(self, key: typing.Union[bytes, str], backend: typing.Any=None) -> None:
        try:
    ...
    def decrypt(self, token: typing.Union[bytes, str], ttl: typing.Optional[int]=None) -> bytes:
    ...
    def decrypt_at_time(self, token: typing.Union[bytes, str], ttl: int, current_time: int) -> bytes:
        if ttl is None:
