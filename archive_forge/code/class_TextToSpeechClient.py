...
class TextToSpeechClient(metaclass=TextToSpeechClientMeta):
    ...
    def _validate_universe_domain(self):
        ...
        """
        self._is_universe_domain_valid = self._is_universe_domain_valid or TextToSpeechClient._compare_universes(self.universe_domain, self.transport._credentials)
    ...
    def __init__(self, *, credentials: Optional[ga_credentials.Credentials]=None, transport: Optional[Union[str, TextToSpeechTransport]]=None, client_options: Optional[Union[client_options_lib.ClientOptions, dict]]=None, client_info: gapic_v1.client_info.ClientInfo=DEFAULT_CLIENT_INFO) -> None:
        ...
        self._api_endpoint = self._api_endpoint or TextToSpeechClient._get_api_endpoint(self._client_options.api_endpoint, self._client_cert_source, self._universe_domain, self._use_mtls_endpoint)
    ...
    def list_voices(self, request: Optional[Union[cloud_tts.ListVoicesRequest, dict]]=None, *, language_code: Optional[str]=None, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> cloud_tts.ListVoicesResponse:
    ...
    def synthesize_speech(self, request: Optional[Union[cloud_tts.SynthesizeSpeechRequest, dict]]=None, *, input: Optional[cloud_tts.SynthesisInput]=None, voice: Optional[cloud_tts.VoiceSelectionParams]=None, audio_config: Optional[cloud_tts.AudioConfig]=None, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> cloud_tts.SynthesizeSpeechResponse:
