...
def test_volume_create_user_project_name(self):
    ...
    arglist = ['--size', str(self.new_volume.size), '--project', self.project.name, '--user', self.user.name, self.new_volume.display_name]
    verifylist = [('size', self.new_volume.size), ('project', self.project.name), ('user', self.user.name), ('name', self.new_volume.display_name)]
