...
class AsyncVectorStores(AsyncAPIResource):
    ...
    async def create(self, *, expires_after: vector_store_create_params.ExpiresAfter | NotGiven=NOT_GIVEN, file_ids: List[str] | NotGiven=NOT_GIVEN, metadata: Optional[object] | NotGiven=NOT_GIVEN, name: str | NotGiven=NOT_GIVEN, extra_headers: Headers | None=None, extra_query: Query | None=None, extra_body: Body | None=None, timeout: float | httpx.Timeout | None | NotGiven=NOT_GIVEN) -> VectorStore:
        ...
        return await self._post('/vector_stores', body=await async_maybe_transform({'expires_after': expires_after, 'file_ids': file_ids, 'metadata': metadata, 'name': name}, vector_store_create_params.VectorStoreCreateParams), options=make_request_options(extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout), cast_to=VectorStore)

    async def retrieve(self, vector_store_id: str, *, extra_headers: Headers | None=None, extra_query: Query | None=None, extra_body: Body | None=None, timeout: float | httpx.Timeout | None | NotGiven=NOT_GIVEN) -> VectorStore:
        """
        ...
        extra_headers = {'OpenAI-Beta': 'assistants=v2', **(extra_headers or {})}
        return await self._get(f'/vector_stores/{vector_store_id}', options=make_request_options(extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout), cast_to=VectorStore)
    ...
    async def update(self, vector_store_id: str, *, expires_after: Optional[vector_store_update_params.ExpiresAfter] | NotGiven=NOT_GIVEN, metadata: Optional[object] | NotGiven=NOT_GIVEN, name: Optional[str] | NotGiven=NOT_GIVEN, extra_headers: Headers | None=None, extra_query: Query | None=None, extra_body: Body | None=None, timeout: float | httpx.Timeout | None | NotGiven=NOT_GIVEN) -> VectorStore:
        ...
        if not vector_store_id:
            raise ValueError(f'Expected a non-empty value for `vector_store_id` but received {vector_store_id!r}')
        extra_headers = {'OpenAI-Beta': 'assistants=v2', **(extra_headers or {})}
        return await self._post(f'/vector_stores/{vector_store_id}', body=await async_maybe_transform({'expires_after': expires_after, 'metadata': metadata, 'name': name}, vector_store_update_params.VectorStoreUpdateParams), options=make_request_options(extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout), cast_to=VectorStore)

    def list(self, *, after: str | NotGiven=NOT_GIVEN, before: str | NotGiven=NOT_GIVEN, limit: int | NotGiven=NOT_GIVEN, order: Literal['asc', 'desc'] | NotGiven=NOT_GIVEN, extra_headers: Headers | None=None, extra_query: Query | None=None, extra_body: Body | None=None, timeout: float | httpx.Timeout | None | NotGiven=NOT_GIVEN) -> AsyncPaginator[VectorStore, AsyncCursorPage[VectorStore]]:
        ...
        """
        extra_headers = {'OpenAI-Beta': 'assistants=v2', **(extra_headers or {})}
        return self._get_api_list('/vector_stores', page=AsyncCursorPage[VectorStore], options=make_request_options(extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout, query=maybe_transform({'after': after, 'before': before, 'limit': limit, 'order': order}, vector_store_list_params.VectorStoreListParams)), model=VectorStore)

    async def delete(self, vector_store_id: str, *, extra_headers: Headers | None=None, extra_query: Query | None=None, extra_body: Body | None=None, timeout: float | httpx.Timeout | None | NotGiven=NOT_GIVEN) -> VectorStoreDeleted:
        """
        ...
        if not vector_store_id:
            raise ValueError(f'Expected a non-empty value for `vector_store_id` but received {vector_store_id!r}')
        extra_headers = {'OpenAI-Beta': 'assistants=v2', **(extra_headers or {})}
        return await self._delete(f'/vector_stores/{vector_store_id}', options=make_request_options(extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout), cast_to=VectorStoreDeleted)