...
class DTD(VisionDataset):
    ...
    def __init__(self, root: str, split: str='train', partition: int=1, transform: Optional[Callable]=None, target_transform: Optional[Callable]=None, download: bool=False) -> None:
