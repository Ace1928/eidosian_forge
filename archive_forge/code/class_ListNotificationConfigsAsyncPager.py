...
class ListNotificationConfigsAsyncPager:
    ...
    def __init__(self, method: Callable[..., Awaitable[storage.ListNotificationConfigsResponse]], request: storage.ListNotificationConfigsRequest, response: storage.ListNotificationConfigsResponse, *, metadata: Sequence[Tuple[str, str]]=()):
