...
class SaharaUtilsTest(common.HeatTestCase):
    ...
    def test_get_image_id(self):
        ...
        self.sahara_client.images.get.side_effect = [self.my_image, sahara_base.APIException(404), sahara_base.APIException(404)]
        ...
        self.assertRaises(exception.EntityNotFound, self.sahara_plugin.get_image_id, 'noimage')
        calls = [mock.call(name=img_name), mock.call(name='noimage')]
    ...
    def test_get_image_id_sahara_exception(self):
        ...
        e = self.assertRaises(exception.Error, self.sahara_plugin.find_resource_by_name, 'images', img_name)
