    ...
    def draw_group(data: pd.DataFrame, panel_params: panel_view, coord: coord, ax: Axes, **params: Any):
        ...
        if draw_label:
            ...
            if params['boxstyle'] in ('round', 'round4'):
                boxstyle = f'{params['boxstyle']},pad={params['label_padding']},rounding_size={params['label_r']}'
            elif params['boxstyle'] in ('roundtooth', 'sawtooth'):
                boxstyle = f'{params['boxstyle']},pad={params['label_padding']},tooth_size={params['tooth_size']}'
            else:
                boxstyle = f'{params['boxstyle']},pad={params['label_padding']},'
