class VideoAttributes(object):
    ...
    def __init__(self, downloadablemedia_attributes, width, height, seconds, gif_playback=None, jpeg_thumbnail=None, gif_attribution=None, caption=None, streaming_sidecar=None):
