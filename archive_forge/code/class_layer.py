...
class layer:
    ...
    def __init__(self, geom: geom, stat: stat, *, mapping: aes, data: Optional[LayerDataLike], position: position, inherit_aes: bool=True, show_legend: bool | dict[str, bool] | None=None, raster: bool=False):
        self.geom = geom
        self.stat = stat
        self._data = data
    ...
    def from_geom(geom: geom) -> layer:
        ...
        """
        kwargs = geom._kwargs
        lkwargs = {'geom': geom, 'mapping': geom.mapping, 'data': geom.data, 'stat': geom._stat, 'position': geom._position}
    ...
    def setup_data(self):
        ...
        check_required_aesthetics(self.geom.REQUIRED_AES, set(data.columns) | set(self.geom.aes_params), self.geom.__class__.__name__)
        self.data = data
    ...
    def use_defaults(self, data: pd.DataFrame | None=None, aes_modifiers: dict[str, Any] | None=None) -> pd.DataFrame:
        """
        Prepare/modify data for plotting
