...
class RoiAlign(OpRun):
    ...
    def _run(self, X, rois, batch_indices, coordinate_transformation_mode=None, mode=None, output_height=None, output_width=None, sampling_ratio=None, spatial_scale=None):
        coordinate_transformation_mode = coordinate_transformation_mode or self.coordinate_transformation_mode
        ...
        self.roi_align_forward(y_dims, X.flatten(), spatial_scale, X.shape[2], X.shape[3], sampling_ratio, rois.flatten(), num_roi_cols, Y, mode.lower(), coordinate_transformation_mode.lower() == 'half_pixel', batch_indices.flatten())
