...
class TimeSeries(TimeSeriesCommands):
    ...
    def __init__(self, client=None, **kwargs):
        ...
        self._MODULE_CALLBACKS = {ALTER_CMD: bool_ok, CREATE_CMD: bool_ok, CREATERULE_CMD: bool_ok, DELETERULE_CMD: bool_ok}
        _RESP2_MODULE_CALLBACKS = {DEL_CMD: int, GET_CMD: parse_get, INFO_CMD: TSInfo, MGET_CMD: parse_m_get, MRANGE_CMD: parse_m_range, MREVRANGE_CMD: parse_m_range, RANGE_CMD: parse_range, REVRANGE_CMD: parse_range, QUERYINDEX_CMD: parse_to_list}
