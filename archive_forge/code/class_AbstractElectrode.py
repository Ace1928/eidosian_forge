...
class AbstractElectrode(Sequence, MSONable):
    ...
    def get_sub_electrodes(self, adjacent_only=True):
        ...
        """
        raise NotImplementedError(f'The get_sub_electrodes function must be implemented for each concrete electrode class {type(self).__name__}')
