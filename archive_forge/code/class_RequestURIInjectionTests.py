...
class RequestURIInjectionTests(URIInjectionTestsMixin, SynchronousTestCase):
    """
    ...
    def attemptRequestWithMaliciousURI(self, uri):
        ...
        """
        client.Request(method=b'GET', uri=uri, headers=http_headers.Headers(), bodyProducer=None)