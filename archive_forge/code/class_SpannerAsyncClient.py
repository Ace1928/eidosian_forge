...
class SpannerAsyncClient:
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        """
        return SpannerClient.from_service_account_info.__func__(SpannerAsyncClient, info, *args, **kwargs)
    ...
    def from_service_account_file(cls, filename: str, *args, **kwargs):
        ...
        Returns:
            SpannerAsyncClient: The constructed client.
        """
        return SpannerClient.from_service_account_file.__func__(SpannerAsyncClient, filename, *args, **kwargs)
    ...
    def get_mtls_endpoint_and_cert_source(cls, client_options: Optional[ClientOptions]=None):
        ...
        """
        return SpannerClient.get_mtls_endpoint_and_cert_source(client_options)
    ...
    def __init__(self, *, credentials: Optional[ga_credentials.Credentials]=None, transport: Union[str, SpannerTransport]='grpc_asyncio', client_options: Optional[ClientOptions]=None, client_info: gapic_v1.client_info.ClientInfo=DEFAULT_CLIENT_INFO) -> None:
        ...
        """
        self._client = SpannerClient(credentials=credentials, transport=transport, client_options=client_options, client_info=client_info)

    async def create_session(self, request: Optional[Union[spanner.CreateSessionRequest, dict]]=None, *, database: Optional[str]=None, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> spanner.Session:
        ...
        rpc = gapic_v1.method_async.wrap_method(self._client._transport.create_session, default_retry=retries.Retry(initial=0.25, maximum=32.0, multiplier=1.3, predicate=retries.if_exception_type(core_exceptions.ServiceUnavailable), deadline=30.0), default_timeout=30.0, client_info=DEFAULT_CLIENT_INFO)
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((('database', request.database),)),)
        response = await rpc(request, retry=retry, timeout=timeout, metadata=metadata)
        return response

    async def batch_create_sessions(self, request: Optional[Union[spanner.BatchCreateSessionsRequest, dict]]=None, *, database: Optional[str]=None, session_count: Optional[int]=None, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> spanner.BatchCreateSessionsResponse:
        ...
        rpc = gapic_v1.method_async.wrap_method(self._client._transport.batch_create_sessions, default_retry=retries.Retry(initial=0.25, maximum=32.0, multiplier=1.3, predicate=retries.if_exception_type(core_exceptions.ServiceUnavailable), deadline=60.0), default_timeout=60.0, client_info=DEFAULT_CLIENT_INFO)
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((('database', request.database),)),)
        response = await rpc(request, retry=retry, timeout=timeout, metadata=metadata)
        return response

    async def get_session(self, request: Optional[Union[spanner.GetSessionRequest, dict]]=None, *, name: Optional[str]=None, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> spanner.Session:
        ...
        if name is not None:
            request.name = name
        rpc = gapic_v1.method_async.wrap_method(self._client._transport.get_session, default_retry=retries.Retry(initial=0.25, maximum=32.0, multiplier=1.3, predicate=retries.if_exception_type(core_exceptions.ServiceUnavailable), deadline=30.0), default_timeout=30.0, client_info=DEFAULT_CLIENT_INFO)
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((('name', request.name),)),)
        response = await rpc(request, retry=retry, timeout=timeout, metadata=metadata)
        return response

    async def list_sessions(self, request: Optional[Union[spanner.ListSessionsRequest, dict]]=None, *, database: Optional[str]=None, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> pagers.ListSessionsAsyncPager:
        ...
        if database is not None:
            request.database = database
        rpc = gapic_v1.method_async.wrap_method(self._client._transport.list_sessions, default_retry=retries.Retry(initial=0.25, maximum=32.0, multiplier=1.3, predicate=retries.if_exception_type(core_exceptions.ServiceUnavailable), deadline=3600.0), default_timeout=3600.0, client_info=DEFAULT_CLIENT_INFO)
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((('database', request.database),)),)
        response = await rpc(request, retry=retry, timeout=timeout, metadata=metadata)
        response = pagers.ListSessionsAsyncPager(method=rpc, request=request, response=response, metadata=metadata)
        return response

    async def delete_session(self, request: Optional[Union[spanner.DeleteSessionRequest, dict]]=None, *, name: Optional[str]=None, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> None:
        ...
        if name is not None:
            request.name = name
        rpc = gapic_v1.method_async.wrap_method(self._client._transport.delete_session, default_retry=retries.Retry(initial=0.25, maximum=32.0, multiplier=1.3, predicate=retries.if_exception_type(core_exceptions.ServiceUnavailable), deadline=30.0), default_timeout=30.0, client_info=DEFAULT_CLIENT_INFO)
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((('name', request.name),)),)
        await rpc(request, retry=retry, timeout=timeout, metadata=metadata)

    async def execute_sql(self, request: Optional[Union[spanner.ExecuteSqlRequest, dict]]=None, *, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> result_set.ResultSet:
        ...
        rpc = gapic_v1.method_async.wrap_method(self._client._transport.execute_sql, default_retry=retries.Retry(initial=0.25, maximum=32.0, multiplier=1.3, predicate=retries.if_exception_type(core_exceptions.ServiceUnavailable), deadline=30.0), default_timeout=30.0, client_info=DEFAULT_CLIENT_INFO)
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((('session', request.session),)),)
        response = await rpc(request, retry=retry, timeout=timeout, metadata=metadata)
        return response

    def execute_streaming_sql(self, request: Optional[Union[spanner.ExecuteSqlRequest, dict]]=None, *, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> Awaitable[AsyncIterable[result_set.PartialResultSet]]:
        ...
        """
        request = spanner.ExecuteSqlRequest(request)
        rpc = gapic_v1.method_async.wrap_method(self._client._transport.execute_streaming_sql, default_timeout=3600.0, client_info=DEFAULT_CLIENT_INFO)
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((('session', request.session),)),)
        response = rpc(request, retry=retry, timeout=timeout, metadata=metadata)
        return response

    async def execute_batch_dml(self, request: Optional[Union[spanner.ExecuteBatchDmlRequest, dict]]=None, *, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> spanner.ExecuteBatchDmlResponse:
        ...
        rpc = gapic_v1.method_async.wrap_method(self._client._transport.execute_batch_dml, default_retry=retries.Retry(initial=0.25, maximum=32.0, multiplier=1.3, predicate=retries.if_exception_type(core_exceptions.ServiceUnavailable), deadline=30.0), default_timeout=30.0, client_info=DEFAULT_CLIENT_INFO)
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((('session', request.session),)),)
        response = await rpc(request, retry=retry, timeout=timeout, metadata=metadata)
        return response

    async def read(self, request: Optional[Union[spanner.ReadRequest, dict]]=None, *, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> result_set.ResultSet:
        ...
        rpc = gapic_v1.method_async.wrap_method(self._client._transport.read, default_retry=retries.Retry(initial=0.25, maximum=32.0, multiplier=1.3, predicate=retries.if_exception_type(core_exceptions.ServiceUnavailable), deadline=30.0), default_timeout=30.0, client_info=DEFAULT_CLIENT_INFO)
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((('session', request.session),)),)
        response = await rpc(request, retry=retry, timeout=timeout, metadata=metadata)
        return response

    def streaming_read(self, request: Optional[Union[spanner.ReadRequest, dict]]=None, *, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> Awaitable[AsyncIterable[result_set.PartialResultSet]]:
        ...
        """
        request = spanner.ReadRequest(request)
        rpc = gapic_v1.method_async.wrap_method(self._client._transport.streaming_read, default_timeout=3600.0, client_info=DEFAULT_CLIENT_INFO)
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((('session', request.session),)),)
        response = rpc(request, retry=retry, timeout=timeout, metadata=metadata)
        return response

    async def begin_transaction(self, request: Optional[Union[spanner.BeginTransactionRequest, dict]]=None, *, session: Optional[str]=None, options: Optional[transaction.TransactionOptions]=None, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> transaction.Transaction:
        ...
        rpc = gapic_v1.method_async.wrap_method(self._client._transport.begin_transaction, default_retry=retries.Retry(initial=0.25, maximum=32.0, multiplier=1.3, predicate=retries.if_exception_type(core_exceptions.ServiceUnavailable), deadline=30.0), default_timeout=30.0, client_info=DEFAULT_CLIENT_INFO)
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((('session', request.session),)),)
        response = await rpc(request, retry=retry, timeout=timeout, metadata=metadata)
        return response

    async def commit(self, request: Optional[Union[spanner.CommitRequest, dict]]=None, *, session: Optional[str]=None, transaction_id: Optional[bytes]=None, mutations: Optional[MutableSequence[mutation.Mutation]]=None, single_use_transaction: Optional[transaction.TransactionOptions]=None, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> commit_response.CommitResponse:
        ...
        rpc = gapic_v1.method_async.wrap_method(self._client._transport.commit, default_retry=retries.Retry(initial=0.25, maximum=32.0, multiplier=1.3, predicate=retries.if_exception_type(core_exceptions.ServiceUnavailable), deadline=3600.0), default_timeout=3600.0, client_info=DEFAULT_CLIENT_INFO)
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((('session', request.session),)),)
        response = await rpc(request, retry=retry, timeout=timeout, metadata=metadata)
        return response

    async def rollback(self, request: Optional[Union[spanner.RollbackRequest, dict]]=None, *, session: Optional[str]=None, transaction_id: Optional[bytes]=None, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> None:
        ...
        if transaction_id is not None:
            request.transaction_id = transaction_id
        rpc = gapic_v1.method_async.wrap_method(self._client._transport.rollback, default_retry=retries.Retry(initial=0.25, maximum=32.0, multiplier=1.3, predicate=retries.if_exception_type(core_exceptions.ServiceUnavailable), deadline=30.0), default_timeout=30.0, client_info=DEFAULT_CLIENT_INFO)
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((('session', request.session),)),)
        await rpc(request, retry=retry, timeout=timeout, metadata=metadata)

    async def partition_query(self, request: Optional[Union[spanner.PartitionQueryRequest, dict]]=None, *, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> spanner.PartitionResponse:
        ...
        rpc = gapic_v1.method_async.wrap_method(self._client._transport.partition_query, default_retry=retries.Retry(initial=0.25, maximum=32.0, multiplier=1.3, predicate=retries.if_exception_type(core_exceptions.ServiceUnavailable), deadline=30.0), default_timeout=30.0, client_info=DEFAULT_CLIENT_INFO)
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((('session', request.session),)),)
        response = await rpc(request, retry=retry, timeout=timeout, metadata=metadata)
        return response

    async def partition_read(self, request: Optional[Union[spanner.PartitionReadRequest, dict]]=None, *, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> spanner.PartitionResponse:
        """Creates a set of partition tokens that can be used to execute a
        ...
        rpc = gapic_v1.method_async.wrap_method(self._client._transport.partition_read, default_retry=retries.Retry(initial=0.25, maximum=32.0, multiplier=1.3, predicate=retries.if_exception_type(core_exceptions.ServiceUnavailable), deadline=30.0), default_timeout=30.0, client_info=DEFAULT_CLIENT_INFO)
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((('session', request.session),)),)
        response = await rpc(request, retry=retry, timeout=timeout, metadata=metadata)
        return response

    def batch_write(self, request: Optional[Union[spanner.BatchWriteRequest, dict]]=None, *, session: Optional[str]=None, mutation_groups: Optional[MutableSequence[spanner.BatchWriteRequest.MutationGroup]]=None, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> Awaitable[AsyncIterable[spanner.BatchWriteResponse]]:
        ...
        rpc = gapic_v1.method_async.wrap_method(self._client._transport.batch_write, default_timeout=3600.0, client_info=DEFAULT_CLIENT_INFO)
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((('session', request.session),)),)
        response = rpc(request, retry=retry, timeout=timeout, metadata=metadata)
        return response
