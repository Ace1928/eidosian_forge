...
class UpgradeInstance(base.UpdateCommand):
    ...
    detailed_help = {'EXAMPLES': textwrap.dedent('          To upgrade a `DEVELOPMENT` instance to `PRODUCTION`, run:\n\n            $ {command} my-instance-id\n\n          ')}
    ...
    """
        ...
        if args.async_:
            ...
            op_ref = resources.REGISTRY.ParseRelativeName(op.name, collection='bigtableadmin.operations')
