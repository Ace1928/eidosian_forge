...
class TestDataHandler(unittest.TestCase):
    ...
    def create_hit(self):
        return {'HIT': {'HITId': str(uuid.uuid4()), 'Expiration': datetime.today().replace(microsecond=0), 'HITStatus': str(uuid.uuid4()), 'NumberOfAssignmentsPending': 1, 'NumberOfAssignmentsAvailable': 2, 'NumberOfAssignmentsCompleted': 3}}
