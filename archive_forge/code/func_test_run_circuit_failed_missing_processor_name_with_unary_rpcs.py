...
def test_run_circuit_failed_missing_processor_name_with_unary_rpcs(client):
    ...
    client().get_job_async.return_value = quantum.QuantumJob(name='projects/proj/programs/prog/jobs/job-id', execution_status={'state': 'FAILURE', 'failure': {'error_code': 'SYSTEM_ERROR', 'error_message': 'Not good'}})
