...
class PartitionAssignmentServiceGrpcAsyncIOTransport(PartitionAssignmentServiceTransport):
    ...
    @property
    def assign_partitions(self) -> Callable[[subscriber.PartitionAssignmentRequest], Awaitable[subscriber.PartitionAssignment]]:
        """Return a callable for the assign partitions method over gRPC.
        ...
        if 'assign_partitions' not in self._stubs:
            self._stubs['assign_partitions'] = self.grpc_channel.stream_stream('/google.cloud.pubsublite.v1.PartitionAssignmentService/AssignPartitions', request_serializer=subscriber.PartitionAssignmentRequest.serialize, response_deserializer=subscriber.PartitionAssignment.deserialize)
