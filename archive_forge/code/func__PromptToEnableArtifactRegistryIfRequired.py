...
def _PromptToEnableArtifactRegistryIfRequired(cli_args):
  ...
  """
    if cli_args.IsSpecified('docker_registry') and cli_args.docker_registry == 'container-registry':
        return
    api_enablement.PromptToEnableApiIfDisabled('artifactregistry.googleapis.com', enable_by_default=True)