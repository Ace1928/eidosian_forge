...
class ServicePolicyAssociations(flask_restful.Resource):
    ...
    def get(self, policy_id, service_id):
        ...
        PROVIDERS.endpoint_policy_api.check_policy_association(policy_id, service_id=service_id)
    ...
    def put(self, policy_id, service_id):
        ...
        PROVIDERS.policy_api.get_policy(policy_id)
        PROVIDERS.catalog_api.get_service(service_id)
        PROVIDERS.endpoint_policy_api.create_policy_association(policy_id, service_id=service_id)
        return (None, http.client.NO_CONTENT)
    ...
    def delete(self, policy_id, service_id):
        ...
        PROVIDERS.policy_api.get_policy(policy_id)
        PROVIDERS.catalog_api.get_service(service_id)
        PROVIDERS.endpoint_policy_api.delete_policy_association(policy_id, service_id=service_id)
        return (None, http.client.NO_CONTENT)