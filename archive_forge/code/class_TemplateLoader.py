...
class TemplateLoader(object):
    ...
    def __init__(self, search_path=None, auto_reload=False, default_encoding=None, max_cache_size=25, default_class=None, variable_lookup='strict', allow_exec=True, callback=None):
            ...
            for loadfunc in search_path:
                ...
                try:
                    ...
                    try:
                        if isabs:
                            filename = filepath
                        tmpl = self._instantiate(cls, fileobj, filepath, filename, encoding=encoding)
                        if self.callback:
                            self.callback(tmpl)
