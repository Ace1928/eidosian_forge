...
class MeshPlugin(base_plugin.TBPlugin):
    ...
    def __init__(self, context):
        ...
        self._version_checker = plugin_util._MetadataVersionChecker(data_kind='mesh', latest_known_version=0)
    ...
    def _tag(self, ctx, experiment, run, instance_tag):
        ...
        return self._instance_tag_metadata(ctx, experiment, run, instance_tag).name
    ...
    def _serve_tags(self, request):
        ...
        all_runs = self._data_provider.list_tensors(ctx, experiment_id=experiment, plugin_name=metadata.PLUGIN_NAME)
        response = dict()
    ...
    def get_plugin_apps(self):
        ...
        """
        return {'/tags': self._serve_tags, '/meshes': self._serve_mesh_metadata, '/data': self._serve_mesh_data}
