...
class AsyncHTTP11Connection(AsyncConnectionInterface):
    ...
    def __init__(self, origin: Origin, stream: AsyncNetworkStream, keepalive_expiry: Optional[float]=None) -> None:
        self._origin = origin
    ...
    async def _send_event(self, event: h11.Event, timeout: Optional[float]=None) -> None:
    ...
    async def _receive_event(self, timeout: Optional[float]=None) -> Union[h11.Event, Type[h11.PAUSED]]:
        while True:
