...
class SubnetworksScopedWarning(_messages.Message):
    """A SubnetworksScopedWarning object.

  Messages:
    WarningValue: An informational warning about unreachable scope
  ...
  """
    ...
    scopeName = _messages.StringField(1)
