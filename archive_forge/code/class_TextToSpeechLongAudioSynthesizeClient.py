...
class TextToSpeechLongAudioSynthesizeClient(metaclass=TextToSpeechLongAudioSynthesizeClientMeta):
    ...
    def _validate_universe_domain(self):
        ...
        """
        self._is_universe_domain_valid = self._is_universe_domain_valid or TextToSpeechLongAudioSynthesizeClient._compare_universes(self.universe_domain, self.transport._credentials)
    ...
    def __init__(self, *, credentials: Optional[ga_credentials.Credentials]=None, transport: Optional[Union[str, TextToSpeechLongAudioSynthesizeTransport]]=None, client_options: Optional[Union[client_options_lib.ClientOptions, dict]]=None, client_info: gapic_v1.client_info.ClientInfo=DEFAULT_CLIENT_INFO) -> None:
        ...
        self._api_endpoint = self._api_endpoint or TextToSpeechLongAudioSynthesizeClient._get_api_endpoint(self._client_options.api_endpoint, self._client_cert_source, self._universe_domain, self._use_mtls_endpoint)
    ...
    def synthesize_long_audio(self, request: Optional[Union[cloud_tts_lrs.SynthesizeLongAudioRequest, dict]]=None, *, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> operation.Operation:
