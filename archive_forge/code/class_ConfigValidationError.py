...
class ConfigValidationError(ValueError):
    ...
    def __init__(self, *, config: Optional[Union[Config, Dict[str, Dict[str, Any]], str]]=None, errors: Union[Sequence[Mapping[str, Any]], Iterable[Dict[str, Any]]]=tuple(), title: Optional[str]='Config validation error', desc: Optional[str]=None, parent: Optional[str]=None, show_config: bool=True) -> None:
