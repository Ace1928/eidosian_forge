...
class Mlflow(LLM):
    ...
    def __init__(self, **kwargs: Any):
        ...
        try:
            ...
            raise ImportError('Failed to create the client. Please run `pip install mlflow[genai]` to install required dependencies.') from e
    ...
    def _call(self, prompt: str, stop: Optional[List[str]]=None, run_manager: Optional[CallbackManagerForLLMRun]=None, **kwargs: Any) -> str:
        data: Dict[str, Any] = {'prompt': prompt, 'temperature': self.temperature, 'n': self.n, **self.extra_params, **kwargs}
