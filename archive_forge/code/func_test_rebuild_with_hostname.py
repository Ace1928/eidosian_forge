...
def test_rebuild_with_hostname(self):
    self.run_command('rebuild sample-server %s --hostname new-hostname' % FAKE_UUID_1, api_version='2.90')
    ...
    self.assert_called('POST', '/servers/1234/action', {'rebuild': {'imageRef': FAKE_UUID_1, 'description': None, 'hostname': 'new-hostname'}}, pos=3)
