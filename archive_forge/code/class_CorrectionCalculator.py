...
class CorrectionCalculator:
    ...
    def __init__(self, species: list[str] | None=None, max_error: float=0.1, allow_unstable: float | bool=0.1, exclude_polyanions: list[str] | None=None) -> None:
        ...
        self.exclude_polyanions = exclude_polyanions if exclude_polyanions is not None else 'SO4 SO3 CO3 NO3 NO2 OCl3 ClO3 ClO4 HO ClO SeO3 TiO3 TiO4 WO4 SiO3 SiO4 Si2O5 PO3 PO4 P2O7'.split()
        self.corrections: list[float] = []
        self.corrections_std_error: list[float] = []
        self.corrections_dict: dict[str, tuple[float, float]] = {}
