...
class ContainerV1(base_api.BaseApiClient):
    ...
    def __init__(self, url='', credentials=None, get_credentials=True, http=None, model=None, log_request=False, log_response=False, credentials_args=None, default_global_params=None, additional_http_headers=None, response_encoding=None):
        ...
        super(ContainerV1, self).__init__(url, credentials=credentials, get_credentials=get_credentials, http=http, model=model, log_request=log_request, log_response=log_response, credentials_args=credentials_args, default_global_params=default_global_params, additional_http_headers=additional_http_headers, response_encoding=response_encoding)
    ...
    class ProjectsLocationsOperationsService(base_api.BaseApiService):
      ...
      """
            ...
            return self._RunMethod(config, request, global_params=global_params)
        Cancel.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1/projects/{projectsId}/locations/{locationsId}/operations/{operationsId}:cancel', http_method='POST', method_id='container.projects.locations.operations.cancel', ordered_params=['name'], path_params=['name'], query_params=[], relative_path='v1/{+name}:cancel', request_field='<request>', request_type_name='CancelOperationRequest', response_type_name='Empty', supports_download=False)
      ...
      """
            config = self.GetMethodConfig('Get')
            return self._RunMethod(config, request, global_params=global_params)
        Get.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1/projects/{projectsId}/locations/{locationsId}/operations/{operationsId}', http_method='GET', method_id='container.projects.locations.operations.get', ordered_params=['name'], path_params=['name'], query_params=['operationId', 'projectId', 'zone'], relative_path='v1/{+name}', request_field='', request_type_name='ContainerProjectsLocationsOperationsGetRequest', response_type_name='Operation', supports_download=False)
      ...
      """
            config = self.GetMethodConfig('List')
            return self._RunMethod(config, request, global_params=global_params)
        List.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1/projects/{projectsId}/locations/{locationsId}/operations', http_method='GET', method_id='container.projects.locations.operations.list', ordered_params=['parent'], path_params=['parent'], query_params=['projectId', 'zone'], relative_path='v1/{+parent}/operations', request_field='', request_type_name='ContainerProjectsLocationsOperationsListRequest', response_type_name='ListOperationsResponse', supports_download=False)
    ...
    class ProjectsLocationsService(base_api.BaseApiService):
      ...
      """
            ...
            return self._RunMethod(config, request, global_params=global_params)
        GetServerConfig.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1/projects/{projectsId}/locations/{locationsId}/serverConfig', http_method='GET', method_id='container.projects.locations.getServerConfig', ordered_params=['name'], path_params=['name'], query_params=['projectId', 'zone'], relative_path='v1/{+name}/serverConfig', request_field='', request_type_name='ContainerProjectsLocationsGetServerConfigRequest', response_type_name='ServerConfig', supports_download=False)
    ...
    class ProjectsZonesService(base_api.BaseApiService):
      ...
      """
            config = self.GetMethodConfig('GetServerconfig')
            return self._RunMethod(config, request, global_params=global_params)
        GetServerconfig.method_config = lambda: base_api.ApiMethodInfo(http_method='GET', method_id='container.projects.zones.getServerconfig', ordered_params=['projectId', 'zone'], path_params=['projectId', 'zone'], query_params=['name'], relative_path='v1/projects/{projectId}/zones/{zone}/serverconfig', request_field='', request_type_name='ContainerProjectsZonesGetServerconfigRequest', response_type_name='ServerConfig', supports_download=False)
