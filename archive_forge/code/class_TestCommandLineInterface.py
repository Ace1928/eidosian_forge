...
class TestCommandLineInterface(unittest.TestCase):
    ...
    def test_single_file(self):
        self.assertEqual(0, cli_detect(['./data/sample-arabic-1.txt']))
    ...
    def test_multiple_file(self):
        self.assertEqual(0, cli_detect(['./data/sample-arabic-1.txt', './data/sample-french.txt', './data/sample-chinese.txt']))

    def test_with_alternative(self):
        self.assertEqual(0, cli_detect(['-a', './data/sample-arabic-1.txt', './data/sample-french.txt', './data/sample-chinese.txt']))
