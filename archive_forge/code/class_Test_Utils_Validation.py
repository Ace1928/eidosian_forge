...
class Test_Utils_Validation(unittest.TestCase):
    ...
    def test_is_valid_ipv4_prefix_invalid_addr(self):
        self.assertEqual(False, validation.is_valid_ipv4_prefix('xxx.xxx.xxx.xxx/24'))
    ...
    def test_is_valid_vpnv6_prefix_invalid_rd(self):
        self.assertEqual(False, validation.is_valid_vpnv6_prefix('foo:bar:10.0.0.1/24'))
    ...
    def test_is_valid_mpls_label_over(self):
        self.assertEqual(False, validation.is_valid_mpls_label(1048576 + 1))
    ...
    def test_is_valid_vni_over(self):
        self.assertEqual(False, validation.is_valid_vni(16777215 + 1))