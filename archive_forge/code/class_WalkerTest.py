...
class WalkerTest(TestCase):
    ...
    def test_merge_of_new_branch_from_old_base(self):
        self.maxDiff = None
        c1, c2, c3, c4, c5 = self.make_commits([[1], [2, 1], [3, 2], [4, 1], [5, 3, 4]], times=[1, 2, 3, 4, 5])
    ...
    def test_paths_merge(self):
        ...
        blob_a2 = make_object(Blob, data=b'a2')
        blob_a3 = make_object(Blob, data=b'a3')
        x1, y2, m3, m4 = self.make_commits([[1], [2], [3, 1, 2], [4, 1, 2]], trees={1: [(b'a', blob_a1)], 2: [(b'a', blob_a2)], 3: [(b'a', blob_a3)], 4: [(b'a', blob_a1)]})
