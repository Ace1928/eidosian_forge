...
class GlobalContextMeta(type):
    ...
    settings_func: Optional[Union[Callable, str]] = None
    settings_config_func: Optional[Union[Callable, str]] = None
    get_worker_func: Optional[Union[Callable, str]] = None
    get_num_worker_func: Optional[Union[Callable, str]] = None
    get_worker_names_func: Optional[Union[Callable, str]] = None
    _settings: Optional[SettingsT] = None
    _state: Optional['AppState'] = None
    _logger: Optional['Logger'] = None

    def configure(cls, queue_types: Optional[List[str]]=None, settings_func: Optional[Union[Callable, str]]=None, settings_config_func: Optional[Union[Callable, str]]=None, get_worker_func: Optional[Union[Callable, str]]=None, get_num_worker_func: Optional[Union[Callable, str]]=None, get_worker_names_func: Optional[Union[Callable, str]]=None):
        """
        ...
        for func in cls.on_close_funcs:
            with anyio.fail_after(timeout):
                try:
                    await func()
                    if verbose:
                        cls.logger.info(f'Called function {func.__name__} on close')
