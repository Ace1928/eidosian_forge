...
def test_unexpected_status_no_response_body(self, mock_api_session, mock_select_datastore):
    ...
    with self._mock_http_connection() as HttpConn:
        HttpConn.return_value = utils.fake_response(status_code=500, no_response_body=True)
