...
class MistralCronTriggerTest(common.HeatTestCase):
    ...
    def setUp(self):
        ...
        self.patchobject(cron_trigger.CronTrigger, 'client', return_value=self.client)
    ...
    def _create_resource(self, name, snippet, stack):
        ...
        self.client.cron_triggers.create.return_value = FakeCronTrigger('my_cron_trigger')
        self.client.cron_triggers.get.return_value = FakeCronTrigger('my_cron_trigger')
    ...
    def test_attributes(self):
        ct = self._create_resource('trigger', self.rsrc_defn, self.stack)
        self.assertEqual('2015-03-01 00:00:00', ct.FnGetAtt('next_execution_time'))
