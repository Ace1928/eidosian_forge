...
class WorldWideDNSTests(unittest.TestCase):
    ...
    def test_list_zones_success(self):
        ...
        self.assertHasKeys(zone.extra, ['HOSTMASTER', 'REFRESH', 'RETRY', 'EXPIRE', 'SECURE', 'S1', 'T1', 'D1', 'S2', 'T2', 'D2', 'S3', 'T3', 'D3'])
    ...
    def test_update_zone_success(self):
        ...
        updated_zone = self.driver.update_zone(zone=zone, domain='niteowebsponsoredthisone.com', ttl=3800, extra={'HOSTMASTER': 'mail.niteowebsponsoredthisone.com'})
    ...
    def test_create_record_success(self):
        ...
        record = self.driver.create_record(name='domain4', zone=zone, type=RecordType.A, data='0.0.0.4', extra={'entry': 4})
    ...
    def test_update_record_success(self):
        ...
        record = self.driver.update_record(record=record, name='domain1', type=RecordType.A, data='0.0.0.1', extra={'entry': 1})
        self.assertEqual(record.id, '1')
