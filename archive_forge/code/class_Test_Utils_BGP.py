...
class Test_Utils_BGP(unittest.TestCase):
    ...
    def test_create_v4flowspec_actions_not_exist_actions(self):
        ...
        expected_communities = []
        self.assertRaises(ValueError, self._test_create_v4flowspec_actions, actions, expected_communities)
    ...
    def test_create_v6flowspec_actions_not_exist_actions(self):
        actions = {'traffic_test': {'test': 10}}
        expected_communities = []
        self.assertRaises(ValueError, self._test_create_v6flowspec_actions, actions, expected_communities)
