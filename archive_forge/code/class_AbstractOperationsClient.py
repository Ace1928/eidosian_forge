...
class AbstractOperationsClient(metaclass=AbstractOperationsClientMeta):
    ...
    def __init__(self, *, credentials: Optional[ga_credentials.Credentials]=None, transport: Union[str, OperationsTransport, None]=None, client_options: Optional[client_options_lib.ClientOptions]=None, client_info: gapic_v1.client_info.ClientInfo=DEFAULT_CLIENT_INFO) -> None:
    ...
    def list_operations(self, name: str, filter_: Optional[str]=None, *, page_size: Optional[int]=None, page_token: Optional[str]=None, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Optional[float]=None, compression: Optional[grpc.Compression]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> pagers.ListOperationsPager:
        ...
        response = rpc(request, retry=retry, timeout=timeout, compression=compression, metadata=metadata)
        response = pagers.ListOperationsPager(method=rpc, request=request, response=response, metadata=metadata)
        return response

    def get_operation(self, name: str, *, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Optional[float]=None, compression: Optional[grpc.Compression]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> operations_pb2.Operation:
    ...
    def delete_operation(self, name: str, *, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Optional[float]=None, compression: Optional[grpc.Compression]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> None:
        ...
        metadata = tuple(metadata or ()) + (gapic_v1.routing_header.to_grpc_metadata((('name', request.name),)),)
        rpc(request, retry=retry, timeout=timeout, compression=compression, metadata=metadata)

    def cancel_operation(self, name: Optional[str]=None, *, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Optional[float]=None, compression: Optional[grpc.Compression]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> None:
