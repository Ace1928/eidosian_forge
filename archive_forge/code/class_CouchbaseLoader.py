...
class CouchbaseLoader(BaseLoader):
    ...
    def __init__(self, connection_string: str, db_username: str, db_password: str, query: str, *, page_content_fields: Optional[List[str]]=None, metadata_fields: Optional[List[str]]=None) -> None:
        ...
        try:
            ...
            raise ImportError('Could not import couchbase package.Please install couchbase SDK with `pip install couchbase`.') from e
