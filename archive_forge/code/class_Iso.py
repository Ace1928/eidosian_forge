...
class Iso(BaseDomain, DomainIdentityMixin):
    ...
    """
    __slots__ = ('id', 'name', 'type', 'architecture', 'description', 'deprecation')

    def __init__(self, id: int | None=None, name: str | None=None, type: str | None=None, architecture: str | None=None, description: str | None=None, deprecated: str | None=None, deprecation: dict | None=None):
        self.id = id
        self.name = name
        self.type = type
        self.architecture = architecture
        self.description = description
        self.deprecation = DeprecationInfo.from_dict(deprecation) if deprecation is not None else None
    ...
    def deprecated(self) -> datetime | None:
        ...
        """
        warn('The `deprecated` field is deprecated, please use the `deprecation` field instead.', DeprecationWarning)
