...
class ListExclusionsPager:
    ...
    def __init__(self, method: Callable[..., logging_config.ListExclusionsResponse], request: logging_config.ListExclusionsRequest, response: logging_config.ListExclusionsResponse, *, metadata: Sequence[Tuple[str, str]]=()):
