...
class MarkAccepted(base.Command):
  ...
  """
    ...
    """
        ...
        parser.add_argument('INSIGHT', type=str, help='Insight id which will be marked as accepted')
        parser.add_argument('--location', metavar='LOCATION', required=True, help='Location')
        parser.add_argument('--insight-type', metavar='INSIGHT_TYPE', required=True, help='Insight Type of the insights')
        parser.add_argument('--etag', required=True, metavar='etag', help='Etag of a insight')
