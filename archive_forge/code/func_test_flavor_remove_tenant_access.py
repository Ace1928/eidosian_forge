...
def test_flavor_remove_tenant_access(self):
    self._verify('openstack.compute.v2.flavor.Flavor.remove_tenant_access', self.proxy.flavor_remove_tenant_access, method_args=['value', 'fake-tenant'], expected_args=[self.proxy, 'fake-tenant'])