...
class ListQuantumJobsAsyncPager:
    ...
    def __init__(self, method: Callable[..., Awaitable[engine.ListQuantumJobsResponse]], request: engine.ListQuantumJobsRequest, response: engine.ListQuantumJobsResponse, *, metadata: Sequence[Tuple[str, str]]=()):
