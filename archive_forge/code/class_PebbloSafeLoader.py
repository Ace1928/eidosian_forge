...
class PebbloSafeLoader(BaseLoader):
    ...
    def __init__(self, langchain_loader: BaseLoader, name: str, owner: str='', description: str='', api_key: Optional[str]=None):
        ...
        self.loader_details = {'loader': loader_name, 'source_path': self.source_path, 'source_type': self.source_type, **({'source_path_size': str(self.source_path_size)} if self.source_path_size > 0 else {})}
