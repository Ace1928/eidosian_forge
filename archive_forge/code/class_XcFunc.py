...
class XcFunc(MSONable):
    ...
    xcf = LibxcFunc
    defined_aliases = {(xcf.LDA_X, xcf.LDA_C_PW): type_name('LDA', 'PW'), (xcf.LDA_X, xcf.LDA_C_PW_MOD): type_name('LDA', 'PW_MOD'), (xcf.LDA_X, xcf.LDA_C_PZ): type_name('LDA', 'PZ'), (xcf.LDA_X, xcf.LDA_C_WIGNER): type_name('LDA', 'W'), (xcf.LDA_X, xcf.LDA_C_HL): type_name('LDA', 'HL'), (xcf.LDA_X, xcf.LDA_C_GL): type_name('LDA', 'GL'), (xcf.LDA_X, xcf.LDA_C_VWN): type_name('LDA', 'VWN'), (xcf.GGA_X_PW91, xcf.GGA_C_PW91): type_name('GGA', 'PW91'), (xcf.GGA_X_PBE, xcf.GGA_C_PBE): type_name('GGA', 'PBE'), (xcf.GGA_X_RPBE, xcf.GGA_C_PBE): type_name('GGA', 'RPBE'), (xcf.GGA_X_PBE_R, xcf.GGA_C_PBE): type_name('GGA', 'revPBE'), (xcf.GGA_X_PBE_SOL, xcf.GGA_C_PBE_SOL): type_name('GGA', 'PBEsol'), (xcf.GGA_X_AM05, xcf.GGA_C_AM05): type_name('GGA', 'AM05'), (xcf.GGA_X_B88, xcf.GGA_C_LYP): type_name('GGA', 'BLYP')}
    del type_name
    abinitixc_to_libxc = {1: {'xc': xcf.LDA_XC_TETER93}, 2: {'x': xcf.LDA_X, 'c': xcf.LDA_C_PZ}, 4: {'x': xcf.LDA_X, 'c': xcf.LDA_C_WIGNER}, 5: {'x': xcf.LDA_X, 'c': xcf.LDA_C_HL}, 7: {'x': xcf.LDA_X, 'c': xcf.LDA_C_PW}, 11: {'x': xcf.GGA_X_PBE, 'c': xcf.GGA_C_PBE}, 14: {'x': xcf.GGA_X_PBE_R, 'c': xcf.GGA_C_PBE}, 15: {'x': xcf.GGA_X_RPBE, 'c': xcf.GGA_C_PBE}}
    del xcf
