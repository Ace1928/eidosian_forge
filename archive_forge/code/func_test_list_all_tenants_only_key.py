...
def test_list_all_tenants_only_key(self):
    ...
    cliutils.print_list.assert_called_once_with(mock.ANY, ['ID', 'Name', 'Size', 'Share Proto', 'Status', 'Is Public', 'Share Type Name', 'Host', 'Availability Zone', 'Project ID'], sortby_index=None)