...
class ClusterTemplateTest(base.BaseTestCase):
    body = {'name': 'name', 'description': 'description', 'plugin_name': 'plugin', 'hadoop_version': '1', 'node_groups': {'name': 'master-node', 'flavor_id': '2', 'node_processes': ['namenode'], 'count': 1}, 'use_autoconfig': False, 'domain_name': 'domain.org.'}
    update_json = {'cluster_template': {'name': 'UpdatedName', 'description': 'Updated description', 'plugin_name': 'plugin', 'hadoop_version': '1', 'node_groups': {'name': 'master-node', 'flavor_id': '3', 'node_processes': ['namenode', 'datanode'], 'count': 1}, 'use_autoconfig': True, 'domain_name': 'domain.org.'}}
