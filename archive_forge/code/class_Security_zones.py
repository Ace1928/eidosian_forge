        ...
        if 'zones' in want.keys():
            ...
            for security_zone in security_zones:
                ...
                if 'advanced_connection_tracking' in security_zone:
                    act_node = build_child_xml_node(security_zone_node, 'advanced-connection-tracking')
                    if 'mode' in security_zone['advanced_connection_tracking']:
                        build_child_xml_node(act_node, 'mode', security_zone['advanced_connection_tracking']['mode'])
                    if 'timeout' in security_zone['advanced_connection_tracking']:
                        build_child_xml_node(act_node, 'timeout', security_zone['advanced_connection_tracking']['timeout'])
                    if 'track_all_policies_to_this_zone' in security_zone['advanced_connection_tracking']:
                        build_child_xml_node(act_node, 'track-all-policies-to-this-zone')
                ...
                if 'unidirectional_session_refreshing' in security_zone:
                    build_child_xml_node(security_zone_node, 'unidirectional-session-refreshing')
