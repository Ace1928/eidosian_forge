...
class ArtifactSaver:
    _server_artifact: Optional[Dict]
    ...
    def __init__(self, api: 'InternalApi', digest: str, manifest_json: Dict, file_pusher: 'FilePusher', is_user_created: bool=False) -> None:
        ...
        self._digest = digest
        self._manifest = ArtifactManifest.from_manifest_json(manifest_json, api=self._api)
    ...
    def save(self, type: str, name: str, client_id: str, sequence_client_id: str, distributed_id: Optional[str]=None, finalize: bool=True, metadata: Optional[Dict]=None, ttl_duration_seconds: Optional[int]=None, description: Optional[str]=None, aliases: Optional[Sequence[str]]=None, use_after_commit: bool=False, incremental: bool=False, history_step: Optional[int]=None, base_id: Optional[str]=None) -> Optional[Dict]:
        try:
            return self._save_internal(type, name, client_id, sequence_client_id, distributed_id, finalize, metadata, ttl_duration_seconds, description, aliases, use_after_commit, incremental, history_step, base_id)
        finally:
