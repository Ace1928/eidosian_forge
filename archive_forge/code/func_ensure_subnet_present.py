...
def ensure_subnet_present(conn, module):
    ...
    if subnet is None:
        if not module.check_mode:
            subnet = create_subnet(conn, module, module.params['vpc_id'], module.params['cidr'], module.params['tags'], ipv6_cidr=module.params['ipv6_cidr'], outpost_arn=module.params['outpost_arn'], az=module.params['az'], start_time=start_time)
        changed = True
        if subnet is None:
