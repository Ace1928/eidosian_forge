    ...
    **Example**
    ...
    def compute_matrix(phi, n_wires=1):
        ...
        **Example**
        ...
        return qml.math.exp(-1j * qml.math.cast(phi, complex)) * qml.math.eye(int(2 ** n_wires), like=interface)

    @staticmethod
    def compute_sparse_matrix(phi, n_wires=1):
    ...
    @staticmethod
    def compute_decomposition(phi, wires=None):
