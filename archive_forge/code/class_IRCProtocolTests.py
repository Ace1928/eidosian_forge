...
class IRCProtocolTests(unittest.TestCase):
    STATIC_USERS = ['useruser', 'otheruser', 'someguy', 'firstuser', 'username', 'userone', 'usertwo', 'userthree', 'userfour', b'userfive', 'someuser']
    ...
    def testJoin(self):
        ...
        self.assertEqual(response[1][1], '353')
        self.assertIn(response[1][2], [['otheruser', '=', '#somechannel', 'firstuser otheruser'], ['otheruser', '=', '#somechannel', 'otheruser firstuser']])
    ...
    def testWhois(self):
        ...
        otherguy.itergroups = lambda: iter([service.Group('groupA'), service.Group('groupB')])
        otherguy.signOn = 10
