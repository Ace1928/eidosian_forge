...
def test_aggregate_remove_host(self):
    self._verify('openstack.compute.v2.aggregate.Aggregate.remove_host', self.proxy.remove_host_from_aggregate, method_args=['value', 'host'], expected_args=[self.proxy, 'host'])