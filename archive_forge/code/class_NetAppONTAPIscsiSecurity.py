...
class NetAppONTAPIscsiSecurity:
    ...
    def __init__(self):
        ...
        self.module = AnsibleModule(argument_spec=self.argument_spec, supports_check_mode=True, required_if=[['auth_type', 'chap', ['inbound_username', 'inbound_password']]], required_together=[['inbound_username', 'inbound_password'], ['outbound_username', 'outbound_password']])
    ...
    def create_initiator(self):
        ...
        :return: None.
        """
        body = {'authentication_type': self.parameters['auth_type'], 'initiator': self.parameters['initiator']}
