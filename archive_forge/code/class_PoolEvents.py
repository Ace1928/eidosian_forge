...
class PoolEvents(event.Events[Pool]):
    ...
    def checkin(self, dbapi_connection: Optional[DBAPIConnection], connection_record: ConnectionPoolEntry) -> None:
    ...
    @event._legacy_signature('2.0', ['dbapi_connection', 'connection_record'], lambda dbapi_connection, connection_record, reset_state: (dbapi_connection, connection_record))
