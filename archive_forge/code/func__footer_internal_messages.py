...
@staticmethod
def _footer_internal_messages(internal_messages_response: Optional['InternalMessagesResponse']=None, quiet: Optional[bool]=None, *, settings: 'Settings', printer: Union['PrinterTerm', 'PrinterJupyter']) -> None:
