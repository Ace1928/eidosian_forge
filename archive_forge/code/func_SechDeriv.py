...
def SechDeriv(duration: int | ParameterValueType, amp: float | ParameterExpression, sigma: float | ParameterExpression, angle: float | ParameterExpression | None=0.0, name: str | None=None, limit_amplitude: bool | None=None) -> ScalableSymbolicPulse:
