...
class BlockchainDocumentLoader(BaseLoader):
    ...
    def __init__(self, contract_address: str, blockchainType: BlockchainType=BlockchainType.ETH_MAINNET, api_key: str='docs-demo', startToken: str='', get_all_tokens: bool=False, max_execution_time: Optional[int]=None):
        """
    ...
    def load(self) -> List[Document]:
        ...
        while True:
            url = f'https://{self.blockchainType}.g.alchemy.com/nft/v2/{self.api_key}/getNFTsForCollection?withMetadata=True&contractAddress={self.contract_address}&startToken={current_start_token}'
            ...
            for item in items:
                ...
                metadata = {'source': self.contract_address, 'blockchain': self.blockchainType, 'tokenId': tokenId}
