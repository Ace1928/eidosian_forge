...
def AddExecuteNowFlag(parser):
    ...
    parser.add_argument('--execute-now', action='store_true', help='Execute the job immediately after the creation or update ' + ' completes. gcloud exits once the job has started unless the ' + '`--wait` flag is set.')