...
class CloudWatchLogsConnection(AWSQueryConnection):
    ...
    _faults = {'LimitExceededException': exceptions.LimitExceededException, 'DataAlreadyAcceptedException': exceptions.DataAlreadyAcceptedException, 'ResourceInUseException': exceptions.ResourceInUseException, 'ServiceUnavailableException': exceptions.ServiceUnavailableException, 'InvalidParameterException': exceptions.InvalidParameterException, 'ResourceNotFoundException': exceptions.ResourceNotFoundException, 'ResourceAlreadyExistsException': exceptions.ResourceAlreadyExistsException, 'OperationAbortedException': exceptions.OperationAbortedException, 'InvalidSequenceTokenException': exceptions.InvalidSequenceTokenException}
