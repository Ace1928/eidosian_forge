...
def test_hot_restore(self):
    tpl = {'heat_template_version': '2013-05-23', 'resources': {'A': {'type': 'ResourceWithRestoreType'}}}
    self.stack = stack.Stack(self.ctx, 'stack_details_test', template.Template(tpl))
    self.stack.store()
    self.stack.create()
    ...
    self.assertEqual('foo', self.stack.resources['A'].properties['a_string'])