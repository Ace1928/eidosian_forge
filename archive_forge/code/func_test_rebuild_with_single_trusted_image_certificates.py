...
def test_rebuild_with_single_trusted_image_certificates(self):
    self.run_command('rebuild sample-server %s --trusted-image-certificate-id id1' % FAKE_UUID_1, api_version='2.63')
    ...
    self.assert_called('POST', '/servers/1234/action', {'rebuild': {'imageRef': FAKE_UUID_1, 'description': None, 'trusted_image_certificates': ['id1']}}, pos=3)
