...
def get_repeating_interval_resolution(isointervalstr, intervaldelimiter='/', datetimedelimiter='T'):
    repeatingintervaltuple = parse_repeating_interval(isointervalstr, intervaldelimiter=intervaldelimiter, datetimedelimiter=datetimedelimiter, builder=TupleBuilder)
