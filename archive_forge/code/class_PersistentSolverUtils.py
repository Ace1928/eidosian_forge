...
class PersistentSolverUtils(abc.ABC):
    ...
    def add_block(self, block):
        ...
        self.add_constraints(list(block.component_data_objects(Constraint, descend_into=True, active=True)))
        self.add_sos_constraints(list(block.component_data_objects(SOSConstraint, descend_into=True, active=True)))
    ...
    def remove_block(self, block):
        self.remove_constraints(list(block.component_data_objects(ctype=Constraint, descend_into=True, active=True)))
        self.remove_sos_constraints(list(block.component_data_objects(ctype=SOSConstraint, descend_into=True, active=True)))
        self.remove_parameters(list(dict(((id(p), p) for p in block.component_data_objects(ctype=Param, descend_into=True))).values()))
