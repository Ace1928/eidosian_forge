...
def test_disable_service_253(self, mv_mock):
    self._verify('openstack.proxy.Proxy._update', self.proxy.disable_service, method_args=['value'], method_kwargs={'disabled_reason': 'some_reason'}, expected_args=[service.Service, 'value'], expected_kwargs={'status': 'disabled', 'disabled_reason': 'some_reason'})