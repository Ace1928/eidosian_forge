...
class NamedArrayAggregations:
    ...
    def reduce(self, func: Callable[..., Any], dim: Dims=None, *, axis: int | Sequence[int] | None=None, keepdims: bool=False, **kwargs: Any) -> Self:
    ...
    def all(self, dim: Dims=None, **kwargs: Any) -> Self:
        ...
        **kwargs : Any
        ...
        array(False)
        """
        return self.reduce(duck_array_ops.array_all, dim=dim, **kwargs)
    ...
    def any(self, dim: Dims=None, **kwargs: Any) -> Self:
        ...
        **kwargs : Any
        ...
        array(True)
        """
        return self.reduce(duck_array_ops.array_any, dim=dim, **kwargs)
    ...
    def std(self, dim: Dims=None, *, skipna: bool | None=None, ddof: int=0, **kwargs: Any) -> Self:
        ...
        **kwargs : Any
        ...
        array(1.14017543)
        """
        return self.reduce(duck_array_ops.std, dim=dim, skipna=skipna, ddof=ddof, **kwargs)
    ...
    def var(self, dim: Dims=None, *, skipna: bool | None=None, ddof: int=0, **kwargs: Any) -> Self:
        ...
        **kwargs : Any
        ...
        array(1.3)
        """
        return self.reduce(duck_array_ops.var, dim=dim, skipna=skipna, ddof=ddof, **kwargs)
