...
class TestProvider(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.config_object_patch = mock.patch.object(provider.Config, 'get', self.get_shared_config)
        self.has_config_object_patch = mock.patch.object(provider.Config, 'has_option', self.has_shared_config)
    ...
    def test_shared_creds_profile_beats_defaults(self):
        self.shared_config = {'default': {'aws_access_key_id': 'shared_access_key', 'aws_secret_access_key': 'shared_secret_key'}, 'foo': {'aws_access_key_id': 'foo_access_key', 'aws_secret_access_key': 'foo_secret_key'}}
    ...
    def test_metadata_config_params(self, config_float, config_int):
        ...
        self.assertEqual(p.secret_key, 'iam_secret_key')
        self.assertEqual(p.security_token, 'iam_token')
        self.get_instance_metadata.assert_called_with(timeout=4.0, num_retries=10, data='meta-data/iam/security-credentials/')
    ...
    def test_provider_google(self):
        ...
        self.shared_config = {'default': {'gs_access_key_id': 'shared_access_key', 'gs_secret_access_key': 'shared_secret_key'}}
        self.config = {'Credentials': {'gs_access_key_id': 'cfg_access_key', 'gs_secret_access_key': 'cfg_secret_key'}}
