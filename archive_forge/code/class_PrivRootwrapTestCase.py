...
class PrivRootwrapTestCase(base.TestCase):
    ...
    def test_execute(self, mock_putils_exec, mock_exec_root):
        ...
        priv_rootwrap.execute('echo', 'foo', run_as_root=True, root_helper='baz', check_exit_code=0)
        mock_exec_root.assert_called_once_with('echo', 'foo', check_exit_code=0)
    ...
    def test_link_root_no_force(self, mock_remove, mock_link):
        priv_rootwrap.link_root(mock.sentinel.target, mock.sentinel.link_name, force=False)
