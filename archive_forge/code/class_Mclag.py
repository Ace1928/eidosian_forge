...
class Mclag(ConfigBase):
    ...
    mclag_simple_attrs = set({'peer_address', 'source_address', 'peer_link', 'system_mac', 'keepalive', 'session_timeout', 'delay_restore', 'gateway_mac'})
    ...
    def remove_default_entries(self, data):
        ...
        if not data:
            ...
            default_val_dict = {'keepalive': 1, 'session_timeout': 30, 'delay_restore': 300}
