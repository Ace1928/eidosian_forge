...
class GsutilFullResourceFormatter(base.FullResourceFormatter):
    ...
    def format_object(self, object_resource, show_acl=True, show_version_in_url=False, **kwargs):
        """See super class."""
        del kwargs
        shim_format_util.replace_time_values_with_gsutil_style_strings(object_resource)
        shim_format_util.replace_object_values_with_encryption_string(object_resource, 'encrypted')
