...
class BareMetalStandaloneCluster(_messages.Message):
    """Resource that represents a bare metal standalone cluster.
  ...
  """
    ...
    class StateValueValuesEnum(_messages.Enum):
        """Output only. The current state of the bare metal standalone cluster.
    ...
    class AnnotationsValue(_messages.Message):
        """Annotations on the bare metal standalone cluster. This field has the
