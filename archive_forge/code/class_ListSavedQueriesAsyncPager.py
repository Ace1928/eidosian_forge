...
class ListSavedQueriesAsyncPager:
    ...
    def __init__(self, method: Callable[..., Awaitable[logging_config.ListSavedQueriesResponse]], request: logging_config.ListSavedQueriesRequest, response: logging_config.ListSavedQueriesResponse, *, metadata: Sequence[Tuple[str, str]]=()):
