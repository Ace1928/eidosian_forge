...
def _generate_random_datetime_strings(pattern: str, n: int=3, start_date: datetime=datetime(1, 1, 1), end_date: datetime=datetime.now() + timedelta(days=3650)) -> List[str]:
