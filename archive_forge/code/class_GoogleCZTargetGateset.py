...
class GoogleCZTargetGateset(cirq.CZTargetGateset):
    ...
    def __init__(self, atol: float=1e-08, eject_paulis: bool=False, additional_gates: Sequence[Union[Type[cirq.Gate], cirq.Gate, cirq.GateFamily]]=()):
        ...
        self._additional_gates_repr_str = ', '.join([cirq.ops.gateset._gate_str(g, repr) for g in additional_gates])
    ...
    def __repr__(self) -> str:
        return f'cirq_google.GoogleCZTargetGateset(atol={self.atol}, eject_paulis={self.eject_paulis}, additional_gates=[{self._additional_gates_repr_str}])'
