    ...
    **Example:**
    ...
    def step(self, objective_fn, x, generators, **kwargs):
        ...
        try:
            ...
            raise ValueError(f'Number of parameters {x} must be equal to the number of generators.') from e
        for d, _ in enumerate(x_flat):
            x_flat[d], generators[d] = self._find_optimal_generators(objective_fn_flat, x_flat, generators, d)
