...
class TestAddNetworkFlavorToProfile(TestNetworkFlavor):
    ...
    def setUp(self):
        ...
        self.cmd = network_flavor.AddNetworkFlavorToProfile(self.app, self.namespace)
    ...
    def test_add_flavor_to_service_profile(self):
        ...
        self.network_client.associate_flavor_with_service_profile.assert_called_once_with(self.network_flavor, self.service_profile)