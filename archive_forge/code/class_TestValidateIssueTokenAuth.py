...
class TestValidateIssueTokenAuth(unit.BaseTestCase):
    ...
    def test_unscoped(self):
        post_data = {'identity': {'methods': ['password'], 'password': {'user': {'name': 'admin', 'domain': {'name': 'Default'}, 'password': 'devstacker'}}}}
        schema.validate_issue_token_auth(post_data)

    def test_user_domain_id(self):
        post_data = {'identity': {'methods': ['password'], 'password': {'user': {'name': 'admin', 'domain': {'id': 'default'}, 'password': 'devstacker'}}}}
        schema.validate_issue_token_auth(post_data)
    ...
    def test_project_scoped(self):
        post_data = {'identity': {'methods': ['password'], 'password': {'user': {'name': 'admin', 'domain': {'name': 'Default'}, 'password': 'devstacker'}}}, 'scope': {'project': {'name': 'demo', 'domain': {'name': 'Default'}}}}
        schema.validate_issue_token_auth(post_data)

    def test_domain_scoped(self):
        post_data = {'identity': {'methods': ['password'], 'password': {'user': {'name': 'admin', 'domain': {'name': 'Default'}, 'password': 'devstacker'}}}, 'scope': {'domain': {'name': 'Default'}}}
        schema.validate_issue_token_auth(post_data)
    ...
    def test_additional_properties(self):
        p = {'identity': {'methods': ['password'], 'password': {'user': {'id': 'whatever', 'extra4': 'whatever4', 'domain': {'id': 'whatever', 'extra5': 'whatever5'}}, 'extra3': 'whatever3'}, 'token': {'id': 'something', 'extra9': 'whatever9'}, 'extra4': 'whatever4'}, 'scope': {'project': {'id': 'something', 'domain': {'id': 'something', 'extra8': 'whatever8'}, 'extra7': 'whatever7'}, 'domain': {'id': 'something', 'extra9': 'whatever9'}, 'extra6': 'whatever6'}, 'extra2': 'whatever2'}
        schema.validate_issue_token_auth(p)