...
class CosineWindow(StatePrepBase):
    ...
    **Example**
    ...
    def state_vector(self, wire_order=None):
        ...
        vector = np.array([coeff * np.cos(-np.pi / 2 + np.pi * x / 2 ** num_op_wires) for x in range(2 ** num_op_wires)])
        ...
        indices = tuple([Ellipsis] + [slice(None)] * num_op_wires + [0] * (num_total_wires - num_op_wires))
