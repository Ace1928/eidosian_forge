...
class Design(param.Parameterized, ResourceComponent):
    ...
    def _get_modifiers(cls, viewable: Viewable, theme: Theme=None, isolated: bool=True):
        from ..io.resources import CDN_DIST, component_resource_path, resolve_custom_path
    ...
    def resolve_resources(self, cdn: bool | Literal['auto']='auto', extras: dict[str, dict[str, str]] | None=None, include_theme: bool=True) -> ResourceTypes:
        """
