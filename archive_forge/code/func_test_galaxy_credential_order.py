...
def test_galaxy_credential_order(run_module, admin_user):
    ...
    module_args = {'name': 'foo', 'state': 'present', 'controller_host': None, 'controller_username': None, 'controller_password': None, 'validate_certs': None, 'controller_oauthtoken': None, 'controller_config_file': None, 'galaxy_credentials': cred_ids}
