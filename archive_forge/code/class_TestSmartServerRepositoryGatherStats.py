...
class TestSmartServerRepositoryGatherStats(tests.TestCaseWithMemoryTransport):
    ...
    def test_not_empty_repository_with_committers(self):
        ...
        tree.commit('a commit', timestamp=654321.4, timezone=0, committer='bar', rev_id=rev_id_utf8)
        tree.unlock()
        tree.branch.repository.gather_stats()
        expected_body = b'committers: 2\nfirstrev: 123456.200 3600\nlatestrev: 654321.400 0\nrevisions: 2\n'
        self.assertEqual(smart_req.SmartServerResponse((b'ok',), expected_body), request.execute(b'', rev_id_utf8, b'yes'))
    ...
    def test_unknown_revid(self):
        ...
        self.assertEqual(smart_req.FailedSmartServerResponse((b'nosuchrevision', b'mia'), None), request.execute(b'', b'mia', b'yes'))