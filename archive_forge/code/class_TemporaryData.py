...
class TemporaryData(abc.ABC):
    ...
    def __init__(self, filepath: Optional[pathlib.Path]=None, is_multithreaded: Optional[bool]=False, timeout: Optional[int]=10):
        if not filepath:
    ...
    @classmethod
    def from_module(cls, module_name: str, data_dir: Optional[str]='.data', is_multithreaded: Optional[bool]=False, **kwargs) -> TemporaryData:
        """
