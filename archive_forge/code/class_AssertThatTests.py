...
class AssertThatTests:
    ...
    def test_assertThat_verbose_output(self):
        ...
        self.assertFails(expected, self.assert_that_callable, matchee, matcher, verbose=True)
    ...
    def test_assertThat_verbose_unicode(self):
        ...
        e = self.assertRaises(self.failureException, self.assert_that_callable, matchee, matcher, verbose=True)
