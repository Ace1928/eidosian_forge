...
class QNSPSAOptimizer:
    ...
    **Examples:**
    ...
    def __init__(self, stepsize=0.001, regularization=0.001, finite_diff_step=0.01, resamplings=1, blocking=True, history_length=5, seed=None):
    ...
    def step(self, cost, *args, **kwargs):
        ...
        """
        if self.blocking:
            warnings.warn('step_and_cost() instead of step() is called when blocking is turned on, as the step-wise loss value is required by the algorithm.', stacklevel=2)
