...
def rvs_ratio_uniforms(pdf, umax, vmin, vmax, size=1, c=0, random_state=None):
    ...
    """
    warnings.warn('Please use `RatioUniforms` from the `scipy.stats.sampling` namespace. The `scipy.stats.rvs_ratio_uniforms` namespace is deprecated and will be removed in SciPy 1.15.0', category=DeprecationWarning, stacklevel=2)
