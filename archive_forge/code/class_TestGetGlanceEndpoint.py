...
class TestGetGlanceEndpoint(base.IsolatedUnitTest):
    ...
    def setUp(self):
        ...
        self.service_catalog = [{'endpoints': [{'adminURL': 'http://localhost:8080/', 'region': 'RegionOne', 'internalURL': 'http://internalURL/', 'publicURL': 'http://publicURL/'}], 'type': 'object-store'}, {'endpoints': [{'adminURL': 'http://localhost:8080/', 'region': 'RegionOne', 'internalURL': 'http://RegionOneInternal/', 'publicURL': 'http://RegionOnePublic/'}], 'type': 'image'}, {'endpoints': [{'adminURL': 'http://localhost:8080/', 'region': 'RegionTwo', 'internalURL': 'http://RegionTwoInternal/', 'publicURL': 'http://RegionTwoPublic/'}], 'type': 'image'}]
