...
def is_powered_on_or_creating(power_status, vsphere_node_status):
    return power_status.state == HardPower.State.POWERED_OFF and vsphere_node_status == Constants.VsphereNodeStatus.CREATING.value or power_status.state == HardPower.State.POWERED_ON