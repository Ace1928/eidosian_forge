...
class MySQLOperations(BaseSpatialOperations, DatabaseOperations):
    ...
    def gis_operators(self):
        ...
        return operators
    disallowed_aggregates = (models.Collect, models.Extent, models.Extent3D, models.MakeLine, models.Union)
    function_names = {'FromWKB': 'ST_GeomFromWKB', 'FromWKT': 'ST_GeomFromText'}

    @cached_property
    def unsupported_functions(self):
        unsupported = {'AsGML', 'AsKML', 'AsSVG', 'Azimuth', 'BoundingCircle', 'ClosestPoint', 'ForcePolygonCW', 'GeometryDistance', 'IsEmpty', 'LineLocatePoint', 'MakeValid', 'MemSize', 'Perimeter', 'PointOnSurface', 'Reverse', 'Scale', 'SnapToGrid', 'Transform', 'Translate'}
        if self.connection.mysql_is_mariadb:
