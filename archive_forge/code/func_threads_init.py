...
def threads_init():
    warnings.warn('Since version 3.11, calling threads_init is no longer needed. See: https://wiki.gnome.org/PyGObject/Threading', PyGIDeprecationWarning, stacklevel=2)