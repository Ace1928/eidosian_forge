...
class TestQosRuleType(base.TestCase):
    ...
    qos_rule_type_details_extension = {'updated': '2017-06-22T10:00:00-00:00', 'name': 'Details of QoS rule types', 'links': [], 'alias': 'qos-rule-type-details', 'description': 'Expose details about QoS rule types supported by loaded backend drivers'}
    mock_rule_type_bandwidth_limit = {'type': 'bandwidth_limit'}
    mock_rule_type_dscp_marking = {'type': 'dscp_marking'}
    mock_rule_types = [mock_rule_type_bandwidth_limit, mock_rule_type_dscp_marking]
    mock_rule_type_details = {'drivers': [{'name': 'linuxbridge', 'supported_parameters': [{'parameter_values': {'start': 0, 'end': 2147483647}, 'parameter_type': 'range', 'parameter_name': u'max_kbps'}, {'parameter_values': ['ingress', 'egress'], 'parameter_type': 'choices', 'parameter_name': u'direction'}, {'parameter_values': {'start': 0, 'end': 2147483647}, 'parameter_type': 'range', 'parameter_name': 'max_burst_kbps'}]}], 'type': rule_type_name}
