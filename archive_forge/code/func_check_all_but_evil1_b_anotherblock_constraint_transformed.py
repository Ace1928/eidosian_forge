...
def check_all_but_evil1_b_anotherblock_constraint_transformed(self, m):
    ...
    with LoggingIntercept(out, 'pyomo.gdp', logging.ERROR):
        self.assertRaisesRegex(KeyError, '.*.evil\\[1\\].b.anotherblock.c', bigm.get_transformed_constraints, m.evil[1].b.anotherblock.c)
    self.assertRegex(out.getvalue(), ".*Constraint 'evil\\[1\\].b.anotherblock.c' has not been transformed.")
