...
def test_get_client_and_interface_and_valid_interfaces(self):
    ...
    kwargs = {'project_name': 'PROJECT_NAME', 'username': 'USERNAME', 'password': 'PASSWORD', 'auth_url': 'http://localhost:35357/v2.0', 'service_type': '', 'interface': ['ignored'], 'valid_interfaces': ['internal', 'public']}
