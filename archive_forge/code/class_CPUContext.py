...
class CPUContext(BaseContext):
    ...
    def load_additional_registries(self):
        ...
        from numba.cpython import builtins, charseq, enumimpl, hashing, heapq, iterators, listobj, numbers, rangeobj, setobj, slicing, tupleobj, unicode
        from numba.core import optional
        from numba.misc import gdb_hook, literal
        from numba.np import linalg, arraymath, arrayobj
        from numba.np.random import generator_core, generator_methods
        from numba.np.polynomial import polynomial_core, polynomial_functions
    ...
    def create_cfunc_wrapper(self, library, fndesc, env, call_helper):
        ...
        status, out = self.call_conv.call_function(builder, wrapper_callee, fndesc.restype, fndesc.argtypes, wrapfn.args, attrs=('noinline',))
