...
class QAsyncioFuture:
    ...
    def __init__(self, *, loop: typing.Optional['events.QAsyncioEventLoop']=None, context: typing.Optional[contextvars.Context]=None) -> None:
    ...
    def add_done_callback(self, cb: typing.Callable, *, context: typing.Optional[contextvars.Context]=None) -> None:
        if self.done():
            self._loop.call_soon(cb, self, context=context if context else self._context)
        else:
