...
class GenericPackageManager(RESTManager):
    ...
    @cli.register_custom_action('GenericPackageManager', ('package_name', 'package_version', 'file_name'))
    @exc.on_http_error(exc.GitlabGetError)
    def download(self, package_name: str, package_version: str, file_name: str, streamed: bool=False, action: Optional[Callable[[bytes], None]]=None, chunk_size: int=1024, *, iterator: bool=False, **kwargs: Any) -> Optional[Union[bytes, Iterator[Any]]]:
