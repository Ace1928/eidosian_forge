...
def test_directly_connect_without_weights(nodes, edges, include_edge_id):
    data = pd.DataFrame({'edge_id': [1.0, 1.0, np.nan, 2.0, 2.0, np.nan, 3.0, 3.0, np.nan, 4.0, 4.0, np.nan], 'x': [0.0, -100.0, np.nan, 0.0, 100.0, np.nan, 0.0, -100.0, np.nan, 0.0, 100.0, np.nan], 'y': [0.0, 100.0, np.nan, 0.0, 100.0, np.nan, 0.0, -100.0, np.nan, 0.0, -100.0, np.nan]})
