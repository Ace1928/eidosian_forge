...
class BmsClient(object):
    ...
    def __init__(self, api_version=_DEFAULT_API_VERSION):
        ...
        self._v1_client = apis.GetClientInstance('baremetalsolution', _V1_API_VERSION)
        ...
        self.nfs_mount_permissions_str_to_message = {'READ_ONLY': self.messages.AllowedClient.MountPermissionsValueValuesEnum.READ, 'READ_WRITE': self.messages.AllowedClient.MountPermissionsValueValuesEnum.READ_WRITE}
        self.nfs_storage_type_str_to_message = {'SSD': self.messages.NfsShare.StorageTypeValueValuesEnum.SSD, 'HDD': self.messages.NfsShare.StorageTypeValueValuesEnum.HDD}
    ...
    def GetInstance(self, resource):
        request = self.messages.BaremetalsolutionProjectsLocationsInstancesGetRequest(name=resource.RelativeName())
        return self.instances_service.Get(request)

    def ListInstances(self, parent, limit=None, page_size=None):
        request = self.messages.BaremetalsolutionProjectsLocationsInstancesListRequest(parent=parent)
        return list_pager.YieldFromList(self.instances_service, request, limit=limit, batch_size_attribute='pageSize', batch_size=page_size, field='instances')

    def UpdateInstance(self, instance_resource, labels, os_image, enable_hyperthreading, ssh_keys, kms_key_version, clear_ssh_keys):
        ...
        instance_msg = self.messages.Instance(name=instance_resource.RelativeName(), labels=labels, osImage=os_image, hyperthreadingEnabled=enable_hyperthreading, sshKeys=ssh_keys_relative, kmsKeyVersion=kms_key_version)
        request = self.messages.BaremetalsolutionProjectsLocationsInstancesPatchRequest(name=instance_resource.RelativeName(), instance=instance_msg, updateMask=','.join(updated_fields))
    ...
    def DeleteSnapshotSchedulePolicy(self, resource):
        request = self.messages.BaremetalsolutionProjectsLocationsSnapshotSchedulePoliciesDeleteRequest(name=resource.RelativeName())
        return self.snapshot_schedule_policies_service.Delete(request)

    def ListVolumes(self, parent, limit=None, page_size=None):
        request = self.messages.BaremetalsolutionProjectsLocationsVolumesListRequest(parent=parent)
        return list_pager.YieldFromList(self.volumes_service, request, limit=limit, batch_size_attribute='pageSize', batch_size=page_size, field='volumes')

    def UpdateVolume(self, volume_resource, labels, snapshot_schedule_policy_resource, remove_snapshot_schedule_policy, snapshot_auto_delete):
        ...
        volume_msg = self.messages.Volume(name=volume_resource.RelativeName(), snapshotAutoDeleteBehavior=snapshot_auto_delete, snapshotSchedulePolicy=policy_name, labels=labels)
        request = self.messages.BaremetalsolutionProjectsLocationsVolumesPatchRequest(name=volume_resource.RelativeName(), volume=volume_msg, updateMask=','.join(updated_fields))
        return self.volumes_service.Patch(request)

    def GetVolume(self, resource):
        request = self.messages.BaremetalsolutionProjectsLocationsVolumesGetRequest(name=resource.RelativeName())
    ...
    def ListOSImages(self, project_resource, limit=None, page_size=None):
        parent = 'projects/%s/locations/global' % project_resource
        request = self.messages.BaremetalsolutionProjectsLocationsOsImagesListRequest(parent=parent)
        return list_pager.YieldFromList(self.os_images_service, request, limit=limit, batch_size_attribute='pageSize', batch_size=page_size, field='osImages')

    def GetOSImage(self, resource):
        request = self.messages.BaremetalsolutionProjectsLocationsOsImagesGetRequest(name=resource.RelativeName())
    ...
    def GetLUN(self, resource):
        request = self.messages.BaremetalsolutionProjectsLocationsVolumesLunsGetRequest(name=resource.RelativeName())
    ...
    def GetVolumeSnapshot(self, resource):
        request = self.messages.BaremetalsolutionProjectsLocationsVolumesSnapshotsGetRequest(name=resource.RelativeName())
        return self.snapshots_service.Get(request)

    def CreateVolumeSnapshot(self, resource, name, description):
        request = self.messages.BaremetalsolutionProjectsLocationsVolumesSnapshotsCreateRequest(parent=resource.RelativeName(), volumeSnapshot=self.messages.VolumeSnapshot(name=name, description=description))
    ...
    def RestoreVolumeSnapshot(self, snapshot_name):
        request = self.messages.BaremetalsolutionProjectsLocationsVolumesSnapshotsRestoreVolumeSnapshotRequest(volumeSnapshot=snapshot_name)
        return self.snapshots_service.RestoreVolumeSnapshot(request)

    def GetNfsShare(self, resource):
        request = self.messages.BaremetalsolutionProjectsLocationsNfsSharesGetRequest(name=resource.RelativeName())
        return self.nfs_shares_service.Get(request)

    def ListNfsShares(self, parent, limit=None, page_size=None):
        request = self.messages.BaremetalsolutionProjectsLocationsNfsSharesListRequest(parent=parent)
        return list_pager.YieldFromList(self.nfs_shares_service, request, limit=limit, batch_size_attribute='pageSize', batch_size=page_size, field='nfsShares')
    ...
    def DeleteNfsShare(self, nfs_share_resource):
        ...
        request = self.messages.BaremetalsolutionProjectsLocationsNfsSharesDeleteRequest(name=nfs_share_resource.RelativeName())
    ...
    def ListSshKeys(self, project_resource, limit=None, page_size=None):
        parent = 'projects/%s/locations/global' % project_resource
        request = self.messages.BaremetalsolutionProjectsLocationsSshKeysListRequest(parent=parent)
        return list_pager.YieldFromList(self.ssh_keys_service, request, limit=limit, batch_size_attribute='pageSize', batch_size=page_size, field='sshKeys')

    def CreateSshKey(self, resource, public_key):
        """Sends request to create an SSH key."""
        request = self.messages.BaremetalsolutionProjectsLocationsSshKeysCreateRequest(parent=resource.Parent().RelativeName(), sshKeyId=resource.Name(), sSHKey=self.messages.SSHKey(publicKey=public_key))
