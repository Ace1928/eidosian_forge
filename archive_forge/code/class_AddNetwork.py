...
class AddNetwork(command.Command):
    ...
    def get_parser(self, prog_name):
        ...
        parser.add_argument('server', metavar='<server>', help=_('Server to add the network to (name or ID)'))
        parser.add_argument('network', metavar='<network>', help=_('Network to add to the server (name or ID)'))
