...
class DirectoryResourcesBuildingsUpdateRequest(_messages.Message):
    """A DirectoryResourcesBuildingsUpdateRequest object.
  ...
  """
    ...
    coordinatesSource = _messages.EnumField('CoordinatesSourceValueValuesEnum', 3, default=u'SOURCE_UNSPECIFIED')
