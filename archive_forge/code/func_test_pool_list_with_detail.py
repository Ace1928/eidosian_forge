...
def test_pool_list_with_detail(self):
    ...
    self.assert_called('GET', '/scheduler-stats/pools/detail?backend=.%2A&host=.%2A&pool=.%2A')
    cliutils.print_dict.assert_called_with({'name': 'host1@backend1#pool2', 'qos': False})