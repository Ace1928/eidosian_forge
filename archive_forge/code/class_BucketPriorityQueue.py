...
class BucketPriorityQueue(Generic[TItem]):
    ...
    def __repr__(self) -> str:
        ...
        return f'cirq.circuits._bucket_priority_queue.BucketPriorityQueue(entries={entries!r}, drop_duplicate_entries={drop_duplicate_entries})'
    __hash__ = None

    def __eq__(self, other):
        if not isinstance(other, type(self)):
            return NotImplemented
        return self.drop_duplicate_entries == other.drop_duplicate_entries and list(self) == list(other)
