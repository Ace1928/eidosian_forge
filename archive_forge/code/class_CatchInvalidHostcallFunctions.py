...
class CatchInvalidHostcallFunctions(control_flow_ops.XLAControlFlowContext):
    ...
    def AddOp(self, op):
        if op.type in ['AudioSummary', 'AudioSummaryV2', 'HistogramSummary', 'ImageSummary', 'MergeSummary', 'ScalarSummary', 'TensorSummary', 'TensorSummaryV2']:
            raise ValueError('Please use tf.contrib.summary instead of tf.summary inside of host_calls.')