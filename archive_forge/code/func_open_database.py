...
def open_database(database: Union[AnyStr, int, os.PathLike, IO], mode: int=MODE_AUTO) -> Reader:
    ...
    Arguments:
        ...
        mode -- mode to open the database with. Valid mode are:
            ...
            * MODE_AUTO - tries MODE_MMAP_EXT, MODE_MMAP, MODE_FILE in that
                          order. Default mode.
    """
    if mode not in (MODE_AUTO, MODE_FD, MODE_FILE, MODE_MEMORY, MODE_MMAP, MODE_MMAP_EXT):
