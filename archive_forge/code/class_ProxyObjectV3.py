...
class ProxyObjectV3(Generic[ProxyObjT]):
    ...
    def __init__(self, obj_cls: Optional[Union[Type[ProxyObjT], str]]=None, obj_getter: Optional[Union[Callable[..., ProxyObjT], str]]=None, obj_args: Optional[Union[str, Callable[..., Iterable[Any]], Iterable[Any]]]=None, obj_kwargs: Optional[Union[str, Callable[..., Dict[str, Any]], Dict[str, Any]]]=None, obj_initialize: Optional[bool]=True, threadsafe: Optional[bool]=True) -> ProxyObjT:
        """
        args:
