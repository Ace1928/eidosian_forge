...
class ElasticsearchTranslator(Visitor):
    ...
    def _format_func(self, func: Union[Operator, Comparator]) -> str:
        ...
        map_dict = {Operator.OR: 'should', Operator.NOT: 'must_not', Operator.AND: 'must', Comparator.EQ: 'term', Comparator.GT: 'gt', Comparator.GTE: 'gte', Comparator.LT: 'lt', Comparator.LTE: 'lte', Comparator.CONTAIN: 'match', Comparator.LIKE: 'match'}
    ...
    def visit_comparison(self, comparison: Comparison) -> Dict:
        ...
        is_range_comparator = comparison.comparator in [Comparator.GT, Comparator.GTE, Comparator.LT, Comparator.LTE]
