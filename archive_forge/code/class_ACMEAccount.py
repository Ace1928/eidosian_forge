...
class ACMEAccount(object):
    ...
    def setup_account(self, contact=None, agreement=None, terms_agreed=False, allow_creation=True, remove_account_uri_if_not_exists=False, external_account_binding=None):
        """
        ...
        if self.client.account_uri is not None:
            ...
            created, account_data = self._new_reg(contact, agreement=agreement, terms_agreed=terms_agreed, allow_creation=allow_creation and (not self.client.module.check_mode), external_account_binding=external_account_binding)
    ...
    def update_account(self, account_data, contact=None):
        ...
        if self.client.module.check_mode:
            ...
            if not isinstance(account_data, Mapping):
                raise ACMEProtocolException(self.client.module, msg='Invalid account updating reply from ACME server', info=info, content=account_data)
