...
class GLibEventLoop(EventLoop):
    ...
    def run_in_executor(self, executor: Executor, func: Callable[_Spec, _T], *args: _Spec.args, **kwargs: _Spec.kwargs) -> Future[_T]:
    ...
    def alarm(self, seconds: float, callback: Callable[[], typing.Any]) -> tuple[int, Callable[[], typing.Any]]:
        """
    ...
    def set_signal_handler(self, signum: int, handler: Callable[[int, FrameType | None], typing.Any] | int | signal.Handlers) -> None:
        """
        ...
        """
        glib_signals = [signal.SIGHUP, signal.SIGINT, signal.SIGTERM, signal.SIGUSR1, signal.SIGUSR2]
