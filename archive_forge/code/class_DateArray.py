...
class DateArray(ExtensionArray):
    ...
    def __init__(self, dates: dt.date | Sequence[dt.date] | tuple[np.ndarray, np.ndarray, np.ndarray] | np.ndarray) -> None:
    ...
    def isna(self) -> np.ndarray:
        return np.logical_and(np.logical_and(self._year == dt.date.min.year, self._month == dt.date.min.month), self._day == dt.date.min.day)
