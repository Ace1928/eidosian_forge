...
class PkiFacts(object):
    ...
    def populate_facts(self, connection, ansible_facts, data=None):
        ...
        objs = {}
        if resources.get('openconfig-pki:pki') and resources.get('openconfig-pki:pki').get('security-profiles') and resources.get('openconfig-pki:pki').get('security-profiles').get('security-profile'):
        ...
        if resources.get('openconfig-pki:pki') and resources.get('openconfig-pki:pki').get('trust-stores') and resources.get('openconfig-pki:pki').get('trust-stores').get('trust-store'):
