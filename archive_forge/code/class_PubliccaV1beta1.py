...
class PubliccaV1beta1(base_api.BaseApiClient):
    ...
    def __init__(self, url='', credentials=None, get_credentials=True, http=None, model=None, log_request=False, log_response=False, credentials_args=None, default_global_params=None, additional_http_headers=None, response_encoding=None):
        ...
        super(PubliccaV1beta1, self).__init__(url, credentials=credentials, get_credentials=get_credentials, http=http, model=model, log_request=log_request, log_response=log_response, credentials_args=credentials_args, default_global_params=default_global_params, additional_http_headers=additional_http_headers, response_encoding=response_encoding)
    ...
    class ProjectsLocationsExternalAccountKeysService(base_api.BaseApiService):
      ...
      """
        ...
        Create.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1beta1/projects/{projectsId}/locations/{locationsId}/externalAccountKeys', http_method='POST', method_id='publicca.projects.locations.externalAccountKeys.create', ordered_params=['parent'], path_params=['parent'], query_params=[], relative_path='v1beta1/{+parent}/externalAccountKeys', request_field='externalAccountKey', request_type_name='PubliccaProjectsLocationsExternalAccountKeysCreateRequest', response_type_name='ExternalAccountKey', supports_download=False)
