...
def test_volume_set_description(self):
    arglist = ['--description', 'new desc', self._volume.display_name]
    verifylist = [('name', None), ('description', 'new desc'), ('size', None), ('property', None), ('volume', self._volume.display_name)]
    parsed_args = self.check_parser(self.cmd, arglist, verifylist)
    result = self.cmd.take_action(parsed_args)
    kwargs = {'display_description': 'new desc'}
