...
def test_extract_model_with_local_function(self) -> None:
    ...
    func_nested_opset_imports = [onnx.helper.make_opsetid('', 14), onnx.helper.make_opsetid(func_domain, 1)]
    func_add_name = 'func_add'
    func_add_inputs = ['a', 'b']
    func_add_outputs = ['c']
    func_add_nodes = [onnx.helper.make_node('Add', ['a', 'b'], ['c'])]
    func_add = onnx.helper.make_function(func_domain, func_add_name, func_add_inputs, func_add_outputs, func_add_nodes, func_opset_imports)
    ...
    func_identity = onnx.helper.make_function(func_domain, func_identity_name, func_identity_inputs, func_identity_outputs, func_identity_nodes, func_opset_imports)
    ...
    func_nested_identity_add_nodes = [onnx.helper.make_node('func_identity', ['a'], ['a1'], domain=func_domain), onnx.helper.make_node('func_identity', ['b'], ['b1'], domain=func_domain), onnx.helper.make_node('func_add', ['a1', 'b1'], ['c'], domain=func_domain)]
    func_nested_identity_add = onnx.helper.make_function(func_domain, func_nested_identity_add_name, func_nested_identity_add_inputs, func_nested_identity_add_outputs, func_nested_identity_add_nodes, func_nested_opset_imports)
    ...
    node_func_nested0 = onnx.helper.make_node(func_nested_identity_add_name, ['t0', 't1'], ['o_all_func0'], domain=func_domain)
    node_func_nested1 = onnx.helper.make_node(func_nested_identity_add_name, ['t3', 't2'], ['o_all_func1'], domain=func_domain)
    ...
    self._verify_function_set(extracted_with_o_all_funcion0, {func_add_name, func_identity_name, func_nested_identity_add_name}, func_domain)
    extracted_with_o_all_funcion1 = utils.Extractor(model).extract_model(['i0', 'i1', 'i2'], ['o_all_func1'])
    self._verify_function_set(extracted_with_o_all_funcion1, {func_add_name, func_identity_name, func_nested_identity_add_name}, func_domain)
    extracted_with_o_all_funcion2 = utils.Extractor(model).extract_model(['i0', 'i1', 'i2'], ['o_no_func', 'o_func_add', 'o_all_func0', 'o_all_func1'])
    self._verify_function_set(extracted_with_o_all_funcion2, {func_add_name, func_identity_name, func_nested_identity_add_name}, func_domain)