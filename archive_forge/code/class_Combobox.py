...
class Combobox(VuetifyWidget):
    ...
    item_disabled = Union([Unicode(), List(Any())], default_value=None, allow_none=True).tag(sync=True)
    item_text = Union([Unicode(), List(Any())], default_value=None, allow_none=True).tag(sync=True)
    item_value = Union([Unicode(), List(Any())], default_value=None, allow_none=True).tag(sync=True)
    ...
    menu_props = Union([Unicode(), List(Any()), Dict()], default_value=None, allow_none=True).tag(sync=True)
