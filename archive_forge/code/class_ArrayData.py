...
class ArrayData(object):
    ...
    def _get_array(self, query_string, project_id=None, subject_id=None, subject_label=None, experiment_id=None, experiment_label=None, experiment_type='xnat:subjectAssessorData', columns=None, constraints=None):
        if constraints is None:
            constraints = {}
        uri = '%s/experiments?xsiType=%s' % (self._intf._get_entry_point(), experiment_type)
    ...
    def experiments(self, project_id=None, subject_id=None, subject_label=None, experiment_id=None, experiment_label=None, experiment_type='xnat:subjectAssessorData', columns=None, constraints=None):
        ...
        return self._get_array(query_string, project_id, subject_id, subject_label, experiment_id, experiment_label, experiment_type, columns, constraints)

    def mrsessions(self, project_id=None, subject_id=None, subject_label=None, experiment_id=None, experiment_label=None, columns=None, constraints=None):
        """ Returns a list of all MR sessions, filtered by optional constraints.
            ...
            constraints: dict
                ...
                pairs by which to filter.
            """
        return self.experiments(project_id, subject_id, subject_label, experiment_id, experiment_label, 'xnat:mrSessionData', columns, constraints)
