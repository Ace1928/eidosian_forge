...
def _copy_file(self, source_full, source_rel, content, content_tempfile, dest, task_vars, follow):
    ...
    if local_checksum != dest_status['checksum']:
        ...
        new_module_args.update(dict(src=tmp_src, dest=dest, _original_basename=source_rel, follow=follow))
        ...
        new_module_args.update(dict(dest=dest, _original_basename=source_rel, recurse=False, state='file'))
        try:
