...
def test_ex_edit_portlist_STR(self):
    ...
    success = self.driver.ex_edit_portlist(ex_portlist=portlist_id, description=description, port_collection=port_collection, child_portlist_list=child_ports_ids)
