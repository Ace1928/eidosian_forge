...
class OracleAutonomousDatabaseLoader(BaseLoader):
    ...
    def __init__(self, query: str, user: str, password: str, *, schema: Optional[str]=None, tns_name: Optional[str]=None, config_dir: Optional[str]=None, wallet_location: Optional[str]=None, wallet_password: Optional[str]=None, connection_string: Optional[str]=None, metadata: Optional[List[str]]=None):
        """
        init method
