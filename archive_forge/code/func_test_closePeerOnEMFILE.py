...
def test_closePeerOnEMFILE(self):
    """
        ...
        """
    assertPeerClosedOnEMFILE(testCase=self, exhauster=_ExhaustsFileDescriptors(), reactor=self.buildReactor(), runReactor=self.runReactor, listen=self.getListeningPort, connect=self.connectToListener)