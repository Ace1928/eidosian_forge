...
class MongodbLoader(BaseLoader):
    ...
    def __init__(self, connection_string: str, db_name: str, collection_name: str, *, filter_criteria: Optional[Dict]=None, field_names: Optional[Sequence[str]]=None) -> None:
        try:
    ...
    async def aload(self) -> List[Document]:
        ...
        if len(result) != total_docs:
            logger.warning(f'Only partial collection of documents returned. Loaded {len(result)} docs, expected {total_docs}.')
        return result