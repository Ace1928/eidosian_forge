...
def _GetBuilder(executable, docker_image_tag, builder_region):
  ...
  """
    if builder_region:
        regionalized_builder = GetRegionalizedBuilder(executable, builder_region, docker_image_tag)
        if regionalized_builder:
            return regionalized_builder
    return GetDefaultBuilder(executable=executable, docker_image_tag=docker_image_tag)