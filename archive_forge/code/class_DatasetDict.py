...
class DatasetDict(dict):
    ...
    def rename_column(self, original_column_name: str, new_column_name: str) -> 'DatasetDict':
        ...
        """
        self._check_values_type()
        return DatasetDict({k: dataset.rename_column(original_column_name=original_column_name, new_column_name=new_column_name) for k, dataset in self.items()})
    ...
    def with_format(self, type: Optional[str]=None, columns: Optional[List]=None, output_all_columns: bool=False, **format_kwargs) -> 'DatasetDict':
    ...
    def with_transform(self, transform: Optional[Callable], columns: Optional[List]=None, output_all_columns: bool=False) -> 'DatasetDict':
        """Set `__getitem__` return format using this transform. The transform is applied on-the-fly on batches when `__getitem__` is called.
        The transform is set for every dataset in the dataset dictionary
    ...
    def map(self, function: Optional[Callable]=None, with_indices: bool=False, with_rank: bool=False, input_columns: Optional[Union[str, List[str]]]=None, batched: bool=False, batch_size: Optional[int]=1000, drop_last_batch: bool=False, remove_columns: Optional[Union[str, List[str]]]=None, keep_in_memory: bool=False, load_from_cache_file: Optional[bool]=None, cache_file_names: Optional[Dict[str, Optional[str]]]=None, writer_batch_size: Optional[int]=1000, features: Optional[Features]=None, disable_nullable: bool=False, fn_kwargs: Optional[dict]=None, num_proc: Optional[int]=None, desc: Optional[str]=None) -> 'DatasetDict':
        ...
        return DatasetDict({k: dataset.map(function=function, with_indices=with_indices, with_rank=with_rank, input_columns=input_columns, batched=batched, batch_size=batch_size, drop_last_batch=drop_last_batch, remove_columns=remove_columns, keep_in_memory=keep_in_memory, load_from_cache_file=load_from_cache_file, cache_file_name=cache_file_names[k], writer_batch_size=writer_batch_size, features=features, disable_nullable=disable_nullable, fn_kwargs=fn_kwargs, num_proc=num_proc, desc=desc) for k, dataset in self.items()})

    def filter(self, function: Optional[Callable]=None, with_indices: bool=False, with_rank: bool=False, input_columns: Optional[Union[str, List[str]]]=None, batched: bool=False, batch_size: Optional[int]=1000, keep_in_memory: bool=False, load_from_cache_file: Optional[bool]=None, cache_file_names: Optional[Dict[str, Optional[str]]]=None, writer_batch_size: Optional[int]=1000, fn_kwargs: Optional[dict]=None, num_proc: Optional[int]=None, desc: Optional[str]=None) -> 'DatasetDict':
        ...
        if cache_file_names is None:
            cache_file_names = {k: None for k in self}
        return DatasetDict({k: dataset.filter(function=function, with_indices=with_indices, with_rank=with_rank, input_columns=input_columns, batched=batched, batch_size=batch_size, keep_in_memory=keep_in_memory, load_from_cache_file=load_from_cache_file, cache_file_name=cache_file_names[k], writer_batch_size=writer_batch_size, fn_kwargs=fn_kwargs, num_proc=num_proc, desc=desc) for k, dataset in self.items()})
    ...
    def sort(self, column_names: Union[str, Sequence[str]], reverse: Union[bool, Sequence[bool]]=False, kind='deprecated', null_placement: str='at_end', keep_in_memory: bool=False, load_from_cache_file: Optional[bool]=None, indices_cache_file_names: Optional[Dict[str, Optional[str]]]=None, writer_batch_size: Optional[int]=1000) -> 'DatasetDict':
        ...
        return DatasetDict({k: dataset.sort(column_names=column_names, reverse=reverse, kind=kind, null_placement=null_placement, keep_in_memory=keep_in_memory, load_from_cache_file=load_from_cache_file, indices_cache_file_name=indices_cache_file_names[k], writer_batch_size=writer_batch_size) for k, dataset in self.items()})

    def shuffle(self, seeds: Optional[Union[int, Dict[str, Optional[int]]]]=None, seed: Optional[int]=None, generators: Optional[Dict[str, np.random.Generator]]=None, keep_in_memory: bool=False, load_from_cache_file: Optional[bool]=None, indices_cache_file_names: Optional[Dict[str, Optional[str]]]=None, writer_batch_size: Optional[int]=1000) -> 'DatasetDict':
        ...
        if indices_cache_file_names is None:
            indices_cache_file_names = {k: None for k in self}
        return DatasetDict({k: dataset.shuffle(seed=seeds[k], generator=generators[k], keep_in_memory=keep_in_memory, load_from_cache_file=load_from_cache_file, indices_cache_file_name=indices_cache_file_names[k], writer_batch_size=writer_batch_size) for k, dataset in self.items()})
    ...
    @staticmethod
    def load_from_disk(dataset_dict_path: PathLike, fs='deprecated', keep_in_memory: Optional[bool]=None, storage_options: Optional[dict]=None) -> 'DatasetDict':
        """
        ...
        for k in splits:
            ...
            dataset_dict[k] = Dataset.load_from_disk(dataset_dict_split_path, keep_in_memory=keep_in_memory, storage_options=storage_options)
        return dataset_dict
    ...
    @staticmethod
    def from_json(path_or_paths: Dict[str, PathLike], features: Optional[Features]=None, cache_dir: str=None, keep_in_memory: bool=False, **kwargs) -> 'DatasetDict':
        ...
        return JsonDatasetReader(path_or_paths, features=features, cache_dir=cache_dir, keep_in_memory=keep_in_memory, **kwargs).read()
    ...
    @staticmethod
    def from_text(path_or_paths: Dict[str, PathLike], features: Optional[Features]=None, cache_dir: str=None, keep_in_memory: bool=False, **kwargs) -> 'DatasetDict':
        ...
        return TextDatasetReader(path_or_paths, features=features, cache_dir=cache_dir, keep_in_memory=keep_in_memory, **kwargs).read()
    ...
    def push_to_hub(self, repo_id, config_name: str='default', set_default: Optional[bool]=None, data_dir: Optional[str]=None, commit_message: Optional[str]=None, commit_description: Optional[str]=None, private: Optional[bool]=False, token: Optional[str]=None, revision: Optional[str]=None, branch='deprecated', create_pr: Optional[bool]=False, max_shard_size: Optional[Union[int, str]]=None, num_shards: Optional[Dict[str, int]]=None, embed_external_files: bool=True) -> CommitInfo:
        ...
        if branch != 'deprecated':
            warnings.warn(f"'branch' was deprecated in favor of 'revision' in version 2.15.0 and will be removed in 3.0.0.\nYou can remove this warning by passing 'revision={branch}' instead.", FutureWarning)
            revision = branch
        self._check_values_type()
        ...
        repo_url = api.create_repo(repo_id, token=token, repo_type='dataset', private=private, exist_ok=True)
        ...
        for split in self.keys():
            ...
            split_additions, uploaded_size, dataset_nbytes = self[split]._push_parquet_shards_to_hub(repo_id, data_dir=data_dir, split=split, token=token, revision=revision, create_pr=create_pr, max_shard_size=max_shard_size, num_shards=num_shards.get(split), embed_external_files=embed_external_files)
        ...
        for repo_file in list_files_info(api, repo_id=repo_id, revision=revision, repo_type='dataset', token=token):
            ...
            elif repo_file.rfilename.startswith(tuple((f'{data_dir}/{split}-' for split in self.keys()))) and repo_file.rfilename not in repo_files_to_add:
                deletions.append(CommitOperationDelete(path_in_repo=repo_file.rfilename))
            elif fnmatch.fnmatch(repo_file.rfilename, PUSH_TO_HUB_WITHOUT_METADATA_CONFIGS_SPLIT_PATTERN_SHARDED.replace('{split}', '*')):
                repo_split = string_to_dict(repo_file.rfilename, glob_pattern_to_regex(PUSH_TO_HUB_WITHOUT_METADATA_CONFIGS_SPLIT_PATTERN_SHARDED))['split']
                if repo_split not in repo_splits:
                    repo_splits.append(split)
        if repo_with_dataset_card:
            dataset_card_path = api.hf_hub_download(repo_id, config.REPOCARD_FILENAME, repo_type='dataset', revision=revision)
        ...
        if not metadata_configs and repo_splits:
            default_metadata_configs_to_dump = {'data_files': [{'split': split, 'path': f'data/{split}-*'} for split in repo_splits]}
            MetadataConfigs({'default': default_metadata_configs_to_dump}).to_dataset_card_data(dataset_card_data)
        metadata_config_to_dump = {'data_files': [{'split': split, 'path': f'{data_dir}/{split}-*'} for split in self.keys()]}
        if set_default and config_name != 'default':
            if metadata_configs:
                ...
                if default_config_name == 'default':
                    raise ValueError("There exists a configuration named 'default'. To set a different configuration as default, rename the 'default' one first.")
                else:
                    _ = metadata_configs[default_config_name].pop('default')
            metadata_config_to_dump['default'] = True
        if repo_with_dataset_infos:
            dataset_infos_path = api.hf_hub_download(repo_id, config.DATASETDICT_INFOS_FILENAME, repo_type='dataset', revision=revision)
            with open(dataset_infos_path, encoding='utf-8') as f:
                dataset_infos: dict = json.load(f)
            dataset_infos[config_name] = asdict(info_to_dump)
            buffer = BytesIO()
            buffer.write(json.dumps(dataset_infos, indent=4).encode('utf-8'))
            additions.append(CommitOperationAdd(path_in_repo=config.DATASETDICT_INFOS_FILENAME, path_or_fileobj=buffer))
        ...
        additions.append(CommitOperationAdd(path_in_repo=config.REPOCARD_FILENAME, path_or_fileobj=str(dataset_card).encode()))
        ...
        if len(additions) <= config.UPLOADS_MAX_NUMBER_PER_COMMIT:
            commit_info = api.create_commit(repo_id, operations=additions + deletions, commit_message=commit_message, commit_description=commit_description, token=token, repo_type='dataset', revision=revision, create_pr=create_pr)
        else:
            logger.info(f'Number of files to upload is larger than {config.UPLOADS_MAX_NUMBER_PER_COMMIT}. Splitting the push into multiple commits.')
            num_commits = math.ceil(len(additions) / config.UPLOADS_MAX_NUMBER_PER_COMMIT)
            for i in range(0, num_commits):
                operations = additions[i * config.UPLOADS_MAX_NUMBER_PER_COMMIT:(i + 1) * config.UPLOADS_MAX_NUMBER_PER_COMMIT] + (deletions if i == 0 else [])
                commit_info = api.create_commit(repo_id, operations=operations, commit_message=commit_message + f' (part {i:05d}-of-{num_commits:05d})', commit_description=commit_description, token=token, repo_type='dataset', revision=revision, create_pr=create_pr)
                logger.info(f'Commit #{i + 1} completed' + (f' (still {num_commits - i - 1} to go)' if num_commits - i - 1 else '') + '.')
        return commit_info