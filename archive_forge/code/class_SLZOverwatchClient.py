...
class SLZOverwatchClient(object):
    ...
    """
        ...
        request = self._messages.SecuredlandingzoneOrganizationsLocationsOverwatchesListRequest(parent=parent, pageSize=page_size, pageToken=page_token)
    ...
    """
        request = self._messages.SecuredlandingzoneOrganizationsLocationsOverwatchesGetRequest(name=overwatch_path)
    ...
    """
        request = self._messages.SecuredlandingzoneOrganizationsLocationsOverwatchesDeleteRequest(name=overwatch_path)
    ...
    """
        req_overwatch = self._messages.GoogleCloudSecuredlandingzoneV1betaOverwatch(name=overwatch.RelativeName(), state=self._messages.GoogleCloudSecuredlandingzoneV1betaOverwatch.StateValueValuesEnum.ACTIVE, planData=blueprint_plan)
        request = self._messages.SecuredlandingzoneOrganizationsLocationsOverwatchesCreateRequest(parent=overwatch.Parent().RelativeName(), googleCloudSecuredlandingzoneV1betaOverwatch=req_overwatch, overwatchId=overwatch.Name())
    ...
    """
        request = self._messages.SecuredlandingzoneOrganizationsLocationsOverwatchesSuspendRequest(name=overwatch_path)
    ...
    """
        request = self._messages.SecuredlandingzoneOrganizationsLocationsOverwatchesActivateRequest(name=overwatch_path)
    ...
    """
        overwatch = self._messages.GoogleCloudSecuredlandingzoneV1betaOverwatch(name=overwatch_path, planData=blueprint_plan)
        request = self._messages.SecuredlandingzoneOrganizationsLocationsOverwatchesPatchRequest(name=overwatch_path, googleCloudSecuredlandingzoneV1betaOverwatch=overwatch, updateMask=update_mask)
    ...
    """
        request = self._messages.SecuredlandingzoneOrganizationsLocationsEnableOverwatchRequest(organization=parent)
    ...
    """
        request = self._messages.SecuredlandingzoneOrganizationsLocationsOperationsGetRequest(name=operation_id)
