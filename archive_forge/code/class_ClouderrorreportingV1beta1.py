...
class ClouderrorreportingV1beta1(base_api.BaseApiClient):
    ...
    def __init__(self, url='', credentials=None, get_credentials=True, http=None, model=None, log_request=False, log_response=False, credentials_args=None, default_global_params=None, additional_http_headers=None, response_encoding=None):
        ...
        super(ClouderrorreportingV1beta1, self).__init__(url, credentials=credentials, get_credentials=get_credentials, http=http, model=model, log_request=log_request, log_response=log_response, credentials_args=credentials_args, default_global_params=default_global_params, additional_http_headers=additional_http_headers, response_encoding=response_encoding)
    ...
    class ProjectsService(base_api.BaseApiService):
      ...
      """
            ...
            return self._RunMethod(config, request, global_params=global_params)
        DeleteEvents.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1beta1/projects/{projectsId}/events', http_method='DELETE', method_id='clouderrorreporting.projects.deleteEvents', ordered_params=['projectName'], path_params=['projectName'], query_params=[], relative_path='v1beta1/{+projectName}/events', request_field='', request_type_name='ClouderrorreportingProjectsDeleteEventsRequest', response_type_name='DeleteEventsResponse', supports_download=False)