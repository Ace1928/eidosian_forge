...
class _BatchRecognize(SpeechRestStub):
    ...
    def __call__(self, request: cloud_speech.BatchRecognizeRequest, *, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Optional[float]=None, metadata: Sequence[Tuple[str, str]]=()) -> operations_pb2.Operation:
        """Call the batch recognize method over HTTP.
            ...
            """
        http_options: List[Dict[str, str]] = [{'method': 'post', 'uri': '/v2/{recognizer=projects/*/locations/*/recognizers/*}:batchRecognize', 'body': '*'}]
