...
def AddUpdateContainerArgs(parser, container_mount_disk_enabled=False):
    ...
    _AddContainerMountGroup(parser, container_mount_disk_enabled=container_mount_disk_enabled)
    _AddContainerArgs(parser)
    AddShieldedInstanceConfigArgs(parser, use_default_value=False, for_update=True, for_container=True)
