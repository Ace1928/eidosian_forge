...
class MigrationUtilsTestCase(test_base.OsWinBaseTestCase):
    ...
    _autospec_classes = [migrationutils.vmutils.VMUtils, migrationutils.jobutils.JobUtils]
    ...
    def test_realize_vm(self, mock_get_planned_vm):
        ...
        self._migrationutils._vs_man_svc.ValidatePlannedSystem.return_value = (mock.sentinel.job_path_ValidatePlannedSystem, mock.sentinel.ret_val_ValidatePlannedSystem)
        self._migrationutils._vs_man_svc.RealizePlannedSystem.return_value = (mock.sentinel.job_path_RealizePlannedSystem, mock.sentinel.ref_RealizePlannedSystem, mock.sentinel.ret_val_RealizePlannedSystem)
        self._migrationutils.realize_vm(self._FAKE_VM_NAME)
        mock_get_planned_vm.assert_called_once_with(self._FAKE_VM_NAME, fail_if_not_found=True)
        expected_call = [mock.call(mock.sentinel.ret_val_ValidatePlannedSystem, mock.sentinel.job_path_ValidatePlannedSystem), mock.call(mock.sentinel.ret_val_RealizePlannedSystem, mock.sentinel.job_path_RealizePlannedSystem)]
        self._migrationutils._jobutils.check_ret_val.assert_has_calls(expected_call)
    ...
    def test_get_planned_vm_exception(self):
        ...
        self.assertRaises(exceptions.HyperVException, self._migrationutils._get_planned_vm, self._FAKE_VM_NAME, fail_if_not_found=True)
        planned_computer_system.assert_called_once_with(ElementName=self._FAKE_VM_NAME)
