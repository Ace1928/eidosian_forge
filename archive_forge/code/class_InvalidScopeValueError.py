...
class InvalidScopeValueError(Error):
    ...
    """
        super(InvalidScopeValueError, self).__init__('Could not parse [{0}] into a valid configuration scope.  Valid values are [{1}]'.format(given, ', '.join(Scope.AllScopeNames())))