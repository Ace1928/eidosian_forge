...
<iq type="result" from="{{GROUP_ID}}" id="{{IQ_ID}}">
  <group subject="{{GROUPSUBJ}}" creation="{{GROUP_CREATION_TYIME}}"
    ...
    def __init__(self, _id, _from, groupId, creationTimestamp, creatorJid, subject, subjectTime, subjectOwnerJid, participants):
        super(InfoGroupsResultIqProtocolEntity, self).__init__(_id=_id, _from=_from)
        self.setGroupProps(groupId, creationTimestamp, creatorJid, subject, subjectTime, subjectOwnerJid, participants)

    def setGroupProps(self, groupId, creationTimestamp, creatorJid, subject, subjectTime, subjectOwnerJid, participants):
    ...
    def fromProtocolTreeNode(node):
        ...
        return InfoGroupsResultIqProtocolEntity(node['id'], node['from'], groupNode['id'], groupNode['creation'], groupNode['creator'], groupNode['subject'], groupNode['s_t'], groupNode['s_o'], participants)