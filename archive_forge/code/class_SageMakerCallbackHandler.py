...
class SageMakerCallbackHandler(BaseCallbackHandler):
    ...
    def __init__(self, run: Any) -> None:
        ...
        super().__init__()
        self.run = run
        self.metrics = {'step': 0, 'starts': 0, 'ends': 0, 'errors': 0, 'text_ctr': 0, 'chain_starts': 0, 'chain_ends': 0, 'llm_starts': 0, 'llm_ends': 0, 'llm_streams': 0, 'tool_starts': 0, 'tool_ends': 0, 'agent_ends': 0}
    ...
    def on_llm_start(self, serialized: Dict[str, Any], prompts: List[str], **kwargs: Any) -> None:
        ...
        for idx, prompt in enumerate(prompts):
            ...
            self.jsonf(prompt_resp, self.temp_dir, f'llm_start_{llm_starts}_prompt_{idx}')
