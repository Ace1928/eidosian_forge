...
def test_enable_service_253(self, mv_mock):
    self._verify('openstack.proxy.Proxy._update', self.proxy.enable_service, method_args=['value'], method_kwargs={}, expected_args=[service.Service, 'value'], expected_kwargs={'status': 'enabled'})