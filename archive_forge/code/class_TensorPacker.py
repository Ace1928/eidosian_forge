...
class TensorPacker(object):
    ...
    def __init__(self, small_feature_dim_size, minimum_num_small_features_to_group):
        self._small_feature_dim_size = small_feature_dim_size
        self._minimum_num_small_features_to_group = minimum_num_small_features_to_group
    ...
    def maybe_split_features(self, maybe_concatenated_features):
        for dtype in self._small_feature_names:
            ...
            splits = tf.split(concatenated_small_features, self._small_feature_sizes[dtype], axis=1)
