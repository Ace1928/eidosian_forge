...
class GameEnvironmentInitializer(ShowBase):
    ...
    def bindMouseToCamera(self):
        ...
        self.mouseWatcherNode.setup_region(PGMouseWatcherBackground())
        self.mouseWatcherNode.set_display_region(self.win.get_display_region(0))
        self.mouseWatcherNode.set_enter_pattern("mouse-enter-%r")
        self.mouseWatcherNode.set_leave_pattern("mouse-leave-%r")
        self.mouseWatcherNode.set_within_pattern("mouse-within-%r")
        self.mouseWatcherNode.set_without_pattern("mouse-without-%r")
