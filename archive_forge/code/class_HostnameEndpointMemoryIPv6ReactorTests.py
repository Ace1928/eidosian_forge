...
class HostnameEndpointMemoryIPv6ReactorTests(_HostnameEndpointMemoryReactorMixin, unittest.TestCase):
    """
    ...
    def createClientEndpoint(self, reactor, clientFactory, **connectArgs):
        ...
        endpoint = endpoints.HostnameEndpoint(reactor, b'ipv6.example.com', address.port, **connectArgs)
