...
def test_aggregate_set_metadata(self):
    self._verify('openstack.compute.v2.aggregate.Aggregate.set_metadata', self.proxy.set_aggregate_metadata, method_args=['value', {'a': 'b'}], expected_args=[self.proxy, {'a': 'b'}])