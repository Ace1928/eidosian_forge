...
class DashvectorTranslator(Visitor):
    ...
    allowed_comparators = [Comparator.EQ, Comparator.GT, Comparator.GTE, Comparator.LT, Comparator.LTE, Comparator.LIKE]
    map_dict = {Operator.AND: ' AND ', Operator.OR: ' OR ', Comparator.EQ: ' = ', Comparator.GT: ' > ', Comparator.GTE: ' >= ', Comparator.LT: ' < ', Comparator.LTE: ' <= ', Comparator.LIKE: ' LIKE '}
