...
def export_image_decoder_decode_bmp_rgb() -> None:
    ...
    data, output = _generate_test_data('bmp', _image_decoder_data.image_decoder_decode_bmp_rgb, 'RGB')
    expect(node, inputs=[data], outputs=[output], name='test_image_decoder_decode_bmp_rgb')