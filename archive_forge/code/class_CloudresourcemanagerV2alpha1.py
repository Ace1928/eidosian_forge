...
class CloudresourcemanagerV2alpha1(base_api.BaseApiClient):
    ...
    def __init__(self, url='', credentials=None, get_credentials=True, http=None, model=None, log_request=False, log_response=False, credentials_args=None, default_global_params=None, additional_http_headers=None, response_encoding=None):
        ...
        super(CloudresourcemanagerV2alpha1, self).__init__(url, credentials=credentials, get_credentials=get_credentials, http=http, model=model, log_request=log_request, log_response=log_response, credentials_args=credentials_args, default_global_params=default_global_params, additional_http_headers=additional_http_headers, response_encoding=response_encoding)
    ...
    class FoldersService(base_api.BaseApiService):
      ...
      """
        ...
        Create.method_config = lambda: base_api.ApiMethodInfo(http_method='POST', method_id='cloudresourcemanager.folders.create', ordered_params=[], path_params=[], query_params=['parent'], relative_path='v2alpha1/folders', request_field='folder', request_type_name='CloudresourcemanagerFoldersCreateRequest', response_type_name='Operation', supports_download=False)
      ...
      """
            ...
            return self._RunMethod(config, request, global_params=global_params)
        Delete.method_config = lambda: base_api.ApiMethodInfo(http_method='DELETE', method_id='cloudresourcemanager.folders.delete', ordered_params=['foldersId'], path_params=['foldersId'], query_params=[], relative_path='v2alpha1/folders/{foldersId}', request_field='', request_type_name='CloudresourcemanagerFoldersDeleteRequest', response_type_name='Folder', supports_download=False)
      ...
      """
            ...
            return self._RunMethod(config, request, global_params=global_params)
        Get.method_config = lambda: base_api.ApiMethodInfo(http_method='GET', method_id='cloudresourcemanager.folders.get', ordered_params=['foldersId'], path_params=['foldersId'], query_params=[], relative_path='v2alpha1/folders/{foldersId}', request_field='', request_type_name='CloudresourcemanagerFoldersGetRequest', response_type_name='Folder', supports_download=False)
      ...
      """
            ...
            return self._RunMethod(config, request, global_params=global_params)
        GetIamPolicy.method_config = lambda: base_api.ApiMethodInfo(http_method='POST', method_id='cloudresourcemanager.folders.getIamPolicy', ordered_params=['foldersId'], path_params=['foldersId'], query_params=[], relative_path='v2alpha1/folders/{foldersId}:getIamPolicy', request_field='getIamPolicyRequest', request_type_name='CloudresourcemanagerFoldersGetIamPolicyRequest', response_type_name='Policy', supports_download=False)
      ...
      """
            ...
            return self._RunMethod(config, request, global_params=global_params)
        Move.method_config = lambda: base_api.ApiMethodInfo(http_method='POST', method_id='cloudresourcemanager.folders.move', ordered_params=['foldersId'], path_params=['foldersId'], query_params=[], relative_path='v2alpha1/folders/{foldersId}:move', request_field='moveFolderRequest', request_type_name='CloudresourcemanagerFoldersMoveRequest', response_type_name='Operation', supports_download=False)
      ...
      """
            ...
            return self._RunMethod(config, request, global_params=global_params)
        SetIamPolicy.method_config = lambda: base_api.ApiMethodInfo(http_method='POST', method_id='cloudresourcemanager.folders.setIamPolicy', ordered_params=['foldersId'], path_params=['foldersId'], query_params=[], relative_path='v2alpha1/folders/{foldersId}:setIamPolicy', request_field='setIamPolicyRequest', request_type_name='CloudresourcemanagerFoldersSetIamPolicyRequest', response_type_name='Policy', supports_download=False)
      ...
      """
            ...
            return self._RunMethod(config, request, global_params=global_params)
        TestIamPermissions.method_config = lambda: base_api.ApiMethodInfo(http_method='POST', method_id='cloudresourcemanager.folders.testIamPermissions', ordered_params=['foldersId'], path_params=['foldersId'], query_params=[], relative_path='v2alpha1/folders/{foldersId}:testIamPermissions', request_field='testIamPermissionsRequest', request_type_name='CloudresourcemanagerFoldersTestIamPermissionsRequest', response_type_name='TestIamPermissionsResponse', supports_download=False)
      ...
      """
            ...
            return self._RunMethod(config, request, global_params=global_params)
        Undelete.method_config = lambda: base_api.ApiMethodInfo(http_method='POST', method_id='cloudresourcemanager.folders.undelete', ordered_params=['foldersId'], path_params=['foldersId'], query_params=[], relative_path='v2alpha1/folders/{foldersId}:undelete', request_field='undeleteFolderRequest', request_type_name='CloudresourcemanagerFoldersUndeleteRequest', response_type_name='Folder', supports_download=False)
      ...
      """
            ...
            return self._RunMethod(config, request, global_params=global_params)
        Update.method_config = lambda: base_api.ApiMethodInfo(http_method='PUT', method_id='cloudresourcemanager.folders.update', ordered_params=['foldersId'], path_params=['foldersId'], query_params=[], relative_path='v2alpha1/folders/{foldersId}', request_field='folder', request_type_name='CloudresourcemanagerFoldersUpdateRequest', response_type_name='Folder', supports_download=False)