...
def quantized_mat_mul_with_bias_and_requantize(a: _atypes.TensorFuzzingAnnotation[TV_QuantizedMatMulWithBiasAndRequantize_T1], b: _atypes.TensorFuzzingAnnotation[TV_QuantizedMatMulWithBiasAndRequantize_T2], bias: _atypes.TensorFuzzingAnnotation[TV_QuantizedMatMulWithBiasAndRequantize_Tbias], min_a: _atypes.TensorFuzzingAnnotation[_atypes.Float32], max_a: _atypes.TensorFuzzingAnnotation[_atypes.Float32], min_b: _atypes.TensorFuzzingAnnotation[_atypes.Float32], max_b: _atypes.TensorFuzzingAnnotation[_atypes.Float32], min_freezed_output: _atypes.TensorFuzzingAnnotation[_atypes.Float32], max_freezed_output: _atypes.TensorFuzzingAnnotation[_atypes.Float32], Toutput: TV_QuantizedMatMulWithBiasAndRequantize_Toutput=_dtypes.quint8, transpose_a: bool=False, transpose_b: bool=False, input_quant_mode: str='MIN_FIRST', name=None):
  ...
  """
    ...
    if tld.is_eager:
        try:
            _result = pywrap_tfe.TFE_Py_FastPathExecute(_ctx, 'QuantizedMatMulWithBiasAndRequantize', name, a, b, bias, min_a, max_a, min_b, max_b, min_freezed_output, max_freezed_output, 'Toutput', Toutput, 'transpose_a', transpose_a, 'transpose_b', transpose_b, 'input_quant_mode', input_quant_mode)
