...
def json_reader(fo: IO, schema: Schema, reader_schema: Optional[Schema]=None, *, decoder=AvroJSONDecoder) -> reader:
    ...
    if reader_schema:
        reader_instance.reader_schema = parse_schema(reader_schema, reader_instance._named_schemas['reader'], _write_hint=False)
