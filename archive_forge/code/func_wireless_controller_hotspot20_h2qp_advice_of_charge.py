...
def wireless_controller_hotspot20_h2qp_advice_of_charge(data, fos):
    ...
    if state == 'present' or state is True:
        return fos.set('wireless-controller.hotspot20', 'h2qp-advice-of-charge', data=filtered_data, vdom=vdom)
    elif state == 'absent':
        return fos.delete('wireless-controller.hotspot20', 'h2qp-advice-of-charge', mkey=filtered_data['name'], vdom=vdom)
    else:
