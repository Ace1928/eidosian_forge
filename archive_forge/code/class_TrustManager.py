...
class TrustManager(base.CrudManager):
    ...
    def create(self, trustee_user, trustor_user, role_names=None, role_ids=None, project=None, impersonation=False, expires_at=None, remaining_uses=None, **kwargs):
        """Create a Trust.
        ...
        if expires_at:
            ...
            expires_str = None
        return super(TrustManager, self).create(expires_at=expires_str, impersonation=impersonation, project_id=base.getid(project), remaining_uses=remaining_uses, roles=roles, trustee_user_id=base.getid(trustee_user), trustor_user_id=base.getid(trustor_user), **kwargs)

    def update(self):
        raise exceptions.MethodNotImplemented(_('Update not supported for trusts'))
    ...
    def list(self, trustee_user=None, trustor_user=None, **kwargs):
        ...
        return super(TrustManager, self).list(trustee_user_id=trustee_user_id, trustor_user_id=trustor_user_id, **kwargs)
