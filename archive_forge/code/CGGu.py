...
def main():
    ...
    spy = get_historical_data_benzinga_api("SPY", "1993-01-01", "1W")
    spy_ret = round(
    ...
    aapl = get_historical_data_benzinga_api("AAPL", "1993-01-01", "1W")
