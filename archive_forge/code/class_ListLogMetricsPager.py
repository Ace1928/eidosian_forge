...
class ListLogMetricsPager:
    ...
    def __init__(self, method: Callable[..., logging_metrics.ListLogMetricsResponse], request: logging_metrics.ListLogMetricsRequest, response: logging_metrics.ListLogMetricsResponse, *, metadata: Sequence[Tuple[str, str]]=()):
