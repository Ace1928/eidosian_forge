...
class CheckpointOptions(object):
  ...
  ```
  """
    __slots__ = ('experimental_io_device', 'experimental_enable_async_checkpoint', 'enable_async')

    @deprecated_args(None, 'Use enable_async instead', 'experimental_enable_async_checkpoint')
    def __init__(self, experimental_io_device=None, experimental_enable_async_checkpoint=False, enable_async=False):
