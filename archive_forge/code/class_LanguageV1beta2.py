...
class LanguageV1beta2(base_api.BaseApiClient):
    ...
    def __init__(self, url='', credentials=None, get_credentials=True, http=None, model=None, log_request=False, log_response=False, credentials_args=None, default_global_params=None, additional_http_headers=None, response_encoding=None):
        ...
        super(LanguageV1beta2, self).__init__(url, credentials=credentials, get_credentials=get_credentials, http=http, model=model, log_request=log_request, log_response=log_response, credentials_args=credentials_args, default_global_params=default_global_params, additional_http_headers=additional_http_headers, response_encoding=response_encoding)
...
other properties.
      ...
      """
        ...
        AnalyzeEntities.method_config = lambda: base_api.ApiMethodInfo(http_method='POST', method_id='language.documents.analyzeEntities', ordered_params=[], path_params=[], query_params=[], relative_path='v1beta2/documents:analyzeEntities', request_field='<request>', request_type_name='AnalyzeEntitiesRequest', response_type_name='AnalyzeEntitiesResponse', supports_download=False)
...
properties.
      ...
      """
            ...
            return self._RunMethod(config, request, global_params=global_params)
        AnalyzeSyntax.method_config = lambda: base_api.ApiMethodInfo(http_method='POST', method_id='language.documents.analyzeSyntax', ordered_params=[], path_params=[], query_params=[], relative_path='v1beta2/documents:analyzeSyntax', request_field='<request>', request_type_name='AnalyzeSyntaxRequest', response_type_name='AnalyzeSyntaxResponse', supports_download=False)
...
classification features in one call.
      ...
      """
            ...
            return self._RunMethod(config, request, global_params=global_params)
        AnnotateText.method_config = lambda: base_api.ApiMethodInfo(http_method='POST', method_id='language.documents.annotateText', ordered_params=[], path_params=[], query_params=[], relative_path='v1beta2/documents:annotateText', request_field='<request>', request_type_name='AnnotateTextRequest', response_type_name='AnnotateTextResponse', supports_download=False)
      ...
      """
            ...
            return self._RunMethod(config, request, global_params=global_params)
        ClassifyText.method_config = lambda: base_api.ApiMethodInfo(http_method='POST', method_id='language.documents.classifyText', ordered_params=[], path_params=[], query_params=[], relative_path='v1beta2/documents:classifyText', request_field='<request>', request_type_name='ClassifyTextRequest', response_type_name='ClassifyTextResponse', supports_download=False)