...
class InstructionScheduleMap:
    ...
    def __init__(self):
        ...
        self._map: dict[str | circuit.instruction.Instruction, dict[tuple, CalibrationEntry]] = defaultdict(functools.partial(defaultdict, CalibrationEntry))
    ...
    def has(self, instruction: str | circuit.instruction.Instruction, qubits: int | Iterable[int]) -> bool:
    ...
    def get(self, instruction: str | circuit.instruction.Instruction, qubits: int | Iterable[int], *params: complex | ParameterExpression, **kwparams: complex | ParameterExpression) -> Schedule | ScheduleBlock:
    ...
    def add(self, instruction: str | circuit.instruction.Instruction, qubits: int | Iterable[int], schedule: Schedule | ScheduleBlock | Callable[..., Schedule | ScheduleBlock], arguments: list[str] | None=None) -> None:
    ...
    def remove(self, instruction: str | circuit.instruction.Instruction, qubits: int | Iterable[int]) -> None:
    ...
    def pop(self, instruction: str | circuit.instruction.Instruction, qubits: int | Iterable[int], *params: complex | ParameterExpression, **kwparams: complex | ParameterExpression) -> Schedule | ScheduleBlock:
    ...
    def get_parameters(self, instruction: str | circuit.instruction.Instruction, qubits: int | Iterable[int]) -> tuple[str, ...]:
