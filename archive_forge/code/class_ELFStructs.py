...
class ELFStructs(object):
    ...
    def _create_rel(self):
        if self.elfclass == 32:
            fields = [self.Elf_xword('r_info'), Value('r_info_sym', lambda ctx: ctx['r_info'] >> 8 & 16777215), Value('r_info_type', lambda ctx: ctx['r_info'] & 255)]
        elif self.e_machine == 'EM_MIPS':
            ...
            fields = [self.Elf_xword('r_info'), Value('r_info_sym', lambda ctx: ctx['r_info'] >> 32 & 4294967295), Value('r_info_type', lambda ctx: ctx['r_info'] & 4294967295)]
