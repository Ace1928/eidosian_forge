...
def test_tabulator_patch_with_filters(document, comm):
    ...
    expected_src = {'index': np.array([3]), 'A': np.array([3]), 'B': np.array([1]), 'C': np.array(['foo4']), 'D': np.array(['2009-01-06T00:00:00.000000000'], dtype='datetime64[ns]').astype(np.int64) / 1000000.0}
