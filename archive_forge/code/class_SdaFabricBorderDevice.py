...
class SdaFabricBorderDevice(object):
    ...
    def __init__(self, params, dnac):
        self.dnac = dnac
        self.new_object = dict(payload=params.get('payload'), device_management_ip_address=params.get('deviceManagementIpAddress'))
    ...
    def get_object_by_name(self, name, is_absent=False):
        result = None
        try:
            items = self.dnac.exec(family='sda', function='gets_border_device_detail', params=self.get_all_params(name=name))
    ...
    def create(self):
        result = self.dnac.exec(family='sda', function='adds_border_device', params=self.create_params(), op_modifies=True)
    ...
    def delete(self):
        ...
        name = self.new_object.get('name')
        result = None
        result = self.dnac.exec(family='sda', function='deletes_border_device', params=self.delete_all_params())
        return result