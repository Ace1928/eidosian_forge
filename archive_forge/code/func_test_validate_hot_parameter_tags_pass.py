...
def test_validate_hot_parameter_tags_pass(self):
    ...
    expected = {'KeyName': {'Description': 'Name of an existing key pair to use for the instance', 'NoEcho': 'false', 'Label': 'Nova KeyPair Name', 'Type': 'String', 'Tags': ['feature1', 'feature2']}}
