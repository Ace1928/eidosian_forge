...
class SchemaServiceRestTransport(SchemaServiceTransport):
    ...
    class _CommitSchema(SchemaServiceRestStub):
        ...
        def __call__(self, request: gp_schema.CommitSchemaRequest, *, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Optional[float]=None, metadata: Sequence[Tuple[str, str]]=()) -> gp_schema.Schema:
            """Call the commit schema method over HTTP.
            ...
            Returns:
                ~.gp_schema.Schema:
                    A schema resource.
            """
            http_options: List[Dict[str, str]] = [{'method': 'post', 'uri': '/v1/{name=projects/*/schemas/*}:commit', 'body': '*'}]
    ...
    class _CreateSchema(SchemaServiceRestStub):
        ...
        def __call__(self, request: gp_schema.CreateSchemaRequest, *, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Optional[float]=None, metadata: Sequence[Tuple[str, str]]=()) -> gp_schema.Schema:
            """Call the create schema method over HTTP.
            ...
            Returns:
                ~.gp_schema.Schema:
                    A schema resource.
            """
            http_options: List[Dict[str, str]] = [{'method': 'post', 'uri': '/v1/{parent=projects/*}/schemas', 'body': 'schema'}]
    ...
    class _DeleteSchema(SchemaServiceRestStub):
        ...
        def __call__(self, request: schema.DeleteSchemaRequest, *, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Optional[float]=None, metadata: Sequence[Tuple[str, str]]=()):
            """Call the delete schema method over HTTP.
            ...
            Args:
                ...
                metadata (Sequence[Tuple[str, str]]): Strings which should be
                    sent along with the request as metadata.
            """
            http_options: List[Dict[str, str]] = [{'method': 'delete', 'uri': '/v1/{name=projects/*/schemas/*}'}]
    ...
    class _DeleteSchemaRevision(SchemaServiceRestStub):
        ...
        def __call__(self, request: schema.DeleteSchemaRevisionRequest, *, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Optional[float]=None, metadata: Sequence[Tuple[str, str]]=()) -> schema.Schema:
            """Call the delete schema revision method over HTTP.
            ...
            Returns:
                ~.schema.Schema:
                    A schema resource.
            """
            http_options: List[Dict[str, str]] = [{'method': 'delete', 'uri': '/v1/{name=projects/*/schemas/*}:deleteRevision'}]
    ...
    class _GetSchema(SchemaServiceRestStub):
        ...
        def __call__(self, request: schema.GetSchemaRequest, *, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Optional[float]=None, metadata: Sequence[Tuple[str, str]]=()) -> schema.Schema:
            """Call the get schema method over HTTP.
            ...
            Returns:
                ~.schema.Schema:
                    A schema resource.
            """
            http_options: List[Dict[str, str]] = [{'method': 'get', 'uri': '/v1/{name=projects/*/schemas/*}'}]
    ...
    class _ListSchemas(SchemaServiceRestStub):
        ...
        def __call__(self, request: schema.ListSchemasRequest, *, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Optional[float]=None, metadata: Sequence[Tuple[str, str]]=()) -> schema.ListSchemasResponse:
            """Call the list schemas method over HTTP.
            ...
            """
            http_options: List[Dict[str, str]] = [{'method': 'get', 'uri': '/v1/{parent=projects/*}/schemas'}]
    ...
    class _RollbackSchema(SchemaServiceRestStub):
        ...
        def __call__(self, request: schema.RollbackSchemaRequest, *, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Optional[float]=None, metadata: Sequence[Tuple[str, str]]=()) -> schema.Schema:
            """Call the rollback schema method over HTTP.
            ...
            Returns:
                ~.schema.Schema:
                    A schema resource.
            """
            http_options: List[Dict[str, str]] = [{'method': 'post', 'uri': '/v1/{name=projects/*/schemas/*}:rollback', 'body': '*'}]
    ...
    class _ValidateMessage(SchemaServiceRestStub):
        ...
        def __call__(self, request: schema.ValidateMessageRequest, *, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Optional[float]=None, metadata: Sequence[Tuple[str, str]]=()) -> schema.ValidateMessageResponse:
            """Call the validate message method over HTTP.
            ...
            """
            http_options: List[Dict[str, str]] = [{'method': 'post', 'uri': '/v1/{parent=projects/*}/schemas:validateMessage', 'body': '*'}]
    ...
    class _ValidateSchema(SchemaServiceRestStub):
        ...
        def __call__(self, request: gp_schema.ValidateSchemaRequest, *, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Optional[float]=None, metadata: Sequence[Tuple[str, str]]=()) -> gp_schema.ValidateSchemaResponse:
            """Call the validate schema method over HTTP.
            ...
            """
            http_options: List[Dict[str, str]] = [{'method': 'post', 'uri': '/v1/{parent=projects/*}/schemas:validate', 'body': '*'}]
