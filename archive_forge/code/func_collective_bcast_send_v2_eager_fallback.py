...
def collective_bcast_send_v2_eager_fallback(input: _atypes.TensorFuzzingAnnotation[TV_CollectiveBcastSendV2_T], group_size: _atypes.TensorFuzzingAnnotation[_atypes.Int32], group_key: _atypes.TensorFuzzingAnnotation[_atypes.Int32], instance_key: _atypes.TensorFuzzingAnnotation[_atypes.Int32], communication_hint: str, timeout_seconds: float, name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_CollectiveBcastSendV2_T]:
    ...
    _attrs = ('T', _attr_T, 'communication_hint', communication_hint, 'timeout_seconds', timeout_seconds)
    _result = _execute.execute(b'CollectiveBcastSendV2', 1, inputs=_inputs_flat, attrs=_attrs, ctx=ctx, name=name)
