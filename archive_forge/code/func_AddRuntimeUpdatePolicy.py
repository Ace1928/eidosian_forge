...
def AddRuntimeUpdatePolicy(parser, track):
    ...
    if track in (base.ReleaseTrack.ALPHA, base.ReleaseTrack.BETA, base.ReleaseTrack.GA):
        parser.add_argument('--runtime-update-policy', help='        Runtime update policy for the 1st Gen function being deployed.\n        The option `on-deploy` is used by default.\n      ')