...
class ConditionalParameterValueDefnumber(ConditionalValueDefnumber):
    ...
    def __init__(self, param: Union[str, 'SchemaBase', UndefinedType]=Undefined, value: Union[float, UndefinedType]=Undefined, empty: Union[bool, UndefinedType]=Undefined, **kwds):
        super(ConditionalParameterValueDefnumber, self).__init__(param=param, value=value, empty=empty, **kwds)