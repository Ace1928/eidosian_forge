...
class _TrainerFabricShim:
    ...
    def __getattr__(self, item: Any) -> Any:
        try:
            ...
            raise AttributeError(f'Your LightningModule code tried to access `self.trainer.{item}` but this attribute is not available when using Fabric with a LightningModule.')