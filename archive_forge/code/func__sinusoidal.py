...
def _sinusoidal(cf_params):
    ...
    """
    return SinusoidalConversion(longitude_natural_origin=cf_params.get('longitude_of_projection_origin', 0.0), false_easting=cf_params.get('false_easting', 0.0), false_northing=cf_params.get('false_northing', 0.0))