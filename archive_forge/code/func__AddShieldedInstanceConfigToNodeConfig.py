...
def _AddShieldedInstanceConfigToNodeConfig(node_config, options, messages):
    ...
    if options.shielded_secure_boot is not None or options.shielded_integrity_monitoring is not None:
        ...
        if options.shielded_secure_boot is not None:
            node_config.shieldedInstanceConfig.enableSecureBoot = options.shielded_secure_boot
        if options.shielded_integrity_monitoring is not None:
            node_config.shieldedInstanceConfig.enableIntegrityMonitoring = options.shielded_integrity_monitoring