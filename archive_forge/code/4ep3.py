...
async def initialize_cache(
    ...
    Args:
        ...
        max_size (int, optional): The maximum size of the in-memory cache. Defaults to CACHE_MAX_SIZE.
        file_path (str, optional): The file path for persistent cache storage. Defaults to CACHE_FILE_PATH.
