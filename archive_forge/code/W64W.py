...
class KAN:
    def __init__(self, input_size: int, output_size: int, depth: int, activation: str = 'tanh'):
        """
    ...
    def train(self, dataset: np.ndarray, targets: np.ndarray, learning_rate: float = 0.01, epochs: int = 100):
        """
    ...
    def _activation_derivative(self, activation, x):
        """
        ...
        if activation == np.tanh:
            ...
            raise ValueError("Unsupported activation function for derivative calculation.")
