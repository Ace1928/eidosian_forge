...
def test_retrieve_subject_token_missing_version(self):
    EXECUTABLE_SUCCESSFUL_OIDC_RESPONSE = {'success': True, 'token_type': 'urn:ietf:params:oauth:token-type:id_token', 'id_token': self.EXECUTABLE_OIDC_TOKEN, 'expiration_time': 9999999999}
