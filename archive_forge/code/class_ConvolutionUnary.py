...
class ConvolutionUnary(ExternKernelAlloc):
    ...
    def codegen(self, wrapper):
        wrapper.generate_extern_kernel_alloc_and_find_schema_if_needed(self.get_name(), self.cpp_kernel if V.graph.cpp_wrapper else self.kernel, self.codegen_args(), self.cpp_op_schema, self.cpp_kernel_key)
