...
def GetMultiRegion(args):
  ...
  """
    regions = getattr(args, 'regions', None) if FlagIsExplicitlySet(args, 'regions') else None
    region = getattr(args, 'region', None)
    if region and regions:
        raise c_exceptions.InvalidArgumentException(parameter_name='--regions', message='--region and --regions are mutually exclusive.')
