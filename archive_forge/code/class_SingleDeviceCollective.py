...
class SingleDeviceCollective(Collective):
    ...
    @override
    def scatter(self, tensor: Tensor, scatter_list: List[Tensor], *_: Any, **__: Any) -> Tensor:
    ...
    @override
    def all_to_all(self, output_tensor_list: List[Tensor], input_tensor_list: List[Tensor], *_: Any, **__: Any) -> List[Tensor]:
