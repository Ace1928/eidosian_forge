...
class PhononDos(MSONable):
    ...
    def __repr__(self) -> str:
        ...
        return f'{type(self).__name__}(frequencies={frequencies!r}, densities={densities!r}, n_positive_freqs={n_positive_freqs!r})'
    ...
    def as_dict(self) -> dict:
        ...
        return {'@module': type(self).__module__, '@class': type(self).__name__, 'frequencies': list(self.frequencies), 'densities': list(self.densities)}
