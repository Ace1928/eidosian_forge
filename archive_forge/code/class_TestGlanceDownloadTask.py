...
class TestGlanceDownloadTask(test_utils.BaseTestCase):
    ...
    def setUp(self):
        ...
        self.context = glance.context.RequestContext(tenant=TENANT1, auth_token='token')
        task_input = {'import_req': {'method': {'name': 'glance-download', 'glance_image_id': uuidsentinel.remote_image, 'glance_region': 'RegionTwo', 'glance_service_interface': 'public'}}}
        ...
        self.action_wrapper = api_image_import.ImportActionWrapper(self.image_repo, self.image_id, self.task_id)
        self.image_repo.get.return_value = mock.MagicMock(extra_properties={'os_glance_import_task': self.task_id})
