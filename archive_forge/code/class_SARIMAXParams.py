...
class SARIMAXParams:
    ...
    def seasonal_ar_poly(self):
        ...
        if s > 0:
            ...
            coef = np.r_[1, np.pad(np.reshape(expanded, (-1, 1)), [(0, 0), (s - 1, 0)], 'constant').flatten()]
        return Polynomial(coef)
    ...
    def is_stationary(self):
        ...
        validate_basic(self.seasonal_ar_params, self.k_seasonal_ar_params, title='seasonal AR coefficients')
        ar_stationary = True
