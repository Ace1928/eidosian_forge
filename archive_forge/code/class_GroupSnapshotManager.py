...
class GroupSnapshotManager(base.ManagerWithFind):
    ...
    def create(self, group_id, name=None, description=None, user_id=None, project_id=None):
       ...
       """
        body = {'group_snapshot': {'group_id': group_id, 'name': name, 'description': description}}
    ...
    def get(self, group_snapshot_id):
        ...
        :rtype: :class:`GroupSnapshot`
        """
        return self._get('/group_snapshots/%s' % group_snapshot_id, 'group_snapshot')
    ...
    def list(self, detailed=True, search_opts=None):
        ...
        if detailed:
            detail = '/detail'
        return self._list('/group_snapshots%s%s' % (detail, query_string), 'group_snapshots')
    ...
    def update(self, group_snapshot, **kwargs):
        ...
        return self._update('/group_snapshots/%s' % base.getid(group_snapshot), body)
