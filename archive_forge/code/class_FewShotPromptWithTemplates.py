...
class FewShotPromptWithTemplates(StringPromptTemplate):
    ...
    def template_is_valid(cls, values: Dict) -> Dict:
        ...
        if values['validate_template']:
            ...
            if missing_vars:
                raise ValueError(f'Got input_variables={input_variables}, but based on prefix/suffix expected {expected_input_variables}')
        else:
            values['input_variables'] = sorted(set(values['suffix'].input_variables) | set(values['prefix'].input_variables if values['prefix'] else []) - set(values['partial_variables']))
        return values
