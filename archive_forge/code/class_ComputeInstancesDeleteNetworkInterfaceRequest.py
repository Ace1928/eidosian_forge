...
class ComputeInstancesDeleteNetworkInterfaceRequest(_messages.Message):
    """A ComputeInstancesDeleteNetworkInterfaceRequest object.
  ...
  """
    ...
    networkInterfaceName = _messages.StringField(2, required=True)
