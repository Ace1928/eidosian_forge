...
class AppsV1beta1DeploymentSpec(object):
    ...
    swagger_types = {'min_ready_seconds': 'int', 'paused': 'bool', 'progress_deadline_seconds': 'int', 'replicas': 'int', 'revision_history_limit': 'int', 'rollback_to': 'AppsV1beta1RollbackConfig', 'selector': 'V1LabelSelector', 'strategy': 'AppsV1beta1DeploymentStrategy', 'template': 'V1PodTemplateSpec'}
