...
class AzureRMDatalakeStore(AzureRMModuleBase):
    ...
    def __init__(self):
        ...
        super(AzureRMDatalakeStore, self).__init__(derived_arg_spec=self.module_arg_spec, supports_check_mode=False, supports_tags=True)
    ...
    def exec_module(self, **kwargs):
        ...
        if self.encryption_config:
            ...
            self.encryption_config_model = self.datalake_store_models.EncryptionConfig(type=self.encryption_config.get('type'), key_vault_meta_info=key_vault_meta_info_model)
        if self.identity is not None:
            self.identity_model = self.datalake_store_models.EncryptionIdentity(type=self.identity)
