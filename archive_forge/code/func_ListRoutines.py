...
def ListRoutines(self, reference, max_results, page_token, filter_expression):
    ...
    """
    return self.GetRoutinesApiClient().routines().list(projectId=reference.projectId, datasetId=reference.datasetId, maxResults=max_results, pageToken=page_token, filter=filter_expression).execute()