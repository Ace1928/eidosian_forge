...
def ModelExists(self, reference: 'bq_id_utils.ApiClientHelper.ModelReference') -> bool:
    """Returns true if the model exists."""
    bq_id_utils.typecheck(reference, bq_id_utils.ApiClientHelper.ModelReference, method='ModelExists')
    try:
