...
def batch_mat_mul_eager_fallback(x: _atypes.TensorFuzzingAnnotation[TV_BatchMatMul_T], y: _atypes.TensorFuzzingAnnotation[TV_BatchMatMul_T], adj_x: bool, adj_y: bool, grad_x: bool, grad_y: bool, name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_BatchMatMul_T]:
    if adj_x is None:
        adj_x = False
    ...
    _result = _execute.execute(b'BatchMatMul', 1, inputs=_inputs_flat, attrs=_attrs, ctx=ctx, name=name)
