...
- Planned support for encryption of sensitive configuration values.
- Future support for JSON-based configuration files.
"""
...
class ConfigManager:
    ...
    def __init__(self, encryption_key: Optional[bytes] = None):
        """
        Initializes the ConfigManager with an empty dictionary for config files and sets up encryption.
