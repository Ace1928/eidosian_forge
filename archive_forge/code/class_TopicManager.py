...
class TopicManager(CRUDMixin, RESTManager):
    _path = '/topics'
    _obj_cls = Topic
    _create_attrs = RequiredOptional(required=('name',), optional=('avatar', 'description', 'title'))
    ...
    @cli.register_custom_action('TopicManager', mandatory=('source_topic_id', 'target_topic_id'))
    @exc.on_http_error(exc.GitlabMRClosedError)
    def merge(self, source_topic_id: Union[int, str], target_topic_id: Union[int, str], **kwargs: Any) -> Dict[str, Any]:
