...
class CustomTargetTypesClient(object):
    ...
    """
        request = self.messages.ClouddeployProjectsLocationsCustomTargetTypesGetRequest(name=name)
    ...
    """
        return self._service.Patch(self.messages.ClouddeployProjectsLocationsCustomTargetTypesPatchRequest(customTargetType=obj, allowMissing=True, name=obj.name, updateMask=CUSTOM_TARGET_TYPE_UPDATE_MASK))
    ...
    Returns:
      The operation message.
    """
        return self._service.Delete(self.messages.ClouddeployProjectsLocationsCustomTargetTypesDeleteRequest(name=name, allowMissing=True))