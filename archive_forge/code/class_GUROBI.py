...
class GUROBI(QpSolver):
    ...
    STATUS_MAP = {2: s.OPTIMAL, 3: s.INFEASIBLE, 4: s.INFEASIBLE_OR_UNBOUNDED, 5: s.UNBOUNDED, 6: s.SOLVER_ERROR, 7: s.USER_LIMIT, 8: s.USER_LIMIT, 9: s.USER_LIMIT, 10: s.USER_LIMIT, 11: s.USER_LIMIT, 12: s.SOLVER_ERROR, 13: s.USER_LIMIT, 14: s.USER_LIMIT, 15: s.USER_LIMIT, 16: s.USER_LIMIT, 17: s.USER_LIMIT}
