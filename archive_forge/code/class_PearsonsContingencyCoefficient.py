...
class PearsonsContingencyCoefficient(Metric):
    ...
    def __init__(self, num_classes: int, nan_strategy: Literal['replace', 'drop']='replace', nan_replace_value: Optional[float]=0.0, **kwargs: Any) -> None:
    ...
    def update(self, preds: Tensor, target: Tensor) -> None:
        ...
        confmat = _pearsons_contingency_coefficient_update(preds, target, self.num_classes, self.nan_strategy, self.nan_replace_value)
