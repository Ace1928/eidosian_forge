...
def test_backup_delete_force(self):
    self._verify('openstack.block_storage.v2.backup.Backup.force_delete', self.proxy.delete_backup, method_args=['value'], method_kwargs={'force': True}, expected_args=[self.proxy])