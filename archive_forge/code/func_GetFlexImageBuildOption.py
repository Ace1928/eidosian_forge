...
def GetFlexImageBuildOption(default_strategy=FlexImageBuildOptions.ON_CLIENT):
    ...
    trigger_build_server_side = properties.VALUES.app.trigger_build_server_side.GetBool(required=False)
    use_flex_with_buildpacks = properties.VALUES.app.use_flex_with_buildpacks.GetBool(required=False)
