...
def _PatchIamWrapper(cls, iter_result, thread_state):
    ...
    return cls.PatchIamHelper(expansion_result.expanded_storage_url, [DeserializeBindingsTuple(t) for t in serialized_bindings_tuples], thread_state=thread_state)