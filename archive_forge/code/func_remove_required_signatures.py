...
def remove_required_signatures(self) -> None:
    """
        ...
        """
    headers, data = self._requester.requestJsonAndCheck('DELETE', f'{self.protection_url}/required_signatures', headers={'Accept': Consts.signaturesProtectedBranchesPreview})