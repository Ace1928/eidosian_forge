...
def test_endpoints_created_with_endpoint_exists(self):
    PROVIDERS.resource_api.create_domain(self.default_domain['id'], self.default_domain)
    ...
    endpoint = unit.new_endpoint_ref(interface='public', service_id=service['id'], url=self.public_url, region_id=self.region_id)
