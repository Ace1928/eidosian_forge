...
class TestListFirmwareComponents(TestBaremetal):
    ...
    def setUp(self):
        ...
        self.baremetal_mock.node.list_firmware_components.return_value = baremetal_fakes.FIRMWARE_COMPONENTS
        self.cmd = baremetal_node.ListFirmwareComponentBaremetalNode(self.app, None)
