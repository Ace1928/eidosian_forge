...
class AddressWithAllocationTest(unittest.TestCase):
    ...
    def test_associate_calls_connection_associate_address_with_correct_args(self):
        ...
        self.address.connection.associate_address.assert_called_with(instance_id=1, public_ip='192.168.1.1', allocation_id='aid1', network_interface_id=None, private_ip_address=None, allow_reassociation=False, dry_run=False)
