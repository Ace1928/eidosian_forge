...
def BuildJavaImageDockerfile(flex_template_base_image, pipeline_paths, env):
    ...
    dockerfile_contents = textwrap.dedent(dockerfile_template).format(base_image=Templates._GetFlexTemplateBaseImage(flex_template_base_image), env=env_list, copy=copy_command, commands='\n'.join(commands))
