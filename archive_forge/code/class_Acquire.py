...
class Acquire(Instruction):
    ...
    def __init__(self, duration: int | ParameterExpression, channel: AcquireChannel, mem_slot: MemorySlot | None=None, reg_slot: RegisterSlot | None=None, kernel: Kernel | None=None, discriminator: Discriminator | None=None, name: str | None=None):
