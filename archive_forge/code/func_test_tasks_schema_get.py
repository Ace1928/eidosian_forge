...
def test_tasks_schema_get(self):
    self._verify('openstack.proxy.Proxy._get', self.proxy.get_tasks_schema, expected_args=[_schema.Schema], expected_kwargs={'base_path': '/schemas/tasks', 'requires_id': False})