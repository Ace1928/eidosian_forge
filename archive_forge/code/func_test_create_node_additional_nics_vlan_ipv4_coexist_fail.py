...
def test_create_node_additional_nics_vlan_ipv4_coexist_fail(self):
    ...
    nic1 = DimensionDataNic(private_ip_v4='10.1.1.1', vlan='fake_vlan', network_adapter_name='v1000')
    nic2 = DimensionDataNic(private_ip_v4='10.1.1.2', vlan='fake_vlan2', network_adapter_name='v1000')
