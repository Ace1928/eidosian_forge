...
def _maybe_in_subresource_crazy_items(in_value: Set[str]=frozenset(), in_subvalues: Set[str]=frozenset(), in_subarray: Set[str]=frozenset()):
    ...
    def maybe_in_subresource(segments: Sequence[int | str], resolver: _Resolver[Any], subresource: Resource[Any]) -> _Resolver[Any]:
        ...
        for segment in _segments:
            if segment == 'items' and isinstance(subresource.contents, Mapping):
