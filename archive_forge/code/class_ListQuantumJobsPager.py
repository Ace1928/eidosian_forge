...
class ListQuantumJobsPager:
    ...
    def __init__(self, method: Callable[..., engine.ListQuantumJobsResponse], request: engine.ListQuantumJobsRequest, response: engine.ListQuantumJobsResponse, *, metadata: Sequence[Tuple[str, str]]=()):
