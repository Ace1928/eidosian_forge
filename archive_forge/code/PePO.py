...
from openai.types.beta.threads import (
    ...
    TextDelta,
    TextDeltaBlock,
)  # Types for Open AI Beta API Threads Messages and Annotations
...
)  # Types for Open AI Beta API Threads Run Steps
from openai.types.beta.threads import (
    RequiredActionFunctionToolCall,
    Run,
)  # Types for Open AI Beta API Threads
