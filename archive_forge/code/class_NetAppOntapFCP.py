...
class NetAppOntapFCP:
    ...
    def __init__(self):
        ...
        self.argument_spec.update(dict(state=dict(required=False, type='str', choices=['present', 'absent'], default='present'), vserver=dict(required=True, type='str'), status=dict(required=False, type='str', choices=['up', 'down'], default='up')))
    ...
    def get_fcp_rest(self):
        options = {'fields': 'enabled,svm.uuid', 'svm.name': self.parameters['vserver']}
