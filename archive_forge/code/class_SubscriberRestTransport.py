...
class SubscriberRestTransport(SubscriberTransport):
    ...
    class _Acknowledge(SubscriberRestStub):
        ...
        def __call__(self, request: pubsub.AcknowledgeRequest, *, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Optional[float]=None, metadata: Sequence[Tuple[str, str]]=()):
            """Call the acknowledge method over HTTP.
            ...
            """
            http_options: List[Dict[str, str]] = [{'method': 'post', 'uri': '/v1/{subscription=projects/*/subscriptions/*}:acknowledge', 'body': '*'}]
    ...
    class _CreateSnapshot(SubscriberRestStub):
        ...
        def __call__(self, request: pubsub.CreateSnapshotRequest, *, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Optional[float]=None, metadata: Sequence[Tuple[str, str]]=()) -> pubsub.Snapshot:
            """Call the create snapshot method over HTTP.
            ...
            """
            http_options: List[Dict[str, str]] = [{'method': 'put', 'uri': '/v1/{name=projects/*/snapshots/*}', 'body': '*'}]
    ...
    class _CreateSubscription(SubscriberRestStub):
        ...
        def __call__(self, request: pubsub.Subscription, *, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Optional[float]=None, metadata: Sequence[Tuple[str, str]]=()) -> pubsub.Subscription:
            """Call the create subscription method over HTTP.
            ...
            """
            http_options: List[Dict[str, str]] = [{'method': 'put', 'uri': '/v1/{name=projects/*/subscriptions/*}', 'body': '*'}]
    ...
    class _DeleteSnapshot(SubscriberRestStub):
        ...
        def __call__(self, request: pubsub.DeleteSnapshotRequest, *, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Optional[float]=None, metadata: Sequence[Tuple[str, str]]=()):
            """Call the delete snapshot method over HTTP.
            ...
            Args:
                ...
                metadata (Sequence[Tuple[str, str]]): Strings which should be
                    sent along with the request as metadata.
            """
            http_options: List[Dict[str, str]] = [{'method': 'delete', 'uri': '/v1/{snapshot=projects/*/snapshots/*}'}]
    ...
    class _DeleteSubscription(SubscriberRestStub):
        ...
        def __call__(self, request: pubsub.DeleteSubscriptionRequest, *, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Optional[float]=None, metadata: Sequence[Tuple[str, str]]=()):
            """Call the delete subscription method over HTTP.
            ...
            Args:
                ...
                metadata (Sequence[Tuple[str, str]]): Strings which should be
                    sent along with the request as metadata.
            """
            http_options: List[Dict[str, str]] = [{'method': 'delete', 'uri': '/v1/{subscription=projects/*/subscriptions/*}'}]
    ...
    class _GetSnapshot(SubscriberRestStub):
        ...
        def __call__(self, request: pubsub.GetSnapshotRequest, *, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Optional[float]=None, metadata: Sequence[Tuple[str, str]]=()) -> pubsub.Snapshot:
            """Call the get snapshot method over HTTP.
            ...
            """
            http_options: List[Dict[str, str]] = [{'method': 'get', 'uri': '/v1/{snapshot=projects/*/snapshots/*}'}]
    ...
    class _GetSubscription(SubscriberRestStub):
        ...
        def __call__(self, request: pubsub.GetSubscriptionRequest, *, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Optional[float]=None, metadata: Sequence[Tuple[str, str]]=()) -> pubsub.Subscription:
            """Call the get subscription method over HTTP.
            ...
            """
            http_options: List[Dict[str, str]] = [{'method': 'get', 'uri': '/v1/{subscription=projects/*/subscriptions/*}'}]
    ...
    class _ListSnapshots(SubscriberRestStub):
        ...
        def __call__(self, request: pubsub.ListSnapshotsRequest, *, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Optional[float]=None, metadata: Sequence[Tuple[str, str]]=()) -> pubsub.ListSnapshotsResponse:
            """Call the list snapshots method over HTTP.
            ...
            """
            http_options: List[Dict[str, str]] = [{'method': 'get', 'uri': '/v1/{project=projects/*}/snapshots'}]
    ...
    class _ListSubscriptions(SubscriberRestStub):
        ...
        def __call__(self, request: pubsub.ListSubscriptionsRequest, *, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Optional[float]=None, metadata: Sequence[Tuple[str, str]]=()) -> pubsub.ListSubscriptionsResponse:
            """Call the list subscriptions method over HTTP.
            ...
            """
            http_options: List[Dict[str, str]] = [{'method': 'get', 'uri': '/v1/{project=projects/*}/subscriptions'}]
    ...
    class _ModifyAckDeadline(SubscriberRestStub):
        ...
        def __call__(self, request: pubsub.ModifyAckDeadlineRequest, *, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Optional[float]=None, metadata: Sequence[Tuple[str, str]]=()):
            """Call the modify ack deadline method over HTTP.
            ...
            Args:
                ...
                metadata (Sequence[Tuple[str, str]]): Strings which should be
                    sent along with the request as metadata.
            """
            http_options: List[Dict[str, str]] = [{'method': 'post', 'uri': '/v1/{subscription=projects/*/subscriptions/*}:modifyAckDeadline', 'body': '*'}]
    ...
    class _ModifyPushConfig(SubscriberRestStub):
        ...
        def __call__(self, request: pubsub.ModifyPushConfigRequest, *, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Optional[float]=None, metadata: Sequence[Tuple[str, str]]=()):
            """Call the modify push config method over HTTP.
            ...
            Args:
                ...
                metadata (Sequence[Tuple[str, str]]): Strings which should be
                    sent along with the request as metadata.
            """
            http_options: List[Dict[str, str]] = [{'method': 'post', 'uri': '/v1/{subscription=projects/*/subscriptions/*}:modifyPushConfig', 'body': '*'}]
    ...
    class _Pull(SubscriberRestStub):
        ...
        def __call__(self, request: pubsub.PullRequest, *, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Optional[float]=None, metadata: Sequence[Tuple[str, str]]=()) -> pubsub.PullResponse:
            """Call the pull method over HTTP.
            ...
            """
            http_options: List[Dict[str, str]] = [{'method': 'post', 'uri': '/v1/{subscription=projects/*/subscriptions/*}:pull', 'body': '*'}]
    ...
    class _Seek(SubscriberRestStub):
        ...
        def __call__(self, request: pubsub.SeekRequest, *, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Optional[float]=None, metadata: Sequence[Tuple[str, str]]=()) -> pubsub.SeekResponse:
            """Call the seek method over HTTP.
            ...
            """
            http_options: List[Dict[str, str]] = [{'method': 'post', 'uri': '/v1/{subscription=projects/*/subscriptions/*}:seek', 'body': '*'}]
    ...
    class _StreamingPull(SubscriberRestStub):
        ...
        def __call__(self, request: pubsub.StreamingPullRequest, *, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Optional[float]=None, metadata: Sequence[Tuple[str, str]]=()) -> rest_streaming.ResponseIterator:
            raise NotImplementedError('Method StreamingPull is not available over REST transport')
    ...
    class _UpdateSnapshot(SubscriberRestStub):
        ...
        def __call__(self, request: pubsub.UpdateSnapshotRequest, *, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Optional[float]=None, metadata: Sequence[Tuple[str, str]]=()) -> pubsub.Snapshot:
            """Call the update snapshot method over HTTP.
            ...
            """
            http_options: List[Dict[str, str]] = [{'method': 'patch', 'uri': '/v1/{snapshot.name=projects/*/snapshots/*}', 'body': '*'}]
