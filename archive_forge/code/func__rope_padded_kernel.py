...
@triton.jit
def _rope_padded_kernel(xq, xk, xv, out_q, cache_k, cache_v, seqstartq, seqstartk, seqlenk, theta, k_start: tl.constexpr, v_start: tl.constexpr, n_groups, dim: tl.constexpr, stride_xqM, stride_xqG, stride_xqH, stride_xkM, stride_xkG, stride_xkH, stride_xvM, stride_xvG, stride_xvH, stride_cachekM, stride_cachekG, stride_cachekH, stride_cachevM, stride_cachevG, stride_cachevH, stride_seqstartq, stride_seqstartk, stride_seqlenk, stride_outqM, stride_outqG, stride_outqH, internal_dtype: tl.constexpr, const_batch_strides: tl.constexpr, cache_padding_length, seqlenk_shift: tl.constexpr, BLOCK_SIZE: tl.constexpr, adjacents: tl.constexpr):
    """
