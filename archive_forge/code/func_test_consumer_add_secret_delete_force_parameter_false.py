...
def test_consumer_add_secret_delete_force_parameter_false(self):
    ...
    e = self.assertRaises(ValueError, self.key_mgr.delete, self.ctxt, stored_id, False)
    self.assertIn('Secret has consumers! Remove them first or use the force parameter to delete it.', str(e))