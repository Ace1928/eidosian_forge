...
class StatefulProperty(Generic[SchemaType], ABC):
    ...
    def __init__(self, cache_key: str, serializer: Optional[str]='json', serializer_kwargs: Optional[Dict[str, Any]]=None, **kwargs):
        """
        Initializes the Stateful Property
        """
        self.cache_key = cache_key
        self._pdict: Optional['PersistentDict'] = None
        self._pdict_kwargs: Dict[str, Any] = {'serializer': serializer, 'serializer_kwargs': serializer_kwargs, **kwargs}
