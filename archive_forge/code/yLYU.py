...
class Menu:
    def __init__(self, game: "Game") -> None:
        ...
        logging.debug(
            "Menu class initialized with mid_size: {}, run_display: {}, cursor_rect: {}, offset: {}, title_size: {}, option_size: {}.".format(
                self.mid_size,
                self.run_display,
                self.cursor_rect,
                self.offset,
    ...
    def draw_cursor(self) -> None:
        ...
        try:
            ...
            logging.debug(
                "Cursor drawn at position: ({}, {}).".format(
...
class MainMenu(Menu):
    def __init__(self, game: "Game") -> None:
        ...
        logging.debug(
            "MainMenu class initialized with state: {}, cursor colors set, and cursor positions defined."
        )
    ...
    def check_input(self) -> None:
        ...
        try:
            ...
            logging.error("Failed to check input: {}".format(e), exc_info=True)
            raise RuntimeError("Checking input failed.") from e
