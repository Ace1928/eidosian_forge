...
class PipelineAI(LLM, BaseModel):
    ...
    def build_extra(cls, values: Dict[str, Any]) -> Dict[str, Any]:
        ...
        for field_name in list(values):
            if field_name not in all_required_field_names:
                ...
                logger.warning(f'{field_name} was transferred to pipeline_kwargs.\n                    Please confirm that {field_name} is what you intended.')
    ...
    def _identifying_params(self) -> Mapping[str, Any]:
        ...
        return {**{'pipeline_key': self.pipeline_key}, **{'pipeline_kwargs': self.pipeline_kwargs}}
    ...
    def _call(self, prompt: str, stop: Optional[List[str]]=None, run_manager: Optional[CallbackManagerForLLMRun]=None, **kwargs: Any) -> str:
        ...
        try:
            ...
            raise ImportError('Could not import pipeline-ai python package. Please install it with `pip install pipeline-ai`.')
        ...
        try:
            ...
            raise AttributeError(f'A pipeline run should have a `result_preview` attribute.Run was: {run}')
        if stop is not None:
