...
class AndroidArgsManager(object):
    ...
    def __init__(self, catalog_mgr=None, typed_arg_rules=None, shared_arg_rules=None):
    ...
    """
        ...
        arg_validate.NormalizeAndValidateDirectoriesToPullList(args.directories_to_pull)
