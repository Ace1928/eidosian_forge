...
class RestStore(BaseRestStore):
    ...
    def create_registered_model(self, name, tags=None, description=None):
        ...
        req_body = message_to_json(CreateRegisteredModel(name=name, tags=proto_tags, description=description))
    ...
    def search_registered_models(self, filter_string=None, max_results=None, order_by=None, page_token=None):
        ...
        """
        req_body = message_to_json(SearchRegisteredModels(filter=filter_string, max_results=max_results, order_by=order_by, page_token=page_token))
        response_proto = self._call_endpoint(SearchRegisteredModels, req_body)
        registered_models = [RegisteredModel.from_proto(registered_model) for registered_model in response_proto.registered_models]
    ...
    def get_latest_versions(self, name, stages=None):
        ...
        return [ModelVersion.from_proto(model_version) for model_version in response_proto.model_versions]
    ...
    def create_model_version(self, name, source, run_id=None, tags=None, run_link=None, description=None, local_model_path=None):
        ...
        """
        proto_tags = [tag.to_proto() for tag in tags or []]
        req_body = message_to_json(CreateModelVersion(name=name, source=source, run_id=run_id, run_link=run_link, tags=proto_tags, description=description))
    ...
    def transition_model_version_stage(self, name, version, stage, archive_existing_versions):
        ...
        """
        req_body = message_to_json(TransitionModelVersionStage(name=name, version=str(version), stage=stage, archive_existing_versions=archive_existing_versions))
    ...
    def update_model_version(self, name, version, description):
        ...
        """
        req_body = message_to_json(UpdateModelVersion(name=name, version=str(version), description=description))
    ...
    def search_model_versions(self, filter_string=None, max_results=None, order_by=None, page_token=None):
        ...
        """
        req_body = message_to_json(SearchModelVersions(filter=filter_string, max_results=max_results, order_by=order_by, page_token=page_token))
    ...
    def set_model_version_tag(self, name, version, tag):
        ...
        Returns:
            None
        """
        req_body = message_to_json(SetModelVersionTag(name=name, version=version, key=tag.key, value=tag.value))
