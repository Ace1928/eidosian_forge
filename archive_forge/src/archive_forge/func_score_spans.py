...
@staticmethod
def score_spans(examples: Iterable[Example], attr: str, *, getter: Callable[[Doc, str], Iterable[Span]]=getattr, has_annotation: Optional[Callable[[Doc], bool]]=None, labeled: bool=True, allow_overlap: bool=False, **cfg) -> Dict[str, Any]:
    ...
    for example in examples:
        ...
        if has_annotation is None or (has_annotation is not None and has_annotation(pred_doc)):
    ...
    final_scores: Dict[str, Any] = {f'{attr}_p': None, f'{attr}_r': None, f'{attr}_f': None}
    if labeled:
