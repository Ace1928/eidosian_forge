...
class GetOAuthUserResponse(ProtocolBuffer.ProtocolMessage):
    ...
    def Equals(self, x):
        ...
        if self.has_user_organization_ != x.has_user_organization_:
            return 0
        if self.has_user_organization_ and self.user_organization_ != x.user_organization_:
            return 0
    ...
    _TEXT = _BuildTagLookupTable({0: 'ErrorCode', 1: 'email', 2: 'user_id', 3: 'auth_domain', 4: 'user_organization', 5: 'is_admin', 6: 'client_id', 7: 'scopes', 8: 'is_project_writer'}, 8)
    _TYPES = _BuildTagLookupTable({0: ProtocolBuffer.Encoder.NUMERIC, 1: ProtocolBuffer.Encoder.STRING, 2: ProtocolBuffer.Encoder.STRING, 3: ProtocolBuffer.Encoder.STRING, 4: ProtocolBuffer.Encoder.STRING, 5: ProtocolBuffer.Encoder.NUMERIC, 6: ProtocolBuffer.Encoder.STRING, 7: ProtocolBuffer.Encoder.STRING, 8: ProtocolBuffer.Encoder.NUMERIC}, 8, ProtocolBuffer.Encoder.MAX_TYPE)
    _STYLE = ''
    _STYLE_CONTENT_TYPE = ''
