...
class wsgify(object):
    ...
    * Raise an exception from :mod:`webob.exc`
    ...
    def __init__(self, func=None, RequestClass=None, args=(), kwargs=None, middleware_wraps=None):
        self.func = func
    ...
    def __call__(self, req, *args, **kw):
        ...
        if isinstance(req, dict):
            if len(args) != 1 or kw:
                raise TypeError('Calling %r as a WSGI app with the wrong signature' % self.func)
            environ = req
