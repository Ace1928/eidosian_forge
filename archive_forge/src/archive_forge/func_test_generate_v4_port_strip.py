...
def test_generate_v4_port_strip(self):
    ...
    headers = {'Content-type': 'application/x-www-form-urlencoded; charset=utf-8', 'X-Amz-Date': '20110909T233600Z', 'Host': 'foo:8000', 'Authorization': auth_str, 'User-Agent': 'Boto/2.9.2 (linux2)'}
    params = {}
    credentials = {'host': 'foo:8000', 'verb': 'POST', 'path': '/', 'params': params, 'headers': headers, 'body_hash': body_hash}
    signature = signer.generate(credentials)
    expected = '9a4b2276a5039ada3b90f72ea8ec174514b92b909fb106b22ad910c5d75a54f4'
