...
class ShareNetworkSubnetsReadWriteTest(base.BaseTestCase):
    ...
    def setUp(self):
        ...
        self.sn = self.create_share_network(name=self.name, description=self.description, neutron_net_id=self.neutron_net_id, neutron_subnet_id=self.neutron_subnet_id)
