...
class Lemmatizer(Pipe):
    ...
    def __init__(self, vocab: Vocab, model: Optional[Model], name: str='lemmatizer', *, mode: str='lookup', overwrite: bool=False, scorer: Optional[Callable]=lemmatizer_score) -> None:
    ...
    def initialize(self, get_examples: Optional[Callable[[], Iterable[Example]]]=None, *, nlp: Optional[Language]=None, lookups: Optional[Lookups]=None):
        ...
        if lookups is None:
            ...
            optional_lookups = load_lookups(lang=self.vocab.lang, tables=optional_tables, strict=False)
    ...
    def to_disk(self, path: Union[str, Path], *, exclude: Iterable[str]=SimpleFrozenList()):
    ...
    def from_disk(self, path: Union[str, Path], *, exclude: Iterable[str]=SimpleFrozenList()) -> 'Lemmatizer':
    ...
    def from_bytes(self, bytes_data: bytes, *, exclude: Iterable[str]=SimpleFrozenList()) -> 'Lemmatizer':
