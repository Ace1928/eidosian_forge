...
class XAS(Spectrum):
    ...
    def __init__(self, x, y, structure, absorbing_element, edge='K', spectrum_type='XANES', absorbing_index=None):
    ...
    def __str__(self):
        return f'{self.absorbing_element} {self.edge} Edge {self.spectrum_type} for {self.structure.reduced_formula}: {super()}'
