...
def connection_info(self):
    ...
    return {'num_clients': data.num_clients, 'python_version': data.python_version, 'ray_version': data.ray_version, 'ray_commit': data.ray_commit, 'protocol_version': data.protocol_version}