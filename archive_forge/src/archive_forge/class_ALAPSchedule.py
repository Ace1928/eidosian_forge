...
class ALAPSchedule(BaseSchedulerTransform):
    ...
    @deprecate_func(additional_msg='Instead, use :class:`~.ALAPScheduleAnalysis`, which is an analysis pass that requires a padding pass to later modify the circuit.', since='0.21.0', pending=True)
