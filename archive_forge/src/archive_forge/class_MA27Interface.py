...
class MA27Interface(object):
    ...
    def __init__(self, iw_factor=None, a_factor=None):
        ...
        self.lib.do_numeric_factorization.argtypes = [ctypes.c_void_p, ctypes.c_int, ctypes.c_int, array_1d_int, array_1d_int, array_1d_double]
    ...
    def do_numeric_factorization(self, irn, icn, dim, entries):
        ...
        ne = ent.size
        assert dim == self._dim_cached, 'Dimension mismatch between symbolic and numeric factorization.Please re-run symbolic factorization with the correct dimension.'
    ...
    def do_backsolve(self, rhs, copy=True):
        ...
        rhs_dim = rhs.size
        assert rhs_dim == self._dim_cached, 'Dimension mismatch in right hand side. Please correct.'
