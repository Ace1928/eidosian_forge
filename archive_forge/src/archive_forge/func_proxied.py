...
def proxied(obj_cls: Optional[ProxyObjT]=None, obj_getter: Optional[Union[Callable, str]]=None, obj_args: Optional[List[Any]]=None, obj_kwargs: Optional[Dict[str, Any]]=None, obj_initialize: Optional[bool]=True, threadsafe: Optional[bool]=True) -> Union[Callable[..., Union[ObjT, ProxyObjT]], Union[ObjT, ProxyObjT]]:
    """
    ...
    if obj_cls is not None:
        return ProxyObject(obj_cls=obj_cls, obj_getter=obj_getter, obj_args=obj_args, obj_kwargs=obj_kwargs, obj_initialize=obj_initialize, threadsafe=threadsafe)
