...
class SLBLoadBalancerUdpListenerTestCase(unittest.TestCase, AssertDictMixin):
    ...
    def setUp(self):
        self.listener = SLBLoadBalancerUdpListener.create(80, 8080, Algorithm.WEIGHTED_ROUND_ROBIN, 1, extra={'PersistenceTimeout': 0})

    def test_get_required_params(self):
        expected = {'Action': 'CreateLoadBalancerUDPListener', 'ListenerPort': 80, 'BackendServerPort': 8080, 'Scheduler': 'wrr', 'Bandwidth': 1}
