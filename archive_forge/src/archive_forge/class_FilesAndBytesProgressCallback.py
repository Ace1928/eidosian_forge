...
class FilesAndBytesProgressCallback:
  ...
  """
    ...
    def __init__(self, status_queue, offset, length, source_url, destination_url=None, component_number=None, total_components=None, operation_name=None, process_id=None, thread_id=None):
    ...
    """
        ...
        self._status_queue.put(thread_messages.DetailedProgressMessage(offset=self._offset, length=self._length, current_byte=current_byte, time=current_time, source_url=self._source_url, destination_url=self._destination_url, component_number=self._component_number, total_components=self._total_components, operation_name=self._operation_name, process_id=self._process_id, thread_id=self._thread_id))