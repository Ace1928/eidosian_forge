...
class PrintExporter(Exporter):
    ...
    def __init__(self, item):
        ...
        self.params = Parameter.create(name='params', type='group', children=[{'name': 'width', 'title': translate('Exporter', 'width'), 'type': 'float', 'value': 0.1, 'limits': (0, None), 'suffix': 'm', 'siPrefix': True}, {'name': 'height', 'title': translate('Exporter', 'height'), 'type': 'float', 'value': 0.1 * tr.height() / tr.width(), 'limits': (0, None), 'suffix': 'm', 'siPrefix': True}])
