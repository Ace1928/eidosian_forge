...
class FileContentsManager(FileManagerMixin, ContentsManager):
    ...
    def _default_preferred_dir(self):
        ...
        try:
            ...
            if value is not None:
                warnings.warn('ServerApp.preferred_dir config is deprecated in jupyter-server 2.0. Use FileContentsManager.preferred_dir instead', FutureWarning, stacklevel=3)
                try:
                    path = Path(value)
    ...
    def copy(self, from_path, to_path=None):
        ...
        return self._copy_dir(from_path=from_path, to_path_original=to_path_original, to_name=to_name, to_path=to_path)
    ...
    def _copy_dir(self, from_path, to_path_original, to_name, to_path):
        ...
        try:
            ...
            raise web.HTTPError(400, f"Can't copy '{from_path}' into Folder '{to_path}'") from err
        return model
