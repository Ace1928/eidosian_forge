...
class DevicesLiveToolsPingDevice(object):
    ...
    def __init__(self, params, meraki):
        self.meraki = meraki
        self.new_object = dict(count=params.get('count'), serial=params.get('serial'), id=params.get('id'))
    ...
    def get_object_by_id(self, id):
        result = None
        try:
            items = self.meraki.exec_meraki(family='devices', function='getDeviceLiveToolsPingDevice', params={'id': id})
    ...
    def requires_update(self, current_obj):
        ...
        obj_params = [('count', 'count'), ('serial', 'serial'), ('id', 'id')]
    ...
    def create(self):
        result = self.meraki.exec_meraki(family='devices', function='createDeviceLiveToolsPingDevice', params=self.create_params(), op_modifies=True)
        return result