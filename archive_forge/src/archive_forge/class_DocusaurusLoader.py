...
class DocusaurusLoader(SitemapLoader):
    ...
    def __init__(self, url: str, custom_html_tags: Optional[List[str]]=None, **kwargs: Any):
        ...
        super().__init__(url, parsing_function=kwargs.get('parsing_function') or self._parsing_function, **kwargs)
