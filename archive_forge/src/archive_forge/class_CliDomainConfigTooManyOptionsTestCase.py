...
class CliDomainConfigTooManyOptionsTestCase(CliDomainConfigAllTestCase):
    ...
    def config(self, config_files):
        CONF(args=['domain_config_upload', '--all', '--domain-name', 'Default'], project='keystone', default_config_files=config_files)
    ...
    def test_config_upload(self):
        ...
        with mock.patch('builtins.print') as mock_print:
            ...
            mock_print.assert_has_calls([mock.call(_('The --all option cannot be used with the --domain-name option'))])