...
@TransformationFactory.register('contrib.piecewise.convex_combination', doc="Convert piecewise-linear model to a GDP to 'Convex Combination' MIP formulation.")
class ConvexCombinationTransformation(Transformation):
    ...
    def _apply_to(self, instance, **kwds):
        TransformationFactory('contrib.piecewise.reduced_inner_repn_gdp').apply_to(instance)
        TransformationFactory('gdp.mbigm').apply_to(instance, reduce_bound_constraints=True)