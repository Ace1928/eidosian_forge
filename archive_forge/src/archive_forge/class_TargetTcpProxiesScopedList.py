...
class TargetTcpProxiesScopedList(_messages.Message):
    """A TargetTcpProxiesScopedList object.
  ...
  """
    ...
    targetTcpProxies = _messages.MessageField('TargetTcpProxy', 1, repeated=True)
