...
class V1beta1RuntimeClass(object):
    ...
    swagger_types = {'api_version': 'str', 'handler': 'str', 'kind': 'str', 'metadata': 'V1ObjectMeta'}
    attribute_map = {'api_version': 'apiVersion', 'handler': 'handler', 'kind': 'kind', 'metadata': 'metadata'}
