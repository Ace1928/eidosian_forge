...
class DatabaseManager:
    """
    Manages database operations, encapsulating connection handling and transaction management.
    This class serves as a foundational component for database interactions, ensuring robust and reusable database connectivity.
    """

    def __init__(self, database_path: str):
        """
        Constructs a DatabaseManager instance with a specified path to the SQLite database.
    ...
    def __enter__(self) -> "DatabaseManager":
        """
        Establishes a database connection upon entering the runtime context.

        Returns:
        - DatabaseManager: The instance with an active database connection.
        """
    ...
    def __exit__(self, exc_type: type, exc_val: Exception, exc_tb: type) -> None:
        """
        Terminates the database connection upon exiting the runtime context.

        Parameters:
        - exc_type (type): The type of the exception.
        - exc_val (Exception): The exception instance.
        - exc_tb (type): The traceback object.
        """
        if self.connection:
    ...
    def commit_changes(self) -> None:
        ...
        This method ensures that all changes made during the transaction are saved.
        """
        if self.connection:
