...
class ListenFDsTests(SynchronousTestCase):
    ...
    def test_repeated(self, descriptors: Sequence[int]) -> None:
        ...
        self.assertEqual(sddaemon.inheritedDescriptors(), sddaemon.inheritedDescriptors())
        self.assertEqual(sddaemon.inheritedNamedDescriptors(), sddaemon.inheritedNamedDescriptors())