...
class _PyDevCommandProcessor(object):
    ...
    def cmd_get_smart_step_into_variants(self, py_db, cmd_id, seq, text):
        ...
        py_db.post_method_as_internal_command(thread_id, internal_get_smart_step_into_variants, seq, thread_id, frame_id, start_line, end_line, set_additional_thread_info=set_additional_thread_info)
