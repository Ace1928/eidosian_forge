...
def test_get_flavor_extra_specs_prop(self):
    self._verify('openstack.compute.v2.flavor.Flavor.get_extra_specs_property', self.proxy.get_flavor_extra_specs_property, method_args=['value', 'prop'], expected_args=[self.proxy, 'prop'])