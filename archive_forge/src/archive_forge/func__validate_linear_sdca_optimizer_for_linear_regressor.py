...
def _validate_linear_sdca_optimizer_for_linear_regressor(feature_columns, label_dimension, optimizer, sparse_combiner):
    ...
    if isinstance(optimizer, LinearSDCA):
        ...
        if label_dimension > 1:
            raise ValueError('LinearSDCA can only be used with one-dimensional label.')