...
class Bgp_af(ConfigBase):
    ...
    advertise_attrs_map = {'advertise_pip': 'advertise-pip', 'advertise_pip_ip': 'advertise-pip-ip', 'advertise_pip_peer_ip': 'advertise-pip-peer-ip', 'advertise_svi_ip': 'advertise-svi-ip', 'advertise_default_gw': 'advertise-default-gw', 'advertise_all_vni': 'advertise-all-vni', 'rd': 'route-distinguisher', 'rt_in': 'import-rts', 'rt_out': 'export-rts'}
    non_list_advertise_attrs = ('advertise_pip', 'advertise_pip_ip', 'advertise_pip_peer_ip', 'advertise_svi_ip', 'advertise_default_gw', 'advertise_all_vni', 'rd')
