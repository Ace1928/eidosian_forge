...
class WrappedMessage(Message):
    ...
    def __init__(self, pb: PubsubMessage.meta.pb, ack_id: AckId, ack_handler: Callable[[AckId, bool], None]):
    ...
    def drop(self):
        logging.warning('Likely incorrect call to drop() on Pub/Sub Lite message. Pub/Sub Lite does not support redelivery in this way.')
