...
class CloudbillingV1(base_api.BaseApiClient):
    ...
    class BillingAccountsProjectsService(base_api.BaseApiService):
      ...
      """
        ...
        List.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1/billingAccounts/{billingAccountsId}/projects', http_method='GET', method_id='cloudbilling.billingAccounts.projects.list', ordered_params=['name'], path_params=['name'], query_params=['pageSize', 'pageToken'], relative_path='v1/{+name}/projects', request_field='', request_type_name='CloudbillingBillingAccountsProjectsListRequest', response_type_name='ListProjectBillingInfoResponse', supports_download=False)
    ...
    class BillingAccountsService(base_api.BaseApiService):
      ...
      """
            config = self.GetMethodConfig('Create')
            return self._RunMethod(config, request, global_params=global_params)
        Create.method_config = lambda: base_api.ApiMethodInfo(http_method='POST', method_id='cloudbilling.billingAccounts.create', ordered_params=[], path_params=[], query_params=['parent'], relative_path='v1/billingAccounts', request_field='billingAccount', request_type_name='CloudbillingBillingAccountsCreateRequest', response_type_name='BillingAccount', supports_download=False)
      ...
      """
            ...
            return self._RunMethod(config, request, global_params=global_params)
        Get.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1/billingAccounts/{billingAccountsId}', http_method='GET', method_id='cloudbilling.billingAccounts.get', ordered_params=['name'], path_params=['name'], query_params=[], relative_path='v1/{+name}', request_field='', request_type_name='CloudbillingBillingAccountsGetRequest', response_type_name='BillingAccount', supports_download=False)
      ...
      """
            ...
            return self._RunMethod(config, request, global_params=global_params)
        GetIamPolicy.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1/billingAccounts/{billingAccountsId}:getIamPolicy', http_method='GET', method_id='cloudbilling.billingAccounts.getIamPolicy', ordered_params=['resource'], path_params=['resource'], query_params=['options_requestedPolicyVersion'], relative_path='v1/{+resource}:getIamPolicy', request_field='', request_type_name='CloudbillingBillingAccountsGetIamPolicyRequest', response_type_name='Policy', supports_download=False)
      ...
      """
            config = self.GetMethodConfig('List')
            return self._RunMethod(config, request, global_params=global_params)
        List.method_config = lambda: base_api.ApiMethodInfo(http_method='GET', method_id='cloudbilling.billingAccounts.list', ordered_params=[], path_params=[], query_params=['filter', 'pageSize', 'pageToken', 'parent'], relative_path='v1/billingAccounts', request_field='', request_type_name='CloudbillingBillingAccountsListRequest', response_type_name='ListBillingAccountsResponse', supports_download=False)
      ...
      """
            ...
            return self._RunMethod(config, request, global_params=global_params)
        Move.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1/billingAccounts/{billingAccountsId}:move', http_method='POST', method_id='cloudbilling.billingAccounts.move', ordered_params=['name'], path_params=['name'], query_params=[], relative_path='v1/{+name}:move', request_field='moveBillingAccountRequest', request_type_name='CloudbillingBillingAccountsMoveRequest', response_type_name='BillingAccount', supports_download=False)
      ...
      """
            ...
            return self._RunMethod(config, request, global_params=global_params)
        Patch.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1/billingAccounts/{billingAccountsId}', http_method='PATCH', method_id='cloudbilling.billingAccounts.patch', ordered_params=['name'], path_params=['name'], query_params=['updateMask'], relative_path='v1/{+name}', request_field='billingAccount', request_type_name='CloudbillingBillingAccountsPatchRequest', response_type_name='BillingAccount', supports_download=False)
      ...
      """
            ...
            return self._RunMethod(config, request, global_params=global_params)
        SetIamPolicy.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1/billingAccounts/{billingAccountsId}:setIamPolicy', http_method='POST', method_id='cloudbilling.billingAccounts.setIamPolicy', ordered_params=['resource'], path_params=['resource'], query_params=[], relative_path='v1/{+resource}:setIamPolicy', request_field='setIamPolicyRequest', request_type_name='CloudbillingBillingAccountsSetIamPolicyRequest', response_type_name='Policy', supports_download=False)
      ...
      """
            ...
            return self._RunMethod(config, request, global_params=global_params)
        TestIamPermissions.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1/billingAccounts/{billingAccountsId}:testIamPermissions', http_method='POST', method_id='cloudbilling.billingAccounts.testIamPermissions', ordered_params=['resource'], path_params=['resource'], query_params=[], relative_path='v1/{+resource}:testIamPermissions', request_field='testIamPermissionsRequest', request_type_name='CloudbillingBillingAccountsTestIamPermissionsRequest', response_type_name='TestIamPermissionsResponse', supports_download=False)
    ...
    class OrganizationsBillingAccountsService(base_api.BaseApiService):
      ...
      """
            config = self.GetMethodConfig('Create')
            return self._RunMethod(config, request, global_params=global_params)
        Create.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1/organizations/{organizationsId}/billingAccounts', http_method='POST', method_id='cloudbilling.organizations.billingAccounts.create', ordered_params=['parent'], path_params=['parent'], query_params=[], relative_path='v1/{+parent}/billingAccounts', request_field='<request>', request_type_name='BillingAccount', response_type_name='BillingAccount', supports_download=False)
      ...
      """
            config = self.GetMethodConfig('List')
            return self._RunMethod(config, request, global_params=global_params)
        List.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1/organizations/{organizationsId}/billingAccounts', http_method='GET', method_id='cloudbilling.organizations.billingAccounts.list', ordered_params=['parent'], path_params=['parent'], query_params=['filter', 'pageSize', 'pageToken'], relative_path='v1/{+parent}/billingAccounts', request_field='', request_type_name='CloudbillingOrganizationsBillingAccountsListRequest', response_type_name='ListBillingAccountsResponse', supports_download=False)
      ...
      """
            config = self.GetMethodConfig('Move')
            return self._RunMethod(config, request, global_params=global_params)
        Move.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1/organizations/{organizationsId}/billingAccounts/{billingAccountsId}:move', http_method='GET', method_id='cloudbilling.organizations.billingAccounts.move', ordered_params=['destinationParent', 'name'], path_params=['destinationParent', 'name'], query_params=[], relative_path='v1/{+destinationParent}/{+name}:move', request_field='', request_type_name='CloudbillingOrganizationsBillingAccountsMoveRequest', response_type_name='BillingAccount', supports_download=False)
    ...
    class ProjectsService(base_api.BaseApiService):
      ...
      """
            ...
            return self._RunMethod(config, request, global_params=global_params)
        GetBillingInfo.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1/projects/{projectsId}/billingInfo', http_method='GET', method_id='cloudbilling.projects.getBillingInfo', ordered_params=['name'], path_params=['name'], query_params=[], relative_path='v1/{+name}/billingInfo', request_field='', request_type_name='CloudbillingProjectsGetBillingInfoRequest', response_type_name='ProjectBillingInfo', supports_download=False)
      ...
      """
            ...
            return self._RunMethod(config, request, global_params=global_params)
        UpdateBillingInfo.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1/projects/{projectsId}/billingInfo', http_method='PUT', method_id='cloudbilling.projects.updateBillingInfo', ordered_params=['name'], path_params=['name'], query_params=[], relative_path='v1/{+name}/billingInfo', request_field='projectBillingInfo', request_type_name='CloudbillingProjectsUpdateBillingInfoRequest', response_type_name='ProjectBillingInfo', supports_download=False)
    ...
    class ServicesService(base_api.BaseApiService):
      ...
      """
            config = self.GetMethodConfig('List')
            return self._RunMethod(config, request, global_params=global_params)
        List.method_config = lambda: base_api.ApiMethodInfo(http_method='GET', method_id='cloudbilling.services.list', ordered_params=[], path_params=[], query_params=['pageSize', 'pageToken'], relative_path='v1/services', request_field='', request_type_name='CloudbillingServicesListRequest', response_type_name='ListServicesResponse', supports_download=False)