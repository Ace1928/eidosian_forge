...
class PatchFilePosixTask(task.Task):
    ...
    def __init__(self, system_posix_data, source_resource, destination_resource, known_source_posix=None, known_destination_posix=None):
        """Initializes task.
    ...
    def execute(self, task_status_queue=None):
        ...
        posix_util.set_posix_attributes_on_file_if_valid(self._system_posix_data, self._source_resource, self._destination_resource, known_source_posix=self._known_source_posix, known_destination_posix=self._known_destination_posix)
    ...
    def __eq__(self, other):
        ...
        return self._system_posix_data == other._system_posix_data and self._source_resource == other._source_resource and (self._destination_resource == other._destination_resource) and (self._known_source_posix == other._known_source_posix) and (self._known_destination_posix == other._known_destination_posix)