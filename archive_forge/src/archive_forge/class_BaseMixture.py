...
class BaseMixture(DensityMixin, BaseEstimator, metaclass=ABCMeta):
    ...
    """
    _parameter_constraints: dict = {'n_components': [Interval(Integral, 1, None, closed='left')], 'tol': [Interval(Real, 0.0, None, closed='left')], 'reg_covar': [Interval(Real, 0.0, None, closed='left')], 'max_iter': [Interval(Integral, 0, None, closed='left')], 'n_init': [Interval(Integral, 1, None, closed='left')], 'init_params': [StrOptions({'kmeans', 'random', 'random_from_data', 'k-means++'})], 'random_state': ['random_state'], 'warm_start': ['boolean'], 'verbose': ['verbose'], 'verbose_interval': [Interval(Integral, 1, None, closed='left')]}
