...
class DatabaseOperations(BaseDatabaseOperations):
    ...
    integer_field_ranges = {**BaseDatabaseOperations.integer_field_ranges, 'PositiveSmallIntegerField': (0, 65535), 'PositiveIntegerField': (0, 4294967295), 'PositiveBigIntegerField': (0, 18446744073709551615)}
    cast_data_types = {'AutoField': 'signed integer', 'BigAutoField': 'signed integer', 'SmallAutoField': 'signed integer', 'CharField': 'char(%(max_length)s)', 'DecimalField': 'decimal(%(max_digits)s, %(decimal_places)s)', 'TextField': 'char', 'IntegerField': 'signed integer', 'BigIntegerField': 'signed integer', 'SmallIntegerField': 'signed integer', 'PositiveBigIntegerField': 'unsigned integer', 'PositiveIntegerField': 'unsigned integer', 'PositiveSmallIntegerField': 'unsigned integer', 'DurationField': 'signed integer'}
    cast_char_field_without_max_length = 'char'
    explain_prefix = 'EXPLAIN'
    _extract_format_re = _lazy_re_compile('[A-Z_]+')
    ...
    def lookup_cast(self, lookup_type, internal_type=None):
        ...
        if internal_type == 'JSONField':
            if self.connection.mysql_is_mariadb or lookup_type in ('iexact', 'contains', 'icontains', 'startswith', 'istartswith', 'endswith', 'iendswith', 'regex', 'iregex'):
