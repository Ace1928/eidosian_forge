class ObserverGraph:
    ...
    def __hash__(self):
        ...
        return hash((type(self).__name__, self.node, frozenset(self.children)))
    ...
    def __eq__(self, other):
        ...
        in the comparison.
        """
        return type(self) is type(other) and self.node == other.node and (set(self.children) == set(other.children))
