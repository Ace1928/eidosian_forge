...
def test_parametric_circuit_through_sampler_with_parametric_compilation(parametric_circuit_with_params: Tuple[cirq.Circuit, cirq.Linspace]) -> None:
    ...
    sampler = RigettiQCSSampler(quantum_computer=qc, executor=circuit_sweep_executors.with_quilc_parametric_compilation)
    qvm = cast(QVM, qc.qam)
    qvm.random_seed = 10
    repetitions = 10
