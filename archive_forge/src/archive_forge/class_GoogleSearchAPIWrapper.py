...
@deprecated(since='0.0.33', removal='0.2.0', alternative_import='langchain_google_community.GoogleSearchAPIWrapper')
class GoogleSearchAPIWrapper(BaseModel):
    ...
    def validate_environment(cls, values: Dict) -> Dict:
        ...
        try:
            ...
            raise ImportError('google-api-python-client is not installed. Please install it with `pip install google-api-python-client>=2.100.0`')
