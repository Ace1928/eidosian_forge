...
def test_metadef_resource_types_schema_get(self):
    self._verify('openstack.proxy.Proxy._get', self.proxy.get_metadef_resource_types_schema, expected_args=[_metadef_schema.MetadefSchema], expected_kwargs={'base_path': '/schemas/metadefs/resource_types', 'requires_id': False})