...
class KeystonePassword(password.Password):
    ...
    def __init__(self, password, auth_url=None, username=None, user_id=None, user_domain_id=None, user_domain_name=None, trust_id=None, domain_id=None, domain_name=None, project_id=None, project_name=None, project_domain_id=None, project_domain_name=None, reauthenticate=True):
        ...
        super(KeystonePassword, self).__init__(username, password)
