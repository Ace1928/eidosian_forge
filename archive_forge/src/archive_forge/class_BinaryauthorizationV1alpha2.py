...
class BinaryauthorizationV1alpha2(base_api.BaseApiClient):
    ...
    def __init__(self, url='', credentials=None, get_credentials=True, http=None, model=None, log_request=False, log_response=False, credentials_args=None, default_global_params=None, additional_http_headers=None, response_encoding=None):
        ...
        super(BinaryauthorizationV1alpha2, self).__init__(url, credentials=credentials, get_credentials=get_credentials, http=http, model=model, log_request=log_request, log_response=log_response, credentials_args=credentials_args, default_global_params=default_global_params, additional_http_headers=additional_http_headers, response_encoding=response_encoding)
    ...
    class ProjectsAttestorsService(base_api.BaseApiService):
      ...
      """
            ...
            return self._RunMethod(config, request, global_params=global_params)
        Create.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1alpha2/projects/{projectsId}/attestors', http_method='POST', method_id='binaryauthorization.projects.attestors.create', ordered_params=['parent'], path_params=['parent'], query_params=['attestorId'], relative_path='v1alpha2/{+parent}/attestors', request_field='attestor', request_type_name='BinaryauthorizationProjectsAttestorsCreateRequest', response_type_name='Attestor', supports_download=False)
      ...
      """
            ...
            return self._RunMethod(config, request, global_params=global_params)
        Delete.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1alpha2/projects/{projectsId}/attestors/{attestorsId}', http_method='DELETE', method_id='binaryauthorization.projects.attestors.delete', ordered_params=['name'], path_params=['name'], query_params=[], relative_path='v1alpha2/{+name}', request_field='', request_type_name='BinaryauthorizationProjectsAttestorsDeleteRequest', response_type_name='Empty', supports_download=False)
      ...
      """
            ...
            return self._RunMethod(config, request, global_params=global_params)
        Get.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1alpha2/projects/{projectsId}/attestors/{attestorsId}', http_method='GET', method_id='binaryauthorization.projects.attestors.get', ordered_params=['name'], path_params=['name'], query_params=[], relative_path='v1alpha2/{+name}', request_field='', request_type_name='BinaryauthorizationProjectsAttestorsGetRequest', response_type_name='Attestor', supports_download=False)
      ...
      """
            ...
            return self._RunMethod(config, request, global_params=global_params)
        GetIamPolicy.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1alpha2/projects/{projectsId}/attestors/{attestorsId}:getIamPolicy', http_method='GET', method_id='binaryauthorization.projects.attestors.getIamPolicy', ordered_params=['resource'], path_params=['resource'], query_params=['options_requestedPolicyVersion'], relative_path='v1alpha2/{+resource}:getIamPolicy', request_field='', request_type_name='BinaryauthorizationProjectsAttestorsGetIamPolicyRequest', response_type_name='IamPolicy', supports_download=False)
      ...
      """
            ...
            return self._RunMethod(config, request, global_params=global_params)
        List.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1alpha2/projects/{projectsId}/attestors', http_method='GET', method_id='binaryauthorization.projects.attestors.list', ordered_params=['parent'], path_params=['parent'], query_params=['pageSize', 'pageToken'], relative_path='v1alpha2/{+parent}/attestors', request_field='', request_type_name='BinaryauthorizationProjectsAttestorsListRequest', response_type_name='ListAttestorsResponse', supports_download=False)
      ...
      """
            ...
            return self._RunMethod(config, request, global_params=global_params)
        SetIamPolicy.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1alpha2/projects/{projectsId}/attestors/{attestorsId}:setIamPolicy', http_method='POST', method_id='binaryauthorization.projects.attestors.setIamPolicy', ordered_params=['resource'], path_params=['resource'], query_params=[], relative_path='v1alpha2/{+resource}:setIamPolicy', request_field='setIamPolicyRequest', request_type_name='BinaryauthorizationProjectsAttestorsSetIamPolicyRequest', response_type_name='IamPolicy', supports_download=False)
      ...
      """
            config = self.GetMethodConfig('TestIamPermissions')
            return self._RunMethod(config, request, global_params=global_params)
        TestIamPermissions.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1alpha2/projects/{projectsId}/attestors/{attestorsId}:testIamPermissions', http_method='POST', method_id='binaryauthorization.projects.attestors.testIamPermissions', ordered_params=['resource'], path_params=['resource'], query_params=[], relative_path='v1alpha2/{+resource}:testIamPermissions', request_field='testIamPermissionsRequest', request_type_name='BinaryauthorizationProjectsAttestorsTestIamPermissionsRequest', response_type_name='TestIamPermissionsResponse', supports_download=False)
      ...
      """
            ...
            return self._RunMethod(config, request, global_params=global_params)
        Update.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1alpha2/projects/{projectsId}/attestors/{attestorsId}', http_method='PUT', method_id='binaryauthorization.projects.attestors.update', ordered_params=['name'], path_params=['name'], query_params=[], relative_path='v1alpha2/{+name}', request_field='<request>', request_type_name='Attestor', response_type_name='Attestor', supports_download=False)
      ...
      """
            ...
            return self._RunMethod(config, request, global_params=global_params)
        ValidateAttestationOccurrence.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1alpha2/projects/{projectsId}/attestors/{attestorsId}:validateAttestationOccurrence', http_method='POST', method_id='binaryauthorization.projects.attestors.validateAttestationOccurrence', ordered_params=['attestor'], path_params=['attestor'], query_params=[], relative_path='v1alpha2/{+attestor}:validateAttestationOccurrence', request_field='validateAttestationOccurrenceRequest', request_type_name='BinaryauthorizationProjectsAttestorsValidateAttestationOccurrenceRequest', response_type_name='ValidateAttestationOccurrenceResponse', supports_download=False)
    ...
    class ProjectsContinuousValidationConfigService(base_api.BaseApiService):
      ...
      """
            config = self.GetMethodConfig('GetIamPolicy')
            return self._RunMethod(config, request, global_params=global_params)
        GetIamPolicy.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1alpha2/projects/{projectsId}/continuousValidationConfig:getIamPolicy', http_method='GET', method_id='binaryauthorization.projects.continuousValidationConfig.getIamPolicy', ordered_params=['resource'], path_params=['resource'], query_params=['options_requestedPolicyVersion'], relative_path='v1alpha2/{+resource}:getIamPolicy', request_field='', request_type_name='BinaryauthorizationProjectsContinuousValidationConfigGetIamPolicyRequest', response_type_name='IamPolicy', supports_download=False)
      ...
      """
            config = self.GetMethodConfig('SetIamPolicy')
            return self._RunMethod(config, request, global_params=global_params)
        SetIamPolicy.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1alpha2/projects/{projectsId}/continuousValidationConfig:setIamPolicy', http_method='POST', method_id='binaryauthorization.projects.continuousValidationConfig.setIamPolicy', ordered_params=['resource'], path_params=['resource'], query_params=[], relative_path='v1alpha2/{+resource}:setIamPolicy', request_field='setIamPolicyRequest', request_type_name='BinaryauthorizationProjectsContinuousValidationConfigSetIamPolicyRequest', response_type_name='IamPolicy', supports_download=False)
      ...
      """
            config = self.GetMethodConfig('TestIamPermissions')
            return self._RunMethod(config, request, global_params=global_params)
        TestIamPermissions.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1alpha2/projects/{projectsId}/continuousValidationConfig:testIamPermissions', http_method='POST', method_id='binaryauthorization.projects.continuousValidationConfig.testIamPermissions', ordered_params=['resource'], path_params=['resource'], query_params=[], relative_path='v1alpha2/{+resource}:testIamPermissions', request_field='testIamPermissionsRequest', request_type_name='BinaryauthorizationProjectsContinuousValidationConfigTestIamPermissionsRequest', response_type_name='TestIamPermissionsResponse', supports_download=False)
    ...
    class ProjectsService(base_api.BaseApiService):
      ...
      """
            ...
            return self._RunMethod(config, request, global_params=global_params)
        GetContinuousValidationConfig.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1alpha2/projects/{projectsId}/continuousValidationConfig', http_method='GET', method_id='binaryauthorization.projects.getContinuousValidationConfig', ordered_params=['name'], path_params=['name'], query_params=[], relative_path='v1alpha2/{+name}', request_field='', request_type_name='BinaryauthorizationProjectsGetContinuousValidationConfigRequest', response_type_name='ContinuousValidationConfig', supports_download=False)
      ...
      """
            ...
            return self._RunMethod(config, request, global_params=global_params)
        GetPolicy.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1alpha2/projects/{projectsId}/policy', http_method='GET', method_id='binaryauthorization.projects.getPolicy', ordered_params=['name'], path_params=['name'], query_params=[], relative_path='v1alpha2/{+name}', request_field='', request_type_name='BinaryauthorizationProjectsGetPolicyRequest', response_type_name='Policy', supports_download=False)
      ...
      """
            ...
            return self._RunMethod(config, request, global_params=global_params)
        UpdateContinuousValidationConfig.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1alpha2/projects/{projectsId}/continuousValidationConfig', http_method='PUT', method_id='binaryauthorization.projects.updateContinuousValidationConfig', ordered_params=['name'], path_params=['name'], query_params=[], relative_path='v1alpha2/{+name}', request_field='<request>', request_type_name='ContinuousValidationConfig', response_type_name='ContinuousValidationConfig', supports_download=False)
      ...
      """
            ...
            return self._RunMethod(config, request, global_params=global_params)
        UpdatePolicy.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1alpha2/projects/{projectsId}/policy', http_method='PUT', method_id='binaryauthorization.projects.updatePolicy', ordered_params=['name'], path_params=['name'], query_params=[], relative_path='v1alpha2/{+name}', request_field='<request>', request_type_name='Policy', response_type_name='Policy', supports_download=False)
