...
class TestSolveModel(unittest.TestCase):
    ...
    def test_matching_problem(self):
        ...
        self.assertTrue(value(m.person_name['P6']) == 5 or value(m.person_name['P6']) == 6)
        self.assertTrue(value(m.person_name['P7']) == 5 or value(m.person_name['P7']) == 6)
