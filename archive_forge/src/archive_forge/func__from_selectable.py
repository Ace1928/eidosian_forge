...
def _from_selectable(self, fromclause: FromClause, set_entity_from: bool=True) -> Self:
    for attr in ('_where_criteria', '_order_by_clauses', '_group_by_clauses', '_limit_clause', '_offset_clause', '_last_joined_entity', '_setup_joins', '_memoized_select_entities', '_distinct', '_distinct_on', '_having_criteria', '_prefixes', '_suffixes'):
