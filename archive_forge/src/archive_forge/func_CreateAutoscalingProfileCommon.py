...
def CreateAutoscalingProfileCommon(self, options):
    ...
    valid_choices = [arg_utils.EnumNameToChoice(n) for n in profiles_enum.names() if n != 'profile-unspecified']
    return arg_utils.ChoiceToEnum(choice=arg_utils.EnumNameToChoice(options.autoscaling_profile), enum_type=profiles_enum, valid_choices=valid_choices)