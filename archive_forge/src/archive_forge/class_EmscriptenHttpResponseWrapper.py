...
class EmscriptenHttpResponseWrapper(BaseHTTPResponse):
    ...
    def __init__(self, internal_response: EmscriptenResponse, url: str | None=None, connection: BaseHTTPConnection | BaseHTTPSConnection | None=None):
        self._pool = None
        self._body = None
        ...
        self._closed = False
        super().__init__(headers=internal_response.headers, status=internal_response.status_code, request_url=url, version=0, reason='', decode_content=True)
