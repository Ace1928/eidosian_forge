...
class SpannerClient(metaclass=SpannerClientMeta):
    ...
    def parse_database_path(path: str) -> Dict[str, str]:
        ...
        m = re.match('^projects/(?P<project>.+?)/instances/(?P<instance>.+?)/databases/(?P<database>.+?)$', path)
    ...
    def parse_session_path(path: str) -> Dict[str, str]:
        ...
        m = re.match('^projects/(?P<project>.+?)/instances/(?P<instance>.+?)/databases/(?P<database>.+?)/sessions/(?P<session>.+?)$', path)
        return m.groupdict() if m else {}
    ...
    def __init__(self, *, credentials: Optional[ga_credentials.Credentials]=None, transport: Optional[Union[str, SpannerTransport]]=None, client_options: Optional[Union[client_options_lib.ClientOptions, dict]]=None, client_info: gapic_v1.client_info.ClientInfo=DEFAULT_CLIENT_INFO) -> None:
    ...
    def create_session(self, request: Optional[Union[spanner.CreateSessionRequest, dict]]=None, *, database: Optional[str]=None, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> spanner.Session:
    ...
    def get_session(self, request: Optional[Union[spanner.GetSessionRequest, dict]]=None, *, name: Optional[str]=None, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> spanner.Session:
    ...
    def list_sessions(self, request: Optional[Union[spanner.ListSessionsRequest, dict]]=None, *, database: Optional[str]=None, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> pagers.ListSessionsPager:
        ...
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((('database', request.database),)),)
        response = rpc(request, retry=retry, timeout=timeout, metadata=metadata)
        response = pagers.ListSessionsPager(method=rpc, request=request, response=response, metadata=metadata)
        return response

    def delete_session(self, request: Optional[Union[spanner.DeleteSessionRequest, dict]]=None, *, name: Optional[str]=None, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> None:
    ...
    def execute_sql(self, request: Optional[Union[spanner.ExecuteSqlRequest, dict]]=None, *, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> result_set.ResultSet:
    ...
    def execute_streaming_sql(self, request: Optional[Union[spanner.ExecuteSqlRequest, dict]]=None, *, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> Iterable[result_set.PartialResultSet]:
    ...
    def execute_batch_dml(self, request: Optional[Union[spanner.ExecuteBatchDmlRequest, dict]]=None, *, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> spanner.ExecuteBatchDmlResponse:
    ...
    def read(self, request: Optional[Union[spanner.ReadRequest, dict]]=None, *, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> result_set.ResultSet:
    ...
    def streaming_read(self, request: Optional[Union[spanner.ReadRequest, dict]]=None, *, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> Iterable[result_set.PartialResultSet]:
    ...
    def begin_transaction(self, request: Optional[Union[spanner.BeginTransactionRequest, dict]]=None, *, session: Optional[str]=None, options: Optional[transaction.TransactionOptions]=None, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> transaction.Transaction:
    ...
    def rollback(self, request: Optional[Union[spanner.RollbackRequest, dict]]=None, *, session: Optional[str]=None, transaction_id: Optional[bytes]=None, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> None:
    ...
    def partition_query(self, request: Optional[Union[spanner.PartitionQueryRequest, dict]]=None, *, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> spanner.PartitionResponse:
    ...
    def partition_read(self, request: Optional[Union[spanner.PartitionReadRequest, dict]]=None, *, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> spanner.PartitionResponse:
        """Creates a set of partition tokens that can be used to execute a
    ...
    def batch_write(self, request: Optional[Union[spanner.BatchWriteRequest, dict]]=None, *, session: Optional[str]=None, mutation_groups: Optional[MutableSequence[spanner.BatchWriteRequest.MutationGroup]]=None, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> Iterable[spanner.BatchWriteResponse]:
