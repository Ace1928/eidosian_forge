...
import ipyvuetify
def _Text(attributes: dict={}, children: list=[], class_: str=None, layout: Union[Dict[str, Any], Element[ipywidgets.widgets.widget_layout.Layout]]={}, slot: str=None, style_: str=None, tabbable: bool=None, tooltip: str=None, v_model: Any='!!disabled!!', v_on: str=None, v_slots: list=[], value: str='', on_v_model: typing.Callable[[Any], Any]=None) -> ValueElement[ipyvuetify.generated.Text, Any]:
    """
