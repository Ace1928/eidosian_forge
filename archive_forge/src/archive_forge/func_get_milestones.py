...
def get_milestones(self, state: Opt[str]=NotSet, sort: Opt[str]=NotSet, direction: Opt[str]=NotSet) -> PaginatedList[Milestone]:
    """
    ...
    return PaginatedList(github.Milestone.Milestone, self._requester, f'{self.url}/milestones', url_parameters)