...
class TestNetworkFirewallGroup(TestNetworkProxy):
    ...
    def test_firewall_group_delete(self):
        self.verify_delete(self.proxy.delete_firewall_group, firewall_group.FirewallGroup, False)

    def test_firewall_group_delete_ignore(self):
        self.verify_delete(self.proxy.delete_firewall_group, firewall_group.FirewallGroup, True)
