...
class ThreeWidget(Widget):
    ...
    if hasattr(Widget, '_ipython_display_'):
        ...
        def _repr_mimebundle_(self, **kwargs):
            if self._previewable:
                ...
                return {'text/plain': plaintext, 'application/vnd.jupyter.widget-view+json': {'version_major': 2, 'version_minor': 0, 'model_id': preview._model_id}}
            else:
