...
class InvalidMessageParseError(ParseError):
    ...
    def __init__(self, path, reason, message_class):
        ...
        super(InvalidMessageParseError, self).__init__(path, 'The YAML-compliant file of messages provided contains errors: {}\n\nThe objects in this file can contain the fields [{}].'.format(reason, ', '.join(valid_fields)))