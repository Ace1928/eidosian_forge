...
class TextResponse(Response):
    ...
    def _set_body(self, body):
        ...
        if isinstance(body, str):
            if self._encoding is None:
                raise TypeError(f'Cannot convert unicode body - {type(self).__name__} has no encoding')
    ...
    def _declared_encoding(self):
        return self._encoding or self._bom_encoding() or self._headers_encoding() or self._body_declared_encoding()
