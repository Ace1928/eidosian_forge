...
class MergedStream(Stream):
    ...
    def __init__(self, merge: Union[Sequence[Union[dict, 'SchemaBase']], UndefinedType]=Undefined, between: Union[Sequence[Union[dict, 'SchemaBase']], UndefinedType]=Undefined, consume: Union[bool, UndefinedType]=Undefined, debounce: Union[float, UndefinedType]=Undefined, filter: Union[str, 'SchemaBase', Sequence[Union[str, 'SchemaBase']], UndefinedType]=Undefined, markname: Union[str, UndefinedType]=Undefined, marktype: Union['SchemaBase', Literal['arc', 'area', 'image', 'group', 'line', 'path', 'rect', 'rule', 'shape', 'symbol', 'text', 'trail'], UndefinedType]=Undefined, throttle: Union[float, UndefinedType]=Undefined, **kwds):
        super(MergedStream, self).__init__(merge=merge, between=between, consume=consume, debounce=debounce, filter=filter, markname=markname, marktype=marktype, throttle=throttle, **kwds)