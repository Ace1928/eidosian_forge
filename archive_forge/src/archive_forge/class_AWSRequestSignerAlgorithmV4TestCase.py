...
class AWSRequestSignerAlgorithmV4TestCase(LibcloudTestCase):
    ...
    def setUp(self):
        ...
        self.signer = AWSRequestSignerAlgorithmV4(access_key='my_key', access_secret='my_secret', version='2013-10-15', connection=self.connection)
    ...
    def test_get_request_params_urlquotes_params_keys(self):
        self.assertEqual(self.signer._get_request_params({'Action+Reaction': 'DescribeInstances'}), 'Action%2BReaction=DescribeInstances')
    ...
    def test_get_payload_hash_with_data_for_PUT_requests(self):
        ...
        self.assertEqual(self.signer._get_payload_hash(method='PUT', data='DUMMY'), 'ceec12762e66397b56dad64fd270bb3d694c78fb9cd665354383c0626dbab013')
