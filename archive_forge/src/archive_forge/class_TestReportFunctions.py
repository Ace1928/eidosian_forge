...
class TestReportFunctions(unittest.TestCase):
    ...
    def test_active_constraint_set(self):
        ...
        assert rpt.active_constraint_set(self.m) == ComponentSet([self.m.c1, self.m.c2, self.m.c3, self.m.c5, self.m.c6, self.m.c7, self.m.c8, self.m.c8b, self.m.c9, self.m.c10])
        self.m.c4.activate()
        assert rpt.active_constraint_set(self.m) == ComponentSet([self.m.c1, self.m.c2, self.m.c3, self.m.c4, self.m.c5, self.m.c6, self.m.c7, self.m.c8, self.m.c8b, self.m.c9, self.m.c10])
