...
def _register_setup_class_fixture(self) -> None:
    ...
    def xunit_setup_class_fixture(request) -> Generator[None, None, None]:
        ...
        if teardown_class is not None:
            ...
            _call_with_optional_argument(func, cls)
    self.session._fixturemanager._register_fixture(name=f'_xunit_setup_class_fixture_{self.obj.__qualname__}', func=xunit_setup_class_fixture, nodeid=self.nodeid, scope='class', autouse=True)