...
def resource_apply_ftrl_v2(var: _atypes.TensorFuzzingAnnotation[_atypes.Resource], accum: _atypes.TensorFuzzingAnnotation[_atypes.Resource], linear: _atypes.TensorFuzzingAnnotation[_atypes.Resource], grad: _atypes.TensorFuzzingAnnotation[TV_ResourceApplyFtrlV2_T], lr: _atypes.TensorFuzzingAnnotation[TV_ResourceApplyFtrlV2_T], l1: _atypes.TensorFuzzingAnnotation[TV_ResourceApplyFtrlV2_T], l2: _atypes.TensorFuzzingAnnotation[TV_ResourceApplyFtrlV2_T], l2_shrinkage: _atypes.TensorFuzzingAnnotation[TV_ResourceApplyFtrlV2_T], lr_power: _atypes.TensorFuzzingAnnotation[TV_ResourceApplyFtrlV2_T], use_locking: bool=False, multiply_linear_by_lr: bool=False, name=None):
  ...
  """
    ...
    if tld.is_eager:
        try:
            _result = pywrap_tfe.TFE_Py_FastPathExecute(_ctx, 'ResourceApplyFtrlV2', name, var, accum, linear, grad, lr, l1, l2, l2_shrinkage, lr_power, 'use_locking', use_locking, 'multiply_linear_by_lr', multiply_linear_by_lr)
            return _result
            ...
            pass
        try:
            return resource_apply_ftrl_v2_eager_fallback(var, accum, linear, grad, lr, l1, l2, l2_shrinkage, lr_power, use_locking=use_locking, multiply_linear_by_lr=multiply_linear_by_lr, name=name, ctx=_ctx)
    ...
    _, _, _op, _outputs = _op_def_library._apply_op_helper('ResourceApplyFtrlV2', var=var, accum=accum, linear=linear, grad=grad, lr=lr, l1=l1, l2=l2, l2_shrinkage=l2_shrinkage, lr_power=lr_power, use_locking=use_locking, multiply_linear_by_lr=multiply_linear_by_lr, name=name)
    return _op