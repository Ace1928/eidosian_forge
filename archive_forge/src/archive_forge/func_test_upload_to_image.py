...
def test_upload_to_image(self):
    self._verify('openstack.block_storage.v3.volume.Volume.upload_to_image', self.proxy.upload_volume_to_image, method_args=['value', '1'], expected_args=[self.proxy, '1'], expected_kwargs={'force': False, 'disk_format': None, 'container_format': None, 'visibility': None, 'protected': None})