...
class Emitter(object):
    DEFAULT_TAG_PREFIXES = {u'!': u'!', u'tag:yaml.org,2002:': u'!!'}
    MAX_SIMPLE_KEY_LENGTH = 128

    def __init__(self, stream, canonical=None, indent=None, width=None, allow_unicode=None, line_break=None, block_seq_indent=None, top_level_colon_align=None, prefix_colon=None, brace_single_entry_mapping_in_flow_sequence=None, dumper=None):
        self.dumper = dumper
        ...
        self.indention = True
        self.compact_seq_seq = True
        self.compact_seq_map = True
        self.no_newline = None
        self.open_ended = False
        self.colon = u':'
        self.prefixed_colon = self.colon if prefix_colon is None else prefix_colon + self.colon
        self.brace_single_entry_mapping_in_flow_sequence = brace_single_entry_mapping_in_flow_sequence
    ...
    def check_empty_mapping(self):
        return isinstance(self.event, MappingStartEvent) and bool(self.events) and isinstance(self.events[0], MappingEndEvent)
    ...
    def process_tag(self):
        ...
        if self.prepared_tag:
            ...
            if self.sequence_context and (not self.flow_level) and isinstance(self.event, ScalarEvent):
                self.no_newline = True
        self.prepared_tag = None
    ...
    def write_single_quoted(self, text, split=True):
        ...
        self.write_indicator(u"'", False)
    ESCAPE_REPLACEMENTS = {u'\x00': u'0', u'\x07': u'a', u'\x08': u'b', u'\t': u't', u'\n': u'n', u'\x0b': u'v', u'\x0c': u'f', u'\r': u'r', u'\x1b': u'e', u'"': u'"', u'\\': u'\\', u'\x85': u'N', u'\xa0': u'_', u'\u2028': u'L', u'\u2029': u'P'}
