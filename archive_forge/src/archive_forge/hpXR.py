...
FrUIT_COLOR: Tuple[int, int, int] = (
    ...
    90,
    101,
)  # This tuple of three integers represents the RGB color of the fruit.
PATHCOLOR: Tuple[int, int, int, int] = (
    41,
    255,
    3,
    50,
)  # This tuple of four integers represents the RGBA color of the path taken by the snake.
...
WINDOW_COLOR: Tuple[int, int, int] = (
    ...
    40,
    41,
)  # This tuple of three integers represents the RGB color of the game window.
WHITE: Tuple[int, int, int] = (
    241,
    241,
    241,
)  # This tuple of three integers represents the RGB color white.
MENU_COLOR: Tuple[int, int, int] = (
    94,
    219,
    111,
)  # This tuple of three integers represents the RGB color of the menu area.
BANNER_COLOR: Tuple[int, int, int] = (
    189,
    189,
    189,
)  # This tuple of three integers represents the RGB color of the banner area.
TITLE_COLOR: Tuple[int, int, int] = (
    133,
    209,
    242,
)  # This tuple of three integers represents the RGB color of the game title.
