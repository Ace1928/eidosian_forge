...
class ZerigoTests(unittest.TestCase):
    ...
    def test_create_record_success(self):
        ...
        record = self.driver.create_record(name='www', zone=zone, type=RecordType.A, data='127.0.0.1')
    ...
    def test_update_record_success(self):
        ...
        updated_record = self.driver.update_record(record=record, name='www', type=RecordType.AAAA, data='::1')
