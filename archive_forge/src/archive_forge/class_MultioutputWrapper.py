...
class MultioutputWrapper(WrapperMetric):
    ...
    def __init__(self, base_metric: Metric, num_outputs: int, output_dim: int=-1, remove_nans: bool=True, squeeze_outputs: bool=True) -> None:
        super().__init__()
    ...
    def forward(self, *args: Any, **kwargs: Any) -> Any:
        ...
        """
        reshaped_args_kwargs = self._get_args_kwargs_by_output(*args, **kwargs)
        results = [metric(*selected_args, **selected_kwargs) for metric, (selected_args, selected_kwargs) in zip(self.metrics, reshaped_args_kwargs)]
