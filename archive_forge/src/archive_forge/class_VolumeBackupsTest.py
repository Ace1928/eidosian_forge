...
class VolumeBackupsTest(utils.TestCase):
    ...
    def test_create_full(self):
        vol = cs.backups.create('2b695faf-b963-40c8-8464-274008fbcef4', None, None, False)
        cs.assert_called('POST', '/backups')
        self._assert_request_id(vol)

    def test_create_incremental(self):
        vol = cs.backups.create('2b695faf-b963-40c8-8464-274008fbcef4', None, None, True)
        cs.assert_called('POST', '/backups')
        self._assert_request_id(vol)
    ...
    def test_create_snapshot(self):
        cs.backups.create('2b695faf-b963-40c8-8464-274008fbcef4', None, None, False, False, '3c706gbg-c074-51d9-9575-385119gcdfg5')
        cs.assert_called('POST', '/backups')
    ...
    def test_delete(self):
        b = cs.backups.list()[0]
        del_back = b.delete()
        cs.assert_called('DELETE', '/backups/76a17945-3c6f-435c-975b-b5685db10b62')
    ...
    def test_reset_state(self):
        ...
        st = cs.backups.reset_state('76a17945-3c6f-435c-975b-b5685db10b62', state='error')
        cs.assert_called('POST', api)
        self._assert_request_id(st)
