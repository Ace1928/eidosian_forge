...
class TestQuotaSet(base.TestCase):
    ...
    def test_basic(self):
        ...
        self.assertDictEqual({'usage': 'usage', 'limit': 'limit', 'marker': 'marker'}, sot._query_mapping._mapping)
    ...
    def test_get(self):
        ...
        sot.fetch(self.sess)
        self.sess.get.assert_called_with('/os-quota-sets/proj', microversion=1, params={}, skip_cache=False)
        self.assertEqual(BASIC_EXAMPLE['backups'], sot.backups)
    ...
    def test_get_usage(self):
        ...
        self.sess.get.assert_called_with('/os-quota-sets/proj', microversion=1, params={'usage': True}, skip_cache=False)
    ...
    def test_delete_quota(self):
        ...
        self.sess.delete.assert_called_with('/os-quota-sets/proj', microversion=1, headers={})