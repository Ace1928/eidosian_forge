...
def AddClearVpcNetworkTagsFlags(parser, resource_kind='service'):
    ...
    parser.add_argument('--clear-network-tags', action='store_true', help='Clears all existing Compute Engine tags from the Cloud Run {kind}. '.format(kind=resource_kind))