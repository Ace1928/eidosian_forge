...
class SdaVirtualNetwork(object):
    ...
    def __init__(self, params, dnac):
        self.dnac = dnac
        self.new_object = dict(virtualNetworkName=params.get('virtualNetworkName'), siteNameHierarchy=params.get('siteNameHierarchy'), virtual_network_name=params.get('virtualNetworkName'), site_name_hierarchy=params.get('siteNameHierarchy'))
    ...
    def get_object_by_name(self, name, is_absent=False):
        result = None
        try:
            items = self.dnac.exec(family='sda', function='get_vn', params=self.get_all_params(name=name))
    ...
    def requires_update(self, current_obj):
        ...
        obj_params = [('virtualNetworkName', 'virtualNetworkName'), ('siteNameHierarchy', 'siteNameHierarchy'), ('virtualNetworkName', 'virtual_network_name'), ('siteNameHierarchy', 'site_name_hierarchy')]
    ...
    def create(self):
        result = self.dnac.exec(family='sda', function='add_vn', params=self.create_params(), op_modifies=True)
    ...
    def delete(self):
        ...
        name = self.new_object.get('name')
        result = None
        result = self.dnac.exec(family='sda', function='delete_vn', params=self.delete_all_params())
        return result