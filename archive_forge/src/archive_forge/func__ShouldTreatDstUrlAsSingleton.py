...
def _ShouldTreatDstUrlAsSingleton(src_url_names_container, have_multiple_srcs, have_existing_dest_subdir, dst_url, recursion_requested):
  ...
  """
    ...
    if dst_url.IsFileUrl():
        ...
        return not have_multiple_srcs and (not have_existing_dest_subdir) and dst_url.IsObject()