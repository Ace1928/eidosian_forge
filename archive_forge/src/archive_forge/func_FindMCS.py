...
def FindMCS(mols, minNumAtoms=2, maximize=Default.maximize, atomCompare=Default.atomCompare, bondCompare=Default.bondCompare, matchValences=Default.matchValences, ringMatchesRingOnly=False, completeRingsOnly=False, timeout=Default.timeout, threshold=None):
    ...
    ***************************************************
    ...
    """
    warnings.warn('The rdkit.Chem.MCS module is deprecated; please use rdkit.Chem.rdFMCS instead.', DeprecationWarning, stacklevel=2)
    ores = fmcs.fmcs(mols, minNumAtoms=minNumAtoms, maximize=maximize, atomCompare=atomCompare, bondCompare=bondCompare, threshold=threshold, matchValences=matchValences, ringMatchesRingOnly=ringMatchesRingOnly, completeRingsOnly=completeRingsOnly, timeout=timeout)
