...
def AddSplitSourceCommitment(parser):
    return parser.add_argument('--split-source-commitment', required=False, help='Creates the new commitment by splitting the specified source commitment and redistributing the specified resources.')