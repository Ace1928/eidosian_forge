...
class CustomScalarsPlugin(base_plugin.TBPlugin):
    ...
    def get_plugin_apps(self):
        return {'/download_data': self.download_data_route, '/layout': self.layout_route, '/scalars': self.scalars_route}
    ...
    def frontend_metadata(self):
        return base_plugin.FrontendMetadata(element_name='tf-custom-scalar-dashboard', tab_name='Custom Scalars')
    ...
    def download_data_route(self, request):
        ...
        try:
            body, mime_type = self.download_data_impl(ctx, run, tag, experiment, response_format)
