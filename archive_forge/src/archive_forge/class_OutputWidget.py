...
class OutputWidget:
    ...
    def send(self, data: Optional[Dict]=None, metadata: Optional[Dict]=None, buffers: Optional[List]=None) -> None:
        """Send a comm message."""
    ...
    def output(self, outs: List, msg: Dict, display_id: str, cell_index: int) -> None:
        ...
        if self.outputs:
            ...
            if last_output['output_type'] == 'stream' and output['output_type'] == 'stream' and (last_output['name'] == output['name']):
