...
class BuildDoc(Command):
    ...
    def finalize_options(self) -> None:
        ...
        self.builder_target_dirs = [(builder, os.path.join(self.build_dir, builder)) for builder in self.builder]

    def run(self) -> None:
        warnings.warn('setup.py build_sphinx is deprecated.', RemovedInSphinx70Warning, stacklevel=2)
        ...
        for builder, builder_target_dir in self.builder_target_dirs:
            ...
            try:
                ...
                with patch_docutils(confdir), docutils_namespace():
                    app = Sphinx(self.source_dir, self.config_dir, builder_target_dir, self.doctree_dir, builder, confoverrides, status_stream, freshenv=self.fresh_env, warningiserror=self.warning_is_error, verbosity=self.verbosity, keep_going=self.keep_going)
            ...
            if not self.link_index:
                continue
            src = app.config.root_doc + app.builder.out_suffix
