...
def test_tabulator_sort_algorithm_no_show_index(page):
    df = pd.DataFrame({'vals': ['A', 'i', 'W', 'g', 'r', 'l', 'a', 'n', 'z', 'N', 'a', 'l', 's', 'm', 'J', 'C', 'w'], 'groups': ['A', 'B', 'C', 'B', 'C', 'C', 'C', 'C', 'C', 'C', 'C', 'C', 'C', 'C', 'C', 'A', 'A']}, index=np.random.choice(list(range(17)), size=17, replace=False))
    target_col = 'vals'
