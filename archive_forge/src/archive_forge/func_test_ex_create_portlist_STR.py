...
def test_ex_create_portlist_STR(self):
    ...
    success = self.driver.ex_create_portlist(ex_network_domain=net_domain.id, name=name, description=description, port_collection=port_collection, child_portlist_list=child_ports_ids)
