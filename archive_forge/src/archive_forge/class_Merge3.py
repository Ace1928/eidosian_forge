class Merge3:
    ...
    def __init__(self, base, a, b, is_cherrypick: bool=False, sequence_matcher=None) -> None:
        """Constructor.
    ...
    def reprocess_merge_regions(self, merge_regions):
        ...
        for region in merge_regions:
            ...
            matches = self.sequence_matcher(None, a_region, b_region).get_matching_blocks()
            next_a = ia
            next_b = ib
