...
class R2ArtifactRepository(OptimizedS3ArtifactRepository):
    ...
    def __init__(self, artifact_uri, access_key_id=None, secret_access_key=None, session_token=None):
        ...
        super().__init__(artifact_uri, access_key_id=access_key_id, secret_access_key=secret_access_key, session_token=session_token, addressing_style='virtual', s3_endpoint_url=s3_endpoint_url)
