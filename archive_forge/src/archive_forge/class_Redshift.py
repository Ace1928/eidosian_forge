...
class Redshift(Postgres):
    ...
    class Tokenizer(Postgres.Tokenizer):
        ...
        HEX_STRINGS = []
        STRING_ESCAPES = ['\\', "'"]
        KEYWORDS = {**Postgres.Tokenizer.KEYWORDS, 'HLLSKETCH': TokenType.HLLSKETCH, 'SUPER': TokenType.SUPER, 'TOP': TokenType.TOP, 'UNLOAD': TokenType.COMMAND, 'VARBYTE': TokenType.VARBINARY}
        KEYWORDS.pop('VALUES')
