...
def test_rebuild_with_multiple_trusted_image_certificate_ids(self):
    self.run_command('rebuild sample-server %s --trusted-image-certificate-id id1 --trusted-image-certificate-id id2' % FAKE_UUID_1, api_version='2.63')
    ...
    self.assert_called('POST', '/servers/1234/action', {'rebuild': {'imageRef': FAKE_UUID_1, 'description': None, 'trusted_image_certificates': ['id1', 'id2']}}, pos=3)
