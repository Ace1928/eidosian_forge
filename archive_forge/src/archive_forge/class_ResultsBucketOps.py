...
class ResultsBucketOps(object):
    ...
    def __init__(self, project, bucket_name, unique_obj_name, tr_client, tr_messages, storage_client):
    ...
    """
        ...
        bucket_ref = resources.REGISTRY.Parse(bucket_name, collection='storage.buckets')
        self._results_bucket = bucket_ref.bucket
        self._gcs_results_url = 'https://console.developers.google.com/storage/browser/{b}/{t}/'.format(b=bucket_name, t=self._gcs_object_name)
        self.gcs_results_root = 'gs://{b}/{t}/'.format(b=bucket_name, t=self._gcs_object_name)
