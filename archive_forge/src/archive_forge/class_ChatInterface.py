...
class ChatInterface(ChatFeed):
    ...
    def __init__(self, *objects, **params):
        ...
        self._input_container = Row(css_classes=['chat-interface-input-container'], stylesheets=self._stylesheets)
        self._update_input_width()
        self._init_widgets()
        if active is not None:
            self.active = active
        self._card.param.update(objects=self._card.objects + [self._input_container], css_classes=['chat-interface'])
