...
class ComprehensiveLoggingSystem:
    ...
    def __init__(self, logger_name: str='ComprehensiveScriptLogger', log_directory: str='logs', log_filename: str='comprehensive_script.log', max_log_size: int=10485760, backup_count: int=5):
        """
