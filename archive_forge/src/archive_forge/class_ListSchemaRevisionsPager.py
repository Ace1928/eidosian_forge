...
class ListSchemaRevisionsPager:
    ...
    def __init__(self, method: Callable[..., schema.ListSchemaRevisionsResponse], request: schema.ListSchemaRevisionsRequest, response: schema.ListSchemaRevisionsResponse, *, metadata: Sequence[Tuple[str, str]]=()):
