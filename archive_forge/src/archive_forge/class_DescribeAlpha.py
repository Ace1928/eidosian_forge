...
class DescribeAlpha(base.DescribeCommand):
    ...
    """
        ...
        bbs = client.projects_locations_bitbucketServerConfigs.Get(messages.CloudbuildProjectsLocationsBitbucketServerConfigsGetRequest(name=bbs_resource.RelativeName()))
        return bbs