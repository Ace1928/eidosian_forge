...
def CreateInstanceLifecyclePolicy(messages, args):
    ...
    if args.IsKnownAndSpecified('default_action_on_vm_failure'):
        policy.defaultActionOnFailure = arg_utils.ChoiceToEnum(args.default_action_on_vm_failure, messages.InstanceGroupManagerInstanceLifecyclePolicy.DefaultActionOnFailureValueValuesEnum)
