...
class AbstractSchemaProxy(metaclass=ABCMeta):
    ...
    def __init__(self, schema: XsdSchemaProtocol, base_element: Optional[XsdElementProtocol]=None) -> None:
    ...
    def find(self, path: str, namespaces: Optional[Dict[str, str]]=None) -> Optional[Union[XsdSchemaProtocol, XsdElementProtocol]]:
        """
