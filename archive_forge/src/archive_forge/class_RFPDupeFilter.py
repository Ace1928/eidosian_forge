...
class RFPDupeFilter(BaseDupeFilter):
    ...
    def from_settings(cls, settings: BaseSettings, *, fingerprinter: Optional[RequestFingerprinterProtocol]=None) -> Self:
        ...
        try:
            ...
            warn("RFPDupeFilter subclasses must either modify their '__init__' method to support a 'fingerprinter' parameter or reimplement the 'from_settings' class method.", ScrapyDeprecationWarning)
