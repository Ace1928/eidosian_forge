...
def test_member_update(self):
    self._verify('openstack.proxy.Proxy._update', self.proxy.update_member, method_args=['member_id', 'image_id'], expected_args=[_member.Member], expected_kwargs={'member_id': 'member_id', 'image_id': 'image_id'})