...
class AzureRMNetAppModuleBase(AzureRMModuleBase):
    ...
    def __init__(self, derived_arg_spec, required_if=None, supports_check_mode=False, supports_tags=True):
        ...
        super(AzureRMNetAppModuleBase, self).__init__(derived_arg_spec=derived_arg_spec, required_if=required_if, supports_check_mode=supports_check_mode, supports_tags=supports_tags)
    ...
    def get_feature(self, feature_name):
        ...
        """
        default_flags = dict(ignore_change_ownership_mode=True)
