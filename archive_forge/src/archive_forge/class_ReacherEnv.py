...
class ReacherEnv(MujocoEnv, utils.EzPickle):
    ...
    * v0: Initial versions release (1.0.0)
    ...
    def __init__(self, **kwargs):
        ...
        MujocoEnv.__init__(self, 'reacher.xml', 2, observation_space=observation_space, **kwargs)
    ...
    def _get_obs(self):
        ...
        return np.concatenate([np.cos(theta), np.sin(theta), self.data.qpos.flat[2:], self.data.qvel.flat[:2], self.get_body_com('fingertip') - self.get_body_com('target')])