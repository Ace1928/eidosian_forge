...
class InfobipAPIWrapper(BaseModel):
    ...
    def run(self, body: str='', to: str='', sender: str='', subject: str='', channel: str='sms') -> str:
        if channel == 'sms':
            if sender == '':
            ...
            return self._send_sms(sender=sender, destination_phone_numbers=[to], text=body)
        elif channel == 'email':
            if sender == '':
            ...
            return self._send_email(from_email=sender, to_email=to, subject=subject, body=body)
        else:
