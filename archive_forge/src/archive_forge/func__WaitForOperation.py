...
def _WaitForOperation(resources, service, operation, target_http_proxy_ref, message):
    ...
    return operation_utils.WaitForOperation(resources, service, operation, collection, target_http_proxy_ref, message)