...
class InsertionVoltagePair(AbstractVoltagePair):
    ...
    def __repr__(self):
        output = [f'Insertion voltage pair with working ion {self.working_ion_entry.reduced_formula}', f'V = {self.voltage}, mAh = {self.mAh}', f'mass_charge = {self.mass_charge}, mass_discharge = {self.mass_discharge}', f'vol_charge = {self.vol_charge}, vol_discharge = {self.vol_discharge}', f'frac_charge = {self.frac_charge}, frac_discharge = {self.frac_discharge}']
        return '\n'.join(output)