...
def GetInternalInterface(instance_resource):
  ...
  """
    ...
    raise MissingNetworkInterfaceError('Instance [{0}] in zone [{1}] has no network interfaces.'.format(instance_resource.name, path_simplifier.Name(instance_resource.zone)))