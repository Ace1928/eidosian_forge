...
class OptionInterpreter:
    ...
    def __init__(self, subproject: 'SubProject') -> None:
        ...
        self.option_types: T.Dict[str, T.Callable[..., coredata.UserOption]] = {'string': self.string_parser, 'boolean': self.boolean_parser, 'combo': self.combo_parser, 'integer': self.integer_parser, 'array': self.string_array_parser, 'feature': self.feature_parser}
    ...
    def process(self, option_file: str) -> None:
        ...
        for cur in ast.lines:
            try:
                ...
                raise mesonlib.MesonException(str(e), lineno=cur.lineno, colno=cur.colno, file=option_file)
    ...
    def func_option(self, args: T.Tuple[str], kwargs: 'FuncOptionArgs') -> None:
        ...
        n_kwargs = {k: v for k, v in kwargs.items() if k not in {'type', 'description', 'deprecated', 'yield'}}
