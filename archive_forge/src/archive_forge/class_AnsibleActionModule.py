...
class AnsibleActionModule(object):
    ...
    def __init__(self, action_plugin, argument_spec, bypass_checks=False, mutually_exclusive=None, required_together=None, required_one_of=None, supports_check_mode=False, required_if=None, required_by=None):
        ...
        if HAS_ARGSPEC_VALIDATOR:
            self._validator = ArgumentSpecValidator(self.argument_spec, self.mutually_exclusive, self.required_together, self.required_one_of, self.required_if, self.required_by)
            ...
            for d in self._validation_result._deprecations:
                if 'name' in d:
                    self.deprecate("Alias '{name}' is deprecated. See the module docs for more information".format(name=d['name']), version=d.get('version'), date=d.get('date'), collection_name=d.get('collection_name'))
                if 'msg' in d:
    ...
    def _handle_aliases(self, spec=None, param=None, option_prefix=''):
        ...
        for deprecation in deprecated_aliases:
            if deprecation['name'] in param.keys():
                self.deprecate("Alias '%s' is deprecated. See the module docs for more information" % deprecation['name'], version=deprecation.get('version'), date=deprecation.get('date'), collection_name=deprecation.get('collection_name'))
