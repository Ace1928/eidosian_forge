...
class DevicesSwitchRoutingInterfacesDhcp(object):
    ...
    def get_object_by_name(self, name):
        result = None
        try:
            items = self.meraki.exec_meraki(family='switch', function='getDeviceSwitchRoutingInterfaceDhcp', params=self.get_all_params(name=name))
    ...
    def update(self):
        ...
        name = self.new_object.get('name')
        result = None
        result = self.meraki.exec_meraki(family='switch', function='updateDeviceSwitchRoutingInterfaceDhcp', params=self.update_all_params(), op_modifies=True)
        return result