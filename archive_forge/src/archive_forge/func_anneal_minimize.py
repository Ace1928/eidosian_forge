...
def anneal_minimize(initial: T, cost_func: Callable[[T], float], move_func: Callable[[T], T], random_sample: Callable[[], float], temp_initial: float=0.01, temp_final: float=1e-06, cooling_factor: float=0.99, repeat: int=100, trace_func: Optional[Callable[[T, float, float, float, bool], None]]=None) -> T:
