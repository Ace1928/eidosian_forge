...
class ArtifactManifest:
    ...
    @classmethod
    def from_manifest_json(cls, manifest_json: Dict, api: Optional[InternalApi]=None) -> 'ArtifactManifest':
    ...
    def __init__(self, storage_policy: 'StoragePolicy', entries: Optional[Mapping[str, 'ArtifactManifestEntry']]=None) -> None:
