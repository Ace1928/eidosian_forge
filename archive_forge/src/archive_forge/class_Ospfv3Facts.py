...
class Ospfv3Facts(object):
    ...
    def populate_facts(self, connection, ansible_facts, data=None):
        ...
        objs = {}
        ospfv3 = findall('^set protocols ospfv3 (.+)', data, M)
        if ospfv3:
    ...
    def parse_attrib(self, conf, param, match=None):
        ...
        """
        param_lst = {'area_id': ['export_list', 'import_list'], 'redistribute': ['route_map'], 'range': ['advertise', 'not_advertise'], 'parameters': ['router_id']}
