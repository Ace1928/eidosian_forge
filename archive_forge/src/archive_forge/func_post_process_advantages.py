...
def post_process_advantages(policy: Policy, sample_batch: SampleBatch, other_agent_batches: Optional[List[SampleBatch]]=None, episode: Optional[Episode]=None) -> SampleBatch:
    ...
    """
    return compute_advantages(rollout=sample_batch, last_r=0.0, gamma=policy.config['gamma'], use_gae=False, use_critic=False)