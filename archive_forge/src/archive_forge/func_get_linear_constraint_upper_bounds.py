...
def get_linear_constraint_upper_bounds(self, constraints: Optional[_IndexOrSeries]=None) -> pd.Series:
    """Gets the upper bounds of all linear constraints in the set.
        ...
        """
    return _attribute_series(func=lambda c: c.upper_bound, values=self._get_linear_constraints(constraints))