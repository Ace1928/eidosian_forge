...
class HostUtils(baseutils.BaseUtilsVirt):
    ...
    def __init__(self, host='.'):
        ...
        self._conn_cimv2 = self._get_wmi_conn(self._wmi_cimv2_namespace, privileges=['Shutdown'])
        self._conn_scimv2 = self._get_wmi_conn(self._wmi_standard_cimv2_namespace)
    ...
    def get_memory_info(self):
        ...
        """
        mem_info = self._conn_cimv2.query('SELECT TotalVisibleMemorySize, FreePhysicalMemory FROM win32_operatingsystem')[0]
        return (int(mem_info.TotalVisibleMemorySize), int(mem_info.FreePhysicalMemory))
