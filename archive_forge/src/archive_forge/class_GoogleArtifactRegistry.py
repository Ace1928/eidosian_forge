...
class GoogleArtifactRegistry(AbstractRegistry):
    ...
    def __init__(self, uri: Optional[str]=None, repository: Optional[str]=None, image_name: Optional[str]=None, project: Optional[str]=None, region: Optional[str]=None) -> None:
