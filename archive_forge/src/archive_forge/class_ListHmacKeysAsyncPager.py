...
class ListHmacKeysAsyncPager:
    ...
    def __init__(self, method: Callable[..., Awaitable[storage.ListHmacKeysResponse]], request: storage.ListHmacKeysRequest, response: storage.ListHmacKeysResponse, *, metadata: Sequence[Tuple[str, str]]=()):
