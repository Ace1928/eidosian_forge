...
def _UploadObject(cls, args, thread_state=None):
  ...
  """
    ...
    if args.need_to_slice:
        cls.PerformSlicedUpload(args.file_name, args.object_name, args.use_file, gsutil_api, gzip_encoded=args.gzip_encoded)
    else:
        cls.Upload(args.file_name, args.object_name, gsutil_api, args.use_file, gzip_encoded=args.gzip_encoded)