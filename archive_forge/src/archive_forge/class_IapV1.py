...
class IapV1(base_api.BaseApiClient):
    ...
    def __init__(self, url='', credentials=None, get_credentials=True, http=None, model=None, log_request=False, log_response=False, credentials_args=None, default_global_params=None, additional_http_headers=None, response_encoding=None):
        ...
        super(IapV1, self).__init__(url, credentials=credentials, get_credentials=get_credentials, http=http, model=model, log_request=log_request, log_response=log_response, credentials_args=credentials_args, default_global_params=default_global_params, additional_http_headers=additional_http_headers, response_encoding=response_encoding)
    ...
    class V1Service(base_api.BaseApiService):
      ...
      """
            ...
            return self._RunMethod(config, request, global_params=global_params)
        GetIamPolicy.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1/{v1Id}:getIamPolicy', http_method='POST', method_id='iap.getIamPolicy', ordered_params=['resource'], path_params=['resource'], query_params=[], relative_path='v1/{+resource}:getIamPolicy', request_field='getIamPolicyRequest', request_type_name='IapGetIamPolicyRequest', response_type_name='Policy', supports_download=False)
      ...
      """
            ...
            return self._RunMethod(config, request, global_params=global_params)
        GetIapSettings.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1/{v1Id}:iapSettings', http_method='GET', method_id='iap.getIapSettings', ordered_params=['name'], path_params=['name'], query_params=[], relative_path='v1/{+name}:iapSettings', request_field='', request_type_name='IapGetIapSettingsRequest', response_type_name='IapSettings', supports_download=False)
      ...
      """
            ...
            return self._RunMethod(config, request, global_params=global_params)
        SetIamPolicy.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1/{v1Id}:setIamPolicy', http_method='POST', method_id='iap.setIamPolicy', ordered_params=['resource'], path_params=['resource'], query_params=[], relative_path='v1/{+resource}:setIamPolicy', request_field='setIamPolicyRequest', request_type_name='IapSetIamPolicyRequest', response_type_name='Policy', supports_download=False)
      ...
      """
            ...
            return self._RunMethod(config, request, global_params=global_params)
        TestIamPermissions.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1/{v1Id}:testIamPermissions', http_method='POST', method_id='iap.testIamPermissions', ordered_params=['resource'], path_params=['resource'], query_params=[], relative_path='v1/{+resource}:testIamPermissions', request_field='testIamPermissionsRequest', request_type_name='IapTestIamPermissionsRequest', response_type_name='TestIamPermissionsResponse', supports_download=False)
      ...
      """
            ...
            return self._RunMethod(config, request, global_params=global_params)
        UpdateIapSettings.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1/{v1Id}:iapSettings', http_method='PATCH', method_id='iap.updateIapSettings', ordered_params=['name'], path_params=['name'], query_params=['updateMask'], relative_path='v1/{+name}:iapSettings', request_field='iapSettings', request_type_name='IapUpdateIapSettingsRequest', response_type_name='IapSettings', supports_download=False)
      ...
      """
            ...
            return self._RunMethod(config, request, global_params=global_params)
        ValidateAttributeExpression.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1/{v1Id}:validateAttributeExpression', http_method='POST', method_id='iap.validateAttributeExpression', ordered_params=['name'], path_params=['name'], query_params=['expression'], relative_path='v1/{+name}:validateAttributeExpression', request_field='', request_type_name='IapValidateAttributeExpressionRequest', response_type_name='ValidateIapAttributeExpressionResponse', supports_download=False)