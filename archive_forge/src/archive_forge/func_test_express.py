...
def test_express():
    ...
    assert express(N.i, C) == (cos(q1) * cos(q3) - sin(q1) * sin(q2) * sin(q3)) * C.i - sin(q1) * cos(q2) * C.j + (sin(q3) * cos(q1) + sin(q1) * sin(q2) * cos(q3)) * C.k
    assert express(N.j, C) == (sin(q1) * cos(q3) + sin(q2) * sin(q3) * cos(q1)) * C.i + cos(q1) * cos(q2) * C.j + (sin(q1) * sin(q3) - sin(q2) * cos(q1) * cos(q3)) * C.k
    ...
    assert express(C.i, N) == (cos(q1) * cos(q3) - sin(q1) * sin(q2) * sin(q3)) * N.i + (sin(q1) * cos(q3) + sin(q2) * sin(q3) * cos(q1)) * N.j - sin(q3) * cos(q2) * N.k
    assert express(C.j, N) == -sin(q1) * cos(q2) * N.i + cos(q1) * cos(q2) * N.j + sin(q2) * N.k
    assert express(C.k, N) == (sin(q3) * cos(q1) + sin(q1) * sin(q2) * cos(q3)) * N.i + (sin(q1) * sin(q3) - sin(q2) * cos(q1) * cos(q3)) * N.j + cos(q2) * cos(q3) * N.k
