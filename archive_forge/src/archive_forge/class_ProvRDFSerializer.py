...
class ProvRDFSerializer(Serializer):
    ...
    def serialize(self, stream=None, rdf_format='trig', PROV_N_MAP=PROV_N_MAP, **kwargs):
        """
    ...
    def deserialize(self, stream, rdf_format='trig', relation_mapper=relation_mapper, predicate_mapper=predicate_mapper, **kwargs):
        """
        ...
        self.decode_document(container, document, relation_mapper=relation_mapper, predicate_mapper=predicate_mapper)
        return document
