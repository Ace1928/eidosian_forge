...
class MaterialsProjectDFTMixingScheme(Compatibility):
    ...
    def __init__(self, structure_matcher: StructureMatcher | None=None, run_type_1: str='GGA(+U)', run_type_2: str='R2SCAN', compat_1: Compatibility | None=MaterialsProject2020Compatibility(), compat_2: Compatibility | None=None, fuzzy_matching: bool=True, check_potcar: bool=True) -> None:
        ...
        if run_type_1 == run_type_2:
            raise ValueError(f'run_type_1=run_type_2={run_type_2!r}. The mixing scheme is meaningless unless run_types different')
        ...
        for compat in (self.compat_1, self.compat_2):
            if hasattr(compat, 'check_potcar'):
                compat.check_potcar = check_potcar
