...
def GetModelResourceSpec(resource_name='model'):
    return concepts.ResourceSpec('ml.projects.models', resource_name=resource_name, projectsId=concepts.DEFAULT_PROJECT_ATTRIBUTE_CONFIG, disable_auto_completers=True)