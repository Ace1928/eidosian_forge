...
def get_environments(self) -> PaginatedList[Environment]:
    """
        ...
        """
    return PaginatedList(Environment, self._requester, f'{self.url}/environments', None, attributesTransformer=PaginatedList.override_attributes({'environments_url': f'/repositories/{self.id}/environments'}), list_item='environments')