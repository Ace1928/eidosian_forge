...
class LocalStorageDriver(StorageDriver):
    ...
    def __init__(self, key, secret=None, secure=True, host=None, port=None, ex_use_locking=True, **kwargs):
        """
    ...
    def download_object(self, obj, destination_path, overwrite_existing=False, delete_on_failure=True):
        ...
        file_path = self._get_obj_file_path(obj=obj, destination_path=destination_path, overwrite_existing=overwrite_existing)
        try:
    ...
    def download_object_range(self, obj, destination_path, start_bytes, end_bytes=None, overwrite_existing=False, delete_on_failure=True):
        ...
        file_path = self._get_obj_file_path(obj=obj, destination_path=destination_path, overwrite_existing=overwrite_existing)
        iterator = self.download_object_range_as_stream(obj=obj, start_bytes=start_bytes, end_bytes=end_bytes)
