...
class Game(ShowBase):
    def __init__(self):
        ...
        logging.info("Point light configured.")

        # Configure the Bullet physics world
        self.world = BulletWorld()
        self.world.set_gravity(Vec3(0, 0, -9.81))
        logging.info("Bullet physics world configured with gravity.")

        # Configure collision handling mechanisms
        self.traverser = CollisionTraverser()
        self.pusher = CollisionHandlerPusher()
        logging.info("Collision handling mechanisms initialized.")
        ...
        logging.info("Player collision node registered with collision traverser.")
        ...
        logging.info("Update task scheduled.")
    ...
    def create_ground(self):
        ...
        logging.debug("Ground element created and configured.")
    ...
    def create_player(self):
        ...
        logging.debug("Player created with collision sphere defined and configured.")
    ...
    def create_obstacles(self):
        for _ in range(10):
            ...
            np.set_pos(x, y, z)
            self.world.attach_rigid_body(body)
        logging.debug("Obstacles created and configured.")

    def update(self, task):
        dt = globalClock.get_dt()
        self.world.do_physics(dt)
        logging.debug(f"Physics updated for dt: {dt}")
        return task.cont


game = Game()
game.run()
logging.info("Game execution started.")
