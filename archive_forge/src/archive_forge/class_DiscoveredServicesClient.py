...
class DiscoveredServicesClient(object):
    ...
    def __init__(self, release_track=base.ReleaseTrack.ALPHA):
        ...
        self._dis_services_client = self.client.projects_locations_discoveredServices
    ...
    """
        describe_req = self.messages.ApphubProjectsLocationsDiscoveredServicesGetRequest(name=discovered_service)
    ...
    """
        list_req = self.messages.ApphubProjectsLocationsDiscoveredServicesListRequest(parent=parent)
        return list_pager.YieldFromList(self._dis_services_client, list_req, field='discoveredServices', batch_size=page_size, limit=limit, batch_size_attribute='pageSize')
    ...
    Returns:
      Generator of matching discovered services.
    """
        find_unregistered_req = self.messages.ApphubProjectsLocationsDiscoveredServicesFindUnregisteredRequest(parent=parent)
        return list_pager.YieldFromList(self._dis_services_client, find_unregistered_req, method='FindUnregistered', field='discoveredServices', batch_size=page_size, limit=limit, batch_size_attribute='pageSize')
    ...
    """
        lookup_req = self.messages.ApphubProjectsLocationsDiscoveredServicesLookupRequest(parent=parent, uri=uri)
