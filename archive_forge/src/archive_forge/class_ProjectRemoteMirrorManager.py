...
class ProjectRemoteMirrorManager(ListMixin, CreateMixin, UpdateMixin, DeleteMixin, RESTManager):
    _path = '/projects/{project_id}/remote_mirrors'
    _obj_cls = ProjectRemoteMirror
    _from_parent_attrs = {'project_id': 'id'}
    _create_attrs = RequiredOptional(required=('url',), optional=('enabled', 'only_protected_branches'))
