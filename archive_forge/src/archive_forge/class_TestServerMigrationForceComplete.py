...
class TestServerMigrationForceComplete(TestServerMigration):
    ...
    def test_migration_force_complete_pre_v222(self):
        ...
        self.assertIn('--os-compute-api-version 2.22 or greater is required', str(ex))
    ...
    def test_server_migration_force_complete_by_uuid(self):
        ...
        self.compute_sdk_client.force_complete_server_migration.assert_called_with(self.server_migration.id, self.server.id)
        self.assertIsNone(result)
