...
def _check_restricted_actions(self, actions, after, before, after_props, before_props, prev_resource):
    """Checks for restricted actions.
        ...
        """
    try:
        if self.preview_update(after, before, after_props, before_props, prev_resource, check_init_complete=True):
