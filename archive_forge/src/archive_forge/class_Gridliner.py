...
class Gridliner(matplotlib.artist.Artist):
    ...
    def __init__(self, axes, crs, draw_labels=False, xlocator=None, ylocator=None, collection_kwargs=None, xformatter=None, yformatter=None, dms=False, x_inline=None, y_inline=None, auto_inline=True, xlim=None, ylim=None, rotate_labels=None, xlabel_style=None, ylabel_style=None, labels_bbox_style=None, xpadding=5, ypadding=5, offset_angle=25, auto_update=None, formatter_kwargs=None):
        """
        ...
        formatter_kwargs = {**(formatter_kwargs or {}), 'dms': dms}
        ...
        if auto_update is None:
            ...
            warnings.warn('The auto_update parameter was deprecated at Cartopy 0.23.  In future the gridlines and labels will always be updated.', DeprecationWarning)
    ...
    def get_tightbbox(self, renderer=None):
        ...
        bboxes = [c.get_tightbbox(renderer=renderer) for c in self.get_visible_children()]
        if bboxes:
