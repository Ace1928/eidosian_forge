...
class NamespacesClient(sd_base.ServiceDirectoryApiLibBase):
    ...
    def Create(self, namespace_ref, labels=None):
        ...
        create_req = self.msgs.ServicedirectoryProjectsLocationsNamespacesCreateRequest(parent=namespace_ref.Parent().RelativeName(), namespace=namespace, namespaceId=namespace_ref.namespacesId)
        return self.service.Create(create_req)

    def Delete(self, namespace_ref):
        """Namespaces delete request."""
        delete_req = self.msgs.ServicedirectoryProjectsLocationsNamespacesDeleteRequest(name=namespace_ref.RelativeName())
        return self.service.Delete(delete_req)

    def Describe(self, namespace_ref):
        """Namespaces describe request."""
        describe_req = self.msgs.ServicedirectoryProjectsLocationsNamespacesGetRequest(name=namespace_ref.RelativeName())
    ...
    def List(self, location_ref, filter_=None, order_by=None, page_size=None):
        ...
        list_req = self.msgs.ServicedirectoryProjectsLocationsNamespacesListRequest(parent=location_ref.RelativeName(), filter=filter_, orderBy=order_by, pageSize=page_size)
        return list_pager.YieldFromList(self.service, list_req, batch_size=page_size, field='namespaces', batch_size_attribute='pageSize')
    ...
    def Update(self, namespace_ref, labels=None):
        ...
        namespace = self.msgs.Namespace(labels=labels)
        update_req = self.msgs.ServicedirectoryProjectsLocationsNamespacesPatchRequest(name=namespace_ref.RelativeName(), namespace=namespace, updateMask=','.join(mask_parts))
    ...
    def GetIamPolicy(self, namespace_ref):
        ...
        get_req = self.msgs.ServicedirectoryProjectsLocationsNamespacesGetIamPolicyRequest(resource=namespace_ref.RelativeName())
    ...
    def SetIamPolicy(self, namespace_ref, policy):
        ...
        set_req = self.msgs.ServicedirectoryProjectsLocationsNamespacesSetIamPolicyRequest(resource=namespace_ref.RelativeName(), setIamPolicyRequest=self.msgs.SetIamPolicyRequest(policy=policy))
