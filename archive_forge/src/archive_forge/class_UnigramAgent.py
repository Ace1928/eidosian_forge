...
class UnigramAgent(Agent):
    ...
    def add_cmdline_args(cls, parser):
        ...
        """
        parser.add_argument('--num-words', type=int, default=10, help='Number of unigrams to output.')
    ...
    def get_prediction(self):
        ...
        if self.unigram_cache is None:
            most_common = sorted(self.dict.freq.items(), key=lambda x: x[1], reverse=True)
