...
def test_type_encryption_update(self):
    self.verify_get(self.proxy.get_type_encryption, type.TypeEncryption, method_args=['value'], expected_args=[], expected_kwargs={'volume_type_id': 'value', 'requires_id': False})
