...
def test_parse_adopt_stack_data_without_parameters(self):
    ...
    template = {'heat_template_version': '2015-04-30', 'resources': {'myres': {'type': 'OS::Cinder::Volume', 'properties': {'name': 'volname', 'size': '1'}}}}
    args = {'adopt_stack_data': '{}'}
    self.eng._parse_template_and_validate_stack(self.ctx, 'stack_name', template, {}, {}, None, None, args)
    args = {'adopt_stack_data': '{\n            "environment": {}\n        }'}
    self.eng._parse_template_and_validate_stack(self.ctx, 'stack_name', template, {}, {}, None, None, args)