        ...
        tables = {
            ...
            "Oscillators_Momentum": """
                CREATE TABLE IF NOT EXISTS Oscillators_Momentum (
                    ticker TEXT,
                    momentum_rsi_14 REAL,  -- Momentum RSI
                    momentum_mfi_14 REAL,  -- Momentum MFI
                    momentum_tsi_25_13 REAL,  -- Momentum TSI
                    momentum_uo_7_14_28 REAL,  -- Momentum UO
                    momentum_stoch_rsi_14 REAL,  -- Momentum Stoch RSI
                    momentum_stoch_rsi_k_14 REAL,  -- Momentum Stoch RSI %K
                    momentum_stoch_rsi_d_14 REAL,  -- Momentum Stoch RSI %D
                    momentum_wr_14 REAL,  -- Momentum Williams %R
                    momentum_ao REAL,  -- Momentum Awesome Oscillator
                    momentum_kama_10_2_30 REAL,  -- Momentum KAMA
                    momentum_ppo_12_26_9 REAL,  -- Momentum PPO
                    momentum_ppo_signal_12_26_9 REAL,  -- Momentum PPO Signal Line
                    momentum_ppo_hist_12_26_9 REAL,  -- Momentum PPO Histogram
                    momentum_pvo_12_26_9 REAL,  -- Momentum PVO
                    momentum_pvo_signal_12_26_9 REAL,  -- Momentum PVO Signal Line
                    momentum_pvo_hist_12_26_9 REAL,  -- Momentum PVO Histogram
                    momentum_roc_10 REAL,  -- Momentum ROC
                    momentum_roc_100 REAL,  -- Momentum ROC 100
                    momentum_roc_100_sma_10 REAL  -- Momentum ROC 100 SMA 10
                )
            """,
            "Volatility_Indicators": """
                CREATE TABLE IF NOT EXISTS Volatility_Indicators (
                    ticker TEXT,
                    volatility_bbands_20_2 REAL,  -- Volatility Bollinger Bands
                    volatility_bbands_upper_20_2 REAL,  -- Volatility Bollinger Bands Upper Band
                    volatility_bbands_lower_20_2 REAL,  -- Volatility Bollinger Bands Lower Band
                    volatility_bbands_middle_20_2 REAL,  -- Volatility Bollinger Bands Middle Band
                    volatility_kc_20_2 REAL,  -- Volatility Keltner Channels
                    volatility_kc_upper_20_2 REAL,  -- Volatility Keltner Channels Upper Band
                    volatility_kc_lower_20_2 REAL,  -- Volatility Keltner Channels Lower Band
                    volatility_kc_middle_20_2 REAL,  -- Volatility Keltner Channels Middle Band
                    volatility_dch_20 REAL,  -- Volatility Donchian Channels
                    volatility_dch_upper_20 REAL,  -- Volatility Donchian Channels Upper Band
                    volatility_dch_lower_20 REAL,  -- Volatility Donchian Channels Lower Band
                    volatility_dch_middle_20 REAL,  -- Volatility Donchian Channels Middle Band
                    volatility_atr_14 REAL,  -- Volatility ATR
                    volatility_true_range_14 REAL,  -- Volatility True Range
                    volatility_natr_14 REAL  -- Volatility NATR
                )
            """,
            "Volume_Indicators": """
                CREATE TABLE IF NOT EXISTS Volume_Indicators (
                    ticker TEXT,
                    volume_adi REAL,  -- Volume ADI
                    volume_obv REAL,  -- Volume OBV
                    volume_cmf_20 REAL,  -- Volume CMF
                    volume_fi_13 REAL,  -- Volume Force Index
                    volume_em_14_100000000 REAL,  -- Volume Ease of Movement
                    volume_sma_em_14_100000000 REAL,  -- Volume SMA Ease of Movement
                    volume_vpt REAL,  -- Volume VPT
                    volume_nvi REAL,  -- Volume NVI
                    volume_vwap REAL  -- Volume VWAP
                )
            """,
            "Trend_Indicators": """
                CREATE TABLE IF NOT EXISTS Trend_Indicators (
                    ticker TEXT,
                    parabolic_sar_0_02_0_2 REAL, -- Parabolic SAR
                    directional_movement_index_14 REAL, -- Directional Movement Index
                    minus_directional_indicator_14 REAL, -- Minus Directional Indicator
                    plus_directional_indicator_14 REAL, -- Plus Directional Indicator
                    average_directional_index_14 REAL, -- Average Directional Index
                    trend_adx_14 REAL,  -- Trend ADX 14
                    trend_adx_pos_di_14 REAL,  -- Trend ADX Positive DI
                    trend_adx_neg_di_14 REAL,  -- Trend ADX Negative DI
                    trend_cci_14 REAL,  -- Trend CCI
                    trend_macd_12_26_9 REAL,  -- Trend MACD
                    trend_macd_signal_12_26_9 REAL,  -- Trend MACD Signal Line
                    trend_macd_diff_12_26_9 REAL,  -- Trend MACD Difference
                    trend_ema_fast_12 REAL,  -- Trend EMA Fast
                    trend_ema_slow_26 REAL,  -- Trend EMA Slow
                    trend_ichimoku_a_9_26_52 REAL,  -- Trend Ichimoku A
                    trend_ichimoku_b_9_26_52 REAL,  -- Trend Ichimoku B
                    trend_ichimoku_base_line_9_26_52 REAL,  -- Trend Ichimoku Base Line
                    trend_ichimoku_conversion_line_9_26_52 REAL,  -- Trend Ichimoku Conversion Line
                    trend_kst_10_15_20_30 REAL,  -- Trend KST
                    trend_kst_sig_10_15_20_30 REAL,  -- Trend KST Signal Line
                    trend_kst_diff_10_15_20_30 REAL,  -- Trend KST Difference
                    trend_psar_0_02_0_2 REAL,  -- Trend PSAR
                    trend_psar_up_indicator REAL,  -- Trend PSAR Up Indicator
                    trend_psar_down_indicator REAL,  -- Trend PSAR Down Indicator
                    trend_stc_10_12_26_9 REAL,  -- Trend STC
                    trend_trix_30_9 REAL,  -- Trend Trix
                    trend_vortex_ind_pos_14 REAL,  -- Trend Vortex Indicator Positive DI
                    trend_vortex_ind_neg_14 REAL,  -- Trend Vortex Indicator Negative DI
                    trend_vortex_ind_diff_14 REAL  -- Trend Vortex Indicator Difference
                )
            """,
            "Price_Patterns_Candlesticks": """
                CREATE TABLE IF NOT EXISTS Price_Patterns_Candlesticks (
                    ticker TEXT,
                    pattern_recognition_cdl2crows REAL,  -- Pattern Recognition CDL 2 Crows
                    pattern_recognition_cdl3blackcrows REAL,  -- Pattern Recognition CDL 3 Black Crows
                    pattern_recognition_cdl3inside REAL,  -- Pattern Recognition CDL 3 Inside
                    pattern_recognition_cdl3linestrike REAL,  -- Pattern Recognition CDL 3 Line Strike
                    pattern_recognition_cdl3outside REAL,  -- Pattern Recognition CDL 3 Outside
                    pattern_recognition_cdl3starsinsouth REAL,  -- Pattern Recognition CDL 3 Stars In South
                    pattern_recognition_cdl3whitesoldiers REAL,  -- Pattern Recognition CDL 3 White Soldiers
                    pattern_recognition_cdlabandonedbaby REAL,  -- Pattern Recognition CDL Abandoned Baby
                    pattern_recognition_cdladvanceblock REAL,  -- Pattern Recognition CDL Advance Block
                    pattern_recognition_cdlbelthold REAL,  -- Pattern Recognition CDL Belt Hold
                    pattern_recognition_cdlbreakaway REAL,  -- Pattern Recognition CDL Breakaway
                    pattern_recognition_cdlclosingmarubozu REAL,  -- Pattern Recognition CDL Closing Marubozu
                    pattern_recognition_cdlconcealbabyswall REAL,  -- Pattern Recognition CDL Conceal Baby Swall
                    pattern_recognition_cdlcounterattack REAL,  -- Pattern Recognition CDL Counterattack
                    pattern_recognition_cdldarkcloudcover REAL,  -- Pattern Recognition CDL Dark Cloud Cover
                    pattern_recognition_cdldoji REAL,  -- Pattern Recognition CDL Doji
                    pattern_recognition_cdldojistar REAL,  -- Pattern Recognition CDL Doji Star
                    pattern_recognition_cdldragonflydoji REAL,  -- Pattern Recognition CDL Dragonfly Doji
                    pattern_recognition_cdlengulfing REAL,  -- Pattern Recognition CDL Engulfing
                    pattern_recognition_cdleveningdojistar REAL,  -- Pattern Recognition CDL Evening Doji Star
                    pattern_recognition_cdleveningstar REAL,  -- Pattern Recognition CDL Evening Star
                    pattern_recognition_cdlgapsidesidewhite REAL,  -- Pattern Recognition CDL Gap Side Side White
                    pattern_recognition_cdlgravestonedoji REAL,  -- Pattern Recognition CDL Gravestone Doji
                    pattern_recognition_cdlhammer REAL,  -- Pattern Recognition CDL Hammer
                    pattern_recognition_cdlhangingman REAL,  -- Pattern Recognition CDL Hanging Man
                    pattern_recognition_cdlharami REAL,  -- Pattern Recognition CDL Harami
                    pattern_recognition_cdlharamicross REAL,  -- Pattern Recognition CDL Harami Cross
                    pattern_recognition_cdlhighwave REAL,  -- Pattern Recognition CDL High Wave
                    pattern_recognition_cdlhikkake REAL,  -- Pattern Recognition CDL Hikkake
                    pattern_recognition_cdlhikkakemod REAL,  -- Pattern Recognition CDL Hikkake Modified
                    pattern_recognition_cdlhomingpigeon REAL,  -- Pattern Recognition CDL Homing Pigeon
                    pattern_recognition_cdlidentical3crows REAL,  -- Pattern Recognition CDL Identical 3 Crows
                    pattern_recognition_cdlinneck REAL,  -- Pattern Recognition CDL In Neck
                    pattern_recognition_cdlinvertedhammer REAL,  -- Pattern Recognition CDL Inverted Hammer
                    pattern_recognition_cdlkicking REAL,  -- Pattern Recognition CDL Kicking
                    pattern_recognition_cdlkickingbylength REAL,  -- Pattern Recognition CDL Kicking By Length
                    pattern_recognition_cdlladderbottom REAL,  -- Pattern Recognition CDL Ladder Bottom
                    pattern_recognition_cdllongleggeddoji REAL,  -- Pattern Recognition CDL Long Legged Doji
                    pattern_recognition_cdllongline REAL,  -- Pattern Recognition CDL Long Line
                    pattern_recognition_cdlmarubozu REAL,  -- Pattern Recognition CDL Marubozu
                    pattern_recognition_cdlmatchinglow REAL,  -- Pattern Recognition CDL Matching Low
                    pattern_recognition_cdlmathold REAL,  -- Pattern Recognition CDL Mat Hold
                    pattern_recognition_cdlmorningdojistar REAL,  -- Pattern Recognition CDL Morning Doji Star
                    pattern_recognition_cdlmorningstar REAL,  -- Pattern Recognition CDL Morning Star
                    pattern_recognition_cdlonneck REAL,  -- Pattern Recognition CDL On Neck
                    pattern_recognition_cdlpiercing REAL,  -- Pattern Recognition CDL Piercing
                    pattern_recognition_cdlrickshawman REAL,  -- Pattern Recognition CDL Rickshaw Man
                    pattern_recognition_cdlrisefall3methods REAL,  -- Pattern Recognition CDL Rise Fall 3 Methods
                    pattern_recognition_cdlseparatinglines REAL,  -- Pattern Recognition CDL Separating Lines
                    pattern_recognition_cdlshootingstar REAL,  -- Pattern Recognition CDL Shooting Star
                    pattern_recognition_cdlshortline REAL,  -- Pattern Recognition CDL Short Line
                    pattern_recognition_cdlspinningtop REAL,  -- Pattern Recognition CDL Spinning Top
                    pattern_recognition_cdlstalledpattern REAL,  -- Pattern Recognition CDL Stalled Pattern
                    pattern_recognition_cdlsticksandwich REAL,  -- Pattern Recognition CDL Stick Sandwich
                    pattern_recognition_cdltakuri REAL,  -- Pattern Recognition CDL Takuri
                    pattern_recognition_cdltasukigap REAL,  -- Pattern Recognition CDL Tasuki Gap
                    pattern_recognition_cdlthrusting REAL,  -- Pattern Recognition CDL Thrusting
                    pattern_recognition_cdltristar REAL,  -- Pattern Recognition CDL Tristar
                    pattern_recognition_cdlunique3river REAL,  -- Pattern Recognition CDL Unique 3 River
                    pattern_recognition_cdlupsidegap2crows REAL,  -- Pattern Recognition CDL Upside Gap 2 Crows
                    pattern_recognition_cdlxsidegap3methods REAL  -- Pattern Recognition CDL X Side Gap 3 Methods
                )
            """,
