def test_gaussian_cmdline(cli):
    ...
    cli.shell('    ase build O O.xyz && ase run gaussian O.xyz -o gaussian_cmdline.json &&\n    ase build O2 O2.xyz && ase run gaussian O2.xyz -o gaussian_cmdline.json', 'gaussian')
