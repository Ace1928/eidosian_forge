...
class Hub(with_metaclass(HubMeta)):
    ...
    def last_event_id(self):
        ...
        """
        logger.warning('Deprecated: last_event_id is deprecated. This will be removed in the future. The functions `capture_event`, `capture_message`, and `capture_exception` return the event ID directly.')
    ...
    def capture_event(self, event, hint=None, scope=None, **scope_kwargs):
        ...
        if client is None:
            return None
        last_event_id = top_scope.capture_event(event, hint, client=client, scope=scope, **scope_kwargs)
    ...
    def capture_message(self, message, level=None, scope=None, **scope_kwargs):
        ...
        if client is None:
            return None
        last_event_id = top_scope.capture_message(message, level=level, client=client, scope=scope, **scope_kwargs)
    ...
    def capture_exception(self, error=None, scope=None, **scope_kwargs):
        ...
        if client is None:
            return None
        last_event_id = top_scope.capture_exception(error, client=client, scope=scope, **scope_kwargs)
        if last_event_id is not None:
            self._last_event_id = last_event_id
        return last_event_id
    ...
    def start_transaction(self, transaction=None, instrumenter=INSTRUMENTER.SENTRY, **kwargs):
        """
    ...
    def continue_trace(self, environ_or_headers, op=None, name=None, source=None):
        ...
        return scope.continue_trace(environ_or_headers=environ_or_headers, op=op, name=name, source=source)
    ...
    def start_session(self, session_mode='application'):
        """Starts a new session."""
        client, scope = self._stack[-1]
        scope.start_session(client=client, session_mode=session_mode)
