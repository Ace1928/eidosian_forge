...
def export_image_decoder_decode_pnm_rgb() -> None:
    ...
    data, output = _generate_test_data('ppm', _image_decoder_data.image_decoder_decode_pnm_rgb, 'RGB')
    expect(node, inputs=[data], outputs=[output], name='test_image_decoder_decode_pnm_rgb')