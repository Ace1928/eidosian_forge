...
def decode_list_object_versions(parsed, context, **kwargs):
    _decode_list_object(top_level_keys=['KeyMarker', 'NextKeyMarker', 'Prefix', 'Delimiter'], nested_keys=[('Versions', 'Key'), ('DeleteMarkers', 'Key'), ('CommonPrefixes', 'Prefix')], parsed=parsed, context=context)