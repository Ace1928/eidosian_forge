...
class TestShowBaremetalDeployTemplate(TestBaremetalDeployTemplate):
    ...
    def setUp(self):
        ...
        self.baremetal_mock.deploy_template.get.return_value = baremetal_fakes.FakeBaremetalResource(None, copy.deepcopy(baremetal_fakes.DEPLOY_TEMPLATE), loaded=True)
        self.cmd = baremetal_deploy_template.ShowBaremetalDeployTemplate(self.app, None)
