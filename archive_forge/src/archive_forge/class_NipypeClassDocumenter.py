...
class NipypeClassDocumenter(_ClassDocumenter):
    priority = 20
    ...
    def add_directive_header(self, sig: str) -> None:
        ...
        if is_interface is True:
            lines = RST_CLASS_BLOCK.format(code_url=get_url(self.object), module=self.modname, name=name, underline='=' * len(name))
