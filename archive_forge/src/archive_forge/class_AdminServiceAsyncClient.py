...
class AdminServiceAsyncClient:
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        """
        return AdminServiceClient.from_service_account_info.__func__(AdminServiceAsyncClient, info, *args, **kwargs)
    ...
    def from_service_account_file(cls, filename: str, *args, **kwargs):
        ...
        Returns:
            AdminServiceAsyncClient: The constructed client.
        """
        return AdminServiceClient.from_service_account_file.__func__(AdminServiceAsyncClient, filename, *args, **kwargs)
    ...
    def get_mtls_endpoint_and_cert_source(cls, client_options: Optional[ClientOptions]=None):
        ...
        """
        return AdminServiceClient.get_mtls_endpoint_and_cert_source(client_options)
    ...
    def __init__(self, *, credentials: Optional[ga_credentials.Credentials]=None, transport: Union[str, AdminServiceTransport]='grpc_asyncio', client_options: Optional[ClientOptions]=None, client_info: gapic_v1.client_info.ClientInfo=DEFAULT_CLIENT_INFO) -> None:
        ...
        """
        self._client = AdminServiceClient(credentials=credentials, transport=transport, client_options=client_options, client_info=client_info)

    async def create_topic(self, request: Optional[Union[admin.CreateTopicRequest, dict]]=None, *, parent: Optional[str]=None, topic: Optional[common.Topic]=None, topic_id: Optional[str]=None, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> common.Topic:
        """Creates a new topic.
        ...
        rpc = gapic_v1.method_async.wrap_method(self._client._transport.create_topic, default_timeout=None, client_info=DEFAULT_CLIENT_INFO)
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((('parent', request.parent),)),)
        response = await rpc(request, retry=retry, timeout=timeout, metadata=metadata)
        return response

    async def get_topic(self, request: Optional[Union[admin.GetTopicRequest, dict]]=None, *, name: Optional[str]=None, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> common.Topic:
        ...
        if name is not None:
            request.name = name
        rpc = gapic_v1.method_async.wrap_method(self._client._transport.get_topic, default_timeout=None, client_info=DEFAULT_CLIENT_INFO)
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((('name', request.name),)),)
        response = await rpc(request, retry=retry, timeout=timeout, metadata=metadata)
        return response

    async def get_topic_partitions(self, request: Optional[Union[admin.GetTopicPartitionsRequest, dict]]=None, *, name: Optional[str]=None, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> admin.TopicPartitions:
        ...
        if name is not None:
            request.name = name
        rpc = gapic_v1.method_async.wrap_method(self._client._transport.get_topic_partitions, default_timeout=None, client_info=DEFAULT_CLIENT_INFO)
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((('name', request.name),)),)
        response = await rpc(request, retry=retry, timeout=timeout, metadata=metadata)
        return response

    async def list_topics(self, request: Optional[Union[admin.ListTopicsRequest, dict]]=None, *, parent: Optional[str]=None, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> pagers.ListTopicsAsyncPager:
        ...
        if parent is not None:
            request.parent = parent
        rpc = gapic_v1.method_async.wrap_method(self._client._transport.list_topics, default_timeout=None, client_info=DEFAULT_CLIENT_INFO)
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((('parent', request.parent),)),)
        response = await rpc(request, retry=retry, timeout=timeout, metadata=metadata)
        response = pagers.ListTopicsAsyncPager(method=rpc, request=request, response=response, metadata=metadata)
        return response

    async def update_topic(self, request: Optional[Union[admin.UpdateTopicRequest, dict]]=None, *, topic: Optional[common.Topic]=None, update_mask: Optional[field_mask_pb2.FieldMask]=None, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> common.Topic:
        ...
        rpc = gapic_v1.method_async.wrap_method(self._client._transport.update_topic, default_timeout=None, client_info=DEFAULT_CLIENT_INFO)
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((('topic.name', request.topic.name),)),)
        response = await rpc(request, retry=retry, timeout=timeout, metadata=metadata)
        return response

    async def delete_topic(self, request: Optional[Union[admin.DeleteTopicRequest, dict]]=None, *, name: Optional[str]=None, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> None:
        ...
        if name is not None:
            request.name = name
        rpc = gapic_v1.method_async.wrap_method(self._client._transport.delete_topic, default_timeout=None, client_info=DEFAULT_CLIENT_INFO)
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((('name', request.name),)),)
        await rpc(request, retry=retry, timeout=timeout, metadata=metadata)

    async def list_topic_subscriptions(self, request: Optional[Union[admin.ListTopicSubscriptionsRequest, dict]]=None, *, name: Optional[str]=None, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> pagers.ListTopicSubscriptionsAsyncPager:
        ...
        if name is not None:
            request.name = name
        rpc = gapic_v1.method_async.wrap_method(self._client._transport.list_topic_subscriptions, default_timeout=None, client_info=DEFAULT_CLIENT_INFO)
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((('name', request.name),)),)
        response = await rpc(request, retry=retry, timeout=timeout, metadata=metadata)
        response = pagers.ListTopicSubscriptionsAsyncPager(method=rpc, request=request, response=response, metadata=metadata)
        return response
    ...
    async def create_subscription(self, request: Optional[Union[admin.CreateSubscriptionRequest, dict]]=None, *, parent: Optional[str]=None, subscription: Optional[common.Subscription]=None, subscription_id: Optional[str]=None, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> common.Subscription:
        ...
        rpc = gapic_v1.method_async.wrap_method(self._client._transport.create_subscription, default_timeout=None, client_info=DEFAULT_CLIENT_INFO)
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((('parent', request.parent),)),)
        response = await rpc(request, retry=retry, timeout=timeout, metadata=metadata)
        return response

    async def get_subscription(self, request: Optional[Union[admin.GetSubscriptionRequest, dict]]=None, *, name: Optional[str]=None, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> common.Subscription:
        ...
        if name is not None:
            request.name = name
        rpc = gapic_v1.method_async.wrap_method(self._client._transport.get_subscription, default_timeout=None, client_info=DEFAULT_CLIENT_INFO)
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((('name', request.name),)),)
        response = await rpc(request, retry=retry, timeout=timeout, metadata=metadata)
        return response

    async def list_subscriptions(self, request: Optional[Union[admin.ListSubscriptionsRequest, dict]]=None, *, parent: Optional[str]=None, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> pagers.ListSubscriptionsAsyncPager:
    ...
    async def update_subscription(self, request: Optional[Union[admin.UpdateSubscriptionRequest, dict]]=None, *, subscription: Optional[common.Subscription]=None, update_mask: Optional[field_mask_pb2.FieldMask]=None, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> common.Subscription:
        ...
        if update_mask is not None:
            request.update_mask = update_mask
        rpc = gapic_v1.method_async.wrap_method(self._client._transport.update_subscription, default_timeout=None, client_info=DEFAULT_CLIENT_INFO)
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((('subscription.name', request.subscription.name),)),)
        response = await rpc(request, retry=retry, timeout=timeout, metadata=metadata)
        return response

    async def delete_subscription(self, request: Optional[Union[admin.DeleteSubscriptionRequest, dict]]=None, *, name: Optional[str]=None, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> None:
        ...
        if name is not None:
            request.name = name
        rpc = gapic_v1.method_async.wrap_method(self._client._transport.delete_subscription, default_timeout=None, client_info=DEFAULT_CLIENT_INFO)
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((('name', request.name),)),)
        await rpc(request, retry=retry, timeout=timeout, metadata=metadata)

    async def seek_subscription(self, request: Optional[Union[admin.SeekSubscriptionRequest, dict]]=None, *, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> operation_async.AsyncOperation:
        ...
        rpc = gapic_v1.method_async.wrap_method(self._client._transport.seek_subscription, default_timeout=None, client_info=DEFAULT_CLIENT_INFO)
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((('name', request.name),)),)
        response = await rpc(request, retry=retry, timeout=timeout, metadata=metadata)
        response = operation_async.from_gapic(response, self._client._transport.operations_client, admin.SeekSubscriptionResponse, metadata_type=admin.OperationMetadata)
        return response

    async def create_reservation(self, request: Optional[Union[admin.CreateReservationRequest, dict]]=None, *, parent: Optional[str]=None, reservation: Optional[common.Reservation]=None, reservation_id: Optional[str]=None, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> common.Reservation:
        ...
        rpc = gapic_v1.method_async.wrap_method(self._client._transport.create_reservation, default_timeout=None, client_info=DEFAULT_CLIENT_INFO)
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((('parent', request.parent),)),)
        response = await rpc(request, retry=retry, timeout=timeout, metadata=metadata)
        return response

    async def get_reservation(self, request: Optional[Union[admin.GetReservationRequest, dict]]=None, *, name: Optional[str]=None, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> common.Reservation:
        ...
        if name is not None:
            request.name = name
        rpc = gapic_v1.method_async.wrap_method(self._client._transport.get_reservation, default_timeout=None, client_info=DEFAULT_CLIENT_INFO)
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((('name', request.name),)),)
        response = await rpc(request, retry=retry, timeout=timeout, metadata=metadata)
        return response

    async def list_reservations(self, request: Optional[Union[admin.ListReservationsRequest, dict]]=None, *, parent: Optional[str]=None, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> pagers.ListReservationsAsyncPager:
        ...
        if parent is not None:
            request.parent = parent
        rpc = gapic_v1.method_async.wrap_method(self._client._transport.list_reservations, default_timeout=None, client_info=DEFAULT_CLIENT_INFO)
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((('parent', request.parent),)),)
        response = await rpc(request, retry=retry, timeout=timeout, metadata=metadata)
        response = pagers.ListReservationsAsyncPager(method=rpc, request=request, response=response, metadata=metadata)
        return response
    ...
    async def update_reservation(self, request: Optional[Union[admin.UpdateReservationRequest, dict]]=None, *, reservation: Optional[common.Reservation]=None, update_mask: Optional[field_mask_pb2.FieldMask]=None, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> common.Reservation:
        ...
        if update_mask is not None:
            request.update_mask = update_mask
        rpc = gapic_v1.method_async.wrap_method(self._client._transport.update_reservation, default_timeout=None, client_info=DEFAULT_CLIENT_INFO)
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((('reservation.name', request.reservation.name),)),)
        response = await rpc(request, retry=retry, timeout=timeout, metadata=metadata)
        return response

    async def delete_reservation(self, request: Optional[Union[admin.DeleteReservationRequest, dict]]=None, *, name: Optional[str]=None, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> None:
        ...
        if name is not None:
            request.name = name
        rpc = gapic_v1.method_async.wrap_method(self._client._transport.delete_reservation, default_timeout=None, client_info=DEFAULT_CLIENT_INFO)
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((('name', request.name),)),)
        await rpc(request, retry=retry, timeout=timeout, metadata=metadata)

    async def list_reservation_topics(self, request: Optional[Union[admin.ListReservationTopicsRequest, dict]]=None, *, name: Optional[str]=None, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> pagers.ListReservationTopicsAsyncPager:
        ...
        if name is not None:
            request.name = name
        rpc = gapic_v1.method_async.wrap_method(self._client._transport.list_reservation_topics, default_timeout=None, client_info=DEFAULT_CLIENT_INFO)
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((('name', request.name),)),)
        response = await rpc(request, retry=retry, timeout=timeout, metadata=metadata)
        response = pagers.ListReservationTopicsAsyncPager(method=rpc, request=request, response=response, metadata=metadata)
        return response

    async def list_operations(self, request: Optional[operations_pb2.ListOperationsRequest]=None, *, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> operations_pb2.ListOperationsResponse:
        ...
        rpc = gapic_v1.method.wrap_method(self._client._transport.list_operations, default_timeout=None, client_info=DEFAULT_CLIENT_INFO)
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((('name', request.name),)),)
        response = await rpc(request, retry=retry, timeout=timeout, metadata=metadata)
        return response

    async def get_operation(self, request: Optional[operations_pb2.GetOperationRequest]=None, *, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> operations_pb2.Operation:
        ...
        rpc = gapic_v1.method.wrap_method(self._client._transport.get_operation, default_timeout=None, client_info=DEFAULT_CLIENT_INFO)
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((('name', request.name),)),)
        response = await rpc(request, retry=retry, timeout=timeout, metadata=metadata)
        return response

    async def delete_operation(self, request: Optional[operations_pb2.DeleteOperationRequest]=None, *, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> None:
        ...
        rpc = gapic_v1.method.wrap_method(self._client._transport.delete_operation, default_timeout=None, client_info=DEFAULT_CLIENT_INFO)
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((('name', request.name),)),)
        await rpc(request, retry=retry, timeout=timeout, metadata=metadata)

    async def cancel_operation(self, request: Optional[operations_pb2.CancelOperationRequest]=None, *, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> None:
        ...
        rpc = gapic_v1.method.wrap_method(self._client._transport.cancel_operation, default_timeout=None, client_info=DEFAULT_CLIENT_INFO)
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((('name', request.name),)),)
        await rpc(request, retry=retry, timeout=timeout, metadata=metadata)
