...
def parse_logout_request(self, xmlstr, binding=BINDING_SOAP, relay_state=None, sigalg=None, signature=None):
    """Deal with a LogoutRequest
        ...
        :return: None if the reply doesn't contain a valid SAML LogoutResponse,
            ...
            was not.
        """
    return self._parse_request(enc_request=xmlstr, request_cls=saml_request.LogoutRequest, service='single_logout_service', binding=binding, relay_state=relay_state, sigalg=sigalg, signature=signature)