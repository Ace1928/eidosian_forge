...
class BaseGenericPlugin(base.BaseIdentityPlugin, metaclass=abc.ABCMeta):
    ...
    def __init__(self, auth_url, tenant_id=None, tenant_name=None, project_id=None, project_name=None, project_domain_id=None, project_domain_name=None, domain_id=None, domain_name=None, system_scope=None, trust_id=None, default_domain_id=None, default_domain_name=None, reauthenticate=True):
        super(BaseGenericPlugin, self).__init__(auth_url=auth_url, reauthenticate=reauthenticate)
    ...
    def get_cache_id_elements(self, _implemented=False):
        ...
        return {'auth_url': self.auth_url, 'project_id': self._project_id, 'project_name': self._project_name, 'project_domain_id': self.project_domain_id, 'project_domain_name': self.project_domain_name, 'domain_id': self._domain_id, 'domain_name': self._domain_name, 'trust_id': self._trust_id}