    ...
    def validate_inputs(self, func: F, *args: Any, **kwargs: Any) -> None:
        ...
        for arg, value in bound_arguments.arguments.items():
            ...
            if expected_type is not None:
                # Skip isinstance check for complex types from the typing module
                if hasattr(
                    expected_type, "__origin__"
                ):  # This is a simple check for complex types
                    continue  # Skip isinstance check for complex types
