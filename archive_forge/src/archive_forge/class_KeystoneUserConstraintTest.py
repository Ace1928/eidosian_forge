...
class KeystoneUserConstraintTest(common.HeatTestCase):
    ...
    def test_expected_exceptions(self):
        self.assertEqual((exception.EntityNotFound,), ks_constr.KeystoneUserConstraint.expected_exceptions, 'KeystoneUserConstraint expected exceptions error')
    ...
    def test_constraint(self):
        ...
        self.assertIsNone(constraint.validate_with_client(client_mock, 'admin'))
