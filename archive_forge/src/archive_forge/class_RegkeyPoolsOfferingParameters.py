...
class RegkeyPoolsOfferingParameters(BaseParameters):
    api_map = {'regKey': 'registration_key', 'licenseState': 'license_state', 'status': 'state'}
    returnables = ['name', 'dossier', 'state', 'licensed_date_time', 'licensed_version', 'evaluation_start_date_time', 'evaluation_end_date_time', 'license_end_date_time', 'license_start_date_time', 'registration_key']
