...
class VCTK_092(Dataset):
    ...
    def __init__(self, root: str, mic_id: str='mic2', download: bool=False, url: str=URL, audio_ext='.flac'):
    ...
    def _load_sample(self, speaker_id: str, utterance_id: str, mic_id: str) -> SampleType:
        ...
        audio_path = os.path.join(self._audio_dir, speaker_id, f'{speaker_id}_{utterance_id}_{mic_id}{self._audio_ext}')
