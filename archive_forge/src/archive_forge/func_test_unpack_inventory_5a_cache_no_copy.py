...
def test_unpack_inventory_5a_cache_no_copy(self):
    ...
    inv = breezy.bzr.xml5.serializer_v5.read_inventory_from_lines(breezy.osutils.split_lines(_inventory_v5a), revision_id=b'test-rev-id', entry_cache=entry_cache, return_from_cache=True)
