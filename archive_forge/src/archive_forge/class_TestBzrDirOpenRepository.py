...
class TestBzrDirOpenRepository(TestRemote):
    ...
    def test_backwards_compat_1_2_3(self):
        ...
        self.assertEqual([('call', b'BzrDir.find_repositoryV3', (b'quack/',)), ('call', b'BzrDir.find_repositoryV2', (b'quack/',)), ('call', b'BzrDir.find_repository', (b'quack/',)), ('call_expecting_body', b'get', (b'/quack/.bzr/branch-format',)), ('call', b'stat', (b'/quack/.bzr',)), ('call_expecting_body', b'get', (b'/quack/.bzr/repository/format',)), ('call', b'stat', (b'/quack/.bzr/repository',))], client._calls)
