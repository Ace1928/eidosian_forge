...
def CreateYamlLoader(impl_path):
  ...
  """
    ...
    loader.constructor.add_constructor(Constructor.INCLUDE_COMMON_MACRO, Constructor.IncludeCommon)
    loader.constructor.add_constructor(Constructor.INCLUDE_REF_MACRO, Constructor.IncludeRef)
    return loader