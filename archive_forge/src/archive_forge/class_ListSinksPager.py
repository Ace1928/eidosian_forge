...
class ListSinksPager:
    ...
    def __init__(self, method: Callable[..., logging_config.ListSinksResponse], request: logging_config.ListSinksRequest, response: logging_config.ListSinksResponse, *, metadata: Sequence[Tuple[str, str]]=()):
