...
class MediaCipher(object):
    ...
    def encrypt(self, plaintext, ref_key, media_info):
        ...
        cipher_encryptor = Cipher(algorithms.AES(key), modes.CBC(iv), backend=default_backend()).encryptor()
    ...
    def decrypt(self, ciphertext, ref_key, media_info):
        ...
        cipher_decryptor = Cipher(algorithms.AES(key), modes.CBC(iv), backend=default_backend()).decryptor()
