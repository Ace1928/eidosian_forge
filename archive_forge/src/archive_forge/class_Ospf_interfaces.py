...
class Ospf_interfaces(ResourceModule):
    ...
    def __init__(self, module):
        super(Ospf_interfaces, self).__init__(empty_fact_val={}, facts_module=Facts(module), module=module, resource='ospf_interfaces', tmplt=Ospf_interfacesTemplate())
        self.parsers = ['authentication_password', 'authentication_md5', 'bandwidth', 'cost', 'hello_interval', 'dead_interval', 'mtu_ignore', 'network', 'priority', 'retransmit_interval', 'transmit_delay', 'ifmtu', 'instance', 'passive']
