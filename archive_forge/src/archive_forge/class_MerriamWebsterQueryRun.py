...
class MerriamWebsterQueryRun(BaseTool):
    ...
    description: str = 'A wrapper around Merriam-Webster. Useful for when you need to get the definition of a word.Input should be the word you want the definition of.'
