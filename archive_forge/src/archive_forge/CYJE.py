...
VALIDATION_RULES_FILE = '/home/lloyd/EVIE/scripts/INDEGO_project_development/config/validation_rules.json'
...
MODULES = ensure_module_config_exists(VALIDATION_RULES_FILE)
