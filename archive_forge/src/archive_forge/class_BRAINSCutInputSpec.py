...
class BRAINSCutInputSpec(CommandLineInputSpec):
    ...
    multiStructureThreshold = traits.Bool(desc='multiStructureThreshold module to deal with overlapping area', argstr='--multiStructureThreshold ')
    histogramEqualization = traits.Bool(desc='A Histogram Equalization process could be added to the creating/applying process from Subject To Atlas. Default is false, which generate input vectors without Histogram Equalization. ', argstr='--histogramEqualization ')
