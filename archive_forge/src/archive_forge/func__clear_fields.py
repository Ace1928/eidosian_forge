...
def _clear_fields(args, messages, job):
    ...
    if getattr(job.transferSpec, 'transferOptions', None):
        ...
        if transfer_options.metadataOptions:
            ...
            if args.clear_preserve_metadata:
                ...
                if existing_metadata_options.storageClass != messages.MetadataOptions.StorageClassValueValuesEnum.STORAGE_CLASS_PRESERVE:
                    new_metadata_options.storageClass = existing_metadata_options.storageClass
    ...
    if getattr(job.transferSpec, 'awsS3CompatibleDataSource', None):
        ...
        s3_compatible_metadata = getattr(job.transferSpec.awsS3CompatibleDataSource, 's3Metadata', None)
