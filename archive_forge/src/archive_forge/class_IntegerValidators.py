...
class IntegerValidators:
    ...
    async def is_between(value: Any, lower_bound: int, upper_bound: int) -> bool:
        ...
        """
        return await IntegerValidators.is_integer(value) and lower_bound <= value <= upper_bound
    ...
    @staticmethod
    async def is_positive_between(value: Any, lower_bound: int, upper_bound: int) -> bool:
        """
        ...
        """
        return await IntegerValidators.is_positive(value) and lower_bound < value < upper_bound

    @staticmethod
    async def is_negative_between(value: Any, lower_bound: int, upper_bound: int) -> bool:
        """
        ...
        """
        return await IntegerValidators.is_negative(value) and lower_bound < value < upper_bound
