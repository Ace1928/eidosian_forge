...
cache: CacheType = acache.cache
file_cache_path: str = acache.cache_path
file_io_lock: afile.Lock = afile.Lock()
function_name: str = func.__name__  # Get the name of the function
args: ArgsType = func.__code__.co_varnames  # Get the arguments of the function
kwargs: KwargsType = func.__defaults__  # Get the keyword arguments of the function
...
exception: ExceptionType = Exception  # Define the exception type
...
class SyncAsyncLauncher:
    ...
    def __init__(self) -> None:
        ...
        self.file_io_lock: afile.Lock = afile.Lock()
