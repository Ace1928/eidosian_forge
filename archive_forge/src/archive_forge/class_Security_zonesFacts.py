    ...
    def render_config(self, spec, conf):
        ...
        if 'functional-zone' in conf:
            ...
            if 'host-inbound-traffic' in functional_zone_management:
                security_zones_config['functional_zone_management']['host_inbound_traffic'] = self.parse_host_inbound_traffic(functional_zone_management['host-inbound-traffic'])
            if 'interfaces' in functional_zone_management:
                ...
                security_zones_config['functional_zone_management']['interfaces'] = [interface['name'] for interface in functional_zone_management['interfaces']]
            ...
            for security_zone in security_zones_list:
                ...
                if 'advanced-connection-tracking' in security_zone:
                    ...
                    if 'timeout' in security_zone['advanced-connection-tracking']:
                        temp_act['timeout'] = security_zone['advanced-connection-tracking']['timeout']
                    if 'track-all-policies-to-this-zone' in security_zone['advanced-connection-tracking']:
