...
class AsyncCheckpoints(AsyncAPIResource):
    ...
    def list(self, fine_tuning_job_id: str, *, after: str | NotGiven=NOT_GIVEN, limit: int | NotGiven=NOT_GIVEN, extra_headers: Headers | None=None, extra_query: Query | None=None, extra_body: Body | None=None, timeout: float | httpx.Timeout | None | NotGiven=NOT_GIVEN) -> AsyncPaginator[FineTuningJobCheckpoint, AsyncCursorPage[FineTuningJobCheckpoint]]:
        """
