...
def internal_convert_n_to_tensor(values, dtype=None, name=None, as_ref=False, preferred_dtype=None, ctx=None) -> List[Union[tensor_lib.Tensor, internal.IndexedSlices]]:
