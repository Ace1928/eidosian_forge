...
class KernelRidge(MultiOutputMixin, RegressorMixin, BaseEstimator):
    ...
    * Kevin P. Murphy
    ...
    """
    _parameter_constraints: dict = {'alpha': [Interval(Real, 0, None, closed='left'), 'array-like'], 'kernel': [StrOptions(set(PAIRWISE_KERNEL_FUNCTIONS.keys()) | {'precomputed'}), callable], 'gamma': [Interval(Real, 0, None, closed='left'), None], 'degree': [Interval(Real, 0, None, closed='left')], 'coef0': [Interval(Real, None, None, closed='neither')], 'kernel_params': [dict, None]}
