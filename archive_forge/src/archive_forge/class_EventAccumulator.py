...
class EventAccumulator:
    ...
    def __init__(self, path, size_guidance=None, tensor_size_guidance=None, purge_orphaned_data=True, event_file_active_filter=None, detect_file_replacement=None):
        ...
        self.path = path
        self._generator = _GeneratorFromPath(path, event_file_active_filter, detect_file_replacement)
    ...
    def GetSourceWriter(self) -> Optional[str]:
        ...
        with self._generator_mutex:
            try:
                ...
                logger.info('End of file in %s, no source writer was found.', self.path)
    ...
    def _GetTensorReservoirSize(self, tag):
        ...
        if summary_metadata is None:
            return default
        return self._tensor_size_guidance.get(summary_metadata.plugin_data.plugin_name, default)
