...
def PortArg(help_text=_DEFAULT_PORT_HELP):
    ...
    return base.Argument('--port', type=arg_parsers.CustomFunctionValidator(_PortValue, 'must be an integer between 1 and 65535, inclusive, or "default".'), help=help_text)