...
class ArangoGraph:
    ...
    *Security note*: Make sure that the database connection uses credentials
    ...
    def generate_schema(self, sample_ratio: float=0) -> Dict[str, List[Dict[str, Any]]]:
        ...
        graph_schema: List[Dict[str, Any]] = [{'graph_name': g['name'], 'edge_definitions': g['edge_definitions']} for g in self.db.graphs()]
        ...
        for collection in self.db.collections():
            ...
            collection_schema.append({'collection_name': col_name, 'collection_type': col_type, f'{col_type}_properties': properties, f'example_{col_type}': doc})
