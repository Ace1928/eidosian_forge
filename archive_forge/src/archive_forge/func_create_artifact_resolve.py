...
def create_artifact_resolve(self, artifact, destination, sessid, consent=None, extensions=None, sign=None, sign_alg=None, digest_alg=None):
    """
    ...
    return self._message(ArtifactResolve, destination, sessid, consent, extensions, sign, artifact=artifact, sign_alg=sign_alg, digest_alg=digest_alg)