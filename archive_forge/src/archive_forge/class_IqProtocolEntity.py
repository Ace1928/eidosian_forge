...
class IqProtocolEntity(ProtocolEntity):
    ...
    def toProtocolTreeNode(self):
        attribs = {'id': self._id, 'type': self._type}
        if self.xmlns:
    ...
    def fromProtocolTreeNode(node):
        return IqProtocolEntity(node.getAttributeValue('xmlns'), node.getAttributeValue('id'), node.getAttributeValue('type'), node.getAttributeValue('to'), node.getAttributeValue('from'))