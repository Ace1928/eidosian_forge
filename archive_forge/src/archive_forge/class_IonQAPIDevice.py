...
class IonQAPIDevice(cirq.Device):
    ...
    def __init__(self, qubits: Union[Sequence[cirq.LineQubit], int], atol=1e-08):
        ...
        self._metadata = cirq.DeviceMetadata(self.qubits, [(a, b) for a in self.qubits for b in self.qubits if a != b])
