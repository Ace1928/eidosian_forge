...
def firewall_internet_service_sld(data, fos, check_mode=False):
    ...
    if check_mode:
        ...
        mkey = fos.get_mkey('firewall', 'internet-service-sld', filtered_data, vdom=vdom)
    ...
    if state == 'present' or state is True:
        return fos.set('firewall', 'internet-service-sld', data=filtered_data, vdom=vdom)
    elif state == 'absent':
        return fos.delete('firewall', 'internet-service-sld', mkey=filtered_data['id'], vdom=vdom)
    else:
