...
class DriverManager(base.Manager):
    ...
    def list(self, driver_type=None, detail=None, os_ironic_api_version=None, global_request_id=None, fields=None):
        ...
        if filters:
            path = '?' + '&'.join(filters)
        return self._list(self._path(path), self._resource_name, os_ironic_api_version=os_ironic_api_version, global_request_id=global_request_id)

    def get(self, driver_name, os_ironic_api_version=None, global_request_id=None, fields=None):
        return self._get(resource_id=driver_name, fields=fields, os_ironic_api_version=os_ironic_api_version, global_request_id=global_request_id)

    def update(self, driver_name, patch, http_method='PATCH', os_ironic_api_version=None, global_request_id=None):
        return self._update(resource_id=driver_name, patch=patch, method=http_method, os_ironic_api_version=os_ironic_api_version, global_request_id=global_request_id)

    def delete(self, driver_name, os_ironic_api_version=None, global_request_id=None):
        return self._delete(resource_id=driver_name, os_ironic_api_version=os_ironic_api_version, global_request_id=global_request_id)

    def properties(self, driver_name, os_ironic_api_version=None, global_request_id=None):
        return self._get_as_dict('%s/properties' % driver_name, os_ironic_api_version=os_ironic_api_version, global_request_id=global_request_id)
