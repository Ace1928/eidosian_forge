...
class TestDataFrameInterpolate:
    ...
    @pytest.mark.parametrize('dtype', ['Float64', 'Float32', pytest.param('float32[pyarrow]', marks=td.skip_if_no('pyarrow')), pytest.param('float64[pyarrow]', marks=td.skip_if_no('pyarrow'))])
