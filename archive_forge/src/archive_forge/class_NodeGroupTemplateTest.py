...
class NodeGroupTemplateTest(base.BaseTestCase):
    body = {'name': 'name', 'plugin_name': 'plugin', 'hadoop_version': '1', 'flavor_id': '2', 'description': 'description', 'volumes_per_node': '3', 'volumes_size': '4', 'node_processes': ['datanode'], 'use_autoconfig': True, 'volume_mount_prefix': '/volumes/disk'}
    update_json = {'node_group_template': {'name': 'UpdatedName', 'plugin_name': 'new_plugin', 'hadoop_version': '2', 'flavor_id': '7', 'description': 'description', 'volumes_per_node': '3', 'volumes_size': '4', 'node_processes': ['datanode', 'namenode'], 'use_autoconfig': False, 'volume_mount_prefix': '/volumes/newdisk'}}
