...
class PublisherAsyncClient:
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        """
        return PublisherClient.from_service_account_info.__func__(PublisherAsyncClient, info, *args, **kwargs)
    ...
    def from_service_account_file(cls, filename: str, *args, **kwargs):
        ...
        Returns:
            PublisherAsyncClient: The constructed client.
        """
        return PublisherClient.from_service_account_file.__func__(PublisherAsyncClient, filename, *args, **kwargs)
    ...
    def get_mtls_endpoint_and_cert_source(cls, client_options: Optional[ClientOptions]=None):
        ...
        """
        return PublisherClient.get_mtls_endpoint_and_cert_source(client_options)
    ...
    def __init__(self, *, credentials: Optional[ga_credentials.Credentials]=None, transport: Union[str, PublisherTransport]='grpc_asyncio', client_options: Optional[ClientOptions]=None, client_info: gapic_v1.client_info.ClientInfo=DEFAULT_CLIENT_INFO) -> None:
        ...
        """
        self._client = PublisherClient(credentials=credentials, transport=transport, client_options=client_options, client_info=client_info)

    async def create_topic(self, request: Optional[Union[pubsub.Topic, dict]]=None, *, name: Optional[str]=None, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: TimeoutType=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> pubsub.Topic:
        ...
        if name is not None:
            request.name = name
        rpc = gapic_v1.method_async.wrap_method(self._client._transport.create_topic, default_retry=retries.Retry(initial=0.1, maximum=60.0, multiplier=1.3, predicate=retries.if_exception_type(core_exceptions.ServiceUnavailable), deadline=60.0), default_timeout=60.0, client_info=DEFAULT_CLIENT_INFO)
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((('name', request.name),)),)
        response = await rpc(request, retry=retry, timeout=timeout, metadata=metadata)
        return response

    async def update_topic(self, request: Optional[Union[pubsub.UpdateTopicRequest, dict]]=None, *, topic: Optional[pubsub.Topic]=None, update_mask: Optional[field_mask_pb2.FieldMask]=None, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: TimeoutType=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> pubsub.Topic:
        ...
        rpc = gapic_v1.method_async.wrap_method(self._client._transport.update_topic, default_retry=retries.Retry(initial=0.1, maximum=60.0, multiplier=1.3, predicate=retries.if_exception_type(core_exceptions.ServiceUnavailable), deadline=60.0), default_timeout=60.0, client_info=DEFAULT_CLIENT_INFO)
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((('topic.name', request.topic.name),)),)
        response = await rpc(request, retry=retry, timeout=timeout, metadata=metadata)
        return response

    async def publish(self, request: Optional[Union[pubsub.PublishRequest, dict]]=None, *, topic: Optional[str]=None, messages: Optional[MutableSequence[pubsub.PubsubMessage]]=None, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: TimeoutType=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> pubsub.PublishResponse:
        ...
        rpc = gapic_v1.method_async.wrap_method(self._client._transport.publish, default_retry=retries.Retry(initial=0.1, maximum=60.0, multiplier=4.0, predicate=retries.if_exception_type(core_exceptions.Aborted, core_exceptions.Cancelled, core_exceptions.DeadlineExceeded, core_exceptions.InternalServerError, core_exceptions.ResourceExhausted, core_exceptions.ServiceUnavailable, core_exceptions.Unknown), deadline=60.0), default_timeout=60.0, client_info=DEFAULT_CLIENT_INFO)
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((('topic', request.topic),)),)
        response = await rpc(request, retry=retry, timeout=timeout, metadata=metadata)
        return response

    async def get_topic(self, request: Optional[Union[pubsub.GetTopicRequest, dict]]=None, *, topic: Optional[str]=None, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: TimeoutType=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> pubsub.Topic:
        ...
        if topic is not None:
            request.topic = topic
        rpc = gapic_v1.method_async.wrap_method(self._client._transport.get_topic, default_retry=retries.Retry(initial=0.1, maximum=60.0, multiplier=1.3, predicate=retries.if_exception_type(core_exceptions.Aborted, core_exceptions.ServiceUnavailable, core_exceptions.Unknown), deadline=60.0), default_timeout=60.0, client_info=DEFAULT_CLIENT_INFO)
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((('topic', request.topic),)),)
        response = await rpc(request, retry=retry, timeout=timeout, metadata=metadata)
        return response

    async def list_topics(self, request: Optional[Union[pubsub.ListTopicsRequest, dict]]=None, *, project: Optional[str]=None, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: TimeoutType=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> pagers.ListTopicsAsyncPager:
        ...
        rpc = gapic_v1.method_async.wrap_method(self._client._transport.list_topics, default_retry=retries.Retry(initial=0.1, maximum=60.0, multiplier=1.3, predicate=retries.if_exception_type(core_exceptions.Aborted, core_exceptions.ServiceUnavailable, core_exceptions.Unknown), deadline=60.0), default_timeout=60.0, client_info=DEFAULT_CLIENT_INFO)
    ...
    async def list_topic_subscriptions(self, request: Optional[Union[pubsub.ListTopicSubscriptionsRequest, dict]]=None, *, topic: Optional[str]=None, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: TimeoutType=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> pagers.ListTopicSubscriptionsAsyncPager:
        ...
        if topic is not None:
            request.topic = topic
        rpc = gapic_v1.method_async.wrap_method(self._client._transport.list_topic_subscriptions, default_retry=retries.Retry(initial=0.1, maximum=60.0, multiplier=1.3, predicate=retries.if_exception_type(core_exceptions.Aborted, core_exceptions.ServiceUnavailable, core_exceptions.Unknown), deadline=60.0), default_timeout=60.0, client_info=DEFAULT_CLIENT_INFO)
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((('topic', request.topic),)),)
        response = await rpc(request, retry=retry, timeout=timeout, metadata=metadata)
        response = pagers.ListTopicSubscriptionsAsyncPager(method=rpc, request=request, response=response, metadata=metadata)
        return response

    async def list_topic_snapshots(self, request: Optional[Union[pubsub.ListTopicSnapshotsRequest, dict]]=None, *, topic: Optional[str]=None, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: TimeoutType=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> pagers.ListTopicSnapshotsAsyncPager:
        ...
        if topic is not None:
            request.topic = topic
        rpc = gapic_v1.method_async.wrap_method(self._client._transport.list_topic_snapshots, default_retry=retries.Retry(initial=0.1, maximum=60.0, multiplier=1.3, predicate=retries.if_exception_type(core_exceptions.Aborted, core_exceptions.ServiceUnavailable, core_exceptions.Unknown), deadline=60.0), default_timeout=60.0, client_info=DEFAULT_CLIENT_INFO)
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((('topic', request.topic),)),)
        response = await rpc(request, retry=retry, timeout=timeout, metadata=metadata)
        response = pagers.ListTopicSnapshotsAsyncPager(method=rpc, request=request, response=response, metadata=metadata)
        return response

    async def delete_topic(self, request: Optional[Union[pubsub.DeleteTopicRequest, dict]]=None, *, topic: Optional[str]=None, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: TimeoutType=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> None:
        ...
        if topic is not None:
            request.topic = topic
        rpc = gapic_v1.method_async.wrap_method(self._client._transport.delete_topic, default_retry=retries.Retry(initial=0.1, maximum=60.0, multiplier=1.3, predicate=retries.if_exception_type(core_exceptions.ServiceUnavailable), deadline=60.0), default_timeout=60.0, client_info=DEFAULT_CLIENT_INFO)
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((('topic', request.topic),)),)
        await rpc(request, retry=retry, timeout=timeout, metadata=metadata)

    async def detach_subscription(self, request: Optional[Union[pubsub.DetachSubscriptionRequest, dict]]=None, *, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: TimeoutType=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> pubsub.DetachSubscriptionResponse:
        ...
        rpc = gapic_v1.method_async.wrap_method(self._client._transport.detach_subscription, default_retry=retries.Retry(initial=0.1, maximum=60.0, multiplier=1.3, predicate=retries.if_exception_type(core_exceptions.ServiceUnavailable), deadline=60.0), default_timeout=60.0, client_info=DEFAULT_CLIENT_INFO)
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((('subscription', request.subscription),)),)
        response = await rpc(request, retry=retry, timeout=timeout, metadata=metadata)
        return response

    async def set_iam_policy(self, request: Optional[iam_policy_pb2.SetIamPolicyRequest]=None, *, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: TimeoutType=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> policy_pb2.Policy:
    ...
    async def get_iam_policy(self, request: Optional[iam_policy_pb2.GetIamPolicyRequest]=None, *, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: TimeoutType=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> policy_pb2.Policy:
    ...
    async def test_iam_permissions(self, request: Optional[iam_policy_pb2.TestIamPermissionsRequest]=None, *, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: TimeoutType=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> iam_policy_pb2.TestIamPermissionsResponse:
