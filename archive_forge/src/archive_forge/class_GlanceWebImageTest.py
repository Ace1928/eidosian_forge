...
class GlanceWebImageTest(common.HeatTestCase):
    ...
    def setUp(self):
        ...
        self.stack = parser.Stack(self.ctx, 'glance_image_test_stack', template.Template(tpl))
    ...
    def test_invalid_min_disk(self):
        ...
        image.reparse()
        error_msg = 'Property error: resources.image.properties.min_disk: -1 is out of range (min: 0, max: None)'
    ...
    def test_invalid_container_format(self):
        ...
        image.t = image.t.freeze(properties=props)
        image.reparse()
        error_msg = 'Property error: resources.image.properties.container_format: "incorrect_format" is not an allowed value'
        self._test_validate(image, error_msg)
    ...
    def _handle_update_image_props(self, prop_diff):
        ...
        self.images.update.assert_called_once_with(self.my_image.resource_id, ['hw_firmware_type'], os_secure_boot='required')
