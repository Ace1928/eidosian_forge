...
class ProjectsSettingsService(base_api.BaseApiService):
    ...
    Get.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1/projects/{projectsId}/settings/{settingsId}', http_method='GET', method_id='resourcesettings.projects.settings.get', ordered_params=['name'], path_params=['name'], query_params=['view'], relative_path='v1/{+name}', request_field='', request_type_name='ResourcesettingsProjectsSettingsGetRequest', response_type_name='GoogleCloudResourcesettingsV1Setting', supports_download=False)
    ...
    def List(self, request, global_params=None):
      ...
      """
        ...
        return self._RunMethod(config, request, global_params=global_params)
    List.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1/projects/{projectsId}/settings', http_method='GET', method_id='resourcesettings.projects.settings.list', ordered_params=['parent'], path_params=['parent'], query_params=['pageSize', 'pageToken', 'view'], relative_path='v1/{+parent}/settings', request_field='', request_type_name='ResourcesettingsProjectsSettingsListRequest', response_type_name='GoogleCloudResourcesettingsV1ListSettingsResponse', supports_download=False)
    ...
    def Patch(self, request, global_params=None):
      ...
      """
        ...
        return self._RunMethod(config, request, global_params=global_params)
    Patch.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1/projects/{projectsId}/settings/{settingsId}', http_method='PATCH', method_id='resourcesettings.projects.settings.patch', ordered_params=['name'], path_params=['name'], query_params=[], relative_path='v1/{+name}', request_field='googleCloudResourcesettingsV1Setting', request_type_name='ResourcesettingsProjectsSettingsPatchRequest', response_type_name='GoogleCloudResourcesettingsV1Setting', supports_download=False)