...
class TransformProgram:
    ...
    **Implemented Dunder methods**
    ...
    def add_transform(self, transform: TransformDispatcher, *targs, **tkwargs):
        ...
        self.push_back(TransformContainer(transform.transform, targs, tkwargs, transform.classical_cotransform, transform.is_informative, transform.final_transform))
    ...
    def __call__(self, tapes: Tuple[QuantumTape]) -> Tuple[ResultBatch, BatchPostProcessingFn]:
        ...
        postprocessing_fn = partial(_apply_postprocessing_stack, postprocessing_stack=processing_fns_stack)
