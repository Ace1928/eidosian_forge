...
class FanoutCache:
    ...
    def __init__(self, directory=None, shards=8, timeout=0.01, disk=Disk, **settings):
    ...
    def cache(self, name, timeout=60, disk=None, **settings):
        ...
        try:
            ...
            temp = Cache(directory=directory, timeout=timeout, disk=self._disk if disk is None else Disk, **settings)
            _caches[name] = temp
            return temp
