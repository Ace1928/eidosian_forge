...
class TestOrchestrationStackEnvironment(TestOrchestrationProxy):
    ...
    def test_get_stack_environment_with_stack_identity(self, mock_find):
        ...
        self._verify('openstack.proxy.Proxy._get', self.proxy.get_stack_environment, method_args=['IDENTITY'], expected_args=[stack_environment.StackEnvironment], expected_kwargs={'requires_id': False, 'stack_name': stack_name, 'stack_id': stack_id})
    ...
    def test_get_stack_environment_with_stack_object(self):
        ...
        stack_name = 'test_stack'
        stk = stack.Stack(id=stack_id, name=stack_name)
        self._verify('openstack.proxy.Proxy._get', self.proxy.get_stack_environment, method_args=[stk], expected_args=[stack_environment.StackEnvironment], expected_kwargs={'requires_id': False, 'stack_name': stack_name, 'stack_id': stack_id})