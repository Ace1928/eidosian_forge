...
def _build_extend_area_to_line_axis1_ragged(draw_trapezoid_y, expand_aggs_and_cols):
    ...
    def extend_cpu(sx, tx, sy, ty, xmin, xmax, ymin, ymax, xs, ys0, ys1, *aggs_and_cols):
        ...
        perform_extend_area_to_line_axis1_ragged(sx, tx, sy, ty, xmin, xmax, ymin, ymax, x_start_inds, x_flat, y0_start_inds, y0_flat, y1_start_inds, y1_flat, *aggs_and_cols)
