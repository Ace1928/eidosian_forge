...
class Cliconf(CliconfBase):
    __rpc__ = CliconfBase.__rpc__ + ['commit', 'discard_changes', 'get_diff', 'run_commands']
    ...
    def get_device_info(self):
        if not self._device_info:
            ...
            match = re.search('(?:HW|Hardware) model:\\s*(\\S+)', data)
            if match:
