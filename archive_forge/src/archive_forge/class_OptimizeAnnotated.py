...
class OptimizeAnnotated(TransformationPass):
    ...
    * Recursively combining annotations.
    ...
    def __init__(self, target: Optional[Target]=None, equivalence_library: Optional[EquivalenceLibrary]=None, basis_gates: Optional[List[str]]=None, recurse: bool=True):
        """
