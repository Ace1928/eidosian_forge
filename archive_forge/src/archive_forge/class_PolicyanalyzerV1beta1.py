...
class PolicyanalyzerV1beta1(base_api.BaseApiClient):
    ...
    class ProjectsLocationsActivityTypesActivitiesService(base_api.BaseApiService):
      ...
      """
        ...
        Query.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1beta1/projects/{projectsId}/locations/{locationsId}/activityTypes/{activityTypesId}/activities:query', http_method='GET', method_id='policyanalyzer.projects.locations.activityTypes.activities.query', ordered_params=['parent'], path_params=['parent'], query_params=['filter', 'pageSize', 'pageToken'], relative_path='v1beta1/{+parent}/activities:query', request_field='', request_type_name='PolicyanalyzerProjectsLocationsActivityTypesActivitiesQueryRequest', response_type_name='GoogleCloudPolicyanalyzerV1beta1QueryActivityResponse', supports_download=False)
