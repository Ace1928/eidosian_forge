...
class TestAutomaticUpgrade(automatic_conversion_test_base.TestAutomaticConversion):
    ...
    def test_And(self) -> None:
        self._test_op_upgrade('And', 7, [[2, 3], [2, 3]], [[2, 3]], [TensorProto.BOOL, TensorProto.BOOL], [TensorProto.BOOL])
    ...
    def test_Add_1(self) -> None:
        self._test_op_upgrade('Add', 1, [[3, 4, 5], [3, 4, 5]], attrs={'consumed_inputs': [0]})
    ...
    def test_ArgMax_2(self) -> None:
        self._test_op_upgrade('ArgMax', 7, [[2, 3, 4]], [[2, 1, 4]], output_types=[TensorProto.INT64], attrs={'axis': 1})

    def test_ArgMin_1(self) -> None:
        self._test_op_upgrade('ArgMin', 7, [[2, 3, 4]], [[1, 3, 4]], output_types=[TensorProto.INT64])
    ...
    def test_AveragePool(self) -> None:
        self._test_op_upgrade('AveragePool', 1, [[1, 1, 5, 5]], [[1, 1, 4, 4]], attrs={'kernel_shape': [2, 2]})
    ...
    def test_constant(self) -> None:
        value = helper.make_tensor('Value', TensorProto.FLOAT, dims=[3, 4, 5], vals=np.random.rand(3, 4, 5).astype(np.float32).tobytes(), raw=True)
    ...
    def test_GatherElements(self) -> None:
        self._test_op_upgrade('GatherElements', 11, [[3, 4, 5], [6, 7]], [[6, 7]], [TensorProto.FLOAT, TensorProto.INT64])
    ...
    def test_Greater(self) -> None:
        self._test_op_upgrade('Greater', 7, [[2, 3], [2, 3]], [[2, 3]], output_types=[TensorProto.BOOL])
    ...
    def test_LessOrEqual(self) -> None:
        self._test_op_upgrade('LessOrEqual', 12, [[2, 3], [2, 3]], [[2, 3]], output_types=[TensorProto.BOOL])
    ...
    def test_MatMulInteger_1(self) -> None:
        self._test_op_upgrade('MatMulInteger', 10, [[2, 3], [3, 4]], [[2, 4]], [TensorProto.INT8, TensorProto.INT8], [TensorProto.INT32])
    ...
    def test_MatMulInteger_3(self) -> None:
        self._test_op_upgrade('MatMulInteger', 10, [[2, 3], [3, 4], [2], [4]], [[2, 4]], [TensorProto.INT8, TensorProto.INT8, TensorProto.INT8, TensorProto.INT8], [TensorProto.INT32])

    def test_Max(self) -> None:
        self._test_op_upgrade('Max', 1, [[2, 3, 4], [2, 3, 4]], [[2, 3, 4]], attrs={'consumed_inputs': [0]})

    def test_MaxPool_1(self) -> None:
        self._test_op_upgrade('MaxPool', 1, [[1, 1, 5, 5]], [[1, 1, 4, 4]], attrs={'kernel_shape': [2, 2]})
    ...
    def test_Min(self) -> None:
        self._test_op_upgrade('Min', 1, [[2, 3, 4], [2, 3, 4]], [[2, 3, 4]], attrs={'consumed_inputs': [0]})
    ...
    def test_Mul(self) -> None:
        self._test_op_upgrade('Mul', 1, [[2, 3, 4], [2, 1, 4]], [[2, 3, 4]], attrs={'consumed_inputs': [0]})

    def test_Multinomial(self) -> None:
        self._test_op_upgrade('Multinomial', 7, [[3, 5]], [[3, 7]], output_types=[TensorProto.INT32], attrs={'sample_size': 7})
    ...
    def test_NegativeLogLikelihoodLoss_2(self) -> None:
        self._test_op_upgrade('NegativeLogLikelihoodLoss', 12, [[3, 4, 5], [3, 5], [4]], [[]], [TensorProto.FLOAT, TensorProto.INT64, TensorProto.FLOAT])
    ...
    def test_Or(self) -> None:
        self._test_op_upgrade('Or', 7, [[2, 3], [2, 3]], [[2, 3]], [TensorProto.BOOL, TensorProto.BOOL], [TensorProto.BOOL])
    ...
    def test_RandomNormalLike(self) -> None:
        ...
        self._test_op_upgrade('RandomNormalLike', 1, [[3, 4, 5]], [[3, 4, 5]], initializer=[like])
    ...
    def test_Range(self) -> None:
        ...
        self._test_op_upgrade('Range', 11, [[], [], []], [[6]], initializer=[start, end, step])
    ...
    def test_ScatterND_2(self) -> None:
        self._test_op_upgrade('ScatterND', 16, [[2, 3], [1, 2], [1, 2]], [[2, 3]], [TensorProto.FLOAT, TensorProto.INT64, TensorProto.FLOAT], [TensorProto.FLOAT], attrs={'reduction': 'mul'})
    ...
    def test_Sum(self) -> None:
        self._test_op_upgrade('Sum', 1, [[2, 3, 4], [2, 3, 4]], [[2, 3, 4]], attrs={'consumed_inputs': [0]})
    ...
    def test_Transpose(self) -> None:
        self._test_op_upgrade('Transpose', 1, [[1, 2, 5, 3, 7]], [[1, 7, 5, 2, 3]], attrs={'perm': [0, 4, 2, 1, 3]})
    ...
    def test_Unique_2(self) -> None:
        self._test_op_upgrade('Unique', 11, [[3, 4, 5]], [[3, None, 5]], attrs={'axis': 1})
    ...
    def test_Xor(self) -> None:
        self._test_op_upgrade('Xor', 7, [[2, 3], [2, 3]], [[2, 3]], [TensorProto.BOOL, TensorProto.BOOL], [TensorProto.BOOL])

    def test_CastLike(self) -> None:
        self._test_op_upgrade('CastLike', 15, [[2, 3, 4], [2, 1, 4]], [[2, 3, 4]], input_types=[TensorProto.FLOAT, TensorProto.FLOAT16], output_types=[TensorProto.FLOAT16])

    def test_LayerNormalization(self) -> None:
        self._test_op_upgrade('LayerNormalization', 17, [[2, 3, 4, 5], [4, 5], [4, 5]], [[2, 3, 4, 5]], input_types=[TensorProto.FLOAT, TensorProto.FLOAT, TensorProto.FLOAT], output_types=[TensorProto.FLOAT], attrs={'axis': 2})
    ...
    def test_BitwiseXor(self) -> None:
        self._test_op_upgrade('BitwiseXor', 18, [[2, 3], [2, 3]], [[2, 3]], [TensorProto.INT16, TensorProto.INT16], [TensorProto.INT16])

    def test_GroupNormalization(self) -> None:
        self._test_op_upgrade('GroupNormalization', 18, [[3, 4, 2, 2], [1], [1]], [[3, 4, 2, 2]], attrs={'epsilon': 1e-05, 'num_groups': 2})
    ...
    def test_ops_tested(self) -> None:
        ...
        excluded_ops = {'ConcatFromSequence', 'SequenceAt', 'SequenceConstruct', 'SequenceEmpty', 'SequenceErase', 'SequenceInsert', 'SequenceLength', 'SequenceMap', 'SplitToSequence', 'Optional', 'OptionalGetElement', 'OptionalHasElement', 'StringSplit'}
