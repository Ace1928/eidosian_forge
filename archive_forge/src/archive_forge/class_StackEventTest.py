...
class StackEventTest(common.HeatTestCase):
    ...
    def test_event_list_with_marker_and_filters(self, mock_get, mock_get_all):
        ...
        self.eng.list_events(self.ctx, 1, limit=limit, marker=marker, sort_keys=sort_keys, sort_dir=sort_dir, filters=filters)
        mock_get_all.assert_called_once_with(self.ctx, 1, limit=limit, sort_keys=sort_keys, marker=marker, sort_dir=sort_dir, filters=filters)
