...
class LuadnsTests(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.test_zone = Zone(id='11', type='master', ttl=None, domain='example.com', extra={}, driver=self.driver)
    ...
    def test_create_record_success(self):
        ...
        record = self.driver.create_record(name='test.com.', zone=self.test_zone, type='A', data='127.0.0.1', extra={'ttl': 13})
        self.assertEqual(record.id, '31')
