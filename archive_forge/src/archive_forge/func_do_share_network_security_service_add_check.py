...
@cliutils.arg('--reset', metavar='<True|False>', choices=['True', 'False'], required=False, default=False, help='Reset and restart the check operation.(Optional, Default=False)')
...
def do_share_network_security_service_add_check(cs, args):
    ...
    add_sec_service_result = cs.share_networks.add_security_service_check(share_network, security_service, reset_operation=args.reset)
