...
class JSONCommands:
    ...
    def arrindex(self, name: str, path: str, scalar: int, start: Optional[int]=None, stop: Optional[int]=None) -> List[Union[int, None]]:
        """
    ...
    def set(self, name: str, path: str, obj: JsonType, nx: Optional[bool]=False, xx: Optional[bool]=False, decode_keys: Optional[bool]=False) -> Optional[str]:
        """
    ...
    def merge(self, name: str, path: str, obj: JsonType, decode_keys: Optional[bool]=False) -> Optional[str]:
        """
    ...
    def set_path(self, json_path: str, root_folder: str, nx: Optional[bool]=False, xx: Optional[bool]=False, decode_keys: Optional[bool]=False) -> Dict[str, bool]:
        """
        ...
        for root, dirs, files in os.walk(root_folder):
            for file in files:
                ...
                try:
                    ...
                    self.set_file(file_name, json_path, file_path, nx=nx, xx=xx, decode_keys=decode_keys)
    ...
    def debug(self, subcommand: str, key: Optional[str]=None, path: Optional[str]=Path.root_path()) -> Union[int, List[str]]:
