...
class TemplatesClient(object):
    ...
    """
        ...
        labels = labels_util.ParseCreateArgs(args, self.message.JobTemplate.LabelsValue)
        job_template = encoding.JsonToMessage(self._template_class, template_json)
        job_template.labels = labels or job_template.labels
        req = self.message.TranscoderProjectsLocationsJobTemplatesCreateRequest(parent=parent_ref.RelativeName(), jobTemplateId=template_id, jobTemplate=job_template)
    ...
    """
        req = self.message.TranscoderProjectsLocationsJobTemplatesDeleteRequest(name=template_ref.RelativeName())
    ...
    """
        req = self.message.TranscoderProjectsLocationsJobTemplatesGetRequest(name=template_ref.RelativeName())
    ...
    """
        req = self.message.TranscoderProjectsLocationsJobTemplatesListRequest(parent=parent_ref.RelativeName(), pageSize=page_size)
        resp = list_pager.YieldFromList(service=self._service, request=req, batch_size=page_size, field='jobTemplates', batch_size_attribute='pageSize')
        return resp