...
def _GetFunctionRef(name):
    if not name:
        return None
    return resources.REGISTRY.Parse(name, params={'projectsId': properties.VALUES.core.project.GetOrFail(), 'locationsId': properties.VALUES.functions.region.GetOrFail()}, collection='cloudfunctions.projects.locations.functions')