...
class DeepChromaProcessor(SequentialProcessor):
    ...
    def __init__(self, fmin=65, fmax=2100, unique_filters=True, models=None, **kwargs):
        ...
        spec = LogarithmicFilteredSpectrogramProcessor(num_bands=24, fmin=fmin, fmax=fmax, unique_filters=unique_filters)
        ...
        super(DeepChromaProcessor, self).__init__([sig, frames, stft, spec, spec_signal, spec_frames, _dcp_flatten, nn])