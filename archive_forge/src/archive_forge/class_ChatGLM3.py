...
class ChatGLM3(LLM):
    ...
    def _invocation_params(self) -> dict:
        ...
        params = {'model': self.model_name, 'temperature': self.temperature, 'max_tokens': self.max_tokens, 'top_p': self.top_p, 'stream': self.streaming}
    ...
    def _call(self, prompt: str, stop: Optional[List[str]]=None, run_manager: Optional[CallbackManagerForLLMRun]=None, **kwargs: Any) -> str:
        ...
        try:
            ...
            raise ValueError(f'Error raised during decoding response from inference endpoint: {e}.\nResponse: {response.text}')
        if stop is not None:
