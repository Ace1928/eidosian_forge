...
class SuiteRequirements(Requirements):
    ...
    def sane_rowcount(self):
        return exclusions.skip_if(lambda config: not config.db.dialect.supports_sane_rowcount, "driver doesn't support 'sane' rowcount")
    ...
    def insert_executemany_returning(self):
        ...
        """
        return exclusions.only_if(lambda config: config.db.dialect.insert_executemany_returning, "%(database)s %(does_support)s 'RETURNING of multiple rows with INSERT executemany'")
