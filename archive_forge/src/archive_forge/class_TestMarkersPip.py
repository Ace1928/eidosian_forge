...
class TestMarkersPip(base.BaseTestCase):
    scenarios = [('pip-latest', {'modules': ['pip']}), ('setuptools-Bullseye', {'modules': ['pip==20.3.4', 'setuptools==52.0.0']}), ('setuptools-Focal', {'modules': ['pip==20.0.2', 'setuptools==45.2.0']}), ('setuptools-Jammy', {'modules': ['pip==22.0.2', 'setuptools==59.6.0']})]
