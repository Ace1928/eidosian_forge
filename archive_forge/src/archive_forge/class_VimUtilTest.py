...
class VimUtilTest(base.TestCase):
    ...
    def test_cancel_retrieval(self, get_token):
        ...
        vim.CancelRetrievePropertiesEx.assert_called_once_with(vim.service_content.propertyCollector, token=token)
    ...
    def test_register_extension(self):
        ...
        self.assertIsNone(ret)
        service_content = vim.service_content
        vim.RegisterExtension.assert_called_once_with(service_content.extensionManager, extension=mock.ANY)
