...
class QueuedResourceList(_messages.Message):
    """A QueuedResourceList object.
  ...
  """
    ...
    items = _messages.MessageField('QueuedResource', 2, repeated=True)
    kind = _messages.StringField(3, default='compute#queuedResourceList')
