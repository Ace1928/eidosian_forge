...
def test_metadef_namespaces_schema_get(self):
    self._verify('openstack.proxy.Proxy._get', self.proxy.get_metadef_namespaces_schema, expected_args=[_metadef_schema.MetadefSchema], expected_kwargs={'base_path': '/schemas/metadefs/namespaces', 'requires_id': False})