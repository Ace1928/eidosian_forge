...
def test_metadef_resource_type_schema_get(self):
    self._verify('openstack.proxy.Proxy._get', self.proxy.get_metadef_resource_type_schema, expected_args=[_metadef_schema.MetadefSchema], expected_kwargs={'base_path': '/schemas/metadefs/resource_type', 'requires_id': False})