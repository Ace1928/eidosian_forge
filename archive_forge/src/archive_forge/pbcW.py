...
def main():
    ...
    model = nn.Sequential(
        ...
        DynamicActivationSynapse(64, 64, activation="tanh"),
        DynamicActivationNeuron(64, 32, activation="sigmoid", neuron_type="spiking"),
        DynamicActivationSynapse(32, 32, activation="standard"),
        DynamicActivationNeuron(
            32, output_size, activation="relu", neuron_type="graph"
        ),
    )
