...
def test_delete_snapshot_metadata(self):
    self._verify('openstack.block_storage.v2.snapshot.Snapshot.delete_metadata_item', self.proxy.delete_snapshot_metadata, expected_result=None, method_args=['value', ['key']], expected_args=[self.proxy, 'key'])