        ...
        if on_exists or off_exists:
            if dtype is not None:
                if on_exists and on_dtype != dtype:
                    raise TypeError('dtype {0} of on_value does not match dtype parameter {1}'.format(on_dtype, dtype))
                if off_exists and off_dtype != dtype:
                    raise TypeError('dtype {0} of off_value does not match dtype parameter {1}'.format(off_dtype, dtype))
            else:
