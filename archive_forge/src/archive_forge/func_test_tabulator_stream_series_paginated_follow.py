...
def test_tabulator_stream_series_paginated_follow(document, comm):
    ...
    expected = {'index': np.array([4, 5]), 'A': np.array([4, 5]), 'B': np.array([0, 1]), 'C': np.array(['foo5', 'foo6']), 'D': np.array(['2009-01-07T00:00:00.000000000', '2009-01-08T00:00:00.000000000'], dtype='datetime64[ns]').astype(np.int64) / 1000000.0}
