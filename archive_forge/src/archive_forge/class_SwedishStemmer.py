...
class SwedishStemmer(_ScandinavianStemmer):
    ...
    __step1_suffixes = ('heterna', 'hetens', 'heter', 'heten', 'anden', 'arnas', 'ernas', 'ornas', 'andes', 'andet', 'arens', 'arna', 'erna', 'orna', 'ande', 'arne', 'aste', 'aren', 'ades', 'erns', 'ade', 'are', 'ern', 'ens', 'het', 'ast', 'ad', 'en', 'ar', 'er', 'or', 'as', 'es', 'at', 'a', 'e', 's')
    __step2_suffixes = ('dd', 'gd', 'nn', 'dt', 'gt', 'kt', 'tt')
    __step3_suffixes = ('fullt', 'löst', 'els', 'lig', 'ig')
