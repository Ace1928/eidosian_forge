...
class TaskPoolMapOperator(MapOperator):
    ...
    def incremental_resource_usage(self) -> ExecutionResources:
        return ExecutionResources(cpu=self._ray_remote_args.get('num_cpus', 0), gpu=self._ray_remote_args.get('num_gpus', 0), object_store_memory=self._metrics.average_bytes_outputs_per_task)