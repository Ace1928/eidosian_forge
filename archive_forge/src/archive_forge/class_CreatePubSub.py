...
class CreatePubSub(base.CreateCommand):
    ...
    """
        ...
        flag_config.add_argument('--topic', help='The topic to which this trigger should subscribe.', required=True)
