...
def _rotate_mask_dispatch(inpt: tv_tensors.Mask, angle: float, expand: bool=False, center: Optional[List[float]]=None, fill: _FillTypeJIT=None, **kwargs) -> tv_tensors.Mask:
