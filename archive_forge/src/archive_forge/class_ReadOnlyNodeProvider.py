...
class ReadOnlyNodeProvider(NodeProvider):
    ...
    def node_tags(self, node_id):
        tags = {TAG_RAY_NODE_KIND: NODE_KIND_HEAD, TAG_RAY_USER_NODE_TYPE: self.nodes[node_id]['node_type'], TAG_RAY_NODE_NAME: node_id, TAG_RAY_NODE_STATUS: STATUS_UP_TO_DATE}
        return tags
