...
@DeveloperAPI
def get_worker(id: str, address: Optional[str]=None, timeout: int=DEFAULT_RPC_TIMEOUT, _explain: bool=False) -> Optional[WorkerState]:
    """Get a worker by id.
    ...
    """
    return StateApiClient(address=address).get(StateResource.WORKERS, id, GetApiOptions(timeout=timeout), _explain=_explain)