...
class TestListBaremetalDriverProperty(TestBaremetalDriver):
    ...
    def setUp(self):
        ...
        self.baremetal_mock.driver.properties.return_value = {'property1': 'description1', 'property2': 'description2'}
        self.cmd = baremetal_driver.ListBaremetalDriverProperty(self.app, None)
