...
def fused_batch_norm_grad_v2_eager_fallback(y_backprop: _atypes.TensorFuzzingAnnotation[TV_FusedBatchNormGradV2_T], x: _atypes.TensorFuzzingAnnotation[TV_FusedBatchNormGradV2_T], scale: _atypes.TensorFuzzingAnnotation[_atypes.Float32], reserve_space_1: _atypes.TensorFuzzingAnnotation[TV_FusedBatchNormGradV2_U], reserve_space_2: _atypes.TensorFuzzingAnnotation[TV_FusedBatchNormGradV2_U], epsilon: float, data_format: str, is_training: bool, name, ctx):
    ...
    _attrs = ('T', _attr_T, 'U', _attr_U, 'epsilon', epsilon, 'data_format', data_format, 'is_training', is_training)
    _result = _execute.execute(b'FusedBatchNormGradV2', 5, inputs=_inputs_flat, attrs=_attrs, ctx=ctx, name=name)
