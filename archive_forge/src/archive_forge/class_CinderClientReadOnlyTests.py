...
class CinderClientReadOnlyTests(base.ClientTestBase):
    ...
    def test_list(self):
        ...
        self.assertTableHeaders(list, ['ID', 'Status', 'Name', 'Size', 'Volume Type', 'Bootable', 'Attached to'])
    ...
    def test_service_list(self):
        ...
        self.assertTableHeaders(service_list, ['Binary', 'Host', 'Zone', 'Status', 'State', 'Updated_at'])

    def test_snapshot_list(self):
        snapshot_list = self.cinder('snapshot-list')
        self.assertTableHeaders(snapshot_list, ['ID', 'Volume ID', 'Status', 'Name', 'Size'])
    ...
    def test_list_extensions(self):
        ...
        self.assertTableHeaders(list_extensions, ['Name', 'Summary', 'Alias', 'Updated'])