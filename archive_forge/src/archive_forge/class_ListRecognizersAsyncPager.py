...
class ListRecognizersAsyncPager:
    ...
    def __init__(self, method: Callable[..., Awaitable[cloud_speech.ListRecognizersResponse]], request: cloud_speech.ListRecognizersRequest, response: cloud_speech.ListRecognizersResponse, *, metadata: Sequence[Tuple[str, str]]=()):
