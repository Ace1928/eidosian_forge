...
class BaseStatefulBackend(collections.abc.MutableMapping):
    ...
    def __init__(self, serializer: Optional[str]=None, serializer_kwargs: Optional[Dict[str, Any]]=None, base_key: Optional[str]=None, async_enabled: Optional[bool]=False, settings: Optional['BaseSettings']=None, **kwargs):
        """
    ...
    def create_hash(self, obj: 'ObjectValue') -> str:
        ...
        Creates a Hash
        """
        return self.serializer.create_hash(obj) if self.serializer is not None else create_obj_hash(obj)
    ...
    def __setitem__(self, key, value):
        ...
        """
        return ThreadPooler.create_background_task(self.aset(key, value)) if self.async_enabled else self.set(key, value)

    def __delitem__(self, key):
        """
        Deletes an Item from the Cache
        """
        return ThreadPooler.create_background_task(self.adelete(key)) if self.async_enabled else self.delete(key)
    ...
    def incr(self, key: str, amount: Union[int, float]=1, **kwargs) -> Union[int, float]:
        ...
        if isinstance(amount, int):
            return self.incrby(key, amount=amount, **kwargs)
    ...
    async def aincr(self, key: str, amount: Union[int, float]=1, **kwargs) -> Union[int, float]:
        ...
        """
        if isinstance(amount, int):
            return await self.aincrby(key, amount=amount, **kwargs)
    ...
    def decr(self, key: str, amount: Union[int, float]=1, **kwargs) -> Union[int, float]:
        ...
        """
        if isinstance(amount, int):
            return self.decrby(key, amount=amount, **kwargs)
    ...
    async def adecr(self, key: str, amount: Union[int, float]=1, **kwargs) -> Union[int, float]:
        ...
        """
        if isinstance(amount, int):
            return await self.adecrby(key, amount=amount, **kwargs)
    ...
    def clone(self, target: Optional[Any], target_base_key: Optional[str]=None, schema_map: Optional[Dict[str, str]]=None, overwrite: Optional[bool]=False, **kwargs):
        """
        Clones the data from the current PersistentDict to a new PersistentDict
        """
        raise NotImplementedError

    async def aclone(self, target: Optional[Any], target_base_key: Optional[str]=None, schema_map: Optional[Dict[str, str]]=None, overwrite: Optional[bool]=False, excluded: Optional[Union[str, List[str]]]=None, **kwargs):
        """
        Clones the data from the target PersistentDict to a current PersistentDict
        """
        raise NotImplementedError

    def clone_from(self, target: Any, target_base_key: Optional[str]=None, schema_map: Optional[Dict[str, str]]=None, overwrite: Optional[bool]=False, excluded: Optional[Union[str, List[str]]]=None, **kwargs):
        """
        Clones the data from the target PersistentDict to a current PersistentDict
        """
        raise NotImplementedError

    async def aclone_from(self, target: Any, target_base_key: Optional[str]=None, schema_map: Optional[Dict[str, str]]=None, overwrite: Optional[bool]=False, excluded: Optional[Union[str, List[str]]]=None, **kwargs):
        """
        Clones the data from the target PersistentDict to a current PersistentDict
        """
