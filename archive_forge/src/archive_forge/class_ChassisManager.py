...
class ChassisManager(base.CreateManager):
    ...
    def list(self, marker=None, limit=None, sort_key=None, sort_dir=None, detail=False, fields=None, os_ironic_api_version=None, global_request_id=None):
        ...
        if limit is None:
            ...
            return self._list_pagination(self._path(path), 'chassis', limit=limit, **header_values)

    def list_nodes(self, chassis_id, marker=None, limit=None, sort_key=None, sort_dir=None, detail=False, fields=None, associated=None, maintenance=None, provision_state=None, os_ironic_api_version=None, global_request_id=None):
    ...
    def get(self, chassis_id, fields=None, os_ironic_api_version=None, global_request_id=None):
        return self._get(resource_id=chassis_id, fields=fields, os_ironic_api_version=os_ironic_api_version, global_request_id=global_request_id)

    def delete(self, chassis_id, os_ironic_api_version=None, global_request_id=None):
        return self._delete(resource_id=chassis_id, os_ironic_api_version=os_ironic_api_version, global_request_id=global_request_id)

    def update(self, chassis_id, patch, os_ironic_api_version=None, global_request_id=None):
        return self._update(resource_id=chassis_id, patch=patch, os_ironic_api_version=os_ironic_api_version, global_request_id=global_request_id)