...
class AnsibleK8SModule:
    ...
    here.
    """
    default_settings = {'check_k8s': True, 'check_pyyaml': True, 'module_class': AnsibleModule}
    ...
    def requires(self, dependency: str, minimum: Optional[str]=None, reason: Optional[str]=None) -> None:
        try:
