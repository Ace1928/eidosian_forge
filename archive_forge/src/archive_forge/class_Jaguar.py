...
class Jaguar(VectorStore):
    ...
    def __init__(self, pod: str, store: str, vector_index: str, vector_type: str, vector_dimension: int, url: str, embedding: Embeddings):
        self._pod = pod
        self._store = store
        ...
        try:
            ...
            raise ValueError('Could not import jaguardb-http-client python package. Please install it with `pip install -U jaguardb-http-client`')
    ...
    def similarity_search_with_score(self, query: str, k: int=3, fetch_k: int=-1, where: Optional[str]=None, args: Optional[str]=None, metadatas: Optional[List[str]]=None, **kwargs: Any) -> List[Tuple[Document, float]]:
        """
    ...
    def similarity_search(self, query: str, k: int=3, where: Optional[str]=None, metadatas: Optional[List[str]]=None, **kwargs: Any) -> List[Document]:
        """
        Return Jaguar documents most similar to query, along with scores.
        Args:
            query: Text to look up documents similar to.
    ...
    @classmethod
    def from_texts(cls, texts: List[str], embedding: Embeddings, url: str, pod: str, store: str, vector_index: str, vector_type: str, vector_dimension: int, metadatas: Optional[List[dict]]=None, jaguar_api_key: Optional[str]='', **kwargs: Any) -> Jaguar:
