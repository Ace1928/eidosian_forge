...
def cds_rdataset_to_ds_rdataset(rdataset: dns.rdataset.Rdataset) -> dns.rdataset.Rdataset:
    ...
    *rdataset*, a ``dns.rdataset.Rdataset``, to create DS Rdataset for.
    ...
    for rdata in rdataset:
        res.append(CDS(rdclass=rdata.rdclass, rdtype=dns.rdatatype.DS, key_tag=rdata.key_tag, algorithm=rdata.algorithm, digest_type=rdata.digest_type, digest=rdata.digest))
