...
def build_inventory_groups_vlanid(self, group_name):
    ...
    gen_instances = [instance_name for instance_name in self.inventory.hosts.keys() if 'ansible_lxd_vlan_ids' in self.inventory.get_host(instance_name).get_vars().keys()]
