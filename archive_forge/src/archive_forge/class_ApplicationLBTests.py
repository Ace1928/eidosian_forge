...
class ApplicationLBTests(unittest.TestCase):
    ...
    rule_id = 'arn:aws:elasticloadbalancing:us-east-1:111111111111:listener-rule/app/Test-Develop-App-LB/1111111111111111/1111111111111111/1111111111111111'
    ...
    def test_create_balancer(self):
        balancer = self.driver.create_balancer(name='Test-ALB', port=443, protocol='HTTPS', algorithm=None, members=[Member(id='i-01111111111111111', ip=None, port=443)], ex_scheme='internet-facing', ex_security_groups=['sg-11111111'], ex_subnets=['subnet-11111111', 'subnet-22222222'], ex_tags={}, ex_ssl_cert_arn=self.ssl_cert_id)
        self.assertEqual(balancer.id, self.balancer_id)
        self.assertEqual(balancer.name, 'Test-ALB')
        self.assertEqual(balancer.state, State.UNKNOWN)
