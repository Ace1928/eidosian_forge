...
class TopicStatsServiceClient(metaclass=TopicStatsServiceClientMeta):
    ...
    def __init__(self, *, credentials: Optional[ga_credentials.Credentials]=None, transport: Optional[Union[str, TopicStatsServiceTransport]]=None, client_options: Optional[Union[client_options_lib.ClientOptions, dict]]=None, client_info: gapic_v1.client_info.ClientInfo=DEFAULT_CLIENT_INFO) -> None:
    ...
    def compute_message_stats(self, request: Optional[Union[topic_stats.ComputeMessageStatsRequest, dict]]=None, *, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> topic_stats.ComputeMessageStatsResponse:
    ...
    def compute_head_cursor(self, request: Optional[Union[topic_stats.ComputeHeadCursorRequest, dict]]=None, *, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> topic_stats.ComputeHeadCursorResponse:
    ...
    def compute_time_cursor(self, request: Optional[Union[topic_stats.ComputeTimeCursorRequest, dict]]=None, *, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> topic_stats.ComputeTimeCursorResponse:
