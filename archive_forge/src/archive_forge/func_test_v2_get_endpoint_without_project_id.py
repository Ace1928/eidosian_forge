...
def test_v2_get_endpoint_without_project_id(self):
    ...
    cs_2 = fakes.FakeClient(api_versions.APIVersion('2.0'), endpoint_type=endpoint_type)
    result = cs_2.versions.get_current()
    self.assert_request_id(result, fakes.FAKE_REQUEST_ID_LIST)
    self.assertEqual(result.manager.api.client.endpoint_type, endpoint_type, 'Check v2 endpoint_type was set')
