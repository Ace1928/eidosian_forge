...
def resource_get_all(context):
    results = context.session.query(models.Resource).options(orm.joinedload(models.Resource.attr_data), orm.joinedload(models.Resource.data), orm.joinedload(models.Resource.rsrc_prop_data)).all()
    if not results:
