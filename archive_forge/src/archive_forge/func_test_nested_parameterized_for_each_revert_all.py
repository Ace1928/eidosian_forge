...
def test_nested_parameterized_for_each_revert_all(self):
    values = [3, 2, 5]
    retry1 = retry.ParameterizedForEach('r1', provides='x', revert_all=True)
