...
def test_migrate_cluster(self):
    self._verify('openstack.block_storage.v3.volume.Volume.migrate', self.proxy.migrate_volume, method_args=['value'], method_kwargs={'cluster': '3'}, expected_args=[self.proxy, None, False, False, '3'])