...
class KeystoneDomainTest(common.HeatTestCase):
    ...
    def setUp(self):
        ...
        self.stack = stack.Stack(self.ctx, 'test_stack_keystone', template.Template(KEYSTONE_REGION_TEMPLATE))
    ...
    def test_get_live_state(self):
        sample_domain = {domain.KeystoneDomain.NAME: 'test', domain.KeystoneDomain.ENABLED: True, domain.KeystoneDomain.DESCRIPTION: 'test domain'}
        d = mock.Mock()
