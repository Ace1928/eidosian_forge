...
class V1ManagedFieldsEntry(object):
    ...
    swagger_types = {'api_version': 'str', 'fields': 'object', 'manager': 'str', 'operation': 'str', 'time': 'datetime'}
    attribute_map = {'api_version': 'apiVersion', 'fields': 'fields', 'manager': 'manager', 'operation': 'operation', 'time': 'time'}
