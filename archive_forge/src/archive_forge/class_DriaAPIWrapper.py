...
class DriaAPIWrapper:
    ...
    def __init__(self, api_key: str, contract_id: Optional[str]=None, top_n: int=10):
        try:
            ...
            logger.error('Dria is not installed. Please install Dria to use this wrapper.\n                \n                You can install Dria using the following command:\n                pip install dria\n                ')
            return
    ...
    def create_knowledge_base(self, name: str, description: str, category: str, embedding: str) -> str:
    ...
    def run(self, query: Union[str, List[float]]) -> Optional[List[Dict[str, Any]]]:
        ...
        if isinstance(query, str):
            ...
            logger.error('Invalid query type. Please provide a string for text search or a \n                list of floats for vector query.')
            return None