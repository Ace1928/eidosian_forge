...
class AbiquoNodeDriver(NodeDriver):
    ...
    def destroy_node(self, node):
        ...
        if state != 'NOT_ALLOCATED':
            ...
            res = self.connection.async_request(action=destroy_uri, method='POST', data=tostring(vm_task), headers=headers)
    ...
    def _to_node(self, vm, driver):
        ...
        return Node(identifier, name, state, public_ips, private_ips, driver, image=image, extra=extra)
