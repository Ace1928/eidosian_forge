    ...
    def get_records(self, shard_iterator, limit=None, b64_decode=True):
        ...
        if b64_decode:
            for record in response.get('Records', []):
                record['Data'] = base64.b64decode(record['Data'].encode('utf-8')).decode('utf-8')
        return response
