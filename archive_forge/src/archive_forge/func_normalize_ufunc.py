...
def normalize_ufunc(func):
    try:
        ...
        _maybe_raise_nondeterministic(f'Cannot tokenize numpy ufunc {func!r}. Please use functions of the dask.array.ufunc module instead. See also https://docs.dask.org/en/latest/array-numpy-compatibility.html')
