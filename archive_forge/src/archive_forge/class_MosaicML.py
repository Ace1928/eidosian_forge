...
class MosaicML(LLM):
    ...
    def _call(self, prompt: str, stop: Optional[List[str]]=None, run_manager: Optional[CallbackManagerForLLMRun]=None, is_retry: bool=False, **kwargs: Any) -> str:
        ...
        try:
            ...
            if isinstance(parsed_response, dict):
                ...
                for key in output_keys:
                    ...
                    raise ValueError(f'No valid key ({', '.join(output_keys)}) in response: {parsed_response}')
