...
class HealthCheckServicesScopedList(_messages.Message):
    """A HealthCheckServicesScopedList object.
  ...
  """
    ...
    resources = _messages.MessageField('HealthCheckService', 1, repeated=True)
