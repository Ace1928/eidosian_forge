...
class TestGlanceApiCmd(test_utils.BaseTestCase):
    ...
    def setUp(self):
        ...
        self.mock_object(glance.common.config, 'load_paste_app', self._do_nothing)
    ...
    def test_cache_cleaner_main(self, mock_cache_clean, mock_cache_init_driver, mock_log_setup, mock_parse_config):
        ...
        expected_call_sequence = [mock.call.mock_parse_config(), mock.call.mock_log_setup(CONF, 'glance'), mock.call.mock_cache_init_driver(), mock.call.mock_cache_clean()]
    ...
    def test_cache_cleaner_main_runtime_exception_handling(self, mock_cache):
        ...
        self.mock_object(glance.image_cache.cleaner.Cleaner, 'run', self._raise(RuntimeError))
