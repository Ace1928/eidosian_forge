...
class ProtocolTreeNode(object):
    ...
    def __eq__(self, protocolTreeNode):
        ...
        :return: bool
        """
        if protocolTreeNode.__class__ == ProtocolTreeNode and self.tag == protocolTreeNode.tag and (self.data == protocolTreeNode.data) and (self.attributes == protocolTreeNode.attributes) and (len(self.getAllChildren()) == len(protocolTreeNode.getAllChildren())):
            found = False
