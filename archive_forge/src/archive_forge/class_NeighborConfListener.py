...
class NeighborConfListener(ConfWithIdListener, ConfWithStatsListener):
    ...
    def __init__(self, neigh_conf):
        ...
        neigh_conf.add_listener(NeighborConf.UPDATE_ENABLED_EVT, self.on_update_enabled)
        neigh_conf.add_listener(NeighborConf.UPDATE_MED_EVT, self.on_update_med)
        neigh_conf.add_listener(NeighborConf.UPDATE_CONNECT_MODE_EVT, self.on_update_connect_mode)
