...
def _GetEnvChanges(args, **kwargs):
    ...
    return config_changes.EnvVarLiteralChanges(updates=_StripKeys(getattr(args, 'update_env_vars', None) or args.set_env_vars or args.env_vars_file or {}), removes=_MapLStrip(getattr(args, 'remove_env_vars', None) or []), clear_others=bool(args.set_env_vars or args.env_vars_file or args.clear_env_vars), **kwargs)