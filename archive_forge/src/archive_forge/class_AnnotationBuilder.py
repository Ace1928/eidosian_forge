...
class AnnotationBuilder:
    ...
    @staticmethod
    def text(rect: Union[RectangleObject, Tuple[float, float, float, float]], text: str, open: bool=False, flags: int=0) -> DictionaryObject:
        """
        Add text annotation.
        ...
        """
        deprecate_with_replacement('AnnotationBuilder.text', 'pypdf.annotations.Text', '4.0.0')
    ...
    @staticmethod
    def line(p1: Tuple[float, float], p2: Tuple[float, float], rect: Union[RectangleObject, Tuple[float, float, float, float]], text: str='', title_bar: Optional[str]=None) -> DictionaryObject:
        """
        ...
        Returns:
            A dictionary object representing the annotation.
        """
        deprecate_with_replacement('AnnotationBuilder.line', 'pypdf.annotations.Line', '4.0.0')
    ...
    @staticmethod
    def rectangle(rect: Union[RectangleObject, Tuple[float, float, float, float]], interiour_color: Optional[str]=None) -> DictionaryObject:
        """
        ...
        Returns:
            A dictionary object representing the annotation.
        """
        deprecate_with_replacement('AnnotationBuilder.rectangle', 'pypdf.annotations.Rectangle', '4.0.0')
        from ..annotations import Rectangle
        return Rectangle(rect=rect, interiour_color=interiour_color)

    @staticmethod
    def highlight(*, rect: Union[RectangleObject, Tuple[float, float, float, float]], quad_points: ArrayObject, highlight_color: str='ff0000') -> DictionaryObject:
        """
        ...
        Returns:
            A dictionary object representing the annotation.
        """
        deprecate_with_replacement('AnnotationBuilder.highlight', 'pypdf.annotations.Highlight', '4.0.0')
        from ..annotations import Highlight
        return Highlight(rect=rect, quad_points=quad_points, highlight_color=highlight_color)

    @staticmethod
    def ellipse(rect: Union[RectangleObject, Tuple[float, float, float, float]], interiour_color: Optional[str]=None) -> DictionaryObject:
        """
        Draw a rectangle on the PDF.
        ...
        Returns:
            A dictionary object representing the annotation.
        """
        deprecate_with_replacement('AnnotationBuilder.ellipse', 'pypdf.annotations.Ellipse', '4.0.0')
    ...
    def polygon(vertices: List[Tuple[float, float]]) -> DictionaryObject:
        deprecate_with_replacement('AnnotationBuilder.polygon', 'pypdf.annotations.Polygon', '4.0.0')
        from ..annotations import Polygon
        return Polygon(vertices=vertices)
    from ._fit import DEFAULT_FIT

    @staticmethod
    def link(rect: Union[RectangleObject, Tuple[float, float, float, float]], border: Optional[ArrayObject]=None, url: Optional[str]=None, target_page_index: Optional[int]=None, fit: Fit=DEFAULT_FIT) -> DictionaryObject:
        """
        ...
        Returns:
            A dictionary object representing the annotation.
        """
        deprecate_with_replacement('AnnotationBuilder.link', 'pypdf.annotations.Link', '4.0.0')
        from ..annotations import Link
        return Link(rect=rect, border=border, url=url, target_page_index=target_page_index, fit=fit)