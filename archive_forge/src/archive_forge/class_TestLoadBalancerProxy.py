...
class TestLoadBalancerProxy(test_proxy_base.TestProxyBase):
    ...
    def test_load_balancer_stats_get(self):
        self.verify_get(self.proxy.get_load_balancer_statistics, lb.LoadBalancerStats, method_args=[self.LB_ID], expected_args=[], expected_kwargs={'lb_id': self.LB_ID, 'requires_id': False})
    ...
    def test_load_balancer_delete_cascade(self, mock_get_resource):
        ...
        fake_load_balancer.id = 'load_balancer_id'
        mock_get_resource.return_value = fake_load_balancer
        self._verify('openstack.proxy.Proxy._delete', self.proxy.delete_load_balancer, method_args=['resource_or_id', True, True], expected_args=[lb.LoadBalancer, fake_load_balancer], expected_kwargs={'ignore_missing': True})
    ...
    def test_load_balancer_failover(self):
        self.verify_update(self.proxy.failover_load_balancer, lb.LoadBalancerFailover, method_args=[self.LB_ID], expected_args=[], expected_kwargs={'lb_id': self.LB_ID})
    ...
    def test_listener_stats_get(self):
        self.verify_get(self.proxy.get_listener_statistics, listener.ListenerStats, method_args=[self.LISTENER_ID], expected_args=[], expected_kwargs={'listener_id': self.LISTENER_ID, 'requires_id': False})
    ...
    def test_members(self):
        self.verify_list(self.proxy.members, member.Member, method_kwargs={'pool': self.POOL_ID}, expected_kwargs={'pool_id': self.POOL_ID})

    def test_member_get(self):
        self.verify_get(self.proxy.get_member, member.Member, method_kwargs={'pool': self.POOL_ID}, expected_kwargs={'pool_id': self.POOL_ID})

    def test_member_create(self):
        self.verify_create(self.proxy.create_member, member.Member, method_kwargs={'pool': self.POOL_ID}, expected_kwargs={'pool_id': self.POOL_ID})

    def test_member_delete(self):
        self.verify_delete(self.proxy.delete_member, member.Member, ignore_missing=True, method_kwargs={'pool': self.POOL_ID}, expected_kwargs={'pool_id': self.POOL_ID, 'ignore_missing': True})

    def test_member_find(self):
        self._verify('openstack.proxy.Proxy._find', self.proxy.find_member, method_args=['MEMBER', self.POOL_ID], expected_args=[member.Member, 'MEMBER'], expected_kwargs={'pool_id': self.POOL_ID, 'ignore_missing': True})

    def test_member_update(self):
        self._verify('openstack.proxy.Proxy._update', self.proxy.update_member, method_args=['MEMBER', self.POOL_ID], expected_args=[member.Member, 'MEMBER'], expected_kwargs={'pool_id': self.POOL_ID})
    ...
    def test_health_monitor_delete(self):
        self.verify_delete(self.proxy.delete_health_monitor, health_monitor.HealthMonitor, True)
    ...
    def test_l7_rules(self):
        self.verify_list(self.proxy.l7_rules, l7_rule.L7Rule, method_kwargs={'l7_policy': self.L7_POLICY_ID}, expected_kwargs={'l7policy_id': self.L7_POLICY_ID})

    def test_l7_rule_get(self):
        self.verify_get(self.proxy.get_l7_rule, l7_rule.L7Rule, method_kwargs={'l7_policy': self.L7_POLICY_ID}, expected_kwargs={'l7policy_id': self.L7_POLICY_ID})

    def test_l7_rule_create(self):
        self.verify_create(self.proxy.create_l7_rule, l7_rule.L7Rule, method_kwargs={'l7_policy': self.L7_POLICY_ID}, expected_kwargs={'l7policy_id': self.L7_POLICY_ID})
    ...
    def test_l7_rule_find(self):
        self._verify('openstack.proxy.Proxy._find', self.proxy.find_l7_rule, method_args=['RULE', self.L7_POLICY_ID], expected_args=[l7_rule.L7Rule, 'RULE'], expected_kwargs={'l7policy_id': self.L7_POLICY_ID, 'ignore_missing': True})

    def test_l7_rule_update(self):
        self._verify('openstack.proxy.Proxy._update', self.proxy.update_l7_rule, method_args=['RULE', self.L7_POLICY_ID], expected_args=[l7_rule.L7Rule, 'RULE'], expected_kwargs={'l7policy_id': self.L7_POLICY_ID})
    ...
    def test_quota_default_get(self):
        self._verify('openstack.proxy.Proxy._get', self.proxy.get_quota_default, expected_args=[quota.QuotaDefault], expected_kwargs={'requires_id': False})
    ...
    def test_provider_flavor_capabilities(self):
        self.verify_list(self.proxy.provider_flavor_capabilities, provider.ProviderFlavorCapabilities, method_args=[self.AMPHORA], expected_args=[], expected_kwargs={'provider': self.AMPHORA})
    ...
    def test_flavor_profile_delete(self):
        self.verify_delete(self.proxy.delete_flavor_profile, flavor_profile.FlavorProfile, True)
    ...
    def test_amphora_configure(self):
        self.verify_update(self.proxy.configure_amphora, amphora.AmphoraConfig, method_args=[self.AMPHORA_ID], expected_args=[], expected_kwargs={'amphora_id': self.AMPHORA_ID})

    def test_amphora_failover(self):
        self.verify_update(self.proxy.failover_amphora, amphora.AmphoraFailover, method_args=[self.AMPHORA_ID], expected_args=[], expected_kwargs={'amphora_id': self.AMPHORA_ID})

    def test_availability_zone_profiles(self):
        self.verify_list(self.proxy.availability_zone_profiles, availability_zone_profile.AvailabilityZoneProfile)
    ...
    def test_availability_zone_profile_delete(self):
        self.verify_delete(self.proxy.delete_availability_zone_profile, availability_zone_profile.AvailabilityZoneProfile, True)
    ...
    def test_availability_zone_profile_update(self):
        self.verify_update(self.proxy.update_availability_zone_profile, availability_zone_profile.AvailabilityZoneProfile)
    ...
    def test_availability_zone_get(self):
        self.verify_get(self.proxy.get_availability_zone, availability_zone.AvailabilityZone)

    def test_availability_zone_create(self):
        self.verify_create(self.proxy.create_availability_zone, availability_zone.AvailabilityZone)

    def test_availability_zone_delete(self):
        self.verify_delete(self.proxy.delete_availability_zone, availability_zone.AvailabilityZone, True)

    def test_availability_zone_find(self):
        self.verify_find(self.proxy.find_availability_zone, availability_zone.AvailabilityZone)

    def test_availability_zone_update(self):
        self.verify_update(self.proxy.update_availability_zone, availability_zone.AvailabilityZone)