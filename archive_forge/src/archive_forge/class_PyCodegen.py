...
class PyCodegen:
    ...
    def __init__(self, tx=None, root: Optional[torch.nn.Module]=None, graph_output_var: Optional[str]=None, tempvars=None):
        self.root = root
    ...
    def __call__(self, value, allow_cache=True):
        ...
        elif isinstance(value, (TensorVariable, SymNodeVariable, UnspecializedPythonVariable, NumpyNdarrayVariable)):
            graph_outputs_key = self.add_graph_output(value)
    ...
    def pop_null(self):
        ...
        return [self._create_load_const(lambda: None), *create_call_function(0, False), create_instruction('POP_TOP')]
