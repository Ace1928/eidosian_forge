...
class SSHKeysClient(ClientEntityBase):
    ...
    def get_list(self, name: str | None=None, fingerprint: str | None=None, label_selector: str | None=None, page: int | None=None, per_page: int | None=None) -> SSHKeysPageResult:
        ...
        ssh_keys = [BoundSSHKey(self, server_data) for server_data in response['ssh_keys']]
        return SSHKeysPageResult(ssh_keys, Meta.parse_meta(response))

    def get_all(self, name: str | None=None, fingerprint: str | None=None, label_selector: str | None=None) -> list[BoundSSHKey]:
    ...
    def create(self, name: str, public_key: str, labels: dict[str, str] | None=None) -> BoundSSHKey:
    ...
    def update(self, ssh_key: SSHKey | BoundSSHKey, name: str | None=None, labels: dict[str, str] | None=None) -> BoundSSHKey:
        ...
        if labels is not None:
            data['labels'] = labels
        response = self._client.request(url=f'/ssh_keys/{ssh_key.id}', method='PUT', json=data)
        return BoundSSHKey(self, response['ssh_key'])
