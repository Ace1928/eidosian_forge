...
def _CopyObjToObjInTheCloud(src_url, src_obj_metadata, dst_url, dst_obj_metadata, preconditions, gsutil_api, decryption_key=None):
  ...
  """
    ...
    progress_callback = FileProgressCallbackHandler(gsutil_api.status_queue, src_url=src_url, dst_url=dst_url, operation_name='Copying').call
    ...
    PutToQueueWithTimeout(gsutil_api.status_queue, FileMessage(src_url, dst_url, end_time, message_type=FileMessage.FILE_CLOUD_COPY, size=src_obj_metadata.size, finished=True))
