...
class RemoteFunction2(Generic[R, T0, T1, T2]):
    ...
    def remote(self, __arg0: 'Union[T0, ObjectRef[T0]]', __arg1: 'Union[T1, ObjectRef[T1]]', __arg2: 'Union[T2, ObjectRef[T2]]') -> 'ObjectRef[R]':
        ...

    def bind(self, __arg0: 'Union[T0, DAGNode[T0]]', __arg1: 'Union[T1, DAGNode[T1]]', __arg2: 'Union[T2, DAGNode[T2]]') -> 'DAGNode[R]':
        ...