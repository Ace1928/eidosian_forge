...
class StatefulQAM(QAM[T]):
    ...
    def write_memory(self, *, region_name: str, value: Union[int, float, Sequence[int], Sequence[float]], offset: Optional[int]=None) -> 'StatefulQAM[T]':
