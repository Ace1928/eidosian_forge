...
class PointDNSTests(unittest.TestCase):
    ...
    def test_create_record_success(self):
        ...
        zone = self.driver.list_zones()[0]
        PointDNSMockHttp.type = 'CREATE'
        record = self.driver.create_record(name='site.example.com', zone=zone, type=RecordType.A, data='1.2.3.4')
    ...
    def test_update_record_success(self):
        ...
        extra = {'ttl': 4500}
        record1 = self.driver.update_record(record=record, name='updated.com', type=RecordType.A, data='1.2.3.5', extra=extra)
        self.assertEqual(record.data, '1.2.3.4')
    ...
    def test_ex_create_redirect_with_error(self):
        ...
        PointDNSMockHttp.type = 'CREATE_WITH_ERROR'
        try:
            self.driver.ex_create_redirect('http://other.com', 'redirect2', '302', zone, iframe='An Iframe', query=True)
