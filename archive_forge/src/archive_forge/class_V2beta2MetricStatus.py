...
class V2beta2MetricStatus(object):
    ...
    swagger_types = {'external': 'V2beta2ExternalMetricStatus', 'object': 'V2beta2ObjectMetricStatus', 'pods': 'V2beta2PodsMetricStatus', 'resource': 'V2beta2ResourceMetricStatus', 'type': 'str'}
