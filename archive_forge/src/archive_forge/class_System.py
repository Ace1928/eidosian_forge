...
class System(_ProcessContainer):
    ...
    __binary_types = {win32.VFT_APP: 'application', win32.VFT_DLL: 'dynamic link library', win32.VFT_STATIC_LIB: 'static link library', win32.VFT_FONT: 'font', win32.VFT_DRV: 'driver', win32.VFT_VXD: 'legacy driver'}
    __driver_types = {win32.VFT2_DRV_COMM: 'communications driver', win32.VFT2_DRV_DISPLAY: 'display driver', win32.VFT2_DRV_INSTALLABLE: 'installable driver', win32.VFT2_DRV_KEYBOARD: 'keyboard driver', win32.VFT2_DRV_LANGUAGE: 'language driver', win32.VFT2_DRV_MOUSE: 'mouse driver', win32.VFT2_DRV_NETWORK: 'network driver', win32.VFT2_DRV_PRINTER: 'printer driver', win32.VFT2_DRV_SOUND: 'sound driver', win32.VFT2_DRV_SYSTEM: 'system driver', win32.VFT2_DRV_VERSIONED_PRINTER: 'versioned printer driver'}
    __font_types = {win32.VFT2_FONT_RASTER: 'raster font', win32.VFT2_FONT_TRUETYPE: 'TrueType font', win32.VFT2_FONT_VECTOR: 'vector font'}
    __months = ('January', 'February', 'March', 'April', 'May', 'June', 'July', 'August', 'September', 'October', 'November', 'December')
    __days_of_the_week = ('Sunday', 'Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday')
    ...
    __dbghelp_locations = {win32.ARCH_AMD64: set([path.join(getenv('ProgramFiles', 'C:\\Program Files'), 'Windows Kits', '8.0', 'Debuggers', 'x64', 'dbghelp.dll'), path.join(getenv('ProgramW6432', getenv('ProgramFiles', 'C:\\Program Files')), 'Windows Kits', '8.0', 'Debuggers', 'x64', 'dbghelp.dll'), path.join(getenv('ProgramFiles', 'C:\\Program Files'), 'Debugging Tools for Windows (x64)', 'dbghelp.dll')]), win32.ARCH_I386: set([path.join(getenv('ProgramFiles', 'C:\\Program Files'), 'Windows Kits', '8.0', 'Debuggers', 'x86', 'dbghelp.dll'), path.join(getenv('ProgramW6432', getenv('ProgramFiles', 'C:\\Program Files')), 'Windows Kits', '8.0', 'Debuggers', 'x86', 'dbghelp.dll'), path.join(getenv('ProgramFiles', 'C:\\Program Files'), 'Debugging Tools for Windows (x86)', 'dbghelp.dll'), path.join(getenv('ProgramFiles', 'C:\\Program Files'), 'Debugging Tools for Windows (x86)', 'dbghelp.dll')])}
