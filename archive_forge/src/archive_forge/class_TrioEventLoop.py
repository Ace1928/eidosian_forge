...
class TrioEventLoop(EventLoop):
    ...
    def alarm(self, seconds: float, callback: Callable[[], typing.Any]) -> trio.CancelScope:
    ...
    def watch_file(self, fd: int | io.IOBase, callback: Callable[[], typing.Any]) -> trio.CancelScope:
    ...
    async def _alarm_task(self, scope: trio.CancelScope, seconds: float, callback: Callable[[], typing.Any]) -> None:
    ...
    async def _watch_task(self, scope: trio.CancelScope, fd: int | io.IOBase, callback: Callable[[], typing.Any]) -> None:
