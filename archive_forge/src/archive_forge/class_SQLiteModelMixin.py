...
class SQLiteModelMixin(BaseModel, abc.ABC):
    ...
    @classmethod
    async def aexecute_sql_init(cls, conn: 'aiosqlite.Connection', tablename: Optional[str]=None, skip_index: Optional[bool]=None, auto_set: Optional[bool]=None):
        """
        Executes the sql init
    ...
    def _get_export_sql_data(self, schemas: Dict[str, Union[str, List[str], Dict[str, str]]], data: Optional[Dict[str, Any]]=None, include: 'IncEx'=None, exclude: 'IncEx'=None, by_alias: bool=False, exclude_unset: bool=False, exclude_defaults: bool=False, exclude_none: bool=False, **kwargs) -> Tuple[Union[str, int, float, Any], ...]:
        """
    ...
    @overload
    def sql_set(self, conn: 'sqlite3.Connection', tablename: Optional[str]=None, include: 'IncEx'=None, exclude: 'IncEx'=None, by_alias: bool=False, exclude_unset: bool=False, exclude_defaults: bool=False, exclude_none: bool=False, **kwargs) -> None:
        """
    ...
    @overload
    async def asql_set(self, conn: 'aiosqlite.Connection', tablename: Optional[str]=None, include: 'IncEx'=None, exclude: 'IncEx'=None, by_alias: bool=False, exclude_unset: bool=False, exclude_defaults: bool=False, exclude_none: bool=False, **kwargs) -> None:
        """
        Saves the data to the database
        """
        ...

    async def asql_set(self, conn: 'aiosqlite.Connection', tablename: Optional[str]=None, **kwargs):
        """
        Saves the data to the database
        """
        insert_dict, insert_data = self._get_export_sql_data_and_index(self.sql_schema, **kwargs)
    ...
    @classmethod
    async def asql_set_many(cls: type['SQLResultT'], conn: 'aiosqlite.Connection', items: List['SQLResultT'], tablename: Optional[str]=None, include: 'IncEx'=None, exclude: 'IncEx'=None, by_alias: bool=False, exclude_unset: bool=False, exclude_defaults: bool=False, exclude_none: bool=False, **kwargs):
        """
        Inserts many items to the database
        """
        schemas = get_or_register_sqlite_schema(cls, tablename)
    ...
    async def asql_refresh(self: 'SQLResultT', conn: 'aiosqlite.Connection', tablename: Optional[str]=None, **kwargs) -> 'SQLResultT':
        """
        Refreshes the data from the database
        """
        schemas = get_or_register_sqlite_schema(self.__class__, tablename)
    ...
    @overload
    @classmethod
    def search_one(cls: type[SQLResultT], conn: 'sqlite3.Connection', query: Optional[str]=None, skip: Optional[int]=None, **kwargs) -> 'SQLResultT':
        """
    ...
    @overload
    @classmethod
    def search_one(cls: type[SQLResultT], conn: 'sqlite3.Connection', query: Optional[str]=None, skip: Optional[int]=None, return_fields: Optional[List[str]]=None, **kwargs) -> Dict[str, Any]:
        """
        Executes the sql search for one item
        """
        ...
    ...
    @overload
    @classmethod
    def search_one(cls: type[SQLResultT], conn: 'sqlite3.Connection', query: Optional[str]=None, skip: Optional[int]=None, return_id_only: Optional[bool]=True, **kwargs) -> str:
        """
        Executes the sql search for one item
        """
        ...
    ...
    @classmethod
    def search_one(cls: type[SQLResultT], conn: 'sqlite3.Connection', query: Optional[str]=None, skip: Optional[int]=None, return_id_only: Optional[bool]=None, return_fields: Optional[List[str]]=None, tablename: Optional[str]=None, verbose: Optional[bool]=None, **kwargs) -> Optional[Union['SQLResultT', str]]:
        """
        Executes the sql search for one item
        """
        cur = conn.cursor()
        ...
        if not query.strip():
            if verbose:
                logger.warning(f'[{tablename}] No query provided. Returning null: {query}, {kwargs}')
            return None
        query_script = SqliteTemplates['search'].render(query=query, limit=1, skip=skip, return_id_only=return_id_only, return_fields=return_fields, **sql_config.sql_schema)
        try:
        ...
        if result is None:
            return None
        if return_fields:
            return dict(zip(return_fields, result))
        if return_id_only:
            return result[0]
    ...
    @overload
    @classmethod
    def search_many(cls: type[SQLResultT], conn: 'sqlite3.Connection', query: Optional[str]=None, limit: Optional[int]=None, skip: Optional[int]=None, **kwargs) -> List['SQLResultT']:
        """
    ...
    @classmethod
    def search_many(cls: type[SQLResultT], conn: 'sqlite3.Connection', query: Optional[str]=None, limit: Optional[int]=None, skip: Optional[int]=None, return_id_only: Optional[bool]=None, return_fields: Optional[List[str]]=None, tablename: Optional[str]=None, verbose: Optional[bool]=None, **kwargs) -> List[Union['SQLResultT', str]]:
        """
        Executes the sql search for many items
        """
        sql_config = get_sqlite_model_config(cls, tablename)
        ...
        if not query.strip():
            if verbose:
                logger.warning(f'[{tablename}] No query provided. Returning empty list: {query}, {kwargs}')
            return []
        query_script = SqliteTemplates['search'].render(query=query, limit=limit, skip=skip, return_id_only=return_id_only, return_fields=return_fields, **sql_config.sql_schema)
        cur = conn.cursor()
        try:
            cur.execute(query_script)
            ...
            for result in cur.fetchall():
                if result:
                    if return_fields:
                        results.append(dict(zip(return_fields, result)))
                    elif return_id_only:
                        results.append(result[0])
                    else:
                        results.append(cls.model_validate(dict(zip(sql_config.sql_keys, result))))
                else:
                    results.append(None)
            return results
        except Exception as e:
    ...
    @overload
    @classmethod
    async def asearch_one(cls: type[SQLResultT], conn: 'sqlite3.Connection', query: Optional[str]=None, skip: Optional[int]=None, **kwargs) -> 'SQLResultT':
        """
        Executes the sql search for one item
        """
        ...
    ...
    @classmethod
    async def asearch_one(cls: type[SQLResultT], conn: 'aiosqlite.Connection', query: Optional[str]=None, skip: Optional[int]=None, return_id_only: Optional[bool]=None, return_fields: Optional[List[str]]=None, tablename: Optional[str]=None, verbose: Optional[bool]=None, **kwargs) -> Optional[Union['SQLResultT', str]]:
        """
        Executes the sql search for one item
        """
        sql_config = get_sqlite_model_config(cls, tablename)
    ...
    @overload
    @classmethod
    async def asearch_many(cls: type[SQLResultT], conn: 'sqlite3.Connection', query: Optional[str]=None, limit: Optional[int]=None, skip: Optional[int]=None, **kwargs) -> List['SQLResultT']:
        """
        Executes the sql search for many items
        """
        ...
    ...
    @classmethod
    async def asearch_many(cls: type[SQLResultT], conn: 'aiosqlite.Connection', query: Optional[str]=None, limit: Optional[int]=None, skip: Optional[int]=None, return_id_only: Optional[bool]=None, return_fields: Optional[List[str]]=None, tablename: Optional[str]=None, verbose: Optional[bool]=None, **kwargs) -> List[Union['SQLResultT', str]]:
        """
        Executes the sql search for one item
        """
        sql_config = get_sqlite_model_config(cls, tablename)
    ...
    def __setattr__(self, name: str, value: Any) -> None:
        ...
        if name.startswith('sql_') or name.startswith('_'):
            return
        if not self.sql_autoset:
            return
        if name not in self.sql_fields:
            return
        if self._is_in_sql_update():
            return
    ...
    async def asql_delete(self, conn: 'aiosqlite.Connection', tablename: Optional[str]=None, **kwargs):
        """
        Deletes the object from the database
        """
        delete_script = SqliteTemplates['delete'].render(**self.sql_schema)
