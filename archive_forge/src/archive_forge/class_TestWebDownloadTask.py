...
class TestWebDownloadTask(test_utils.BaseTestCase):
    ...
    def setUp(self):
        ...
        task_input = {'import_req': {'method': {'name': 'web_download', 'uri': 'http://cloud.foo/image.qcow2'}}}
        ...
        self.web_download_task = web_download._WebDownload(self.task.task_id, self.task_type, self.uri, self.action_wrapper, ['foo'])
