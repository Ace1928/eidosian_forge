...
def test_fetchParserMacros(self):
    cases = [[b'ALL', (4, [b'flags', b'internaldate', b'rfc822.size', b'envelope'])], [b'FULL', (5, [b'flags', b'internaldate', b'rfc822.size', b'envelope', b'body'])], [b'FAST', (3, [b'flags', b'internaldate', b'rfc822.size'])]]
