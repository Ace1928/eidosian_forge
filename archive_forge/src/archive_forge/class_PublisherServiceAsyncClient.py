...
class PublisherServiceAsyncClient:
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        """
        return PublisherServiceClient.from_service_account_info.__func__(PublisherServiceAsyncClient, info, *args, **kwargs)
    ...
    def from_service_account_file(cls, filename: str, *args, **kwargs):
        ...
        Returns:
            PublisherServiceAsyncClient: The constructed client.
        """
        return PublisherServiceClient.from_service_account_file.__func__(PublisherServiceAsyncClient, filename, *args, **kwargs)
    ...
    def get_mtls_endpoint_and_cert_source(cls, client_options: Optional[ClientOptions]=None):
        ...
        """
        return PublisherServiceClient.get_mtls_endpoint_and_cert_source(client_options)
    ...
    def __init__(self, *, credentials: Optional[ga_credentials.Credentials]=None, transport: Union[str, PublisherServiceTransport]='grpc_asyncio', client_options: Optional[ClientOptions]=None, client_info: gapic_v1.client_info.ClientInfo=DEFAULT_CLIENT_INFO) -> None:
        ...
        """
        self._client = PublisherServiceClient(credentials=credentials, transport=transport, client_options=client_options, client_info=client_info)

    def publish(self, requests: Optional[AsyncIterator[publisher.PublishRequest]]=None, *, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> Awaitable[AsyncIterable[publisher.PublishResponse]]:
        ...
        """
        rpc = gapic_v1.method_async.wrap_method(self._client._transport.publish, default_timeout=None, client_info=DEFAULT_CLIENT_INFO)
