...
class AdaNorm(nn.Module):
    ...
    It also includes options for different normalization strategies and adaptive
    ...
    def extra_repr(self) -> str:
        return f"num_features={self.num_features}, eps={self.eps}, adaptive={self.adaptive}, momentum={self.momentum}"
