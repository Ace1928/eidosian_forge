...
class GlobalLister(BaseLister):
    ...
    def GetResources(self, args, errors):
        return lister.GetGlobalResourcesDicts(service=self.service, project=self.project, filter_expr=self.GetFilterExpr(args), http=self.http, batch_url=self.batch_url, errors=errors)