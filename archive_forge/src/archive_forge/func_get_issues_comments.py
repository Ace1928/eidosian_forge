...
def get_issues_comments(self, sort: Opt[str]=NotSet, direction: Opt[str]=NotSet, since: Opt[datetime]=NotSet) -> PaginatedList[IssueComment]:
    """
    ...
    return PaginatedList(github.IssueComment.IssueComment, self._requester, f'{self.url}/issues/comments', url_parameters)