...
class AddLabelFixedCandsTRA(TorchRankerAgent):
    ...
    def add_cmdline_args(cls, argparser):
        ...
        agent.add_argument('--add-label-to-fixed-cands', type='bool', default=True, hidden=True, help='When true, adds an example label to the fixed candidate set if not already present')
