...
class SpectralDistortionIndex(Metric):
    ...
    def __init__(self, p: int=1, reduction: Literal['elementwise_mean', 'sum', 'none']='elementwise_mean', **kwargs: Any) -> None:
        ...
        rank_zero_warn('Metric `SpectralDistortionIndex` will save all targets and predictions in buffer. For large datasets this may lead to large memory footprint.')
