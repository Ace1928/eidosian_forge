...
class MultilabelRecallAtFixedPrecision(MultilabelPrecisionRecallCurve):
    ...
    def __init__(self, num_labels: int, min_precision: float, thresholds: Optional[Union[int, List[float], Tensor]]=None, ignore_index: Optional[int]=None, validate_args: bool=True, **kwargs: Any) -> None:
    ...
    def compute(self) -> Tuple[Tensor, Tensor]:
        ...
        return _multilabel_recall_at_fixed_precision_arg_compute(state, self.num_labels, self.thresholds, self.ignore_index, self.min_precision)
