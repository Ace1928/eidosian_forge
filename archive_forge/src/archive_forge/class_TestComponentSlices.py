...
class TestComponentSlices(unittest.TestCase):
    ...
    def test_setitem_slices(self):
        ...
        with self.assertRaisesRegex(KeyError, "Index 'bogus' is not valid for indexed component 'b\\[1,4\\]\\.c\\[1,4\\]\\.x'"):
            _slice['bogus'] = 0
    ...
    def test_iterators(self):
        ...
        self.assertEqual(list(_slice.wildcard_items()), [(7, m.x[7]), (8, m.x[8]), (9, m.x[9])])
        self.assertEqual(list(_slice.expanded_keys()), [7, 8, 9])
        self.assertEqual(list(_slice.expanded_items()), [(7, m.x[7]), (8, m.x[8]), (9, m.x[9])])
        _slice = self.m.b[...]
        self.assertEqual(list(_slice.wildcard_keys()), [(1, 4), (1, 5), (1, 6), (2, 4), (2, 5), (2, 6), (3, 4), (3, 5), (3, 6)])
        self.assertEqual(list(_slice.wildcard_items()), [((1, 4), m.b[1, 4]), ((1, 5), m.b[1, 5]), ((1, 6), m.b[1, 6]), ((2, 4), m.b[2, 4]), ((2, 5), m.b[2, 5]), ((2, 6), m.b[2, 6]), ((3, 4), m.b[3, 4]), ((3, 5), m.b[3, 5]), ((3, 6), m.b[3, 6])])
        self.assertEqual(list(_slice.expanded_keys()), [(1, 4), (1, 5), (1, 6), (2, 4), (2, 5), (2, 6), (3, 4), (3, 5), (3, 6)])
        self.assertEqual(list(_slice.expanded_items()), [((1, 4), m.b[1, 4]), ((1, 5), m.b[1, 5]), ((1, 6), m.b[1, 6]), ((2, 4), m.b[2, 4]), ((2, 5), m.b[2, 5]), ((2, 6), m.b[2, 6]), ((3, 4), m.b[3, 4]), ((3, 5), m.b[3, 5]), ((3, 6), m.b[3, 6])])
        _slice = self.m.b[1, :]
        self.assertEqual(list(_slice.wildcard_keys(False)), [4, 5, 6])
        self.assertEqual(list(_slice.wildcard_items(False)), [(4, m.b[1, 4]), (5, m.b[1, 5]), (6, m.b[1, 6])])
        self.assertEqual(list(_slice.expanded_keys()), [(1, 4), (1, 5), (1, 6)])
        self.assertEqual(list(_slice.expanded_items()), [((1, 4), m.b[1, 4]), ((1, 5), m.b[1, 5]), ((1, 6), m.b[1, 6])])
    ...
    def test_UnknownSetDimen(self):
        ...
        m.J = Set()
        m.x = Var(m.I, m.J)
        with self.assertRaisesRegex(IndexError, 'Slicing components relies on knowing the underlying set dimensionality'):
            ref = list(m.x[:, :])
    ...
    def test_str(self):
        ...
        self.assertEqual(str(s), "b[...].x[:, 1:2, 1:5:2, ::1, 5, 'a'].component('foo', kwarg=1)")
        s = m.b[...]
        self.assertEqual(str(IndexedComponent_slice(s, (IndexedComponent_slice.del_attribute, 'bogus'))), 'del b[...].bogus')
        self.assertEqual(str(IndexedComponent_slice(s, (IndexedComponent_slice.set_attribute, 'bogus', 10))), 'b[...].bogus = 10')
