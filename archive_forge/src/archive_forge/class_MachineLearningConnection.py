...
class MachineLearningConnection(AWSQueryConnection):
    ...
    _faults = {'InternalServerException': exceptions.InternalServerException, 'LimitExceededException': exceptions.LimitExceededException, 'ResourceNotFoundException': exceptions.ResourceNotFoundException, 'IdempotentParameterMismatchException': exceptions.IdempotentParameterMismatchException, 'PredictorNotMountedException': exceptions.PredictorNotMountedException, 'InvalidInputException': exceptions.InvalidInputException}
    ...
    def create_batch_prediction(self, batch_prediction_id, ml_model_id, batch_prediction_data_source_id, output_uri, batch_prediction_name=None):
        ...
        return self.make_request(action='CreateBatchPrediction', body=json.dumps(params))
    ...
    def describe_batch_predictions(self, filter_variable=None, eq=None, gt=None, lt=None, ge=None, le=None, ne=None, prefix=None, sort_order=None, next_token=None, limit=None):
        ...
        if limit is not None:
            params['Limit'] = limit
        return self.make_request(action='DescribeBatchPredictions', body=json.dumps(params))
    ...
    def make_request(self, action, body, host=None):
        ...
        http_request_kwargs = {'method': 'POST', 'path': '/', 'auth_path': '/', 'params': {}, 'headers': headers, 'data': body}
        if host is not None:
            headers['Host'] = host
