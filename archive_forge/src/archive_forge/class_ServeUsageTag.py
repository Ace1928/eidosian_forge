...
class ServeUsageTag(Enum):
    ...
    AUTOSCALING_CONFIG_LIGHTWEIGHT_UPDATED = TagKey.SERVE_AUTOSCALING_CONFIG_LIGHTWEIGHT_UPDATED
    ...
    DEPLOYMENT_HANDLE_TO_OBJECT_REF_API_USED = TagKey.SERVE_DEPLOYMENT_HANDLE_TO_OBJECT_REF_API_USED
    ...
    DEPLOYMENT_CONTAINER_RUNTIME_ENV_USED = TagKey.SERVE_DEPLOYMENT_CONTAINER_RUNTIME_ENV_USED
