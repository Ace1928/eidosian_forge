...
class FloatingIPsClient(ClientEntityBase):
    ...
    def get_actions_list(self, floating_ip: FloatingIP | BoundFloatingIP, status: list[str] | None=None, sort: list[str] | None=None, page: int | None=None, per_page: int | None=None) -> ActionsPageResult:
        ...
        response = self._client.request(url=f'/floating_ips/{floating_ip.id}/actions', method='GET', params=params)
        actions = [BoundAction(self._client.actions, action_data) for action_data in response['actions']]
        return ActionsPageResult(actions, Meta.parse_meta(response))

    def get_actions(self, floating_ip: FloatingIP | BoundFloatingIP, status: list[str] | None=None, sort: list[str] | None=None) -> list[BoundAction]:
        """Returns all action objects for a Floating IP.
        ...
        """
        return self._iter_pages(self.get_actions_list, floating_ip, status=status, sort=sort)
    ...
    def get_list(self, label_selector: str | None=None, page: int | None=None, per_page: int | None=None, name: str | None=None) -> FloatingIPsPageResult:
    ...
    def get_all(self, label_selector: str | None=None, name: str | None=None) -> list[BoundFloatingIP]:
    ...
    def create(self, type: str, description: str | None=None, labels: str | None=None, home_location: Location | BoundLocation | None=None, server: Server | BoundServer | None=None, name: str | None=None) -> CreateFloatingIPResponse:
        ...
        result = CreateFloatingIPResponse(floating_ip=BoundFloatingIP(self, response['floating_ip']), action=action)
        return result

    def update(self, floating_ip: FloatingIP | BoundFloatingIP, description: str | None=None, labels: dict[str, str] | None=None, name: str | None=None) -> BoundFloatingIP:
        ...
        if name is not None:
            data['name'] = name
        response = self._client.request(url=f'/floating_ips/{floating_ip.id}', method='PUT', json=data)
        return BoundFloatingIP(self, response['floating_ip'])
    ...
    def delete(self, floating_ip: FloatingIP | BoundFloatingIP) -> bool:
        ...
        :return: boolean
        """
        self._client.request(url=f'/floating_ips/{floating_ip.id}', method='DELETE')
        return True

    def change_protection(self, floating_ip: FloatingIP | BoundFloatingIP, delete: bool | None=None) -> BoundAction:
        ...
        response = self._client.request(url=f'/floating_ips/{floating_ip.id}/actions/change_protection', method='POST', json=data)
        return BoundAction(self._client.actions, response['action'])

    def assign(self, floating_ip: FloatingIP | BoundFloatingIP, server: Server | BoundServer) -> BoundAction:
        ...
        :return: :class:`BoundAction <hcloud.actions.client.BoundAction>`
        """
        response = self._client.request(url=f'/floating_ips/{floating_ip.id}/actions/assign', method='POST', json={'server': server.id})
        return BoundAction(self._client.actions, response['action'])
    ...
    def unassign(self, floating_ip: FloatingIP | BoundFloatingIP) -> BoundAction:
        ...
        :return: :class:`BoundAction <hcloud.actions.client.BoundAction>`
        """
        response = self._client.request(url=f'/floating_ips/{floating_ip.id}/actions/unassign', method='POST')
        return BoundAction(self._client.actions, response['action'])

    def change_dns_ptr(self, floating_ip: FloatingIP | BoundFloatingIP, ip: str, dns_ptr: str) -> BoundAction:
        ...
        :return: :class:`BoundAction <hcloud.actions.client.BoundAction>`
        """
        response = self._client.request(url=f'/floating_ips/{floating_ip.id}/actions/change_dns_ptr', method='POST', json={'ip': ip, 'dns_ptr': dns_ptr})
        return BoundAction(self._client.actions, response['action'])