...
class StructureVis:
    ...
    def __init__(self, element_color_mapping=None, show_unit_cell=True, show_bonds=False, show_polyhedron=True, poly_radii_tol_factor=0.5, excluded_bonding_elements=None):
        """
    ...
    def display_help(self):
        ...
        help_text = ['h : Toggle help', 'A/a, B/b or C/c : Increase/decrease cell by one a, b or c unit vector', '# : Toggle showing of polyhedrons', '-: Toggle showing of bonds', 'r : Reset camera direction', f'[/]: Decrease or increase poly_radii_tol_factor by 0.05. Value = {self.poly_radii_tol_factor}', 'Up/Down: Rotate view along Up direction by 90 clockwise/anticlockwise', 'Left/right: Rotate view along camera direction by 90 clockwise/anticlockwise', 's: Save view to image.png', 'o: Orthogonalize structure']
