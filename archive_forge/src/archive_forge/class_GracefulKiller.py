...
class GracefulKiller:
    kill_now = False
    signals = {signal.SIGINT: 'SIGINT', signal.SIGTERM: 'SIGTERM', signal.SIGKILL: 'SIGKILL', signal.SIGQUIT: 'SIGQUIT', signal.SIGSTOP: 'SIGSTOP', signal.SIGABRT: 'SIGABRT'}

    def __init__(self, enabled: Optional[List[signal.Signals]]=[signal.SIGINT, signal.SIGTERM], logger: Optional['Logger']=None):
