...
class ShareNetworkManager(base.ManagerWithFind):
    ...
    def create(self, neutron_net_id=None, neutron_subnet_id=None, nova_net_id=None, name=None, description=None):
    ...
    @api_versions.wraps('2.26', '2.50')
    def create(self, neutron_net_id=None, neutron_subnet_id=None, name=None, description=None):
        """Create share network.
    ...
    def create(self, neutron_net_id=None, neutron_subnet_id=None, name=None, description=None, availability_zone=None):
        values = {}
        if neutron_net_id:
            values['neutron_net_id'] = neutron_net_id
        if neutron_subnet_id:
    ...
    def get(self, share_network):
        ...
        """
        return self._get(RESOURCE_PATH % base.getid(share_network), RESOURCE_NAME)

    @api_versions.wraps('1.0', '2.25')
    def update(self, share_network, neutron_net_id=None, neutron_subnet_id=None, nova_net_id=None, name=None, description=None):
        ...
        body = {RESOURCE_NAME: values}
        return self._update(RESOURCE_PATH % base.getid(share_network), body, RESOURCE_NAME)

    @api_versions.wraps('2.26')
    def update(self, share_network, neutron_net_id=None, neutron_subnet_id=None, name=None, description=None):
        """Updates a share network.
    ...
    @api_versions.wraps('2.63')
    def update_share_network_security_service(self, share_network, current_security_service, new_security_service):
        ...
        :rtype: :class:`ShareNetwork`
        """
        info = {'current_service_id': base.getid(current_security_service), 'new_service_id': base.getid(new_security_service)}
    ...
    def share_network_subnet_create_check(self, share_network_id, neutron_net_id=None, neutron_subnet_id=None, availability_zone=None, reset_operation=False):
        ...
        return self._action('share_network_subnet_create_check', share_network_id, values)