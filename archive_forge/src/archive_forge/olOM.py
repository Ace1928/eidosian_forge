...
# Define color constants for better readability and maintainability
...
ORANGE_RED = "\033[38;2;255;128;0m"
ORANGE = "\033[38;2;255;165;0m"
YELLOW_ORANGE = "\033[38;2;255;192;0m"
YELLOW = "\033[38;2;255;255;0m"
YELLOW_GREEN = "\033[38;2;192;255;0m"
GREEN = "\033[38;2;0;255;0m"
DARK_GREEN = "\033[38;2;0;192;0m"
TEAL = "\033[38;2;0;128;128m"
CYAN = "\033[38;2;0;255;255m"
BLUE = "\033[38;2;0;0;255m"
DARK_BLUE = "\033[38;2;0;0;192m"
PURPLE = "\033[38;2;128;0;255m"
MAGENTA = "\033[38;2;192;0;255m"
    ...
    def print_characters(self, batch_size: int = 1000):
        ...
        with log_memory_usage():
            for batch in self._batch(self.characters, batch_size):
                ...
                print()  # Move to the next line after each batch
            ...
            with multiprocessing.Pool() as pool:
                ...
                for batch in batches:
                    ...
                    for char, color in zip(batch, itertools.cycle(colors)):
                        # Validate color string before using
                        if color:  # Ensure color is not an empty string
                            self.character_text.insert(
                                "end", f"{char}", ("color", color)
                            )
                            try:
                                self.character_text.tag_configure(
                            ...
                            logging.warning("Empty color string encountered.")
