...
class UnpaddedLlamaModel(UnpaddedLlamaPreTrainedModel):
    ...
    def __init__(self, config: LlamaConfig):
        ...
        self.rotary_emb = UnpaddedLlamaRotaryEmbedding(config.hidden_size // config.num_attention_heads, max_position_embeddings=config.max_position_embeddings, base=config.rope_theta)
