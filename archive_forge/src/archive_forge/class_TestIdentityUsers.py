...
class TestIdentityUsers(base.TestCase):
    ...
    def get_mock_url(self, service_type='identity', interface='public', resource='users', append=None, base_url_append='v3', qs_elements=None):
        return super(TestIdentityUsers, self).get_mock_url(service_type, interface, resource, append, base_url_append, qs_elements)
    ...
    def test_create_user(self):
        ...
        user = self.cloud.create_user(user_data.name, password=user_data.password, domain_id=domain_data.domain_id)
