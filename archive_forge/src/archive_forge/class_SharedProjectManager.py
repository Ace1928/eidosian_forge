...
class SharedProjectManager(ListMixin, RESTManager):
    ...
    _list_filters = ('archived', 'visibility', 'order_by', 'sort', 'search', 'simple', 'starred', 'with_issues_enabled', 'with_merge_requests_enabled', 'min_access_level', 'with_custom_attributes')