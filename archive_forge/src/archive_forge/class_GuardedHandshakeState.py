...
class GuardedHandshakeState(ForwarderHandshakeState):
    ...
    _TRANSITIONS = [['start', 'init', 'handshake'], ['next_message', 'handshake', '='], ['start', 'handshake', '='], ['finish', 'handshake', 'finish'], ['start', 'finish', 'handshake']]
    ...
    def __init__(self, handshakestate):
        ...
        self._handshake_machine = Machine(states=self._STATES, transitions=self._TRANSITIONS, initial='init')
        self._pattern_machine = None
