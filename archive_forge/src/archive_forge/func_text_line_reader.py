...
def text_line_reader(skip_header_lines: int=0, container: str='', shared_name: str='', name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.String]:
  ...
  """
    ...
    _, _, _op, _outputs = _op_def_library._apply_op_helper('TextLineReader', skip_header_lines=skip_header_lines, container=container, shared_name=shared_name, name=name)
    _result = _outputs[:]
