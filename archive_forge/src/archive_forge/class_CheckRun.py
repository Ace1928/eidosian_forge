...
class CheckRun(CompletableGithubObject):
    ...
    def edit(self, name: Opt[str]=NotSet, head_sha: Opt[str]=NotSet, details_url: Opt[str]=NotSet, external_id: Opt[str]=NotSet, status: Opt[str]=NotSet, started_at: Opt[datetime]=NotSet, conclusion: Opt[str]=NotSet, completed_at: Opt[datetime]=NotSet, output: Opt[dict]=NotSet, actions: Opt[list[dict]]=NotSet) -> None:
        """
    ...
    def _useAttributes(self, attributes: dict[str, Any]) -> None:
        ...
        if 'check_suite' in attributes and 'id' in attributes['check_suite']:
