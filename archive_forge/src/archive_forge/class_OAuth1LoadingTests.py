...
class OAuth1LoadingTests(test_utils.TestCase):
    ...
    def test_basic(self):
        ...
        p = self.create(access_key=access_key, access_secret=access_secret, consumer_key=consumer_key, consumer_secret=consumer_secret)
    ...
    def test_options(self):
        ...
        self.assertEqual(set([o.name for o in options]), set(['auth-url', 'access-key', 'access-secret', 'consumer-key', 'consumer-secret']))