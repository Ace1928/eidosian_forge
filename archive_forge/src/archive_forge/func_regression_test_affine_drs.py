...
def regression_test_affine_drs(self):
    ...
    results = pyros.solve(model=m, first_stage_variables=m.decision_vars, second_stage_variables=[], uncertain_params=[m.p[1]], uncertainty_set=box_set, local_solver=solver, global_solver=solver, options={'objective_focus': ObjectiveType.nominal, 'decision_rule_order': 1})
