...
def AddManagedConfigFlag(parser, hidden=True):
    ...
    parser.add_argument('--managed-config', choices={'disabled': 'Disable managed config.', 'autofleet': 'Selects fleet conforming config for the cluster.'}, help=help_text, hidden=hidden)