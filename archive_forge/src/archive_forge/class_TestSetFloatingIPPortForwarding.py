...
class TestSetFloatingIPPortForwarding(TestFloatingIPPortForwarding):
    ...
    def setUp(self):
        ...
        self.network_client.update_floating_ip_port_forwarding = mock.Mock(return_value=None)
        ...
        self.cmd = floating_ip_port_forwarding.SetFloatingIPPortForwarding(self.app, self.namespace)
