...
def test_group_type_delete_group_specs_prop(self):
    self._verify('openstack.block_storage.v3.group_type.GroupType.delete_group_specs_property', self.proxy.delete_group_type_group_specs_property, method_args=['value', 'prop'], expected_args=[self.proxy, 'prop'])