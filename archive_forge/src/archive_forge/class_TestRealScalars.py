...
class TestRealScalars:
    ...
    def test_dragon4(self):
        ...
        assert_equal(fpos32(0.5 ** (126 + 23), unique=False, precision=149), '0.00000000000000000000000000000000000000000000140129846432481707092372958328991613128026194189281577175706828388979108268586060148663818836212158203125')
