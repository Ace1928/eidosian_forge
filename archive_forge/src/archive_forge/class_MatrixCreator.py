...
class MatrixCreator(object):
    ...
    def __init__(self, args, context, history_id, gcs_results_root, release_track):
    ...
    def _TestSpecFromType(self, test_type):
        ...
        if test_type == 'xctest':
            ...
            raise exceptions.InvalidArgumentException('type', 'Unknown test type "{}".'.format(test_type))
