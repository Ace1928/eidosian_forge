...
try:
    ...
    logger.info("Datasets loaded successfully into pandas DataFrames")
except Exception as e:
    logger.error(f"Failed to load datasets into DataFrames: {e}")
    raise

# Extract questions and answers from the training data
train_questions = train_data["question"].tolist()
train_answers = train_data["answer"].tolist()
logger.info("Training questions and answers extracted successfully")

# Extract questions and answers from the validation data
val_questions = val_data["question"].tolist()
val_answers = val_data["answer"].tolist()
logger.info("Validation questions and answers extracted successfully")
...
logger.info("Test questions and answers extracted successfully")
