...
class WaylandModule(ExtensionModule):
    ...
    def __init__(self, interpreter: Interpreter) -> None:
        ...
        self.methods.update({'scan_xml': self.scan_xml, 'find_protocol': self.find_protocol})
    ...
    @typed_kwargs('wayland.find_protocol', KwargInfo('state', str, default='stable', validator=in_set_validator({'stable', 'staging', 'unstable'})), KwargInfo('version', (int, NoneType)))
