...
class Logging_global(ResourceModule):
    ...
    def __init__(self, module):
        super(Logging_global, self).__init__(empty_fact_val={}, facts_module=Facts(module), module=module, resource='logging_global', tmplt=Logging_globalTemplate())
        self.parsers = ['console.facilities', 'global_params.archive.file_num', 'global_params.archive.size', 'global_params.marker_interval', 'global_params.preserve_fqdn', 'global_params.facilities', 'files.archive.size', 'files.archive.file_num', 'files', 'hosts.port', 'hosts', 'users']
    ...
    def list_to_dict(self, param, op=None):
        ...
        if self.state == 'deleted':
            ...
            self.pkey = {'files': 'path', 'hosts': 'hostname', 'users': 'username'}
            for element, val in iteritems(param):
