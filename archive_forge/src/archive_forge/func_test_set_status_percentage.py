...
def test_set_status_percentage(self):
    self._verify('openstack.block_storage.v3.snapshot.Snapshot.set_status', self.proxy.set_snapshot_status, method_args=['value', 'new_status', 'per'], expected_args=[self.proxy, 'new_status', 'per'])