...
class EventAlarmTest(common.HeatTestCase):
    ...
    def test_update(self):
        ...
        update_props.update({'enabled': True, 'insufficient_data_actions': [], 'alarm_actions': [], 'ok_actions': ['signal_handler'], 'query': [dict(field='traits.resource_id', op='eq', value='c7405b0f-139f-4fbd-9348-f32dfc5674ac')]})
