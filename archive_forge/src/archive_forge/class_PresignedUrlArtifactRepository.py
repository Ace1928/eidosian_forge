...
class PresignedUrlArtifactRepository(CloudArtifactRepository):
    ...
    def log_artifact(self, local_file, artifact_path=None):
        ...
        self._upload_to_cloud(cloud_credential_info=cloud_credentials, src_file_path=local_file, artifact_file_path=None)
    ...
    def _get_write_credential_infos(self, remote_file_paths):
        ...
        for relative_path in remote_file_paths:
            ...
            resp = call_endpoint(host_creds=self.db_creds, endpoint=endpoint, method=method, json_body=req_body, response_proto=response_proto)
            headers = [ArtifactCredentialInfo.HttpHeader(name=header.name, value=header.value) for header in resp.headers]
    ...
    def list_artifacts(self, path=''):
        ...
        while True:
            ...
            resp = call_endpoint(host_creds=self.db_creds, endpoint=endpoint, method='GET', json_body=req_body, response_proto=response_proto)
