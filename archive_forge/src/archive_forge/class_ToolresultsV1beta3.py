...
class ToolresultsV1beta3(base_api.BaseApiClient):
    ...
    def __init__(self, url='', credentials=None, get_credentials=True, http=None, model=None, log_request=False, log_response=False, credentials_args=None, default_global_params=None, additional_http_headers=None, response_encoding=None):
        ...
        super(ToolresultsV1beta3, self).__init__(url, credentials=credentials, get_credentials=get_credentials, http=http, model=model, log_request=log_request, log_response=log_response, credentials_args=credentials_args, default_global_params=default_global_params, additional_http_headers=additional_http_headers, response_encoding=response_encoding)
    ...
    class ProjectsService(base_api.BaseApiService):
      ...
      """
            ...
            return self._RunMethod(config, request, global_params=global_params)
        GetSettings.method_config = lambda: base_api.ApiMethodInfo(http_method='GET', method_id='toolresults.projects.getSettings', ordered_params=['projectId'], path_params=['projectId'], query_params=[], relative_path='toolresults/v1beta3/projects/{projectId}/settings', request_field='', request_type_name='ToolresultsProjectsGetSettingsRequest', response_type_name='ProjectSettings', supports_download=False)
      ...
      """
            ...
            return self._RunMethod(config, request, global_params=global_params)
        InitializeSettings.method_config = lambda: base_api.ApiMethodInfo(http_method='POST', method_id='toolresults.projects.initializeSettings', ordered_params=['projectId'], path_params=['projectId'], query_params=[], relative_path='toolresults/v1beta3/projects/{projectId}:initializeSettings', request_field='', request_type_name='ToolresultsProjectsInitializeSettingsRequest', response_type_name='ProjectSettings', supports_download=False)