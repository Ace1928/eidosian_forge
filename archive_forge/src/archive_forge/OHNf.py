...
class Node:
    def __init__(self, x: int, y: int, f: int = 1000000, g: int = 0, h: int = 0):
        """
        ...
        f (int): The total cost from start to goal through this node, initialized to a high value to represent infinity.
    ...
    def __eq__(self, other: "Node") -> bool:
        """
        Equality comparison based on f value for priority queue operations in pathfinding algorithms.

        Parameters:
        other (Node): The other node to compare with.

        Returns:
        bool: True if this node's f value is equal to the other node's f value, False otherwise.
        """
        return self.f == other.f
    ...
    def __repr__(self) -> str:
        ...
        """
        return f"Node(x={self.x}, y={self.y}, f={self.f}, g={self.g}, h={self.h})"
