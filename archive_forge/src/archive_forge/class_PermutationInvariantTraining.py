...
class PermutationInvariantTraining(Metric):
    ...
    def __init__(self, metric_func: Callable, mode: Literal['speaker-wise', 'permutation-wise']='speaker-wise', eval_func: Literal['max', 'min']='max', **kwargs: Any) -> None:
        base_kwargs: Dict[str, Any] = {'dist_sync_on_step': kwargs.pop('dist_sync_on_step', False), 'process_group': kwargs.pop('process_group', None), 'dist_sync_fn': kwargs.pop('dist_sync_fn', None)}
    ...
    def update(self, preds: Tensor, target: Tensor) -> None:
        ...
        pit_metric = permutation_invariant_training(preds, target, self.metric_func, self.mode, self.eval_func, **self.kwargs)[0]
