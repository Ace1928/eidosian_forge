...
@mock.patch.dict(os.environ, {environment_vars.AWS_REGION: AWS_REGION, environment_vars.AWS_SECRET_ACCESS_KEY: SECRET_ACCESS_KEY})
def test_retrieve_subject_token_success_temp_creds_environment_vars_missing_access_key_id_idmsv2(self, utcnow):
