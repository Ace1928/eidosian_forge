...
class TranslationEditRate(Metric):
    ...
    def update(self, preds: Union[str, Sequence[str]], target: Sequence[Union[str, Sequence[str]]]) -> None:
        ...
        self.total_num_edits, self.total_tgt_len, self.sentence_ter = _ter_update(preds, target, self.tokenizer, self.total_num_edits, self.total_tgt_len, self.sentence_ter)
