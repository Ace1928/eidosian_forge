...
def test_init_attachment(self):
    self._verify('openstack.block_storage.v3.volume.Volume.init_attachment', self.proxy.init_volume_attachment, method_args=['value', '1'], expected_args=[self.proxy, '1'])