...
def NamespaceResourceName(project, name, release_track=base.ReleaseTrack.ALPHA):
    return resources.REGISTRY.Parse(line=None, params={'projectsId': project, 'locationsId': 'global', 'namespacesId': name}, collection='gkehub.projects.locations.namespaces', api_version=VERSION_MAP[release_track]).RelativeName()