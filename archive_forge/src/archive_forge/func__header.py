...
@staticmethod
def _header(check_version: Optional['CheckVersionResponse']=None, *, settings: 'Settings', printer: Union['PrinterTerm', 'PrinterJupyter']) -> None:
    Run._header_version_check_info(check_version, settings=settings, printer=printer)
