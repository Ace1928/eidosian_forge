...
class LLMRailsEmbeddings(BaseModel, Embeddings):
    ...
    def embed_documents(self, texts: List[str]) -> List[List[float]]:
        ...
        """
        response = requests.post('https://api.llmrails.com/v1/embeddings', headers={'X-API-KEY': self.api_key.get_secret_value()}, json={'input': texts, 'model': self.model}, timeout=60)
