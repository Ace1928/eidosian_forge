...
class MonitoringV1(base_api.BaseApiClient):
    ...
    def __init__(self, url='', credentials=None, get_credentials=True, http=None, model=None, log_request=False, log_response=False, credentials_args=None, default_global_params=None, additional_http_headers=None, response_encoding=None):
        ...
        super(MonitoringV1, self).__init__(url, credentials=credentials, get_credentials=get_credentials, http=http, model=model, log_request=log_request, log_response=log_response, credentials_args=credentials_args, default_global_params=default_global_params, additional_http_headers=additional_http_headers, response_encoding=response_encoding)
    ...
    class LocationsGlobalMetricsScopesService(base_api.BaseApiService):
      ...
      """
            ...
            return self._RunMethod(config, request, global_params=global_params)
        Get.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1/locations/global/metricsScopes/{metricsScopesId}', http_method='GET', method_id='monitoring.locations.global.metricsScopes.get', ordered_params=['name'], path_params=['name'], query_params=[], relative_path='v1/{+name}', request_field='', request_type_name='MonitoringLocationsGlobalMetricsScopesGetRequest', response_type_name='MetricsScope', supports_download=False)
      ...
      """
            ...
            return self._RunMethod(config, request, global_params=global_params)
        ListMetricsScopesByMonitoredProject.method_config = lambda: base_api.ApiMethodInfo(http_method='GET', method_id='monitoring.locations.global.metricsScopes.listMetricsScopesByMonitoredProject', ordered_params=[], path_params=[], query_params=['monitoredResourceContainer'], relative_path='v1/locations/global/metricsScopes:listMetricsScopesByMonitoredProject', request_field='', request_type_name='MonitoringLocationsGlobalMetricsScopesListMetricsScopesByMonitoredProjectRequest', response_type_name='ListMetricsScopesByMonitoredProjectResponse', supports_download=False)
    ...
    class OperationsService(base_api.BaseApiService):
      ...
      """
            config = self.GetMethodConfig('Get')
            return self._RunMethod(config, request, global_params=global_params)
        Get.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1/operations/{operationsId}', http_method='GET', method_id='monitoring.operations.get', ordered_params=['name'], path_params=['name'], query_params=[], relative_path='v1/{+name}', request_field='', request_type_name='MonitoringOperationsGetRequest', response_type_name='Operation', supports_download=False)
