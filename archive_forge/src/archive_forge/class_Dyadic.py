...
class Dyadic(Printable, EvalfMixin):
    ...
    def _latex(self, printer):
        ...
        for i, v in enumerate(ar):
            if ar[i][0] == 1:
                ol.append(' + ' + printer._print(ar[i][1]) + '\\otimes ' + printer._print(ar[i][2]))
            elif ar[i][0] == -1:
                ol.append(' - ' + printer._print(ar[i][1]) + '\\otimes ' + printer._print(ar[i][2]))
            elif ar[i][0] != 0:
                ...
                if arg_str.startswith('-'):
                    ...
                    str_start = ' + '
                ol.append(str_start + arg_str + printer._print(ar[i][1]) + '\\otimes ' + printer._print(ar[i][2]))
        outstr = ''.join(ol)
    ...
    def _pretty(self, printer):
        ...
        class Fake:
            ...
            def render(self, *args, **kwargs):
                ...
                if len(ar) == 0:
                    return str(0)
                bar = '⊗' if printer._use_unicode else '|'
                ol = []
                for i, v in enumerate(ar):
                    if ar[i][0] == 1:
