...
class TestTrustDelete(TestTrust):
    ...
    def setUp(self):
        ...
        self.trusts_mock.get.return_value = fakes.FakeResource(None, copy.deepcopy(identity_fakes.TRUST), loaded=True)
    ...
    def test_trust_delete(self):
        ...
        self.trusts_mock.delete.assert_called_with(identity_fakes.trust_id)
