...
class ConfigServiceV2Client(metaclass=ConfigServiceV2ClientMeta):
    ...
    def parse_cmek_settings_path(path: str) -> Dict[str, str]:
        ...
        m = re.match('^projects/(?P<project>.+?)/cmekSettings$', path)
    ...
    def parse_link_path(path: str) -> Dict[str, str]:
        ...
        m = re.match('^projects/(?P<project>.+?)/locations/(?P<location>.+?)/buckets/(?P<bucket>.+?)/links/(?P<link>.+?)$', path)
        return m.groupdict() if m else {}
    ...
    def parse_log_bucket_path(path: str) -> Dict[str, str]:
        ...
        m = re.match('^projects/(?P<project>.+?)/locations/(?P<location>.+?)/buckets/(?P<bucket>.+?)$', path)
        return m.groupdict() if m else {}
    ...
    def parse_log_exclusion_path(path: str) -> Dict[str, str]:
        ...
        m = re.match('^projects/(?P<project>.+?)/exclusions/(?P<exclusion>.+?)$', path)
        return m.groupdict() if m else {}
    ...
    def parse_log_sink_path(path: str) -> Dict[str, str]:
        ...
        m = re.match('^projects/(?P<project>.+?)/sinks/(?P<sink>.+?)$', path)
        return m.groupdict() if m else {}
    ...
    def parse_log_view_path(path: str) -> Dict[str, str]:
        ...
        m = re.match('^projects/(?P<project>.+?)/locations/(?P<location>.+?)/buckets/(?P<bucket>.+?)/views/(?P<view>.+?)$', path)
        return m.groupdict() if m else {}
    ...
    def parse_recent_query_path(path: str) -> Dict[str, str]:
        ...
        m = re.match('^projects/(?P<project>.+?)/locations/(?P<location>.+?)/recentQueries/(?P<recent_query>.+?)$', path)
        return m.groupdict() if m else {}
    ...
    def parse_saved_query_path(path: str) -> Dict[str, str]:
        ...
        m = re.match('^projects/(?P<project>.+?)/locations/(?P<location>.+?)/savedQueries/(?P<saved_query>.+?)$', path)
        return m.groupdict() if m else {}
    ...
    def parse_settings_path(path: str) -> Dict[str, str]:
        ...
        m = re.match('^projects/(?P<project>.+?)/settings$', path)
        return m.groupdict() if m else {}
    ...
    def __init__(self, *, credentials: Optional[ga_credentials.Credentials]=None, transport: Optional[Union[str, ConfigServiceV2Transport]]=None, client_options: Optional[Union[client_options_lib.ClientOptions, dict]]=None, client_info: gapic_v1.client_info.ClientInfo=DEFAULT_CLIENT_INFO) -> None:
    ...
    def list_buckets(self, request: Optional[Union[logging_config.ListBucketsRequest, dict]]=None, *, parent: Optional[str]=None, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> pagers.ListBucketsPager:
        """Lists log buckets.
        ...
        response = pagers.ListBucketsPager(method=rpc, request=request, response=response, metadata=metadata)
        return response

    def get_bucket(self, request: Optional[Union[logging_config.GetBucketRequest, dict]]=None, *, name: Optional[str]=None, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> logging_config.LogBucket:
        """Gets a log bucket.
    ...
    def create_bucket_async(self, request: Optional[Union[logging_config.CreateBucketRequest, dict]]=None, *, parent: Optional[str]=None, bucket: Optional[logging_config.LogBucket]=None, bucket_id: Optional[str]=None, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> operation.Operation:
        ...
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((('parent', request.parent),)),)
        response = rpc(request, retry=retry, timeout=timeout, metadata=metadata)
        response = operation.from_gapic(response, self._transport.operations_client, logging_config.LogBucket, metadata_type=logging_config.BucketMetadata)
        return response

    def update_bucket_async(self, request: Optional[Union[logging_config.UpdateBucketRequest, dict]]=None, *, name: Optional[str]=None, bucket: Optional[logging_config.LogBucket]=None, update_mask: Optional[field_mask_pb2.FieldMask]=None, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> operation.Operation:
    ...
    def create_bucket(self, request: Optional[Union[logging_config.CreateBucketRequest, dict]]=None, *, parent: Optional[str]=None, bucket: Optional[logging_config.LogBucket]=None, bucket_id: Optional[str]=None, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> logging_config.LogBucket:
    ...
    def update_bucket(self, request: Optional[Union[logging_config.UpdateBucketRequest, dict]]=None, *, name: Optional[str]=None, bucket: Optional[logging_config.LogBucket]=None, update_mask: Optional[field_mask_pb2.FieldMask]=None, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> logging_config.LogBucket:
    ...
    def delete_bucket(self, request: Optional[Union[logging_config.DeleteBucketRequest, dict]]=None, *, name: Optional[str]=None, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> None:
    ...
    def undelete_bucket(self, request: Optional[Union[logging_config.UndeleteBucketRequest, dict]]=None, *, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> None:
    ...
    def list_views(self, request: Optional[Union[logging_config.ListViewsRequest, dict]]=None, *, parent: Optional[str]=None, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> pagers.ListViewsPager:
        ...
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((('parent', request.parent),)),)
        response = rpc(request, retry=retry, timeout=timeout, metadata=metadata)
        response = pagers.ListViewsPager(method=rpc, request=request, response=response, metadata=metadata)
        return response

    def get_view(self, request: Optional[Union[logging_config.GetViewRequest, dict]]=None, *, name: Optional[str]=None, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> logging_config.LogView:
    ...
    def create_view(self, request: Optional[Union[logging_config.CreateViewRequest, dict]]=None, *, parent: Optional[str]=None, view: Optional[logging_config.LogView]=None, view_id: Optional[str]=None, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> logging_config.LogView:
    ...
    def update_view(self, request: Optional[Union[logging_config.UpdateViewRequest, dict]]=None, *, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> logging_config.LogView:
    ...
    def delete_view(self, request: Optional[Union[logging_config.DeleteViewRequest, dict]]=None, *, name: Optional[str]=None, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> None:
    ...
    def list_exclusions(self, request: Optional[Union[logging_config.ListExclusionsRequest, dict]]=None, *, parent: Optional[str]=None, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> pagers.ListExclusionsPager:
        ...
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((('parent', request.parent),)),)
        response = rpc(request, retry=retry, timeout=timeout, metadata=metadata)
        response = pagers.ListExclusionsPager(method=rpc, request=request, response=response, metadata=metadata)
        return response

    def get_exclusion(self, request: Optional[Union[logging_config.GetExclusionRequest, dict]]=None, *, name: Optional[str]=None, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> logging_config.LogExclusion:
    ...
    def create_exclusion(self, request: Optional[Union[logging_config.CreateExclusionRequest, dict]]=None, *, parent: Optional[str]=None, exclusion: Optional[logging_config.LogExclusion]=None, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> logging_config.LogExclusion:
    ...
    def update_exclusion(self, request: Optional[Union[logging_config.UpdateExclusionRequest, dict]]=None, *, name: Optional[str]=None, exclusion: Optional[logging_config.LogExclusion]=None, update_mask: Optional[field_mask_pb2.FieldMask]=None, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> logging_config.LogExclusion:
    ...
    def delete_exclusion(self, request: Optional[Union[logging_config.DeleteExclusionRequest, dict]]=None, *, name: Optional[str]=None, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> None:
    ...
    def list_sinks(self, request: Optional[Union[logging_config.ListSinksRequest, dict]]=None, *, parent: Optional[str]=None, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> pagers.ListSinksPager:
        """Lists sinks.
        ...
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((('parent', request.parent),)),)
        response = rpc(request, retry=retry, timeout=timeout, metadata=metadata)
        response = pagers.ListSinksPager(method=rpc, request=request, response=response, metadata=metadata)
        return response

    def get_sink(self, request: Optional[Union[logging_config.GetSinkRequest, dict]]=None, *, sink_name: Optional[str]=None, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> logging_config.LogSink:
        """Gets a sink.
        ...
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((('sink_name', request.sink_name),)),)
        response = rpc(request, retry=retry, timeout=timeout, metadata=metadata)
        return response

    def create_sink(self, request: Optional[Union[logging_config.CreateSinkRequest, dict]]=None, *, parent: Optional[str]=None, sink: Optional[logging_config.LogSink]=None, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> logging_config.LogSink:
    ...
    def update_sink(self, request: Optional[Union[logging_config.UpdateSinkRequest, dict]]=None, *, sink_name: Optional[str]=None, sink: Optional[logging_config.LogSink]=None, update_mask: Optional[field_mask_pb2.FieldMask]=None, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> logging_config.LogSink:
    ...
    def delete_sink(self, request: Optional[Union[logging_config.DeleteSinkRequest, dict]]=None, *, sink_name: Optional[str]=None, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> None:
    ...
    def list_links(self, request: Optional[Union[logging_config.ListLinksRequest, dict]]=None, *, parent: Optional[str]=None, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> pagers.ListLinksPager:
        """Lists links.
        ...
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((('parent', request.parent),)),)
        response = rpc(request, retry=retry, timeout=timeout, metadata=metadata)
        response = pagers.ListLinksPager(method=rpc, request=request, response=response, metadata=metadata)
        return response

    def get_link(self, request: Optional[Union[logging_config.GetLinkRequest, dict]]=None, *, name: Optional[str]=None, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> logging_config.Link:
        """Gets a link.
    ...
    def create_link(self, request: Optional[Union[logging_config.CreateLinkRequest, dict]]=None, *, parent: Optional[str]=None, link: Optional[logging_config.Link]=None, link_id: Optional[str]=None, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> operation.Operation:
        ...
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((('parent', request.parent),)),)
        response = rpc(request, retry=retry, timeout=timeout, metadata=metadata)
        response = operation.from_gapic(response, self._transport.operations_client, logging_config.Link, metadata_type=logging_config.LinkMetadata)
        return response

    def delete_link(self, request: Optional[Union[logging_config.DeleteLinkRequest, dict]]=None, *, name: Optional[str]=None, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> operation.Operation:
        ...
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((('name', request.name),)),)
        response = rpc(request, retry=retry, timeout=timeout, metadata=metadata)
        response = operation.from_gapic(response, self._transport.operations_client, empty_pb2.Empty, metadata_type=logging_config.LinkMetadata)
        return response

    def get_cmek_settings(self, request: Optional[Union[logging_config.GetCmekSettingsRequest, dict]]=None, *, name: Optional[str]=None, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> logging_config.CmekSettings:
    ...
    def update_cmek_settings(self, request: Optional[Union[logging_config.UpdateCmekSettingsRequest, dict]]=None, *, name: Optional[str]=None, cmek_settings: Optional[logging_config.CmekSettings]=None, update_mask: Optional[field_mask_pb2.FieldMask]=None, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> logging_config.CmekSettings:
    ...
    def get_settings(self, request: Optional[Union[logging_config.GetSettingsRequest, dict]]=None, *, name: Optional[str]=None, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> logging_config.Settings:
    ...
    def update_settings(self, request: Optional[Union[logging_config.UpdateSettingsRequest, dict]]=None, *, settings: Optional[logging_config.Settings]=None, update_mask: Optional[field_mask_pb2.FieldMask]=None, name: Optional[str]=None, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> logging_config.Settings:
    ...
    def list_saved_queries(self, request: Optional[Union[logging_config.ListSavedQueriesRequest, dict]]=None, *, parent: Optional[str]=None, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> pagers.ListSavedQueriesPager:
        ...
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((('parent', request.parent),)),)
        response = rpc(request, retry=retry, timeout=timeout, metadata=metadata)
        response = pagers.ListSavedQueriesPager(method=rpc, request=request, response=response, metadata=metadata)
        return response

    def create_saved_query(self, request: Optional[Union[logging_config.CreateSavedQueryRequest, dict]]=None, *, parent: Optional[str]=None, saved_query: Optional[logging_config.SavedQuery]=None, saved_query_id: Optional[str]=None, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> logging_config.SavedQuery:
    ...
    def delete_saved_query(self, request: Optional[Union[logging_config.DeleteSavedQueryRequest, dict]]=None, *, name: Optional[str]=None, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> None:
    ...
    def list_recent_queries(self, request: Optional[Union[logging_config.ListRecentQueriesRequest, dict]]=None, *, parent: Optional[str]=None, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> pagers.ListRecentQueriesPager:
        ...
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((('parent', request.parent),)),)
        response = rpc(request, retry=retry, timeout=timeout, metadata=metadata)
        response = pagers.ListRecentQueriesPager(method=rpc, request=request, response=response, metadata=metadata)
        return response

    def copy_log_entries(self, request: Optional[Union[logging_config.CopyLogEntriesRequest, dict]]=None, *, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> operation.Operation:
        ...
        response = rpc(request, retry=retry, timeout=timeout, metadata=metadata)
        response = operation.from_gapic(response, self._transport.operations_client, logging_config.CopyLogEntriesResponse, metadata_type=logging_config.CopyLogEntriesMetadata)
        return response
