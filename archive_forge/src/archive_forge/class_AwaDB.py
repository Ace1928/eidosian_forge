...
class AwaDB(VectorStore):
    ...
    def __init__(self, table_name: str=_DEFAULT_TABLE_NAME, embedding: Optional[Embeddings]=None, log_and_data_dir: Optional[str]=None, client: Optional[awadb.Client]=None, **kwargs: Any) -> None:
        ...
        elif log_and_data_dir is not None:
    ...
    def add_texts(self, texts: Iterable[str], metadatas: Optional[List[dict]]=None, is_duplicate_texts: Optional[bool]=None, **kwargs: Any) -> List[str]:
        ...
        return self.awadb_client.AddTexts('embedding_text', 'text_embedding', texts, embeddings, metadatas, is_duplicate_texts)
    ...
    def similarity_search(self, query: str, k: int=DEFAULT_TOPN, text_in_page_content: Optional[str]=None, meta_filter: Optional[dict]=None, **kwargs: Any) -> List[Document]:
        ...
        return self.similarity_search_by_vector(embedding, k, text_in_page_content=text_in_page_content, meta_filter=meta_filter, not_include_fields_in_metadata=not_include_fields)

    def similarity_search_with_score(self, query: str, k: int=DEFAULT_TOPN, text_in_page_content: Optional[str]=None, meta_filter: Optional[dict]=None, **kwargs: Any) -> List[Tuple[Document, float]]:
        ...
        retrieval_docs = self.similarity_search_by_vector(embedding, k, text_in_page_content=text_in_page_content, meta_filter=meta_filter, not_include_fields_in_metadata=not_include_fields)
    ...
    def similarity_search_by_vector(self, embedding: Optional[List[float]]=None, k: int=DEFAULT_TOPN, text_in_page_content: Optional[str]=None, meta_filter: Optional[dict]=None, not_include_fields_in_metadata: Optional[Set[str]]=None, **kwargs: Any) -> List[Document]:
        ...
        if embedding is None:
            return results
        show_results = self.awadb_client.Search(embedding, k, text_in_page_content=text_in_page_content, meta_filter=meta_filter, not_include_fields=not_include_fields_in_metadata)
    ...
    def max_marginal_relevance_search(self, query: str, k: int=4, fetch_k: int=20, lambda_mult: float=0.5, text_in_page_content: Optional[str]=None, meta_filter: Optional[dict]=None, **kwargs: Any) -> List[Document]:
        ...
        if embedding.__len__() == 0:
            return []
        results = self.max_marginal_relevance_search_by_vector(embedding, k, fetch_k, lambda_mult=lambda_mult, text_in_page_content=text_in_page_content, meta_filter=meta_filter)
        return results

    def max_marginal_relevance_search_by_vector(self, embedding: List[float], k: int=4, fetch_k: int=20, lambda_mult: float=0.5, text_in_page_content: Optional[str]=None, meta_filter: Optional[dict]=None, **kwargs: Any) -> List[Document]:
        """Return docs selected using the maximal marginal relevance.
        ...
        retrieved_docs = self.similarity_search_by_vector(embedding, fetch_k, text_in_page_content=text_in_page_content, meta_filter=meta_filter, not_include_fields_in_metadata=not_include_fields)
        top_embeddings = []
    ...
    def get(self, ids: Optional[List[str]]=None, text_in_page_content: Optional[str]=None, meta_filter: Optional[dict]=None, not_include_fields: Optional[Set[str]]=None, limit: Optional[int]=None, **kwargs: Any) -> Dict[str, Document]:
        ...
        if self.awadb_client is None:
            raise ValueError('AwaDB client is None!!!')
        docs_detail = self.awadb_client.Get(ids=ids, text_in_page_content=text_in_page_content, meta_filter=meta_filter, not_include_fields=not_include_fields, limit=limit)
    ...
    def update(self, ids: List[str], texts: Iterable[str], metadatas: Optional[List[dict]]=None, **kwargs: Any) -> List[str]:
    ...
    @classmethod
    def from_texts(cls: Type[AwaDB], texts: List[str], embedding: Optional[Embeddings]=None, metadatas: Optional[List[dict]]=None, table_name: str=_DEFAULT_TABLE_NAME, log_and_data_dir: Optional[str]=None, client: Optional[awadb.Client]=None, **kwargs: Any) -> AwaDB:
        ...
        """
        awadb_client = cls(table_name=table_name, embedding=embedding, log_and_data_dir=log_and_data_dir, client=client)
        awadb_client.add_texts(texts=texts, metadatas=metadatas)
        return awadb_client

    @classmethod
    def from_documents(cls: Type[AwaDB], documents: List[Document], embedding: Optional[Embeddings]=None, table_name: str=_DEFAULT_TABLE_NAME, log_and_data_dir: Optional[str]=None, client: Optional[awadb.Client]=None, **kwargs: Any) -> AwaDB:
        ...
        return cls.from_texts(texts=texts, embedding=embedding, metadatas=metadatas, table_name=table_name, log_and_data_dir=log_and_data_dir, client=client)