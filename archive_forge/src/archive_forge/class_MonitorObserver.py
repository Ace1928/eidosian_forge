...
class MonitorObserver(Thread):
    ...
    def __init__(self, monitor, event_handler=None, callback=None, *args, **kwargs):
        ...
        if event_handler is not None:
            import warnings
            warnings.warn('"event_handler" argument will be removed in 1.0. Use Monitor.poll() instead.', DeprecationWarning)
    ...
    def run(self):
        self.monitor.start()
        notifier = poll.Poll.for_events((self.monitor, 'r'), (self._stop_event.source, 'r'))
        while True:
