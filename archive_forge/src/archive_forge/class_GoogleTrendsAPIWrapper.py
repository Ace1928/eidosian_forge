...
class GoogleTrendsAPIWrapper(BaseModel):
    ...
    def run(self, query: str) -> str:
        ...
        params = {'engine': 'google_trends', 'api_key': serpapi_api_key.get_secret_value(), 'q': query}
        total_results = []
        ...
        params = {'engine': 'google_trends', 'api_key': serpapi_api_key.get_secret_value(), 'data_type': 'RELATED_QUERIES', 'q': query}
        total_results2 = {}
        client = self.serp_search_engine(params)
