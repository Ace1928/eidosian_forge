...
class SpeechClient(metaclass=SpeechClientMeta):
    ...
    def _validate_universe_domain(self):
        ...
        """
        self._is_universe_domain_valid = self._is_universe_domain_valid or SpeechClient._compare_universes(self.universe_domain, self.transport._credentials)
    ...
    def __init__(self, *, credentials: Optional[ga_credentials.Credentials]=None, transport: Optional[Union[str, SpeechTransport]]=None, client_options: Optional[Union[client_options_lib.ClientOptions, dict]]=None, client_info: gapic_v1.client_info.ClientInfo=DEFAULT_CLIENT_INFO) -> None:
        ...
        self._api_endpoint = self._api_endpoint or SpeechClient._get_api_endpoint(self._client_options.api_endpoint, self._client_cert_source, self._universe_domain, self._use_mtls_endpoint)
    ...
    def recognize(self, request: Optional[Union[cloud_speech.RecognizeRequest, dict]]=None, *, config: Optional[cloud_speech.RecognitionConfig]=None, audio: Optional[cloud_speech.RecognitionAudio]=None, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> cloud_speech.RecognizeResponse:
    ...
    def long_running_recognize(self, request: Optional[Union[cloud_speech.LongRunningRecognizeRequest, dict]]=None, *, config: Optional[cloud_speech.RecognitionConfig]=None, audio: Optional[cloud_speech.RecognitionAudio]=None, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> operation.Operation:
        ...
        self._validate_universe_domain()
        response = rpc(request, retry=retry, timeout=timeout, metadata=metadata)
        response = operation.from_gapic(response, self._transport.operations_client, cloud_speech.LongRunningRecognizeResponse, metadata_type=cloud_speech.LongRunningRecognizeMetadata)
        return response

    def streaming_recognize(self, requests: Optional[Iterator[cloud_speech.StreamingRecognizeRequest]]=None, *, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> Iterable[cloud_speech.StreamingRecognizeResponse]:
