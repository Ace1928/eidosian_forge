    ...
    def modify_ndmp(self, modify):
        ...
        if self.use_rest:
            ...
            try:
                ...
                self.module.fail_json(msg='Error modifying ndmp on %s: %s' % (self.parameters['vserver'], to_native(exc)), exception=traceback.format_exc())
