...
class TestSmartServerRequestHasSignatureForRevisionId(tests.TestCaseWithMemoryTransport):
    ...
    def test_missing_revision(self):
        ...
        self.assertEqual(smart_req.FailedSmartServerResponse((b'nosuchrevision', b'revid'), None), request.execute(b'', b'revid'))
    ...
    def test_missing_signature(self):
        ...
        self.assertEqual(smart_req.SmartServerResponse((b'no',)), request.execute(b'', b'A'))
