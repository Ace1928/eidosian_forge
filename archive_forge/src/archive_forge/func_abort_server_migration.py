...
def abort_server_migration(self, server_migration, server, ignore_missing=True):
    ...
    self._delete(_server_migration.ServerMigration, server_migration, server_id=server_id, ignore_missing=ignore_missing)