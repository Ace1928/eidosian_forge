...
class WeaviateTranslator(Visitor):
    ...
    allowed_comparators = [Comparator.EQ, Comparator.NE, Comparator.GTE, Comparator.LTE, Comparator.LT, Comparator.GT]

    def _format_func(self, func: Union[Operator, Comparator]) -> str:
        self._validate_func(func)
        map_dict = {Operator.AND: 'And', Operator.OR: 'Or', Comparator.EQ: 'Equal', Comparator.NE: 'NotEqual', Comparator.GTE: 'GreaterThanEqual', Comparator.LTE: 'LessThanEqual', Comparator.LT: 'LessThan', Comparator.GT: 'GreaterThan'}
    ...
    def visit_comparison(self, comparison: Comparison) -> Dict:
        ...
        filter = {'path': [comparison.attribute], 'operator': self._format_func(comparison.comparator), value_type: value}
        return filter
