...
def _update_model_version():
    request_message = _get_request_message(UpdateModelVersion(), schema={'name': [_assert_string, _assert_required], 'version': [_assert_string, _assert_required], 'description': [_assert_string]})
    new_description = None
    if request_message.HasField('description'):
        new_description = request_message.description
    model_version = _get_model_registry_store().update_model_version(name=request_message.name, version=request_message.version, description=new_description)
