...
class CreateCSR(base.CreateCommand):
    ...
    """
        ...
        repo_spec = presentation_specs.ResourcePresentationSpec('--repo', repo_resource.GetRepoResourceSpec(), 'Cloud Source Repository.', required=True, prefixes=False)
    ...
    """
        ...
        trigger = messages.BuildTrigger(name=args.name, description=args.description, serviceAccount=args.service_account, triggerTemplate=messages.RepoSource(repoName=repo, branchName=args.branch_pattern, tagName=args.tag_pattern))
