...
def _CreateAndWait(gcf_client: client_v2.FunctionsClient, function_ref: resources.Resource, function: api_types.Function) -> None:
    """Create a function.
  ...
  """
    ...
    create_request = messages.CloudfunctionsProjectsLocationsFunctionsCreateRequest(parent=function_ref.Parent().RelativeName(), functionId=function_ref.Name(), function=function)
