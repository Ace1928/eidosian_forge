...
def require_api_key_or_user_role(api_keys: Union[str, List[str]], role: Optional[Union[str, UserRole]]=None, dry_run: Optional[bool]=False, verbose: Optional[bool]=False):
    """
