...
class TestPull(tests.TestCaseWithTransport):
    ...
    def test_pull_revision(self):
        ...
        a_tree.add('goodbye2')
        a_tree.commit(message='setup')
        b_tree = a_tree.controldir.sprout('b', revision_id=a_tree.branch.get_rev_id(1)).open_workingtree()
    ...
    def test_pull_bundle(self):
        ...
        self.assertEqualDiff(tree_a.branch.last_revision(), tree_b.branch.last_revision())
        testament_a = Testament.from_revision(tree_a.branch.repository, tree_a.get_parent_ids()[0])
    ...
    def test_pull_verbose_defaults_to_long(self):
        ...
        self.assertContainsRe(out, 'revno: 1\\ncommitter: .*\\nbranch nick: source')
    ...
    def test_pull_verbose_uses_default_log(self):
        ...
        self.assertNotContainsRe(out, 'revno: 1\\ncommitter: .*\\nbranch nick: source')
