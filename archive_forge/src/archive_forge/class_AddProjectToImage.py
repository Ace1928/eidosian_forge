...
class AddProjectToImage(command.ShowOne):
    ...
    def get_parser(self, prog_name):
        ...
        parser.add_argument('image', metavar='<image>', help=_('Image to share (name or ID)'))
        parser.add_argument('project', metavar='<project>', help=_('Project to associate with image (ID)'))
    ...
    def take_action(self, parsed_args):
        ...
        obj = image_client.add_member(image=image.id, member_id=project_id)
