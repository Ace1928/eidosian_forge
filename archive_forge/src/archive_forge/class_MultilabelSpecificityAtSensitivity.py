...
class MultilabelSpecificityAtSensitivity(MultilabelPrecisionRecallCurve):
    ...
    def __init__(self, num_labels: int, min_sensitivity: float, thresholds: Optional[Union[int, List[float], Tensor]]=None, ignore_index: Optional[int]=None, validate_args: bool=True, **kwargs: Any) -> None:
    ...
    def compute(self) -> Tuple[Tensor, Tensor]:
        ...
        return _multilabel_specificity_at_sensitivity_compute(state, self.num_labels, self.thresholds, self.ignore_index, self.min_sensitivity)