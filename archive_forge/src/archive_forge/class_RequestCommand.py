...
class RequestCommand(Command):
    ...
    def command(self):
        ...
        for item in self.args[2:]:
            ...
            qs.append(item)
        qs = '&'.join(qs)
        environ = {'REQUEST_METHOD': request_method, 'CONTENT_TYPE': 'text/plain', 'wsgi.run_once': True, 'wsgi.multithread': False, 'wsgi.multiprocess': False, 'wsgi.errors': sys.stderr, 'QUERY_STRING': qs, 'HTTP_ACCEPT': 'text/plain;q=1.0, */*;q=0.1', 'paste.command_request': True}
