...
class ContextCallbackHandler(BaseCallbackHandler):
    ...
    def __init__(self, token: str='', verbose: bool=False, **kwargs: Any) -> None:
        self.context, self.credential, self.conversation_model, self.message_model, self.message_role_model, self.rating_model = import_context()
    ...
    def on_llm_end(self, response: LLMResult, **kwargs: Any) -> None:
        ...
        if not self.chain_run_id:
            ...
            self.messages.append(self.message_model(message=generation.text, role=self.message_role_model.ASSISTANT))
    ...
    def on_chain_end(self, outputs: Dict[str, Any], **kwargs: Any) -> None:
        """Run when chain ends."""
        self.messages.append(self.message_model(message=outputs['text'], role=self.message_role_model.ASSISTANT))
        self._log_conversation()
        self.chain_run_id = None
