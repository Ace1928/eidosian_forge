    ...
    * etc.
    ...
    if out_type.fullname == chained_out_fullname:
        for (arg1, arg2), (type1, type2) in zip(arg_pairs, arg_types_pairs):
            ...
            check_chained(l1_arg=arg1, l1_type=type1, l2_arg=arg2, l2_type=type2, api=ctx.api)
        return Instance(ctx.default_return_type.type, [arg_types[0].args[0], arg_types[-1].args[1]])
        ...
        for (arg1, arg2), (type1, type2) in zip(arg_pairs, arg_types_pairs):
            ...
            assert type1.type.fullname == thinc_model_fullname
            assert type2.type.fullname == thinc_model_fullname
            check_intoin_outtoout(l1_arg=arg1, l1_type=type1, l2_arg=arg2, l2_type=type2, api=ctx.api)
        return Instance(ctx.default_return_type.type, [arg_types[0].args[0], arg_types[0].args[1]])
