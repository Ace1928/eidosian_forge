...
class SenlinProfileTest(common.HeatTestCase):
    ...
    def setUp(self):
        ...
        self.patchobject(senlin.ProfileTypeConstraint, 'validate', return_value=True)
    ...
    def test_profile_create(self):
        ...
        expect_kwargs = {'name': 'SenlinProfile', 'metadata': None, 'spec': profile_spec}
        self.senlin_mock.create_profile.assert_called_once_with(**expect_kwargs)
    ...
    def test_profile_delete(self):
        ...
        self.senlin_mock.delete_profile.assert_called_once_with(profile.resource_id)

    def test_profile_update(self):
        profile = self._create_profile(self.t)
        prop_diff = {'metadata': {'foo': 'bar'}}
        self.senlin_mock.get_profile.return_value = self.fake_p
        profile.handle_update(json_snippet=None, tmpl_diff=None, prop_diff=prop_diff)
        self.senlin_mock.update_profile.assert_called_once_with(self.fake_p, **prop_diff)