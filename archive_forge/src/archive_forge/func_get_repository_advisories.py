...
def get_repository_advisories(self) -> PaginatedList[github.RepositoryAdvisory.RepositoryAdvisory]:
    """
        ...
        """
    return PaginatedList(github.RepositoryAdvisory.RepositoryAdvisory, self._requester, f'{self.url}/security-advisories', None)