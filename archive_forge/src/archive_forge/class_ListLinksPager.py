...
class ListLinksPager:
    ...
    def __init__(self, method: Callable[..., logging_config.ListLinksResponse], request: logging_config.ListLinksRequest, response: logging_config.ListLinksResponse, *, metadata: Sequence[Tuple[str, str]]=()):
