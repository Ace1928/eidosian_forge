...
class ExportStatefile(base.Command):
  ...
  """
    ...
    """
        ...
        return deploy_util.ExportDeploymentStateFile(messages, deployment_full_name, args.draft, args.file)