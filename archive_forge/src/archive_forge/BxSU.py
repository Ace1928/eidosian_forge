def heuristic(
    ...
    # Food Seeking: Favor nodes that are closer to the food
...
def a_star_search(
    ...
    # Post-process the path to remove unnecessary zigzags
...
def _optimize_path(self, path: List[Tuple[int, int]]) -> List[Tuple[int, int]]:
    """
    Optimize the path by removing unnecessary zigzags.
