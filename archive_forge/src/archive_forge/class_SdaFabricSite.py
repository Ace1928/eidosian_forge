...
class SdaFabricSite(object):
    ...
    def __init__(self, params, dnac):
        self.dnac = dnac
        self.new_object = dict(fabricName=params.get('fabricName'), siteNameHierarchy=params.get('siteNameHierarchy'), fabricType=params.get('fabricType'), site_name_hierarchy=params.get('siteNameHierarchy'))
    ...
    def get_object_by_name(self, name, is_absent=False):
        result = None
        try:
            items = self.dnac.exec(family='sda', function='get_site', params=self.get_all_params(name=name))
    ...
    def requires_update(self, current_obj):
        ...
        obj_params = [('fabricName', 'fabricName'), ('siteNameHierarchy', 'siteNameHierarchy'), ('fabricType', 'fabricType'), ('siteNameHierarchy', 'site_name_hierarchy')]
    ...
    def create(self):
        result = self.dnac.exec(family='sda', function='add_site', params=self.create_params(), op_modifies=True)
    ...
    def delete(self):
        ...
        name = self.new_object.get('name')
        result = None
        result = self.dnac.exec(family='sda', function='delete_site', params=self.delete_all_params())
        return result