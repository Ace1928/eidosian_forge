...
class OsconfigV1alpha1(base_api.BaseApiClient):
    ...
    def __init__(self, url='', credentials=None, get_credentials=True, http=None, model=None, log_request=False, log_response=False, credentials_args=None, default_global_params=None, additional_http_headers=None, response_encoding=None):
        ...
        super(OsconfigV1alpha1, self).__init__(url, credentials=credentials, get_credentials=get_credentials, http=http, model=model, log_request=log_request, log_response=log_response, credentials_args=credentials_args, default_global_params=default_global_params, additional_http_headers=additional_http_headers, response_encoding=response_encoding)
    ...
    class FoldersAssignmentsService(base_api.BaseApiService):
      ...
      """
        ...
        Create.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1alpha1/folders/{foldersId}/assignments', http_method='POST', method_id='osconfig.folders.assignments.create', ordered_params=['parent'], path_params=['parent'], query_params=[], relative_path='v1alpha1/{+parent}/assignments', request_field='assignment', request_type_name='OsconfigFoldersAssignmentsCreateRequest', response_type_name='Assignment', supports_download=False)
      ...
      """
            ...
            return self._RunMethod(config, request, global_params=global_params)
        Delete.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1alpha1/folders/{foldersId}/assignments/{assignmentsId}', http_method='DELETE', method_id='osconfig.folders.assignments.delete', ordered_params=['name'], path_params=['name'], query_params=[], relative_path='v1alpha1/{+name}', request_field='', request_type_name='OsconfigFoldersAssignmentsDeleteRequest', response_type_name='Empty', supports_download=False)
      ...
      """
            ...
            return self._RunMethod(config, request, global_params=global_params)
        Get.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1alpha1/folders/{foldersId}/assignments/{assignmentsId}', http_method='GET', method_id='osconfig.folders.assignments.get', ordered_params=['name'], path_params=['name'], query_params=[], relative_path='v1alpha1/{+name}', request_field='', request_type_name='OsconfigFoldersAssignmentsGetRequest', response_type_name='Assignment', supports_download=False)
      ...
      """
            ...
            return self._RunMethod(config, request, global_params=global_params)
        List.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1alpha1/folders/{foldersId}/assignments', http_method='GET', method_id='osconfig.folders.assignments.list', ordered_params=['parent'], path_params=['parent'], query_params=['pageSize', 'pageToken'], relative_path='v1alpha1/{+parent}/assignments', request_field='', request_type_name='OsconfigFoldersAssignmentsListRequest', response_type_name='ListAssignmentsResponse', supports_download=False)
      ...
      """
            ...
            return self._RunMethod(config, request, global_params=global_params)
        Patch.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1alpha1/folders/{foldersId}/assignments/{assignmentsId}', http_method='PATCH', method_id='osconfig.folders.assignments.patch', ordered_params=['name'], path_params=['name'], query_params=['updateMask'], relative_path='v1alpha1/{+name}', request_field='assignment', request_type_name='OsconfigFoldersAssignmentsPatchRequest', response_type_name='Assignment', supports_download=False)
...
policy if the resource exists but does not have a policy set.
      ...
      """
            ...
            return self._RunMethod(config, request, global_params=global_params)
        GetIamPolicy.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1alpha1/folders/{foldersId}:getIamPolicy', http_method='POST', method_id='osconfig.folders.getIamPolicy', ordered_params=['resource'], path_params=['resource'], query_params=[], relative_path='v1alpha1/{+resource}:getIamPolicy', request_field='getIamPolicyRequest', request_type_name='OsconfigFoldersGetIamPolicyRequest', response_type_name='Policy', supports_download=False)
...
Replaces any existing policy.
      ...
      """
            ...
            return self._RunMethod(config, request, global_params=global_params)
        SetIamPolicy.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1alpha1/folders/{foldersId}:setIamPolicy', http_method='POST', method_id='osconfig.folders.setIamPolicy', ordered_params=['resource'], path_params=['resource'], query_params=[], relative_path='v1alpha1/{+resource}:setIamPolicy', request_field='setIamPolicyRequest', request_type_name='OsconfigFoldersSetIamPolicyRequest', response_type_name='Policy', supports_download=False)
      ...
      """
            ...
            return self._RunMethod(config, request, global_params=global_params)
        TestIamPermissions.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1alpha1/folders/{foldersId}:testIamPermissions', http_method='POST', method_id='osconfig.folders.testIamPermissions', ordered_params=['resource'], path_params=['resource'], query_params=[], relative_path='v1alpha1/{+resource}:testIamPermissions', request_field='testIamPermissionsRequest', request_type_name='OsconfigFoldersTestIamPermissionsRequest', response_type_name='TestIamPermissionsResponse', supports_download=False)
...
policy if the resource exists but does not have a policy set.
      ...
      """
            config = self.GetMethodConfig('GetIamPolicy')
            return self._RunMethod(config, request, global_params=global_params)
        GetIamPolicy.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1alpha1/organizations/{organizationsId}:getIamPolicy', http_method='POST', method_id='osconfig.organizations.getIamPolicy', ordered_params=['resource'], path_params=['resource'], query_params=[], relative_path='v1alpha1/{+resource}:getIamPolicy', request_field='getIamPolicyRequest', request_type_name='OsconfigOrganizationsGetIamPolicyRequest', response_type_name='Policy', supports_download=False)
...
Replaces any existing policy.
      ...
      """
            config = self.GetMethodConfig('SetIamPolicy')
            return self._RunMethod(config, request, global_params=global_params)
        SetIamPolicy.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1alpha1/organizations/{organizationsId}:setIamPolicy', http_method='POST', method_id='osconfig.organizations.setIamPolicy', ordered_params=['resource'], path_params=['resource'], query_params=[], relative_path='v1alpha1/{+resource}:setIamPolicy', request_field='setIamPolicyRequest', request_type_name='OsconfigOrganizationsSetIamPolicyRequest', response_type_name='Policy', supports_download=False)
      ...
      """
            config = self.GetMethodConfig('TestIamPermissions')
            return self._RunMethod(config, request, global_params=global_params)
        TestIamPermissions.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1alpha1/organizations/{organizationsId}:testIamPermissions', http_method='POST', method_id='osconfig.organizations.testIamPermissions', ordered_params=['resource'], path_params=['resource'], query_params=[], relative_path='v1alpha1/{+resource}:testIamPermissions', request_field='testIamPermissionsRequest', request_type_name='OsconfigOrganizationsTestIamPermissionsRequest', response_type_name='TestIamPermissionsResponse', supports_download=False)
    ...
    class ProjectsPatchJobsInstanceDetailsService(base_api.BaseApiService):
      ...
      """
            config = self.GetMethodConfig('List')
            return self._RunMethod(config, request, global_params=global_params)
        List.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1alpha1/projects/{projectsId}/patchJobs/{patchJobsId}/instanceDetails', http_method='GET', method_id='osconfig.projects.patchJobs.instanceDetails.list', ordered_params=['parent'], path_params=['parent'], query_params=['filter', 'pageSize', 'pageToken'], relative_path='v1alpha1/{+parent}/instanceDetails', request_field='', request_type_name='OsconfigProjectsPatchJobsInstanceDetailsListRequest', response_type_name='ListPatchJobInstanceDetailsResponse', supports_download=False)
...
cannot be restarted.
      ...
      """
            ...
            return self._RunMethod(config, request, global_params=global_params)
        Cancel.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1alpha1/projects/{projectsId}/patchJobs/{patchJobsId}:cancel', http_method='POST', method_id='osconfig.projects.patchJobs.cancel', ordered_params=['name'], path_params=['name'], query_params=[], relative_path='v1alpha1/{+name}:cancel', request_field='cancelPatchJobRequest', request_type_name='OsconfigProjectsPatchJobsCancelRequest', response_type_name='PatchJob', supports_download=False)
      ...
      """
            ...
            return self._RunMethod(config, request, global_params=global_params)
        Execute.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1alpha1/projects/{projectsId}/patchJobs:execute', http_method='POST', method_id='osconfig.projects.patchJobs.execute', ordered_params=['parent'], path_params=['parent'], query_params=[], relative_path='v1alpha1/{+parent}/patchJobs:execute', request_field='executePatchJobRequest', request_type_name='OsconfigProjectsPatchJobsExecuteRequest', response_type_name='PatchJob', supports_download=False)
...
ongoing patch job or review the details of completed jobs.
      ...
      """
            config = self.GetMethodConfig('Get')
            return self._RunMethod(config, request, global_params=global_params)
        Get.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1alpha1/projects/{projectsId}/patchJobs/{patchJobsId}', http_method='GET', method_id='osconfig.projects.patchJobs.get', ordered_params=['name'], path_params=['name'], query_params=[], relative_path='v1alpha1/{+name}', request_field='', request_type_name='OsconfigProjectsPatchJobsGetRequest', response_type_name='PatchJob', supports_download=False)
      ...
      """
            config = self.GetMethodConfig('List')
            return self._RunMethod(config, request, global_params=global_params)
        List.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1alpha1/projects/{projectsId}/patchJobs', http_method='GET', method_id='osconfig.projects.patchJobs.list', ordered_params=['parent'], path_params=['parent'], query_params=['pageSize', 'pageToken'], relative_path='v1alpha1/{+parent}/patchJobs', request_field='', request_type_name='OsconfigProjectsPatchJobsListRequest', response_type_name='ListPatchJobsResponse', supports_download=False)
...
This
      ...
      """
            ...
            return self._RunMethod(config, request, global_params=global_params)
        LookupConfigs.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1alpha1/projects/{projectsId}/zones/{zonesId}/instances/{instancesId}:lookupConfigs', http_method='POST', method_id='osconfig.projects.zones.instances.lookupConfigs', ordered_params=['resource'], path_params=['resource'], query_params=[], relative_path='v1alpha1/{+resource}:lookupConfigs', request_field='lookupConfigsRequest', request_type_name='OsconfigProjectsZonesInstancesLookupConfigsRequest', response_type_name='LookupConfigsResponse', supports_download=False)
...
being correctly applied to this instance.
      ...
      """
            ...
            return self._RunMethod(config, request, global_params=global_params)
        ReportPatchJobInstanceDetails.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1alpha1/projects/{projectsId}/zones/{zonesId}/instances/{instancesId}:reportPatchJobInstanceDetails', http_method='POST', method_id='osconfig.projects.zones.instances.reportPatchJobInstanceDetails', ordered_params=['resource'], path_params=['resource'], query_params=[], relative_path='v1alpha1/{+resource}:reportPatchJobInstanceDetails', request_field='reportPatchJobInstanceDetailsRequest', request_type_name='OsconfigProjectsZonesInstancesReportPatchJobInstanceDetailsRequest', response_type_name='ReportPatchJobInstanceDetailsResponse', supports_download=False)
...
policy if the resource exists but does not have a policy set.
      ...
      """
            config = self.GetMethodConfig('GetIamPolicy')
            return self._RunMethod(config, request, global_params=global_params)
        GetIamPolicy.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1alpha1/projects/{projectsId}:getIamPolicy', http_method='POST', method_id='osconfig.projects.getIamPolicy', ordered_params=['resource'], path_params=['resource'], query_params=[], relative_path='v1alpha1/{+resource}:getIamPolicy', request_field='getIamPolicyRequest', request_type_name='OsconfigProjectsGetIamPolicyRequest', response_type_name='Policy', supports_download=False)
...
Replaces any existing policy.
      ...
      """
            config = self.GetMethodConfig('SetIamPolicy')
            return self._RunMethod(config, request, global_params=global_params)
        SetIamPolicy.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1alpha1/projects/{projectsId}:setIamPolicy', http_method='POST', method_id='osconfig.projects.setIamPolicy', ordered_params=['resource'], path_params=['resource'], query_params=[], relative_path='v1alpha1/{+resource}:setIamPolicy', request_field='setIamPolicyRequest', request_type_name='OsconfigProjectsSetIamPolicyRequest', response_type_name='Policy', supports_download=False)
      ...
      """
            config = self.GetMethodConfig('TestIamPermissions')
            return self._RunMethod(config, request, global_params=global_params)
        TestIamPermissions.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1alpha1/projects/{projectsId}:testIamPermissions', http_method='POST', method_id='osconfig.projects.testIamPermissions', ordered_params=['resource'], path_params=['resource'], query_params=[], relative_path='v1alpha1/{+resource}:testIamPermissions', request_field='testIamPermissionsRequest', request_type_name='OsconfigProjectsTestIamPermissionsRequest', response_type_name='TestIamPermissionsResponse', supports_download=False)