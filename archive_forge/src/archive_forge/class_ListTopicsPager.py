...
class ListTopicsPager:
    ...
    def __init__(self, method: Callable[..., admin.ListTopicsResponse], request: admin.ListTopicsRequest, response: admin.ListTopicsResponse, *, metadata: Sequence[Tuple[str, str]]=()):
