...
def serialize_to_json(elements: Iterable[Any], etree_module: Optional[ModuleType]=None, token: Optional['XPathToken']=None, **params: Any) -> str:
    ...
    kwargs: Dict[str, Any] = {'cls': XPathEncoder, 'ensure_ascii': True, 'separators': (',', ':'), 'allow_nan': False}
    try:
