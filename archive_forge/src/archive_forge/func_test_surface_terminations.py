def test_surface_terminations():
    ...
    a = 4.6
    c = 2.95
    rutile = crystal(['Ti', 'O'], basis=[(0, 0, 0), (0.3, 0.3, 0.0)], spacegroup=136, cellpar=[a, a, c, 90, 90, 90])
    ...
    images = surfaces_with_termination(rutile, indices=(1, 1, 0), layers=4, vacuum=10, termination='O')
    check_surf_composition(images, 'O')
    images = surfaces_with_termination(rutile, indices=(1, 1, 0), layers=4, vacuum=10, termination='TiO')
