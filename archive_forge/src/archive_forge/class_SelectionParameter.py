...
class SelectionParameter(VegaLiteSchema):
    ...
    def __init__(self, name: Union[str, 'SchemaBase', UndefinedType]=Undefined, select: Union[dict, 'SchemaBase', Literal['point', 'interval'], UndefinedType]=Undefined, bind: Union[str, dict, 'SchemaBase', UndefinedType]=Undefined, value: Union[str, bool, dict, None, float, 'SchemaBase', Sequence[Union[dict, 'SchemaBase']], UndefinedType]=Undefined, **kwds):
        super(SelectionParameter, self).__init__(name=name, select=select, bind=bind, value=value, **kwds)