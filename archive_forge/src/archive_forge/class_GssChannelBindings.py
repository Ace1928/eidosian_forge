...
class GssChannelBindings:
    ...
    def __init__(self, initiator_addrtype: AddressType=AddressType.unspecified, initiator_address: typing.Optional[bytes]=None, acceptor_addrtype: AddressType=AddressType.unspecified, acceptor_address: typing.Optional[bytes]=None, application_data: typing.Optional[bytes]=None) -> None:
    ...
    def __repr__(self) -> str:
        return '{0}.{1} initiator_addrtype={2}|initiator_address={3}|acceptor_addrtype={4}|acceptor_address={5}|application_data={6}'.format(type(self).__module__, type(self).__name__, repr(self.initiator_addrtype), repr(self.initiator_address), repr(self.acceptor_addrtype), repr(self.acceptor_address), repr(self.application_data))

    def __str__(self) -> str:
        return '{0} initiator_addr({1}.{2}|{3!r}) | acceptor_addr({4}.{5}|{6!r}) | application_data({7!r})'.format(type(self).__name__, type(self.initiator_addrtype).__name__, self.initiator_addrtype.name, self.initiator_address, type(self.acceptor_addrtype).__name__, self.acceptor_addrtype.name, self.acceptor_address, self.application_data)
    ...
    def pack(self) -> bytes:
        ...
        return b''.join([_pack_value(self.initiator_addrtype, self.initiator_address), _pack_value(self.acceptor_addrtype, self.acceptor_address), _pack_value(None, self.application_data)])
    ...
    def unpack(b_data: bytes) -> 'GssChannelBindings':
        ...
        return GssChannelBindings(initiator_addrtype=initiator_addrtype, initiator_address=initiator_address, acceptor_addrtype=acceptor_addrtype, acceptor_address=acceptor_address, application_data=application_data)