...
class TestNetworkSubnet(TestNetworkProxy):
    ...
    def test_subnet_delete(self):
        self.verify_delete(self.proxy.delete_subnet, subnet.Subnet, False, expected_kwargs={'if_revision': None})

    def test_subnet_delete_ignore(self):
        self.verify_delete(self.proxy.delete_subnet, subnet.Subnet, True, expected_kwargs={'if_revision': None})

    def test_subnet_delete_if_revision(self):
        self.verify_delete(self.proxy.delete_subnet, subnet.Subnet, True, method_kwargs={'if_revision': 42}, expected_kwargs={'if_revision': 42})
    ...
    def test_subnet_update(self):
        self.verify_update(self.proxy.update_subnet, subnet.Subnet, expected_kwargs={'x': 1, 'y': 2, 'z': 3, 'if_revision': None})
