...
class RayServegRPCContext:
    ...
    def __init__(self, grpc_context: grpc._cython.cygrpc._ServicerContext):
        ...
        self._invocation_metadata = [(key, value) for key, value in grpc_context.invocation_metadata()]
        ...
        self._trailing_metadata = [(key, value) for key, value in grpc_context.trailing_metadata()]
