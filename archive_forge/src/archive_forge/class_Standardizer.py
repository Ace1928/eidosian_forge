...
class Standardizer(object):
    ...
    def __init__(self, normalizations=NORMALIZATIONS, acid_base_pairs=ACID_BASE_PAIRS, charge_corrections=CHARGE_CORRECTIONS, tautomer_transforms=TAUTOMER_TRANSFORMS, tautomer_scores=TAUTOMER_SCORES, max_restarts=MAX_RESTARTS, max_tautomers=MAX_TAUTOMERS, prefer_organic=PREFER_ORGANIC):
        ...
        """
        warn(f'The class {self.__class__.__name__} is deprecated and will be removed in the next release.', DeprecationWarning, stacklevel=2)
