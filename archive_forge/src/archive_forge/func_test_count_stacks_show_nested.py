...
def test_count_stacks_show_nested(self, mock_stack_count_all):
    ...
    mock_stack_count_all.assert_called_once_with(mock.ANY, filters=mock.ANY, show_deleted=False, show_nested=True, show_hidden=False, tags=None, tags_any=None, not_tags=None, not_tags_any=None)