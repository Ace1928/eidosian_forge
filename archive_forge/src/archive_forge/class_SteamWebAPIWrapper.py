...
class SteamWebAPIWrapper(BaseModel):
    ...
    steam: Any
    from langchain_community.tools.steam.prompt import STEAM_GET_GAMES_DETAILS, STEAM_GET_RECOMMENDED_GAMES
    operations: List[dict] = [{'mode': 'get_game_details', 'name': 'Get Game Details', 'description': STEAM_GET_GAMES_DETAILS}, {'mode': 'get_recommended_games', 'name': 'Get Recommended Games', 'description': STEAM_GET_RECOMMENDED_GAMES}]
