...
class JoinedTable(Media):
    ...
    def _validate_table_input(table):
        ...
        return isinstance(table, str) and table.endswith('.table.json') or isinstance(table, Table) or isinstance(table, PartitionedTable) or (hasattr(table, 'ref_url') and table.ref_url().endswith('.table.json'))
