...
class CmdLineChecker:
    ...
    def print_help(self):
        print([info(color('0', color='yellow') + '..' + color('N', color='yellow') + ':\t' + color('replace', color='bold') + ' with the numbered suggestion')])
        print([info(color('R', color='cyan') + color('0', color='yellow') + '..' + color('R', color='cyan') + color('N', color='yellow') + ':\t' + color('always replace', color='bold') + ' with the numbered suggestion')])
        print([info(color('i', color='cyan') + ':\t\t' + color('ignore', color='bold') + ' this word')])
        print([info(color('I', color='cyan') + ':\t\t' + color('always ignore', color='bold') + ' this word')])
        print([info(color('a', color='cyan') + ':\t\t' + color('add', color='bold') + ' word to personal dictionary')])
        print([info(color('e', color='cyan') + ':\t\t' + color('edit', color='bold') + ' the word')])
        print([info(color('q', color='cyan') + ':\t\t' + color('quit', color='bold') + ' checking')])
        print([info(color('h', color='cyan') + ':\t\tprint this ' + color('help', color='bold') + ' message')])
        print([info('----------------------------------------------------')])
        self.print_suggestions()
