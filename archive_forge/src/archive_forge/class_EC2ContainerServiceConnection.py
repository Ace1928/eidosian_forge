...
class EC2ContainerServiceConnection(AWSQueryConnection):
    ...
    _faults = {'ServerException': exceptions.ServerException, 'ClientException': exceptions.ClientException}
    ...
    def list_tasks(self, cluster=None, container_instance=None, family=None, next_token=None, max_results=None):
        ...
        if max_results is not None:
            params['maxResults'] = max_results
        return self._make_request(action='ListTasks', verb='POST', path='/', params=params)
    ...
    def start_task(self, task_definition, container_instances, cluster=None, overrides=None):
        ...
        if overrides is not None:
            params['overrides'] = overrides
        return self._make_request(action='StartTask', verb='POST', path='/', params=params)
    ...
    def submit_container_state_change(self, cluster=None, task=None, container_name=None, status=None, exit_code=None, reason=None, network_bindings=None):
        ...
        if network_bindings is not None:
            self.build_complex_list_params(params, network_bindings, 'networkBindings.member', ('bindIP', 'containerPort', 'hostPort'))
        return self._make_request(action='SubmitContainerStateChange', verb='POST', path='/', params=params)
