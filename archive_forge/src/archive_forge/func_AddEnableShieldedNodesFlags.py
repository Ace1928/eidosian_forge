...
def AddEnableShieldedNodesFlags(parser):
    ...
    help_text = 'Enable Shielded Nodes for this cluster. Enabling Shielded Nodes will enable a\nmore secure Node credential bootstrapping implementation. Starting with version\n1.18, clusters will have Shielded GKE nodes by default.\n'
    parser.add_argument('--enable-shielded-nodes', action='store_true', default=None, help=help_text, hidden=False)