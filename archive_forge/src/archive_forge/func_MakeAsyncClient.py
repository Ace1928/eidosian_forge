...
def MakeAsyncClient(client_class, credentials, address_override_func=None, mtls_enabled=False, attempt_direct_path=False):
  ...
  """
    ...
    return client_class(transport=gapic_util_internal.MakeAsyncTransport(client_class, credentials, address_override_func, mtls_enabled, attempt_direct_path))