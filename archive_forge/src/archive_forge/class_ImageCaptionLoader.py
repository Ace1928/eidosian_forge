...
class ImageCaptionLoader(BaseLoader):
    ...
    def __init__(self, images: Union[str, Path, bytes, List[Union[str, bytes, Path]]], blip_processor: str='Salesforce/blip-image-captioning-base', blip_model: str='Salesforce/blip-image-captioning-base'):
