...
def test_snapshot_create_w_metadata(self, mock_find_vol):
    ...
    self.run_command('--os-volume-api-version 3.66 snapshot-create 123456 --metadata a=b')
    self.assert_called_anytime('POST', '/snapshots', body=self.SNAP_BODY_3_66_W_METADATA)