...
class OauthScopedPayload(BasePayload):
    ...
    def assemble(cls, user_id, methods, system, project_id, domain_id, expires_at, audit_ids, trust_id, federated_group_ids, identity_provider_id, protocol_id, access_token_id, app_cred_id, thumbprint):
        ...
        b_access_token_id = cls.attempt_convert_uuid_hex_to_bytes(access_token_id)
        return (b_user_id, methods, b_project_id, b_access_token_id, expires_at_int, b_audit_ids)
    ...
    def disassemble(cls, payload):
        ...
        access_token_id = cls._convert_or_decode(is_stored_as_bytes, access_token_id)
