...
class SwitchLangevin(Langevin):
    ...
    def __init__(self, atoms, calc1, calc2, dt, T=None, friction=None, n_eq=None, n_switch=None, temperature_K=None, **langevin_kwargs):
        super().__init__(atoms, dt, temperature=T, temperature_K=temperature_K, friction=friction, **langevin_kwargs)
        if friction is None:
