...
class EC2Connection(AWSQueryConnection):
    ...
    DefaultRegionEndpoint = boto.config.get('Boto', 'ec2_region_endpoint', 'ec2.us-east-1.amazonaws.com')
    ...
    def __init__(self, aws_access_key_id=None, aws_secret_access_key=None, is_secure=True, host=None, port=None, proxy=None, proxy_port=None, proxy_user=None, proxy_pass=None, debug=0, https_connection_factory=None, region=None, path='/', api_version=None, security_token=None, validate_certs=True, profile_name=None):
        ...
        self.region = region
        super(EC2Connection, self).__init__(aws_access_key_id, aws_secret_access_key, is_secure, port, proxy, proxy_port, proxy_user, proxy_pass, self.region.endpoint, debug, https_connection_factory, path, security_token, validate_certs=validate_certs, profile_name=profile_name)
        if api_version:
    ...
    def get_params(self):
        ...
        """
        param_names = ['aws_access_key_id', 'aws_secret_access_key', 'is_secure', 'port', 'proxy', 'proxy_port', 'proxy_user', 'proxy_pass', 'debug', 'https_connection_factory']
        params = {}
    ...
    def register_image(self, name=None, description=None, image_location=None, architecture=None, kernel_id=None, ramdisk_id=None, root_device_name=None, block_device_map=None, dry_run=False, virtualization_type=None, sriov_net_support=None, snapshot_id=None, delete_root_volume_on_termination=False):
        ...
        if snapshot_id:
            root_vol = BlockDeviceType(snapshot_id=snapshot_id, delete_on_termination=delete_root_volume_on_termination)
    ...
    def get_all_instances(self, instance_ids=None, filters=None, dry_run=False, max_results=None):
        ...
        """
        warnings.warn('The current get_all_instances implementation will be replaced with get_all_reservations.', PendingDeprecationWarning)
        return self.get_all_reservations(instance_ids=instance_ids, filters=filters, dry_run=dry_run, max_results=max_results)
    ...
    def cancel_spot_instance_requests(self, request_ids, dry_run=False):
        ...
        if dry_run:
            params['DryRun'] = 'true'
        return self.get_list('CancelSpotInstanceRequests', params, [('item', SpotInstanceRequest)], verb='POST')
    ...
    def get_spot_datafeed_subscription(self, dry_run=False):
        ...
        if dry_run:
            params['DryRun'] = 'true'
        return self.get_object('DescribeSpotDatafeedSubscription', params, SpotDatafeedSubscription, verb='POST')
    ...
    def create_spot_datafeed_subscription(self, bucket, prefix, dry_run=False):
        ...
        if dry_run:
            params['DryRun'] = 'true'
        return self.get_object('CreateSpotDatafeedSubscription', params, SpotDatafeedSubscription, verb='POST')
    ...
    def _associate_address(self, status, instance_id=None, public_ip=None, allocation_id=None, network_interface_id=None, private_ip_address=None, allow_reassociation=False, dry_run=False):
        params = {}
    ...
    def get_all_volume_status(self, volume_ids=None, max_results=None, next_token=None, filters=None, dry_run=False):
        ...
        if dry_run:
            params['DryRun'] = 'true'
        return self.get_object('DescribeVolumeStatus', params, VolumeStatusSet, verb='POST')
    ...
    def get_volume_attribute(self, volume_id, attribute='autoEnableIO', dry_run=False):
        ...
        if dry_run:
            params['DryRun'] = 'true'
        return self.get_object('DescribeVolumeAttribute', params, VolumeAttribute, verb='POST')
    ...
    def trim_snapshots(self, hourly_backups=8, daily_backups=7, weekly_backups=4, monthly_backups=True):
        ...
        while start_of_month > oldest_snapshot_date and (monthly_backups is True or monthly_snapshots_added < monthly_backups):
    ...
    def get_all_security_groups(self, groupnames=None, group_ids=None, filters=None, dry_run=False):
        ...
        if dry_run:
            params['DryRun'] = 'true'
        return self.get_list('DescribeSecurityGroups', params, [('item', SecurityGroup)], verb='POST')
    ...
    def cancel_reserved_instances_listing(self, reserved_instances_listing_ids=None, dry_run=False):
        ...
        if dry_run:
            params['DryRun'] = 'true'
        return self.get_list('CancelReservedInstancesListing', params, [('item', ReservedInstanceListing)], verb='POST')
    ...
    def get_all_network_interfaces(self, network_interface_ids=None, filters=None, dry_run=False):
        ...
        if dry_run:
            params['DryRun'] = 'true'
        return self.get_list('DescribeNetworkInterfaces', params, [('item', NetworkInterface)], verb='POST')
    ...
    def get_all_classic_link_instances(self, instance_ids=None, filters=None, dry_run=False, max_results=None, next_token=None):
        ...
        if next_token:
            params['NextToken'] = next_token
        return self.get_list('DescribeClassicLinkInstances', params, [('item', Instance)], verb='POST')