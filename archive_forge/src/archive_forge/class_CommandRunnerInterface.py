...
class CommandRunnerInterface:
    ...
    **Important**: This is an INTERNAL API that is only exposed for the purpose
    ...
    def run(self, cmd: Optional[str]=None, timeout: int=120, exit_on_fail: bool=False, port_forward: List[Tuple[int, int]]=None, with_output: bool=False, environment_variables: Optional[Dict[str, object]]=None, run_env: str='auto', ssh_options_override_ssh_key: str='', shutdown_after_run: bool=False) -> str:
    ...
    def run_init(self, *, as_head: bool, file_mounts: Dict[str, str], sync_run_yet: bool) -> Optional[bool]:
