...
class UndirectedHypergraph:
    ...
    def __init__(self, *, vertices: Optional[Iterable[Hashable]]=None, labelled_edges: Optional[Dict[Iterable[Hashable], Any]]=None) -> None:
    ...
    @classmethod
    def random(cls, vertices: Union[int, Iterable], edge_probs: Mapping[int, float]) -> 'UndirectedHypergraph':
        """A random hypergraph.
