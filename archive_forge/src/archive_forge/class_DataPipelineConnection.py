...
class DataPipelineConnection(AWSQueryConnection):
    ...
    _faults = {'PipelineDeletedException': exceptions.PipelineDeletedException, 'InvalidRequestException': exceptions.InvalidRequestException, 'TaskNotFoundException': exceptions.TaskNotFoundException, 'PipelineNotFoundException': exceptions.PipelineNotFoundException, 'InternalServiceError': exceptions.InternalServiceError}
    ...
    def evaluate_expression(self, pipeline_id, expression, object_id):
        ...
        """
        params = {'pipelineId': pipeline_id, 'objectId': object_id, 'expression': expression}
    ...
    def get_pipeline_definition(self, pipeline_id, version=None):
        ...
        return self.make_request(action='GetPipelineDefinition', body=json.dumps(params))
    ...
    def set_status(self, object_ids, status, pipeline_id):
        ...
        """
        params = {'pipelineId': pipeline_id, 'objectIds': object_ids, 'status': status}
