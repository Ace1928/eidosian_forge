...
def log_cmap(field_name: str, palette: Sequence[ColorLike], low: float, high: float, low_color: ColorLike | None=None, high_color: ColorLike | None=None, nan_color: ColorLike='gray') -> Field:
    ...
    """
    return Field(field_name, LogColorMapper(palette=palette, low=low, high=high, nan_color=nan_color, low_color=low_color, high_color=high_color))