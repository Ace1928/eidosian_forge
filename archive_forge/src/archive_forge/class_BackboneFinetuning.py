...
class BackboneFinetuning(BaseFinetuning):
    ...
    def __init__(self, unfreeze_backbone_at_epoch: int=10, lambda_func: Callable=multiplicative, backbone_initial_ratio_lr: float=0.1, backbone_initial_lr: Optional[float]=None, should_align: bool=True, initial_denom_lr: float=10.0, train_bn: bool=True, verbose: bool=False, rounding: int=12) -> None:
        super().__init__()
    ...
    def state_dict(self) -> Dict[str, Any]:
        return {'internal_optimizer_metadata': self._internal_optimizer_metadata, 'previous_backbone_lr': self.previous_backbone_lr}
