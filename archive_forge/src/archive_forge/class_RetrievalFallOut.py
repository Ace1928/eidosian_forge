...
class RetrievalFallOut(RetrievalMetric):
    ...
    def __init__(self, empty_target_action: str='pos', ignore_index: Optional[int]=None, top_k: Optional[int]=None, aggregation: Union[Literal['mean', 'median', 'min', 'max'], Callable]='mean', **kwargs: Any) -> None:
        super().__init__(empty_target_action=empty_target_action, ignore_index=ignore_index, aggregation=aggregation, **kwargs)
    ...
    def compute(self) -> Tensor:
        ...
        return _retrieval_aggregate(torch.stack([x.to(preds) for x in res]), aggregation=self.aggregation) if res else tensor(0.0).to(preds)
