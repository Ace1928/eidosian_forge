...
@keras_export(['keras.metrics.binary_focal_crossentropy', 'keras.losses.binary_focal_crossentropy'])
def binary_focal_crossentropy(y_true, y_pred, apply_class_balancing=False, alpha=0.25, gamma=2.0, from_logits=False, label_smoothing=0.0, axis=-1):
    ...
    bce = ops.binary_crossentropy(target=y_true, output=y_pred, from_logits=False)
