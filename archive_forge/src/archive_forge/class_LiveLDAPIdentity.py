...
class LiveLDAPIdentity(test_backend_ldap.LDAPIdentity):
    ...
    def test_user_enable_attribute_mask(self):
        self.config_fixture.config(group='ldap', user_enabled_emulation=False, user_enabled_attribute='employeeType')
        super(LiveLDAPIdentity, self).test_user_enable_attribute_mask()

    def test_create_project_case_sensitivity(self):

        def call_super():
            super(LiveLDAPIdentity, self).test_create_project_case_sensitivity()
    ...
    def test_project_update_missing_attrs_with_a_falsey_value(self):
        ...
        def call_super():
            super(LiveLDAPIdentity, self).test_project_update_missing_attrs_with_a_falsey_value()
