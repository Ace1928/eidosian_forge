...
class KeystoneToken(token.Token):
    ...
    def __init__(self, token, auth_url=None, trust_id=None, domain_id=None, domain_name=None, project_id=None, project_name=None, project_domain_id=None, project_domain_name=None, reauthenticate=True):
