...
class CloudSearchDomainConnection(AWSAuthConnection):
    ...
    _faults = {'SearchException': exceptions.SearchException, 'DocumentServiceException': exceptions.DocumentServiceException}
    ...
    def __init__(self, **kwargs):
        ...
        if kwargs.get('host', None) is None:
            raise ValueError("The argument, host, must be provided when creating a CloudSearchDomainConnection because its methods require the specific domain's endpoint in order to successfully make requests to that CloudSearch Domain.")
