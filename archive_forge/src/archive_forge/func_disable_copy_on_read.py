...
def disable_copy_on_read(resource: _atypes.TensorFuzzingAnnotation[_atypes.Resource], name=None):
  ...
  """
    ...
    if tld.is_eager:
        try:
            _result = pywrap_tfe.TFE_Py_FastPathExecute(_ctx, 'DisableCopyOnRead', name, resource)
            return _result
        ...
        try:
            ...
            pass
    _, _, _op, _outputs = _op_def_library._apply_op_helper('DisableCopyOnRead', resource=resource, name=name)
    return _op