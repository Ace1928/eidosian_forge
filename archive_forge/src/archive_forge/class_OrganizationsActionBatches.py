...
class OrganizationsActionBatches(object):
    ...
    def __init__(self, params, meraki):
        self.meraki = meraki
        self.new_object = dict(confirmed=params.get('confirmed'), synchronous=params.get('synchronous'), actions=params.get('actions'), organizationId=params.get('organizationId'), actionBatchId=params.get('actionBatchId'))
    ...
    def get_params_by_id(self, name=None, id=None):
        ...
        if self.new_object.get('actionBatchId') is not None or self.new_object.get('action_batch_id') is not None:
            new_object_params['actionBatchId'] = self.new_object.get('actionBatchId') or self.new_object.get('action_batch_id')
        return new_object_params
    ...
    def create_params(self):
        ...
        if self.new_object.get('actions') is not None or self.new_object.get('actions') is not None:
            new_object_params['actions'] = self.new_object.get('actions') or self.new_object.get('actions')
        if self.new_object.get('organizationId') is not None or self.new_object.get('organization_id') is not None:
            new_object_params['organizationId'] = self.new_object.get('organizationId') or self.new_object.get('organization_id')
        return new_object_params
    ...
    def get_object_by_name(self, name):
        result = None
        try:
            items = self.meraki.exec_meraki(family='organizations', function='getOrganizationActionBatches', params=self.get_all_params(name=name))
    ...
    def get_object_by_id(self, id):
        result = None
        try:
            items = self.meraki.exec_meraki(family='organizations', function='getOrganizationActionBatch', params=self.get_params_by_id())
            if isinstance(items, dict):
                if 'response' in items:
                    items = items.get('response')
    ...
    def exists(self):
        ...
        o_id = o_id or self.new_object.get('action_batch_id') or self.new_object.get('actionBatchId')
    ...
    def requires_update(self, current_obj):
        ...
        obj_params = [('confirmed', 'confirmed'), ('synchronous', 'synchronous'), ('actions', 'actions'), ('organizationId', 'organizationId'), ('actionBatchId', 'actionBatchId')]
    ...
    def create(self):
        result = self.meraki.exec_meraki(family='organizations', function='createOrganizationActionBatch', params=self.create_params(), op_modifies=True)
        return result
    ...
    def update(self):
        ...
        result = self.meraki.exec_meraki(family='organizations', function='updateOrganizationActionBatch', params=self.update_by_id_params(), op_modifies=True)
        return result
    ...
    def delete(self):
        ...
        if not id:
            ...
            if id_:
                self.new_object.update(dict(actionBatchId=id_))
        result = self.meraki.exec_meraki(family='organizations', function='deleteOrganizationActionBatch', params=self.delete_by_id_params())
        return result