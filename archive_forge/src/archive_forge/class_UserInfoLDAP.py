...
class UserInfoLDAP(UserInfo):
    ...
    def __init__(self, uri, base, filter_pattern, scope=SCOPE_SUBTREE, tls=False, user='', passwd='', attr=None, attrsonly=False):
    ...
    def __call__(self, userid, base='', filter_pattern='', scope=SCOPE_SUBTREE, tls=False, attr=None, attrsonly=False, **kwargs):
        if filter_pattern:
