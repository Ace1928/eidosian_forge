...
def internal_convert_n_to_tensor_or_composite(values, dtype=None, name=None, as_ref=False) -> List[Union[tensor_lib.Tensor, composite_tensor.CompositeTensor, type(None)]]:
