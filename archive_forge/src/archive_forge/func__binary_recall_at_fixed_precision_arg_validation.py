...
def _binary_recall_at_fixed_precision_arg_validation(min_precision: float, thresholds: Optional[Union[int, List[float], Tensor]]=None, ignore_index: Optional[int]=None) -> None:
