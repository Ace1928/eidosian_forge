...
class FileChecker:
    ...
    def check_similarity(self):
        ...
        file_hashes = self.calculate_file_hashes(folder)
        similarity_groups = self.group_similar_files(file_hashes, threshold)

        self.display_results(similarity_groups)
    ...
    def display_results(self, similarity_groups: Dict[str, List[str]]):
            ...
            if len(group_files) > 1:
                ...
                for file_path in group_files:
                    ...
                    with open(file_path, "r") as file:
                        ...
                        tree.insert(
                            group_node, tk.END, text=f"Suggested Name: {generated_name}"
                        )
    ...
    def generate_file_name(self, file_content: str) -> str:
        ...
        # Add the file content as a message to the thread
        message = self.openai_client.beta.threads.messages.create(
            thread_id=thread.id,
            role="user",
            content=f"Please generate a concise, accurate, and specific file name for the following document:\n\n{file_content}",
        )
        ...
        return event_handler.generated_name.strip()
