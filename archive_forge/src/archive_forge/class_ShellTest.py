...
class ShellTest(shell_test_base.TestCommandLineArgument):
    ...
    def test_cluster_template_create_success_no_servertype(self, mock_create):
        self._test_arg_success('cluster-template-create --name test --image-id test_image --keypair-id test_keypair --external-network-id test_net --coe swarm --dns-nameserver test_dns --flavor-id test_flavor --fixed-network public --network-driver test_driver --labels key=val --master-flavor-id test_flavor --docker-volume-size 10 --docker-storage-driver devicemapper --public ')
        ...
        mock_create.assert_called_with(**expected_args)
        self._test_arg_success('cluster-template-create --keypair-id test_keypair --external-network-id test_net --image-id test_image --coe kubernetes --name test ')
        expected_args = self._get_expected_args(name='test', image_id='test_image', keypair_id='test_keypair', coe='kubernetes', external_network_id='test_net')
        mock_create.assert_called_with(**expected_args)
    ...
    def test_cluster_template_create_public_success(self, mock_create):
        self._test_arg_success('cluster-template-create --name test --network-driver test_driver --keypair-id test_keypair --external-network-id test_net --image-id test_image --coe swarm --public --server-type vm')
        expected_args = self._get_expected_args(name='test', image_id='test_image', keypair_id='test_keypair', coe='swarm', external_network_id='test_net', public=True, server_type='vm', network_driver='test_driver')
        mock_create.assert_called_with(**expected_args)
    ...
    @mock.patch('magnumclient.v1.cluster_templates.ClusterTemplateManager.create')
    def test_cluster_template_create_docker_vol_size_success(self, mock_create):
        self._test_arg_success('cluster-template-create --name test --docker-volume-size 4514 --keypair-id test_keypair --external-network-id test_net --image-id test_image --coe swarm --server-type vm')
        expected_args = self._get_expected_args(name='test', image_id='test_image', keypair_id='test_keypair', coe='swarm', external_network_id='test_net', server_type='vm', docker_volume_size=4514)
        mock_create.assert_called_with(**expected_args)

    @mock.patch('magnumclient.v1.cluster_templates.ClusterTemplateManager.create')
    def test_cluster_template_create_docker_storage_driver_success(self, mock_create):
        self._test_arg_success('cluster-template-create --name test --keypair-id test_keypair --external-network-id test_net --image-id test_image --docker-storage-driver devicemapper --coe swarm')
        expected_args = self._get_expected_args(name='test', image_id='test_image', keypair_id='test_keypair', coe='swarm', external_network_id='test_net', docker_storage_driver='devicemapper')
        mock_create.assert_called_with(**expected_args)

    @mock.patch('magnumclient.v1.cluster_templates.ClusterTemplateManager.create')
    def test_cluster_template_create_fixed_network_success(self, mock_create):
        self._test_arg_success('cluster-template-create --name test --fixed-network private --keypair-id test_keypair --external-network-id test_net --image-id test_image --coe swarm --server-type vm')
        expected_args = self._get_expected_args(name='test', image_id='test_image', keypair_id='test_keypair', coe='swarm', fixed_network='private', external_network_id='test_net', server_type='vm')
        mock_create.assert_called_with(**expected_args)

    @mock.patch('magnumclient.v1.cluster_templates.ClusterTemplateManager.create')
    def test_cluster_template_create_network_driver_success(self, mock_create):
        self._test_arg_success('cluster-template-create --name test --network-driver test_driver --keypair-id test_keypair --external-network-id test_net --image-id test_image --coe swarm --server-type vm')
        expected_args = self._get_expected_args(name='test', image_id='test_image', keypair_id='test_keypair', coe='swarm', external_network_id='test_net', server_type='vm', network_driver='test_driver')
        mock_create.assert_called_with(**expected_args)

    @mock.patch('magnumclient.v1.cluster_templates.ClusterTemplateManager.create')
    def test_cluster_template_create_volume_driver_success(self, mock_create):
        self._test_arg_success('cluster-template-create --name test --volume-driver test_volume --keypair-id test_keypair --external-network-id test_net --image-id test_image --coe swarm --server-type vm')
        expected_args = self._get_expected_args(name='test', image_id='test_image', keypair_id='test_keypair', coe='swarm', external_network_id='test_net', server_type='vm', volume_driver='test_volume')
        mock_create.assert_called_with(**expected_args)

    @mock.patch('magnumclient.v1.cluster_templates.ClusterTemplateManager.create')
    def test_cluster_template_create_http_proxy_success(self, mock_create):
        self._test_arg_success('cluster-template-create --name test --fixed-network private --keypair-id test_keypair --external-network-id test_net --image-id test_image --coe swarm --http-proxy http_proxy --server-type vm')
        expected_args = self._get_expected_args(name='test', image_id='test_image', keypair_id='test_keypair', coe='swarm', external_network_id='test_net', fixed_network='private', server_type='vm', http_proxy='http_proxy')
        mock_create.assert_called_with(**expected_args)
    ...
    def test_cluster_template_create_no_proxy_success(self, mock_create):
        self._test_arg_success('cluster-template-create --name test --fixed-network private --keypair-id test_keypair --external-network-id test_net --image-id test_image --coe swarm --no-proxy no_proxy --server-type vm')
        expected_args = self._get_expected_args(name='test', image_id='test_image', keypair_id='test_keypair', coe='swarm', external_network_id='test_net', fixed_network='private', server_type='vm', no_proxy='no_proxy')
        mock_create.assert_called_with(**expected_args)

    @mock.patch('magnumclient.v1.cluster_templates.ClusterTemplateManager.create')
    def test_cluster_template_create_labels_success(self, mock_create):
        self._test_arg_success('cluster-template-create --name test --labels key=val --keypair-id test_keypair --external-network-id test_net --image-id test_image --coe swarm --server-type vm')
        expected_args = self._get_expected_args(name='test', image_id='test_image', keypair_id='test_keypair', coe='swarm', external_network_id='test_net', server_type='vm', labels={'key': 'val'})
        mock_create.assert_called_with(**expected_args)

    @mock.patch('magnumclient.v1.cluster_templates.ClusterTemplateManager.create')
    def test_cluster_template_create_separate_labels_success(self, mock_create):
        self._test_arg_success('cluster-template-create --name test --labels key1=val1 --labels key2=val2 --keypair-id test_keypair --external-network-id test_net --image-id test_image --coe swarm --server-type vm')
    ...
    @mock.patch('magnumclient.v1.cluster_templates.ClusterTemplateManager.create')
    def test_cluster_template_create_combined_labels_success(self, mock_create):
        self._test_arg_success('cluster-template-create --name test --labels key1=val1,key2=val2 --keypair-id test_keypair --external-network-id test_net --image-id test_image --coe swarm --server-type vm')
        expected_args = self._get_expected_args(name='test', image_id='test_image', keypair_id='test_keypair', coe='swarm', external_network_id='test_net', server_type='vm', labels={'key1': 'val1', 'key2': 'val2'})
        mock_create.assert_called_with(**expected_args)
    ...
    def test_cluster_template_list_success_detailed(self, mock_list):
        self._test_arg_success('cluster-template-list --detail')
