...
def deprecate(field_name: DEPRECATED_FEATURES, warning_message: str, run: Optional['wandb_run.Run']=None) -> None:
    ...
    if field_name not in known_fields:
        raise ValueError(f'Unknown field name: {field_name}. Known fields: {known_fields}')
