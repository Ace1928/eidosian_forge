...
class Qu2CuPen(ContourFilterPen):
    ...
    def __init__(self, other_pen, max_err, all_cubic=False, reverse_direction=False, stats=None):
        ...
        if not self.all_cubic:
            ...
            for op, args in contour:
                if op == 'qCurveTo' and newContour and (newContour[-1][0] == 'qCurveTo'):
                    ...
                    pt2 = args[0]
                    if pt1 is not None and math.isclose(pt2[0] - pt1[0], pt1[0] - pt0[0]) and math.isclose(pt2[1] - pt1[1], pt1[1] - pt0[1]):
