...
def ScopeParentName(project, release_track=base.ReleaseTrack.ALPHA):
    return resources.REGISTRY.Parse(line=None, params={'projectsId': project, 'locationsId': 'global'}, collection='gkehub.projects.locations', api_version=VERSION_MAP[release_track]).RelativeName()