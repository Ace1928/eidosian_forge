...
def create_one_server_interface(attrs=None):
    ...
    """
    attrs = attrs or {}
    server_interface_info = {'fixed_ips': uuid.uuid4().hex, 'mac_addr': 'aa:aa:aa:aa:aa:aa', 'net_id': uuid.uuid4().hex, 'port_id': uuid.uuid4().hex, 'port_state': 'ACTIVE', 'server_id': uuid.uuid4().hex, 'tag': 'foo'}
