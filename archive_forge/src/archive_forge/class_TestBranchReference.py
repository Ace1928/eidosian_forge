...
class TestBranchReference(tests.TestCaseWithTransport):
    ...
    def test_get_reference(self):
        ...
        self.assertFileEqual(reference_url.encode('utf-8'), 'checkout/.bzr/branch/location')
        self.assertEqual(reference_url, _mod_bzrbranch.BranchReferenceFormat().get_reference(checkout.controldir))