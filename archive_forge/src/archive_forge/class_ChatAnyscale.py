...
class ChatAnyscale(ChatOpenAI):
    ...
    def validate_environment(cls, values: dict) -> dict:
        ...
        values['anyscale_api_base'] = get_from_dict_or_env(values, 'anyscale_api_base', 'ANYSCALE_API_BASE', default=DEFAULT_API_BASE)
        values['openai_proxy'] = get_from_dict_or_env(values, 'anyscale_proxy', 'ANYSCALE_PROXY', default='')
        try:
            import openai
        ...
        available_models = cls.get_available_models(values['anyscale_api_key'].get_secret_value(), values['anyscale_api_base'])
