...
def GetTypeMetadataByResourceType(resource_type: str) -> Optional[TypeMetadata]:
  ...
  """
    for integration in _GetAllTypeMetadata():
        if integration.resource_type == resource_type and _IntegrationVisible(integration):
            return integration
    return None