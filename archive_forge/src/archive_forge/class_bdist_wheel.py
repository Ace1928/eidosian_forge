...
class bdist_wheel(Command):
    ...
    def run(self):
        ...
        getattr(self.distribution, 'dist_files', []).append(('bdist_wheel', '{}.{}'.format(*sys.version_info[:2]), wheel_path))
