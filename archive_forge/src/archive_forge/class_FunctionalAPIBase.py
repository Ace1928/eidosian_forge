...
class FunctionalAPIBase:
    ...
    def test_read_text(self):
        self.assertEqual(resources.read_text(self.anchor01, 'utf-8.file'), 'Hello, UTF-8 world!\n')
        self.assertEqual(resources.read_text(self.anchor02, 'subdirectory', 'subsubdir', 'resource.txt', encoding='utf-8'), 'a resource')
        for path_parts in self._gen_resourcetxt_path_parts():
            self.assertEqual(resources.read_text(self.anchor02, *path_parts, encoding='utf-8'), 'a resource')
        ...
        self.assertEqual(resources.read_text(self.anchor01, 'binary.file', encoding='latin1'), '\x00\x01\x02\x03')
        self.assertEqual(resources.read_text(self.anchor01, 'utf-16.file', errors='backslashreplace'), 'Hello, UTF-16 world!\n'.encode('utf-16').decode(errors='backslashreplace'))
    ...
    def test_open_text(self):
        ...
        for path_parts in self._gen_resourcetxt_path_parts():
            with resources.open_text(self.anchor02, *path_parts, encoding='utf-8') as f:
        ...
        with resources.open_text(self.anchor01, 'utf-16.file') as f:
            with self.assertRaises(UnicodeDecodeError):
                f.read()
        with resources.open_text(self.anchor01, 'binary.file', encoding='latin1') as f:
            self.assertEqual(f.read(), '\x00\x01\x02\x03')
        with resources.open_text(self.anchor01, 'utf-16.file', errors='backslashreplace') as f:
            self.assertEqual(f.read(), 'Hello, UTF-16 world!\n'.encode('utf-16').decode(errors='backslashreplace'))

    def test_open_binary(self):
        with resources.open_binary(self.anchor01, 'utf-8.file') as f:
            self.assertEqual(f.read(), b'Hello, UTF-8 world!\n')
        for path_parts in self._gen_resourcetxt_path_parts():
            with resources.open_binary(self.anchor02, *path_parts) as f:
    ...
    def test_contents(self):
        ...
        self.assertGreaterEqual(set(c), {'utf-8.file', 'utf-16.file', 'binary.file', 'subdirectory'})
        ...
        self.assertGreaterEqual(set(c), {'binary.file'})
