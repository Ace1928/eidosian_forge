...
class Route53DomainsConnection(AWSQueryConnection):
    ...
    _faults = {'DuplicateRequest': exceptions.DuplicateRequest, 'DomainLimitExceeded': exceptions.DomainLimitExceeded, 'InvalidInput': exceptions.InvalidInput, 'OperationLimitExceeded': exceptions.OperationLimitExceeded, 'UnsupportedTLD': exceptions.UnsupportedTLD, 'TLDRulesViolation': exceptions.TLDRulesViolation}
    ...
    def disable_domain_transfer_lock(self, domain_name):
        ...
        """
        params = {'DomainName': domain_name}
        return self.make_request(action='DisableDomainTransferLock', body=json.dumps(params))
