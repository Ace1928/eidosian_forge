...
class NetworksApplianceVlansSettings(object):
    ...
    def __init__(self, params, meraki):
        self.meraki = meraki
        self.new_object = dict(vlansEnabled=params.get('vlansEnabled'), network_id=params.get('networkId'))
    ...
    def get_object_by_name(self, name):
        result = None
        try:
            items = self.meraki.exec_meraki(family='appliance', function='getNetworkApplianceVlansSettings', params=self.get_all_params(name=name))
    ...
    def requires_update(self, current_obj):
        ...
        obj_params = [('vlansEnabled', 'vlansEnabled'), ('networkId', 'networkId')]
    ...
    def update(self):
        ...
        name = self.new_object.get('name')
        result = None
        result = self.meraki.exec_meraki(family='appliance', function='updateNetworkApplianceVlansSettings', params=self.update_all_params(), op_modifies=True)
        return result