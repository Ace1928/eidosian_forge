...
class Quickshear(CommandLine):
    ...
    _references = [{'entry': BibTeX('@inproceedings{Schimke2011,address = {San Francisco},author = {Schimke, Nakeisha and Hale, John},booktitle = {Proceedings of the 2nd USENIX Conference on Health Security and Privacy},title = {{Quickshear Defacing for Neuroimages}},year = {2011},month = sep}'), 'tags': ['implementation']}]