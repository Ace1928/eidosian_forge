...
class TextToSpeechAsyncClient:
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        """
        return TextToSpeechClient.from_service_account_info.__func__(TextToSpeechAsyncClient, info, *args, **kwargs)
    ...
    def from_service_account_file(cls, filename: str, *args, **kwargs):
        ...
        Returns:
            TextToSpeechAsyncClient: The constructed client.
        """
        return TextToSpeechClient.from_service_account_file.__func__(TextToSpeechAsyncClient, filename, *args, **kwargs)
    ...
    def get_mtls_endpoint_and_cert_source(cls, client_options: Optional[ClientOptions]=None):
        ...
        """
        return TextToSpeechClient.get_mtls_endpoint_and_cert_source(client_options)
    ...
    def __init__(self, *, credentials: Optional[ga_credentials.Credentials]=None, transport: Union[str, TextToSpeechTransport]='grpc_asyncio', client_options: Optional[ClientOptions]=None, client_info: gapic_v1.client_info.ClientInfo=DEFAULT_CLIENT_INFO) -> None:
    ...
    async def list_voices(self, request: Optional[Union[cloud_tts.ListVoicesRequest, dict]]=None, *, language_code: Optional[str]=None, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> cloud_tts.ListVoicesResponse:
        ...
        rpc = gapic_v1.method_async.wrap_method(self._client._transport.list_voices, default_timeout=None, client_info=DEFAULT_CLIENT_INFO)
        self._client._validate_universe_domain()
        response = await rpc(request, retry=retry, timeout=timeout, metadata=metadata)
        return response

    async def synthesize_speech(self, request: Optional[Union[cloud_tts.SynthesizeSpeechRequest, dict]]=None, *, input: Optional[cloud_tts.SynthesisInput]=None, voice: Optional[cloud_tts.VoiceSelectionParams]=None, audio_config: Optional[cloud_tts.AudioConfig]=None, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> cloud_tts.SynthesizeSpeechResponse:
        ...
        rpc = gapic_v1.method_async.wrap_method(self._client._transport.synthesize_speech, default_timeout=None, client_info=DEFAULT_CLIENT_INFO)
        self._client._validate_universe_domain()
        response = await rpc(request, retry=retry, timeout=timeout, metadata=metadata)
        return response
    ...
    async def list_operations(self, request: Optional[operations_pb2.ListOperationsRequest]=None, *, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> operations_pb2.ListOperationsResponse:
        ...
        rpc = gapic_v1.method_async.wrap_method(self._client._transport.list_operations, default_timeout=None, client_info=DEFAULT_CLIENT_INFO)
    ...
    async def get_operation(self, request: Optional[operations_pb2.GetOperationRequest]=None, *, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> operations_pb2.Operation:
        ...
        rpc = gapic_v1.method_async.wrap_method(self._client._transport.get_operation, default_timeout=None, client_info=DEFAULT_CLIENT_INFO)
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((('name', request.name),)),)
        self._client._validate_universe_domain()
        response = await rpc(request, retry=retry, timeout=timeout, metadata=metadata)
        return response
