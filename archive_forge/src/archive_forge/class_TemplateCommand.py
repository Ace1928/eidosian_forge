...
class TemplateCommand(BaseCommand):
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument('--exclude', '-x', action='append', default=argparse.SUPPRESS, nargs='?', const='', help='The directory name(s) to exclude, in addition to .git and __pycache__. Can be used multiple times.')
