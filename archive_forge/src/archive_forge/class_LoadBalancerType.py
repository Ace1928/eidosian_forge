...
class LoadBalancerType(BaseDomain, DomainIdentityMixin):
    ...
    """
    __slots__ = ('id', 'name', 'description', 'max_connections', 'max_services', 'max_targets', 'max_assigned_certificates', 'prices')

    def __init__(self, id: int | None=None, name: str | None=None, description: str | None=None, max_connections: int | None=None, max_services: int | None=None, max_targets: int | None=None, max_assigned_certificates: int | None=None, prices: dict | None=None):
        self.id = id
        self.name = name
