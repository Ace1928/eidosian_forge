...
def _AddResources(parser, include_set=True):
    repeated.AddPrimitiveArgs(parser, 'perimeter', 'resources', 'resources', additional_help='Resources must be projects, in the form `projects/<projectnumber>`.', include_set=include_set)