...
class CombineMM(Calculator):
    ...
    def __init__(self, idx, apm1, apm2, calc1, calc2, sig1, eps1, sig2, eps2, rc=7.0, width=1.0):
    ...
    def initialize(self, atoms):
        ...
        self.pbc = atoms.pbc
        self.sigma, self.epsilon = combine_lj_lorenz_berthelot(self.sig1, self.sig2, self.eps1, self.eps2)
