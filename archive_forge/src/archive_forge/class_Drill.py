...
class Drill(Dialect):
    ...
    class Parser(parser.Parser):
        STRICT_CAST = False
        FUNCTIONS = {**parser.Parser.FUNCTIONS, 'TO_TIMESTAMP': exp.TimeStrToTime.from_arg_list, 'TO_CHAR': build_formatted_time(exp.TimeToStr, 'drill')}
