...
class _CuDNNRNN(RNN):
    ...
    def __init__(self, return_sequences=False, return_state=False, go_backwards=False, stateful=False, time_major=False, **kwargs):
    ...
    def call(self, inputs, mask=None, training=None, initial_state=None):
        ...
        if self.stateful:
            updates = [tf.compat.v1.assign(self_state, state) for self_state, state in zip(self.states, states)]
    ...
    def get_config(self):
        config = {'return_sequences': self.return_sequences, 'return_state': self.return_state, 'go_backwards': self.go_backwards, 'stateful': self.stateful, 'time_major': self.time_major}
