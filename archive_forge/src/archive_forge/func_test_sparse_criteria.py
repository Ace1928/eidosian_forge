...
@pytest.mark.parametrize('tree_type, criterion', list(product([tree for tree in SPARSE_TREES if tree in REG_TREES], REG_CRITERIONS)) + list(product([tree for tree in SPARSE_TREES if tree in CLF_TREES], CLF_CRITERIONS)))
