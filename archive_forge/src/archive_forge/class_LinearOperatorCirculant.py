...
class LinearOperatorCirculant(_BaseLinearOperatorCirculant):
  ...
  * If `is_X == None` (the default), callers should have no expectation either
  ...
  """
    ...
    def __init__(self, spectrum, input_output_dtype=dtypes.complex64, is_non_singular=None, is_self_adjoint=None, is_positive_definite=None, is_square=True, name='LinearOperatorCirculant'):
