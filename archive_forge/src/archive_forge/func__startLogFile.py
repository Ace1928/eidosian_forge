...
def _startLogFile(self):
    ...
    def _get_log_contents_for_weird_testtools_api():
        return [pseudo_log_file.getvalue().decode('utf-8', 'replace').encode('utf-8')]
    self.addDetail('log', content.Content(content.ContentType('text', 'plain', {'charset': 'utf8'}), _get_log_contents_for_weird_testtools_api))
