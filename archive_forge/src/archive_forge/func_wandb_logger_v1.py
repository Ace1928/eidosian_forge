...
def wandb_logger_v1(project_name: str, remove_config_values: List[str]=[]):
    try:
        ...
        err_msg = "The 'wandb' library could not be found - did you install it? Alternatively, specify the 'ConsoleLogger' in the 'training.logger' config section, instead of the 'WandbLogger'."
