...
class Col(VuetifyWidget):
    ...
    cols = Union([Bool(), Unicode(), Float()], default_value=None, allow_none=True).tag(sync=True)
    lg = Union([Bool(), Unicode(), Float()], default_value=None, allow_none=True).tag(sync=True)
    md = Union([Bool(), Unicode(), Float()], default_value=None, allow_none=True).tag(sync=True)
    ...
    sm = Union([Bool(), Unicode(), Float()], default_value=None, allow_none=True).tag(sync=True)
    tag = Unicode(None, allow_none=True).tag(sync=True)
    xl = Union([Bool(), Unicode(), Float()], default_value=None, allow_none=True).tag(sync=True)