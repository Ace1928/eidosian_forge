...
class AWSLambdaConnection(AWSAuthConnection):
    ...
    **Overview**
    ...
    _faults = {'InvalidRequestContentException': exceptions.InvalidRequestContentException, 'ResourceNotFoundException': exceptions.ResourceNotFoundException, 'InvalidParameterValueException': exceptions.InvalidParameterValueException, 'ServiceException': exceptions.ServiceException}
