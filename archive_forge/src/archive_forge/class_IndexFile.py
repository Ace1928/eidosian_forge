...
class IndexFile(LazyMixin, git_diff.Diffable, Serializable):
    ...
    def new(cls, repo: 'Repo', *tree_sha: Union[str, Tree]) -> 'IndexFile':
        ...
        inst = cls(repo)
        entries: Dict[Tuple[PathLike, int], IndexEntry] = dict(zip(((e.path, e.stage) for e in base_entries), (IndexEntry.from_base(e) for e in base_entries)))
    ...
    def add(self, items: Sequence[Union[PathLike, Blob, BaseIndexEntry, 'Submodule']], force: bool=True, fprogress: Callable=lambda *args: None, path_rewriter: Union[Callable[..., PathLike], None]=None, write: bool=True, write_extension_data: bool=False) -> List[BaseIndexEntry]:
    ...
    @post_clear_cache
    @default_index
    def remove(self, items: Sequence[Union[PathLike, Blob, BaseIndexEntry, 'Submodule']], working_tree: bool=False, **kwargs: Any) -> List[str]:
    ...
    @post_clear_cache
    @default_index
    def move(self, items: Sequence[Union[PathLike, Blob, BaseIndexEntry, 'Submodule']], skip_errors: bool=False, **kwargs: Any) -> List[Tuple[str, str]]:
    ...
    def commit(self, message: str, parent_commits: Union[Commit_ish, None]=None, head: bool=True, author: Union[None, 'Actor']=None, committer: Union[None, 'Actor']=None, author_date: Union[datetime.datetime, str, None]=None, commit_date: Union[datetime.datetime, str, None]=None, skip_hooks: bool=False) -> Commit:
    ...
    @default_index
    def checkout(self, paths: Union[None, Iterable[PathLike]]=None, force: bool=False, fprogress: Callable=lambda *args: None, **kwargs: Any) -> Union[None, Iterator[PathLike], Sequence[PathLike]]:
        ...
        if paths is None:
            ...
            try:
                ...
                raise CheckoutError("Some files could not be checked out from the index, probably because they didn't exist.", failed_files, [], failed_reasons)
            handle_stderr(proc, checked_out_files)
            return checked_out_files

    @default_index
    def reset(self, commit: Union[Commit, 'Reference', str]='HEAD', working_tree: bool=False, paths: Union[None, Iterable[PathLike]]=None, head: bool=False, **kwargs: Any) -> 'IndexFile':
