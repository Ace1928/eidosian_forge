...
def test_expand_already_sync(self, mock_validate_engine, mock_get_alembic_branch_head, mock_get_current_alembic_heads):
    ...
    self.db.expand()
    self.assertIn('Database expansion is up to date. No expansion needed.', self.output.getvalue())