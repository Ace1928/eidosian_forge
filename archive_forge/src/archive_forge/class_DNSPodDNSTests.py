...
class DNSPodDNSTests(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.test_zone = Zone(id='11', type='master', ttl=None, domain='test.com', extra={}, driver=self.driver)
        self.test_record = Record(id='13', type=RecordType.A, name='example.com', zone=self.test_zone, data='127.0.0.1', driver=self, extra={})
    ...
    def test_create_record_success(self):
        ...
        record = self.driver.create_record(name='@', zone=self.test_zone, type='A', data='96.126.115.73', extra={'ttl': 13, 'record_line': 'default'})
        self.assertEqual(record.id, '50')
        self.assertEqual(record.name, '@')
        self.assertEqual(record.data, '96.126.115.73')
