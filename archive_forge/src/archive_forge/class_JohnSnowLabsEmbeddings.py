...
class JohnSnowLabsEmbeddings(BaseModel, Embeddings):
    ...
    def __init__(self, model: Any='embed_sentence.bert', hardware_target: str='cpu', **kwargs: Any):
        ...
        try:
            ...
            raise ImportError('Could not import johnsnowlabs python package. Please install it with `pip install johnsnowlabs`.') from exc
        try:
