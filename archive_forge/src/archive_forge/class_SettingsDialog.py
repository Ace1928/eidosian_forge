...
class SettingsDialog(Dialog):
    ...
    def validate(self):
        ...
        try:
            ...
            showerror('Invalid input', 'Please enter a number for the cutoff.')
            return False
    ...
    def buttonbox(self):
        ...
        OK = ttk.Button(box, text='OK', width=10, command=self.ok, default=Tk_.ACTIVE)
        OK.grid(row=0, column=0, sticky=Tk_.NE, padx=5)
        Apply = ttk.Button(box, text='Apply', width=10, command=self.settings.apply_settings)
