...
def RemoveFunctionIamPolicyBindingIfFound(function_resource_name, member='allUsers', role='roles/cloudfunctions.invoker'):
    ...
    return client.projects_locations_functions.SetIamPolicy(messages.CloudfunctionsProjectsLocationsFunctionsSetIamPolicyRequest(resource=function_resource_name, setIamPolicyRequest=messages.SetIamPolicyRequest(policy=policy)))