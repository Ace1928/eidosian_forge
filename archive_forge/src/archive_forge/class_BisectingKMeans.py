...
class BisectingKMeans(_BaseKMeans):
    ...
    array([[ 2., 1.],
           ...
           [10., 1.]])
    """
    _parameter_constraints: dict = {**_BaseKMeans._parameter_constraints, 'init': [StrOptions({'k-means++', 'random'}), callable], 'n_init': [Interval(Integral, 1, None, closed='left')], 'copy_x': ['boolean'], 'algorithm': [StrOptions({'lloyd', 'elkan'})], 'bisecting_strategy': [StrOptions({'biggest_inertia', 'largest_cluster'})]}
