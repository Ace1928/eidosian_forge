...
class FillDatum(DatumChannelMixin, core.FieldOrDatumDefWithConditionDatumDefGradientstringnull):
    ...
    @overload
    def condition(self, test: Union[str, dict, core.SchemaBase, UndefinedType]=Undefined, value: Union[str, dict, None, core._Parameter, core.SchemaBase, UndefinedType]=Undefined, **kwds) -> 'FillDatum':
        ...

    @overload
    def condition(self, empty: Union[bool, UndefinedType]=Undefined, param: Union[str, core.SchemaBase, UndefinedType]=Undefined, value: Union[str, dict, None, core._Parameter, core.SchemaBase, UndefinedType]=Undefined, **kwds) -> 'FillDatum':
        ...
    ...
    def __init__(self, datum, bandPosition: Union[float, UndefinedType]=Undefined, condition: Union[dict, core.SchemaBase, Sequence[Union[dict, core.SchemaBase]], UndefinedType]=Undefined, title: Union[str, None, Sequence[str], core.SchemaBase, UndefinedType]=Undefined, type: Union[core.SchemaBase, Literal['quantitative', 'ordinal', 'temporal', 'nominal', 'geojson'], UndefinedType]=Undefined, **kwds):
        super(FillDatum, self).__init__(datum=datum, bandPosition=bandPosition, condition=condition, title=title, type=type, **kwds)