...
def xla_dot_v2_eager_fallback(lhs: _atypes.TensorFuzzingAnnotation[TV_XlaDotV2_LhsT], rhs: _atypes.TensorFuzzingAnnotation[TV_XlaDotV2_RhsT], dimension_numbers: str, precision_config: str, preferred_element_type: TV_XlaDotV2_preferred_element_type, name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_XlaDotV2_preferred_element_type]:
    ...
    _attrs = ('LhsT', _attr_LhsT, 'RhsT', _attr_RhsT, 'dimension_numbers', dimension_numbers, 'precision_config', precision_config, 'preferred_element_type', preferred_element_type)
    _result = _execute.execute(b'XlaDotV2', 1, inputs=_inputs_flat, attrs=_attrs, ctx=ctx, name=name)
