...
def get_standard_gate_name_mapping():
    ...
    gates = [IGate(), SXGate(), XGate(), CXGate(), RZGate(Parameter('λ')), RGate(Parameter('ϴ'), Parameter('φ')), Reset(), C3SXGate(), CCXGate(), DCXGate(), CHGate(), CPhaseGate(Parameter('ϴ')), CRXGate(Parameter('ϴ')), CRYGate(Parameter('ϴ')), CRZGate(Parameter('ϴ')), CSwapGate(), CSXGate(), CUGate(Parameter('ϴ'), Parameter('φ'), Parameter('λ'), Parameter('γ')), CU1Gate(Parameter('λ')), CU3Gate(Parameter('ϴ'), Parameter('φ'), Parameter('λ')), CYGate(), CZGate(), CCZGate(), GlobalPhaseGate(Parameter('ϴ')), HGate(), PhaseGate(Parameter('ϴ')), RCCXGate(), RC3XGate(), RXGate(Parameter('ϴ')), RXXGate(Parameter('ϴ')), RYGate(Parameter('ϴ')), RYYGate(Parameter('ϴ')), RZZGate(Parameter('ϴ')), RZXGate(Parameter('ϴ')), XXMinusYYGate(Parameter('ϴ'), Parameter('β')), XXPlusYYGate(Parameter('ϴ'), Parameter('β')), ECRGate(), SGate(), SdgGate(), CSGate(), CSdgGate(), SwapGate(), iSwapGate(), SXdgGate(), TGate(), TdgGate(), UGate(Parameter('ϴ'), Parameter('φ'), Parameter('λ')), U1Gate(Parameter('λ')), U2Gate(Parameter('φ'), Parameter('λ')), U3Gate(Parameter('ϴ'), Parameter('φ'), Parameter('λ')), YGate(), ZGate(), Delay(Parameter('t')), Measure()]
