...
class HashiVaultAuthMethodAwsIam(HashiVaultAuthMethodBase):
    ...
    NAME = 'aws_iam'
    OPTIONS = ['aws_profile', 'aws_access_key', 'aws_secret_key', 'aws_security_token', 'region', 'aws_iam_server_id', 'role_id']
    ...
    def validate(self):
        params = {'access_key': self._options.get_option_default('aws_access_key'), 'secret_key': self._options.get_option_default('aws_secret_key')}
