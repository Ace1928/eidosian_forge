...
class NetworkPlacementsListResponse(_messages.Message):
  ...
  Fields:
    ...
    kind: [Output Only] Type of resource. Always compute#networkPlacementList
  ...
  """
    ...
    items = _messages.MessageField('NetworkPlacement', 3, repeated=True)
    kind = _messages.StringField(4, default='compute#networkPlacementList')
