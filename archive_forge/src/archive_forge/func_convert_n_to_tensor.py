...
def convert_n_to_tensor(values, dtype=None, name=None, preferred_dtype=None) -> List[Union[tensor_lib.Tensor, internal.IndexedSlices]]:
  ...
  Raises:
    ...
    RuntimeError: If a registered conversion function returns an invalid
      value.
  """
    return internal_convert_n_to_tensor(values=values, dtype=dtype, name=name, preferred_dtype=preferred_dtype, as_ref=False)