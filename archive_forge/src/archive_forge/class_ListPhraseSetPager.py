...
class ListPhraseSetPager:
    ...
    def __init__(self, method: Callable[..., cloud_speech_adaptation.ListPhraseSetResponse], request: cloud_speech_adaptation.ListPhraseSetRequest, response: cloud_speech_adaptation.ListPhraseSetResponse, *, metadata: Sequence[Tuple[str, str]]=()):
