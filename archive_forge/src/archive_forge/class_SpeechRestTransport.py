...
class SpeechRestTransport(SpeechTransport):
    ...
    def operations_client(self) -> operations_v1.AbstractOperationsClient:
        ...
        if self._operations_client is None:
            http_options: Dict[str, List[Dict[str, str]]] = {'google.longrunning.Operations.GetOperation': [{'method': 'get', 'uri': '/v1p1beta1/operations/{name=**}'}], 'google.longrunning.Operations.ListOperations': [{'method': 'get', 'uri': '/v1p1beta1/operations'}]}
            rest_transport = operations_v1.OperationsRestTransport(host=self._host, credentials=self._credentials, scopes=self._scopes, http_options=http_options, path_prefix='v1p1beta1')
    ...
    class _LongRunningRecognize(SpeechRestStub):
        ...
        def __call__(self, request: cloud_speech.LongRunningRecognizeRequest, *, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Optional[float]=None, metadata: Sequence[Tuple[str, str]]=()) -> operations_pb2.Operation:
            """Call the long running recognize method over HTTP.
            ...
            """
            http_options: List[Dict[str, str]] = [{'method': 'post', 'uri': '/v1p1beta1/speech:longrunningrecognize', 'body': '*'}]
    ...
    class _Recognize(SpeechRestStub):
        ...
        def __call__(self, request: cloud_speech.RecognizeRequest, *, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Optional[float]=None, metadata: Sequence[Tuple[str, str]]=()) -> cloud_speech.RecognizeResponse:
            """Call the recognize method over HTTP.
            ...
            """
            http_options: List[Dict[str, str]] = [{'method': 'post', 'uri': '/v1p1beta1/speech:recognize', 'body': '*'}]
    ...
    class _StreamingRecognize(SpeechRestStub):
        ...
        def __call__(self, request: cloud_speech.StreamingRecognizeRequest, *, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Optional[float]=None, metadata: Sequence[Tuple[str, str]]=()) -> rest_streaming.ResponseIterator:
    ...
    def recognize(self) -> Callable[[cloud_speech.RecognizeRequest], cloud_speech.RecognizeResponse]:
        return self._Recognize(self._session, self._host, self._interceptor)

    @property
    def streaming_recognize(self) -> Callable[[cloud_speech.StreamingRecognizeRequest], cloud_speech.StreamingRecognizeResponse]:
        return self._StreamingRecognize(self._session, self._host, self._interceptor)
