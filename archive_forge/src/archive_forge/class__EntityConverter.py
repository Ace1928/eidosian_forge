...
class _EntityConverter(object):
    ...
    """
        ...
        if v3_property_value.has_booleanvalue():
            ...
            if v3_meaning == entity_pb.Property.GD_WHEN:
                v4_value.set_timestamp_microseconds_value(v3_property_value.int64value())
                v3_meaning = None
            else:
            ...
            if v3_meaning == MEANING_GEORSS_POINT:
                ...
                self.__v3_to_v4_point_entity(v3_property_value.pointvalue(), v4_value.mutable_entity_value())
                v4_value.set_meaning(MEANING_PREDEFINED_ENTITY_POINT)
            v3_meaning = None
        elif v3_property_value.has_uservalue():
            self.v3_user_value_to_v4_entity(v3_property_value.uservalue(), v4_value.mutable_entity_value())
    ...
    """
        check_conversion(v1_value.HasField('string_value'), 'Value does not contain a string value.')
    ...
    def __is_v3_property_value_union_valid(self, v3_property_value):
        ...
        num_sub_values = v3_property_value.has_booleanvalue() + v3_property_value.has_int64value() + v3_property_value.has_doublevalue() + v3_property_value.has_referencevalue() + v3_property_value.has_stringvalue() + v3_property_value.has_pointvalue() + v3_property_value.has_uservalue()
