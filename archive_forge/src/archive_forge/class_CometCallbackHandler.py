...
class CometCallbackHandler(BaseMetadataCallbackHandler, BaseCallbackHandler):
    ...
    def __init__(self, task_type: Optional[str]='inference', workspace: Optional[str]=None, project_name: Optional[str]=None, tags: Optional[Sequence]=None, name: Optional[str]=None, visualizations: Optional[List[str]]=None, complexity_metrics: bool=False, custom_metrics: Optional[Callable]=None, stream_logs: bool=True) -> None:
        ...
        warning = 'The comet_ml callback is currently in beta and is subject to change based on updates to `langchain`. Please report any issues to https://github.com/comet-ml/issue-tracking/issues with the tag `langchain`.'
    ...
    def on_chain_start(self, serialized: Dict[str, Any], inputs: Dict[str, Any], **kwargs: Any) -> None:
        ...
        for chain_input_key, chain_input_val in inputs.items():
            if isinstance(chain_input_val, str):
                ...
                self.comet_ml.LOGGER.warning(f'Unexpected data format provided! Input Value for {chain_input_key} will not be logged')
    ...
    def on_chain_end(self, outputs: Dict[str, Any], **kwargs: Any) -> None:
        ...
        for chain_output_key, chain_output_val in outputs.items():
            if isinstance(chain_output_val, str):
                ...
                self.comet_ml.LOGGER.warning(f'Unexpected data format provided! Output Value for {chain_output_key} will not be logged')
    ...
    def flush_tracker(self, langchain_asset: Any=None, task_type: Optional[str]='inference', workspace: Optional[str]=None, project_name: Optional[str]='comet-langchain-demo', tags: Optional[Sequence]=None, name: Optional[str]=None, visualizations: Optional[List[str]]=None, complexity_metrics: bool=False, custom_metrics: Optional[Callable]=None, finish: bool=False, reset: bool=False) -> None:
        ...
        if langchain_asset:
            try:
                ...
                self.comet_ml.LOGGER.error('Failed to export agent or LLM to Comet', exc_info=True, extra={'show_traceback': True})
        if finish:
            self.experiment.end()
        if reset:
            self._reset(task_type, workspace, project_name, tags, name, visualizations, complexity_metrics, custom_metrics)
    ...
    def _reset(self, task_type: Optional[str]=None, workspace: Optional[str]=None, project_name: Optional[str]=None, tags: Optional[Sequence]=None, name: Optional[str]=None, visualizations: Optional[List[str]]=None, complexity_metrics: bool=False, custom_metrics: Optional[Callable]=None) -> None:
        ...
        self.__init__(task_type=_task_type, workspace=_workspace, project_name=_project_name, tags=_tags, name=_name, visualizations=_visualizations, complexity_metrics=_complexity_metrics, custom_metrics=_custom_metrics)
