...
def quantized_mat_mul_with_bias_and_relu_eager_fallback(a: _atypes.TensorFuzzingAnnotation[TV_QuantizedMatMulWithBiasAndRelu_T1], b: _atypes.TensorFuzzingAnnotation[TV_QuantizedMatMulWithBiasAndRelu_T2], bias: _atypes.TensorFuzzingAnnotation[_atypes.Float32], min_a: _atypes.TensorFuzzingAnnotation[_atypes.Float32], max_a: _atypes.TensorFuzzingAnnotation[_atypes.Float32], min_b: _atypes.TensorFuzzingAnnotation[_atypes.Float32], max_b: _atypes.TensorFuzzingAnnotation[_atypes.Float32], Toutput: TV_QuantizedMatMulWithBiasAndRelu_Toutput, transpose_a: bool, transpose_b: bool, input_quant_mode: str, name, ctx):
    ...
    _attrs = ('T1', _attr_T1, 'T2', _attr_T2, 'Toutput', Toutput, 'transpose_a', transpose_a, 'transpose_b', transpose_b, 'input_quant_mode', input_quant_mode)
    _result = _execute.execute(b'QuantizedMatMulWithBiasAndRelu', 3, inputs=_inputs_flat, attrs=_attrs, ctx=ctx, name=name)
