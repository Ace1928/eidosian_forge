...
class Nebula(LLM):
    ...
    def validate_environment(cls, values: Dict) -> Dict:
        ...
        nebula_service_url = get_from_dict_or_env(values, 'nebula_service_url', 'NEBULA_SERVICE_URL', DEFAULT_NEBULA_SERVICE_URL)
        nebula_service_path = get_from_dict_or_env(values, 'nebula_service_path', 'NEBULA_SERVICE_PATH', DEFAULT_NEBULA_SERVICE_PATH)
    ...
    def _default_params(self) -> Dict[str, Any]:
        ...
        return {'max_new_tokens': self.max_new_tokens, 'temperature': self.temperature, 'top_k': self.top_k, 'top_p': self.top_p, 'repetition_penalty': self.repetition_penalty}

    @property
    def _identifying_params(self) -> Mapping[str, Any]:
        """Get the identifying parameters."""
        _model_kwargs = self.model_kwargs or {}
        return {'nebula_service_url': self.nebula_service_url, 'nebula_service_path': self.nebula_service_path, **{'model_kwargs': _model_kwargs}}
    ...
    def _call(self, prompt: str, stop: Optional[List[str]]=None, run_manager: Optional[CallbackManagerForLLMRun]=None, **kwargs: Any) -> str:
        ...
        prompt = prompt.strip()
        response = completion_with_retry(self, prompt=prompt, params=params, url=f'{self.nebula_service_url}{self.nebula_service_path}')
