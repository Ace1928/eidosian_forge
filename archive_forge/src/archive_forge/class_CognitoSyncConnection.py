...
class CognitoSyncConnection(AWSAuthConnection):
    ...
    _faults = {'LimitExceededException': exceptions.LimitExceededException, 'ResourceConflictException': exceptions.ResourceConflictException, 'InvalidConfigurationException': exceptions.InvalidConfigurationException, 'TooManyRequestsException': exceptions.TooManyRequestsException, 'InvalidParameterException': exceptions.InvalidParameterException, 'ResourceNotFoundException': exceptions.ResourceNotFoundException, 'InternalErrorException': exceptions.InternalErrorException, 'NotAuthorizedException': exceptions.NotAuthorizedException}
