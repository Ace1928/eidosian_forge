...
class PubliccaV1alpha1(base_api.BaseApiClient):
    ...
    class ProjectsLocationsExternalAccountKeysService(base_api.BaseApiService):
      ...
      """
        ...
        Create.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1alpha1/projects/{projectsId}/locations/{locationsId}/externalAccountKeys', http_method='POST', method_id='publicca.projects.locations.externalAccountKeys.create', ordered_params=['parent'], path_params=['parent'], query_params=[], relative_path='v1alpha1/{+parent}/externalAccountKeys', request_field='externalAccountKey', request_type_name='PubliccaProjectsLocationsExternalAccountKeysCreateRequest', response_type_name='ExternalAccountKey', supports_download=False)
