...
class BaseRequest(MutableMapping[str, Any], HeadersMixin):
    ...
    ATTRS = HeadersMixin.ATTRS | frozenset(['_message', '_protocol', '_payload_writer', '_payload', '_headers', '_method', '_version', '_rel_url', '_post', '_read_bytes', '_state', '_cache', '_task', '_client_max_size', '_loop', '_transport_sslcontext', '_transport_peername'])
    ...
    async def post(self) -> 'MultiDictProxy[Union[str, bytes, FileField]]':
        ...
        if content_type == 'multipart/form-data':
            ...
            if data:
                ...
                out.extend(parse_qsl(data.rstrip().decode(charset), keep_blank_values=True, encoding=charset))
