...
class ValidationToolbar(ConditionalContainer):
    ...
    def __init__(self, show_position=False):
        super(ValidationToolbar, self).__init__(content=Window(ValidationToolbarControl(show_position=show_position), height=LayoutDimension.exact(1)), filter=HasValidationError() & ~IsDone())