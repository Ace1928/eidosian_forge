...
class TempFS(OSFS):
    ...
    def __init__(self, identifier='__tempfs__', temp_dir=None, auto_clean=True, ignore_clean_errors=True):
    ...
    def clean(self):
        ...
        try:
            ...
            if not self._ignore_clean_errors:
                raise errors.OperationFailed(msg='failed to remove temporary directory; {}'.format(error), exc=error)
        self._cleaned = True