...
class ImportErrorsTests(packages.SysPathManglingTest):
    ...
    def assertIn(self, container: str, containee: str, *args: object, **kwargs: object) -> str:
        super().assertIn(containee, container, *args, **kwargs)
        return container

    def assertNotIn(self, container: str, containee: str, *args: object, **kwargs: object) -> str:
