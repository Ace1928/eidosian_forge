...
class QdrantTranslator(Visitor):
    ...
    allowed_comparators = (Comparator.EQ, Comparator.LT, Comparator.LTE, Comparator.GT, Comparator.GTE, Comparator.LIKE)
    ...
    def visit_operation(self, operation: Operation) -> rest.Filter:
        ...
        operator = {Operator.AND: 'must', Operator.OR: 'should', Operator.NOT: 'must_not'}[operation.operator]
