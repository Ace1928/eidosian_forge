...
class PathBasedConnection(base.Connection, metaclass=abc.ABCMeta):
    ...
    def save_logbook(self, book):
        ...
        with self._transaction() as transaction:
            ...
            for flow_details in book:
                ...
                self._do_update_flow_details(flow_details, transaction, ignore_missing=True)
    ...
    def update_flow_details(self, flow_detail, ignore_missing=False):
        with self._transaction() as transaction:
            return self._do_update_flow_details(flow_detail, transaction, ignore_missing=ignore_missing)
    ...
    def update_atom_details(self, atom_detail, ignore_missing=False):
        with self._transaction() as transaction:
            return self._update_object(atom_detail, transaction, ignore_missing=ignore_missing)
