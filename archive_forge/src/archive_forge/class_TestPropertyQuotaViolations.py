...
class TestPropertyQuotaViolations(base.ApiTest):
    ...
    def _headers(self, custom_headers=None):
        base_headers = {'X-Identity-Status': 'Confirmed', 'X-Auth-Token': '932c5c84-02ac-4fe5-a9ba-620af0e2bb96', 'X-User-Id': 'f9a41d13-0c13-47e9-bee2-ce4e8bfe958e', 'X-Tenant-Id': 'foo', 'X-Roles': 'member'}
    ...
    def _create_image(self, body):
        ...
        rsp, content = self.http.request(path, 'POST', headers=headers, body=jsonutils.dumps(body))
