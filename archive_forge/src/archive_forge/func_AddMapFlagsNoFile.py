...
def AddMapFlagsNoFile(parser, flag_name, group_help='', long_name=None, key_type=None, value_type=None, key_metavar='KEY', value_metavar='VALUE'):
  ...
  """
    return MapFlagsNoFile(flag_name, group_help, long_name, key_type, value_type, key_metavar=key_metavar, value_metavar=value_metavar).AddToParser(parser)