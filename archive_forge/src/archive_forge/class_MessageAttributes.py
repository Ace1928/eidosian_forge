...
class MessageAttributes(object):
    ...
    def __init__(self, conversation=None, image=None, contact=None, location=None, extended_text=None, document=None, audio=None, video=None, sticker=None, sender_key_distribution_message=None, protocol=None):
