...
def convert_string_to_type(val: Optional[Union[str, int, float, bool]], convert_type: Union[int, float, bool]) -> Union[int, float, bool]:
    ...
    if val is None:
        ...
        try:
            ...
            raise ValueError(f'Failed to convert a value {val} of type {type(val)} to {convert_type}')
