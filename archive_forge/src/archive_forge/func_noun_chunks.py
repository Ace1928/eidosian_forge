...
def noun_chunks(doclike: Union[Doc, Span]) -> Iterator[Tuple[int, int, int]]:
    ...
    """
    labels = ['nsubj', 'nsubj:pass', 'obj', 'obl', 'obl:agent', 'obl:arg', 'obl:mod', 'nmod', 'pcomp', 'appos', 'ROOT']
    ...
    for i, word in enumerate(doclike):
        ...
        if word.dep in np_deps:
            ...
            if right_child:
                ...
                elif right_child.dep == det_label and right_child.pos == det_pos:
                    right_end = right_child
                elif right_child.dep in np_modifs:
