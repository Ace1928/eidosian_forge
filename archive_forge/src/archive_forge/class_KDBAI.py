...
class KDBAI(VectorStore):
    ...
    def __init__(self, table: Any, embedding: Embeddings, distance_strategy: Optional[DistanceStrategy]=DistanceStrategy.EUCLIDEAN_DISTANCE):
        try:
            import kdbai_client
        except ImportError:
            raise ImportError('Could not import kdbai_client python package. Please install it with `pip install kdbai_client`.')
        self._table = table
    ...
    def similarity_search_with_score(self, query: str, k: int=1, filter: Optional[List]=[], **kwargs: Any) -> List[Tuple[Document, float]]:
    ...
    def similarity_search_by_vector_with_score(self, embedding: List[float], *, k: int=1, filter: Optional[List]=[], **kwargs: Any) -> List[Tuple[Document, float]]:
    ...
    def similarity_search(self, query: str, k: int=1, filter: Optional[List]=[], **kwargs: Any) -> List[Document]:
    ...
    @classmethod
    def from_texts(cls: Any, texts: List[str], embedding: Embeddings, metadatas: Optional[List[dict]]=None, **kwargs: Any) -> Any:
        """Not implemented."""
