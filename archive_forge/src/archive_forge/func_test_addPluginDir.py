...
def test_addPluginDir(self):
    """
        ...
        """
    util.addPluginDir()
    currentWarnings = self.flushWarnings(offendingFunctions=[self.test_addPluginDir])
    self.assertEqual(currentWarnings[0]['message'], 'twisted.python.util.addPluginDir is deprecated since Twisted 12.2.')
