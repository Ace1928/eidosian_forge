...
class CliffWalkingEnv(Env):
    ...
    def __init__(self, render_mode: Optional[str]=None):
        ...
        self.window_size = (self.shape[1] * self.cell_size[1], self.shape[0] * self.cell_size[0])
    ...
    def _render_gui(self, mode):
        ...
        if self.elf_images is None:
            hikers = [path.join(path.dirname(__file__), 'img/elf_up.png'), path.join(path.dirname(__file__), 'img/elf_right.png'), path.join(path.dirname(__file__), 'img/elf_down.png'), path.join(path.dirname(__file__), 'img/elf_left.png')]
        ...
        if self.mountain_bg_img is None:
            bg_imgs = [path.join(path.dirname(__file__), 'img/mountain_bg1.png'), path.join(path.dirname(__file__), 'img/mountain_bg2.png')]
            self.mountain_bg_img = [pygame.transform.scale(pygame.image.load(f_name), self.cell_size) for f_name in bg_imgs]
        if self.near_cliff_img is None:
            near_cliff_imgs = [path.join(path.dirname(__file__), 'img/mountain_near-cliff1.png'), path.join(path.dirname(__file__), 'img/mountain_near-cliff2.png')]
            self.near_cliff_img = [pygame.transform.scale(pygame.image.load(f_name), self.cell_size) for f_name in near_cliff_imgs]
