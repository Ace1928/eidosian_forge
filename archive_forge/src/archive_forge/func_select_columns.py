...
def select_columns(self, cols: List[str], *, compute: Union[str, ComputeStrategy]=None, concurrency: Optional[Union[int, Tuple[int, int]]]=None, **ray_remote_args) -> 'Dataset':
    ...
    return self.map_batches(fn, batch_format='pandas', zero_copy_batch=True, compute=compute, **ray_remote_args)