...
def Sin(duration: int | ParameterExpression, amp: float | ParameterExpression, phase: float | ParameterExpression, freq: float | ParameterExpression | None=None, angle: float | ParameterExpression | None=0.0, name: str | None=None, limit_amplitude: bool | None=None) -> ScalableSymbolicPulse:
    """A sinusoidal pulse.
