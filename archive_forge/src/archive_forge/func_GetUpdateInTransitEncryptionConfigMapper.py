...
def GetUpdateInTransitEncryptionConfigMapper(messages, hidden=False):
  ...
  """
    ...
    return arg_utils.ChoiceEnumMapper('--in-transit-encryption', messages.ClusterUpdate.DesiredInTransitEncryptionConfigValueValuesEnum, _GetInTransitEncryptionConfigCustomMappings(), hidden=hidden, help_str=help_text)