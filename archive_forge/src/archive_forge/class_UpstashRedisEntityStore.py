...
class UpstashRedisEntityStore(BaseEntityStore):
    ...
    def __init__(self, session_id: str='default', url: str='', token: str='', key_prefix: str='memory_store', ttl: Optional[int]=60 * 60 * 24, recall_ttl: Optional[int]=60 * 60 * 24 * 3, *args: Any, **kwargs: Any):
        try:
            from upstash_redis import Redis
        except ImportError:
            raise ImportError('Could not import upstash_redis python package. Please install it with `pip install upstash_redis`.')
