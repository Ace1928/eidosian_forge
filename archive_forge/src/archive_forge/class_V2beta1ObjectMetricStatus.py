...
class V2beta1ObjectMetricStatus(object):
    ...
    swagger_types = {'average_value': 'str', 'current_value': 'str', 'metric_name': 'str', 'selector': 'V1LabelSelector', 'target': 'V2beta1CrossVersionObjectReference'}
    attribute_map = {'average_value': 'averageValue', 'current_value': 'currentValue', 'metric_name': 'metricName', 'selector': 'selector', 'target': 'target'}
