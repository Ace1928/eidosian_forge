...
class DownloadButton(Component):
    ...
    def __init__(self, label: str='Download', value: str | Path | Callable | None=None, *, every: float | None=None, variant: Literal['primary', 'secondary', 'stop']='secondary', visible: bool=True, size: Literal['sm', 'lg'] | None=None, icon: str | None=None, scale: int | None=None, min_width: int | None=None, interactive: bool=True, elem_id: str | None=None, elem_classes: list[str] | str | None=None, render: bool=True):
        """
        Parameters:
