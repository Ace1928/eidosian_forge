...
class Milestone(CompletableGithubObject):
    ...
    def edit(self, title: str, state: Opt[str]=NotSet, description: Opt[str]=NotSet, due_on: Opt[date]=NotSet) -> None:
        """
        ...
        post_parameters = NotSet.remove_unset_items({'title': title, 'state': state, 'description': description})
