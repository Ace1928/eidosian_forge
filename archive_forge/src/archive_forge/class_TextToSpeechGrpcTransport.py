...
class TextToSpeechGrpcTransport(TextToSpeechTransport):
    ...
    def __init__(self, *, host: str='texttospeech.googleapis.com', credentials: Optional[ga_credentials.Credentials]=None, credentials_file: Optional[str]=None, scopes: Optional[Sequence[str]]=None, channel: Optional[grpc.Channel]=None, api_mtls_endpoint: Optional[str]=None, client_cert_source: Optional[Callable[[], Tuple[bytes, bytes]]]=None, ssl_channel_credentials: Optional[grpc.ChannelCredentials]=None, client_cert_source_for_mtls: Optional[Callable[[], Tuple[bytes, bytes]]]=None, quota_project_id: Optional[str]=None, client_info: gapic_v1.client_info.ClientInfo=DEFAULT_CLIENT_INFO, always_use_jwt_access: Optional[bool]=False, api_audience: Optional[str]=None) -> None:
    ...
    @classmethod
    def create_channel(cls, host: str='texttospeech.googleapis.com', credentials: Optional[ga_credentials.Credentials]=None, credentials_file: Optional[str]=None, scopes: Optional[Sequence[str]]=None, quota_project_id: Optional[str]=None, **kwargs) -> grpc.Channel:
    ...
    def list_voices(self) -> Callable[[cloud_tts.ListVoicesRequest], cloud_tts.ListVoicesResponse]:
        """Return a callable for the list voices method over gRPC.
        ...
        if 'list_voices' not in self._stubs:
            self._stubs['list_voices'] = self.grpc_channel.unary_unary('/google.cloud.texttospeech.v1.TextToSpeech/ListVoices', request_serializer=cloud_tts.ListVoicesRequest.serialize, response_deserializer=cloud_tts.ListVoicesResponse.deserialize)
    ...
    def synthesize_speech(self) -> Callable[[cloud_tts.SynthesizeSpeechRequest], cloud_tts.SynthesizeSpeechResponse]:
        """Return a callable for the synthesize speech method over gRPC.
        ...
        if 'synthesize_speech' not in self._stubs:
            self._stubs['synthesize_speech'] = self.grpc_channel.unary_unary('/google.cloud.texttospeech.v1.TextToSpeech/SynthesizeSpeech', request_serializer=cloud_tts.SynthesizeSpeechRequest.serialize, response_deserializer=cloud_tts.SynthesizeSpeechResponse.deserialize)
