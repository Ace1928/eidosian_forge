...
def _get_proxy_artifact_validator(method: str, view_args: Optional[Dict[str, Any]]) -> Optional[Callable[[], bool]]:
    ...
    return {'GET': validate_can_read_experiment_artifact_proxy, 'PUT': validate_can_update_experiment_artifact_proxy, 'DELETE': validate_can_delete_experiment_artifact_proxy}.get(method)