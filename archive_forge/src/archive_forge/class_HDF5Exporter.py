...
class HDF5Exporter(Exporter):
    ...
    def __init__(self, item):
        ...
        self.params = Parameter.create(name='params', type='group', children=[{'name': 'Name', 'title': translate('Exporter', 'Name'), 'type': 'str', 'value': 'Export'}, {'name': 'columnMode', 'title': translate('Exporter', 'columnMode'), 'type': 'list', 'limits': ['(x,y) per plot', '(x,y,y,y) for all plots'], 'value': '(x,y) per plot'}])
