...
@mock.patch.object(shim_util, 'ENCRYPTION_SUPPORTED_COMMANDS', new={'fake_shim'})
def test_decryption_key_gets_converted_to_flag(self):
    with _mock_boto_config({'GSUtil': collections.OrderedDict([('decryption_key1', 'key1'), ('decryption_key12', 'key12'), ('decryption_key100', 'key100')])}):
