...
def with_signpost_interval(layer: _ModelT, signposter: 'os_signpost.Signposter', name: Optional[str]=None) -> _ModelT:
    ...
    if not has_os_signpost:
        raise ValueError("with_signpost_interval layer requires the 'os_signpost' package")
