...
def test_fip_port_forward_delete(self):
    ...
    self.patchobject(self.sdkclient.network, 'create_floating_ip_port_forwarding', return_value=pfid)
    mock_delete = self.patchobject(self.sdkclient.network, 'delete_floating_ip_port_forwarding', return_value=None)
    ...
    mock_delete.assert_called_once_with(fip_id, '180941c5-9e82-41c7-b64d-6a57302ec211', ignore_missing=True)