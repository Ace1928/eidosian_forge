...
def test_arrays_heap(gdb_arrow):
    ...
    check_heap_repr(gdb_arrow, 'heap_timestamp_array_ns', 'arrow::TimestampArray of type arrow::timestamp(arrow::TimeUnit::NANO), length 2, offset 0, null count 1 = {[0] = null, [1] = -2203932303012345679ns [1900-02-28 12:34:56.989284321]}')
