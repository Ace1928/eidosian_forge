...
class SpanishLemmatizer(Lemmatizer):
    ...
    def rule_lemmatize(self, token: Token) -> List[str]:
        ...
        if pos in ('', 'eol', 'space'):
            return [string.lower()]
        if pos in ('adp', 'cconj', 'intj', 'part', 'propn', 'punct', 'sconj', 'sym', 'x'):
        ...
        if exc is not None:
            ...
            lemmas = getattr(self, 'lemmatize_' + rule_pos)(string, features, rule, index)
    ...
    def lemmatize_noun(self, word: str, features: List[str], rule: str, index: List[str]) -> List[str]:
        """
        Lemmatize a noun.
    ...
    def lemmatize_pron(self, word: str, features: List[str], rule: Optional[str], index: List[str]) -> List[str]:
        """
        Lemmatize a pronoun.
