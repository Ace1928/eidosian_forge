...
class ReadTheDocsLoader(BaseLoader):
    ...
    def __init__(self, path: Union[str, Path], encoding: Optional[str]=None, errors: Optional[str]=None, custom_html_tag: Optional[Tuple[str, dict]]=None, patterns: Sequence[str]=('*.htm', '*.html'), exclude_links_ratio: float=1.0, **kwargs: Optional[Any]):
        """
        ...
        try:
            _ = BeautifulSoup('<html><body>Parser builder library test.</body></html>', 'html.parser', **kwargs)
