...
class ListQuantumReservationGrantsAsyncPager:
    ...
    def __init__(self, method: Callable[..., Awaitable[engine.ListQuantumReservationGrantsResponse]], request: engine.ListQuantumReservationGrantsRequest, response: engine.ListQuantumReservationGrantsResponse, *, metadata: Sequence[Tuple[str, str]]=()):
