...
def _before_relational_expr(visitor, node):
    raise MouseTrap("The RelationalExpression '%s' was used as a Boolean term in a logical proposition. This is not yet supported when transforming to disjunctive form." % node)