...
class MetaDataset(Dataset):
    ...
    def __init__(self, source: DatasetSource, name: Optional[str]=None, digest: Optional[str]=None, schema: Optional[Schema]=None):
        self._schema = schema
    ...
    def _compute_digest(self) -> str:
        ...
        dict.
        """
        config = {'name': self.name, 'source': self.source.to_json(), 'source_type': self.source._get_source_type(), 'schema': self.schema.to_dict() if self.schema else ''}
