...
def wireless_controller_hotspot20_h2qp_osu_provider_nai(data, fos):
    ...
    if state == 'present' or state is True:
        return fos.set('wireless-controller.hotspot20', 'h2qp-osu-provider-nai', data=filtered_data, vdom=vdom)
    elif state == 'absent':
        return fos.delete('wireless-controller.hotspot20', 'h2qp-osu-provider-nai', mkey=filtered_data['name'], vdom=vdom)
    else:
