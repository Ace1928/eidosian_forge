...
class EndpointFilterManager(base.Manager):
    ...
    def list_endpoints_for_project(self, project):
        ...
        return super(EndpointFilterManager, self)._list(base_url, endpoints.EndpointManager.collection_key, obj_class=endpoints.EndpointManager.resource_class)
    ...
    def list_endpoint_groups_for_project(self, project):
        ...
        return super(EndpointFilterManager, self)._list(base_url, 'endpoint_groups', obj_class=endpoint_groups.EndpointGroupManager.resource_class)
