...
def _delete_model_version():
    request_message = _get_request_message(DeleteModelVersion(), schema={'name': [_assert_string, _assert_required], 'version': [_assert_string, _assert_required]})
    _get_model_registry_store().delete_model_version(name=request_message.name, version=request_message.version)
