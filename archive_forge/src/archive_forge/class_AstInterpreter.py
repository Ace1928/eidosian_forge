...
class AstInterpreter(InterpreterBase):
    ...
    def evaluate_plusassign(self, node: PlusAssignmentNode) -> None:
        ...
        self.assignments[node.var_name.value] = node.value
    ...
    def reduce_arguments(self, args: mparser.ArgumentNode, key_resolver: T.Callable[[mparser.BaseNode], str]=default_resolve_key, duplicate_key_error: T.Optional[str]=None) -> T.Tuple[T.List[TYPE_var], TYPE_nkwargs]:
