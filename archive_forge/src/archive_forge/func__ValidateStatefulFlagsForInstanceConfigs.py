...
def _ValidateStatefulFlagsForInstanceConfigs(self, args, per_instance_config):
    instance_groups_flags.ValidateMigStatefulFlagsForInstanceConfigs(args, for_update=True)
    instance_groups_flags.ValidateMigStatefulIPFlagsForInstanceConfigs(args, UpdateGA._GetInterfacesWithInternalAddresses(per_instance_config), UpdateGA._GetInterfacesWithExternalAddresses(per_instance_config), for_update=True)