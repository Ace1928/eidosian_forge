...
class Berny(Optimizer):
    ...
    def __init__(self, atoms, restart=None, logfile='-', trajectory=None, master=None, dihedral=True):
        """Berny optimizer.
        ...
        self._berny = _Berny(geom, debug=True, restart=self._restart_data, maxsteps=10000000000, gradientmax=0.0, gradientrms=0.0, stepmax=0.0, steprms=0.0, dihedral=dihedral)
        next(self._berny)
