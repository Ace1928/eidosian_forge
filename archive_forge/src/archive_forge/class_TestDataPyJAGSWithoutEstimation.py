...
class TestDataPyJAGSWithoutEstimation:
    ...
    def test_convert_pyjags_samples_dictionary_to_arviz_samples_dictionary(self):
        ...
        pyjags_dict_from_arviz_dict_from_pyjags_dict = _convert_arviz_dict_to_pyjags_dict(arviz_samples_dict_from_pyjags_samples_dict)
        assert verify_equality_of_numpy_values_dictionaries(PYJAGS_POSTERIOR_DICT, pyjags_dict_from_arviz_dict_from_pyjags_dict)
