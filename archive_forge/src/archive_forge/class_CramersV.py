...
class CramersV(Metric):
    ...
    def __init__(self, num_classes: int, bias_correction: bool=True, nan_strategy: Literal['replace', 'drop']='replace', nan_replace_value: Optional[float]=0.0, **kwargs: Any) -> None:
