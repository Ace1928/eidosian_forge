...
class TestBzrDirCreateBranch(TestRemote):
    ...
    def test_backwards_compat(self):
        ...
        create_branch_call_count = len([call for call in self.hpss_calls if call.call.method == b'BzrDir.create_branch'])
    ...
    def test_current_server(self):
        ...
        client.add_expected_call(b'BzrDir.create_branch', (b'quack/', network_name), b'success', (b'ok', network_name, b'', b'no', b'no', b'yes', reference_repo_name))
