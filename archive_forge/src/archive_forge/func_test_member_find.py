...
def test_member_find(self):
    self._verify('openstack.proxy.Proxy._find', self.proxy.find_member, method_args=['member_id'], method_kwargs={'image': 'image_id'}, expected_args=[_member.Member, 'member_id'], expected_kwargs={'ignore_missing': True, 'image_id': 'image_id'})