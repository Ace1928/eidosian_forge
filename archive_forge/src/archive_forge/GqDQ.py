...
fusion_products = np.array(fusion_products)
...
print("Masses:", masses)
print("Colors:", colors)
print("Fusion Products:", fusion_products)
print("Electromagnetic Charges:", em_charges)
print("Electromagnetic Radii:", em_radii)
print("Strong Couplings:", strong_couplings)
print("Strong Radii:", strong_radii)
