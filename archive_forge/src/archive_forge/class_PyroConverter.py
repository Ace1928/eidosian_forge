...
class PyroConverter:
    ...
    def __init__(self, *, posterior=None, prior=None, posterior_predictive=None, log_likelihood=None, predictions=None, constant_data=None, predictions_constant_data=None, coords=None, dims=None, pred_dims=None, num_chains=1):
        ...
        if self.model is not None:
            ...
            observations = {name: site['value'].cpu() for name, site in trace.nodes.items() if site['type'] == 'sample' and site['is_observed']}
    ...
    def log_likelihood_to_xarray(self):
        ...
        if self.observations is not None:
            try:
                ...
                warnings.warn('Could not get vectorized trace, log_likelihood group will be omitted. Check your model vectorization or set log_likelihood=False')
                return None
