...
class AiplatformProjectsLocationsExtensionsDeploymentsOperationsWaitRequest(_messages.Message):
    """A AiplatformProjectsLocationsExtensionsDeploymentsOperationsWaitRequest
  object.
