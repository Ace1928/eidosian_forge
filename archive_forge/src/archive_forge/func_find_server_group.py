...
def find_server_group(self, name_or_id, ignore_missing=True, *, all_projects=False):
    ...
    return self._find(_server_group.ServerGroup, name_or_id, ignore_missing=ignore_missing, **query)