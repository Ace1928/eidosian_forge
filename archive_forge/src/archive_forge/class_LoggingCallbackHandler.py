...
class LoggingCallbackHandler(FunctionCallbackHandler):
    ...
    def __init__(self, logger: logging.Logger, log_level: int=logging.INFO, extra: Optional[dict]=None, **kwargs: Any) -> None:
    ...
    def on_text(self, text: str, *, run_id: UUID, parent_run_id: Optional[UUID]=None, **kwargs: Any) -> None:
        try:
            ...
            crumbs_str = ''
        self.function_callback(f'{get_colored_text('[text]', color='blue')} {get_bolded_text(f'{crumbs_str}New text:')}\n{text}')