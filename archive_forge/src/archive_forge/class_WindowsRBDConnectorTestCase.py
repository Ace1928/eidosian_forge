...
@ddt.ddt
class WindowsRBDConnectorTestCase(test_base_rbd.RBDConnectorTestMixin, test_base.WindowsConnectorTestBase):
    ...
    def test_connect_volume(self, mock_get_dev_name, mock_wait_vol):
        ...
        exp_ret_val = {'path': self.dev_name, 'type': 'block'}
        ...
        self._diskutils.set_disk_offline.assert_called_once_with(mock_get_dev_num.return_value)
