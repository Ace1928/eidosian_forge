...
class OAuth2Session(requests.Session):
    ...
    def __init__(self, client_id=None, client=None, auto_refresh_url=None, auto_refresh_kwargs=None, scope=None, redirect_uri=None, token=None, state=None, token_updater=None, pkce=None, **kwargs):
        ...
        self.compliance_hook = {'access_token_response': set(), 'refresh_token_response': set(), 'protected_request': set(), 'refresh_token_request': set(), 'access_token_request': set()}
    ...
    def authorization_url(self, url, state=None, **kwargs):
        ...
        if self._pkce:
            ...
            kwargs['code_challenge'] = self._client.create_code_challenge(code_verifier=self._code_verifier, code_challenge_method=self._pkce)
        return (self._client.prepare_request_uri(url, redirect_uri=self.redirect_uri, scope=self.scope, state=state, **kwargs), state)

    def fetch_token(self, token_url, code=None, authorization_response=None, body='', auth=None, username=None, password=None, method='POST', force_querystring=False, timeout=None, headers=None, verify=None, proxies=None, include_client_id=None, client_secret=None, cert=None, **kwargs):
        ...
        headers = headers or {'Accept': 'application/json', 'Content-Type': 'application/x-www-form-urlencoded'}
        self.token = {}
        request_kwargs = {}
