...
class NetworksCellularGatewayConnectivityMonitoringDestinations(object):
    ...
    def update(self):
        ...
        name = self.new_object.get('name')
        result = None
        result = self.meraki.exec_meraki(family='cellulargateway', function='updateNetworkCellularGatewayConnectivityMonitoringDestinations', params=self.update_all_params(), op_modifies=True)
        return result