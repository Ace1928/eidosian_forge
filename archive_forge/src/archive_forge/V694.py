...
================================================================================
"""
all = ["ExampleClass", "example_function", "import_from_path"]
...
class ExampleClass:
    ...
    This class serves as an example of standard class structure and documentation
    practices within the EVIE project. It includes basic constructor, method, and
    property examples.
    Attributes:
    param (Any): An example attribute documented in the class docstring.
    """

    def init(self, param: Any):
        """
    ...
    def example_method(self) -> None:
        """
        An example method that performs an operation.
        This method is a placeholder for actual functionality and demonstrates
        the standard way to document a method's purpose and behavior.
        """
    ...
    def example_function(param1: int, param2: Optional[str] = None) -> bool:
        ...
        """
        if param1 < 0:
            logger.error("param1 cannot be less than zero")
            raise ValueError("param1 cannot be less than zero")

        if param2 is not None and not isinstance(param2, str):
            logger.error("param2 must be a string")
            raise TypeError("param2 must be a string")

        # Example logic (placeholder)
        logger.info(
            "Executing example_function with param1=%s and param2=%s", param1, param2
        )
        return True
