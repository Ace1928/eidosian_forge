...
class AsyncSparseTypedTTLCache(Generic[T]):
    ...
    # Compress the data to be stored in the cache. This method should compress the data using the most efficient compression algorithm available, ensuring minimal storage footprint and no loss of information.
    @staticmethod
    ...
    # Decompress the data stored in the cache. This method should decompress the data using the appropriate decompression algorithm, restoring the original data.
    # This is run after from file and before
    @staticmethod
    ...
    # Serialize the data to be stored in the cache. This method should serialize the data using a fast and efficient serialization algorithm, ensuring data integrity and compatibility.
    # This is run before before hash and after execution.
    @staticmethod
    ...
    # Deserialize the data stored in the cache. This method should deserialize the data using the appropriate deserialization algorithm, restoring the original data.
    # This is run after compression and before checking hash.
    @staticmethod
    ...
    # Validate the data against a Pydantic model. This method should validate the input data against the specified Pydantic model, ensuring data integrity and adherence to the expected schema.
    # This is run after checking hash and before execution.
    @staticmethod
    ...
    # Hash the data to generate a unique identifier for caching purposes. This method should hash the input data to generate a unique identifier for caching purposes.
    # This is run after serialisation and before compression.
    @staticmethod
    ...
    # Learn from the data and result to optimize caching strategies. This method should analyze the input data and corresponding result to identify patterns and optimize future caching strategies.
    @staticmethod
