...
class ProtocolManager(base.CrudManager):
    ...
    def build_url(self, dict_args_in_out=None):
        ...
        if dict_args_in_out is None:
            dict_args_in_out = {}
        identity_provider_id = dict_args_in_out.pop('identity_provider_id', None)
    ...
    def create(self, protocol_id, identity_provider, mapping, **kwargs):
        ...
        """
        return self._build_url_and_put(request_body={'mapping_id': base.getid(mapping)}, identity_provider_id=base.getid(identity_provider), protocol_id=protocol_id, **kwargs)
    ...
    def get(self, identity_provider, protocol, **kwargs):
        ...
        """
        return super(ProtocolManager, self).get(identity_provider_id=base.getid(identity_provider), protocol_id=base.getid(protocol), **kwargs)
    ...
    def list(self, identity_provider, **kwargs):
        ...
        """
        return super(ProtocolManager, self).list(identity_provider_id=base.getid(identity_provider), **kwargs)
    ...
    def update(self, identity_provider, protocol, mapping, **kwargs):
        ...
        """
        return super(ProtocolManager, self).update(identity_provider_id=base.getid(identity_provider), protocol_id=base.getid(protocol), mapping_id=base.getid(mapping), **kwargs)
    ...
    def delete(self, identity_provider, protocol):
        ...
        """
        return super(ProtocolManager, self).delete(identity_provider_id=base.getid(identity_provider), protocol_id=base.getid(protocol))