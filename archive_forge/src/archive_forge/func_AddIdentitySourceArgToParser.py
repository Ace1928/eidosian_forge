...
def AddIdentitySourceArgToParser(parser):
    ...
    presentation_spec = presentation_specs.ResourcePresentationSpec(name='identity_source', concept_spec=resource_spec, required=True, group_help='identity_source.')
