...
class DirectConnectConnection(AWSQueryConnection):
    ...
    _faults = {'DirectConnectClientException': exceptions.DirectConnectClientException, 'DirectConnectServerException': exceptions.DirectConnectServerException}
    ...
    def create_connection(self, location, bandwidth, connection_name):
        ...
        """
        params = {'location': location, 'bandwidth': bandwidth, 'connectionName': connection_name}
    ...
    def create_private_virtual_interface(self, connection_id, new_private_virtual_interface):
        ...
        """
        params = {'connectionId': connection_id, 'newPrivateVirtualInterface': new_private_virtual_interface}
        return self.make_request(action='CreatePrivateVirtualInterface', body=json.dumps(params))
