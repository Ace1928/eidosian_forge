...
class CloudfrontSignedUrlsTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.canned_policy = '{"Statement":[{"Resource":"http://d604721fxaaqy9.cloudfront.net/horizon.jpg?large=yes&license=yes","Condition":{"DateLessThan":{"AWS:EpochTime":1258237200}}}]}'
