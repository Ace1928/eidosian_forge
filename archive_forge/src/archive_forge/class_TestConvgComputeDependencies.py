...
class TestConvgComputeDependencies(common.HeatTestCase):
    ...
    def setUp(self):
        ...
        self.stack = tools.get_stack('test_stack_convg', self.ctx, template=tools.string_template_five, convergence=True)
    ...
    def test_dependencies_update_same_template(self):
        ...
        self.assertEqual([((1, False), (1, True)), ((1, True), (3, True)), ((2, False), (2, True)), ((2, True), (3, True)), ((3, False), (1, False)), ((3, False), (2, False)), ((3, False), (3, True)), ((3, True), (4, True)), ((3, True), (5, True)), ((4, False), (3, False)), ((4, False), (4, True)), ((5, False), (3, False)), ((5, False), (5, True))], sorted(self.stack._convg_deps._graph.edges()))
