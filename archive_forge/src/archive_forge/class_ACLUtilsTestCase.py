...
class ACLUtilsTestCase(test_base.OsWinBaseTestCase):
    _autospec_classes = [_acl_utils.win32utils.Win32Utils]
    ...
    def _setup_lib_mocks(self):
        ...
        mock.patch.multiple(_acl_utils, ctypes=self._ctypes, advapi32=mock.DEFAULT, kernel32=mock.DEFAULT, create=True).start()
