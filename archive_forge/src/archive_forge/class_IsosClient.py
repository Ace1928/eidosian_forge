...
class IsosClient(ClientEntityBase):
    ...
    def get_list(self, name: str | None=None, architecture: list[str] | None=None, include_wildcard_architecture: bool | None=None, include_architecture_wildcard: bool | None=None, page: int | None=None, per_page: int | None=None) -> IsosPageResult:
        """Get a list of ISOs
        ...
        if include_wildcard_architecture is not None:
            warn('The `include_wildcard_architecture` argument is deprecated, please use the `include_architecture_wildcard` argument instead.', DeprecationWarning)
    ...
    def get_all(self, name: str | None=None, architecture: list[str] | None=None, include_wildcard_architecture: bool | None=None, include_architecture_wildcard: bool | None=None) -> list[BoundIso]:
        """Get all ISOs
        ...
        if include_wildcard_architecture is not None:
            warn('The `include_wildcard_architecture` argument is deprecated, please use the `include_architecture_wildcard` argument instead.', DeprecationWarning)
            include_architecture_wildcard = include_wildcard_architecture
        return self._iter_pages(self.get_list, name=name, architecture=architecture, include_architecture_wildcard=include_architecture_wildcard)
