...
class VolumeConnectorManager(base.CreateManager):
    ...
    _creation_attributes = ['extra', 'node_uuid', 'type', 'connector_id', 'uuid']
    ...
    def list(self, node=None, limit=None, marker=None, sort_key=None, sort_dir=None, detail=False, fields=None, os_ironic_api_version=None, global_request_id=None):
        ...
        if limit is None:
            ...
            return self._list_pagination(self._path(path), 'connectors', limit=limit, **header_values)

    def get(self, volume_connector_id, fields=None, os_ironic_api_version=None, global_request_id=None):
        return self._get(resource_id=volume_connector_id, fields=fields, os_ironic_api_version=os_ironic_api_version, global_request_id=global_request_id)

    def delete(self, volume_connector_id, os_ironic_api_version=None, global_request_id=None):
        return self._delete(resource_id=volume_connector_id, os_ironic_api_version=os_ironic_api_version, global_request_id=global_request_id)

    def update(self, volume_connector_id, patch, os_ironic_api_version=None, global_request_id=None):
        return self._update(resource_id=volume_connector_id, patch=patch, os_ironic_api_version=os_ironic_api_version, global_request_id=global_request_id)