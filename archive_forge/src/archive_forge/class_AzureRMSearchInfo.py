...
class AzureRMSearchInfo(AzureRMModuleBase):
    ...
    def __init__(self):
        self.module_arg_spec = dict(name=dict(type='str'), resource_group=dict(type='str'), show_keys=dict(type='bool', default=False))
        self.results = dict(changed=False, search=[])
        self.name = None
        self.resource_group = None
        self.show_keys = False
        super(AzureRMSearchInfo, self).__init__(derived_arg_spec=self.module_arg_spec, supports_check_mode=True, supports_tags=False)
