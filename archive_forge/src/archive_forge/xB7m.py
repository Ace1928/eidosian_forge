...
class ShaderManager:
    ...
    def load_shader_from_file(self, file_path: str, shader_type: str) -> cl.Program:
        ...
        If the specified file does not exist, it attempts to load a default shader from a predefined location and copies it to the application's default location.
        ...
        Raises:
            FileNotFoundError: If the shader file does not exist and no default is available.
            ValueError: If an unsupported shader type is provided.
        """
        default_shaders = {
