...
class Bgp_address_family(ResourceModule):
    ...
    def __init__(self, module):
        super(Bgp_address_family, self).__init__(empty_fact_val={}, facts_module=Facts(module), module=module, resource='bgp_address_family', tmplt=Bgp_address_familyTemplate())
        self.parsers = []
    ...
    def _compare_af(self, want, have):
        ...
        for name, entry in iteritems(waf):
            self._compare_lists(entry, have=haf.get(name, {}), as_number=want['as_number'], afi=name)
