...
def test_putNotQuiescent(self):
    ...
    self.assertEqual(f.getErrorMessage(), 'BUG: Non-quiescent protocol added to connection pool.')
    self.assertIdentical(None, self.pool._connections.get(('http', b'example.com', 80)))
