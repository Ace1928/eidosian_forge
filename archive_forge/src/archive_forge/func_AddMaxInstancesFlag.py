...
def AddMaxInstancesFlag(parser):
    ...
    parser.add_argument('--max-instances', type=_ScaleValue, help="The maximum number of container instances of the Service to run. Use 'default' to unset the limit and use the platform default.")