...
class LoggerConfig:
    ...
    LogEntryExceptionType: TypeAlias = Optional[Exception]
...
class BasicLogger:
    ...
    def __init__(
        self,
        timestamp: TimestampType = datetime.datetime.now().isoformat(),
        message: LogEntryMessageType = "",
        level: LogEntryLevelType = "DEBUG",
        module: LogEntryModuleType = None,
        function: LogEntryFunctionType = None,
        line: LogEntryLineType = None,
        exc_info: LogEntryExceptionType = None,
    ) -> None:
        """
...
class AdvancedASCIIFormatter:
    ...
    def __init__(
        self,
        log: Optional[LogEntryDictType] = None,
    ) -> None:
        if log is None:
            log = {
        ...
        self.LEVEL_SYMBOLS: Dict[LogEntryLevelType, str] = {
            LogEntryLevelType.NOTSET: "🤷",
            LogEntryLevelType.DEBUG: "🐞",
            LogEntryLevelType.INFO: "ℹ️",
            LogEntryLevelType.WARNING: "⚠️",
            LogEntryLevelType.ERROR: "❌",
            LogEntryLevelType.CRITICAL: "🚨",
        }
        # Exception Symbols for different exception types
        self.EXCEPTION_SYMBOLS: Dict[Type[Exception], str] = {
            LogEntryExceptionType.ValueError: "#❌#",  # Value Error
            LogEntryExceptionType.TypeError: "T❌T",  # Type Error
            LogEntryExceptionType.KeyError: "K❌K",  # Key Error
            LogEntryExceptionType.IndexError: "I❌I",  # Index Error
            LogEntryExceptionType.AttributeError: "A❌A",  # Attribute Error
            LogEntryExceptionType.Exception: "E❌E",  # General Exception
        }
...
class ColoredFormatter:
    ...
    def __call__(
        self, log_entry: AdvancedASCIIFormatter = AdvancedASCIIFormatter()
    ) -> str:
        """
