...
class EncoderTest(unittest.TestCase):
    ...
    def test_encode(self):
        ...
        self.assertTrue(result in ([0, 248, 6, 9, 11, 252, 3, 120, 121, 122, 5, 252, 3, 97, 98, 99, 248, 1, 248, 4, 50, 238, 86, 255, 130, 18, 63, 252, 6, 49, 50, 51, 52, 53, 54], [0, 248, 6, 9, 5, 252, 3, 97, 98, 99, 11, 252, 3, 120, 121, 122, 248, 1, 248, 4, 50, 238, 86, 255, 130, 18, 63, 252, 6, 49, 50, 51, 52, 53, 54]))