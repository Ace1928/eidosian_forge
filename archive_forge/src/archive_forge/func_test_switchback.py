...
@pytest.mark.skipif(not is_triton_available() or not torch.cuda.is_available() or (not torch.cuda.get_device_capability()[0] >= 8), reason='This test requires triton and a GPU with compute capability 8.0 or higher.')
