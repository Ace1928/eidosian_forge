...
class PDFtoTextConverter(BaseConverter):
    ...
    async def _aconvert_source_to_target(self, source: InputSourceType, target: Optional[str]='.txt', source_filename: Optional[str]=None, target_output: Optional[Any]=None, raise_errors: Optional[bool]=False, **kwargs) -> OutputType:
        """
        Convert the source to the target
