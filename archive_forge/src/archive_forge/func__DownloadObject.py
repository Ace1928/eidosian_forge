...
def _DownloadObject(cls, args, thread_state=None):
  ...
  """
    ...
    if args.need_to_slice:
        cls.PerformSlicedDownload(args.object_name, args.file_name, args.serialization_data)
    else:
        cls.Download(args.object_name, gsutil_api, args.file_name, args.serialization_data)