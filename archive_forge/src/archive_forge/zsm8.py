...
def generate_scene() -> Scene:
    ...
    # Add a sphere with a dynamic color material
...
async def main() -> None:
    ...
    extended_color_codes = await validate_and_load_color_codes()
...
if __name__ == "__main__":
    ...
    profile_function(asyncio.run(main()))
