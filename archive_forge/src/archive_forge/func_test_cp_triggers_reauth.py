...
def test_cp_triggers_reauth(self, mock_get_process_and_thread_count, mock_trigger_reauth):
    ...
    mock_trigger_reauth.assert_called_once_with(StorageUrlFromString(suri(bucket_uri)), mock.ANY, 6)
    mock_get_process_and_thread_count.assert_called_once_with(process_count=None, thread_count=None, parallel_operations_override=None, print_macos_warning=False)