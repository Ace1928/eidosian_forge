...
def _update_run():
    request_message = _get_request_message(UpdateRun(), schema={'run_id': [_assert_required, _assert_string], 'end_time': [_assert_intlike], 'status': [_assert_string], 'run_name': [_assert_string]})
