...
class SetInstructionBreakpointsArguments(BaseSchema):
    ...
    """
    __props__ = {'breakpoints': {'type': 'array', 'items': {'$ref': '#/definitions/InstructionBreakpoint'}, 'description': 'The instruction references of the breakpoints'}}
    __refs__ = set()
    ...
    def to_dict(self, update_ids_to_dap=False):
        ...
        dct = {'breakpoints': [InstructionBreakpoint.update_dict_ids_to_dap(o) for o in breakpoints] if update_ids_to_dap and breakpoints else breakpoints}
