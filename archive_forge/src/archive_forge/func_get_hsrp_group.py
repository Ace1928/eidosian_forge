...
def get_hsrp_group(group, interface, module):
    ...
    hsrp = {}
    hsrp_key = {'sh_if_index': 'interface', 'sh_group_num': 'group', 'sh_group_version': 'version', 'sh_cfg_prio': 'priority', 'sh_preempt': 'preempt', 'sh_vip': 'vip', 'sh_authentication_type': 'auth_type', 'sh_keystring_attr': 'auth_enc', 'sh_authentication_data': 'auth_string'}
    try:
