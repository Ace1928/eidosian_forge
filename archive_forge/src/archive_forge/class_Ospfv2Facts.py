...
class Ospfv2Facts(object):
    ...
    def populate_facts(self, connection, ansible_facts, data=None):
        ...
        objs = {}
        ospfv2 = findall('^set protocols ospf (.+)', data, M)
        if ospfv2:
    ...
    def is_bool(self, attrib):
        ...
        :return: True/False
        """
        bool_set = ('set', 'always', 'normal', 'enabled', 'opaque_lsa', 'not_advertise', 'administrative', 'rfc1583_compatibility')
    ...
    def is_num(self, attrib):
        ...
        :return: True/false.
        """
        num_set = ('ospf', 'delay', 'metric', 'inter_area', 'intra_area', 'on_startup', 'metric_type', 'on_shutdown', 'max_holdtime', 'poll_interval', 'default_metric', 'initial_holdtime', 'key_id')
