...
class SetIamPolicyGA(base.Command):
  ...
  """
    ...
    def Run(self, args):
        ...
        req = messages.DnsManagedZonesSetIamPolicyRequest(resource=resource_name, googleIamV1SetIamPolicyRequest=messages.GoogleIamV1SetIamPolicyRequest(policy=policy, updateMask=update_mask))
