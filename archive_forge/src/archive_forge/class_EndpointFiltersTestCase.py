...
class EndpointFiltersTestCase(base.V3ClientTestCase, test_endpoint_groups.EndpointGroupsTestMixin, test_projects.ProjectsTestMixin):
    ...
    def setUp(self):
        ...
        self.client.endpoint_filter.add_endpoint_group_to_project(self.endpoint_group, self.project)
    ...
    def test_add_endpoint_group_to_project(self):
        ...
        self.client.endpoint_filter.add_endpoint_group_to_project(endpoint_group, project)
        self.client.endpoint_filter.check_endpoint_group_in_project(endpoint_group, project)

    def test_delete_endpoint_group_from_project(self):
        self.client.endpoint_filter.delete_endpoint_group_from_project(self.endpoint_group, self.project)
        self.assertRaises(http.NotFound, self.client.endpoint_filter.check_endpoint_group_in_project, self.endpoint_group, self.project)
    ...
    def test_list_endpoint_groups_for_project(self):
        ...
        self.client.endpoint_filter.add_endpoint_group_to_project(endpoint_group_two, self.project)
        endpoint_groups = self.client.endpoint_filter.list_endpoint_groups_for_project(self.project)
    ...
    def test_list_projects_for_endpoint_group(self):
        ...
        self.client.endpoint_filter.add_endpoint_group_to_project(self.endpoint_group, project_two)
