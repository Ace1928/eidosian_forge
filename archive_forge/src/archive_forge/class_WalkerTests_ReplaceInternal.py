...
class WalkerTests_ReplaceInternal(unittest.TestCase):
    ...
    def test_replace(self):
        ...
        assertExpressionsEqual(self, SumExpression([LinearExpression([MonomialTermExpression((1, m.y[1])), MonomialTermExpression((1, m.y[2]))]), LinearExpression([MonomialTermExpression((1, m.y[2])), MonomialTermExpression((1, m.y[3]))])]) == 0, f)
