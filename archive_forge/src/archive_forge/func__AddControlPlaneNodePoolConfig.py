...
def _AddControlPlaneNodePoolConfig(bare_metal_control_plane_config_group, is_update=False):
  ...
  """
    ...
    bare_metal_control_plane_node_pool_config_group = bare_metal_control_plane_config_group.add_group(help='Anthos on bare metal standalone cluster control plane node pool configuration.', required=required)
