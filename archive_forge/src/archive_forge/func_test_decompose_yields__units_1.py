...
def test_decompose_yields__units_1():
    ...
    gamma_yields = {'OH-': 0.5 * u.per100eV, 'H2O2': 0.7 * u.per100eV, 'OH': 2.7 * u.per100eV, 'H2': 0.45 * u.per100eV, 'H': 0.66 * u.per100eV, 'H+': 3.1 * u.per100eV, 'HO2': 0.02 * u.per100eV, 'e-(aq)': 2.6 * u.per100eV}
    ...
    ref = 4.64 * u.per100eV
    assert abs((_sum(G_H2O) + ref) / ref) < 0.001