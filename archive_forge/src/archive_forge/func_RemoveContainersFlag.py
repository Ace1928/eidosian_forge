...
def RemoveContainersFlag():
    return base.Argument('--remove-containers', action=arg_parsers.UpdateAction, type=arg_parsers.ArgList(element_type=_CONTAINER_NAME_TYPE, max_length=9), metavar='CONTAINER', help='List of containers to remove.')