...
class AuthenticatedUser(CompletableGithubObject):
    ...
    def create_project(self, name: str, body: Opt[str]=NotSet) -> Project:
        ...
        headers, data = self._requester.requestJsonAndCheck('POST', '/user/projects', input=post_parameters, headers={'Accept': Consts.mediaTypeProjectsPreview})
    ...
    def edit(self, name: Opt[str]=NotSet, email: Opt[str]=NotSet, blog: Opt[str]=NotSet, company: Opt[str]=NotSet, location: Opt[str]=NotSet, hireable: Opt[bool]=NotSet, bio: Opt[str]=NotSet) -> None:
        """
        ...
        post_parameters: dict[str, Any] = NotSet.remove_unset_items({'name': name, 'email': email, 'blog': blog, 'company': company, 'location': location, 'hireable': hireable, 'bio': bio})
    ...
    def get_repos(self, visibility: Opt[str]=NotSet, affiliation: Opt[str]=NotSet, type: Opt[str]=NotSet, sort: Opt[str]=NotSet, direction: Opt[str]=NotSet) -> PaginatedList[Repository]:
        """
        ...
        assert is_optional(sort, str), sort
        assert is_optional(direction, str), direction
        url_parameters = NotSet.remove_unset_items({'visibility': visibility, 'affiliation': affiliation, 'type': type, 'sort': sort, 'direction': direction})
    ...
    def get_invitations(self) -> PaginatedList[Invitation]:
        ...
        """
        return PaginatedList(github.Invitation.Invitation, self._requester, '/user/repository_invitations', None)
    ...
    def get_migrations(self) -> PaginatedList[Migration]:
        ...
        """
        return PaginatedList(github.Migration.Migration, self._requester, '/user/migrations', None, headers={'Accept': Consts.mediaTypeMigrationPreview})
