...
class StandardDecorator:
    ...
    def __init__(
        ...
        logging.debug(
            f"Initialised with Default values of {retries}, {delay}, {cache_results}, {log_level}, {validation_rules}, {retry_exceptions}, {cache_maxsize}, {enable_performance_logging}, {dynamic_retry_enabled}, {cache_key_strategy}, {enable_caching}, {enable_validation}, {file_cache_path}, {call_threshold}, {call_counter}, {cache}"
        )
