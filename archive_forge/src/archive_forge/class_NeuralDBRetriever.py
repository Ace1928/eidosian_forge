...
class NeuralDBRetriever(BaseRetriever):
    ...
    @classmethod
    def from_checkpoint(cls, checkpoint: Union[str, Path], thirdai_key: Optional[str]=None) -> NeuralDBRetriever:
        """
    ...
    def insert(self, sources: List[Any], train: bool=True, fast_mode: bool=True, **kwargs: dict) -> None:
