...
class ServiceCatalog(metaclass=abc.ABCMeta):
    ...
    def get_endpoints(self, service_type=None, interface=None, region_name=None, service_name=None, service_id=None, endpoint_id=None):
        """Fetch and filter endpoint data for the specified service(s).
        ...
        """
        endpoints_data = self.get_endpoints_data(service_type=service_type, interface=interface, region_name=region_name, service_name=service_name, service_id=service_id, endpoint_id=endpoint_id)
        endpoints = {}
    ...
    def get_urls(self, service_type=None, interface='public', region_name=None, service_name=None, service_id=None, endpoint_id=None):
        ...
        """
        endpoints = self.get_endpoint_data_list(service_type=service_type, interface=interface, region_name=region_name, service_name=service_name, service_id=service_id, endpoint_id=endpoint_id)
        return tuple([endpoint.url for endpoint in endpoints])

    def url_for(self, service_type=None, interface='public', region_name=None, service_name=None, service_id=None, endpoint_id=None):
        ...
        :param string endpoint_id: The identifier of an endpoint.
        """
        return self.endpoint_data_for(service_type=service_type, interface=interface, region_name=region_name, service_name=service_name, service_id=service_id, endpoint_id=endpoint_id).url

    def endpoint_data_for(self, service_type=None, interface='public', region_name=None, service_name=None, service_id=None, endpoint_id=None):
        ...
        endpoint_data_list = self.get_endpoint_data_list(service_type=service_type, interface=interface, region_name=region_name, service_name=service_name, service_id=service_id, endpoint_id=endpoint_id)
        if endpoint_data_list:
            return endpoint_data_list[0]
        if service_name and region_name:
            msg = '%(interface)s endpoint for %(service_type)s service named %(service_name)s in %(region_name)s region not found' % {'interface': interface, 'service_type': service_type, 'service_name': service_name, 'region_name': region_name}
        elif service_name:
            msg = '%(interface)s endpoint for %(service_type)s service named %(service_name)s not found' % {'interface': interface, 'service_type': service_type, 'service_name': service_name}
        elif region_name:
            msg = '%(interface)s endpoint for %(service_type)s service in %(region_name)s region not found' % {'interface': interface, 'service_type': service_type, 'region_name': region_name}
        else:
            msg = '%(interface)s endpoint for %(service_type)s service not found' % {'interface': interface, 'service_type': service_type}
