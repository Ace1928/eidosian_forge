...
def webfilter_content_header(data, fos, check_mode=False):
    ...
    webfilter_content_header_data = flatten_multilists_attributes(webfilter_content_header_data)
    ...
    if state == 'present' or state is True:
        ...
        return fos.delete('webfilter', 'content-header', mkey=filtered_data['id'], vdom=vdom)
    else:
