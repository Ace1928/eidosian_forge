...
class LaunchConfigurationTest(common.HeatTestCase):
    ...
    def test_validate_BlockDeviceMappings_without_SnapshotId_property(self):
        ...
        self.stub_FlavorConstraint_validate()
        e = self.assertRaises(exception.StackValidationFailed, self.validate_launch_config, stack)
        self.assertIn('SnapshotId is missing, this is required', str(e))
    ...
    def test_validate_BlockDeviceMappings_without_DeviceName_property(self):
        ...
        self.stub_SnapshotConstraint_validate()
        e = self.assertRaises(exception.StackValidationFailed, self.validate_launch_config, stack)
        excepted_error = 'Property error: Resources.LaunchConfig.Properties.BlockDeviceMappings[0]: Property DeviceName not assigned'
