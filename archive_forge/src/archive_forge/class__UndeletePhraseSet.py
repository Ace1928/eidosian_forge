...
class _UndeletePhraseSet(SpeechRestStub):
    ...
    def __call__(self, request: cloud_speech.UndeletePhraseSetRequest, *, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Optional[float]=None, metadata: Sequence[Tuple[str, str]]=()) -> operations_pb2.Operation:
        """Call the undelete phrase set method over HTTP.
            ...
            """
        http_options: List[Dict[str, str]] = [{'method': 'post', 'uri': '/v2/{name=projects/*/locations/*/phraseSets/*}:undelete', 'body': '*'}]
