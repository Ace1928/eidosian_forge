...
class ORTModel:
    ...
    def __init__(self, model_path: Union[str, os.PathLike], execution_provider: Optional[str]='CPUExecutionProvider', compute_metrics: Optional[Callable[[EvalPrediction], Dict]]=None, label_names: Optional[List[str]]=None):
        """
        Args:
