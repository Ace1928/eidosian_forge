  ...
  *{command}* adds labels to a Compute Engine snapshot.
  ...
  """
    ...
    def Run(self, args):
        ...
        snapshot_ref = SnapshotsAddLabels.SnapshotArg.ResolveAsResource(args, holder.resources)
        ...
        labels_update = labels_util.Diff(additions=add_labels).Apply(messages.GlobalSetLabelsRequest.LabelsValue, snapshot.labels)
