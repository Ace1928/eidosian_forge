...
class DirectoryUsersListRequest(_messages.Message):
    """A DirectoryUsersListRequest object.
  ...
  """
    ...
    maxResults = _messages.IntegerField(5, variant=_messages.Variant.INT32, default=100)
    orderBy = _messages.EnumField('OrderByValueValuesEnum', 6)
    pageToken = _messages.StringField(7)
    projection = _messages.EnumField('ProjectionValueValuesEnum', 8, default=u'basic')
    ...
    viewType = _messages.EnumField('ViewTypeValueValuesEnum', 12, default=u'admin_view')