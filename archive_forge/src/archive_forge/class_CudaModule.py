...
class CudaModule(NewExtensionModule):
    ...
    def __init__(self, interp: Interpreter):
        super().__init__()
        self.methods.update({'min_driver_version': self.min_driver_version, 'nvcc_arch_flags': self.nvcc_arch_flags, 'nvcc_arch_readable': self.nvcc_arch_readable})
    ...
    def nvcc_arch_readable(self, state: 'ModuleState', args: T.Tuple[T.Union[CudaCompiler, str], T.List[str]], kwargs: ArchFlagsKwargs) -> T.List[str]:
        nvcc_arch_args = self._validate_nvcc_arch_args(args, kwargs)
