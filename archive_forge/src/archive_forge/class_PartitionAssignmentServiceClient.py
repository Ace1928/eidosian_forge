...
class PartitionAssignmentServiceClient(metaclass=PartitionAssignmentServiceClientMeta):
    ...
    def __init__(self, *, credentials: Optional[ga_credentials.Credentials]=None, transport: Optional[Union[str, PartitionAssignmentServiceTransport]]=None, client_options: Optional[Union[client_options_lib.ClientOptions, dict]]=None, client_info: gapic_v1.client_info.ClientInfo=DEFAULT_CLIENT_INFO) -> None:
    ...
    def assign_partitions(self, requests: Optional[Iterator[subscriber.PartitionAssignmentRequest]]=None, *, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> Iterable[subscriber.PartitionAssignment]:
