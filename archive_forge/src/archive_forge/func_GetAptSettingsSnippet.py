...
def GetAptSettingsSnippet(args):
  ...
  """
    ...
    location, repo_path = _GetLocationAndRepoPath(args, messages.Repository.FormatValueValuesEnum.APT)
    repo = _GetRequiredRepoValue(args)
    project = _GetRequiredProjectValue(args)
    data = {'location': location, 'project': project, 'repo': repo, 'repo_path': repo_path}
