...
class QtHelpBuilder(StandaloneHTMLBuilder):
    ...
    """
    name = 'qthelp'
    epilog = __('You can now run "qcollectiongenerator" with the .qhcp project file in %(outdir)s, like this:\n$ qcollectiongenerator %(outdir)s/%(project)s.qhcp\nTo view the help file:\n$ assistant -collectionFile %(outdir)s/%(project)s.qhc')
    copysource = False
    ...
    def handle_finish(self) -> None:
        self.epilog = self.epilog % {'outdir': '%(outdir)s', 'project': self.config.qthelp_basename}
