...
class ImageClassificationProcessing(TaskProcessor):
    ...
    def __init__(self, config: 'PretrainedConfig', preprocessor: 'BaseImageProcessor', preprocessor_kwargs: Optional[Dict[str, Any]]=None):
        ...
        self.transforms = Compose([Resize(size), CenterCrop(size), ToTensor(), Normalize(mean=self.preprocessor.image_mean, std=self.preprocessor.image_std)])
