...
class MonitoringV3(base_api.BaseApiClient):
    ...
    def __init__(self, url='', credentials=None, get_credentials=True, http=None, model=None, log_request=False, log_response=False, credentials_args=None, default_global_params=None, additional_http_headers=None, response_encoding=None):
        ...
        super(MonitoringV3, self).__init__(url, credentials=credentials, get_credentials=get_credentials, http=http, model=model, log_request=log_request, log_response=log_response, credentials_args=credentials_args, default_global_params=default_global_params, additional_http_headers=additional_http_headers, response_encoding=response_encoding)
    ...
    class ProjectsCollectdTimeSeriesService(base_api.BaseApiService):
      ...
      """
            config = self.GetMethodConfig('Create')
            return self._RunMethod(config, request, global_params=global_params)
        Create.method_config = lambda: base_api.ApiMethodInfo(flat_path='v3/projects/{projectsId}/collectdTimeSeries', http_method='POST', method_id='monitoring.projects.collectdTimeSeries.create', ordered_params=['name'], path_params=['name'], query_params=[], relative_path='v3/{+name}/collectdTimeSeries', request_field='createCollectdTimeSeriesRequest', request_type_name='MonitoringProjectsCollectdTimeSeriesCreateRequest', response_type_name='CreateCollectdTimeSeriesResponse', supports_download=False)
    ...
    class ProjectsGroupsService(base_api.BaseApiService):
      ...
      """
            config = self.GetMethodConfig('Create')
            return self._RunMethod(config, request, global_params=global_params)
        Create.method_config = lambda: base_api.ApiMethodInfo(flat_path='v3/projects/{projectsId}/groups', http_method='POST', method_id='monitoring.projects.groups.create', ordered_params=['name'], path_params=['name'], query_params=['validateOnly'], relative_path='v3/{+name}/groups', request_field='group', request_type_name='MonitoringProjectsGroupsCreateRequest', response_type_name='Group', supports_download=False)
      ...
      """
            config = self.GetMethodConfig('Delete')
            return self._RunMethod(config, request, global_params=global_params)
        Delete.method_config = lambda: base_api.ApiMethodInfo(flat_path='v3/projects/{projectsId}/groups/{groupsId}', http_method='DELETE', method_id='monitoring.projects.groups.delete', ordered_params=['name'], path_params=['name'], query_params=['recursive'], relative_path='v3/{+name}', request_field='', request_type_name='MonitoringProjectsGroupsDeleteRequest', response_type_name='Empty', supports_download=False)
      ...
      """
            config = self.GetMethodConfig('Get')
            return self._RunMethod(config, request, global_params=global_params)
        Get.method_config = lambda: base_api.ApiMethodInfo(flat_path='v3/projects/{projectsId}/groups/{groupsId}', http_method='GET', method_id='monitoring.projects.groups.get', ordered_params=['name'], path_params=['name'], query_params=[], relative_path='v3/{+name}', request_field='', request_type_name='MonitoringProjectsGroupsGetRequest', response_type_name='Group', supports_download=False)
      ...
      """
            config = self.GetMethodConfig('List')
            return self._RunMethod(config, request, global_params=global_params)
        List.method_config = lambda: base_api.ApiMethodInfo(flat_path='v3/projects/{projectsId}/groups', http_method='GET', method_id='monitoring.projects.groups.list', ordered_params=['name'], path_params=['name'], query_params=['ancestorsOfGroup', 'childrenOfGroup', 'descendantsOfGroup', 'pageSize', 'pageToken'], relative_path='v3/{+name}/groups', request_field='', request_type_name='MonitoringProjectsGroupsListRequest', response_type_name='ListGroupsResponse', supports_download=False)
      ...
      """
            ...
            return self._RunMethod(config, request, global_params=global_params)
        Update.method_config = lambda: base_api.ApiMethodInfo(flat_path='v3/projects/{projectsId}/groups/{groupsId}', http_method='PUT', method_id='monitoring.projects.groups.update', ordered_params=['name'], path_params=['name'], query_params=['validateOnly'], relative_path='v3/{+name}', request_field='group', request_type_name='MonitoringProjectsGroupsUpdateRequest', response_type_name='Group', supports_download=False)
    ...
    class ServicesService(base_api.BaseApiService):
      ...
      """
            config = self.GetMethodConfig('Create')
            return self._RunMethod(config, request, global_params=global_params)
        Create.method_config = lambda: base_api.ApiMethodInfo(flat_path='v3/{v3Id}/{v3Id1}/services', http_method='POST', method_id='monitoring.services.create', ordered_params=['parent'], path_params=['parent'], query_params=['serviceId'], relative_path='v3/{+parent}/services', request_field='service', request_type_name='MonitoringServicesCreateRequest', response_type_name='Service', supports_download=False)
      ...
      """
            config = self.GetMethodConfig('Delete')
            return self._RunMethod(config, request, global_params=global_params)
        Delete.method_config = lambda: base_api.ApiMethodInfo(flat_path='v3/{v3Id}/{v3Id1}/services/{servicesId}', http_method='DELETE', method_id='monitoring.services.delete', ordered_params=['name'], path_params=['name'], query_params=[], relative_path='v3/{+name}', request_field='', request_type_name='MonitoringServicesDeleteRequest', response_type_name='Empty', supports_download=False)
      ...
      """
            config = self.GetMethodConfig('Get')
            return self._RunMethod(config, request, global_params=global_params)
        Get.method_config = lambda: base_api.ApiMethodInfo(flat_path='v3/{v3Id}/{v3Id1}/services/{servicesId}', http_method='GET', method_id='monitoring.services.get', ordered_params=['name'], path_params=['name'], query_params=[], relative_path='v3/{+name}', request_field='', request_type_name='MonitoringServicesGetRequest', response_type_name='Service', supports_download=False)
      ...
      """
            config = self.GetMethodConfig('List')
            return self._RunMethod(config, request, global_params=global_params)
        List.method_config = lambda: base_api.ApiMethodInfo(flat_path='v3/{v3Id}/{v3Id1}/services', http_method='GET', method_id='monitoring.services.list', ordered_params=['parent'], path_params=['parent'], query_params=['filter', 'pageSize', 'pageToken'], relative_path='v3/{+parent}/services', request_field='', request_type_name='MonitoringServicesListRequest', response_type_name='ListServicesResponse', supports_download=False)
      ...
      """
            config = self.GetMethodConfig('Patch')
            return self._RunMethod(config, request, global_params=global_params)
        Patch.method_config = lambda: base_api.ApiMethodInfo(flat_path='v3/{v3Id}/{v3Id1}/services/{servicesId}', http_method='PATCH', method_id='monitoring.services.patch', ordered_params=['name'], path_params=['name'], query_params=['updateMask'], relative_path='v3/{+name}', request_field='service', request_type_name='MonitoringServicesPatchRequest', response_type_name='Service', supports_download=False)
    ...
    class UptimeCheckIpsService(base_api.BaseApiService):
      ...
      """
            config = self.GetMethodConfig('List')
            return self._RunMethod(config, request, global_params=global_params)
        List.method_config = lambda: base_api.ApiMethodInfo(http_method='GET', method_id='monitoring.uptimeCheckIps.list', ordered_params=[], path_params=[], query_params=['pageSize', 'pageToken'], relative_path='v3/uptimeCheckIps', request_field='', request_type_name='MonitoringUptimeCheckIpsListRequest', response_type_name='ListUptimeCheckIpsResponse', supports_download=False)