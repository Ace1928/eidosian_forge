...
def GetRegionalizedBuilder(executable, region, docker_image_tag):
  ...
  """
    ...
    regionalized_builder = GetRegionalisedBuilderIfExists(gcp_project, executable, region, docker_image_tag)
    ...
    fallback_regionalized_builder = GetRegionalisedBuilderIfExists(fallback_project_name, executable, region, docker_image_tag)
