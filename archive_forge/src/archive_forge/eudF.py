...
try:
    ...
    print("Datasets loaded successfully into pandas DataFrames")
except ValueError as e:
    raise Exception(f"Failed to load datasets into DataFrames: {e}")
...
print("Training questions and answers extracted successfully")
