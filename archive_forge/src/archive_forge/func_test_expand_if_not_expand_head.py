...
def test_expand_if_not_expand_head(self, mock_validate_engine, mock_get_alembic_branch_head, mock_get_current_alembic_heads):
    ...
    self.assertIn("Database expansion failed. Couldn't find head revision of expand branch.", exit.code)