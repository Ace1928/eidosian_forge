...
class _AcceleratorConnector:
    ...
    def __init__(self, devices: Union[List[int], str, int]='auto', num_nodes: int=1, accelerator: Union[str, Accelerator]='auto', strategy: Union[str, Strategy]='auto', plugins: Optional[Union[_PLUGIN_INPUT, List[_PLUGIN_INPUT]]]=None, precision: Optional[_PRECISION_INPUT]=None, sync_batchnorm: bool=False, benchmark: Optional[bool]=None, use_distributed_sampler: bool=True, deterministic: Optional[Union[bool, _LITERAL_WARN]]=None) -> None:
