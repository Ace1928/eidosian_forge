...
def generate_autosummary_content(name: str, obj: Any, parent: Any, template: AutosummaryRenderer, template_name: str, imported_members: bool, app: Any, recursive: bool, context: Dict, modname: Optional[str]=None, qualname: Optional[str]=None) -> str:
    ...
    def skip_member(obj: Any, name: str, objtype: str) -> bool:
        try:
            ...
            logger.warning(__('autosummary: failed to determine %r to be documented, the following exception was raised:\n%s'), name, exc, type='autosummary')
            return False
