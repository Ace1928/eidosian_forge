...
class RadialHeatMapPlotTests(TestMPLPlot):
    ...
    def setUp(self):
        ...
        self.wedge_data = [((0.5, 0.5), 0.125, 0.375, 180.0, 360.0), ((0.5, 0.5), 0.125, 0.375, 0.0, 180.0), ((0.5, 0.5), 0.125, 0.5, 180.0, 360.0), ((0.5, 0.5), 0.125, 0.5, 0.0, 180.0)]
        self.xticks = [(0.0, 'Seg 0'), (3.141592653589793, 'Seg 1')]
        self.yticks = [(0.25, 'Ann 0'), (0.375, 'Ann 1')]
        plot_opts = dict(start_angle=0, max_radius=1, radius_inner=0.5, radius_outer=0.2, radial=True)
    ...
    def test_get_data(self):
        ...
        for wedge, wdata in zip(wedges, self.wedge_data):
            self.assertEqual((wedge.center, wedge.width, wedge.r, wedge.theta1, wedge.theta2), wdata)
