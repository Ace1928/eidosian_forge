...
class ListQuantumReservationBudgetsPager:
    ...
    def __init__(self, method: Callable[..., engine.ListQuantumReservationBudgetsResponse], request: engine.ListQuantumReservationBudgetsRequest, response: engine.ListQuantumReservationBudgetsResponse, *, metadata: Sequence[Tuple[str, str]]=()):
