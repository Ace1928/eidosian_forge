...
class AssigningSingleSubscriber(AsyncSingleSubscriber, PermanentFailable):
    ...
    def __init__(self, assigner_factory: Callable[[], Assigner], subscriber_factory: PartitionSubscriberFactory, reassignment_handler: ReassignmentHandler):
        """
    ...
    async def _assign_action(self):
        ...
        maybe_awaitable = self._reassignment_handler.handle_reassignment(old_assignment, assignment)
    ...
    async def __aexit__(self, exc_type, exc_value, traceback):
        ...
        await wait_ignore_errors(self._assigner.__aexit__(exc_type, exc_value, traceback))
