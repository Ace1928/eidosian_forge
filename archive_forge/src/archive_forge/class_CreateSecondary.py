...
class CreateSecondary(base.CreateCommand):
    ...
    """
        ...
        kms_resource_args.AddKmsKeyResourceArg(parser, 'cluster', permission_info="The 'AlloyDB Service Agent' service account must hold permission 'Cloud KMS CryptoKey Encrypter/Decrypter'")
    ...
    """
        ...
        location_ref = client.resource_parser.Create('alloydb.projects.locations', projectsId=properties.VALUES.core.project.GetOrFail, locationsId=args.region)
        req = cluster_helper.ConstructCreatesecondaryRequestFromArgs(alloydb_messages, location_ref, args)
