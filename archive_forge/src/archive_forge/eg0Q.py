...
def log_exception(func: Callable) -> Callable:
    ...
    Purpose:
        This decorator catches and logs any exceptions raised by the decorated function,
        providing detailed error information for debugging purposes. The exception is
        re-raised after logging to allow for proper error handling.
