...
def _should_create_evaluation_rollout_workers(cls, eval_config: 'AlgorithmConfig'):
    """Determines whether we need to create evaluation workers.
        ...
        """
    run_offline_evaluation = eval_config.off_policy_estimation_methods and (not eval_config.ope_split_batch_by_episode)
    return not run_offline_evaluation and (eval_config.evaluation_num_workers > 0 or eval_config.evaluation_interval)