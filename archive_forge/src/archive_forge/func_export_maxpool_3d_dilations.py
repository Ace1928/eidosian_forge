...
def export_maxpool_3d_dilations() -> None:
    """input_shape: [1, 1, 4, 4, 4]
        ...
        """
    node = onnx.helper.make_node('MaxPool', inputs=['x'], outputs=['y'], kernel_shape=[2, 2, 2], strides=[1, 1, 1], dilations=[2, 2, 2])
    ...
    y = np.array([[[[[11, 12], [15, 16]], [[11, 12], [15, 16]]]]]).astype(np.float32)
