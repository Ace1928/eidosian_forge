...
def hue_to_rgb(hue):
    ...
    """
    hue_normalized = hue % 360  # Normalize hue to be within 0-360 degrees
    saturation = 1.0  # Saturation is set to maximum
    brightness = 1.0  # Brightness is set to maximum
    x = 1 - abs((hue_normalized / 60.0 % 2) - 1)
    ...
    sector_index = int(hue_normalized // 60)
    r, g, b = rgb_sector[sector_index]
