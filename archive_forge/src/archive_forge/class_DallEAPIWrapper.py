...
class DallEAPIWrapper(BaseModel):
    ...
    def validate_environment(cls, values: Dict) -> Dict:
        ...
        values['openai_organization'] = values['openai_organization'] or os.getenv('OPENAI_ORG_ID') or os.getenv('OPENAI_ORGANIZATION') or None
    ...
    def run(self, query: str) -> str:
        ...
        if is_openai_v1():
            response = self.client.generate(prompt=query, n=self.n, size=self.size, model=self.model_name, quality=self.quality)
