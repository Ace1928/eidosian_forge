...
class Test_matrix_constraint(unittest.TestCase):
    ...
    @unittest.skipIf(_scipy_ver < (1, 1), 'csr_matrix.reshape only available in scipy >= 1.1')
    def test_A(self):
        A = numpy.ones((4, 5))
    ...
    def test_preorder_traversal(self):
        ...
        for obj in pmo.preorder_traversal(m, ctype=IConstraint, descend=no_mc_descend):
            ...
            self.assertTrue(obj.ctype is block._ctype or obj.ctype is constraint._ctype)
            cnt += 1
