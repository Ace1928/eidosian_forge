...
import six
def RunImageImport(args, import_args, tags, output_filter, release_track, docker_image_tag=_DEFAULT_BUILDER_VERSION):
  ...
  """
    ...
    builder = _GetBuilder(_IMAGE_IMPORT_BUILDER_EXECUTABLE, docker_image_tag, builder_region)
