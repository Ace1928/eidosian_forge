...
@deprecated(since='0.0.32', removal='0.2.0', alternative_import='langchain_google_community.GCSFileLoader')
class GCSFileLoader(BaseLoader):
    """Load from GCS file."""

    def __init__(self, project_name: str, bucket: str, blob: str, loader_func: Optional[Callable[[str], BaseLoader]]=None):
