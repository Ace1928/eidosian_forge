...
def batch_mat_mul_v3_eager_fallback(x: _atypes.TensorFuzzingAnnotation[TV_BatchMatMulV3_Ta], y: _atypes.TensorFuzzingAnnotation[TV_BatchMatMulV3_Tb], Tout: TV_BatchMatMulV3_Tout, adj_x: bool, adj_y: bool, grad_x: bool, grad_y: bool, name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_BatchMatMulV3_Tout]:
    ...
    _inputs_flat = [x, y]
    _attrs = ('Ta', _attr_Ta, 'Tb', _attr_Tb, 'Tout', Tout, 'adj_x', adj_x, 'adj_y', adj_y, 'grad_x', grad_x, 'grad_y', grad_y)
    _result = _execute.execute(b'BatchMatMulV3', 1, inputs=_inputs_flat, attrs=_attrs, ctx=ctx, name=name)
