...
def GetRegionArg(include_global=False):
    ...
    if include_global:
        return base.Argument('--region', choices=constants.SUPPORTED_REGIONS_WITH_GLOBAL, help=_REGION_FLAG_WITH_GLOBAL_HELPTEXT)
    return base.Argument('--region', choices=constants.SUPPORTED_REGIONS, help=_REGION_FLAG_HELPTEXT)