...
def AddSecureTagsArgs(parser):
    ...
    parser.add_argument('--secure-tags', type=arg_parsers.ArgList(min_length=1), metavar='SECURE_TAG', help='      Specifies a list of secure tags to apply to the instance. These tags allow\n      network firewall rules and routes to be applied to specified VM instances.\n      See gcloud_compute_network_firewall-policies_rules_create(1) for more\n      details.\n      ')