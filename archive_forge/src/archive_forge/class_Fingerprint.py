...
class Fingerprint(object):
  ...
  """
    ...
    def __init__(self, saved_model_checksum=None, graph_def_program_hash=None, signature_def_hash=None, saved_object_graph_hash=None, checkpoint_hash=None, version=None):
    ...
    def __str__(self):
        return '\n'.join([f'SavedModel Fingerprint', f'  saved_model_checksum: {self.saved_model_checksum}', f'  graph_def_program_hash: {self.graph_def_program_hash}', f'  signature_def_hash: {self.signature_def_hash}', f'  saved_object_graph_hash: {self.saved_object_graph_hash}', f'  checkpoint_hash: {self.checkpoint_hash}'])
