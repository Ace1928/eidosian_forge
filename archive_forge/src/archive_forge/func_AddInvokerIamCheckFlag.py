...
def AddInvokerIamCheckFlag(parser):
    ...
    parser.add_argument('--invoker-iam-check', action=arg_parsers.StoreTrueFalseAction, help='Indicates whether an IAM check should occur when invoking the container. This is Enabled by default. Disabling this flag is not available in all projects.')