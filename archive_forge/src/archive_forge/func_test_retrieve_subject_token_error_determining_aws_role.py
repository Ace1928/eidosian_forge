...
def test_retrieve_subject_token_error_determining_aws_role(self):
    request = self.make_mock_request(region_status=http_client.OK, region_name=self.AWS_REGION, role_status=http_client.BAD_REQUEST)
    ...
    assert excinfo.match('Unable to retrieve AWS role name')