...
def is_single_entity(self) -> bool:
    """Indicates if this :class:`_query.Query`
        ...
        """
    return not self.load_options._only_return_tuples and len(self._raw_columns) == 1 and ('parententity' in self._raw_columns[0]._annotations) and isinstance(self._raw_columns[0]._annotations['parententity'], ORMColumnsClauseRole)