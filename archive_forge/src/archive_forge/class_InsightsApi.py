...
class InsightsApi:
    ...
    def create_dataset_config_link(self, dataset_config_relative_name):
        ...
        request = self.messages.StorageinsightsProjectsLocationsDatasetConfigsLinkDatasetRequest(name=dataset_config_relative_name)
    ...
    def delete_dataset_config_link(self, dataset_config_relative_name):
        ...
        request = self.messages.StorageinsightsProjectsLocationsDatasetConfigsUnlinkDatasetRequest(name=dataset_config_relative_name)
    ...
    def get_dataset_config(self, dataset_config_relative_name):
        ...
        return self.client.projects_locations_datasetConfigs.Get(self.messages.StorageinsightsProjectsLocationsDatasetConfigsGetRequest(name=dataset_config_relative_name))
    ...
    def _get_metadata_options_and_update_mask(self, metadata_fields, destination_url):
        ...
        if destination_url is not None:
            storage_destination_message = self.messages.CloudStorageDestinationOptions(bucket=destination_url.bucket_name, destinationPath=destination_url.object_name)
            update_mask.append('objectMetadataReportOptions.storageDestinationOptions.bucket')
            update_mask.append('objectMetadataReportOptions.storageDestinationOptions.destinationPath')
        else:
            storage_destination_message = None
        return (self.messages.ObjectMetadataReportOptions(metadataFields=metadata_fields, storageDestinationOptions=storage_destination_message), update_mask)
    ...
    def cancel_operation(self, operation_name):
        self.client.projects_locations_operations.Cancel(self.messages.StorageinsightsProjectsLocationsOperationsCancelRequest(name=operation_name))

    def get_operation(self, operation_name):
        return self.client.projects_locations_operations.Get(self.messages.StorageinsightsProjectsLocationsOperationsGetRequest(name=operation_name))

    def list_operations(self, parent_resource_name):
        request = self.messages.StorageinsightsProjectsLocationsOperationsListRequest(name=parent_resource_name)
        return list_pager.YieldFromList(self.client.projects_locations_operations, request, batch_size_attribute='pageSize', field='operations')