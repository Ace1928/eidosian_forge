...
def shuffle_and_repeat_dataset_v2_eager_fallback(input_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], buffer_size: _atypes.TensorFuzzingAnnotation[_atypes.Int64], seed: _atypes.TensorFuzzingAnnotation[_atypes.Int64], seed2: _atypes.TensorFuzzingAnnotation[_atypes.Int64], count: _atypes.TensorFuzzingAnnotation[_atypes.Int64], seed_generator: _atypes.TensorFuzzingAnnotation[_atypes.Resource], output_types, output_shapes, reshuffle_each_iteration: bool, metadata: str, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
    ...
    _attrs = ('reshuffle_each_iteration', reshuffle_each_iteration, 'output_types', output_types, 'output_shapes', output_shapes, 'metadata', metadata)
    _result = _execute.execute(b'ShuffleAndRepeatDatasetV2', 1, inputs=_inputs_flat, attrs=_attrs, ctx=ctx, name=name)
