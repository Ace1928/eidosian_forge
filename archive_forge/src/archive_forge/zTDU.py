...
class DualLogger:
    def __init__(self, name: str, file_level: int = logging.INFO, console_level: int = logging.DEBUG, formatter: FormatterType = None) -> None:
        self.logger: logging.Logger = logging.getLogger(name)
    ...
    def add_custom_formatter(self, formatter: FormatterType) -> None:
        ...
        formatted_message: str = custom_formatter.format(self.log)
