...
class TestMTurkAgent(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.turk_agent = MTurkAgent(self.opt.copy(), self.mturk_manager, TEST_HIT_ID_1, TEST_ASSIGNMENT_ID_1, TEST_WORKER_ID_1)
    ...
    def test_connection_id(self):
        ...
        """
        connection_id = '{}_{}'.format(self.turk_agent.worker_id, self.turk_agent.assignment_id)
