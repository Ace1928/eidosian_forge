...
class SetRotationSchedule(base.UpdateCommand):
  ...
  """
    ...
    def Run(self, args):
        ...
        req = messages.CloudkmsProjectsLocationsKeyRingsCryptoKeysPatchRequest(name=crypto_key_ref.RelativeName(), cryptoKey=messages.CryptoKey())
        ...
        if not fields_to_update:
            raise exceptions.ArgumentError('At least one of --next-rotation-time or --rotation-period must be specified.')
