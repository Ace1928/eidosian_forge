...
class AzureDDoSProtectionPlanInfo(AzureRMModuleBase):
    ...
    def __init__(self):
        ...
        self.name = None
        self.tags = None
        super(AzureDDoSProtectionPlanInfo, self).__init__(self.module_arg_spec, supports_check_mode=True, supports_tags=False)
    ...
    def exec_module(self, **kwargs):
        ...
        self.results['ddosprotectionplan'] = [self.ddos_protection_plan_to_dict(x) for x in results]
        return self.results
    ...
    def get(self):
        ...
        results = []
        try:
            response = self.network_client.ddos_protection_plans.get(self.resource_group, self.name)
    ...
    def list_resource_group(self):
        ...
        try:
            response = self.network_client.ddos_protection_plans.list_by_resource_group(self.resource_group)
