...
class Dice(Metric):
    ...
    @no_type_check
    def __init__(self, zero_division: int=0, num_classes: Optional[int]=None, threshold: float=0.5, average: Optional[Literal['micro', 'macro', 'none']]='micro', mdmc_average: Optional[str]='global', ignore_index: Optional[int]=None, top_k: Optional[int]=None, multiclass: Optional[bool]=None, **kwargs: Any) -> None:
    ...
    def update(self, preds: Tensor, target: Tensor) -> None:
        ...
        tp, fp, tn, fn = _stat_scores_update(preds, target, reduce=self.reduce, mdmc_reduce=self.mdmc_reduce, threshold=self.threshold, num_classes=self.num_classes, top_k=self.top_k, multiclass=self.multiclass, ignore_index=self.ignore_index)
