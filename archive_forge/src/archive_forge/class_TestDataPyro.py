...
class TestDataPyro:
    ...
    def test_inference_data(self, data, eight_schools_params, predictions_data):
        ...
        test_dict = {'posterior': ['mu', 'tau', 'eta'], 'sample_stats': ['diverging'], 'posterior_predictive': ['obs'], 'predictions': ['obs'], 'prior': ['mu', 'tau', 'eta'], 'prior_predictive': ['obs']}
