...
class SpecsMatcherTestCase(test_base.BaseTestCase):
    ...
    def test_specs_fails_with_op_sle(self):
        self._do_specs_matcher_test(value='1234', req='s<= 1000', matches=False)
    ...
    def test_specs_matches_with_op_in(self):
        self._do_specs_matcher_test(value='12311321', req='<in> 11', matches=True)

    def test_specs_matches_with_op_in2(self):
        self._do_specs_matcher_test(value='12311321', req='<in> 12311321', matches=True)
    ...
    def test_specs_fails_with_op_in2(self):
        self._do_specs_matcher_test(value='12310321', req='<in> 11 <in>', matches=False)

    def test_specs_matches_with_op_or(self):
        self._do_specs_matcher_test(value='12', req='<or> 11 <or> 12', matches=True)

    def test_specs_matches_with_op_or2(self):
        self._do_specs_matcher_test(value='12', req='<or> 11 <or> 12 <or>', matches=True)
    ...
    def test_specs_fails_with_op_or(self):
        self._do_specs_matcher_test(value='13', req='<or> 11 <or> 12', matches=False)
    ...
    def test_specs_matches_all_with_op_allin(self):
        self._do_specs_matcher_test(value=str(['aes', 'mmx', 'aux']), req='<all-in> aes mmx', matches=True)

    def test_specs_matches_one_with_op_allin(self):
        self._do_specs_matcher_test(value=str(['aes', 'mmx', 'aux']), req='<all-in> mmx', matches=True)
    ...
    def test_specs_fails_all_with_op_allin(self):
        self._do_specs_matcher_test(value=str(['aes', 'mmx', 'aux']), req='<all-in> txt 3dnow', matches=False)

    def test_specs_fails_match_one_with_op_allin(self):
        self._do_specs_matcher_test(value=str(['aes', 'mmx', 'aux']), req='<all-in> txt aes', matches=False)
    ...
    def test_specs_errors_list_with_op_allin(self):
        self.assertRaises(TypeError, specs_matcher.match, value=['aes', 'mmx', 'aux'], req='<all-in> aes')
    ...
    def test_specs_errors_dict_literal_with_op_allin(self):
        self.assertRaises(TypeError, specs_matcher.match, value=str({'aes': 1}), req='<all-in> aes')
    ...
    def test_specs_fails_bad_limits_with_op_rangein(self):
        self.assertRaises(TypeError, specs_matcher.match, value='23', req='<range-in> [ 20 10 ]')
    ...
    def test_specs_fails_match_under_scope_with_op_rangein_ge(self):
        self._do_specs_matcher_test(matches=False, value='5', req='<range-in> [ 10 20 ]')
    ...
    def test_specs_fails_matchesint_lower_int_range_with_op_rangein_gt(self):
        self._do_specs_matcher_test(matches=False, value='10', req='<range-in> ( 10 20 ]')
    ...
    def test_specs_fails_matche_float_lower_float_range_with_op_rangein_gt(self):
        self._do_specs_matcher_test(matches=False, value='10.1', req='<range-in> ( 10.1 20 ]')
    ...
    def test_specs_matches_float_upper_mixed_range_with_op_rangein(self):
        self._do_specs_matcher_test(matches=True, value='20.5', req='<range-in> [ 10 20.5 ]')
