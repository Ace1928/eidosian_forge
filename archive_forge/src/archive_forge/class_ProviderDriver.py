...
class ProviderDriver:
    ...
    def create_vip_port(self, loadbalancer_id, project_id, vip_dictionary, additional_vip_dicts):
        ...
        :raises NotImplementedError: The driver does not support creating VIP
                                     ports.
        """
        raise exceptions.NotImplementedError(user_fault_string='This provider does not support creating VIP ports.', operator_fault_string='This provider does not support creating VIP ports. Octavia will create it.')
    ...
    def pool_create(self, pool):
        ...
        :raises UnsupportedOptionError: if driver does not
          support one of the configuration options.
        """
        raise exceptions.NotImplementedError(user_fault_string='This provider does not support creating pools.', operator_fault_string='This provider does not support creating pools.')
    ...
    def pool_delete(self, pool):
        ...
        :raises NotImplementedError: if driver does not support request.
        """
        raise exceptions.NotImplementedError(user_fault_string='This provider does not support deleting pools.', operator_fault_string='This provider does not support deleting pools.')
    ...
    def pool_update(self, old_pool, new_pool):
        ...
        :raises UnsupportedOptionError: if driver does not
          support one of the configuration options.
        """
        raise exceptions.NotImplementedError(user_fault_string='This provider does not support updating pools.', operator_fault_string='This provider does not support updating pools.')
    ...
    def member_batch_update(self, pool_id, members):
        ...
        :raises UnsupportedOptionError: if driver does not
          support one of the configuration options.
        """
        raise exceptions.NotImplementedError(user_fault_string='This provider does not support batch updating members.', operator_fault_string='This provider does not support batch updating members.')
    ...
    def health_monitor_update(self, old_healthmonitor, new_healthmonitor):
        ...
        :raises UnsupportedOptionError: if driver does not
          support one of the configuration options.
        """
        raise exceptions.NotImplementedError(user_fault_string='This provider does not support updating health monitors.', operator_fault_string='This provider does not support updating health monitors.')
