...
class UniqueOperationTypesRule(SDLValidationRule):
    ...
    def __init__(self, context: SDLValidationContext):
        ...
        self.existing_operation_types: Dict[OperationType, Optional[GraphQLObjectType]] = {OperationType.QUERY: schema.query_type, OperationType.MUTATION: schema.mutation_type, OperationType.SUBSCRIPTION: schema.subscription_type} if schema else {}
        self.schema = schema
