...
class AsyncInferenceClient:
    ...
    def __init__(self, model: Optional[str]=None, token: Union[str, bool, None]=None, timeout: Optional[float]=None, headers: Optional[Dict[str, str]]=None, cookies: Optional[Dict[str, str]]=None) -> None:
    ...
    @overload
    async def post(self, *, json: Optional[Union[str, Dict, List]]=None, data: Optional[ContentT]=None, model: Optional[str]=None, task: Optional[str]=None, stream: Literal[False]=...) -> bytes:
        pass

    @overload
    async def post(self, *, json: Optional[Union[str, Dict, List]]=None, data: Optional[ContentT]=None, model: Optional[str]=None, task: Optional[str]=None, stream: Literal[True]=...) -> AsyncIterable[bytes]:
        pass

    async def post(self, *, json: Optional[Union[str, Dict, List]]=None, data: Optional[ContentT]=None, model: Optional[str]=None, task: Optional[str]=None, stream: bool=False) -> Union[bytes, AsyncIterable[bytes]]:
        """
        ...
        while True:
            with _open_as_binary(data) as data_as_binary:
                client = aiohttp.ClientSession(headers=headers, cookies=self.cookies, timeout=aiohttp.ClientTimeout(self.timeout))
                try:
                    ...
                    if response.status == 503:
                        if timeout is not None and time.time() - t0 > timeout:
                            raise InferenceTimeoutError(f'Model not loaded on the server: {url}. Please retry with a higher timeout (current: {self.timeout}).', request=error.request, response=error.response) from error
                        logger.info(f'Waiting for model to be loaded on the server: {error}')
                        time.sleep(1)
                        if timeout is not None:
                            timeout = max(self.timeout - (time.time() - t0), 1)
                        continue
                    raise error

    async def audio_classification(self, audio: ContentT, *, model: Optional[str]=None) -> List[ClassificationOutput]:
        """
    ...
    async def audio_to_audio(self, audio: ContentT, *, model: Optional[str]=None) -> List[AudioToAudioOutput]:
        """
    ...
    async def automatic_speech_recognition(self, audio: ContentT, *, model: Optional[str]=None) -> str:
        """
    ...
    async def conversational(self, text: str, generated_responses: Optional[List[str]]=None, past_user_inputs: Optional[List[str]]=None, *, parameters: Optional[Dict[str, Any]]=None, model: Optional[str]=None) -> ConversationalOutput:
        """
    ...
    async def document_question_answering(self, image: ContentT, question: str, *, model: Optional[str]=None) -> List[QuestionAnsweringOutput]:
        """
    ...
    async def image_classification(self, image: ContentT, *, model: Optional[str]=None) -> List[ClassificationOutput]:
        """
    ...
    async def image_segmentation(self, image: ContentT, *, model: Optional[str]=None) -> List[ImageSegmentationOutput]:
        """
    ...
    async def image_to_image(self, image: ContentT, prompt: Optional[str]=None, *, negative_prompt: Optional[str]=None, height: Optional[int]=None, width: Optional[int]=None, num_inference_steps: Optional[int]=None, guidance_scale: Optional[float]=None, model: Optional[str]=None, **kwargs) -> 'Image':
        """
    ...
    async def list_deployed_models(self, frameworks: Union[None, str, Literal['all'], List[str]]=None) -> Dict[str, List[str]]:
        """
    ...
    async def object_detection(self, image: ContentT, *, model: Optional[str]=None) -> List[ObjectDetectionOutput]:
        """
    ...
    async def question_answering(self, question: str, context: str, *, model: Optional[str]=None) -> QuestionAnsweringOutput:
        """
        ...
        response = await self.post(json=payload, model=model, task='question-answering')
        return _bytes_to_dict(response)

    async def sentence_similarity(self, sentence: str, other_sentences: List[str], *, model: Optional[str]=None) -> List[float]:
        """
        ...
        ```
        """
        response = await self.post(json={'inputs': {'source_sentence': sentence, 'sentences': other_sentences}}, model=model, task='sentence-similarity')
        return _bytes_to_list(response)

    async def summarization(self, text: str, *, parameters: Optional[Dict[str, Any]]=None, model: Optional[str]=None) -> str:
        """
    ...
    async def table_question_answering(self, table: Dict[str, Any], query: str, *, model: Optional[str]=None) -> TableQuestionAnsweringOutput:
        """
        ...
        ```
        """
        response = await self.post(json={'query': query, 'table': table}, model=model, task='table-question-answering')
        return _bytes_to_dict(response)
    ...
    @overload
    async def text_generation(self, prompt: str, *, details: Literal[False]=..., stream: Literal[False]=..., model: Optional[str]=None, do_sample: bool=False, max_new_tokens: int=20, best_of: Optional[int]=None, repetition_penalty: Optional[float]=None, return_full_text: bool=False, seed: Optional[int]=None, stop_sequences: Optional[List[str]]=None, temperature: Optional[float]=None, top_k: Optional[int]=None, top_p: Optional[float]=None, truncate: Optional[int]=None, typical_p: Optional[float]=None, watermark: bool=False) -> str:
        ...

    @overload
    async def text_generation(self, prompt: str, *, details: Literal[True]=..., stream: Literal[False]=..., model: Optional[str]=None, do_sample: bool=False, max_new_tokens: int=20, best_of: Optional[int]=None, repetition_penalty: Optional[float]=None, return_full_text: bool=False, seed: Optional[int]=None, stop_sequences: Optional[List[str]]=None, temperature: Optional[float]=None, top_k: Optional[int]=None, top_p: Optional[float]=None, truncate: Optional[int]=None, typical_p: Optional[float]=None, watermark: bool=False) -> TextGenerationResponse:
        ...

    @overload
    async def text_generation(self, prompt: str, *, details: Literal[False]=..., stream: Literal[True]=..., model: Optional[str]=None, do_sample: bool=False, max_new_tokens: int=20, best_of: Optional[int]=None, repetition_penalty: Optional[float]=None, return_full_text: bool=False, seed: Optional[int]=None, stop_sequences: Optional[List[str]]=None, temperature: Optional[float]=None, top_k: Optional[int]=None, top_p: Optional[float]=None, truncate: Optional[int]=None, typical_p: Optional[float]=None, watermark: bool=False) -> AsyncIterable[str]:
        ...

    @overload
    async def text_generation(self, prompt: str, *, details: Literal[True]=..., stream: Literal[True]=..., model: Optional[str]=None, do_sample: bool=False, max_new_tokens: int=20, best_of: Optional[int]=None, repetition_penalty: Optional[float]=None, return_full_text: bool=False, seed: Optional[int]=None, stop_sequences: Optional[List[str]]=None, temperature: Optional[float]=None, top_k: Optional[int]=None, top_p: Optional[float]=None, truncate: Optional[int]=None, typical_p: Optional[float]=None, watermark: bool=False) -> AsyncIterable[TextGenerationStreamResponse]:
        ...

    async def text_generation(self, prompt: str, *, details: bool=False, stream: bool=False, model: Optional[str]=None, do_sample: bool=False, max_new_tokens: int=20, best_of: Optional[int]=None, repetition_penalty: Optional[float]=None, return_full_text: bool=False, seed: Optional[int]=None, stop_sequences: Optional[List[str]]=None, temperature: Optional[float]=None, top_k: Optional[int]=None, top_p: Optional[float]=None, truncate: Optional[int]=None, typical_p: Optional[float]=None, watermark: bool=False, decoder_input_details: bool=False) -> Union[str, TextGenerationResponse, AsyncIterable[str], AsyncIterable[TextGenerationStreamResponse]]:
        """
    ...
    async def text_to_image(self, prompt: str, *, negative_prompt: Optional[str]=None, height: Optional[float]=None, width: Optional[float]=None, num_inference_steps: Optional[float]=None, guidance_scale: Optional[float]=None, model: Optional[str]=None, **kwargs) -> 'Image':
        """
    ...
    async def token_classification(self, text: str, *, model: Optional[str]=None) -> List[TokenClassificationOutput]:
        ...
        """
        payload: Dict[str, Any] = {'inputs': text}
        response = await self.post(json=payload, model=model, task='token-classification')
        return _bytes_to_list(response)

    async def translation(self, text: str, *, model: Optional[str]=None, src_lang: Optional[str]=None, tgt_lang: Optional[str]=None) -> str:
        """
    ...
    async def zero_shot_classification(self, text: str, labels: List[str], *, multi_label: bool=False, model: Optional[str]=None) -> List[ClassificationOutput]:
        """
        ...
        response = await self.post(json={'inputs': text, 'parameters': {'candidate_labels': ','.join(labels), 'multi_label': multi_label}}, model=model, task='zero-shot-classification')
        output = _bytes_to_dict(response)
        return [{'label': label, 'score': score} for label, score in zip(output['labels'], output['scores'])]

    async def zero_shot_image_classification(self, image: ContentT, labels: List[str], *, model: Optional[str]=None) -> List[ClassificationOutput]:
        """
        ...
        if len(labels) < 2:
            raise ValueError('You must specify at least 2 classes to compare.')
        response = await self.post(json={'image': _b64_encode(image), 'parameters': {'candidate_labels': ','.join(labels)}}, model=model, task='zero-shot-image-classification')
        return _bytes_to_list(response)
