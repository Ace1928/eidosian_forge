...
def to_time(arg, format: str | None=None, infer_time_format: bool=False, errors: DateTimeErrorChoices='raise'):
    ...
    """
    if errors == 'ignore':
        warnings.warn("errors='ignore' is deprecated and will raise in a future version. Use to_time without passing `errors` and catch exceptions explicitly instead", FutureWarning, stacklevel=find_stack_level())
