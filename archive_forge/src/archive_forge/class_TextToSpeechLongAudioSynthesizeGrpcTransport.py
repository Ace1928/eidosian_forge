...
class TextToSpeechLongAudioSynthesizeGrpcTransport(TextToSpeechLongAudioSynthesizeTransport):
    ...
    def synthesize_long_audio(self) -> Callable[[cloud_tts_lrs.SynthesizeLongAudioRequest], operations_pb2.Operation]:
        """Return a callable for the synthesize long audio method over gRPC.
        ...
        if 'synthesize_long_audio' not in self._stubs:
            self._stubs['synthesize_long_audio'] = self.grpc_channel.unary_unary('/google.cloud.texttospeech.v1.TextToSpeechLongAudioSynthesize/SynthesizeLongAudio', request_serializer=cloud_tts_lrs.SynthesizeLongAudioRequest.serialize, response_deserializer=operations_pb2.Operation.FromString)
