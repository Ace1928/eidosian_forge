...
class ParamViewer(Component):
    ...
    """
    EVENTS = [Events.change, Events.upload]

    def __init__(self, value: dict[str, Parameter] | None=None, language: Literal['python', 'typescript']='python', linkify: list[str] | None=None, every: float | None=None, render: bool=True):
        """
        Parameters:
        ...
        super().__init__(every=every, value=value, render=render)
