...
def IsThirdPartyUser():
    ...
    return creds_type in (c_creds.CredentialTypeGoogleAuth.EXTERNAL_ACCOUNT, c_creds.CredentialTypeGoogleAuth.EXTERNAL_ACCOUNT_USER, c_creds.CredentialTypeGoogleAuth.EXTERNAL_ACCOUNT_AUTHORIZED_USER)