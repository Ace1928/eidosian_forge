...
def add_required_signatures(self) -> None:
    """
        ...
        """
    headers, data = self._requester.requestJsonAndCheck('POST', f'{self.protection_url}/required_signatures', headers={'Accept': Consts.signaturesProtectedBranchesPreview})