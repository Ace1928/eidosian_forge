...
class RestOME(object):
    ...
    def _url_common_args_spec(self, method, api_timeout, headers=None):
        ...
        url_kwargs = {'method': method, 'validate_certs': self.validate_certs, 'ca_path': self.ca_path, 'use_proxy': True, 'headers': req_header, 'timeout': api_timeout, 'follow_redirects': 'all'}
        return url_kwargs
    ...
    def get_job_info(self, job_id):
        try:
            job_status_map = {2020: 'Scheduled', 2030: 'Queued', 2040: 'Starting', 2050: 'Running', 2060: 'Completed', 2070: 'Failed', 2090: 'Warning', 2080: 'New', 2100: 'Aborted', 2101: 'Paused', 2102: 'Stopped', 2103: 'Canceled'}
