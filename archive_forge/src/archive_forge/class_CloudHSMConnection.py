...
class CloudHSMConnection(AWSQueryConnection):
    ...
    _faults = {'InvalidRequestException': exceptions.InvalidRequestException, 'CloudHsmServiceException': exceptions.CloudHsmServiceException, 'CloudHsmInternalException': exceptions.CloudHsmInternalException}
