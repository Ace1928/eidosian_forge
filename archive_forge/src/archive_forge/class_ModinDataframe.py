...
class ModinDataframe(ABC):
    ...
    @abstractmethod
    def take_2d_labels_or_positional(self, row_labels: Optional[List[Hashable]]=None, row_positions: Optional[List[int]]=None, col_labels: Optional[List[Hashable]]=None, col_positions: Optional[List[int]]=None) -> 'ModinDataframe':
        """
    ...
    @abstractmethod
    def map(self, function: Callable, axis: Optional[Union[int, Axis]]=None, dtypes: Optional[str]=None, new_columns: Optional[List[Hashable]]=None) -> 'ModinDataframe':
        """
    ...
    @abstractmethod
    def explode(self, axis: Union[int, Axis], function: Callable, result_schema: Optional[Dict[Hashable, type]]=None) -> 'ModinDataframe':
        """
    ...
    @abstractmethod
    def window(self, axis: Union[int, Axis], reduce_fn: Callable, window_size: int, result_schema: Optional[Dict[Hashable, type]]=None) -> 'ModinDataframe':
        """
    ...
    @abstractmethod
    def groupby(self, axis: Union[int, Axis], by: Union[str, List[str]], operator: Callable, result_schema: Optional[Dict[Hashable, type]]=None) -> 'ModinDataframe':
        """
    ...
    @abstractmethod
    def reduce(self, axis: Union[int, Axis], function: Callable, dtypes: Optional[str]=None) -> 'ModinDataframe':
        """
    ...
    @abstractmethod
    def join(self, axis: Union[int, Axis], condition: Callable, other: 'ModinDataframe', join_type: Union[str, JoinType]) -> 'ModinDataframe':
        """
    ...
    @abstractmethod
    def concat(self, axis: Union[int, Axis], others: Union['ModinDataframe', List['ModinDataframe']]) -> 'ModinDataframe':
        """
    ...
    @abstractmethod
    def rename(self, new_row_labels: Optional[Union[Dict[Hashable, Hashable], Callable]]=None, new_col_labels: Optional[Union[Dict[Hashable, Hashable], Callable]]=None) -> 'ModinDataframe':
        """
    ...
    @abstractmethod
    def sort_by(self, axis: Union[int, Axis], labels: Union[str, List[str]], ascending: bool=True) -> 'ModinDataframe':
        """
