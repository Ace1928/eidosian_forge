...
class ChannelTests(TestCase):
    ...
    def test_str(self) -> None:
        ...
        self.assertEqual(str(channel.SSHChannel(localWindow=1)), '<SSHChannel None (lw 1 rw 0)>')
    ...
    def test_bytes(self) -> None:
        ...
        """
        self.assertEqual(self.channel.__bytes__(), b'<SSHChannel channel (lw 131072 rw 0)>')
        self.assertEqual(channel.SSHChannel(localWindow=1).__bytes__(), b'<SSHChannel None (lw 1 rw 0)>')
    ...
    def test_logPrefix(self) -> None:
        ...
        """
        self.assertEqual(self.channel.logPrefix(), 'SSHChannel channel (unknown) on MockConnection')
    ...
    def test_loseConnection(self) -> None:
        ...
        self.channel.addWindowBytes(4)
        self.assertIsNone(self.conn.closes.get(self.channel))
        self.channel.addWindowBytes(8)
