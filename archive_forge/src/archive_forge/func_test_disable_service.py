...
def test_disable_service(self):
    self._verify('openstack.block_storage.v3.service.Service.disable', self.proxy.disable_service, method_args=['value'], expected_kwargs={'reason': None}, expected_args=[self.proxy])