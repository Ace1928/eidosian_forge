...
class Game(ShowBase):
    def __init__(self):
        ...
        self.globalClock.set_mode(0)
        self.globalClock.set_frame_rate(60)
        self.globalClock.set_frame_rate_variable(True)
        self.globalClock.set_frame_rate_variable_min(30)
        self.globalClock.set_frame_rate_variable_max(120)
