...
def test_refresh_impersonation_with_lifetime(self):
    ...
    impersonation_request_data = {'delegates': None, 'scope': self.SCOPES, 'lifetime': '2800s'}
    ...
    credentials = self.make_credentials(service_account_impersonation_url=self.SERVICE_ACCOUNT_IMPERSONATION_URL, service_account_impersonation_options={'token_lifetime_seconds': 2800}, scopes=self.SCOPES)
