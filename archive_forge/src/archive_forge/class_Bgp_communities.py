...
class Bgp_communities(ConfigBase):
    ...
    gather_network_resources = ['bgp_communities']
    standard_communities_map = {'no_peer': 'NOPEER', 'no_export': 'NO_EXPORT', 'no_advertise': 'NO_ADVERTISE', 'local_as': 'NO_EXPORT_SUBCONFED'}
