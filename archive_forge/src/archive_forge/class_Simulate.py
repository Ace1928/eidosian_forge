...
class Simulate(base.Command):
  ...
  """
    ...
    def Run(self, args):
        ...
        custom_config = parsing.GetCustomConfigFromArgs(args.custom_config_from_file)
        resource = parsing.GetTestResourceFromArgs(args.resource_from_file)
        client = clients.SHACustomModuleClient()
        return client.Simulate(parent=parent, custom_config=custom_config, resource=resource)