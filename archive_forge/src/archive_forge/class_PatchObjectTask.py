...
class PatchObjectTask(task.Task):
    ...
    def __init__(self, object_resource, posix_to_set=None, user_request_args=None):
        """Initializes task.
    ...
    def execute(self, task_status_queue=None):
        ...
        api_factory.get_api(provider).patch_object_metadata(self._object_resource.storage_url.bucket_name, self._object_resource.storage_url.object_name, self._object_resource, request_config=request_config, posix_to_set=self._posix_to_set)
    ...
    def __eq__(self, other):
        ...
        return self._object_resource == other._object_resource and self._posix_to_set == other._posix_to_set and (self._user_request_args == other._user_request_args)