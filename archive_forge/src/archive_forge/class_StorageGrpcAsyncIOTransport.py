...
class StorageGrpcAsyncIOTransport(StorageTransport):
    ...
    def __init__(self, *, host: str='storage.googleapis.com', credentials: Optional[ga_credentials.Credentials]=None, credentials_file: Optional[str]=None, scopes: Optional[Sequence[str]]=None, channel: Optional[aio.Channel]=None, api_mtls_endpoint: Optional[str]=None, client_cert_source: Optional[Callable[[], Tuple[bytes, bytes]]]=None, ssl_channel_credentials: Optional[grpc.ChannelCredentials]=None, client_cert_source_for_mtls: Optional[Callable[[], Tuple[bytes, bytes]]]=None, quota_project_id: Optional[str]=None, client_info: gapic_v1.client_info.ClientInfo=DEFAULT_CLIENT_INFO, always_use_jwt_access: Optional[bool]=False, api_audience: Optional[str]=None) -> None:
    ...
    @property
    def delete_bucket(self) -> Callable[[storage.DeleteBucketRequest], Awaitable[empty_pb2.Empty]]:
        ...
        if 'delete_bucket' not in self._stubs:
            self._stubs['delete_bucket'] = self.grpc_channel.unary_unary('/google.storage.v2.Storage/DeleteBucket', request_serializer=storage.DeleteBucketRequest.serialize, response_deserializer=empty_pb2.Empty.FromString)
        return self._stubs['delete_bucket']

    @property
    def get_bucket(self) -> Callable[[storage.GetBucketRequest], Awaitable[storage.Bucket]]:
        ...
        if 'get_bucket' not in self._stubs:
            self._stubs['get_bucket'] = self.grpc_channel.unary_unary('/google.storage.v2.Storage/GetBucket', request_serializer=storage.GetBucketRequest.serialize, response_deserializer=storage.Bucket.deserialize)
        return self._stubs['get_bucket']

    @property
    def create_bucket(self) -> Callable[[storage.CreateBucketRequest], Awaitable[storage.Bucket]]:
        ...
        if 'create_bucket' not in self._stubs:
            self._stubs['create_bucket'] = self.grpc_channel.unary_unary('/google.storage.v2.Storage/CreateBucket', request_serializer=storage.CreateBucketRequest.serialize, response_deserializer=storage.Bucket.deserialize)
        return self._stubs['create_bucket']

    @property
    def list_buckets(self) -> Callable[[storage.ListBucketsRequest], Awaitable[storage.ListBucketsResponse]]:
        ...
        if 'list_buckets' not in self._stubs:
            self._stubs['list_buckets'] = self.grpc_channel.unary_unary('/google.storage.v2.Storage/ListBuckets', request_serializer=storage.ListBucketsRequest.serialize, response_deserializer=storage.ListBucketsResponse.deserialize)
        return self._stubs['list_buckets']

    @property
    def lock_bucket_retention_policy(self) -> Callable[[storage.LockBucketRetentionPolicyRequest], Awaitable[storage.Bucket]]:
        """Return a callable for the lock bucket retention policy method over gRPC.
        ...
        if 'lock_bucket_retention_policy' not in self._stubs:
            self._stubs['lock_bucket_retention_policy'] = self.grpc_channel.unary_unary('/google.storage.v2.Storage/LockBucketRetentionPolicy', request_serializer=storage.LockBucketRetentionPolicyRequest.serialize, response_deserializer=storage.Bucket.deserialize)
    ...
    def get_iam_policy(self) -> Callable[[iam_policy_pb2.GetIamPolicyRequest], Awaitable[policy_pb2.Policy]]:
        ...
        if 'get_iam_policy' not in self._stubs:
            self._stubs['get_iam_policy'] = self.grpc_channel.unary_unary('/google.storage.v2.Storage/GetIamPolicy', request_serializer=iam_policy_pb2.GetIamPolicyRequest.SerializeToString, response_deserializer=policy_pb2.Policy.FromString)
        return self._stubs['get_iam_policy']

    @property
    def set_iam_policy(self) -> Callable[[iam_policy_pb2.SetIamPolicyRequest], Awaitable[policy_pb2.Policy]]:
        """Return a callable for the set iam policy method over gRPC.
        ...
        if 'set_iam_policy' not in self._stubs:
            self._stubs['set_iam_policy'] = self.grpc_channel.unary_unary('/google.storage.v2.Storage/SetIamPolicy', request_serializer=iam_policy_pb2.SetIamPolicyRequest.SerializeToString, response_deserializer=policy_pb2.Policy.FromString)
    ...
    def test_iam_permissions(self) -> Callable[[iam_policy_pb2.TestIamPermissionsRequest], Awaitable[iam_policy_pb2.TestIamPermissionsResponse]]:
        ...
        if 'test_iam_permissions' not in self._stubs:
            self._stubs['test_iam_permissions'] = self.grpc_channel.unary_unary('/google.storage.v2.Storage/TestIamPermissions', request_serializer=iam_policy_pb2.TestIamPermissionsRequest.SerializeToString, response_deserializer=iam_policy_pb2.TestIamPermissionsResponse.FromString)
        return self._stubs['test_iam_permissions']

    @property
    def update_bucket(self) -> Callable[[storage.UpdateBucketRequest], Awaitable[storage.Bucket]]:
        ...
        if 'update_bucket' not in self._stubs:
            self._stubs['update_bucket'] = self.grpc_channel.unary_unary('/google.storage.v2.Storage/UpdateBucket', request_serializer=storage.UpdateBucketRequest.serialize, response_deserializer=storage.Bucket.deserialize)
        return self._stubs['update_bucket']

    @property
    def compose_object(self) -> Callable[[storage.ComposeObjectRequest], Awaitable[storage.Object]]:
        """Return a callable for the compose object method over gRPC.
        ...
        if 'compose_object' not in self._stubs:
            self._stubs['compose_object'] = self.grpc_channel.unary_unary('/google.storage.v2.Storage/ComposeObject', request_serializer=storage.ComposeObjectRequest.serialize, response_deserializer=storage.Object.deserialize)
        return self._stubs['compose_object']

    @property
    def delete_object(self) -> Callable[[storage.DeleteObjectRequest], Awaitable[empty_pb2.Empty]]:
        """Return a callable for the delete object method over gRPC.
        ...
        if 'delete_object' not in self._stubs:
            self._stubs['delete_object'] = self.grpc_channel.unary_unary('/google.storage.v2.Storage/DeleteObject', request_serializer=storage.DeleteObjectRequest.serialize, response_deserializer=empty_pb2.Empty.FromString)
        return self._stubs['delete_object']

    @property
    def restore_object(self) -> Callable[[storage.RestoreObjectRequest], Awaitable[storage.Object]]:
        """Return a callable for the restore object method over gRPC.
        ...
        if 'restore_object' not in self._stubs:
            self._stubs['restore_object'] = self.grpc_channel.unary_unary('/google.storage.v2.Storage/RestoreObject', request_serializer=storage.RestoreObjectRequest.serialize, response_deserializer=storage.Object.deserialize)
        return self._stubs['restore_object']

    @property
    def cancel_resumable_write(self) -> Callable[[storage.CancelResumableWriteRequest], Awaitable[storage.CancelResumableWriteResponse]]:
        """Return a callable for the cancel resumable write method over gRPC.
        ...
        if 'cancel_resumable_write' not in self._stubs:
            self._stubs['cancel_resumable_write'] = self.grpc_channel.unary_unary('/google.storage.v2.Storage/CancelResumableWrite', request_serializer=storage.CancelResumableWriteRequest.serialize, response_deserializer=storage.CancelResumableWriteResponse.deserialize)
        return self._stubs['cancel_resumable_write']

    @property
    def get_object(self) -> Callable[[storage.GetObjectRequest], Awaitable[storage.Object]]:
        """Return a callable for the get object method over gRPC.
        ...
        if 'get_object' not in self._stubs:
            self._stubs['get_object'] = self.grpc_channel.unary_unary('/google.storage.v2.Storage/GetObject', request_serializer=storage.GetObjectRequest.serialize, response_deserializer=storage.Object.deserialize)
        return self._stubs['get_object']

    @property
    def read_object(self) -> Callable[[storage.ReadObjectRequest], Awaitable[storage.ReadObjectResponse]]:
        """Return a callable for the read object method over gRPC.
        ...
        if 'read_object' not in self._stubs:
            self._stubs['read_object'] = self.grpc_channel.unary_stream('/google.storage.v2.Storage/ReadObject', request_serializer=storage.ReadObjectRequest.serialize, response_deserializer=storage.ReadObjectResponse.deserialize)
        return self._stubs['read_object']

    @property
    def update_object(self) -> Callable[[storage.UpdateObjectRequest], Awaitable[storage.Object]]:
        """Return a callable for the update object method over gRPC.
        ...
        if 'update_object' not in self._stubs:
            self._stubs['update_object'] = self.grpc_channel.unary_unary('/google.storage.v2.Storage/UpdateObject', request_serializer=storage.UpdateObjectRequest.serialize, response_deserializer=storage.Object.deserialize)
        return self._stubs['update_object']

    @property
    def write_object(self) -> Callable[[storage.WriteObjectRequest], Awaitable[storage.WriteObjectResponse]]:
        """Return a callable for the write object method over gRPC.
        ...
        if 'write_object' not in self._stubs:
            self._stubs['write_object'] = self.grpc_channel.stream_unary('/google.storage.v2.Storage/WriteObject', request_serializer=storage.WriteObjectRequest.serialize, response_deserializer=storage.WriteObjectResponse.deserialize)
        return self._stubs['write_object']

    @property
    def bidi_write_object(self) -> Callable[[storage.BidiWriteObjectRequest], Awaitable[storage.BidiWriteObjectResponse]]:
        """Return a callable for the bidi write object method over gRPC.
        ...
        if 'bidi_write_object' not in self._stubs:
            self._stubs['bidi_write_object'] = self.grpc_channel.stream_stream('/google.storage.v2.Storage/BidiWriteObject', request_serializer=storage.BidiWriteObjectRequest.serialize, response_deserializer=storage.BidiWriteObjectResponse.deserialize)
        return self._stubs['bidi_write_object']

    @property
    def list_objects(self) -> Callable[[storage.ListObjectsRequest], Awaitable[storage.ListObjectsResponse]]:
        """Return a callable for the list objects method over gRPC.
        ...
        if 'list_objects' not in self._stubs:
            self._stubs['list_objects'] = self.grpc_channel.unary_unary('/google.storage.v2.Storage/ListObjects', request_serializer=storage.ListObjectsRequest.serialize, response_deserializer=storage.ListObjectsResponse.deserialize)
        return self._stubs['list_objects']

    @property
    def rewrite_object(self) -> Callable[[storage.RewriteObjectRequest], Awaitable[storage.RewriteResponse]]:
        """Return a callable for the rewrite object method over gRPC.
        ...
        if 'rewrite_object' not in self._stubs:
            self._stubs['rewrite_object'] = self.grpc_channel.unary_unary('/google.storage.v2.Storage/RewriteObject', request_serializer=storage.RewriteObjectRequest.serialize, response_deserializer=storage.RewriteResponse.deserialize)
        return self._stubs['rewrite_object']

    @property
    def start_resumable_write(self) -> Callable[[storage.StartResumableWriteRequest], Awaitable[storage.StartResumableWriteResponse]]:
        """Return a callable for the start resumable write method over gRPC.
        ...
        if 'start_resumable_write' not in self._stubs:
            self._stubs['start_resumable_write'] = self.grpc_channel.unary_unary('/google.storage.v2.Storage/StartResumableWrite', request_serializer=storage.StartResumableWriteRequest.serialize, response_deserializer=storage.StartResumableWriteResponse.deserialize)
        return self._stubs['start_resumable_write']

    @property
    def query_write_status(self) -> Callable[[storage.QueryWriteStatusRequest], Awaitable[storage.QueryWriteStatusResponse]]:
        """Return a callable for the query write status method over gRPC.
        ...
        if 'query_write_status' not in self._stubs:
            self._stubs['query_write_status'] = self.grpc_channel.unary_unary('/google.storage.v2.Storage/QueryWriteStatus', request_serializer=storage.QueryWriteStatusRequest.serialize, response_deserializer=storage.QueryWriteStatusResponse.deserialize)
        return self._stubs['query_write_status']

    @property
    def get_service_account(self) -> Callable[[storage.GetServiceAccountRequest], Awaitable[storage.ServiceAccount]]:
        """Return a callable for the get service account method over gRPC.
        ...
        if 'get_service_account' not in self._stubs:
            self._stubs['get_service_account'] = self.grpc_channel.unary_unary('/google.storage.v2.Storage/GetServiceAccount', request_serializer=storage.GetServiceAccountRequest.serialize, response_deserializer=storage.ServiceAccount.deserialize)
        return self._stubs['get_service_account']

    @property
    def create_hmac_key(self) -> Callable[[storage.CreateHmacKeyRequest], Awaitable[storage.CreateHmacKeyResponse]]:
        """Return a callable for the create hmac key method over gRPC.
        ...
        if 'create_hmac_key' not in self._stubs:
            self._stubs['create_hmac_key'] = self.grpc_channel.unary_unary('/google.storage.v2.Storage/CreateHmacKey', request_serializer=storage.CreateHmacKeyRequest.serialize, response_deserializer=storage.CreateHmacKeyResponse.deserialize)
        return self._stubs['create_hmac_key']

    @property
    def delete_hmac_key(self) -> Callable[[storage.DeleteHmacKeyRequest], Awaitable[empty_pb2.Empty]]:
        """Return a callable for the delete hmac key method over gRPC.
        ...
        if 'delete_hmac_key' not in self._stubs:
            self._stubs['delete_hmac_key'] = self.grpc_channel.unary_unary('/google.storage.v2.Storage/DeleteHmacKey', request_serializer=storage.DeleteHmacKeyRequest.serialize, response_deserializer=empty_pb2.Empty.FromString)
        return self._stubs['delete_hmac_key']

    @property
    def get_hmac_key(self) -> Callable[[storage.GetHmacKeyRequest], Awaitable[storage.HmacKeyMetadata]]:
        """Return a callable for the get hmac key method over gRPC.
        ...
        if 'get_hmac_key' not in self._stubs:
            self._stubs['get_hmac_key'] = self.grpc_channel.unary_unary('/google.storage.v2.Storage/GetHmacKey', request_serializer=storage.GetHmacKeyRequest.serialize, response_deserializer=storage.HmacKeyMetadata.deserialize)
        return self._stubs['get_hmac_key']

    @property
    def list_hmac_keys(self) -> Callable[[storage.ListHmacKeysRequest], Awaitable[storage.ListHmacKeysResponse]]:
        """Return a callable for the list hmac keys method over gRPC.
        ...
        if 'list_hmac_keys' not in self._stubs:
            self._stubs['list_hmac_keys'] = self.grpc_channel.unary_unary('/google.storage.v2.Storage/ListHmacKeys', request_serializer=storage.ListHmacKeysRequest.serialize, response_deserializer=storage.ListHmacKeysResponse.deserialize)
        return self._stubs['list_hmac_keys']

    @property
    def update_hmac_key(self) -> Callable[[storage.UpdateHmacKeyRequest], Awaitable[storage.HmacKeyMetadata]]:
        """Return a callable for the update hmac key method over gRPC.
        ...
        if 'update_hmac_key' not in self._stubs:
            self._stubs['update_hmac_key'] = self.grpc_channel.unary_unary('/google.storage.v2.Storage/UpdateHmacKey', request_serializer=storage.UpdateHmacKeyRequest.serialize, response_deserializer=storage.HmacKeyMetadata.deserialize)
        return self._stubs['update_hmac_key']

    @property
    def delete_notification_config(self) -> Callable[[storage.DeleteNotificationConfigRequest], Awaitable[empty_pb2.Empty]]:
        """Return a callable for the delete notification config method over gRPC.
        ...
        if 'delete_notification_config' not in self._stubs:
            self._stubs['delete_notification_config'] = self.grpc_channel.unary_unary('/google.storage.v2.Storage/DeleteNotificationConfig', request_serializer=storage.DeleteNotificationConfigRequest.serialize, response_deserializer=empty_pb2.Empty.FromString)
        return self._stubs['delete_notification_config']

    @property
    def get_notification_config(self) -> Callable[[storage.GetNotificationConfigRequest], Awaitable[storage.NotificationConfig]]:
        """Return a callable for the get notification config method over gRPC.
        ...
        if 'get_notification_config' not in self._stubs:
            self._stubs['get_notification_config'] = self.grpc_channel.unary_unary('/google.storage.v2.Storage/GetNotificationConfig', request_serializer=storage.GetNotificationConfigRequest.serialize, response_deserializer=storage.NotificationConfig.deserialize)
        return self._stubs['get_notification_config']

    @property
    def create_notification_config(self) -> Callable[[storage.CreateNotificationConfigRequest], Awaitable[storage.NotificationConfig]]:
        """Return a callable for the create notification config method over gRPC.
        ...
        if 'create_notification_config' not in self._stubs:
            self._stubs['create_notification_config'] = self.grpc_channel.unary_unary('/google.storage.v2.Storage/CreateNotificationConfig', request_serializer=storage.CreateNotificationConfigRequest.serialize, response_deserializer=storage.NotificationConfig.deserialize)
        return self._stubs['create_notification_config']

    @property
    def list_notification_configs(self) -> Callable[[storage.ListNotificationConfigsRequest], Awaitable[storage.ListNotificationConfigsResponse]]:
        ...
        if 'list_notification_configs' not in self._stubs:
            self._stubs['list_notification_configs'] = self.grpc_channel.unary_unary('/google.storage.v2.Storage/ListNotificationConfigs', request_serializer=storage.ListNotificationConfigsRequest.serialize, response_deserializer=storage.ListNotificationConfigsResponse.deserialize)
