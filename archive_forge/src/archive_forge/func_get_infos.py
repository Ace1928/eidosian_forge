...
def get_infos(self, indices: Union[int, List[int]]=-1, global_ts: bool=True, as_list: bool=False) -> Union[MultiAgentDict, List[MultiAgentDict]]:
    """Gets infos for all agents that stepped in the last timesteps.
        ...
        """
    return self._getattr_by_index('infos', indices, has_initial_value=True, global_ts=global_ts, as_list=as_list)