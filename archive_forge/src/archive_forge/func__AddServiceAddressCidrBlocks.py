...
def _AddServiceAddressCidrBlocks(vmware_network_config_group, for_update=False):
  ...
  """
    ...
    if for_update:
        return
    vmware_network_config_group.add_argument('--service-address-cidr-blocks', metavar='SERVICE_ADDRESS', type=arg_parsers.ArgList(min_length=1, max_length=1), required=required, help='IPv4 address range for all services in the cluster.')