...
class AreaToZeroAxis1XConstant(AreaToZeroAxis1):
    ...
    def _build_extend(self, x_mapper, y_mapper, info, append, _antialias_stage_2, _antialias_stage_2_funcs):
        ...
        extend_cpu, extend_cuda = _build_extend_area_to_zero_axis1_x_constant(draw_trapezoid_y, expand_aggs_and_cols)
        x_values = self.x
        y_names = self.y
        ...
        def extend(aggs, df, vt, bounds, plot_start=True):
            ...
            do_extend(sx, tx, sy, ty, xmin, xmax, ymin, ymax, x_values, ys, *aggs_and_cols)
        return extend