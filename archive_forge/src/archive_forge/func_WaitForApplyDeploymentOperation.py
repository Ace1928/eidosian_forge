...
def WaitForApplyDeploymentOperation(operation, progress_message='Applying the deployment'):
  ...
  """
    ...
    poller = waiter.CloudOperationPoller(client.projects_locations_deployments, client.projects_locations_operations)
    ...
    """
        ...
        deployment_metadata = encoding.JsonToMessage(messages.OperationMetadata, json_val).deploymentMetadata
        logs = ''
        step = ''
