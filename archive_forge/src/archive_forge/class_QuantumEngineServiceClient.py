...
class QuantumEngineServiceClient(metaclass=QuantumEngineServiceClientMeta):
    ...
    def parse_quantum_job_path(path: str) -> Dict[str, str]:
        ...
        m = re.match('^projects/(?P<project>.+?)/programs/(?P<program>.+?)/jobs/(?P<job>.+?)$', path)
    ...
    def parse_quantum_processor_path(path: str) -> Dict[str, str]:
        ...
        m = re.match('^projects/(?P<project_id>.+?)/processors/(?P<processor_id>.+?)$', path)
        return m.groupdict() if m else {}
    ...
    def parse_quantum_program_path(path: str) -> Dict[str, str]:
        ...
        m = re.match('^projects/(?P<project>.+?)/programs/(?P<program>.+?)$', path)
        return m.groupdict() if m else {}
    ...
    def __init__(self, *, credentials: Optional[ga_credentials.Credentials]=None, transport: Union[str, QuantumEngineServiceTransport, None]=None, client_options: Optional[client_options_lib.ClientOptions]=None, client_info: gapic_v1.client_info.ClientInfo=DEFAULT_CLIENT_INFO) -> None:
    ...
    def create_quantum_program(self, request: Union[engine.CreateQuantumProgramRequest, dict, None]=None, *, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Optional[float]=None, metadata: Sequence[Tuple[str, str]]=()) -> quantum.QuantumProgram:
        """-
    ...
    def get_quantum_program(self, request: Union[engine.GetQuantumProgramRequest, dict, None]=None, *, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Optional[float]=None, metadata: Sequence[Tuple[str, str]]=()) -> quantum.QuantumProgram:
        """-
    ...
    def list_quantum_programs(self, request: Union[engine.ListQuantumProgramsRequest, dict, None]=None, *, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Optional[float]=None, metadata: Sequence[Tuple[str, str]]=()) -> pagers.ListQuantumProgramsPager:
        """-
        ...
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((('parent', request.parent),)),)
        response = rpc(request, retry=retry, timeout=timeout, metadata=metadata)
        response = pagers.ListQuantumProgramsPager(method=rpc, request=request, response=response, metadata=metadata)
        return response

    def delete_quantum_program(self, request: Union[engine.DeleteQuantumProgramRequest, dict, None]=None, *, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Optional[float]=None, metadata: Sequence[Tuple[str, str]]=()) -> None:
        """-
    ...
    def update_quantum_program(self, request: Union[engine.UpdateQuantumProgramRequest, dict, None]=None, *, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Optional[float]=None, metadata: Sequence[Tuple[str, str]]=()) -> quantum.QuantumProgram:
        """-
    ...
    def create_quantum_job(self, request: Union[engine.CreateQuantumJobRequest, dict, None]=None, *, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Optional[float]=None, metadata: Sequence[Tuple[str, str]]=()) -> quantum.QuantumJob:
        """-
    ...
    def get_quantum_job(self, request: Union[engine.GetQuantumJobRequest, dict, None]=None, *, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Optional[float]=None, metadata: Sequence[Tuple[str, str]]=()) -> quantum.QuantumJob:
        """-
    ...
    def list_quantum_jobs(self, request: Union[engine.ListQuantumJobsRequest, dict, None]=None, *, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Optional[float]=None, metadata: Sequence[Tuple[str, str]]=()) -> pagers.ListQuantumJobsPager:
        """-
        ...
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((('parent', request.parent),)),)
        response = rpc(request, retry=retry, timeout=timeout, metadata=metadata)
        response = pagers.ListQuantumJobsPager(method=rpc, request=request, response=response, metadata=metadata)
        return response

    def delete_quantum_job(self, request: Union[engine.DeleteQuantumJobRequest, dict, None]=None, *, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Optional[float]=None, metadata: Sequence[Tuple[str, str]]=()) -> None:
        """-
    ...
    def update_quantum_job(self, request: Union[engine.UpdateQuantumJobRequest, dict, None]=None, *, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Optional[float]=None, metadata: Sequence[Tuple[str, str]]=()) -> quantum.QuantumJob:
        """-
    ...
    def cancel_quantum_job(self, request: Union[engine.CancelQuantumJobRequest, dict, None]=None, *, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Optional[float]=None, metadata: Sequence[Tuple[str, str]]=()) -> None:
        """-
    ...
    def list_quantum_job_events(self, request: Union[engine.ListQuantumJobEventsRequest, dict, None]=None, *, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Optional[float]=None, metadata: Sequence[Tuple[str, str]]=()) -> pagers.ListQuantumJobEventsPager:
        """-
        ...
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((('parent', request.parent),)),)
        response = rpc(request, retry=retry, timeout=timeout, metadata=metadata)
        response = pagers.ListQuantumJobEventsPager(method=rpc, request=request, response=response, metadata=metadata)
        return response

    def get_quantum_result(self, request: Union[engine.GetQuantumResultRequest, dict, None]=None, *, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Optional[float]=None, metadata: Sequence[Tuple[str, str]]=()) -> quantum.QuantumResult:
        """-
    ...
    def list_quantum_processors(self, request: Union[engine.ListQuantumProcessorsRequest, dict, None]=None, *, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Optional[float]=None, metadata: Sequence[Tuple[str, str]]=()) -> pagers.ListQuantumProcessorsPager:
        """-
        ...
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((('parent', request.parent),)),)
        response = rpc(request, retry=retry, timeout=timeout, metadata=metadata)
        response = pagers.ListQuantumProcessorsPager(method=rpc, request=request, response=response, metadata=metadata)
        return response
    ...
    def list_quantum_calibrations(self, request: Union[engine.ListQuantumCalibrationsRequest, dict, None]=None, *, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Optional[float]=None, metadata: Sequence[Tuple[str, str]]=()) -> pagers.ListQuantumCalibrationsPager:
        """-
        ...
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((('parent', request.parent),)),)
        response = rpc(request, retry=retry, timeout=timeout, metadata=metadata)
        response = pagers.ListQuantumCalibrationsPager(method=rpc, request=request, response=response, metadata=metadata)
        return response

    def get_quantum_calibration(self, request: Union[engine.GetQuantumCalibrationRequest, dict, None]=None, *, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Optional[float]=None, metadata: Sequence[Tuple[str, str]]=()) -> quantum.QuantumCalibration:
        """-
    ...
    def delete_quantum_reservation(self, request: Union[engine.DeleteQuantumReservationRequest, dict, None]=None, *, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Optional[float]=None, metadata: Sequence[Tuple[str, str]]=()) -> None:
        """-
    ...
    def get_quantum_reservation(self, request: Union[engine.GetQuantumReservationRequest, dict, None]=None, *, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Optional[float]=None, metadata: Sequence[Tuple[str, str]]=()) -> quantum.QuantumReservation:
        """-
    ...
    def list_quantum_reservations(self, request: Union[engine.ListQuantumReservationsRequest, dict, None]=None, *, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Optional[float]=None, metadata: Sequence[Tuple[str, str]]=()) -> pagers.ListQuantumReservationsPager:
        """-
        ...
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((('parent', request.parent),)),)
        response = rpc(request, retry=retry, timeout=timeout, metadata=metadata)
        response = pagers.ListQuantumReservationsPager(method=rpc, request=request, response=response, metadata=metadata)
        return response

    def update_quantum_reservation(self, request: Union[engine.UpdateQuantumReservationRequest, dict, None]=None, *, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Optional[float]=None, metadata: Sequence[Tuple[str, str]]=()) -> quantum.QuantumReservation:
        """-
    ...
    def quantum_run_stream(self, requests: Optional[Iterator[engine.QuantumRunStreamRequest]]=None, *, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Optional[float]=None, metadata: Sequence[Tuple[str, str]]=()) -> Iterable[engine.QuantumRunStreamResponse]:
        """-
    ...
    def list_quantum_reservation_grants(self, request: Union[engine.ListQuantumReservationGrantsRequest, dict, None]=None, *, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Optional[float]=None, metadata: Sequence[Tuple[str, str]]=()) -> pagers.ListQuantumReservationGrantsPager:
        """-
        ...
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((('parent', request.parent),)),)
        response = rpc(request, retry=retry, timeout=timeout, metadata=metadata)
        response = pagers.ListQuantumReservationGrantsPager(method=rpc, request=request, response=response, metadata=metadata)
        return response

    def reallocate_quantum_reservation_grant(self, request: Union[engine.ReallocateQuantumReservationGrantRequest, dict, None]=None, *, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Optional[float]=None, metadata: Sequence[Tuple[str, str]]=()) -> quantum.QuantumReservationGrant:
        """-
    ...
    def list_quantum_reservation_budgets(self, request: Union[engine.ListQuantumReservationBudgetsRequest, dict, None]=None, *, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Optional[float]=None, metadata: Sequence[Tuple[str, str]]=()) -> pagers.ListQuantumReservationBudgetsPager:
        """-
        ...
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((('parent', request.parent),)),)
        response = rpc(request, retry=retry, timeout=timeout, metadata=metadata)
        response = pagers.ListQuantumReservationBudgetsPager(method=rpc, request=request, response=response, metadata=metadata)
        return response
    ...
    def list_quantum_time_slots(self, request: Union[engine.ListQuantumTimeSlotsRequest, dict, None]=None, *, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Optional[float]=None, metadata: Sequence[Tuple[str, str]]=()) -> pagers.ListQuantumTimeSlotsPager:
        ...
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((('parent', request.parent),)),)
        response = rpc(request, retry=retry, timeout=timeout, metadata=metadata)
        response = pagers.ListQuantumTimeSlotsPager(method=rpc, request=request, response=response, metadata=metadata)
        return response
