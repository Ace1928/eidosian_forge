...
def AddGeneralAnnotationFlags(parser):
  ...
  """
    parser.add_argument('--update-annotations', metavar='KEY=VALUE', type=arg_parsers.ArgDict(), action=arg_parsers.UpdateAction, hidden=True, help='List of annotation KEY=VALUE pairs to update. If an annotation exists, its value is modified. Otherwise, a new annotation is created.')