...
def create_autolink(self, key_prefix: str, url_template: str, is_alphanumeric: Opt[bool]=NotSet) -> github.Autolink.Autolink:
    """
    ...
    post_parameters = NotSet.remove_unset_items({'key_prefix': key_prefix, 'url_template': url_template, 'is_alphanumeric': is_alphanumeric})
