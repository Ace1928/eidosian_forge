...
class Bgp_afFacts(object):
    ...
    """
    afi_safi_types_map = {'openconfig-bgp-types:IPV4_UNICAST': 'ipv4_unicast', 'openconfig-bgp-types:IPV6_UNICAST': 'ipv6_unicast', 'openconfig-bgp-types:L2VPN_EVPN': 'l2vpn_evpn'}
    af_params_map = {'afi': 'afi-safi-name', 'route_map': 'policy-name', 'prefix': 'prefix', 'neighbor': 'neighbor-address', 'route_reflector_client': 'route-reflector-client', 'route_server_client': 'route-server-client', 'next_hop_self': ['next-hop-self', 'enabled'], 'remove_private_as': ['remove-private-as', 'enabled'], 'prefix_list_in': ['prefix-list', 'import-policy'], 'prefix_list_out': ['prefix-list', 'export-policy'], 'maximum_prefix': ['prefix-limit', 'max-prefixes'], 'activate': 'enabled', 'advertise_pip': ['l2vpn-evpn', 'openconfig-bgp-evpn-ext:config', 'advertise-pip'], 'advertise_pip_ip': ['l2vpn-evpn', 'openconfig-bgp-evpn-ext:config', 'advertise-pip-ip'], 'advertise_pip_peer_ip': ['l2vpn-evpn', 'openconfig-bgp-evpn-ext:config', 'advertise-pip-peer-ip'], 'advertise_svi_ip': ['l2vpn-evpn', 'openconfig-bgp-evpn-ext:config', 'advertise-svi-ip'], 'advertise_all_vni': ['l2vpn-evpn', 'openconfig-bgp-evpn-ext:config', 'advertise-all-vni'], 'advertise_default_gw': ['l2vpn-evpn', 'openconfig-bgp-evpn-ext:config', 'advertise-default-gw'], 'ebgp': ['use-multiple-paths', 'ebgp', 'maximum-paths'], 'ibgp': ['use-multiple-paths', 'ibgp', 'maximum-paths'], 'network': ['network-config', 'network'], 'dampening': ['route-flap-damping', 'config', 'enabled'], 'route_advertise_list': ['l2vpn-evpn', 'openconfig-bgp-evpn-ext:route-advertise', 'route-advertise-list'], 'rd': ['l2vpn-evpn', 'openconfig-bgp-evpn-ext:config', 'route-distinguisher'], 'rt_in': ['l2vpn-evpn', 'openconfig-bgp-evpn-ext:config', 'import-rts'], 'rt_out': ['l2vpn-evpn', 'openconfig-bgp-evpn-ext:config', 'export-rts'], 'vnis': ['l2vpn-evpn', 'openconfig-bgp-evpn-ext:vnis', 'vni']}
    af_redis_params_map = {'protocol': 'src-protocol', 'afi': 'address-family', 'metric': 'metric', 'route_map': 'import-policy'}
