...
class TransformedStructure(MSONable):
    ...
    def __init__(self, structure: Structure, transformations: AbstractTransformation | Sequence[AbstractTransformation] | None=None, history: list[AbstractTransformation | dict[str, Any]] | None=None, other_parameters: dict[str, Any] | None=None) -> None:
    ...
    def append_transformation(self, transformation, return_alternatives: bool=False, clear_redo: bool=True) -> list[TransformedStructure] | None:
    ...
    def extend_transformations(self, transformations: list[AbstractTransformation], return_alternatives: bool=False) -> None:
    ...
    def write_vasp_input(self, vasp_input_set: type[VaspInputSet]=MPRelaxSet, output_dir: str='.', create_directory: bool=True, **kwargs) -> None:
