    ...
    def modify_fpolicy_scope(self, modify):
        ...
        if self.use_rest:
            ...
            try:
                ...
                self.module.fail_json(msg='Error modifying fPolicy policy scope %s on vserver %s: %s' % (self.parameters['name'], self.parameters['vserver'], to_native(error)), exception=traceback.format_exc())
