...
class QuantumScriptSerializer:
    ...
    def __init__(self, device_name, use_csingle: bool=False, use_mpi: bool=False, split_obs: bool=False):
        ...
        if device_name == 'lightning.qubit':
            try:
                ...
                raise ImportError(f'Pre-compiled binaries for {device_name} are not available.') from exception
