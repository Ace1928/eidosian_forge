...
class TestSinusoidal:
    ...
    def test_default(self):
        ...
        assert_almost_equal(np.array(crs.x_limits), [-20037508.3428, 20037508.3428], decimal=4)
        assert_almost_equal(np.array(crs.y_limits), [-10001965.7293, 10001965.7293], decimal=4)
    ...
    def test_eccentric_globe(self):
        ...
        expected_y = [-1216.6, 1216.6]
        if pyproj.__proj_version__ >= '9.2.0':
            expected_x = [-3141.6, 3141.6]
