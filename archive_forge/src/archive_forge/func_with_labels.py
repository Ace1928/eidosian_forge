...
@util.became_legacy_20(':meth:`_orm.Query.with_labels` and :meth:`_orm.Query.apply_labels`', alternative='Use set_label_style(LABEL_STYLE_TABLENAME_PLUS_COL) instead.')
