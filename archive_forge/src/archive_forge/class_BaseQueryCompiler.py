...
class BaseQueryCompiler(ClassLogger, abc.ABC, modin_layer='QUERY-COMPILER'):
    ...
    def add_prefix(self, prefix, axis=1):
        ...
        """
        return DataFrameDefault.register(pandas.DataFrame.add_prefix)(self, prefix=prefix, axis=axis)
    ...
    def add_suffix(self, suffix, axis=1):
        ...
        BaseQueryCompiler
            New query compiler with updated labels.
        """
        return DataFrameDefault.register(pandas.DataFrame.add_suffix)(self, suffix=suffix, axis=axis)
        ...
        **kwargs : dict
        ...
        def concat(df, axis, other, **kwargs):
            ...
            if kwargs.get('join', 'outer') in concat_join:
                ...
                if isinstance(other, (pandas.DataFrame, pandas.Series)) or len(other) <= 1:
                    kwargs['rsuffix'] = 'r_'
    ...
    def series_to_dict(self, into=dict):
        """
    ...
    def align(self, other, **kwargs):
        ...
        **kwargs : dict
        ...
        BaseQueryCompiler
            Aligned `other`.
        """
        return DataFrameDefault.register(pandas.DataFrame.align)(self, other=other, **kwargs)
    ...
    def combine(self, other, **kwargs):
        ...
        **kwargs : dict
        ...
        BaseQueryCompiler
            Result of combine.
        """
        return BinaryDefault.register(pandas.DataFrame.combine)(self, other=other, **kwargs)
    ...
    def radd(self, other, **kwargs):
        return BinaryDefault.register(pandas.DataFrame.radd)(self, other=other, **kwargs)
    ...
    def rdivmod(self, other, **kwargs):
        ...
        **kwargs : dict
        ...
        BaseQueryCompiler
            Compiler representing Series with modulo part of division.
        """
        return SeriesDefault.register(pandas.Series.rdivmod)(self, other=other, **kwargs)
    ...
    def __and__(self, other, **kwargs):
        return BinaryDefault.register(pandas.DataFrame.__and__)(self, other=other, **kwargs)
    ...
    def where(self, cond, other, **kwargs):
        ...
        **kwargs : dict
        ...
        """
        return DataFrameDefault.register(pandas.DataFrame.where)(self, cond=cond, other=other, **kwargs)
    ...
    def merge(self, right, **kwargs):
        ...
        **kwargs : dict
        ...
        """
        return DataFrameDefault.register(pandas.DataFrame.merge)(self, right=right, **kwargs)
    ...
    def merge_asof(self, right: 'BaseQueryCompiler', left_on: Optional[IndexLabel]=None, right_on: Optional[IndexLabel]=None, left_index: bool=False, right_index: bool=False, left_by=None, right_by=None, suffixes: Suffixes=('_x', '_y'), tolerance=None, allow_exact_matches: bool=True, direction: str='backward'):
        if left_index and right_on is not None or not (left_by is None or is_scalar(left_by)) or (not (right_by is None or is_scalar(right_by))) or (not right.index.is_unique):
            return self.default_to_pandas(pandas.merge_asof, right, left_on=left_on, right_on=right_on, left_index=left_index, right_index=right_index, left_by=left_by, right_by=right_by, suffixes=suffixes, tolerance=tolerance, allow_exact_matches=allow_exact_matches, direction=direction)
        if left_on is None:
        ...
        merged = pandas.merge_asof(left_pandas_limited, right_pandas_limited, on='on', direction=direction, allow_exact_matches=allow_exact_matches, tolerance=tolerance, **extra_kwargs)
        right_subset = right.reindex(axis=0, labels=pandas.Index(merged['right_labels']))
        if not right_index:
        ...
        result = self.merge(right_subset, left_index=True, right_index=True, suffixes=suffixes, how='left')
        if left_on is not None and right_index:
            result = result.insert(list(result.columns).index(left_on + suffixes[0]), left_on, result.getitem_array([left_on + suffixes[0]]))
    ...
    def transpose(self, *args, **kwargs):
        ...
        **kwargs : dict
        ...
        """
        return DataFrameDefault.register(pandas.DataFrame.transpose)(self, *args, **kwargs)
    ...
    def reindex(self, axis, labels, **kwargs):
        ...
        **kwargs : dict
        ...
        """
        return DataFrameDefault.register(pandas.DataFrame.reindex)(self, axis=axis, labels=labels, **kwargs)
    ...
    def mask(self, cond, other, **kwargs):
        ...
        """
        return DataFrameDefault.register(pandas.DataFrame.mask)(self, cond, other, **kwargs)
    ...
    def map(self, func, *args, **kwargs):
        ...
        **kwargs : dict
        ...
        """
        return DataFrameDefault.register(pandas.DataFrame.map)(self, func, *args, **kwargs)
    ...
    def isin(self, values, ignore_indices=False, **kwargs):
        ...
        **kwargs : dict
        ...
        if self._shape_hint == 'column':
            ...
            return DataFrameDefault.register(pandas.DataFrame.isin)(self, values, **kwargs)
    ...
    def to_timedelta(self, unit='ns', errors='raise'):
        """
        ...
        """
        return SeriesDefault.register(pandas.to_timedelta)(self, unit=unit, errors=errors)
    ...
    def stack(self, level, dropna):
        ...
        BaseQueryCompiler
        """
        return DataFrameDefault.register(pandas.DataFrame.stack)(self, level=level, dropna=dropna)
    ...
    def astype(self, col_dtypes, errors: str='raise'):
        ...
        """
        return DataFrameDefault.register(pandas.DataFrame.astype)(self, dtype=col_dtypes, errors=errors)
    ...
    def convert_dtypes(self, infer_objects: bool=True, convert_string: bool=True, convert_integer: bool=True, convert_boolean: bool=True, convert_floating: bool=True, dtype_backend: DtypeBackend='numpy_nullable'):
        ...
        BaseQueryCompiler
            New QueryCompiler with updated dtypes.
        """
        return DataFrameDefault.register(pandas.DataFrame.convert_dtypes)(self, infer_objects=infer_objects, convert_string=convert_string, convert_integer=convert_integer, convert_boolean=convert_boolean, convert_floating=convert_floating, dtype_backend=dtype_backend)
    ...
    def first_valid_index(self):
        ...
        scalar
        """
        return DataFrameDefault.register(pandas.DataFrame.first_valid_index)(self).to_pandas().squeeze()
    ...
    def last_valid_index(self):
        ...
        scalar
        """
        return DataFrameDefault.register(pandas.DataFrame.last_valid_index)(self).to_pandas().squeeze()
    ...
    def describe(self, percentiles: np.ndarray):
        ...
        """
        return DataFrameDefault.register(pandas.DataFrame.describe)(self, percentiles=percentiles, include='all')
    ...
    def nlargest(self, n=5, columns=None, keep='first'):
        ...
        if columns is None:
            ...
            return DataFrameDefault.register(pandas.DataFrame.nlargest)(self, n=n, columns=columns, keep=keep)
    ...
    def nsmallest(self, n=5, columns=None, keep='first'):
        ...
        if columns is None:
            ...
            return DataFrameDefault.register(pandas.DataFrame.nsmallest)(self, n=n, columns=columns, keep=keep)
    ...
    def eval(self, expr, **kwargs):
        ...
        **kwargs : dict
        ...
        """
        return DataFrameDefault.register(pandas.DataFrame.eval)(self, expr=expr, **kwargs)
    ...
    def sort_rows_by_column_values(self, columns, ascending=True, **kwargs):
        ...
        **kwargs : dict
        ...
        BaseQueryCompiler
            New QueryCompiler that contains result of the sort.
        """
        return DataFrameDefault.register(pandas.DataFrame.sort_values)(self, by=columns, axis=0, ascending=ascending, **kwargs)
    ...
    def insert(self, loc, column, value):
        ...
        def inserter(df, loc, column, value):
            ...
            return df
        return DataFrameDefault.register(inserter, inplace=True)(self, loc=loc, column=column, value=value)
    ...
    def drop(self, index=None, columns=None, errors: str='raise'):
        ...
        if index is None and columns is None:
            ...
            return DataFrameDefault.register(pandas.DataFrame.drop)(self, index=index, columns=columns, errors=errors)
    ...
    def apply(self, func, axis, raw=False, result_type=None, *args, **kwargs):
        ...
        **kwargs : dict
        ...
        """
        return DataFrameDefault.register(pandas.DataFrame.apply)(self, *args, func=func, axis=axis, raw=raw, result_type=result_type, **kwargs)
    ...
    def groupby_count(self, by, axis, groupby_kwargs, agg_args, agg_kwargs, drop=False):
        return GroupByDefault.register(pandas.core.groupby.DataFrameGroupBy.count)(self, by=by, axis=axis, groupby_kwargs=groupby_kwargs, agg_args=agg_args, agg_kwargs=agg_kwargs, drop=drop)
    ...
    def groupby_any(self, by, axis, groupby_kwargs, agg_args, agg_kwargs, drop=False):
        return GroupByDefault.register(pandas.core.groupby.DataFrameGroupBy.any)(self, by=by, axis=axis, groupby_kwargs=groupby_kwargs, agg_args=agg_args, agg_kwargs=agg_kwargs, drop=drop)

    @doc_utils.doc_groupby_method(action='get the index of the minimum value', result='index of minimum value', refer_to='idxmin')
    def groupby_idxmin(self, by, axis, groupby_kwargs, agg_args, agg_kwargs, drop=False):
        return GroupByDefault.register(pandas.core.groupby.DataFrameGroupBy.idxmin)(self, by=by, axis=axis, groupby_kwargs=groupby_kwargs, agg_args=agg_args, agg_kwargs=agg_kwargs, drop=drop)
    ...
    def groupby_min(self, by, axis, groupby_kwargs, agg_args, agg_kwargs, drop=False):
        return GroupByDefault.register(pandas.core.groupby.DataFrameGroupBy.min)(self, by=by, axis=axis, groupby_kwargs=groupby_kwargs, agg_args=agg_args, agg_kwargs=agg_kwargs, drop=drop)

    @doc_utils.doc_groupby_method(result='product', refer_to='prod')
    def groupby_prod(self, by, axis, groupby_kwargs, agg_args, agg_kwargs, drop=False):
        return GroupByDefault.register(pandas.core.groupby.DataFrameGroupBy.prod)(self, by=by, axis=axis, groupby_kwargs=groupby_kwargs, agg_args=agg_args, agg_kwargs=agg_kwargs, drop=drop)

    @doc_utils.doc_groupby_method(action='get the maximum value', result='maximum value', refer_to='max')
    def groupby_max(self, by, axis, groupby_kwargs, agg_args, agg_kwargs, drop=False):
        return GroupByDefault.register(pandas.core.groupby.DataFrameGroupBy.max)(self, by=by, axis=axis, groupby_kwargs=groupby_kwargs, agg_args=agg_args, agg_kwargs=agg_kwargs, drop=drop)
    ...
    def groupby_all(self, by, axis, groupby_kwargs, agg_args, agg_kwargs, drop=False):
        return GroupByDefault.register(pandas.core.groupby.DataFrameGroupBy.all)(self, by=by, axis=axis, groupby_kwargs=groupby_kwargs, agg_args=agg_args, agg_kwargs=agg_kwargs, drop=drop)
    ...
    def groupby_sum(self, by, axis, groupby_kwargs, agg_args, agg_kwargs, drop=False):
        return GroupByDefault.register(pandas.core.groupby.DataFrameGroupBy.sum)(self, by=by, axis=axis, groupby_kwargs=groupby_kwargs, agg_args=agg_args, agg_kwargs=agg_kwargs, drop=drop)
    ...
    def groupby_size(self, by, axis, groupby_kwargs, agg_args, agg_kwargs, drop=False):
        result = GroupByDefault.register(pandas.core.groupby.DataFrameGroupBy.size)(self, by=by, axis=axis, groupby_kwargs=groupby_kwargs, agg_args=agg_args, agg_kwargs=agg_kwargs, drop=drop, method='size')
    ...
    def groupby_agg(self, by, agg_func, axis, groupby_kwargs, agg_args, agg_kwargs, how='axis_wise', drop=False, series_groupby=False):
        ...
        return defaulter.register(defaulter.get_aggregation_method(how))(self, by=by, agg_func=agg_func, axis=axis, groupby_kwargs=groupby_kwargs, agg_args=agg_args, agg_kwargs=agg_kwargs, drop=drop)
    ...
    def groupby_mean(self, by, axis, groupby_kwargs, agg_args, agg_kwargs, drop=False):
        return self.groupby_agg(by=by, agg_func='mean', axis=axis, groupby_kwargs=groupby_kwargs, agg_args=agg_args, agg_kwargs=agg_kwargs, drop=drop)
    ...
    def groupby_skew(self, by, axis, groupby_kwargs, agg_args, agg_kwargs, drop=False):
        if axis == 1:
            return GroupByDefault.register(pandas.core.groupby.DataFrameGroupBy.skew)(self, by=by, axis=axis, groupby_kwargs=groupby_kwargs, agg_args=agg_args, agg_kwargs=agg_kwargs, drop=drop)
        return self.groupby_agg(by=by, agg_func='skew', axis=axis, groupby_kwargs=groupby_kwargs, agg_args=agg_args, agg_kwargs=agg_kwargs, drop=drop)

    @doc_utils.doc_groupby_method(action='compute cumulative count', result='count of all the previous values', refer_to='cumcount')
    def groupby_cumcount(self, by, axis, groupby_kwargs, agg_args, agg_kwargs, drop=False):
        return self.groupby_agg(by=by, agg_func='cumcount', axis=axis, groupby_kwargs=groupby_kwargs, agg_args=agg_args, agg_kwargs=agg_kwargs, drop=drop)

    @doc_utils.doc_groupby_method(action='compute cumulative sum', result='sum of all the previous values', refer_to='cumsum')
    def groupby_cumsum(self, by, axis, groupby_kwargs, agg_args, agg_kwargs, drop=False):
        return self.groupby_agg(by=by, agg_func='cumsum', axis=axis, groupby_kwargs=groupby_kwargs, agg_args=agg_args, agg_kwargs=agg_kwargs, drop=drop)

    @doc_utils.doc_groupby_method(action='get cumulative maximum', result='maximum of all the previous values', refer_to='cummax')
    def groupby_cummax(self, by, axis, groupby_kwargs, agg_args, agg_kwargs, drop=False):
        return self.groupby_agg(by=by, agg_func='cummax', axis=axis, groupby_kwargs=groupby_kwargs, agg_args=agg_args, agg_kwargs=agg_kwargs, drop=drop)
    ...
    def groupby_cumprod(self, by, axis, groupby_kwargs, agg_args, agg_kwargs, drop=False):
        return self.groupby_agg(by=by, agg_func='cumprod', axis=axis, groupby_kwargs=groupby_kwargs, agg_args=agg_args, agg_kwargs=agg_kwargs, drop=drop)

    @doc_utils.doc_groupby_method(action='compute standard deviation', result='standard deviation', refer_to='std')
    def groupby_std(self, by, axis, groupby_kwargs, agg_args, agg_kwargs, drop=False):
        return self.groupby_agg(by=by, agg_func='std', axis=axis, groupby_kwargs=groupby_kwargs, agg_args=agg_args, agg_kwargs=agg_kwargs, drop=drop)

    @doc_utils.doc_groupby_method(action='compute standard error', result='standard error', refer_to='sem')
    def groupby_sem(self, by, axis, groupby_kwargs, agg_args, agg_kwargs, drop=False):
        return self.groupby_agg(by=by, agg_func='sem', axis=axis, groupby_kwargs=groupby_kwargs, agg_args=agg_args, agg_kwargs=agg_kwargs, drop=drop)
    ...
    def groupby_corr(self, by, axis, groupby_kwargs, agg_args, agg_kwargs, drop=False):
        return self.groupby_agg(by=by, agg_func='corr', axis=axis, groupby_kwargs=groupby_kwargs, agg_args=agg_args, agg_kwargs=agg_kwargs, drop=drop)
    ...
    def groupby_cov(self, by, axis, groupby_kwargs, agg_args, agg_kwargs, drop=False):
        return self.groupby_agg(by=by, agg_func='cov', axis=axis, groupby_kwargs=groupby_kwargs, agg_args=agg_args, agg_kwargs=agg_kwargs, drop=drop)

    @doc_utils.doc_groupby_method(action='get the number of unique values', result='number of unique values', refer_to='nunique')
    def groupby_nunique(self, by, axis, groupby_kwargs, agg_args, agg_kwargs, drop=False):
        return self.groupby_agg(by=by, agg_func='nunique', axis=axis, groupby_kwargs=groupby_kwargs, agg_args=agg_args, agg_kwargs=agg_kwargs, drop=drop)

    @doc_utils.doc_groupby_method(action='get the median value', result='median value', refer_to='median')
    def groupby_median(self, by, axis, groupby_kwargs, agg_args, agg_kwargs, drop=False):
        return self.groupby_agg(by=by, agg_func='median', axis=axis, groupby_kwargs=groupby_kwargs, agg_args=agg_args, agg_kwargs=agg_kwargs, drop=drop)

    @doc_utils.doc_groupby_method(action='compute specified quantile', result='quantile value', refer_to='quantile')
    def groupby_quantile(self, by, axis, groupby_kwargs, agg_args, agg_kwargs, drop=False):
        return self.groupby_agg(by=by, agg_func='quantile', axis=axis, groupby_kwargs=groupby_kwargs, agg_args=agg_args, agg_kwargs=agg_kwargs, drop=drop)
    ...
    def groupby_fillna(self, by, axis, groupby_kwargs, agg_args, agg_kwargs, drop=False):
        return self.groupby_agg(by=by, agg_func='fillna', axis=axis, groupby_kwargs=groupby_kwargs, agg_args=agg_args, agg_kwargs=agg_kwargs, drop=drop)

    def groupby_diff(self, by, axis, groupby_kwargs, agg_args, agg_kwargs, drop=False):
        return self.groupby_agg(by=by, agg_func='diff', axis=axis, groupby_kwargs=groupby_kwargs, agg_args=agg_args, agg_kwargs=agg_kwargs, drop=drop)

    def groupby_pct_change(self, by, axis, groupby_kwargs, agg_args, agg_kwargs, drop=False):
        return self.groupby_agg(by=by, agg_func='pct_change', axis=axis, groupby_kwargs=groupby_kwargs, agg_args=agg_args, agg_kwargs=agg_kwargs, drop=drop)
    ...
    def groupby_dtypes(self, by, axis, groupby_kwargs, agg_args, agg_kwargs, drop=False):
        return self.groupby_agg(by=by, agg_func='dtypes', axis=axis, groupby_kwargs=groupby_kwargs, agg_args=agg_args, agg_kwargs=agg_kwargs, drop=drop)
    ...
    def groupby_get_group(self, by, axis, groupby_kwargs, agg_args, agg_kwargs, drop=False):
        return self.groupby_agg(by=by, agg_func='get_group', axis=axis, groupby_kwargs=groupby_kwargs, agg_args=agg_args, agg_kwargs=agg_kwargs, drop=drop)

    @doc_utils.doc_groupby_method(action='shift data with the specified settings', result='shifted value', refer_to='shift')
    def groupby_shift(self, by, axis, groupby_kwargs, agg_args, agg_kwargs, drop=False):
        return self.groupby_agg(by=by, agg_func='shift', axis=axis, groupby_kwargs=groupby_kwargs, agg_args=agg_args, agg_kwargs=agg_kwargs, drop=drop)

    @doc_utils.doc_groupby_method(action='get first value in group', result='first value', refer_to='first')
    def groupby_first(self, by, axis, groupby_kwargs, agg_args, agg_kwargs, drop=False):
        return self.groupby_agg(by=by, agg_func='first', axis=axis, groupby_kwargs=groupby_kwargs, agg_args=agg_args, agg_kwargs=agg_kwargs, drop=drop)

    @doc_utils.doc_groupby_method(action='get last value in group', result='last value', refer_to='last')
    def groupby_last(self, by, axis, groupby_kwargs, agg_args, agg_kwargs, drop=False):
        return self.groupby_agg(by=by, agg_func='last', axis=axis, groupby_kwargs=groupby_kwargs, agg_args=agg_args, agg_kwargs=agg_kwargs, drop=drop)

    @doc_utils.doc_groupby_method(action='get first n values of a group', result='first n values of a group', refer_to='head')
    def groupby_head(self, by, axis, groupby_kwargs, agg_args, agg_kwargs, drop=False):
        return self.groupby_agg(by=by, agg_func='head', axis=axis, groupby_kwargs=groupby_kwargs, agg_args=agg_args, agg_kwargs=agg_kwargs, drop=drop)

    @doc_utils.doc_groupby_method(action='get last n values in group', result='last n values', refer_to='tail')
    def groupby_tail(self, by, axis, groupby_kwargs, agg_args, agg_kwargs, drop=False):
        return self.groupby_agg(by=by, agg_func='tail', axis=axis, groupby_kwargs=groupby_kwargs, agg_args=agg_args, agg_kwargs=agg_kwargs, drop=drop)
    ...
    def groupby_nth(self, by, axis, groupby_kwargs, agg_args, agg_kwargs, drop=False):
        return self.groupby_agg(by=by, agg_func='nth', axis=axis, groupby_kwargs=groupby_kwargs, agg_args=agg_args, agg_kwargs=agg_kwargs, drop=drop)

    @doc_utils.doc_groupby_method(action='get group number of each value', result='group number of each value', refer_to='ngroup')
    def groupby_ngroup(self, by, axis, groupby_kwargs, agg_args, agg_kwargs, drop=False):
        return self.groupby_agg(by=by, agg_func='ngroup', axis=axis, groupby_kwargs=groupby_kwargs, agg_args=agg_args, agg_kwargs=agg_kwargs, drop=drop)

    @doc_utils.doc_groupby_method(action='get n largest values in group', result='n largest values', refer_to='nlargest')
    def groupby_nlargest(self, by, axis, groupby_kwargs, agg_args, agg_kwargs, drop=False):
        return self.groupby_agg(by=by, agg_func='nlargest', axis=axis, groupby_kwargs=groupby_kwargs, agg_args=agg_args, agg_kwargs=agg_kwargs, drop=drop, series_groupby=True)

    @doc_utils.doc_groupby_method(action='get n nsmallest values in group', result='n nsmallest values', refer_to='nsmallest')
    def groupby_nsmallest(self, by, axis, groupby_kwargs, agg_args, agg_kwargs, drop=False):
        return self.groupby_agg(by=by, agg_func='nsmallest', axis=axis, groupby_kwargs=groupby_kwargs, agg_args=agg_args, agg_kwargs=agg_kwargs, drop=drop, series_groupby=True)

    @doc_utils.doc_groupby_method(action='get unique values in group', result='unique values', refer_to='unique')
    def groupby_unique(self, by, axis, groupby_kwargs, agg_args, agg_kwargs, drop=False):
        return self.groupby_agg(by=by, agg_func='unique', axis=axis, groupby_kwargs=groupby_kwargs, agg_args=agg_args, agg_kwargs=agg_kwargs, drop=drop, series_groupby=True)

    def groupby_ohlc(self, by, axis, groupby_kwargs, agg_args, agg_kwargs, is_df):
        if not is_df:
            return self.groupby_agg(by=by, agg_func='ohlc', axis=axis, groupby_kwargs=groupby_kwargs, agg_args=agg_args, agg_kwargs=agg_kwargs, series_groupby=True)
        return GroupByDefault.register(pandas.core.groupby.DataFrameGroupBy.ohlc)(self, by=by, axis=axis, groupby_kwargs=groupby_kwargs, agg_args=agg_args, agg_kwargs=agg_kwargs, drop=True)
    ...
    def unstack(self, level, fill_value):
        ...
        BaseQueryCompiler
        """
        return DataFrameDefault.register(pandas.DataFrame.unstack)(self, level=level, fill_value=fill_value)
    ...
    def pivot(self, index, columns, values):
        ...
        """
        return DataFrameDefault.register(pandas.DataFrame.pivot)(self, index=index, columns=columns, values=values)
    ...
    def pivot_table(self, index, values, columns, aggfunc, fill_value, margins, dropna, margins_name, observed, sort):
        ...
        BaseQueryCompiler
        """
        return DataFrameDefault.register(pandas.DataFrame.pivot_table)(self, index=index, values=values, columns=columns, aggfunc=aggfunc, fill_value=fill_value, margins=margins, dropna=dropna, margins_name=margins_name, observed=observed, sort=sort)
    ...
    def write_items(self, row_numeric_index, col_numeric_index, item, need_columns_reindex=True):
        ...
        return DataFrameDefault.register(write_items)(self, broadcasted_items=broadcasted_item)
    ...
    def tz_convert(self, tz, axis=0, level=None, copy=True):
        ...
        if level is not None:
            new_labels = pandas.Series(index=self.get_axis(axis)).tz_convert(tz, level=level).index
        else:
    ...
    def tz_localize(self, tz, axis=0, level=None, copy=True, ambiguous='raise', nonexistent='raise'):
        ...
        """
        new_labels = pandas.Series(index=self.get_axis(axis)).tz_localize(tz, axis=axis, level=level, copy=False, ambiguous=ambiguous, nonexistent=nonexistent).index
        obj = self.copy() if copy else self
        if axis == 0:
            obj.index = new_labels
        else:
    ...
    def dt_ceil(self, freq, ambiguous='raise', nonexistent='raise'):
        return DateTimeDefault.register(pandas.Series.dt.ceil)(self, freq, ambiguous, nonexistent)
    ...
    def dt_floor(self, freq, ambiguous='raise', nonexistent='raise'):
        return DateTimeDefault.register(pandas.Series.dt.floor)(self, freq, ambiguous, nonexistent)
    ...
    def dt_round(self, freq, ambiguous='raise', nonexistent='raise'):
        return DateTimeDefault.register(pandas.Series.dt.round)(self, freq, ambiguous, nonexistent)
    ...
    def resample_agg_df(self, resample_kwargs, func, *args, **kwargs):
        return ResampleDefault.register(pandas.core.resample.Resampler.aggregate)(self, resample_kwargs, func, *args, **kwargs)
    ...
    def resample_app_df(self, resample_kwargs, func, *args, **kwargs):
        return ResampleDefault.register(pandas.core.resample.Resampler.apply)(self, resample_kwargs, func, *args, **kwargs)
    ...
    def resample_app_ser(self, resample_kwargs, func, *args, **kwargs):
        return ResampleDefault.register(pandas.core.resample.Resampler.apply, squeeze_self=True)(self, resample_kwargs, func, *args, **kwargs)
    ...
    def resample_bfill(self, resample_kwargs, limit):
        return ResampleDefault.register(pandas.core.resample.Resampler.bfill)(self, resample_kwargs, limit)
    ...
    def resample_count(self, resample_kwargs):
        return ResampleDefault.register(pandas.core.resample.Resampler.count)(self, resample_kwargs)

    @doc_utils.doc_resample_fillna(method='forward-fill', refer_to='ffill')
    def resample_ffill(self, resample_kwargs, limit):
        return ResampleDefault.register(pandas.core.resample.Resampler.ffill)(self, resample_kwargs, limit)
    ...
    def resample_fillna(self, resample_kwargs, method, limit):
        return ResampleDefault.register(pandas.core.resample.Resampler.fillna)(self, resample_kwargs, method, limit)

    @doc_utils.doc_resample_reduce(result='first element', refer_to='first')
    def resample_first(self, resample_kwargs, *args, **kwargs):
        return ResampleDefault.register(pandas.core.resample.Resampler.first)(self, resample_kwargs, *args, **kwargs)
    ...
    def resample_last(self, resample_kwargs, *args, **kwargs):
        return ResampleDefault.register(pandas.core.resample.Resampler.last)(self, resample_kwargs, *args, **kwargs)

    @doc_utils.doc_resample_reduce(result='maximum value', refer_to='max')
    def resample_max(self, resample_kwargs, *args, **kwargs):
        return ResampleDefault.register(pandas.core.resample.Resampler.max)(self, resample_kwargs, *args, **kwargs)

    @doc_utils.doc_resample_reduce(result='mean value', refer_to='mean')
    def resample_mean(self, resample_kwargs, *args, **kwargs):
        return ResampleDefault.register(pandas.core.resample.Resampler.mean)(self, resample_kwargs, *args, **kwargs)

    @doc_utils.doc_resample_reduce(result='median value', refer_to='median')
    def resample_median(self, resample_kwargs, *args, **kwargs):
        return ResampleDefault.register(pandas.core.resample.Resampler.median)(self, resample_kwargs, *args, **kwargs)
    ...
    def resample_nearest(self, resample_kwargs, limit):
        return ResampleDefault.register(pandas.core.resample.Resampler.nearest)(self, resample_kwargs, limit)
    ...
    def resample_ohlc_df(self, resample_kwargs, *args, **kwargs):
        return ResampleDefault.register(pandas.core.resample.Resampler.ohlc)(self, resample_kwargs, *args, **kwargs)

    @doc_utils.doc_resample_agg(action='compute open, high, low and close values', output='labels of columns containing computed values', refer_to='ohlc')
    def resample_ohlc_ser(self, resample_kwargs, *args, **kwargs):
        return ResampleDefault.register(pandas.core.resample.Resampler.ohlc, squeeze_self=True)(self, resample_kwargs, *args, **kwargs)
    ...
    def resample_prod(self, resample_kwargs, min_count, *args, **kwargs):
        return ResampleDefault.register(pandas.core.resample.Resampler.prod)(self, resample_kwargs, min_count, *args, **kwargs)
    ...
    def resample_quantile(self, resample_kwargs, q, *args, **kwargs):
        return ResampleDefault.register(pandas.core.resample.Resampler.quantile)(self, resample_kwargs, q, *args, **kwargs)
    ...
    def resample_sem(self, resample_kwargs, *args, **kwargs):
        return ResampleDefault.register(pandas.core.resample.Resampler.sem)(self, resample_kwargs, *args, **kwargs)
    ...
    def resample_size(self, resample_kwargs, *args, **kwargs):
        return ResampleDefault.register(pandas.core.resample.Resampler.size)(self, resample_kwargs, *args, **kwargs)
    ...
    def resample_std(self, resample_kwargs, ddof, *args, **kwargs):
        return ResampleDefault.register(pandas.core.resample.Resampler.std)(self, resample_kwargs, ddof, *args, **kwargs)
    ...
    def resample_var(self, resample_kwargs, ddof, *args, **kwargs):
        return ResampleDefault.register(pandas.core.resample.Resampler.var)(self, resample_kwargs, ddof, *args, **kwargs)
    ...
    def str_contains(self, pat, case=True, flags=0, na=None, regex=True):
        return StrDefault.register(pandas.Series.str.contains)(self, pat, case, flags, na, regex)
    ...
    def str_replace(self, pat, repl, n=-1, case=None, flags=0, regex=None):
        return StrDefault.register(pandas.Series.str.replace)(self, pat, repl, n, case, flags, regex)
    ...
    def str_rsplit(self, pat=None, *, n=-1, expand=False):
        return StrDefault.register(pandas.Series.str.rsplit)(self, pat, n=n, expand=expand)
    ...
    def str_slice_replace(self, start=None, stop=None, repl=None):
        return StrDefault.register(pandas.Series.str.slice_replace)(self, start, stop, repl)

    @doc_utils.doc_str_method(refer_to='split', params='\n        pat : str, optional\n        n : int, default: -1\n        expand : bool, default: False\n        regex : bool, default: None')
    def str_split(self, pat=None, *, n=-1, expand=False, regex=None):
        return StrDefault.register(pandas.Series.str.split)(self, pat, n=n, expand=expand, regex=regex)
    ...
    def rolling_aggregate(self, fold_axis, rolling_kwargs, func, *args, **kwargs):
        return RollingDefault.register(pandas.core.window.rolling.Rolling.aggregate)(self, rolling_kwargs, func, *args, **kwargs)
    ...
    def rolling_corr(self, fold_axis, rolling_kwargs, other=None, pairwise=None, *args, **kwargs):
        return RollingDefault.register(pandas.core.window.rolling.Rolling.corr)(self, rolling_kwargs, other, pairwise, *args, **kwargs)
    ...
    def rolling_count(self, fold_axis, rolling_kwargs):
        return RollingDefault.register(pandas.core.window.rolling.Rolling.count)(self, rolling_kwargs)
    ...
    def rolling_kurt(self, fold_axis, rolling_kwargs, **kwargs):
        return RollingDefault.register(pandas.core.window.rolling.Rolling.kurt)(self, rolling_kwargs, **kwargs)
    ...
    def rolling_max(self, fold_axis, rolling_kwargs, *args, **kwargs):
        return RollingDefault.register(pandas.core.window.rolling.Rolling.max)(self, rolling_kwargs, *args, **kwargs)
    ...
    def rolling_mean(self, fold_axis, rolling_kwargs, *args, **kwargs):
        return RollingDefault.register(pandas.core.window.rolling.Rolling.mean)(self, rolling_kwargs, *args, **kwargs)
    ...
    def rolling_min(self, fold_axis, rolling_kwargs, *args, **kwargs):
        return RollingDefault.register(pandas.core.window.rolling.Rolling.min)(self, rolling_kwargs, *args, **kwargs)

    @doc_utils.doc_window_method(window_cls_name='Rolling', result='quantile', refer_to='quantile', params="\n        quantile : float\n        interpolation : {'linear', 'lower', 'higher', 'midpoint', 'nearest'}, default: 'linear'\n        **kwargs : dict")
    def rolling_quantile(self, fold_axis, rolling_kwargs, quantile, interpolation='linear', **kwargs):
        return RollingDefault.register(pandas.core.window.rolling.Rolling.quantile)(self, rolling_kwargs, quantile, interpolation, **kwargs)
    ...
    def rolling_skew(self, fold_axis, rolling_kwargs, **kwargs):
        return RollingDefault.register(pandas.core.window.rolling.Rolling.skew)(self, rolling_kwargs, **kwargs)
    ...
    def rolling_std(self, fold_axis, rolling_kwargs, ddof=1, *args, **kwargs):
        return RollingDefault.register(pandas.core.window.rolling.Rolling.std)(self, rolling_kwargs, ddof, *args, **kwargs)
    ...
    def rolling_sum(self, fold_axis, rolling_kwargs, *args, **kwargs):
        return RollingDefault.register(pandas.core.window.rolling.Rolling.sum)(self, rolling_kwargs, *args, **kwargs)
    ...
    def rolling_sem(self, fold_axis, rolling_kwargs, *args, **kwargs):
        return RollingDefault.register(pandas.core.window.rolling.Rolling.sem)(self, rolling_kwargs, *args, **kwargs)
    ...
    def expanding_aggregate(self, fold_axis, expanding_args, func, *args, **kwargs):
        return ExpandingDefault.register(pandas.core.window.expanding.Expanding.aggregate)(self, expanding_args, func, *args, **kwargs)
    ...
    def expanding_min(self, fold_axis, expanding_args, *args, **kwargs):
        return ExpandingDefault.register(pandas.core.window.expanding.Expanding.min)(self, expanding_args, *args, **kwargs)
    ...
    def expanding_max(self, fold_axis, expanding_args, *args, **kwargs):
        return ExpandingDefault.register(pandas.core.window.expanding.Expanding.max)(self, expanding_args, *args, **kwargs)
    ...
    def expanding_mean(self, fold_axis, expanding_args, *args, **kwargs):
        return ExpandingDefault.register(pandas.core.window.expanding.Expanding.mean)(self, expanding_args, *args, **kwargs)
    ...
    def expanding_var(self, fold_axis, expanding_args, ddof=1, *args, **kwargs):
        return ExpandingDefault.register(pandas.core.window.expanding.Expanding.var)(self, expanding_args, *args, ddof=ddof, **kwargs)
    ...
    def expanding_std(self, fold_axis, expanding_args, ddof=1, *args, **kwargs):
        return ExpandingDefault.register(pandas.core.window.expanding.Expanding.std)(self, expanding_args, *args, ddof=ddof, **kwargs)
    ...
    def expanding_cov(self, fold_axis, expanding_args, squeeze_self, squeeze_other, other=None, pairwise=None, ddof=1, numeric_only=False, **kwargs):
        other_for_default = other if other is None else other.to_pandas().squeeze(axis=1) if squeeze_other else other.to_pandas()
        return ExpandingDefault.register(pandas.core.window.expanding.Expanding.cov, squeeze_self=squeeze_self)(self, expanding_args, other=other_for_default, pairwise=pairwise, ddof=ddof, numeric_only=numeric_only, **kwargs)

    @doc_utils.doc_window_method(window_cls_name='Expanding', result='standard deviation', refer_to='std', win_type='expanding window', params='\n        ddof : int, default: 1\n        *args : iterable\n        **kwargs : dict')
    def expanding_count(self, fold_axis, expanding_args, ddof=1, *args, **kwargs):
        return ExpandingDefault.register(pandas.core.window.expanding.Expanding.count)(self, expanding_args, *args, **kwargs)
    ...
    def expanding_quantile(self, fold_axis, expanding_args, quantile, interpolation, **kwargs):
        return ExpandingDefault.register(pandas.core.window.expanding.Expanding.quantile)(self, expanding_args, quantile, interpolation, **kwargs)
    ...
    def expanding_skew(self, fold_axis, expanding_args, numeric_only=False, **kwargs):
        return ExpandingDefault.register(pandas.core.window.expanding.Expanding.skew)(self, expanding_args, numeric_only=numeric_only, **kwargs)
    ...
    def expanding_kurt(self, fold_axis, expanding_args, numeric_only=False, **kwargs):
        return ExpandingDefault.register(pandas.core.window.expanding.Expanding.kurt)(self, expanding_args, numeric_only=numeric_only, **kwargs)
    ...
    def window_sum(self, fold_axis, window_kwargs, *args, **kwargs):
        return RollingDefault.register(pandas.core.window.Window.sum)(self, window_kwargs, *args, **kwargs)
    ...
    def kurt(self, axis, numeric_only=False, skipna=True, **kwargs):
        return DataFrameDefault.register(pandas.DataFrame.kurt)(self, axis=axis, skipna=skipna, numeric_only=numeric_only, **kwargs)
    sum_min_count = sum
    prod_min_count = prod
    ...
    def compare(self, other, align_axis, keep_shape, keep_equal, result_names):
        ...
        BaseQueryCompiler
            ...
            query compiler.
        """
        return DataFrameDefault.register(pandas.DataFrame.compare)(self, other=other, align_axis=align_axis, keep_shape=keep_shape, keep_equal=keep_equal, result_names=result_names)
    ...
    def case_when(self, caselist):
        ...
        """
        qc_type = type(self)
        caselist = [tuple((data.to_pandas().squeeze(axis=1) if isinstance(data, qc_type) else data for data in case_tuple)) for case_tuple in caselist]
    ...
    def repartition(self, axis=None):
        ...
        for _ax in axes:
            new_query_compiler = new_query_compiler.__constructor__(new_query_compiler._modin_frame.apply_full_axis(_ax, lambda df: df, new_index=self._modin_frame.copy_index_cache(copy_lengths=_ax == 1), new_columns=self._modin_frame.copy_columns_cache(copy_lengths=_ax == 0), dtypes=self._modin_frame.copy_dtypes_cache(), keep_partitioning=False, sync_labels=False))
