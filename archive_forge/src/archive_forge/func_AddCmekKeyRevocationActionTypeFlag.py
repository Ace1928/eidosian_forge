...
def AddCmekKeyRevocationActionTypeFlag(parser, with_clear=True):
    ...
    if with_clear:
        ...
        policy_group.add_argument('--clear-post-key-revocation-action-type', default=False, action='store_true', help='Remove any previously set post CMEK key revocation action type.')
    policy_group.add_argument('--post-key-revocation-action-type', choices=_POST_CMEK_KEY_REVOCATION_ACTION_TYPE_CHOICES, help='Action type after CMEK key revocation.')