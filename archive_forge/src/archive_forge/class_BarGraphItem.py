...
class BarGraphItem(GraphicsObject):
    ...
    def __init__(self, **opts):
        ...
        self.opts = dict(x=None, y=None, x0=None, y0=None, x1=None, y1=None, name=None, height=None, width=None, pen=None, brush=None, pens=None, brushes=None)
        if 'pen' not in opts:
    ...
    def _render(self, painter):
        ...
        no_pen = not multi_pen and self._sharedPen.style() == QtCore.Qt.PenStyle.NoPen
