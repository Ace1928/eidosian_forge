...
@pytest.mark.parametrize('geometry,expected', [(Point(0, 0), []), ([Point(0, 0)], [[], []]), (shapely.linestrings([[0, 0], [2, 2]]), []), ([shapely.linestrings([[0, 0], [2, 2]])], [[], []]), (box(0, 0, 1, 1), []), ([box(0, 0, 1, 1)], [[], []]), (box(0, 0, 2, 2), [1]), ([box(0, 0, 2, 2)], [[0], [1]]), (shapely.buffer(Point(3, 3), HALF_UNIT_DIAG), []), ([shapely.buffer(Point(3, 3), HALF_UNIT_DIAG)], [[], []]), (shapely.buffer(Point(3, 3), 3 * HALF_UNIT_DIAG), [3]), ([shapely.buffer(Point(3, 3), 3 * HALF_UNIT_DIAG)], [[0], [3]]), (MultiPoint([[5, 7], [7, 5]]), []), ([MultiPoint([[5, 7], [7, 5]])], [[], []])])
