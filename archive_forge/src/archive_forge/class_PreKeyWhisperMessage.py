...
class PreKeyWhisperMessage(CiphertextMessage):
    ...
    def __init__(self, messageVersion=None, registrationId=None, preKeyId=None, signedPreKeyId=None, ecPublicBaseKey=None, identityKey=None, whisperMessage=None, serialized=None):
        if serialized:
            try:
                ...
                if preKeyWhisperMessage.signedPreKeyId is None or not preKeyWhisperMessage.baseKey or (not preKeyWhisperMessage.identityKey) or (not preKeyWhisperMessage.message):
