...
class NDFrame(PandasObject, indexing.IndexingMixin):
    ...
    """
    _internal_names: list[str] = ['_mgr', '_cacher', '_item_cache', '_cache', '_is_copy', '_name', '_metadata', '_flags']
    ...
    @property
    def _data(self):
        warnings.warn(f'{type(self).__name__}._data is deprecated and will be removed in a future version. Use public APIs instead.', DeprecationWarning, stacklevel=find_stack_level())
        return self._mgr
    ...
    def _get_cleaned_column_resolvers(self) -> dict[Hashable, Series]:
        ...
        return {clean_column_name(k): Series(v, copy=False, index=self.index, name=k, dtype=self.dtypes[k]).__finalize__(self) for k, v in zip(self.columns, self._iter_column_arrays()) if not isinstance(k, int)}
    ...
    def swapaxes(self, axis1: Axis, axis2: Axis, copy: bool_t | None=None) -> Self:
        ...
        """
        warnings.warn(f"'{type(self).__name__}.swapaxes' is deprecated and will be removed in a future version. Please use '{type(self).__name__}.transpose' instead.", FutureWarning, stacklevel=find_stack_level())
        ...
        if self._mgr.is_single_block and isinstance(self._mgr, BlockManager):
            new_mgr = ndarray_to_mgr(new_values, new_axes[0], new_axes[1], dtype=None, copy=False, typ='block')
        ...
        return self._constructor(new_values, *new_axes, copy=False).__finalize__(self, method='swapaxes')
    ...
    def rename_axis(self, mapper: IndexLabel | lib.NoDefault=lib.no_default, *, index=lib.no_default, columns=lib.no_default, axis: Axis=0, copy: bool_t | None=None, inplace: bool_t=False) -> Self | None:
        """
    ...
    def take(self, indices, axis: Axis=0, **kwargs) -> Self:
        ...
        **kwargs
        ...
        if not isinstance(indices, slice):
            ...
            warnings.warn(f'Passing a slice to {type(self).__name__}.take is deprecated and will raise in a future version. Use `obj[slicer]` or pass a sequence of integers instead.', FutureWarning, stacklevel=find_stack_level())
    ...
    def drop(self, labels: IndexLabel | None=None, *, axis: Axis=0, index: IndexLabel | None=None, columns: IndexLabel | None=None, level: Level | None=None, inplace: bool_t=False, errors: IgnoreRaise='raise') -> Self | None:
        inplace = validate_bool_kwarg(inplace, 'inplace')
    ...
    def sort_values(self, *, axis: Axis=0, ascending: bool_t | Sequence[bool_t]=True, inplace: bool_t=False, kind: SortKind='quicksort', na_position: NaPosition='last', ignore_index: bool_t=False, key: ValueKeyFunc | None=None) -> Self | None:
        """
    ...
    def sort_index(self, *, axis: Axis=0, level: IndexLabel | None=None, ascending: bool_t | Sequence[bool_t]=True, inplace: bool_t=False, kind: SortKind='quicksort', na_position: NaPosition='last', sort_remaining: bool_t=True, ignore_index: bool_t=False, key: IndexKeyFunc | None=None) -> Self | None:
        inplace = validate_bool_kwarg(inplace, 'inplace')
        axis = self._get_axis_number(axis)
    ...
    def reindex(self, labels=None, *, index=None, columns=None, axis: Axis | None=None, method: ReindexMethod | None=None, copy: bool_t | None=None, level: Level | None=None, fill_value: Scalar | None=np.nan, limit: int | None=None, tolerance=None) -> Self:
        """
    ...
    @final
    def sample(self, n: int | None=None, frac: float | None=None, replace: bool_t=False, weights=None, random_state: RandomState | None=None, axis: Axis | None=None, ignore_index: bool_t=False) -> Self:
        """
    ...
    def _deprecate_downcast(self, downcast, method_name: str):
        if downcast is not lib.no_default:
            warnings.warn(f"The 'downcast' keyword in {method_name} is deprecated and will be removed in a future version. Use res.infer_objects(copy=False) to infer non-object dtype, or pd.to_numeric with the 'downcast' keyword to downcast numeric results.", FutureWarning, stacklevel=find_stack_level())
        else:
            downcast = None
        return downcast
    ...
    def _pad_or_backfill(self, method: Literal['ffill', 'bfill', 'pad', 'backfill'], *, axis: None | Axis=None, inplace: bool_t=False, limit: None | int=None, limit_area: Literal['inside', 'outside'] | None=None, downcast: dict | None=None):
        ...
        if not self._mgr.is_single_block and axis == 1:
            ...
            return result
        new_mgr = self._mgr.pad_or_backfill(method=method, axis=self._get_block_manager_axis(axis), limit=limit, limit_area=limit_area, inplace=inplace, downcast=downcast)
        result = self._constructor_from_mgr(new_mgr, axes=new_mgr.axes)
        if inplace:
            return self._update_inplace(result)
        else:
    ...
    def fillna(self, value: Hashable | Mapping | Series | DataFrame | None=None, *, method: FillnaOptions | None=None, axis: Axis | None=None, inplace: bool_t=False, limit: int | None=None, downcast: dict | None | lib.NoDefault=lib.no_default) -> Self | None:
        """
        ...
        if method is not None:
            warnings.warn(f"{type(self).__name__}.fillna with 'method' is deprecated and will raise in a future version. Use obj.ffill() or obj.bfill() instead.", FutureWarning, stacklevel=find_stack_level())
        ...
        axis = self._get_axis_number(axis)
        if value is None:
            return self._pad_or_backfill(method, axis=axis, limit=limit, inplace=inplace, downcast=downcast)
        elif self.ndim == 1:
    ...
    @final
    @doc(klass=_shared_doc_kwargs['klass'])
    def pad(self, *, axis: None | Axis=None, inplace: bool_t=False, limit: None | int=None, downcast: dict | None | lib.NoDefault=lib.no_default) -> Self | None:
        """
        Fill NA/NaN values by propagating the last valid observation to next valid.
        ...
        """
        warnings.warn('DataFrame.pad/Series.pad is deprecated. Use DataFrame.ffill/Series.ffill instead', FutureWarning, stacklevel=find_stack_level())
    ...
    @final
    @doc(klass=_shared_doc_kwargs['klass'])
    def backfill(self, *, axis: None | Axis=None, inplace: bool_t=False, limit: None | int=None, downcast: dict | None | lib.NoDefault=lib.no_default) -> Self | None:
        """
        Fill NA/NaN values by using the next valid observation to fill the gap.
        ...
        """
        warnings.warn('DataFrame.backfill/Series.backfill is deprecated. Use DataFrame.bfill/Series.bfill instead', FutureWarning, stacklevel=find_stack_level())
    ...
    def replace(self, to_replace=None, value=lib.no_default, *, inplace: bool_t=False, limit: int | None=None, regex: bool_t=False, method: Literal['pad', 'ffill', 'bfill'] | lib.NoDefault=lib.no_default) -> Self | None:
        if method is not lib.no_default:
            warnings.warn(f"The 'method' keyword in {type(self).__name__}.replace is deprecated and will be removed in a future version.", FutureWarning, stacklevel=find_stack_level())
        elif limit is not None:
            warnings.warn(f"The 'limit' keyword in {type(self).__name__}.replace is deprecated and will be removed in a future version.", FutureWarning, stacklevel=find_stack_level())
        if value is lib.no_default and method is lib.no_default and (not is_dict_like(to_replace)) and (regex is False):
            warnings.warn(f"{type(self).__name__}.replace without 'value' and with non-dict-like 'to_replace' is deprecated and will raise in a future version. Explicitly specify the new values instead.", FutureWarning, stacklevel=find_stack_level())
        ...
        if value is lib.no_default or method is not lib.no_default:
            ...
            if isinstance(to_replace, (tuple, list)):
                if isinstance(self, ABCDataFrame):
                    from pandas import Series
                    result = self.apply(Series._replace_single, args=(to_replace, method, inplace, limit))
                    if inplace:
                        return None
                    return result
    ...
    @final
    def interpolate(self, method: InterpolateOptions='linear', *, axis: Axis=0, limit: int | None=None, inplace: bool_t=False, limit_direction: Literal['forward', 'backward', 'both'] | None=None, limit_area: Literal['inside', 'outside'] | None=None, downcast: Literal['infer'] | None | lib.NoDefault=lib.no_default, **kwargs) -> Self | None:
        """
        ...
        """
        if downcast is not lib.no_default:
            warnings.warn(f"The 'downcast' keyword in {type(self).__name__}.interpolate is deprecated and will be removed in a future version. Call result.infer_objects(copy=False) on the result instead.", FutureWarning, stacklevel=find_stack_level())
        else:
            downcast = None
        ...
        if method.lower() in fillna_methods:
            warnings.warn(f'{type(self).__name__}.interpolate with method={method} is deprecated and will raise in a future version. Use obj.ffill() or obj.bfill() instead.', FutureWarning, stacklevel=find_stack_level())
            ...
            if np.any(obj.dtypes == object):
                if not (obj.ndim == 2 and np.all(obj.dtypes == object)):
                    warnings.warn(f'{type(self).__name__}.interpolate with object dtype is deprecated and will raise in a future version. Call obj.infer_objects(copy=False) before interpolating instead.', FutureWarning, stacklevel=find_stack_level())
        if method in fillna_methods and 'fill_value' in kwargs:
            raise ValueError(f"'fill_value' is not a valid keyword for {type(self).__name__}.interpolate with method from {fillna_methods}")
        ...
        if method.lower() in fillna_methods:
            ...
            new_data = obj._mgr.pad_or_backfill(method=method, axis=self._get_block_manager_axis(axis), limit=limit, limit_area=limit_area, inplace=inplace, downcast=downcast)
        else:
            index = missing.get_interp_index(method, obj.index)
            new_data = obj._mgr.interpolate(method=method, index=index, limit=limit, limit_direction=limit_direction, limit_area=limit_area, inplace=inplace, downcast=downcast, **kwargs)
        result = self._constructor_from_mgr(new_data, axes=new_data.axes)
        if should_transpose:
            result = result.T
        if inplace:
    ...
    @final
    def clip(self, lower=None, upper=None, *, axis: Axis | None=None, inplace: bool_t=False, **kwargs) -> Self | None:
        """
    ...
    @final
    @doc(klass=_shared_doc_kwargs['klass'])
    def resample(self, rule, axis: Axis | lib.NoDefault=lib.no_default, closed: Literal['right', 'left'] | None=None, label: Literal['right', 'left'] | None=None, convention: Literal['start', 'end', 's', 'e'] | lib.NoDefault=lib.no_default, kind: Literal['timestamp', 'period'] | None | lib.NoDefault=lib.no_default, on: Level | None=None, level: Level | None=None, origin: str | TimestampConvertibleTypes='start_day', offset: TimedeltaConvertibleTypes | None=None, group_keys: bool_t=False) -> Resampler:
        """
        ...
        if axis is not lib.no_default:
            axis = self._get_axis_number(axis)
            if axis == 1:
                warnings.warn('DataFrame.resample with axis=1 is deprecated. Do `frame.T.resample(...)` without axis instead.', FutureWarning, stacklevel=find_stack_level())
            else:
                warnings.warn(f"The 'axis' keyword in {type(self).__name__}.resample is deprecated and will be removed in a future version.", FutureWarning, stacklevel=find_stack_level())
        else:
            axis = 0
        if kind is not lib.no_default:
            warnings.warn(f"The 'kind' keyword in {type(self).__name__}.resample is deprecated and will be removed in a future version. Explicitly cast the index to the desired type instead", FutureWarning, stacklevel=find_stack_level())
        else:
            kind = None
        if convention is not lib.no_default:
            ...
            convention = 'start'
        return get_resampler(cast('Series | DataFrame', self), freq=rule, label=label, closed=closed, axis=axis, kind=kind, convention=convention, key=on, level=level, origin=origin, offset=offset, group_keys=group_keys)
    ...
    def last(self, offset) -> Self:
        ...
        not returned.
        """
        warnings.warn('last is deprecated and will be removed in a future version. Please create a mask and filter using `.loc` instead', FutureWarning, stacklevel=find_stack_level())
        if not isinstance(self.index, DatetimeIndex):
    ...
    @final
    def _align_frame(self, other: DataFrame, join: AlignJoin='outer', axis: Axis | None=None, level=None, copy: bool_t | None=None, fill_value=None, method=None, limit: int | None=None, fill_axis: Axis=0) -> tuple[Self, DataFrame, Index | None]:
    ...
    @final
    def _where(self, cond, other=lib.no_default, inplace: bool_t=False, axis: Axis | None=None, level=None, warn: bool_t=True):
        """
        ...
        if isinstance(other, NDFrame):
            if other.ndim <= self.ndim:
                other = self.align(other, join='left', axis=axis, level=level, fill_value=None, copy=False)[1]
    ...
    def where(self, cond, other=np.nan, *, inplace: bool_t=False, axis: Axis | None=None, level: Level | None=None) -> Self | None:
        """
    ...
    def mask(self, cond, other=lib.no_default, *, inplace: bool_t=False, axis: Axis | None=None, level: Level | None=None) -> Self | None:
        inplace = validate_bool_kwarg(inplace, 'inplace')
        if inplace:
            if not PYPY and using_copy_on_write():
                if sys.getrefcount(self) <= REF_COUNT:
    ...
    @final
    def truncate(self, before=None, after=None, axis: Axis | None=None, copy: bool_t | None=None) -> Self:
        """
    ...
    @final
    @doc(klass=_shared_doc_kwargs['klass'])
    def tz_localize(self, tz, axis: Axis=0, level=None, copy: bool_t | None=None, ambiguous: TimeAmbiguous='raise', nonexistent: TimeNonexistent='raise') -> Self:
        """
    ...
    def _logical_func(self, name: str, func, axis: Axis | None=0, bool_only: bool_t=False, skipna: bool_t=True, **kwargs) -> Series | bool_t:
        ...
        if self.ndim > 1 and axis is None:
            ...
            axis = 0
        if self.ndim > 1 and axis == 1 and (len(self._mgr.arrays) > 1) and all((x.ndim == 2 for x in self._mgr.arrays)) and (not kwargs):
            obj = self
            if bool_only:
    ...
    @final
    def _stat_function_ddof(self, name: str, func, axis: Axis | None | lib.NoDefault=lib.no_default, skipna: bool_t=True, ddof: int=1, numeric_only: bool_t=False, **kwargs) -> Series | float:
    ...
    @final
    @doc(Expanding)
    def expanding(self, min_periods: int=1, axis: Axis | lib.NoDefault=lib.no_default, method: Literal['single', 'table']='single') -> Expanding:
        if axis is not lib.no_default:
            axis = self._get_axis_number(axis)
            name = 'expanding'
            if axis == 1:
    ...
    def _inplace_method(self, other, op) -> Self:
        ...
        if self.ndim == 1 and result._indexed_same(self) and (result.dtype == self.dtype) and (not using_copy_on_write()) and (not (warn_copy_on_write() and (not warn))):
            self._mgr.setitem_inplace(slice(None), result._values, warn=warn)
            return self
        self._reset_cacher()
