...
class NetworksApplianceConnectivityMonitoringDestinations(object):
    ...
    def __init__(self, params, meraki):
        self.meraki = meraki
        self.new_object = dict(destinations=params.get('destinations'), network_id=params.get('networkId'))
    ...
    def get_object_by_name(self, name):
        result = None
        try:
            items = self.meraki.exec_meraki(family='appliance', function='getNetworkApplianceConnectivityMonitoringDestinations', params=self.get_all_params(name=name))
    ...
    def update(self):
        ...
        name = self.new_object.get('name')
        result = None
        result = self.meraki.exec_meraki(family='appliance', function='updateNetworkApplianceConnectivityMonitoringDestinations', params=self.update_all_params(), op_modifies=True)
        return result