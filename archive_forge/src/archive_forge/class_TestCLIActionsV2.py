...
class TestCLIActionsV2(base.BaseCommandTest):
    ...
    def test_delete(self):
        ...
        self.client.actions.delete.assert_called_once_with('name', namespace='')

    def test_delete_with_namespace(self):
        self.call(action_cmd.Delete, app_args=['name', '--namespace', 'test_namespace'])
        self.client.actions.delete.assert_called_once_with('name', namespace='test_namespace')
    ...
    def test_delete_with_multi_names(self):
        ...
        self.assertEqual(2, self.client.actions.delete.call_count)
        self.assertEqual([mock.call('name1', namespace=''), mock.call('name2', namespace='')], self.client.actions.delete.call_args_list)
    ...
    def test_validate_failed(self, mock_open):
        self.client.actions.validate.return_value = {'valid': False, 'error': 'Invalid DSL...'}
        result = self.call(action_cmd.Validate, app_args=['action.yaml'])
