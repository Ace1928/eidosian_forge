...
class Encrypt(base.Command):
    ...
    detailed_help = {'DESCRIPTION': '          Encrypt the existing volumes with the desired KMS (Key Management System) Config using Customer Managed Encryption Keys (CMEK).\n          ', 'EXAMPLES': '          The following command encrypts the existing volumes with the desired KMS Config instance named KMS_CONFIG using specified project and location.\n\n              $ {command} KMS_CONFIG --location=us-central1\n          '}
