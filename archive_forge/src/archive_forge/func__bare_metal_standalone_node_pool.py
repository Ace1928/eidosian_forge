...
def _bare_metal_standalone_node_pool(self, args: parser_extensions.Namespace):
    ...
    kwargs = {'name': self._node_pool_name(args), 'nodePoolConfig': self._node_pool_config(args), 'displayName': getattr(args, 'display_name', None), 'annotations': self._annotations(args)}
