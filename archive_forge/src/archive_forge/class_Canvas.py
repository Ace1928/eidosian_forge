...
class Canvas(_PDFColorSetter):
    ...
    def __init__(self, filename, pagesize=None, bottomup=1, pageCompression=None, invariant=None, verbosity=0, encrypt=None, cropMarks=None, pdfVersion=None, enforceColorSpace=None, initialFontName=None, initialFontSize=None, initialLeading=None, cropBox=None, artBox=None, trimBox=None, bleedBox=None, lang=None):
        ...
        self._doc = pdfdoc.PDFDocument(compression=pageCompression, invariant=invariant, filename=filename, pdfVersion=pdfVersion or pdfdoc.PDF_VERSION_DEFAULT, lang=lang)
    ...
    def drawInlineImage(self, image, x, y, width=None, height=None, preserveAspectRatio=False, anchor='c', anchorAtXY=False, showBoundary=False, extraReturn=None):
        ...
        img_obj.drawInlineImage(self, preserveAspectRatio=preserveAspectRatio, anchor=anchor, anchorAtXY=anchorAtXY, showBoundary=showBoundary, extraReturn=extraReturn)
    ...
    def transform(self, a, b, c, d, e, f):
        ...
        if ENABLE_TRACKING:
            ...
            self._currentMatrix = (a0 * a + c0 * b, b0 * a + d0 * b, a0 * c + c0 * d, b0 * c + d0 * d, a0 * e + c0 * f + e0, b0 * e + d0 * f + f0)
    ...
    def stringWidth(self, text, fontName=None, fontSize=None):
        ...
        return pdfmetrics.stringWidth(text, fontName or self._fontname, (fontSize, self._fontsize)[fontSize is None])
