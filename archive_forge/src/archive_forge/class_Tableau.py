...
class Tableau(Dialect):
    ...
    class Generator(generator.Generator):
        ...
        TABLE_HINTS = False
        QUERY_HINTS = False
        TRANSFORMS = {**generator.Generator.TRANSFORMS, exp.Coalesce: rename_func('IFNULL'), exp.Select: transforms.preprocess([transforms.eliminate_distinct_on])}
    ...
    class Parser(parser.Parser):
        FUNCTIONS = {**parser.Parser.FUNCTIONS, 'COUNTD': lambda args: exp.Count(this=exp.Distinct(expressions=args))}
