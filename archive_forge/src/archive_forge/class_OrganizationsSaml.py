...
class OrganizationsSaml(object):
    ...
    def __init__(self, params, meraki):
        self.meraki = meraki
        self.new_object = dict(enabled=params.get('enabled'), organization_id=params.get('organizationId'))
    ...
    def get_object_by_name(self, name):
        result = None
        try:
            items = self.meraki.exec_meraki(family='organizations', function='getOrganizationSaml', params=self.get_all_params(name=name))
    ...
    def requires_update(self, current_obj):
        ...
        obj_params = [('enabled', 'enabled'), ('organizationId', 'organizationId')]
    ...
    def update(self):
        ...
        name = self.new_object.get('name')
        result = None
        result = self.meraki.exec_meraki(family='organizations', function='updateOrganizationSaml', params=self.update_all_params(), op_modifies=True)
        return result