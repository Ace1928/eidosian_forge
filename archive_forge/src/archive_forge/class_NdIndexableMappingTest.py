...
class NdIndexableMappingTest(ComparisonTestCase):
    ...
    def test_idxmapping_init_dimdict(self):
        MultiDimensionalMapping(self.init_item_odict, kdims=[dict(name=label) for label in self.dimension_labels])
    ...
    def test_idxmapping_redim(self):
        ...
        self.assertEqual(redimmed.kdims, [Dimension('Integer', type=int), Dimension('floatdim', type=float)])
