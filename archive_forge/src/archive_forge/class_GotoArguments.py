...
class GotoArguments(BaseSchema):
    ...
    """
    __props__ = {'threadId': {'type': 'integer', 'description': 'Set the goto target for this thread.'}, 'targetId': {'type': 'integer', 'description': 'The location where the debuggee will continue to run.'}}
    __refs__ = set()
    __slots__ = list(__props__.keys()) + ['kwargs']

    def __init__(self, threadId, targetId, update_ids_from_dap=False, **kwargs):
        """
    ...
    def to_dict(self, update_ids_to_dap=False):
        ...
        dct = {'threadId': threadId, 'targetId': targetId}
