...
def test_delete_image_w_snap_with_error(self, unprotect, remove_snap, remove):
    ...
    self.assertRaises(TestException, self.store._delete_image, 'fake_pool', self.location.image, snapshot_name='snap')
