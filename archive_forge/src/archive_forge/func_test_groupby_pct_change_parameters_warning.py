...
def test_groupby_pct_change_parameters_warning():
    ...
    match_string = "The 'fill_method' keyword being not None and the 'limit' keyword " + 'in (DataFrame|DataFrameGroupBy).pct_change are deprecated'
    with pytest.warns(FutureWarning, match=match_string):
