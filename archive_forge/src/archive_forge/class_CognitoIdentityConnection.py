...
class CognitoIdentityConnection(AWSQueryConnection):
    ...
    _faults = {'LimitExceededException': exceptions.LimitExceededException, 'ResourceConflictException': exceptions.ResourceConflictException, 'DeveloperUserAlreadyRegisteredException': exceptions.DeveloperUserAlreadyRegisteredException, 'TooManyRequestsException': exceptions.TooManyRequestsException, 'InvalidParameterException': exceptions.InvalidParameterException, 'ResourceNotFoundException': exceptions.ResourceNotFoundException, 'InternalErrorException': exceptions.InternalErrorException, 'NotAuthorizedException': exceptions.NotAuthorizedException}
