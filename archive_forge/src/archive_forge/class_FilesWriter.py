...
class FilesWriter(WriterBase):
    ...
    def write(self, output, resources, notebook_name=None, **kw):
        ...
        if attachments:
            self.log.info('Attachments will be in %s', os.path.join(resources.get('attachment_files_dir', ''), ''))
