...
class NetworksApplianceFirewallL3FirewallRules(object):
    ...
    def get_object_by_name(self, name):
        result = None
        try:
            items = self.meraki.exec_meraki(family='appliance', function='getNetworkApplianceFirewallL3FirewallRules', params=self.get_all_params(name=name))
    ...
    def update(self):
        ...
        name = self.new_object.get('name')
        result = None
        result = self.meraki.exec_meraki(family='appliance', function='updateNetworkApplianceFirewallL3FirewallRules', params=self.update_all_params(), op_modifies=True)
        return result