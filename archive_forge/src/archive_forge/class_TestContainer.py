...
class TestContainer(base.TestCase):
    ...
    def setUp(self):
        ...
        self.body = {'count': 2, 'bytes': 630666, 'name': self.container}
        self.headers = {'x-container-object-count': '2', 'x-container-read': 'read-settings', 'x-container-write': 'write-settings', 'x-container-sync-to': 'sync-to', 'x-container-sync-key': 'sync-key', 'x-container-bytes-used': '630666', 'x-versions-location': 'versions-location', 'x-history-location': 'history-location', 'content-type': 'application/json; charset=utf-8', 'x-timestamp': '1453414055.48672', 'x-storage-policy': 'Gold'}
    ...
    def test_list(self):
        containers = [{'count': 999, 'bytes': 12345, 'name': 'container1'}, {'count': 888, 'bytes': 54321, 'name': 'container2'}]
    ...
    def test_to_json(self):
        sot = container.Container.new(name=self.container)
        self.assertEqual({'bytes': None, 'bytes_used': None, 'content_type': None, 'count': None, 'id': self.container, 'if_none_match': None, 'is_content_type_detected': None, 'is_newest': None, 'location': None, 'name': self.container, 'object_count': None, 'read_ACL': None, 'sync_key': None, 'sync_to': None, 'meta_temp_url_key': None, 'meta_temp_url_key_2': None, 'timestamp': None, 'versions_location': None, 'history_location': None, 'write_ACL': None, 'storage_policy': None}, json.loads(json.dumps(sot)))
