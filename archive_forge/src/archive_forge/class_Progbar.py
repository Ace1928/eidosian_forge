...
class Progbar(object):
  ...
  """
    ...
    def __init__(self, target, width=30, verbose=1, interval=0.05, stateful_metrics=None, unit_name='step'):
        ...
        self._dynamic_display = hasattr(sys.stdout, 'isatty') and sys.stdout.isatty() or 'ipykernel' in sys.modules or 'posix' in sys.modules or ('PYCHARM_HOSTED' in os.environ)
        self._total_width = 0
        self._seen_so_far = 0
        self._values = {}
        self._values_order = []
