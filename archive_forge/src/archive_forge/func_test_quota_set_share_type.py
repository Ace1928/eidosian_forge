...
def test_quota_set_share_type(self):
    ...
    with mock.patch('osc_lib.utils.find_resource') as mock_find_resource:
        ...
        self.quotas_mock.update.assert_called_with(force=None, gigabytes=None, share_networks=None, share_type='default', shares=None, snapshot_gigabytes=None, snapshots=None, tenant_id=self.project.id, user_id=None)
