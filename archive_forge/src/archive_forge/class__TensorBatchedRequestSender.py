...
class _TensorBatchedRequestSender:
    ...
    def __init__(self, experiment_id, api, rpc_rate_limiter, max_request_size, max_tensor_point_size, tracker):
    ...
    def flush(self):
        ...
        with _request_logger(request, request.runs):
            with self._tracker.tensors_tracker(self._num_values, self._num_values_skipped, self._tensor_bytes, self._tensor_bytes_skipped):
                try:
