class ASCIIFormatter:
    ...
    Initializes the AdvancedASCIIFormatter class with the default ASCII art components.
        ...
        self.NESTED_ENTRY_QUESTION: str = "❓"   # For Nested Entry Question
        self.NESTED_ENTRY_EXCLAMATION: str = "❗"   # For Nested Entry Exclamation
        self.NESTED_ENTRY_CHECK: str = ""   # For Nested Entry Check
        self.NESTED_ENTRY_CROSS: str = "❌"   # For Nested Entry Cross
