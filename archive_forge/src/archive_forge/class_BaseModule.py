...
class BaseModule(object):
    ...
    def score(self, eval_data, eval_metric, num_batch=None, batch_end_callback=None, score_end_callback=None, reset=True, epoch=0, sparse_row_id_fn=None):
    ...
    def predict(self, eval_data, num_batch=None, merge_batches=True, reset=True, always_output_list=False, sparse_row_id_fn=None):
        ...
        if merge_batches:
            ...
            for out in output_list:
                assert len(out) == num_outputs, 'Cannot merge batches, as num of outputs is not the same ' + 'in mini-batches. Maybe bucketing is used?'
