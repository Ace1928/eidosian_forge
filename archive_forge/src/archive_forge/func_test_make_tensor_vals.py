...
def test_make_tensor_vals(tensor_dtype: int) -> None:
    ...
    tensor = helper.make_tensor(name='test', data_type=tensor_dtype, dims=np_array.shape, vals=np_array)
