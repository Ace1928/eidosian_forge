...
# Type alias for clarity and to avoid repetition
FieldsDictType = Dict[str, Tuple[Type[Any], Union[Any, Tuple[()]]]]
...
class UniversalModel(BaseModel):
    ...
    def create_dynamic_model(cls, name: str, fields: FieldsDictType) -> ModelType:
        ...
        # Create a new model that inherits from the base model and adds the new fields
        new_model: ModelType = create_model(name, __base__=cls, **fields)
        return new_model
