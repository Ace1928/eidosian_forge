...
class SamplingParams:
    ...
    def __init__(self, n: int=1, best_of: Optional[int]=None, presence_penalty: float=0.0, frequency_penalty: float=0.0, repetition_penalty: float=1.0, temperature: float=1.0, top_p: float=1.0, top_k: int=-1, min_p: float=0.0, seed: Optional[int]=None, use_beam_search: bool=False, length_penalty: float=1.0, early_stopping: Union[bool, str]=False, stop: Optional[Union[str, List[str]]]=None, stop_token_ids: Optional[List[int]]=None, include_stop_str_in_output: bool=False, ignore_eos: bool=False, max_tokens: Optional[int]=16, logprobs: Optional[int]=None, prompt_logprobs: Optional[int]=None, skip_special_tokens: bool=True, spaces_between_special_tokens: bool=True, logits_processors: Optional[List[LogitsProcessor]]=None) -> None:
        self.n = n
    ...
    def __repr__(self) -> str:
        return f'SamplingParams(n={self.n}, best_of={self.best_of}, presence_penalty={self.presence_penalty}, frequency_penalty={self.frequency_penalty}, repetition_penalty={self.repetition_penalty}, temperature={self.temperature}, top_p={self.top_p}, top_k={self.top_k}, min_p={self.min_p}, seed={self.seed}, use_beam_search={self.use_beam_search}, length_penalty={self.length_penalty}, early_stopping={self.early_stopping}, stop={self.stop}, stop_token_ids={self.stop_token_ids}, include_stop_str_in_output={self.include_stop_str_in_output}, ignore_eos={self.ignore_eos}, max_tokens={self.max_tokens}, logprobs={self.logprobs}, prompt_logprobs={self.prompt_logprobs}, skip_special_tokens={self.skip_special_tokens}, spaces_between_special_tokens={self.spaces_between_special_tokens})'