...
class hvPlotTabular(hvPlotBase):
    ...
    **kwds : optional
    ...
    """
    __all__ = ['line', 'step', 'scatter', 'area', 'errorbars', 'ohlc', 'heatmap', 'hexbin', 'bivariate', 'bar', 'barh', 'box', 'violin', 'hist', 'kde', 'density', 'table', 'dataset', 'points', 'vectorfield', 'polygons', 'paths', 'labels', 'explorer']
