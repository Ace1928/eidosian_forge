...
class CursorServiceTransport(abc.ABC):
    ...
    @property
    def streaming_commit_cursor(self) -> Callable[[cursor.StreamingCommitCursorRequest], Union[cursor.StreamingCommitCursorResponse, Awaitable[cursor.StreamingCommitCursorResponse]]]:
        raise NotImplementedError()
    ...
    @property
    def list_partition_cursors(self) -> Callable[[cursor.ListPartitionCursorsRequest], Union[cursor.ListPartitionCursorsResponse, Awaitable[cursor.ListPartitionCursorsResponse]]]:
        raise NotImplementedError()
