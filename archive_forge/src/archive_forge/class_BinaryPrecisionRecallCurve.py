...
class BinaryPrecisionRecallCurve(Metric):
    ...
    def __init__(self, thresholds: Optional[Union[int, List[float], Tensor]]=None, ignore_index: Optional[int]=None, validate_args: bool=True, **kwargs: Any) -> None:
    ...
    def plot(self, curve: Optional[Tuple[Tensor, Tensor, Tensor]]=None, score: Optional[Union[Tensor, bool]]=None, ax: Optional[_AX_TYPE]=None) -> _PLOT_OUT_TYPE:
        ...
        score = _auc_compute_without_check(curve_computed[0], curve_computed[1], direction=-1.0) if not curve and score is True else None
