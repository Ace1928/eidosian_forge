...
class ListPartitionCursorsPager:
    ...
    def __init__(self, method: Callable[..., cursor.ListPartitionCursorsResponse], request: cursor.ListPartitionCursorsRequest, response: cursor.ListPartitionCursorsResponse, *, metadata: Sequence[Tuple[str, str]]=()):
