...
def export_image_decoder_decode_jpeg2k_rgb() -> None:
    ...
    data, output = _generate_test_data('jpeg2000', _image_decoder_data.image_decoder_decode_jpeg2k_rgb, 'RGB')
    expect(node, inputs=[data], outputs=[output], name='test_image_decoder_decode_jpeg2k_rgb')