...
@fugue_annotated_param(Iterable[Dict[str, Any]], matcher=lambda x: x == Iterable[Dict[str, Any]] or x == Iterator[Dict[str, Any]])
class _IterableDictParam(_LocalNoSchemaDataFrameParam):
    ...
    @no_type_check
    def to_output_df(self, output: Iterable[Dict[str, Any]], schema: Any, ctx: Any) -> DataFrame:
