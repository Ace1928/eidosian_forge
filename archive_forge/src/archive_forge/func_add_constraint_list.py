...
def add_constraint_list(util_block):
    ...
    util_block.constraint_list = list(model.component_data_objects(ctype=Constraint, active=True, descend_into=(Block, Disjunct), sort=SortComponents.deterministic))