...
def test_seq2col_window_one_lengths(ops, dtype):
    ...
    ops.xp.testing.assert_allclose(ops.asarray2f([[0, 0, 0, 1, 2, 3, 0, 0, 0], [0, 0, 0, 4, 5, 6, 7, 8, 9], [4, 5, 6, 7, 8, 9, 10, 11, 12], [7, 8, 9, 10, 11, 12, 0, 0, 0], [0, 0, 0, 13, 14, 15, 0, 0, 0]], dtype=dtype), cols)