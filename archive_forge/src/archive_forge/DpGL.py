...
class Pathfinder:
    ...
    def __init__(
        ...
        # Initialize an empty set to store obstacle positions
    ...
    def calculate_obstacle_proximity_penalty(
        ...
        # Return the total penalty accumulated from all nearby obstacles
        return penalty
    ...
    def calculate_body_position_proximity_penalty(
        ...
        Args:
            position (pygame.math.Vector2): The current position as a Vector2 object.
            body_positions (Set[pygame.math.Vector2]): A set of positions occupied by the snake's body as Vector2 objects. Default is an empty set.
        ...
        # Initialize the penalty to 0
        penalty: float = 0.0
        # Iterate through each body position
    ...
    def evaluate_escape_route_availability(
        ...
        Args:
            position (pygame.math.Vector2): The current position as a Vector2 object.
            obstacles (Set[pygame.math.Vector2]): A set of obstacle positions as Vector2 objects. Default is an empty set.
            boundaries (Tuple[int, int, int, int]): The boundaries of the environment as a tuple of (x_min, y_min, x_max, y_max). Default is (0, 0, 100, 100).
