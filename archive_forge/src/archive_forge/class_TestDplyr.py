...
class TestDplyr(object):
    ...
    @pytest.mark.parametrize('join_method', ('inner_join', 'left_join', 'right_join', 'full_join'))
    ...
    def test_arrange(self):
        ...
        assert tuple(sorted(dataf.collect().rx2('mpg'))) == tuple(dataf_arrange.collect().rx2('mpg'))