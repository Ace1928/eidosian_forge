...
def _shuffle_batch_join(tensors_list, batch_size, capacity, min_after_dequeue, keep_input, seed=None, enqueue_many=False, shapes=None, allow_smaller_final_batch=False, shared_name=None, name=None):
    ...
    with ops.name_scope(name, 'shuffle_batch_join', _flatten(tensor_list_list) + [keep_input]) as name:
