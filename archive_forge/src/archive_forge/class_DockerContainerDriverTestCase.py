...
class DockerContainerDriverTestCase(unittest.TestCase):
    ...
    def test_list_images(self):
        for driver in self.drivers:
            ...
            self.assertEqual(images[0].id, 'cf55d61f5307b7a18a45980971d6cfd40b737dd661879c4a6b3f2aecc3bc37b0')
    ...
    def test_list_containers(self):
        for driver in self.drivers:
            ...
            self.assertEqual(containers[0].id, '160936dc54fe8c332095676d9379003534b8cddd7565fa63018996e06dae1b6b')
