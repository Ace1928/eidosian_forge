...
def expand_range(x: CoordRange, expand: TupleFloat2 | TupleFloat4, trans: trans | Type[trans]) -> range_view:
    """
    ...
    l0, l1 = x
    f0, f1 = final_x
    final_range = (f0 if np.isfinite(f0) else l0, f1 if np.isfinite(f1) else l1)
