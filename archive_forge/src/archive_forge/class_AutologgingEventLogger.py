...
class AutologgingEventLogger:
    ...
    def log_original_function_success(self, session, patch_obj, function_name, call_args, call_kwargs):
        ...
        """
        _logger.debug("Original function invocation completed successfully during execution of patched API call '%s.%s' for %s autologging. Original function was invoked with with args '%s' and kwargs '%s'", patch_obj, function_name, session.integration, call_args, call_kwargs)
