...
class ListSubscriptionsPager:
    ...
    def __init__(self, method: Callable[..., admin.ListSubscriptionsResponse], request: admin.ListSubscriptionsRequest, response: admin.ListSubscriptionsResponse, *, metadata: Sequence[Tuple[str, str]]=()):
