...
def AddSetCloudSQLFlag(parser):
    ...
    parser.add_argument('--set-cloudsql-instances', type=arg_parsers.ArgList(), metavar='CLOUDSQL-INSTANCES', help="You can specify a name of a Cloud SQL instance if it's in the same\n      project and region as your Cloud Run resource; otherwise specify\n      <project>:<region>:<instance> for the instance.")