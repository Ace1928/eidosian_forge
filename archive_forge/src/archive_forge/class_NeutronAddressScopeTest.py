...
class NeutronAddressScopeTest(common.HeatTestCase):
    ...
    def setUp(self):
        ...
        self.stack = stack.Stack(self.ctx, 'neutron_address_scope_test', template.Template(tpl))
        ...
        self.my_address_scope.client = mock.MagicMock(return_value=self.neutronclient)
        self.patchobject(self.my_address_scope, 'physical_resource_name', return_value='test_address_scope')
