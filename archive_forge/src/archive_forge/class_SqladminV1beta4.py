...
class SqladminV1beta4(base_api.BaseApiClient):
    ...
    def __init__(self, url='', credentials=None, get_credentials=True, http=None, model=None, log_request=False, log_response=False, credentials_args=None, default_global_params=None, additional_http_headers=None, response_encoding=None):
        ...
        super(SqladminV1beta4, self).__init__(url, credentials=credentials, get_credentials=get_credentials, http=http, model=model, log_request=log_request, log_response=log_response, credentials_args=credentials_args, default_global_params=default_global_params, additional_http_headers=additional_http_headers, response_encoding=response_encoding)
    ...
    class OperationsService(base_api.BaseApiService):
      ...
      """
            ...
            return self._RunMethod(config, request, global_params=global_params)
        Cancel.method_config = lambda: base_api.ApiMethodInfo(http_method='POST', method_id='sql.operations.cancel', ordered_params=['project', 'operation'], path_params=['operation', 'project'], query_params=[], relative_path='sql/v1beta4/projects/{project}/operations/{operation}/cancel', request_field='', request_type_name='SqlOperationsCancelRequest', response_type_name='Empty', supports_download=False)
      ...
      """
            config = self.GetMethodConfig('Get')
            return self._RunMethod(config, request, global_params=global_params)
        Get.method_config = lambda: base_api.ApiMethodInfo(http_method='GET', method_id='sql.operations.get', ordered_params=['project', 'operation'], path_params=['operation', 'project'], query_params=[], relative_path='sql/v1beta4/projects/{project}/operations/{operation}', request_field='', request_type_name='SqlOperationsGetRequest', response_type_name='Operation', supports_download=False)
      ...
      """
            config = self.GetMethodConfig('List')
            return self._RunMethod(config, request, global_params=global_params)
        List.method_config = lambda: base_api.ApiMethodInfo(http_method='GET', method_id='sql.operations.list', ordered_params=['project'], path_params=['project'], query_params=['filter', 'instance', 'maxResults', 'pageToken'], relative_path='sql/v1beta4/projects/{project}/operations', request_field='', request_type_name='SqlOperationsListRequest', response_type_name='OperationsListResponse', supports_download=False)
    ...
    class ProjectsInstancesService(base_api.BaseApiService):
      ...
      """
            ...
            return self._RunMethod(config, request, global_params=global_params)
        GetDiskShrinkConfig.method_config = lambda: base_api.ApiMethodInfo(http_method='GET', method_id='sql.projects.instances.getDiskShrinkConfig', ordered_params=['project', 'instance'], path_params=['instance', 'project'], query_params=[], relative_path='sql/v1beta4/projects/{project}/instances/{instance}/getDiskShrinkConfig', request_field='', request_type_name='SqlProjectsInstancesGetDiskShrinkConfigRequest', response_type_name='SqlInstancesGetDiskShrinkConfigResponse', supports_download=False)
      ...
      """
            ...
            return self._RunMethod(config, request, global_params=global_params)
        GetLatestRecoveryTime.method_config = lambda: base_api.ApiMethodInfo(http_method='GET', method_id='sql.projects.instances.getLatestRecoveryTime', ordered_params=['project', 'instance'], path_params=['instance', 'project'], query_params=[], relative_path='sql/v1beta4/projects/{project}/instances/{instance}/getLatestRecoveryTime', request_field='', request_type_name='SqlProjectsInstancesGetLatestRecoveryTimeRequest', response_type_name='SqlInstancesGetLatestRecoveryTimeResponse', supports_download=False)
      ...
      """
            ...
            return self._RunMethod(config, request, global_params=global_params)
        PerformDiskShrink.method_config = lambda: base_api.ApiMethodInfo(http_method='POST', method_id='sql.projects.instances.performDiskShrink', ordered_params=['project', 'instance'], path_params=['instance', 'project'], query_params=[], relative_path='sql/v1beta4/projects/{project}/instances/{instance}/performDiskShrink', request_field='performDiskShrinkContext', request_type_name='SqlProjectsInstancesPerformDiskShrinkRequest', response_type_name='Operation', supports_download=False)
      ...
      """
            ...
            return self._RunMethod(config, request, global_params=global_params)
        RescheduleMaintenance.method_config = lambda: base_api.ApiMethodInfo(http_method='POST', method_id='sql.projects.instances.rescheduleMaintenance', ordered_params=['project', 'instance'], path_params=['instance', 'project'], query_params=[], relative_path='sql/v1beta4/projects/{project}/instances/{instance}/rescheduleMaintenance', request_field='sqlInstancesRescheduleMaintenanceRequestBody', request_type_name='SqlProjectsInstancesRescheduleMaintenanceRequest', response_type_name='Operation', supports_download=False)
      ...
      """
            ...
            return self._RunMethod(config, request, global_params=global_params)
        ResetReplicaSize.method_config = lambda: base_api.ApiMethodInfo(http_method='POST', method_id='sql.projects.instances.resetReplicaSize', ordered_params=['project', 'instance'], path_params=['instance', 'project'], query_params=[], relative_path='sql/v1beta4/projects/{project}/instances/{instance}/resetReplicaSize', request_field='sqlInstancesResetReplicaSizeRequest', request_type_name='SqlProjectsInstancesResetReplicaSizeRequest', response_type_name='Operation', supports_download=False)
      ...
      """
            ...
            return self._RunMethod(config, request, global_params=global_params)
        StartExternalSync.method_config = lambda: base_api.ApiMethodInfo(http_method='POST', method_id='sql.projects.instances.startExternalSync', ordered_params=['project', 'instance'], path_params=['instance', 'project'], query_params=[], relative_path='sql/v1beta4/projects/{project}/instances/{instance}/startExternalSync', request_field='sqlInstancesStartExternalSyncRequest', request_type_name='SqlProjectsInstancesStartExternalSyncRequest', response_type_name='Operation', supports_download=False)
      ...
      """
            ...
            return self._RunMethod(config, request, global_params=global_params)
        VerifyExternalSyncSettings.method_config = lambda: base_api.ApiMethodInfo(http_method='POST', method_id='sql.projects.instances.verifyExternalSyncSettings', ordered_params=['project', 'instance'], path_params=['instance', 'project'], query_params=[], relative_path='sql/v1beta4/projects/{project}/instances/{instance}/verifyExternalSyncSettings', request_field='sqlInstancesVerifyExternalSyncSettingsRequest', request_type_name='SqlProjectsInstancesVerifyExternalSyncSettingsRequest', response_type_name='SqlInstancesVerifyExternalSyncSettingsResponse', supports_download=False)
    ...
    class UsersService(base_api.BaseApiService):
      ...
      """
            config = self.GetMethodConfig('Delete')
            return self._RunMethod(config, request, global_params=global_params)
        Delete.method_config = lambda: base_api.ApiMethodInfo(http_method='DELETE', method_id='sql.users.delete', ordered_params=['project', 'instance'], path_params=['instance', 'project'], query_params=['host', 'name'], relative_path='sql/v1beta4/projects/{project}/instances/{instance}/users', request_field='', request_type_name='SqlUsersDeleteRequest', response_type_name='Operation', supports_download=False)
      ...
      """
            config = self.GetMethodConfig('Get')
            return self._RunMethod(config, request, global_params=global_params)
        Get.method_config = lambda: base_api.ApiMethodInfo(http_method='GET', method_id='sql.users.get', ordered_params=['project', 'instance', 'name'], path_params=['instance', 'name', 'project'], query_params=['host'], relative_path='sql/v1beta4/projects/{project}/instances/{instance}/users/{name}', request_field='', request_type_name='SqlUsersGetRequest', response_type_name='User', supports_download=False)
      ...
      """
            config = self.GetMethodConfig('Insert')
            return self._RunMethod(config, request, global_params=global_params)
        Insert.method_config = lambda: base_api.ApiMethodInfo(http_method='POST', method_id='sql.users.insert', ordered_params=['project', 'instance'], path_params=['instance', 'project'], query_params=[], relative_path='sql/v1beta4/projects/{project}/instances/{instance}/users', request_field='<request>', request_type_name='User', response_type_name='Operation', supports_download=False)
      ...
      """
            config = self.GetMethodConfig('List')
            return self._RunMethod(config, request, global_params=global_params)
        List.method_config = lambda: base_api.ApiMethodInfo(http_method='GET', method_id='sql.users.list', ordered_params=['project', 'instance'], path_params=['instance', 'project'], query_params=[], relative_path='sql/v1beta4/projects/{project}/instances/{instance}/users', request_field='', request_type_name='SqlUsersListRequest', response_type_name='UsersListResponse', supports_download=False)
      ...
      """
            config = self.GetMethodConfig('Update')
            return self._RunMethod(config, request, global_params=global_params)
        Update.method_config = lambda: base_api.ApiMethodInfo(http_method='PUT', method_id='sql.users.update', ordered_params=['project', 'instance'], path_params=['instance', 'project'], query_params=['host', 'name'], relative_path='sql/v1beta4/projects/{project}/instances/{instance}/users', request_field='user', request_type_name='SqlUsersUpdateRequest', response_type_name='Operation', supports_download=False)