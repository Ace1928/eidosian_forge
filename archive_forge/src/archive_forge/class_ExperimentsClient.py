...
class ExperimentsClient(object):
    ...
    """
        describe_req = self.messages.FaultinjectiontestingProjectsLocationsExperimentsGetRequest(name=experiment)
    ...
    """
        delete_req = self.messages.FaultinjectiontestingProjectsLocationsExperimentsDeleteRequest(name=experiment)
    ...
    Returns:
      Experiment.
    """
        create_req = api_lib_utils.ParseCreateExperimentFromYaml(experiment, experiment_config, parent)
    ...
    Returns:
      Experiment.
    """
        patch_req = api_lib_utils.ParseUpdateExperimentFromYaml(experiment, experiment_config)
    ...
    """
        list_req = self.messages.FaultinjectiontestingProjectsLocationsExperimentsListRequest(parent=parent)
        return list_pager.YieldFromList(self._experiments_client, list_req, field='experiments', batch_size=page_size, limit=limit, batch_size_attribute='pageSize')