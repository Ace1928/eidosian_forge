...
def test_terminate_attachment(self):
    self._verify('openstack.block_storage.v3.volume.Volume.terminate_attachment', self.proxy.terminate_volume_attachment, method_args=['value', '1'], expected_args=[self.proxy, '1'])