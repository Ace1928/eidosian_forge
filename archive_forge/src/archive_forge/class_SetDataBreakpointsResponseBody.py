...
class SetDataBreakpointsResponseBody(BaseSchema):
    ...
    """
    __props__ = {'breakpoints': {'type': 'array', 'items': {'$ref': '#/definitions/Breakpoint'}, 'description': "Information about the data breakpoints. The array elements correspond to the elements of the input argument 'breakpoints' array."}}
    __refs__ = set()
