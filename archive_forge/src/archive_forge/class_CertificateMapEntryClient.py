...
class CertificateMapEntryClient(object):
    ...
    def Create(self, parent_ref, entry_id, hostname=None, cert_refs=None, description=None, labels=None):
    ...
    """
        req = self.messages.CertificatemanagerProjectsLocationsCertificateMapsCertificateMapEntriesCreateRequest(parent=parent_ref.RelativeName(), certificateMapEntryId=entry_id, certificateMapEntry=self.messages.CertificateMapEntry(labels=labels, hostname=hostname, matcher=self.messages.CertificateMapEntry.MatcherValueValuesEnum.PRIMARY if not hostname else None, certificates=[ref.RelativeName() for ref in cert_refs], description=description))
    ...
    """
        get_req = self.messages.CertificatemanagerProjectsLocationsCertificateMapsCertificateMapEntriesGetRequest(name=entry_ref.RelativeName())
    ...
    """
        list_req = self.messages.CertificatemanagerProjectsLocationsCertificateMapsCertificateMapEntriesListRequest(parent=parent_ref.RelativeName(), filter=list_filter, orderBy=order_by)
        return list_pager.YieldFromList(self._service, list_req, batch_size=page_size, limit=limit, current_token_attribute='pageToken', next_token_attribute='nextPageToken', field='certificateMapEntries', batch_size_attribute='pageSize')
    ...
    """
        delete_req = self.messages.CertificatemanagerProjectsLocationsCertificateMapsCertificateMapEntriesDeleteRequest(name=entry_ref.RelativeName())
    ...
    """
        ...
        if cert_refs is not None:
            certificate_map_entry.certificates.extend([ref.RelativeName() for ref in cert_refs])
            updated_fields.append('certificates')
        update_mask = ','.join(updated_fields)
        patch_req = self.messages.CertificatemanagerProjectsLocationsCertificateMapsCertificateMapEntriesPatchRequest(certificateMapEntry=certificate_map_entry, name=entry_ref.RelativeName(), updateMask=update_mask)
