...
class VpnGatewayHelper(object):
    ...
    """
        request = self._messages.ComputeVpnGatewaysInsertRequest(project=ref.project, region=ref.region, vpnGateway=vpn_gateway)
    ...
    """
        request = self._messages.ComputeVpnGatewaysGetRequest(project=ref.project, region=ref.region, vpnGateway=ref.Name())
    ...
    """
        request = self._messages.ComputeVpnGatewaysDeleteRequest(project=ref.project, region=ref.region, vpnGateway=ref.Name())
    ...
    """
        ...
        while True:
            request = self._messages.ComputeVpnGatewaysAggregatedListRequest(project=project, filter=filter_expr, pageToken=next_page_token)
    ...
    """
        set_labels_request = self._messages.RegionSetLabelsRequest(labelFingerprint=existing_label_fingerprint, labels=new_labels)
        request = self._messages.ComputeVpnGatewaysSetLabelsRequest(project=ref.project, region=ref.region, resource=ref.Name(), regionSetLabelsRequest=set_labels_request)
