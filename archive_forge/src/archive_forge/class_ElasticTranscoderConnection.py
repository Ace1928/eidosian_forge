...
class ElasticTranscoderConnection(AWSAuthConnection):
    ...
    _faults = {'IncompatibleVersionException': exceptions.IncompatibleVersionException, 'LimitExceededException': exceptions.LimitExceededException, 'ResourceInUseException': exceptions.ResourceInUseException, 'AccessDeniedException': exceptions.AccessDeniedException, 'ResourceNotFoundException': exceptions.ResourceNotFoundException, 'InternalServiceException': exceptions.InternalServiceException, 'ValidationException': exceptions.ValidationException}
    ...
    def make_request(self, verb, resource, headers=None, data='', expected_status=None, params=None):
        if headers is None:
            headers = {}
        response = super(ElasticTranscoderConnection, self).make_request(verb, resource, headers=headers, data=data, params=params)
