...
def _get_qvm_based_on_real_quantum_processor(*, client_configuration: QCSClientConfiguration, name: str, quantum_processor: QCSQuantumProcessor, noisy: bool, qvm_type: str, compiler_timeout: float, execution_timeout: float) -> QuantumComputer:
    """
    ...
    if noisy:
        ...
        noise_model = None
    return _get_qvm_qc(client_configuration=client_configuration, name=name, quantum_processor=quantum_processor, noise_model=noise_model, qvm_type=qvm_type, compiler_timeout=compiler_timeout, execution_timeout=execution_timeout)