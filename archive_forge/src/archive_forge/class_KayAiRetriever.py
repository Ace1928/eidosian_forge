...
class KayAiRetriever(BaseRetriever):
    ...
    @classmethod
    def create(cls, dataset_id: str, data_types: List[str], num_contexts: int=6) -> KayAiRetriever:
        """
        ...
        try:
            ...
            raise ImportError('Could not import kay python package. Please install it with `pip install kay`.')
