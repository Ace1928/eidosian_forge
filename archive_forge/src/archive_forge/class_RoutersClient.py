...
class RoutersClient(object):
    ...
    def AddInterface(self, router_ref, args):
        ...
        new_router_object = self.ModifyToAddInterface(router_ref, args, router_object)
        update_router_req = self._messages.EdgenetworkProjectsLocationsZonesRoutersPatchRequest(name=router_ref.RelativeName(), router=new_router_object, updateMask=self.FIELD_PATH_INTERFACE)
    ...
    def GetStatus(self, router_ref):
        ...
        get_router_status_req = self._messages.EdgenetworkProjectsLocationsZonesRoutersDiagnoseRequest(name=router_ref.RelativeName())
