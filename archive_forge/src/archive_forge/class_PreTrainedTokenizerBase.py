...
class PreTrainedTokenizerBase(SpecialTokensMixin, PushToHubMixin):
    ...
    def apply_chat_template(self, conversation: Union[List[Dict[str, str]], 'Conversation'], chat_template: Optional[str]=None, add_generation_prompt: bool=False, tokenize: bool=True, padding: bool=False, truncation: bool=False, max_length: Optional[int]=None, return_tensors: Optional[Union[str, TensorType]]=None, return_dict: bool=False, **tokenizer_kwargs) -> Union[str, List[int]]:
        """
        ...
        if tokenize:
            if return_dict:
                return self(rendered, padding=padding, truncation=truncation, max_length=max_length, add_special_tokens=False, return_tensors=return_tensors, **tokenizer_kwargs)
            else:
                return self.encode(rendered, padding=padding, truncation=truncation, max_length=max_length, add_special_tokens=False, return_tensors=return_tensors, **tokenizer_kwargs)
        else:
            return rendered
