...
class RecycleDataAdapter(EventDispatcher):
    ...
    _sizing_attrs = {'size', 'width', 'height', 'size_hint', 'size_hint_x', 'size_hint_y', 'pos', 'x', 'y', 'center', 'center_x', 'center_y', 'pos_hint', 'size_hint_min', 'size_hint_min_x', 'size_hint_min_y', 'size_hint_max', 'size_hint_max_x', 'size_hint_max_y'}
    ...
    def refresh_view_layout(self, index, layout, view, viewport):
        ...
        if view.__class__ not in _view_base_cache:
            _view_base_cache[view.__class__] = isinstance(view, RecycleDataViewBehavior)
