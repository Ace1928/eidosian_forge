...
def _get_open_meteo_api(llm: BaseLanguageModel) -> BaseTool:
    ...
    return Tool(name='Open-Meteo-API', description='Useful for when you want to get weather information from the OpenMeteo API. The input should be a question in natural language that this API can answer.', func=chain.run)