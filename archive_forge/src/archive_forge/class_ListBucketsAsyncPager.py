...
class ListBucketsAsyncPager:
    ...
    def __init__(self, method: Callable[..., Awaitable[storage.ListBucketsResponse]], request: storage.ListBucketsRequest, response: storage.ListBucketsResponse, *, metadata: Sequence[Tuple[str, str]]=()):
