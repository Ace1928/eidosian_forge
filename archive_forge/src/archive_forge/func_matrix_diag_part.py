...
def matrix_diag_part(input, name='diag_part', k=0, padding_value=0, align='RIGHT_LEFT'):
  ...
  """
    ...
    return gen_array_ops.matrix_diag_part_v3(input=input, k=k, padding_value=padding_value, align=align, name=name)