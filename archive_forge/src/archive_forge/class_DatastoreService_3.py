...
class DatastoreService_3(ProtocolBuffer.ProtocolMessage):
    ...
    GetIndices = 15
    DeleteIndex = 16
    _Method_NAMES = {1: 'Get', 2: 'Put', 3: 'Touch', 4: 'Delete', 5: 'RunQuery', 6: 'AddActions', 7: 'Next', 8: 'DeleteCursor', 9: 'BeginTransaction', 10: 'Commit', 11: 'Rollback', 12: 'AllocateIds', 13: 'CreateIndex', 14: 'UpdateIndex', 15: 'GetIndices', 16: 'DeleteIndex'}

    def Method_Name(cls, x):
        return cls._Method_NAMES.get(x, '')
