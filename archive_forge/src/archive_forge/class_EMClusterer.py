...
class EMClusterer(VectorSpaceClusterer):
    ...
    def __init__(self, initial_means, priors=None, covariance_matrices=None, conv_threshold=1e-06, bias=0.1, normalise=False, svd_dimensions=None):
        """
    ...
    def cluster_vectorspace(self, vectors, trace=False):
        ...
        if not covariances:
            covariances = self._covariance_matrices = [numpy.identity(dimensions, numpy.float64) for i in range(self._num_clusters)]
