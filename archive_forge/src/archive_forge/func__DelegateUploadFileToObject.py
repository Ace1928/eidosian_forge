...
def _DelegateUploadFileToObject(upload_delegate, upload_url, upload_stream, zipped_file, gzip_encoded_file, parallel_composite_upload, logger):
    ...
    try:
        ...
        if zipped_file:
            try:
                ...
                logger.warning('Could not delete %s. This can occur in Windows because the temporary file is still locked.', upload_url.object_name)
