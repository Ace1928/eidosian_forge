...
class TestSmartServerBranchRequestLastRevisionInfo(tests.TestCaseWithMemoryTransport):
    ...
    def test_empty(self):
        ...
        self.make_branch('.')
        self.assertEqual(smart_req.SmartServerResponse((b'ok', b'0', b'null:')), request.execute(b''))
    ...
    def test_ghost(self):
        ...
        self.assertRaises(errors.GhostRevisionsHaveNoRevno, request.do_with_branch, branch)
