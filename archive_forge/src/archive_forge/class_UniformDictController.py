...
class UniformDictController:
    ...
    def __init__(self, uniform_dict, key, scale=None, label=None, checkbox=None, radio_buttons=None, update_function=None, format_string=None, index=None, component_index=None):
    ...
    def get_value(self):
        ...
        if self.uniform_type == 'vec2[]':
            return float(self.uniform_dict[self.key][1][self.index][self.component_index])
    ...
    def set_value(self, value):
        if self.uniform_type == 'int':
            ...
            self.uniform_dict[self.key][1][self.index][self.component_index] = float(value)
        elif self.uniform_type == 'bool':
