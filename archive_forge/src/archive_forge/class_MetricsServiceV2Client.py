...
class MetricsServiceV2Client(metaclass=MetricsServiceV2ClientMeta):
    ...
    def parse_log_metric_path(path: str) -> Dict[str, str]:
        ...
        m = re.match('^projects/(?P<project>.+?)/metrics/(?P<metric>.+?)$', path)
    ...
    def __init__(self, *, credentials: Optional[ga_credentials.Credentials]=None, transport: Optional[Union[str, MetricsServiceV2Transport]]=None, client_options: Optional[Union[client_options_lib.ClientOptions, dict]]=None, client_info: gapic_v1.client_info.ClientInfo=DEFAULT_CLIENT_INFO) -> None:
    ...
    def list_log_metrics(self, request: Optional[Union[logging_metrics.ListLogMetricsRequest, dict]]=None, *, parent: Optional[str]=None, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> pagers.ListLogMetricsPager:
        ...
        response = pagers.ListLogMetricsPager(method=rpc, request=request, response=response, metadata=metadata)
        return response

    def get_log_metric(self, request: Optional[Union[logging_metrics.GetLogMetricRequest, dict]]=None, *, metric_name: Optional[str]=None, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> logging_metrics.LogMetric:
    ...
    def delete_log_metric(self, request: Optional[Union[logging_metrics.DeleteLogMetricRequest, dict]]=None, *, metric_name: Optional[str]=None, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Union[float, object]=gapic_v1.method.DEFAULT, metadata: Sequence[Tuple[str, str]]=()) -> None:
