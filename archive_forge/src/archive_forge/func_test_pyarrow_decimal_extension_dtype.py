...
def test_pyarrow_decimal_extension_dtype():
    ...
    data = pa.array([decimal.Decimal('8093.234'), decimal.Decimal('8094.234'), decimal.Decimal('8095.234'), decimal.Decimal('8096.234'), decimal.Decimal('8097.234'), decimal.Decimal('8098.234')], type=pa_dtype)
