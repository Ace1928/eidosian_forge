...
class InsideViewer(ttk.Frame):
    ...
    def __init__(self, container, manifold, fillings_changed_callback=None, weights=None, cohomology_basis=None, cohomology_class=None, geodesics=[]):
        ...
        main_frame = self.create_frame_with_main_widget(self, manifold, weights, cohomology_basis, cohomology_class, geodesics)
        ...
        if cohomology_class:
            self.notebook.add(self.create_cohomology_class_frame(self), text='Cohomology class')
        self.notebook.add(self.create_cusps_frame(self), text='Cusps/Geodesics')
        ...
        self.view_scale_controller = ViewScaleController(self.widget.ui_uniform_dict, self.view_scale_slider, self.view_scale_label, self.view_scale_value_label, update_function=self.widget.redraw_if_initialized)
    ...
    def show_geodesics_window(self):
        ...
        if self.geodesics_window is None:
            ...
            self.geodesics_window.protocol('WM_DELETE_WINDOW', self.close_geodesics_window)
        else:
