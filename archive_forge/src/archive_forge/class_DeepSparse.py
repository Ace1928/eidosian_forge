...
class DeepSparse(LLM):
    ...
    def _identifying_params(self) -> Dict[str, Any]:
        ...
        return {'model': self.model, 'model_config': self.model_config, 'generation_config': self.generation_config, 'streaming': self.streaming}
    ...
    def validate_environment(cls, values: Dict) -> Dict:
        ...
        values['pipeline'] = Pipeline.create(task='text_generation', model_path=values['model'], **model_config)
        return values
