...
def post_json_to_stream(self, pathfmt, *args, **kwargs):
    ...
    return self._read_from_socket(self._post_json(self._url(pathfmt, *args, versioned_api=True), data, headers=headers, stream=True, **kwargs), stream, tty=tty, demux=demux)