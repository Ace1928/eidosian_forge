...
class RemoteLoginWithAuthProxyFlowRunner(FlowRunner):
    ...
    def _CreateFlow(self):
        ...
        return c_flow.RemoteLoginWithAuthProxyFlow.from_client_config(self._client_config, self._scopes, autogenerate_code_verifier=not properties.VALUES.auth.disable_code_verifier.GetBool(), redirect_uri=self._redirect_uri)