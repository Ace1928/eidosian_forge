...
class MovieMaker(object):
    ...
    def __init__(self, stream, camera, positions=None, quaternions=None, times=None, filename_camera='moviemaker.json', filename_movie='movie.webm', overwrite_video=False):
        self.stream = stream
        self.camera = camera
        ...
        self.button_record = widgets.ToggleButton(description='Record', icon='circle', value=False)
        ...
        self.options_interpolation = [('discrete', 'InterpolateDiscrete'), ('linear', 'InterpolateLinear'), ('smooth', 'InterpolateSmooth')]
        ...
        self.widget_main = widgets.VBox([self.button_record, self.select_interpolation, box_io, box_control, self.select_keyframes, self.camera_action_box, self.output])
    ...
    def show(self):
        box_io = widgets.HBox([self.button_save, self.button_load])
        box_control = widgets.HBox([self.button_add, self.button_replace, self.button_remove])
        display(widgets.VBox([self.button_record, self.select_interpolation, box_io, box_control, self.select_keyframes, self.camera_action_box, self.output]))