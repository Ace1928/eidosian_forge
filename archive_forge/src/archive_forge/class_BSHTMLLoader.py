...
class BSHTMLLoader(BaseLoader):
    ...
    def __init__(self, file_path: Union[str, Path], open_encoding: Union[str, None]=None, bs_kwargs: Union[dict, None]=None, get_text_separator: str='') -> None:
    ...
    def lazy_load(self) -> Iterator[Document]:
        ...
        if soup.title:
            ...
            title = ''
        metadata: Dict[str, Union[str, None]] = {'source': str(self.file_path), 'title': title}
