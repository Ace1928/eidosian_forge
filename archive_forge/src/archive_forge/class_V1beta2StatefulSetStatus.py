...
class V1beta2StatefulSetStatus(object):
    ...
    swagger_types = {'collision_count': 'int', 'conditions': 'list[V1beta2StatefulSetCondition]', 'current_replicas': 'int', 'current_revision': 'str', 'observed_generation': 'int', 'ready_replicas': 'int', 'replicas': 'int', 'update_revision': 'str', 'updated_replicas': 'int'}
