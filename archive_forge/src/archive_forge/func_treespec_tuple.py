...
def treespec_tuple(iterable: Iterable[PyTreeSpec]=(), *, none_is_leaf: bool=False, namespace: str='') -> PyTreeSpec:
    ...
    """
    return _C.make_from_collection(tuple(iterable), none_is_leaf, namespace)