...
def get_collaborators(self, affiliation: Opt[str]=NotSet, permission: Opt[str]=NotSet) -> PaginatedList[NamedUser]:
    """
    ...
    return PaginatedList(github.NamedUser.NamedUser, self._requester, f'{self.url}/collaborators', url_parameters)