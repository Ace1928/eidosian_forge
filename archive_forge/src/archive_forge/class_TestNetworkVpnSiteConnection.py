...
class TestNetworkVpnSiteConnection(TestNetworkProxy):
    ...
    def test_ipsec_site_connection_create_attrs(self):
        self.verify_create(self.proxy.create_vpn_ipsec_site_connection, vpn_ipsec_site_connection.VpnIPSecSiteConnection)

    def test_ipsec_site_connection_delete(self):
        self.verify_delete(self.proxy.delete_vpn_ipsec_site_connection, vpn_ipsec_site_connection.VpnIPSecSiteConnection, False)

    def test_ipsec_site_connection_delete_ignore(self):
        self.verify_delete(self.proxy.delete_vpn_ipsec_site_connection, vpn_ipsec_site_connection.VpnIPSecSiteConnection, True)

    def test_ipsec_site_connection_find(self):
        self.verify_find(self.proxy.find_vpn_ipsec_site_connection, vpn_ipsec_site_connection.VpnIPSecSiteConnection)

    def test_ipsec_site_connection_get(self):
        self.verify_get(self.proxy.get_vpn_ipsec_site_connection, vpn_ipsec_site_connection.VpnIPSecSiteConnection)

    def test_ipsec_site_connections(self):
        self.verify_list(self.proxy.vpn_ipsec_site_connections, vpn_ipsec_site_connection.VpnIPSecSiteConnection)

    def test_ipsec_site_connection_update(self):
        self.verify_update(self.proxy.update_vpn_ipsec_site_connection, vpn_ipsec_site_connection.VpnIPSecSiteConnection)