...
class VolumeTest(vt_base.VolumeTestCase):
    ...
    def _mock_create_volume(self, fv, stack_name, final_status='available', mock_attachment=None):
    ...
    def test_volume(self):
        ...
        self.cinder_fc.volumes.get.side_effect = [vt_base.FakeVolume('available'), cinder_exp.NotFound('Not found')]
    ...
    def test_volume_attachment(self):
        ...
        self.cinder_fc.volumes.get.side_effect = [fva, vt_base.FakeVolume('detaching', id=fva.id), vt_base.FakeVolume('available', id=fva.id)]
    ...
    def test_snapshot(self):
        ...
        fv = vt_base.FakeVolume('creating')
        fv_ready = vt_base.FakeVolume('available', id=fv.id)
        fv = self._mock_create_volume(fv, stack_name, mock_attachment=fv_ready)
        ...
        stack = utils.parse_stack(self.t, stack_name=stack_name)
        rsrc = self.create_volume(self.t, stack, 'DataVolume')
        self.cinder_fc.volumes.get.side_effect = [fv, vt_base.FakeVolume('available'), cinder_exp.NotFound('Not found')]
        scheduler.TaskRunner(rsrc.destroy)()
