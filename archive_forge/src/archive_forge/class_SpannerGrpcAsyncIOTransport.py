...
class SpannerGrpcAsyncIOTransport(SpannerTransport):
    ...
    @classmethod
    def create_channel(cls, host: str='spanner.googleapis.com', credentials: Optional[ga_credentials.Credentials]=None, credentials_file: Optional[str]=None, scopes: Optional[Sequence[str]]=None, quota_project_id: Optional[str]=None, **kwargs) -> aio.Channel:
    ...
    def __init__(self, *, host: str='spanner.googleapis.com', credentials: Optional[ga_credentials.Credentials]=None, credentials_file: Optional[str]=None, scopes: Optional[Sequence[str]]=None, channel: Optional[aio.Channel]=None, api_mtls_endpoint: Optional[str]=None, client_cert_source: Optional[Callable[[], Tuple[bytes, bytes]]]=None, ssl_channel_credentials: Optional[grpc.ChannelCredentials]=None, client_cert_source_for_mtls: Optional[Callable[[], Tuple[bytes, bytes]]]=None, quota_project_id: Optional[str]=None, client_info: gapic_v1.client_info.ClientInfo=DEFAULT_CLIENT_INFO, always_use_jwt_access: Optional[bool]=False, api_audience: Optional[str]=None) -> None:
    ...
    @property
    def create_session(self) -> Callable[[spanner.CreateSessionRequest], Awaitable[spanner.Session]]:
        """Return a callable for the create session method over gRPC.
        ...
        if 'create_session' not in self._stubs:
            self._stubs['create_session'] = self.grpc_channel.unary_unary('/google.spanner.v1.Spanner/CreateSession', request_serializer=spanner.CreateSessionRequest.serialize, response_deserializer=spanner.Session.deserialize)
        return self._stubs['create_session']

    @property
    def batch_create_sessions(self) -> Callable[[spanner.BatchCreateSessionsRequest], Awaitable[spanner.BatchCreateSessionsResponse]]:
        """Return a callable for the batch create sessions method over gRPC.
        ...
        if 'batch_create_sessions' not in self._stubs:
            self._stubs['batch_create_sessions'] = self.grpc_channel.unary_unary('/google.spanner.v1.Spanner/BatchCreateSessions', request_serializer=spanner.BatchCreateSessionsRequest.serialize, response_deserializer=spanner.BatchCreateSessionsResponse.deserialize)
        return self._stubs['batch_create_sessions']

    @property
    def get_session(self) -> Callable[[spanner.GetSessionRequest], Awaitable[spanner.Session]]:
        """Return a callable for the get session method over gRPC.
        ...
        if 'get_session' not in self._stubs:
            self._stubs['get_session'] = self.grpc_channel.unary_unary('/google.spanner.v1.Spanner/GetSession', request_serializer=spanner.GetSessionRequest.serialize, response_deserializer=spanner.Session.deserialize)
        return self._stubs['get_session']

    @property
    def list_sessions(self) -> Callable[[spanner.ListSessionsRequest], Awaitable[spanner.ListSessionsResponse]]:
        """Return a callable for the list sessions method over gRPC.
        ...
        if 'list_sessions' not in self._stubs:
            self._stubs['list_sessions'] = self.grpc_channel.unary_unary('/google.spanner.v1.Spanner/ListSessions', request_serializer=spanner.ListSessionsRequest.serialize, response_deserializer=spanner.ListSessionsResponse.deserialize)
        return self._stubs['list_sessions']

    @property
    def delete_session(self) -> Callable[[spanner.DeleteSessionRequest], Awaitable[empty_pb2.Empty]]:
        """Return a callable for the delete session method over gRPC.
        ...
        if 'delete_session' not in self._stubs:
            self._stubs['delete_session'] = self.grpc_channel.unary_unary('/google.spanner.v1.Spanner/DeleteSession', request_serializer=spanner.DeleteSessionRequest.serialize, response_deserializer=empty_pb2.Empty.FromString)
        return self._stubs['delete_session']

    @property
    def execute_sql(self) -> Callable[[spanner.ExecuteSqlRequest], Awaitable[result_set.ResultSet]]:
        """Return a callable for the execute sql method over gRPC.
        ...
        if 'execute_sql' not in self._stubs:
            self._stubs['execute_sql'] = self.grpc_channel.unary_unary('/google.spanner.v1.Spanner/ExecuteSql', request_serializer=spanner.ExecuteSqlRequest.serialize, response_deserializer=result_set.ResultSet.deserialize)
        return self._stubs['execute_sql']

    @property
    def execute_streaming_sql(self) -> Callable[[spanner.ExecuteSqlRequest], Awaitable[result_set.PartialResultSet]]:
        """Return a callable for the execute streaming sql method over gRPC.
        ...
        if 'execute_streaming_sql' not in self._stubs:
            self._stubs['execute_streaming_sql'] = self.grpc_channel.unary_stream('/google.spanner.v1.Spanner/ExecuteStreamingSql', request_serializer=spanner.ExecuteSqlRequest.serialize, response_deserializer=result_set.PartialResultSet.deserialize)
        return self._stubs['execute_streaming_sql']

    @property
    def execute_batch_dml(self) -> Callable[[spanner.ExecuteBatchDmlRequest], Awaitable[spanner.ExecuteBatchDmlResponse]]:
        """Return a callable for the execute batch dml method over gRPC.
        ...
        if 'execute_batch_dml' not in self._stubs:
            self._stubs['execute_batch_dml'] = self.grpc_channel.unary_unary('/google.spanner.v1.Spanner/ExecuteBatchDml', request_serializer=spanner.ExecuteBatchDmlRequest.serialize, response_deserializer=spanner.ExecuteBatchDmlResponse.deserialize)
        return self._stubs['execute_batch_dml']

    @property
    def read(self) -> Callable[[spanner.ReadRequest], Awaitable[result_set.ResultSet]]:
        """Return a callable for the read method over gRPC.
        ...
        if 'read' not in self._stubs:
            self._stubs['read'] = self.grpc_channel.unary_unary('/google.spanner.v1.Spanner/Read', request_serializer=spanner.ReadRequest.serialize, response_deserializer=result_set.ResultSet.deserialize)
        return self._stubs['read']

    @property
    def streaming_read(self) -> Callable[[spanner.ReadRequest], Awaitable[result_set.PartialResultSet]]:
        """Return a callable for the streaming read method over gRPC.
        ...
        if 'streaming_read' not in self._stubs:
            self._stubs['streaming_read'] = self.grpc_channel.unary_stream('/google.spanner.v1.Spanner/StreamingRead', request_serializer=spanner.ReadRequest.serialize, response_deserializer=result_set.PartialResultSet.deserialize)
        return self._stubs['streaming_read']

    @property
    def begin_transaction(self) -> Callable[[spanner.BeginTransactionRequest], Awaitable[transaction.Transaction]]:
        ...
        if 'begin_transaction' not in self._stubs:
            self._stubs['begin_transaction'] = self.grpc_channel.unary_unary('/google.spanner.v1.Spanner/BeginTransaction', request_serializer=spanner.BeginTransactionRequest.serialize, response_deserializer=transaction.Transaction.deserialize)
        return self._stubs['begin_transaction']

    @property
    def commit(self) -> Callable[[spanner.CommitRequest], Awaitable[commit_response.CommitResponse]]:
        ...
        if 'commit' not in self._stubs:
            self._stubs['commit'] = self.grpc_channel.unary_unary('/google.spanner.v1.Spanner/Commit', request_serializer=spanner.CommitRequest.serialize, response_deserializer=commit_response.CommitResponse.deserialize)
        return self._stubs['commit']

    @property
    def rollback(self) -> Callable[[spanner.RollbackRequest], Awaitable[empty_pb2.Empty]]:
        ...
        if 'rollback' not in self._stubs:
            self._stubs['rollback'] = self.grpc_channel.unary_unary('/google.spanner.v1.Spanner/Rollback', request_serializer=spanner.RollbackRequest.serialize, response_deserializer=empty_pb2.Empty.FromString)
        return self._stubs['rollback']

    @property
    def partition_query(self) -> Callable[[spanner.PartitionQueryRequest], Awaitable[spanner.PartitionResponse]]:
        """Return a callable for the partition query method over gRPC.
        ...
        if 'partition_query' not in self._stubs:
            self._stubs['partition_query'] = self.grpc_channel.unary_unary('/google.spanner.v1.Spanner/PartitionQuery', request_serializer=spanner.PartitionQueryRequest.serialize, response_deserializer=spanner.PartitionResponse.deserialize)
        return self._stubs['partition_query']

    @property
    def partition_read(self) -> Callable[[spanner.PartitionReadRequest], Awaitable[spanner.PartitionResponse]]:
        """Return a callable for the partition read method over gRPC.
        ...
        if 'partition_read' not in self._stubs:
            self._stubs['partition_read'] = self.grpc_channel.unary_unary('/google.spanner.v1.Spanner/PartitionRead', request_serializer=spanner.PartitionReadRequest.serialize, response_deserializer=spanner.PartitionResponse.deserialize)
        return self._stubs['partition_read']

    @property
    def batch_write(self) -> Callable[[spanner.BatchWriteRequest], Awaitable[spanner.BatchWriteResponse]]:
        """Return a callable for the batch write method over gRPC.
        ...
        if 'batch_write' not in self._stubs:
            self._stubs['batch_write'] = self.grpc_channel.unary_stream('/google.spanner.v1.Spanner/BatchWrite', request_serializer=spanner.BatchWriteRequest.serialize, response_deserializer=spanner.BatchWriteResponse.deserialize)
