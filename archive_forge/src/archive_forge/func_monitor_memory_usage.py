...
def monitor_memory_usage(print_interval_s: int=30, record_interval_s: int=5, warning_threshold: float=0.9):
    ...
    memory_monitor_actor = MemoryMonitorActor.options(resources={f'node:{current_node_ip}': 0.001}).remote(print_interval_s=print_interval_s, record_interval_s=record_interval_s, warning_threshold=warning_threshold)
