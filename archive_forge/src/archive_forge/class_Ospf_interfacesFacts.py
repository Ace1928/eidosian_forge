...
class Ospf_interfacesFacts(object):
    ...
    def populate_facts(self, connection, ansible_facts, data=None):
        ...
        for resource in resources:
            ospf_interfaces_parser = Ospf_interfacesTemplate(lines=resource.split('\n'), module=self._module)
        ...
        params = utils.remove_empties(ospf_interfaces_parser.validate_config(self.argument_spec, {'config': ospf_interfaces_facts}, redact=True))
