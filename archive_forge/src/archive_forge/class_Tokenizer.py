...
class Tokenizer(Preprocessor):
    ...
    def __init__(self, columns: List[str], tokenization_fn: Optional[Callable[[str], List[str]]]=None):
    ...
    def __repr__(self):
        ...
        return f'{self.__class__.__name__}(columns={self.columns!r}, tokenization_fn={name})'