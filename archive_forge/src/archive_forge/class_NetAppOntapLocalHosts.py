...
class NetAppOntapLocalHosts:
    ...
    def __init__(self):
        ...
        self.argument_spec.update(dict(state=dict(required=False, type='str', choices=['present', 'absent'], default='present'), owner=dict(required=True, type='str'), address=dict(required=True, type='str'), aliases=dict(required=False, type='list', elements='str'), host=dict(required=False, type='str')))
