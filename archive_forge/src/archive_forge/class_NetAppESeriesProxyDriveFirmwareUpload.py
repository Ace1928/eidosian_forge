...
class NetAppESeriesProxyDriveFirmwareUpload(NetAppESeriesModule):
    ...
    def __init__(self):
        ...
        super(NetAppESeriesProxyDriveFirmwareUpload, self).__init__(ansible_options=ansible_options, web_services_version='02.00.0000.0000', supports_check_mode=True, proxy_specific_task=True)
