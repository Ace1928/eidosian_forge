...
service.
      ...
      """
        ...
        Get.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1beta/operations/{operationsId}', http_method='GET', method_id='servicenetworking.operations.get', ordered_params=['name'], path_params=['name'], query_params=[], relative_path='v1beta/{+name}', request_field='', request_type_name='ServicenetworkingOperationsGetRequest', response_type_name='Operation', supports_download=False)
...
region. Operation<response: Subnetwork>
      ...
      """
            ...
            return self._RunMethod(config, request, global_params=global_params)
        AddSubnetwork.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1beta/services/{servicesId}/{servicesId1}/{servicesId2}:addSubnetwork', http_method='POST', method_id='servicenetworking.services.addSubnetwork', ordered_params=['parent'], path_params=['parent'], query_params=[], relative_path='v1beta/{+parent}:addSubnetwork', request_field='addSubnetworkRequest', request_type_name='ServicenetworkingServicesAddSubnetworkRequest', response_type_name='Operation', supports_download=False)