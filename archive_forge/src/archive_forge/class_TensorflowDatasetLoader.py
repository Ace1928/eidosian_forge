...
class TensorflowDatasetLoader(BaseLoader):
    ...
    def __init__(self, dataset_name: str, split_name: str, load_max_docs: Optional[int]=100, sample_to_document_function: Optional[Callable[[Dict], Document]]=None):
        ...
        self._tfds_client = TensorflowDatasets(dataset_name=self.dataset_name, split_name=self.split_name, load_max_docs=self.load_max_docs, sample_to_document_function=self.sample_to_document_function)
