...
class LearnedPerceptualImagePatchSimilarity(Metric):
    ...
    def __init__(self, net_type: Literal['vgg', 'alex', 'squeeze']='alex', reduction: Literal['sum', 'mean']='mean', normalize: bool=False, **kwargs: Any) -> None:
        super().__init__(**kwargs)
        if not _TORCHVISION_AVAILABLE:
            raise ModuleNotFoundError('LPIPS metric requires that torchvision is installed. Either install as `pip install torchmetrics[image]` or `pip install torchvision`.')
