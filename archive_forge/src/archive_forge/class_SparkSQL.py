...
class SparkSQL:
    ...
    def __init__(self, spark_session: Optional[SparkSession]=None, catalog: Optional[str]=None, schema: Optional[str]=None, ignore_tables: Optional[List[str]]=None, include_tables: Optional[List[str]]=None, sample_rows_in_table_info: int=3):
    ...
    def from_uri(cls, database_uri: str, engine_args: Optional[dict]=None, **kwargs: Any) -> SparkSQL:
        ...
        try:
            ...
            raise ValueError('pyspark is not installed. Please install it with `pip install pyspark`')
