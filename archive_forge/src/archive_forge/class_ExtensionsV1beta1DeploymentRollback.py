...
class ExtensionsV1beta1DeploymentRollback(object):
    ...
    swagger_types = {'api_version': 'str', 'kind': 'str', 'name': 'str', 'rollback_to': 'ExtensionsV1beta1RollbackConfig', 'updated_annotations': 'dict(str, str)'}
    attribute_map = {'api_version': 'apiVersion', 'kind': 'kind', 'name': 'name', 'rollback_to': 'rollbackTo', 'updated_annotations': 'updatedAnnotations'}
