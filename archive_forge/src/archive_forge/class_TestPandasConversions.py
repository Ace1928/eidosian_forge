...
class TestPandasConversions(object):
    ...
    def test_dataframe(self):
        l = (('b', numpy.array([True, False, True], dtype=numpy.bool_)), ('i', numpy.array([1, 2, 3], dtype='i')), ('f', numpy.array([1, 2, 3], dtype='f')), ('u', numpy.array([u'a', u'b', u'c'], dtype='U')), ('dates', [datetime(2012, 5, 2), datetime(2012, 6, 3), datetime(2012, 7, 1)]))
        od = OrderedDict(l)
    ...
    def test_repr(self):
        l = (('b', numpy.array([True, False, True], dtype=numpy.bool_)), ('i', numpy.array([1, 2, 3], dtype='i')), ('f', numpy.array([1, 2, 3], dtype='f')), ('s', numpy.array(['a', 'b', 'c'], dtype='S')), ('u', numpy.array([u'a', u'b', u'c'], dtype='U')))
        od = OrderedDict(l)
        pd_df = pandas.core.frame.DataFrame(od)
        with localconverter(default_converter + rpyp.converter) as cv:
            rp_df = robjects.conversion.converter_ctx.get().py2rpy(pd_df)
