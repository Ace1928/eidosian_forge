...
class Substitutor(MSONable):
    ...
    """
    charge_balanced_tol: float = 1e-09

    def __init__(self, threshold=0.001, symprec: float=0.1, **kwargs):
        """
    ...
    def as_dict(self):
        ...
        return {'name': type(self).__name__, 'version': __version__, 'kwargs': self._kwargs, 'threshold': self._threshold, '@module': type(self).__module__, '@class': type(self).__name__}
