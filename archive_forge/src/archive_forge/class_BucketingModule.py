...
class BucketingModule(BaseModule):
    ...
    def set_params(self, arg_params, aux_params, allow_missing=False, force_init=True, allow_extra=False):
        ...
        if self.params_initialized and (not force_init):
            ...
            return
        self._curr_module.set_params(arg_params, aux_params, allow_missing=allow_missing, force_init=force_init, allow_extra=allow_extra)
    ...
    def init_params(self, initializer=Uniform(0.01), arg_params=None, aux_params=None, allow_missing=False, force_init=False, allow_extra=False):
        ...
        self._curr_module.init_params(initializer=initializer, arg_params=arg_params, aux_params=aux_params, allow_missing=allow_missing, force_init=force_init, allow_extra=allow_extra)
        self._params_dirty = False
        self.params_initialized = True
    ...
    def bind(self, data_shapes, label_shapes=None, for_training=True, inputs_need_grad=False, force_rebind=False, shared_module=None, grad_req='write'):
        ...
        module.bind(data_shapes, label_shapes, for_training, inputs_need_grad, force_rebind=False, shared_module=None, grad_req=self._grad_req)
    ...
    def load(prefix, epoch, sym_gen=None, default_bucket_key=None, **kwargs):
        ...
        compression_params : dict
            ...
            See mxnet.KVStore.set_gradient_compression method for more details on gradient compression.
        """
        assert sym_gen is not None, 'sym_gen is required for loading BucketingModule'
        assert default_bucket_key is not None, 'default_bucket_key is required for loading BucketingModule'
    ...
    @staticmethod
    def load_dict(sym_dict=None, sym_gen=None, default_bucket_key=None, arg_params=None, aux_params=None, **kwargs):
        ...
        compression_params : dict
            ...
            See mxnet.KVStore.set_gradient_compression method for more details on gradient compression.
        """
        assert sym_dict is not None, 'sym_dict needs to be provided for BucketingModule.load_dict'
        assert arg_params is not None, 'arg_params need to be provided for BucketingModule.load_dict'
        assert aux_params is not None, 'aux_params need to be provided for BucketingModule.load_dict'
        assert default_bucket_key is not None, 'default_bucket_key needs to be provided for BucketingModule.load_dict'
        bucketing_mod = BucketingModule(sym_gen, default_bucket_key, **kwargs)
