...
def test_generate_v4_port_malformed_version(self):
    ...
    headers = {'Content-type': 'application/x-www-form-urlencoded; charset=utf-8', 'X-Amz-Date': '20110909T233600Z', 'Host': 'foo:8000', 'Authorization': auth_str, 'User-Agent': 'Boto/2.922 (linux2)'}
    params = {}
