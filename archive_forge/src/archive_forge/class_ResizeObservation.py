...
class ResizeObservation(gym.ObservationWrapper):
    ...
    def __init__(self, env: gym.Env, shape: Union[tuple, int]):
        ...
        assert isinstance(env.observation_space, Box), f'Expected the observation space to be Box, actual type: {type(env.observation_space)}'
    ...
    def observation(self, observation):
        ...
        try:
            ...
            raise DependencyNotInstalled('opencv is not install, run `pip install gym[other]`')
