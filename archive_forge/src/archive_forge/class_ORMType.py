...
class ORMType(object):
    ...
    @classmethod
    def get(cls, load_attrs: Optional[List[str]]=None, load_attr_method: Optional[Union[str, Callable]]=None, readonly: Optional[bool]=False, raise_exceptions: Optional[bool]=True, **kwargs) -> 'ORMType':
        """
        Get a record
        """
    ...
    @classmethod
    async def aget(cls, load_attrs: Optional[List[str]]=None, load_attr_method: Optional[Union[str, Callable]]=None, readonly: Optional[bool]=False, raise_exceptions: Optional[bool]=True, **kwargs) -> Type['ORMType']:
        """
        Get a record
        """
    ...
    @classmethod
    def get_all(cls, load_attrs: Optional[List[str]]=None, load_attr_method: Optional[Union[str, Callable]]=None, readonly: Optional[bool]=False, **kwargs) -> List['ORMType']:
        """
        Get all records
        """
        with PostgresDB.session(ro=readonly) as db_sess:
    ...
    @classmethod
    async def aget_all(cls, load_attrs: Optional[List[str]]=None, load_attr_method: Optional[Union[str, Callable]]=None, readonly: Optional[bool]=False, **kwargs) -> List['ORMType']:
        """
        Get all records
        """
        async with PostgresDB.async_session(ro=readonly) as db_sess:
    ...
    @classmethod
    def count(cls, readonly: Optional[bool]=True, **kwargs) -> int:
        """
        Count the number of records in the table.
        """
        query = select(func.count(cls.id)).filter(*[getattr(cls, key) == value for key, value in kwargs.items()]) if kwargs else select(func.count(cls.id))
        try:
            with PostgresDB.session(ro=readonly) as db_sess:
    ...
    @classmethod
    async def acount(cls, readonly: Optional[bool]=True, **kwargs) -> int:
        """
        Count the number of records in the table.
        """
    ...
    def diff(self, other: Union[Any, 'ORMType']) -> Dict[str, Any]:
        """
    ...
    @classmethod
    async def afilter_first(cls, attr: str, value: Any, model_type: Optional[ModelType]=None, readonly: Optional[bool]=False) -> Optional[ModelType]:
        """
    ...
    @classmethod
    def first(cls, db: Session, stmt: Select, model_type: ModelType) -> Optional[ModelType]:
        """
        Return the first result of a query.
        """
    ...
    @classmethod
    async def afirst(cls, db: AsyncSession, stmt: Select, model_type: ModelType) -> Optional[ModelType]:
        """
        Return the first result of a query.
        """
    ...
    async def aget_or_create_or_update(cls, _defaults: Dict[str, Any]=None, **kwargs) -> Tuple[ModelType, bool]:
        ...
        try:
            ...
            return (await res.aupdate(**_defaults), True) if _defaults else (res, False)
        except NoResultFound:
            _defaults = _defaults or {}
    ...
    @classmethod
    async def aget_by_owner(cls, owner_id: int, owner_key: str='owner_id', name: Optional[str]=None, name_key: Optional[str]='name', skip: int=0, limit: int=100, order_by: Optional[Any]=None, load_attrs: Optional[List[str]]=None, load_attr_method: Optional[Union[str, Callable]]=None, readonly: Optional[bool]=False):
        """
        Fetch all records by owner_id
        """
        async with PostgresDB.async_session(ro=readonly) as db_sess:
