...
def normal_tanh_distribution(num_actions, gaussian_std_fn=softplus_default_std_fn):
    ...
    def create_dist(parameters):
        ...
        return tfd.Independent(TanhTransformedDistribution(normal_dist), reinterpreted_batch_ndims=1)
