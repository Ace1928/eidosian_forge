...
def _AddLVPShareConfig(bare_metal_storage_config_group):
  ...
  """
    bare_metal_lvp_share_config_group = bare_metal_storage_config_group.add_group(help=' LVP share configuration.', required=True)
    bare_metal_lvp_share_config_group.add_argument('--shared-path-pv-count', help='Number of subdirectories to create under path.')
