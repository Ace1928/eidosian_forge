    ...
    def setup_params(self, data):
        ...
        if params['method'] == 'auto':
            ...
            if max_group < 1000:
                ...
                params['method'] = 'glm'
        if params['method'] == 'mavg' and 'window' not in params['method_args']:
            window = len(data) // 10
            warnings.warn(f"No 'window' specified in the method_args. Using window = {window}. The same window is used for all groups or facets", PlotnineWarning, stacklevel=2)
