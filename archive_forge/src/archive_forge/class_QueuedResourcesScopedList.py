...
class QueuedResourcesScopedList(_messages.Message):
    """A QueuedResourcesScopedList object.
  ...
  """
    ...
    queuedResources = _messages.MessageField('QueuedResource', 1, repeated=True)
