...
def test_ui_BytesToFixedWidthString(self):
    ...
    self.assertEqual('  2.3 KiB', BytesToFixedWidthString(2.27 * 1024, decimal_places=1))
    self.assertEqual(' 1023 KiB', BytesToFixedWidthString(1023.2 * 1024, decimal_places=1))
    self.assertEqual('  1.0 MiB', BytesToFixedWidthString(1024 ** 2, decimal_places=1))
    self.assertEqual('999.1 MiB', BytesToFixedWidthString(999.1 * 1024 ** 2, decimal_places=1))