...
def test_fip_port_forward_update(self):
    ...
    mock_update = self.patchobject(self.sdkclient.network, 'update_floating_ip_port_forwarding', return_value=pfid)
    ...
    mock_update.assert_called_once_with(fip_id, '180941c5-9e82-41c7-b64d-6a57302ec211', **prop_diff)