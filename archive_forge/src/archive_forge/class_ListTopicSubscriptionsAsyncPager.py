...
class ListTopicSubscriptionsAsyncPager:
    ...
    def __init__(self, method: Callable[..., Awaitable[admin.ListTopicSubscriptionsResponse]], request: admin.ListTopicSubscriptionsRequest, response: admin.ListTopicSubscriptionsResponse, *, metadata: Sequence[Tuple[str, str]]=()):
