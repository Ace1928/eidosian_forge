...
class V1APIServiceSpec(object):
    ...
    swagger_types = {'ca_bundle': 'str', 'group': 'str', 'group_priority_minimum': 'int', 'insecure_skip_tls_verify': 'bool', 'service': 'V1ServiceReference', 'version': 'str', 'version_priority': 'int'}
