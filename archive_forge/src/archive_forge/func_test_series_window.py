...
def test_series_window(data, window, min_periods, method, kwargs):
    ...
    eval_general(modin_series, pandas_series, lambda series: getattr(series.rolling(window=window, min_periods=min_periods, win_type='triang', center=True), method)(**kwargs))