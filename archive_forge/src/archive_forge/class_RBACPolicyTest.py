...
class RBACPolicyTest(common.HeatTestCase):
    ...
    def _test_create(self, obj_type='network'):
        ...
        expected = {'rbac_policy': {'action': 'access_as_shared', 'object_type': obj_type, 'object_id': '9ba4c03a-dbd5-4836-b651-defa595796ba', 'target_tenant': 'd1dbbed707e5469da9cd4fdd618e9706'}}
    ...
    def test_update(self):
        ...
        prop_diff = {'target_tenant': '77485d3b002b4e0c9e8b37fac7261842'}
        self.rbac.handle_update(None, None, prop_diff)
        self.neutron_client.update_rbac_policy.assert_called_with('bca25c0e-5937-4341-a911-53e202629269', {'rbac_policy': prop_diff})

    def test_delete(self):
        self._create_stack()
        self.rbac.resource_id_set('bca25c0e-5937-4341-a911-53e202629269')
        self.rbac.handle_delete()
        self.neutron_client.delete_rbac_policy.assert_called_with('bca25c0e-5937-4341-a911-53e202629269')

    def test_delete_failed(self):
        self._create_stack()
        self.rbac.resource_id_set('bca25c0e-5937-4341-a911-53e202629269')
        self.neutron_client.delete_rbac_policy.side_effect = exceptions.Unauthorized
        self.assertRaises(exceptions.Unauthorized, self.rbac.handle_delete)

    def test_delete_not_found(self):
        self._create_stack()
        self.rbac.resource_id_set('bca25c0e-5937-4341-a911-53e202629269')
        self.neutron_client.delete_rbac_policy.side_effect = exceptions.NotFound()
        self.assertIsNone(self.rbac.handle_delete())

    def test_show_resource(self):
        self._create_stack()
        self.rbac.resource_id_set('1234')
        self.neutron_client.show_rbac_policy.return_value = {'rbac_policy': {'id': '123'}}
