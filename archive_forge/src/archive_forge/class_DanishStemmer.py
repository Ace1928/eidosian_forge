...
class DanishStemmer(_ScandinavianStemmer):
    ...
    __s_ending = 'abcdfghjklmnoprtvyzå'
    __step1_suffixes = ('erendes', 'erende', 'hedens', 'ethed', 'erede', 'heden', 'heder', 'endes', 'ernes', 'erens', 'erets', 'ered', 'ende', 'erne', 'eren', 'erer', 'heds', 'enes', 'eres', 'eret', 'hed', 'ene', 'ere', 'ens', 'ers', 'ets', 'en', 'er', 'es', 'et', 'e', 's')
    __step2_suffixes = ('gd', 'dt', 'gt', 'kt')
    __step3_suffixes = ('elig', 'løst', 'lig', 'els', 'ig')
