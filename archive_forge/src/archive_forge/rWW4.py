...
class Node:
    def __init__(self, x: int, y: int, f: int = 0, g: int = 0, h: int = 0):
        ...
        """
        self.x: int = int(x)  # Explicit conversion to integer, ensuring type correctness
        self.y: int = int(y)  # Explicit conversion to integer, ensuring type correctness
        self.f: int = int(f)  # Explicit conversion to integer, ensuring type correctness
        self.g: int = int(g)  # Explicit conversion to integer, ensuring type correctness
        self.h: int = int(h)  # Explicit conversion to integer, ensuring type correctness
