...
def test_share_network_subnets(self):
    self.verify_list(self.proxy.share_network_subnets, share_network_subnet.ShareNetworkSubnet, method_args=['test_share'], expected_args=[], expected_kwargs={'share_network_id': 'test_share'})