...
def ScopeRBACRoleBindingParentName(project, scope, release_track=base.ReleaseTrack.ALPHA):
    return resources.REGISTRY.Parse(line=None, params={'projectsId': project, 'locationsId': 'global', 'scopesId': scope}, collection='gkehub.projects.locations.scopes', api_version=VERSION_MAP[release_track]).RelativeName()