...
def test_share_group_snapshot_reset_state_with_flag(self):
    ...
    self.run_command('share-group-snapshot-reset-state --state creating 1234')
    self.assert_called('POST', '/share-group-snapshots/1234/action', {'reset_status': {'status': 'creating'}})