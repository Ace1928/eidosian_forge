...
def general_dropout(x, rate, uniform_sampler, noise_shape=None, name=None):
  ...
  """
    ...
    def dummy_rng_step():
        pass
    return _dropout(x=x, rate=rate, noise_shape=noise_shape, uniform_sampler=uniform_sampler, dummy_rng_step=dummy_rng_step, name=name, default_name='general_dropout')