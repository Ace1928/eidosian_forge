...
def regressor_parse_example_spec_v2(feature_columns, label_key, label_dtype=tf.dtypes.float32, label_default=None, label_dimension=1, weight_column=None):
  ...
  * It is difficult to map expected label by a regressor such as `DNNRegressor`
  ...
  """
    ...
    label_spec = tf.io.FixedLenFeature((label_dimension,), label_dtype, label_default)
