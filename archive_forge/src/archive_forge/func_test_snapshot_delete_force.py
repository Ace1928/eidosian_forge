...
def test_snapshot_delete_force(self):
    self._verify('openstack.block_storage.v3.snapshot.Snapshot.force_delete', self.proxy.delete_snapshot, method_args=['value'], method_kwargs={'force': True}, expected_args=[self.proxy])