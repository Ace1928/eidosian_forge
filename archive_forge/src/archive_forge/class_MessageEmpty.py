...
class MessageEmpty:
    ...
    def bytes(cls):
        ...
        """
        return b'\x01\x00\x97\x8f\x00\x00\x00\x00\x00\x00\x00\x00'
    ...
    def kwargs(cls):
        ...
        """
        return dict(id=256, answer=True, opCode=dns.OP_STATUS, auth=True, trunc=True, recDes=True, recAv=True, rCode=15, ednsVersion=None)