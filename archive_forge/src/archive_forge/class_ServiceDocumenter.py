...
class ServiceDocumenter(BaseServiceDocumenter):
    ...
    def __init__(self, service_name, session):
        super(ServiceDocumenter, self).__init__(service_name=service_name, session=session._session)
        ...
        self.sections = ['title', 'table-of-contents', 'client', 'paginators', 'waiters', 'service-resource', 'resources', 'examples']
