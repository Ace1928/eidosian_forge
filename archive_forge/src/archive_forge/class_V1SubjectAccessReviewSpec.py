...
class V1SubjectAccessReviewSpec(object):
    ...
    swagger_types = {'extra': 'dict(str, list[str])', 'groups': 'list[str]', 'non_resource_attributes': 'V1NonResourceAttributes', 'resource_attributes': 'V1ResourceAttributes', 'uid': 'str', 'user': 'str'}
