...
class TestDatetime(yaql.tests.TestCase):
    ...
    def test_replace(self):
        dt = DT(2006, 11, 21, 16, 30, tzinfo=tz.tzutc())
        self.assertEqual(DT(2009, 11, 21, 16, 40, tzinfo=tz.tzutc()), self.eval('$.replace(year => 2009, minute => 40)', dt))
    ...
    def test_now(self):
        ...
        self.assertThat(self.eval('now(utctz()) - now()'), matchers.LessThan(TS(seconds=1)))
