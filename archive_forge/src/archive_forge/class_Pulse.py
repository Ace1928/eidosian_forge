...
class Pulse(ABC):
    ...
    @abstractmethod
    def __init__(self, duration: int | ParameterExpression, name: str | None=None, limit_amplitude: bool | None=None):
    ...
    def draw(self, style: dict[str, Any] | None=None, backend: Backend | None=None, time_range: tuple[int, int] | None=None, time_unit: str='dt', show_waveform_info: bool=True, plotter: str='mpl2d', axis: Any | None=None):
