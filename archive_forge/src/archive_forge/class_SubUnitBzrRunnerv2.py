...
class SubUnitBzrRunnerv2(TextTestRunner, SubunitTestRunner):
    ...
    def __init__(self, stream=sys.stderr, descriptions=0, verbosity=1, bench_history=None, strict=False, result_decorators=None):
        TextTestRunner.__init__(self, stream=stream, descriptions=descriptions, verbosity=verbosity, bench_history=bench_history, strict=strict, result_decorators=result_decorators)
