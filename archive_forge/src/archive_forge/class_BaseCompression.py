...
class BaseCompression(abc.ABC):
    ...
    def __init__(self, compression_level: Optional[int]=None, encoding: Optional[str]=None, raise_errors: bool=False, compression_kwargs: Optional[Dict[str, Any]]=None, decompression_kwargs: Optional[Dict[str, Any]]=None, **kwargs):
        """
