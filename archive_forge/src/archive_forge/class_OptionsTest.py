...
class OptionsTest(unittest.TestCase):
    ...
    def test_types(self):
        ...
        options.parse_command_line(['main.py', '--str=asdf', '--basestring=qwer', '--int=42', '--float=1.5', '--datetime=2013-04-28 05:16', '--timedelta=45s', '--email=tornado@web.com', '--list-of-int=1,2,3', '--list-of-str=a,b,c'])
