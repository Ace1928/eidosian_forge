...
class ExchangeTaskSpec:
    ...
    @staticmethod
    def map(idx: int, block: Block, output_num_blocks: int) -> List[Union[BlockMetadata, Block]]:
        """
    ...
    @staticmethod
    def reduce(*mapper_outputs: List[Block], partial_reduce: bool=False) -> Tuple[Block, BlockMetadata]:
        """
