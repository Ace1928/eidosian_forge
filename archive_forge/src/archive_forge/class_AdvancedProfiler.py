...
class AdvancedProfiler(Profiler):
    ...
    def __init__(self, dirpath: Optional[Union[str, Path]]=None, filename: Optional[str]=None, line_count_restriction: float=1.0) -> None:
        """
        Args:
    ...
    def __reduce__(self) -> Tuple:
        return (self.__class__, (), {'dirpath': self.dirpath, 'filename': self.filename, 'line_count_restriction': self.line_count_restriction})