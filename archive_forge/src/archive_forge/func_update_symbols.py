    ...
    if isinstance(shape, dict):
        for i, dim in shape.items():
            if isinstance(dim, _Dim):
                ...
                raise UserError(UserErrorType.INVALID_INPUT, f'Unexpected item #{i} ({dim}) in dynamic_shape {shape} of Tensor, try None instead')
        ...
        raise UserError(UserErrorType.INVALID_INPUT, f'Unexpected dynamic_shape {shape} of Tensor, try None instead')