...
class RealTerminal:
    ...
    if IS_WINDOWS:
        ...
        def tty_signal_keys(self, intr: Literal['undefined'] | int | None=None, quit: Literal['undefined'] | int | None=None, start: Literal['undefined'] | int | None=None, stop: Literal['undefined'] | int | None=None, susp: Literal['undefined'] | int | None=None, fileno: int | None=None):
            """
