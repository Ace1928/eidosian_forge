...
def _GetShieldedInstanceIntegrityPolicyRef(self, instance_ref, holder):
    ...
    shieldedinstance_integrity_policy_message = instance_utils.CreateShieldedInstanceIntegrityPolicyMessage(messages)
    request = messages.ComputeInstancesSetShieldedInstanceIntegrityPolicyRequest(instance=instance_ref.Name(), project=instance_ref.project, shieldedInstanceIntegrityPolicy=shieldedinstance_integrity_policy_message, zone=instance_ref.zone)
