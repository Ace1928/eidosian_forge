...
class JarvisAtomsAdaptor:
    ...
    def get_atoms(structure):
        ...
        return Atoms(lattice_mat=structure.lattice.matrix, elements=elements, coords=coords, cartesian=False)
    ...
    def get_structure(atoms):
        ...
        """
        return Structure(lattice=atoms.lattice_mat, species=atoms.elements, coords=atoms.frac_coords, coords_are_cartesian=False)