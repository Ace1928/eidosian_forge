...
class UniversalDecorator:
    ...
    def __call__(
        ...
        """
        Transforms the UniversalDecorator into a callable object, allowing it to be used as a decorator.
            ...
            while attempts < self.retries:
                try:
                    ...
                    if self.enable_performance_logging:
                        await self.log_performance(func.__name__, start_time, end_time)
                    return result
        ...
        def sync_wrapper(*args: Any, **kwargs: Any) -> Any:
            """
            A synchronous wrapper function that leverages an event loop to provide the core functionality of the UniversalDecorator for synchronous functions.
