...
class NWChem(FileIOCalculator):
    ...
    def __init__(self, restart=None, ignore_bad_restart_file=FileIOCalculator._deprecated, label='nwchem', atoms=None, command=None, **kwargs):
        """
    ...
    def write_input(self, atoms, properties=None, system_changes=None):
        ...
        io.write(self.label + '.nwi', atoms, properties=properties, label=self.label, **self.parameters)
