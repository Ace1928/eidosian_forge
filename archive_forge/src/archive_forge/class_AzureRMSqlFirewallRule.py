...
class AzureRMSqlFirewallRule(AzureRMModuleBase):
    ...
    def __init__(self):
        ...
        super(AzureRMSqlFirewallRule, self).__init__(derived_arg_spec=self.module_arg_spec, supports_check_mode=True, supports_tags=False)
    ...
    def create_update_firewallrule(self):
        ...
        try:
            params = FirewallRule(name=self.name, start_ip_address=self.start_ip_address, end_ip_address=self.end_ip_address)
            response = self.sql_client.firewall_rules.create_or_update(resource_group_name=self.resource_group, server_name=self.server_name, firewall_rule_name=self.name, parameters=params)
    ...
    def delete_firewallrule(self):
        ...
        try:
            self.sql_client.firewall_rules.delete(resource_group_name=self.resource_group, server_name=self.server_name, firewall_rule_name=self.name)
