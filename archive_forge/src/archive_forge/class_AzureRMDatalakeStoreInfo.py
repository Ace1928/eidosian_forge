...
class AzureRMDatalakeStoreInfo(AzureRMModuleBase):
    ...
    def __init__(self):
        self.module_arg_spec = dict(name=dict(type='str'), resource_group=dict(type='str', aliases=['resource_group_name']))
        self.results = dict(changed=False, datalake=[])
        self.name = None
        self.resource_group = None
        super(AzureRMDatalakeStoreInfo, self).__init__(self.module_arg_spec, supports_check_mode=True, supports_tags=False)
