...
class InstancesAddTags(base.UpdateCommand):
    ...
    def Args(parser):
        ...
        parser.add_argument('--tags', required=True, type=arg_parsers.ArgList(min_length=1), metavar='TAG', help='        Specifies strings to be attached to the instance for later\n        identifying the instance when adding network firewall rules.\n        Multiple tags can be attached by repeating this flag.\n        ')
