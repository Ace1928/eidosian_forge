...
def CreateUserWorkloadsConfigMap(environment_ref: 'Resource', config_map_file_path: str, release_track: base.ReleaseTrack=base.ReleaseTrack.ALPHA) -> typing.Union['composer_v1alpha2_messages.UserWorkloadsConfigMap', 'composer_v1beta1_messages.UserWorkloadsConfigMap', 'composer_v1_messages.UserWorkloadsConfigMap']:
  ...
  """
    ...
    request_message = message_module.ComposerProjectsLocationsEnvironmentsUserWorkloadsConfigMapsCreateRequest(parent=environment_ref.RelativeName(), userWorkloadsConfigMap=message_module.UserWorkloadsConfigMap(name=user_workloads_config_map_name, data=user_workloads_config_map_data))
