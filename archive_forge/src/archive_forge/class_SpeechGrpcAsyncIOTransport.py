...
class SpeechGrpcAsyncIOTransport(SpeechTransport):
    ...
    def recognize(self) -> Callable[[cloud_speech.RecognizeRequest], Awaitable[cloud_speech.RecognizeResponse]]:
        """Return a callable for the recognize method over gRPC.
        ...
        if 'recognize' not in self._stubs:
            self._stubs['recognize'] = self.grpc_channel.unary_unary('/google.cloud.speech.v1p1beta1.Speech/Recognize', request_serializer=cloud_speech.RecognizeRequest.serialize, response_deserializer=cloud_speech.RecognizeResponse.deserialize)
    ...
    def long_running_recognize(self) -> Callable[[cloud_speech.LongRunningRecognizeRequest], Awaitable[operations_pb2.Operation]]:
        """Return a callable for the long running recognize method over gRPC.
        ...
        if 'long_running_recognize' not in self._stubs:
            self._stubs['long_running_recognize'] = self.grpc_channel.unary_unary('/google.cloud.speech.v1p1beta1.Speech/LongRunningRecognize', request_serializer=cloud_speech.LongRunningRecognizeRequest.serialize, response_deserializer=operations_pb2.Operation.FromString)
    ...
    def streaming_recognize(self) -> Callable[[cloud_speech.StreamingRecognizeRequest], Awaitable[cloud_speech.StreamingRecognizeResponse]]:
        """Return a callable for the streaming recognize method over gRPC.
        ...
        if 'streaming_recognize' not in self._stubs:
            self._stubs['streaming_recognize'] = self.grpc_channel.stream_stream('/google.cloud.speech.v1p1beta1.Speech/StreamingRecognize', request_serializer=cloud_speech.StreamingRecognizeRequest.serialize, response_deserializer=cloud_speech.StreamingRecognizeResponse.deserialize)
