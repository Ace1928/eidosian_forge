...
class Test_RstBPDUs(unittest.TestCase):
    ...
    def test_serialize(self):
        ...
        self.assertEqual(bpdu.RstBPDUs._decode_bridge_id(res[4]), (self.root_priority, self.root_system_id_extension, self.root_mac_address))
        self.assertEqual(res[5], self.root_path_cost)
        self.assertEqual(bpdu.RstBPDUs._decode_bridge_id(res[6]), (self.bridge_priority, self.bridge_system_id_extension, self.bridge_mac_address))
        self.assertEqual(bpdu.RstBPDUs._decode_port_id(res[7]), (self.port_priority, self.port_number))
