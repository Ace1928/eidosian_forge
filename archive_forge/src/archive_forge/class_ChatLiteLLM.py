...
class ChatLiteLLM(BaseChatModel):
    ...
    def _default_params(self) -> Dict[str, Any]:
        ...
        return {'model': set_model_value, 'force_timeout': self.request_timeout, 'max_tokens': self.max_tokens, 'stream': self.streaming, 'n': self.n, 'temperature': self.temperature, 'custom_llm_provider': self.custom_llm_provider, **self.model_kwargs}
    ...
    def _client_params(self) -> Dict[str, Any]:
        ...
        creds: Dict[str, Any] = {'model': set_model_value, 'force_timeout': self.request_timeout, 'api_base': self.api_base}
    ...
    def validate_environment(cls, values: Dict) -> Dict:
        ...
        try:
            ...
            raise ChatLiteLLMException('Could not import litellm python package. Please install it with `pip install litellm`')
    ...
    def _identifying_params(self) -> Dict[str, Any]:
        ...
        if self.model_name is not None:
            set_model_value = self.model_name
        return {'model': set_model_value, 'temperature': self.temperature, 'top_p': self.top_p, 'top_k': self.top_k, 'n': self.n}
