...
class SaharaDataSourceTest(common.HeatTestCase):
    ...
    def setUp(self):
        ...
        self.patchobject(data_source.DataSource, 'client', return_value=self.client)
    ...
    def test_create(self):
        ...
        expected_args = {'name': 'my-ds', 'description': '', 'data_source_type': 'swift', 'url': 'swift://container.sahara/text', 'credential_user': 'admin', 'credential_pass': 'swordfish'}
    ...
    def test_update(self):
        ...
        data = {'name': 'my-ds', 'description': '', 'type': 'hdfs', 'url': 'my/path', 'credentials': {'user': 'admin', 'password': 'swordfish'}}
        self.client.data_sources.update.assert_called_once_with('12345', data)
