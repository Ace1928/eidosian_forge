...
class ManilaShareNetworkTest(common.HeatTestCase):
    ...
    def setUp(self):
        ...
        self.patchobject(share_network.ManilaShareNetwork, 'client', return_value=self.client)
        self.client_plugin = mock.MagicMock()

        def resolve_neutron(resource_type, name):
            return name
        self.client_plugin.find_resourceid_by_name_or_id.side_effect = resolve_neutron
        self.patchobject(share_network.ManilaShareNetwork, 'client_plugin', return_value=self.client_plugin)

        def return_network(name):
            return '3'
        self.client_plugin.network_id_from_subnet_id.side_effect = return_network
    ...
    def _create_network(self, name, snippet, stack, use_neutron=True):
        ...
        self.client_plugin.get_security_service.side_effect = get_security_service
    ...
    def test_create_fail(self):
        ...
        self.assertRaises(exception.ResourceFailure, self._create_network, 'share_network', self.rsrc_defn, self.stack)
        csn = self.client.share_networks
        csn.create.assert_called_with(name='1', description='2', neutron_net_id='3', neutron_subnet_id='4', nova_net_id=None)
    ...
    def test_update(self):
        ...
        exp_args = {'name': 'a', 'description': 'b', 'neutron_net_id': 'c', 'neutron_subnet_id': 'd', 'nova_net_id': None}
    ...
    def test_get_live_state(self):
        ...
        value.to_dict.return_value = {'name': 'test', 'segmentation_id': '123', 'created_at': '2016-02-02T18:40:24.000000', 'neutron_subnet_id': None, 'updated_at': None, 'network_type': None, 'neutron_net_id': '4321', 'ip_version': None, 'nova_net_id': None, 'cidr': None, 'project_id': '221b4f51e9bd4f659845f657a3051a46', 'id': '4000d1c7-1017-4ea2-a4a1-951d8b63857a', 'description': None}
        self.client.share_networks.get.return_value = value
        self.client.security_services.list.return_value = [mock.Mock(id='6'), mock.Mock(id='7')]
        reality = net.get_live_state(net.properties)
        expected = {'name': 'test', 'neutron_subnet': None, 'neutron_network': '4321', 'nova_network': None, 'description': None, 'security_services': ['6', '7']}
