...
class AsyncHTTP2Connection(AsyncConnectionInterface):
    ...
    def __init__(self, origin: Origin, stream: AsyncNetworkStream, keepalive_expiry: typing.Optional[float]=None):
        self._origin = origin
        ...
        self._events: typing.Dict[int, typing.Union[h2.events.ResponseReceived, h2.events.DataReceived, h2.events.StreamEnded, h2.events.StreamReset]] = {}
        self._connection_terminated: typing.Optional[h2.events.ConnectionTerminated] = None
    ...
    async def _receive_response(self, request: Request, stream_id: int) -> typing.Tuple[int, typing.List[typing.Tuple[bytes, bytes]]]:
        """
    ...
    async def _receive_stream_event(self, request: Request, stream_id: int) -> typing.Union[h2.events.ResponseReceived, h2.events.DataReceived, h2.events.StreamEnded]:
        """
    ...
    async def _receive_events(self, request: Request, stream_id: typing.Optional[int]=None) -> None:
        """
    ...
    async def __aexit__(self, exc_type: typing.Optional[typing.Type[BaseException]]=None, exc_value: typing.Optional[BaseException]=None, traceback: typing.Optional[types.TracebackType]=None) -> None:
        await self.aclose()