...
class EnableGA(base.SilentCommand):
  ...
  """
    ...
    def Run(self, args):
        ...
        resource_args.CheckExpectedCAType(messages.CertificateAuthority.TypeValueValuesEnum.SUBORDINATE, current_ca, 'v1')
        ...
        log.status.Print('Enabled Subordinate CA [{}].'.format(ca_ref.RelativeName()))