...
class ServiceusageV1alpha(base_api.BaseApiClient):
    ...
    def __init__(self, url='', credentials=None, get_credentials=True, http=None, model=None, log_request=False, log_response=False, credentials_args=None, default_global_params=None, additional_http_headers=None, response_encoding=None):
        ...
        super(ServiceusageV1alpha, self).__init__(url, credentials=credentials, get_credentials=get_credentials, http=http, model=model, log_request=log_request, log_response=log_response, credentials_args=credentials_args, default_global_params=default_global_params, additional_http_headers=additional_http_headers, response_encoding=response_encoding)
...
service.
      ...
      """
        ...
        Get.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1alpha/operations/{operationsId}', http_method='GET', method_id='serviceusage.operations.get', ordered_params=['name'], path_params=['name'], query_params=[], relative_path='v1alpha/{+name}', request_field='', request_type_name='ServiceusageOperationsGetRequest', response_type_name='Operation', supports_download=False)
    ...
    class ServicesService(base_api.BaseApiService):
      ...
      """
            ...
            return self._RunMethod(config, request, global_params=global_params)
        GenerateIdentity.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1alpha/{v1alphaId}/{v1alphaId1}/services/{servicesId}:generateIdentity', http_method='POST', method_id='serviceusage.services.generateIdentity', ordered_params=['parent'], path_params=['parent'], query_params=[], relative_path='v1alpha/{+parent}:generateIdentity', request_field='', request_type_name='ServiceusageServicesGenerateIdentityRequest', response_type_name='Operation', supports_download=False)
      ...
      """
            ...
            return self._RunMethod(config, request, global_params=global_params)
        GetIdentity.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1alpha/{v1alphaId}/{v1alphaId1}/services/{servicesId}:getIdentity', http_method='GET', method_id='serviceusage.services.getIdentity', ordered_params=['parent'], path_params=['parent'], query_params=[], relative_path='v1alpha/{+parent}:getIdentity', request_field='', request_type_name='ServiceusageServicesGetIdentityRequest', response_type_name='ServiceIdentity', supports_download=False)