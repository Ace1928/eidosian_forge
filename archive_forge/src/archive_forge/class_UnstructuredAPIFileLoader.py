...
class UnstructuredAPIFileLoader(UnstructuredFileLoader):
    ...
    def __init__(self, file_path: Union[str, List[str], None]='', mode: str='single', url: str='https://api.unstructured.io/general/v0/general', api_key: str='', **unstructured_kwargs: Any):
