...
class SubscriberImpl(ContextManager, StreamingPullManager):
    ...
    def __init__(self, underlying: AsyncSingleSubscriber, callback: MessageCallback, unowned_executor: ThreadPoolExecutor):
    ...
    def __exit__(self, exc_type, exc_value, traceback):
        ...
        try:
            ...
            pass
        self._event_loop.submit(wait_ignore_errors(self._underlying.__aexit__(exc_type, exc_value, traceback))).result()
