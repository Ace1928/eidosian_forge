...
class NttCisVIPNode:
    ...
    def __init__(self, id, name, status, ip, connection_limit='10000', connection_rate_limit='10000', health_monitor=None):
        """
    ...
    def __repr__(self):
        return '<NttCisVIPNode: id=%s, name=%s, status=%s, ip=%s>' % (self.id, self.name, self.status, self.ip)