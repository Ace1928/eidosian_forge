...
class Migration(CompletableGithubObject):
    ...
    def get_status(self) -> str:
        ...
        """
        headers, data = self._requester.requestJsonAndCheck('GET', self.url, headers={'Accept': Consts.mediaTypeMigrationPreview})
    ...
    def get_archive_url(self) -> str:
        ...
        """
        headers, data = self._requester.requestJsonAndCheck('GET', f'{self.url}/archive', headers={'Accept': Consts.mediaTypeMigrationPreview})
        return data['data']
    ...
    def delete(self) -> None:
        ...
        """
        headers, data = self._requester.requestJsonAndCheck('DELETE', f'{self.url}/archive', headers={'Accept': Consts.mediaTypeMigrationPreview})
