...
class DevicesSwitchWarmSpare(object):
    ...
    def __init__(self, params, meraki):
        self.meraki = meraki
        self.new_object = dict(enabled=params.get('enabled'), spareSerial=params.get('spareSerial'), serial=params.get('serial'))
    ...
    def update_all_params(self):
        ...
        if self.new_object.get('spareSerial') is not None or self.new_object.get('spare_serial') is not None:
            new_object_params['spareSerial'] = self.new_object.get('spareSerial') or self.new_object.get('spare_serial')
        if self.new_object.get('serial') is not None or self.new_object.get('serial') is not None:
    ...
    def get_object_by_name(self, name):
        result = None
        try:
            items = self.meraki.exec_meraki(family='switch', function='getDeviceSwitchWarmSpare', params=self.get_all_params(name=name))
    ...
    def requires_update(self, current_obj):
        ...
        obj_params = [('enabled', 'enabled'), ('spareSerial', 'spareSerial'), ('serial', 'serial')]
    ...
    def update(self):
        ...
        name = self.new_object.get('name')
        result = None
        result = self.meraki.exec_meraki(family='switch', function='updateDeviceSwitchWarmSpare', params=self.update_all_params(), op_modifies=True)
        return result