...
class ScratchDir:
    ...
    def __init__(self, rootpath: Union[str, Path, None], create_symbolic_link: bool=False, copy_from_current_on_enter: bool=False, copy_to_current_on_exit: bool=False, gzip_on_exit: bool=False, delete_removed_files: bool=True):
        """
