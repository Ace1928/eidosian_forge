...
class FileManager:
    ...
    def process_file(
        ...
        try:
            ...
            # Start a transaction explicitly (optional here because sqlite3 starts it automatically)
            embedding_database_manager.connection_manager.cursor.execute("BEGIN;")
