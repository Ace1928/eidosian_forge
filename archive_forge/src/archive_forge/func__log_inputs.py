...
def _log_inputs():
    request_message = _get_request_message(LogInputs(), schema={'run_id': [_assert_required, _assert_string], 'datasets': [_assert_required, _assert_array]})
    run_id = request_message.run_id
    datasets = [DatasetInput.from_proto(proto_dataset_input) for proto_dataset_input in request_message.datasets]
