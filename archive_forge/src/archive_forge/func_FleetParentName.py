...
def FleetParentName(project, location='global', release_track=base.ReleaseTrack.ALPHA):
    return resources.REGISTRY.Parse(line=None, params={'projectsId': project, 'locationsId': location}, collection='gkehub.projects.locations', api_version=VERSION_MAP[release_track]).RelativeName()