...
class ClearButton(Button):
    ...
    def __init__(self, components: None | list[Component] | Component=None, *, value: str='Clear', every: float | None=None, variant: Literal['primary', 'secondary', 'stop']='secondary', size: Literal['sm', 'lg'] | None=None, icon: str | None=None, link: str | None=None, visible: bool=True, interactive: bool=True, elem_id: str | None=None, elem_classes: list[str] | str | None=None, render: bool=True, scale: int | None=None, min_width: int | None=None, api_name: str | None | Literal['False']=None, show_api: bool=False):
    ...
    def add(self, components: None | Component | list[Component]) -> ClearButton:
        ...
        if state_components:
            self.click(lambda: resolve_singleton(initial_states), None, state_components, api_name=self.api_name, show_api=self.show_api)
        return self
