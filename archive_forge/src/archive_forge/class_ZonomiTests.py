...
class ZonomiTests(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.test_zone = Zone(id='zone.com', domain='zone.com', driver=self.driver, type='master', ttl=None, extra={})
        self.test_record = Record(id='record.zone.com', name='record.zone.com', data='127.0.0.1', type='A', zone=self.test_zone, driver=self, extra={})
    ...
    def test_create_record_already_exists(self):
        ...
        try:
            self.driver.create_record(name='createrecord', type='A', data='127.0.0.1', zone=zone, extra={})
    ...
    def test_create_record_success(self):
        ...
        zone = self.test_zone
        record = self.driver.create_record(name='createrecord', zone=zone, type='A', data='127.0.0.1', extra={})
