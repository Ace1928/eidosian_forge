...
class CassandraChatMessageHistory(BaseChatMessageHistory):
    ...
    def __init__(self, session_id: str, session: Session, keyspace: str, table_name: str=DEFAULT_TABLE_NAME, ttl_seconds: typing.Optional[int]=DEFAULT_TTL_SECONDS) -> None:
        try:
    ...
    def add_message(self, message: BaseMessage) -> None:
        ...
        self.blob_history.store(self.session_id, json.dumps(message_to_dict(message)), self.ttl_seconds)
