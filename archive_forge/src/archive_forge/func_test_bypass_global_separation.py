...
def test_bypass_global_separation(self):
    ...
    self.assertRegex(warning_msgs, '.*Option to bypass global separation was chosen\\. Robust feasibility and optimality of the reported solution are not guaranteed\\.')