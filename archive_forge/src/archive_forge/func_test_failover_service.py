...
def test_failover_service(self):
    self._verify('openstack.block_storage.v3.service.Service.failover', self.proxy.failover_service, method_args=['value'], expected_args=[self.proxy], expected_kwargs={'backend_id': None, 'cluster': None})