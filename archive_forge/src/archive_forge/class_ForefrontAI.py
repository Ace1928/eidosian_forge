...
class ForefrontAI(LLM):
    ...
    def _default_params(self) -> Mapping[str, Any]:
        ...
        return {'temperature': self.temperature, 'length': self.length, 'top_p': self.top_p, 'top_k': self.top_k, 'repetition_penalty': self.repetition_penalty}
    ...
    def _call(self, prompt: str, stop: Optional[List[str]]=None, run_manager: Optional[CallbackManagerForLLMRun]=None, **kwargs: Any) -> str:
        ...
        response = requests.post(url=self.endpoint_url, headers={'Authorization': auth_value, 'Content-Type': 'application/json'}, json={'text': prompt, **self._default_params, **kwargs})
