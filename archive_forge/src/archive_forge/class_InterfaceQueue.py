...
class InterfaceQueue(InterfaceShared):
    ...
    def __init__(self, record_q: Optional['Queue[pb.Record]']=None, result_q: Optional['Queue[pb.Result]']=None, process: Optional[BaseProcess]=None, process_check: bool=True, mailbox: Optional[Mailbox]=None) -> None:
