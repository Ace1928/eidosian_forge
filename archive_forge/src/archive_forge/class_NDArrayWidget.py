...
class NDArrayWidget(NDArrayBase):
    ...
    compression_level = Int(0, help='If above 0, compress the data with zlib during serialization. Note: It is often more efficient to turn on compression on the notebook application level than to use this option.').tag(sync=True)
