...
class TestRemoveTrait(TestBaremetal):
    ...
    def test_baremetal_remove_trait(self):
        ...
        self.baremetal_mock.node.remove_trait.assert_called_once_with('node_uuid', 'CUSTOM_FOO')
    ...
    def test_baremetal_remove_trait_all(self):
        ...
        parsed_args = self.check_parser(self.cmd, arglist, verifylist)
        self.cmd.take_action(parsed_args)
        self.baremetal_mock.node.remove_all_traits.assert_called_once_with('node_uuid')
