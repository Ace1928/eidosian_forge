...
class GkemulticloudV1(base_api.BaseApiClient):
    ...
    class ProjectsLocationsAzureClustersService(base_api.BaseApiService):
      ...
      """
            config = self.GetMethodConfig('Create')
            return self._RunMethod(config, request, global_params=global_params)
        Create.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1/projects/{projectsId}/locations/{locationsId}/azureClusters', http_method='POST', method_id='gkemulticloud.projects.locations.azureClusters.create', ordered_params=['parent'], path_params=['parent'], query_params=['azureClusterId', 'validateOnly'], relative_path='v1/{+parent}/azureClusters', request_field='googleCloudGkemulticloudV1AzureCluster', request_type_name='GkemulticloudProjectsLocationsAzureClustersCreateRequest', response_type_name='GoogleLongrunningOperation', supports_download=False)
      ...
      """
            config = self.GetMethodConfig('Delete')
            return self._RunMethod(config, request, global_params=global_params)
        Delete.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1/projects/{projectsId}/locations/{locationsId}/azureClusters/{azureClustersId}', http_method='DELETE', method_id='gkemulticloud.projects.locations.azureClusters.delete', ordered_params=['name'], path_params=['name'], query_params=['allowMissing', 'etag', 'ignoreErrors', 'validateOnly'], relative_path='v1/{+name}', request_field='', request_type_name='GkemulticloudProjectsLocationsAzureClustersDeleteRequest', response_type_name='GoogleLongrunningOperation', supports_download=False)
      ...
      """
            ...
            return self._RunMethod(config, request, global_params=global_params)
        GenerateAzureAccessToken.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1/projects/{projectsId}/locations/{locationsId}/azureClusters/{azureClustersId}:generateAzureAccessToken', http_method='GET', method_id='gkemulticloud.projects.locations.azureClusters.generateAzureAccessToken', ordered_params=['azureCluster'], path_params=['azureCluster'], query_params=[], relative_path='v1/{+azureCluster}:generateAzureAccessToken', request_field='', request_type_name='GkemulticloudProjectsLocationsAzureClustersGenerateAzureAccessTokenRequest', response_type_name='GoogleCloudGkemulticloudV1GenerateAzureAccessTokenResponse', supports_download=False)
      ...
      """
            ...
            return self._RunMethod(config, request, global_params=global_params)
        GenerateAzureClusterAgentToken.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1/projects/{projectsId}/locations/{locationsId}/azureClusters/{azureClustersId}:generateAzureClusterAgentToken', http_method='POST', method_id='gkemulticloud.projects.locations.azureClusters.generateAzureClusterAgentToken', ordered_params=['azureCluster'], path_params=['azureCluster'], query_params=[], relative_path='v1/{+azureCluster}:generateAzureClusterAgentToken', request_field='googleCloudGkemulticloudV1GenerateAzureClusterAgentTokenRequest', request_type_name='GkemulticloudProjectsLocationsAzureClustersGenerateAzureClusterAgentTokenRequest', response_type_name='GoogleCloudGkemulticloudV1GenerateAzureClusterAgentTokenResponse', supports_download=False)
      ...
      """
            config = self.GetMethodConfig('Get')
            return self._RunMethod(config, request, global_params=global_params)
        Get.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1/projects/{projectsId}/locations/{locationsId}/azureClusters/{azureClustersId}', http_method='GET', method_id='gkemulticloud.projects.locations.azureClusters.get', ordered_params=['name'], path_params=['name'], query_params=[], relative_path='v1/{+name}', request_field='', request_type_name='GkemulticloudProjectsLocationsAzureClustersGetRequest', response_type_name='GoogleCloudGkemulticloudV1AzureCluster', supports_download=False)
      ...
      """
            config = self.GetMethodConfig('GetJwks')
            return self._RunMethod(config, request, global_params=global_params)
        GetJwks.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1/projects/{projectsId}/locations/{locationsId}/azureClusters/{azureClustersId}/jwks', http_method='GET', method_id='gkemulticloud.projects.locations.azureClusters.getJwks', ordered_params=['azureCluster'], path_params=['azureCluster'], query_params=[], relative_path='v1/{+azureCluster}/jwks', request_field='', request_type_name='GkemulticloudProjectsLocationsAzureClustersGetJwksRequest', response_type_name='GoogleCloudGkemulticloudV1AzureJsonWebKeys', supports_download=False)
      ...
      """
            config = self.GetMethodConfig('List')
            return self._RunMethod(config, request, global_params=global_params)
        List.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1/projects/{projectsId}/locations/{locationsId}/azureClusters', http_method='GET', method_id='gkemulticloud.projects.locations.azureClusters.list', ordered_params=['parent'], path_params=['parent'], query_params=['pageSize', 'pageToken'], relative_path='v1/{+parent}/azureClusters', request_field='', request_type_name='GkemulticloudProjectsLocationsAzureClustersListRequest', response_type_name='GoogleCloudGkemulticloudV1ListAzureClustersResponse', supports_download=False)
      ...
      """
            config = self.GetMethodConfig('Patch')
            return self._RunMethod(config, request, global_params=global_params)
        Patch.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1/projects/{projectsId}/locations/{locationsId}/azureClusters/{azureClustersId}', http_method='PATCH', method_id='gkemulticloud.projects.locations.azureClusters.patch', ordered_params=['name'], path_params=['name'], query_params=['updateMask', 'validateOnly'], relative_path='v1/{+name}', request_field='googleCloudGkemulticloudV1AzureCluster', request_type_name='GkemulticloudProjectsLocationsAzureClustersPatchRequest', response_type_name='GoogleLongrunningOperation', supports_download=False)
    ...
    class ProjectsLocationsOperationsService(base_api.BaseApiService):
      ...
      """
            ...
            return self._RunMethod(config, request, global_params=global_params)
        Cancel.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1/projects/{projectsId}/locations/{locationsId}/operations/{operationsId}:cancel', http_method='POST', method_id='gkemulticloud.projects.locations.operations.cancel', ordered_params=['name'], path_params=['name'], query_params=[], relative_path='v1/{+name}:cancel', request_field='googleLongrunningCancelOperationRequest', request_type_name='GkemulticloudProjectsLocationsOperationsCancelRequest', response_type_name='GoogleProtobufEmpty', supports_download=False)
      ...
      """
            config = self.GetMethodConfig('Delete')
            return self._RunMethod(config, request, global_params=global_params)
        Delete.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1/projects/{projectsId}/locations/{locationsId}/operations/{operationsId}', http_method='DELETE', method_id='gkemulticloud.projects.locations.operations.delete', ordered_params=['name'], path_params=['name'], query_params=[], relative_path='v1/{+name}', request_field='', request_type_name='GkemulticloudProjectsLocationsOperationsDeleteRequest', response_type_name='GoogleProtobufEmpty', supports_download=False)
      ...
      """
            config = self.GetMethodConfig('Get')
            return self._RunMethod(config, request, global_params=global_params)
        Get.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1/projects/{projectsId}/locations/{locationsId}/operations/{operationsId}', http_method='GET', method_id='gkemulticloud.projects.locations.operations.get', ordered_params=['name'], path_params=['name'], query_params=[], relative_path='v1/{+name}', request_field='', request_type_name='GkemulticloudProjectsLocationsOperationsGetRequest', response_type_name='GoogleLongrunningOperation', supports_download=False)
      ...
      """
            config = self.GetMethodConfig('List')
            return self._RunMethod(config, request, global_params=global_params)
        List.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1/projects/{projectsId}/locations/{locationsId}/operations', http_method='GET', method_id='gkemulticloud.projects.locations.operations.list', ordered_params=['name'], path_params=['name'], query_params=['filter', 'pageSize', 'pageToken'], relative_path='v1/{+name}/operations', request_field='', request_type_name='GkemulticloudProjectsLocationsOperationsListRequest', response_type_name='GoogleLongrunningListOperationsResponse', supports_download=False)
    ...
    class ProjectsLocationsService(base_api.BaseApiService):
      ...
      """
            ...
            return self._RunMethod(config, request, global_params=global_params)
        GenerateAttachedClusterInstallManifest.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1/projects/{projectsId}/locations/{locationsId}:generateAttachedClusterInstallManifest', http_method='GET', method_id='gkemulticloud.projects.locations.generateAttachedClusterInstallManifest', ordered_params=['parent'], path_params=['parent'], query_params=['attachedClusterId', 'platformVersion', 'proxyConfig_kubernetesSecret_name', 'proxyConfig_kubernetesSecret_namespace'], relative_path='v1/{+parent}:generateAttachedClusterInstallManifest', request_field='', request_type_name='GkemulticloudProjectsLocationsGenerateAttachedClusterInstallManifestRequest', response_type_name='GoogleCloudGkemulticloudV1GenerateAttachedClusterInstallManifestResponse', supports_download=False)
      ...
      """
            ...
            return self._RunMethod(config, request, global_params=global_params)
        GetAttachedServerConfig.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1/projects/{projectsId}/locations/{locationsId}/attachedServerConfig', http_method='GET', method_id='gkemulticloud.projects.locations.getAttachedServerConfig', ordered_params=['name'], path_params=['name'], query_params=[], relative_path='v1/{+name}', request_field='', request_type_name='GkemulticloudProjectsLocationsGetAttachedServerConfigRequest', response_type_name='GoogleCloudGkemulticloudV1AttachedServerConfig', supports_download=False)
      ...
      """
            ...
            return self._RunMethod(config, request, global_params=global_params)
        GetAwsServerConfig.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1/projects/{projectsId}/locations/{locationsId}/awsServerConfig', http_method='GET', method_id='gkemulticloud.projects.locations.getAwsServerConfig', ordered_params=['name'], path_params=['name'], query_params=[], relative_path='v1/{+name}', request_field='', request_type_name='GkemulticloudProjectsLocationsGetAwsServerConfigRequest', response_type_name='GoogleCloudGkemulticloudV1AwsServerConfig', supports_download=False)
      ...
      """
            ...
            return self._RunMethod(config, request, global_params=global_params)
        GetAzureServerConfig.method_config = lambda: base_api.ApiMethodInfo(flat_path='v1/projects/{projectsId}/locations/{locationsId}/azureServerConfig', http_method='GET', method_id='gkemulticloud.projects.locations.getAzureServerConfig', ordered_params=['name'], path_params=['name'], query_params=[], relative_path='v1/{+name}', request_field='', request_type_name='GkemulticloudProjectsLocationsGetAzureServerConfigRequest', response_type_name='GoogleCloudGkemulticloudV1AzureServerConfig', supports_download=False)
