...
class VMwareHostPassthrough(PyVmomi):
    ...
    def collect_pci_device_ids_for_supported_passthrough(self):
        ...
        for host_obj in self.hosts:
            ...
            self.hosts_passthrough_pci_device_id[esxi_hostname] = {'host_obj': host_obj, 'pci_device_ids': []}
    ...
    def execute(self):
        ...
        self.result['passthrough_configs'] = [{esxi_hostname: value['new_configs']} for esxi_hostname, value in self.host_target_device_to_change_configuration.items() if value['new_configs']]
