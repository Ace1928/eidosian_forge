...
class SdaFabric(object):
    ...
    def __init__(self, params, dnac):
        self.dnac = dnac
        self.new_object = dict(fabricName=params.get('fabricName'))
    ...
    def get_object_by_name(self, name, is_absent=False):
        result = None
        try:
            items = self.dnac.exec(family='sda', function='get_sda_fabric_info', params=self.get_all_params(name=name))
    ...
    def requires_update(self, current_obj):
        ...
        obj_params = [('fabricName', 'fabricName')]
    ...
    def create(self):
        result = self.dnac.exec(family='sda', function='add_fabric', params=self.create_params(), op_modifies=True)
    ...
    def delete(self):
        ...
        name = self.new_object.get('fabricName')
        result = None
        result = self.dnac.exec(family='sda', function='delete_sda_fabric', params=self.delete_all_params())
        return result