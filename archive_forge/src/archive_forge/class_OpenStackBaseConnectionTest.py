...
class OpenStackBaseConnectionTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.connection = OpenStackBaseConnection('foo', 'bar', timeout=self.timeout, ex_force_auth_url='https://127.0.0.1')
    ...
    def test_request(self, mock_request):
        ...
        response = self.connection.request('/path', data='somedata', headers={'h1': 'v1'}, method='POST')
        self.assertEqual(response, expected_response)
        mock_request.assert_called_with(action='/path', params={}, data='somedata', method='POST', headers={'h1': 'v1', 'Content-Type': 'application/json'}, raw=False)
