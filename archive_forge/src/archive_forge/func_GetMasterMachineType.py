...
def GetMasterMachineType():
    ...
    help_text = "  Specifies the type of virtual machine to use for training job's master worker.\n\n  You must set this value when `--scale-tier` is set to `CUSTOM`.\n  "
    return base.Argument('--master-machine-type', required=False, help=help_text)