...
class CredentialManager(base.CrudManager):
    ...
    def create(self, user, type, blob, project=None, **kwargs):
        ...
        """
        return super(CredentialManager, self).create(user_id=base.getid(user), type=type, blob=blob, project_id=base.getid(project), **kwargs)
    ...
    def get(self, credential):
        ...
        """
        return super(CredentialManager, self).get(credential_id=base.getid(credential))
    ...
    def update(self, credential, user, type=None, blob=None, project=None, **kwargs):
        ...
        """
        return super(CredentialManager, self).update(credential_id=base.getid(credential), user_id=base.getid(user), type=type, blob=blob, project_id=base.getid(project), **kwargs)
    ...
    def delete(self, credential):
        ...
        """
        return super(CredentialManager, self).delete(credential_id=base.getid(credential))