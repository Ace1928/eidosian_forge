...
class Clarifai(LLM):
    ...
    def _identifying_params(self) -> Dict[str, Any]:
        ...
        return {**{'model_url': self.model_url, 'user_id': self.user_id, 'app_id': self.app_id, 'model_id': self.model_id}}
    ...
    def _call(self, prompt: str, stop: Optional[List[str]]=None, run_manager: Optional[CallbackManagerForLLMRun]=None, inference_params: Optional[Dict[str, Any]]=None, **kwargs: Any) -> str:
        ...
        try:
            ...
            predict_response = self.model.predict_by_bytes(bytes(prompt, 'utf-8'), input_type='text', inference_params=inference_params)
    ...
    def _generate(self, prompts: List[str], stop: Optional[List[str]]=None, run_manager: Optional[CallbackManagerForLLMRun]=None, inference_params: Optional[Dict[str, Any]]=None, **kwargs: Any) -> LLMResult:
