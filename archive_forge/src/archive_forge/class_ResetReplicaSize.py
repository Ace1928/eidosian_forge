...
class ResetReplicaSize(base.Command):
    ...
    """
        ...
        try:
            request = sql_messages.SqlProjectsInstancesResetReplicaSizeRequest(project=instance_ref.project, instance=instance_ref.instance)
            ...
            if args.async_:
                return {'Name': instance_ref.instance, 'Project': instance_ref.project, 'OperationId': result_operation.name, 'Status': result_operation.status}
            operations.OperationsV1Beta4.WaitForOperation(sql_client, operation_ref, 'Resetting the Cloud SQL read replica size.')
            ...
            return {'Name': instance_ref.instance, 'Project': instance_ref.project, 'StorageSizeGb': changed_instance_resource.settings.dataDiskSizeGb}
