...
class HTTP2Connection(ConnectionInterface):
    ...
    def __init__(self, origin: Origin, stream: NetworkStream, keepalive_expiry: typing.Optional[float]=None):
        self._origin = origin
    ...
    def _receive_stream_event(self, request: Request, stream_id: int) -> typing.Union[h2.events.ResponseReceived, h2.events.DataReceived, h2.events.StreamEnded]:
        """
    ...
    def __exit__(self, exc_type: typing.Optional[typing.Type[BaseException]]=None, exc_value: typing.Optional[BaseException]=None, traceback: typing.Optional[types.TracebackType]=None) -> None:
        self.close()