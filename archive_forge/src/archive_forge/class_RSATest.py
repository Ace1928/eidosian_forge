...
class RSATest(unittest.TestCase):
    ...
    def _check_private_key(self, rsaObj):
        ...
        self.assertEqual(1, rsaObj.d * rsaObj.e % lcm)
    ...
    def _check_public_key(self, rsaObj):
        ...
        self.assertEqual(rsaObj.public_key() == rsaObj.public_key(), True)
        self.assertEqual(rsaObj.public_key() != rsaObj.public_key(), False)
