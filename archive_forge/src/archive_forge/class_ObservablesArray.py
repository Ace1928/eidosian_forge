...
class ObservablesArray(ShapedMixin):
    ...
    def __init__(self, observables: ObservablesArrayLike, copy: bool=True, validate: bool=True):
        ...
        if validate:
            ...
            for ndi, obs in np.ndenumerate(self._array):
                ...
                if num_qubits is None:
                    ...
                    raise ValueError('The number of qubits must be the same for all observables in the observables array.')
