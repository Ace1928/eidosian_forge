...
class ErdosRenyi(StochasticBlockModel):
    ...
    def __init__(self, N=100, p=0.1, directed=False, self_loops=False, connected=False, max_iter=10, seed=None, **kwargs):
        super(ErdosRenyi, self).__init__(N=N, k=1, p=p, directed=directed, self_loops=self_loops, connected=connected, max_iter=max_iter, seed=seed, **kwargs)
