...
def test_feature_names_count_vectorizer():
    ...
    assert_array_equal(pipe[:-1].get_feature_names_out(), ['beer', 'burger', 'coke', 'copyright', 'pizza', 'the'])
    assert_array_equal(pipe[:-1].get_feature_names_out('nonsense_is_ignored'), ['beer', 'burger', 'coke', 'copyright', 'pizza', 'the'])