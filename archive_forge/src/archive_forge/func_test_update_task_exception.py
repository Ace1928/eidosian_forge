...
def test_update_task_exception(self, mock_stack_update):
    ...
    class RandomException(Exception):
        pass
    tmpl1 = template.Template({'HeatTemplateFormatVersion': '2012-12-12', 'Resources': {'foo': {'Type': 'GenericResourceType'}}})
    ...
    tmpl2 = template.Template({'HeatTemplateFormatVersion': '2012-12-12', 'Resources': {'foo': {'Type': 'GenericResourceType'}, 'bar': {'Type': 'GenericResourceType'}}})
