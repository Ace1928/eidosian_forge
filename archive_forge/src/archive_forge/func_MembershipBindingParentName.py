...
def MembershipBindingParentName(project, membership, location='global', release_track=base.ReleaseTrack.GA):
    return resources.REGISTRY.Parse(line=None, params={'projectsId': project, 'locationsId': location, 'membershipsId': membership}, collection='gkehub.projects.locations.memberships', api_version=VERSION_MAP[release_track]).RelativeName()