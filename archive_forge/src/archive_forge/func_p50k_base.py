...
def p50k_base():
    ...
    return {'name': 'p50k_base', 'explicit_n_vocab': 50281, 'pat_str': "'(?:[sdmt]|ll|ve|re)| ?\\p{L}+| ?\\p{N}+| ?[^\\s\\p{L}\\p{N}]+|\\s+(?!\\S)|\\s+", 'mergeable_ranks': mergeable_ranks, 'special_tokens': {ENDOFTEXT: 50256}}