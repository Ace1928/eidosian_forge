...
@deprecated('Resolving directly in a Promise instance is deprecated, as Promise.resolve() is now a class method. Please use promise.do_resolve() instead.', name='resolve')
