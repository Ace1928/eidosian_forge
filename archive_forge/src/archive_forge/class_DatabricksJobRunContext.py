...
class DatabricksJobRunContext(RunContextProvider):
    ...
    def tags(self):
        ...
        tags = {MLFLOW_SOURCE_NAME: f'jobs/{job_id}/run/{job_run_id}' if job_id is not None and job_run_id is not None else None, MLFLOW_SOURCE_TYPE: SourceType.to_string(SourceType.JOB)}
