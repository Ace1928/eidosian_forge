...
def lights_gray():
    return [AmbientLight(color=[0.6, 0.6, 0.6]), DirectionalLight(position=[0, 1, 1], color=[0.5, 0.5, 0.5]), DirectionalLight(position=[0, 0, 1], color=[0.5, 0.5, 0.5]), DirectionalLight(position=[1, 1, 1], color=[0.5, 0.5, 0.5]), DirectionalLight(position=[-1, -1, -1], color=[0.7, 0.7, 0.7])]