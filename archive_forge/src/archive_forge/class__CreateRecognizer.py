...
class _CreateRecognizer(SpeechRestStub):
    ...
    def __call__(self, request: cloud_speech.CreateRecognizerRequest, *, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Optional[float]=None, metadata: Sequence[Tuple[str, str]]=()) -> operations_pb2.Operation:
        """Call the create recognizer method over HTTP.
            ...
            """
        http_options: List[Dict[str, str]] = [{'method': 'post', 'uri': '/v2/{parent=projects/*/locations/*}/recognizers', 'body': 'recognizer'}]
