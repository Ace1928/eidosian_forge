...
def AddCpuThrottlingFlag(parser):
    ...
    parser.add_argument('--cpu-throttling', action=arg_parsers.StoreTrueFalseAction, help='Whether to throttle the CPU when the container is not actively serving requests.')