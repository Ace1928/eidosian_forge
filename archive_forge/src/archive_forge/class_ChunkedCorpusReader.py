...
class ChunkedCorpusReader(CorpusReader):
    ...
    def words(self, fileids=None):
        ...
        :rtype: list(str)
        """
        return concat([ChunkedCorpusView(f, enc, 0, 0, 0, 0, *self._cv_args) for f, enc in self.abspaths(fileids, True)])
    ...
    def sents(self, fileids=None):
        ...
        :rtype: list(list(str))
        """
        return concat([ChunkedCorpusView(f, enc, 0, 1, 0, 0, *self._cv_args) for f, enc in self.abspaths(fileids, True)])
    ...
    def paras(self, fileids=None):
        ...
        """
        return concat([ChunkedCorpusView(f, enc, 0, 1, 1, 0, *self._cv_args) for f, enc in self.abspaths(fileids, True)])
    ...
    def tagged_words(self, fileids=None, tagset=None):
        ...
        """
        return concat([ChunkedCorpusView(f, enc, 1, 0, 0, 0, *self._cv_args, target_tagset=tagset) for f, enc in self.abspaths(fileids, True)])
    ...
    def tagged_sents(self, fileids=None, tagset=None):
        ...
        """
        return concat([ChunkedCorpusView(f, enc, 1, 1, 0, 0, *self._cv_args, target_tagset=tagset) for f, enc in self.abspaths(fileids, True)])
    ...
    def tagged_paras(self, fileids=None, tagset=None):
        ...
        """
        return concat([ChunkedCorpusView(f, enc, 1, 1, 1, 0, *self._cv_args, target_tagset=tagset) for f, enc in self.abspaths(fileids, True)])
