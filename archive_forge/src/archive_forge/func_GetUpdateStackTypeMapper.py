...
def GetUpdateStackTypeMapper(messages, hidden=False):
  ...
  """
    ...
    return arg_utils.ChoiceEnumMapper('--stack-type', messages.ClusterUpdate.DesiredStackTypeValueValuesEnum, _GetStackTypeCustomMappings(), hidden=hidden, help_str=help_text)