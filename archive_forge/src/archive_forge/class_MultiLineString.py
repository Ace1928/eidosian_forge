...
class MultiLineString(Geometry):
    ...
    def __init__(self, coordinates: Union[Sequence[Sequence[Union['SchemaBase', Sequence[float]]]], UndefinedType]=Undefined, type: Union[str, UndefinedType]=Undefined, bbox: Union['SchemaBase', Sequence[float], UndefinedType]=Undefined, **kwds):
