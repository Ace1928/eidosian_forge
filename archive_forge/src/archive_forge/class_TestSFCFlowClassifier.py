...
class TestSFCFlowClassifier(base.BaseFunctionalTest):
    ...
    def tearDown(self):
        sot = self.operator_cloud.network.delete_sfc_flow_classifier(self.FLOW_CLASSIFIER.id, ignore_missing=True)
