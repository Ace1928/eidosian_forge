...
class ConditionalParameterValueDefGradientstringnullExprRef(ConditionalValueDefGradientstringnullExprRef):
    ...
    def __init__(self, param: Union[str, 'SchemaBase', UndefinedType]=Undefined, value: Union[str, dict, None, '_Parameter', 'SchemaBase', UndefinedType]=Undefined, empty: Union[bool, UndefinedType]=Undefined, **kwds):
        super(ConditionalParameterValueDefGradientstringnullExprRef, self).__init__(param=param, value=value, empty=empty, **kwds)