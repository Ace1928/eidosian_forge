...
class TestBlacklist(BaseDesignateTest):
    ...
    def setUp(self):
        ...
        self.blacklist = self.useFixture(BlacklistFixture(pattern=pattern, description='A random blacklist')).blacklist
    ...
    def test_zone_blacklist_delete(self):
        ...
        self.assertRaises(CommandFailed, client.zone_blacklist_show, self.blacklist.id)
