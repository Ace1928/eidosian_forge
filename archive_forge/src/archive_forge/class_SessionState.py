...
class SessionState:
    ...
    def getSenderChainKey(self):
        ...
        return ChainKey(HKDF.createFor(self.getSessionVersion()), chainKeyStructure.key, chainKeyStructure.index)
    ...
    def getUnacknowledgedPreKeyMessageItems(self):
        ...
        return SessionState.UnacknowledgedPreKeyMessageItems(preKeyId, self.sessionStructure.pendingPreKey.signedPreKeyId, Curve.decodePoint(bytearray(self.sessionStructure.pendingPreKey.baseKey), 0))
