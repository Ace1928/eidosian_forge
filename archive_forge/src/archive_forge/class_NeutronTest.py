...
class NeutronTest(common.HeatTestCase):
    ...
    def test_needs_replace_failed(self):
        ...
        side_effect = [{'attr1': 'val1', 'status': 'ACTIVE'}, {'attr1': 'val1', 'status': 'ERROR'}, {'attr1': 'val1', 'attr2': 'val2'}, qe.NotFound]
        mock_show_resource = self.patchobject(res, '_show_resource', side_effect=side_effect)
        res.resource_id = None
