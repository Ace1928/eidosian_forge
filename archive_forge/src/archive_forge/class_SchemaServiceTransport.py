...
class SchemaServiceTransport(abc.ABC):
    ...
    AUTH_SCOPES = ('https://www.googleapis.com/auth/cloud-platform', 'https://www.googleapis.com/auth/pubsub')
    ...
    @property
    def list_schema_revisions(self) -> Callable[[schema.ListSchemaRevisionsRequest], Union[schema.ListSchemaRevisionsResponse, Awaitable[schema.ListSchemaRevisionsResponse]]]:
        raise NotImplementedError()

    @property
    def commit_schema(self) -> Callable[[gp_schema.CommitSchemaRequest], Union[gp_schema.Schema, Awaitable[gp_schema.Schema]]]:
        raise NotImplementedError()

    @property
    def rollback_schema(self) -> Callable[[schema.RollbackSchemaRequest], Union[schema.Schema, Awaitable[schema.Schema]]]:
        raise NotImplementedError()

    @property
    def delete_schema_revision(self) -> Callable[[schema.DeleteSchemaRevisionRequest], Union[schema.Schema, Awaitable[schema.Schema]]]:
        raise NotImplementedError()
