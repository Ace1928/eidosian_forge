...
class DatePickerDateTable(VuetifyWidget):
    ...
    first_day_of_week = Union([Unicode(), Float()], default_value=None, allow_none=True).tag(sync=True)
    light = Bool(None, allow_none=True).tag(sync=True)
    locale = Unicode(None, allow_none=True).tag(sync=True)
    locale_first_day_of_year = Union([Unicode(), Float()], default_value=None, allow_none=True).tag(sync=True)
