...
def test_credential_source_timeout_large(self):
    with pytest.raises(ValueError) as excinfo:
        CREDENTIAL_SOURCE = {'executable': {'command': self.CREDENTIAL_SOURCE_EXECUTABLE_COMMAND, 'timeout_millis': 120000 + 1, 'output_file': self.CREDENTIAL_SOURCE_EXECUTABLE_OUTPUT_FILE}}
