...
class SimpleReadOnlyOpenStackClientTest(base.OpenStackClientTestBase):
    ...
    def test_heat_template_validate_yaml(self):
        self._template_validate('heat_minimal.yaml', ['ClientName=ClientName', 'WaitSecs=123'])
    ...
    def test_orchestration_template_validate_hot(self):
        self._orchestration_template_validate('heat_minimal_hot.yaml', ['test_client_name=test_client_name', 'test_wait_secs=123'])