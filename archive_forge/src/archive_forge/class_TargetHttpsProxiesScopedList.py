...
class TargetHttpsProxiesScopedList(_messages.Message):
    """A TargetHttpsProxiesScopedList object.
  ...
  """
    ...
    targetHttpsProxies = _messages.MessageField('TargetHttpsProxy', 1, repeated=True)
