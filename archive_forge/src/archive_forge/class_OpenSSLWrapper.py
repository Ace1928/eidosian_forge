...
class OpenSSLWrapper:
    ...
    def create_certificate(self, cert_info, request=False, valid_from=0, valid_to=315360000, sn=1, key_length=1024, hash_alg='sha256', write_to_file=False, cert_dir='', cipher_passphrase=None):
        """
