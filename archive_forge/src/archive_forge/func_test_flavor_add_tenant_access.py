...
def test_flavor_add_tenant_access(self):
    self._verify('openstack.compute.v2.flavor.Flavor.add_tenant_access', self.proxy.flavor_add_tenant_access, method_args=['value', 'fake-tenant'], expected_args=[self.proxy, 'fake-tenant'])