...
class _UndeleteRecognizer(SpeechRestStub):
    ...
    def __call__(self, request: cloud_speech.UndeleteRecognizerRequest, *, retry: OptionalRetry=gapic_v1.method.DEFAULT, timeout: Optional[float]=None, metadata: Sequence[Tuple[str, str]]=()) -> operations_pb2.Operation:
        """Call the undelete recognizer method over HTTP.
            ...
            """
        http_options: List[Dict[str, str]] = [{'method': 'post', 'uri': '/v2/{name=projects/*/locations/*/recognizers/*}:undelete', 'body': '*'}]
