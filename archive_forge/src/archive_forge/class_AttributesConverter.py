...
class AttributesConverter(object):
    ...
    def proto_to_protocol(self, proto):
        return ProtocolAttributes(self.proto_to_message_key(proto.key), proto.type)
    ...
    def proto_to_contact(self, proto):
        return ContactAttributes(proto.display_name, proto.vcard, self.proto_to_contextinfo(proto.context_info) if proto.HasField('context_info') else None)
    ...
    def proto_to_extendedtext(self, proto):
        return ExtendedTextAttributes(proto.text if proto.HasField('text') else None, proto.matched_text if proto.HasField('matched_text') else None, proto.canonical_url if proto.HasField('canonical_url') else None, proto.description if proto.HasField('description') else None, proto.title if proto.HasField('title') else None, proto.jpeg_thumbnail if proto.HasField('jpeg_thumbnail') else None, self.proto_to_contextinfo(proto.context_info) if proto.HasField('context_info') else None)
    ...
    def proto_to_document(self, proto):
        return DocumentAttributes(self.proto_to_downloadablemedia(proto), proto.file_name if proto.HasField('file_name') else None, proto.file_length if proto.HasField('file_length') else None, proto.title if proto.HasField('title') else None, proto.page_count if proto.HasField('page_count') else None, proto.jpeg_thumbnail if proto.HasField('jpeg_thumbnail') else None)
    ...
    def proto_to_audio(self, proto):
        return AudioAttributes(self.proto_to_downloadablemedia(proto), proto.seconds, proto.ptt)
    ...
    def proto_to_sticker(self, proto):
        return StickerAttributes(self.proto_to_downloadablemedia(proto), proto.width, proto.height, proto.png_thumbnail)
    ...
    def proto_to_media(self, proto):
        return MediaAttributes(context_info=proto.context_info if proto.HasField('context_info') else None)
    ...
    def proto_to_contextinfo(self, proto):
        return ContextInfoAttributes(stanza_id=proto.stanza_id if proto.HasField('stanza_id') else None, participant=proto.participant if proto.HasField('participant') else None, quoted_message=self.proto_to_message(proto.quoted_message) if proto.HasField('quoted_message') else None, remote_jid=proto.remote_jid if proto.HasField('remote_jid') else None, mentioned_jid=proto.mentioned_jid if len(proto.mentioned_jid) else [], edit_version=proto.edit_version if proto.HasField('edit_version') else None, revoke_message=proto.revoke_message if proto.HasField('revoke_message') else None)
