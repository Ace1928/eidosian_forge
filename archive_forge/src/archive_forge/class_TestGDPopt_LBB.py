...
class TestGDPopt_LBB(unittest.TestCase):
    ...
    def test_LBB_8PP(self):
        ...
        results = SolverFactory('gdpopt.lbb').solve(eight_process, tee=False, minlp_solver=minlp_solver, minlp_solver_args=minlp_args)
    ...
    def test_LBB_strip_pack(self):
        ...
        SolverFactory('gdpopt.lbb').solve(strip_pack, tee=False, minlp_solver=minlp_solver, minlp_solver_args=minlp_args)
    ...
    def test_LBB_constrained_layout(self):
        ...
        SolverFactory('gdpopt.lbb').solve(cons_layout, tee=False, minlp_solver=minlp_solver, minlp_solver_args=minlp_args)
    ...
    def test_LBB_ex_633_trespalacios(self):
        ...
        SolverFactory('gdpopt.lbb').solve(model, tee=False, minlp_solver=minlp_solver, minlp_solver_args=minlp_args)
