...
class V1beta2DeploymentStatus(object):
    ...
    swagger_types = {'available_replicas': 'int', 'collision_count': 'int', 'conditions': 'list[V1beta2DeploymentCondition]', 'observed_generation': 'int', 'ready_replicas': 'int', 'replicas': 'int', 'unavailable_replicas': 'int', 'updated_replicas': 'int'}
