...
class PersistentDict(collections.abc.MutableMapping, MutableMapping[KT, VT]):
    ...
    def __init__(self, name: Optional[str]=None, serializer: Optional[str]=None, serializer_kwargs: Optional[Dict[str, Any]]=None, base_key: Optional[str]=None, async_enabled: Optional[bool]=False, settings: Optional['BaseSettings']=None, backend: Optional['BackendT']=None, backend_type: Optional[str]=None, metric_types: Optional[Dict[str, Union[str, Type['MetricT']]]]=None, **kwargs):
        """
        ...
        self.base = self.base_class(name=self.name, base_key=self.base_key, async_enabled=async_enabled, settings=self.settings, **self._kwargs)
    ...
    def copy(self, exclude: Optional[Set[str]]=None, exclude_none: Optional[bool]=False, **kwargs) -> Dict[KT, VT]:
        """
    ...
    async def acopy(self, exclude: Optional[Set[str]]=None, exclude_none: Optional[bool]=False, **kwargs) -> Dict[KT, VT]:
        """
        Copies the current data and returns a Dict
        """
    ...
    def clone(self, target: Optional[Any], target_base_key: Optional[str]=None, schema_map: Optional[Dict[str, str]]=None, overwrite: Optional[bool]=None, **kwargs):
        """
    ...
    @overload
    async def aclone(self, target: str, target_base_key: Optional[str]=None, target_db_id: Optional[int]=None, source_url: Optional[str]=None, source_base_key: Optional[str]=None, schema_map: Optional[Dict[str, str]]=None, overwrite: Optional[bool]=None, excluded: Optional[Union[str, List[str]]]=None, filter_function: Optional[Callable[[str], bool]]=None, raise_errors: Optional[bool]=True, verbose: Optional[bool]=True, **kwargs) -> Dict[str, Union[List[str], int, float]]:
        """
        Clones the data from the current PersistentDict to a new PersistentDict
        """
        ...

    async def aclone(self, target: Optional[Any], target_base_key: Optional[str]=None, schema_map: Optional[Dict[str, str]]=None, overwrite: Optional[bool]=None, **kwargs):
        """
        Clones the data from the current PersistentDict to a new PersistentDict
        """
    ...
    def clone_from(self, target: Any, target_base_key: Optional[str]=None, schema_map: Optional[Dict[str, str]]=None, overwrite: Optional[bool]=None, **kwargs):
        """
    ...
    @overload
    async def aclone_from(self, target: str, target_base_key: Optional[str]=None, target_db_id: Optional[int]=None, source_url: Optional[str]=None, source_base_key: Optional[str]=None, schema_map: Optional[Dict[str, str]]=None, overwrite: Optional[bool]=None, excluded: Optional[Union[str, List[str]]]=None, filter_function: Optional[Callable[[str], bool]]=None, raise_errors: Optional[bool]=True, verbose: Optional[bool]=True, **kwargs) -> Dict[str, Union[List[str], int, float]]:
        """
        Clones the data from the target PersistentDict to a current PersistentDict
        """
        ...

    async def aclone_from(self, target: Any, target_base_key: Optional[str]=None, schema_map: Optional[Dict[str, str]]=None, overwrite: Optional[bool]=None, **kwargs):
        """
        Clones the data from the target PersistentDict to a current PersistentDict
        """
    ...
    def configure_metric(self, name: str, kind: str, reset: Optional[bool]=None, metric_class: Optional[Union[Type['MetricT'], str]]=None, verbose: Optional[bool]=False, **kwargs):
        """
        Configures a Metric
        """
        ...
        if reset or name not in self['metrics']:
            if metric_class:
                metric_class = lazy_import(metric_class) if isinstance(metric_class, str) else metric_class
            else:
                metric_class = self.get_metric_class(kind, **kwargs)
