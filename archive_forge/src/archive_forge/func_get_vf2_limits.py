...
def get_vf2_limits(optimization_level: int, layout_method: Optional[str]=None, initial_layout: Optional[Layout]=None) -> VF2Limits:
    ...
    if layout_method is None and initial_layout is None:
        if optimization_level == 1:
            limits = VF2Limits(int(50000.0), 2500)
        elif optimization_level == 2:
            limits = VF2Limits(int(5000000.0), 25000)
        elif optimization_level == 3:
            limits = VF2Limits(int(30000000.0), 250000)
    return limits