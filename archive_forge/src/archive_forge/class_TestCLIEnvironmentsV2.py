...
class TestCLIEnvironmentsV2(base.BaseCommandTest):
    ...
    def test_list(self):
        ...
        expected = (ENVIRONMENT_DICT['name'], ENVIRONMENT_DICT['description'], ENVIRONMENT_DICT['scope'], ENVIRONMENT_DICT['created_at'], ENVIRONMENT_DICT['updated_at'])
    ...
    def test_delete_with_multi_names(self):
        ...
        self.assertEqual([mock.call('name1'), mock.call('name2')], self.client.environments.delete.call_args_list)