...
class TestMetadefsControllers(base.IsolatedUnitTest):
    ...
    def setUp(self):
        ...
        self._create_tags()
        self.namespace_controller = namespaces.NamespaceController(self.db, self.policy, self.notifier)
        self.property_controller = properties.NamespacePropertiesController(self.db, self.policy, self.notifier)
        self.object_controller = objects.MetadefObjectsController(self.db, self.policy, self.notifier)
        self.rt_controller = resource_types.ResourceTypeController(self.db, self.policy, self.notifier)
        self.tag_controller = tags.TagsController(self.db, self.policy, self.notifier)
        self.deserializer = objects.RequestDeserializer()
        self.property_deserializer = properties.RequestDeserializer()

    def _create_namespaces(self):
        req = unit_test_utils.get_fake_request()
        self.namespaces = [_db_namespace_fixture(NAMESPACE1, owner=TENANT1, visibility='private', protected=True), _db_namespace_fixture(NAMESPACE2, owner=TENANT2, visibility='private'), _db_namespace_fixture(NAMESPACE3, owner=TENANT3), _db_namespace_fixture(NAMESPACE5, owner=TENANT4), _db_namespace_fixture(NAMESPACE6, owner=TENANT4)]
        [self.db.metadef_namespace_create(req.context, namespace) for namespace in self.namespaces]
    ...
    def _create_tags(self):
        req = unit_test_utils.get_fake_request()
        self.tags = [(NAMESPACE3, _db_tag_fixture(TAG1)), (NAMESPACE3, _db_tag_fixture(TAG2)), (NAMESPACE1, _db_tag_fixture(TAG1))]
        [self.db.metadef_tag_create(req.context, namespace, tag) for namespace, tag in self.tags]
    ...
    def assertNotificationLog(self, expected_event_type, expected_payloads):
        events = [{'type': expected_event_type, 'payload': payload} for payload in expected_payloads]
    ...
    def test_namespace_show_non_existing(self):
        request = unit_test_utils.get_fake_request()
        self.assertRaises(webob.exc.HTTPNotFound, self.namespace_controller.show, request, 'FakeName')
    ...
    def test_namespace_delete(self):
        ...
        self.assertNotificationLog('metadef_namespace.delete', [{'namespace': NAMESPACE2}])
        self.assertRaises(webob.exc.HTTPNotFound, self.namespace_controller.show, request, NAMESPACE2)
    ...
    def test_namespace_delete_non_existing(self):
        request = unit_test_utils.get_fake_request()
        self.assertRaises(webob.exc.HTTPNotFound, self.namespace_controller.delete, request, 'FakeName')
        self.assertNotificationsLog([])

    def test_namespace_delete_non_visible(self):
        request = unit_test_utils.get_fake_request()
        self.assertRaises(webob.exc.HTTPNotFound, self.namespace_controller.delete, request, NAMESPACE2)
        self.assertNotificationsLog([])
    ...
    def test_namespace_delete_protected(self):
        request = unit_test_utils.get_fake_request()
        self.assertRaises(webob.exc.HTTPForbidden, self.namespace_controller.delete, request, NAMESPACE1)
        self.assertNotificationsLog([])
    ...
    def test_namespace_delete_with_contents(self):
        ...
        self.assertRaises(webob.exc.HTTPNotFound, self.namespace_controller.show, request, NAMESPACE3)
        self.assertRaises(webob.exc.HTTPNotFound, self.object_controller.show, request, NAMESPACE3, OBJECT1)
        self.assertRaises(webob.exc.HTTPNotFound, self.property_controller.show, request, NAMESPACE3, OBJECT1)
    ...
    def test_namespace_delete_properties_other_owner(self):
        request = unit_test_utils.get_fake_request()
        self.assertRaises(webob.exc.HTTPForbidden, self.namespace_controller.delete_properties, request, NAMESPACE3)
        self.assertNotificationsLog([])
    ...
    def test_namespace_non_existing_delete_properties(self):
        request = unit_test_utils.get_fake_request(roles=['admin'])
        self.assertRaises(webob.exc.HTTPNotFound, self.namespace_controller.delete_properties, request, NAMESPACE4)
        self.assertNotificationsLog([])
    ...
    def test_namespace_delete_objects(self):
        ...
        self.assertNotificationLog('metadef_namespace.delete_objects', [{'namespace': NAMESPACE3}])

    def test_namespace_delete_objects_other_owner(self):
        request = unit_test_utils.get_fake_request()
        self.assertRaises(webob.exc.HTTPForbidden, self.namespace_controller.delete_objects, request, NAMESPACE3)
        self.assertNotificationsLog([])
    ...
    def test_namespace_non_existing_delete_objects(self):
        request = unit_test_utils.get_fake_request(roles=['admin'])
        self.assertRaises(webob.exc.HTTPNotFound, self.namespace_controller.delete_objects, request, NAMESPACE4)
        self.assertNotificationsLog([])
    ...
    def test_namespace_delete_tags_other_owner(self):
        request = unit_test_utils.get_fake_request()
        self.assertRaises(webob.exc.HTTPForbidden, self.namespace_controller.delete_tags, request, NAMESPACE3)
        self.assertNotificationsLog([])
    ...
    def test_namespace_non_existing_delete_tags(self):
        request = unit_test_utils.get_fake_request(roles=['admin'])
        self.assertRaises(webob.exc.HTTPNotFound, self.namespace_controller.delete_tags, request, NAMESPACE4)
        self.assertNotificationsLog([])
    ...
    def test_namespace_create_with_4byte_character(self):
        ...
        namespace = namespaces.Namespace()
        namespace.namespace = '🚓'
        self.assertRaises(webob.exc.HTTPBadRequest, self.namespace_controller.create, request, namespace)
    ...
    def test_namespace_create_different_owner(self):
        ...
        self.assertRaises(webob.exc.HTTPForbidden, self.namespace_controller.create, request, namespace)
        self.assertNotificationsLog([])
    ...
    def test_namespace_update(self):
        ...
        self.assertNotificationLog('metadef_namespace.update', [{'namespace': NAMESPACE1, 'protected': False}])
        namespace = self.namespace_controller.show(request, NAMESPACE1)
        self.assertFalse(namespace.protected)
    ...
    def test_namespace_update_non_existing(self):
        ...
        namespace = namespaces.Namespace()
        namespace.namespace = NAMESPACE4
        self.assertRaises(webob.exc.HTTPNotFound, self.namespace_controller.update, request, namespace, NAMESPACE4)
        self.assertNotificationsLog([])
    ...
    def test_namespace_update_non_visible(self):
        ...
        self.assertRaises(webob.exc.HTTPNotFound, self.namespace_controller.update, request, namespace, NAMESPACE2)
        self.assertNotificationsLog([])
    ...
    def test_namespace_update_non_visible_admin(self):
        ...
        namespace.protected = False
        namespace = self.namespace_controller.update(request, namespace, NAMESPACE2)
        self.assertFalse(namespace.protected)
        self.assertNotificationLog('metadef_namespace.update', [{'namespace': NAMESPACE2, 'protected': False}])
        namespace = self.namespace_controller.show(request, NAMESPACE2)
        self.assertFalse(namespace.protected)
    ...
    def test_namespace_update_with_4byte_character(self):
        ...
        namespace = self.namespace_controller.show(request, NAMESPACE1)
        namespace.namespace = '🚓'
        self.assertRaises(webob.exc.HTTPBadRequest, self.namespace_controller.update, request, namespace, NAMESPACE1)

    def test_namespace_update_name_conflict(self):
        request = unit_test_utils.get_fake_request(roles=['admin'])
        namespace = self.namespace_controller.show(request, NAMESPACE1)
        namespace.namespace = NAMESPACE2
        self.assertRaises(webob.exc.HTTPConflict, self.namespace_controller.update, request, namespace, NAMESPACE1)
        self.assertNotificationsLog([])
    ...
    def test_property_index_non_existing_namespace(self):
        request = unit_test_utils.get_fake_request(tenant=TENANT2)
        self.assertRaises(webob.exc.HTTPNotFound, self.property_controller.index, request, NAMESPACE4)
    ...
    def test_property_show_prefix_mismatch(self):
        request = unit_test_utils.get_fake_request()
        self.assertRaises(webob.exc.HTTPNotFound, self.property_controller.show, request, NAMESPACE6, PROPERTY4, filters={'resource_type': RESOURCE_TYPE4})

    def test_property_show_non_existing_resource_type(self):
        request = unit_test_utils.get_fake_request()
        self.assertRaises(webob.exc.HTTPNotFound, self.property_controller.show, request, NAMESPACE2, PROPERTY1, filters={'resource_type': 'test'})

    def test_property_show_non_existing(self):
        request = unit_test_utils.get_fake_request()
        self.assertRaises(webob.exc.HTTPNotFound, self.property_controller.show, request, NAMESPACE2, PROPERTY1)

    def test_property_show_non_visible(self):
        request = unit_test_utils.get_fake_request(tenant=TENANT2)
        self.assertRaises(webob.exc.HTTPNotFound, self.property_controller.show, request, NAMESPACE1, PROPERTY1)
    ...
    def test_property_delete(self):
        ...
        self.assertNotificationLog('metadef_property.delete', [{'name': PROPERTY1, 'namespace': NAMESPACE3}])
        self.assertRaises(webob.exc.HTTPNotFound, self.property_controller.show, request, NAMESPACE3, PROPERTY1)
    ...
    def test_property_delete_other_owner(self):
        request = unit_test_utils.get_fake_request()
        self.assertRaises(webob.exc.HTTPForbidden, self.property_controller.delete, request, NAMESPACE3, PROPERTY1)
        self.assertNotificationsLog([])
    ...
    def test_property_delete_non_existing(self):
        request = unit_test_utils.get_fake_request(roles=['admin'])
        self.assertRaises(webob.exc.HTTPNotFound, self.property_controller.delete, request, NAMESPACE5, PROPERTY2)
        self.assertNotificationsLog([])

    def test_property_delete_non_existing_namespace(self):
        request = unit_test_utils.get_fake_request(roles=['admin'])
        self.assertRaises(webob.exc.HTTPNotFound, self.property_controller.delete, request, NAMESPACE4, PROPERTY1)
        self.assertNotificationsLog([])

    def test_property_delete_non_visible(self):
        request = unit_test_utils.get_fake_request(tenant=TENANT2)
        self.assertRaises(webob.exc.HTTPNotFound, self.property_controller.delete, request, NAMESPACE1, PROPERTY1)
        self.assertNotificationsLog([])

    def test_property_delete_admin_protected(self):
        request = unit_test_utils.get_fake_request(roles=['admin'])
        self.assertRaises(webob.exc.HTTPForbidden, self.property_controller.delete, request, NAMESPACE1, PROPERTY1)
        self.assertNotificationsLog([])
    ...
    def test_property_create(self):
        ...
        self.assertNotificationLog('metadef_property.create', [{'name': PROPERTY2, 'namespace': NAMESPACE1}])
    ...
    def test_property_create_overlimit_name(self):
        request = unit_test_utils.get_fake_request('/metadefs/namespaces/Namespace3/properties', roles=['admin'])
    ...
    def test_property_create_non_visible_namespace(self):
        ...
        property.type = 'string'
        property.title = 'title'
        self.assertRaises(webob.exc.HTTPNotFound, self.property_controller.create, request, NAMESPACE1, property)
        self.assertNotificationsLog([])
    ...
    def test_property_create_non_existing_namespace(self):
        ...
        property.type = 'string'
        property.title = 'title'
        self.assertRaises(webob.exc.HTTPNotFound, self.property_controller.create, request, NAMESPACE4, property)
        self.assertNotificationsLog([])
    ...
    def test_property_update_conflict(self):
        ...
        property.type = 'string'
        property.title = 'title'
        self.assertRaises(webob.exc.HTTPConflict, self.property_controller.update, request, NAMESPACE3, PROPERTY1, property)
        self.assertNotificationsLog([])
    ...
    def test_property_update_namespace_non_existing(self):
        ...
        property.type = 'string'
        property.title = 'title'
        self.assertRaises(webob.exc.HTTPNotFound, self.property_controller.update, request, NAMESPACE4, PROPERTY1, property)
        self.assertNotificationsLog([])
    ...
    def test_object_index_zero_limit(self):
        request = unit_test_utils.get_fake_request('/metadefs/namespaces/Namespace3/objects?limit=0')
    ...
    def test_object_index_non_existing_namespace(self):
        request = unit_test_utils.get_fake_request()
        self.assertRaises(webob.exc.HTTPNotFound, self.object_controller.index, request, NAMESPACE4)
    ...
    def test_object_show_non_existing(self):
        request = unit_test_utils.get_fake_request()
        self.assertRaises(webob.exc.HTTPNotFound, self.object_controller.show, request, NAMESPACE5, OBJECT1)

    def test_object_show_non_visible(self):
        request = unit_test_utils.get_fake_request(tenant=TENANT2)
        self.assertRaises(webob.exc.HTTPNotFound, self.object_controller.show, request, NAMESPACE1, OBJECT1)
    ...
    def test_object_delete(self):
        ...
        self.assertNotificationLog('metadef_object.delete', [{'name': OBJECT1, 'namespace': NAMESPACE3}])
        self.assertRaises(webob.exc.HTTPNotFound, self.object_controller.show, request, NAMESPACE3, OBJECT1)
    ...
    def test_object_delete_other_owner(self):
        request = unit_test_utils.get_fake_request()
        self.assertRaises(webob.exc.HTTPForbidden, self.object_controller.delete, request, NAMESPACE3, OBJECT1)
        self.assertNotificationsLog([])
    ...
    def test_object_delete_non_existing(self):
        request = unit_test_utils.get_fake_request(roles=['admin'])
        self.assertRaises(webob.exc.HTTPNotFound, self.object_controller.delete, request, NAMESPACE5, OBJECT1)
        self.assertNotificationsLog([])

    def test_object_delete_non_existing_namespace(self):
        request = unit_test_utils.get_fake_request(roles=['admin'])
        self.assertRaises(webob.exc.HTTPNotFound, self.object_controller.delete, request, NAMESPACE4, OBJECT1)
        self.assertNotificationsLog([])

    def test_object_delete_non_visible(self):
        request = unit_test_utils.get_fake_request(tenant=TENANT2)
        self.assertRaises(webob.exc.HTTPNotFound, self.object_controller.delete, request, NAMESPACE1, OBJECT1)
        self.assertNotificationsLog([])

    def test_object_delete_admin_protected(self):
        request = unit_test_utils.get_fake_request(roles=['admin'])
        self.assertRaises(webob.exc.HTTPForbidden, self.object_controller.delete, request, NAMESPACE1, OBJECT1)
        self.assertNotificationsLog([])
    ...
    def test_object_create(self):
        ...
        self.assertNotificationLog('metadef_object.create', [{'name': OBJECT2, 'namespace': NAMESPACE1, 'properties': []}])
    ...
    def test_object_create_duplicate(self):
        ...
        self.assertRaises(webob.exc.HTTPConflict, self.object_controller.create, request, object, NAMESPACE3)
    ...
    def test_object_create_non_existing_namespace(self):
        ...
        object.required = []
        object.properties = {}
        self.assertRaises(webob.exc.HTTPNotFound, self.object_controller.create, request, object, NAMESPACE4)
        self.assertNotificationsLog([])
    ...
    def test_object_create_non_visible_namespace(self):
        ...
        object.required = []
        object.properties = {}
        self.assertRaises(webob.exc.HTTPNotFound, self.object_controller.create, request, object, NAMESPACE1)
        self.assertNotificationsLog([])
    ...
    def test_object_update(self):
        ...
        object = self.object_controller.update(request, object, NAMESPACE3, OBJECT1)
        self.assertEqual(OBJECT1, object.name)
        self.assertEqual('description', object.description)
        self.assertNotificationLog('metadef_object.update', [{'name': OBJECT1, 'namespace': NAMESPACE3, 'description': 'description'}])
    ...
    def test_object_update_non_existing(self):
        ...
        object.required = []
        object.properties = {}
        self.assertRaises(webob.exc.HTTPNotFound, self.object_controller.update, request, object, NAMESPACE5, OBJECT1)
        self.assertNotificationsLog([])
    ...
    def test_object_update_namespace_non_existing(self):
        ...
        object.required = []
        object.properties = {}
        self.assertRaises(webob.exc.HTTPNotFound, self.object_controller.update, request, object, NAMESPACE4, OBJECT1)
        self.assertNotificationsLog([])
    ...
    def test_resource_type_show_non_visible(self):
        request = unit_test_utils.get_fake_request()
        self.assertRaises(webob.exc.HTTPNotFound, self.rt_controller.show, request, NAMESPACE2)
    ...
    def test_resource_type_show_non_existing_namespace(self):
        request = unit_test_utils.get_fake_request()
        self.assertRaises(webob.exc.HTTPNotFound, self.rt_controller.show, request, NAMESPACE4)

    def test_resource_type_association_delete(self):
        request = unit_test_utils.get_fake_request(tenant=TENANT3, roles=['admin'])
        self.rt_controller.delete(request, NAMESPACE3, RESOURCE_TYPE1)
        self.assertNotificationLog('metadef_resource_type.delete', [{'name': RESOURCE_TYPE1, 'namespace': NAMESPACE3}])
        output = self.rt_controller.show(request, NAMESPACE3)
        self.assertEqual(0, len(output.resource_type_associations))
    ...
    def test_resource_type_association_delete_other_owner(self):
        request = unit_test_utils.get_fake_request()
        self.assertRaises(webob.exc.HTTPForbidden, self.rt_controller.delete, request, NAMESPACE3, RESOURCE_TYPE1)
        self.assertNotificationsLog([])
    ...
    def test_resource_type_association_delete_non_existing(self):
        request = unit_test_utils.get_fake_request(roles=['admin'])
        self.assertRaises(webob.exc.HTTPNotFound, self.rt_controller.delete, request, NAMESPACE1, RESOURCE_TYPE2)
        self.assertNotificationsLog([])

    def test_resource_type_association_delete_non_existing_namespace(self):
        request = unit_test_utils.get_fake_request(roles=['admin'])
        self.assertRaises(webob.exc.HTTPNotFound, self.rt_controller.delete, request, NAMESPACE4, RESOURCE_TYPE1)
        self.assertNotificationsLog([])
    ...
    def test_resource_type_association_delete_protected_admin(self):
        request = unit_test_utils.get_fake_request(roles=['admin'])
        self.assertRaises(webob.exc.HTTPForbidden, self.rt_controller.delete, request, NAMESPACE1, RESOURCE_TYPE1)
        self.assertNotificationsLog([])
    ...
    def test_resource_type_association_create(self):
        ...
        rt.name = RESOURCE_TYPE2
        rt.prefix = 'pref'
        self.assertRaises(webob.exc.HTTPForbidden, self.rt_controller.create, request, rt, NAMESPACE1)
    ...
    def test_resource_type_association_create_conflict(self):
        ...
        rt.prefix = 'pref'
        self.assertRaises(webob.exc.HTTPConflict, self.rt_controller.create, request, rt, NAMESPACE1)
        self.assertNotificationsLog([])
    ...
    def test_resource_type_association_create_non_existing_resource_type(self):
        ...
        rt.prefix = 'pref'
        self.assertRaises(webob.exc.HTTPNotFound, self.rt_controller.create, request, rt, NAMESPACE1)
        self.assertNotificationsLog([])
    ...
    def test_tag_index_non_existing_namespace(self):
        request = unit_test_utils.get_fake_request()
        self.assertRaises(webob.exc.HTTPNotFound, self.tag_controller.index, request, NAMESPACE4)
    ...
    def test_tag_show_non_existing(self):
        request = unit_test_utils.get_fake_request()
        self.assertRaises(webob.exc.HTTPNotFound, self.tag_controller.show, request, NAMESPACE5, TAG1)

    def test_tag_show_non_visible(self):
        request = unit_test_utils.get_fake_request(tenant=TENANT2)
        self.assertRaises(webob.exc.HTTPNotFound, self.tag_controller.show, request, NAMESPACE1, TAG1)
    ...
    def test_tag_delete_other_owner(self):
        request = unit_test_utils.get_fake_request()
        self.assertRaises(webob.exc.HTTPForbidden, self.tag_controller.delete, request, NAMESPACE3, TAG1)
        self.assertNotificationsLog([])
    ...
    def test_tag_delete_non_existing(self):
        request = unit_test_utils.get_fake_request(roles=['admin'])
        self.assertRaises(webob.exc.HTTPNotFound, self.tag_controller.delete, request, NAMESPACE5, TAG1)
        self.assertNotificationsLog([])

    def test_tag_delete_non_existing_namespace(self):
        request = unit_test_utils.get_fake_request(roles=['admin'])
        self.assertRaises(webob.exc.HTTPNotFound, self.tag_controller.delete, request, NAMESPACE4, TAG1)
        self.assertNotificationsLog([])

    def test_tag_delete_non_visible(self):
        request = unit_test_utils.get_fake_request(tenant=TENANT2)
        self.assertRaises(webob.exc.HTTPNotFound, self.tag_controller.delete, request, NAMESPACE1, TAG1)
        self.assertNotificationsLog([])

    def test_tag_delete_admin_protected(self):
        request = unit_test_utils.get_fake_request(roles=['admin'])
        self.assertRaises(webob.exc.HTTPForbidden, self.tag_controller.delete, request, NAMESPACE1, TAG1)
        self.assertNotificationsLog([])
    ...
    def test_tag_create_overlimit_name(self):
        request = unit_test_utils.get_fake_request(roles=['admin'])
        exc = self.assertRaises(webob.exc.HTTPBadRequest, self.tag_controller.create, request, NAMESPACE1, 'a' * 81)
        self.assertIn("Failed validating 'maxLength' in schema['properties']['name']", exc.explanation)

    def test_tag_create_with_4byte_character(self):
        request = unit_test_utils.get_fake_request(roles=['admin'])
        self.assertRaises(webob.exc.HTTPBadRequest, self.tag_controller.create, request, NAMESPACE1, '🚓')
    ...
    def test_tag_create_tags_with_append_false(self):
        request = unit_test_utils.get_fake_request(headers={'X-Openstack-Append': 'False'}, roles=['admin'])
        metadef_tags = tags.MetadefTags()
        metadef_tags.tags = _db_tags_fixture([TAG2, TAG3])
        output = self.tag_controller.create_tags(request, metadef_tags, NAMESPACE1)
        output = output.to_dict()
    ...
    def test_tag_create_conflict(self):
        request = unit_test_utils.get_fake_request(roles=['admin'])
        self.assertRaises(webob.exc.HTTPConflict, self.tag_controller.create, request, NAMESPACE1, TAG1)
        self.assertNotificationsLog([])

    def test_tag_create_non_existing_namespace(self):
        request = unit_test_utils.get_fake_request(roles=['admin'])
        self.assertRaises(webob.exc.HTTPNotFound, self.tag_controller.create, request, NAMESPACE4, TAG1)
        self.assertNotificationsLog([])
    ...
    def test_tag_update_with_4byte_character(self):
        ...
        tag = self.tag_controller.show(request, NAMESPACE1, TAG1)
        tag.name = '🚓'
        self.assertRaises(webob.exc.HTTPBadRequest, self.tag_controller.update, request, tag, NAMESPACE1, TAG1)
    ...
    def test_tag_update_conflict(self):
        ...
        tag = self.tag_controller.show(request, NAMESPACE3, TAG1)
        tag.name = TAG2
        self.assertRaises(webob.exc.HTTPConflict, self.tag_controller.update, request, tag, NAMESPACE3, TAG1)
        self.assertNotificationsLog([])
    ...
    def test_tag_update_non_existing(self):
        ...
        tag = tags.MetadefTag()
        tag.name = TAG1
        self.assertRaises(webob.exc.HTTPNotFound, self.tag_controller.update, request, tag, NAMESPACE5, TAG1)
        self.assertNotificationsLog([])
