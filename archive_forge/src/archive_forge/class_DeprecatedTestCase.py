...
class DeprecatedTestCase(test_base.BaseTestCase):
    ...
    def test_deprecated_without_replacement(self, mock_reporter):
        ...
        def do_outdated_stuff():
            return
        do_outdated_stuff()
        self.assert_deprecated(mock_reporter, what='do_outdated_stuff()', as_of='Grizzly', remove_in='Icehouse')
    ...
    def test_deprecated_with_removed_plus_3(self, mock_reporter):
        ...
        @versionutils.deprecated(as_of=versionutils.deprecated.GRIZZLY, remove_in=+3)
        def do_outdated_stuff():
            return
        do_outdated_stuff()
        self.assert_deprecated(mock_reporter, what='do_outdated_stuff()', as_of='Grizzly', remove_in='Juno')
    ...
    def test_deprecated_with_removed_none(self, mock_reporter):
        ...
        @versionutils.deprecated(as_of=versionutils.deprecated.GRIZZLY, remove_in=None)
        def do_outdated_stuff():
            return
        do_outdated_stuff()
        self.assert_deprecated(mock_reporter, no_removal=True, what='do_outdated_stuff()', as_of='Grizzly', remove_in='Grizzly')
    ...
    def test_deprecated_with_removed_zero_and_alternative(self, mock_reporter):
        ...
        def do_outdated_stuff():
            return
        do_outdated_stuff()
        self.assert_deprecated(mock_reporter, no_removal=True, what='do_outdated_stuff()', as_of='Grizzly', in_favor_of='different_stuff()', remove_in='Grizzly')
    ...
    def test_deprecated_exception_old(self, mock_log):
        ...
        try:
            ...
            pass
        self.assert_deprecated(mock_log, what='OldException()', as_of='Icehouse', remove_in='Juno')
    ...
    def test_deprecated_newton_plus_two(self, mock_reporter):
        ...
        @versionutils.deprecated(as_of=versionutils.deprecated.NEWTON, remove_in=+2)
        class OutdatedClass(object):
            pass
        obj = OutdatedClass()
        self.assertIsInstance(obj, OutdatedClass)
        self.assert_deprecated(mock_reporter, what='OutdatedClass()', as_of='Newton', remove_in='Pike')
