...
from panda3d.core import globalClock  # Import globalClock directly
import random
...
class Game(ShowBase):
    def __init__(self):
        ...
        globalClock.set_mode(0)
        globalClock.set_frame_rate(60)
        globalClock.set_frame_rate_variable(True)
        globalClock.set_frame_rate_variable_min(30)
        globalClock.set_frame_rate_variable_max(120)
