...
class _RuntimeInfo:
    ...
    def __init__(self, *, full=True):
        ...
        self.cufft_version = _eval_or_error(cupy.cuda.cufft.getVersion, cupy.cuda.cufft.CuFFTError)
        ...
        self.nvrtc_version = _eval_or_error(cupy.cuda.nvrtc.getVersion, cupy.cuda.nvrtc.NVRTCError)
        try:
