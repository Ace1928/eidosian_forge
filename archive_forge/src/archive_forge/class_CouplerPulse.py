...
class CouplerPulse(cirq.ops.Gate):
    ...
    def __init__(self, hold_time: cirq.Duration, coupling_mhz: cirq.TParamVal, rise_time: Optional[cirq.Duration]=cirq.Duration(nanos=8), padding_time: Optional[cirq.Duration]=cirq.Duration(nanos=2.5), q0_detune_mhz: cirq.TParamVal=0.0, q1_detune_mhz: cirq.TParamVal=0.0):
        """Inits CouplerPulse.
    ...
    def __repr__(self) -> str:
        return f'cirq_google.experimental.ops.coupler_pulse.CouplerPulse(hold_time={proper_repr(self.hold_time)}, coupling_mhz={proper_repr(self.coupling_mhz)}, rise_time={proper_repr(self.rise_time)}, padding_time={proper_repr(self.padding_time)}, q0_detune_mhz={proper_repr(self.q0_detune_mhz)}, q1_detune_mhz={proper_repr(self.q1_detune_mhz)})'

    def __str__(self) -> str:
        return f'CouplerPulse(hold_time={self.hold_time}, coupling_mhz={self.coupling_mhz}, rise_time={self.rise_time}, padding_time={self.padding_time}, q0_detune_mhz={self.q0_detune_mhz}, q1_detune_mhz={self.q1_detune_mhz})'
    ...
    def _json_dict_(self):
        return cirq.obj_to_dict_helper(self, ['hold_time', 'coupling_mhz', 'rise_time', 'padding_time', 'q0_detune_mhz', 'q1_detune_mhz'])