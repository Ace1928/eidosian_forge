...
class ProcessExecutorHelpersTest(test.TestCase):
    ...
    def test_send_and_dispatch(self):
        ...
        t.notifier.register(task.EVENT_UPDATE_PROGRESS, lambda _event_type, details: details_capture.append(details))
        ...
        send_what = [{'progress': 0.1}, {'progress': 0.2}, {'progress': 0.3}, {'progress': 0.4}, {'progress': 0.5}, {'progress': 0.6}, {'progress': 0.7}, {'progress': 0.8}, {'progress': 0.9}]
