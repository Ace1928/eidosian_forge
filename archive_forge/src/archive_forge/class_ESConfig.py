...
class ESConfig(AlgorithmConfig):
    ...
    def training(self, *, action_noise_std: Optional[float]=NotProvided, l2_coeff: Optional[float]=NotProvided, noise_stdev: Optional[int]=NotProvided, episodes_per_batch: Optional[int]=NotProvided, eval_prob: Optional[float]=NotProvided, stepsize: Optional[float]=NotProvided, noise_size: Optional[int]=NotProvided, report_length: Optional[int]=NotProvided, tf_single_threaded: Optional[bool]=NotProvided, **kwargs) -> 'ESConfig':
