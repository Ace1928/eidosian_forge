...
class TestRepositoryIterInventories(TestRemoteRepository):
    ...
    def test_missing(self):
        transport_path = 'quack'
        repo, client = self.setup_fake_client_and_repository(transport_path)
        client.add_expected_call(b'VersionedFileRepository.get_inventories', (b'quack/', b'unordered'), b'success', (b'ok',), iter([]))
        self.assertRaises(errors.NoSuchRevision, list, repo.iter_inventories([b'somerevid']))