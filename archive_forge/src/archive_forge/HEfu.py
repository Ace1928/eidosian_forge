...
# Sign Bit: 3 bit (1 bit used as primary, 2 more for future use (ie extension to different logic system and factoring in uncertainty))
# Value Bits: n bits where range for n is 1 to 32 (precision) (typical 6 bits for 32-bit float and 15 bits for 64-bit float, more precision accounted for for future extension and to allow for multidimensional and multi-vector operations)
