...
def test_refresh_text_file_success_with_impersonation_use_default_scopes(self):
    credentials = self.make_credentials(credential_source=self.CREDENTIAL_SOURCE_TEXT, service_account_impersonation_url=SERVICE_ACCOUNT_IMPERSONATION_URL, scopes=None, default_scopes=SCOPES)
