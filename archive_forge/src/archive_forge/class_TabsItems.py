...
class TabsItems(VuetifyWidget):
    ...
    next_icon = Union([Bool(), Unicode()], default_value=None, allow_none=True).tag(sync=True)
    prev_icon = Union([Bool(), Unicode()], default_value=None, allow_none=True).tag(sync=True)
