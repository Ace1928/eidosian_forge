...
class TestTraitDocumenter(unittest.TestCase):
    ...
    def test_add_line(self):
        ...
        with mock.patch('traits.util.trait_documenter.ClassLevelDocumenter.add_directive_header'):
            documenter.add_directive_header('')
        self.assertEqual(len(documenter.directive.result.append.mock_calls), 1)
