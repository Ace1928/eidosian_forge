...
def _freeze_tasks(self, tasks, group_id, chord, root_id, parent_id):
    ...
    yield from (task.freeze(group_id=group_id, chord=chord, root_id=root_id, parent_id=parent_id, group_index=group_index) for group_index, task in enumerate(tasks))