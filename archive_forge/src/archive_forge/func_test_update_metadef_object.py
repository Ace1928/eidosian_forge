...
def test_update_metadef_object(self):
    self.verify_update(self.proxy.update_metadef_object, _metadef_object.MetadefObject, method_kwargs={'namespace': 'test_namespace_name'}, expected_kwargs={'namespace_name': 'test_namespace_name'})