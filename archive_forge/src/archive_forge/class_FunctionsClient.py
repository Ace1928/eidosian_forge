...
class FunctionsClient(object):
    ...
    """
        ...
        request = self.messages.CloudfunctionsProjectsLocationsListRequest(name='projects/' + project)
        return list_pager.YieldFromList(service=self.client.projects_locations, request=request, field='locations', batch_size_attribute='pageSize')
    ...
    """
        project = properties.VALUES.core.project.GetOrFail()
        request = self.messages.CloudfunctionsProjectsLocationsRuntimesListRequest(parent='projects/{project}/locations/{region}'.format(project=project, region=region), filter=query_filter)
    ...
    """
        return self.client.projects_locations_functions.AbortFunctionUpgrade(self.messages.CloudfunctionsProjectsLocationsFunctionsAbortFunctionUpgradeRequest(name=name))
    ...
    Returns:
      A long-running operation.
    """
        return self.client.projects_locations_functions.CommitFunctionUpgrade(self.messages.CloudfunctionsProjectsLocationsFunctionsCommitFunctionUpgradeRequest(name=name))
    ...
    Returns:
      A long-running operation.
    """
        return self.client.projects_locations_functions.RedirectFunctionUpgradeTraffic(self.messages.CloudfunctionsProjectsLocationsFunctionsRedirectFunctionUpgradeTrafficRequest(name=name))
    ...
    Returns:
      A long-running operation.
    """
        return self.client.projects_locations_functions.RollbackFunctionUpgradeTraffic(self.messages.CloudfunctionsProjectsLocationsFunctionsRollbackFunctionUpgradeTrafficRequest(name=name))
    ...
    Returns:
      A long-running operation.
    """
        return self.client.projects_locations_functions.SetupFunctionUpgradeConfig(self.messages.CloudfunctionsProjectsLocationsFunctionsSetupFunctionUpgradeConfigRequest(name=name))