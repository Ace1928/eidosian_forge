...
def main():
    ...
    model = nn.Sequential(
        ...
        DynamicActivationSynapse(216, 144, activation="tanh"),
        DynamicActivationNeuron(144, 72, activation="sigmoid", neuron_type="spiking"),
        DynamicActivationSynapse(72, 36, activation="sigmoid"),
        DynamicActivationNeuron(
