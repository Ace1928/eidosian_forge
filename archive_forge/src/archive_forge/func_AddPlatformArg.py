...
def AddPlatformArg(parser, managed_only=False, anthos_only=False):
    ...
    parser.add_argument('--platform', choices=choices, action=actions.StoreProperty(properties.VALUES.run.platform), default=platforms.PLATFORM_MANAGED, help='Target platform for running commands. Alternatively, set the property [run/platform]. ')