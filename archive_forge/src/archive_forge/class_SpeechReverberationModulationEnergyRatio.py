...
class SpeechReverberationModulationEnergyRatio(Metric):
    ...
    def __init__(self, fs: int, n_cochlear_filters: int=23, low_freq: float=125, min_cf: float=4, max_cf: Optional[float]=None, norm: bool=False, fast: bool=False, **kwargs: Any) -> None:
    ...
    def update(self, preds: Tensor) -> None:
        ...
        metric_val_batch = speech_reverberation_modulation_energy_ratio(preds, self.fs, self.n_cochlear_filters, self.low_freq, self.min_cf, self.max_cf, self.norm, self.fast).to(self.msum.device)
