...
def define_homogeneous_container_type(namespace, name, container_class, ctype, doc=None, use_slots=True):
    """
    ...
    if use_slots:
        cls_dict['__slots__'] = ('_parent', '_storage_key', '_active', '_data', '__weakref__')
