...
class CloudFrontFactsServiceManager:
    ...
    CLOUDFRONT_CLIENT_API_MAPPING = {'get_distribution': {'error': 'Error describing distribution'}, 'get_distribution_config': {'error': 'Error describing distribution configuration'}, 'get_origin_access_identity': {'error': 'Error describing origin access identity', 'client_api': 'get_cloud_front_origin_access_identity'}, 'get_origin_access_identity_config': {'error': 'Error describing origin access identity configuration', 'client_api': 'get_cloud_front_origin_access_identity_config'}, 'get_streaming_distribution': {'error': 'Error describing streaming distribution'}, 'get_streaming_distribution_config': {'error': 'Error describing streaming distribution'}, 'get_invalidation': {'error': 'Error describing invalidation'}, 'list_distributions_by_web_acl_id': {'error': 'Error listing distributions by web acl id', 'post_process': lambda x: cloudfront_facts_keyed_list_helper(x.get('DistributionList', {}).get('Items', []))}}
    CLOUDFRONT_CLIENT_PAGINATE_API_MAPPING = {'list_origin_access_identities': {'error': 'Error listing cloud front origin access identities', 'client_api': 'list_cloud_front_origin_access_identities', 'key': 'CloudFrontOriginAccessIdentityList'}, 'list_distributions': {'error': 'Error listing distributions', 'key': 'DistributionList', 'keyed': True}, 'list_invalidations': {'error': 'Error listing invalidations', 'key': 'InvalidationList'}, 'list_streaming_distributions': {'error': 'Error listing streaming distributions', 'key': 'StreamingDistributionList', 'keyed': True}}
