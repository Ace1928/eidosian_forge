...
@pytest.mark.parametrize('a, b', [('%2Ftmp%2Ftest.sock', 'http+unix://%2Ftmp%2FTEST.sock'), ('%2Ftmp%2Ftest.sock', 'http+unix://%2Ftmp%2FTEST.sock/'), ('%2Ftmp%2Ftest.sock', 'http+unix://%2Ftmp%2FTEST.sock/abracadabra'), ('%2Fvar%2Frun%2Fdocker.sock', 'http+unix://%2Ftmp%2FTEST.sock')])
