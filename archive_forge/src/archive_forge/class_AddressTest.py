...
class AddressTest(unittest.TestCase):
    ...
    def test_release_calls_connection_release_address_with_correct_args(self):
        ...
        self.address.connection.release_address.assert_called_with(public_ip='192.168.1.1', dry_run=False)

    def test_associate_calls_connection_associate_address_with_correct_args(self):
        self.address.associate(1)
        self.address.connection.associate_address.assert_called_with(instance_id=1, public_ip='192.168.1.1', allow_reassociation=False, network_interface_id=None, private_ip_address=None, dry_run=False)
