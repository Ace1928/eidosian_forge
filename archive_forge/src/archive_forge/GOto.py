...
class GUI(QMainWindow):
    ...
    def open_file_dialog(self):
        ...
        if files:
            self.file_processor._list_files(files)
    ...
    def setup_embedding_tab(self):
        ...
        generate_button.clicked.connect(self.embedding_storage._generate_embeddings)
    ...
    def setup_analysis_tab(self):
        ...
        pca_button.clicked.connect(self.data_analysis._perform_pca)
        layout.addWidget(pca_button)

        tsne_button = QPushButton("Perform t-SNE")
        tsne_button.clicked.connect(self.data_analysis._perform_tsne)
        layout.addWidget(tsne_button)

        clustering_button = QPushButton("Perform Clustering")
        clustering_button.clicked.connect(self.data_analysis._perform_clustering)
