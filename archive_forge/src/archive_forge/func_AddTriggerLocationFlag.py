...
def AddTriggerLocationFlag(parser):
    ...
    parser.add_argument('--trigger-location', help='The location of the trigger, which must be a region or multi-region where the relevant events originate. This is only relevant when `--gen2` is provided.', completer=LocationsCompleter)