...
def AddCaPoolIssuancePolicyFlag(parser):
    base.Argument('--issuance-policy', action='store', type=arg_parsers.YAMLFileContents(), help="A YAML file describing this CA Pool's issuance policy.").AddToParser(parser)