...
class DiscoveredWorkloadsClient(object):
    ...
    def __init__(self, release_track=base.ReleaseTrack.ALPHA):
        ...
        self._dis_workloads_client = self.client.projects_locations_discoveredWorkloads
    ...
    """
        describe_req = self.messages.ApphubProjectsLocationsDiscoveredWorkloadsGetRequest(name=discovered_workload)
    ...
    """
        list_req = self.messages.ApphubProjectsLocationsDiscoveredWorkloadsListRequest(parent=parent)
        return list_pager.YieldFromList(self._dis_workloads_client, list_req, field='discoveredWorkloads', batch_size=page_size, limit=limit, batch_size_attribute='pageSize')

    def FindUnregistered(self, parent, limit=None, page_size=100):
    ...
    Returns:
      Generator of matching discovered workloads.
    """
        find_unregistered_req = self.messages.ApphubProjectsLocationsDiscoveredWorkloadsFindUnregisteredRequest(parent=parent)
        return list_pager.YieldFromList(self._dis_workloads_client, find_unregistered_req, method='FindUnregistered', field='discoveredWorkloads', batch_size=page_size, limit=limit, batch_size_attribute='pageSize')
    ...
    """
        lookup_req = self.messages.ApphubProjectsLocationsDiscoveredWorkloadsLookupRequest(parent=parent, uri=uri)
