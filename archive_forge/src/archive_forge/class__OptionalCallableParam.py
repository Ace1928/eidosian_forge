...
@fugue_annotated_param('Callable', 'f', lambda annotation: annotation == Optional[Callable] or annotation == Optional[callable] or str(annotation).startswith('typing.Union[typing.Callable') or str(annotation).startswith('typing.Optional[typing.Callable'))
