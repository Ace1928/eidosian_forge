...
class TestNodeSetSecureBoot(base.TestCase):
    ...
    def test_node_set_secure_boot(self):
        ...
        self.session.put.assert_called_once_with('nodes/%s/states/secure_boot' % self.node.id, json={'target': True}, headers=mock.ANY, microversion=mock.ANY, retriable_status_codes=_common.RETRIABLE_STATUS_CODES)
