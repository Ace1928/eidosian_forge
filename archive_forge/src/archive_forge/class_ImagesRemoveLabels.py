...
class ImagesRemoveLabels(base.UpdateCommand):
    ...
    def Run(self, args):
        ...
        image_ref = self.DISK_IMAGE_ARG.ResolveAsResource(args, holder.resources)
        ...
        labels_update = labels_util.Diff(subtractions=remove_labels).Apply(messages.GlobalSetLabelsRequest.LabelsValue, image.labels)
