...
def test_refresh_success_with_impersonation_ignore_default_scopes(self, utcnow):
    ...
    credentials = self.make_credentials(client_id=CLIENT_ID, client_secret=CLIENT_SECRET, credential_source=self.CREDENTIAL_SOURCE, service_account_impersonation_url=SERVICE_ACCOUNT_IMPERSONATION_URL, quota_project_id=QUOTA_PROJECT_ID, scopes=SCOPES, default_scopes=['ignored'])
