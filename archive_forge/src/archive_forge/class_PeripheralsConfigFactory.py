...
class PeripheralsConfigFactory(object):
  ...
  """
    ...
    def __init__(self, dataproc, spark_history_server_config_factory_override=None):
    ...
    """
        ...
        self.spark_history_server_config_factory = spark_history_server_config_factory_override
        if not self.spark_history_server_config_factory:
            self.spark_history_server_config_factory = shscf.SparkHistoryServerConfigFactory(self.dataproc)
    ...
    """
        ...
        spark_history_server_config = self.spark_history_server_config_factory.GetMessage(args)
