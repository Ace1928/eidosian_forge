...
class APIv2(api.BaseAPI):
    ...
    def find(self, path, value=None, attr=None):
    ...
    def floating_ip_create(self, pool=None):
        ...
        url = '/os-floating-ips'
        try:
            return self.create(url, json={'pool': pool})['floating_ip']
        except (ksa_exceptions.NotFound, ksa_exceptions.BadRequest):
    ...
    def network_find(self, network=None):
        ...
        """
        url = '/os-networks'
        return self.find(url, attr='label', value=network)
