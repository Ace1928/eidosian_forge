...
class PrometheusAlarmTest(common.HeatTestCase):
    ...
    def test_update(self):
        ...
        update_props.update({'comparison_operator': 'lt', 'enabled': True, 'threshold': '9', 'insufficient_data_actions': [], 'alarm_actions': [], 'ok_actions': ['signal_handler'], 'query': "some_other_metric{some_other_label='value'}"})
