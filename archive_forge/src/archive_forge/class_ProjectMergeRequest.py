...
class ProjectMergeRequest(SubscribableMixin, TodoMixin, TimeTrackingMixin, ParticipantsMixin, SaveMixin, ObjectDeleteMixin, RESTObject):
    ...
    def reset_approvals(self, **kwargs: Any) -> Union[Dict[str, Any], requests.Response]:
    ...
    @cli.register_custom_action('ProjectMergeRequest', (), ('merge_commit_message', 'should_remove_source_branch', 'merge_when_pipeline_succeeds'))
    @exc.on_http_error(exc.GitlabMRClosedError)
    def merge(self, merge_commit_message: Optional[str]=None, should_remove_source_branch: Optional[bool]=None, merge_when_pipeline_succeeds: Optional[bool]=None, **kwargs: Any) -> Dict[str, Any]:
