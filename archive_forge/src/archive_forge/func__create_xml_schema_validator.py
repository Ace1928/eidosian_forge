...
def _create_xml_schema_validator(source=None, **kwargs):
    ...
    path_schema_eidas_attribute_naturalperson = str(schema_resources.joinpath('eidas-schema-attribute-naturalperson.xsd'))
    ...
    locations = {'http://www.w3.org/XML/1998/namespace': path_schema_xml, 'http://schemas.xmlsoap.org/soap/envelope/': path_schema_envelope, 'http://www.w3.org/2001/04/xmlenc#': path_schema_xenc, 'http://www.w3.org/2000/09/xmldsig#': path_schema_xmldsig_core, 'urn:oasis:names:tc:SAML:2.0:assertion': path_schema_saml_assertion, 'urn:oasis:names:tc:SAML:2.0:metadata': path_schema_saml_metadata, 'urn:oasis:names:tc:SAML:2.0:protocol': path_schema_saml_protocol, 'http://eidas.europa.eu/metadata/servicelist': path_schema_eidas_metadata_servicelist, 'http://eidas.europa.eu/saml-extensions': path_schema_eidas_saml_extensions, 'http://eidas.europa.eu/attributes/naturalperson': path_schema_eidas_attribute_naturalperson, 'http://eidas.europa.eu/attributes/legalperson': path_schema_eidas_attribute_legalperson}
    kwargs = {**kwargs, 'validation': 'strict', 'locations': locations, 'base_url': source, 'allow': 'sandbox', 'use_fallback': False}
