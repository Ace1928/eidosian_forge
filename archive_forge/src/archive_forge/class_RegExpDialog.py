...
class RegExpDialog(QtWidgets.QDialog):
    ...
    def __init__(self, parent=None):
        ...
        self.patternComboBox.setSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Preferred)
        ...
        palette.setBrush(QtGui.QPalette.Base, palette.brush(QtGui.QPalette.Disabled, QtGui.QPalette.Base))
        ...
        self.syntaxComboBox.addItem('Regular expression v1', QtCore.QRegExp.RegExp)
        self.syntaxComboBox.addItem('Regular expression v2', QtCore.QRegExp.RegExp2)
        ...
        self.textComboBox.setSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Preferred)
    ...
    def refresh(self):
        ...
        if rx.isValid():
            palette.setColor(QtGui.QPalette.Text, self.textComboBox.palette().color(QtGui.QPalette.Text))
        else:
