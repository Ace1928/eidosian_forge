...
def AddListEnvironmentFlags(parser):
    parser.add_argument('--location', completer=completers.LocationCompleter, help='Google Cloud location of this environment: https://cloud.google.com/compute/docs/regions-zones/#locations.')