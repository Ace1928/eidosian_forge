...
class RemoteFunction5(Generic[R, T0, T1, T2, T3, T4, T5]):
    ...
    def remote(self, __arg0: 'Union[T0, ObjectRef[T0]]', __arg1: 'Union[T1, ObjectRef[T1]]', __arg2: 'Union[T2, ObjectRef[T2]]', __arg3: 'Union[T3, ObjectRef[T3]]', __arg4: 'Union[T4, ObjectRef[T4]]', __arg5: 'Union[T5, ObjectRef[T5]]') -> 'ObjectRef[R]':
        ...

    def bind(self, __arg0: 'Union[T0, DAGNode[T0]]', __arg1: 'Union[T1, DAGNode[T1]]', __arg2: 'Union[T2, DAGNode[T2]]', __arg3: 'Union[T3, DAGNode[T3]]', __arg4: 'Union[T4, DAGNode[T4]]', __arg5: 'Union[T5, DAGNode[T5]]') -> 'DAGNode[R]':
        ...