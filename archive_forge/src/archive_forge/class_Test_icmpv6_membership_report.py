...
class Test_icmpv6_membership_report(Test_icmpv6_membership_query):
    ...
    maxresp = 10000
    address = 'ff08::1'
    buf = b"\x83\x00\xb4\xa4'\x10\x00\x00" + b'\xff\x08\x00\x00\x00\x00\x00\x00' + b'\x00\x00\x00\x00\x00\x00\x00\x01'

    def test_json(self):
        ic1 = icmpv6.icmpv6(type_=icmpv6.MLD_LISTENER_REPOR, data=icmpv6.mld())
