...
class AmplitudeControl(SoundModule):
    ...
    Methods:
        process_sound(sound: np.ndarray = np.zeros(0)) -> np.ndarray:
            Dynamically applies amplitude control to the input sound based on the current volume setting.
        set_parameter(parameter: str = 'volume', value: float = 1.0) -> None:
    ...
    def process_sound(self, sound: np.ndarray = np.zeros(0)) -> np.ndarray:
        """
        Processes the input sound data by applying amplitude control based on the current volume setting.

        Args:
            sound (np.ndarray): The input sound data as a NumPy array. Defaults to an empty array.
    ...
    def set_parameter(self, parameter: str = "volume", value: float = 1.0) -> None:
        """
        ...
        Args:
            parameter (str): The name of the parameter to set. Supported parameter: 'volume'. Defaults to 'volume'.
            value (float): The value to set the parameter to. Defaults to 1.0.
...
class EnvelopeGenerator(SoundModule):
    ...
    def __init__(
        ...
        Args:
            attack (float): The attack time in seconds. Defaults to 0.1.
            decay (float): The decay time in seconds. Defaults to 0.1.
            sustain (float): The sustain level (0.0 to 1.0). Defaults to 0.7.
            release (float): The release time in seconds. Defaults to 0.2.
        """
        super().__init__()
    ...
    def set_parameter(self, parameter: str = "volume", value: float = 1.0) -> None:
        ...
        Args:
            parameter (str): The name of the parameter to set. Defaults to 'volume'.
            value (float): The value to set the parameter to. Defaults to 1.0.
...
class PitchControl(SoundModule):
    ...
    def __init__(self, base_frequency: float = 440.0) -> None:
        """
        Initializes the PitchControl module with a specified base frequency.

        Args:
            base_frequency (float): The base frequency in Hz for the pitch control. Defaults to 440.0 Hz.
        """
        super().__init__()
        self.base_frequency: float = base_frequency
        self.validate_parameters({"base_frequency": base_frequency})

    def process_sound(self, sound: np.ndarray = np.array([])) -> np.ndarray:
        """
        ...
        Raises:
            ValueError: If the input sound is not a one-dimensional NumPy array or is empty.
        """
        if sound.size == 0:
            raise ValueError("Input sound is empty.")
        if sound.ndim != 1:
    ...
    def set_parameter(
        self, parameter: str = "base_frequency", value: float = 440.0
    ) -> None:
        """
        Sets the specified parameter to the given value if it is supported.

        Parameters:
            parameter (str): The name of the parameter to set. Defaults to 'base_frequency'.
            value (float): The value to set the parameter to. Defaults to 440.0 Hz.
...
class TimbreAdjustment(SoundModule):
    ...
    def __init__(self, harmonics: dict = None) -> None:
        """
        Initializes the TimbreAdjustment module with the specified harmonics.

        Args:
            harmonics (dict, optional): A dictionary of harmonic frequencies and their corresponding amplitude multipliers. Defaults to an empty dictionary if not provided.
        """
        super().__init__()
    ...
    def process_sound(self, sound: np.ndarray = np.array([])) -> np.ndarray:
        ...
        Parameters:
            sound (np.ndarray, optional): The input sound data as a NumPy array. Defaults to an empty array if not provided.
        ...
        """
        if sound.size == 0:
            return sound  # Return the empty array if no sound data is provided
        if sound.ndim != 1:
            raise ValueError("Input sound must be a one-dimensional NumPy array.")
    ...
    def set_parameter(self, parameter: str, value: dict = None) -> None:
        """
        Sets the specified parameter to the given value if it is supported.
        ...
        Parameters:
            parameter (str): The name of the parameter to set.
                             Supported parameters: 'harmonics'.
            value (dict, optional): The value to set the parameter to. Defaults to an empty dictionary if not provided.
...
class HarmonicGenerator(SoundModule):
    ...
    def __init__(self, fundamental_frequency: float = 440.0) -> None:
        """
        ...
        Args:
            fundamental_frequency (float): The fundamental frequency in Hz, which is the base for generating harmonics. Default is 440.0 Hz.
        """
        super().__init__()
        self.fundamental_frequency: float = fundamental_frequency
        self.overtones: dict = {
            1: 1.0  # Initialize with the fundamental frequency only, represented as the first harmonic.
        }

    def process_sound(self, sound: np.ndarray = np.zeros(1024)) -> np.ndarray:
        """
        ...
        Parameters:
            sound (np.ndarray): The input sound data as a NumPy array. Default is an array of zeros with length 1024.
    ...
    def set_parameter(self, parameter: str, value: float = 440.0) -> None:
        """
        Sets the specified parameter to the given value if it is supported, specifically for adjusting the 'fundamental_frequency'.

        Parameters:
            parameter (str): The name of the parameter to set.
            value (float): The value to set the parameter to. Default is 440.0 Hz.
...
class ModulationTechniques(SoundModule):
    ...
    def __init__(
        ...
        modulation_frequency: float = 440.0,
    ...
    def set_parameter(self, parameter: str, value: Union[str, float] = None) -> None:
        """
...
class EchoEffect(SoundModule):
    ...
    Attributes:
        delay_time (float): The delay time between echoes, measured in seconds, defaulting to 0.5 seconds.
        feedback (float): The feedback amount, controlling the echo strength, ranging from 0.0 (no feedback) to 1.0 (full feedback), defaulting to 0.5.
        mix (float): The mix ratio between the original sound and the echoed sound, ranging from 0.0 (all original) to 1.0 (all echoed), defaulting to 0.5.
    ...
    def __init__(self, delay_time: float = 0.5, feedback: float = 0.5, mix: float = 0.5) -> None:
        """
        Initializes the EchoEffect module with specified delay time, feedback, and mix parameters.

        Args:
            delay_time (float): The delay time between echoes in seconds, defaulting to 0.5.
            feedback (float): The feedback amount controlling the echo strength, defaulting to 0.5.
            mix (float): The mix ratio between the original and echoed sound, defaulting to 0.5.
...
class ChorusEffect(SoundModule):
    ...
    Attributes:
        rate (float): The modulation rate of the chorus effect in Hz, defaulting to 1.0 Hz.
        depth (float): The depth of the chorus effect, representing the maximum delay variation (0.0 to 1.0), defaulting to 0.5.
        mix (float): The mix ratio between the original and chorused sound (0.0 to 1.0), defaulting to 0.5.
    ...
    def __init__(self, rate: float = 1.0, depth: float = 0.5, mix: float = 0.5) -> None:
        """
    ...
    def process_sound(self, sound: np.ndarray = np.array([])) -> np.ndarray:
        ...
        Parameters:
            sound (np.ndarray): The input sound data as a NumPy array. Defaults to an empty array if not provided.
    ...
    def set_parameter(self, parameter: str, value: float = 0.0) -> None:
        """
        Sets the specified parameter to the given value if it is supported, with a default value if not specified.

        Parameters:
            parameter (str): The name of the parameter to set.
                             Supported parameters: 'rate', 'depth', 'mix'.
            value (float): The value to set the parameter to. Defaults to 0.0 if not specified.
...
class FlangerEffect(SoundModule):
    ...
    def __init__(
        self, delay: float = 0.005, depth: float = 0.5, rate: float = 0.2, feedback: float = 0.5, mix: float = 0.5
    ) -> None:
        """
...
class PhaserEffect(SoundModule):
    ...
    Attributes:
        rate (float): The modulation rate of the phaser effect in Hz, defaulting to 1.0 Hz.
        depth (float): The depth of the phaser effect, indicating the extent of phase modulation, defaulting to 0.5.
        feedback (float): The feedback amount, which controls the intensity of the effect by feeding the output back into the input, defaulting to 0.5.

    Inherits:
        SoundModule: Inherits the abstract base class SoundModule, ensuring compliance with the sound processing interface.
    """

    def __init__(self, rate: float = 1.0, depth: float = 0.5, feedback: float = 0.5) -> None:
        """
        Initializes the PhaserEffect module with specified modulation rate, depth, and feedback parameters.

        Args:
            rate (float): The modulation rate in Hz, defaulting to 1.0 Hz.
            depth (float): The modulation depth, ranging from 0.0 (no effect) to 1.0 (full effect), defaulting to 0.5.
            feedback (float): The feedback amount, ranging from 0.0 (no feedback) to 1.0 (maximum feedback), defaulting to 0.5.
...
class Equalizer(SoundModule):
    ...
    def process_sound(self, sound: np.ndarray, frequency_bands: dict = {}) -> np.ndarray:
        """
        Applies equalization to the input sound based on the frequency bands stored in the instance or provided as an argument. This method adjusts the amplitude of specific frequency ranges according to the gains specified in the frequency_bands dictionary.

        Parameters:
            sound (np.ndarray): The input sound data as a NumPy array.
            frequency_bands (dict): Optional dictionary specifying frequency bands and their corresponding gains.
        ...
        # Use instance frequency bands if no argument is provided
        bands_to_use = frequency_bands if frequency_bands else self.frequency_bands

        # Validate the frequency bands and gains
        for freq_range, gain in bands_to_use.items():
        ...
        for (low_freq, high_freq), gain in bands_to_use.items():
    ...
    def set_parameter(self, parameter: str, value: float = 0.0) -> None:
        ...
        Parameters:
            ...
            value (float): The new gain value in dB to be set for the specified frequency range, defaulting to 0 dB if not specified.
...
class DynamicRangeCompressor(SoundModule):
    ...
    def __init__(self, threshold: float = -10.0, ratio: float = 4.0) -> None:
        """
        Initializes the DynamicRangeCompressor with the specified threshold and ratio.

        Parameters:
            threshold (float): The threshold level in dB above which the compression starts. Defaults to -10.0 dB.
            ratio (float): The ratio of input to output change above the threshold. Defaults to 4.0.
    ...
    def set_parameter(self, parameter: str, value: float = 0.0) -> None:
        ...
        Parameters:
            parameter (str): The name of the parameter to set.
            value (float): The value to set the parameter to. Defaults to 0.0.
...
class DistortionEffect(SoundModule):
    ...
    Methods:
        process_sound(sound: np.ndarray, drive: float = 0.5, tone: float = 0.0) -> np.ndarray:
            Applies distortion to the input sound based on drive and tone settings.
    """

    def __init__(self, drive: float = 0.5, tone: float = 0.0) -> None:
        """
        Initializes the DistortionEffect module with default or specified drive and tone parameters.

        Parameters:
            drive (float): The initial amount of distortion to apply. Defaults to 0.5.
            tone (float): The initial tone of the distortion. Defaults to 0.0.
        """
        super().__init__()
        self.validate_parameters({"drive": drive, "tone": tone})
        self.drive: float = drive
        self.tone: float = tone

    def process_sound(self, sound: np.ndarray, drive: float = 0.5, tone: float = 0.0) -> np.ndarray:
        """
        Applies distortion to the input sound based on the drive and tone settings.
        ...
        Parameters:
            sound (np.ndarray): The input sound data as a NumPy array.
            drive (float): The amount of distortion to apply. Defaults to 0.5.
            tone (float): The tone of the distortion. Defaults to 0.0.

        Returns:
            np.ndarray: The processed sound data with distortion applied.

        Raises:
            ValueError: If the input parameters are out of the expected range or if the sound is not a one-dimensional array.
        """
    ...
    def set_parameter(self, parameter: str, value: float) -> None:
        ...
        Raises:
            ValueError: If the specified parameter is not supported or if the value is not within the valid range.
        """
        if parameter in ["drive", "tone"]:
            if parameter == "drive" and not (0.0 <= value <= 1.0):
                raise ValueError("Drive must be between 0.0 and 1.0.")
            if parameter == "tone" and not (-1.0 <= value <= 1.0):
                raise ValueError("Tone must be between -1.0 and 1.0.")
            setattr(self, parameter, value)
        else:
            raise ValueError(f"Unsupported parameter: {parameter}")
...
class StereoPanning(SoundModule):
    ...
    def process_sound(self, sound: np.ndarray = np.array([])) -> np.ndarray:
        ...
        Parameters:
            sound (np.ndarray): The input sound data as a NumPy array, expected to be mono (1D). Defaults to an empty array.
    ...
    def set_parameter(self, parameter: str = "pan", value: float = 0.0) -> None:
        """
        Sets the specified parameter to the given value if it is supported by this module.

        Parameters:
            parameter (str): The name of the parameter to set ('pan' in this case). Defaults to 'pan'.
            value (float): The value to set the parameter to. Defaults to 0.0.
    ...
    def process_sound(self, sound: np.ndarray, new_rate: int = SAMPLE_RATE) -> np.ndarray:
        """
        ...
        Parameters:
            sound (np.ndarray): The input sound data as a NumPy array.
            new_rate (int): The new sample rate to resample the sound to. Defaults to SAMPLE_RATE.
    ...
    def __init__(self, default_depth: int = 16) -> None:
        """
        ...
        The default bit depth is set to 16 bits if not specified otherwise.

        Parameters:
            default_depth (int): The default bit depth to initialize with, defaulting to 16.
        """
        super().__init__()  # Ensures proper initialization chaining in derived classes
        self.default_depth: int = default_depth

    def process_sound(self, sound: np.ndarray = np.array([]), new_depth: int = 16) -> np.ndarray:
        """
        ...
        Parameters:
            sound (np.ndarray): The input sound data as a NumPy array, defaulting to an empty array.
            new_depth (int): The new bit depth to apply to the sound, must be between 1 and 32, defaulting to 16.
    ...
    def set_parameter(self, parameter: str = "new_depth", value: float = 16) -> None:
        """
        Sets the specified parameter to the given value if it is supported by this module.

        Parameters:
            parameter (str): The name of the parameter to set ('new_depth' in this case), defaulting to 'new_depth'.
            value (float): The value to set the parameter to, defaulting to 16.
    ...
    def validate_parameters(self, parameters: Dict[str, Any] = {"new_depth": 16}) -> None:
        """
        Validates the parameters provided to the module to ensure they meet expected criteria.
        This method can be overridden by subclasses to implement module-specific validation logic.

        Parameters:
            parameters (Dict[str, Any]): A dictionary of parameter names and values to be validated, defaulting to {'new_depth': 16}.
        ...
        super().validate_parameters(
            parameters
        )  # Call to base class method to maintain validation logic
        for param, value in parameters.items():
            if param == "new_depth" and not (1 <= value <= 32):
                raise ValueError(
                    f"New depth must be between 1 and 32, got {value} instead."
                )
...
class FormantAdjustment(SoundModule):
    ...
    def __init__(self, default_formant_shifts: dict = None) -> None:
        """
        Initializes the FormantAdjustment module with default configurations or state setups if necessary.
        This constructor may be extended by subclasses to include specific initializations.
        """
        super().__init__()  # Ensures proper initialization chaining in derived classes
        if default_formant_shifts is None:
            default_formant_shifts = {1: 0, 2: 0, 3: 0}  # Default shifts for three formants
        self.default_formant_shifts = default_formant_shifts

    def process_sound(self, sound: np.ndarray = np.array([]), formant_shifts: dict = None) -> np.ndarray:
        """
        ...
        Raises:
            ...
            TypeError: If the input sound is not a one-dimensional NumPy array.
        """
        if formant_shifts is None:
            formant_shifts = self.default_formant_shifts
        if not isinstance(sound, np.ndarray):
            raise TypeError("Input sound must be a NumPy array.")
        if sound.ndim != 1:
            raise ValueError("Input sound must be a one-dimensional NumPy array.")
        if not all(isinstance(shift, (int, float)) for shift in formant_shifts.values()):
    ...
    def _analyze_formants(
        self, sound: np.ndarray = np.array([]), sample_rate: int = 44100
    ...
    def _synthesize_formants(
        self,
        sound: np.ndarray = np.array([]),
        formants: Dict[int, float] = {1: 500, 2: 1500, 3: 2500},
        bandwidths: Dict[int, float] = {1: 50, 2: 70, 3: 100},
...
class NoiseAddition(SoundModule):
    ...
    Methods:
        process_sound(sound: np.ndarray, color: str = 'white') -> np.ndarray:
            Adds colored noise (e.g., white, pink) to the input sound.
    """

    def process_sound(self, sound: np.ndarray, color: str = 'white') -> np.ndarray:
        """
        Adds colored noise (e.g., white, pink) to the input sound.

        Parameters:
            sound (np.ndarray): The input sound data as a NumPy array.
            color (str): The color of the noise to add (e.g., 'white', 'pink'). Defaults to 'white'.
...
class TransientShaping(SoundModule):
    """
    The TransientShaping class, inheriting from the SoundModule base class, meticulously shapes the transients in a sound to modify its attack and decay characteristics. This module is pivotal for dynamic sound design, allowing for precise control over the sharpness and duration of sound peaks, thereby enhancing the auditory experience.

    Attributes:
        attack (float): The attack time in seconds, defining how quickly the sound reaches its peak amplitude.
        sustain (float): The sustain level (0.0 to 1.0), representing the amplitude level during the main sequence of the sound's duration, before the release starts.

    Methods:
        process_sound(sound: np.ndarray, attack: float, sustain: float) -> np.ndarray:
            Modifies the attack and sustain characteristics of the input sound, applying an envelope to enhance or suppress transients.
    """

    def __init__(self, attack: float = 0.1, sustain: float = 0.5) -> None:
        """
        Initializes the TransientShaping module with default or specified attack and sustain values.

        Parameters:
            attack (float): Optional; the initial attack time in seconds. Defaults to 0.1 seconds.
            sustain (float): Optional; the initial sustain level. Defaults to 0.5.
        """
        super().__init__()
        self.attack = attack
        self.sustain = sustain
        self.validate_parameters({"attack": attack, "sustain": sustain})

    def process_sound(
        self, sound: np.ndarray, attack: float = 0.1, sustain: float = 0.5
    ) -> np.ndarray:
        """
