...
def _register_setup_method_fixture(self) -> None:
    ...
    def xunit_setup_method_fixture(request) -> Generator[None, None, None]:
        ...
        if teardown_method is not None:
            ...
            _call_with_optional_argument(func, method)
    self.session._fixturemanager._register_fixture(name=f'_xunit_setup_method_fixture_{self.obj.__qualname__}', func=xunit_setup_method_fixture, nodeid=self.nodeid, scope='function', autouse=True)