...
class FSMTest(testcase.TestCase):
    ...
    def test_on_enter_on_exit(self):
        ...
        m.process_event('jump')
        m.process_event('fall')
        self.assertEqual([('down', 'beat'), ('up', 'jump'), ('down', 'fall')], enter_transitions)
        self.assertEqual([('start', 'beat'), ('down', 'jump'), ('up', 'fall')], exit_transitions)
    ...
    def test_freeze(self):
        ...
        self.assertRaises(excp.FrozenMachine, self.jumper.add_transition, 'test', 'test', 'test')
        self.assertRaises(excp.FrozenMachine, self.jumper.add_reaction, 'test', 'test', lambda *args: 'test')
