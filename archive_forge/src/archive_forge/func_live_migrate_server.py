...
def live_migrate_server(self, server, host=None, force=False, block_migration=None):
    ...
    server.live_migrate(self, host, force=force, block_migration=block_migration)