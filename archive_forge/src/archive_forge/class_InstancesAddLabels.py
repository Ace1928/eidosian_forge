...
class InstancesAddLabels(base.UpdateCommand):
    ...
    def Run(self, args):
        ...
        labels_update = labels_util.Diff(additions=add_labels).Apply(messages.InstancesSetLabelsRequest.LabelsValue, instance.labels)
        ...
        return waiter.WaitFor(operation_poller, operation_ref, 'Updating labels of instance [{0}]'.format(instance_ref.Name()))