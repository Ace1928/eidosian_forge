...
class LocalAIEmbeddings(BaseModel, Embeddings):
    ...
    def validate_environment(cls, values: Dict) -> Dict:
        ...
        values['openai_api_base'] = get_from_dict_or_env(values, 'openai_api_base', 'OPENAI_API_BASE', default='')
        ...
        values['openai_organization'] = get_from_dict_or_env(values, 'openai_organization', 'OPENAI_ORGANIZATION', default='')
        try:
            import openai
    ...
    def _invocation_params(self) -> Dict:
        openai_args = {'model': self.model, 'request_timeout': self.request_timeout, 'headers': self.headers, 'api_key': self.openai_api_key, 'organization': self.openai_organization, 'api_base': self.openai_api_base, 'api_version': self.openai_api_version, **self.model_kwargs}
