...
class UnstructuredRTFLoader(UnstructuredFileLoader):
    ...
    def __init__(self, file_path: Union[str, Path], mode: str='single', **unstructured_kwargs: Any):
        """
        ...
        if not satisfies_min_unstructured_version(min_unstructured_version):
            raise ValueError(f'Partitioning rtf files is only supported in unstructured>={min_unstructured_version}.')
