...
class CloudtasksV2beta2(base_api.BaseApiClient):
    ...
    def __init__(self, url='', credentials=None, get_credentials=True, http=None, model=None, log_request=False, log_response=False, credentials_args=None, default_global_params=None, additional_http_headers=None, response_encoding=None):
        ...
        super(CloudtasksV2beta2, self).__init__(url, credentials=credentials, get_credentials=get_credentials, http=http, model=model, log_request=log_request, log_response=log_response, credentials_args=credentials_args, default_global_params=default_global_params, additional_http_headers=additional_http_headers, response_encoding=response_encoding)
    ...
    class ApiQueueService(base_api.BaseApiService):
      ...
      """
        ...
        Update.method_config = lambda: base_api.ApiMethodInfo(http_method='POST', method_id='cloudtasks.api.queue.update', ordered_params=[], path_params=[], query_params=['appId'], relative_path='api/queue/update', request_field='httpBody', request_type_name='CloudtasksApiQueueUpdateRequest', response_type_name='Empty', supports_download=False)
    ...
    class ProjectsLocationsQueuesTasksService(base_api.BaseApiService):
      ...
      """
            ...
            return self._RunMethod(config, request, global_params=global_params)
        Acknowledge.method_config = lambda: base_api.ApiMethodInfo(flat_path='v2beta2/projects/{projectsId}/locations/{locationsId}/queues/{queuesId}/tasks/{tasksId}:acknowledge', http_method='POST', method_id='cloudtasks.projects.locations.queues.tasks.acknowledge', ordered_params=['name'], path_params=['name'], query_params=[], relative_path='v2beta2/{+name}:acknowledge', request_field='acknowledgeTaskRequest', request_type_name='CloudtasksProjectsLocationsQueuesTasksAcknowledgeRequest', response_type_name='Empty', supports_download=False)
      ...
      """
            ...
            return self._RunMethod(config, request, global_params=global_params)
        Buffer.method_config = lambda: base_api.ApiMethodInfo(flat_path='v2beta2/projects/{projectsId}/locations/{locationsId}/queues/{queuesId}/tasks/{taskId}:buffer', http_method='POST', method_id='cloudtasks.projects.locations.queues.tasks.buffer', ordered_params=['queue', 'taskId'], path_params=['queue', 'taskId'], query_params=[], relative_path='v2beta2/{+queue}/tasks/{taskId}:buffer', request_field='bufferTaskRequest', request_type_name='CloudtasksProjectsLocationsQueuesTasksBufferRequest', response_type_name='BufferTaskResponse', supports_download=False)
      ...
      """
            ...
            return self._RunMethod(config, request, global_params=global_params)
        CancelLease.method_config = lambda: base_api.ApiMethodInfo(flat_path='v2beta2/projects/{projectsId}/locations/{locationsId}/queues/{queuesId}/tasks/{tasksId}:cancelLease', http_method='POST', method_id='cloudtasks.projects.locations.queues.tasks.cancelLease', ordered_params=['name'], path_params=['name'], query_params=[], relative_path='v2beta2/{+name}:cancelLease', request_field='cancelLeaseRequest', request_type_name='CloudtasksProjectsLocationsQueuesTasksCancelLeaseRequest', response_type_name='Task', supports_download=False)
      ...
      """
            ...
            return self._RunMethod(config, request, global_params=global_params)
        Create.method_config = lambda: base_api.ApiMethodInfo(flat_path='v2beta2/projects/{projectsId}/locations/{locationsId}/queues/{queuesId}/tasks', http_method='POST', method_id='cloudtasks.projects.locations.queues.tasks.create', ordered_params=['parent'], path_params=['parent'], query_params=[], relative_path='v2beta2/{+parent}/tasks', request_field='createTaskRequest', request_type_name='CloudtasksProjectsLocationsQueuesTasksCreateRequest', response_type_name='Task', supports_download=False)
      ...
      """
            ...
            return self._RunMethod(config, request, global_params=global_params)
        Delete.method_config = lambda: base_api.ApiMethodInfo(flat_path='v2beta2/projects/{projectsId}/locations/{locationsId}/queues/{queuesId}/tasks/{tasksId}', http_method='DELETE', method_id='cloudtasks.projects.locations.queues.tasks.delete', ordered_params=['name'], path_params=['name'], query_params=[], relative_path='v2beta2/{+name}', request_field='', request_type_name='CloudtasksProjectsLocationsQueuesTasksDeleteRequest', response_type_name='Empty', supports_download=False)
      ...
      """
            ...
            return self._RunMethod(config, request, global_params=global_params)
        Get.method_config = lambda: base_api.ApiMethodInfo(flat_path='v2beta2/projects/{projectsId}/locations/{locationsId}/queues/{queuesId}/tasks/{tasksId}', http_method='GET', method_id='cloudtasks.projects.locations.queues.tasks.get', ordered_params=['name'], path_params=['name'], query_params=['responseView'], relative_path='v2beta2/{+name}', request_field='', request_type_name='CloudtasksProjectsLocationsQueuesTasksGetRequest', response_type_name='Task', supports_download=False)
      ...
      """
            ...
            return self._RunMethod(config, request, global_params=global_params)
        Lease.method_config = lambda: base_api.ApiMethodInfo(flat_path='v2beta2/projects/{projectsId}/locations/{locationsId}/queues/{queuesId}/tasks:lease', http_method='POST', method_id='cloudtasks.projects.locations.queues.tasks.lease', ordered_params=['parent'], path_params=['parent'], query_params=[], relative_path='v2beta2/{+parent}/tasks:lease', request_field='leaseTasksRequest', request_type_name='CloudtasksProjectsLocationsQueuesTasksLeaseRequest', response_type_name='LeaseTasksResponse', supports_download=False)
      ...
      """
            ...
            return self._RunMethod(config, request, global_params=global_params)
        List.method_config = lambda: base_api.ApiMethodInfo(flat_path='v2beta2/projects/{projectsId}/locations/{locationsId}/queues/{queuesId}/tasks', http_method='GET', method_id='cloudtasks.projects.locations.queues.tasks.list', ordered_params=['parent'], path_params=['parent'], query_params=['pageSize', 'pageToken', 'responseView'], relative_path='v2beta2/{+parent}/tasks', request_field='', request_type_name='CloudtasksProjectsLocationsQueuesTasksListRequest', response_type_name='ListTasksResponse', supports_download=False)
      ...
      """
            ...
            return self._RunMethod(config, request, global_params=global_params)
        RenewLease.method_config = lambda: base_api.ApiMethodInfo(flat_path='v2beta2/projects/{projectsId}/locations/{locationsId}/queues/{queuesId}/tasks/{tasksId}:renewLease', http_method='POST', method_id='cloudtasks.projects.locations.queues.tasks.renewLease', ordered_params=['name'], path_params=['name'], query_params=[], relative_path='v2beta2/{+name}:renewLease', request_field='renewLeaseRequest', request_type_name='CloudtasksProjectsLocationsQueuesTasksRenewLeaseRequest', response_type_name='Task', supports_download=False)
    ...
    class ProjectsLocationsQueuesService(base_api.BaseApiService):
      ...
      """
            config = self.GetMethodConfig('Create')
            return self._RunMethod(config, request, global_params=global_params)
        Create.method_config = lambda: base_api.ApiMethodInfo(flat_path='v2beta2/projects/{projectsId}/locations/{locationsId}/queues', http_method='POST', method_id='cloudtasks.projects.locations.queues.create', ordered_params=['parent'], path_params=['parent'], query_params=[], relative_path='v2beta2/{+parent}/queues', request_field='queue', request_type_name='CloudtasksProjectsLocationsQueuesCreateRequest', response_type_name='Queue', supports_download=False)
      ...
      """
            config = self.GetMethodConfig('Delete')
            return self._RunMethod(config, request, global_params=global_params)
        Delete.method_config = lambda: base_api.ApiMethodInfo(flat_path='v2beta2/projects/{projectsId}/locations/{locationsId}/queues/{queuesId}', http_method='DELETE', method_id='cloudtasks.projects.locations.queues.delete', ordered_params=['name'], path_params=['name'], query_params=[], relative_path='v2beta2/{+name}', request_field='', request_type_name='CloudtasksProjectsLocationsQueuesDeleteRequest', response_type_name='Empty', supports_download=False)
      ...
      """
            config = self.GetMethodConfig('Get')
            return self._RunMethod(config, request, global_params=global_params)
        Get.method_config = lambda: base_api.ApiMethodInfo(flat_path='v2beta2/projects/{projectsId}/locations/{locationsId}/queues/{queuesId}', http_method='GET', method_id='cloudtasks.projects.locations.queues.get', ordered_params=['name'], path_params=['name'], query_params=['readMask'], relative_path='v2beta2/{+name}', request_field='', request_type_name='CloudtasksProjectsLocationsQueuesGetRequest', response_type_name='Queue', supports_download=False)
      ...
      """
            ...
            return self._RunMethod(config, request, global_params=global_params)
        GetIamPolicy.method_config = lambda: base_api.ApiMethodInfo(flat_path='v2beta2/projects/{projectsId}/locations/{locationsId}/queues/{queuesId}:getIamPolicy', http_method='POST', method_id='cloudtasks.projects.locations.queues.getIamPolicy', ordered_params=['resource'], path_params=['resource'], query_params=[], relative_path='v2beta2/{+resource}:getIamPolicy', request_field='getIamPolicyRequest', request_type_name='CloudtasksProjectsLocationsQueuesGetIamPolicyRequest', response_type_name='Policy', supports_download=False)
      ...
      """
            config = self.GetMethodConfig('List')
            return self._RunMethod(config, request, global_params=global_params)
        List.method_config = lambda: base_api.ApiMethodInfo(flat_path='v2beta2/projects/{projectsId}/locations/{locationsId}/queues', http_method='GET', method_id='cloudtasks.projects.locations.queues.list', ordered_params=['parent'], path_params=['parent'], query_params=['filter', 'pageSize', 'pageToken', 'readMask'], relative_path='v2beta2/{+parent}/queues', request_field='', request_type_name='CloudtasksProjectsLocationsQueuesListRequest', response_type_name='ListQueuesResponse', supports_download=False)
      ...
      """
            ...
            return self._RunMethod(config, request, global_params=global_params)
        Patch.method_config = lambda: base_api.ApiMethodInfo(flat_path='v2beta2/projects/{projectsId}/locations/{locationsId}/queues/{queuesId}', http_method='PATCH', method_id='cloudtasks.projects.locations.queues.patch', ordered_params=['name'], path_params=['name'], query_params=['updateMask'], relative_path='v2beta2/{+name}', request_field='queue', request_type_name='CloudtasksProjectsLocationsQueuesPatchRequest', response_type_name='Queue', supports_download=False)
      ...
      """
            ...
            return self._RunMethod(config, request, global_params=global_params)
        Pause.method_config = lambda: base_api.ApiMethodInfo(flat_path='v2beta2/projects/{projectsId}/locations/{locationsId}/queues/{queuesId}:pause', http_method='POST', method_id='cloudtasks.projects.locations.queues.pause', ordered_params=['name'], path_params=['name'], query_params=[], relative_path='v2beta2/{+name}:pause', request_field='pauseQueueRequest', request_type_name='CloudtasksProjectsLocationsQueuesPauseRequest', response_type_name='Queue', supports_download=False)
      ...
      """
            ...
            return self._RunMethod(config, request, global_params=global_params)
        Resume.method_config = lambda: base_api.ApiMethodInfo(flat_path='v2beta2/projects/{projectsId}/locations/{locationsId}/queues/{queuesId}:resume', http_method='POST', method_id='cloudtasks.projects.locations.queues.resume', ordered_params=['name'], path_params=['name'], query_params=[], relative_path='v2beta2/{+name}:resume', request_field='resumeQueueRequest', request_type_name='CloudtasksProjectsLocationsQueuesResumeRequest', response_type_name='Queue', supports_download=False)
      ...
      """
            ...
            return self._RunMethod(config, request, global_params=global_params)
        SetIamPolicy.method_config = lambda: base_api.ApiMethodInfo(flat_path='v2beta2/projects/{projectsId}/locations/{locationsId}/queues/{queuesId}:setIamPolicy', http_method='POST', method_id='cloudtasks.projects.locations.queues.setIamPolicy', ordered_params=['resource'], path_params=['resource'], query_params=[], relative_path='v2beta2/{+resource}:setIamPolicy', request_field='setIamPolicyRequest', request_type_name='CloudtasksProjectsLocationsQueuesSetIamPolicyRequest', response_type_name='Policy', supports_download=False)
      ...
      """
            ...
            return self._RunMethod(config, request, global_params=global_params)
        TestIamPermissions.method_config = lambda: base_api.ApiMethodInfo(flat_path='v2beta2/projects/{projectsId}/locations/{locationsId}/queues/{queuesId}:testIamPermissions', http_method='POST', method_id='cloudtasks.projects.locations.queues.testIamPermissions', ordered_params=['resource'], path_params=['resource'], query_params=[], relative_path='v2beta2/{+resource}:testIamPermissions', request_field='testIamPermissionsRequest', request_type_name='CloudtasksProjectsLocationsQueuesTestIamPermissionsRequest', response_type_name='TestIamPermissionsResponse', supports_download=False)
    ...
    class ProjectsLocationsService(base_api.BaseApiService):
      ...
      """
            config = self.GetMethodConfig('Get')
            return self._RunMethod(config, request, global_params=global_params)
        Get.method_config = lambda: base_api.ApiMethodInfo(flat_path='v2beta2/projects/{projectsId}/locations/{locationsId}', http_method='GET', method_id='cloudtasks.projects.locations.get', ordered_params=['name'], path_params=['name'], query_params=[], relative_path='v2beta2/{+name}', request_field='', request_type_name='CloudtasksProjectsLocationsGetRequest', response_type_name='Location', supports_download=False)
      ...
      """
            ...
            return self._RunMethod(config, request, global_params=global_params)
        GetCmekConfig.method_config = lambda: base_api.ApiMethodInfo(flat_path='v2beta2/projects/{projectsId}/locations/{locationsId}/cmekConfig', http_method='GET', method_id='cloudtasks.projects.locations.getCmekConfig', ordered_params=['name'], path_params=['name'], query_params=[], relative_path='v2beta2/{+name}', request_field='', request_type_name='CloudtasksProjectsLocationsGetCmekConfigRequest', response_type_name='CmekConfig', supports_download=False)
      ...
      """
            config = self.GetMethodConfig('List')
            return self._RunMethod(config, request, global_params=global_params)
        List.method_config = lambda: base_api.ApiMethodInfo(flat_path='v2beta2/projects/{projectsId}/locations', http_method='GET', method_id='cloudtasks.projects.locations.list', ordered_params=['name'], path_params=['name'], query_params=['filter', 'pageSize', 'pageToken'], relative_path='v2beta2/{+name}/locations', request_field='', request_type_name='CloudtasksProjectsLocationsListRequest', response_type_name='ListLocationsResponse', supports_download=False)
      ...
      """
            ...
            return self._RunMethod(config, request, global_params=global_params)
        UpdateCmekConfig.method_config = lambda: base_api.ApiMethodInfo(flat_path='v2beta2/projects/{projectsId}/locations/{locationsId}/cmekConfig', http_method='PATCH', method_id='cloudtasks.projects.locations.updateCmekConfig', ordered_params=['name'], path_params=['name'], query_params=['updateMask'], relative_path='v2beta2/{+name}', request_field='cmekConfig', request_type_name='CloudtasksProjectsLocationsUpdateCmekConfigRequest', response_type_name='CmekConfig', supports_download=False)
