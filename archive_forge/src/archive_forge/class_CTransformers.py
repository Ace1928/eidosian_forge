...
class CTransformers(LLM):
    ...
    def _identifying_params(self) -> Dict[str, Any]:
        ...
        return {'model': self.model, 'model_type': self.model_type, 'model_file': self.model_file, 'config': self.config}
    ...
    def validate_environment(cls, values: Dict) -> Dict:
        ...
        try:
            ...
            raise ImportError('Could not import `ctransformers` package. Please install it with `pip install ctransformers`')
        config = values['config'] or {}
        values['client'] = AutoModelForCausalLM.from_pretrained(values['model'], model_type=values['model_type'], model_file=values['model_file'], lib=values['lib'], **config)
        return values

    def _call(self, prompt: str, stop: Optional[Sequence[str]]=None, run_manager: Optional[CallbackManagerForLLMRun]=None, **kwargs: Any) -> str:
