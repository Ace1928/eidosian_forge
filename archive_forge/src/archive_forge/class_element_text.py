...
class element_text(element_base):
    ...
    def __init__(self, family: Optional[str | list[str]]=None, style: Optional[str | Sequence[str]]=None, weight: Optional[int | str | Sequence[int | str]]=None, color: Optional[str | TupleFloat3 | TupleFloat4 | Sequence[str | TupleFloat3 | TupleFloat4]]=None, size: Optional[float | Sequence[float]]=None, ha: Optional[Literal['center', 'left', 'right'] | float]=None, va: Optional[Literal['center', 'top', 'bottom', 'baseline', 'center_baseline'] | float]=None, rotation: Optional[Literal['vertical', 'horizontal'] | float | Sequence[Literal['vertical', 'horizontal']] | Sequence[float]]=None, linespacing: Optional[float]=None, backgroundcolor: Optional[str | TupleFloat3 | TupleFloat4 | Sequence[str | TupleFloat3 | TupleFloat4]]=None, margin: Optional[dict[Literal['t', 'b', 'l', 'r', 'units'], Any]]=None, **kwargs: Any):
        ...
        names = ('backgroundcolor', 'color', 'family', 'ha', 'linespacing', 'rotation', 'size', 'style', 'va', 'weight')
        variables = locals()
        for name in names:
