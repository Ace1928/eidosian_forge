...
class CmdStanPathfinder:
    ...
    def __init__(self, runset: RunSet):
        ...
        if not runset.method == Method.PATHFINDER:
            raise ValueError('Wrong runset method, expecting Pathfinder runset, found method {}'.format(runset.method))
        self._runset = runset
    ...
    def __repr__(self) -> str:
        rep = 'CmdStanPathfinder: model={}{}'.format(self._runset.model, self._runset._args.method_args.compose(0, cmd=[]))
