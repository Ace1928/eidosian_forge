...
class TestCLITriggersV2(base.BaseCommandTest):
    ...
    def test_create(self, mock_open, mock_convert):
        ...
        result = self.call(cron_triggers_cmd.Create, app_args=['my_trigger', 'flow1', '--pattern', '* * * * *', '--params', '{}', '--count', '5', '--first-time', '4242-12-20 13:37', '--utc'])
    ...
    def test_delete_with_multi_names(self):
        ...
        self.assertEqual([mock.call('name1'), mock.call('name2')], self.client.cron_triggers.delete.call_args_list)