...
@Deprecated(message='Use ray.get_runtime_context().get_assigned_resources() instead.', warning=True)
def get_resource_ids():
    ...
    if _mode() == LOCAL_MODE:
        raise RuntimeError('ray._private.worker.get_resource_ids() does not work in local_mode.')
