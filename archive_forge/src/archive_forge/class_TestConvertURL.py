...
class TestConvertURL(TestCase):
    ...
    def test_simple(self):
        ...
        self.assertEqual(git_url_to_bzr_url('user@foo:bar/path'), 'git+ssh://user@foo/bar/path')

    def test_regular(self):
        self.assertEqual(git_url_to_bzr_url('git+ssh://user@foo/bar/path'), 'git+ssh://user@foo/bar/path')
