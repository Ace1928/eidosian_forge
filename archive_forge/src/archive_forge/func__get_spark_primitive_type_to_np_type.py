...
def _get_spark_primitive_type_to_np_type():
    ...
    return {types.IntegerType: np.int32, types.LongType: np.int64, types.FloatType: np.float32, types.DoubleType: np.float64, types.BooleanType: np.bool_, types.StringType: np.str_}