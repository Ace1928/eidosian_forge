...
class SimulationConfig:
    ...
    def __init__(self):
        ...
        self.particles_per_type: int = max(1, 200) # Ensure at least 1 particle
        self.min_particles_per_type: int = max(1, 50)
        self.max_particles_per_type: int = max(500, self.min_particles_per_type)
        ...
        self.evolution_interval: int = max(1, np.inf)
