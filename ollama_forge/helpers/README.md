# `ollama_forge/helpers`

<!-- EIDOS:DOCSYS:START -->
- Contract: `eidos.directory_doc.v1`
- Generated: `2026-03-13T00:19:24Z`
- Path: `ollama_forge/helpers`

## What It Is

Managed directory documentation for `ollama_forge/helpers`, generated from tracked files and directory structure.
...
- Python modules: `common, embedding, install_ollama, model_constants`
...
- [`model_constants.py`](./model_constants.py)
