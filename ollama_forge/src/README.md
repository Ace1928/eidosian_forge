...
- Path: `ollama_forge/src`

## What It Is

Managed directory documentation for `ollama_forge/src`, generated from tracked files and directory structure.

## Why It Exists

This directory exists to hold the `src` surface for `ollama_forge` and keep that responsibility separate from adjacent forge concerns.
...
- [`ollama_forge`](./ollama_forge/README.md)
