# `skills/moltbook/references`

<!-- EIDOS:DOCSYS:START -->
- Contract: `eidos.directory_doc.v1`
- Generated: `2026-03-13T00:19:25Z`
- Path: `skills/moltbook/references`

## What It Is

Managed directory documentation for `skills/moltbook/references`, generated from tracked files and directory structure.

## Why It Exists

This directory exists to hold the `directory` surface for `skills` and keep that responsibility separate from adjacent forge concerns.
