# `skills/moltbook/scripts`

<!-- EIDOS:DOCSYS:START -->
- Contract: `eidos.directory_doc.v1`
- Generated: `2026-03-13T00:19:25Z`
- Path: `skills/moltbook/scripts`

## What It Is

Managed directory documentation for `skills/moltbook/scripts`, generated from tracked files and directory structure.

## Why It Exists

This directory exists to hold the `scripts` surface for `skills` and keep that responsibility separate from adjacent forge concerns.
...
- Parent README: [`skills/moltbook/README.md`](../README.md)
- Forge README: [`skills/README.md`](../../README.md)
