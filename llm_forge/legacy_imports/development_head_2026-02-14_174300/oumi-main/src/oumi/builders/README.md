# `llm_forge/legacy_imports/development_head_2026-02-14_174300/oumi-main/src/oumi/builders`

<!-- EIDOS:DOCSYS:START -->
- Contract: `eidos.directory_doc.v1`
- Generated: `2026-03-13T00:19:22Z`
- Path: `llm_forge/legacy_imports/development_head_2026-02-14_174300/oumi-main/src/oumi/builders`

## What It Is

Managed directory documentation for `llm_forge/legacy_imports/development_head_2026-02-14_174300/oumi-main/src/oumi/builders`, generated from tracked files and directory structure.
...
- Python modules: `callbacks, collators, data, inference_engines, lr_schedules, metrics, models, optimizers, oumi_data, processors`
...
- [`data.py`](./data.py)
- [`inference_engines.py`](./inference_engines.py)
- [`lr_schedules.py`](./lr_schedules.py)
