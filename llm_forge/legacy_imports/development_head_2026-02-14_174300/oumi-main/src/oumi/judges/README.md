# `llm_forge/legacy_imports/development_head_2026-02-14_174300/oumi-main/src/oumi/judges`

<!-- EIDOS:DOCSYS:START -->
- Contract: `eidos.directory_doc.v1`
- Generated: `2026-03-13T00:19:22Z`
- Path: `llm_forge/legacy_imports/development_head_2026-02-14_174300/oumi-main/src/oumi/judges`

## What It Is

Managed directory documentation for `llm_forge/legacy_imports/development_head_2026-02-14_174300/oumi-main/src/oumi/judges`, generated from tracked files and directory structure.
...
- Python modules: `base_judge, judge_court, oumi_judge`
...
- [`base_judge.py`](./base_judge.py)
- [`judge_court.py`](./judge_court.py)
- [`oumi_judge.py`](./oumi_judge.py)
