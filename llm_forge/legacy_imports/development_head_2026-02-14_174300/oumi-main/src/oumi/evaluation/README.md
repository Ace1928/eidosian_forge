# `llm_forge/legacy_imports/development_head_2026-02-14_174300/oumi-main/src/oumi/evaluation`

<!-- EIDOS:DOCSYS:START -->
- Contract: `eidos.directory_doc.v1`
- Generated: `2026-03-13T00:19:22Z`
- Path: `llm_forge/legacy_imports/development_head_2026-02-14_174300/oumi-main/src/oumi/evaluation`

## What It Is

Managed directory documentation for `llm_forge/legacy_imports/development_head_2026-02-14_174300/oumi-main/src/oumi/evaluation`, generated from tracked files and directory structure.
...
- Python modules: `alpaca_eval, lm_harness, platform_prerequisites, save_utils`
...
- [`alpaca_eval.py`](./alpaca_eval.py)
- [`lm_harness.py`](./lm_harness.py)
- [`platform_prerequisites.py`](./platform_prerequisites.py)
