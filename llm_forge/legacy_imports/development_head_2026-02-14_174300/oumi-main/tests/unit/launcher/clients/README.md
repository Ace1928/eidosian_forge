# `llm_forge/legacy_imports/development_head_2026-02-14_174300/oumi-main/tests/unit/launcher/clients`

<!-- EIDOS:DOCSYS:START -->
- Contract: `eidos.directory_doc.v1`
- Generated: `2026-03-13T00:19:22Z`
- Path: `llm_forge/legacy_imports/development_head_2026-02-14_174300/oumi-main/tests/unit/launcher/clients`

## What It Is

Managed directory documentation for `llm_forge/legacy_imports/development_head_2026-02-14_174300/oumi-main/tests/unit/launcher/clients`, generated from tracked files and directory structure.
...
- Child directories: `0`
- Tests detected: `True`
- Python modules: `test_local_client, test_polaris_client, test_sky_client`
...
- [`test_local_client.py`](./test_local_client.py)
- [`test_polaris_client.py`](./test_polaris_client.py)
- [`test_sky_client.py`](./test_sky_client.py)
