# `llm_forge/src/llm_forge/core`

<!-- EIDOS:DOCSYS:START -->
- Contract: `eidos.directory_doc.v1`
- Generated: `2026-03-13T00:19:22Z`
- Path: `llm_forge/src/llm_forge/core`

## What It Is

Managed directory documentation for `llm_forge/src/llm_forge/core`, generated from tracked files and directory structure.

## Why It Exists

This directory exists to hold the `core` surface for `llm_forge` and keep that responsibility separate from adjacent forge concerns.
...
- Python modules: `interfaces, manager`
...
- Parent README: [`llm_forge/src/llm_forge/README.md`](../README.md)
